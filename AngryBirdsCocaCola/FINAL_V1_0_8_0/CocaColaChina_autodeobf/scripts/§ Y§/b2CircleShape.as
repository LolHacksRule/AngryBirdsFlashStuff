package § Y§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§%o§.Set(_loc4_ - b2internal:: !!,_loc5_ - b2internal:: !!);
         param1.§4!_§.Set(_loc4_ + b2internal:: !!,_loc5_ + b2internal:: !!);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§7Q§ = param2 * b2Settings.b2_pi * b2internal:: !! * b2internal:: !!;
         param1.center.SetV(this.§`!a§);
         param1.§3`§ = param1.§7Q§ * (0.5 * b2internal:: !! * b2internal:: !! + (this.§`!a§.x * this.§`!a§.x + this.§`!a§.y * this.§`!a§.y));
      }
      
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         var _loc9_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§;!P§(param3,this.§`!a§);
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.§9O§(param1,_loc5_) - param2)) < -b2internal:: !! + Number.MIN_VALUE)
         {
            return 0;
         }
      ...
      public function §9!0§(param1:b2Vec2) : void
      {
         this.§`!a§.SetV(param1);
      }
