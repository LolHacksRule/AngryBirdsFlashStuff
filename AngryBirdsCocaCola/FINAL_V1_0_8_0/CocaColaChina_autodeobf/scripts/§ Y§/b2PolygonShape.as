package § Y§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §4!4§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §;'§:b2Vec2;
      
      b2internal var §33§:Vector.<b2Vec2>;
      ...
      public static function §>!U§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
      ...
      public static function §<I§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc3_.§!'§(_loc9_);
            _loc3_.§!'§(_loc10_);
            _loc3_.§`!e§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            while(_loc3_ < this.§>Z§)
            {
               this.§33§[_loc3_].SetV(_loc2_.§33§[_loc3_]);
      ...
      public function §]H§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function §2]§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§>Z§)
         {
            this.§33§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§>Z§)
         {
            ...
            _loc6_ = b2Math.§`"§(this.§33§[_loc5_],this.§33§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§!J§() > Number.MIN_VALUE);
            this.§^$§[_loc3_].SetV(b2Math.§,7§(_loc6_,1));
            this.§^$§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§;'§ = §<I§(this.§33§,this.§>Z§);
      }
      ...
      public function §%#§(param1:Number, param2:Number) : void
      {
         this.§>Z§ = 4;
         this.§2W§(4);
         this.§33§[0].Set(-param1,-param2);
         this.§33§[1].Set(param1,-param2);
         this.§33§[2].Set(param1,param2);
         this.§33§[3].Set(-param1,param2);
         this.§^$§[0].Set(0,-1);
         this.§^$§[1].Set(1,0);
         this.§^$§[2].Set(0,1);
         this.§^$§[3].Set(-1,0);
      ...
      public function §7§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§>Z§)
         {
            this.§33§[_loc6_] = b2Math.§;!P§(_loc5_,this.§33§[_loc6_]);
            this.§^$§[_loc6_] = b2Math.§#t§(_loc5_.R,this.§^$§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §8!Y§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§>Z§ = 2;
         this.§2W§(2);
         this.§33§[0].SetV(param1);
         this.§33§[1].SetV(param2);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         {
            _loc6_ = (_loc9_ = this.§33§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§%o§.x = _loc5_ - b2internal:: !!;
         param1.§%o§.y = _loc6_ - b2internal:: !!;
         param1.§4!_§.x = _loc7_ + b2internal:: !!;
         param1.§4!_§.y = _loc8_ + b2internal:: !!;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§>Z§ == 2)
         {
            param1.center.x = 0.5 * (this.§33§[0].x + this.§33§[1].x);
            param1.center.y = 0.5 * (this.§33§[0].y + this.§33§[1].y);
            param1.§7Q§ = 0;
            param1.§3`§ = 0;
            return;
         }
         ...
         {
            _loc11_ = this.§33§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§>Z§ ? this.§33§[int(_loc10_ + 1)] : this.§33§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§6i§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§9O§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§9O§(_loc5_,this.§33§[_loc12_]) - _loc6_;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§33§[_loc9_].x * (1 - _loc15_) + this.§33§[_loc13_].x * _loc15_,this.§33§[_loc9_].y * (1 - _loc15_) + this.§33§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§33§[_loc10_].x * (1 - _loc16_) + this.§33§[_loc14_].x * _loc16_,this.§33§[_loc10_].y * (1 - _loc16_) + this.§33§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§33§[_loc13_];
         _loc12_ = _loc13_;
      ...
      public function §0!C§() : Vector.<b2Vec2>
      {
         return this.§^$§;
      }
      ...
      private function §2W§(param1:int) : void
      {
         var _loc2_:int = this.§33§.length;
         while(_loc2_ < param1)
         {
            this.§33§[_loc2_] = new b2Vec2();
