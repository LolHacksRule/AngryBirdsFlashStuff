package § Y§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§;!!§ = this.§!K§.Normalize();
         this.§;!V§.Set(this.§!K§.y,-this.§!K§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§;!V§.x - this.§!K§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§;!V§.y - this.§!K§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§;!V§.x + this.§!K§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§;!V§.y + this.§!K§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§;!V§;
         this.m_cornerDir2.Set(-this.§;!V§.x,-this.§;!V§.y);
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc8_:Number = b2Math.§9O§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§9O§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §0!e§() : b2EdgeShape
      {
         return this.§<T§;
      }
