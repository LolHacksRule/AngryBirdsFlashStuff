   ...
   public class §[!6§ extends §]u§
   {
      ...
      protected function §;D§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§7f§(_loc7_,_loc6_)]) == null)
            {
            ...
            if(_loc10_)
            {
               ...
               (_loc16_ = new §4!E§()).mName = _loc6_;
               _loc16_.§'+§ = _loc15_;
               _loc16_.§4!@§ = _loc10_.pivotX;
               _loc16_.§0U§ = _loc10_.pivotY;
               _loc16_.§<!&§ = §23§;
               §!E§(_loc16_);
            }
         }
      ...
      private function §7f§(param1:String, param2:String) : String
      {
      ...
      private function §#!,§(param1:Vector.<XML>) : Dictionary
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§7f§(_loc4_,_loc6_.@name);
