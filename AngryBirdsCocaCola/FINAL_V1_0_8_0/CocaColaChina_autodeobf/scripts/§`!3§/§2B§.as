package §`!3§
{
   ...
   public class §2B§
   {
      ...
      public static function §-l§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §#4§(_loc2_);
         return §5H§.§%!E§(_loc3_.readInt(),true) + §5H§.§%!E§(_loc3_.readInt(),true) + §5H§.§%!E§(_loc3_.readInt(),true) + §5H§.§%!E§(_loc3_.readInt(),true) + §5H§.§%!E§(_loc3_.readInt(),true);
      }
      
      public static function §4!+§(param1:ByteArray) : String
      {
         var _loc2_:Array = §2B§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §#4§(_loc2_);
         return §5H§.§%!E§(_loc3_.readInt(),true) + §5H§.§%!E§(_loc3_.readInt(),true) + §5H§.§%!E§(_loc3_.readInt(),true) + §5H§.§%!E§(_loc3_.readInt(),true) + §5H§.§%!E§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §2B§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §#4§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §#4§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
