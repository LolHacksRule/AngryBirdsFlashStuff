package §1z§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §9T§:b2WorldManifold = new b2WorldManifold();
      
      private static var §1!S§:b2PositionSolverManifold = new b2PositionSolverManifold();
       
      
      private var §0!E§:b2TimeStep;
      
      private var §]!M§;
      
      b2internal var §?s§:Vector.<b2ContactConstraint>;
      
      private var § "§:int;
      
      public function b2ContactSolver()
      {
         this.§0!E§ = new b2TimeStep();
         this.§?s§ = new Vector.<b2ContactConstraint>();
         super();
      }
      ...
      public function §2#§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§]!M§ = param4;
         this.§ "§ = param3;
         while(this.§?s§.length < this.§ "§)
         {
            this.§?s§[this.§?s§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            ...
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§5!2§(),_loc10_.§5!2§());
            _loc20_ = _loc15_.§1!K§.x;
            _loc21_ = _loc15_.§1!K§.y;
            _loc22_ = _loc16_.§1!K§.x;
            _loc23_ = _loc16_.§1!K§.y;
            _loc24_ = _loc15_.m_angularVelocity;
            _loc25_ = _loc16_.m_angularVelocity;
            b2Settings.b2Assert(_loc17_.§6p§ > 0);
            §9T§.§2#§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §9T§.§;!V§.x;
            _loc27_ = §9T§.§;!V§.y;
            (_loc28_ = this.§?s§[_loc6_]).§;!9§ = _loc15_;
            _loc28_.§;!,§ = _loc16_;
            _loc28_.§;_§ = _loc17_;
            _loc28_.normal.x = _loc26_;
            _loc28_.normal.y = _loc27_;
            _loc28_.§^Q§ = _loc17_.§6p§;
            _loc28_.friction = _loc18_;
            _loc28_.restitution = _loc19_;
            _loc28_.§!!;§.x = _loc17_.§4!F§.x;
            _loc28_.§!!;§.y = _loc17_.§4!F§.y;
            _loc28_.localPoint.x = _loc17_.m_localPoint.x;
            _loc28_.localPoint.y = _loc17_.m_localPoint.y;
            _loc28_.radius = _loc13_ + _loc14_;
            _loc28_.type = _loc17_.§2M§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§^Q§)
            {
               _loc30_ = _loc17_.§1!§[_loc29_];
               ...
               _loc32_ = _loc31_.§;N§.x = §9T§.§1!§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§;N§.y = §9T§.§1!§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§"R§.x = §9T§.§1!§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§"R§.y = §9T§.§1!§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§;z§ + _loc16_.§;z§ + _loc15_.§?C§ * _loc36_ + _loc16_.§?C§ * _loc37_;
               _loc31_.§5c§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§&!§ * _loc15_.§;z§ + _loc16_.§&!§ * _loc16_.§;z§) + (_loc15_.§&!§ * _loc15_.§?C§ * _loc36_ + _loc16_.§&!§ * _loc16_.§?C§ * _loc37_);
               _loc31_.§ !H§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§;z§ + _loc16_.§;z§ + _loc15_.§?C§ * _loc42_ + _loc16_.§?C§ * _loc43_;
               _loc31_.§;o§ = 1 / _loc44_;
               _loc31_.§=+§ = 0;
            ...
            if(_loc28_.§^Q§ == 2)
            {
               ...
               _loc55_ = _loc48_.§"R§.x * _loc27_ - _loc48_.§"R§.y * _loc26_;
               _loc56_ = _loc49_.§;N§.x * _loc27_ - _loc49_.§;N§.y * _loc26_;
               _loc57_ = _loc49_.§"R§.x * _loc27_ - _loc49_.§"R§.y * _loc26_;
               ...
               {
                  _loc28_.§8!V§.col1.Set(_loc58_,_loc60_);
                  _loc28_.§8!V§.col2.Set(_loc60_,_loc59_);
                  _loc28_.§8!V§.§&!6§(_loc28_.§5c§);
               }
               else
               {
                  _loc28_.§^Q§ = 1;
         ...
         while(_loc5_ < this.§ "§)
         {
            ...
            if(param1.§9w§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc7_.§1!K§.x -= _loc9_ * _loc21_;
                  _loc7_.§1!K§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§"R§.x * _loc22_ - _loc20_.§"R§.y * _loc21_);
                  _loc8_.§1!K§.x += _loc11_ * _loc21_;
                  _loc8_.§1!K§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         while(_loc24_ < this.§ "§)
         {
            _loc26_ = (_loc25_ = this.§?s§[_loc24_]).§;!9§;
            _loc27_ = _loc25_.§;!,§;
            ...
            _loc1_ = 0;
            while(_loc1_ < _loc25_.§^Q§)
            {
               _loc2_ = _loc25_.§?!$§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§"R§.y - _loc30_.x + _loc28_ * _loc2_.§;N§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§"R§.x - _loc30_.y - _loc28_ * _loc2_.§;N§.x;
               ...
               _loc29_ += _loc35_ * (_loc2_.§"R§.x * _loc15_ - _loc2_.§"R§.y * _loc14_);
            ...
            if(_loc25_.§^Q§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§5c§ * (_loc9_ - _loc2_.§=+§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§"R§.y - _loc30_.x + _loc28_ * _loc43_.§;N§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§"R§.x - _loc30_.y - _loc28_ * _loc43_.§;N§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§"R§.y - _loc30_.x + _loc28_ * _loc44_.§;N§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§"R§.x - _loc30_.y - _loc28_ * _loc44_.§;N§.x;
               ...
               _loc55_ = 0.001;
               _loc56_ = -((_loc22_ = _loc25_.§5c§).col1.x * _loc53_ + _loc22_.col2.x * _loc54_);
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc29_ += _loc35_ * (_loc43_.§"R§.x * _loc19_ - _loc43_.§"R§.y * _loc18_ + _loc44_.§"R§.x * _loc21_ - _loc44_.§"R§.y * _loc20_);
                  _loc43_.normalImpulse = _loc56_;
                  _loc44_.normalImpulse = _loc57_;
               }
               else
               {
                  _loc56_ = -_loc43_.§5c§ * _loc53_;
                  _loc57_ = 0;
                  _loc51_ = 0;
                  _loc52_ = _loc25_.§8!V§.col1.y * _loc56_ + _loc54_;
                  ...
                  {
                     _loc56_ = 0;
                     _loc57_ = -_loc44_.§5c§ * _loc54_;
                     _loc51_ = _loc25_.§8!V§.col2.x * _loc57_ + _loc53_;
                     _loc52_ = 0;
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§ "§)
         {
            ...
            _loc11_ = §1!S§.§;!V§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§^Q§)
            {
               _loc13_ = _loc4_.§?!$§[_loc12_];
               _loc14_ = §1!S§.§1!§[_loc12_];
               _loc15_ = §1!S§.§&!a§[_loc12_];
               ...
               _loc22_ = (_loc21_ = -_loc13_.§ !H§ * _loc20_) * _loc11_.x;
