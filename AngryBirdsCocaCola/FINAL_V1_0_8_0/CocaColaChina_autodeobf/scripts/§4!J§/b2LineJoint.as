package §4!J§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§5!M§.x * this.§+N§.x + (this.§2!N§ + this.§5!M§.y) * this.§?!c§.x),param1 * (this.§5!M§.x * this.§+N§.y + (this.§2!N§ + this.§5!M§.y) * this.§?!c§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§4A§ = this.§4A§ > Number.MIN_VALUE ? Number(1 / this.§4A§) : Number(0);
         ...
         this.§8!R§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§8!R§.col2.x = this.§8!R§.col1.y;
         this.§8!R§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§;P§)
         {
         ...
         if(param1.§9w§)
         {
            ...
            this.§5!M§.y *= param1.§7!<§;
            this.§2!N§ *= param1.§7!<§;
            _loc19_ = this.§5!M§.x * this.§+N§.x + (this.§2!N§ + this.§5!M§.y) * this.§?!c§.x;
            _loc20_ = this.§5!M§.x * this.§+N§.y + (this.§2!N§ + this.§5!M§.y) * this.§?!c§.y;
            _loc21_ = this.§5!M§.x * this.m_s1 + (this.§2!N§ + this.§5!M§.y) * this.m_a1;
            _loc22_ = this.§5!M§.x * this.m_s2 + (this.§2!N§ + this.§5!M§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§?!c§.x * (_loc6_.x - _loc4_.x) + this.§?!c§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§4A§ * (this.§0!§ - _loc13_);
            _loc15_ = this.§2!N§;
            _loc16_ = param1.§?!§ * this.§9f§;
            this.§2!N§ = b2Math.§^7§(this.§2!N§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§2!N§ - _loc15_) * this.§?!c§.x;
            _loc9_ = _loc14_ * this.§?!c§.y;
         ...
         {
            _loc17_ = this.§?!c§.x * (_loc6_.x - _loc4_.x) + this.§?!c§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§5!M§.Copy();
            _loc19_ = this.§8!R§.§?!7§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§5!M§.§!'§(_loc19_);
            if(this.§[J§ == b2internal::"!Y)
            {
               this.§5!M§.y = b2Math.§3U§(this.§5!M§.y,0);
            }
            else if(this.§[J§ == b2internal::^!T)
            {
               this.§5!M§.y = b2Math.§]!e§(this.§5!M§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§5!M§.y - _loc18_.y) * this.§8!R§.col2.x;
            if(this.§8!R§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§8!R§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§5!M§.x = _loc21_;
            _loc19_.x = this.§5!M§.x - _loc18_.x;
            _loc19_.y = this.§5!M§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§+N§.x + _loc19_.y * this.§?!c§.x;
            _loc9_ = _loc19_.x * this.§+N§.y + _loc19_.y * this.§?!c§.y;
         ...
         else
         {
            if(this.§8!R§.col1.x != 0)
            {
               _loc22_ = -_loc12_ / this.§8!R§.col1.x;
            }
            else
            {
               _loc22_ = 0;
            ...
            this.§5!M§.x += _loc22_;
            _loc8_ = _loc22_ * this.§+N§.x;
            _loc9_ = _loc22_ * this.§+N§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§;P§)
         {
            ...
            _loc34_ = this.§?!c§.x * _loc26_ + this.§?!c§.y * _loc27_;
            if(b2Math.§]+§(this.§set § - this.§]l§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§^7§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§]+§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§]l§)
            {
               _loc19_ = b2Math.§^7§(_loc34_ - this.§]l§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§]l§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§set §)
            {
               _loc19_ = b2Math.§^7§(_loc34_ - this.§set § + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§set §;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§8!R§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§8!R§.col2.x = this.§8!R§.col1.y;
            this.§8!R§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§8!R§.§?!7§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::2X;
         ...
         var _loc30_:Number = _loc28_.x * this.§+N§.x + _loc28_.y * this.§?!c§.x;
         var _loc31_:Number = _loc28_.x * this.§+N§.y + _loc28_.y * this.§?!c§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::2X * _loc30_;
         _loc6_.y -= b2internal::2X * _loc31_;
         _loc7_ -= b2internal::0H * _loc32_;
         _loc8_.x += b2internal::-S * _loc30_;
         _loc8_.y += b2internal::-S * _loc31_;
