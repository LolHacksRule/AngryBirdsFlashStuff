package §?F§
{
   ...
   public class b2Collision
   {
      ...
      private static var §6H§:b2Vec2 = new b2Vec2();
      ...
      private static var §2C§:b2Vec2 = new b2Vec2();
      ...
      public static function §2!_§(param1:Vector.<§]!&§>, param2:Vector.<§]!&§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§]!&§ = null;
         var _loc6_:int = 0;
      ...
      public static function §,6§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param1.§33§;
         var _loc8_:Vector.<b2Vec2> = param1.§^$§;
         var _loc9_:int = param4.§>Z§;
         var _loc10_:Vector.<b2Vec2> = param4.§33§;
         _loc11_ = param2.R;
      ...
      public static function §^!J§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §,6§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §,6§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §,6§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §,6§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §#!?§(param1:Vector.<§]!&§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc10_:Vector.<b2Vec2> = param5.§33§;
         ...
         _loc20_.id.§`!R§.§?b§ = param4;
         _loc20_.id.§`!R§.§`w§ = _loc21_;
         _loc20_.id.§`!R§.§=!b§ = 0;
         _loc20_ = param1[1];
      ...
      public static function §5!B§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §0!=§[0] = _loc8_;
         var _loc9_:Number = §^!J§(§0!=§,param2,param3,param4,param5);
         _loc8_ = §0!=§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         § 8§[0] = _loc10_;
         var _loc11_:Number = §^!J§(§ 8§,param4,param5,param2,param3);
         _loc10_ = § 8§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§33§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §6H§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         ...
         if((_loc39_ = §2!_§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §2!_§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
      ...
      public static function §5!]§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§2M§ = b2Manifold.§-G§;
         param1.m_localPoint.SetV(param2.§`!a§);
         param1.§4!F§.§;@§();
         param1.§6p§ = 1;
         param1.§1!§[0].m_localPoint.SetV(param4.§`!a§);
         param1.§1!§[0].m_id.key = 0;
      }
      
      public static function §^!U§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc22_:Vector.<b2Vec2> = param2.§33§;
      ...
      public static function §13§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§%o§;
         var _loc4_:b2Vec2 = param1.§4!_§;
