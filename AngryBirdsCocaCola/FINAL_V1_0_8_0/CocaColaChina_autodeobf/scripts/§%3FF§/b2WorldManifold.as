      ...
      public function §2#§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         ...
         switch(param1.§2M§)
         {
            case b2Manifold.§-G§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§1!§[0].m_localPoint;
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§;!V§.x = _loc19_ / _loc26_;
                  this.§;!V§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§;!V§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§;!V§.x;
               _loc23_ = _loc16_ + param3 * this.§;!V§.y;
               _loc24_ = _loc17_ - param5 * this.§;!V§.x;
               _loc25_ = _loc18_ - param5 * this.§;!V§.y;
               this.§1!§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§1!§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§3s§:
               _loc8_ = param2.R;
               _loc7_ = param1.§4!F§;
               ...
               this.§;!V§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§6p§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§1!§[_loc6_].m_localPoint;
                  ...
                  this.§1!§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§1!§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§'!T§:
               ...
               while(_loc6_ < param1.§6p§)
               {
                  ...
                  this.§1!§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§1!§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
