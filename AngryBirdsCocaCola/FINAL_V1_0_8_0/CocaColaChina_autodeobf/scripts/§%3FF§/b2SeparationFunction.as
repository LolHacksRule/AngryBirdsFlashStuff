package §?F§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §2#§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§2M§ = §=!G§;
            _loc7_ = this.§1!>§.§4h§(param1.indexA[0]);
            _loc10_ = this.§%1§.§4h§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§?!c§.x = _loc15_ - _loc13_;
            this.§?!c§.y = _loc16_ - _loc14_;
            this.§?!c§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§2M§ = §3s§;
            _loc8_ = this.§1!>§.§4h§(param1.indexA[0]);
            _loc9_ = this.§1!>§.§4h§(param1.indexA[1]);
            _loc10_ = this.§%1§.§4h§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§?!c§ = b2Math.§,7§(b2Math.§`"§(_loc9_,_loc8_),1);
            this.§?!c§.Normalize();
            _loc20_ = this.§?!c§;
         ...
         {
            this.§2M§ = §'!T§;
            _loc11_ = this.§%1§.§4h§(param1.indexB[0]);
            _loc12_ = this.§%1§.§4h§(param1.indexB[1]);
            _loc7_ = this.§1!>§.§4h§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§?!c§ = b2Math.§,7§(b2Math.§`"§(_loc12_,_loc11_),1);
            this.§?!c§.Normalize();
            _loc20_ = this.§?!c§;
         ...
         else
         {
            ...
            _loc11_ = this.§%1§.§4h§(param1.indexB[0]);
            _loc12_ = this.§%1§.§4h§(param1.indexB[1]);
            _loc23_ = b2Math.§;!P§(param3,_loc7_);
            _loc24_ = b2Math.§#t§(param3.R,b2Math.§`"§(_loc9_,_loc8_));
            _loc25_ = b2Math.§;!P§(param5,_loc10_);
            _loc26_ = b2Math.§#t§(param5.R,b2Math.§`"§(_loc12_,_loc11_));
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§^7§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§^7§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §=!G§:
               _loc3_ = b2Math.§6i§(param1.R,this.§?!c§);
               _loc4_ = b2Math.§6i§(param2.R,this.§?!c§.§4m§());
               _loc5_ = this.§1!>§.§?i§(_loc3_);
               _loc6_ = this.§%1§.§?i§(_loc4_);
               _loc7_ = b2Math.§;!P§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§;!P§(param2,_loc6_)).x - _loc7_.x) * this.§?!c§.x + (_loc8_.y - _loc7_.y) * this.§?!c§.y);
            case §3s§:
               _loc10_ = b2Math.§#t§(param1.R,this.§?!c§);
               _loc7_ = b2Math.§;!P§(param1,this.m_localPoint);
               _loc4_ = b2Math.§6i§(param2.R,_loc10_.§4m§());
               _loc6_ = this.§%1§.§?i§(_loc4_);
               return Number(((_loc8_ = b2Math.§;!P§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §'!T§:
               _loc10_ = b2Math.§#t§(param2.R,this.§?!c§);
               _loc8_ = b2Math.§;!P§(param2,this.m_localPoint);
               _loc3_ = b2Math.§6i§(param1.R,_loc10_.§4m§());
               _loc5_ = this.§1!>§.§?i§(_loc3_);
               return Number(((_loc7_ = b2Math.§;!P§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
