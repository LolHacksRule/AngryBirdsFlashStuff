   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         if(param1 >= 0 && param1 < this.numChildren)
         {
            ...
            _loc3_.dispatchEvent(new Event(Event.§7W§,true));
            if(stage)
            {
      ...
      public function §@!0§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      public function §[!+§(param1:DisplayObject, param2:DisplayObject) : void
      {
         ...
         this.§39§(_loc3_,_loc4_);
      }
      
      public function §39§(param1:int, param2:int) : void
      {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            ...
            §84§(_loc7_,§`!7§);
            transformCoords(§`!7§,_loc3_,_loc4_,§?"§);
