package §68§
{
   ...
   public class §+9§ extends §0_§
   {
      ...
      public function §+9§(param1:XML, param2:§`?§, param3:MovieClip = null)
      {
         this.§>!>§ = new Rectangle();
      ...
      private function startDrag(param1:Event = null) : void
      {
         if(mClip.stage)
         {
            ...
            this.mDragging = true;
            mClip.stage.addEventListener(MouseEvent.MOUSE_MOVE,this.§2!M§);
            mClip.stage.addEventListener(MouseEvent.ROLL_OUT,this.stopDrag);
            mClip.stage.addEventListener(MouseEvent.MOUSE_UP,this.stopDrag);
         }
      }
      
      private function §2!M§(param1:MouseEvent) : void
      {
         this.listenerEventOccured(§@Y§,§6o§[§@Y§]);
      }
      ...
      private function stopDrag(param1:Event = null) : void
      {
         ...
         if(mClip.stage)
         {
            mClip.stage.removeEventListener(MouseEvent.MOUSE_MOVE,this.§2!M§);
            mClip.stage.removeEventListener(MouseEvent.ROLL_OUT,this.stopDrag);
            mClip.stage.removeEventListener(MouseEvent.MOUSE_UP,this.stopDrag);
            this.setComponentVisualState(§4o§.COMPONENT_STATE_ACTIVE_DEFAULT);
         }
         if(this.§'&§)
         {
