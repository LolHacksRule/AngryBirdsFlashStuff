package §48§
{
   ...
   public class §&m§
   {
      ...
      public static function §<>§(param1:XML) : void
      {
         ...
         {
            §5!=§[String(_loc3_.@name)] = _loc3_;
         }
      }
      
      public static function §9!$§(param1:String, param2:§4a§, param3:Boolean = true) : §&!9§.Sprite
      {
         var _loc7_:XML = null;
         var _loc8_:§6!Z§ = null;
         var _loc9_:§,,§ = null;
         ...
         {
            if(_loc8_ = param2.§-o§(_loc7_.@name))
            {
      ...
      public static function §^5§(param1:String, param2:§4a§) : flash.display.Sprite
      {
         var _loc6_:XML = null;
         var _loc7_:§6!Z§ = null;
         ...
         var _loc4_:XML;
         var _loc5_:XMLList = (_loc4_ = §5!=§[param1]).child(§[7§);
         for each(_loc6_ in _loc5_)
         {
            if(_loc7_ = param2.§-o§(_loc6_.@name))
            {
