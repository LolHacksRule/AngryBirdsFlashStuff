package §6V§
{
   public class b2Math
   {
      ...
      public static function §9O§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §6i§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§9O§(param2,param1.col1),§9O§(param2,param1.col2));
      }
      ...
      public static function §5p§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §9!b§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         var _loc3_:Number = param1.x - param2.x;
         var _loc4_:Number = param1.y - param2.y;
      ...
      public static function §=!d§(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§"-§(§5p§(param1.col1,param2.col1),§5p§(param1.col2,param2.col2));
      }
      
      public static function §4q§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
      ...
      {
         var _loc3_:b2Vec2 = new b2Vec2(§9O§(param1.col1,param2.col1),§9O§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§9O§(param1.col1,param2.col2),§9O§(param1.col2,param2.col2));
      ...
      public static function §9e§(param1:b2Mat22) : b2Mat22
      {
      ...
      public static function §3U§(param1:Number, param2:Number) : Number
      {
         return param1 > param2 ? Number(param1) : Number(param2);
      }
      
      public static function §6!O§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§3U§(param1.x,param2.x),§3U§(param1.y,param2.y));
      }
      ...
      public static function §52§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §6!O§(param2,§3^§(param1,param3));
      }
      ...
      public static function § use§(param1:Number, param2:Number) : Number
      {
