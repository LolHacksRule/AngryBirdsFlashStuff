package §6V§
{
   public class b2Vec2
   {
      ...
      public static function §5w§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §6f§(param1:b2Vec2) : void
      {
         this.x -= param1.x;
         this.y -= param1.y;
      }
      ...
      {
         var _loc2_:Number = b2Math.§9O§(this,param1.col1);
         this.y = b2Math.§9O§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      public function §6!O§(param1:b2Vec2) : void
      {
         this.x = this.x > param1.x ? Number(this.x) : Number(param1.x);
         this.y = this.y > param1.y ? Number(this.y) : Number(param1.y);
      }
