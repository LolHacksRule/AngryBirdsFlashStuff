package §6!4§
{
   ...
   public class Texture
   {
      ...
      public static function §+!E§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §6!4§.Texture
      {
         return §=!%§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §=!%§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §6!4§.Texture
      {
         ...
         return new §6!7§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §5!A§(param1:Context3D, param2:ByteArray) : §6!4§.Texture
      {
         if(param1 == null)
         {
            throw new §#!1§();
      ...
      public static function §5!$§(param1:§6!4§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §6!4§.Texture
      {
         var _loc4_:§6!4§.Texture;
         (_loc4_ = new §6!7§(param1,param2)).§ !-§ = param3;
         return _loc4_;
      }
      
      public static function §3§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §6!4§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§6!4§.Texture = §=!%§(param1,_loc6_,false,param5);
         if(!§?y§.§12§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§try§, param2:int, param3:int) : void
      {
         ...
         if(this.§ !-§)
         {
            ...
            param1.§%r§(param2,-this.§ !-§.x,-this.§ !-§.y);
            param1.§%r§(param2 + 1,-_loc4_,-this.§ !-§.y);
            param1.§%r§(param2 + 2,-this.§ !-§.x,-_loc5_);
            param1.§%r§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      ...
      public function get root() : §6!4§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §6!4§.Texture
      {
         return this;
      }
