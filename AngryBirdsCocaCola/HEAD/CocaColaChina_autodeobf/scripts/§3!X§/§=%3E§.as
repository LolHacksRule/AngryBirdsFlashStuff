package §3!X§
{
   ...
   public class §=>§
   {
      ...
      public static function §!+§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §87§(_loc2_);
         return §<!S§.§,!I§(_loc3_.readInt(),true) + §<!S§.§,!I§(_loc3_.readInt(),true) + §<!S§.§,!I§(_loc3_.readInt(),true) + §<!S§.§,!I§(_loc3_.readInt(),true) + §<!S§.§,!I§(_loc3_.readInt(),true);
      }
      
      public static function §!p§(param1:ByteArray) : String
      {
      ...
      private static function §87§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
