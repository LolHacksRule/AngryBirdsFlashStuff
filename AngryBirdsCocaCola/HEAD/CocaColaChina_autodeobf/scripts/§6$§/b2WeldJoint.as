   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§&!X§)
         {
            ...
            this.§7!P§.y *= param1.§@=§;
            this.§7!P§.z *= param1.§@=§;
            _loc4_.§9!Q§.x -= _loc10_ * this.§7!P§.x;
            _loc4_.§9!Q§.y -= _loc10_ * this.§7!P§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§7!P§.y - _loc7_ * this.§7!P§.x + this.§7!P§.z);
            _loc5_.§9!Q§.x += _loc11_ * this.§7!P§.x;
            _loc5_.§9!Q§.y += _loc11_ * this.§7!P§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc19_:Number = b2Math.§5y§(_loc16_);
         if(_loc18_ > _loc17_)
         {
            _loc12_ *= 1;
            _loc13_ *= 1;
