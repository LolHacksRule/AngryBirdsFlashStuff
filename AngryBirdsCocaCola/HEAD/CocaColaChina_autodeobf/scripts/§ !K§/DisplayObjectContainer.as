package § !K§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function §5W§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            ...
            §]`§(_loc7_,§]!!§);
            transformCoords(§]!!§,_loc3_,_loc4_,§2P§);
            if(_loc8_ = _loc7_.hitTest(§2P§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§8Q§(this,param1.type,_loc2_);
      ...
      private function §8Q§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               this.§8Q§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
