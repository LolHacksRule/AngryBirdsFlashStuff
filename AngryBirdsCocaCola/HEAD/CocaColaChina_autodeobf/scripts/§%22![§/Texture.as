package §"![§
{
   ...
   public class Texture
   {
      ...
      public static function §^!1§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §"![§.Texture
      {
         return §@!E§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §@!E§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §"![§.Texture
      {
      ...
      public static function §1!<§(param1:Context3D, param2:ByteArray) : §"![§.Texture
      {
         if(param1 == null)
         {
            throw new §2w§();
      ...
      {
         var _loc4_:§"![§.Texture;
         (_loc4_ = new §,K§(param1,param2)).§^U§ = param3;
         return _loc4_;
      }
      ...
      public static function §[!L§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §"![§.Texture
      {
         ...
         var _loc7_:§"![§.Texture = §@!E§(param1,_loc6_,false,param5);
         if(!§79§.§%!S§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§17§, param2:int, param3:int) : void
      {
         ...
         if(this.§^U§)
         {
            ...
            _loc4_ = this.§^U§.width + this.§^U§.x - this.width;
            _loc5_ = this.§^U§.height + this.§^U§.y - this.height;
            param1.§5!Q§(param2,-this.§^U§.x,-this.§^U§.y);
            param1.§5!Q§(param2 + 1,-_loc4_,-this.§^U§.y);
            param1.§5!Q§(param2 + 2,-this.§^U§.x,-_loc5_);
            param1.§5!Q§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      
      public function get §8W§() : Rectangle
      {
         return !!this.§^U§ ? this.§^U§.clone() : new Rectangle(0,0,this.width,this.height);
      }
