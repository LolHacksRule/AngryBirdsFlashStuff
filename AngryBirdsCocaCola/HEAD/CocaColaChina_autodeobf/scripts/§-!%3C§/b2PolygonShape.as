package §-!<§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      public static function §3!A§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §?S§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         ...
         (_loc5_ = new b2PolygonShape()).§8-§(param1,param2,param3,param4);
         return _loc5_;
      }
      ...
      public static function §1!G§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§9Y§(new b2Vec2(0,0));
            _loc3_.§9Y§(_loc9_);
            _loc3_.§9Y§(_loc10_);
            _loc3_.§?!4§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      public function §=!A§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§-q§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§ <§(this.§+!=§[_loc5_],this.§+!=§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§8L§() > Number.MIN_VALUE);
            this.§-t§[_loc3_].SetV(b2Math.§4K§(_loc6_,1));
            this.§-t§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§+!R§ = §1!G§(this.§+!=§,this.§-q§);
      }
      ...
      public function §8-§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§-q§ = 4;
         this.§1a§(4);
         this.§+!=§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§-q§)
         {
            this.§+!=§[_loc6_] = b2Math.§,!2§(_loc5_,this.§+!=§[_loc6_]);
            this.§-t§[_loc6_] = b2Math.§%§(_loc5_.R,this.§-t§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §!!-§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§+!=§[0].SetV(param1);
         this.§+!=§[1].SetV(param2);
         this.§+!R§.x = 0.5 * (param1.x + param2.x);
         this.§+!R§.y = 0.5 * (param1.y + param2.y);
         this.§-t§[0] = b2Math.§4K§(b2Math.§ <§(param2,param1),1);
         this.§-t§[0].Normalize();
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§#W§.x = _loc5_ - b2internal::=W;
         param1.§#W§.y = _loc6_ - b2internal::=W;
         param1.§3!c§.x = _loc7_ + b2internal::=W;
         param1.§3!c§.y = _loc8_ + b2internal::=W;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         while(_loc10_ < this.§-q§)
         {
            ...
            _loc12_ = _loc10_ + 1 < this.§-q§ ? this.§+!=§[int(_loc10_ + 1)] : this.§+!=§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         {
            _loc7_[_loc12_] = b2Math.§2!+§(_loc5_,this.§+!=§[_loc12_]) - _loc6_;
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§-q§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
      ...
      public function §0N§(param1:b2Vec2) : int
      {
      ...
      private function §1a§(param1:int) : void
      {
