package §=!!§
{
   ...
   public class b2DynamicTree
   {
      ...
      private var §=g§:b2DynamicTreeNode;
      ...
      public function §0L§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
         ...
         _loc3_.aabb.§3!c§.x = param1.§3!c§.x + _loc4_;
         _loc3_.aabb.§3!c§.y = param1.§3!c§.y + _loc5_;
         _loc3_.§6!6§ = param2;
         this.§=0§(_loc3_);
         return _loc3_;
      }
      
      public function §2s§(param1:b2DynamicTreeNode) : void
      {
         this.§&!A§(param1);
         this.§6!F§(param1);
      }
      ...
      public function §#!$§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         var _loc4_:Number = NaN;
         var _loc5_:Number = NaN;
         b2Settings.b2Assert(param1.§return§());
         ...
         param1.aabb.§3!c§.x = param2.§3!c§.x + _loc4_;
         param1.aabb.§3!c§.y = param2.§3!c§.y + _loc5_;
         this.§=0§(param1);
         return true;
      }
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         _loc9_.§3!c§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§3!c§.y = Math.max(_loc3_.y,_loc11_);
         var _loc12_:Vector.<b2DynamicTreeNode> = new Vector.<b2DynamicTreeNode>();
         var _loc13_:int = 0;
         var _loc19_:*;
         _loc12_[_loc19_ = _loc13_++] = this.§7K§;
         while(_loc13_ > 0)
         {
      ...
      private function §=0§(param1:b2DynamicTreeNode) : void
      {
         ...
         var _loc3_:b2DynamicTreeNode = this.§7K§;
         if(_loc3_.§return§() == false)
         {
            do
            {
               _loc6_ = _loc3_.child1;
               _loc7_ = _loc3_.child2;
               _loc8_ = Math.abs((_loc6_.aabb.§#W§.x + _loc6_.aabb.§3!c§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§#W§.y + _loc6_.aabb.§3!c§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§#W§.x + _loc7_.aabb.§3!c§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§#W§.y + _loc7_.aabb.§3!c§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         _loc5_.§6!6§ = null;
         _loc5_.aabb.§'!K§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            {
               _loc4_.aabb.§'!K§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
      ...
      private function §&!A§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc5_ = _loc3_.aabb;
               _loc3_.aabb = b2AABB.§'!K§(_loc3_.child1.aabb,_loc3_.child2.aabb);
