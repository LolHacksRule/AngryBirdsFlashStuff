package §=!!§
{
   ...
   public class b2Collision
   {
      ...
      public static function §'!]§(param1:Vector.<§+!S§>, param2:Vector.<§+!S§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§+!S§ = null;
         var _loc6_:int = 0;
      ...
      public static function § p§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§-q§;
         var _loc7_:Vector.<b2Vec2> = param1.§+!=§;
         var _loc8_:Vector.<b2Vec2> = param1.§-t§;
         var _loc9_:int = param4.§-q§;
      ...
      public static function §>l§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = § p§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = § p§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = § p§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = § p§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §[!F§(param1:Vector.<§+!S§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§+!S§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§-q§;
         var _loc8_:Vector.<b2Vec2> = param2.§-t§;
         var _loc9_:int = param5.§-q§;
         ...
         _loc20_.id.§"!1§.§^L§ = param4;
         _loc20_.id.§"!1§.§4!!§ = _loc21_;
         _loc20_.id.§"!1§.§@@§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§"!1§.§^L§ = param4;
         _loc20_.id.§"!1§.§4!!§ = _loc22_;
         _loc20_.id.§"!1§.§@@§ = 1;
      }
      
      private static function §&![§() : Vector.<§+!S§>
      {
      ...
      public static function §8E§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§+!S§ = null;
         ...
         var _loc8_:int = 0;
         §!!!§[0] = _loc8_;
         var _loc9_:Number = §>l§(§!!!§,param2,param3,param4,param5);
         _loc8_ = §!!!§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §9&§[0] = _loc10_;
         var _loc11_:Number = §>l§(§9&§,param4,param5,param2,param3);
         _loc10_ = §9&§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§+!S§> = §'!+§;
         §[!F§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§-q§;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §8§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §7l§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §+!N§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §-!K§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§+!S§> = s_clipPoints1;
         var _loc38_:Vector.<§+!S§> = s_clipPoints2;
      ...
      public static function §<!b§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§!L§.§`§();
         param1.§#!H§ = 1;
         param1.§7i§[0].m_localPoint.SetV(param4.§<[§);
         param1.§7i§[0].m_id.key = 0;
      }
      ...
      public static function §>!F§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§#!H§ = 1;
            param1.§'!c§ = b2Manifold.§5!J§;
            param1.§!L§.x = _loc15_ - _loc27_.x;
            param1.§!L§.y = _loc16_ - _loc27_.y;
            param1.§!L§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§#!H§ = 1;
            param1.§'!c§ = b2Manifold.§5!J§;
            param1.§!L§.x = _loc15_ - _loc28_.x;
            param1.§!L§.y = _loc16_ - _loc28_.y;
            param1.§!L§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§7i§[0].m_localPoint.SetV(param4.§<[§);
            param1.§7i§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§#!H§ = 1;
            param1.§'!c§ = b2Manifold.§5!J§;
            param1.§!L§.x = _loc23_[_loc25_].x;
            param1.§!L§.y = _loc23_[_loc25_].y;
            param1.§!L§.Normalize();
