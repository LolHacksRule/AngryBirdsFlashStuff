package §?r§
{
   ...
   public class §^n§
   {
      ...
      public static const §`v§:String = "easeInBack";
      
      public static const §7a§:String = "easeOutBack";
      ...
      public static const §2!E§:String = "easeInOutElastic";
      ...
      public static const §break§:String = "easeInOutBounce";
      ...
      private static function §-&§() : void
      {
         ...
         §?@§(§;!$§,easeInElastic);
         §?@§(§&<§,easeOutElastic);
         §?@§(§2!E§,easeInOutElastic);
         §?@§(§,#§,easeOutInElastic);
         §?@§(§?Y§,easeInBounce);
         §?@§(§`+§,easeOutBounce);
         §?@§(§break§,easeInOutBounce);
         §?@§(§1g§,easeOutInBounce);
      }
