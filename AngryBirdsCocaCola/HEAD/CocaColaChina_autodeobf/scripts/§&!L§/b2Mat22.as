package §&!L§
{
   public class b2Mat22
   {
      ...
      public static function §3T§(param1:Number) : b2Mat22
      {
      ...
      public static function § R§(param1:b2Vec2, param2:b2Vec2) : b2Mat22
      {
      ...
      public function §1!J§(param1:b2Mat22) : void
      {
      ...
      public function §9#§(param1:b2Mat22) : b2Mat22
      {
      ...
      public function §#m§(param1:b2Vec2, param2:Number, param3:Number) : b2Vec2
      {
