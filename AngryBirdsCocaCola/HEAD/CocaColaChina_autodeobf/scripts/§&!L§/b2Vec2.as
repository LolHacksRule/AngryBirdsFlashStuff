package §&!L§
{
   public class b2Vec2
   {
      ...
      public function §9Y§(param1:b2Vec2) : void
      {
         this.x += param1.x;
         this.y += param1.y;
      }
      ...
      public function §9U§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§2!+§(this,param1.col1);
      ...
      public function §0p§(param1:b2Vec2) : void
      {
      ...
      {
         return b2Math.§@W§(this.x) && b2Math.§@W§(this.y);
      }
   }
}
