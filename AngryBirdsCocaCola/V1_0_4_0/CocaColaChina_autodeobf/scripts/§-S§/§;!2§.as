package §-S§
{
   ...
   public class §;!2§ extends §@,§
   {
      ...
      private static function §@!B§(param1:§7O§, param2:int, param3:int) : void
      {
         if(param1.§"0§.top < 0)
         {
            param1.§"0§.top = 0;
