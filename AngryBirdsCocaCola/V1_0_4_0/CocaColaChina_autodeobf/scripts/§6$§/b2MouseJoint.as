package §6$§
{
   ...
   public class b2MouseJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§,!D§ = param1.§"p§ * (_loc5_ + param1.§"p§ * _loc6_);
         this.§,!D§ = this.§,!D§ != 0 ? Number(1 / this.§,!D§) : Number(0);
         this.§<!"§ = param1.§"p§ * _loc6_ * this.§,!D§;
         ...
         this.§"!2§.§+!<§(this.K1);
         this.§"!2§.§1!J§(this.K2);
         this.§"!2§.col1.x += this.§,!D§;
         this.§"!2§.col2.y += this.§,!D§;
         this.§"!2§.§9#§(this.§ !4§);
         ...
         this.§7!P§.x *= param1.§@=§;
         this.§7!P§.y *= param1.§@=§;
         _loc2_.§9!Q§.x += _loc11_ * this.§7!P§.x;
         _loc2_.§9!Q§.y += _loc11_ * this.§7!P§.y;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc6_ = _loc4_;
         var _loc8_:Number = _loc2_.§9!Q§.x + -_loc2_.m_angularVelocity * _loc7_;
         var _loc9_:Number = _loc2_.§9!Q§.y + _loc2_.m_angularVelocity * _loc6_;
         _loc3_ = this.§ !4§;
         ...
         this.§7!P§.x += _loc10_;
         this.§7!P§.y += _loc11_;
         var _loc14_:Number = param1.§"p§ * this.§=!O§;
         if(this.§7!P§.§8L§() > _loc14_ * _loc14_)
         {
            this.§7!P§.§?!4§(_loc14_ / this.§7!P§.§=!I§());
         }
         _loc10_ = this.§7!P§.x - _loc12_;
         _loc11_ = this.§7!P§.y - _loc13_;
         _loc2_.§9!Q§.x += _loc2_.§3!`§ * _loc10_;
         _loc2_.§9!Q§.y += _loc2_.§3!`§ * _loc11_;
         _loc2_.m_angularVelocity += _loc2_.§=4§ * (_loc6_ * _loc11_ - _loc7_ * _loc10_);
      }
