   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§`!&§ && this.§,!L§ != b2internal::5!<)
         {
            ...
            _loc16_ = this.§"h§;
            _loc17_ = param1.§"p§ * this.§>g§;
            this.§"h§ = b2Math.§2m§(this.§"h§ + _loc15_,-_loc17_,_loc17_);
         ...
         if(this.§6Q§ && this.§,!L§ != b2internal::]m)
         {
            ...
            if(this.§,!L§ == b2internal::``)
            {
               this.§7!P§.z = b2Math.§ m§(this.§7!P§.z,0);
            }
            else if(this.§,!L§ == b2internal::=A)
            {
               this.§7!P§.z = b2Math.§9h§(this.§7!P§.z,0);
            }
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§6Q§)
         {
            ...
            if(b2Math.§5y§(this.§"!c§ - this.§[!S§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§2m§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§5y§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§[!S§)
            {
               _loc19_ = b2Math.§2m§(_loc35_ - this.§[!S§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§[!S§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§"!c§)
            {
               _loc19_ = b2Math.§2m§(_loc35_ - this.§"!c§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
