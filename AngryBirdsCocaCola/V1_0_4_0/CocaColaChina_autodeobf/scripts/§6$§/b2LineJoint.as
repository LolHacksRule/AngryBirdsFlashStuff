package §6$§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§7!P§.x * this.§8,§.x + (this.§"h§ + this.§7!P§.y) * this.§`R§.x),param1 * (this.§7!P§.x * this.§8,§.y + (this.§"h§ + this.§7!P§.y) * this.§`R§.y));
      }
      ...
      public function §"1§() : Number
      {
         ...
         var _loc8_:b2Vec2;
         return Number((_loc8_ = _loc1_.§%x§(this.§3N§)).x * _loc6_ + _loc8_.y * _loc7_);
      }
      ...
      public function §!!7§() : Number
      {
         ...
         var _loc15_:b2Vec2 = _loc1_.§%x§(this.§3N§);
         var _loc16_:b2Vec2 = _loc1_.§9!Q§;
         var _loc17_:b2Vec2 = _loc2_.§9!Q§;
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         b2internal::5!W.SetV(_loc2_.§#!!§());
         b2internal::!!N.SetV(_loc3_.§#!!§());
         ...
         §%!K§ = _loc2_.§=4§;
         §82§ = _loc3_.§=4§;
         this.§`R§.SetV(b2Math.§%§(_loc6_.R,this.§3N§));
         ...
         this.§4!T§ = this.§4!T§ > Number.MIN_VALUE ? Number(1 / this.§4!T§) : Number(0);
         this.§8,§.SetV(b2Math.§%§(_loc6_.R,this.§8!§));
         ...
         if(this.§6Q§)
         {
            ...
            if(b2Math.§5y§(this.§"!c§ - this.§[!S§) < 2 * b2Settings.b2_linearSlop)
            {
               this.§,!L§ = b2internal::5!<;
            }
         ...
         if(param1.§&!X§)
         {
            ...
            this.§7!P§.y *= param1.§@=§;
            this.§"h§ *= param1.§@=§;
            _loc19_ = this.§7!P§.x * this.§8,§.x + (this.§"h§ + this.§7!P§.y) * this.§`R§.x;
            _loc20_ = this.§7!P§.x * this.§8,§.y + (this.§"h§ + this.§7!P§.y) * this.§`R§.y;
            _loc21_ = this.§7!P§.x * this.m_s1 + (this.§"h§ + this.§7!P§.y) * this.m_a1;
            _loc22_ = this.§7!P§.x * this.m_s2 + (this.§"h§ + this.§7!P§.y) * this.m_a2;
            _loc2_.§9!Q§.x -= b2internal::9R * _loc19_;
            _loc2_.§9!Q§.y -= b2internal::9R * _loc20_;
            _loc2_.m_angularVelocity -= b2internal::%!K * _loc21_;
            _loc3_.§9!Q§.x += b2internal::'o * _loc19_;
            _loc3_.§9!Q§.y += b2internal::'o * _loc20_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc2_:b2Body = b2internal::2!I;
         var _loc3_:b2Body = b2internal::%!#;
         var _loc4_:b2Vec2 = _loc2_.§9!Q§;
         var _loc5_:Number = _loc2_.m_angularVelocity;
         var _loc6_:b2Vec2 = _loc3_.§9!Q§;
         ...
         if(this.§`!&§ && this.§,!L§ != b2internal::5!<)
         {
            ...
            _loc14_ = this.§4!T§ * (this.§^!R§ - _loc13_);
            _loc15_ = this.§"h§;
            _loc16_ = param1.§"p§ * this.§>g§;
            this.§"h§ = b2Math.§2m§(this.§"h§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§"h§ - _loc15_) * this.§`R§.x;
         ...
         if(this.§6Q§ && this.§,!L§ != b2internal::]m)
         {
            ...
            _loc18_ = this.§7!P§.Copy();
            _loc19_ = this.§^!H§.§#m§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§7!P§.§9Y§(_loc19_);
            if(this.§,!L§ == b2internal::``)
            {
               this.§7!P§.y = b2Math.§ m§(this.§7!P§.y,0);
            }
            else if(this.§,!L§ == b2internal::=A)
            {
               this.§7!P§.y = b2Math.§9h§(this.§7!P§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§7!P§.y - _loc18_.y) * this.§^!H§.col2.x;
            if(this.§^!H§.col1.x != 0)
            {
            ...
            this.§7!P§.x = _loc21_;
            _loc19_.x = this.§7!P§.x - _loc18_.x;
            _loc19_.y = this.§7!P§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§8,§.x + _loc19_.y * this.§`R§.x;
            _loc9_ = _loc19_.x * this.§8,§.y + _loc19_.y * this.§`R§.y;
         ...
         _loc2_.§9!Q§.SetV(_loc4_);
         _loc2_.m_angularVelocity = _loc5_;
         _loc3_.§9!Q§.SetV(_loc6_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc20_:b2Mat22 = b2Mat22.§3T§(_loc7_);
         var _loc21_:b2Mat22 = b2Mat22.§3T§(_loc9_);
         _loc10_ = _loc20_;
         ...
         if(this.§6Q§)
         {
            ...
            if(b2Math.§5y§(this.§"!c§ - this.§[!S§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§2m§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§5y§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§[!S§)
            {
               _loc19_ = b2Math.§2m§(_loc34_ - this.§[!S§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§[!S§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§"!c§)
            {
               _loc19_ = b2Math.§2m§(_loc34_ - this.§"!c§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§"!c§;
               _loc18_ = true;
            }
         }
         this.§8,§ = b2Math.§%§(_loc20_,this.§8!§);
         ...
         _loc16_ = b2Math.§ m§(_loc16_,b2Math.§5y§(_loc29_));
         _loc17_ = 0;
         if(_loc18_)
         {
            ...
            this.§^!H§.§#m§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::9R;
         ...
         var _loc30_:Number = _loc28_.x * this.§8,§.x + _loc28_.y * this.§`R§.x;
         var _loc31_:Number = _loc28_.x * this.§8,§.y + _loc28_.y * this.§`R§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::9R * _loc30_;
         _loc6_.y -= b2internal::9R * _loc31_;
         _loc7_ -= b2internal::%!K * _loc32_;
         _loc8_.x += b2internal::'o * _loc30_;
         _loc8_.y += b2internal::'o * _loc31_;
         _loc9_ += b2internal::82 * _loc33_;
