package §&!L§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§ R§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §@W§(param1:Number) : Boolean
      {
      ...
      public static function §4K§(param1:b2Vec2, param2:Number) : b2Vec2
      {
      ...
      public static function §9!6§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      {
         return b2Mat22.§ R§(§>W§(param1.col1,param2.col1),§>W§(param1.col2,param2.col2));
      }
      
      public static function §-8§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§ R§(§%§(param1,param2.col1),§%§(param1,param2.col2));
      }
      ...
      public static function §&b§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         ...
         return b2Mat22.§ R§(_loc3_,_loc4_);
      }
      
      public static function §5y§(param1:Number) : Number
      {
      ...
      {
         return new b2Vec2(§5y§(param1.x),§5y§(param1.y));
      }
      
      public static function § !1§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§ R§(§[!-§(param1.col1),§[!-§(param1.col2));
      }
      ...
      public static function §0p§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§9h§(param1.x,param2.x),§9h§(param1.y,param2.y));
      }
      ...
      public static function §2m§(param1:Number, param2:Number, param3:Number) : Number
      {
         return param1 < param2 ? Number(param2) : (param1 > param3 ? Number(param3) : Number(param1));
      }
      
      public static function §@h§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §=?§(param2,§0p§(param1,param3));
      }
      ...
      public static function §4!R§() : Number
      {
      ...
      public static function §1e§(param1:uint) : uint
      {
