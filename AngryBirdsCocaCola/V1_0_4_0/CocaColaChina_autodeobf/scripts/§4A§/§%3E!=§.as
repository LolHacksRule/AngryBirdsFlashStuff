package §4A§
{
   ...
   public class §>!=§
   {
      ...
      public function §>!=§(param1:§3m§, param2:Sprite, param3:String, param4:Number, param5:Number)
      {
         super();
         this.§"@§ = param1;
         this.§]!+§ = param2;
         this.mName = param3;
         this.§+=§ = §[!P§.§!I§(this.mName).§^c§;
         this.§03§ = param4;
         this.§5,§ = param5;
         this.§8&§ = param4;
         this.§-A§ = param5;
      ...
      public function §^!N§(param1:Number) : void
      {
         ...
         if(!this.§,P§ && this.§;!5§ >= 0)
         {
            if(this.§%I§ > this.§"@§.mLevelMain.§@I§.§>R§)
            {
               this.§2A§(this.§"@§.mLevelMain.§@I§.§>R§ - this.§%I§);
               this.§;!5§ = -1;
            }
            this.§;!5§ -= param1;
            if(this.§;!5§ <= 0)
            {
               ...
               if(!isNaN(this.§%I§))
               {
                  _loc2_ = this.§"@§.mLevelMain.objects.§'!b§(this.§03§,this.§%I§);
               }
               if(_loc2_ < 0)
               {
      ...
      public function §2A§(param1:Number) : Boolean
      {
         ...
         if(this.§%I§ > this.§"@§.mLevelMain.§@I§.§>R§)
         {
            param1 = this.§%I§ - this.§"@§.mLevelMain.§@I§.§>R§;
            this.§5,§ -= param1;
            this.§%I§ -= param1;
            this.§]Z§();
            return true;
      ...
      {
         var _loc1_:§!!U§ = §[!P§.§!I§(this.mName).shape;
         if(_loc1_.§;N§() == §!!U§.§<7§)
         {
            this.§3g§ = _loc1_.§@!!§()[0];
            this.§7!#§ = _loc1_.§3§;
         }
         else if(_loc1_.§;N§() == §!!U§.§1r§)
         {
            this.§3g§ = new b2Vec2(0,0);
            this.§7!#§ = 1.5;
         }
         this.§2!F§ = this.§"@§.mLevelMain.§0!+§.§ !Z§(this.mName);
         if(!this.§2!F§)
         {
            this.§>!,§(null);
         }
      ...
      public function §>!,§(param1:§"#§) : void
      {
         ...
         if(!param1)
         {
            _loc2_ = this.§"@§.§-e§.textureManager.§`j§();
         }
         else
         {
         ...
         if(this.§6!0§ > 0)
         {
            ...
            else
            {
               ...
               else
               {
                  ...
                  _loc3_ = § !7§.§,;§(_loc3_,false);
                  this.§`S§ = this.§0X§ + _loc3_ * -this.§0X§;
               }
               this.§1Q§ = 360 * § !7§.§,;§((this.§<!§ - this.§6!0§) / this.§<!§) * this.§"r§;
            }
            this.§]Z§();
         }
