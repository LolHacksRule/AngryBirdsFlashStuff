package §<l§
{
   ...
   public class b2PolyAndCircleContact extends b2Contact
   {
      ...
      public function §0c§(param1:b2Fixture, param2:b2Fixture) : void
      {
         ...
         b2Settings.b2Assert(param2.§6`§() == b2Shape.§6!>§);
      }
      ...
      override b2internal function Evaluate() : void
      {
         ...
         b2Collision.§>!F§(b2internal::;y,b2internal::^v.GetShape() as b2PolygonShape,_loc1_.m_xf,b2internal::>!D.GetShape() as b2CircleShape,_loc2_.m_xf);
      }
   }
}
