package §6$§
{
   ...
   public class b2DistanceJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc13_:Number = _loc4_.§0,§ + _loc4_.§'!=§ * _loc11_ * _loc11_ + _loc5_.§0,§ + _loc5_.§'!=§ * _loc12_ * _loc12_;
         ...
         if(this.§&k§ > 0)
         {
            ...
            this.§,!D§ = param1.§5!+§ * (_loc16_ + param1.§5!+§ * _loc17_);
            this.§,!D§ = this.§,!D§ != 0 ? Number(1 / this.§,!D§) : Number(0);
            this.§2Y§ = _loc14_ * param1.§5!+§ * _loc17_ * this.§,!D§;
         ...
         if(param1.§9!3§)
         {
            ...
            _loc4_.§3s§.x -= _loc4_.§0,§ * _loc18_;
            _loc4_.§3s§.y -= _loc4_.§0,§ * _loc19_;
            _loc4_.m_angularVelocity -= _loc4_.§'!=§ * (_loc6_ * _loc19_ - _loc7_ * _loc18_);
            _loc5_.§3s§.x += _loc5_.§0,§ * _loc18_;
            _loc5_.§3s§.y += _loc5_.§0,§ * _loc19_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = _loc2_.col1.y * _loc8_ + _loc2_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         var _loc10_:Number = _loc3_.§3s§.x + -_loc3_.m_angularVelocity * _loc6_;
         var _loc11_:Number = _loc3_.§3s§.y + _loc3_.m_angularVelocity * _loc5_;
         var _loc12_:Number = _loc4_.§3s§.x + -_loc4_.m_angularVelocity * _loc9_;
         var _loc13_:Number = _loc4_.§3s§.y + _loc4_.m_angularVelocity * _loc8_;
         ...
         _loc4_.§3s§.x += _loc4_.§0,§ * _loc16_;
         _loc4_.§3s§.y += _loc4_.§0,§ * _loc17_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         _loc4_.m_sweep.c.x += _loc4_.§0,§ * _loc15_;
         _loc4_.m_sweep.c.y += _loc4_.§0,§ * _loc16_;
         _loc4_.m_sweep.a += _loc4_.§'!=§ * (_loc8_ * _loc16_ - _loc9_ * _loc15_);
         _loc3_.§4!O§();
         _loc4_.§4!O§();
         return b2Math.§?!4§(_loc13_) < b2Settings.b2_linearSlop;
      }
   }
}
