package §#-§
{
   ...
   public class §1!D§
   {
      ...
      public function §1!D§(param1:*)
      {
         super();
         this.§8t§ = this.§01§(param1);
      }
      ...
      private function §01§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§3!b§(param1 as String);
         }
         if(param1 is Number)
         {
      ...
      private function §3!b§(param1:String) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§3!b§(v.@name.toString()) + ":" + this.§01§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
