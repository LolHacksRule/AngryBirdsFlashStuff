package §@o§
{
   ...
   public class §]t§ extends EventDispatcher
   {
      ...
      {
         return §2&§.§4`§(param1,param2 != -1 ? int(param2) : int(this.§=o§(param1)));
      }
      
      public function §%!V§(param1:§0x§) : int
      {
      ...
      public function §=5§(param1:§0x§) : int
      {
         var _loc3_:String = null;
         var _loc2_:int = 0;
         for each(_loc3_ in param1.§+O§())
      ...
      public function §6v§(param1:§0x§) : int
      {
         return param1.§+O§().length * 3;
      }
      
      public function §=<§(param1:§0x§) : int
      {
         return param1.§+O§().length;
      }
      
      public function §7R§(param1:§0x§) : int
      {
         var _loc3_:String = null;
         var _loc2_:int = 0;
         for each(_loc3_ in param1.§+O§())
      ...
      public function §%3§(param1:String) : Boolean
      {
         ...
         if(_loc2_.length == 2)
         {
            ...
            if((_loc6_ = §2&§.§%1§(param1)).pageIndexes[0] == _loc4_ && _loc5_ == 1)
            {
               return true;
            }
            if(_loc5_ > 1)
