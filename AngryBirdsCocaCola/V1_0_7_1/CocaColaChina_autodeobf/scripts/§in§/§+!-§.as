package §in§
{
   ...
   public class §+!-§ extends §-!L§
   {
      ...
      {
         super(param3);
         this.§6_§(param1,param2);
      }
      
      protected function §6_§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc16_:§3!+§ = null;
         var _loc3_:Dictionary = this.§1h§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§@!B§(_loc7_,_loc6_)]) == null)
            {
               ...
               {
                  _loc10_ = new §6b§(0,0,_loc11_,_loc12_,_loc13_,_loc14_);
               }
            }
            if(_loc10_)
            {
      ...
      private function §1h§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§@!B§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §6b§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
