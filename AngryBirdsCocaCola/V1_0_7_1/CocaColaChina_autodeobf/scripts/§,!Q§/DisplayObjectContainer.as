package §,!Q§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function § w§(param1:DisplayObject, param2:DisplayObject) : void
      {
         var _loc3_:int = this.getChildIndex(param1);
         ...
         this.§7M§(_loc3_,_loc4_);
      }
      
      public function §7M§(param1:int, param2:int) : void
      {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            ...
            § !K§(_loc7_,§,!J§);
            transformCoords(§,!J§,_loc3_,_loc4_,§5W§);
            if(_loc8_ = _loc7_.hitTest(§5W§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
