package § Y§
{
   ...
   public class b2Collision
   {
      ...
      private static var §&![§:Vector.<§>!F§> = §[!F§();
      
      private static var s_clipPoints1:Vector.<§>!F§> = §[!F§();
      
      private static var s_clipPoints2:Vector.<§>!F§> = §[!F§();
      ...
      private static var §7l§:b2Vec2 = new b2Vec2();
      ...
      public static function §return§(param1:Vector.<§>!F§>, param2:Vector.<§>!F§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§>!F§ = null;
         var _loc6_:int = 0;
      ...
      public static function §'!]§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc6_:int = param1.§'u§;
         var _loc7_:Vector.<b2Vec2> = param1.§>!5§;
         var _loc8_:Vector.<b2Vec2> = param1.§0N§;
         var _loc9_:int = param4.§'u§;
         var _loc10_:Vector.<b2Vec2> = param4.§>!5§;
         _loc11_ = param2.R;
      ...
      public static function § p§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§'u§;
         var _loc7_:Vector.<b2Vec2> = param2.§0N§;
         _loc9_ = param5.R;
         _loc8_ = param4.§"b§;
      ...
      public static function §>l§(param1:Vector.<§>!F§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§>!F§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§'u§;
         var _loc8_:Vector.<b2Vec2> = param2.§0N§;
         var _loc9_:int = param5.§'u§;
         var _loc10_:Vector.<b2Vec2> = param5.§>!5§;
         var _loc11_:Vector.<b2Vec2> = param5.§0N§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§`1§.§]_§ = param4;
         _loc20_.id.§`1§.§`!P§ = _loc21_;
         _loc20_.id.§`1§.§2!4§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§`1§.§]_§ = param4;
         _loc20_.id.§`1§.§`!P§ = _loc22_;
         _loc20_.id.§`1§.§2!4§ = 1;
      }
      
      private static function §[!F§() : Vector.<§>!F§>
      {
         var _loc1_:Vector.<§>!F§> = new Vector.<§>!F§>(2);
         _loc1_[0] = new §>!F§();
         _loc1_[1] = new §>!F§();
         return _loc1_;
      }
      ...
      public static function §-!K§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         param1.§!L§ = 0;
         var _loc7_:Number = param2.§2B§ + param4.§2B§;
         var _loc8_:int = 0;
         §'!+§[0] = _loc8_;
         var _loc9_:Number = § p§(§'!+§,param2,param3,param4,param5);
         _loc8_ = §'!+§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §!!!§[0] = _loc10_;
         var _loc11_:Number = § p§(§!!!§,param4,param5,param2,param3);
         _loc10_ = §!!!§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§'!c§ = b2Manifold.§5N§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§>!F§> = §&![§;
         §>l§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§'u§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§>!5§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §9&§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §8§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §7l§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §&!d§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§>!F§> = s_clipPoints1;
         var _loc38_:Vector.<§>!F§> = s_clipPoints2;
         if((_loc39_ = §return§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §return§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§"!§.SetV(_loc27_);
      ...
      public static function §8E§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§2B§ + param4.§2B§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§'!c§ = b2Manifold.§#!H§;
         param1.m_localPoint.SetV(param2.§1!G§);
         param1.§"!§.§`§();
         param1.§!L§ = 1;
         param1.§>!B§[0].m_localPoint.SetV(param4.§1!G§);
         param1.§>!B§[0].m_id.key = 0;
      }
      
      public static function §<!b§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§2B§ + param4.§2B§;
         var _loc21_:int = param2.§'u§;
         var _loc22_:Vector.<b2Vec2> = param2.§>!5§;
         var _loc23_:Vector.<b2Vec2> = param2.§0N§;
         var _loc24_:int = 0;
