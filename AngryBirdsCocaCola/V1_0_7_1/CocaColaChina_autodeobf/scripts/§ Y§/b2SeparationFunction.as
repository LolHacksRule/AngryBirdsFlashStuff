package § Y§
{
   ...
   class b2SeparationFunction
   {
      ...
      public var §7U§:b2DistanceProxy;
      
      public var §9z§:b2DistanceProxy;
      ...
      public function §,?§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§'!c§ = §^!"§;
            _loc7_ = this.§7U§.§4c§(param1.indexA[0]);
            _loc10_ = this.§9z§.§4c§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§'!c§ = §5N§;
            _loc8_ = this.§7U§.§4c§(param1.indexA[0]);
            _loc9_ = this.§7U§.§4c§(param1.indexA[1]);
            _loc10_ = this.§9z§.§4c§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§`R§ = b2Math.§6H§(b2Math.§2!+§(_loc9_,_loc8_),1);
            this.§`R§.Normalize();
            _loc20_ = this.§`R§;
         ...
         {
            this.§'!c§ = §5!J§;
            _loc11_ = this.§9z§.§4c§(param1.indexB[0]);
            _loc12_ = this.§9z§.§4c§(param1.indexB[1]);
            _loc7_ = this.§7U§.§4c§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§`R§ = b2Math.§6H§(b2Math.§2!+§(_loc12_,_loc11_),1);
            this.§`R§.Normalize();
            _loc20_ = this.§`R§;
         ...
         else
         {
            ...
            _loc11_ = this.§9z§.§4c§(param1.indexB[0]);
            _loc12_ = this.§9z§.§4c§(param1.indexB[1]);
            _loc23_ = b2Math.§8L§(param3,_loc7_);
            _loc24_ = b2Math.§5y§(param3.R,b2Math.§2!+§(_loc9_,_loc8_));
            _loc25_ = b2Math.§8L§(param5,_loc10_);
            _loc26_ = b2Math.§5y§(param5.R,b2Math.§2!+§(_loc12_,_loc11_));
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§>!M§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§>!M§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §^!"§:
               _loc3_ = b2Math.§=!I§(param1.R,this.§`R§);
               _loc4_ = b2Math.§=!I§(param2.R,this.§`R§.§`@§());
               _loc5_ = this.§7U§.§8-§(_loc3_);
               _loc6_ = this.§9z§.§8-§(_loc4_);
               _loc7_ = b2Math.§8L§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§8L§(param2,_loc6_)).x - _loc7_.x) * this.§`R§.x + (_loc8_.y - _loc7_.y) * this.§`R§.y);
            case §5N§:
               _loc10_ = b2Math.§5y§(param1.R,this.§`R§);
               _loc7_ = b2Math.§8L§(param1,this.m_localPoint);
               _loc4_ = b2Math.§=!I§(param2.R,_loc10_.§`@§());
               _loc6_ = this.§9z§.§8-§(_loc4_);
               return Number(((_loc8_ = b2Math.§8L§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §5!J§:
               _loc10_ = b2Math.§5y§(param2.R,this.§`R§);
               _loc8_ = b2Math.§8L§(param2,this.m_localPoint);
               _loc3_ = b2Math.§=!I§(param1.R,_loc10_.§`@§());
               _loc5_ = this.§7U§.§8-§(_loc3_);
               return Number(((_loc7_ = b2Math.§8L§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
