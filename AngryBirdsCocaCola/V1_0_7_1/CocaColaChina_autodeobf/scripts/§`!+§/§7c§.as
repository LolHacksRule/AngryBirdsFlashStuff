   ...
   public class §7c§ extends §!!9§
   {
      ...
      public function §=h§(param1:int, param2:Boolean = false) : void
      {
         ...
         else if(param1 == LEVEL_STATE_VICTORY1_SLINGSHOT)
         {
            ...
            §7I§.playSound("LevelCompletedBirdsMilitary" + (1 + int(Math.random() * 2)));
         }
         else if(param1 == §@0§)
         {
            §7I§.§1!F§();
            §7I§.playSound("LevelFailedPigs1");
            this.§57§ = 1200;
            mLevelMain.camera.goToCastleView();
      ...
      {
         return mLevelMain.slingshot.mSlingShotState == §,!^§.§,B§ && !mLevelMain.objects.hasBirds();
      }
      ...
      public function §6!,§(param1:Number) : void
      {
         ...
         {
            if(!(_loc4_ = mLevelMain.activeObject) || _loc4_.§ b§ < _loc4_.§&=§)
            {
               if(_loc4_ && _loc4_ is §]A§ && (!(_loc4_ as §&]§).§<n§ || _loc4_.getSpecialAnimationProgress() >= 0))
               {
                  this.§9!$§ = true;
                  this.§=h§(§?!+§);
               }
      ...
      {
         if(!this.§6l§ || !mLevelMain.mReadyToRun)
         {
            return;
         }
      ...
      override public function getEagleScore() : int
      {
         ...
         var _loc1_:Number = §2&§.§<t§(§2&§.§86§).getEagleScore();
