package §@M§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §try §:b2WorldManifold = new b2WorldManifold();
      
      private static var §"y§:b2PositionSolverManifold = new b2PositionSolverManifold();
       
      
      private var §31§:b2TimeStep;
      ...
      {
         this.§31§ = new b2TimeStep();
         this.§^Y§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §4$§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§2!Q§ = param4;
         this.§7[§ = param3;
         while(this.§^Y§.length < this.§7[§)
         {
            this.§^Y§[this.§^Y§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§'M§;
            _loc10_ = _loc5_.§=!A§;
            _loc11_ = _loc9_.§,[§;
            _loc12_ = _loc10_.§,[§;
            _loc13_ = _loc11_.§[8§;
            ...
            _loc17_ = _loc5_.§@,§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§!O§(),_loc10_.§!O§());
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§>!B§(),_loc10_.§>!B§());
            _loc20_ = _loc15_.§,!@§.x;
            _loc21_ = _loc15_.§,!@§.y;
            _loc22_ = _loc16_.§,!@§.x;
            _loc23_ = _loc16_.§,!@§.y;
            ...
            b2Settings.b2Assert(_loc17_.§!!_§ > 0);
            §try §.§4$§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §try §.§;^§.x;
            _loc27_ = §try §.§;^§.y;
            (_loc28_ = this.§^Y§[_loc6_]).§]!M§ = _loc15_;
            _loc28_.§'!Q§ = _loc16_;
            _loc28_.§9W§ = _loc17_;
            ...
            _loc28_.§case §.x = _loc17_.§^!!§.x;
            _loc28_.§case §.y = _loc17_.§^!!§.y;
            ...
            while(_loc29_ < _loc28_.§[>§)
            {
               ...
               (_loc31_ = _loc28_.§>!-§[_loc29_]).normalImpulse = _loc30_.§%z§;
               _loc31_.tangentImpulse = _loc30_.§+!<§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§5!5§.x = §try §.§9;§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§5!5§.y = §try §.§9;§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§!B§.x = §try §.§9;§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§!B§.y = §try §.§9;§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§1!G§ + _loc16_.§1!G§ + _loc15_.§+$§ * _loc36_ + _loc16_.§+$§ * _loc37_;
               _loc31_.§ V§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§9^§ * _loc15_.§1!G§ + _loc16_.§9^§ * _loc16_.§1!G§) + (_loc15_.§9^§ * _loc15_.§+$§ * _loc36_ + _loc16_.§9^§ * _loc16_.§+$§ * _loc37_);
               _loc31_.§4t§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§1!G§ + _loc16_.§1!G§ + _loc15_.§+$§ * _loc42_ + _loc16_.§+$§ * _loc43_;
               _loc31_.§#K§ = 1 / _loc44_;
               _loc31_.§`8§ = 0;
            ...
            if(_loc28_.§[>§ == 2)
            {
               ...
               _loc52_ = _loc16_.§1!G§;
               _loc53_ = _loc16_.§+$§;
               _loc54_ = _loc48_.§5!5§.x * _loc27_ - _loc48_.§5!5§.y * _loc26_;
               _loc55_ = _loc48_.§!B§.x * _loc27_ - _loc48_.§!B§.y * _loc26_;
               _loc56_ = _loc49_.§5!5§.x * _loc27_ - _loc49_.§5!5§.y * _loc26_;
         ...
         while(_loc5_ < this.§7[§)
         {
            ...
            if(param1.§5R§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc20_.normalImpulse *= param1.§5!Y§;
                  _loc20_.tangentImpulse *= param1.§5!Y§;
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§5!5§.x * _loc22_ - _loc20_.§5!5§.y * _loc21_);
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§7[§)
         {
            _loc26_ = (_loc25_ = this.§^Y§[_loc24_]).§]!M§;
            _loc27_ = _loc25_.§'!Q§;
            ...
            while(_loc1_ < _loc25_.§[>§)
            {
               ...
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§!B§.y - _loc30_.x + _loc28_ * _loc2_.§5!5§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§!B§.x - _loc30_.y - _loc28_ * _loc2_.§5!5§.x;
               ...
               _loc28_ -= _loc33_ * (_loc2_.§5!5§.x * _loc15_ - _loc2_.§5!5§.y * _loc14_);
            ...
            if(_loc25_.§[>§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§ V§ * (_loc9_ - _loc2_.§`8§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§!B§.y - _loc30_.x + _loc28_ * _loc43_.§5!5§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§!B§.x - _loc30_.y - _loc28_ * _loc43_.§5!5§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§!B§.y - _loc30_.x + _loc28_ * _loc44_.§5!5§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§!B§.x - _loc30_.y - _loc28_ * _loc44_.§5!5§.x;
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§5!5§.x * _loc19_ - _loc43_.§5!5§.y * _loc18_ + _loc44_.§5!5§.x * _loc21_ - _loc44_.§5!5§.y * _loc20_);
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§7[§)
         {
            _loc5_ = (_loc4_ = this.§^Y§[_loc3_]).§]!M§;
            _loc6_ = _loc4_.§'!Q§;
            _loc7_ = _loc5_.§9^§ * _loc5_.§1!G§;
            _loc8_ = _loc5_.§9^§ * _loc5_.§+$§;
            _loc9_ = _loc6_.§9^§ * _loc6_.§1!G§;
            ...
            while(_loc12_ < _loc4_.§[>§)
            {
               ...
               _loc22_ = (_loc21_ = -_loc13_.§4t§ * _loc20_) * _loc11_.x;
