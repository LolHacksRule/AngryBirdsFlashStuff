package §24§
{
   ...
   public class §0!P§ extends §8J§
   {
      
      public static var §#V§:Boolean = false;
       
      
      public function §0!P§(param1:Object, param2:BitmapData)
      {
         super(param2);
         this.§@!5§(param1);
      }
      
      private static function §#!W§(param1:§ !F§, param2:int, param3:int) : void
      {
         if(param1.§`Y§.top < 0)
         {
            param1.§`Y§.top = 0;
