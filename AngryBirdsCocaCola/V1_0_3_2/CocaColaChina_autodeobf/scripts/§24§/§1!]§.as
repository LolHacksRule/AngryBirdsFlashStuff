   ...
   public class §1!]§ extends §8J§
   {
      ...
      protected function §@!5§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§?F§(_loc7_,_loc6_)]) == null)
            {
      ...
      private function §?F§(param1:String, param2:String) : String
      {
      ...
      private function §>!<§(param1:Vector.<XML>) : Dictionary
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§?F§(_loc4_,_loc6_.@name);
