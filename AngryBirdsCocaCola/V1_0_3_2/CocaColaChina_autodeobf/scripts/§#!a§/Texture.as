package §#!a§
{
   ...
   public class Texture
   {
      ...
      public static function §@8§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §#!a§.Texture
      {
         return §@0§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §@0§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §#!a§.Texture
      {
      ...
      public static function §]F§(param1:Context3D, param2:ByteArray) : §#!a§.Texture
      {
         if(param1 == null)
         {
            throw new §8A§();
      ...
      public static function §4P§(param1:§#!a§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §#!a§.Texture
      {
      ...
      public static function §"S§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §#!a§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§#!a§.Texture = §@0§(param1,_loc6_,false,param5);
         if(!§0O§.§5D§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§-2§, param2:int, param3:int) : void
      {
         ...
         if(this.§+!"§)
         {
            ...
            param1.§21§(param2,-this.§+!"§.x,-this.§+!"§.y);
            param1.§21§(param2 + 1,-_loc4_,-this.§+!"§.y);
            param1.§21§(param2 + 2,-this.§+!"§.x,-_loc5_);
            param1.§21§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
