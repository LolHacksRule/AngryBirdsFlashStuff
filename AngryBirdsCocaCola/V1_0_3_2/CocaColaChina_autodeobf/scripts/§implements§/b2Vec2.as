package §implements§
{
   public class b2Vec2
   {
      ...
      public static function §2!$§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §4!E§(param1:b2Vec2) : void
      {
         this.x -= param1.x;
         this.y -= param1.y;
      }
      ...
      public function §7E§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§>i§(this,param1.col1);
         this.y = b2Math.§>i§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      public function §0!b§(param1:b2Vec2) : void
      {
         this.x = this.x > param1.x ? Number(this.x) : Number(param1.x);
         this.y = this.y > param1.y ? Number(this.y) : Number(param1.y);
      }
      ...
      {
         return b2Math.§&9§(this.x) && b2Math.§&9§(this.y);
      }
   }
}
