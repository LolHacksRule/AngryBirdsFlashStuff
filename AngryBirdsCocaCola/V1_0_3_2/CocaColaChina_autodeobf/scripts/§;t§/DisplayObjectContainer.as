package §;t§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§?D§ = new Vector.<DisplayObject>(0);
      }
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         if(param1 >= 0 && param1 < this.numChildren)
         {
            ...
            _loc3_.dispatchEvent(new Event(Event.§^!W§,true));
            if(stage)
            {
      ...
      public function §;u§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      public function §@t§(param1:DisplayObject, param2:DisplayObject) : void
      {
         var _loc3_:int = this.getChildIndex(param1);
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§?D§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§?D§.length;
         if(_loc3_ == 0)
         {
            §7!P§(param1,§'t§);
            transformCoords(§'t§,0,0,§!q§);
            param2.x = §!q§.x;
            param2.y = §!q§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§?D§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§?D§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§?D§[_loc6_];
            §7!P§(_loc7_,§'t§);
            transformCoords(§'t§,_loc3_,_loc4_,§!q§);
            if(_loc8_ = _loc7_.hitTest(§!q§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§4!b§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§?D§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§@%§();
               param1.§?#§(_loc5_);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§@S§(this,param1.type,_loc2_);
      ...
      private function §@S§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§?D§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
               this.§@S§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
