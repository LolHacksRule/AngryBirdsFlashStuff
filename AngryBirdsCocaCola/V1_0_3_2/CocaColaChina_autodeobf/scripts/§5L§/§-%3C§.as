package §5L§
{
   ...
   public class §-<§
   {
      ...
      public static const §2"§:String = "SWFWheel.join";
      ...
      public static function §4"§(param1:Stage) : void
      {
         ...
         ExternalInterface.call(§2"§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §-c§ = ExternalInterface.call(§@1§,ExternalInterface.objectID);
         if(§-c§ == § 4§)
         {
            return;
         }
      ...
      public static function get §1!A§() : Boolean
      {
         return §>=§;
      }
