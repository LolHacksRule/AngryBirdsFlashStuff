package §7L§
{
   ...
   public class §"%§
   {
      ...
      public static function §8!L§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §6L§(_loc2_);
      ...
      public static function §6f§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §"%§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §6L§(_loc2_);
      ...
      private static function §6L§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
