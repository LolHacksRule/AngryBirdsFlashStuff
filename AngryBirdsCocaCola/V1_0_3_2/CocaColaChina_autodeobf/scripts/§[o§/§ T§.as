package §[o§
{
   ...
   public class § T§
   {
      ...
      public static function §8a§(param1:XMLList) : void
      {
         var _loc2_:XML = null;
         §>!5§ = new Array();
      ...
      {
         §>!5§[§>!5§.length] = new §3!M§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13);
      }
      
      public static function §2h§(param1:String) : §3!M§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §>!5§.length)
         {
            if(§3!M§(§>!5§[_loc2_]).mName.toLowerCase() == param1.toLowerCase())
            {
               return §3!M§(§>!5§[_loc2_]);
            }
            _loc2_++;
         }
         §7!7§.log("WARNING: LevelItemResourcePaths -> getResourcePathSound request has no return value, this path does not exist: " + param1);
         return null;
      }
   }
}
