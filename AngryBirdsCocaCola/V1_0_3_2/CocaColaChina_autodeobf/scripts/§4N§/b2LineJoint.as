package §4N§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§%!3§.x * this.§@!+§.x + (this.§?!#§ + this.§%!3§.y) * this.§=!E§.x),param1 * (this.§%!3§.x * this.§@!+§.y + (this.§?!#§ + this.§%!3§.y) * this.§=!E§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§5R§)
         {
            ...
            this.§%!3§.y *= param1.§5!Y§;
            this.§?!#§ *= param1.§5!Y§;
            _loc19_ = this.§%!3§.x * this.§@!+§.x + (this.§?!#§ + this.§%!3§.y) * this.§=!E§.x;
            _loc20_ = this.§%!3§.x * this.§@!+§.y + (this.§?!#§ + this.§%!3§.y) * this.§=!E§.y;
            _loc21_ = this.§%!3§.x * this.m_s1 + (this.§?!#§ + this.§%!3§.y) * this.m_a1;
            _loc22_ = this.§%!3§.x * this.m_s2 + (this.§?!#§ + this.§%!3§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§7!J§ && this.§,L§ != b2internal::+2)
         {
            ...
            _loc14_ = this.§4'§ * (this.§+!3§ - _loc13_);
            _loc15_ = this.§?!#§;
            _loc16_ = param1.§5V§ * this.§[!S§;
            this.§?!#§ = b2Math.§+I§(this.§?!#§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§?!#§ - _loc15_) * this.§=!E§.x;
         ...
         if(this.§-P§ && this.§,L§ != b2internal::=!X)
         {
            ...
            _loc18_ = this.§%!3§.Copy();
            _loc19_ = this.§'x§.§@!'§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§%!3§.§=C§(_loc19_);
            if(this.§,L§ == b2internal::"!3)
            {
               this.§%!3§.y = b2Math.§"!X§(this.§%!3§.y,0);
            }
            else if(this.§,L§ == b2internal::`p)
            {
               this.§%!3§.y = b2Math.§^Q§(this.§%!3§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§%!3§.y - _loc18_.y) * this.§'x§.col2.x;
            if(this.§'x§.col1.x != 0)
            {
            ...
            _loc8_ = _loc19_.x * this.§@!+§.x + _loc19_.y * this.§=!E§.x;
            _loc9_ = _loc19_.x * this.§@!+§.y + _loc19_.y * this.§=!E§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§-P§)
         {
            ...
            if(b2Math.§5'§(this.§?C§ - this.§;!S§) < 2 * b2Settings.b2_linearSlop)
            {
               ...
               _loc16_ = b2Math.§5'§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§;!S§)
            {
               _loc19_ = b2Math.§+I§(_loc34_ - this.§;!S§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§;!S§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§?C§)
            {
               _loc19_ = b2Math.§+I§(_loc34_ - this.§?C§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§'x§.§@!'§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::try;
         ...
         var _loc30_:Number = _loc28_.x * this.§@!+§.x + _loc28_.y * this.§=!E§.x;
         var _loc31_:Number = _loc28_.x * this.§@!+§.y + _loc28_.y * this.§=!E§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::try * _loc30_;
         _loc6_.y -= b2internal::try * _loc31_;
