package §4N§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §9_§:Number = 2;
       
      
      private var §5!9§:b2Body;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§5!9§ = b2internal::^!N.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§4!1§.x - this.§5!9§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§4!1§.y - this.§5!9§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§8`§.x - this.§5!9§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§8`§.y - this.§5!9§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§7z§);
         this.m_localAnchor2.SetV(param1.§#t§);
         this.§#!_§ = param1.§&!^§;
         this.§!!@§ = param1.§%J§ + this.§#!_§ * param1.§?I§;
         this.m_maxLength1 = b2Math.§^Q§(param1.§>3§,this.§!!@§ - this.§#!_§ * b2internal::9_);
         this.m_maxLength2 = b2Math.§^Q§(param1.§5A§,(this.§!!@§ - b2internal::9_) / this.§#!_§);
         this.§%!3§ = 0;
      ...
      {
         var _loc1_:b2Vec2 = this.§5!9§.m_xf.position.Copy();
      ...
      public function GetLength1() : Number
      {
         ...
         var _loc2_:Number = this.§5!9§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.§5!9§.m_xf.position.y + this.m_groundAnchor1.y;
      ...
      {
         var _loc1_:b2Vec2 = b2internal::1A.GetWorldPoint(this.m_localAnchor2);
         var _loc2_:Number = this.§5!9§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.§5!9§.m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc14_:Number = this.§5!9§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.§5!9§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.§5!9§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.§5!9§.m_xf.position.y + this.m_groundAnchor2.y;
         this.m_u1.Set(_loc10_ - _loc14_,_loc11_ - _loc15_);
         this.m_u2.Set(_loc12_ - _loc16_,_loc13_ - _loc17_);
         var _loc18_:Number = this.m_u1.§5t§();
         var _loc19_:Number = this.m_u2.§5t§();
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§!!@§ - _loc18_ - this.§#!_§ * _loc19_) > 0)
         {
            this.§ 9§ = b2internal::=!X;
            this.§%!3§ = 0;
         }
         ...
         this.m_limitMass1 = _loc2_.§1!G§ + _loc2_.§+$§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§1!G§ + _loc3_.§+$§ * _loc22_ * _loc22_;
         this.§@O§ = this.m_limitMass1 + this.§#!_§ * this.§#!_§ * this.m_limitMass2;
         ...
         {
            this.§%!3§ *= param1.§5!Y§;
            this.m_limitImpulse1 *= param1.§5!Y§;
            this.m_limitImpulse2 *= param1.§5!Y§;
            _loc23_ = (-this.§%!3§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§%!3§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§#!_§ * this.§%!3§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§#!_§ * this.§%!3§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§,!@§.x += _loc2_.§1!G§ * _loc23_;
            _loc2_.§,!@§.y += _loc2_.§1!G§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§+$§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§,!@§.x += _loc3_.§1!G§ * _loc25_;
            _loc3_.§,!@§.y += _loc3_.§1!G§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§ 9§ == b2internal::`p)
         {
            ...
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§#!_§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§@O§ * -_loc18_;
            _loc20_ = this.§%!3§;
            this.§%!3§ = b2Math.§"!X§(0,this.§%!3§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§%!3§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§#!_§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§#!_§ * _loc19_ * this.m_u2.y;
            _loc2_.§,!@§.x += _loc2_.§1!G§ * _loc14_;
            _loc2_.§,!@§.y += _loc2_.§1!G§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§+$§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§,!@§.x += _loc3_.§1!G§ * _loc16_;
            _loc3_.§,!@§.y += _loc3_.§1!G§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§+$§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
         if(this.m_limitState1 == b2internal::`p)
         {
            _loc10_ = _loc2_.§,!@§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§,!@§.y + _loc2_.m_angularVelocity * _loc5_;
            ...
            this.m_limitImpulse1 = b2Math.§"!X§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == b2internal::`p)
         {
            _loc12_ = _loc3_.§,!@§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§,!@§.y + _loc3_.m_angularVelocity * _loc8_;
            ...
            this.m_limitImpulse2 = b2Math.§"!X§(0,this.m_limitImpulse2 + _loc19_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal::^!N;
         var _loc3_:b2Body = b2internal::1A;
         var _loc5_:Number = this.§5!9§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.§5!9§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.§5!9§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.§5!9§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         if(this.§ 9§ == b2internal::`p)
         {
            ...
            _loc17_ = this.m_u1.§5t§();
            _loc18_ = this.m_u2.§5t§();
            ...
            _loc19_ = this.§!!@§ - _loc17_ - this.§#!_§ * _loc18_;
            _loc24_ = b2Math.§"!X§(_loc24_,-_loc19_);
            ...
            _loc15_ = -this.§#!_§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§#!_§ * _loc20_ * this.m_u2.y;
            _loc2_.m_sweep.c.x += _loc2_.§1!G§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§1!G§ * _loc14_;
            _loc2_.m_sweep.a += _loc2_.§+$§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§1!G§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§1!G§ * _loc16_;
         ...
         if(this.m_limitState1 == b2internal::`p)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§5t§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::`p)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§5t§()) > b2Settings.b2_linearSlop)
            {
