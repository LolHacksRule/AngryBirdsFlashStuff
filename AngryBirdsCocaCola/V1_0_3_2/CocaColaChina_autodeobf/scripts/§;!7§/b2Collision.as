package §;!7§
{
   ...
   public class b2Collision
   {
      ...
      private static var §[u§:Vector.<§^&§> = §=!K§();
      
      private static var s_clipPoints1:Vector.<§^&§> = §=!K§();
      
      private static var s_clipPoints2:Vector.<§^&§> = §=!K§();
      
      private static var §<!8§:Vector.<int> = new Vector.<int>(1);
      
      private static var §6!A§:Vector.<int> = new Vector.<int>(1);
      ...
      private static var §58§:b2Vec2 = new b2Vec2();
      ...
      public static function §9&§(param1:Vector.<§^&§>, param2:Vector.<§^&§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§^&§ = null;
         var _loc6_:int = 0;
      ...
      public static function §2y§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§4!M§;
         var _loc7_:Vector.<b2Vec2> = param1.§@H§;
         var _loc8_:Vector.<b2Vec2> = param1.§^l§;
         var _loc9_:int = param4.§4!M§;
      ...
      public static function §1!S§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §2y§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §2y§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §2y§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §2y§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function § n§(param1:Vector.<§^&§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§^&§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§4!M§;
         var _loc8_:Vector.<b2Vec2> = param2.§^l§;
         var _loc9_:int = param5.§4!M§;
      ...
      private static function §=!K§() : Vector.<§^&§>
      {
      ...
      public static function §"!-§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §<!8§[0] = _loc8_;
         var _loc9_:Number = §1!S§(§<!8§,param2,param3,param4,param5);
         _loc8_ = §<!8§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §6!A§[0] = _loc10_;
         var _loc11_:Number = §1!S§(§6!A§,param4,param5,param2,param3);
         _loc10_ = §6!A§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         if((_loc39_ = §9&§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §9&§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§^!!§.SetV(_loc27_);
      ...
      public static function §4!&§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§;>§ = b2Manifold.§0<§;
         param1.m_localPoint.SetV(param2.§0!M§);
         param1.§^!!§.§^!&§();
         param1.§!!_§ = 1;
         param1.§9;§[0].m_localPoint.SetV(param4.§0!M§);
         param1.§9;§[0].m_id.key = 0;
      }
      
      public static function §!3§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
