package §;!7§
{
   ...
   public class b2AABB
   {
      ...
      public static function §5!B§(param1:b2AABB, param2:b2AABB) : b2AABB
      {
         var _loc3_:b2AABB = new b2AABB();
         _loc3_.§5!B§(param1,param2);
         return _loc3_;
      }
      ...
      public function §&9§() : Boolean
      {
         ...
         return Boolean(_loc3_ && this.§^]§.§&9§() && this.§ $§.§&9§());
      }
      ...
      public function §5!B§(param1:b2AABB, param2:b2AABB) : void
      {
