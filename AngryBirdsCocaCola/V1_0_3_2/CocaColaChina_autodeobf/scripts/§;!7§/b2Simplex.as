   ...
   class b2Simplex
   {
      ...
      public function §^@§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         while(_loc9_ < this.§=+§)
         {
            ...
            _loc6_ = param2.§5@§(_loc10_.indexA);
            _loc7_ = param4.§5@§(_loc10_.indexB);
            _loc10_.§9!&§ = b2Math.§'!2§(param3,_loc6_);
            _loc10_.§;<§ = b2Math.§'!2§(param5,_loc7_);
            _loc10_.§>w§ = b2Math.§^!J§(_loc10_.§;<§,_loc10_.§9!&§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§=+§ > 1)
         {
            _loc11_ = param1.§>^§;
            if((_loc12_ = this.§3!U§()) < 0.5 * _loc11_ || 2 * _loc11_ < _loc12_ || _loc12_ < Number.MIN_VALUE)
            {
               this.§=+§ = 0;
            }
         }
      ...
      public function §8!J§() : b2Vec2
      {
         ...
         {
            case 1:
               return this.m_v1.§>w§.§4w§();
            case 2:
               _loc1_ = b2Math.§^!J§(this.m_v2.§>w§,this.m_v1.§>w§);
               _loc2_ = b2Math.§?!B§(_loc1_,this.m_v1.§>w§.§4w§());
               if(_loc2_ > 0)
               {
                  return b2Math.§"!L§(1,_loc1_);
               }
      ...
      public function §3!U§() : Number
      {
         switch(this.§=+§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§^!J§(this.m_v1.§>w§,this.m_v2.§>w§).§5t§();
            case 3:
               return b2Math.§?!B§(b2Math.§^!J§(this.m_v2.§>w§,this.m_v1.§>w§),b2Math.§^!J§(this.m_v3.§>w§,this.m_v1.§>w§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve2() : void
      {
         ...
         var _loc3_:b2Vec2 = b2Math.§^!J§(_loc2_,_loc1_);
         var _loc4_:Number;
      ...
      public function Solve3() : void
      {
         ...
         var _loc4_:b2Vec2 = b2Math.§^!J§(_loc2_,_loc1_);
         var _loc5_:Number = b2Math.§>i§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§>i§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§^!J§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§>i§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§>i§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§^!J§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§>i§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§>i§(_loc3_,_loc14_);
         var _loc18_:Number = -_loc15_;
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§?!B§(_loc4_,_loc9_)) * b2Math.§?!B§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§?!B§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§?!B§(_loc1_,_loc2_);
