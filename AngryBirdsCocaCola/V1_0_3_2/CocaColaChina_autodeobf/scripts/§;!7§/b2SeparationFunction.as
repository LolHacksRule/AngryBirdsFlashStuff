package §;!7§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §4$§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§;>§ = §3Q§;
            _loc7_ = this.§+!K§.§5@§(param1.indexA[0]);
            _loc10_ = this.§=!c§.§5@§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§;>§ = §"!F§;
            _loc8_ = this.§+!K§.§5@§(param1.indexA[0]);
            _loc9_ = this.§+!K§.§5@§(param1.indexA[1]);
            _loc10_ = this.§=!c§.§5@§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§=!E§ = b2Math.§ O§(b2Math.§^!J§(_loc9_,_loc8_),1);
            this.§=!E§.Normalize();
            _loc20_ = this.§=!E§;
         ...
         {
            this.§;>§ = §]6§;
            _loc11_ = this.§=!c§.§5@§(param1.indexB[0]);
            _loc12_ = this.§=!c§.§5@§(param1.indexB[1]);
            _loc7_ = this.§+!K§.§5@§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§=!E§ = b2Math.§ O§(b2Math.§^!J§(_loc12_,_loc11_),1);
            this.§=!E§.Normalize();
            _loc20_ = this.§=!E§;
         ...
         else
         {
            ...
            _loc24_ = b2Math.§`e§(param3.R,b2Math.§^!J§(_loc9_,_loc8_));
            _loc25_ = b2Math.§'!2§(param5,_loc10_);
            _loc26_ = b2Math.§`e§(param5.R,b2Math.§^!J§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§^!J§(_loc26_,_loc24_);
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §3Q§:
               _loc3_ = b2Math.§4![§(param1.R,this.§=!E§);
               _loc4_ = b2Math.§4![§(param2.R,this.§=!E§.§4w§());
               _loc5_ = this.§+!K§.§ @§(_loc3_);
               _loc6_ = this.§=!c§.§ @§(_loc4_);
               _loc7_ = b2Math.§'!2§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§'!2§(param2,_loc6_)).x - _loc7_.x) * this.§=!E§.x + (_loc8_.y - _loc7_.y) * this.§=!E§.y);
            case §"!F§:
               _loc10_ = b2Math.§`e§(param1.R,this.§=!E§);
               _loc7_ = b2Math.§'!2§(param1,this.m_localPoint);
               _loc4_ = b2Math.§4![§(param2.R,_loc10_.§4w§());
               _loc6_ = this.§=!c§.§ @§(_loc4_);
               return Number(((_loc8_ = b2Math.§'!2§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §]6§:
               _loc10_ = b2Math.§`e§(param2.R,this.§=!E§);
               _loc8_ = b2Math.§'!2§(param2,this.m_localPoint);
               _loc3_ = b2Math.§4![§(param1.R,_loc10_.§4w§());
               _loc5_ = this.§+!K§.§ @§(_loc3_);
