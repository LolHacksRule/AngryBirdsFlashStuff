package §;!7§
{
   ...
   public class b2Distance
   {
      ...
      public static function §]r§(param1:b2DistanceOutput, param2:b2SimplexCache, param3:b2DistanceInput) : void
      {
         ...
         ++b2_gjkCalls;
         var _loc4_:b2DistanceProxy = param3.§9b§;
         var _loc5_:b2DistanceProxy = param3.§'o§;
         var _loc6_:b2Transform = param3.§&F§;
         var _loc7_:b2Transform = param3.§0!J§;
         ...
         var _loc15_:Number;
         var _loc14_:b2Vec2;
         var _loc16_:Number = _loc15_ = (_loc14_ = _loc8_.§6!X§()).§"!b§();
         var _loc19_:int = 0;
         while(_loc19_ < 20)
         {
            _loc13_ = _loc8_.§=+§;
            ...
            if((_loc16_ = (_loc18_ = _loc8_.§6!X§()).§"!b§()) > _loc15_)
            {
            }
            _loc15_ = _loc16_;
            if((_loc20_ = _loc8_.§8!J§()).§"!b§() < Number.MIN_VALUE * Number.MIN_VALUE)
            {
               break;
            }
            (_loc21_ = _loc9_[_loc8_.§=+§]).indexA = _loc4_.§'!L§(b2Math.§4![§(_loc6_.R,_loc20_.§4w§()));
            _loc21_.§9!&§ = b2Math.§'!2§(_loc6_,_loc4_.§5@§(_loc21_.indexA));
            _loc21_.indexB = _loc5_.§'!L§(b2Math.§4![§(_loc7_.R,_loc20_));
            _loc21_.§;<§ = b2Math.§'!2§(_loc7_,_loc5_.§5@§(_loc21_.indexB));
            _loc21_.§>w§ = b2Math.§^!J§(_loc21_.§;<§,_loc21_.§9!&§);
            _loc19_++;
            ++b2_gjkIters;
            _loc22_ = false;
            _loc17_ = 0;
         ...
         param1.§>!K§ = b2Math.§^!J§(param1.§[!^§,param1.§#'§).§5t§();
         param1.§7A§ = _loc19_;
         _loc8_.§>,§(param2);
         if(param3.§]i§)
         {
            _loc23_ = _loc4_.§[8§;
            _loc24_ = _loc5_.§[8§;
            if(param1.§>!K§ > _loc23_ + _loc24_ && param1.§>!K§ > Number.MIN_VALUE)
            {
               param1.§>!K§ -= _loc23_ + _loc24_;
               (_loc25_ = b2Math.§^!J§(param1.§#'§,param1.§[!^§)).Normalize();
