   ...
   public class §?-§ extends § F§
   {
      ...
      private function §>!S§(param1:§=!R§) : void
      {
         ...
         while(_loc11_ < 80)
         {
            ...
            param1.§'!"§("PARTICLE_COLLECT_DRUM_STAR_" + _loc10_,§=!R§.§4r§,§@r§.§"5§,§?!7§().GetWorldCenter().x,§?!7§().GetWorldCenter().y,2000 * (80 * 0.5),"",§<!J§.§7D§(§7!0§),_loc8_,_loc9_,-20,_loc9_ * 20,0.5 + Math.random());
            _loc11_++;
         }
      }
   }
