package §'&§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§0!V§(param1,param2);
         return _loc3_;
      }
      
      public static function §7!S§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §3!@§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§8f§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §5!T§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      b2internal static function §%!8§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§5K§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§5K§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§3M§.SetV(_loc2_.§3M§);
            this.§4!M§ = _loc2_.§4!M§;
            this.§`§(this.§4!M§);
            _loc3_ = 0;
            while(_loc3_ < this.§4!M§)
            {
      ...
      public function §,;§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§0!V§(_loc3_,param2);
      }
      
      public function §0!V§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§4!M§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§^!J§(this.§@H§[_loc5_],this.§@H§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§"!b§() > Number.MIN_VALUE);
            this.§^l§[_loc3_].SetV(b2Math.§ O§(_loc6_,1));
            this.§^l§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§3M§ = §,b§(this.§@H§,this.§4!M§);
      }
      ...
      public function §8f§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§4!M§ = 4;
         this.§`§(4);
         this.§@H§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§4!M§)
         {
            this.§@H§[_loc6_] = b2Math.§'!2§(_loc5_,this.§@H§[_loc6_]);
            this.§^l§[_loc6_] = b2Math.§`e§(_loc5_.R,this.§^l§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §9#§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§3M§.x = 0.5 * (param1.x + param2.x);
         this.§3M§.y = 0.5 * (param1.y + param2.y);
         this.§^l§[0] = b2Math.§ O§(b2Math.§^!J§(param2,param1),1);
         this.§^l§[0].Normalize();
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§^]§.x = _loc5_ - b2internal::[8;
         param1.§^]§.y = _loc6_ - b2internal::[8;
         param1.§ $§.x = _loc7_ + b2internal::[8;
         param1.§ $§.y = _loc8_ + b2internal::[8;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§4!M§ == 2)
         {
            param1.center.x = 0.5 * (this.§@H§[0].x + this.§@H§[1].x);
            param1.center.y = 0.5 * (this.§@H§[0].y + this.§@H§[1].y);
            param1.§3!Z§ = 0;
            param1.§=!#§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§4!M§)
         {
            _loc11_ = this.§@H§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§4!M§ ? this.§@H§[int(_loc10_ + 1)] : this.§@H§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§>i§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§4!M§)
         {
            _loc7_[_loc12_] = b2Math.§>i§(_loc5_,this.§@H§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§'!2§(param3,_loc24_.center));
                  return _loc24_.§3!Z§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§4!M§;
         var _loc14_:int = (_loc10_ + 1) % this.§4!M§;
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§4!M§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
