package §'&§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      b2internal var §60§:Number;
      
      b2internal var §;^§:b2Vec2;
      
      b2internal var §2!b§:b2Vec2;
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§2!b§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§60§ = this.§2!b§.Normalize();
         this.§;^§.Set(this.§2!b§.y,-this.§2!b§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§;^§.x - this.§2!b§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§;^§.y - this.§2!b§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§;^§.x + this.§2!b§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§;^§.y + this.§2!b§.y) + this.m_v2.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§5k§ * _loc12_)
            {
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc8_:Number = b2Math.§>i§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§>i§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §1n§(param1:b2Transform) : b2Vec2
      {
      ...
      b2internal function §0!O§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§]K§ = param1;
