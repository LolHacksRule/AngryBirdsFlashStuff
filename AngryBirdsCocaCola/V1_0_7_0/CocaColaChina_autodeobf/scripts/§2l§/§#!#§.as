package §2l§
{
   ...
   public class §#!#§
   {
      ...
      public static function § !Z§(param1:XML) : void
      {
         ...
         {
            §'O§[String(_loc3_.@name)] = _loc3_;
         }
      }
      
      public static function §'S§(param1:String, param2:§]O§, param3:Boolean = true) : §,!Q§.Sprite
      {
         var _loc7_:XML = null;
         var _loc8_:§4!Q§ = null;
         var _loc9_:§%^§ = null;
         ...
         {
            if(_loc8_ = param2.§!v§(_loc7_.@name))
            {
      ...
      public static function §8@§(param1:String, param2:§]O§) : flash.display.Sprite
      {
         var _loc6_:XML = null;
         var _loc7_:§4!Q§ = null;
         ...
         var _loc4_:XML;
         var _loc5_:XMLList = (_loc4_ = §'O§[param1]).child(§^J§);
         for each(_loc6_ in _loc5_)
         {
            if(_loc7_ = param2.§!v§(_loc6_.@name))
            {
