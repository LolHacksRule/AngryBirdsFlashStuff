package §%n§
{
   ...
   public class §@t§ extends §91§
   {
      ...
      override public function init() : void
      {
         ...
         §5d§ = new §"!'§(41,118,142,1);
         §5!R§ = new § !G§(this);
         §5!R§.init(§-h§.§#z§.Views.View_LevelSelection[0]);
      ...
      override public function activate() : void
      {
         ...
         if(this.§@Y§.length == 1)
         {
            (§5!R§.getItemByName("Button_Prev") as §;!P§).setVisibility(false);
            (§5!R§.getItemByName("Button_Next") as §;!P§).setVisibility(false);
            (§5!R§.getItemByName("TextField_LevelNumberSmall") as §,!B§).setVisibility(false);
         }
         else
         {
            (§5!R§.getItemByName("Button_Prev") as §;!P§).setVisibility(true);
            (§5!R§.getItemByName("Button_Next") as §;!P§).setVisibility(true);
            (§5!R§.getItemByName("TextField_LevelNumberSmall") as §,!B§).setVisibility(true);
         }
         var _loc1_:§0x§ = §2&§.§2!H§();
         §5!R§.setText(§"!@§.§6!-§.§=5§(_loc1_) + "/" + §"!@§.§6!-§.§6v§(_loc1_),"Textfield_CollectedStars");
         this.§+h§ = this.§>4§.x;
      }
      ...
      private function §,X§() : void
      {
         ...
         while(_loc1_ < this.§>&§.length)
         {
            if(-this.§>4§.x >= this.§@Y§[_loc1_].x && -this.§+h§ < this.§@Y§[_loc1_].x)
            {
               ...
               (§5!R§.getItemByName("TextField_LevelNumberSmall") as §,!B§).x = this.§>&§[_loc1_].x;
               this.§+!K§(_loc1_);
            }
            if(-this.§>4§.x <= this.§@Y§[_loc1_].x && -this.§+h§ > this.§@Y§[_loc1_].x)
            {
      ...
      private function §8!K§() : void
      {
         ...
         while(_loc1_ < this.§@Y§.length)
         {
            ...
            {
               (this.§@Y§[_loc1_] as §]!G§).setEnabled(false);
            }
            else
            {
               (this.§@Y§[_loc1_] as §]!G§).setEnabled(true);
            }
            _loc1_++;
         }
      }
      ...
      override public function deActivate() : void
      {
         super.deActivate();
         this.§4!U§();
         (§5!R§.getItemByName("Button_Back") as §;!P§).setComponentVisualState(§#!K§.COMPONENT_STATE_ACTIVE_DEFAULT);
         §2&§.§!!d§ = null;
      }
      ...
      public function §>A§() : void
      {
         ...
         this.§5a§ = this.§@Q§;
         this.§#c§ = this.§@Q§;
         var _loc2_:§0x§ = §2&§.§@^§(§2&§.§6q§);
         var _loc3_:Number = 0;
         while(_loc3_ < _loc2_.pageIndexes.length)
         {
            _loc8_ = _loc2_.§9g§(_loc2_.pageIndexes[_loc3_]);
            this.§,n§.push(_loc2_.§,^§(_loc3_));
            this.§7!c§.push(_loc2_.§+s§(_loc3_));
         ...
         var _loc4_:Class;
         var _loc5_:MovieClip = new (_loc4_ = §@x§.§="§(_loc2_.§4!A§))();
         var _loc6_:Class;
         var _loc7_:MovieClip = new (_loc6_ = §@x§.§="§(_loc2_.§ ![§))();
      ...
      private function §]V§(param1:Array, param2:int, param3:Number, param4:§0x§) : Number
      {
         var _loc8_:XML = null;
         ...
         var _loc6_:Class = §@x§.§="§(this.§7!c§[param2]);
         var _loc7_:Number = 0;
         ...
         var _loc9_:§]!G§;
         (_loc9_ = new §]!G§(_loc8_,this.§>4§,null,null)).§[F§(_loc5_);
         _loc9_.setVisibility(true);
         _loc9_.x += param3;
         this.§>4§.addComponent(_loc9_);
         this.§@Y§.push(_loc9_);
         return Number(param3 + §"!@§.§`?§);
      }
      ...
      private function §18§() : void
      {
         ...
         while(_loc4_ < this.§@Y§.length)
         {
            _loc1_ = §@x§.§="§("Button_Dot");
            _loc2_ = new _loc1_();
            _loc2_.x = §"!@§.§`?§ / 2 + _loc3_ - this.§@Y§.length * _loc2_.width / 2;
            _loc2_.y = (§5!R§.getItemByName("Button_Next") as §;!P§).y - _loc2_.height / 2;
            if(_loc4_ == this.§@Q§)
            {
               _loc2_.gotoAndStop("Selected");
               (§5!R§.getItemByName("TextField_LevelNumberSmall") as §,!B§).x = _loc2_.x;
               (§5!R§.getItemByName("TextField_LevelNumberSmall") as §,!B§).y = _loc2_.y - _loc2_.height;
               this.§+!K§(_loc4_);
            }
            else
            {
         ...
         (§5!R§.getItemByName("Button_Next") as §;!P§).x = §"!@§.§`?§ / 2;
         (§5!R§.getItemByName("Button_Prev") as §;!P§).x = §"!@§.§`?§ / 2;
         (§5!R§.getItemByName("Button_Next") as §;!P§).x = (§5!R§.getItemByName("Button_Next") as §;!P§).x + (_loc3_ + 10);
         (§5!R§.getItemByName("Button_Prev") as §;!P§).x = (§5!R§.getItemByName("Button_Prev") as §;!P§).x - (_loc3_ + 10);
      }
      ...
      {
         (§5!R§.getItemByName("TextField_LevelNumberSmall") as §,!B§).§&J§.text = §2&§.§@^§(§2&§.§6q§).pageIndexes[param1];
      }
   }
}
