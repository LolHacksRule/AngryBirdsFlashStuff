   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§`!&§ && this.§,!L§ != b2internal::5!<)
         {
            ...
            _loc15_ = this.§"h§;
            _loc16_ = param1.§5!+§ * this.§>g§;
            this.§"h§ = b2Math.§>!M§(this.§"h§ + _loc14_,-_loc16_,_loc16_);
         ...
         if(this.§6Q§ && this.§,!L§ != b2internal::]m)
         {
            ...
            _loc19_ = this.§^!H§.§1e§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§7!P§.§<W§(_loc19_);
            if(this.§,!L§ == b2internal::``)
            {
               this.§7!P§.y = b2Math.§0$§(this.§7!P§.y,0);
            }
            else if(this.§,!L§ == b2internal::=A)
            {
               this.§7!P§.y = b2Math.§]#§(this.§7!P§.y,0);
            }
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§6Q§)
         {
            ...
            if(b2Math.§?!4§(this.§"!c§ - this.§[!S§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§>!M§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§?!4§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§[!S§)
            {
               _loc19_ = b2Math.§>!M§(_loc34_ - this.§[!S§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§[!S§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§"!c§)
            {
               _loc19_ = b2Math.§>!M§(_loc34_ - this.§"!c§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§^!H§.§1e§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::9R;
