   ...
   public class b2GearJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         else
         {
            ...
            this.§-D§.§6n§ = -_loc12_;
            _loc14_ += _loc4_.§0,§ + _loc4_.§'!=§ * _loc12_ * _loc12_;
         }
         if(this.m_revolute2)
         {
            this.§-D§.§">§ = -this.§7§;
            _loc14_ += this.§7§ * this.§7§ * _loc5_.§'!=§;
         }
         else
         {
            ...
            _loc14_ += this.§7§ * this.§7§ * (_loc5_.§0,§ + _loc5_.§'!=§ * _loc12_ * _loc12_);
         }
         this.§ !4§ = _loc14_ > 0 ? Number(1 / _loc14_) : Number(0);
         if(param1.§9!3§)
         {
            _loc4_.§3s§.x += _loc4_.§0,§ * this.§7!P§ * this.§-D§.§-R§.x;
            _loc4_.§3s§.y += _loc4_.§0,§ * this.§7!P§ * this.§-D§.§-R§.y;
            _loc4_.m_angularVelocity += _loc4_.§'!=§ * this.§7!P§ * this.§-D§.§6n§;
            _loc5_.§3s§.x += _loc5_.§0,§ * this.§7!P§ * this.§-D§.§5! §.x;
            _loc5_.§3s§.y += _loc5_.§0,§ * this.§7!P§ * this.§-D§.§5! §.y;
            _loc5_.m_angularVelocity += _loc5_.§'!=§ * this.§7!P§ * this.§-D§.§">§;
         }
         else
         {
            this.§7!P§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc4_:Number = this.§-D§.§=X§(_loc2_.§3s§,_loc2_.m_angularVelocity,_loc3_.§3s§,_loc3_.m_angularVelocity);
         var _loc5_:Number = -this.§ !4§ * _loc4_;
         this.§7!P§ += _loc5_;
         _loc2_.§3s§.x += _loc2_.§0,§ * _loc5_ * this.§-D§.§-R§.x;
         _loc2_.§3s§.y += _loc2_.§0,§ * _loc5_ * this.§-D§.§-R§.y;
         _loc2_.m_angularVelocity += _loc2_.§'!=§ * _loc5_ * this.§-D§.§6n§;
         _loc3_.§3s§.x += _loc3_.§0,§ * _loc5_ * this.§-D§.§5! §.x;
         _loc3_.§3s§.y += _loc3_.§0,§ * _loc5_ * this.§-D§.§5! §.y;
         _loc3_.m_angularVelocity += _loc3_.§'!=§ * _loc5_ * this.§-D§.§">§;
      }
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         _loc3_.m_sweep.c.x += _loc3_.§0,§ * _loc8_ * this.§-D§.§-R§.x;
         _loc3_.m_sweep.c.y += _loc3_.§0,§ * _loc8_ * this.§-D§.§-R§.y;
         _loc3_.m_sweep.a += _loc3_.§'!=§ * _loc8_ * this.§-D§.§6n§;
         _loc4_.m_sweep.c.x += _loc4_.§0,§ * _loc8_ * this.§-D§.§5! §.x;
         _loc4_.m_sweep.c.y += _loc4_.§0,§ * _loc8_ * this.§-D§.§5! §.y;
         _loc4_.m_sweep.a += _loc4_.§'!=§ * _loc8_ * this.§-D§.§">§;
         _loc3_.§4!O§();
         _loc4_.§4!O§();
