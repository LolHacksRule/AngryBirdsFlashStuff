   ...
   public class b2RevoluteJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§6Q§)
         {
            ...
            if(b2Math.§?!4§(this.§2z§ - this.§#![§) < 2 * b2Settings.b2_angularSlop)
            {
               this.§,!L§ = b2internal::5!<;
            }
         ...
         if(param1.§9!3§)
         {
            ...
            _loc15_ = this.§7!P§.x;
            _loc16_ = this.§7!P§.y;
            _loc2_.§3s§.x -= _loc10_ * _loc15_;
            _loc2_.§3s§.y -= _loc10_ * _loc16_;
            _loc2_.m_angularVelocity -= _loc12_ * (_loc6_ * _loc16_ - _loc7_ * _loc15_ + this.§"h§ + this.§7!P§.z);
            _loc3_.§3s§.x += _loc11_ * _loc15_;
            _loc3_.§3s§.y += _loc11_ * _loc16_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc11_:b2Vec2 = _loc2_.§3s§;
         var _loc12_:Number = _loc2_.m_angularVelocity;
         var _loc13_:b2Vec2 = _loc3_.§3s§;
         var _loc14_:Number = _loc3_.m_angularVelocity;
         var _loc15_:Number = _loc2_.§0,§;
         ...
         if(this.§`!&§ && this.§,!L§ != b2internal::5!<)
         {
            ...
            _loc21_ = this.§"h§;
            _loc22_ = param1.§5!+§ * this.§with§;
            this.§"h§ = b2Math.§>!M§(this.§"h§ + _loc20_,-_loc22_,_loc22_);
         ...
         _loc2_.§3s§.SetV(_loc11_);
         _loc2_.m_angularVelocity = _loc12_;
         _loc3_.§3s§.SetV(_loc13_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§6Q§ && this.§,!L§ != b2internal::]m)
         {
            ...
            if(this.§,!L§ == b2internal::5!<)
            {
               _loc3_ = b2Math.§>!M§(_loc25_ - this.§#![§,-b2Settings.b2_maxAngularCorrection,b2Settings.b2_maxAngularCorrection);
               _loc26_ = -this.§4!T§ * _loc3_;
               _loc7_ = b2Math.§?!4§(_loc3_);
            }
            else if(this.§,!L§ == b2internal::``)
            {
               _loc3_ = _loc25_ - this.§#![§;
         ...
         var _loc20_:Number = _loc5_.§0,§;
         var _loc21_:Number = _loc6_.§0,§;
         ...
         this.§@!M§.§,R§(this.K2);
         this.§@!M§.§,R§(this.K3);
         this.§@!M§.§1e§(§-! §,-_loc16_,-_loc17_);
         _loc10_ = §-! §.x;
         _loc11_ = §-! §.y;
         _loc5_.m_sweep.c.x -= _loc5_.§0,§ * _loc10_;
         _loc5_.m_sweep.c.y -= _loc5_.§0,§ * _loc11_;
         _loc5_.m_sweep.a -= _loc5_.§'!=§ * (_loc12_ * _loc11_ - _loc13_ * _loc10_);
         _loc6_.m_sweep.c.x += _loc6_.§0,§ * _loc10_;
         _loc6_.m_sweep.c.y += _loc6_.§0,§ * _loc11_;
