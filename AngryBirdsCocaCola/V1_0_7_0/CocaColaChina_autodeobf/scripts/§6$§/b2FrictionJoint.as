   ...
   public class b2FrictionJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§9!3§)
         {
            ...
            this.§>]§ *= param1.§8!W§;
            _loc15_ = this.§[!C§;
            _loc4_.§3s§.x -= _loc10_ * _loc15_.x;
            _loc4_.§3s§.y -= _loc10_ * _loc15_.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * _loc15_.y - _loc7_ * _loc15_.x + this.§>]§);
            _loc5_.§3s§.x += _loc11_ * _loc15_.x;
            _loc5_.§3s§.y += _loc11_ * _loc15_.y;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc18_ = param1.§5!+§ * this.§4!0§;
         this.§>]§ = b2Math.§>!M§(this.§>]§ + _loc20_,-_loc18_,_loc18_);
         _loc20_ = this.§>]§ - _loc21_;
         _loc7_ -= _loc12_ * _loc20_;
         _loc9_ += _loc13_ * _loc20_;
         var _loc22_:Number = _loc8_.x - _loc9_ * _loc17_ - _loc6_.x + _loc7_ * _loc15_;
         var _loc23_:Number = _loc8_.y + _loc9_ * _loc16_ - _loc6_.y - _loc7_ * _loc14_;
         var _loc24_:b2Vec2 = b2Math.§5y§(this.§4f§,new b2Vec2(-_loc22_,-_loc23_));
         var _loc25_:b2Vec2 = this.§[!C§.Copy();
         this.§[!C§.§<W§(_loc24_);
         _loc18_ = param1.§5!+§ * this.§=!O§;
         if(this.§[!C§.§9U§() > _loc18_ * _loc18_)
         {
            this.§[!C§.Normalize();
            this.§[!C§.§8;§(_loc18_);
         }
         _loc24_ = b2Math.§2!+§(this.§[!C§,_loc25_);
