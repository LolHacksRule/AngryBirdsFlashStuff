package § 3§
{
   ...
   public class §5!E§
   {
      ...
      public static const §=!4§:String = "SWFWheel.getState";
      ...
      private static var §9!1§:Stage;
      
      private static var §6o§:int;
      ...
      public static function §1!b§(param1:Stage) : void
      {
         ...
         §6o§ = ExternalInterface.call(§=!4§,ExternalInterface.objectID);
         if(§6o§ == §[!§)
         {
            return;
         }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §9!1§.getObjectsUnderPoint(new Point(§9!1§.mouseX,§9!1§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
