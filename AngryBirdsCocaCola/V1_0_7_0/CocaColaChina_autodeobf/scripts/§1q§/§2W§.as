package §1q§
{
   ...
   public class §2W§
   {
      ...
      public static const §1f§:Number = §,!1§.§9!;§ * §&_§.§5-§;
      ...
      public function §2W§(param1:§&_§, param2:§5!F§, param3:Number = 1.0)
      {
      ...
      public function §4!@§() : void
      {
         ...
         this.§%!I§ = this.mLevelMain.§@I§.§?!K§ - 20 * §&_§.§#u§ * §&_§.§5-§;
         this.§"!!§ = this.mLevelMain.§@I§.§?!K§ + 4;
      ...
      public function §;!]§(param1:§5!F§) : void
      {
         var _loc3_:§8m§ = null;
      ...
      public function §#!X§(param1:§5!F§) : void
      {
         var _loc2_:§8m§ = new §8m§();
         _loc2_.id = §#'§;
         _loc2_.x = this.§8!]§.x;
         _loc2_.y = this.§8!]§.y;
      ...
      public function §2G§(param1:§8m§) : void
      {
         var _loc2_:Number = param1.scale;
         var _loc3_:Number = param1.x - §,!1§.§ e§ * 0.5 / _loc2_ * §&_§.§5-§;
         var _loc4_:Number = param1.y - §,!1§.§9!;§ * 0.5 / _loc2_ * §&_§.§5-§;
         var _loc5_:Number = _loc3_ + §,!1§.§ e§ / _loc2_ * §&_§.§5-§;
         var _loc6_:Number = _loc4_ + §,!1§.§9!;§ / _loc2_ * §&_§.§5-§;
         param1.left = _loc3_;
         param1.top = _loc4_;
         param1.right = _loc5_;
      ...
      public function §1o§(param1:Number, param2:Number) : void
      {
         ...
         if(this.mCurrentAction == §0s§)
         {
            ...
            {
               _loc6_ = (_loc5_ = this.mLevelMain.activeObject).§@!?§().GetPosition().x + (!!_loc5_.§ L§ ? _loc5_.§ L§ * §&_§.§5-§ : 0);
               _loc7_ = _loc5_.§@!?§().GetPosition().y + (!!_loc5_.§ N§ ? _loc5_.§ N§ * §&_§.§5-§ : 0);
               if((_loc8_ = _loc5_.§@!?§().GetLinearVelocity().x) > 0 && this.§2^§ != 0)
               {
      ...
      public function §8<§() : void
      {
         ...
         {
            _loc1_ = §,!1§.§;!O§() / §,!1§.§@!7§ - §,!1§.§9!;§ >> 1;
            §%!;§ = this.mLevelMain.sprite.x = §&_§.§ !>§ * ((1 - §2W§.§2!V§) / 2);
            §-b§ = this.mLevelMain.sprite.y = _loc1_ + §&_§.§#u§ * (1 - §2W§.§2!V§) * §0!!§.§2!2§;
         }
      }
      ...
      public function §3M§() : void
      {
         ...
         this.§=d§ = _loc2_ - §&_§.§#u§ / 2 + §0!!§.§0![§;
         if(this.mLevelMain.background)
         {
            this.mLevelMain.background.§]H§(this.§^7§,this.§=d§);
         }
         if(this.mLevelMain.objects)
         {
            this.mLevelMain.objects.§]H§(this.§^7§,this.§=d§);
         }
         if(this.mLevelMain.mLevelEngine)
         {
            this.mLevelMain.mLevelEngine.§]H§(this.§^7§,this.§=d§,§2!V§);
         }
         if(this.mLevelMain.slingshot)
         {
            this.mLevelMain.slingshot.§]H§(this.§^7§,this.§=d§);
         }
         if(this.mLevelMain.particles)
         {
            this.mLevelMain.particles.§]H§(this.§^7§,this.§=d§);
         }
      }
      ...
      public function §1!L§(param1:§8m§) : void
      {
         this.§'!&§ = param1;
         if(this.§'!&§ != null)
         {
