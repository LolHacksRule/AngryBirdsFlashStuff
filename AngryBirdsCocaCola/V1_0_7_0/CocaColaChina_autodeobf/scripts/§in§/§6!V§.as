package §in§
{
   ...
   public class §6!V§ extends §-!L§
   {
       
      
      public function §6!V§(param1:Object, param2:BitmapData)
      {
         super(param2);
         this.§6_§(param1);
      }
         ...
         for(_loc3_ in param1)
         {
            if(_loc3_.indexOf("chars") == 0)
            {
               ...
               for(_loc5_ in _loc4_)
               {
                  ...
                  _loc7_.§9D§ = new Rectangle(_loc6_.x,_loc6_.y,_loc6_.width,_loc6_.height);
                  _loc7_.§7O§ = _loc6_.width / 2;
