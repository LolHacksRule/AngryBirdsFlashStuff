package §>![§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      b2internal var §>!5§:Vector.<b2Vec2>;
      
      b2internal var §0N§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         §'!c§ = b2internal::6!2;
         this.§"b§ = new b2Vec2();
         this.§>!5§ = new Vector.<b2Vec2>();
         this.§0N§ = new Vector.<b2Vec2>();
         §2B§ = b2Settings.b2_polygonRadius;
         this.§"b§.§`§();
      }
      ...
      public static function §1a§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §+!R§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§=`§(param1,param2);
         return _loc3_;
      ...
      public static function §-t§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
      ...
      public static function §+!'§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§<W§(new b2Vec2(0,0));
            _loc3_.§<W§(_loc9_);
            _loc3_.§<W§(_loc10_);
            _loc3_.§8;§(_loc16_ * _loc7_);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§"b§.SetV(_loc2_.§"b§);
            this.§'u§ = _loc2_.§'u§;
            this.§'d§(this.§'u§);
            _loc3_ = 0;
            while(_loc3_ < this.§'u§)
            {
               this.§>!5§[_loc3_].SetV(_loc2_.§>!5§[_loc3_]);
               this.§0N§[_loc3_].SetV(_loc2_.§0N§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §`F§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function §@"§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§'u§)
         {
            this.§>!5§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§'u§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§'u§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§2!+§(this.§>!5§[_loc5_],this.§>!5§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§9U§() > Number.MIN_VALUE);
            this.§0N§[_loc3_].SetV(b2Math.§6H§(_loc6_,1));
            this.§0N§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§"b§ = §+!'§(this.§>!5§,this.§'u§);
      }
      ...
      public function §=`§(param1:Number, param2:Number) : void
      {
         this.§'u§ = 4;
         this.§'d§(4);
         this.§>!5§[0].Set(-param1,-param2);
         this.§>!5§[1].Set(param1,-param2);
         this.§>!5§[2].Set(param1,param2);
         this.§>!5§[3].Set(-param1,param2);
         this.§0N§[0].Set(0,-1);
         this.§0N§[1].Set(1,0);
         this.§0N§[2].Set(0,1);
         this.§0N§[3].Set(-1,0);
      ...
      public function §[C§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§'u§)
         {
            this.§>!5§[_loc6_] = b2Math.§8L§(_loc5_,this.§>!5§[_loc6_]);
            this.§0N§[_loc6_] = b2Math.§5y§(_loc5_.R,this.§0N§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §-!,§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§'u§ = 2;
         this.§'d§(2);
         this.§>!5§[0].SetV(param1);
         this.§>!5§[1].SetV(param2);
         this.§"b§.x = 0.5 * (param1.x + param2.x);
         this.§"b§.y = 0.5 * (param1.y + param2.y);
         this.§0N§[0] = b2Math.§6H§(b2Math.§2!+§(param2,param1),1);
         this.§0N§[0].Normalize();
         this.§0N§[1].x = -this.§0N§[0].x;
         this.§0N§[1].y = -this.§0N§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§'u§)
         {
            _loc6_ = (_loc9_ = this.§>!5§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§0N§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§'!K§.x = _loc5_ - b2internal::2B;
         param1.§'!K§.y = _loc6_ - b2internal::2B;
         param1.§#W§.x = _loc7_ + b2internal::2B;
         param1.§#W§.y = _loc8_ + b2internal::2B;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§'u§ == 2)
         {
            param1.center.x = 0.5 * (this.§>!5§[0].x + this.§>!5§[1].x);
            param1.center.y = 0.5 * (this.§>!5§[0].y + this.§>!5§[1].y);
            param1.§7!>§ = 0;
            param1.§;!4§ = 0;
            return;
         }
         ...
         {
            _loc11_ = this.§>!5§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§'u§ ? this.§>!5§[int(_loc10_ + 1)] : this.§>!5§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§7!>§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§;!4§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§0p§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§'u§)
         {
            _loc7_[_loc12_] = b2Math.§0p§(_loc5_,this.§>!5§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§8L§(param3,_loc24_.center));
                  return _loc24_.§7!>§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§'u§;
         var _loc14_:int = (_loc10_ + 1) % this.§'u§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§>!5§[_loc9_].x * (1 - _loc15_) + this.§>!5§[_loc13_].x * _loc15_,this.§>!5§[_loc9_].y * (1 - _loc15_) + this.§>!5§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§>!5§[_loc10_].x * (1 - _loc16_) + this.§>!5§[_loc14_].x * _loc16_,this.§>!5§[_loc10_].y * (1 - _loc16_) + this.§>!5§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§>!5§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§'u§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§>!5§[_loc12_];
            }
         ...
         _loc20_.§8;§(1 / _loc19_);
         param4.SetV(b2Math.§8L§(param3,_loc20_));
         return _loc19_;
      }
      ...
      private function §'d§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            this.§>!5§[_loc2_] = new b2Vec2();
            this.§0N§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
