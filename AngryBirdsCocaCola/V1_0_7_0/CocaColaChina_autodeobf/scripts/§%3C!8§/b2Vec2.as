package §<!8§
{
   public class b2Vec2
   {
      ...
      {
         var _loc2_:Number = b2Math.§0p§(this,param1.col1);
         this.y = b2Math.§0p§(this,param1.col2);
         this.x = _loc2_;
      }
      
      public function §6H§(param1:Number) : void
      {
         var _loc2_:Number = this.x;
      ...
      {
         return b2Math.§4K§(this.x) && b2Math.§4K§(this.y);
      }
   }
}
