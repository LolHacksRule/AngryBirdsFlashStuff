package §<!8§
{
   public class b2Math
   {
      ...
      public static function §4K§(param1:Number) : Boolean
      {
         return isFinite(param1);
      }
      
      public static function §0p§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §6H§(param1:b2Vec2, param2:Number) : b2Vec2
      {
      ...
      public static function §5y§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return new b2Vec2(§0p§(param2,param1.col1),§0p§(param2,param1.col2));
      }
      
      public static function §8L§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         _loc3_ = §5y§(param1.R,param2);
      ...
      public static function §%!2§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§`!$§(§5y§(param1,param2.col1),§5y§(param1,param2.col2));
      }
      
      public static function §>W§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§0p§(param1.col1,param2.col1),§0p§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§0p§(param1.col1,param2.col2),§0p§(param1.col2,param2.col2));
      ...
      {
         return new b2Vec2(§?!4§(param1.x),§?!4§(param1.y));
      }
      
      public static function §9!6§(param1:b2Mat22) : b2Mat22
      {
      ...
      public static function §9Y§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§]#§(param1.x,param2.x),§]#§(param1.y,param2.y));
      }
      ...
      public static function §-8§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §7$§(param2,§9Y§(param1,param3));
      }
      ...
      public static function §9h§(param1:uint) : uint
      {
      ...
      public static function § m§(param1:uint) : Boolean
      {
