package §+!S§
{
   ...
   public class Texture
   {
      ...
      public static function §5+§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §+!S§.Texture
      {
         return §8W§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §8W§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §+!S§.Texture
      {
         ...
         _loc10_ = new §[!L§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§3!&§.§5C§)
         {
            _loc10_.§>!Q§(param2);
         }
         ...
         return new §'R§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §@!E§(param1:Context3D, param2:ByteArray) : §+!S§.Texture
      {
         if(param1 == null)
         {
            throw new §2w§();
         ...
         var _loc9_:§[!L§ = new §[!L§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§3!&§.§5C§)
         {
            _loc9_.§>!Q§(param2);
         }
      ...
      public static function §1!<§(param1:§+!S§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §+!S§.Texture
      {
         ...
         (_loc4_ = new §'R§(param1,param2)).§"![§ = param3;
         return _loc4_;
      }
      
      public static function §>-§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §+!S§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§+!S§.Texture = §8W§(param1,_loc6_,false,param5);
         if(!§3!&§.§5C§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§4k§, param2:int, param3:int) : void
      {
         ...
         if(this.§"![§)
         {
            ...
            param1.§1K§(param2,-this.§"![§.x,-this.§"![§.y);
            param1.§1K§(param2 + 1,-_loc4_,-this.§"![§.y);
            param1.§1K§(param2 + 2,-this.§"![§.x,-_loc5_);
            param1.§1K§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
