package §2!S§
{
   ...
   public class §3!X§
   {
      ...
      public static function §9!`§(param1:String) : String
      {
         ...
         return §,!8§.§5Y§(_loc3_.readInt(),true) + §,!8§.§5Y§(_loc3_.readInt(),true) + §,!8§.§5Y§(_loc3_.readInt(),true) + §,!8§.§5Y§(_loc3_.readInt(),true) + §,!8§.§5Y§(_loc3_.readInt(),true);
      }
      
      public static function §!+§(param1:ByteArray) : String
      {
         var _loc2_:Array = §3!X§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §@X§(_loc2_);
         return §,!8§.§5Y§(_loc3_.readInt(),true) + §,!8§.§5Y§(_loc3_.readInt(),true) + §,!8§.§5Y§(_loc3_.readInt(),true) + §,!8§.§5Y§(_loc3_.readInt(),true) + §,!8§.§5Y§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §3!X§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §@X§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
