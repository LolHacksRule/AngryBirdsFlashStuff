package §`!O§
{
   ...
   class b2PositionSolverManifold
   {
      ...
      private static var §7i§:b2Vec2 = new b2Vec2();
      ...
      public function §,?§(param1:b2ContactConstraint) : void
      {
         ...
         switch(param1.type)
         {
            case b2Manifold.§#!H§:
               ...
               this.§>!B§[0].x = 0.5 * (_loc9_ + _loc11_);
               this.§>!B§[0].y = 0.5 * (_loc10_ + _loc12_);
            ...
            case b2Manifold.§5N§:
               ...
               while(_loc2_ < param1.§?!!§)
               {
                  _loc6_ = param1.§2i§[_loc2_].localPoint;
                  ...
                  this.§>!B§[_loc2_].x = _loc3_;
                  this.§>!B§[_loc2_].y = _loc4_;
                  _loc2_++;
               }
               break;
            case b2Manifold.§5!J§:
               ...
               while(_loc2_ < param1.§?!!§)
               {
                  ...
                  this.§`!2§[_loc2_] = (_loc3_ - _loc7_) * this.§!-§.x + (_loc4_ - _loc8_) * this.§!-§.y - param1.radius;
                  this.§>!B§[_loc2_].Set(_loc3_,_loc4_);
                  _loc2_++;
               }
               this.§!-§.x *= -1;
               this.§!-§.y *= -1;
