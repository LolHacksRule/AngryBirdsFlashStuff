package § Y§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function b2WorldManifold()
      {
         this.§!-§ = new b2Vec2();
         super();
         this.§>!B§ = new Vector.<b2Vec2>(b2Settings.b2_maxManifoldPoints);
         var _loc1_:int = 0;
         while(_loc1_ < b2Settings.b2_maxManifoldPoints)
         {
            this.§>!B§[_loc1_] = new b2Vec2();
            _loc1_++;
         }
      }
      ...
      public function §,?§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         ...
         switch(param1.§'!c§)
         {
            case b2Manifold.§#!H§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§>!B§[0].m_localPoint;
               ...
               this.§>!B§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§>!B§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§5N§:
               _loc8_ = param2.R;
               _loc7_ = param1.§"!§;
               ...
               this.§!-§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§!L§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§>!B§[_loc6_].m_localPoint;
                  ...
                  this.§>!B§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§>!B§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§5!J§:
               ...
               while(_loc6_ < param1.§!L§)
               {
                  ...
                  this.§>!B§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§>!B§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
