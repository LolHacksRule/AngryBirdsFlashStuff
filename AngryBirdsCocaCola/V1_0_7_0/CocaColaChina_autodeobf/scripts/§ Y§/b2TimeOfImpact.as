package § Y§
{
   ...
   public class b2TimeOfImpact
   {
      ...
      private static var §64§:b2DistanceInput = new b2DistanceInput();
      ...
      private static var §9P§:b2DistanceOutput = new b2DistanceOutput();
      ...
      public static function §5!-§(param1:b2TOIInput) : Number
      {
         ...
         var _loc4_:b2Sweep = param1.§%V§;
         var _loc5_:b2Sweep = param1.§8!J§;
         b2Settings.b2Assert(_loc4_.§9#§ == _loc5_.§9#§);
         b2Settings.b2Assert(1 - _loc4_.§9#§ > Number.MIN_VALUE);
         var _loc6_:Number = _loc2_.§2B§ + _loc3_.§2B§;
         ...
         do
         {
            ...
            _loc16_ = _loc12_;
            _loc4_.§1!J§(§ §,_loc15_);
            _loc5_.§1!J§(§7[§,_loc15_);
            if((_loc17_ = §>P§.Evaluate(§ §,§7[§)) >= _loc11_)
            {
               _loc8_ = 1;
               break;
            }
            ...
            do
            {
               ...
               _loc4_.§1!J§(§ §,_loc19_);
               _loc5_.§1!J§(§7[§,_loc19_);
               _loc20_ = §>P§.Evaluate(§ §,§7[§);
               if(b2Math.§?!4§(_loc20_ - _loc11_) < 0.025 * _loc7_)
               {
                  _loc13_ = _loc19_;
                  break;
               }
