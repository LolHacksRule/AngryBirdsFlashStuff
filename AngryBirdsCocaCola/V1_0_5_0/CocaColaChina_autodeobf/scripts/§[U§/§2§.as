package §[U§
{
   ...
   public class §2§ extends §8f§
   {
       
      
      public function §2§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
      ...
      protected function §>!5§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         var _loc16_:§%&§ = null;
         var _loc3_:Dictionary = this.§8!W§(param2);
      ...
      private function §8!W§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
