package §,f§
{
   ...
   public class §5@§
   {
      ...
      public static function §@#§(param1:Stage) : void
      {
         ...
         §7!=§ = param1;
         ExternalInterface.call(each);
         ExternalInterface.call(§;b§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §<!@§ = ExternalInterface.call(§69§,ExternalInterface.objectID);
         if(§<!@§ == §+d§)
         {
            return;
         }
      ...
      public static function get §throw§() : Boolean
      {
         return §&8§;
      }
      
      public static function set §throw§(param1:Boolean) : void
      {
         §&8§ = param1;
      }
