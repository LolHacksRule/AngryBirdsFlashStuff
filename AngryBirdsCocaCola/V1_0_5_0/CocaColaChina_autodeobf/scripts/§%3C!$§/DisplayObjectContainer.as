package §<!$§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§ !&§[param1];
            _loc3_.dispatchEvent(new Event(Event.§7!F§,true));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§[!I§));
            }
            _loc3_.§7! §(null);
      ...
      public function §6!4§(param1:Function) : void
      {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§ !&§[_loc6_];
            §>]§(_loc7_,§'§);
            transformCoords(§'§,_loc3_,_loc4_,§6^§);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§+E§(this,param1.type,_loc2_);
      ...
      private function §+E§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               this.§+E§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
