package §,-§
{
   ...
   public class §'c§
   {
      ...
      {
         §4e§[§4e§.length] = new §#o§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13);
      }
      
      public static function §+! §(param1:String) : §#o§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §4e§.length)
         {
            if(§#o§(§4e§[_loc2_]).mName.toLowerCase() == param1.toLowerCase())
            {
               return §#o§(§4e§[_loc2_]);
            }
            _loc2_++;
