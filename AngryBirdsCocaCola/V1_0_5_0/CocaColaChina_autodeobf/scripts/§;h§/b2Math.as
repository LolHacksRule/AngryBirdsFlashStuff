package §;h§
{
   public class b2Math
   {
      ...
      public static function §2!C§(param1:Number) : Boolean
      {
      ...
      public static function §3l§(param1:b2Vec2, param2:Number) : b2Vec2
      {
         return new b2Vec2(param2 * param1.y,-param2 * param1.x);
      }
      
      public static function §1!S§(param1:Number, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(-param1 * param2.y,param1 * param2.x);
      }
      
      public static function §0q§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §9l§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         _loc3_ = §0q§(param1.R,param2);
      ...
      public static function §6!_§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §8F§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
      ...
      {
         return b2Mat22.§#!@§(§0q§(param1,param2.col1),§0q§(param1,param2.col2));
      }
      ...
      public static function §&!3§(param1:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§7'§(param1.x),§7'§(param1.y));
      }
      
      public static function §9! §(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§#!@§(§&!3§(param1.col1),§&!3§(param1.col2));
      }
      
      public static function §13§(param1:Number, param2:Number) : Number
      {
      ...
      {
         return new b2Vec2(§13§(param1.x,param2.x),§13§(param1.y,param2.y));
      }
      ...
      public static function §2x§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§@!'§(param1.x,param2.x),§@!'§(param1.y,param2.y));
      }
      
      public static function §!!T§(param1:Number, param2:Number, param3:Number) : Number
      {
      ...
      {
         return §2x§(param2,§&!A§(param1,param3));
      }
      
      public static function § if§(param1:Array, param2:Array) : void
      {
         var _loc3_:* = param1[0];
         param1[0] = param2[0];
         param2[0] = _loc3_;
      ...
      public static function §[S§(param1:uint) : uint
      {
