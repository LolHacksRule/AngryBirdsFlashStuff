package §;h§
{
   public class b2Vec2
   {
      ...
      public static function §4!b§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §8J§(param1:b2Vec2) : void
      {
         this.x += param1.x;
         this.y += param1.y;
      }
      ...
      public function §2x§(param1:b2Vec2) : void
      {
         this.x = this.x > param1.x ? Number(this.x) : Number(param1.x);
         this.y = this.y > param1.y ? Number(this.y) : Number(param1.y);
      }
      ...
      {
         return b2Math.§2!C§(this.x) && b2Math.§2!C§(this.y);
      }
   }
}
