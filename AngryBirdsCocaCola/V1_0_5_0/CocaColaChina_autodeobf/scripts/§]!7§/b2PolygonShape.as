package §]!7§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §4C§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §!!Z§:b2Vec2;
      
      b2internal var §9d§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         §2+§ = b2internal::3!D;
         this.§!!Z§ = new b2Vec2();
         this.§9d§ = new Vector.<b2Vec2>();
         this.§%,§ = new Vector.<b2Vec2>();
         §,!3§ = b2Settings.b2_polygonRadius;
         this.§!!Z§.§9!V§();
      }
      ...
      public static function §"3§(param1:Array, param2:Number) : b2PolygonShape
      {
         ...
         _loc3_.§1!M§(param1,param2);
         return _loc3_;
      }
      
      public static function §61§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §implements§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§9!Z§(param1,param2);
         return _loc3_;
      }
      
      public static function §6h§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§!!N§(param1,param2,param3,param4);
         return _loc5_;
      }
      ...
      public static function §<0§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§8J§(new b2Vec2(0,0));
            _loc3_.§8J§(_loc9_);
            _loc3_.§8J§(_loc10_);
            _loc3_.§#M§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            {
               this.§9d§[_loc3_].SetV(_loc2_.§9d§[_loc3_]);
      ...
      public function §1!M§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function § [§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§5!5§)
         {
            this.§9d§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§5!5§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§5!5§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§"!S§(this.§9d§[_loc5_],this.§9d§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§&T§() > Number.MIN_VALUE);
            this.§%,§[_loc3_].SetV(b2Math.§3l§(_loc6_,1));
            this.§%,§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§!!Z§ = §<0§(this.§9d§,this.§5!5§);
      }
      
      public function §9!Z§(param1:Number, param2:Number) : void
      {
         this.§5!5§ = 4;
         this.§<!^§(4);
         this.§9d§[0].Set(-param1,-param2);
         this.§9d§[1].Set(param1,-param2);
         this.§9d§[2].Set(param1,param2);
         this.§9d§[3].Set(-param1,param2);
         this.§%,§[0].Set(0,-1);
         this.§%,§[1].Set(1,0);
         this.§%,§[2].Set(0,1);
         this.§%,§[3].Set(-1,0);
      ...
      public function §!!N§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§5!5§ = 4;
         this.§<!^§(4);
         this.§9d§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§5!5§)
         {
            this.§9d§[_loc6_] = b2Math.§9l§(_loc5_,this.§9d§[_loc6_]);
            this.§%,§[_loc6_] = b2Math.§0q§(_loc5_.R,this.§%,§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §6!6§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§5!5§ = 2;
         this.§<!^§(2);
         this.§9d§[0].SetV(param1);
         this.§9d§[1].SetV(param2);
         this.§!!Z§.x = 0.5 * (param1.x + param2.x);
         this.§!!Z§.y = 0.5 * (param1.y + param2.y);
         this.§%,§[0] = b2Math.§3l§(b2Math.§"!S§(param2,param1),1);
         this.§%,§[0].Normalize();
         this.§%,§[1].x = -this.§%,§[0].x;
         this.§%,§[1].y = -this.§%,§[0].y;
      }
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < this.§5!5§)
         {
            _loc3_ = this.§9d§[_loc9_];
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§5!5§)
         {
            _loc6_ = (_loc9_ = this.§9d§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§;s§.x = _loc5_ - b2internal::,!3;
         param1.§;s§.y = _loc6_ - b2internal::,!3;
         param1.§`!]§.x = _loc7_ + b2internal::,!3;
         param1.§`!]§.y = _loc8_ + b2internal::,!3;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§5!5§ == 2)
         {
            param1.center.x = 0.5 * (this.§9d§[0].x + this.§9d§[1].x);
            param1.center.y = 0.5 * (this.§9d§[0].y + this.§9d§[1].y);
            param1.§7W§ = 0;
            param1.§`D§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§5!5§)
         {
            _loc11_ = this.§9d§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§5!5§ ? this.§9d§[int(_loc10_ + 1)] : this.§9d§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§7W§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§`D§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§[B§(param3.R,param1);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§5!5§)
         {
            _loc7_[_loc12_] = b2Math.§]%§(_loc5_,this.§9d§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§9l§(param3,_loc24_.center));
                  return _loc24_.§7W§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§5!5§;
         var _loc14_:int = (_loc10_ + 1) % this.§5!5§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§9d§[_loc9_].x * (1 - _loc15_) + this.§9d§[_loc13_].x * _loc15_,this.§9d§[_loc9_].y * (1 - _loc15_) + this.§9d§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§9d§[_loc10_].x * (1 - _loc16_) + this.§9d§[_loc14_].x * _loc16_,this.§9d§[_loc10_].y * (1 - _loc16_) + this.§9d§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§9d§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§5!5§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§9d§[_loc12_];
            }
         ...
         _loc20_.§#M§(1 / _loc19_);
         param4.SetV(b2Math.§9l§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §,!X§() : Vector.<b2Vec2>
      {
         return this.§9d§;
      }
      
      public function §5^§() : Vector.<b2Vec2>
      {
         return this.§%,§;
      }
      
      public function §2!c§(param1:b2Vec2) : int
      {
         var _loc5_:Number = NaN;
         var _loc2_:int = 0;
         var _loc3_:Number = this.§9d§[0].x * param1.x + this.§9d§[0].y * param1.y;
         var _loc4_:int = 1;
         while(_loc4_ < this.§5!5§)
         {
      ...
      {
         var _loc2_:int = this.§9d§.length;
         while(_loc2_ < param1)
         {
            this.§9d§[_loc2_] = new b2Vec2();
