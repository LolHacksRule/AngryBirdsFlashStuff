package §!u§
{
   ...
   class b2Simplex
   {
      ...
      public var §9d§:Vector.<b2SimplexVertex>;
      ...
      function b2Simplex()
      {
         ...
         this.§9d§ = new Vector.<b2SimplexVertex>(3);
         super();
         this.§9d§[0] = this.m_v1;
         this.§9d§[1] = this.m_v2;
         this.§9d§[2] = this.m_v3;
      ...
      public function §]!#§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         this.§0!K§ = param1.count;
         var _loc8_:Vector.<b2SimplexVertex> = this.§9d§;
         var _loc9_:int = 0;
         while(_loc9_ < this.§0!K§)
         {
            (_loc10_ = _loc8_[_loc9_]).indexA = param1.indexA[_loc9_];
            _loc10_.indexB = param1.indexB[_loc9_];
            _loc6_ = param2.§>R§(_loc10_.indexA);
            _loc7_ = param4.§>R§(_loc10_.indexB);
            _loc10_.§+!d§ = b2Math.§9l§(param3,_loc6_);
            _loc10_.§,!-§ = b2Math.§9l§(param5,_loc7_);
            _loc10_.§"!2§ = b2Math.§"!S§(_loc10_.§,!-§,_loc10_.§+!d§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§0!K§ > 1)
      ...
      public function §1p§(param1:b2SimplexCache) : void
      {
         param1.§<!2§ = this.§"$§();
         param1.count = uint(this.§0!K§);
         var _loc2_:Vector.<b2SimplexVertex> = this.§9d§;
         var _loc3_:int = 0;
         while(_loc3_ < this.§0!K§)
         {
      ...
      public function §+]§() : b2Vec2
      {
         ...
         switch(this.§0!K§)
         {
            ...
            case 2:
               _loc1_ = b2Math.§"!S§(this.m_v2.§"!2§,this.m_v1.§"!2§);
               _loc2_ = b2Math.§`P§(_loc1_,this.m_v1.§"!2§.§'g§());
               if(_loc2_ > 0)
               {
                  return b2Math.§1!S§(1,_loc1_);
               }
               return b2Math.§3l§(_loc1_,1);
               break;
            default:
      ...
      public function §!!0§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§0!K§)
         {
            case 0:
               ...
               break;
            case 1:
               param1.SetV(this.m_v1.§+!d§);
               param2.SetV(this.m_v1.§,!-§);
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§+!d§.x + this.m_v2.a * this.m_v2.§+!d§.x;
               param1.y = this.m_v1.a * this.m_v1.§+!d§.y + this.m_v2.a * this.m_v2.§+!d§.y;
               param2.x = this.m_v1.a * this.m_v1.§,!-§.x + this.m_v2.a * this.m_v2.§,!-§.x;
               param2.y = this.m_v1.a * this.m_v1.§,!-§.y + this.m_v2.a * this.m_v2.§,!-§.y;
               break;
            case 3:
               param2.x = param1.x = this.m_v1.a * this.m_v1.§+!d§.x + this.m_v2.a * this.m_v2.§+!d§.x + this.m_v3.a * this.m_v3.§+!d§.x;
               param2.y = param1.y = this.m_v1.a * this.m_v1.§+!d§.y + this.m_v2.a * this.m_v2.§+!d§.y + this.m_v3.a * this.m_v3.§+!d§.y;
               break;
            default:
               b2Settings.b2Assert(false);
         }
      ...
      public function §"$§() : Number
      {
         switch(this.§0!K§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§"!S§(this.m_v1.§"!2§,this.m_v2.§"!2§).§&c§();
            case 3:
               return b2Math.§`P§(b2Math.§"!S§(this.m_v2.§"!2§,this.m_v1.§"!2§),b2Math.§"!S§(this.m_v3.§"!2§,this.m_v1.§"!2§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§`P§(_loc4_,_loc9_)) * b2Math.§`P§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§`P§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§`P§(_loc1_,_loc2_);
