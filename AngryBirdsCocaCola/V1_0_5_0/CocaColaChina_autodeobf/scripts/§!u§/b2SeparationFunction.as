package §!u§
{
   ...
   class b2SeparationFunction
   {
      ...
      public var §0!B§:b2DistanceProxy;
      ...
      public function §#§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§2+§ = §&!D§;
            _loc7_ = this.§^!R§.§>R§(param1.indexA[0]);
            _loc10_ = this.§0!B§.§>R§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§4l§.x = _loc15_ - _loc13_;
            this.§4l§.y = _loc16_ - _loc14_;
            this.§4l§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§2+§ = § in§;
            _loc8_ = this.§^!R§.§>R§(param1.indexA[0]);
            _loc9_ = this.§^!R§.§>R§(param1.indexA[1]);
            _loc10_ = this.§0!B§.§>R§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§4l§ = b2Math.§3l§(b2Math.§"!S§(_loc9_,_loc8_),1);
            this.§4l§.Normalize();
            _loc20_ = this.§4l§;
         ...
         {
            this.§2+§ = §;!5§;
            _loc11_ = this.§0!B§.§>R§(param1.indexB[0]);
            _loc12_ = this.§0!B§.§>R§(param1.indexB[1]);
            _loc7_ = this.§^!R§.§>R§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§4l§ = b2Math.§3l§(b2Math.§"!S§(_loc12_,_loc11_),1);
            this.§4l§.Normalize();
            _loc20_ = this.§4l§;
         ...
         else
         {
            ...
            _loc11_ = this.§0!B§.§>R§(param1.indexB[0]);
            _loc12_ = this.§0!B§.§>R§(param1.indexB[1]);
            _loc23_ = b2Math.§9l§(param3,_loc7_);
            _loc24_ = b2Math.§0q§(param3.R,b2Math.§"!S§(_loc9_,_loc8_));
            _loc25_ = b2Math.§9l§(param5,_loc10_);
            _loc26_ = b2Math.§0q§(param5.R,b2Math.§"!S§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§"!S§(_loc26_,_loc24_);
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§!!T§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§!!T§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §&!D§:
               _loc3_ = b2Math.§[B§(param1.R,this.§4l§);
               _loc4_ = b2Math.§[B§(param2.R,this.§4l§.§'g§());
               _loc5_ = this.§^!R§.§>!J§(_loc3_);
               _loc6_ = this.§0!B§.§>!J§(_loc4_);
               _loc7_ = b2Math.§9l§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§9l§(param2,_loc6_)).x - _loc7_.x) * this.§4l§.x + (_loc8_.y - _loc7_.y) * this.§4l§.y);
            case § in§:
               _loc10_ = b2Math.§0q§(param1.R,this.§4l§);
               _loc7_ = b2Math.§9l§(param1,this.m_localPoint);
               _loc4_ = b2Math.§[B§(param2.R,_loc10_.§'g§());
               _loc6_ = this.§0!B§.§>!J§(_loc4_);
               return Number(((_loc8_ = b2Math.§9l§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §;!5§:
               _loc10_ = b2Math.§0q§(param2.R,this.§4l§);
               _loc8_ = b2Math.§9l§(param2,this.m_localPoint);
               _loc3_ = b2Math.§[B§(param1.R,_loc10_.§'g§());
               _loc5_ = this.§^!R§.§>!J§(_loc3_);
               return Number(((_loc7_ = b2Math.§9l§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
