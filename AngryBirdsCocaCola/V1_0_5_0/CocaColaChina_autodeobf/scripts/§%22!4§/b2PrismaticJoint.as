package §"!4§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§46§.x * this.§]!X§.x + (this.§3!L§ + this.§46§.z) * this.§4l§.x),param1 * (this.§46§.x * this.§]!X§.y + (this.§3!L§ + this.§46§.z) * this.§4l§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§[!Z§)
         {
            ...
            this.§46§.y *= param1.§56§;
            this.§3!L§ *= param1.§56§;
            _loc19_ = this.§46§.x * this.§]!X§.x + (this.§3!L§ + this.§46§.z) * this.§4l§.x;
            _loc20_ = this.§46§.x * this.§]!X§.y + (this.§3!L§ + this.§46§.z) * this.§4l§.y;
            _loc21_ = this.§46§.x * this.m_s1 + this.§46§.y + (this.§3!L§ + this.§46§.z) * this.m_a1;
            _loc22_ = this.§46§.x * this.m_s2 + this.§46§.y + (this.§3!L§ + this.§46§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§4l§.x * (_loc6_.x - _loc4_.x) + this.§4l§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§3I§ * (this.§5&§ - _loc14_);
            _loc16_ = this.§3!L§;
            _loc17_ = param1.§9!^§ * this.§4!Y§;
            this.§3!L§ = b2Math.§!!T§(this.§3!L§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§3!L§ - _loc16_) * this.§4l§.x;
            _loc9_ = _loc15_ * this.§4l§.y;
         ...
         {
            _loc18_ = this.§4l§.x * (_loc6_.x - _loc4_.x) + this.§4l§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§46§.Copy();
            _loc20_ = this.§[C§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§46§.§8J§(_loc20_);
            if(this.§1'§ == b2internal::;!-)
            {
               this.§46§.z = b2Math.§@!'§(this.§46§.z,0);
            }
            else if(this.§1'§ == b2internal::-g)
            {
               this.§46§.z = b2Math.§13§(this.§46§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§46§.z - _loc19_.z) * this.§[C§.col3.x;
            _loc22_ = -_loc13_ - (this.§46§.z - _loc19_.z) * this.§[C§.col3.y;
            _loc23_ = this.§[C§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§46§.x = _loc23_.x;
            this.§46§.y = _loc23_.y;
            _loc20_.x = this.§46§.x - _loc19_.x;
            _loc20_.y = this.§46§.y - _loc19_.y;
            _loc20_.z = this.§46§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§]!X§.x + _loc20_.z * this.§4l§.x;
            _loc9_ = _loc20_.x * this.§]!X§.y + _loc20_.z * this.§4l§.y;
         ...
         else
         {
            ...
            this.§46§.x += _loc24_.x;
            this.§46§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§]!X§.x;
            _loc9_ = _loc24_.x * this.§]!X§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§,!+§)
         {
            ...
            _loc35_ = this.§4l§.x * _loc26_ + this.§4l§.y * _loc27_;
            if(b2Math.§7'§(this.§5!S§ - this.§ do§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§!!T§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§7'§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§ do§)
            {
               _loc19_ = b2Math.§!!T§(_loc35_ - this.§ do§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§ do§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§5!S§)
            {
               _loc19_ = b2Math.§!!T§(_loc35_ - this.§5!S§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§5!S§;
               _loc18_ = true;
            }
         }
         ...
         var _loc31_:Number = _loc28_.x * this.§]!X§.x + _loc28_.z * this.§4l§.x;
         var _loc32_:Number = _loc28_.x * this.§]!X§.y + _loc28_.z * this.§4l§.y;
         ...
         _loc6_.x -= b2internal::0!' * _loc31_;
         _loc6_.y -= b2internal::0!' * _loc32_;
         _loc7_ -= b2internal::'t * _loc33_;
         _loc8_.x += b2internal::]C * _loc31_;
         _loc8_.y += b2internal::]C * _loc32_;
