package §@'§
{
   ...
   public class Texture
   {
      ...
      public static function §"z§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §@'§.Texture
      {
      ...
      {
         var _loc4_:§@'§.Texture;
         (_loc4_ = new § D§(param1,param2)).§-&§ = param3;
         return _loc4_;
      }
