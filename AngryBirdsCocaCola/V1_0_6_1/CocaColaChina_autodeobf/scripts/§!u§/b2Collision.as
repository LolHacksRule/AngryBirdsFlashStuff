package §!u§
{
   ...
   public class b2Collision
   {
      ...
      private static var §1Q§:Vector.<§&P§> = §87§();
      
      private static var s_clipPoints1:Vector.<§&P§> = §87§();
      
      private static var s_clipPoints2:Vector.<§&P§> = §87§();
      
      private static var §-4§:Vector.<int> = new Vector.<int>(1);
      
      private static var §8^§:Vector.<int> = new Vector.<int>(1);
      
      private static var §<!"§:b2Vec2 = new b2Vec2();
      
      private static var §=b§:b2Vec2 = new b2Vec2();
      
      private static var §&L§:b2Vec2 = new b2Vec2();
      
      private static var § each§:b2Vec2 = new b2Vec2();
      ...
      public static function §9t§(param1:Vector.<§&P§>, param2:Vector.<§&P§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§&P§ = null;
         var _loc6_:int = 0;
      ...
      public static function §,!A§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc6_:int = param1.§5!5§;
         var _loc7_:Vector.<b2Vec2> = param1.§9d§;
         var _loc8_:Vector.<b2Vec2> = param1.§%,§;
         var _loc9_:int = param4.§5!5§;
         var _loc10_:Vector.<b2Vec2> = param4.§9d§;
         _loc11_ = param2.R;
      ...
      public static function §>K§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
      ...
      public static function § else§(param1:Vector.<§&P§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§&P§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§5!5§;
         var _loc8_:Vector.<b2Vec2> = param2.§%,§;
         var _loc9_:int = param5.§5!5§;
         var _loc10_:Vector.<b2Vec2> = param5.§9d§;
      ...
      private static function §87§() : Vector.<§&P§>
      {
      ...
      public static function §3!d§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§&P§ = null;
         ...
         param1.§72§ = 0;
         var _loc7_:Number = param2.§,!3§ + param4.§,!3§;
         var _loc8_:int = 0;
         §-4§[0] = _loc8_;
         var _loc9_:Number = §>K§(§-4§,param2,param3,param4,param5);
         _loc8_ = §-4§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §8^§[0] = _loc10_;
         var _loc11_:Number = §>K§(§8^§,param4,param5,param2,param3);
         _loc10_ = §8^§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§2+§ = b2Manifold.§ in§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§&P§> = §1Q§;
         § else§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§5!5§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§9d§)[_loc16_];
         ...
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §=b§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §&L§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §@%§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§&P§> = s_clipPoints1;
         var _loc38_:Vector.<§&P§> = s_clipPoints2;
         if((_loc39_ = §9t§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §9t§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
      ...
      public static function §<!a§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§,!3§ + param4.§,!3§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§2+§ = b2Manifold.§%N§;
         param1.m_localPoint.SetV(param2.§3b§);
         param1.§ !W§.§9!V§();
         param1.§72§ = 1;
         param1.§+!]§[0].m_localPoint.SetV(param4.§3b§);
         param1.§+!]§[0].m_id.key = 0;
      }
      
      public static function §9!'§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§,!3§ + param4.§,!3§;
         var _loc21_:int = param2.§5!5§;
         var _loc22_:Vector.<b2Vec2> = param2.§9d§;
      ...
      public static function §"!a§(param1:b2AABB, param2:b2AABB) : Boolean
      {
