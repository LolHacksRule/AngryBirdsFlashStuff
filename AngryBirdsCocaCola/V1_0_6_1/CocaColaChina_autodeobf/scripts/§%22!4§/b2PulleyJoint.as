package §"!4§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§5!=§ = b2internal::`1.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§4!A§.x - this.§5!=§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§4!A§.y - this.§5!=§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§9Z§.x - this.§5!=§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§9Z§.y - this.§5!=§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§9%§);
         this.m_localAnchor2.SetV(param1.§+!"§);
         this.§#;§ = param1.§;a§;
         this.§var§ = param1.§'!#§ + this.§#;§ * param1.§=!&§;
         this.m_maxLength1 = b2Math.§13§(param1.§6E§,this.§var§ - this.§#;§ * b2internal::4!#);
         this.m_maxLength2 = b2Math.§13§(param1.§]!O§,(this.§var§ - b2internal::4!#) / this.§#;§);
         this.§46§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§46§ * this.m_u2.x,param1 * this.§46§ * this.m_u2.y);
      }
      ...
      public function §06§() : b2Vec2
      {
         var _loc1_:b2Vec2 = this.§5!=§.m_xf.position.Copy();
         _loc1_.§8J§(this.m_groundAnchor1);
         return _loc1_;
      }
      ...
      {
         var _loc1_:b2Vec2 = this.§5!=§.m_xf.position.Copy();
         _loc1_.§8J§(this.m_groundAnchor2);
         return _loc1_;
      }
      ...
      public function GetLength1() : Number
      {
         ...
         var _loc2_:Number = this.§5!=§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.§5!=§.m_xf.position.y + this.m_groundAnchor1.y;
      ...
      {
         var _loc1_:b2Vec2 = b2internal::[!4.GetWorldPoint(this.m_localAnchor2);
         var _loc2_:Number = this.§5!=§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.§5!=§.m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc14_:Number = this.§5!=§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.§5!=§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.§5!=§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.§5!=§.m_xf.position.y + this.m_groundAnchor2.y;
         this.m_u1.Set(_loc10_ - _loc14_,_loc11_ - _loc15_);
         this.m_u2.Set(_loc12_ - _loc16_,_loc13_ - _loc17_);
         var _loc18_:Number = this.m_u1.§&c§();
         var _loc19_:Number = this.m_u2.§&c§();
         if(_loc18_ > b2Settings.b2_linearSlop)
         {
            this.m_u1.§#M§(1 / _loc18_);
         }
         else
         {
            this.m_u1.§9!V§();
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§var§ - _loc18_ - this.§#;§ * _loc19_) > 0)
         {
            this.§>!4§ = b2internal::'P;
            this.§46§ = 0;
         }
         ...
         {
            this.m_limitState1 = b2internal::'P;
            this.m_limitImpulse1 = 0;
         }
         else
         {
         ...
         {
            this.m_limitState2 = b2internal::'P;
            this.m_limitImpulse2 = 0;
         }
         else
         {
         ...
         this.m_limitMass1 = _loc2_.§!S§ + _loc2_.§2`§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§!S§ + _loc3_.§2`§ * _loc22_ * _loc22_;
         this.§,3§ = this.m_limitMass1 + this.§#;§ * this.§#;§ * this.m_limitMass2;
         ...
         {
            this.§46§ *= param1.§56§;
            this.m_limitImpulse1 *= param1.§56§;
            this.m_limitImpulse2 *= param1.§56§;
            _loc23_ = (-this.§46§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§46§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§#;§ * this.§46§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§#;§ * this.§46§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§+!W§.x += _loc2_.§!S§ * _loc23_;
            _loc2_.§+!W§.y += _loc2_.§!S§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§2`§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§+!W§.x += _loc3_.§!S§ * _loc25_;
            _loc3_.§+!W§.y += _loc3_.§!S§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§2`§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§46§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = _loc4_.col1.y * _loc8_ + _loc4_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         if(this.§>!4§ == b2internal::-g)
         {
            _loc10_ = _loc2_.§+!W§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§+!W§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§+!W§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§+!W§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§#;§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§,3§ * -_loc18_;
            _loc20_ = this.§46§;
            this.§46§ = b2Math.§@!'§(0,this.§46§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§46§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§#;§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§#;§ * _loc19_ * this.m_u2.y;
            _loc2_.§+!W§.x += _loc2_.§!S§ * _loc14_;
            _loc2_.§+!W§.y += _loc2_.§!S§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§2`§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§+!W§.x += _loc3_.§!S§ * _loc16_;
            _loc3_.§+!W§.y += _loc3_.§!S§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§2`§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
         if(this.m_limitState1 == b2internal::-g)
         {
            _loc10_ = _loc2_.§+!W§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§+!W§.y + _loc2_.m_angularVelocity * _loc5_;
         ...
         if(this.m_limitState2 == b2internal::-g)
         {
            _loc12_ = _loc3_.§+!W§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§+!W§.y + _loc3_.m_angularVelocity * _loc8_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal::`1;
         var _loc3_:b2Body = b2internal::[!4;
         var _loc5_:Number = this.§5!=§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.§5!=§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.§5!=§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.§5!=§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         if(this.§>!4§ == b2internal::-g)
         {
            ...
            if(_loc18_ > b2Settings.b2_linearSlop)
            {
               this.m_u2.§#M§(1 / _loc18_);
            }
            else
            {
               this.m_u2.§9!V§();
            }
            _loc19_ = this.§var§ - _loc17_ - this.§#;§ * _loc18_;
            _loc24_ = b2Math.§@!'§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§!!T§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            ...
            _loc2_.m_sweep.a += _loc2_.§2`§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§!S§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§!S§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§2`§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§-!d§();
            _loc3_.§-!d§();
         }
         if(this.m_limitState1 == b2internal::-g)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§&c§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::-g)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§&c§()) > b2Settings.b2_linearSlop)
            {
