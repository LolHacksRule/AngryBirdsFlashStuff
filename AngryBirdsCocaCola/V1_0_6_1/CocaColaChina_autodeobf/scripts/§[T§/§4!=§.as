package §[T§
{
   ...
   public class §4!=§
   {
      ...
      private function §5A§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§75§(param1 as String);
         }
         if(param1 is Number)
         {
      ...
      private function §75§(param1:String) : String
      {
      ...
      private function §]q§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§75§(v.@name.toString()) + ":" + this.§5A§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
