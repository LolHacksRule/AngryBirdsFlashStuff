package §]!7§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§9k§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§"L§ = this.§9k§.Normalize();
         this.§"!L§.Set(this.§9k§.y,-this.§9k§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§"!L§.x - this.§9k§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§"!L§.y - this.§9k§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§"!L§.x + this.§9k§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§"!L§.y + this.§9k§.y) + this.m_v2.y);
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§9l§(param3,this.m_v1);
         var _loc7_:b2Vec2 = b2Math.§9l§(param3,this.m_v2);
      ...
      public function §6o§() : b2EdgeShape
      {
         return this.§&!U§;
      }
      ...
      b2internal function §4d§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§&!U§ = param1;
      ...
      b2internal function §import§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§6r§ = param1;
