package §_-19§
{
   ...
   public class §_-GJ§
   {
      ...
      public static function §_-da§(param1:Stage) : void
      {
         ...
         §_-TQ§ = param1;
         ExternalInterface.call(§_-uv§);
         ExternalInterface.call(§_-jj§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §_-lD§ = ExternalInterface.call(§_-V6§,ExternalInterface.objectID);
         if(§_-lD§ == §_-aW§)
         {
            return;
         }
      ...
      public static function get §_-lK§() : int
      {
         return §_-lD§;
      }
      
      public static function get §_-n3§() : Boolean
      {
         return §_-Nl§;
      }
      
      public static function set §_-n3§(param1:Boolean) : void
      {
         §_-Nl§ = param1;
      }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §_-TQ§.getObjectsUnderPoint(new Point(§_-TQ§.mouseX,§_-TQ§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
