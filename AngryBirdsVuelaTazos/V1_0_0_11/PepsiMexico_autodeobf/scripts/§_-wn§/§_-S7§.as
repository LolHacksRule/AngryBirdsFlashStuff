package §_-wn§
{
   ...
   public class §_-S7§
   {
      ...
      private var §_-8k§:Dictionary;
      
      private var §_-Y0§:Dictionary;
      
      public function §_-S7§()
      {
         this.§_-Y0§ = new Dictionary();
         this.§_-8k§ = new Dictionary();
         super();
      }
      
      private function §_-tv§(param1:Class) : Vector.<Class>
      {
      ...
      public function §_-UT§(param1:Class, param2:Class, param3:Array) : void
      {
         var _loc4_:uint = param3.length;
         var _loc5_:uint = 0;
         while(_loc5_ < _loc4_)
         {
            this.§_-Vg§(param1,param2,param3[_loc5_]);
            _loc5_++;
         }
      }
      
      public function §_-aC§(param1:Class, param2:String) : Class
      {
         var _loc4_:* = undefined;
         var _loc3_:* = this.§_-Y0§[param1];
         if(_loc3_ != null)
         {
         ...
         this.§_-QX§(param1);
         return this.§_-aC§(param1,param2);
      }
      
      public function §_-Vg§(param1:Class, param2:Class, param3:String) : void
      {
         var _loc7_:uint = 0;
         var _loc8_:uint = 0;
         var _loc9_:Class = null;
         if(this.§_-Y0§[param2] == undefined)
         {
            this.§_-QX§(param2);
         }
         var _loc4_:Dictionary;
         var _loc5_:Class = (_loc4_ = this.§_-Y0§)[param2][param3] as Class;
         _loc4_[param2][param3] = param1;
         var _loc6_:Vector.<Class>;
         if((_loc6_ = this.§_-8k§[param2] as Vector.<Class>) != null)
         {
      ...
      private function §_-QX§(param1:Class) : void
      {
         ...
         var _loc2_:Dictionary = this.§_-Y0§;
         var _loc3_:Dictionary = this.§_-8k§;
         var _loc4_:Dictionary = new Dictionary();
         var _loc6_:uint;
         var _loc5_:Vector.<Class>;
         var _loc7_:int = _loc6_ = (_loc5_ = this.§_-tv§(param1)).length;
         while(--_loc7_ >= 0)
         {
