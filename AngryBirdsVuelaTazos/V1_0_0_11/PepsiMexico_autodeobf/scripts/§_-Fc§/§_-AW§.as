package §_-Fc§
{
   ...
   public class §_-AW§ extends §_-3D§ implements §_-Lz§
   {
      ...
      private var §_-Yr§:Number = 0;
      
      private var §_-v§:§_-i8§;
      
      public function §_-AW§(param1:Array, param2:§_-Y4§, param3:Number)
      {
         var _loc4_:uint = 0;
         var _loc5_:uint = 0;
         ...
         if(_loc4_ > 0)
         {
            ...
            §_-hZ§ += this.§_-qn§.duration;
            if(_loc4_ > 1)
            {
               this.§_-v§ = param1[1] as §_-i8§;
               §_-hZ§ += this.§_-v§.duration;
               if(_loc4_ > 2)
               {
                  this.§import§ = param1[2] as §_-i8§;
                  §_-hZ§ += this.§import§.duration;
                  if(_loc4_ > 3)
                  {
                     this.§_-gj§ = param1[3] as §_-i8§;
                     §_-hZ§ += this.§_-gj§.duration;
                     if(_loc4_ > 4)
                     {
      ...
      override protected function internalUpdate(param1:Number) : void
      {
         var _loc5_:uint = 0;
         var _loc6_:int = 0;
         var _loc7_:§_-i8§ = null;
         var _loc2_:Number = 0;
         var _loc3_:Number = 0;
         var _loc4_:Number = this.§_-Yr§;
         if(param1 - _loc4_ >= 0)
         {
            if(this.§_-qn§ != null)
            {
               if(_loc4_ <= (_loc2_ = _loc2_ + this.§_-qn§.duration) && _loc3_ <= param1)
               {
                  this.§_-qn§.update(param1 - _loc3_);
               }
               _loc3_ = _loc2_;
               if(this.§_-v§ != null)
               {
                  if(_loc4_ <= (_loc2_ = _loc2_ + this.§_-v§.duration) && _loc3_ <= param1)
                  {
                     this.§_-v§.update(param1 - _loc3_);
                  }
                  _loc3_ = _loc2_;
                  if(this.§import§ != null)
                  {
                     if(_loc4_ <= (_loc2_ = _loc2_ + this.§import§.duration) && _loc3_ <= param1)
                     {
                        this.§import§.update(param1 - _loc3_);
                     }
                     _loc3_ = _loc2_;
                     if(this.§_-gj§ != null)
                     {
                        if(_loc4_ <= (_loc2_ = _loc2_ + this.§_-gj§.duration) && _loc3_ <= param1)
                        {
                           this.§_-gj§.update(param1 - _loc3_);
                        }
                        _loc3_ = _loc2_;
                        if(this.§_-st§ != null)
                        {
                           _loc5_ = this.§_-st§.length;
                           _loc6_ = 0;
                           while(_loc6_ < _loc5_)
                           {
                              _loc7_ = this.§_-st§[_loc6_];
         ...
         else
         {
            ...
            if(this.§_-gj§ != null)
            {
               if(_loc4_ >= (_loc2_ = _loc2_ - this.§_-gj§.duration) && _loc3_ >= param1)
               {
                  this.§_-gj§.update(param1 - _loc2_);
               }
               _loc3_ = _loc2_;
            }
            if(this.§import§ != null)
            {
               if(_loc4_ >= (_loc2_ = _loc2_ - this.§import§.duration) && _loc3_ >= param1)
               {
                  this.§import§.update(param1 - _loc2_);
               }
               _loc3_ = _loc2_;
            }
            if(this.§_-v§ != null)
            ...
            if(this.§_-qn§ != null)
            {
               if(_loc4_ >= (_loc2_ = _loc2_ - this.§_-qn§.duration) && _loc3_ >= param1)
               {
                  this.§_-qn§.update(param1 - _loc2_);
               }
               _loc3_ = _loc2_;
            }
         }
