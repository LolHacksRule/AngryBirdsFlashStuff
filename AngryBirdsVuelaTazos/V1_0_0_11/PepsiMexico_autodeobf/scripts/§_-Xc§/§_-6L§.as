package §_-Xc§
{
   ...
   public class §_-6L§ extends §_-Yd§
   {
       
      
      public function §_-6L§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§_-Wj§(param1,param2);
      }
      
      protected function §_-Wj§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc3_:Dictionary = this.§_-Zg§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if(_loc10_ = _loc3_[this.§_-RA§(_loc7_,_loc6_)])
            {
               _loc11_ = new Rectangle(_loc8_ + _loc10_.x,_loc9_ + _loc10_.y,_loc10_.width,_loc10_.height);
               (_loc12_ = new §_-39§()).mName = _loc6_;
               _loc12_.§_-LD§ = _loc11_;
               _loc12_.§_-oy§ = _loc10_.pivotX;
               _loc12_.§_-Pk§ = _loc10_.pivotY;
               _loc12_.§_-Et§ = §_-M§;
               §_-vB§(_loc12_);
            }
         }
      ...
      private function §_-RA§(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function §_-Zg§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§_-RA§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §_-Jh§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
