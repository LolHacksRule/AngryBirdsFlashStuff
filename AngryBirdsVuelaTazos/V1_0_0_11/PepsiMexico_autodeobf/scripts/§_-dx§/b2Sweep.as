package §_-dx§
{
   public class b2Sweep
   {
      ...
      public function Copy() : b2Sweep
      {
         ...
         _loc1_.a0 = this.a0;
         _loc1_.a = this.a;
         _loc1_.§_-Oc§ = this.§_-Oc§;
         return _loc1_;
      }
      
      public function §_-LW§(param1:b2Transform, param2:Number) : void
      {
      ...
      public function §_-N9§(param1:Number) : void
      {
         ...
         if(this.§_-Oc§ < param1 && 1 - this.§_-Oc§ > Number.MIN_VALUE)
         {
            _loc2_ = (param1 - this.§_-Oc§) / (1 - this.§_-Oc§);
