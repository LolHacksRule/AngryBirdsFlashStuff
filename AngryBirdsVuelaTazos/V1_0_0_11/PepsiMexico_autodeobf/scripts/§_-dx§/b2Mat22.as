package §_-dx§
{
   public class b2Mat22
   {
      ...
      public static function §_-59§(param1:Number) : b2Mat22
      {
      ...
      public static function §_-um§(param1:b2Vec2, param2:b2Vec2) : b2Mat22
      {
         var _loc3_:b2Mat22 = new b2Mat22();
         _loc3_.§_-d4§(param1,param2);
         return _loc3_;
      }
      ...
      public function §_-d4§(param1:b2Vec2, param2:b2Vec2) : void
      {
      ...
      public function §_-JX§(param1:b2Mat22) : void
      {
         this.col1.SetV(param1.col1);
         this.col2.SetV(param1.col2);
      }
      
      public function §_-hU§(param1:b2Mat22) : void
      {
      ...
      public function §_-Hd§(param1:b2Mat22) : b2Mat22
      {
      ...
      public function §_-Ok§(param1:b2Vec2, param2:Number, param3:Number) : b2Vec2
      {
