package §_-E6§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§_-TC§.x * this.§_-F4§.x + (this.§_-OB§ + this.§_-TC§.z) * this.§_-oP§.x),param1 * (this.§_-TC§.x * this.§_-F4§.y + (this.§_-OB§ + this.§_-TC§.z) * this.§_-oP§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§_-ay§ > Number.MIN_VALUE)
         {
            this.§_-ay§ = 1 / this.§_-ay§;
         }
         ...
         this.§_-kv§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§_-kv§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§_-kv§.col2.x = this.§_-kv§.col1.y;
         this.§_-kv§.col2.y = _loc16_ + _loc17_;
         this.§_-kv§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§_-kv§.col3.x = this.§_-kv§.col1.z;
         this.§_-kv§.col3.y = this.§_-kv§.col2.z;
         this.§_-kv§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§_-Th§)
         {
         ...
         if(param1.§_-xV§)
         {
            ...
            _loc19_ = this.§_-TC§.x * this.§_-F4§.x + (this.§_-OB§ + this.§_-TC§.z) * this.§_-oP§.x;
            _loc20_ = this.§_-TC§.x * this.§_-F4§.y + (this.§_-OB§ + this.§_-TC§.z) * this.§_-oP§.y;
            _loc21_ = this.§_-TC§.x * this.m_s1 + this.§_-TC§.y + (this.§_-OB§ + this.§_-TC§.z) * this.m_a1;
            _loc22_ = this.§_-TC§.x * this.m_s2 + this.§_-TC§.y + (this.§_-OB§ + this.§_-TC§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§_-oP§.x * (_loc6_.x - _loc4_.x) + this.§_-oP§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§_-ay§ * (this.§_-lP§ - _loc14_);
            _loc16_ = this.§_-OB§;
            _loc17_ = param1.§_-a9§ * this.§_-BN§;
            this.§_-OB§ = b2Math.§_-k3§(this.§_-OB§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§_-OB§ - _loc16_) * this.§_-oP§.x;
            _loc9_ = _loc15_ * this.§_-oP§.y;
         ...
         {
            _loc18_ = this.§_-oP§.x * (_loc6_.x - _loc4_.x) + this.§_-oP§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§_-TC§.Copy();
            _loc20_ = this.§_-kv§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§_-TC§.§_-7H§(_loc20_);
            if(this.§_-N0§ == b2internal::_-lg)
            {
               this.§_-TC§.z = b2Math.§_-Cz§(this.§_-TC§.z,0);
            }
            else if(this.§_-N0§ == b2internal::_-pq)
            {
               this.§_-TC§.z = b2Math.§_-Li§(this.§_-TC§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§_-TC§.z - _loc19_.z) * this.§_-kv§.col3.x;
            _loc22_ = -_loc13_ - (this.§_-TC§.z - _loc19_.z) * this.§_-kv§.col3.y;
            _loc23_ = this.§_-kv§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§_-TC§.x = _loc23_.x;
            this.§_-TC§.y = _loc23_.y;
            _loc20_.x = this.§_-TC§.x - _loc19_.x;
            _loc20_.y = this.§_-TC§.y - _loc19_.y;
            _loc20_.z = this.§_-TC§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§_-F4§.x + _loc20_.z * this.§_-oP§.x;
            _loc9_ = _loc20_.x * this.§_-F4§.y + _loc20_.z * this.§_-oP§.y;
         ...
         {
            _loc24_ = this.§_-kv§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§_-TC§.x += _loc24_.x;
            this.§_-TC§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§_-F4§.x;
            _loc9_ = _loc24_.x * this.§_-F4§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§_-Th§)
         {
            ...
            _loc35_ = this.§_-oP§.x * _loc26_ + this.§_-oP§.y * _loc27_;
            if(b2Math.§_-2l§(this.§_-ou§ - this.§_-b1§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§_-k3§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§_-2l§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§_-b1§)
            {
               _loc19_ = b2Math.§_-k3§(_loc35_ - this.§_-b1§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§_-b1§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§_-ou§)
            {
               _loc19_ = b2Math.§_-k3§(_loc35_ - this.§_-ou§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§_-ou§;
               _loc18_ = true;
            }
         }
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§_-fc§;
         _loc16_ = b2Math.§_-Cz§(_loc16_,b2Math.§_-2l§(_loc29_));
         _loc17_ = b2Math.§_-2l§(_loc30_);
         if(_loc18_)
         {
            ...
            this.§_-kv§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§_-kv§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§_-kv§.col2.x = this.§_-kv§.col1.y;
            this.§_-kv§.col2.y = _loc14_ + _loc15_;
            this.§_-kv§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§_-kv§.col3.x = this.§_-kv§.col1.z;
            this.§_-kv§.col3.y = this.§_-kv§.col2.z;
            this.§_-kv§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§_-kv§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::_-lT;
            ...
            this.§_-kv§.col1.Set(_loc36_,_loc37_,0);
            this.§_-kv§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§_-kv§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§_-F4§.x + _loc28_.z * this.§_-oP§.x;
         var _loc32_:Number = _loc28_.x * this.§_-F4§.y + _loc28_.z * this.§_-oP§.y;
         ...
         _loc6_.x -= b2internal::_-lT * _loc31_;
         _loc6_.y -= b2internal::_-lT * _loc32_;
         _loc7_ -= b2internal::_-lc * _loc33_;
         _loc8_.x += b2internal::_-vb * _loc31_;
         _loc8_.y += b2internal::_-vb * _loc32_;
         _loc9_ += b2internal::_-n0 * _loc34_;
