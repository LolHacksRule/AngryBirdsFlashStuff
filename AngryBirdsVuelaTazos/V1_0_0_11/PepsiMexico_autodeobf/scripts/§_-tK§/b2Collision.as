package §_-tK§
{
   ...
   public class b2Collision
   {
      ...
      private static var §_-jL§:Vector.<§_-Rf§> = §_-Pb§();
      
      private static var s_clipPoints1:Vector.<§_-Rf§> = §_-Pb§();
      
      private static var s_clipPoints2:Vector.<§_-Rf§> = §_-Pb§();
      
      private static var §_-rM§:Vector.<int> = new Vector.<int>(1);
      
      private static var §_-vH§:Vector.<int> = new Vector.<int>(1);
      
      private static var §_-ca§:b2Vec2 = new b2Vec2();
      
      private static var §_-4i§:b2Vec2 = new b2Vec2();
      
      private static var §_-mm§:b2Vec2 = new b2Vec2();
      
      private static var §_-p8§:b2Vec2 = new b2Vec2();
      
      private static var §_-Up§:b2Vec2 = new b2Vec2();
      ...
      public static function §_-lH§(param1:Vector.<§_-Rf§>, param2:Vector.<§_-Rf§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§_-Rf§ = null;
         var _loc6_:int = 0;
         var _loc7_:b2Vec2 = null;
         var _loc9_:Number = NaN;
         var _loc11_:Number = NaN;
         var _loc12_:b2Vec2 = null;
         var _loc13_:§_-Rf§ = null;
         _loc6_ = 0;
      ...
      public static function §_-pi§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§_-gy§;
         var _loc7_:Vector.<b2Vec2> = param1.§_-n6§;
         var _loc8_:Vector.<b2Vec2> = param1.§_-UB§;
         var _loc9_:int = param4.§_-gy§;
         var _loc10_:Vector.<b2Vec2> = param4.§_-n6§;
         _loc11_ = param2.R;
      ...
      public static function §_-va§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§_-gy§;
         var _loc7_:Vector.<b2Vec2> = param2.§_-UB§;
         _loc9_ = param5.R;
         _loc8_ = param4.§_-XI§;
         ...
         var _loc17_:Number = §_-pi§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §_-pi§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §_-pi§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §_-pi§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §_-qj§(param1:Vector.<§_-Rf§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§_-Rf§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§_-gy§;
         var _loc8_:Vector.<b2Vec2> = param2.§_-UB§;
         var _loc9_:int = param5.§_-gy§;
         var _loc10_:Vector.<b2Vec2> = param5.§_-n6§;
         var _loc11_:Vector.<b2Vec2> = param5.§_-UB§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§_-Fu§.§_-hI§ = param4;
         _loc20_.id.§_-Fu§.§_-Cq§ = _loc21_;
         _loc20_.id.§_-Fu§.§_-a3§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§_-Fu§.§_-hI§ = param4;
         _loc20_.id.§_-Fu§.§_-Cq§ = _loc22_;
         _loc20_.id.§_-Fu§.§_-a3§ = 1;
      }
      
      private static function §_-Pb§() : Vector.<§_-Rf§>
      {
         var _loc1_:Vector.<§_-Rf§> = new Vector.<§_-Rf§>(2);
         _loc1_[0] = new §_-Rf§();
         _loc1_[1] = new §_-Rf§();
         return _loc1_;
      }
      
      public static function §_-Gc§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§_-Rf§ = null;
         ...
         param1.§_-sx§ = 0;
         var _loc7_:Number = param2.§_-8z§ + param4.§_-8z§;
         var _loc8_:int = 0;
         §_-rM§[0] = _loc8_;
         var _loc9_:Number = §_-va§(§_-rM§,param2,param3,param4,param5);
         _loc8_ = §_-rM§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §_-vH§[0] = _loc10_;
         var _loc11_:Number = §_-va§(§_-vH§,param4,param5,param2,param3);
         _loc10_ = §_-vH§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§_-9f§ = b2Manifold.§_-3S§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§_-Rf§> = §_-jL§;
         §_-qj§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§_-gy§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§_-n6§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §_-ca§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §_-4i§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §_-mm§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §_-Up§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§_-Rf§> = s_clipPoints1;
         var _loc38_:Vector.<§_-Rf§> = s_clipPoints2;
         if((_loc39_ = §_-lH§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §_-lH§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§_-lj§.SetV(_loc27_);
         ...
         while(_loc41_ < b2Settings.b2_maxManifoldPoints)
         {
            ...
            if((_loc42_ = _loc31_.x * _loc6_.v.x + _loc31_.y * _loc6_.v.y - _loc34_) <= _loc7_)
            {
               ...
               _loc43_.m_id.§_-Fu§.§_-G8§ = _loc17_;
               _loc40_++;
            }
            _loc41_++;
         }
      ...
      public static function §_-Z4§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§_-8z§ + param4.§_-8z§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§_-9f§ = b2Manifold.§_-DR§;
         param1.m_localPoint.SetV(param2.§_-B1§);
         param1.§_-lj§.§_-pZ§();
         param1.§_-sx§ = 1;
         param1.§_-of§[0].m_localPoint.SetV(param4.§_-B1§);
         param1.§_-of§[0].m_id.key = 0;
      }
      
      public static function §_-RY§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§_-8z§ + param4.§_-8z§;
         var _loc21_:int = param2.§_-gy§;
         var _loc22_:Vector.<b2Vec2> = param2.§_-n6§;
         var _loc23_:Vector.<b2Vec2> = param2.§_-UB§;
         var _loc24_:int = 0;
         ...
         if(_loc19_ < Number.MIN_VALUE)
         {
            param1.§_-sx§ = 1;
            param1.§_-9f§ = b2Manifold.§_-3S§;
            param1.§_-lj§.SetV(_loc23_[_loc18_]);
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§_-sx§ = 1;
            param1.§_-9f§ = b2Manifold.§_-3S§;
            param1.§_-lj§.x = _loc15_ - _loc27_.x;
            param1.§_-lj§.y = _loc16_ - _loc27_.y;
            param1.§_-lj§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§_-sx§ = 1;
            param1.§_-9f§ = b2Manifold.§_-3S§;
            param1.§_-lj§.x = _loc15_ - _loc28_.x;
            param1.§_-lj§.y = _loc16_ - _loc28_.y;
            param1.§_-lj§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§_-of§[0].m_localPoint.SetV(param4.§_-B1§);
            param1.§_-of§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§_-sx§ = 1;
            param1.§_-9f§ = b2Manifold.§_-3S§;
            param1.§_-lj§.x = _loc23_[_loc25_].x;
            param1.§_-lj§.y = _loc23_[_loc25_].y;
            param1.§_-lj§.Normalize();
      ...
      public static function §_-9u§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§_-eZ§;
         var _loc4_:b2Vec2 = param1.§_-ad§;
