package §_-26§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §_-rA§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §_-XI§:b2Vec2;
      
      b2internal var §_-n6§:Vector.<b2Vec2>;
      
      b2internal var §_-UB§:Vector.<b2Vec2>;
      
      b2internal var §_-gy§:int;
      
      public function b2PolygonShape()
      {
         super();
         §_-9f§ = b2internal::_-fB;
         this.§_-XI§ = new b2Vec2();
         this.§_-n6§ = new Vector.<b2Vec2>();
         this.§_-UB§ = new Vector.<b2Vec2>();
         §_-8z§ = b2Settings.b2_polygonRadius;
         this.§_-XI§.§_-pZ§();
      }
      
      public static function §_-Vk§(param1:Array, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-ap§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-h§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-Iu§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-A-§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-B8§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-o0§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§_-vl§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §_-OF§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-HM§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-M2§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§_-7H§(new b2Vec2(0,0));
            _loc3_.§_-7H§(_loc9_);
            _loc3_.§_-7H§(_loc10_);
            _loc3_.§_-Lp§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §_-5h§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§_-Wv§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§_-Wv§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§_-XI§.SetV(_loc2_.§_-XI§);
            this.§_-gy§ = _loc2_.§_-gy§;
            this.§_-ms§(this.§_-gy§);
            _loc3_ = 0;
            while(_loc3_ < this.§_-gy§)
            {
               this.§_-n6§[_loc3_].SetV(_loc2_.§_-n6§[_loc3_]);
               this.§_-UB§[_loc3_].SetV(_loc2_.§_-UB§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §_-ap§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§_-Iu§(_loc3_,param2);
      }
      
      public function §_-Iu§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§_-gy§)
         {
            this.§_-n6§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§_-gy§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§_-gy§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§_-L6§(this.§_-n6§[_loc5_],this.§_-n6§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§_-u4§() > Number.MIN_VALUE);
            this.§_-UB§[_loc3_].SetV(b2Math.§_-eh§(_loc6_,1));
            this.§_-UB§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§_-XI§ = §_-M2§(this.§_-n6§,this.§_-gy§);
      }
      
      public function §_-B8§(param1:Number, param2:Number) : void
      {
         this.§_-gy§ = 4;
         this.§_-ms§(4);
         this.§_-n6§[0].Set(-param1,-param2);
         this.§_-n6§[1].Set(param1,-param2);
         this.§_-n6§[2].Set(param1,param2);
         this.§_-n6§[3].Set(-param1,param2);
         this.§_-UB§[0].Set(0,-1);
         this.§_-UB§[1].Set(1,0);
         this.§_-UB§[2].Set(0,1);
         this.§_-UB§[3].Set(-1,0);
      ...
      public function §_-vl§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§_-gy§ = 4;
         this.§_-ms§(4);
         this.§_-n6§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§_-gy§)
         {
            this.§_-n6§[_loc6_] = b2Math.§_-nn§(_loc5_,this.§_-n6§[_loc6_]);
            this.§_-UB§[_loc6_] = b2Math.§_-IM§(_loc5_.R,this.§_-UB§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §_-HM§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§_-gy§ = 2;
         this.§_-ms§(2);
         this.§_-n6§[0].SetV(param1);
         this.§_-n6§[1].SetV(param2);
         this.§_-XI§.x = 0.5 * (param1.x + param2.x);
         this.§_-XI§.y = 0.5 * (param1.y + param2.y);
         this.§_-UB§[0] = b2Math.§_-eh§(b2Math.§_-L6§(param2,param1),1);
         this.§_-UB§[0].Normalize();
         this.§_-UB§[1].x = -this.§_-UB§[0].x;
         this.§_-UB§[1].y = -this.§_-UB§[0].y;
      }
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < this.§_-gy§)
         {
            _loc3_ = this.§_-n6§[_loc9_];
            _loc5_ = _loc7_ - _loc3_.x;
            _loc6_ = _loc8_ - _loc3_.y;
            _loc3_ = this.§_-UB§[_loc9_];
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§_-gy§)
         {
            _loc6_ = (_loc9_ = this.§_-n6§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§_-UB§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§_-eZ§.x = _loc5_ - b2internal::_-8z;
         param1.§_-eZ§.y = _loc6_ - b2internal::_-8z;
         param1.§_-ad§.x = _loc7_ + b2internal::_-8z;
         param1.§_-ad§.y = _loc8_ + b2internal::_-8z;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§_-gy§ == 2)
         {
            param1.center.x = 0.5 * (this.§_-n6§[0].x + this.§_-n6§[1].x);
            param1.center.y = 0.5 * (this.§_-n6§[0].y + this.§_-n6§[1].y);
            param1.§_-YY§ = 0;
            param1.§_-A1§ = 0;
            return;
         }
         ...
         var _loc6_:Number = 0;
         var _loc10_:int = 0;
         while(_loc10_ < this.§_-gy§)
         {
            _loc11_ = this.§_-n6§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§_-gy§ ? this.§_-n6§[int(_loc10_ + 1)] : this.§_-n6§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§_-YY§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§_-A1§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§_-vC§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§_-I1§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§_-gy§)
         {
            _loc7_[_loc12_] = b2Math.§_-I1§(_loc5_,this.§_-n6§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§_-nn§(param3,_loc24_.center));
                  return _loc24_.§_-YY§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§_-gy§;
         var _loc14_:int = (_loc10_ + 1) % this.§_-gy§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§_-n6§[_loc9_].x * (1 - _loc15_) + this.§_-n6§[_loc13_].x * _loc15_,this.§_-n6§[_loc9_].y * (1 - _loc15_) + this.§_-n6§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§_-n6§[_loc10_].x * (1 - _loc16_) + this.§_-n6§[_loc14_].x * _loc16_,this.§_-n6§[_loc10_].y * (1 - _loc16_) + this.§_-n6§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§_-n6§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§_-gy§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§_-n6§[_loc12_];
            }
         ...
         _loc20_.§_-Lp§(1 / _loc19_);
         param4.SetV(b2Math.§_-nn§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §_-so§() : Vector.<b2Vec2>
      {
         return this.§_-n6§;
      }
      
      public function §_-fL§() : Vector.<b2Vec2>
      {
         return this.§_-UB§;
      }
      
      public function §_-na§(param1:b2Vec2) : int
      {
         var _loc5_:Number = NaN;
         var _loc2_:int = 0;
         var _loc3_:Number = this.§_-n6§[0].x * param1.x + this.§_-n6§[0].y * param1.y;
         var _loc4_:int = 1;
         while(_loc4_ < this.§_-gy§)
         {
      ...
      private function §_-Iz§() : Boolean
      {
         return false;
      }
      
      private function §_-ms§(param1:int) : void
      {
         var _loc2_:int = this.§_-n6§.length;
         while(_loc2_ < param1)
         {
            this.§_-n6§[_loc2_] = new b2Vec2();
            this.§_-UB§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
