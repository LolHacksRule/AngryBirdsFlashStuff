package §_-lG§
{
   ...
   public class §_-Z9§
   {
      ...
      public static var §_-Dy§:ByteArray;
      ...
      public static function §_-Wt§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-sX§(_loc2_);
         return §_-ed§.§_-bU§(_loc3_.readInt(),true) + §_-ed§.§_-bU§(_loc3_.readInt(),true) + §_-ed§.§_-bU§(_loc3_.readInt(),true) + §_-ed§.§_-bU§(_loc3_.readInt(),true) + §_-ed§.§_-bU§(_loc3_.readInt(),true);
      }
      
      public static function §_-lw§(param1:ByteArray) : String
      {
         var _loc2_:Array = §_-Z9§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §_-sX§(_loc2_);
         return §_-ed§.§_-bU§(_loc3_.readInt(),true) + §_-ed§.§_-bU§(_loc3_.readInt(),true) + §_-ed§.§_-bU§(_loc3_.readInt(),true) + §_-ed§.§_-bU§(_loc3_.readInt(),true) + §_-ed§.§_-bU§(_loc3_.readInt(),true);
      }
      
      public static function §_-FR§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §_-Z9§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-sX§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §_-sX§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
