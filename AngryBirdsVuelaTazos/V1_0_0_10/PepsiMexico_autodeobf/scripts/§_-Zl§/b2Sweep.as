package §_-Zl§
{
   public class b2Sweep
   {
      ...
      public function Copy() : b2Sweep
      {
         ...
         _loc1_.a0 = this.a0;
         _loc1_.a = this.a;
         _loc1_.§_-eq§ = this.§_-eq§;
         return _loc1_;
      }
      
      public function §_-9F§(param1:b2Transform, param2:Number) : void
      {
      ...
      public function §_-d5§(param1:Number) : void
      {
         var _loc2_:Number = NaN;
         if(this.§_-eq§ < param1 && 1 - this.§_-eq§ > Number.MIN_VALUE)
         {
            _loc2_ = (param1 - this.§_-eq§) / (1 - this.§_-eq§);
