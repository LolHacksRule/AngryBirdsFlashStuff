package §_-rM§
{
   ...
   public class §_-1E§
   {
      ...
      private var §_-qW§:Dictionary;
      
      private var §_-a2§:Dictionary;
      
      public function §_-1E§()
      {
         this.§_-a2§ = new Dictionary();
         this.§_-qW§ = new Dictionary();
         super();
      }
      
      private function §_-lB§(param1:Class) : Vector.<Class>
      {
      ...
      public function §_-v4§(param1:Class, param2:Class, param3:Array) : void
      {
         var _loc4_:uint = param3.length;
         var _loc5_:uint = 0;
         while(_loc5_ < _loc4_)
         {
            this.§_-4Y§(param1,param2,param3[_loc5_]);
            _loc5_++;
         }
      }
      
      public function §_-b2§(param1:Class, param2:String) : Class
      {
         var _loc4_:* = undefined;
         var _loc3_:* = this.§_-a2§[param1];
         if(_loc3_ != null)
         {
         ...
         this.§_-wU§(param1);
         return this.§_-b2§(param1,param2);
      }
      
      public function §_-4Y§(param1:Class, param2:Class, param3:String) : void
      {
         var _loc7_:uint = 0;
         var _loc8_:uint = 0;
         var _loc9_:Class = null;
         if(this.§_-a2§[param2] == undefined)
         {
            this.§_-wU§(param2);
         }
         var _loc4_:Dictionary;
         var _loc5_:Class = (_loc4_ = this.§_-a2§)[param2][param3] as Class;
         _loc4_[param2][param3] = param1;
         var _loc6_:Vector.<Class>;
         if((_loc6_ = this.§_-qW§[param2] as Vector.<Class>) != null)
         {
      ...
      private function §_-wU§(param1:Class) : void
      {
         ...
         var _loc2_:Dictionary = this.§_-a2§;
         var _loc3_:Dictionary = this.§_-qW§;
         var _loc4_:Dictionary = new Dictionary();
         var _loc6_:uint;
         var _loc5_:Vector.<Class>;
         var _loc7_:int = _loc6_ = (_loc5_ = this.§_-lB§(param1)).length;
         while(--_loc7_ >= 0)
         {
