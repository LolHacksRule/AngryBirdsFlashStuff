package §_-I2§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      b2internal var §_-ct§:Number;
      
      b2internal var §_-X4§:b2Vec2;
      
      b2internal var §_-MC§:b2Vec2;
      ...
      b2internal var §_-Y3§:b2EdgeShape;
      
      b2internal var §_-8t§:b2EdgeShape;
      
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         this.§_-HN§ = new b2Vec2();
         this.m_v1 = new b2Vec2();
         this.m_v2 = new b2Vec2();
         this.m_coreV1 = new b2Vec2();
         this.m_coreV2 = new b2Vec2();
         this.§_-X4§ = new b2Vec2();
         this.§_-MC§ = new b2Vec2();
         this.m_cornerDir1 = new b2Vec2();
         this.m_cornerDir2 = new b2Vec2();
         super();
         §_-K9§ = b2internal::_-bK;
         this.§_-8t§ = null;
         this.§_-Y3§ = null;
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§_-MC§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§_-ct§ = this.§_-MC§.Normalize();
         this.§_-X4§.Set(this.§_-MC§.y,-this.§_-MC§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§_-X4§.x - this.§_-MC§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§_-X4§.y - this.§_-MC§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§_-X4§.x + this.§_-MC§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§_-X4§.y + this.§_-MC§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§_-X4§;
         this.m_cornerDir2.Set(-this.§_-X4§.x,-this.§_-X4§.y);
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§_-pC§ * _loc12_)
            {
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         if(_loc4_ < _loc6_)
         {
            param1.§_-nx§.x = _loc4_;
            param1.§_-u6§.x = _loc6_;
         }
         else
         {
            param1.§_-nx§.x = _loc6_;
            param1.§_-u6§.x = _loc4_;
         }
         if(_loc5_ < _loc7_)
         {
            param1.§_-nx§.y = _loc5_;
            param1.§_-u6§.y = _loc7_;
         }
         else
         {
            param1.§_-nx§.y = _loc7_;
            param1.§_-u6§.y = _loc5_;
         }
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§_-Oi§(param3,this.m_v1);
         var _loc7_:b2Vec2 = b2Math.§_-Oi§(param3,this.m_v2);
         var _loc8_:Number = b2Math.§_-Uf§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§_-Uf§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §_-5H§() : b2Vec2
      {
         return this.§_-X4§;
      }
      
      public function §_-Fg§() : b2Vec2
      {
         return this.§_-MC§;
      }
      ...
      public function §_-GB§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §_-TI§() : b2EdgeShape
      {
         return this.§_-Y3§;
      }
      
      public function §_-7v§() : b2EdgeShape
      {
         return this.§_-8t§;
      }
      
      public function §_-Kk§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
      ...
      b2internal function §_-Uj§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§_-8t§ = param1;
      ...
      b2internal function §_-we§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§_-Y3§ = param1;
