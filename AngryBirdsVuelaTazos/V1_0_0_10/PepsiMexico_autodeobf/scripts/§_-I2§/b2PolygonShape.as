package §_-I2§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §_-5F§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §_-jn§:b2Vec2;
      
      b2internal var §_-3A§:Vector.<b2Vec2>;
      
      b2internal var §_-iY§:Vector.<b2Vec2>;
      
      b2internal var §_-om§:int;
      
      public function b2PolygonShape()
      {
         super();
         §_-K9§ = b2internal::_-Sw;
         this.§_-jn§ = new b2Vec2();
         this.§_-3A§ = new Vector.<b2Vec2>();
         this.§_-iY§ = new Vector.<b2Vec2>();
         §_-Bn§ = b2Settings.b2_polygonRadius;
         this.§_-jn§.§_-Vw§();
      }
      
      public static function §_-MU§(param1:Array, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-Vf§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-MX§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §_-o9§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-GY§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-bU§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§_-kd§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §_-Fh§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-of§(param1,param2);
         return _loc3_;
      }
      
      public static function §try§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§_-Ec§(new b2Vec2(0,0));
            _loc3_.§_-Ec§(_loc9_);
            _loc3_.§_-Ec§(_loc10_);
            _loc3_.§_-v8§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §_-iS§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§_-mM§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§_-mM§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§_-jn§.SetV(_loc2_.§_-jn§);
            this.§_-om§ = _loc2_.§_-om§;
            this.§_-nD§(this.§_-om§);
            _loc3_ = 0;
            while(_loc3_ < this.§_-om§)
            {
               this.§_-3A§[_loc3_].SetV(_loc2_.§_-3A§[_loc3_]);
               this.§_-iY§[_loc3_].SetV(_loc2_.§_-iY§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §_-Vf§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§_-sb§(_loc3_,param2);
      }
      
      public function §_-sb§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§_-om§)
         {
            this.§_-3A§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§_-om§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§_-om§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§_-Fu§(this.§_-3A§[_loc5_],this.§_-3A§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§_-QN§() > Number.MIN_VALUE);
            this.§_-iY§[_loc3_].SetV(b2Math.§_-gX§(_loc6_,1));
            this.§_-iY§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§_-jn§ = §try§(this.§_-3A§,this.§_-om§);
      }
      
      public function §_-GY§(param1:Number, param2:Number) : void
      {
         this.§_-om§ = 4;
         this.§_-nD§(4);
         this.§_-3A§[0].Set(-param1,-param2);
         this.§_-3A§[1].Set(param1,-param2);
         this.§_-3A§[2].Set(param1,param2);
         this.§_-3A§[3].Set(-param1,param2);
         this.§_-iY§[0].Set(0,-1);
         this.§_-iY§[1].Set(1,0);
         this.§_-iY§[2].Set(0,1);
         this.§_-iY§[3].Set(-1,0);
      ...
      public function §_-kd§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§_-om§ = 4;
         this.§_-nD§(4);
         this.§_-3A§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§_-om§)
         {
            this.§_-3A§[_loc6_] = b2Math.§_-Oi§(_loc5_,this.§_-3A§[_loc6_]);
            this.§_-iY§[_loc6_] = b2Math.§_-KM§(_loc5_.R,this.§_-iY§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §_-of§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§_-om§ = 2;
         this.§_-nD§(2);
         this.§_-3A§[0].SetV(param1);
         this.§_-3A§[1].SetV(param2);
         this.§_-jn§.x = 0.5 * (param1.x + param2.x);
         this.§_-jn§.y = 0.5 * (param1.y + param2.y);
         this.§_-iY§[0] = b2Math.§_-gX§(b2Math.§_-Fu§(param2,param1),1);
         this.§_-iY§[0].Normalize();
         this.§_-iY§[1].x = -this.§_-iY§[0].x;
         this.§_-iY§[1].y = -this.§_-iY§[0].y;
      }
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < this.§_-om§)
         {
            _loc3_ = this.§_-3A§[_loc9_];
            _loc5_ = _loc7_ - _loc3_.x;
            _loc6_ = _loc8_ - _loc3_.y;
            _loc3_ = this.§_-iY§[_loc9_];
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§_-om§)
         {
            _loc6_ = (_loc9_ = this.§_-3A§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§_-iY§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§_-nx§.x = _loc5_ - b2internal::_-Bn;
         param1.§_-nx§.y = _loc6_ - b2internal::_-Bn;
         param1.§_-u6§.x = _loc7_ + b2internal::_-Bn;
         param1.§_-u6§.y = _loc8_ + b2internal::_-Bn;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§_-om§ == 2)
         {
            param1.center.x = 0.5 * (this.§_-3A§[0].x + this.§_-3A§[1].x);
            param1.center.y = 0.5 * (this.§_-3A§[0].y + this.§_-3A§[1].y);
            param1.§_-Un§ = 0;
            param1.§_-0D§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§_-om§)
         {
            _loc11_ = this.§_-3A§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§_-om§ ? this.§_-3A§[int(_loc10_ + 1)] : this.§_-3A§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§_-Un§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§_-0D§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§_-vG§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§_-Uf§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§_-om§)
         {
            _loc7_[_loc12_] = b2Math.§_-Uf§(_loc5_,this.§_-3A§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§_-Oi§(param3,_loc24_.center));
                  return _loc24_.§_-Un§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§_-om§;
         var _loc14_:int = (_loc10_ + 1) % this.§_-om§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§_-3A§[_loc9_].x * (1 - _loc15_) + this.§_-3A§[_loc13_].x * _loc15_,this.§_-3A§[_loc9_].y * (1 - _loc15_) + this.§_-3A§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§_-3A§[_loc10_].x * (1 - _loc16_) + this.§_-3A§[_loc14_].x * _loc16_,this.§_-3A§[_loc10_].y * (1 - _loc16_) + this.§_-3A§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§_-3A§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§_-om§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§_-3A§[_loc12_];
            }
         ...
         _loc20_.§_-v8§(1 / _loc19_);
         param4.SetV(b2Math.§_-Oi§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §_-Ua§() : Vector.<b2Vec2>
      {
         return this.§_-3A§;
      }
      ...
      {
         var _loc2_:int = this.§_-3A§.length;
         while(_loc2_ < param1)
         {
            this.§_-3A§[_loc2_] = new b2Vec2();
            this.§_-iY§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
