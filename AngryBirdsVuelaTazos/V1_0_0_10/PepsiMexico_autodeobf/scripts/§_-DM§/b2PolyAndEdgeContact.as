package §_-DM§
{
   ...
   public class b2PolyAndEdgeContact extends b2Contact
   {
      ...
      public function §_-t3§(param1:b2Fixture, param2:b2Fixture) : void
      {
         ...
         b2Settings.b2Assert(param2.§_-Iy§() == b2Shape.§_-bK§);
      }
      ...
      override b2internal function Evaluate() : void
      {
         ...
         this.§_-ew§(b2internal::_-R2,b2internal::_-di.GetShape() as b2PolygonShape,_loc1_.m_xf,b2internal::include.GetShape() as b2EdgeShape,_loc2_.m_xf);
      }
      
      private function §_-ew§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2EdgeShape, param5:b2Transform) : void
      {
      }
   }
}
