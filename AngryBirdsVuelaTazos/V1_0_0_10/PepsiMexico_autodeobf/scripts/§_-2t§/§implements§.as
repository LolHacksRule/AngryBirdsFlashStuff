package §_-2t§
{
   public class §implements§
   {
      ...
      public static function §_-Yu§(param1:String) : String
      {
         if(§_-r7§[param1])
         {
            return §_-r7§[param1];
         }
         return §_-r7§.UNEXPECTED_ERROR;
      }
      
      public static function §_-Qk§(param1:String) : String
      {
         switch(param1)
         {
            case "nickName":
