package §_-r5§
{
   ...
   public class §_-mU§
   {
      ...
      public static var §_-h7§:ByteArray;
      ...
      public static function §_-CK§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-EJ§(_loc2_);
         return §_-lb§.§_-GX§(_loc3_.readInt(),true) + §_-lb§.§_-GX§(_loc3_.readInt(),true) + §_-lb§.§_-GX§(_loc3_.readInt(),true) + §_-lb§.§_-GX§(_loc3_.readInt(),true) + §_-lb§.§_-GX§(_loc3_.readInt(),true);
      }
      
      public static function §_-sk§(param1:ByteArray) : String
      {
         var _loc2_:Array = §_-mU§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §_-EJ§(_loc2_);
         return §_-lb§.§_-GX§(_loc3_.readInt(),true) + §_-lb§.§_-GX§(_loc3_.readInt(),true) + §_-lb§.§_-GX§(_loc3_.readInt(),true) + §_-lb§.§_-GX§(_loc3_.readInt(),true) + §_-lb§.§_-GX§(_loc3_.readInt(),true);
      }
      
      public static function §_-Nj§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §_-mU§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-EJ§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §_-EJ§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
