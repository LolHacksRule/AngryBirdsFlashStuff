package §_-6M§
{
   ...
   public class §break§ extends §_-b8§ implements §_-vj§
   {
      ...
      public function §break§(param1:Array, param2:§_-Q5§, param3:Number)
      {
         var _loc4_:uint = 0;
         var _loc5_:uint = 0;
         ...
         if(_loc4_ > 0)
         {
            ...
            §_-sA§ = this.§_-1t§.duration > §_-sA§ ? Number(this.§_-1t§.duration) : Number(§_-sA§);
            if(_loc4_ > 1)
            {
               this.§_-K2§ = param1[1] as §_-x5§;
               §_-sA§ = this.§_-K2§.duration > §_-sA§ ? Number(this.§_-K2§.duration) : Number(§_-sA§);
               if(_loc4_ > 2)
               {
                  this.§_-vc§ = param1[2] as §_-x5§;
                  §_-sA§ = this.§_-vc§.duration > §_-sA§ ? Number(this.§_-vc§.duration) : Number(§_-sA§);
                  if(_loc4_ > 3)
                  {
                     this.§_-Pp§ = param1[3] as §_-x5§;
                     §_-sA§ = this.§_-Pp§.duration > §_-sA§ ? Number(this.§_-Pp§.duration) : Number(§_-sA§);
                     if(_loc4_ > 4)
                     {
                        ...
                        while(_loc5_ < _loc4_)
                        {
                           ...
                           §_-sA§ = _loc6_.duration > §_-sA§ ? Number(_loc6_.duration) : Number(§_-sA§);
                           _loc5_++;
                        }
                     }
                  }
      ...
      override protected function newInstance() : §_-b8§
      {
         ...
         return new §break§(_loc1_,§_-MR§,0);
      }
