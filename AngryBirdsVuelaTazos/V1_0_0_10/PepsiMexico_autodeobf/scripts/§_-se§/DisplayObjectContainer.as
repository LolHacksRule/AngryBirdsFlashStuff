package §_-se§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private var §_-x-§:Vector.<DisplayObject>;
      
      private var §_-XI§:Matrix3D;
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§_-x-§ = new Vector.<DisplayObject>(0);
         this.§_-XI§ = new Matrix3D();
      }
      
      override public function dispose() : void
      {
         var _loc1_:DisplayObject = null;
         for each(_loc1_ in this.§_-x-§)
         {
            _loc1_.dispose();
         }
         super.dispose();
      ...
      public function addChildAt(param1:DisplayObject, param2:int) : void
      {
         ...
         {
            param1.§_-R1§();
            this.§_-x-§.splice(param2,0,param1);
            param1.§_-p-§(this);
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§_-x-§[param1];
            _loc3_.dispatchEvent(new Event(Event.§_-s0§));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§_-6P§));
            }
            _loc3_.§_-p-§(null);
            this.§_-x-§.splice(param1,1);
            if(param2)
            {
               _loc3_.dispose();
            }
      ...
      public function §_-sL§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      {
         return this.§_-x-§.indexOf(param1);
      }
      ...
      public function setChildIndex(param1:DisplayObject, param2:int) : void
      {
         ...
         this.§_-x-§.splice(_loc3_,1);
         this.§_-x-§.splice(param2,0,param1);
      }
      
      public function §_-P8§(param1:DisplayObject, param2:DisplayObject) : void
      {
         var _loc3_:int = this.getChildIndex(param1);
         ...
         this.§_-lt§(_loc3_,_loc4_);
      }
      
      public function §_-lt§(param1:int, param2:int) : void
      {
         var _loc3_:DisplayObject = this.getChildAt(param1);
         var _loc4_:DisplayObject = this.getChildAt(param2);
         this.§_-x-§[param1] = _loc4_;
         this.§_-x-§[param2] = _loc3_;
      }
      ...
      override public function getBounds(param1:DisplayObject) : Rectangle
      {
         ...
         var _loc2_:int = this.§_-x-§.length;
         if(_loc2_ == 0)
         {
            _loc3_ = §_-h3§(param1);
      ...
      override public function hitTestPoint(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc3_:int = this.§_-x-§.length;
         var _loc4_:int = _loc3_ - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.§_-x-§[_loc4_];
            if(!param2 || _loc5_.visible && _loc5_.§_-kU§ && _loc5_.alpha > 0)
            {
               _loc7_ = (_loc6_ = §_-h3§(_loc5_)).transformPoint(param1);
      ...
      override public function render(param1:§_-Ke§, param2:Number) : void
      {
         var _loc3_:DisplayObject = null;
         param2 *= this.alpha;
         param1.§_-FU§(this.§_-XI§);
         for each(_loc3_ in this.§_-x-§)
         {
            if(_loc3_.alpha != 0 && _loc3_.visible && _loc3_.scaleX != 0 && _loc3_.scaleY != 0)
            {
               param1.§_-KI§(_loc3_);
               _loc3_.render(param1,param2);
               param1.§_-kN§(this.§_-XI§);
            }
         }
      }
      
      public function §_-D1§(param1:Event) : void
      {
         if(param1.bubbles)
         {
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§_-68§(this,param1.type,_loc2_);
      ...
      private function §_-68§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         var _loc5_:DisplayObject = null;
         ...
         if(_loc4_)
         {
            for each(_loc5_ in _loc4_.§_-x-§)
            {
               this.§_-68§(_loc5_,param2,param3);
            }
         }
      }
