package §_-Rb§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§_-ro§.x * this.§_-0o§.x + (this.§_-IB§ + this.§_-ro§.y) * this.§_-Xb§.x),param1 * (this.§_-ro§.x * this.§_-0o§.y + (this.§_-IB§ + this.§_-ro§.y) * this.§_-Xb§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§_-4K§ = this.§_-4K§ > Number.MIN_VALUE ? Number(1 / this.§_-4K§) : Number(0);
         ...
         this.§_-SI§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§_-SI§.col2.x = this.§_-SI§.col1.y;
         this.§_-SI§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§_-p1§)
         {
         ...
         if(param1.§_-Fx§)
         {
            ...
            _loc19_ = this.§_-ro§.x * this.§_-0o§.x + (this.§_-IB§ + this.§_-ro§.y) * this.§_-Xb§.x;
            _loc20_ = this.§_-ro§.x * this.§_-0o§.y + (this.§_-IB§ + this.§_-ro§.y) * this.§_-Xb§.y;
            _loc21_ = this.§_-ro§.x * this.m_s1 + (this.§_-IB§ + this.§_-ro§.y) * this.m_a1;
            _loc22_ = this.§_-ro§.x * this.m_s2 + (this.§_-IB§ + this.§_-ro§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§_-Xb§.x * (_loc6_.x - _loc4_.x) + this.§_-Xb§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§_-4K§ * (this.§_-Ug§ - _loc13_);
            _loc15_ = this.§_-IB§;
            _loc16_ = param1.§_-Vj§ * this.§_-O2§;
            this.§_-IB§ = b2Math.§_-Kz§(this.§_-IB§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§_-IB§ - _loc15_) * this.§_-Xb§.x;
            _loc9_ = _loc14_ * this.§_-Xb§.y;
         ...
         {
            _loc17_ = this.§_-Xb§.x * (_loc6_.x - _loc4_.x) + this.§_-Xb§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§_-ro§.Copy();
            _loc19_ = this.§_-SI§.§_-c7§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§_-ro§.§_-Ec§(_loc19_);
            if(this.§_-vI§ == b2internal::_-nw)
            {
               this.§_-ro§.y = b2Math.§_-Gj§(this.§_-ro§.y,0);
            }
            else if(this.§_-vI§ == b2internal::_-WR)
            {
               this.§_-ro§.y = b2Math.§_-9u§(this.§_-ro§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§_-ro§.y - _loc18_.y) * this.§_-SI§.col2.x;
            if(this.§_-SI§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§_-SI§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§_-ro§.x = _loc21_;
            _loc19_.x = this.§_-ro§.x - _loc18_.x;
            _loc19_.y = this.§_-ro§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§_-0o§.x + _loc19_.y * this.§_-Xb§.x;
            _loc9_ = _loc19_.x * this.§_-0o§.y + _loc19_.y * this.§_-Xb§.y;
         ...
         else
         {
            if(this.§_-SI§.col1.x != 0)
            {
               _loc22_ = -_loc12_ / this.§_-SI§.col1.x;
            }
            else
            {
               _loc22_ = 0;
            ...
            this.§_-ro§.x += _loc22_;
            _loc8_ = _loc22_ * this.§_-0o§.x;
            _loc9_ = _loc22_ * this.§_-0o§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§_-p1§)
         {
            ...
            _loc34_ = this.§_-Xb§.x * _loc26_ + this.§_-Xb§.y * _loc27_;
            if(b2Math.§_-Os§(this.§_-eh§ - this.§_-Sn§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§_-Kz§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§_-Os§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§_-Sn§)
            {
               _loc19_ = b2Math.§_-Kz§(_loc34_ - this.§_-Sn§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§_-Sn§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§_-eh§)
            {
               _loc19_ = b2Math.§_-Kz§(_loc34_ - this.§_-eh§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§_-eh§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§_-SI§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§_-SI§.col2.x = this.§_-SI§.col1.y;
            this.§_-SI§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§_-SI§.§_-c7§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::_-UK;
         ...
         var _loc30_:Number = _loc28_.x * this.§_-0o§.x + _loc28_.y * this.§_-Xb§.x;
         var _loc31_:Number = _loc28_.x * this.§_-0o§.y + _loc28_.y * this.§_-Xb§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::_-UK * _loc30_;
         _loc6_.y -= b2internal::_-UK * _loc31_;
         _loc7_ -= b2internal::_-J7 * _loc32_;
         _loc8_.x += b2internal::_-qn * _loc30_;
         _loc8_.y += b2internal::_-qn * _loc31_;
         _loc9_ += b2internal::_-Fq * _loc33_;
