package §_-SO§
{
   ...
   public class §_-Te§
   {
      ...
      public static function §_-WC§(param1:Stage) : void
      {
         ...
         §_-na§ = param1;
         ExternalInterface.call(§_-8m§);
         ExternalInterface.call(§_-8P§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §_-Mz§ = ExternalInterface.call(§_-jc§,ExternalInterface.objectID);
         if(§_-Mz§ == §_-o1§)
         {
            return;
         }
      ...
      public static function get §_-Xz§() : int
      {
         return §_-Mz§;
      }
      
      public static function get §_-ap§() : Boolean
      {
         return §_-20§;
      }
      
      public static function set §_-ap§(param1:Boolean) : void
      {
         §_-20§ = param1;
      }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §_-na§.getObjectsUnderPoint(new Point(§_-na§.mouseX,§_-na§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
