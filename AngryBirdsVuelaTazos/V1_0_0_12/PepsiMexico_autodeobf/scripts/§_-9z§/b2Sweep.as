package §_-9z§
{
   public class b2Sweep
   {
      ...
      public function Copy() : b2Sweep
      {
         ...
         _loc1_.a0 = this.a0;
         _loc1_.a = this.a;
         _loc1_.§_-Mv§ = this.§_-Mv§;
         return _loc1_;
      }
      
      public function §return§(param1:b2Transform, param2:Number) : void
      {
      ...
      public function §_-qB§(param1:Number) : void
      {
         var _loc2_:Number = NaN;
         if(this.§_-Mv§ < param1 && 1 - this.§_-Mv§ > Number.MIN_VALUE)
         {
            _loc2_ = (param1 - this.§_-Mv§) / (1 - this.§_-Mv§);
