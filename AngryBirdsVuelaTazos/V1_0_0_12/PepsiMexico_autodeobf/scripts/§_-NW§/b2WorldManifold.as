package §_-Nw§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §_-fn§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§_-g1§)
         {
            case b2Manifold.§_-uU§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§_-Xy§[0].m_localPoint;
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§_-Pw§.x = _loc19_ / _loc26_;
                  this.§_-Pw§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§_-Pw§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§_-Pw§.x;
               _loc23_ = _loc16_ + param3 * this.§_-Pw§.y;
               _loc24_ = _loc17_ - param5 * this.§_-Pw§.x;
               _loc25_ = _loc18_ - param5 * this.§_-Pw§.y;
               this.§_-Xy§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§_-Xy§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§_-Cm§:
               ...
               this.§_-Pw§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§_-pT§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§_-Xy§[_loc6_].m_localPoint;
                  ...
                  this.§_-Xy§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§_-Xy§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§_-1x§:
               ...
               while(_loc6_ < param1.§_-pT§)
               {
                  ...
                  this.§_-Xy§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§_-Xy§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
