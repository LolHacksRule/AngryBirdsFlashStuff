package §_-3K§
{
   ...
   public class §_-h3§
   {
      ...
      public static function §_-ue§(param1:Stage) : void
      {
         ...
         §_-ic§ = param1;
         ExternalInterface.call(§_-aK§);
         ExternalInterface.call(§_-v9§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §_-aB§ = ExternalInterface.call(§_-ha§,ExternalInterface.objectID);
         if(§_-aB§ == §_-61§)
         {
            return;
         }
      ...
      public static function get §_-XG§() : int
      {
         return §_-aB§;
      }
      
      public static function get §_-DM§() : Boolean
      {
         return §_-Nc§;
      }
      
      public static function set §_-DM§(param1:Boolean) : void
      {
         §_-Nc§ = param1;
      }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §_-ic§.getObjectsUnderPoint(new Point(§_-ic§.mouseX,§_-ic§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
