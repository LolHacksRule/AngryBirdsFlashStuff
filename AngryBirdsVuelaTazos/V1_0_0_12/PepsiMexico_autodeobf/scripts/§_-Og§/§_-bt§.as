package §_-Og§
{
   ...
   public class §_-bt§
   {
      ...
      private var §_-tw§:Dictionary;
      
      private var §_-Ew§:Dictionary;
      
      public function §_-bt§()
      {
         this.§_-Ew§ = new Dictionary();
         this.§_-tw§ = new Dictionary();
         super();
      }
      
      private function §_-ot§(param1:Class) : Vector.<Class>
      {
      ...
      public function §_-MU§(param1:Class, param2:Class, param3:Array) : void
      {
         var _loc4_:uint = param3.length;
         var _loc5_:uint = 0;
         while(_loc5_ < _loc4_)
         {
            this.§_-jq§(param1,param2,param3[_loc5_]);
            _loc5_++;
         }
      }
      
      public function §_-uP§(param1:Class, param2:String) : Class
      {
         var _loc4_:* = undefined;
         var _loc3_:* = this.§_-Ew§[param1];
         if(_loc3_ != null)
         {
         ...
         this.§_-sC§(param1);
         return this.§_-uP§(param1,param2);
      }
      
      public function §_-jq§(param1:Class, param2:Class, param3:String) : void
      {
         var _loc7_:uint = 0;
         var _loc8_:uint = 0;
         var _loc9_:Class = null;
         if(this.§_-Ew§[param2] == undefined)
         {
            this.§_-sC§(param2);
         }
         var _loc4_:Dictionary;
         var _loc5_:Class = (_loc4_ = this.§_-Ew§)[param2][param3] as Class;
         _loc4_[param2][param3] = param1;
         var _loc6_:Vector.<Class>;
         if((_loc6_ = this.§_-tw§[param2] as Vector.<Class>) != null)
         {
      ...
      private function §_-sC§(param1:Class) : void
      {
         ...
         var _loc2_:Dictionary = this.§_-Ew§;
         var _loc3_:Dictionary = this.§_-tw§;
         var _loc4_:Dictionary = new Dictionary();
         var _loc6_:uint;
         var _loc5_:Vector.<Class>;
         var _loc7_:int = _loc6_ = (_loc5_ = this.§_-ot§(param1)).length;
         while(--_loc7_ >= 0)
         {
