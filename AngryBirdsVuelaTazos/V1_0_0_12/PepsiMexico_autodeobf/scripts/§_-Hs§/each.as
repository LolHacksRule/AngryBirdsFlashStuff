package §_-Hs§
{
   ...
   public class each
   {
      ...
      public static var §_-lW§:ByteArray;
      ...
      public static function §_-hU§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-Ck§(_loc2_);
         return §_-e5§.§_-9H§(_loc3_.readInt(),true) + §_-e5§.§_-9H§(_loc3_.readInt(),true) + §_-e5§.§_-9H§(_loc3_.readInt(),true) + §_-e5§.§_-9H§(_loc3_.readInt(),true) + §_-e5§.§_-9H§(_loc3_.readInt(),true);
      }
      
      public static function §_-SH§(param1:ByteArray) : String
      {
         var _loc2_:Array = each.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §_-Ck§(_loc2_);
         return §_-e5§.§_-9H§(_loc3_.readInt(),true) + §_-e5§.§_-9H§(_loc3_.readInt(),true) + §_-e5§.§_-9H§(_loc3_.readInt(),true) + §_-e5§.§_-9H§(_loc3_.readInt(),true) + §_-e5§.§_-9H§(_loc3_.readInt(),true);
      }
      
      public static function §else §(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = each.createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-Ck§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §_-Ck§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
