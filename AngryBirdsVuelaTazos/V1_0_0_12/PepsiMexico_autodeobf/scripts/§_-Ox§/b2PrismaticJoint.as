package §_-Ox§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§_-AM§.x * this.§_-Wx§.x + (this.§_-AH§ + this.§_-AM§.z) * this.§_-jL§.x),param1 * (this.§_-AM§.x * this.§_-Wx§.y + (this.§_-AH§ + this.§_-AM§.z) * this.§_-jL§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§_-9y§ > Number.MIN_VALUE)
         {
            this.§_-9y§ = 1 / this.§_-9y§;
         }
         ...
         this.§_-q6§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§_-q6§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§_-q6§.col2.x = this.§_-q6§.col1.y;
         this.§_-q6§.col2.y = _loc16_ + _loc17_;
         this.§_-q6§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§_-q6§.col3.x = this.§_-q6§.col1.z;
         this.§_-q6§.col3.y = this.§_-q6§.col2.z;
         this.§_-q6§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§_-I4§)
         {
         ...
         if(param1.§_-lZ§)
         {
            ...
            _loc19_ = this.§_-AM§.x * this.§_-Wx§.x + (this.§_-AH§ + this.§_-AM§.z) * this.§_-jL§.x;
            _loc20_ = this.§_-AM§.x * this.§_-Wx§.y + (this.§_-AH§ + this.§_-AM§.z) * this.§_-jL§.y;
            _loc21_ = this.§_-AM§.x * this.m_s1 + this.§_-AM§.y + (this.§_-AH§ + this.§_-AM§.z) * this.m_a1;
            _loc22_ = this.§_-AM§.x * this.m_s2 + this.§_-AM§.y + (this.§_-AH§ + this.§_-AM§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§_-jL§.x * (_loc6_.x - _loc4_.x) + this.§_-jL§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§_-9y§ * (this.§_-1C§ - _loc14_);
            _loc16_ = this.§_-AH§;
            _loc17_ = param1.§_-pG§ * this.§_-tr§;
            this.§_-AH§ = b2Math.§_-5a§(this.§_-AH§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§_-AH§ - _loc16_) * this.§_-jL§.x;
            _loc9_ = _loc15_ * this.§_-jL§.y;
         ...
         {
            _loc18_ = this.§_-jL§.x * (_loc6_.x - _loc4_.x) + this.§_-jL§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§_-AM§.Copy();
            _loc20_ = this.§_-q6§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§_-AM§.§_-3a§(_loc20_);
            if(this.§_-D9§ == b2internal::_-Pp)
            {
               this.§_-AM§.z = b2Math.§_-DY§(this.§_-AM§.z,0);
            }
            else if(this.§_-D9§ == b2internal::_-HL)
            {
               this.§_-AM§.z = b2Math.§_-cq§(this.§_-AM§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§_-AM§.z - _loc19_.z) * this.§_-q6§.col3.x;
            _loc22_ = -_loc13_ - (this.§_-AM§.z - _loc19_.z) * this.§_-q6§.col3.y;
            _loc23_ = this.§_-q6§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§_-AM§.x = _loc23_.x;
            this.§_-AM§.y = _loc23_.y;
            _loc20_.x = this.§_-AM§.x - _loc19_.x;
            _loc20_.y = this.§_-AM§.y - _loc19_.y;
            _loc20_.z = this.§_-AM§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§_-Wx§.x + _loc20_.z * this.§_-jL§.x;
            _loc9_ = _loc20_.x * this.§_-Wx§.y + _loc20_.z * this.§_-jL§.y;
         ...
         {
            _loc24_ = this.§_-q6§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§_-AM§.x += _loc24_.x;
            this.§_-AM§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§_-Wx§.x;
            _loc9_ = _loc24_.x * this.§_-Wx§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§_-I4§)
         {
            ...
            _loc35_ = this.§_-jL§.x * _loc26_ + this.§_-jL§.y * _loc27_;
            if(b2Math.§_-Y9§(this.§_-CV§ - this.§_-MZ§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§_-5a§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§_-Y9§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§_-MZ§)
            {
               _loc19_ = b2Math.§_-5a§(_loc35_ - this.§_-MZ§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§_-MZ§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§_-CV§)
            {
               _loc19_ = b2Math.§_-5a§(_loc35_ - this.§_-CV§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§_-CV§;
               _loc18_ = true;
            }
         }
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§_-45§;
         _loc16_ = b2Math.§_-DY§(_loc16_,b2Math.§_-Y9§(_loc29_));
         _loc17_ = b2Math.§_-Y9§(_loc30_);
         if(_loc18_)
         {
            ...
            this.§_-q6§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§_-q6§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§_-q6§.col2.x = this.§_-q6§.col1.y;
            this.§_-q6§.col2.y = _loc14_ + _loc15_;
            this.§_-q6§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§_-q6§.col3.x = this.§_-q6§.col1.z;
            this.§_-q6§.col3.y = this.§_-q6§.col2.z;
            this.§_-q6§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§_-q6§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::_-Zi;
            ...
            this.§_-q6§.col1.Set(_loc36_,_loc37_,0);
            this.§_-q6§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§_-q6§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§_-Wx§.x + _loc28_.z * this.§_-jL§.x;
         var _loc32_:Number = _loc28_.x * this.§_-Wx§.y + _loc28_.z * this.§_-jL§.y;
         ...
         _loc6_.x -= b2internal::_-Zi * _loc31_;
         _loc6_.y -= b2internal::_-Zi * _loc32_;
         _loc7_ -= b2internal::_-Ay * _loc33_;
         _loc8_.x += b2internal::_-c2 * _loc31_;
         _loc8_.y += b2internal::_-c2 * _loc32_;
         _loc9_ += b2internal::_-it * _loc34_;
