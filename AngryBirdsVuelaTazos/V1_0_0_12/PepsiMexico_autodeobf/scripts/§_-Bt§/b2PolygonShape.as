package §_-Bt§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §_-ad§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §_-Hc§:b2Vec2;
      
      b2internal var §_-2M§:Vector.<b2Vec2>;
      
      b2internal var §_-7J§:Vector.<b2Vec2>;
      ...
      {
         super();
         §_-g1§ = b2internal::_-Tn;
         this.§_-Hc§ = new b2Vec2();
         this.§_-2M§ = new Vector.<b2Vec2>();
         this.§_-7J§ = new Vector.<b2Vec2>();
         §_-uB§ = b2Settings.b2_polygonRadius;
         this.§_-Hc§.§_-TJ§();
      }
      
      public static function §_-CE§(param1:Array, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-xQ§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-8V§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-ho§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-5M§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-IT§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-S1§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§_-xG§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §_-67§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-G5§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-4r§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§_-3a§(new b2Vec2(0,0));
            _loc3_.§_-3a§(_loc9_);
            _loc3_.§_-3a§(_loc10_);
            _loc3_.§_-5L§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §_-8W§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§_-Uk§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§_-Uk§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§_-Hc§.SetV(_loc2_.§_-Hc§);
            this.§_-fy§ = _loc2_.§_-fy§;
            this.§_-6F§(this.§_-fy§);
            _loc3_ = 0;
            while(_loc3_ < this.§_-fy§)
            {
               this.§_-2M§[_loc3_].SetV(_loc2_.§_-2M§[_loc3_]);
               this.§_-7J§[_loc3_].SetV(_loc2_.§_-7J§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §_-xQ§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§_-ho§(_loc3_,param2);
      }
      
      public function §_-ho§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§_-fy§)
         {
            this.§_-2M§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§_-fy§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§_-fy§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§_-9M§(this.§_-2M§[_loc5_],this.§_-2M§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§_-8y§() > Number.MIN_VALUE);
            this.§_-7J§[_loc3_].SetV(b2Math.§_-XH§(_loc6_,1));
            this.§_-7J§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§_-Hc§ = §_-4r§(this.§_-2M§,this.§_-fy§);
      }
      ...
      public function §_-IT§(param1:Number, param2:Number) : void
      {
         this.§_-fy§ = 4;
         this.§_-6F§(4);
         this.§_-2M§[0].Set(-param1,-param2);
         this.§_-2M§[1].Set(param1,-param2);
         this.§_-2M§[2].Set(param1,param2);
         this.§_-2M§[3].Set(-param1,param2);
         this.§_-7J§[0].Set(0,-1);
         this.§_-7J§[1].Set(1,0);
         this.§_-7J§[2].Set(0,1);
         this.§_-7J§[3].Set(-1,0);
      ...
      public function §_-xG§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§_-fy§ = 4;
         this.§_-6F§(4);
         this.§_-2M§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§_-fy§)
         {
            this.§_-2M§[_loc6_] = b2Math.§_-sF§(_loc5_,this.§_-2M§[_loc6_]);
            this.§_-7J§[_loc6_] = b2Math.§_-0q§(_loc5_.R,this.§_-7J§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §_-G5§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§_-fy§ = 2;
         this.§_-6F§(2);
         this.§_-2M§[0].SetV(param1);
         this.§_-2M§[1].SetV(param2);
         this.§_-Hc§.x = 0.5 * (param1.x + param2.x);
         this.§_-Hc§.y = 0.5 * (param1.y + param2.y);
         this.§_-7J§[0] = b2Math.§_-XH§(b2Math.§_-9M§(param2,param1),1);
         this.§_-7J§[0].Normalize();
         this.§_-7J§[1].x = -this.§_-7J§[0].x;
         this.§_-7J§[1].y = -this.§_-7J§[0].y;
      }
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < this.§_-fy§)
         {
            _loc3_ = this.§_-2M§[_loc9_];
            _loc5_ = _loc7_ - _loc3_.x;
            _loc6_ = _loc8_ - _loc3_.y;
            _loc3_ = this.§_-7J§[_loc9_];
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§_-fy§)
         {
            _loc6_ = (_loc9_ = this.§_-2M§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§_-7J§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§_-9P§.x = _loc5_ - b2internal::_-uB;
         param1.§_-9P§.y = _loc6_ - b2internal::_-uB;
         param1.§_-5c§.x = _loc7_ + b2internal::_-uB;
         param1.§_-5c§.y = _loc8_ + b2internal::_-uB;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§_-fy§ == 2)
         {
            param1.center.x = 0.5 * (this.§_-2M§[0].x + this.§_-2M§[1].x);
            param1.center.y = 0.5 * (this.§_-2M§[0].y + this.§_-2M§[1].y);
            param1.§_-E8§ = 0;
            param1.§_-0i§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§_-fy§)
         {
            _loc11_ = this.§_-2M§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§_-fy§ ? this.§_-2M§[int(_loc10_ + 1)] : this.§_-2M§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§_-E8§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§_-0i§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§_-fK§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§_-aI§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§_-fy§)
         {
            _loc7_[_loc12_] = b2Math.§_-aI§(_loc5_,this.§_-2M§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§_-sF§(param3,_loc24_.center));
                  return _loc24_.§_-E8§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§_-fy§;
         var _loc14_:int = (_loc10_ + 1) % this.§_-fy§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§_-2M§[_loc9_].x * (1 - _loc15_) + this.§_-2M§[_loc13_].x * _loc15_,this.§_-2M§[_loc9_].y * (1 - _loc15_) + this.§_-2M§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§_-2M§[_loc10_].x * (1 - _loc16_) + this.§_-2M§[_loc14_].x * _loc16_,this.§_-2M§[_loc10_].y * (1 - _loc16_) + this.§_-2M§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§_-2M§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§_-fy§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§_-2M§[_loc12_];
            }
         ...
         _loc20_.§_-5L§(1 / _loc19_);
         param4.SetV(b2Math.§_-sF§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §_-la§() : Vector.<b2Vec2>
      {
         return this.§_-2M§;
      }
      
      public function §_-BL§() : Vector.<b2Vec2>
      {
         return this.§_-7J§;
      }
      
      public function §_-uK§(param1:b2Vec2) : int
      {
         var _loc5_:Number = NaN;
         var _loc2_:int = 0;
         var _loc3_:Number = this.§_-2M§[0].x * param1.x + this.§_-2M§[0].y * param1.y;
         var _loc4_:int = 1;
         while(_loc4_ < this.§_-fy§)
         {
      ...
      private function §_-6F§(param1:int) : void
      {
         var _loc2_:int = this.§_-2M§.length;
         while(_loc2_ < param1)
         {
            this.§_-2M§[_loc2_] = new b2Vec2();
            this.§_-7J§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
