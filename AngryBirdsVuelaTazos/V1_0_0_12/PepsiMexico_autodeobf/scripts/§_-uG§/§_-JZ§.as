package §_-uG§
{
   public class §_-JZ§
   {
      ...
      public static function §_-pz§(param1:String) : String
      {
         if(§_-vE§[param1])
         {
            return §_-vE§[param1];
         }
         return §_-vE§.UNEXPECTED_ERROR;
      }
      
      public static function §_-at§(param1:String) : String
      {
         switch(param1)
         {
            case "nickName":
