package §_-qg§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §_-mf§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
         ...
         _loc3_.aabb.§_-N-§.x = param1.§_-N-§.x - _loc4_;
         _loc3_.aabb.§_-N-§.y = param1.§_-N-§.y - _loc5_;
         _loc3_.aabb.§_-TE§.x = param1.§_-TE§.x + _loc4_;
         _loc3_.aabb.§_-TE§.y = param1.§_-TE§.y + _loc5_;
         _loc3_.§_-Vb§ = param2;
         this.§_-5Z§(_loc3_);
         return _loc3_;
      }
      ...
      public function §_-Se§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         ...
         param1.aabb.§_-N-§.x = param2.§_-N-§.x - _loc4_;
         param1.aabb.§_-N-§.y = param2.§_-N-§.y - _loc5_;
         param1.aabb.§_-TE§.x = param2.§_-TE§.x + _loc4_;
         param1.aabb.§_-TE§.y = param2.§_-TE§.y + _loc5_;
         this.§_-5Z§(param1);
         return true;
      }
      ...
      public function §_-pP§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            ...
            {
               _loc3_ = !!(this.§_-TF§ >> _loc4_ & 1) ? _loc3_.child2 : _loc3_.child1;
               _loc4_ = _loc4_ + 1 & 31;
            }
            ++this.§_-TF§;
            this.§_-GM§(_loc3_);
      ...
      public function §_-7a§(param1:Function, param2:b2AABB) : void
      {
         ...
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§_-pb§(param2))
            {
               if(_loc5_.§_-dO§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§_-pb§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§_-aW§();
      ...
      private function §_-5Z§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_.§_-dO§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§_-N-§.x + _loc6_.aabb.§_-TE§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§_-N-§.y + _loc6_.aabb.§_-TE§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§_-N-§.x + _loc7_.aabb.§_-TE§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§_-N-§.y + _loc7_.aabb.§_-TE§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         _loc5_.§_-Vb§ = null;
         _loc5_.aabb.§_-ot§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            while(!_loc4_.aabb.§_-r2§(_loc5_.aabb))
            {
               _loc4_.aabb.§_-ot§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
