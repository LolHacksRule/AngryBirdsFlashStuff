package §_-qg§
{
   ...
   public class b2Collision
   {
      ...
      private static var s_clipPoints1:Vector.<§_-uS§> = §_-vc§();
      
      private static var s_clipPoints2:Vector.<§_-uS§> = §_-vc§();
      
      private static var §_-Z2§:Vector.<int> = new Vector.<int>(1);
      
      private static var §case§:Vector.<int> = new Vector.<int>(1);
      
      private static var §_-TT§:b2Vec2 = new b2Vec2();
      
      private static var §_-IS§:b2Vec2 = new b2Vec2();
      
      private static var §_-rb§:b2Vec2 = new b2Vec2();
      
      private static var §_-ou§:b2Vec2 = new b2Vec2();
      
      private static var §_-i2§:b2Vec2 = new b2Vec2();
      ...
      public static function §_-ll§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §_-Sl§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §_-Sl§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §_-Sl§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §_-Sl§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §_-E7§(param1:Vector.<§_-uS§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§_-Wz§;
         var _loc8_:Vector.<b2Vec2> = param2.§_-3s§;
         var _loc9_:int = param5.§_-Wz§;
         ...
         _loc20_.id.§_-0P§.§_-cf§ = param4;
         _loc20_.id.§_-0P§.§_-qC§ = _loc21_;
         _loc20_.id.§_-0P§.§_-qs§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§_-0P§.§_-cf§ = param4;
         _loc20_.id.§_-0P§.§_-qC§ = _loc22_;
         _loc20_.id.§_-0P§.§_-qs§ = 1;
      }
      ...
      public static function §_-ZL§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §_-Z2§[0] = _loc8_;
         var _loc9_:Number = §_-ll§(§_-Z2§,param2,param3,param4,param5);
         _loc8_ = §_-Z2§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §case§[0] = _loc10_;
         var _loc11_:Number = §_-ll§(§case§,param4,param5,param2,param3);
         _loc10_ = §case§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §_-TT§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §_-IS§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §_-rb§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         ...
         if((_loc39_ = §_-cp§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §_-cp§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         ...
         while(_loc41_ < b2Settings.b2_maxManifoldPoints)
         {
            ...
            if((_loc42_ = _loc31_.x * _loc6_.v.x + _loc31_.y * _loc6_.v.y - _loc34_) <= _loc7_)
            {
               ...
               _loc43_.m_id.§_-0P§.§_-oN§ = _loc17_;
               _loc40_++;
            }
            _loc41_++;
         }
      ...
      public static function §_-Ip§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§_-Tu§ = 1;
            param1.§_-Sj§ = b2Manifold.§_-zO§;
            param1.§_-Pv§.x = _loc15_ - _loc27_.x;
            param1.§_-Pv§.y = _loc16_ - _loc27_.y;
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§_-Tu§ = 1;
            param1.§_-Sj§ = b2Manifold.§_-zO§;
            param1.§_-Pv§.x = _loc15_ - _loc28_.x;
            param1.§_-Pv§.y = _loc16_ - _loc28_.y;
            param1.§_-Pv§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§_-hn§[0].m_localPoint.SetV(param4.§_-Ga§);
            param1.§_-hn§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§_-Tu§ = 1;
            param1.§_-Sj§ = b2Manifold.§_-zO§;
            param1.§_-Pv§.x = _loc23_[_loc25_].x;
            param1.§_-Pv§.y = _loc23_[_loc25_].y;
            param1.§_-Pv§.Normalize();
