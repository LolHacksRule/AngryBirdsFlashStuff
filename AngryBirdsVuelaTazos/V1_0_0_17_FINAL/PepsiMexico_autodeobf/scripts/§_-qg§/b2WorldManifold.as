         ...
         switch(param1.§_-Sj§)
         {
            case b2Manifold.§_-1§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§_-u5§.x = _loc19_ / _loc26_;
                  this.§_-u5§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§_-u5§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§_-u5§.x;
               _loc23_ = _loc16_ + param3 * this.§_-u5§.y;
               _loc24_ = _loc17_ - param5 * this.§_-u5§.x;
               _loc25_ = _loc18_ - param5 * this.§_-u5§.y;
