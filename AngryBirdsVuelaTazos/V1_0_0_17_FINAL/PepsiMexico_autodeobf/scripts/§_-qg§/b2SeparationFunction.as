package §_-qg§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §_-lc§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§_-Sj§ = §_-Mo§;
            _loc7_ = this.§_-KM§.§_-Su§(param1.indexA[0]);
            _loc10_ = this.§_-m5§.§_-Su§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§_-YX§.x = _loc15_ - _loc13_;
            this.§_-YX§.y = _loc16_ - _loc14_;
            this.§_-YX§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§_-Sj§ = §_-zO§;
            _loc8_ = this.§_-KM§.§_-Su§(param1.indexA[0]);
            _loc9_ = this.§_-KM§.§_-Su§(param1.indexA[1]);
            _loc10_ = this.§_-m5§.§_-Su§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§_-YX§ = b2Math.§_-a4§(b2Math.§_-TD§(_loc9_,_loc8_),1);
            this.§_-YX§.Normalize();
            _loc20_ = this.§_-YX§;
         ...
         {
            this.§_-Sj§ = §_-77§;
            _loc11_ = this.§_-m5§.§_-Su§(param1.indexB[0]);
            _loc12_ = this.§_-m5§.§_-Su§(param1.indexB[1]);
            _loc7_ = this.§_-KM§.§_-Su§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§_-YX§ = b2Math.§_-a4§(b2Math.§_-TD§(_loc12_,_loc11_),1);
            this.§_-YX§.Normalize();
            _loc20_ = this.§_-YX§;
         ...
         else
         {
            ...
            _loc11_ = this.§_-m5§.§_-Su§(param1.indexB[0]);
            _loc12_ = this.§_-m5§.§_-Su§(param1.indexB[1]);
            _loc23_ = b2Math.§_-Y9§(param3,_loc7_);
            _loc24_ = b2Math.§_-FP§(param3.R,b2Math.§_-TD§(_loc9_,_loc8_));
            _loc25_ = b2Math.§_-Y9§(param5,_loc10_);
            _loc26_ = b2Math.§_-FP§(param5.R,b2Math.§_-TD§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§_-TD§(_loc26_,_loc24_);
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§_-Gj§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§_-Gj§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         switch(this.§_-Sj§)
         {
            case §_-Mo§:
               ...
               return Number(((_loc8_ = b2Math.§_-Y9§(param2,_loc6_)).x - _loc7_.x) * this.§_-YX§.x + (_loc8_.y - _loc7_.y) * this.§_-YX§.y);
            case §_-zO§:
               _loc10_ = b2Math.§_-FP§(param1.R,this.§_-YX§);
               _loc7_ = b2Math.§_-Y9§(param1,this.m_localPoint);
               _loc4_ = b2Math.§_-P4§(param2.R,_loc10_.§_-D§());
               _loc6_ = this.§_-m5§.§_-cH§(_loc4_);
               return Number(((_loc8_ = b2Math.§_-Y9§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §_-77§:
               _loc10_ = b2Math.§_-FP§(param2.R,this.§_-YX§);
               _loc8_ = b2Math.§_-Y9§(param2,this.m_localPoint);
               _loc3_ = b2Math.§_-P4§(param1.R,_loc10_.§_-D§());
               _loc5_ = this.§_-KM§.§_-cH§(_loc3_);
               return Number(((_loc7_ = b2Math.§_-Y9§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
