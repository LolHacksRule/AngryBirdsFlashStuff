package §_-ax§
{
   ...
   public class §_-gB§
   {
      ...
      public static var §_-sV§:ByteArray;
      ...
      public static function §_-k0§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-kf§(_loc2_);
         return §_-WW§.§_-EP§(_loc3_.readInt(),true) + §_-WW§.§_-EP§(_loc3_.readInt(),true) + §_-WW§.§_-EP§(_loc3_.readInt(),true) + §_-WW§.§_-EP§(_loc3_.readInt(),true) + §_-WW§.§_-EP§(_loc3_.readInt(),true);
      }
      
      public static function §_-Ce§(param1:ByteArray) : String
      {
         var _loc2_:Array = §_-gB§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §_-kf§(_loc2_);
         return §_-WW§.§_-EP§(_loc3_.readInt(),true) + §_-WW§.§_-EP§(_loc3_.readInt(),true) + §_-WW§.§_-EP§(_loc3_.readInt(),true) + §_-WW§.§_-EP§(_loc3_.readInt(),true) + §_-WW§.§_-EP§(_loc3_.readInt(),true);
      }
      
      public static function §_-V3§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §_-gB§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-kf§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §_-kf§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
