package §_-bA§
{
   public class b2Vec2
   {
      ...
      public static function §_-4N§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §_-B8§(param1:b2Vec2) : void
      {
         this.x += param1.x;
         this.y += param1.y;
      }
      ...
      public function §_-2O§(param1:Number) : void
      {
         this.x *= param1;
         this.y *= param1;
      }
      
      public function §_-kZ§(param1:b2Mat22) : void
      {
      ...
      public function §_-jQ§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§_-Ve§(this,param1.col1);
         this.y = b2Math.§_-Ve§(this,param1.col2);
         this.x = _loc2_;
      }
      
      public function §_-Rg§(param1:Number) : void
      {
         var _loc2_:Number = this.x;
      ...
      public function §_-3k§(param1:Number) : void
      {
         var _loc2_:Number = this.x;
         this.x = -param1 * this.y;
         this.y = param1 * _loc2_;
      ...
      {
         return b2Math.§_-HM§(this.x) && b2Math.§_-HM§(this.y);
      }
   }
}
