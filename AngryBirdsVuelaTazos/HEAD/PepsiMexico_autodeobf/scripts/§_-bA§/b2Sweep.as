package §_-bA§
{
   public class b2Sweep
   {
      ...
      public function Set(param1:b2Sweep) : void
      {
         ...
         this.§_-Zh§.SetV(param1.§_-Zh§);
         this.a0 = param1.a0;
         this.a = param1.a;
         this.§_-QQ§ = param1.§_-QQ§;
      }
      ...
      public function Copy() : b2Sweep
      {
         ...
         _loc1_.§_-Zh§.SetV(this.§_-Zh§);
         _loc1_.a0 = this.a0;
         _loc1_.a = this.a;
         _loc1_.§_-QQ§ = this.§_-QQ§;
         return _loc1_;
      }
      
      public function §_-ow§(param1:b2Transform, param2:Number) : void
      {
         param1.position.x = (1 - param2) * this.c0.x + param2 * this.§_-Zh§.x;
         param1.position.y = (1 - param2) * this.c0.y + param2 * this.§_-Zh§.y;
      ...
      public function §_-Cd§(param1:Number) : void
      {
         ...
         if(this.§_-QQ§ < param1 && 1 - this.§_-QQ§ > Number.MIN_VALUE)
         {
            _loc2_ = (param1 - this.§_-QQ§) / (1 - this.§_-QQ§);
            this.c0.x = (1 - _loc2_) * this.c0.x + _loc2_ * this.§_-Zh§.x;
            this.c0.y = (1 - _loc2_) * this.c0.y + _loc2_ * this.§_-Zh§.y;
