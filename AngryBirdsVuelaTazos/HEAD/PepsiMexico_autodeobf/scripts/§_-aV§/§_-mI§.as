package §_-aV§
{
   public class §_-mI§
   {
      ...
      public static function §_-xF§(param1:String) : String
      {
         if(§_-ai§[param1])
         {
            return §_-ai§[param1];
         }
         return §_-ai§.UNEXPECTED_ERROR;
      }
      
      public static function §_-Hx§(param1:String) : String
      {
         switch(param1)
         {
            case "nickName":
