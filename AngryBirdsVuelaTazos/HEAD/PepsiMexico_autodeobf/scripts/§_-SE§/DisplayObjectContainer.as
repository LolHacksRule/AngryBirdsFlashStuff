package §_-SE§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private var §_-9v§:Vector.<DisplayObject>;
      
      private var §_-tX§:Matrix3D;
      
      private var §_-70§:uint = 16777215;
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§_-9v§ = new Vector.<DisplayObject>(0);
         this.§_-tX§ = new Matrix3D();
      }
      
      override public function dispose() : void
      {
         var _loc1_:DisplayObject = null;
         for each(_loc1_ in this.§_-9v§)
         {
            _loc1_.dispose();
         }
         super.dispose();
      ...
      public function addChildAt(param1:DisplayObject, param2:int) : void
      {
         ...
         {
            param1.§_-Q-§();
            this.§_-9v§.splice(param2,0,param1);
            param1.§_-8Q§(this);
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§_-9v§[param1];
            _loc3_.dispatchEvent(new Event(Event.§_-a7§));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§_-iz§));
            }
            _loc3_.§_-8Q§(null);
            this.§_-9v§.splice(param1,1);
            if(param2)
            {
               _loc3_.dispose();
            }
      ...
      public function §_-0--§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      {
         return this.§_-9v§.indexOf(param1);
      }
      ...
      public function setChildIndex(param1:DisplayObject, param2:int) : void
      {
         ...
         this.§_-9v§.splice(_loc3_,1);
         this.§_-9v§.splice(param2,0,param1);
      }
      
      public function §_-WP§(param1:DisplayObject, param2:DisplayObject) : void
      {
         var _loc3_:int = this.getChildIndex(param1);
         ...
         this.§_-WZ§(_loc3_,_loc4_);
      }
      
      public function §_-WZ§(param1:int, param2:int) : void
      {
         var _loc3_:DisplayObject = this.getChildAt(param1);
         var _loc4_:DisplayObject = this.getChildAt(param2);
         this.§_-9v§[param1] = _loc4_;
         this.§_-9v§[param2] = _loc3_;
      }
      ...
      override public function getBounds(param1:DisplayObject) : Rectangle
      {
         ...
         var _loc2_:int = this.§_-9v§.length;
         if(_loc2_ == 0)
         {
            _loc3_ = §_-Bv§(param1);
      ...
      override public function hitTestPoint(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc3_:int = this.§_-9v§.length;
         var _loc4_:int = _loc3_ - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.§_-9v§[_loc4_];
            if(!param2 || _loc5_.visible && _loc5_.§_-54§ && _loc5_.alpha > 0)
            {
               _loc7_ = (_loc6_ = §_-Bv§(_loc5_)).transformPoint(param1);
      ...
      override public function render(param1:§_-Nq§, param2:Number) : void
      {
         ...
         for each(_loc3_ in this.§_-9v§)
         {
            if(_loc3_.alpha != 0 && _loc3_.visible && _loc3_.scaleX != 0 && _loc3_.scaleY != 0)
            {
               ...
               param1.§_-VB§(this.§_-tX§);
            }
         }
      }
      
      public function §_-TH§(param1:Event) : void
      {
         if(param1.bubbles)
         {
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         _loc2_ = this.§_-lw§(this,param1.type,_loc2_);
         if(_loc2_)
         {
      ...
      private function §_-lw§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : Vector.<DisplayObject>
      {
         var _loc5_:DisplayObject = null;
         ...
         if(_loc4_)
         {
            for each(_loc5_ in _loc4_.§_-9v§)
            {
               param3 = this.§_-lw§(_loc5_,param2,param3);
            }
         }
         return param3;
      }
