package §_-KI§
{
   ...
   public class §_-W3§
   {
      ...
      public static function §_-xS§(param1:Stage) : void
      {
         ...
         §_-gn§ = param1;
         ExternalInterface.call(§_-yB§);
         ExternalInterface.call(§_-5R§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §_-Bz§ = ExternalInterface.call(§_-Uy§,ExternalInterface.objectID);
         if(§_-Bz§ == §_-VN§)
         {
            return;
         }
      ...
      public static function get §_-oT§() : int
      {
         return §_-Bz§;
      }
      
      public static function get §return§() : Boolean
      {
         return §_-8u§;
      }
      
      public static function set §return§(param1:Boolean) : void
      {
         §_-8u§ = param1;
      }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §_-gn§.getObjectsUnderPoint(new Point(§_-gn§.mouseX,§_-gn§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
