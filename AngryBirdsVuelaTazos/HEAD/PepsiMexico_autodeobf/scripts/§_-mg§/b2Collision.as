package §_-mg§
{
   ...
   public class b2Collision
   {
      ...
      private static var §_-nD§:Vector.<§_-GN§> = §_-QI§();
      
      private static var s_clipPoints1:Vector.<§_-GN§> = §_-QI§();
      
      private static var s_clipPoints2:Vector.<§_-GN§> = §_-QI§();
      
      private static var §_-lV§:Vector.<int> = new Vector.<int>(1);
      
      private static var §_-2§:Vector.<int> = new Vector.<int>(1);
      
      private static var §_-as§:b2Vec2 = new b2Vec2();
      
      private static var §_-zm§:b2Vec2 = new b2Vec2();
      
      private static var §_-pf§:b2Vec2 = new b2Vec2();
      
      private static var §_-VH§:b2Vec2 = new b2Vec2();
      
      private static var §_-LQ§:b2Vec2 = new b2Vec2();
      ...
      public static function §_-GH§(param1:Vector.<§_-GN§>, param2:Vector.<§_-GN§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§_-GN§ = null;
         var _loc6_:int = 0;
         var _loc7_:b2Vec2 = null;
         var _loc9_:Number = NaN;
         var _loc11_:Number = NaN;
         var _loc12_:b2Vec2 = null;
         var _loc13_:§_-GN§ = null;
         _loc6_ = 0;
      ...
      public static function §_-FJ§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§_-aU§;
         var _loc7_:Vector.<b2Vec2> = param1.§_-4p§;
         var _loc8_:Vector.<b2Vec2> = param1.§_-Bp§;
         var _loc9_:int = param4.§_-aU§;
         var _loc10_:Vector.<b2Vec2> = param4.§_-4p§;
         _loc11_ = param2.R;
      ...
      public static function §_-5h§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§_-aU§;
         var _loc7_:Vector.<b2Vec2> = param2.§_-Bp§;
         _loc9_ = param5.R;
         _loc8_ = param4.§_-Pe§;
         ...
         var _loc17_:Number = §_-FJ§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §_-FJ§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §_-FJ§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §_-FJ§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §_-El§(param1:Vector.<§_-GN§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§_-GN§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§_-aU§;
         var _loc8_:Vector.<b2Vec2> = param2.§_-Bp§;
         var _loc9_:int = param5.§_-aU§;
         var _loc10_:Vector.<b2Vec2> = param5.§_-4p§;
         var _loc11_:Vector.<b2Vec2> = param5.§_-Bp§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§_-Jd§.§switch§ = param4;
         _loc20_.id.§_-Jd§.§_-dQ§ = _loc21_;
         _loc20_.id.§_-Jd§.§_-qT§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§_-Jd§.§switch§ = param4;
         _loc20_.id.§_-Jd§.§_-dQ§ = _loc22_;
         _loc20_.id.§_-Jd§.§_-qT§ = 1;
      }
      
      private static function §_-QI§() : Vector.<§_-GN§>
      {
         var _loc1_:Vector.<§_-GN§> = new Vector.<§_-GN§>(2);
         _loc1_[0] = new §_-GN§();
         _loc1_[1] = new §_-GN§();
         return _loc1_;
      }
      
      public static function §_-gZ§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§_-GN§ = null;
         ...
         param1.§_-HT§ = 0;
         var _loc7_:Number = param2.§_-Cv§ + param4.§_-Cv§;
         var _loc8_:int = 0;
         §_-lV§[0] = _loc8_;
         var _loc9_:Number = §_-5h§(§_-lV§,param2,param3,param4,param5);
         _loc8_ = §_-lV§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §_-2§[0] = _loc10_;
         var _loc11_:Number = §_-5h§(§_-2§,param4,param5,param2,param3);
         _loc10_ = §_-2§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§_-Ra§ = b2Manifold.§_-y2§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§_-GN§> = §_-nD§;
         §_-El§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§_-aU§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§_-4p§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §_-as§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §_-zm§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §_-pf§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §_-LQ§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§_-GN§> = s_clipPoints1;
         var _loc38_:Vector.<§_-GN§> = s_clipPoints2;
         if((_loc39_ = §_-GH§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §_-GH§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§_-nZ§.SetV(_loc27_);
         ...
         while(_loc41_ < b2Settings.b2_maxManifoldPoints)
         {
            ...
            if((_loc42_ = _loc31_.x * _loc6_.v.x + _loc31_.y * _loc6_.v.y - _loc34_) <= _loc7_)
            {
               ...
               _loc43_.m_id.§_-Jd§.§_-ci§ = _loc17_;
               _loc40_++;
            }
            _loc41_++;
         }
      ...
      public static function §_-mx§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§_-Cv§ + param4.§_-Cv§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§_-Ra§ = b2Manifold.§_-Ia§;
         param1.m_localPoint.SetV(param2.§_-cE§);
         param1.§_-nZ§.§_-qi§();
         param1.§_-HT§ = 1;
         param1.§_-Eb§[0].m_localPoint.SetV(param4.§_-cE§);
         param1.§_-Eb§[0].m_id.key = 0;
      }
      
      public static function §_-5s§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§_-Cv§ + param4.§_-Cv§;
         var _loc21_:int = param2.§_-aU§;
         var _loc22_:Vector.<b2Vec2> = param2.§_-4p§;
         var _loc23_:Vector.<b2Vec2> = param2.§_-Bp§;
         var _loc24_:int = 0;
         ...
         if(_loc19_ < Number.MIN_VALUE)
         {
            param1.§_-HT§ = 1;
            param1.§_-Ra§ = b2Manifold.§_-y2§;
            param1.§_-nZ§.SetV(_loc23_[_loc18_]);
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§_-HT§ = 1;
            param1.§_-Ra§ = b2Manifold.§_-y2§;
            param1.§_-nZ§.x = _loc15_ - _loc27_.x;
            param1.§_-nZ§.y = _loc16_ - _loc27_.y;
            param1.§_-nZ§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§_-HT§ = 1;
            param1.§_-Ra§ = b2Manifold.§_-y2§;
            param1.§_-nZ§.x = _loc15_ - _loc28_.x;
            param1.§_-nZ§.y = _loc16_ - _loc28_.y;
            param1.§_-nZ§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§_-Eb§[0].m_localPoint.SetV(param4.§_-cE§);
            param1.§_-Eb§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§_-HT§ = 1;
            param1.§_-Ra§ = b2Manifold.§_-y2§;
            param1.§_-nZ§.x = _loc23_[_loc25_].x;
            param1.§_-nZ§.y = _loc23_[_loc25_].y;
            param1.§_-nZ§.Normalize();
      ...
      public static function §_-lP§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§_-PO§;
         var _loc4_:b2Vec2 = param1.§_-LW§;
