package §_-zP§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§_-TZ§.x * this.§_-g5§.x + (this.§_-ss§ + this.§_-TZ§.y) * this.§_-hR§.x),param1 * (this.§_-TZ§.x * this.§_-g5§.y + (this.§_-ss§ + this.§_-TZ§.y) * this.§_-hR§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§_-Nr§ = this.§_-Nr§ > Number.MIN_VALUE ? Number(1 / this.§_-Nr§) : Number(0);
         ...
         this.§ use§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§ use§.col2.x = this.§ use§.col1.y;
         this.§ use§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§_-KD§)
         {
         ...
         if(param1.§_-uU§)
         {
            ...
            _loc19_ = this.§_-TZ§.x * this.§_-g5§.x + (this.§_-ss§ + this.§_-TZ§.y) * this.§_-hR§.x;
            _loc20_ = this.§_-TZ§.x * this.§_-g5§.y + (this.§_-ss§ + this.§_-TZ§.y) * this.§_-hR§.y;
            _loc21_ = this.§_-TZ§.x * this.m_s1 + (this.§_-ss§ + this.§_-TZ§.y) * this.m_a1;
            _loc22_ = this.§_-TZ§.x * this.m_s2 + (this.§_-ss§ + this.§_-TZ§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§_-hR§.x * (_loc6_.x - _loc4_.x) + this.§_-hR§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§_-Nr§ * (this.§_-qu§ - _loc13_);
            _loc15_ = this.§_-ss§;
            _loc16_ = param1.§_-Qf§ * this.§_-t8§;
            this.§_-ss§ = b2Math.§_-rr§(this.§_-ss§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§_-ss§ - _loc15_) * this.§_-hR§.x;
            _loc9_ = _loc14_ * this.§_-hR§.y;
         ...
         {
            _loc17_ = this.§_-hR§.x * (_loc6_.x - _loc4_.x) + this.§_-hR§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§_-TZ§.Copy();
            _loc19_ = this.§ use§.§_-TD§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§_-TZ§.§_-B8§(_loc19_);
            if(this.§_-l-§ == b2internal::_-3O)
            {
               this.§_-TZ§.y = b2Math.§_-44§(this.§_-TZ§.y,0);
            }
            else if(this.§_-l-§ == b2internal::_-3x)
            {
               this.§_-TZ§.y = b2Math.§_-1A§(this.§_-TZ§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§_-TZ§.y - _loc18_.y) * this.§ use§.col2.x;
            if(this.§ use§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§ use§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§_-TZ§.x = _loc21_;
            _loc19_.x = this.§_-TZ§.x - _loc18_.x;
            _loc19_.y = this.§_-TZ§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§_-g5§.x + _loc19_.y * this.§_-hR§.x;
            _loc9_ = _loc19_.x * this.§_-g5§.y + _loc19_.y * this.§_-hR§.y;
         ...
         else
         {
            if(this.§ use§.col1.x != 0)
            {
               _loc22_ = -_loc12_ / this.§ use§.col1.x;
            }
            else
            {
               _loc22_ = 0;
            ...
            this.§_-TZ§.x += _loc22_;
            _loc8_ = _loc22_ * this.§_-g5§.x;
            _loc9_ = _loc22_ * this.§_-g5§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§_-KD§)
         {
            ...
            _loc34_ = this.§_-hR§.x * _loc26_ + this.§_-hR§.y * _loc27_;
            if(b2Math.§_-30§(this.§_-XF§ - this.§_-Pr§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§_-rr§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§_-30§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§_-Pr§)
            {
               _loc19_ = b2Math.§_-rr§(_loc34_ - this.§_-Pr§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§_-Pr§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§_-XF§)
            {
               _loc19_ = b2Math.§_-rr§(_loc34_ - this.§_-XF§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§_-XF§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§ use§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§ use§.col2.x = this.§ use§.col1.y;
            this.§ use§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§ use§.§_-TD§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::_-DC;
         ...
         var _loc30_:Number = _loc28_.x * this.§_-g5§.x + _loc28_.y * this.§_-hR§.x;
         var _loc31_:Number = _loc28_.x * this.§_-g5§.y + _loc28_.y * this.§_-hR§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::_-DC * _loc30_;
         _loc6_.y -= b2internal::_-DC * _loc31_;
         _loc7_ -= b2internal::_-NS * _loc32_;
         _loc8_.x += b2internal::_-TG * _loc30_;
         _loc8_.y += b2internal::_-TG * _loc31_;
         _loc9_ += b2internal::_-e * _loc33_;
