package §_-Pu§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      b2internal var §_-om§:Number;
      
      b2internal var §_-K4§:b2Vec2;
      
      b2internal var §_-DB§:b2Vec2;
      ...
      b2internal var §_-y-§:b2EdgeShape;
      
      b2internal var §_-Id§:b2EdgeShape;
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§_-DB§ = new b2Vec2();
         this.m_cornerDir1 = new b2Vec2();
         this.m_cornerDir2 = new b2Vec2();
         super();
         §_-Ra§ = b2internal::_-ne;
         this.§_-Id§ = null;
         this.§_-y-§ = null;
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§_-DB§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§_-om§ = this.§_-DB§.Normalize();
         this.§_-K4§.Set(this.§_-DB§.y,-this.§_-DB§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§_-K4§.x - this.§_-DB§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§_-K4§.y - this.§_-DB§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§_-K4§.x + this.§_-DB§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§_-K4§.y + this.§_-DB§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§_-K4§;
         this.m_cornerDir2.Set(-this.§_-K4§.x,-this.§_-K4§.y);
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§_-1x§ * _loc12_)
            {
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         if(_loc4_ < _loc6_)
         {
            param1.§_-PO§.x = _loc4_;
            param1.§_-LW§.x = _loc6_;
         }
         else
         {
            param1.§_-PO§.x = _loc6_;
            param1.§_-LW§.x = _loc4_;
         }
         if(_loc5_ < _loc7_)
         {
            param1.§_-PO§.y = _loc5_;
            param1.§_-LW§.y = _loc7_;
         }
         else
         {
            param1.§_-PO§.y = _loc7_;
            param1.§_-LW§.y = _loc5_;
         }
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§_-av§(param3,this.m_v1);
         var _loc7_:b2Vec2 = b2Math.§_-av§(param3,this.m_v2);
         var _loc8_:Number = b2Math.§_-Ve§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§_-Ve§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §_-vX§() : b2Vec2
      {
         return this.§_-K4§;
      }
      
      public function §_-QU§() : b2Vec2
      {
         return this.§_-DB§;
      }
      ...
      public function §_-2w§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §_-7P§() : b2EdgeShape
      {
         return this.§_-y-§;
      }
      
      public function §_-Lj§() : b2EdgeShape
      {
         return this.§_-Id§;
      }
      
      public function §_-hU§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
      ...
      b2internal function §_-N7§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§_-Id§ = param1;
      ...
      b2internal function §_-YR§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§_-y-§ = param1;
