package §_-Pu§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §_-XL§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §_-Pe§:b2Vec2;
      
      b2internal var §_-4p§:Vector.<b2Vec2>;
      
      b2internal var §_-Bp§:Vector.<b2Vec2>;
      
      b2internal var §_-aU§:int;
      
      public function b2PolygonShape()
      {
         super();
         §_-Ra§ = b2internal::_-u-;
         this.§_-Pe§ = new b2Vec2();
         this.§_-4p§ = new Vector.<b2Vec2>();
         this.§_-Bp§ = new Vector.<b2Vec2>();
         §_-Cv§ = b2Settings.b2_polygonRadius;
         this.§_-Pe§.§_-qi§();
      }
      
      public static function §_-CH§(param1:Array, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-qU§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-Mr§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-Il§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-h§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-fP§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-dG§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§_-Nw§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §_-EO§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-US§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-Tu§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§_-B8§(new b2Vec2(0,0));
            _loc3_.§_-B8§(_loc9_);
            _loc3_.§_-B8§(_loc10_);
            _loc3_.§_-2O§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §_-AW§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§_-NI§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§_-NI§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§_-Pe§.SetV(_loc2_.§_-Pe§);
            this.§_-aU§ = _loc2_.§_-aU§;
            this.§_-Ko§(this.§_-aU§);
            _loc3_ = 0;
            while(_loc3_ < this.§_-aU§)
            {
               this.§_-4p§[_loc3_].SetV(_loc2_.§_-4p§[_loc3_]);
               this.§_-Bp§[_loc3_].SetV(_loc2_.§_-Bp§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §_-qU§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§_-Il§(_loc3_,param2);
      }
      
      public function §_-Il§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§_-aU§)
         {
            this.§_-4p§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§_-aU§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§_-aU§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§_-2E§(this.§_-4p§[_loc5_],this.§_-4p§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§_-vz§() > Number.MIN_VALUE);
            this.§_-Bp§[_loc3_].SetV(b2Math.§_-Rg§(_loc6_,1));
            this.§_-Bp§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§_-Pe§ = §_-Tu§(this.§_-4p§,this.§_-aU§);
      }
      
      public function §_-fP§(param1:Number, param2:Number) : void
      {
         this.§_-aU§ = 4;
         this.§_-Ko§(4);
         this.§_-4p§[0].Set(-param1,-param2);
         this.§_-4p§[1].Set(param1,-param2);
         this.§_-4p§[2].Set(param1,param2);
         this.§_-4p§[3].Set(-param1,param2);
         this.§_-Bp§[0].Set(0,-1);
         this.§_-Bp§[1].Set(1,0);
         this.§_-Bp§[2].Set(0,1);
         this.§_-Bp§[3].Set(-1,0);
      ...
      public function §_-Nw§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§_-aU§ = 4;
         this.§_-Ko§(4);
         this.§_-4p§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§_-aU§)
         {
            this.§_-4p§[_loc6_] = b2Math.§_-av§(_loc5_,this.§_-4p§[_loc6_]);
            this.§_-Bp§[_loc6_] = b2Math.§_-7h§(_loc5_.R,this.§_-Bp§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §_-US§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§_-aU§ = 2;
         this.§_-Ko§(2);
         this.§_-4p§[0].SetV(param1);
         this.§_-4p§[1].SetV(param2);
         this.§_-Pe§.x = 0.5 * (param1.x + param2.x);
         this.§_-Pe§.y = 0.5 * (param1.y + param2.y);
         this.§_-Bp§[0] = b2Math.§_-Rg§(b2Math.§_-2E§(param2,param1),1);
         this.§_-Bp§[0].Normalize();
         this.§_-Bp§[1].x = -this.§_-Bp§[0].x;
         this.§_-Bp§[1].y = -this.§_-Bp§[0].y;
      }
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < this.§_-aU§)
         {
            _loc3_ = this.§_-4p§[_loc9_];
            _loc5_ = _loc7_ - _loc3_.x;
            _loc6_ = _loc8_ - _loc3_.y;
            _loc3_ = this.§_-Bp§[_loc9_];
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§_-aU§)
         {
            _loc6_ = (_loc9_ = this.§_-4p§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§_-Bp§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§_-PO§.x = _loc5_ - b2internal::_-Cv;
         param1.§_-PO§.y = _loc6_ - b2internal::_-Cv;
         param1.§_-LW§.x = _loc7_ + b2internal::_-Cv;
         param1.§_-LW§.y = _loc8_ + b2internal::_-Cv;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§_-aU§ == 2)
         {
            param1.center.x = 0.5 * (this.§_-4p§[0].x + this.§_-4p§[1].x);
            param1.center.y = 0.5 * (this.§_-4p§[0].y + this.§_-4p§[1].y);
            param1.§_-Kn§ = 0;
            param1.§_-hW§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§_-aU§)
         {
            _loc11_ = this.§_-4p§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§_-aU§ ? this.§_-4p§[int(_loc10_ + 1)] : this.§_-4p§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§_-Kn§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§_-hW§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§_-D1§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§_-Ve§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§_-aU§)
         {
            _loc7_[_loc12_] = b2Math.§_-Ve§(_loc5_,this.§_-4p§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§_-av§(param3,_loc24_.center));
                  return _loc24_.§_-Kn§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§_-aU§;
         var _loc14_:int = (_loc10_ + 1) % this.§_-aU§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§_-4p§[_loc9_].x * (1 - _loc15_) + this.§_-4p§[_loc13_].x * _loc15_,this.§_-4p§[_loc9_].y * (1 - _loc15_) + this.§_-4p§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§_-4p§[_loc10_].x * (1 - _loc16_) + this.§_-4p§[_loc14_].x * _loc16_,this.§_-4p§[_loc10_].y * (1 - _loc16_) + this.§_-4p§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§_-4p§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§_-aU§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§_-4p§[_loc12_];
            }
         ...
         _loc20_.§_-2O§(1 / _loc19_);
         param4.SetV(b2Math.§_-av§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §_-xu§() : Vector.<b2Vec2>
      {
         return this.§_-4p§;
      }
      
      public function §_-yS§() : Vector.<b2Vec2>
      {
         return this.§_-Bp§;
      }
      
      public function §_-0F§(param1:b2Vec2) : int
      {
         var _loc5_:Number = NaN;
         var _loc2_:int = 0;
         var _loc3_:Number = this.§_-4p§[0].x * param1.x + this.§_-4p§[0].y * param1.y;
         var _loc4_:int = 1;
         while(_loc4_ < this.§_-aU§)
         {
      ...
      {
         var _loc2_:int = this.§_-4p§.length;
         while(_loc2_ < param1)
         {
            this.§_-4p§[_loc2_] = new b2Vec2();
            this.§_-Bp§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
