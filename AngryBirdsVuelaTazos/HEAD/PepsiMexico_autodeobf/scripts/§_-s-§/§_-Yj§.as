package §_-s-§
{
   ...
   public class §_-Yj§
   {
      ...
      public function §_-Yj§(param1:*)
      {
         super();
         this.§_-P-§ = this.§_-gD§(param1);
      }
      ...
      private function §_-gD§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§_-PW§(param1 as String);
         }
         if(param1 is Number)
         {
         ...
         if(param1 is Array)
         {
            return this.§_-6a§(param1 as Array);
         }
      ...
      private function §_-PW§(param1:String) : String
      {
      ...
      private function §_-6a§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§_-gD§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §_-0f§(param1:Object) : String
      {
         ...
         if(classInfo.@name.toString() == "Object")
         {
            for(key in o)
            {
               ...
               if(!(value is Function))
               {
                  ...
                  s += this.§_-PW§(key) + ":" + this.§_-gD§(value);
               }
            }
         }
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§_-PW§(v.@name.toString()) + ":" + this.§_-gD§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
