package §var§
{
   public class b2Sweep
   {
      ...
      public function Copy() : b2Sweep
      {
         ...
         _loc1_.a0 = this.a0;
         _loc1_.a = this.a;
         _loc1_.§_-EZ§ = this.§_-EZ§;
         return _loc1_;
      }
      
      public function §_-tx§(param1:b2Transform, param2:Number) : void
      {
      ...
      public function §_-n6§(param1:Number) : void
      {
         var _loc2_:Number = NaN;
         if(this.§_-EZ§ < param1 && 1 - this.§_-EZ§ > Number.MIN_VALUE)
         {
            _loc2_ = (param1 - this.§_-EZ§) / (1 - this.§_-EZ§);
