package §var§
{
   public class b2Mat22
   {
      ...
      public static function §_-iG§(param1:Number) : b2Mat22
      {
      ...
      public static function §_-rc§(param1:b2Vec2, param2:b2Vec2) : b2Mat22
      {
         var _loc3_:b2Mat22 = new b2Mat22();
         _loc3_.§_-TS§(param1,param2);
         return _loc3_;
      }
      ...
      public function §_-TS§(param1:b2Vec2, param2:b2Vec2) : void
      {
      ...
      public function §_-rb§(param1:b2Mat22) : void
      {
         this.col1.SetV(param1.col1);
         this.col2.SetV(param1.col2);
      }
      
      public function §_-Ge§(param1:b2Mat22) : void
      {
      ...
      public function §_-Ph§(param1:b2Mat22) : b2Mat22
      {
      ...
      public function §_-Zy§(param1:b2Vec2, param2:Number, param3:Number) : b2Vec2
      {
