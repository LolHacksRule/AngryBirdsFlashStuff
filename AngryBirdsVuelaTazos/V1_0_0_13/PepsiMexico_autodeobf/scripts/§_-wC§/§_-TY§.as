package §_-wC§
{
   ...
   public class §_-TY§
   {
      ...
      public static var §_-Hg§:ByteArray;
      ...
      public static function §_-MG§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-5D§(_loc2_);
         return §_-qK§.§_-us§(_loc3_.readInt(),true) + §_-qK§.§_-us§(_loc3_.readInt(),true) + §_-qK§.§_-us§(_loc3_.readInt(),true) + §_-qK§.§_-us§(_loc3_.readInt(),true) + §_-qK§.§_-us§(_loc3_.readInt(),true);
      }
      
      public static function §_-oh§(param1:ByteArray) : String
      {
         var _loc2_:Array = §_-TY§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §_-5D§(_loc2_);
         return §_-qK§.§_-us§(_loc3_.readInt(),true) + §_-qK§.§_-us§(_loc3_.readInt(),true) + §_-qK§.§_-us§(_loc3_.readInt(),true) + §_-qK§.§_-us§(_loc3_.readInt(),true) + §_-qK§.§_-us§(_loc3_.readInt(),true);
      }
      
      public static function §_-pj§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §_-TY§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-5D§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §_-5D§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
