package §_-wZ§
{
   ...
   class b2SeparationFunction
   {
      ...
      public static const §_-VY§:int = 1;
      ...
      public var §_-dp§:b2DistanceProxy;
      
      public var §_-gE§:b2DistanceProxy;
      
      public var §_-64§:int;
      
      public var m_localPoint:b2Vec2;
      
      public var §_-Oi§:b2Vec2;
      ...
      public function §_-PU§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§_-64§ = §_-VY§;
            _loc7_ = this.§_-dp§.§_-br§(param1.indexA[0]);
            _loc10_ = this.§_-gE§.§_-br§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§_-Oi§.x = _loc15_ - _loc13_;
            this.§_-Oi§.y = _loc16_ - _loc14_;
            this.§_-Oi§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§_-64§ = §_-EB§;
            _loc8_ = this.§_-dp§.§_-br§(param1.indexA[0]);
            _loc9_ = this.§_-dp§.§_-br§(param1.indexA[1]);
            _loc10_ = this.§_-gE§.§_-br§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§_-Oi§ = b2Math.§_-Ag§(b2Math.§_-MF§(_loc9_,_loc8_),1);
            this.§_-Oi§.Normalize();
            _loc20_ = this.§_-Oi§;
         ...
         {
            this.§_-64§ = §_-j1§;
            _loc11_ = this.§_-gE§.§_-br§(param1.indexB[0]);
            _loc12_ = this.§_-gE§.§_-br§(param1.indexB[1]);
            _loc7_ = this.§_-dp§.§_-br§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§_-Oi§ = b2Math.§_-Ag§(b2Math.§_-MF§(_loc12_,_loc11_),1);
            this.§_-Oi§.Normalize();
            _loc20_ = this.§_-Oi§;
         ...
         else
         {
            ...
            _loc11_ = this.§_-gE§.§_-br§(param1.indexB[0]);
            _loc12_ = this.§_-gE§.§_-br§(param1.indexB[1]);
            _loc23_ = b2Math.§_-ei§(param3,_loc7_);
            _loc24_ = b2Math.§_-hb§(param3.R,b2Math.§_-MF§(_loc9_,_loc8_));
            _loc25_ = b2Math.§_-ei§(param5,_loc10_);
            _loc26_ = b2Math.§_-hb§(param5.R,b2Math.§_-MF§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§_-MF§(_loc26_,_loc24_);
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§_-vw§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§_-vw§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §_-VY§:
               _loc3_ = b2Math.§_-IL§(param1.R,this.§_-Oi§);
               _loc4_ = b2Math.§_-IL§(param2.R,this.§_-Oi§.§_-jb§());
               _loc5_ = this.§_-dp§.§_-YG§(_loc3_);
               _loc6_ = this.§_-gE§.§_-YG§(_loc4_);
               _loc7_ = b2Math.§_-ei§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§_-ei§(param2,_loc6_)).x - _loc7_.x) * this.§_-Oi§.x + (_loc8_.y - _loc7_.y) * this.§_-Oi§.y);
            case §_-EB§:
               _loc10_ = b2Math.§_-hb§(param1.R,this.§_-Oi§);
               _loc7_ = b2Math.§_-ei§(param1,this.m_localPoint);
               _loc4_ = b2Math.§_-IL§(param2.R,_loc10_.§_-jb§());
               _loc6_ = this.§_-gE§.§_-YG§(_loc4_);
               return Number(((_loc8_ = b2Math.§_-ei§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §_-j1§:
               _loc10_ = b2Math.§_-hb§(param2.R,this.§_-Oi§);
               _loc8_ = b2Math.§_-ei§(param2,this.m_localPoint);
               _loc3_ = b2Math.§_-IL§(param1.R,_loc10_.§_-jb§());
               _loc5_ = this.§_-dp§.§_-YG§(_loc3_);
               return Number(((_loc7_ = b2Math.§_-ei§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
