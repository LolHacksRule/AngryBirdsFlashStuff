package §_-wZ§
{
   ...
   public class b2Collision
   {
      ...
      private static var §_-rk§:Vector.<§_-Rb§> = §_-Al§();
      
      private static var s_clipPoints1:Vector.<§_-Rb§> = §_-Al§();
      
      private static var s_clipPoints2:Vector.<§_-Rb§> = §_-Al§();
      
      private static var §_-k8§:Vector.<int> = new Vector.<int>(1);
      
      private static var §_-Sv§:Vector.<int> = new Vector.<int>(1);
      
      private static var §_-Iz§:b2Vec2 = new b2Vec2();
      
      private static var §_-7s§:b2Vec2 = new b2Vec2();
      
      private static var §_-fB§:b2Vec2 = new b2Vec2();
      
      private static var §use §:b2Vec2 = new b2Vec2();
      
      private static var §_-pO§:b2Vec2 = new b2Vec2();
      ...
      public static function §_-hD§(param1:Vector.<§_-Rb§>, param2:Vector.<§_-Rb§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§_-Rb§ = null;
         var _loc6_:int = 0;
         var _loc7_:b2Vec2 = null;
         var _loc9_:Number = NaN;
         var _loc11_:Number = NaN;
         var _loc12_:b2Vec2 = null;
         var _loc13_:§_-Rb§ = null;
         _loc6_ = 0;
      ...
      public static function §_-jm§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§_-n5§;
         var _loc7_:Vector.<b2Vec2> = param1.§_-zV§;
         var _loc8_:Vector.<b2Vec2> = param1.§_-JJ§;
         var _loc9_:int = param4.§_-n5§;
         var _loc10_:Vector.<b2Vec2> = param4.§_-zV§;
         _loc11_ = param2.R;
      ...
      public static function §_-vK§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§_-n5§;
         var _loc7_:Vector.<b2Vec2> = param2.§_-JJ§;
         _loc9_ = param5.R;
         _loc8_ = param4.§_-EA§;
         ...
         var _loc17_:Number = §_-jm§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §_-jm§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §_-jm§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §_-jm§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §_-97§(param1:Vector.<§_-Rb§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§_-Rb§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§_-n5§;
         var _loc8_:Vector.<b2Vec2> = param2.§_-JJ§;
         var _loc9_:int = param5.§_-n5§;
         var _loc10_:Vector.<b2Vec2> = param5.§_-zV§;
         var _loc11_:Vector.<b2Vec2> = param5.§_-JJ§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§_-nm§.§_-aj§ = param4;
         _loc20_.id.§_-nm§.§_-pA§ = _loc21_;
         _loc20_.id.§_-nm§.§_-AA§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§_-nm§.§_-aj§ = param4;
         _loc20_.id.§_-nm§.§_-pA§ = _loc22_;
         _loc20_.id.§_-nm§.§_-AA§ = 1;
      }
      
      private static function §_-Al§() : Vector.<§_-Rb§>
      {
         var _loc1_:Vector.<§_-Rb§> = new Vector.<§_-Rb§>(2);
         _loc1_[0] = new §_-Rb§();
         _loc1_[1] = new §_-Rb§();
         return _loc1_;
      }
      
      public static function §_-dT§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§_-Rb§ = null;
         ...
         param1.§_-QB§ = 0;
         var _loc7_:Number = param2.§_-uG§ + param4.§_-uG§;
         var _loc8_:int = 0;
         §_-k8§[0] = _loc8_;
         var _loc9_:Number = §_-vK§(§_-k8§,param2,param3,param4,param5);
         _loc8_ = §_-k8§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §_-Sv§[0] = _loc10_;
         var _loc11_:Number = §_-vK§(§_-Sv§,param4,param5,param2,param3);
         _loc10_ = §_-Sv§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§_-64§ = b2Manifold.§_-EB§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§_-Rb§> = §_-rk§;
         §_-97§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§_-n5§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§_-zV§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §_-Iz§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §_-7s§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §_-fB§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §_-pO§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§_-Rb§> = s_clipPoints1;
         var _loc38_:Vector.<§_-Rb§> = s_clipPoints2;
         if((_loc39_ = §_-hD§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §_-hD§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§_-1b§.SetV(_loc27_);
         ...
         while(_loc41_ < b2Settings.b2_maxManifoldPoints)
         {
            ...
            if((_loc42_ = _loc31_.x * _loc6_.v.x + _loc31_.y * _loc6_.v.y - _loc34_) <= _loc7_)
            {
               ...
               _loc43_.m_id.§_-nm§.§_-vE§ = _loc17_;
               _loc40_++;
            }
            _loc41_++;
         }
      ...
      public static function §_-Qu§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§_-uG§ + param4.§_-uG§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§_-64§ = b2Manifold.§_-h6§;
         param1.m_localPoint.SetV(param2.§_-SG§);
         param1.§_-1b§.§_-pR§();
         param1.§_-QB§ = 1;
         param1.§_-KA§[0].m_localPoint.SetV(param4.§_-SG§);
         param1.§_-KA§[0].m_id.key = 0;
      }
      
      public static function §_-oL§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§_-uG§ + param4.§_-uG§;
         var _loc21_:int = param2.§_-n5§;
         var _loc22_:Vector.<b2Vec2> = param2.§_-zV§;
         var _loc23_:Vector.<b2Vec2> = param2.§_-JJ§;
         var _loc24_:int = 0;
         ...
         if(_loc19_ < Number.MIN_VALUE)
         {
            param1.§_-QB§ = 1;
            param1.§_-64§ = b2Manifold.§_-EB§;
            param1.§_-1b§.SetV(_loc23_[_loc18_]);
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§_-QB§ = 1;
            param1.§_-64§ = b2Manifold.§_-EB§;
            param1.§_-1b§.x = _loc15_ - _loc27_.x;
            param1.§_-1b§.y = _loc16_ - _loc27_.y;
            param1.§_-1b§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§_-QB§ = 1;
            param1.§_-64§ = b2Manifold.§_-EB§;
            param1.§_-1b§.x = _loc15_ - _loc28_.x;
            param1.§_-1b§.y = _loc16_ - _loc28_.y;
            param1.§_-1b§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§_-KA§[0].m_localPoint.SetV(param4.§_-SG§);
            param1.§_-KA§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§_-QB§ = 1;
            param1.§_-64§ = b2Manifold.§_-EB§;
            param1.§_-1b§.x = _loc23_[_loc25_].x;
            param1.§_-1b§.y = _loc23_[_loc25_].y;
            param1.§_-1b§.Normalize();
      ...
      public static function §_-db§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§_-Cw§;
         var _loc4_:b2Vec2 = param1.§_-OC§;
