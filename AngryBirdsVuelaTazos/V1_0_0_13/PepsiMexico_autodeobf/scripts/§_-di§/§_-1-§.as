package §_-di§
{
   ...
   public class §_-1-§ extends §_-XM§
   {
       
      
      public function §_-1-§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§_-Uf§(param1,param2);
      }
      
      protected function §_-Uf§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc8_:int = 0;
         var _loc9_:int = 0;
         var _loc10_:§_-9Y§ = null;
         var _loc11_:Rectangle = null;
         var _loc12_:§_-hc§ = null;
         var _loc3_:Dictionary = this.§_-2h§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if(_loc10_ = _loc3_[this.§_-LC§(_loc7_,_loc6_)])
            {
               _loc11_ = new Rectangle(_loc8_ + _loc10_.x,_loc9_ + _loc10_.y,_loc10_.width,_loc10_.height);
               (_loc12_ = new §_-hc§()).mName = _loc6_;
               _loc12_.§_-WP§ = _loc11_;
               _loc12_.§_-u1§ = _loc10_.pivotX;
               _loc12_.§_-su§ = _loc10_.pivotY;
               _loc12_.§_-KL§ = §_-At§;
               §_-Zg§(_loc12_);
            }
         }
      ...
      private function §_-LC§(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function §_-2h§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§_-LC§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §_-9Y§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
