package §_-Yv§
{
   ...
   public class §_-Jn§
   {
      ...
      public static function §_-UD§(param1:Stage) : void
      {
         ...
         §_-aQ§ = param1;
         ExternalInterface.call(§_-Ej§);
         ExternalInterface.call(§_-Mb§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §_-vp§ = ExternalInterface.call(§_-lf§,ExternalInterface.objectID);
         if(§_-vp§ == §_-Ox§)
         {
            return;
         }
      ...
      public static function get §_-Ui§() : Boolean
      {
         return §_-UQ§;
      }
      
      public static function set §_-Ui§(param1:Boolean) : void
      {
         §_-UQ§ = param1;
      }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §_-aQ§.getObjectsUnderPoint(new Point(§_-aQ§.mouseX,§_-aQ§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
