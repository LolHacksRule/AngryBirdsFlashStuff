package §_-8i§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      b2internal var §_-XV§:Number;
      
      b2internal var §_-dE§:b2Vec2;
      
      b2internal var §_-Oh§:b2Vec2;
      ...
      b2internal var §_-lU§:b2EdgeShape;
      
      b2internal var §_-Nd§:b2EdgeShape;
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§_-Oh§ = new b2Vec2();
         this.m_cornerDir1 = new b2Vec2();
         this.m_cornerDir2 = new b2Vec2();
         super();
         §_-64§ = b2internal::_-pV;
         this.§_-Nd§ = null;
         this.§_-lU§ = null;
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§_-Oh§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§_-XV§ = this.§_-Oh§.Normalize();
         this.§_-dE§.Set(this.§_-Oh§.y,-this.§_-Oh§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§_-dE§.x - this.§_-Oh§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§_-dE§.y - this.§_-Oh§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§_-dE§.x + this.§_-Oh§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§_-dE§.y + this.§_-Oh§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§_-dE§;
         this.m_cornerDir2.Set(-this.§_-dE§.x,-this.§_-dE§.y);
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§_-r3§ * _loc12_)
            {
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         if(_loc4_ < _loc6_)
         {
            param1.§_-Cw§.x = _loc4_;
            param1.§_-OC§.x = _loc6_;
         }
         else
         {
            param1.§_-Cw§.x = _loc6_;
            param1.§_-OC§.x = _loc4_;
         }
         if(_loc5_ < _loc7_)
         {
            param1.§_-Cw§.y = _loc5_;
            param1.§_-OC§.y = _loc7_;
         }
         else
         {
            param1.§_-Cw§.y = _loc7_;
            param1.§_-OC§.y = _loc5_;
         }
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§_-ei§(param3,this.m_v1);
         var _loc7_:b2Vec2 = b2Math.§_-ei§(param3,this.m_v2);
         var _loc8_:Number = b2Math.§_-WJ§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§_-WJ§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §_-mF§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §super§() : b2EdgeShape
      {
         return this.§_-lU§;
      }
      
      public function §_-e8§() : b2EdgeShape
      {
         return this.§_-Nd§;
      }
      
      public function §_-M8§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
      ...
      b2internal function §_-5t§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§_-Nd§ = param1;
      ...
      b2internal function §_-px§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§_-lU§ = param1;
