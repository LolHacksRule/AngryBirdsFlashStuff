package §_-8i§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §_-MZ§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §_-EA§:b2Vec2;
      
      b2internal var §_-zV§:Vector.<b2Vec2>;
      
      b2internal var §_-JJ§:Vector.<b2Vec2>;
      
      b2internal var §_-n5§:int;
      
      public function b2PolygonShape()
      {
         super();
         §_-64§ = b2internal::_-Bp;
         this.§_-EA§ = new b2Vec2();
         this.§_-zV§ = new Vector.<b2Vec2>();
         this.§_-JJ§ = new Vector.<b2Vec2>();
         §_-uG§ = b2Settings.b2_polygonRadius;
         this.§_-EA§.§_-pR§();
      }
      
      public static function §_-xs§(param1:Array, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-61§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-xX§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-4Q§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-Q5§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-sB§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-is§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§_-Q§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §_-gn§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-Mm§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-Ja§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§default§(new b2Vec2(0,0));
            _loc3_.§default§(_loc9_);
            _loc3_.§default§(_loc10_);
            _loc3_.§_-ju§(_loc16_ * _loc7_);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §_-1R§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§_-bX§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§_-bX§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§_-EA§.SetV(_loc2_.§_-EA§);
            this.§_-n5§ = _loc2_.§_-n5§;
            this.§_-1x§(this.§_-n5§);
            _loc3_ = 0;
            while(_loc3_ < this.§_-n5§)
            {
               this.§_-zV§[_loc3_].SetV(_loc2_.§_-zV§[_loc3_]);
               this.§_-JJ§[_loc3_].SetV(_loc2_.§_-JJ§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §_-61§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§_-4Q§(_loc3_,param2);
      }
      
      public function §_-4Q§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§_-n5§)
         {
            this.§_-zV§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§_-n5§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§_-n5§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§_-MF§(this.§_-zV§[_loc5_],this.§_-zV§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§_-0k§() > Number.MIN_VALUE);
            this.§_-JJ§[_loc3_].SetV(b2Math.§_-Ag§(_loc6_,1));
            this.§_-JJ§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§_-EA§ = §_-Ja§(this.§_-zV§,this.§_-n5§);
      }
      ...
      public function §_-sB§(param1:Number, param2:Number) : void
      {
         this.§_-n5§ = 4;
         this.§_-1x§(4);
         this.§_-zV§[0].Set(-param1,-param2);
         this.§_-zV§[1].Set(param1,-param2);
         this.§_-zV§[2].Set(param1,param2);
         this.§_-zV§[3].Set(-param1,param2);
         this.§_-JJ§[0].Set(0,-1);
         this.§_-JJ§[1].Set(1,0);
         this.§_-JJ§[2].Set(0,1);
         this.§_-JJ§[3].Set(-1,0);
      ...
      public function §_-Q§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§_-n5§ = 4;
         this.§_-1x§(4);
         this.§_-zV§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§_-n5§)
         {
            this.§_-zV§[_loc6_] = b2Math.§_-ei§(_loc5_,this.§_-zV§[_loc6_]);
            this.§_-JJ§[_loc6_] = b2Math.§_-hb§(_loc5_.R,this.§_-JJ§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §_-Mm§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§_-n5§ = 2;
         this.§_-1x§(2);
         this.§_-zV§[0].SetV(param1);
         this.§_-zV§[1].SetV(param2);
         this.§_-EA§.x = 0.5 * (param1.x + param2.x);
         this.§_-EA§.y = 0.5 * (param1.y + param2.y);
         this.§_-JJ§[0] = b2Math.§_-Ag§(b2Math.§_-MF§(param2,param1),1);
         this.§_-JJ§[0].Normalize();
         this.§_-JJ§[1].x = -this.§_-JJ§[0].x;
         this.§_-JJ§[1].y = -this.§_-JJ§[0].y;
      }
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < this.§_-n5§)
         {
            _loc3_ = this.§_-zV§[_loc9_];
            _loc5_ = _loc7_ - _loc3_.x;
            _loc6_ = _loc8_ - _loc3_.y;
            _loc3_ = this.§_-JJ§[_loc9_];
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§_-n5§)
         {
            _loc6_ = (_loc9_ = this.§_-zV§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§_-JJ§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§_-Cw§.x = _loc5_ - b2internal::_-uG;
         param1.§_-Cw§.y = _loc6_ - b2internal::_-uG;
         param1.§_-OC§.x = _loc7_ + b2internal::_-uG;
         param1.§_-OC§.y = _loc8_ + b2internal::_-uG;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§_-n5§ == 2)
         {
            param1.center.x = 0.5 * (this.§_-zV§[0].x + this.§_-zV§[1].x);
            param1.center.y = 0.5 * (this.§_-zV§[0].y + this.§_-zV§[1].y);
            param1.§_-UE§ = 0;
            param1.§_-tB§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§_-n5§)
         {
            _loc11_ = this.§_-zV§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§_-n5§ ? this.§_-zV§[int(_loc10_ + 1)] : this.§_-zV§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§_-UE§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§_-tB§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§_-IL§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§_-WJ§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§_-n5§)
         {
            _loc7_[_loc12_] = b2Math.§_-WJ§(_loc5_,this.§_-zV§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§_-ei§(param3,_loc24_.center));
                  return _loc24_.§_-UE§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§_-n5§;
         var _loc14_:int = (_loc10_ + 1) % this.§_-n5§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§_-zV§[_loc9_].x * (1 - _loc15_) + this.§_-zV§[_loc13_].x * _loc15_,this.§_-zV§[_loc9_].y * (1 - _loc15_) + this.§_-zV§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§_-zV§[_loc10_].x * (1 - _loc16_) + this.§_-zV§[_loc14_].x * _loc16_,this.§_-zV§[_loc10_].y * (1 - _loc16_) + this.§_-zV§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§_-zV§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§_-n5§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§_-zV§[_loc12_];
            }
         ...
         _loc20_.§_-ju§(1 / _loc19_);
         param4.SetV(b2Math.§_-ei§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §_-J7§() : Vector.<b2Vec2>
      {
         return this.§_-zV§;
      }
      
      public function §_-IA§() : Vector.<b2Vec2>
      {
         return this.§_-JJ§;
      }
      
      public function §_-lz§(param1:b2Vec2) : int
      {
         var _loc5_:Number = NaN;
         var _loc2_:int = 0;
         var _loc3_:Number = this.§_-zV§[0].x * param1.x + this.§_-zV§[0].y * param1.y;
         var _loc4_:int = 1;
         while(_loc4_ < this.§_-n5§)
         {
      ...
      private function §_-aL§() : Boolean
      {
         return false;
      }
      
      private function §_-1x§(param1:int) : void
      {
         var _loc2_:int = this.§_-zV§.length;
         while(_loc2_ < param1)
         {
            this.§_-zV§[_loc2_] = new b2Vec2();
            this.§_-JJ§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
