package §_-UX§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private var §_-sl§:Vector.<DisplayObject>;
      
      private var §_-Pf§:Matrix3D;
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§_-sl§ = new Vector.<DisplayObject>(0);
         this.§_-Pf§ = new Matrix3D();
      }
      
      override public function dispose() : void
      {
         var _loc1_:DisplayObject = null;
         for each(_loc1_ in this.§_-sl§)
         {
            _loc1_.dispose();
         }
         super.dispose();
      ...
      public function addChildAt(param1:DisplayObject, param2:int) : void
      {
         ...
         {
            param1.§_-N7§();
            this.§_-sl§.splice(param2,0,param1);
            param1.§_-7n§(this);
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§_-sl§[param1];
            _loc3_.dispatchEvent(new Event(Event.§_-x0§));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§_-cf§));
            }
            _loc3_.§_-7n§(null);
            this.§_-sl§.splice(param1,1);
            if(param2)
            {
               _loc3_.dispose();
            }
      ...
      public function §_-zM§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      {
         return this.§_-sl§.indexOf(param1);
      }
      ...
      public function setChildIndex(param1:DisplayObject, param2:int) : void
      {
         ...
         this.§_-sl§.splice(_loc3_,1);
         this.§_-sl§.splice(param2,0,param1);
      }
      
      public function §_-kR§(param1:DisplayObject, param2:DisplayObject) : void
      {
         var _loc3_:int = this.getChildIndex(param1);
         ...
         this.§_-Uy§(_loc3_,_loc4_);
      }
      
      public function §_-Uy§(param1:int, param2:int) : void
      {
         var _loc3_:DisplayObject = this.getChildAt(param1);
         var _loc4_:DisplayObject = this.getChildAt(param2);
         this.§_-sl§[param1] = _loc4_;
         this.§_-sl§[param2] = _loc3_;
      }
      ...
      override public function getBounds(param1:DisplayObject) : Rectangle
      {
         ...
         var _loc2_:int = this.§_-sl§.length;
         if(_loc2_ == 0)
         {
            _loc3_ = §_-Iy§(param1);
      ...
      override public function hitTestPoint(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc3_:int = this.§_-sl§.length;
         var _loc4_:int = _loc3_ - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.§_-sl§[_loc4_];
            if(!param2 || _loc5_.visible && _loc5_.§_-SS§ && _loc5_.alpha > 0)
            {
               _loc7_ = (_loc6_ = §_-Iy§(_loc5_)).transformPoint(param1);
      ...
      override public function render(param1:§_-t2§, param2:Number) : void
      {
         var _loc3_:DisplayObject = null;
         param2 *= this.alpha;
         param1.§_-H3§(this.§_-Pf§);
         for each(_loc3_ in this.§_-sl§)
         {
            if(_loc3_.alpha != 0 && _loc3_.visible && _loc3_.scaleX != 0 && _loc3_.scaleY != 0)
            {
               param1.§_-JG§(_loc3_);
               _loc3_.render(param1,param2);
               param1.§_-sr§(this.§_-Pf§);
            }
         }
      }
      
      public function §_-qn§(param1:Event) : void
      {
         if(param1.bubbles)
         {
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         var _loc3_:DisplayObject = null;
         _loc2_ = this.§_-9D§(this,param1.type,_loc2_);
         if(_loc2_)
         {
      ...
      private function §_-9D§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : Vector.<DisplayObject>
      {
         var _loc5_:DisplayObject = null;
         ...
         if(_loc4_)
         {
            for each(_loc5_ in _loc4_.§_-sl§)
            {
               param3 = this.§_-9D§(_loc5_,param2,param3);
            }
         }
         return param3;
      }
