package §_-gy§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§continue§.x * this.§_-dC§.x + (this.§_-YX§ + this.§continue§.z) * this.§_-Oi§.x),param1 * (this.§continue§.x * this.§_-dC§.y + (this.§_-YX§ + this.§continue§.z) * this.§_-Oi§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§_-vQ§ > Number.MIN_VALUE)
         {
            this.§_-vQ§ = 1 / this.§_-vQ§;
         }
         ...
         this.§_-WH§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§_-WH§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§_-WH§.col2.x = this.§_-WH§.col1.y;
         this.§_-WH§.col2.y = _loc16_ + _loc17_;
         this.§_-WH§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§_-WH§.col3.x = this.§_-WH§.col1.z;
         this.§_-WH§.col3.y = this.§_-WH§.col2.z;
         this.§_-WH§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§_-ig§)
         {
         ...
         if(param1.§_-bF§)
         {
            ...
            _loc19_ = this.§continue§.x * this.§_-dC§.x + (this.§_-YX§ + this.§continue§.z) * this.§_-Oi§.x;
            _loc20_ = this.§continue§.x * this.§_-dC§.y + (this.§_-YX§ + this.§continue§.z) * this.§_-Oi§.y;
            _loc21_ = this.§continue§.x * this.m_s1 + this.§continue§.y + (this.§_-YX§ + this.§continue§.z) * this.m_a1;
            _loc22_ = this.§continue§.x * this.m_s2 + this.§continue§.y + (this.§_-YX§ + this.§continue§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§_-Oi§.x * (_loc6_.x - _loc4_.x) + this.§_-Oi§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§_-vQ§ * (this.§_-yt§ - _loc14_);
            _loc16_ = this.§_-YX§;
            _loc17_ = param1.§_-sn§ * this.§_-PD§;
            this.§_-YX§ = b2Math.§_-vw§(this.§_-YX§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§_-YX§ - _loc16_) * this.§_-Oi§.x;
            _loc9_ = _loc15_ * this.§_-Oi§.y;
         ...
         {
            _loc18_ = this.§_-Oi§.x * (_loc6_.x - _loc4_.x) + this.§_-Oi§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§continue§.Copy();
            _loc20_ = this.§_-WH§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§continue§.§default§(_loc20_);
            if(this.§_-52§ == b2internal::_-R7)
            {
               this.§continue§.z = b2Math.§_-NO§(this.§continue§.z,0);
            }
            else if(this.§_-52§ == b2internal::_-v4)
            {
               this.§continue§.z = b2Math.§_-U5§(this.§continue§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§continue§.z - _loc19_.z) * this.§_-WH§.col3.x;
            _loc22_ = -_loc13_ - (this.§continue§.z - _loc19_.z) * this.§_-WH§.col3.y;
            _loc23_ = this.§_-WH§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§continue§.x = _loc23_.x;
            this.§continue§.y = _loc23_.y;
            _loc20_.x = this.§continue§.x - _loc19_.x;
            _loc20_.y = this.§continue§.y - _loc19_.y;
            _loc20_.z = this.§continue§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§_-dC§.x + _loc20_.z * this.§_-Oi§.x;
            _loc9_ = _loc20_.x * this.§_-dC§.y + _loc20_.z * this.§_-Oi§.y;
         ...
         {
            _loc24_ = this.§_-WH§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§continue§.x += _loc24_.x;
            this.§continue§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§_-dC§.x;
            _loc9_ = _loc24_.x * this.§_-dC§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§_-ig§)
         {
            ...
            _loc35_ = this.§_-Oi§.x * _loc26_ + this.§_-Oi§.y * _loc27_;
            if(b2Math.§_-PB§(this.§_-Tl§ - this.§_-dO§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§_-vw§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§_-PB§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§_-dO§)
            {
               _loc19_ = b2Math.§_-vw§(_loc35_ - this.§_-dO§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§_-dO§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§_-Tl§)
            {
               _loc19_ = b2Math.§_-vw§(_loc35_ - this.§_-Tl§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§_-Tl§;
               _loc18_ = true;
            }
         }
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§_-68§;
         _loc16_ = b2Math.§_-NO§(_loc16_,b2Math.§_-PB§(_loc29_));
         _loc17_ = b2Math.§_-PB§(_loc30_);
         if(_loc18_)
         {
            ...
            this.§_-WH§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§_-WH§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§_-WH§.col2.x = this.§_-WH§.col1.y;
            this.§_-WH§.col2.y = _loc14_ + _loc15_;
            this.§_-WH§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§_-WH§.col3.x = this.§_-WH§.col1.z;
            this.§_-WH§.col3.y = this.§_-WH§.col2.z;
            this.§_-WH§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§_-WH§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::_-r5;
            ...
            this.§_-WH§.col1.Set(_loc36_,_loc37_,0);
            this.§_-WH§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§_-WH§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§_-dC§.x + _loc28_.z * this.§_-Oi§.x;
         var _loc32_:Number = _loc28_.x * this.§_-dC§.y + _loc28_.z * this.§_-Oi§.y;
         ...
         _loc6_.x -= b2internal::_-r5 * _loc31_;
         _loc6_.y -= b2internal::_-r5 * _loc32_;
         _loc7_ -= b2internal::_-Y5 * _loc33_;
         _loc8_.x += b2internal::_-OX * _loc31_;
         _loc8_.y += b2internal::_-OX * _loc32_;
         _loc9_ += b2internal::_-Xk * _loc34_;
