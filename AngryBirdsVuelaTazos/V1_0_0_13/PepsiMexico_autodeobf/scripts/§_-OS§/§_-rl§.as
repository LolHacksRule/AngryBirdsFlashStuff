package §_-OS§
{
   ...
   public class §_-rl§
   {
      ...
      private var §_-d6§:Dictionary;
      
      private var §_-aA§:Dictionary;
      
      public function §_-rl§()
      {
         this.§_-aA§ = new Dictionary();
         this.§_-d6§ = new Dictionary();
         super();
      }
      
      private function §_-H4§(param1:Class) : Vector.<Class>
      {
      ...
      public function §_-P3§(param1:Class, param2:Class, param3:Array) : void
      {
         var _loc4_:uint = param3.length;
         var _loc5_:uint = 0;
         while(_loc5_ < _loc4_)
         {
            this.§_-We§(param1,param2,param3[_loc5_]);
            _loc5_++;
         }
      }
      
      public function §_-kG§(param1:Class, param2:String) : Class
      {
         var _loc4_:* = undefined;
         var _loc3_:* = this.§_-aA§[param1];
         if(_loc3_ != null)
         {
         ...
         this.§_-c3§(param1);
         return this.§_-kG§(param1,param2);
      }
      
      public function §_-We§(param1:Class, param2:Class, param3:String) : void
      {
         var _loc7_:uint = 0;
         var _loc8_:uint = 0;
         var _loc9_:Class = null;
         if(this.§_-aA§[param2] == undefined)
         {
            this.§_-c3§(param2);
         }
         var _loc4_:Dictionary;
         var _loc5_:Class = (_loc4_ = this.§_-aA§)[param2][param3] as Class;
         _loc4_[param2][param3] = param1;
         var _loc6_:Vector.<Class>;
         if((_loc6_ = this.§_-d6§[param2] as Vector.<Class>) != null)
         {
      ...
      private function §_-c3§(param1:Class) : void
      {
         ...
         var _loc2_:Dictionary = this.§_-aA§;
         var _loc3_:Dictionary = this.§_-d6§;
         var _loc4_:Dictionary = new Dictionary();
         var _loc6_:uint;
         var _loc5_:Vector.<Class>;
         var _loc7_:int = _loc6_ = (_loc5_ = this.§_-H4§(param1)).length;
         while(--_loc7_ >= 0)
         {
