package §_-9C§
{
   public class §_-6M§
   {
      ...
      public static function §_-lc§(param1:String) : String
      {
         if(§_-bX§[param1])
         {
            return §_-bX§[param1];
         }
         return §_-bX§.UNEXPECTED_ERROR;
      }
      
      public static function §_-9w§(param1:String) : String
      {
         switch(param1)
         {
            case "nickName":
