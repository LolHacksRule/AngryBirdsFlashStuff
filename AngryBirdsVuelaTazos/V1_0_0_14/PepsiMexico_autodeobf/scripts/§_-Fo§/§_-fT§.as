package §_-Fo§
{
   ...
   public class §_-fT§
   {
      ...
      public static var §_-lE§:ByteArray;
       
      
      public function §_-fT§()
      {
         super();
      }
      
      public static function §_-Kw§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-tg§(_loc2_);
         return §_-BT§.§_-EL§(_loc3_.readInt(),true) + §_-BT§.§_-EL§(_loc3_.readInt(),true) + §_-BT§.§_-EL§(_loc3_.readInt(),true) + §_-BT§.§_-EL§(_loc3_.readInt(),true) + §_-BT§.§_-EL§(_loc3_.readInt(),true);
      }
      
      public static function §_-7M§(param1:ByteArray) : String
      {
         var _loc2_:Array = §_-fT§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §_-tg§(_loc2_);
         return §_-BT§.§_-EL§(_loc3_.readInt(),true) + §_-BT§.§_-EL§(_loc3_.readInt(),true) + §_-BT§.§_-EL§(_loc3_.readInt(),true) + §_-BT§.§_-EL§(_loc3_.readInt(),true) + §_-BT§.§_-EL§(_loc3_.readInt(),true);
      }
      
      public static function §_-SX§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §_-fT§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-tg§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §_-tg§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
