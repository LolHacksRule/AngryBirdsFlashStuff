package §_-b5§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private var §_-V2§:Vector.<DisplayObject>;
      
      private var §_-kx§:Matrix3D;
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§_-V2§ = new Vector.<DisplayObject>(0);
         this.§_-kx§ = new Matrix3D();
      }
      
      override public function dispose() : void
      {
         var _loc1_:DisplayObject = null;
         for each(_loc1_ in this.§_-V2§)
         {
            _loc1_.dispose();
         }
         super.dispose();
      ...
      public function addChildAt(param1:DisplayObject, param2:int) : void
      {
         ...
         {
            param1.§_-fi§();
            this.§_-V2§.splice(param2,0,param1);
            param1.§_-4W§(this);
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§_-V2§[param1];
            _loc3_.dispatchEvent(new Event(Event.§_-xz§));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§_-H5§));
            }
            _loc3_.§_-4W§(null);
            this.§_-V2§.splice(param1,1);
            if(param2)
            {
               _loc3_.dispose();
            }
      ...
      public function §_-E0§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      {
         return this.§_-V2§.indexOf(param1);
      }
      ...
      public function setChildIndex(param1:DisplayObject, param2:int) : void
      {
         ...
         this.§_-V2§.splice(_loc3_,1);
         this.§_-V2§.splice(param2,0,param1);
      }
      
      public function §_-RA§(param1:DisplayObject, param2:DisplayObject) : void
      {
         var _loc3_:int = this.getChildIndex(param1);
         ...
         this.§_-Xb§(_loc3_,_loc4_);
      }
      
      public function §_-Xb§(param1:int, param2:int) : void
      {
         var _loc3_:DisplayObject = this.getChildAt(param1);
         var _loc4_:DisplayObject = this.getChildAt(param2);
         this.§_-V2§[param1] = _loc4_;
         this.§_-V2§[param2] = _loc3_;
      }
      ...
      override public function getBounds(param1:DisplayObject) : Rectangle
      {
         ...
         var _loc2_:int = this.§_-V2§.length;
         if(_loc2_ == 0)
         {
            _loc3_ = §_-C4§(param1);
      ...
      override public function hitTestPoint(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc3_:int = this.§_-V2§.length;
         var _loc4_:int = _loc3_ - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.§_-V2§[_loc4_];
            if(!param2 || _loc5_.visible && _loc5_.§_-3V§ && _loc5_.alpha > 0)
            {
               _loc7_ = (_loc6_ = §_-C4§(_loc5_)).transformPoint(param1);
      ...
      override public function render(param1:§_-6W§, param2:Number) : void
      {
         var _loc3_:DisplayObject = null;
         param2 *= this.alpha;
         param1.§_-5y§(this.§_-kx§);
         for each(_loc3_ in this.§_-V2§)
         {
            if(_loc3_.alpha != 0 && _loc3_.visible && _loc3_.scaleX != 0 && _loc3_.scaleY != 0)
            {
               param1.§_-UM§(_loc3_);
               _loc3_.render(param1,param2);
               param1.§_-gE§(this.§_-kx§);
            }
         }
      }
      
      public function §_-tV§(param1:Event) : void
      {
         if(param1.bubbles)
         {
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         var _loc3_:DisplayObject = null;
         _loc2_ = this.§_-cn§(this,param1.type,_loc2_);
         if(_loc2_)
         {
      ...
      private function §_-cn§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : Vector.<DisplayObject>
      {
         var _loc5_:DisplayObject = null;
         ...
         if(_loc4_)
         {
            for each(_loc5_ in _loc4_.§_-V2§)
            {
               param3 = this.§_-cn§(_loc5_,param2,param3);
            }
         }
         return param3;
      }
