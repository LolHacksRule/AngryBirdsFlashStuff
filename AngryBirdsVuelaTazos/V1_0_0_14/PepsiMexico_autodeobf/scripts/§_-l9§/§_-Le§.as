package §_-l9§
{
   ...
   public class §_-Le§
   {
      ...
      public static function §_-gD§(param1:Stage) : void
      {
         ...
         §_-lQ§ = param1;
         ExternalInterface.call(§_-fe§);
         ExternalInterface.call(§_-gs§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §_-0X§ = ExternalInterface.call(§_-TX§,ExternalInterface.objectID);
         if(§_-0X§ == §_-M1§)
         {
            return;
         }
      ...
      public static function get §_-h7§() : Boolean
      {
         return §_-jq§;
      }
      
      public static function set §_-h7§(param1:Boolean) : void
      {
         §_-jq§ = param1;
      }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §_-lQ§.getObjectsUnderPoint(new Point(§_-lQ§.mouseX,§_-lQ§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
