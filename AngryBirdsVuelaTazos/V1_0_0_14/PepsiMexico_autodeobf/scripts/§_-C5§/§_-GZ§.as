package §_-C5§
{
   ...
   public class §_-GZ§ extends EventDispatcher
   {
       
      
      private var §_-Td§:Dictionary;
      
      public function §_-GZ§(param1:IEventDispatcher = null)
      {
         this.§_-Td§ = new Dictionary();
         super(param1);
      }
      ...
      override public function addEventListener(param1:String, param2:Function, param3:Boolean = false, param4:int = 0, param5:Boolean = false) : void
      {
         ...
         ((this.§_-Td§[param1] || (this.§_-Td§[param1] = new Vector.<ListenerData>())) as Vector.<ListenerData>).push(_loc6_);
      }
      ...
      override public function removeEventListener(param1:String, param2:Function, param3:Boolean = false) : void
      {
         ...
         if((_loc4_ = this.§_-Td§[param1] as Vector.<ListenerData>) != null)
         {
      ...
      public function copyFrom(param1:§_-GZ§) : void
      {
         var _loc3_:* = null;
         ...
         var _loc6_:uint = 0;
         var _loc7_:ListenerData = null;
         var _loc2_:Dictionary = param1.§_-Td§;
