package §_-C5§
{
   ...
   public class §_-3l§
   {
      ...
      private var §_-ud§:Dictionary;
      
      private var §_-VE§:Dictionary;
      
      public function §_-3l§()
      {
         this.§_-VE§ = new Dictionary();
         this.§_-ud§ = new Dictionary();
         super();
      }
      
      private function §_-Mn§(param1:Class) : Vector.<Class>
      {
      ...
      public function §_-8Z§(param1:Class, param2:Class, param3:Array) : void
      {
         var _loc4_:uint = param3.length;
         var _loc5_:uint = 0;
         while(_loc5_ < _loc4_)
         {
            this.§_-zO§(param1,param2,param3[_loc5_]);
            _loc5_++;
         }
      }
      
      public function §_-oC§(param1:Class, param2:String) : Class
      {
         var _loc4_:* = undefined;
         var _loc3_:* = this.§_-VE§[param1];
         if(_loc3_ != null)
         {
         ...
         this.§_-na§(param1);
         return this.§_-oC§(param1,param2);
      }
      
      public function §_-zO§(param1:Class, param2:Class, param3:String) : void
      {
         var _loc7_:uint = 0;
         var _loc8_:uint = 0;
         var _loc9_:Class = null;
         if(this.§_-VE§[param2] == undefined)
         {
            this.§_-na§(param2);
         }
         var _loc4_:Dictionary;
         var _loc5_:Class = (_loc4_ = this.§_-VE§)[param2][param3] as Class;
         _loc4_[param2][param3] = param1;
         var _loc6_:Vector.<Class>;
         if((_loc6_ = this.§_-ud§[param2] as Vector.<Class>) != null)
         {
      ...
      private function §_-na§(param1:Class) : void
      {
         ...
         var _loc2_:Dictionary = this.§_-VE§;
         var _loc3_:Dictionary = this.§_-ud§;
         var _loc4_:Dictionary = new Dictionary();
         var _loc6_:uint;
         var _loc5_:Vector.<Class>;
         var _loc7_:int = _loc6_ = (_loc5_ = this.§_-Mn§(param1)).length;
         while(--_loc7_ >= 0)
         {
