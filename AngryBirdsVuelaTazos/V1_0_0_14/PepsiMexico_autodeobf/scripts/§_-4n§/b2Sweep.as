package §_-4n§
{
   public class b2Sweep
   {
      ...
      public function Copy() : b2Sweep
      {
         ...
         _loc1_.a0 = this.a0;
         _loc1_.a = this.a;
         _loc1_.§_-pu§ = this.§_-pu§;
         return _loc1_;
      }
      
      public function §_-XD§(param1:b2Transform, param2:Number) : void
      {
      ...
      public function §_-y5§(param1:Number) : void
      {
         var _loc2_:Number = NaN;
         if(this.§_-pu§ < param1 && 1 - this.§_-pu§ > Number.MIN_VALUE)
         {
            _loc2_ = (param1 - this.§_-pu§) / (1 - this.§_-pu§);
