package §_-4n§
{
   public class b2Vec2
   {
      ...
      public static function §_-2c§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §_-YN§(param1:b2Vec2) : void
      {
         this.x += param1.x;
         this.y += param1.y;
      }
      
      public function §_-0D§(param1:b2Vec2) : void
      {
         this.x -= param1.x;
         this.y -= param1.y;
      }
      ...
      public function §_-R8§(param1:b2Mat22) : void
      {
      ...
      public function §_-vA§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§_-pS§(this,param1.col1);
         this.y = b2Math.§_-pS§(this,param1.col2);
         this.x = _loc2_;
      }
      
      public function §_-Eg§(param1:Number) : void
      {
         var _loc2_:Number = this.x;
      ...
      public function §_-2e§(param1:Number) : void
      {
         var _loc2_:Number = this.x;
         this.x = -param1 * this.y;
         this.y = param1 * _loc2_;
      ...
      {
         return b2Math.§_-KD§(this.x) && b2Math.§_-KD§(this.y);
      }
   }
}
