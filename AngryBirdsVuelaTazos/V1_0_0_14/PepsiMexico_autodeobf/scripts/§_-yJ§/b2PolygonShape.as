package §_-yJ§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §_-EP§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §_-HR§:b2Vec2;
      
      b2internal var §_-dR§:Vector.<b2Vec2>;
      
      b2internal var §_-Sz§:Vector.<b2Vec2>;
      
      b2internal var §_-xp§:int;
      
      public function b2PolygonShape()
      {
         super();
         §_-rI§ = b2internal::_-yl;
         this.§_-HR§ = new b2Vec2();
         this.§_-dR§ = new Vector.<b2Vec2>();
         this.§_-Sz§ = new Vector.<b2Vec2>();
         §_-9H§ = b2Settings.b2_polygonRadius;
         this.§_-HR§.§_-IE§();
      }
      
      public static function §_-fc§(param1:Array, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-Qd§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-rW§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-NG§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-D-§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-LE§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-Sm§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§_-QG§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §_-XT§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-ZZ§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-jS§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§_-YN§(new b2Vec2(0,0));
            _loc3_.§_-YN§(_loc9_);
            _loc3_.§_-YN§(_loc10_);
            _loc3_.§_-wB§(_loc16_ * _loc7_);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §_-55§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§_-Oc§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§_-Oc§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§_-HR§.SetV(_loc2_.§_-HR§);
            this.§_-xp§ = _loc2_.§_-xp§;
            this.§_-LI§(this.§_-xp§);
            _loc3_ = 0;
            while(_loc3_ < this.§_-xp§)
            {
               this.§_-dR§[_loc3_].SetV(_loc2_.§_-dR§[_loc3_]);
               this.§_-Sz§[_loc3_].SetV(_loc2_.§_-Sz§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §_-Qd§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§_-NG§(_loc3_,param2);
      }
      
      public function §_-NG§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§_-xp§)
         {
            this.§_-dR§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§_-xp§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§_-xp§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§_-nM§(this.§_-dR§[_loc5_],this.§_-dR§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§_-xA§() > Number.MIN_VALUE);
            this.§_-Sz§[_loc3_].SetV(b2Math.§_-Eg§(_loc6_,1));
            this.§_-Sz§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§_-HR§ = §_-jS§(this.§_-dR§,this.§_-xp§);
      }
      
      public function §_-LE§(param1:Number, param2:Number) : void
      {
         this.§_-xp§ = 4;
         this.§_-LI§(4);
         this.§_-dR§[0].Set(-param1,-param2);
         this.§_-dR§[1].Set(param1,-param2);
         this.§_-dR§[2].Set(param1,param2);
         this.§_-dR§[3].Set(-param1,param2);
         this.§_-Sz§[0].Set(0,-1);
         this.§_-Sz§[1].Set(1,0);
         this.§_-Sz§[2].Set(0,1);
         this.§_-Sz§[3].Set(-1,0);
      ...
      public function §_-QG§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§_-xp§ = 4;
         this.§_-LI§(4);
         this.§_-dR§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§_-xp§)
         {
            this.§_-dR§[_loc6_] = b2Math.§_-7c§(_loc5_,this.§_-dR§[_loc6_]);
            this.§_-Sz§[_loc6_] = b2Math.§_-UD§(_loc5_.R,this.§_-Sz§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §_-ZZ§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§_-xp§ = 2;
         this.§_-LI§(2);
         this.§_-dR§[0].SetV(param1);
         this.§_-dR§[1].SetV(param2);
         this.§_-HR§.x = 0.5 * (param1.x + param2.x);
         this.§_-HR§.y = 0.5 * (param1.y + param2.y);
         this.§_-Sz§[0] = b2Math.§_-Eg§(b2Math.§_-nM§(param2,param1),1);
         this.§_-Sz§[0].Normalize();
         this.§_-Sz§[1].x = -this.§_-Sz§[0].x;
         this.§_-Sz§[1].y = -this.§_-Sz§[0].y;
      }
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < this.§_-xp§)
         {
            _loc3_ = this.§_-dR§[_loc9_];
            _loc5_ = _loc7_ - _loc3_.x;
            _loc6_ = _loc8_ - _loc3_.y;
            _loc3_ = this.§_-Sz§[_loc9_];
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§_-xp§)
         {
            _loc6_ = (_loc9_ = this.§_-dR§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§_-Sz§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§_-Cd§.x = _loc5_ - b2internal::_-9H;
         param1.§_-Cd§.y = _loc6_ - b2internal::_-9H;
         param1.§_-sZ§.x = _loc7_ + b2internal::_-9H;
         param1.§_-sZ§.y = _loc8_ + b2internal::_-9H;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§_-xp§ == 2)
         {
            param1.center.x = 0.5 * (this.§_-dR§[0].x + this.§_-dR§[1].x);
            param1.center.y = 0.5 * (this.§_-dR§[0].y + this.§_-dR§[1].y);
            param1.§_-bR§ = 0;
            param1.§_-2y§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§_-xp§)
         {
            _loc11_ = this.§_-dR§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§_-xp§ ? this.§_-dR§[int(_loc10_ + 1)] : this.§_-dR§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§_-bR§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§_-2y§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§_-Wl§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§_-pS§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§_-xp§)
         {
            _loc7_[_loc12_] = b2Math.§_-pS§(_loc5_,this.§_-dR§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§_-7c§(param3,_loc24_.center));
                  return _loc24_.§_-bR§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§_-xp§;
         var _loc14_:int = (_loc10_ + 1) % this.§_-xp§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§_-dR§[_loc9_].x * (1 - _loc15_) + this.§_-dR§[_loc13_].x * _loc15_,this.§_-dR§[_loc9_].y * (1 - _loc15_) + this.§_-dR§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§_-dR§[_loc10_].x * (1 - _loc16_) + this.§_-dR§[_loc14_].x * _loc16_,this.§_-dR§[_loc10_].y * (1 - _loc16_) + this.§_-dR§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§_-dR§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§_-xp§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§_-dR§[_loc12_];
            }
         ...
         _loc20_.§_-wB§(1 / _loc19_);
         param4.SetV(b2Math.§_-7c§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §_-N5§() : Vector.<b2Vec2>
      {
         return this.§_-dR§;
      }
      
      public function §_-An§() : Vector.<b2Vec2>
      {
         return this.§_-Sz§;
      }
      
      public function §_-ex§(param1:b2Vec2) : int
      {
      ...
      private function §_-a2§() : Boolean
      {
         return false;
      }
      
      private function §_-LI§(param1:int) : void
      {
         var _loc2_:int = this.§_-dR§.length;
         while(_loc2_ < param1)
         {
            this.§_-dR§[_loc2_] = new b2Vec2();
            this.§_-Sz§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
