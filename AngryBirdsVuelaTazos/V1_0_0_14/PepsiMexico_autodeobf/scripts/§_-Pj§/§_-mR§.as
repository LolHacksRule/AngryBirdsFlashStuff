package §_-Pj§
{
   ...
   public class §_-mR§
   {
      ...
      private static var §_-p§:Array;
      
      private static var §_-fX§:Boolean = false;
      ...
      public static function encode(param1:BitmapData) : ByteArray
      {
         ...
         _loc4_.compress();
         §_-d5§(_loc2_,1229209940,_loc4_);
         §_-d5§(_loc2_,1229278788,null);
         return _loc2_;
      }
      
      private static function §_-d5§(param1:ByteArray, param2:uint, param3:ByteArray) : void
      {
         var _loc8_:uint = 0;
         var _loc9_:uint = 0;
         var _loc10_:uint = 0;
         ...
         {
            _loc8_ = uint(§_-p§[(_loc8_ ^ param1.readUnsignedByte()) & uint(255)] ^ uint(_loc8_ >>> 8));
            _loc7_++;
         }
