package §_-Rh§
{
   ...
   public class §_-fv§ extends §_-tv§
   {
      
      public static const §_-lA§:Array = ["x","y","z","scaleX","scaleY","scaleZ","rotation","rotationX","rotationY","rotationZ","alpha","width","height","_bevelFilter","_blurFilter","_colorMatrixFilter","_convolutionFilter","_displacementMapFilter","_dropShadowFilter","_glowFilter","_gradientBevelFilter","_gradientGlowFilter","_shaderFilter"];
       
      
      protected var _flags:uint = 0;
      
      protected var §_-OR§:DisplayObjectParameter;
      
      protected var §_-lg§:DisplayObject = null;
      
      protected var §_-Ov§:DisplayObjectParameter;
      
      public function §_-fv§()
      {
         this.§_-Ov§ = new DisplayObjectParameter();
         this.§_-OR§ = new DisplayObjectParameter();
         super();
      }
      
      public static function §_-FR§(param1:§_-3l§) : void
      {
         param1.§_-8Z§(§_-fv§,DisplayObject,§_-lA§);
      }
      ...
      override public function setObject(param1:String, param2:Object) : void
      {
         ...
         {
            this.§_-BK§(param2 as BitmapFilter,BlurFilter);
            return;
         }
         if(param1 == "_glowFilter")
         {
            this.§_-BK§(param2 as BitmapFilter,GlowFilter);
            return;
         }
         if(param1 == "_dropShadowFilter")
         {
            this.§_-BK§(param2 as BitmapFilter,DropShadowFilter);
            return;
         }
         if(param1 == "_colorMatrixFilter")
         {
            this.§_-BK§(param2 as BitmapFilter,ColorMatrixFilter);
            return;
         }
         if(param1 == "_bevelFilter")
         {
            this.§_-BK§(param2 as BitmapFilter,BevelFilter);
            return;
         }
         if(param1 == "_gradientGlowFilter")
         {
            this.§_-BK§(param2 as BitmapFilter,GradientGlowFilter);
            return;
         }
         if(param1 == "_gradientBevelFilter")
         {
            this.§_-BK§(param2 as BitmapFilter,GradientBevelFilter);
            return;
         }
         if(param1 == "_convolutionFilter")
         {
            this.§_-BK§(param2 as BitmapFilter,ConvolutionFilter);
            return;
         }
         if(param1 == "_displacementMapFilter")
         {
            this.§_-BK§(param2 as BitmapFilter,DisplacementMapFilter);
            return;
         }
         if(param1 == "_shaderFilter")
         {
            this.§_-BK§(param2 as BitmapFilter,ShaderFilter);
            return;
         }
      }
      ...
      override public function setDestinationValue(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         {
            this._flags |= 2;
            this.§_-OR§.relativeFlags |= !!param3 ? 2 : 0;
            this.§_-OR§.y = param2;
         }
         else if(param1 == "z")
         {
            this._flags |= 4;
            this.§_-OR§.relativeFlags |= !!param3 ? 4 : 0;
            this.§_-OR§.z = param2;
         }
         else if(param1 == "scaleX")
         {
            this._flags |= 8;
            this.§_-OR§.relativeFlags |= !!param3 ? 8 : 0;
            this.§_-OR§.scaleX = param2;
         }
         else if(param1 == "scaleY")
         {
            this._flags |= 16;
            this.§_-OR§.relativeFlags |= !!param3 ? 16 : 0;
            this.§_-OR§.scaleY = param2;
         }
         else if(param1 == "scaleZ")
         {
            this._flags |= 32;
            this.§_-OR§.relativeFlags |= !!param3 ? 32 : 0;
            this.§_-OR§.scaleZ = param2;
         }
         else if(param1 == "rotation")
         {
            this._flags |= 64;
            this.§_-OR§.relativeFlags |= !!param3 ? 64 : 0;
            this.§_-OR§.rotation = param2;
         }
         else if(param1 == "rotationX")
         {
            this._flags |= 128;
            this.§_-OR§.relativeFlags |= !!param3 ? 128 : 0;
            this.§_-OR§.rotationX = param2;
         }
         else if(param1 == "rotationY")
         {
            this._flags |= 256;
            this.§_-OR§.relativeFlags |= !!param3 ? 256 : 0;
            this.§_-OR§.rotationY = param2;
         }
         else if(param1 == "rotationZ")
         {
            this._flags |= 512;
            this.§_-OR§.relativeFlags |= !!param3 ? 512 : 0;
            this.§_-OR§.rotationZ = param2;
         }
         else if(param1 == "alpha")
         {
            this._flags |= 1024;
            this.§_-OR§.relativeFlags |= !!param3 ? 1024 : 0;
            this.§_-OR§.alpha = param2;
         }
         else if(param1 == "width")
         {
            this._flags |= 2048;
            this.§_-OR§.relativeFlags |= !!param3 ? 2048 : 0;
            this.§_-OR§.width = param2;
         }
         else if(param1 == "height")
         {
            this._flags |= 4096;
            this.§_-OR§.relativeFlags |= !!param3 ? 4096 : 0;
            this.§_-OR§.height = param2;
         }
      }
      
      protected function §_-BK§(param1:BitmapFilter, param2:Class) : void
      {
         var _loc3_:Array = this.§_-lg§.filters;
      ...
      protected function §_-88§(param1:Class) : BitmapFilter
      {
      ...
      override public function setSourceValue(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         {
            this._flags |= 2;
            this.§_-Ov§.relativeFlags |= !!param3 ? 2 : 0;
            this.§_-Ov§.y = param2;
         }
         else if(param1 == "z")
         {
            this._flags |= 4;
            this.§_-Ov§.relativeFlags |= !!param3 ? 4 : 0;
            this.§_-Ov§.z = param2;
         }
         else if(param1 == "scaleX")
         {
            this._flags |= 8;
            this.§_-Ov§.relativeFlags |= !!param3 ? 8 : 0;
            this.§_-Ov§.scaleX = param2;
         }
         else if(param1 == "scaleY")
         {
            this._flags |= 16;
            this.§_-Ov§.relativeFlags |= !!param3 ? 16 : 0;
            this.§_-Ov§.scaleY = param2;
         }
         else if(param1 == "scaleZ")
         {
            this._flags |= 32;
            this.§_-Ov§.relativeFlags |= !!param3 ? 32 : 0;
            this.§_-Ov§.scaleZ = param2;
         }
         else if(param1 == "rotation")
         {
            this._flags |= 64;
            this.§_-Ov§.relativeFlags |= !!param3 ? 64 : 0;
            this.§_-Ov§.rotation = param2;
         }
         else if(param1 == "rotationX")
         {
            this._flags |= 128;
            this.§_-Ov§.relativeFlags |= !!param3 ? 128 : 0;
            this.§_-Ov§.rotationX = param2;
         }
         else if(param1 == "rotationY")
         {
            this._flags |= 256;
            this.§_-Ov§.relativeFlags |= !!param3 ? 256 : 0;
            this.§_-Ov§.rotationY = param2;
         }
         else if(param1 == "rotationZ")
         {
            this._flags |= 512;
            this.§_-Ov§.relativeFlags |= !!param3 ? 512 : 0;
            this.§_-Ov§.rotationZ = param2;
         }
         else if(param1 == "alpha")
         {
            this._flags |= 1024;
            this.§_-Ov§.relativeFlags |= !!param3 ? 1024 : 0;
            this.§_-Ov§.alpha = param2;
         }
         else if(param1 == "width")
         {
            this._flags |= 2048;
            this.§_-Ov§.relativeFlags |= !!param3 ? 2048 : 0;
            this.§_-Ov§.width = param2;
         }
         else if(param1 == "height")
         {
            this._flags |= 4096;
            this.§_-Ov§.relativeFlags |= !!param3 ? 4096 : 0;
            this.§_-Ov§.height = param2;
         }
      }
      
      override protected function updateObject(param1:Number) : void
      {
         var _loc2_:DisplayObject = this.§_-lg§;
         var _loc3_:DisplayObjectParameter = this.§_-OR§;
         var _loc4_:DisplayObjectParameter = this.§_-Ov§;
      ...
      {
         this.§_-lg§ = param1 as DisplayObject;
      }
      
      override protected function resolveValues() : void
      {
         var _loc1_:DisplayObject = this.§_-lg§;
         var _loc2_:DisplayObjectParameter = this.§_-OR§;
         var _loc3_:DisplayObjectParameter = this.§_-Ov§;
         var _loc4_:uint;
      ...
      override public function getObject(param1:String) : Object
      {
         if(param1 == "_blurFilter")
         {
            return this.§_-88§(BlurFilter);
         }
         if(param1 == "_glowFilter")
         {
            return this.§_-88§(GlowFilter);
         }
         if(param1 == "_dropShadowFilter")
         {
            return this.§_-88§(DropShadowFilter);
         }
         if(param1 == "_colorMatrixFilter")
         {
            return this.§_-88§(ColorMatrixFilter);
         }
         if(param1 == "_bevelFilter")
         {
            return this.§_-88§(BevelFilter);
         }
         if(param1 == "_gradientGlowFilter")
         {
            return this.§_-88§(GradientGlowFilter);
         }
         if(param1 == "_gradientBevelFilter")
         {
            return this.§_-88§(GradientBevelFilter);
         }
         if(param1 == "_convolutionFilter")
         {
            return this.§_-88§(ConvolutionFilter);
         }
         if(param1 == "_displacementMapFilter")
         {
            return this.§_-88§(DisplacementMapFilter);
         }
         if(param1 == "_shaderFilter")
         {
            return this.§_-88§(ShaderFilter);
         }
         return null;
      }
      ...
      override protected function copyFrom(param1:§_-tv§) : void
      {
         ...
         var _loc2_:§_-fv§ = param1 as §_-fv§;
