package §_-bt§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§_-A0§.x * this.§_-up§.x + (this.§_-Nh§ + this.§_-A0§.z) * this.§_-PK§.x),param1 * (this.§_-A0§.x * this.§_-up§.y + (this.§_-Nh§ + this.§_-A0§.z) * this.§_-PK§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§_-b6§ > Number.MIN_VALUE)
         {
            this.§_-b6§ = 1 / this.§_-b6§;
         }
         ...
         this.§_-bP§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§_-bP§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§_-bP§.col2.x = this.§_-bP§.col1.y;
         this.§_-bP§.col2.y = _loc16_ + _loc17_;
         this.§_-bP§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§_-bP§.col3.x = this.§_-bP§.col1.z;
         this.§_-bP§.col3.y = this.§_-bP§.col2.z;
         this.§_-bP§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§_-5b§)
         {
         ...
         if(param1.§_-lv§)
         {
            ...
            _loc19_ = this.§_-A0§.x * this.§_-up§.x + (this.§_-Nh§ + this.§_-A0§.z) * this.§_-PK§.x;
            _loc20_ = this.§_-A0§.x * this.§_-up§.y + (this.§_-Nh§ + this.§_-A0§.z) * this.§_-PK§.y;
            _loc21_ = this.§_-A0§.x * this.m_s1 + this.§_-A0§.y + (this.§_-Nh§ + this.§_-A0§.z) * this.m_a1;
            _loc22_ = this.§_-A0§.x * this.m_s2 + this.§_-A0§.y + (this.§_-Nh§ + this.§_-A0§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§_-PK§.x * (_loc6_.x - _loc4_.x) + this.§_-PK§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§_-b6§ * (this.§_-Fn§ - _loc14_);
            _loc16_ = this.§_-Nh§;
            _loc17_ = param1.§_-ib§ * this.§_-Ik§;
            this.§_-Nh§ = b2Math.§_-1P§(this.§_-Nh§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§_-Nh§ - _loc16_) * this.§_-PK§.x;
            _loc9_ = _loc15_ * this.§_-PK§.y;
         ...
         {
            _loc18_ = this.§_-PK§.x * (_loc6_.x - _loc4_.x) + this.§_-PK§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§_-A0§.Copy();
            _loc20_ = this.§_-bP§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§_-A0§.§_-YN§(_loc20_);
            if(this.§_-rj§ == b2internal::_-Ep)
            {
               this.§_-A0§.z = b2Math.§_-NX§(this.§_-A0§.z,0);
            }
            else if(this.§_-rj§ == b2internal::_-45)
            {
               this.§_-A0§.z = b2Math.§_-NB§(this.§_-A0§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§_-A0§.z - _loc19_.z) * this.§_-bP§.col3.x;
            _loc22_ = -_loc13_ - (this.§_-A0§.z - _loc19_.z) * this.§_-bP§.col3.y;
            _loc23_ = this.§_-bP§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§_-A0§.x = _loc23_.x;
            this.§_-A0§.y = _loc23_.y;
            _loc20_.x = this.§_-A0§.x - _loc19_.x;
            _loc20_.y = this.§_-A0§.y - _loc19_.y;
            _loc20_.z = this.§_-A0§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§_-up§.x + _loc20_.z * this.§_-PK§.x;
            _loc9_ = _loc20_.x * this.§_-up§.y + _loc20_.z * this.§_-PK§.y;
         ...
         {
            _loc24_ = this.§_-bP§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§_-A0§.x += _loc24_.x;
            this.§_-A0§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§_-up§.x;
            _loc9_ = _loc24_.x * this.§_-up§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§_-5b§)
         {
            ...
            _loc35_ = this.§_-PK§.x * _loc26_ + this.§_-PK§.y * _loc27_;
            if(b2Math.§_-R3§(this.§_-Rm§ - this.§_-nl§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§_-1P§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§_-R3§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§_-nl§)
            {
               _loc19_ = b2Math.§_-1P§(_loc35_ - this.§_-nl§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§_-nl§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§_-Rm§)
            {
               _loc19_ = b2Math.§_-1P§(_loc35_ - this.§_-Rm§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§_-Rm§;
               _loc18_ = true;
            }
         }
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§_-3t§;
         _loc16_ = b2Math.§_-NX§(_loc16_,b2Math.§_-R3§(_loc29_));
         _loc17_ = b2Math.§_-R3§(_loc30_);
         if(_loc18_)
         {
            ...
            this.§_-bP§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§_-bP§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§_-bP§.col2.x = this.§_-bP§.col1.y;
            this.§_-bP§.col2.y = _loc14_ + _loc15_;
            this.§_-bP§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§_-bP§.col3.x = this.§_-bP§.col1.z;
            this.§_-bP§.col3.y = this.§_-bP§.col2.z;
            this.§_-bP§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§_-bP§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::_-YG;
            ...
            this.§_-bP§.col1.Set(_loc36_,_loc37_,0);
            this.§_-bP§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§_-bP§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§_-up§.x + _loc28_.z * this.§_-PK§.x;
         var _loc32_:Number = _loc28_.x * this.§_-up§.y + _loc28_.z * this.§_-PK§.y;
         ...
         _loc6_.x -= b2internal::_-YG * _loc31_;
         _loc6_.y -= b2internal::_-YG * _loc32_;
         _loc7_ -= b2internal::_-33 * _loc33_;
         _loc8_.x += b2internal::_-VU * _loc31_;
         _loc8_.y += b2internal::_-VU * _loc32_;
         _loc9_ += b2internal::_-oP * _loc34_;
