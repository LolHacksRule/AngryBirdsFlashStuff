package §%"Q§
{
   ...
   public class §'!V§ extends §`!6§
   {
      ...
      {
         var _loc3_:§5!K§ = null;
         this.§&#4§ = §^!b§.getItemByName("Container_ChapterSelection") as §@!8§;
         this.§&!G§ = [];
         this.§!K§ = [];
         var _loc1_:Number = 0;
         this.§9!5§ = new Sprite();
         ...
         this.§9!5§.x = this.§?5§;
         this.§&#4§.mClip.addChild(this.§9!5§);
         var _loc2_:int = 0;
      ...
      protected function §`D§() : void
      {
         ...
         while(_loc2_ < this.§&!G§.length)
         {
            ...
            this.§&#4§.mClip.addChild(_loc3_);
            _loc3_.buttonMode = true;
            this.§!K§.push(_loc3_);
            _loc1_ += _loc3_.width;
            _loc3_.addEventListener(MouseEvent.MOUSE_DOWN,this.§=!H§);
            _loc2_++;
         }
      ...
      protected function §3#0§(param1:String, param2:Number, param3:§5!K§ = null) : Number
      {
         ...
         _loc4_.addEventListener(MouseEvent.CLICK,this.§else§);
      ...
      private function §=!H§(param1:MouseEvent) : void
      {
         if(!this.§8#§)
         {
            this.§2"G§(this.§!K§.indexOf(param1.target));
         }
      }
      ...
      protected function §2"G§(param1:int) : void
      {
         ...
         this.§@@§ = §5!%§.§!6§.§4!M§(this.§9!5§,{"x":_loc2_},null,_loc4_,set.easeOut);
         this.§@@§.onComplete = this.§7s§;
         this.§@@§.play();
      }
