package §&"s§
{
   ...
   public class Texture
   {
      ...
      public static function §43§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §&"s§.Texture
      {
         return §?!]§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §?!]§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §&"s§.Texture
      {
         ...
         _loc10_ = new §#B§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§6!R§.§?8§)
         {
            _loc10_.§61§(param2);
         }
         ...
         return new §-Y§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §"!w§(param1:Context3D, param2:ByteArray) : §&"s§.Texture
      {
         if(param1 == null)
         {
            throw new §2"[§();
         ...
         var _loc9_:§#B§ = new §#B§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§6!R§.§?8§)
         {
            _loc9_.§61§(param2);
         }
      ...
      public static function §package§(param1:§&"s§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §&"s§.Texture
      {
         var _loc4_:§&"s§.Texture;
         (_loc4_ = new §-Y§(param1,param2)).§]!,§ = param3;
         return _loc4_;
      }
      
      public static function §1A§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §&"s§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§&"s§.Texture = §?!]§(param1,_loc6_,false,param5);
         if(!§6!R§.§?8§)
         {
            _loc6_.dispose();
         }
