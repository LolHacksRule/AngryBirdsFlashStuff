package §=![§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc7_ = this.§7R§.y - _loc4_.m_sweep.localCenter.y;
         _loc3_ = _loc2_.col1.x * _loc6_ + _loc2_.col2.x * _loc7_;
         _loc7_ = _loc2_.col1.y * _loc6_ + _loc2_.col2.y * _loc7_;
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.m_xf.R;
         _loc8_ = this.§7"T§.x - _loc5_.m_sweep.localCenter.x;
         _loc9_ = this.§7"T§.y - _loc5_.m_sweep.localCenter.y;
         ...
         if(param1.§?!'§)
         {
            ...
            this.§8!t§.y *= param1.§!"J§;
            this.§8!t§.z *= param1.§!"J§;
            _loc4_.§9"H§.x -= _loc10_ * this.§8!t§.x;
            _loc4_.§9"H§.y -= _loc10_ * this.§8!t§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§8!t§.y - _loc7_ * this.§8!t§.x + this.§8!t§.z);
            _loc5_.§9"H§.x += _loc11_ * this.§8!t§.x;
            _loc5_.§9"H§.y += _loc11_ * this.§8!t§.y;
            _loc5_.m_angularVelocity += _loc13_ * (_loc8_ * this.§8!t§.y - _loc9_ * this.§8!t§.x + this.§8!t§.z);
         }
         else
         {
            this.§8!t§.§6![§();
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc5_:b2Body = b2internal::?!p;
         _loc2_ = _loc4_.m_xf.R;
         var _loc6_:Number = this.§7R§.x - _loc4_.m_sweep.localCenter.x;
         var _loc7_:Number = this.§7R§.y - _loc4_.m_sweep.localCenter.y;
         _loc3_ = _loc2_.col1.x * _loc6_ + _loc2_.col2.x * _loc7_;
         _loc7_ = _loc2_.col1.y * _loc6_ + _loc2_.col2.y * _loc7_;
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.m_xf.R;
         var _loc8_:Number = this.§7"T§.x - _loc5_.m_sweep.localCenter.x;
