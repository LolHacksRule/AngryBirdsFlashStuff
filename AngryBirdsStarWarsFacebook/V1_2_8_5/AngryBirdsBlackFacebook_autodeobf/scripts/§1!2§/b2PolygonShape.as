package §1!2§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §>"3§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §continue§:b2Vec2;
      
      b2internal var §0I§:Vector.<b2Vec2>;
      ...
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§8s§(param1,param2);
         return _loc3_;
      }
      
      public static function §7"F§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
      ...
      public static function §9$§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§4"5§(new b2Vec2(0,0));
            _loc3_.§4"5§(_loc9_);
            _loc3_.§4"5§(_loc10_);
            _loc3_.§ 6§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §2I§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               _loc25_ = param1.R;
               param1.§4B§.x = _loc7_.x + (_loc25_.col1.x * _loc23_ + _loc25_.col2.x * _loc24_);
               param1.§4B§.y = _loc7_.y + (_loc25_.col1.y * _loc23_ + _loc25_.col2.y * _loc24_);
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§continue§.SetV(_loc2_.§continue§);
            this.§,#&§ = _loc2_.§,#&§;
            this.§]x§(this.§,#&§);
            _loc3_ = 0;
            while(_loc3_ < this.§,#&§)
            {
               this.§0I§[_loc3_].SetV(_loc2_.§0I§[_loc3_]);
      ...
      public function §7,§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§0!5§(_loc3_,param2);
      }
      
      public function §0!5§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§,#&§)
         {
            this.§0I§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§,#&§)
         {
            ...
            _loc6_ = b2Math.§["+§(this.§0I§[_loc5_],this.§0I§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§1",§() > Number.MIN_VALUE);
            this.§,!'§[_loc3_].SetV(b2Math.§"o§(_loc6_,1));
            this.§,!'§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§continue§ = §9$§(this.§0I§,this.§,#&§);
      }
      
      public function §8s§(param1:Number, param2:Number) : void
      {
         this.§,#&§ = 4;
         this.§]x§(4);
         this.§0I§[0].Set(-param1,-param2);
         this.§0I§[1].Set(param1,-param2);
         this.§0I§[2].Set(param1,param2);
         this.§0I§[3].Set(-param1,param2);
         this.§,!'§[0].Set(0,-1);
         this.§,!'§[1].Set(1,0);
         this.§,!'§[2].Set(0,1);
         this.§,!'§[3].Set(-1,0);
      ...
      public function §'"1§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§,#&§)
         {
            this.§0I§[_loc6_] = b2Math.§@#%§(_loc5_,this.§0I§[_loc6_]);
            this.§,!'§[_loc6_] = b2Math.§6%§(_loc5_.R,this.§,!'§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §'[§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§,#&§ = 2;
         this.§]x§(2);
         this.§0I§[0].SetV(param1);
         this.§0I§[1].SetV(param2);
         this.§continue§.x = 0.5 * (param1.x + param2.x);
         this.§continue§.y = 0.5 * (param1.y + param2.y);
         this.§,!'§[0] = b2Math.§"o§(b2Math.§["+§(param2,param1),1);
         this.§,!'§[0].Normalize();
         this.§,!'§[1].x = -this.§,!'§[0].x;
         this.§,!'§[1].y = -this.§,!'§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         while(_loc17_ < this.§,#&§)
         {
            _loc6_ = (_loc9_ = this.§0I§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§-"^§.x = _loc5_ - b2internal::#J;
         param1.§-"^§.y = _loc6_ - b2internal::#J;
         param1.§%!n§.x = _loc7_ + b2internal::#J;
         param1.§%!n§.y = _loc8_ + b2internal::#J;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§,#&§ == 2)
         {
            param1.§4B§.x = 0.5 * (this.§0I§[0].x + this.§0I§[1].x);
            param1.§4B§.y = 0.5 * (this.§0I§[0].y + this.§0I§[1].y);
            param1.§2"f§ = 0;
            param1.§&e§ = 0;
            return;
         }
         ...
         while(_loc10_ < this.§,#&§)
         {
            _loc11_ = this.§0I§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§,#&§ ? this.§0I§[int(_loc10_ + 1)] : this.§0I§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§2"f§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.§4B§.Set(_loc3_,_loc4_);
         param1.§&e§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§<f§(param1,param3.position);
         ...
         while(_loc12_ < this.§,#&§)
         {
            _loc7_[_loc12_] = b2Math.§<f§(_loc5_,this.§0I§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§@#%§(param3,_loc24_.§4B§));
                  return _loc24_.§2"f§;
               }
               return 0;
               break;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§0I§[_loc9_].x * (1 - _loc15_) + this.§0I§[_loc13_].x * _loc15_,this.§0I§[_loc9_].y * (1 - _loc15_) + this.§0I§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§0I§[_loc10_].x * (1 - _loc16_) + this.§0I§[_loc14_].x * _loc16_,this.§0I§[_loc10_].y * (1 - _loc16_) + this.§0I§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§0I§[_loc13_];
         _loc12_ = _loc13_;
      ...
      public function §3!E§() : Vector.<b2Vec2>
      {
         return this.§,!'§;
      }
      
      public function §+E§(param1:b2Vec2) : int
      {
