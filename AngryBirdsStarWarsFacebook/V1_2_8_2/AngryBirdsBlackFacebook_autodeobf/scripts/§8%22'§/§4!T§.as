package §8"'§
{
   ...
   public class §4!T§ extends §`!6§
   {
      ...
      override protected function init() : void
      {
         ...
         this.§8"x§ = new Vector.<§=t§>(§ #%§);
         var _loc1_:int = this.§9"P§.§,"z§;
         var _loc2_:int = 0;
         while(_loc2_ < § #%§)
         {
            _loc3_ = this.§8"x§[_loc2_] = new §=t§(§^!b§.getItemByName("Container_LevelSelection").mClip["level" + (_loc2_ + 1)].levelButton,§^!b§.getItemByName("Container_LevelSelection").mClip["level" + (_loc2_ + 1)].tournamentScore,_loc2_ + 1);
      ...
      private function §]!#§(param1:MouseEvent) : void
      {
         ...
         {
            _loc5_ = this.§9"P§.levelObjects[this.§8"x§.indexOf(_loc2_)].levelId;
      ...
      private function §%m§() : void
      {
         ...
         while(_loc2_ < § #%§)
         {
            ...
            this.§=!?§(this.§8"x§[_loc2_],this.§9"P§.levelObjects[_loc2_]);
            _loc2_++;
         }
         this.§!!R§();
         this.§@"5§();
      ...
      private function §!!R§() : void
      {
         ...
         while(_loc1_ < § #%§)
         {
            this.§8"x§[_loc1_].canBuyToUnlock = _loc1_ > 0 && this.§8"x§[_loc1_].isLocked && !this.§8"x§[_loc1_ - 1].isLocked;
            _loc1_++;
         }
      }
