package §>r§
{
   ...
   public class b2DynamicTree
   {
      ...
      private var §9"e§:b2DynamicTreeNode;
      ...
      public function §4"6§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
      ...
      public function §9#7§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         var _loc4_:Number = NaN;
         var _loc5_:Number = NaN;
         b2Settings.b2Assert(param1.§[@§());
         if(param1.aabb.§^!N§(param2))
         {
            return false;
         }
         this.§]"O§(param1);
      ...
      public function §7!T§(param1:b2DynamicTreeNode) : b2AABB
      {
         return param1.aabb;
      }
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc7_:b2Vec2 = b2Math.§`!F§(_loc6_);
         ...
         _loc9_.§%!n§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§%!n§.y = Math.max(_loc3_.y,_loc11_);
         var _loc12_:Vector.<b2DynamicTreeNode> = new Vector.<b2DynamicTreeNode>();
         var _loc13_:int = 0;
         var _loc19_:*;
         _loc12_[_loc19_ = _loc13_++] = this.§9"e§;
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§+">§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§3R§();
               _loc16_ = _loc14_.aabb.§4"`§();
      ...
      private function §@"z§() : b2DynamicTreeNode
      {
      ...
      private function §5#7§(param1:b2DynamicTreeNode) : void
      {
      ...
      private function §#"2§(param1:b2DynamicTreeNode) : void
      {
         ...
         {
            this.§9"e§ = param1;
            this.§9"e§.parent = null;
            return;
         }
         var _loc2_:b2Vec2 = param1.aabb.§3R§();
         var _loc3_:b2DynamicTreeNode = this.§9"e§;
         if(_loc3_.§[@§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§-"^§.x + _loc6_.aabb.§%!n§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§-"^§.y + _loc6_.aabb.§%!n§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§-"^§.x + _loc7_.aabb.§%!n§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§-"^§.y + _loc7_.aabb.§%!n§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         if(_loc4_)
         {
            ...
            while(!_loc4_.aabb.§^!N§(_loc5_.aabb))
            {
