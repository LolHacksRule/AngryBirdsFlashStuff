package §>r§
{
   ...
   class b2Simplex
   {
      ...
      public var §0I§:Vector.<b2SimplexVertex>;
      ...
      function b2Simplex()
      {
         ...
         this.§0I§ = new Vector.<b2SimplexVertex>(3);
         super();
         this.§0I§[0] = this.m_v1;
         this.§0I§[1] = this.m_v2;
         this.§0I§[2] = this.m_v3;
      ...
      public function §]!H§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         this.§-",§ = param1.count;
         var _loc8_:Vector.<b2SimplexVertex> = this.§0I§;
         var _loc9_:int = 0;
         while(_loc9_ < this.§-",§)
         {
            ...
            _loc10_.§2]§ = b2Math.§@#%§(param5,_loc7_);
            _loc10_.w = b2Math.§["+§(_loc10_.§2]§,_loc10_.§=v§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§-",§ > 1)
         {
            _loc11_ = param1.§!!n§;
            if((_loc12_ = this.§4p§()) < 0.5 * _loc11_ || 2 * _loc11_ < _loc12_ || _loc12_ < Number.MIN_VALUE)
            {
               this.§-",§ = 0;
            }
         }
      ...
      public function §-"u§(param1:b2SimplexCache) : void
      {
         ...
         var _loc2_:Vector.<b2SimplexVertex> = this.§0I§;
         var _loc3_:int = 0;
         while(_loc3_ < this.§-",§)
         {
      ...
      public function §%"[§() : b2Vec2
      {
         ...
         {
            case 1:
               return this.m_v1.w.§2!$§();
            case 2:
               _loc1_ = b2Math.§["+§(this.m_v2.w,this.m_v1.w);
               _loc2_ = b2Math.§ !j§(_loc1_,this.m_v1.w.§2!$§());
               if(_loc2_ > 0)
               {
      ...
      public function §4p§() : Number
      {
         switch(this.§-",§)
         {
            ...
            case 3:
               return b2Math.§ !j§(b2Math.§["+§(this.m_v2.w,this.m_v1.w),b2Math.§["+§(this.m_v3.w,this.m_v1.w));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc5_:Number = b2Math.§<f§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§<f§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§["+§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§<f§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§<f§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§["+§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§<f§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§<f§(_loc3_,_loc14_);
         var _loc18_:Number = -_loc15_;
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§ !j§(_loc4_,_loc9_)) * b2Math.§ !j§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§ !j§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§ !j§(_loc1_,_loc2_);
