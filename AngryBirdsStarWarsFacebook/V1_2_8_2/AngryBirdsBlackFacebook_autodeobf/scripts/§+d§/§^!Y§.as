package §+d§
{
   ...
   public class §^!Y§
   {
      ...
      public static function §&S§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         jsonString = §8!R§(luaString,emptyObjectAsArray);
         try
         {
      ...
      public static function §5"f§(param1:String, param2:Boolean = false) : Object
      {
         var returnObject:Object = null;
      ...
      public static function §8!R§(param1:String, param2:Boolean = false) : String
      {
         ...
         return §9C§(param1,param2);
      }
      
      private static function §9C§(param1:String, param2:Boolean) : String
      {
      ...
      private static function §]]§(param1:Object, param2:int) : String
      {
         ...
         for(_loc4_ in param1)
         {
            ...
            _loc3_ += _loc4_ + " = " + §`"d§(param1[_loc4_],param2);
            if(param2 > 1)
            {
               _loc3_ += ",";
            }
      ...
      private static function §`"d§(param1:*, param2:int) : String
      {
         ...
         else
         {
            ...
            if(param1 is Array)
            {
               ...
               {
                  _loc3_ += !!(§`"d§(param1[_loc6_],param2) + (_loc6_ < param1.length - 1)) ? "," : "";
                  _loc6_++;
               }
               return _loc3_ + "}";
            }
