package §7!I§
{
   public class b2Settings
   {
      ...
      public static const §<"z§:int = 65535;
      ...
      public static const §,0§:Number = 0.05;
      
      public static const §`E§:Number = 0.005;
      
      public static const §-"R§:Number = 0.007;
      
      public static const b2_linearSlop:Number = §-"R§;
      
      public static const §8!5§:Number = b2_linearSlop - §`E§;
      
      public static const b2_polygonRadius:Number = 8 * b2_linearSlop;
      ...
      public static const §#1§:Number = 0.1;
      
      public static var b2_linearSleepTolerance:Number = §<!9§;
