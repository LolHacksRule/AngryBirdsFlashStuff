package §+=§
{
   ...
   public class §[",§ extends §<T§
   {
      ...
      {
         super(param3);
         this.§5"D§(param1,param2);
      }
      
      protected function §5"D§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc16_:§@"Z§ = null;
         var _loc3_:Dictionary = this.§4"V§(param2);
      ...
      private function §4"V§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            for each(_loc6_ in _loc5_)
            {
               ...
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §7!]§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
