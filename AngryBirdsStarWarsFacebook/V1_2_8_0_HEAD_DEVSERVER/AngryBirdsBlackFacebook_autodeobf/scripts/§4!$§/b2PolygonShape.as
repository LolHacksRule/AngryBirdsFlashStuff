package §4!$§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §3#U§:b2Mat22 = new b2Mat22();
      ...
      public static function §?"a§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§ true§(new b2Vec2(0,0));
            _loc3_.§ true§(_loc9_);
            _loc3_.§ true§(_loc10_);
            _loc3_.§?1§(_loc16_ * _loc7_);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §2!A§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               _loc25_ = param1.R;
               param1.§+#K§.x = _loc7_.x + (_loc25_.col1.x * _loc23_ + _loc25_.col2.x * _loc24_);
               param1.§+#K§.y = _loc7_.y + (_loc25_.col1.y * _loc23_ + _loc25_.col2.y * _loc24_);
      ...
      public function §?!7§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§;!9§)
         {
            ...
            _loc6_ = b2Math.§8!3§(this.§=#S§[_loc5_],this.§=#S§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§1"t§() > Number.MIN_VALUE);
            this.§"!M§[_loc3_].SetV(b2Math.§`0§(_loc6_,1));
      ...
      public function §>"u§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§2"s§.x = 0.5 * (param1.x + param2.x);
         this.§2"s§.y = 0.5 * (param1.y + param2.y);
         this.§"!M§[0] = b2Math.§`0§(b2Math.§8!3§(param2,param1),1);
         this.§"!M§[0].Normalize();
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         {
            _loc6_ = (_loc9_ = this.§=#S§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§1!,§.x = _loc5_ - b2internal:: "^;
         param1.§1!,§.y = _loc6_ - b2internal:: "^;
         param1.§ D§.x = _loc7_ + b2internal:: "^;
         param1.§ D§.y = _loc8_ + b2internal:: "^;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§;!9§ == 2)
         {
            param1.§+#K§.x = 0.5 * (this.§=#S§[0].x + this.§=#S§[1].x);
            param1.§+#K§.y = 0.5 * (this.§=#S§[0].y + this.§=#S§[1].y);
            param1.§5"Z§ = 0;
            param1.I = 0;
            return;
         }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§=#S§[_loc9_].x * (1 - _loc15_) + this.§=#S§[_loc13_].x * _loc15_,this.§=#S§[_loc9_].y * (1 - _loc15_) + this.§=#S§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§=#S§[_loc10_].x * (1 - _loc16_) + this.§=#S§[_loc14_].x * _loc16_,this.§=#S§[_loc10_].y * (1 - _loc16_) + this.§=#S§[_loc14_].y * _loc16_);
