package §>#K§
{
   ...
   public class §8!u§
   {
      ...
      public static var §6"n§:ByteArray;
      ...
      public static function §`q§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = § f§(_loc2_);
         return §[!"§.§5"E§(_loc3_.readInt(),true) + §[!"§.§5"E§(_loc3_.readInt(),true) + §[!"§.§5"E§(_loc3_.readInt(),true) + §[!"§.§5"E§(_loc3_.readInt(),true) + §[!"§.§5"E§(_loc3_.readInt(),true);
      }
      
      public static function §3"O§(param1:ByteArray) : String
      {
         var _loc2_:Array = §8!u§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = § f§(_loc2_);
         return §[!"§.§5"E§(_loc3_.readInt(),true) + §[!"§.§5"E§(_loc3_.readInt(),true) + §[!"§.§5"E§(_loc3_.readInt(),true) + §[!"§.§5"E§(_loc3_.readInt(),true) + §[!"§.§5"E§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc6_:uint = 0;
         var _loc2_:Array = §8!u§.createBlocksFromString(param1);
         var _loc3_:ByteArray = § f§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function § f§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
