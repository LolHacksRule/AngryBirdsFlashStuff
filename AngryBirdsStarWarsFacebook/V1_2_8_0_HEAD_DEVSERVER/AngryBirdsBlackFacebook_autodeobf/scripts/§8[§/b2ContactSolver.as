package §8[§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §<!J§:b2PositionSolverManifold = new b2PositionSolverManifold();
      ...
      public function §8#5§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§8"Q§;
            _loc10_ = _loc5_.§?# §;
            _loc11_ = _loc9_.§5%§;
            _loc12_ = _loc10_.§5%§;
            _loc13_ = _loc11_.§ "^§;
            ...
            _loc17_ = _loc5_.§2;§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§`"s§(),_loc10_.§`"s§());
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§7H§(),_loc10_.§7H§());
            _loc20_ = _loc15_.§ #`§.x;
            _loc21_ = _loc15_.§ #`§.y;
            _loc22_ = _loc16_.§ #`§.x;
            _loc23_ = _loc16_.§ #`§.y;
            ...
            §["Y§.§8#5§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §["Y§.§7w§.x;
            _loc27_ = §["Y§.§7w§.y;
            (_loc28_ = this.§[#@§[_loc6_]).§9"P§ = _loc15_;
            _loc28_.§continue§ = _loc16_;
            _loc28_.§#j§ = _loc17_;
            _loc28_.normal.x = _loc26_;
            _loc28_.normal.y = _loc27_;
            _loc28_.§6!c§ = _loc17_.§6#;§;
            _loc28_.friction = _loc18_;
            _loc28_.restitution = _loc19_;
            _loc28_.§6!I§.x = _loc17_.§[#M§.x;
            _loc28_.§6!I§.y = _loc17_.§[#M§.y;
            ...
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§6!c§)
            {
               _loc30_ = _loc17_.§="8§[_loc29_];
               (_loc31_ = _loc28_.§9"`§[_loc29_]).normalImpulse = _loc30_.§,#?§;
               _loc31_.tangentImpulse = _loc30_.§!#a§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§!Y§.x = §["Y§.§="8§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§!Y§.y = §["Y§.§="8§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§&"k§.x = §["Y§.§="8§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§&"k§.y = §["Y§.§="8§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               if((_loc38_ = _loc15_.§3#>§ + _loc16_.§3#>§ + _loc15_.§3"y§ * _loc36_ + _loc16_.§3"y§ * _loc37_) > 0)
               {
                  _loc31_.§&!M§ = 1 / _loc38_;
               }
               else
               ...
               _loc41_ *= _loc41_;
               _loc42_ *= _loc42_;
               if((_loc43_ = _loc15_.§3#>§ + _loc16_.§3#>§ + _loc15_.§3"y§ * _loc41_ + _loc16_.§3"y§ * _loc42_) > 0)
               {
                  _loc31_.§+!5§ = 1 / _loc43_;
               }
               else
               ...
               {
                  _loc31_.§2!4§ = -_loc28_.restitution * _loc46_;
               }
               _loc29_++;
            }
            if(_loc28_.§6!c§ == 2)
            {
               ...
               _loc51_ = _loc16_.§3#>§;
               _loc52_ = _loc16_.§3"y§;
               _loc53_ = _loc47_.§!Y§.x * _loc27_ - _loc47_.§!Y§.y * _loc26_;
               _loc54_ = _loc47_.§&"k§.x * _loc27_ - _loc47_.§&"k§.y * _loc26_;
               _loc55_ = _loc48_.§!Y§.x * _loc27_ - _loc48_.§!Y§.y * _loc26_;
               _loc56_ = _loc48_.§&"k§.x * _loc27_ - _loc48_.§&"k§.y * _loc26_;
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         while(_loc5_ < this.§>"3§)
         {
            ...
            if(param1.§-'§)
            {
               ...
               {
                  _loc20_ = _loc6_.§9"`§[_loc18_];
                  _loc20_.normalImpulse *= param1.§8"]§;
                  _loc20_.tangentImpulse *= param1.§8"]§;
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§!Y§.x * _loc22_ - _loc20_.§!Y§.y * _loc21_);
            ...
            else
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  (_loc23_ = _loc6_.§9"`§[_loc18_]).normalImpulse = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         {
            _loc26_ = (_loc25_ = this.§[#@§[_loc24_]).§9"P§;
            _loc27_ = _loc25_.§continue§;
            ...
            _loc1_ = 0;
            while(_loc1_ < _loc25_.§6!c§)
            {
               _loc2_ = _loc25_.§9"`§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§&"k§.y - _loc30_.x + _loc28_ * _loc2_.§!Y§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§&"k§.x - _loc30_.y - _loc28_ * _loc2_.§!Y§.x;
               ...
               _loc28_ -= _loc33_ * (_loc2_.§!Y§.x * _loc15_ - _loc2_.§!Y§.y * _loc14_);
            ...
            if(_loc25_.§6!c§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§&!M§ * (_loc9_ - _loc2_.§2!4§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§&"k§.y - _loc30_.x + _loc28_ * _loc43_.§!Y§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§&"k§.x - _loc30_.y - _loc28_ * _loc43_.§!Y§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§&"k§.y - _loc30_.x + _loc28_ * _loc44_.§!Y§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§&"k§.x - _loc30_.y - _loc28_ * _loc44_.§!Y§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§2!4§;
               _loc54_ = _loc52_ - _loc44_.§2!4§;
               _loc22_ = _loc25_.K;
               _loc53_ -= _loc22_.col1.x * _loc45_ + _loc22_.col2.x * _loc46_;
               _loc54_ -= _loc22_.col1.y * _loc45_ + _loc22_.col2.y * _loc46_;
               _loc55_ = 0.001;
               _loc56_ = -((_loc22_ = _loc25_.§&!M§).col1.x * _loc53_ + _loc22_.col2.x * _loc54_);
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§!Y§.x * _loc19_ - _loc43_.§!Y§.y * _loc18_ + _loc44_.§!Y§.x * _loc21_ - _loc44_.§!Y§.y * _loc20_);
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§>"3§)
         {
            _loc5_ = (_loc4_ = this.§[#@§[_loc3_]).§9"P§;
            _loc6_ = _loc4_.§continue§;
            _loc7_ = _loc5_.§3#>§;
            _loc8_ = _loc5_.§3"y§;
            _loc9_ = _loc6_.§3#>§;
            _loc10_ = _loc6_.§3"y§;
            ...
            _loc11_ = §<!J§.§7w§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§6!c§)
            {
               _loc13_ = _loc4_.§9"`§[_loc12_];
               _loc14_ = §<!J§.§="8§[_loc12_];
               _loc15_ = §<!J§.§0#K§[_loc12_];
