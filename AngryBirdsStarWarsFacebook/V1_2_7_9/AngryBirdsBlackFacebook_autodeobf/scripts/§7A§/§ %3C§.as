package §7A§
{
   ...
   public class § <§
   {
      ...
      public static function §%"W§(param1:DisplayObject, param2:Number) : ByteArray
      {
         var _loc3_:BitmapData = §6""§(param1);
         var _loc4_:§7t§;
         return (_loc4_ = new §7t§(param2)).encode(_loc3_);
      }
      ...
      public static function §=!g§(param1:String, param2:Function) : void
      {
         ...
         var _loc4_:ByteArray = Base64.§>n§(param1);
         §6!g§(_loc4_,param2);
      }
      
      public static function §6!g§(param1:ByteArray, param2:Function) : void
      {
