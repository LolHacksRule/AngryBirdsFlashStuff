package §7A§
{
   ...
   public class §7!a§
   {
      ...
      public static function §[!V§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
      ...
      public static function §!#6§(param1:String, param2:Boolean = false) : Object
      {
         var returnObject:Object = null;
      ...
      public static function §-! §(param1:String, param2:Boolean = false) : String
      {
         ...
         return §>"j§(param1,param2);
      }
      
      private static function §>"j§(param1:String, param2:Boolean) : String
      {
      ...
      public static function §5o§(param1:Object) : String
      {
         return §%5§(param1,0);
      }
      
      private static function §%5§(param1:Object, param2:int) : String
      {
         var _loc4_:* = null;
         var _loc5_:int = 0;
         param2++;
         ...
         for(_loc4_ in param1)
         {
            ...
            _loc3_ += _loc4_ + " = " + §<"g§(param1[_loc4_],param2);
            if(param2 > 1)
            {
               _loc3_ += ",";
            }
      ...
      private static function §<"g§(param1:*, param2:int) : String
      {
         ...
         else
         {
            ...
            if(param1 is Array)
            {
               ...
               {
                  _loc3_ += !!(§<"g§(param1[_loc6_],param2) + (_loc6_ < param1.length - 1)) ? "," : "";
                  _loc6_++;
               }
               return _loc3_ + "}";
            }
