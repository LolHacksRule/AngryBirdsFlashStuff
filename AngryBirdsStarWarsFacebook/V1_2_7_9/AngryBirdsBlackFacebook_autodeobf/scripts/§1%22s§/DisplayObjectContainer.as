package §1"s§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private var §;!o§:Vector.<DisplayObject>;
      
      private var §7I§:uint = 16777215;
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§;!o§ = new Vector.<DisplayObject>(0);
      }
      
      override public function dispose() : void
      {
         var _loc1_:int = this.§;!o§.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            this.§;!o§[_loc2_].dispose();
            _loc2_++;
         }
         super.dispose();
      }
      ...
      public function §%!2§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      public function §+!;§(param1:int, param2:int) : void
      {
         ...
         this.§;!o§[param2] = _loc3_;
      }
      
      public function §=S§(param1:Function) : void
      {
         this.§;!o§ = this.§;!o§.sort(param1);
      }
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§;!o§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§;!o§.length;
         if(_loc3_ == 0)
         {
            §>"`§(param1,§4g§);
            transformCoords(§4g§,0,0,§>!"§);
            param2.x = §>!"§.x;
            param2.y = §>!"§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§;!o§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§;!o§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§;!o§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§;!o§[_loc6_];
            §>"`§(_loc7_,§4g§);
            transformCoords(§4g§,_loc3_,_loc4_,§>!"§);
      ...
      override public function render(param1:§ _§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§;!o§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§=s§();
               param1.§]"W§(_loc5_);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§1!b§(this,param1.type,_loc2_);
      ...
      private function §1!b§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§;!o§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
               this.§1!b§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
