package §1!X§
{
   ...
   public class §["%§ extends §!"#§
   {
      ...
      public function §["%§(param1:§,m§, param2:§7!m§, param3:§;"I§, param4:§4"K§, param5:§="B§)
      {
         this.§4&§ = new §<1§();
         super(param1,param2,param4,param5);
         this.§^!!§ = param3;
         this.§#!Y§ = §=5§.getItemByName("TextField_CurrentScore") as §+">§;
      }
      ...
      override protected function init() : void
      {
         ...
         this.§&!R§ = §,m§(§=5§.getItemByName("Container_MEScore"));
         this.§1!;§ = TextField(§=5§.getItemByName("Container_MEScore").mClip.text);
      }
      ...
      protected function §7"'§(param1:Number) : void
      {
         ...
         {
            this.§7##§.visible = true;
            _loc4_ = §;"@§.singleton.dataModel.userProgress.getEagleScoreForLevel(§ !p§.currentLevel);
            this.§7##§.updateScore(_loc4_);
         }
         else
         {
