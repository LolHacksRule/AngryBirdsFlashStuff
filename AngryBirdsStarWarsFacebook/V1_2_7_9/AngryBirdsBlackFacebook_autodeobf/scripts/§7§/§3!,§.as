package §7§#2
{
   ...
   public class §3!,§ extends §21§
   {
       
      
      public function §3!,§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§;!$§(param1,param2);
      }
      ...
      protected function §;!$§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         var _loc16_:§%>§ = null;
         var _loc3_:Dictionary = this.§?"1§(param2);
      ...
      private function §?"1§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
