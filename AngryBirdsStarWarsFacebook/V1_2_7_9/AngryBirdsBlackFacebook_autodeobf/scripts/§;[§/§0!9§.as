package §;[§
{
   ...
   public class §0!9§
   {
      ...
      public static function §7"3§(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number) : §<!x§
      {
         ...
         while(_loc17_ < 2)
         {
            _loc12_[_loc17_] = §;V§(_loc8_,_loc9_,_loc14_[_loc17_].x,_loc14_[_loc17_].y);
         ...
         var _loc19_:§<!x§;
         (_loc19_ = new §<!x§()).§'"V§ = Math.sqrt(_loc16_);
         _loc19_.§&#%§ = _loc18_;
         return _loc19_;
      }
      
      public static function §;V§(param1:Number, param2:Number, param3:Number, param4:Number) : Number
      {
