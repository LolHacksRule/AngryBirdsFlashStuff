package §2",§
{
   ...
   public class b2DistanceJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * this.§^!t§ * this.§<!+§.x,param1 * this.§^!t§ * this.§<!+§.y);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc13_:Number = _loc4_.§@"P§ + _loc4_.§%#2§ * _loc11_ * _loc11_ + _loc5_.§@"P§ + _loc5_.§%#2§ * _loc12_ * _loc12_;
         this.§'J§ = _loc13_ != 0 ? Number(1 / _loc13_) : Number(0);
         if(this.§!!j§ > 0)
         {
            _loc14_ = _loc10_ - this.§^!D§;
            _loc15_ = 2 * Math.PI * this.§!!j§;
            _loc16_ = 2 * this.§'J§ * this.§>B§ * _loc15_;
            _loc17_ = this.§'J§ * _loc15_ * _loc15_;
            this.§32§ = param1.§&"%§ * (_loc16_ + param1.§&"%§ * _loc17_);
            this.§32§ = this.§32§ != 0 ? Number(1 / this.§32§) : Number(0);
            this.§&!;§ = _loc14_ * param1.§&"%§ * _loc17_ * this.§32§;
            this.§'J§ = _loc13_ + this.§32§;
            this.§'J§ = this.§'J§ != 0 ? Number(1 / this.§'J§) : Number(0);
         }
         if(param1.§56§)
         {
            this.§^!t§ *= param1.§<J§;
            _loc18_ = this.§^!t§ * this.§<!+§.x;
            _loc19_ = this.§^!t§ * this.§<!+§.y;
            _loc4_.§5!r§.x -= _loc4_.§@"P§ * _loc18_;
            _loc4_.§5!r§.y -= _loc4_.§@"P§ * _loc19_;
            _loc4_.m_angularVelocity -= _loc4_.§%#2§ * (_loc6_ * _loc19_ - _loc7_ * _loc18_);
            _loc5_.§5!r§.x += _loc5_.§@"P§ * _loc18_;
            _loc5_.§5!r§.y += _loc5_.§@"P§ * _loc19_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = _loc2_.col1.y * _loc8_ + _loc2_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         var _loc10_:Number = _loc3_.§5!r§.x + -_loc3_.m_angularVelocity * _loc6_;
         var _loc11_:Number = _loc3_.§5!r§.y + _loc3_.m_angularVelocity * _loc5_;
         var _loc12_:Number = _loc4_.§5!r§.x + -_loc4_.m_angularVelocity * _loc9_;
         var _loc13_:Number = _loc4_.§5!r§.y + _loc4_.m_angularVelocity * _loc8_;
         var _loc14_:Number = this.§<!+§.x * (_loc12_ - _loc10_) + this.§<!+§.y * (_loc13_ - _loc11_);
         var _loc15_:Number = -this.§'J§ * (_loc14_ + this.§&!;§ + this.§32§ * this.§^!t§);
         this.§^!t§ += _loc15_;
         ...
         _loc4_.§5!r§.x += _loc4_.§@"P§ * _loc16_;
         _loc4_.§5!r§.y += _loc4_.§@"P§ * _loc17_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         _loc13_ = b2Math.§2"R§(_loc13_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
