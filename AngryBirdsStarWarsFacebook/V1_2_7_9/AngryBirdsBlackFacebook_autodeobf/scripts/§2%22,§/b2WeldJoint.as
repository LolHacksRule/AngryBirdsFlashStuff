package §2",§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc7_ = this.§9"B§.y - _loc4_.m_sweep.localCenter.y;
         ...
         if(param1.§56§)
         {
            ...
            this.§^!t§.y *= param1.§<J§;
            this.§^!t§.z *= param1.§<J§;
            _loc4_.§5!r§.x -= _loc10_ * this.§^!t§.x;
            _loc4_.§5!r§.y -= _loc10_ * this.§^!t§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§^!t§.y - _loc7_ * this.§^!t§.x + this.§^!t§.z);
            _loc5_.§5!r§.x += _loc11_ * this.§^!t§.x;
            _loc5_.§5!r§.y += _loc11_ * this.§^!t§.y;
            _loc5_.m_angularVelocity += _loc13_ * (_loc8_ * this.§^!t§.y - _loc9_ * this.§^!t§.x + this.§^!t§.z);
         }
         else
         {
            this.§^!t§.§@e§();
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc5_:b2Body = b2internal::@!u;
         _loc2_ = _loc4_.m_xf.R;
         var _loc6_:Number = this.§9"B§.x - _loc4_.m_sweep.localCenter.x;
