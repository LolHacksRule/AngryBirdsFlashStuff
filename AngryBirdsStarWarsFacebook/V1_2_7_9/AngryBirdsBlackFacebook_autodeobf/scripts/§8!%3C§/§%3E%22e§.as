package §8!<§
{
   ...
   public class §>"e§
   {
      ...
      public static function §5"H§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §]p§(_loc2_);
         return §="j§.§["L§(_loc3_.readInt(),true) + §="j§.§["L§(_loc3_.readInt(),true) + §="j§.§["L§(_loc3_.readInt(),true) + §="j§.§["L§(_loc3_.readInt(),true) + §="j§.§["L§(_loc3_.readInt(),true);
      }
      ...
      private static function §]p§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
