package §3"5§
{
   ...
   public class b2Collision
   {
      ...
      private static var §3!"§:Vector.<§]R§> = §;"f§();
      
      private static var s_clipPoints1:Vector.<§]R§> = §;"f§();
      
      private static var s_clipPoints2:Vector.<§]R§> = §;"f§();
      
      private static var §;#6§:Vector.<int> = new Vector.<int>(1);
      
      private static var §7#[§:Vector.<int> = new Vector.<int>(1);
      
      private static var §0!T§:b2Vec2 = new b2Vec2();
      
      private static var §^!]§:b2Vec2 = new b2Vec2();
      
      private static var §>!H§:b2Vec2 = new b2Vec2();
      
      private static var §6!F§:b2Vec2 = new b2Vec2();
      ...
      public static function §`"6§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §&!L§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §&!L§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §&!L§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §&!L§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §1";§(param1:Vector.<§]R§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         _loc20_.id.§="i§.§7!b§ = param4;
         _loc20_.id.§="i§.§4"f§ = _loc21_;
         _loc20_.id.§="i§.§^"F§ = 0;
         _loc20_ = param1[1];
      ...
      public static function §?e§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §;#6§[0] = _loc8_;
         var _loc9_:Number = §`"6§(§;#6§,param2,param3,param4,param5);
         _loc8_ = §;#6§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §7#[§[0] = _loc10_;
         var _loc11_:Number = §`"6§(§7#[§,param4,param5,param2,param3);
         _loc10_ = §7#[§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§]R§> = §3!"§;
         §1";§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§;!9§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§=#S§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §0!T§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §^!]§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §>!H§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §!!P§;
         _loc20_ = _loc14_.R;
         ...
         if((_loc39_ = §7#$§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §7#$§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
      ...
      public static function §7"S§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc22_:Vector.<b2Vec2> = param2.§=#S§;
