package §1!2§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§##,§.x * this.§2#U§.x + (this.§4#5§ + this.§##,§.z) * this.§<#§.x),param1 * (this.§##,§.x * this.§2#U§.y + (this.§4#5§ + this.§##,§.z) * this.§<#§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§<i§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§<i§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§<i§.col2.x = this.§<i§.col1.y;
         if(_loc16_ + _loc17_ != 0)
         {
            this.§<i§.col2.y = _loc16_ + _loc17_;
         }
         else
         {
            this.§<i§.col2.y = 1;
         }
         this.§<i§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§<i§.col3.x = this.§<i§.col1.z;
         this.§<i§.col3.y = this.§<i§.col2.z;
         this.§<i§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§'s§)
         {
         ...
         if(param1.§-'§)
         {
            ...
            this.§##,§.y *= param1.§8"]§;
            this.§4#5§ *= param1.§8"]§;
            _loc19_ = this.§##,§.x * this.§2#U§.x + (this.§4#5§ + this.§##,§.z) * this.§<#§.x;
            _loc20_ = this.§##,§.x * this.§2#U§.y + (this.§4#5§ + this.§##,§.z) * this.§<#§.y;
            _loc21_ = this.§##,§.x * this.m_s1 + this.§##,§.y + (this.§4#5§ + this.§##,§.z) * this.m_a1;
            _loc22_ = this.§##,§.x * this.m_s2 + this.§##,§.y + (this.§4#5§ + this.§##,§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§9!X§ && this.§<!G§ != b2internal::?!b)
         {
            ...
            _loc15_ = this.§99§ * (this.§7#R§ - _loc14_);
            _loc16_ = this.§4#5§;
            _loc17_ = param1.§1!O§ * this.§'!9§;
            this.§4#5§ = b2Math.§<"X§(this.§4#5§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§4#5§ - _loc16_) * this.§<#§.x;
         ...
         if(this.§'s§ && this.§<!G§ != b2internal::"!G)
         {
            ...
            _loc19_ = this.§##,§.Copy();
            _loc20_ = this.§<i§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§##,§.§ true§(_loc20_);
            if(this.§<!G§ == b2internal::5#C)
            {
               this.§##,§.z = b2Math.§<#N§(this.§##,§.z,0);
            }
            else if(this.§<!G§ == b2internal::#"e)
            {
               this.§##,§.z = b2Math.§'#Z§(this.§##,§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§##,§.z - _loc19_.z) * this.§<i§.col3.x;
            _loc22_ = -_loc13_ - (this.§##,§.z - _loc19_.z) * this.§<i§.col3.y;
            _loc23_ = this.§<i§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§##,§.x = _loc23_.x;
            this.§##,§.y = _loc23_.y;
            ...
            _loc8_ = _loc20_.x * this.§2#U§.x + _loc20_.z * this.§<#§.x;
            _loc9_ = _loc20_.x * this.§2#U§.y + _loc20_.z * this.§<#§.y;
         ...
         {
            _loc24_ = this.§<i§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§##,§.x += _loc24_.x;
            this.§##,§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§2#U§.x;
            _loc9_ = _loc24_.x * this.§2#U§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§'s§)
         {
            ...
            {
               _loc19_ = b2Math.§<"X§(_loc35_ - this.§2!<§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§2!<§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§%!N§)
            {
               _loc19_ = b2Math.§<"X§(_loc35_ - this.§%!N§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§%!N§;
               _loc18_ = true;
            }
         }
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§7"H§;
         ...
         if(_loc18_)
         {
            ...
            this.§<i§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§<i§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§<i§.col2.x = this.§<i§.col1.y;
            if(_loc14_ + _loc15_ != 0)
            {
               this.§<i§.col2.y = _loc14_ + _loc15_;
            }
            else
            {
               this.§<i§.col2.y = 1;
            }
            this.§<i§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§<i§.col3.x = this.§<i§.col1.z;
            this.§<i§.col3.y = this.§<i§.col2.z;
            this.§<i§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§<i§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::<M;
            ...
            this.§<i§.col1.Set(_loc36_,_loc37_,0);
            this.§<i§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§<i§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§2#U§.x + _loc28_.z * this.§<#§.x;
         var _loc32_:Number = _loc28_.x * this.§2#U§.y + _loc28_.z * this.§<#§.y;
