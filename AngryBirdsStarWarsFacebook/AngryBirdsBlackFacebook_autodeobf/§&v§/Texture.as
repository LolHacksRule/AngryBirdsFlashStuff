   ...
   public class Texture
   {
      ...
      public function adjustVertexData(param1:§%"G§, param2:int, param3:int) : void
      {
         ...
         if(this.§7m§)
         {
            ...
            _loc4_ = this.§7m§.width + this.§7m§.x - this.width;
            _loc5_ = this.§7m§.height + this.§7m§.y - this.height;
            param1.§^!c§(param2,-this.§7m§.x,-this.§7m§.y);
            param1.§^!c§(param2 + 1,-_loc4_,-this.§7m§.y);
            param1.§^!c§(param2 + 2,-this.§7m§.x,-_loc5_);
