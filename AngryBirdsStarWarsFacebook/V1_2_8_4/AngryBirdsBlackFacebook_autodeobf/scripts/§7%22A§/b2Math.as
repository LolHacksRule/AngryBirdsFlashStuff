package §7"A§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§"1§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §[!X§(param1:Number) : Boolean
      {
         return isFinite(param1);
      }
      
      public static function §<f§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         return param1.x * param2.x + param1.y * param2.y;
      }
      
      public static function § !j§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §6%§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return new b2Vec2(§<f§(param2,param1.col1),§<f§(param2,param1.col2));
      }
      
      public static function §@#%§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         _loc3_ = §6%§(param1.R,param2);
         _loc3_.x += param1.position.x;
         _loc3_.y += param1.position.y;
         return _loc3_;
      }
      
      public static function §true§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
      ...
      public static function §87§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§"1§(§"!^§(param1.col1,param2.col1),§"!^§(param1.col2,param2.col2));
      }
      
      public static function §>#,§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§"1§(§6%§(param1,param2.col1),§6%§(param1,param2.col2));
      }
      
      public static function §5!Z§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§<f§(param1.col1,param2.col1),§<f§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§<f§(param1.col1,param2.col2),§<f§(param1.col2,param2.col2));
      ...
      public static function §`!F§(param1:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§"1§(§`!F§(param1.col1),§`!F§(param1.col2));
      }
      ...
      {
         return new b2Vec2(§%y§(param1.x,param2.x),§%y§(param1.y,param2.y));
      }
      
      public static function § b§(param1:Number, param2:Number) : Number
      {
         return param1 > param2 ? Number(param1) : Number(param2);
      }
      ...
      {
         return new b2Vec2(§ b§(param1.x,param2.x),§ b§(param1.y,param2.y));
      }
      
      public static function §0!M§(param1:Number, param2:Number, param3:Number) : Number
      {
      ...
      {
         return §;"G§(param2,§?f§(param1,param3));
      }
      
      public static function §6!2§(param1:Array, param2:Array) : void
      {
         var _loc3_:* = param1[0];
         param1[0] = param2[0];
         param2[0] = _loc3_;
      ...
      public static function §9n§(param1:Number, param2:Number) : Number
      {
