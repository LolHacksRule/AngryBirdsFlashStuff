package §%"Q§
{
   ...
   public class §`=§ extends §`!6§
   {
      ...
      public function §`=§(param1:§5#§, param2:§5#+§, param3:Boolean = false, param4:String = "LevelEndEagleState")
      {
      ...
      override protected function init() : void
      {
         ...
         this.§%I§ = (§^!b§.getItemByName("MovieClip_EagleMeterFill") as §9!c§).width;
         §=Q§.§`"u§(§2"p§,1,1);
      }
      ...
      override public function activate(param1:String) : void
      {
         ...
         this.§4"C§ = §4"#§.singleton.dataModel.userProgress.getEagleScoreForLevel(§'""§.currentLevel);
         var _loc3_:* = _loc2_ > this.§4"C§;
         if(_loc3_)
         {
         ...
         this.§&#4§ = §5!%§.§!6§.§4!M§(this,{"mEagleScoreCounter":_loc2_},{"mEagleScoreCounter":0},_loc2_ / 100 * 4);
      ...
      {
         super.update(param1);
         if(int(this.mEagleScoreCounter) > this.§4"C§)
         {
         ...
         {
            (§^!b§.getItemByName("TextField_EaglePercentage") as §0%§).§9";§.text = int(this.§4"C§) + "%";
            (§^!b§.getItemByName("TextField_EaglePercentageEffects") as §0%§).§9";§.text = int(this.§4"C§) + "%";
         }
         var _loc2_:Rectangle = new Rectangle(0,0,this.§%I§ * (this.mEagleScoreCounter / 100),(§^!b§.getItemByName("MovieClip_EagleMeterFill") as §9!c§).height);
