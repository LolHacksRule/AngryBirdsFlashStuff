package §+=§
{
   ...
   public class §9"j§ extends §<T§
   {
      
      public static var §>#5§:Boolean = false;
       
      
      public function §9"j§(param1:Object, param2:BitmapData)
      {
         super(param2);
         this.§5"D§(param1);
      }
      
      private static function §1P§(param1:§@"Z§, param2:int, param3:int) : void
      {
      ...
      protected function §5"D§(param1:Object) : void
      {
         var _loc4_:* = null;
