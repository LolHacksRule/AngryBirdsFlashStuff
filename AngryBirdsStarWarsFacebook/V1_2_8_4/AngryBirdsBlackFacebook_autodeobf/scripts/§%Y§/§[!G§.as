package §%Y§
{
   ...
   public class §[!G§
   {
      ...
      public static function §,O§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §,s§(_loc2_);
         return §^#§.§8"B§(_loc3_.readInt(),true) + §^#§.§8"B§(_loc3_.readInt(),true) + §^#§.§8"B§(_loc3_.readInt(),true) + §^#§.§8"B§(_loc3_.readInt(),true) + §^#§.§8"B§(_loc3_.readInt(),true);
      }
      
      public static function §9#5§(param1:ByteArray) : String
      {
      ...
      public static function §1"g§(param1:String) : String
      {
         var _loc6_:uint = 0;
      ...
      private static function §,s§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
