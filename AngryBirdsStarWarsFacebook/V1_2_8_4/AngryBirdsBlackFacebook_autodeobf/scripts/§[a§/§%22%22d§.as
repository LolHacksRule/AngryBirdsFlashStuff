package §[a§
{
   ...
   public class §""d§
   {
      ...
      public static const §7x§:String = "linear";
      ...
      public static const §8"K§:String = "easeOutIn";
      ...
      public static const §+"k§:String = "easeOutInBack";
      
      public static const §#x§:String = "easeInElastic";
      
      public static const §,C§:String = "easeOutElastic";
      
      public static const §3!T§:String = "easeInOutElastic";
      ...
      public static const §%!R§:String = "easeOutInBounce";
      
      private static var §9d§:Dictionary;
      ...
      private static function §&=§() : void
      {
         ...
         §%w§(§#x§,easeInElastic);
         §%w§(§,C§,easeOutElastic);
         §%w§(§3!T§,easeInOutElastic);
         §%w§(§<!O§,easeOutInElastic);
         §%w§(§;!R§,easeInBounce);
         §%w§(§#"&§,easeOutBounce);
         §%w§(§`!Z§,easeInOutBounce);
         §%w§(§%!R§,easeOutInBounce);
