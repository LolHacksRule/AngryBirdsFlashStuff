package §8!E§
{
   ...
   public class §true § extends §7"]§
   {
      ...
      {
         if(§4#;§.singleton.dataModel.userProgress.§0#9§ && §4#;§.singleton.dataModel.userProgress.§=!d§(§+!b§.currentLevel))
         {
         }
      }
      ...
      protected function §0r§(param1:Number) : void
      {
         ...
         var _loc4_:int;
         if((_loc4_ = this.§0"-§.getValue()) < _loc2_)
         {
            _loc4_ = Math.min(_loc2_,this.§0"-§.getValue() + param1 * §#!X§);
            this.§0"-§.§3"Q§(_loc4_);
         }
      }
