package §4!$§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§8_§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§7!U§ = this.§8_§.Normalize();
         this.§7w§.Set(this.§8_§.y,-this.§8_§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§7w§.x - this.§8_§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§7w§.y - this.§8_§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§7w§.x + this.§8_§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§7w§.y + this.§8_§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§7w§;
         this.m_cornerDir2.Set(-this.§7w§.x,-this.§7w§.y);
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§%#8§ * _loc12_)
            {
