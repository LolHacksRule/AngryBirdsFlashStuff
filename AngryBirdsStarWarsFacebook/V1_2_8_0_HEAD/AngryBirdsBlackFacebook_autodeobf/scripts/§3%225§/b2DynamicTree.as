   ...
   public class b2DynamicTree
   {
      ...
      public function §"4§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            ...
            {
               _loc3_ = !!(this.§6!U§ >> _loc4_ & 1) ? _loc3_.child2 : _loc3_.child1;
               _loc4_ = _loc4_ + 1 & 31;
            }
            ++this.§6!U§;
            this.§@#&§(_loc3_);
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         _loc9_.§ D§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§ D§.y = Math.max(_loc3_.y,_loc11_);
      ...
      private function §9"E§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_.§'"A§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§1!,§.x + _loc6_.aabb.§ D§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§1!,§.y + _loc6_.aabb.§ D§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§1!,§.x + _loc7_.aabb.§ D§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§1!,§.y + _loc7_.aabb.§ D§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         if(_loc4_)
         {
            ...
            while(!_loc4_.aabb.§+g§(_loc5_.aabb))
            {
