         ...
         switch(param1.§%!9§)
         {
            case b2Manifold.§1!9§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§7w§.x = _loc19_ / _loc26_;
                  this.§7w§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§7w§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§7w§.x;
               _loc23_ = _loc16_ + param3 * this.§7w§.y;
               _loc24_ = _loc17_ - param5 * this.§7w§.x;
               _loc25_ = _loc18_ - param5 * this.§7w§.y;
               this.§="8§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§="8§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§=!m§:
               _loc8_ = param2.R;
               _loc7_ = param1.§[#M§;
               ...
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§="8§[_loc6_].m_localPoint;
                  ...
                  this.§="8§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§="8§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§3"f§:
               ...
               while(_loc6_ < param1.§6#;§)
               {
                  ...
                  this.§="8§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§="8§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
