package §3"5§
{
   ...
   public class b2AABB
   {
      ...
      {
         var _loc1_:Number = this.§ D§.x - this.§1!,§.x;
         var _loc2_:Number = this.§ D§.y - this.§1!,§.y;
         var _loc3_:Boolean = _loc1_ >= 0 && _loc2_ >= 0;
         return Boolean(_loc3_ && this.§1!,§.§&" §() && this.§ D§.§&" §());
      }
      
      public function §&!m§() : b2Vec2
      {
         return new b2Vec2((this.§1!,§.x + this.§ D§.x) / 2,(this.§1!,§.y + this.§ D§.y) / 2);
      }
      
      public function §5"y§() : b2Vec2
      {
         return new b2Vec2((this.§ D§.x - this.§1!,§.x) / 2,(this.§ D§.y - this.§1!,§.y) / 2);
      }
      ...
      public function §+g§(param1:b2AABB) : Boolean
      {
         ...
         _loc2_ = _loc2_ && param1.§ D§.x <= this.§ D§.x;
         return Boolean(_loc2_ && param1.§ D§.y <= this.§ D§.y);
      }
      ...
      public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput) : Boolean
      {
         ...
         {
            if(_loc5_ < this.§1!,§.x || this.§ D§.x < _loc5_)
            {
               return false;
            }
         }
         else
         {
            ...
            _loc14_ = (this.§ D§.x - _loc5_) * _loc12_;
            _loc16_ = -1;
            if(_loc13_ > _loc14_)
            {
               _loc15_ = _loc13_;
         ...
         {
            if(_loc6_ < this.§1!,§.y || this.§ D§.y < _loc6_)
            {
               return false;
            }
         }
         else
         {
            ...
            _loc14_ = (this.§ D§.y - _loc6_) * _loc12_;
            _loc16_ = -1;
            if(_loc13_ > _loc14_)
            {
               _loc15_ = _loc13_;
      ...
      {
         var _loc2_:Number = param1.§1!,§.x - this.§ D§.x;
         var _loc3_:Number = param1.§1!,§.y - this.§ D§.y;
         var _loc4_:Number = this.§1!,§.x - param1.§ D§.x;
         var _loc5_:Number = this.§1!,§.y - param1.§ D§.y;
      ...
      public function §"";§(param1:b2AABB, param2:b2AABB) : void
      {
         ...
         this.§ D§.x = Math.max(param1.§ D§.x,param2.§ D§.x);
         this.§ D§.y = Math.max(param1.§ D§.y,param2.§ D§.y);
      }
   }
}
