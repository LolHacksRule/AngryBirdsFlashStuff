package §3"5§
{
   ...
   class b2Simplex
   {
      ...
      public function §`"7§() : b2Vec2
      {
         ...
         switch(this.§@"K§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§0#W§(_loc1_,this.m_v1.w.§5!]§());
               if(_loc2_ > 0)
               {
      ...
      public function §4`§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§@"K§)
         {
            ...
            case 1:
               ...
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§5#1§.x + this.m_v2.a * this.m_v2.§5#1§.x;
               param1.y = this.m_v1.a * this.m_v1.§5#1§.y + this.m_v2.a * this.m_v2.§5#1§.y;
               param2.x = this.m_v1.a * this.m_v1.§6!V§.x + this.m_v2.a * this.m_v2.§6!V§.x;
               param2.y = this.m_v1.a * this.m_v1.§6!V§.y + this.m_v2.a * this.m_v2.§6!V§.y;
               break;
            case 3:
               param2.x = param1.x = this.m_v1.a * this.m_v1.§5#1§.x + this.m_v2.a * this.m_v2.§5#1§.x + this.m_v3.a * this.m_v3.§5#1§.x;
               param2.y = param1.y = this.m_v1.a * this.m_v1.§5#1§.y + this.m_v2.a * this.m_v2.§5#1§.y + this.m_v3.a * this.m_v3.§5#1§.y;
               break;
            default:
               b2Settings.b2Assert(false);
         }
      ...
      public function §%<§() : Number
      {
         switch(this.§@"K§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§8!3§(this.m_v1.w,this.m_v2.w).Length();
            case 3:
               return b2Math.§0#W§(b2Math.§8!3§(this.m_v2.w,this.m_v1.w),b2Math.§8!3§(this.m_v3.w,this.m_v1.w));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§0#W§(_loc4_,_loc9_)) * b2Math.§0#W§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§0#W§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§0#W§(_loc1_,_loc2_);
