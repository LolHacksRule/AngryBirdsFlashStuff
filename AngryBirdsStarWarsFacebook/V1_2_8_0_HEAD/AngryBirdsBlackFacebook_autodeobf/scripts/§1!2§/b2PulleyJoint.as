package §1!2§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         this.m_groundAnchor1.x = param1.§6!b§.x - this.§[!K§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§6!b§.y - this.§[!K§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§'p§.x - this.§[!K§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§'p§.y - this.§[!K§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§!"4§);
         this.m_localAnchor2.SetV(param1.§#"B§);
         this.§-_§ = param1.§@!%§;
         this.§-"§ = param1.§&y§ + this.§-_§ * param1.§,"q§;
         this.m_maxLength1 = b2Math.§'#Z§(param1.§1!B§,this.§-"§ - this.§-_§ * b2internal::!!N);
         this.m_maxLength2 = b2Math.§'#Z§(param1.§&!q§,(this.§-"§ - b2internal::!!N) / this.§-_§);
         this.§##,§ = 0;
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.m_limitMass1 = _loc2_.§3#>§ + _loc2_.§3"y§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§3#>§ + _loc3_.§3"y§ * _loc22_ * _loc22_;
         this.§6"M§ = this.m_limitMass1 + this.§-_§ * this.§-_§ * this.m_limitMass2;
         ...
         {
            this.§##,§ *= param1.§8"]§;
            this.m_limitImpulse1 *= param1.§8"]§;
            this.m_limitImpulse2 *= param1.§8"]§;
            _loc23_ = (-this.§##,§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§##,§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§-_§ * this.§##,§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§-_§ * this.§##,§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§ #`§.x += _loc2_.§3#>§ * _loc23_;
            _loc2_.§ #`§.y += _loc2_.§3#>§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§3"y§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§ #`§.x += _loc3_.§3#>§ * _loc25_;
            _loc3_.§ #`§.y += _loc3_.§3#>§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§3"y§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§##,§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§&>§ == b2internal::#"e)
         {
            ...
            _loc19_ = this.§6"M§ * -_loc18_;
            _loc20_ = this.§##,§;
            this.§##,§ = b2Math.§<#N§(0,this.§##,§ + _loc19_);
            ...
            _loc2_.§ #`§.x += _loc2_.§3#>§ * _loc14_;
            _loc2_.§ #`§.y += _loc2_.§3#>§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§3"y§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§ #`§.x += _loc3_.§3#>§ * _loc16_;
            _loc3_.§ #`§.y += _loc3_.§3#>§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§3"y§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§&>§ == b2internal::#"e)
         {
            ...
            _loc19_ = b2Math.§<"X§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§6"M§ * _loc19_) * this.m_u1.x;
            ...
            _loc2_.m_sweep.a += _loc2_.§3"y§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§3#>§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§3#>§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§3"y§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§`"a§();
            _loc3_.§`"a§();
         }
         if(this.m_limitState1 == b2internal::#"e)
