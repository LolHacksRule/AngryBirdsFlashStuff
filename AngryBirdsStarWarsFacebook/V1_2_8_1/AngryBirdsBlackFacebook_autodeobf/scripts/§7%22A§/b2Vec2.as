package §7"A§
{
   public class b2Vec2
   {
      ...
      public function §0T§(param1:b2Vec2) : void
      {
         this.x -= param1.x;
         this.y -= param1.y;
      }
      ...
      public function §3!J§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§<f§(this,param1.col1);
         this.y = b2Math.§<f§(this,param1.col2);
         this.x = _loc2_;
      }
