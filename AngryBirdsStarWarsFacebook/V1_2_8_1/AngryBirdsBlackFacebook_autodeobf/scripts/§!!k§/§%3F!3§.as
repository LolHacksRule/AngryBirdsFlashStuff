package §!!k§
{
   ...
   public class §?!3§
   {
      ...
      private var §1"q§:Dictionary;
      
      public function §?!3§(param1:§0!B§)
      {
      ...
      public function §5#0§() : void
      {
         ...
         this.§&!d§("SLINGSHOT",["SLING_SHOT_01_BACK","SLING_SHOT_01_FRONT","SLING_HOLDER","SLING_RUBBERBAND"]);
         ...
         this.§&!d§("SMOKE_BUFF_SMALL",["SMOKE_BUFF_1","SMOKE_BUFF_2","SMOKE_BUFF_3"]);
         for each(_loc1_ in [{
            "name":"TRAIL_",
            "count":3
         },{
         ...
         }])
         {
            ...
            {
               this.§&!d§(_loc1_.name + _loc2_,[_loc1_.name + _loc2_]);
               _loc2_++;
            }
         }
      ...
      public function §&!d§(param1:String, param2:Array, param3:Array = null, param4:String = null) : §1!^§
      {
         var _loc5_:§1!^§ = this.§=#7§(param1,param2,param3,param4);
         this.§9#3§(param1,_loc5_);
         return _loc5_;
      }
      
      public function §&!"§(param1:String, param2:Array) : void
      {
         var _loc3_:§<!S§ = this.§ y§(param1,param2);
         this.§9#3§(param1,_loc3_);
      }
      
      private function §=#7§(param1:String, param2:Array, param3:Array = null, param4:String = null) : §1!^§
      {
         var _loc7_:String = null;
         var _loc8_:Number = NaN;
         var _loc5_:§1!^§ = new §1!^§(param1,this.§9!G§);
         var _loc6_:int = 0;
      ...
      private function § y§(param1:String, param2:Array) : §<!S§
      {
         ...
         var _loc3_:§<!S§ = new §<!S§(param1,this.§9!G§);
         for each(_loc4_ in param2)
         {
            _loc5_ = _loc4_[0];
            if((_loc6_ = _loc4_[1]).length > 0 && _loc6_[0] is Array)
            {
               _loc3_.§&!d§(_loc5_,this.§ y§(_loc5_,_loc6_));
            }
            else
            {
               _loc7_ = null;
               ...
               _loc3_.§&!d§(_loc5_,this.§=#7§(_loc5_,_loc6_,_loc7_,_loc8_));
            }
         }
         return _loc3_;
      }
      
      private function §9#3§(param1:String, param2:§1!^§) : void
      {
         if(this.§1"q§[param1])
         {
            return;
         }
         this.§1"q§[param1] = param2;
      }
