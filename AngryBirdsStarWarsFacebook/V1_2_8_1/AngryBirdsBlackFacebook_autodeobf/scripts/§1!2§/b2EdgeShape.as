package §1!2§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§]#%§ = this.§3!"§.Normalize();
         this.§8!g§.Set(this.§3!"§.y,-this.§3!"§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§8!g§.x - this.§3!"§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§8!g§.y - this.§3!"§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§8!g§.x + this.§3!"§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§8!g§.y + this.§3!"§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§8!g§;
         this.m_cornerDir2.Set(-this.§8!g§.x,-this.§8!g§.y);
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc8_:Number = b2Math.§<f§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§<f§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §+!S§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §'!F§() : b2EdgeShape
      {
         return this.§^"d§;
      }
      
      public function §9!I§() : b2EdgeShape
      {
         return this.§!!Z§;
      }
      
      public function §%6§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
      ...
      b2internal function §3"G§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§!!Z§ = param1;
      ...
      b2internal function §6V§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§^"d§ = param1;
