package §%"Q§
{
   ...
   public class §,L§ extends §`!6§
   {
      ...
      public function set scrollIndex(param1:Number) : void
      {
         ...
         {
            _loc6_ = ((_loc5_ = this.§7!0§ < this.§5=§ ? Number(-1) : Number(1)) * this.§1!$§ * §'9§ + _loc4_ - _loc2_) / _loc2_;
         ...
         {
            _loc9_ = ((_loc8_ = this.§7!0§ < this.§5=§ ? Number(1) : Number(-1)) * (1 - this.§1!$§) * §'9§ + _loc4_ - _loc2_) / _loc2_;
      ...
      protected function §6!g§() : void
      {
         ...
         while(_loc1_ < this.§^!]§.length)
         {
            _loc2_ = this.§7!0§ + this.§1!$§ * (this.§5=§ - this.§7!0§) + 0.5;
