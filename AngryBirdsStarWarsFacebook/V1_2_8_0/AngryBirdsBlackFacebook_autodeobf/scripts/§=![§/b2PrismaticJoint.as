package §=![§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§8!t§.x * this.§3X§.x + (this.§7'§ + this.§8!t§.z) * this.§;7§.x),param1 * (this.§8!t§.x * this.§3X§.y + (this.§7'§ + this.§8!t§.z) * this.§;7§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§?!'§)
         {
            ...
            this.§8!t§.y *= param1.§!"J§;
            this.§7'§ *= param1.§!"J§;
            _loc19_ = this.§8!t§.x * this.§3X§.x + (this.§7'§ + this.§8!t§.z) * this.§;7§.x;
            _loc20_ = this.§8!t§.x * this.§3X§.y + (this.§7'§ + this.§8!t§.z) * this.§;7§.y;
            _loc21_ = this.§8!t§.x * this.m_s1 + this.§8!t§.y + (this.§7'§ + this.§8!t§.z) * this.m_a1;
            _loc22_ = this.§8!t§.x * this.m_s2 + this.§8!t§.y + (this.§7'§ + this.§8!t§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§;7§.x * (_loc6_.x - _loc4_.x) + this.§;7§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§7!v§ * (this.§@b§ - _loc14_);
            _loc16_ = this.§7'§;
            _loc17_ = param1.§-!@§ * this.§?"I§;
            this.§7'§ = b2Math.§0!M§(this.§7'§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§7'§ - _loc16_) * this.§;7§.x;
            _loc9_ = _loc15_ * this.§;7§.y;
         ...
         {
            _loc18_ = this.§;7§.x * (_loc6_.x - _loc4_.x) + this.§;7§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§8!t§.Copy();
            _loc20_ = this.§`!N§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§8!t§.§4"5§(_loc20_);
            if(this.§]"g§ == b2internal::["G)
            {
               this.§8!t§.z = b2Math.§ b§(this.§8!t§.z,0);
            }
            else if(this.§]"g§ == b2internal::""Q)
            {
               this.§8!t§.z = b2Math.§%y§(this.§8!t§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§8!t§.z - _loc19_.z) * this.§`!N§.col3.x;
            _loc22_ = -_loc13_ - (this.§8!t§.z - _loc19_.z) * this.§`!N§.col3.y;
            _loc23_ = this.§`!N§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§8!t§.x = _loc23_.x;
            this.§8!t§.y = _loc23_.y;
            _loc20_.x = this.§8!t§.x - _loc19_.x;
            _loc20_.y = this.§8!t§.y - _loc19_.y;
            _loc20_.z = this.§8!t§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§3X§.x + _loc20_.z * this.§;7§.x;
            _loc9_ = _loc20_.x * this.§3X§.y + _loc20_.z * this.§;7§.y;
         ...
         else
         {
            ...
            this.§8!t§.x += _loc24_.x;
            this.§8!t§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§3X§.x;
            _loc9_ = _loc24_.x * this.§3X§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§,o§)
         {
            ...
            _loc35_ = this.§;7§.x * _loc26_ + this.§;7§.y * _loc27_;
            if(b2Math.§>b§(this.§#!!§ - this.§&#&§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§0!M§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§>b§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§&#&§)
            {
               _loc19_ = b2Math.§0!M§(_loc35_ - this.§&#&§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§&#&§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§#!!§)
            {
               _loc19_ = b2Math.§0!M§(_loc35_ - this.§#!!§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§,!Z§;
         ...
         var _loc31_:Number = _loc28_.x * this.§3X§.x + _loc28_.z * this.§;7§.x;
         var _loc32_:Number = _loc28_.x * this.§3X§.y + _loc28_.z * this.§;7§.y;
