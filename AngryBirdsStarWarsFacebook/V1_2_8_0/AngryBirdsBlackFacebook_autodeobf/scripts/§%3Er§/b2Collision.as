package §>r§
{
   ...
   public class b2Collision
   {
      ...
      private static var §;%§:Vector.<§,![§> = §3#1§();
      
      private static var s_clipPoints1:Vector.<§,![§> = §3#1§();
      
      private static var s_clipPoints2:Vector.<§,![§> = §3#1§();
      
      private static var § "S§:Vector.<int> = new Vector.<int>(1);
      
      private static var §4!X§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §'!p§(param1:Vector.<§,![§>, param2:Vector.<§,![§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§,![§ = null;
         var _loc6_:int = 0;
      ...
      public static function §7!1§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§,#&§;
         var _loc7_:Vector.<b2Vec2> = param1.§0I§;
         var _loc8_:Vector.<b2Vec2> = param1.§,!'§;
         var _loc9_:int = param4.§,#&§;
         var _loc10_:Vector.<b2Vec2> = param4.§0I§;
         _loc11_ = param2.R;
      ...
      public static function §+T§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §7!1§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §7!1§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §7!1§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §7!1§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §%"^§(param1:Vector.<§,![§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc10_:Vector.<b2Vec2> = param5.§0I§;
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§'!B§.§'!'§ = param4;
         _loc20_.id.§'!B§.§9!+§ = _loc22_;
         _loc20_.id.§'!B§.§`"R§ = 1;
      }
      
      private static function §3#1§() : Vector.<§,![§>
      {
      ...
      public static function §9#0§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§,![§ = null;
         ...
         var _loc8_:int = 0;
         § "S§[0] = _loc8_;
         var _loc9_:Number = §+T§(§ "S§,param2,param3,param4,param5);
         _loc8_ = § "S§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §4!X§[0] = _loc10_;
         var _loc11_:Number = §+T§(§4!X§,param4,param5,param2,param3);
         _loc10_ = §4!X§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§0I§)[_loc16_];
         ...
         if((_loc39_ = §'!p§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §'!p§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§!!M§.SetV(_loc27_);
      ...
      public static function §6"l§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§<"a§ = b2Manifold.§=g§;
         param1.m_localPoint.SetV(param2.§5!]§);
         param1.§!!M§.§6![§();
         param1.§="#§ = 1;
         param1.§+"5§[0].m_localPoint.SetV(param4.§5!]§);
      ...
      public static function §#+§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc22_:Vector.<b2Vec2> = param2.§0I§;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§="#§ = 1;
            param1.§<"a§ = b2Manifold.§ !e§;
            param1.§!!M§.x = _loc15_ - _loc27_.x;
            param1.§!!M§.y = _loc16_ - _loc27_.y;
            param1.§!!M§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§="#§ = 1;
            param1.§<"a§ = b2Manifold.§ !e§;
            param1.§!!M§.x = _loc15_ - _loc28_.x;
            param1.§!!M§.y = _loc16_ - _loc28_.y;
            param1.§!!M§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§+"5§[0].m_localPoint.SetV(param4.§5!]§);
            param1.§+"5§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§="#§ = 1;
            param1.§<"a§ = b2Manifold.§ !e§;
            param1.§!!M§.x = _loc23_[_loc25_].x;
            param1.§!!M§.y = _loc23_[_loc25_].y;
            param1.§!!M§.Normalize();
