package §>"!§
{
   ...
   public class §0"%§
   {
      ...
      public static function encode(param1:BitmapData) : ByteArray
      {
         ...
         _loc4_.compress();
         §7!b§(_loc2_,1229209940,_loc4_);
         §7!b§(_loc2_,1229278788,null);
         return _loc2_;
      }
      
      private static function §7!b§(param1:ByteArray, param2:uint, param3:ByteArray) : void
      {
         var _loc8_:uint = 0;
         var _loc9_:uint = 0;
         var _loc10_:uint = 0;
