package §;"E§
{
   ...
   public class §]T§
   {
      ...
      public static function §8"3§(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number) : §>"§
      {
         ...
         while(_loc17_ < 2)
         {
            _loc12_[_loc17_] = §-!Q§(_loc8_,_loc9_,_loc14_[_loc17_].x,_loc14_[_loc17_].y);
         ...
         var _loc19_:§>"§;
         (_loc19_ = new §>"§()).§4!4§ = Math.sqrt(_loc16_);
         _loc19_.§;!@§ = _loc18_;
         return _loc19_;
      }
      
      public static function §-!Q§(param1:Number, param2:Number, param3:Number, param4:Number) : Number
      {
