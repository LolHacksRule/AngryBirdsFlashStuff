         ...
         switch(param1.§<"a§)
         {
            case b2Manifold.§=g§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§8!g§.x = _loc19_ / _loc26_;
                  this.§8!g§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§8!g§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§8!g§.x;
               _loc23_ = _loc16_ + param3 * this.§8!g§.y;
               _loc24_ = _loc17_ - param5 * this.§8!g§.x;
               _loc25_ = _loc18_ - param5 * this.§8!g§.y;
            ...
            case b2Manifold.§ !e§:
               ...
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§+"5§[_loc6_].m_localPoint;
                  ...
                  this.§+"5§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§+"5§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§'!=§:
               ...
               while(_loc6_ < param1.§="#§)
               {
                  ...
                  this.§+"5§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§+"5§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
