package §0b§
{
   ...
   public class §^#§ extends §5"u§
   {
      ...
      public static const §0"H§:String = "transition_lop";
      ...
      protected function runAnimation(param1:int) : void
      {
         ...
         if(_loc3_)
         {
            if(_loc4_ = §>!8§.loop && !§,!T§)
            {
               if(_loc2_.name == "MovieClip_TutorialClip" && §>!8§.type == §6"§.§+"n§)
               {
                  _loc5_ = "loop_run";
                  _loc2_.gotoAndStop(_loc5_);
                  dispatchEvent(new Event(§0"H§));
               }
               else
               {
                  _loc6_ = §>!8§.defaultStartLabel != "" ? §>!8§.defaultStartLabel : "";
                  if((_loc7_ = §>!8§.startLabel != "" ? §>!8§.startLabel : _loc6_) != "")
                  {
