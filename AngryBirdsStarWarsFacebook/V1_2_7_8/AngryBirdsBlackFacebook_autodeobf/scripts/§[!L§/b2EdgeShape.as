package §[!L§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§^!D§ = this.§?!h§.Normalize();
         this.§+"Y§.Set(this.§?!h§.y,-this.§?!h§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§+"Y§.x - this.§?!h§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§+"Y§.y - this.§?!h§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§+"Y§.x + this.§?!h§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§+"Y§.y + this.§?!h§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§+"Y§;
         this.m_cornerDir2.Set(-this.§+"Y§.x,-this.§+"Y§.y);
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§3!3§ * _loc12_)
            {
      ...
      public function §9"5§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §1k§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
      ...
      b2internal function §2G§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§^#-§ = param1;
      ...
      b2internal function §0!N§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§&!7§ = param1;
