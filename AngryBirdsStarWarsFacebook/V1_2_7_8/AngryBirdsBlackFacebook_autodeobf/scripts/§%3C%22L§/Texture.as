package §<"L§
{
   ...
   public class Texture
   {
      ...
      public static function §-2§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §<"L§.Texture
      {
         return §7i§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §7i§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §<"L§.Texture
      {
         ...
         _loc10_ = new §<"m§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§=!S§.§`!d§)
         {
            _loc10_.§"!C§(param2);
         }
         ...
         return new §^m§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §==§(param1:Context3D, param2:ByteArray) : §<"L§.Texture
      {
         if(param1 == null)
         {
            throw new §@p§();
         ...
         var _loc9_:§<"m§ = new §<"m§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§=!S§.§`!d§)
         {
            _loc9_.§"!C§(param2);
         }
      ...
      public static function §2"2§(param1:§<"L§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §<"L§.Texture
      {
         var _loc4_:§<"L§.Texture;
         (_loc4_ = new §^m§(param1,param2)).§'!Y§ = param3;
         return _loc4_;
      }
      
      public static function §1"D§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §<"L§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§<"L§.Texture = §7i§(param1,_loc6_,false,param5);
         if(!§=!S§.§`!d§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§;P§, param2:int, param3:int) : void
      {
         ...
         if(this.§'!Y§)
         {
            ...
            _loc4_ = this.§'!Y§.width + this.§'!Y§.x - this.width;
            _loc5_ = this.§'!Y§.height + this.§'!Y§.y - this.height;
            param1.§[!#§(param2,-this.§'!Y§.x,-this.§'!Y§.y);
            param1.§[!#§(param2 + 1,-_loc4_,-this.§'!Y§.y);
            param1.§[!#§(param2 + 2,-this.§'!Y§.x,-_loc5_);
      ...
      {
         return !!this.§'!Y§ ? this.§'!Y§.clone() : new Rectangle(0,0,this.width,this.height);
      }
      ...
      public function get root() : §<"L§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §<"L§.Texture
      {
         return this;
      }
