package §9!s§
{
   public class b2Settings
   {
      ...
      public static const §@A§:int = 65535;
      ...
      public static const §#J§:Number = 0.005;
      
      public static const §8J§:Number = 0.007;
      
      public static const b2_linearSlop:Number = §8J§;
      
      public static const §=c§:Number = b2_linearSlop - §#J§;
      ...
      public static const §0"a§:Number = 0.1;
      
      public static var b2_linearSleepTolerance:Number = §<"B§;
