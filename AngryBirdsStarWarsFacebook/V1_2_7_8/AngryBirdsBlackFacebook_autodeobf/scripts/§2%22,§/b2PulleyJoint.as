package §2",§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §2""§:Number = 2;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§&"&§ = b2internal::0"n.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§!S§.x - this.§&"&§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§!S§.y - this.§&"&§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§6f§.x - this.§&"&§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§6f§.y - this.§&"&§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§2"g§);
         this.m_localAnchor2.SetV(param1.§#l§);
         this.§<"G§ = param1.§5"=§;
         this.§,#,§ = param1.§[<§ + this.§<"G§ * param1.§#!!§;
         this.m_maxLength1 = b2Math.§9!P§(param1.§1!W§,this.§,#,§ - this.§<"G§ * b2internal::2"");
         this.m_maxLength2 = b2Math.§9!P§(param1.§+!y§,(this.§,#,§ - b2internal::2"") / this.§<"G§);
         this.§^!t§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§^!t§ * this.m_u2.x,param1 * this.§^!t§ * this.m_u2.y);
      }
      ...
      {
         var _loc1_:b2Vec2 = b2internal::0"n.GetWorldPoint(this.m_localAnchor1);
      ...
      {
         var _loc1_:b2Vec2 = b2internal::@!u.GetWorldPoint(this.m_localAnchor2);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§,#,§ - _loc18_ - this.§<"G§ * _loc19_) > 0)
         {
            this.§"!l§ = b2internal::<!D;
            this.§^!t§ = 0;
         }
         ...
         this.m_limitMass1 = _loc2_.§@"P§ + _loc2_.§%#2§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§@"P§ + _loc3_.§%#2§ * _loc22_ * _loc22_;
         this.§`"B§ = this.m_limitMass1 + this.§<"G§ * this.§<"G§ * this.m_limitMass2;
         ...
         if(param1.§56§)
         {
            ...
            _loc23_ = (-this.§^!t§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§^!t§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§<"G§ * this.§^!t§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§<"G§ * this.§^!t§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§5!r§.x += _loc2_.§@"P§ * _loc23_;
            _loc2_.§5!r§.y += _loc2_.§@"P§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§%#2§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§5!r§.x += _loc3_.§@"P§ * _loc25_;
            _loc3_.§5!r§.y += _loc3_.§@"P§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = _loc4_.col1.y * _loc8_ + _loc4_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         if(this.§"!l§ == b2internal::6#-)
         {
            _loc10_ = _loc2_.§5!r§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§5!r§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§5!r§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§5!r§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§<"G§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§`"B§ * -_loc18_;
            _loc20_ = this.§^!t§;
            this.§^!t§ = b2Math.§]V§(0,this.§^!t§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§^!t§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§<"G§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§<"G§ * _loc19_ * this.m_u2.y;
            _loc2_.§5!r§.x += _loc2_.§@"P§ * _loc14_;
            _loc2_.§5!r§.y += _loc2_.§@"P§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§%#2§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§5!r§.x += _loc3_.§@"P§ * _loc16_;
            _loc3_.§5!r§.y += _loc3_.§@"P§ * _loc17_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§"!l§ == b2internal::6#-)
         {
            ...
            _loc19_ = this.§,#,§ - _loc17_ - this.§<"G§ * _loc18_;
            _loc24_ = b2Math.§]V§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§2"R§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
