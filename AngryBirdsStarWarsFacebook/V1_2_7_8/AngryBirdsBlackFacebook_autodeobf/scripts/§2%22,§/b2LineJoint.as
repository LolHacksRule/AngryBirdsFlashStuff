package §2",§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§^!t§.x * this.§!#7§.x + (this.§,"w§ + this.§^!t§.y) * this.§0!L§.x),param1 * (this.§^!t§.x * this.§!#7§.y + (this.§,"w§ + this.§^!t§.y) * this.§0!L§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§56§)
         {
            ...
            this.§^!t§.y *= param1.§<J§;
            this.§,"w§ *= param1.§<J§;
            _loc19_ = this.§^!t§.x * this.§!#7§.x + (this.§,"w§ + this.§^!t§.y) * this.§0!L§.x;
            _loc20_ = this.§^!t§.x * this.§!#7§.y + (this.§,"w§ + this.§^!t§.y) * this.§0!L§.y;
            _loc21_ = this.§^!t§.x * this.m_s1 + (this.§,"w§ + this.§^!t§.y) * this.m_a1;
            _loc22_ = this.§^!t§.x * this.m_s2 + (this.§,"w§ + this.§^!t§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§0!L§.x * (_loc6_.x - _loc4_.x) + this.§0!L§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§?!C§ * (this.§4"c§ - _loc13_);
            _loc15_ = this.§,"w§;
            _loc16_ = param1.§&"%§ * this.§9!W§;
            this.§,"w§ = b2Math.§2"R§(this.§,"w§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§,"w§ - _loc15_) * this.§0!L§.x;
            _loc9_ = _loc14_ * this.§0!L§.y;
         ...
         {
            _loc17_ = this.§0!L§.x * (_loc6_.x - _loc4_.x) + this.§0!L§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§^!t§.Copy();
            _loc19_ = this.§!!+§.§]"K§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§^!t§.§%#3§(_loc19_);
            if(this.§'"6§ == b2internal::6+)
            {
               this.§^!t§.y = b2Math.§]V§(this.§^!t§.y,0);
            }
            else if(this.§'"6§ == b2internal::6#-)
            {
               this.§^!t§.y = b2Math.§9!P§(this.§^!t§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§^!t§.y - _loc18_.y) * this.§!!+§.col2.x;
            if(this.§!!+§.col1.x != 0)
            {
            ...
            this.§^!t§.x = _loc21_;
            _loc19_.x = this.§^!t§.x - _loc18_.x;
            _loc19_.y = this.§^!t§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§!#7§.x + _loc19_.y * this.§0!L§.x;
            _loc9_ = _loc19_.x * this.§!#7§.y + _loc19_.y * this.§0!L§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§@!O§)
         {
            ...
            _loc34_ = this.§0!L§.x * _loc26_ + this.§0!L§.y * _loc27_;
            if(b2Math.§=G§(this.§9![§ - this.§-a§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§2"R§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§=G§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§-a§)
            {
               _loc19_ = b2Math.§2"R§(_loc34_ - this.§-a§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§-a§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§9![§)
            {
               _loc19_ = b2Math.§2"R§(_loc34_ - this.§9![§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§!!+§.§]"K§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::]q;
         ...
         var _loc30_:Number = _loc28_.x * this.§!#7§.x + _loc28_.y * this.§0!L§.x;
         var _loc31_:Number = _loc28_.x * this.§!#7§.y + _loc28_.y * this.§0!L§.y;
         ...
         _loc8_.x += b2internal::>"u * _loc30_;
         _loc8_.y += b2internal::>"u * _loc31_;
