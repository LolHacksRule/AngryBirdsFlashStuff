package §_-Kt§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §_-iq§:b2Mat22 = new b2Mat22();
      ...
      public static function §_-iW§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§_-Jv§(new b2Vec2(0,0));
            _loc3_.§_-Jv§(_loc9_);
            _loc3_.§_-Jv§(_loc10_);
            _loc3_.§_-6z§(_loc16_ * _loc7_);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §_-sW§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§_-fb§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§_-fb§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §_-3b§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§_-Wz§)
         {
            this.§_-Ui§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§_-Wz§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§_-Wz§ ? int(_loc3_ + 1) : 0;
      ...
      public function §_-tr§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§_-5h§.x = 0.5 * (param1.x + param2.x);
         this.§_-5h§.y = 0.5 * (param1.y + param2.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§_-Wz§)
         {
            _loc6_ = (_loc9_ = this.§_-Ui§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§_-3s§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§_-N-§.x = _loc5_ - b2internal::_-Q2;
         param1.§_-N-§.y = _loc6_ - b2internal::_-Q2;
         param1.§_-TE§.x = _loc7_ + b2internal::_-Q2;
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§_-Wz§ == 2)
         {
            param1.center.x = 0.5 * (this.§_-Ui§[0].x + this.§_-Ui§[1].x);
            param1.center.y = 0.5 * (this.§_-Ui§[0].y + this.§_-Ui§[1].y);
            param1.§_-zT§ = 0;
            param1.§_-Lx§ = 0;
            return;
         }
         ...
         param1.§_-zT§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§_-Lx§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§_-Ly§(param1,param3.position);
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§_-Wz§;
         var _loc14_:int = (_loc10_ + 1) % this.§_-Wz§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§_-Ui§[_loc9_].x * (1 - _loc15_) + this.§_-Ui§[_loc13_].x * _loc15_,this.§_-Ui§[_loc9_].y * (1 - _loc15_) + this.§_-Ui§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§_-Ui§[_loc10_].x * (1 - _loc16_) + this.§_-Ui§[_loc14_].x * _loc16_,this.§_-Ui§[_loc10_].y * (1 - _loc16_) + this.§_-Ui§[_loc14_].y * _loc16_);
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§_-Wz§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
