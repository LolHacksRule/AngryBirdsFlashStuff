package §_-Kt§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc4_:Number = param1.position.x + (_loc3_.col1.x * this.§_-Ga§.x + _loc3_.col2.x * this.§_-Ga§.y);
         var _loc5_:Number = param1.position.y + (_loc3_.col1.y * this.§_-Ga§.x + _loc3_.col2.y * this.§_-Ga§.y);
         _loc4_ = param2.x - _loc4_;
         _loc5_ = param2.y - _loc5_;
         return _loc4_ * _loc4_ + _loc5_ * _loc5_ <= b2internal::_-Q2 * b2internal::_-Q2;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc5_:Number = param3.position.x + (_loc4_.col1.x * this.§_-Ga§.x + _loc4_.col2.x * this.§_-Ga§.y);
         var _loc6_:Number = param3.position.y + (_loc4_.col1.y * this.§_-Ga§.x + _loc4_.col2.y * this.§_-Ga§.y);
         var _loc7_:Number = param2.p1.x - _loc5_;
         _loc8_ = param2.p1.y - _loc6_;
         var _loc9_:Number = _loc7_ * _loc7_ + _loc8_ * _loc8_ - b2internal::_-Q2 * b2internal::_-Q2;
         ...
         if(0 <= _loc15_ && _loc15_ <= param2.§_-fa§ * _loc13_)
         {
            _loc15_ /= _loc13_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         var _loc4_:Number = param2.position.x + (_loc3_.col1.x * this.§_-Ga§.x + _loc3_.col2.x * this.§_-Ga§.y);
         var _loc5_:Number = param2.position.y + (_loc3_.col1.y * this.§_-Ga§.x + _loc3_.col2.y * this.§_-Ga§.y);
         param1.§_-N-§.Set(_loc4_ - b2internal::_-Q2,_loc5_ - b2internal::_-Q2);
         param1.§_-TE§.Set(_loc4_ + b2internal::_-Q2,_loc5_ + b2internal::_-Q2);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§_-zT§ = param2 * b2Settings.b2_pi * b2internal::_-Q2 * b2internal::_-Q2;
         param1.center.SetV(this.§_-Ga§);
         param1.§_-Lx§ = param1.§_-zT§ * (0.5 * b2internal::_-Q2 * b2internal::_-Q2 + (this.§_-Ga§.x * this.§_-Ga§.x + this.§_-Ga§.y * this.§_-Ga§.y));
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.§_-Ly§(param1,_loc5_) - param2)) < -b2internal::_-Q2 + Number.MIN_VALUE)
         {
            return 0;
         }
         if(_loc6_ > b2internal::_-Q2)
         {
            param4.SetV(_loc5_);
            return Math.PI * b2internal::_-Q2 * b2internal::_-Q2;
         }
         var _loc7_:Number = b2internal::_-Q2 * b2internal::_-Q2;
         var _loc8_:Number = _loc6_ * _loc6_;
         _loc9_ = _loc7_ * (Math.asin(_loc6_ / b2internal::_-Q2) + Math.PI / 2) + _loc6_ * Math.sqrt(_loc7_ - _loc8_);
