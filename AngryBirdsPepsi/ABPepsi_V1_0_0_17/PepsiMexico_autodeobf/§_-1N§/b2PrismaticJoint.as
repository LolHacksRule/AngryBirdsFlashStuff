package §_-1N§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§_-tN§.x * this.§_-k1§.x + (this.§_-3k§ + this.§_-tN§.z) * this.§_-YX§.x),param1 * (this.§_-tN§.x * this.§_-k1§.y + (this.§_-3k§ + this.§_-tN§.z) * this.§_-YX§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§_-5w§ > Number.MIN_VALUE)
         {
            this.§_-5w§ = 1 / this.§_-5w§;
         }
         ...
         this.§_-Zj§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§_-Zj§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§_-Zj§.col2.x = this.§_-Zj§.col1.y;
         this.§_-Zj§.col2.y = _loc16_ + _loc17_;
         this.§_-Zj§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§_-Zj§.col3.x = this.§_-Zj§.col1.z;
         this.§_-Zj§.col3.y = this.§_-Zj§.col2.z;
         this.§_-Zj§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§_-b9§)
         {
         ...
         if(param1.§_-o-§)
         {
            ...
            _loc19_ = this.§_-tN§.x * this.§_-k1§.x + (this.§_-3k§ + this.§_-tN§.z) * this.§_-YX§.x;
            _loc20_ = this.§_-tN§.x * this.§_-k1§.y + (this.§_-3k§ + this.§_-tN§.z) * this.§_-YX§.y;
            _loc21_ = this.§_-tN§.x * this.m_s1 + this.§_-tN§.y + (this.§_-3k§ + this.§_-tN§.z) * this.m_a1;
            _loc22_ = this.§_-tN§.x * this.m_s2 + this.§_-tN§.y + (this.§_-3k§ + this.§_-tN§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§_-YX§.x * (_loc6_.x - _loc4_.x) + this.§_-YX§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§_-5w§ * (this.§_-bm§ - _loc14_);
            _loc16_ = this.§_-3k§;
            _loc17_ = param1.§_-h8§ * this.§_-oY§;
            this.§_-3k§ = b2Math.§_-Gj§(this.§_-3k§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§_-3k§ - _loc16_) * this.§_-YX§.x;
            _loc9_ = _loc15_ * this.§_-YX§.y;
         ...
         {
            _loc18_ = this.§_-YX§.x * (_loc6_.x - _loc4_.x) + this.§_-YX§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§_-tN§.Copy();
            _loc20_ = this.§_-Zj§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§_-tN§.§_-Jv§(_loc20_);
            if(this.§_-0L§ == b2internal::_-oP)
            {
               this.§_-tN§.z = b2Math.§_-YD§(this.§_-tN§.z,0);
            }
            else if(this.§_-0L§ == b2internal::_-Hv)
            {
               this.§_-tN§.z = b2Math.§_-cD§(this.§_-tN§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§_-tN§.z - _loc19_.z) * this.§_-Zj§.col3.x;
            _loc22_ = -_loc13_ - (this.§_-tN§.z - _loc19_.z) * this.§_-Zj§.col3.y;
            _loc23_ = this.§_-Zj§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§_-tN§.x = _loc23_.x;
            this.§_-tN§.y = _loc23_.y;
            _loc20_.x = this.§_-tN§.x - _loc19_.x;
            _loc20_.y = this.§_-tN§.y - _loc19_.y;
            _loc20_.z = this.§_-tN§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§_-k1§.x + _loc20_.z * this.§_-YX§.x;
            _loc9_ = _loc20_.x * this.§_-k1§.y + _loc20_.z * this.§_-YX§.y;
         ...
         {
            _loc24_ = this.§_-Zj§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§_-tN§.x += _loc24_.x;
            this.§_-tN§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§_-k1§.x;
            _loc9_ = _loc24_.x * this.§_-k1§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§_-b9§)
         {
            ...
            _loc35_ = this.§_-YX§.x * _loc26_ + this.§_-YX§.y * _loc27_;
            if(b2Math.§_-xY§(this.§_-AB§ - this.§_-OF§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§_-Gj§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§_-xY§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§_-OF§)
            {
               _loc19_ = b2Math.§_-Gj§(_loc35_ - this.§_-OF§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§_-OF§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§_-AB§)
            {
               _loc19_ = b2Math.§_-Gj§(_loc35_ - this.§_-AB§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§_-AB§;
               _loc18_ = true;
            }
         }
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§_-D3§;
         _loc16_ = b2Math.§_-YD§(_loc16_,b2Math.§_-xY§(_loc29_));
         _loc17_ = b2Math.§_-xY§(_loc30_);
         if(_loc18_)
         {
            ...
            this.§_-Zj§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§_-Zj§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§_-Zj§.col2.x = this.§_-Zj§.col1.y;
            this.§_-Zj§.col2.y = _loc14_ + _loc15_;
            this.§_-Zj§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§_-Zj§.col3.x = this.§_-Zj§.col1.z;
            this.§_-Zj§.col3.y = this.§_-Zj§.col2.z;
            this.§_-Zj§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§_-Zj§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::_-k9;
            ...
            this.§_-Zj§.col1.Set(_loc36_,_loc37_,0);
            this.§_-Zj§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§_-Zj§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§_-k1§.x + _loc28_.z * this.§_-YX§.x;
         var _loc32_:Number = _loc28_.x * this.§_-k1§.y + _loc28_.z * this.§_-YX§.y;
         ...
         _loc6_.x -= b2internal::_-k9 * _loc31_;
         _loc6_.y -= b2internal::_-k9 * _loc32_;
         _loc7_ -= b2internal::_-kg * _loc33_;
         _loc8_.x += b2internal::_-s8 * _loc31_;
         _loc8_.y += b2internal::_-s8 * _loc32_;
         _loc9_ += b2internal::_-GH * _loc34_;
