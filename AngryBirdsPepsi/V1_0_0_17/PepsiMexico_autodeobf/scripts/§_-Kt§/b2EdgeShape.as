package §_-Kt§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§_-3t§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§_-GG§ = this.§_-3t§.Normalize();
         this.§_-u5§.Set(this.§_-3t§.y,-this.§_-3t§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§_-u5§.x - this.§_-3t§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§_-u5§.y - this.§_-3t§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§_-u5§.x + this.§_-3t§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§_-u5§.y + this.§_-3t§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§_-u5§;
         this.m_cornerDir2.Set(-this.§_-u5§.x,-this.§_-u5§.y);
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§_-fa§ * _loc12_)
            {
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         {
            param1.§_-N-§.x = _loc4_;
            param1.§_-TE§.x = _loc6_;
         }
         else
         {
            param1.§_-N-§.x = _loc6_;
            param1.§_-TE§.x = _loc4_;
         }
         if(_loc5_ < _loc7_)
         {
            param1.§_-N-§.y = _loc5_;
            param1.§_-TE§.y = _loc7_;
         }
         else
         {
            param1.§_-N-§.y = _loc7_;
            param1.§_-TE§.y = _loc5_;
         }
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc8_:Number = b2Math.§_-Ly§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§_-Ly§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
