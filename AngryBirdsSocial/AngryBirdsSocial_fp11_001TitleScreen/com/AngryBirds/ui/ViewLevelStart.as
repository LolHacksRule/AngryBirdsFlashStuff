      ...
      override public function listenerEventOccured(param1:int, param2:String, param3:UIEventListenerRovio) : void
      {
         ...
         switch(param2)
         {
            ...
            case "STOP_SUN_ANIMATION":
               ...
               break;
            case "VIEW_CREATOR_PAGE":
               AngryBirdsExternalInterface.openProfileForUser(AngryBirdsSocial.smLevelMain.mLevelData.levelCreator);
               break;
            case "VIEW_LEVEL_PAGE":
               AngryBirdsExternalInterface.setCurrentLevel(AngryBirdsSocial.smLevelMain.mLevelData.levelID);
         }
      }
   }
}
