package com.AngryBirds.states
{
   ...
   public class StateLevelEditor extends StateBase
   {
      ...
      public var mLevelSaveInProgress:Boolean = false;
      ...
      override public function uiInteractionHandler(param1:int, param2:String, param3:UIEventListenerRovio) : void
      {
         ...
         switch(param2)
         {
            ...
            case "PUBLISH":
               ...
               {
                  this.goToCastleView();
                  AngryBirdsSocial.smLevelMain.mLevelCamera.updateCamera(99999);
            ...
            case "POPUP_PUBLISH_LEVEL_PUBLISH":
               ...
               if(this.mLevelSaveInProgress)
               {
                  break;
               }
               if(AngryBirdsSocial.USER.name)
               {
                  if((_loc7_ = AngryBirdsSocial.smLevelMain.mLevelEditor.validateLevelName(AngryBirdsSocial.smLevelMain.mLevelEditor.mLevelName)) == "OK")
                  {
                     (this.mUIView.getItemByName("Popup_Editor_PublishLevel") as UIPopUpRovio).close();
                     AngryBirdsSocial.smLevelMain.mLevelEditor.uploadLevel(false);
                     (this.mUIView.getItemByName("Popup_Editor_Saving_Level") as UIPopUpRovio).open();
                     this.mLevelSaveInProgress = true;
                  }
               }
               else
               {
            ...
            case "POPUP_LEVELEXTEND_CONFIRM":
               ...
               AngryBirdsSocial.smLevelMain.addFloatingText("Level Expanded!",AngryBirdsSocial.smLevelMain.mLevelCamera.mXcenterB2,AngryBirdsSocial.smLevelMain.mLevelCamera.mYcenterB2,3000,LevelParticle.PARTICLE_MATERIAL_TEXT_WHITE,0,-1);
         }
         ...
         {
            StatisticsManager.markEvent(StatisticsList.USER_FUNNEL_LEVEL_EDITOR,param2,this.mEditorSessionId + "," + (getTimer() - this.mEditorSessionStartTime),false);
         }
      }
      ...
      public function handleLevelResponse(param1:Boolean) : void
      {
         this.mLevelSaveInProgress = false;
         (this.mUIView.getItemByName("Popup_Editor_Saving_Level") as UIPopUpRovio).close();
