      ...
      public function dailySprintDataResponse(param1:Object) : void
      {
         ...
         if(param1.scores != null)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               {
                  mUIView.getItemByName("Container_DailySprint_Player").mClip.addChild(AngryBirdsSocial.USER_INFO.getImage());
                  mUIView.getItemByName("Container_DailySprint_Player_Leading").mClip.addChild(AngryBirdsSocial.USER_INFO.getImage());
               }
            ...
            if(_loc6_ != null)
            {
               ...
               {
                  mUIView.getItemByName("Container_DailySprint_Friend").mClip.addChild(AngryBirdsSocial.getUserInfo(_loc6_.username).getImage());
               }
      ...
      public function weeklyRaceDataResponse(param1:Object) : void
      {
         ...
         if(param1.scores != null)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               if(AngryBirdsSocial.USER_INFO)
               {
                  mUIView.getItemByName("Container_WeeklyRace_Player").mClip.addChild(AngryBirdsSocial.USER_INFO.getImage());
                  mUIView.getItemByName("Container_WeeklyRace_Player_Leading").mClip.addChild(AngryBirdsSocial.USER_INFO.getImage());
               }
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  mUIView.getItemByName("Container_WeeklyRace_Friend").mClip.addChild(AngryBirdsSocial.getUserInfo(_loc7_.username).getImage());
               }
