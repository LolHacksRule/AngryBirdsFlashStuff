package com.rovio.ui.Components.Helpers
{
   ...
   public class UIComponentInteractiveRovio extends UIComponentRovio
   {
      ...
      public function goToCorrectFrame() : void
      {
         ...
         var _loc1_:Array = new Array(this.mComponentState + "_" + this.mVisualState,this.mComponentState + "_" + VISUAL_STATE_MOUSE_UP_DEFULT,COMPONENT_STATE_ACTIVE_DEFAULT + "_" + this.mVisualState,COMPONENT_STATE_ACTIVE_DEFAULT + "_" + VISUAL_STATE_MOUSE_UP_DEFULT);
         var _loc2_:int = 0;
      ...
      override public function changeMovieClip(param1:MovieClip) : void
      {
         ...
         mClip.y = _loc3_;
         this.goToCorrectFrame();
         var _loc5_:Number = mParentContainer.mClip.getChildIndex(mClip);
         AngryBirdsSocial.printObjectTree(mParentContainer.mClip);
      }
