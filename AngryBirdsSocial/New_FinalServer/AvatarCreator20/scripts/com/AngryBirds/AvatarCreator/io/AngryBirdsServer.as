package com.AngryBirds.AvatarCreator.io
{
   ...
   public class AngryBirdsServer
   {
      ...
      public static const COMMAND_PURCHASE_ITEM_LIST:String = "purchaseItemList";
      
      public static const COMMAND_PURCHASE_ITEM:String = "purchaseItem";
      ...
      public static function initCommands() : void
      {
         ...
         Server.addCommand(COMMAND_GET_META_GAME_DATA);
         Server.addCommand(COMMAND_PURCHASE_ITEM);
         Server.addCommand(COMMAND_PURCHASE_ITEM_LIST);
      }
      ...
      public static function getOwnedItemList(param1:Function) : void
      {
         var _loc2_:String = null;
         Log.log("Get owned item list...");
         if(AvatarCreator.USER.loggedIn)
         {
            _loc2_ = AvatarCreator.USER.authenticationToken;
            new AngryBirdsServer(COMMAND_GET_ITEM_LIST,{
               "token":_loc2_,
               "type":"ownedAvatarItemList"
            },param1);
         }
      }
      ...
      {
         var _loc2_:String = null;
         Log.log("Get meta game data...");
         if(AvatarCreator.USER.loggedIn)
         {
            _loc2_ = AvatarCreator.USER.authenticationToken;
            new AngryBirdsServer(COMMAND_GET_META_GAME_DATA,{"token":_loc2_},param1);
         }
      }
      
      public static function purchaseItemList(param1:String, param2:Function) : void
      {
         var _loc3_:String = null;
         if(AvatarCreator.USER.loggedIn)
         {
            _loc3_ = AvatarCreator.USER.authenticationToken;
            new AngryBirdsServer(COMMAND_PURCHASE_ITEM_LIST,{
               "token":_loc3_,
               "list":param1,
               "type":"ownedAvatarItemList"
            },param2);
