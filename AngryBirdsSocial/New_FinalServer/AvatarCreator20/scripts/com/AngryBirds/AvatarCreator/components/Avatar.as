package com.AngryBirds.AvatarCreator.components
{
   ...
   public class Avatar extends Sprite
   {
      ...
      public function getUnpaidItems() : Array
      {
         var _loc2_:Item = null;
         var _loc1_:Array = new Array();
         for each(_loc2_ in this.mItemsEquipped)
         {
            if(AvatarCreator.smPaidItems.indexOf(_loc2_.mId) == -1 && _loc2_.mCost > 0)
            {
               _loc1_.push(_loc2_.mId);
            }
         }
         return _loc1_;
      }
      ...
      public function getAvatarData() : String
      {
         ...
         _loc1_ += _loc2_;
         _loc1_ += "]}";
         _loc4_ = com.rovio.adobe.serialization.json.JSON.decode(_loc1_);
         return _loc1_;
      }
