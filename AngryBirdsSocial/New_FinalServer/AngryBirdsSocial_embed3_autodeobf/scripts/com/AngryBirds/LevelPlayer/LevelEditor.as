package com.AngryBirds.LevelPlayer
{
   ...
   public class LevelEditor extends Sprite
   {
      ...
      public function keyUp(e:KeyboardEvent) : void
      {
         ...
         else if(e.keyCode == 67 && this.mSelectedTool == SELECTED_TOOL_SELECT && this.mSelectedObjects.length > 0)
         {
            Log.log("COPY ACTION");
      ...
      {
         var THUMBNAIL_WIDTH:Number = AngryBirdsSocial.SCREEN_WIDTH * 0.25;
         var THUMBNAIL_HEIGHT:Number = AngryBirdsSocial.SCREEN_HEIGHT * 0.25;
