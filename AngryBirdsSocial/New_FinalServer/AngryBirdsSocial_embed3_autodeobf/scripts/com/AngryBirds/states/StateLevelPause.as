package com.AngryBirds.states
{
   ...
   public class StateLevelPause extends StateBase
   {
      ...
      public function StateLevelPause(initState:Boolean = false, name:String = "LevelPauseState")
      {
      ...
      override public function activate() : void
      {
         ...
         mUIView.getItemByName("Button_LevelOfTheDay_Competition").setVisibility(AngryBirdsSocial.smLevelMain.isLevelOfDay() && !AngryBirdsSocial.RUN_AS_EMBED_PLAYER);
