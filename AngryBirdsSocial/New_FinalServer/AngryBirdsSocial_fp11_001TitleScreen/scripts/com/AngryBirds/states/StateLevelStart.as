package com.AngryBirds.states
{
   ...
   public class StateLevelStart extends StateBase
   {
      ...
      override public function activate() : void
      {
         ...
         var _loc2_:String = AngryBirdsSocial.smLevelMain.mLevelData.levelCreator;
         mUIView.setText("by: " + _loc2_,"TextField_LevelCreator");
         if(AngryBirdsSocial.smLevelMain.mLevelData.levelName != null)
         {
            mUIView.setText(AngryBirdsSocial.smLevelMain.mLevelData.levelName,"TextField_LevelName");
         }
         mUIView.setText(AngryBirdsSocial.smLevelMain.mLevelData.timesLiked + " likes","TextField_LevelLikes");
         this.setCreatorImage(AngryBirdsSocial.getUserInfo(_loc2_).getImage());
      }
      ...
      public function setCreatorImage(param1:DisplayObject) : void
      {
         if(mUIView.getItemByName("Container_CreatorImage").mClip.numChildren > 0)
         {
            while(mUIView.getItemByName("Container_CreatorImage").mClip.numChildren > 0)
            {
               mUIView.getItemByName("Container_CreatorImage").mClip.removeChildAt(0);
            }
         }
         mUIView.getItemByName("Container_CreatorImage").mClip.addChild(param1);
      }
   }
}
