package com.AngryBirds.LevelPlayer
{
   ...
   public class LevelBackground extends Sprite
   {
      ...
      public function LevelBackground(param1:LevelMain, param2:String, param3:Number)
      {
         ...
         if(this.mLevelBackgroundInformation == null && StateLevelLoad.smRunLevelHack)
         {
            param2 = "ThemeHills";
            this.mLevelBackgroundInformation = LevelThemeBackgrounds.getBackground(param2);
         }
         ...
         {
            this.mLayerClips[_loc5_] = new LevelBackgroundLayer(_loc4_,this.mLevelBackgroundInformation.mLayers[_loc5_]);
      ...
      public function resetLevelBackground(param1:String) : void
      {
         ...
         {
            this.mLayerClips[_loc2_] = new LevelBackgroundLayer(_loc3_,this.mLevelBackgroundInformation.mLayers[_loc2_]);
      ...
      {
         if(SHOW_BACKGROUNDS && this.mBackground.parent == this.mLevelMain)
         {
            this.mLevelMain.removeChild(this.mBackground);
         }
         if(this.mSkyAndGround.parent == this.mLevelMain)
         {
            this.mLevelMain.removeChild(this.mSkyAndGround);
         }
         if(SHOW_BACKGROUNDS && this.mForeground.parent == this.mLevelMain)
         {
