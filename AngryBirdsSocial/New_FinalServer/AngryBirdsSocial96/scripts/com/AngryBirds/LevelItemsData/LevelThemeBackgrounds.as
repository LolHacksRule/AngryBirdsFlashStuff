package com.AngryBirds.LevelItemsData
{
   public class LevelThemeBackgrounds
   {
      ...
      public static function loadBackgrounds(param1:XMLList) : void
      {
         ...
         {
            newBackground(_loc2_.@id,_loc2_.Layers,_loc2_.@sky,_loc2_.@ground,_loc2_.@sound,_loc2_.@texture,_loc2_.@textureStrokeColor,_loc2_.@icon);
         }
      }
      
      public static function newBackground(param1:String, param2:XMLList, param3:Number, param4:Number, param5:String, param6:String, param7:Number, param8:String) : void
      {
         mBackgrounds[mBackgrounds.length] = new LevelThemeBackground(param1,param2,param3,param4,param5,param6,param7,param8);
      }
