package com.AngryBirds.states
{
   ...
   public class StateLevelOverVictory extends StateBase
   {
      ...
      override public function activate() : void
      {
         ...
         if(!contains(AngryBirdsSocial.getFriendsBar()))
         {
            addChild(AngryBirdsSocial.getFriendsBar());
         }
      ...
      override public function deActivate() : void
      {
         if(contains(AngryBirdsSocial.getFriendsBar()))
         {
            removeChild(AngryBirdsSocial.getFriendsBar());
         }
      ...
      public function moreLevelsReceived(param1:Object) : void
      {
         ...
         while(true)
         {
            ...
            if(_loc6_.screenShot != null && _loc6_.screenShot.toString().length > 0)
            {
