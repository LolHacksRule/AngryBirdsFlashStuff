package
{
   ...
   public class AngryBirdsSocial extends BasicGame
   {
      ...
      public static var SCREEN_HEIGHT:int = 425;
      ...
      private static var smFriendsBar:UIContainerRovio = null;
      ...
      public static function getFriendsBar() : UIContainerRovio
      {
         if(smFriendsBar == null)
         {
            smFriendsBar = new UIContainerRovio(ViewXMLLibrary.mLibrary.Components.Component_FriendsBar[0],null,null);
            smFriendsBar.setActiveStatus(true);
         }
         return smFriendsBar;
      }
