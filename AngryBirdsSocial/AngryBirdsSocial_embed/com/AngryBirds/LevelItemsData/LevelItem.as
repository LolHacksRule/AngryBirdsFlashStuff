package com.AngryBirds.LevelItemsData
{
   public class LevelItem
   {
      ...
      public function LevelItem(param1:String, param2:int, param3:LevelItemMaterial, param4:LevelItemResourcePathSound, param5:LevelItemShape, param6:Number, param7:String, param8:Number, param9:Number)
      {
         super();
