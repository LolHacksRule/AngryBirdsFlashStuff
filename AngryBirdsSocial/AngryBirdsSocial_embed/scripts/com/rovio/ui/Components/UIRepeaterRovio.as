   ...
   public class UIRepeaterRovio extends UIContainerRovio
   {
      ...
      public function UIRepeaterRovio(param1:XML, param2:UIContainerRovio, param3:UIView)
      {
         ...
         if((_loc4_ = param1.@GlowFilter) && _loc4_.length > 0)
         {
            ...
            this.mGlowFilter = new GlowFilter(_loc15_,1,3,3,10);
         }
         var _loc5_:XML;
         ...
         {
            _loc16_ = mClip.getChildByName("Button_Area3").x - this.mSurfaceX;
            _loc17_ = mClip.getChildByName("Button_Area3").y - this.mSurfaceY;
            this.mButtonMarginX2 = _loc16_ - this.mFirstButtonX;
            this.mButtonMarginY2 = _loc17_ - this.mFirstButtonY;
