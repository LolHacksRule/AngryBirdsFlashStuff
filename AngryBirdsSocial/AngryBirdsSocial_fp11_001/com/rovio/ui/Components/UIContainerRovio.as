   ...
   public class UIContainerRovio extends UIComponentRovio
   {
      ...
      public function UIContainerRovio(param1:XML, param2:UIContainerRovio, param3:UIView, param4:MovieClip = null)
      {
         ...
         if(param3)
         {
            ...
            mClip = new _loc11_();
            this.mParentView.mMovieClip.addChild(mClip);
         }
      ...
      {
         this.mItems[this.mItems.length] = param1;
         param1.setActiveStatus(this.mActive);
         param1.setVisibility(this.mVisibility);
      }
      ...
      override public function clear() : void
      {
         ...
         if(this.mParentView)
         {
            this.mParentView.mMovieClip.removeChild(mClip);
         }
         super.clear();
      }
