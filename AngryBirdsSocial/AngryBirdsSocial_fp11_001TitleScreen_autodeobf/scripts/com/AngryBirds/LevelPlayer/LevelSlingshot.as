package com.AngryBirds.LevelPlayer
{
   ...
   public class LevelSlingshot extends Sprite
   {
      ...
      public static const BIRD_LAUNCH_FORCE:Number = 47.5;
            ...
            if(!this.mLevelMain.mEditorMode)
            {
               ...
               else if(this.mSlingShotState != STATE_AWARDING_REMAINING_BIRD_SCORES)
               {
                  ...
                  else if(this.mSlingShotState == STATE_BIRD_IS_READY)
                  {
                     ...
                     {
                        this.mLevelMain.mActiveObject = this.mLevelMain.mLevelObjects.addObject(_loc2_.mName,_loc2_.mX,_loc2_.mY);
                        this.mLevelMain.addTrailingObject(this.mLevelMain.mActiveObject);
                        this.mLevelMain.mTrailFrameCounter = 0;
                        ...
                        _loc3_ = _loc2_.mName.toUpperCase() == "BIRD_GREEN" ? Number(BIRD_LAUNCH_FORCE_GREEN) : Number(BIRD_LAUNCH_FORCE);
                        ...
                        this.mLevelMain.mLevelCamera.setAction(LevelCamera.ACTION_FOLLOW_BIRD);
                        ++this.mNextBirdIndex;
                        this.mShootTheBird = false;
                        ...
                        {
                           StatisticsManager.markEvent(StatisticsList.BIRD_SHOT,_loc2_.mName);
                        }
                     }
                  }
               }
      ...
      public function getBirdsSideInXMLForJSON() : String
      {
         var _loc5_:LevelSlingshotObject = null;
         var _loc1_:Number = this.mX;
         var _loc2_:Number = this.mY;
         ...
         while(_loc4_ < this.mBirds.length)
         {
            if(_loc5_ = this.mBirds[_loc4_] as LevelSlingshotObject)
            {
               ...
               _loc1_ = LevelEditor.roundUpCoordinate(_loc1_,true);
               _loc2_ = LevelEditor.roundUpCoordinate(_loc2_,true);
               _loc3_ += "<Bird id=\"" + _loc5_.mName + "\" x = \"" + _loc1_ + "\" y = \"" + _loc2_ + "\" angle=\"0\" />" + AngryBirdsSocial.LINE_BREAK_XML;
            }
            _loc4_++;
         }
         return _loc3_;
      ...
      public function getBirdsSideInJSON() : String
      {
         ...
         _loc2_ = LevelEditor.roundUpCoordinate(_loc2_,true);
         var _loc3_:String = "";
         _loc3_ += "\"slingshot\":{" + "\"x\":\"" + _loc1_ + "\"," + "\"y\":\"" + _loc2_ + "\"" + "},";
         var _loc4_:Number = 0;
         var _loc5_:int = 0;
         while(_loc5_ < this.mBirds.length)
         {
            if(_loc6_ = this.mBirds[_loc5_] as LevelSlingshotObject)
            {
               _loc4_++;
               _loc1_ = _loc6_.mX;
               _loc2_ = _loc6_.mY;
               _loc1_ = LevelEditor.roundUpCoordinate(_loc1_,true);
               _loc2_ = LevelEditor.roundUpCoordinate(_loc2_,true);
               _loc3_ += "\"bird_" + _loc4_ + "\": { \"id\":\"" + _loc6_.mName + "\"," + " \"x\":\"" + _loc1_ + "\"," + " \"y\":\"" + _loc2_ + "\"," + " \"angle\":0 }";
      ...
      public function getBirdsCount() : Number
      {
