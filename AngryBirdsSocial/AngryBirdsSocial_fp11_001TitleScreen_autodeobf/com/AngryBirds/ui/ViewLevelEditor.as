package com.AngryBirds.ui
{
   ...
   public class ViewLevelEditor extends UIView
   {
      ...
      public static const INVENTORY_CATAGORIES:Array = new Array("Wood","Stone","Ice","Snow","Pigs","Birds","Food","Misc","Textures");
      ...
      public function getRepeaterTabDataXML() : Array
      {
         ...
         _loc2_ = new Array("Tab_Textures","Tab_Pigs","Tab_Wood","Tab_Ice","Tab_Stone","Tab_Snow","Tab_Food","Tab_Misc");
         _loc3_ = new Array("Thumbnail_Texture","Thumbnail_Pig","Thumbnail_Wood","Thumbnail_Ice","Thumbnail_Stone","Thumbnail_Snow","Thumbnail_Food","Thumbnail_Misc");
         _loc4_ = 0;
         while(_loc4_ < _loc2_.length)
         {
            (_loc5_ = <Button/>).@name = _loc2_[_loc4_] as String;
      ...
      public function getRepeaterItemsDataXML() : Array
      {
         ...
         while(_loc2_ < INVENTORY_CATAGORIES.length)
         {
            ...
            while(_loc8_ < _loc7_.length)
            {
               ...
               _loc10_ = new (_loc9_ = AssetCache.getAssetFromCache("Repeater_Button_Editor_Items"))() as MovieClip;
               ...
               _loc10_.ImageContainer_Item.addChild(_loc4_);
               _loc10_.ImageContainer_Item.ImageContainer_Item_Guide.visible = false;
               _loc4_.y -= _loc4_.height / 2;
               _loc10_.TextField_Cost.text = _loc6_.getItemCost().toString();
               (_loc1_[_loc2_] as Array).push(new Array(_loc3_,null,_loc10_));
               _loc8_++;
            }
            _loc2_++;
         }
      ...
      public function updateExtensionUi() : void
      {
         ...
         setText("x" + AngryBirdsSocial.smLevelMain.mLevelEditor.getExtensionCost(AngryBirdsSocial.smLevelMain.mLevelCamera.mLevelExtension + 1),"TextField_LevelExtend_Cost" + _loc1_);
      }
      ...
      public function updateUI() : void
      {
         ...
         if((getItemByName("Button_ViewBird") as UIComponentRovio).mVisibility != true)
         {
            (getItemByName("Button_ViewBird") as UIComponentRovio).setVisibility(true);
         }
         if((getItemByName("Button_ViewPig") as UIComponentRovio).mVisibility != true)
         {
            (getItemByName("Button_ViewPig") as UIComponentRovio).setVisibility(true);
         }
         ...
         setText(AngryBirdsSocial.smLevelMain.mLevelEditor.calculateLevelCost().toString(),"TextField_LevelEditor_LevelCost");
      }
   }
}
