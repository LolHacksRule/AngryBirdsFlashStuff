package com.AngryBirds.io
{
   ...
   public class AngryBirdsServer
   {
      ...
      public static function uploadLevel(param1:String, param2:String, param3:Boolean, param4:String, param5:int, param6:int, param7:int, param8:String, param9:Function) : void
      {
         var _loc10_:String = escape(Base64.encode(param2));
         var _loc11_:XML = new XML(Base64.decode(unescape(_loc10_)));
         var _loc12_:Object = {
            "token":AngryBirdsSocial.USER.authenticationToken,
            "level":param1,
            "data":_loc10_,
         ...
         if(param4 != null)
         {
            _loc12_.levelKey = param4;
         }
         new AngryBirdsServer(ServerCommands.COMMAND_UPLOAD_LEVEL,_loc12_,param9);
      }
      ...
      public static function getLevelList(param1:Function, param2:int = -1, param3:int = -1) : void
      {
         var _loc4_:Object;
         (_loc4_ = new Object()).published = true;
         if(param2 != -1)
         {
         ...
         var _loc5_:String = com.rovio.adobe.serialization.json.JSON.encode(_loc4_);
         new AngryBirdsServer(ServerCommands.COMMAND_GET_MORE_LEVELS,{
            "token":AngryBirdsSocial.USER.authenticationToken,
            "includeScreenShot":true,
