package com.AngryBirds.LevelPlayer
{
   ...
   public class LevelMain extends Sprite
   {
      ...
      public var mTrailingObjects:Array = null;
      ...
      public const BIRD_TRAIL_FRAME_INTERVAL:int = 2;
      
      public var mTrailFrameCounter:int = 0;
      ...
      public function init(param1:XML, param2:Boolean = false) : void
      {
         ...
         if(param1.@background.toString() == "ThemeJungle")
         {
            param1.@background = "ThemeForest";
         }
      ...
      public function keyDown(param1:KeyboardEvent) : void
      {
         ...
         if(param1.keyCode == Keyboard.SPACE)
         {
            ...
            {
               (AngryBirdsSocial.smLevelMain.parent as StateBase).mNextState = StateLevelLoad.STATE_NAME;
               return;
            }
         }
         if(param1.keyCode == Keyboard.NUMPAD_0)
         {
            ...
            {
               trace(_loc2_ + 1 + ":" + this.getChildAt(_loc2_) + ":" + this.getChildAt(_loc2_).toString() + ":" + this.getChildAt(_loc2_).name);
               _loc2_++;
            }
         }
         else if(param1.keyCode >= Keyboard.NUMPAD_1 && param1.keyCode <= Keyboard.NUMPAD_9)
         {
            _loc3_ = param1.keyCode - Keyboard.NUMPAD_1;
            this.getChildAt(_loc3_).visible = !this.getChildAt(_loc3_).visible;
         }
         else if(param1.keyCode >= Keyboard.F5 && param1.keyCode <= Keyboard.F8)
         {
            _loc3_ = param1.keyCode - Keyboard.F5;
            this.mLevelBackground.mBackground.getChildAt(_loc3_).visible = !this.mLevelBackground.mBackground.getChildAt(_loc3_).visible;
         }
         if(param1.keyCode == Keyboard.INSERT)
         {
            ...
            this.mLevelEditor.createLevelJSON();
         }
         ...
         else if(!this.mEditorMode)
         {
            ...
            else if(param1.keyCode != Keyboard.UP)
            {
               if(param1.keyCode == Keyboard.DELETE)
               {
                  ...
                  {
                     for each(_loc4_ in AngryBirdsSocial.smLevelMain.mLevelObjects.mObjects)
                     {
                        if(_loc4_.isPig())
                        {
                           _loc4_.mHealth = 0;
      ...
      public function mouseDown(param1:MouseEvent) : void
      {
         ...
         else
         {
            if(this.mActiveObject)
            {
               ...
               {
                  if(this.mActiveObject.mObjectName.toUpperCase() == "BIRD_BLUE" || this.mActiveObject.mObjectName.toUpperCase() == "BIRD_YELLOW" || this.mActiveObject.mObjectName.toUpperCase() == "BIRD_WHITE" || this.mActiveObject.mObjectName.toUpperCase() == "BIRD_BLACK" || this.mActiveObject.mObjectName.toUpperCase() == "BIRD_GREEN" || this.mActiveObject.mObjectName.toUpperCase() == "BIRD_RED" || this.mActiveObject.mObjectName.toUpperCase() == "BIRD_RED_BIG")
                  {
         ...
         if(!this.mEditorMode && this.mLevelSlingshot.canWeStartDragging(_loc2_))
         {
            ...
            else
            {
               ...
               this.mLevelCamera.setAction(LevelCamera.ACTION_GO_TO_SLINGSHOT);
            }
         }
         else
         {
            this.mLevelCamera.startDragging(param1.stageX,param1.stageY);
         }
      }
      ...
      public function mouseRollOut(param1:MouseEvent) : void
      {
         if(this.mDraggingOverlay && param1.target != this.mDraggingOverlay)
         {
            return;
         }
         if(this.mEditorMode)
         {
            ...
            {
               this.mLevelCamera.stopDragging(param1.stageX,param1.stageY);
            }
         }
         else
         {
      ...
      public function mouseUp(param1:MouseEvent) : void
      {
         ...
         if(this.mLevelCamera.mDragging)
         {
            if(param1)
            {
               this.mLevelCamera.dragToNewPoint(param1.stageX,param1.stageY);
            }
      ...
      public function update(param1:Number, param2:Boolean = true) : Boolean
      {
         ...
         if(this.mTrailingObjects)
         {
            if(this.mTrailSpecial)
            {
               this.mTrailFrameCounter = 0;
            }
            if(this.mTrailFrameCounter == 0)
            {
               this.addBirdTrail();
            }
            this.mTrailFrameCounter = (this.mTrailFrameCounter + 1) % this.BIRD_TRAIL_FRAME_INTERVAL;
         }
      ...
      public function handleStateChanges(param1:Number) : void
      {
         ...
         if(this.mLevelState == LEVEL_STATE_CASTLE_VIEW)
         {
            ...
            if(!this.mLevelCamera.isOnCastleView() && this.mLevelCamera.mCurrentAction != LevelCamera.ACTION_DRAG)
            {
               this.changeGameState(LEVEL_STATE_SLINGSHOT);
            }
         }
      ...
      {
         if(this.mLevelCamera.mCurrentCameraSliderLocation < LevelCamera.SLIDER_MAX)
         {
            return false;
         }
         if(!this.mLevelObjects.isWorldAtSleep())
      ...
      public function addScore(param1:Number, param2:Boolean = false, param3:Number = 0, param4:Number = 0, param5:int = -9999) : void
      {
         if(param5 == -9999)
         {
            param5 = LevelParticle.PARTICLE_MATERIAL_BLOCKS_MISC;
         }
      ...
      public function addTrailingObject(param1:LevelObject) : void
      {
         if(this.mTrailingObjects == null)
         {
      ...
      {
         this.mLevelParticles.clearGroup(LevelParticles.PARTICLE_GROUP_TRAILS_OLD);
