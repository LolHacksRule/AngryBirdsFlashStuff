   ...
   public class LevelItems
   {
      ...
      public static function loadItems() : void
      {
         ...
         for each(_loc1_ in mItemDataTable.Items.Blocks.Item)
         {
            ...
            newItem(_loc1_.@id,LevelItem.ITEM_TYPE_BLOCK,_loc1_.@material,_loc1_.@sounds,_loc1_.@shape,_loc1_.@score,_loc1_.@category,_loc1_.@iconScale);
         }
         for each(_loc2_ in mItemDataTable.Items.Birds.Item)
         {
            ...
            newItem(_loc2_.@id,LevelItem.ITEM_TYPE_BIRD,_loc2_.@material,_loc2_.@sounds,_loc2_.@shape,_loc2_.@score,_loc2_.@category,_loc2_.@iconScale);
         }
         for each(_loc3_ in mItemDataTable.Items.Pigs.Item)
         {
            ...
            newItem(_loc3_.@id,LevelItem.ITEM_TYPE_PIG,_loc3_.@material,_loc3_.@sounds,_loc3_.@shape,_loc3_.@score,_loc3_.@category,_loc3_.@iconScale);
         }
         for each(_loc4_ in mItemDataTable.Items.Miscs.Item)
         {
            ...
            newItem(_loc4_.@id,LevelItem.ITEM_TYPE_MISC,_loc4_.@material,_loc4_.@sounds,_loc4_.@shape,_loc4_.@score,_loc4_.@category,_loc4_.@iconScale);
         }
         for each(_loc5_ in mItemDataTable.Items.Borders.Item)
         {
            ...
            newItem(_loc5_.@id,LevelItem.ITEM_TYPE_BORDER,_loc5_.@material,_loc5_.@sounds,_loc5_.@shape,0,_loc5_.@category,_loc5_.@iconScale);
         }
         for each(_loc6_ in mItemDataTable.Items.Textures.Item)
         {
            ...
            newItem(_loc6_.@id,LevelItem.ITEM_TYPE_TEXTURE,_loc6_.@material,_loc6_.@sounds,_loc6_.@shape,0,_loc6_.@category,_loc6_.@iconScale);
         }
         loadSoundChannels(mItemDataTable.SoundChannels);
      }
      
      public static function newItem(param1:String, param2:int, param3:String, param4:String, param5:String, param6:Number, param7:String, param8:Number) : void
      {
         mItems[mItems.length] = new LevelItem(param1,param2,LevelItemMaterials.getMaterial(param3),LevelItemResourcePaths.getResourcePathSound(param4),LevelItemShapes.getShape(param5),param6,param7,param8);
      }
