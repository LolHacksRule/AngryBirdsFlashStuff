package com.AngryBirds.states
{
   ...
   public class StateLoginPage extends StateBase
   {
      ...
      {
         var _loc2_:Object = com.adobe.serialization.json.JSON.decode(param1.json);
         if(_loc2_.token)
         {
            ...
            AngryBirdsSocial.USER.name = _loc2_.username.toString();
            AngryBirdsSocial.USER.authenticationToken = _loc2_.token.toString();
            if(!AngryBirdsSocial.USER_INFO)
            {
               AngryBirdsSocial.USER_INFO = new UserInfoModel();
            }
