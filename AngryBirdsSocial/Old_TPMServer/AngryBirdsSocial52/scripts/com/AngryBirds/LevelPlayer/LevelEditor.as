package com.AngryBirds.LevelPlayer
{
   ...
   public class LevelEditor extends Sprite
   {
      ...
      public static const SELECTED_TOOL_ROTATE:int = 2;
      
      public static const SELECTED_TOOL_ROTATE_NEW:int = 22;
      
      public static const SELECTED_TOOL_DELETE:int = 3;
      ...
      public static var smDefaultEditorLevel:XML;
      ...
      public function update(param1:Number) : void
      {
         ...
         else if(this.mSelectedTool == SELECTED_TOOL_ROTATE_NEW)
         {
      ...
      public function setSelectedTool(param1:int) : void
      {
         ...
         else if(this.mSelectedTool == SELECTED_TOOL_ROTATE_NEW || this.mSelectedTool == SELECTED_TOOL_ROTATE)
         {
      ...
      public function mouseMove(param1:Point) : Boolean
      {
         ...
         if(this.mSelectedTool != SELECTED_TOOL_ROTATE_NEW)
         {
            if(this.mSelectedTool == SELECTED_TOOL_ROTATE || this.mSelectedTool == SELECTED_TOOL_DELETE)
            {
               if(!(!this.mLastRolledOverObject && !this.mLastRolledOverObject2))
               {
                  if(this.mLastRolledOverObject)
      ...
      public function mouseDown(param1:Point) : Boolean
      {
         ...
         else if(this.mSelectedTool == SELECTED_TOOL_ROTATE_NEW || this.mSelectedTool == SELECTED_TOOL_ROTATE || this.mSelectedTool == SELECTED_TOOL_DELETE)
         {
            _loc2_ = this.mLevelMain.mLevelObjects.getObjectFromPoint(this.mMousePositionXB2,this.mMousePositionYB2);
            if(_loc2_ && !_loc2_.isGround())
            {
      ...
      public function updateRotateAndDeleteButtons() : void
      {
         ...
         {
            ((this.mLevelMain.parent as StateLevelEditor).mUIView as ViewLevelEditor).switchRotateAndDeleteButtons(false,this.mLevelMain.mLevelCamera.mLevelExtension > 0);
         }
         else
         {
            ((this.mLevelMain.parent as StateLevelEditor).mUIView as ViewLevelEditor).switchRotateAndDeleteButtons(true,this.mLevelMain.mLevelCamera.mLevelExtension > 0);
         }
      }
      ...
      public function rotateSelectedItems() : void
      {
         ...
         while(_loc1_ < this.mSelectedObjects.length)
         {
            if(this.mSelectedObjects[_loc1_] is LevelObject)
            {
               (this.mSelectedObjects[_loc1_] as LevelObject).rotate(22.5);
            }
            else if(this.mSelectedObjects[_loc1_] is LevelSlingshotObject)
            {
            }
      ...
      public function keyUp(param1:KeyboardEvent) : void
      {
         ...
         {
            if(this.mSelectedTool == SELECTED_TOOL_SELECT && this.mSelectedObjects.length > 0)
            {
         ...
         else if(param1.keyCode == 82 && this.mSelectedTool == SELECTED_TOOL_SELECT && this.mSelectedObjects.length > 0)
         {
         ...
         else if(param1.keyCode == 69)
         {
            if(this.mSelectedObjects.length == 0)
            {
               ((this.mLevelMain.parent as StateLevelEditor).mUIView as ViewLevelEditor).switchRotateAndDeleteButtons(true,true);
            }
         }
      ...
      {
         AngryBirdsServer.sendScreenshot(param1,this.createScreenshot());
      }
      ...
      public function publishLevel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.mLevelMain.mLevelObjects.mObjects.length)
         {
            if((_loc4_ = this.mLevelMain.mLevelObjects.mObjects[_loc1_]) && !_loc4_.isGround())
            {
               this.removeSelectedObjectFromList(this.isAlreadySelected(_loc4_));
            }
            _loc1_++;
         ...
         var _loc2_:String = AngryBirdsSocial.USER.name;
         var _loc3_:String = escape(this.mLevelName);
         Log.log("publishLevel step 4");
         AngryBirdsServer.uploadLevel(_loc3_,this.createLevelXML(_loc3_),this.levelResponseReceived);
      }
      ...
      private function levelResponseReceived(param1:Object) : void
      {
         ...
         if(param1.json)
         {
            _loc2_ = com.adobe.serialization.json.JSON.decode(param1.json);
            _loc3_ = _loc2_.levelKey;
            AngryBirdsSocial.smLevelMain.mLevelData.levelID = _loc3_;
            this.storeLevelScreenshot(_loc3_);
         }
      }
      
      public function createLevelXML(param1:String = "Placeholder level name") : String
      {
         var _loc2_:* = "";
         _loc2_ += "<Level id=\"" + param1 + "\" background=\"" + AngryBirdsSocial.smLevelMain.mLevelBackground.mLevelBackgroundInformation.mName + "\"";
         _loc2_ += " LevelExtension=\"" + this.mLevelMain.mLevelCamera.mLevelExtension + "\"";
         _loc2_ += " AutoCamera=\"" + (!!this.mLevelMain.mLevelCamera.mLevelAutoCamera ? "True" : "False") + "\"";
         _loc2_ += ">" + AngryBirdsSocial.LINE_BREAK_XML;
         _loc2_ += AngryBirdsSocial.smLevelMain.mLevelCamera.getCamerasInXML();
         _loc2_ += AngryBirdsSocial.smLevelMain.mLevelSlingshot.getSlingshotinXML();
         _loc2_ += AngryBirdsSocial.smLevelMain.mLevelObjects.getLevelObjectsinXML();
         _loc2_ += "</Level>";
         Log.log("Publish:\n" + _loc2_);
         return _loc2_;
      }
      ...
      public function updateAutoCameraCoordinates() : void
      {
         ...
         {
            this.mLevelMain.mLevelCamera.loadCameraInformation(smDefaultEditorLevel.Cameras);
         }
         else
         {
