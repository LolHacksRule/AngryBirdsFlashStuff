package com.AngryBirds.ui
{
   ...
   public class ViewLevelEditor extends UIView
   {
      ...
      override public function activateView() : void
      {
         ...
         this.switchRotateAndDeleteButtons(true,AngryBirdsSocial.smLevelMain.mLevelCamera.mLevelExtension > 0);
      }
      ...
      override public function listenerEventOccured(param1:int, param2:String, param3:UIEventListenerRovio) : void
      {
         ...
         switch(param2)
         {
            ...
            case "POPUP_LEVEL_PUBLISHED_CLOSE":
               (getItemByName("Popup_Editor_LevelPublished") as UIPopUpRovio).close();
               break;
      ...
      public function switchRotateAndDeleteButtons(param1:Boolean, param2:Boolean) : void
      {
         if((getItemByName("Button_ToolRotate") as UIButtonRovio).mVisibility != (param1 && param2))
         {
            setItemVisibility("Button_ToolRotate",param1 && param2);
            setItemVisibility("Button_ToolDelete",param1 && param2);
         }
         if((getItemByName("Button_ToolRotateAll") as UIButtonRovio).mVisibility != !param1)
         {
            setItemVisibility("Button_ToolRotateAll",!param1);
            setItemVisibility("Button_ToolDeleteAll",!param1);
         }
      }
      ...
      {
         var _loc8_:UIMovieClipRovio = null;
         ...
         if((getItemByName("Button_ViewBird") as UIComponentRovio).mVisibility != _loc2_)
         {
            (getItemByName("Button_ViewBird") as UIComponentRovio).setVisibility(_loc2_);
         }
         if((getItemByName("Button_ViewPig") as UIComponentRovio).mVisibility != _loc2_)
         {
            (getItemByName("Button_ViewPig") as UIComponentRovio).setVisibility(_loc2_);
         }
         var _loc3_:Boolean = !_loc2_ && AngryBirdsSocial.smLevelMain.mLevelEditor.mEditorView == LevelEditor.EDITOR_VIEW_CASTLE;
         if((getItemByName("Button_ViewBird_BirdAlone") as UIComponentRovio).mVisibility != _loc3_)
         {
            (getItemByName("Button_ViewBird_BirdAlone") as UIComponentRovio).setVisibility(_loc3_);
         }
         var _loc4_:Boolean = !_loc2_ && AngryBirdsSocial.smLevelMain.mLevelEditor.mEditorView == LevelEditor.EDITOR_VIEW_SLINGSHOT;
         if((getItemByName("Button_ViewPig_PigAlone") as UIComponentRovio).mVisibility != _loc4_)
         {
            (getItemByName("Button_ViewPig_PigAlone") as UIComponentRovio).setVisibility(_loc4_);
         }
         var _loc5_:Number = AngryBirdsSocial.smLevelMain.mLevelEditor.calculateBlockCount();
         var _loc6_:Number = AngryBirdsSocial.smLevelMain.mLevelEditor.getMaxBlockCount();
         this.setText(_loc5_ + "/" + _loc6_,"Textfield_BlockLimit");
         var _loc7_:Number = 1;
         if(_loc5_ < _loc6_ / 2)
         {
            _loc7_ = 1;
         ...
         if((this.getItemByName("MovieClip_BlockLimit_Bg") as UIMovieClipRovio).getCurrentFrame() != _loc7_)
         {
            (this.getItemByName("MovieClip_BlockLimit_Bg") as UIMovieClipRovio).StopAt(_loc7_);
            (this.getItemByName("Container_Editor_BlockLimit") as UIContainerRovio).setVisibility(_loc7_ != 1);
         }
         if((getItemByName("Container_CameraDropDown") as UIContainerRovio).mVisibility)
         {
            if((_loc8_ = getItemByName("MovieClip_CameraDropdown_Hitarea") as UIMovieClipRovio).mClip.mouseX < 0 || _loc8_.mClip.mouseX > _loc8_.width || _loc8_.mClip.mouseY < 0 || _loc8_.mClip.mouseY > _loc8_.height)
            {
               (getItemByName("Container_CameraDropDown") as UIContainerRovio).setVisibility(false);
            }
            _loc9_ = !!AngryBirdsSocial.smLevelMain.mLevelCamera.mLevelAutoCamera ? "Button_CameraDropdown_Autocamera" : "Button_CameraDropdown_SetCamera";
            if(this.mButtonGroupCameraDropdown.mLastSelectedButtonName != _loc9_)
            {
               this.mButtonGroupCameraDropdown.buttonSelected(_loc9_);
            }
         }
         if((getItemByName("Container_FileDropDown") as UIContainerRovio).mVisibility)
         {
            if((_loc10_ = getItemByName("MovieClip_FileDropdown_Hitarea") as UIMovieClipRovio).mClip.mouseX < 0 || _loc10_.mClip.mouseX > _loc10_.width || _loc10_.mClip.mouseY < 0 || _loc10_.mClip.mouseY > _loc10_.height)
            {
