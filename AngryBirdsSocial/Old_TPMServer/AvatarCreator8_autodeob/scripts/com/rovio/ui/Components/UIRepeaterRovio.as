package com.rovio.ui.Components
{
   ...
   public class UIRepeaterRovio extends UIContainerRovio
   {
      ...
      public function UIRepeaterRovio(param1:XML, param2:UIContainerRovio, param3:UIView)
      {
         ...
         {
            _loc15_ = mClip.getChildByName("Button_Area3").x - this.mSurfaceX;
            _loc16_ = mClip.getChildByName("Button_Area3").y - this.mSurfaceY;
            this.mButtonMarginX2 = _loc15_ - this.mFirstButtonX;
            this.mButtonMarginY2 = _loc16_ - this.mFirstButtonY;
      ...
      public function loadTabs(param1:Array = null) : void
      {
         ...
         while(_loc2_ < param1.length)
         {
            ...
            _loc6_.initTab(this.mButtonCountOnSurface,this.mSurfaceX,this.mSurfaceY,this.mButtonCountOnSurface * this.mButtonMarginX,this.mButtonCountOnSurface * this.mButtonMarginY,this.mTrackCount);
            _loc2_++;
         }
         if(param1.length > 1)
         {
