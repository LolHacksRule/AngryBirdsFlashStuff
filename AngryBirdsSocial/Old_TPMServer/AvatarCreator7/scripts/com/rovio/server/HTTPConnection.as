   ...
   public class HTTPConnection extends ServerConnection
   {
      ...
      override public function sendRequest(param1:String, param2:Object) : void
      {
         ...
         if(Server.smServerType == "Google")
         {
            ...
            if(param1 == "setLevel")
            {
               _loc3_ = new URLRequest(getServerAddress() + "uploadLevel");
            }
            else if(param1 == "screenshot")
            {
               _loc3_ = new URLRequest(getServerAddress() + "setScreenShot");
            }
            else
            {
            ...
            (_loc4_ = new URLLoader()).dataFormat = URLLoaderDataFormat.VARIABLES;
