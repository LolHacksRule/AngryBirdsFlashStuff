package §`#C§
{
   ...
   public class §?"V§ extends §;$0§
   {
      ...
      protected function § #_§(param1:String, param2:Object) : §^#A§
      {
         ...
         var _loc20_:§;">§ = new §;">§(param1,_loc3_,_loc4_,_loc5_,_loc6_,_loc7_,_loc8_,_loc9_,_loc10_,_loc11_,_loc12_,_loc13_,_loc14_,_loc15_,_loc16_,_loc17_,_loc18_,_loc19_);
         §+$6§[param1] = _loc20_;
         return _loc20_;
      }
   }
