   ...
   public class §^#M§ extends §="@§
   {
      ...
      override protected function addDestructionParticles(param1:§7!O§) : void
      {
         ...
         while(_loc5_ < _loc3_)
         {
            ...
            §>"$§.§3#'§.particles.addSimpleParticle(§!#B§[this.§>!D§][_loc5_],"",§5"6§.PARTICLE_GROUP_GAME_EFFECTS,§=$4§.PARTICLE_TYPE_KINETIC_PARTICLE,getBody().GetPosition().x,getBody().GetPosition().y,_loc8_,"",0,_loc4_ * Math.cos(_loc6_),-_loc4_ * Math.sin(_loc6_),10,_loc7_,1,1,true);
            _loc5_++;
         }
      }
   }
