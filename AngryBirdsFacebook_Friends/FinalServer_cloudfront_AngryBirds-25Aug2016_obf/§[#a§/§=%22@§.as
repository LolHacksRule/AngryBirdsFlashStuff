package §[#a§
{
   ...
   public class §="@§ extends §'?§ implements §%"<§, include
   {
      ...
      {
         var _loc1_:int = 30;
         return getBody().IsAwake() && (this is §-k§ && this.§>#b§ == this.§=#I§ || Math.abs(getBody().GetLinearVelocity().x) > b2Settings.b2_linearSleepTolerance * _loc1_ || Math.abs(getBody().GetLinearVelocity().y) > b2Settings.b2_linearSleepTolerance * _loc1_ || Math.abs(getBody().GetAngularVelocity()) > b2Settings.b2_angularSleepTolerance * _loc1_);
      }
