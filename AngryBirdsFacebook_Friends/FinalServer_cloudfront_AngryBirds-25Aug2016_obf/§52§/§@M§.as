package §52§
{
   ...
   public class §@M§ extends EventDispatcher
   {
      ...
      protected function §![§(param1:Number) : Number
      {
         ...
         if(param1 > _loc5_)
         {
            if(this.§,#j§ > -90 - _loc2_ + _loc3_ && this.§,#j§ < -90 + _loc2_ + _loc3_)
            {
               return _loc5_;
            }
            if(this.§,#j§ > -90 - _loc2_ - _loc4_ + _loc3_ && this.§,#j§ < -90 + _loc2_ + _loc4_ + _loc3_)
            {
               return Number(_loc5_ + (this.§6"=§ - _loc5_) * (Math.abs(this.§,#j§ - -90 - _loc3_) - _loc2_) / _loc4_);
            }
         }
         return param1;
      }
      ...
      protected function showDestructionParticles(param1:§5!&§) : void
      {
         ...
         while(_loc5_ < _loc3_)
         {
            ...
            this.§,#2§.particles.addParticle(§=$4§.§9J§,§5"6§.PARTICLE_GROUP_GAME_EFFECTS,§=$4§.PARTICLE_TYPE_KINETIC_PARTICLE,param1.x + _loc7_,param1.y + _loc8_,1500,"",§=$4§.getParticleMaterialFromEngineMaterial(param1.name),_loc2_ * Math.cos(_loc6_),-_loc2_ * Math.sin(_loc6_),5,_loc2_ * 20);
            _loc5_++;
         }
         this.§,#2§.particles.addParticle(§=$4§.§=!_§,§5"6§.PARTICLE_GROUP_GAME_EFFECTS,§=$4§.PARTICLE_TYPE_KINETIC_PARTICLE,param1.x,param1.y,1000,"",0,Math.cos(_loc6_),0,5,_loc2_ * 5);
      }
