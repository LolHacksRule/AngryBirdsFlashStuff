package §9@§
{
   ...
   public class §["X§
   {
      ...
      public static function § ">§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         jsonString = §-J§(luaString,emptyObjectAsArray);
         try
         {
      ...
      private static function §-!S§(param1:Object, param2:int) : String
      {
         ...
         for(_loc4_ in param1)
         {
            ...
            _loc3_ += _loc4_ + " = " + §6!@§(param1[_loc4_],param2);
            if(param2 > 1)
            {
               _loc3_ += ",";
            }
      ...
      private static function §6!@§(param1:*, param2:int) : String
      {
         ...
         else
         {
            ...
            if(param1 is Array)
            {
               ...
               {
                  _loc3_ += !!(§6!@§(param1[_loc6_],param2) + (_loc6_ < param1.length - 1)) ? "," : "";
                  _loc6_++;
               }
               return _loc3_ + "}";
            }
