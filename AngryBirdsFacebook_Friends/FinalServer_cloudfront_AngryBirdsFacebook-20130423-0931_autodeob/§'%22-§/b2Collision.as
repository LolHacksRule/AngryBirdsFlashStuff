package §'"-§
{
   ...
   public class b2Collision
   {
      ...
      private static var s_clipPoints1:Vector.<§^!`§> = §>c§();
      
      private static var s_clipPoints2:Vector.<§^!`§> = §>c§();
      ...
      private static var §6Q§:b2Vec2 = new b2Vec2();
      
      private static var §=x§:b2Vec2 = new b2Vec2();
      
      private static var §2H§:b2Vec2 = new b2Vec2();
      ...
      public static function §7">§(param1:Vector.<§^!`§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc20_:§^!`§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§4C§;
         var _loc8_:Vector.<b2Vec2> = param2.§0!3§;
         var _loc9_:int = param5.§4C§;
         ...
         _loc20_.id.§]§.§1g§ = param4;
         _loc20_.id.§]§.§&V§ = _loc21_;
         _loc20_.id.§]§.§%!#§ = 0;
         _loc20_ = param1[1];
      ...
      public static function §<!s§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §'"2§[0] = _loc8_;
         var _loc9_:Number = §5;§(§'"2§,param2,param3,param4,param5);
         _loc8_ = §'"2§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §=P§[0] = _loc10_;
         var _loc11_:Number = §5;§(§=P§,param4,param5,param2,param3);
         _loc10_ = §=P§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§^!`§> = §"!'§;
         §7">§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§4C§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§["8§)[_loc16_];
         ...
         if((_loc39_ = §0L§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §0L§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§3=§.SetV(_loc27_);
      ...
      public static function §;!R§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§0!_§ + param4.§0!_§;
         var _loc21_:int = param2.§4C§;
         var _loc22_:Vector.<b2Vec2> = param2.§["8§;
         var _loc23_:Vector.<b2Vec2> = param2.§0!3§;
         var _loc24_:int = 0;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§0,§ = 1;
            param1.§<"@§ = b2Manifold.§[!7§;
            param1.§3=§.x = _loc15_ - _loc27_.x;
            param1.§3=§.y = _loc16_ - _loc27_.y;
            param1.§3=§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§0,§ = 1;
            param1.§<"@§ = b2Manifold.§[!7§;
            param1.§3=§.x = _loc15_ - _loc28_.x;
            param1.§3=§.y = _loc16_ - _loc28_.y;
            param1.§3=§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§4!_§[0].m_localPoint.SetV(param4.§2"9§);
            param1.§4!_§[0].m_id.key = 0;
