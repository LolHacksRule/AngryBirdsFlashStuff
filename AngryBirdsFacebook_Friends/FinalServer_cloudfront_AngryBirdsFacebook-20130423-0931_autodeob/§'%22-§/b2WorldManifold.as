      ...
      public function §6!Q§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         ...
         switch(param1.§<"@§)
         {
            case b2Manifold.§>E§:
               ...
               this.§4!_§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§4!_§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§[!7§:
               _loc8_ = param2.R;
               _loc7_ = param1.§3=§;
               ...
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§4!_§[_loc6_].m_localPoint;
                  ...
                  this.§4!_§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§4!_§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§?!Q§:
               ...
               while(_loc6_ < param1.§0,§)
               {
                  ...
                  this.§4!_§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§4!_§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
