package §;!Q§
{
   ...
   public class §]"1§ extends AbstractPopup
   {
      ...
      {
         super(param1,param2,§@#`§.§#!c§.Views.PopupView_RaffleWinnersPopup[0]);
         ...
         this.§<"w§ = this.mClip.CompetitionWinners_Text.y + this.§&H§;
         this.§@!Y§ = this.mClip.CompetitionWinners_Text.y + this.§,#Y§ - this.mClip.CompetitionWinners_Text.height + this.§;"+§;
         ...
         this.§-C§ = this.mClip.CompetitionWinners_Text.y;
         this.§>!J§();
      }
      ...
      private function §1#R§(param1:Event) : void
      {
         ...
         var _loc2_:Number = this.mClip.CompetitionWinners_Text.y - (this.§<"w§ + this.§-C§);
         this.mClip.CompetitionWinners_Text.y -= _loc2_ / 5;
      }
