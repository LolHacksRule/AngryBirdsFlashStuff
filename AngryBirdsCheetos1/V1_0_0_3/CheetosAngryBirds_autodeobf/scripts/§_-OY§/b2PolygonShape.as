package §_-OY§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §_-wi§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §_-Z5§:b2Vec2;
      
      b2internal var §_-ja§:Vector.<b2Vec2>;
      
      b2internal var §_-o8§:Vector.<b2Vec2>;
      
      b2internal var §_-Ta§:int;
      
      public function b2PolygonShape()
      {
         super();
         §_-Kg§ = b2internal::_-8u;
         this.§_-Z5§ = new b2Vec2();
         this.§_-ja§ = new Vector.<b2Vec2>();
         this.§_-o8§ = new Vector.<b2Vec2>();
         §_-EG§ = b2Settings.b2_polygonRadius;
         this.§_-Z5§.§return§();
      }
      
      public static function §_-I7§(param1:Array, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-6T§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-sr§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-nf§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-NM§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-010§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-wa§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§_-Ny§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §_-V4§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-c5§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-tT§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§_-vL§(new b2Vec2(0,0));
            _loc3_.§_-vL§(_loc9_);
            _loc3_.§_-vL§(_loc10_);
            _loc3_.§_-Hx§(_loc16_ * _loc7_);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §_-Zh§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§_-hP§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§_-hP§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§_-Z5§.SetV(_loc2_.§_-Z5§);
            this.§_-Ta§ = _loc2_.§_-Ta§;
            this.§_-FI§(this.§_-Ta§);
            _loc3_ = 0;
            while(_loc3_ < this.§_-Ta§)
            {
               this.§_-ja§[_loc3_].SetV(_loc2_.§_-ja§[_loc3_]);
               this.§_-o8§[_loc3_].SetV(_loc2_.§_-o8§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §_-6T§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§_-nf§(_loc3_,param2);
      }
      
      public function §_-nf§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§_-Ta§)
         {
            this.§_-ja§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§_-Ta§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§_-Ta§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§_-FN§(this.§_-ja§[_loc5_],this.§_-ja§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§_-Tv§() > Number.MIN_VALUE);
            this.§_-o8§[_loc3_].SetV(b2Math.§_-w§(_loc6_,1));
            this.§_-o8§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§_-Z5§ = §_-tT§(this.§_-ja§,this.§_-Ta§);
      }
      
      public function §_-010§(param1:Number, param2:Number) : void
      {
         this.§_-Ta§ = 4;
         this.§_-FI§(4);
         this.§_-ja§[0].Set(-param1,-param2);
         this.§_-ja§[1].Set(param1,-param2);
         this.§_-ja§[2].Set(param1,param2);
         this.§_-ja§[3].Set(-param1,param2);
         this.§_-o8§[0].Set(0,-1);
         this.§_-o8§[1].Set(1,0);
         this.§_-o8§[2].Set(0,1);
         this.§_-o8§[3].Set(-1,0);
      ...
      public function §_-Ny§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§_-Ta§ = 4;
         this.§_-FI§(4);
         this.§_-ja§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§_-Ta§)
         {
            this.§_-ja§[_loc6_] = b2Math.§_-jR§(_loc5_,this.§_-ja§[_loc6_]);
            this.§_-o8§[_loc6_] = b2Math.§_-E0§(_loc5_.R,this.§_-o8§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §_-c5§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§_-Ta§ = 2;
         this.§_-FI§(2);
         this.§_-ja§[0].SetV(param1);
         this.§_-ja§[1].SetV(param2);
         this.§_-Z5§.x = 0.5 * (param1.x + param2.x);
         this.§_-Z5§.y = 0.5 * (param1.y + param2.y);
         this.§_-o8§[0] = b2Math.§_-w§(b2Math.§_-FN§(param2,param1),1);
         this.§_-o8§[0].Normalize();
         this.§_-o8§[1].x = -this.§_-o8§[0].x;
         this.§_-o8§[1].y = -this.§_-o8§[0].y;
      }
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < this.§_-Ta§)
         {
            _loc3_ = this.§_-ja§[_loc9_];
            _loc5_ = _loc7_ - _loc3_.x;
            _loc6_ = _loc8_ - _loc3_.y;
            _loc3_ = this.§_-o8§[_loc9_];
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§_-Ta§)
         {
            _loc6_ = (_loc9_ = this.§_-ja§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§_-o8§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§_-00c§.x = _loc5_ - b2internal::_-EG;
         param1.§_-00c§.y = _loc6_ - b2internal::_-EG;
         param1.§_-ZN§.x = _loc7_ + b2internal::_-EG;
         param1.§_-ZN§.y = _loc8_ + b2internal::_-EG;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§_-Ta§ == 2)
         {
            param1.center.x = 0.5 * (this.§_-ja§[0].x + this.§_-ja§[1].x);
            param1.center.y = 0.5 * (this.§_-ja§[0].y + this.§_-ja§[1].y);
            param1.§_-ae§ = 0;
            param1.§_-YY§ = 0;
            return;
         }
         ...
         var _loc6_:Number = 0;
         var _loc10_:int = 0;
         while(_loc10_ < this.§_-Ta§)
         {
            _loc11_ = this.§_-ja§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§_-Ta§ ? this.§_-ja§[int(_loc10_ + 1)] : this.§_-ja§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§_-ae§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§_-YY§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§_-dE§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§_-kH§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§_-Ta§)
         {
            _loc7_[_loc12_] = b2Math.§_-kH§(_loc5_,this.§_-ja§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§_-jR§(param3,_loc24_.center));
                  return _loc24_.§_-ae§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§_-Ta§;
         var _loc14_:int = (_loc10_ + 1) % this.§_-Ta§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§_-ja§[_loc9_].x * (1 - _loc15_) + this.§_-ja§[_loc13_].x * _loc15_,this.§_-ja§[_loc9_].y * (1 - _loc15_) + this.§_-ja§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§_-ja§[_loc10_].x * (1 - _loc16_) + this.§_-ja§[_loc14_].x * _loc16_,this.§_-ja§[_loc10_].y * (1 - _loc16_) + this.§_-ja§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§_-ja§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§_-Ta§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§_-ja§[_loc12_];
            }
         ...
         _loc20_.§_-Hx§(1 / _loc19_);
         param4.SetV(b2Math.§_-jR§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §_-MW§() : Vector.<b2Vec2>
      {
         return this.§_-ja§;
      }
      
      public function §_-md§() : Vector.<b2Vec2>
      {
         return this.§_-o8§;
      }
      
      public function §_-Bv§(param1:b2Vec2) : int
      {
         var _loc5_:Number = NaN;
         var _loc2_:int = 0;
         var _loc3_:Number = this.§_-ja§[0].x * param1.x + this.§_-ja§[0].y * param1.y;
         var _loc4_:int = 1;
         while(_loc4_ < this.§_-Ta§)
         {
      ...
      private function §_-BF§() : Boolean
      {
         return false;
      }
      
      private function §_-FI§(param1:int) : void
      {
         var _loc2_:int = this.§_-ja§.length;
         while(_loc2_ < param1)
         {
            this.§_-ja§[_loc2_] = new b2Vec2();
            this.§_-o8§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
