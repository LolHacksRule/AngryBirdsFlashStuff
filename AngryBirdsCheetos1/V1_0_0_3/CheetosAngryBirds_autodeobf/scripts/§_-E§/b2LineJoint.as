package §_-E§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§_-Ud§.x * this.§_-1y§.x + (this.§_-O7§ + this.§_-Ud§.y) * this.§_-4C§.x),param1 * (this.§_-Ud§.x * this.§_-1y§.y + (this.§_-O7§ + this.§_-Ud§.y) * this.§_-4C§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§_-jK§ = this.§_-jK§ > Number.MIN_VALUE ? Number(1 / this.§_-jK§) : Number(0);
         ...
         this.§_-Ob§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§_-Ob§.col2.x = this.§_-Ob§.col1.y;
         this.§_-Ob§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§_-Gy§)
         {
         ...
         if(param1.§_-eH§)
         {
            ...
            _loc19_ = this.§_-Ud§.x * this.§_-1y§.x + (this.§_-O7§ + this.§_-Ud§.y) * this.§_-4C§.x;
            _loc20_ = this.§_-Ud§.x * this.§_-1y§.y + (this.§_-O7§ + this.§_-Ud§.y) * this.§_-4C§.y;
            _loc21_ = this.§_-Ud§.x * this.m_s1 + (this.§_-O7§ + this.§_-Ud§.y) * this.m_a1;
            _loc22_ = this.§_-Ud§.x * this.m_s2 + (this.§_-O7§ + this.§_-Ud§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§_-4C§.x * (_loc6_.x - _loc4_.x) + this.§_-4C§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§_-jK§ * (this.§_-kY§ - _loc13_);
            _loc15_ = this.§_-O7§;
            _loc16_ = param1.§_-Km§ * this.§_-lb§;
            this.§_-O7§ = b2Math.§_-a4§(this.§_-O7§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§_-O7§ - _loc15_) * this.§_-4C§.x;
            _loc9_ = _loc14_ * this.§_-4C§.y;
         ...
         {
            _loc17_ = this.§_-4C§.x * (_loc6_.x - _loc4_.x) + this.§_-4C§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§_-Ud§.Copy();
            _loc19_ = this.§_-Ob§.§_-O8§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§_-Ud§.§_-vL§(_loc19_);
            if(this.§_-x§ == b2internal::_-t2)
            {
               this.§_-Ud§.y = b2Math.§_-6y§(this.§_-Ud§.y,0);
            }
            else if(this.§_-x§ == b2internal::_-v7)
            {
               this.§_-Ud§.y = b2Math.§_-6A§(this.§_-Ud§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§_-Ud§.y - _loc18_.y) * this.§_-Ob§.col2.x;
            if(this.§_-Ob§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§_-Ob§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§_-Ud§.x = _loc21_;
            _loc19_.x = this.§_-Ud§.x - _loc18_.x;
            _loc19_.y = this.§_-Ud§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§_-1y§.x + _loc19_.y * this.§_-4C§.x;
            _loc9_ = _loc19_.x * this.§_-1y§.y + _loc19_.y * this.§_-4C§.y;
         ...
         else
         {
            if(this.§_-Ob§.col1.x != 0)
            {
               _loc22_ = -_loc12_ / this.§_-Ob§.col1.x;
            }
            else
            {
               _loc22_ = 0;
            ...
            this.§_-Ud§.x += _loc22_;
            _loc8_ = _loc22_ * this.§_-1y§.x;
            _loc9_ = _loc22_ * this.§_-1y§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§_-Gy§)
         {
            ...
            _loc34_ = this.§_-4C§.x * _loc26_ + this.§_-4C§.y * _loc27_;
            if(b2Math.§_-hI§(this.§_-W§ - this.§_-8Q§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§_-a4§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§_-hI§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§_-8Q§)
            {
               _loc19_ = b2Math.§_-a4§(_loc34_ - this.§_-8Q§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§_-8Q§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§_-W§)
            {
               _loc19_ = b2Math.§_-a4§(_loc34_ - this.§_-W§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§_-W§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§_-Ob§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§_-Ob§.col2.x = this.§_-Ob§.col1.y;
            this.§_-Ob§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§_-Ob§.§_-O8§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::_-M8;
         ...
         var _loc30_:Number = _loc28_.x * this.§_-1y§.x + _loc28_.y * this.§_-4C§.x;
         var _loc31_:Number = _loc28_.x * this.§_-1y§.y + _loc28_.y * this.§_-4C§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::_-M8 * _loc30_;
         _loc6_.y -= b2internal::_-M8 * _loc31_;
         _loc7_ -= b2internal::_-Fp * _loc32_;
         _loc8_.x += b2internal::_-pU * _loc30_;
         _loc8_.y += b2internal::_-pU * _loc31_;
         _loc9_ += b2internal::_-Gb * _loc33_;
