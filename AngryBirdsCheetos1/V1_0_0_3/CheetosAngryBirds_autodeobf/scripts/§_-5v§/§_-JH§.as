package §_-5v§
{
   ...
   public class §_-JH§
   {
      ...
      public static function §_-sY§(param1:Stage) : void
      {
         ...
         §_-p-§ = param1;
         ExternalInterface.call(§_-As§);
         ExternalInterface.call(§_-ZT§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §_-u7§ = ExternalInterface.call(§_-6X§,ExternalInterface.objectID);
         if(§_-u7§ == §_-Sc§)
         {
            return;
         }
      ...
      public static function get §_-hN§() : int
      {
         return §_-u7§;
      }
      
      public static function get §_-4Y§() : Boolean
      {
         return §_-0-t§;
      }
      
      public static function set §_-4Y§(param1:Boolean) : void
      {
         §_-0-t§ = param1;
      }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §_-p-§.getObjectsUnderPoint(new Point(§_-p-§.mouseX,§_-p-§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
