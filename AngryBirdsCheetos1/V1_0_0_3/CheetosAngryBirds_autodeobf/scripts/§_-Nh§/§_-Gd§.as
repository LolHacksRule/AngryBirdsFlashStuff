package §_-Nh§
{
   ...
   public class §_-Gd§
   {
      ...
      public static var §_-CH§:ByteArray;
      ...
      public static function §_-sQ§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-ST§(_loc2_);
         return §_-JL§.§_-BJ§(_loc3_.readInt(),true) + §_-JL§.§_-BJ§(_loc3_.readInt(),true) + §_-JL§.§_-BJ§(_loc3_.readInt(),true) + §_-JL§.§_-BJ§(_loc3_.readInt(),true) + §_-JL§.§_-BJ§(_loc3_.readInt(),true);
      }
      
      public static function §_-jZ§(param1:ByteArray) : String
      {
         var _loc2_:Array = §_-Gd§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §_-ST§(_loc2_);
         return §_-JL§.§_-BJ§(_loc3_.readInt(),true) + §_-JL§.§_-BJ§(_loc3_.readInt(),true) + §_-JL§.§_-BJ§(_loc3_.readInt(),true) + §_-JL§.§_-BJ§(_loc3_.readInt(),true) + §_-JL§.§_-BJ§(_loc3_.readInt(),true);
      }
      
      public static function §_-4D§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §_-Gd§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-ST§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §_-ST§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
