package §_-Vn§
{
   public class b2Mat22
   {
      ...
      public static function §_-xB§(param1:Number) : b2Mat22
      {
      ...
      public static function §_-Mx§(param1:b2Vec2, param2:b2Vec2) : b2Mat22
      {
         var _loc3_:b2Mat22 = new b2Mat22();
         _loc3_.§_-eK§(param1,param2);
         return _loc3_;
      }
      ...
      public function §_-eK§(param1:b2Vec2, param2:b2Vec2) : void
      {
      ...
      public function §_-QN§(param1:b2Mat22) : void
      {
         this.col1.SetV(param1.col1);
         this.col2.SetV(param1.col2);
      }
      
      public function §_-Fj§(param1:b2Mat22) : void
      {
      ...
      public function §throw§(param1:b2Mat22) : b2Mat22
      {
      ...
      public function §_-O8§(param1:b2Vec2, param2:Number, param3:Number) : b2Vec2
      {
