package §[!8§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§ !6§.x * this.§#9§.x + (this.§]!]§ + this.§ !6§.z) * this.§"Z§.x),param1 * (this.§ !6§.x * this.§#9§.y + (this.§]!]§ + this.§ !6§.z) * this.§"Z§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§]2§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§]2§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§]2§.col2.x = this.§]2§.col1.y;
         this.§]2§.col2.y = _loc16_ + _loc17_;
         this.§]2§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§]2§.col3.x = this.§]2§.col1.z;
         this.§]2§.col3.y = this.§]2§.col2.z;
         this.§]2§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§?;§)
         {
         ...
         if(param1.§5!N§)
         {
            ...
            this.§ !6§.y *= param1.§7!M§;
            this.§]!]§ *= param1.§7!M§;
            _loc19_ = this.§ !6§.x * this.§#9§.x + (this.§]!]§ + this.§ !6§.z) * this.§"Z§.x;
            _loc20_ = this.§ !6§.x * this.§#9§.y + (this.§]!]§ + this.§ !6§.z) * this.§"Z§.y;
            _loc21_ = this.§ !6§.x * this.m_s1 + this.§ !6§.y + (this.§]!]§ + this.§ !6§.z) * this.m_a1;
            _loc22_ = this.§ !6§.x * this.m_s2 + this.§ !6§.y + (this.§]!]§ + this.§ !6§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§"Z§.x * (_loc6_.x - _loc4_.x) + this.§"Z§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§4v§ * (this.§'!E§ - _loc14_);
            _loc16_ = this.§]!]§;
            _loc17_ = param1.§7!?§ * this.§"`§;
            this.§]!]§ = b2Math.§-!1§(this.§]!]§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§]!]§ - _loc16_) * this.§"Z§.x;
            _loc9_ = _loc15_ * this.§"Z§.y;
         ...
         {
            _loc18_ = this.§"Z§.x * (_loc6_.x - _loc4_.x) + this.§"Z§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§ !6§.Copy();
            _loc20_ = this.§]2§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§ !6§.§-i§(_loc20_);
            if(this.§,4§ == b2internal::%! )
            {
               this.§ !6§.z = b2Math.§>e§(this.§ !6§.z,0);
            }
            else if(this.§,4§ == b2internal::+!E)
            {
               this.§ !6§.z = b2Math.§[S§(this.§ !6§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§ !6§.z - _loc19_.z) * this.§]2§.col3.x;
            _loc22_ = -_loc13_ - (this.§ !6§.z - _loc19_.z) * this.§]2§.col3.y;
            _loc23_ = this.§]2§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§ !6§.x = _loc23_.x;
            this.§ !6§.y = _loc23_.y;
            _loc20_.x = this.§ !6§.x - _loc19_.x;
            _loc20_.y = this.§ !6§.y - _loc19_.y;
            _loc20_.z = this.§ !6§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§#9§.x + _loc20_.z * this.§"Z§.x;
            _loc9_ = _loc20_.x * this.§#9§.y + _loc20_.z * this.§"Z§.y;
         ...
         {
            _loc24_ = this.§]2§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§ !6§.x += _loc24_.x;
            this.§ !6§.y += _loc24_.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§?;§)
         {
            ...
            _loc35_ = this.§"Z§.x * _loc26_ + this.§"Z§.y * _loc27_;
            if(b2Math.§8M§(this.§=!C§ - this.§@!C§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§-!1§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§8M§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§@!C§)
            {
               _loc19_ = b2Math.§-!1§(_loc35_ - this.§@!C§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§@!C§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§=!C§)
            {
               _loc19_ = b2Math.§-!1§(_loc35_ - this.§=!C§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§]2§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§]2§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§]2§.col2.x = this.§]2§.col1.y;
            this.§]2§.col2.y = _loc14_ + _loc15_;
            this.§]2§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§]2§.col3.x = this.§]2§.col1.z;
            this.§]2§.col3.y = this.§]2§.col2.z;
            this.§]2§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§]2§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::3#;
            ...
            this.§]2§.col1.Set(_loc36_,_loc37_,0);
            this.§]2§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§]2§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§#9§.x + _loc28_.z * this.§"Z§.x;
         var _loc32_:Number = _loc28_.x * this.§#9§.y + _loc28_.z * this.§"Z§.y;
