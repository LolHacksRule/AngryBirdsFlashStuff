package §9"§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §>b§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§8!J§ = §9!0§;
            _loc7_ = this.§9!5§.§-&§(param1.indexA[0]);
            _loc10_ = this.§0L§.§-&§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§8!J§ = §0!&§;
            _loc8_ = this.§9!5§.§-&§(param1.indexA[0]);
            _loc9_ = this.§9!5§.§-&§(param1.indexA[1]);
            _loc10_ = this.§0L§.§-&§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§"Z§ = b2Math.§8!;§(b2Math.§4_§(_loc9_,_loc8_),1);
            this.§"Z§.Normalize();
            _loc20_ = this.§"Z§;
         ...
         {
            this.§8!J§ = §5!8§;
            _loc11_ = this.§0L§.§-&§(param1.indexB[0]);
            _loc12_ = this.§0L§.§-&§(param1.indexB[1]);
            _loc7_ = this.§9!5§.§-&§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§"Z§ = b2Math.§8!;§(b2Math.§4_§(_loc12_,_loc11_),1);
            this.§"Z§.Normalize();
            _loc20_ = this.§"Z§;
         ...
         else
         {
            ...
            _loc24_ = b2Math.§2!3§(param3.R,b2Math.§4_§(_loc9_,_loc8_));
            _loc25_ = b2Math.§@E§(param5,_loc10_);
            _loc26_ = b2Math.§2!3§(param5.R,b2Math.§4_§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§4_§(_loc26_,_loc24_);
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         switch(this.§8!J§)
         {
            case §9!0§:
               ...
               return Number(((_loc8_ = b2Math.§@E§(param2,_loc6_)).x - _loc7_.x) * this.§"Z§.x + (_loc8_.y - _loc7_.y) * this.§"Z§.y);
            case §0!&§:
