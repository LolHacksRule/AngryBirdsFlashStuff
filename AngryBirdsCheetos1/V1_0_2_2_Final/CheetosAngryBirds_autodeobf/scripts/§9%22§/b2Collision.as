package §9"§
{
   ...
   public class b2Collision
   {
      ...
      private static var §'!6§:Vector.<§>I§> = §;0§();
      
      private static var s_clipPoints1:Vector.<§>I§> = §;0§();
      
      private static var s_clipPoints2:Vector.<§>I§> = §;0§();
      
      private static var §8!N§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §"x§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         while(true)
         {
            ...
            if((_loc17_ = §%I§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §'H§(param1:Vector.<§>I§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc20_:§>I§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§9X§;
         var _loc8_:Vector.<b2Vec2> = param2.§&b§;
         var _loc9_:int = param5.§9X§;
         ...
         _loc20_.id.§;f§.§<!S§ = param4;
         _loc20_.id.§;f§.§ null§ = _loc21_;
         _loc20_.id.§;f§.§!R§ = 0;
         _loc20_ = param1[1];
      ...
      public static function §`6§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §8!N§[0] = _loc8_;
         var _loc9_:Number = §"x§(§8!N§,param2,param3,param4,param5);
         _loc8_ = §8!N§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §9!?§[0] = _loc10_;
         var _loc11_:Number = §"x§(§9!?§,param4,param5,param2,param3);
         _loc10_ = §9!?§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§>I§> = §'!6§;
         §'H§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§9X§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§9Z§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §7!>§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §=`§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §;!0§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §<!V§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§>I§> = s_clipPoints1;
         var _loc38_:Vector.<§>I§> = s_clipPoints2;
         if((_loc39_ = §<B§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §<B§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
      ...
      public static function §3s§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§9X§;
         var _loc22_:Vector.<b2Vec2> = param2.§9Z§;
