package §<!>§
{
   ...
   public class §@[§
   {
      ...
      public static function §<!E§(param1:Stage) : void
      {
         ...
         §<g§ = param1;
         ExternalInterface.call(§]!9§);
         ExternalInterface.call(§@E§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §%I§ = ExternalInterface.call(§"q§,ExternalInterface.objectID);
         if(§%I§ == §1q§)
         {
            return;
         }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §<g§.getObjectsUnderPoint(new Point(§<g§.mouseX,§<g§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
