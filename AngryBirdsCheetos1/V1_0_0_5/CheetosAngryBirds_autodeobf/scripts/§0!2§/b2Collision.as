package §0!2§
{
   ...
   public class b2Collision
   {
      ...
      private static var §7!L§:Vector.<§^!2§> = §-`§();
      ...
      private static var §"!6§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §#x§(param1:Vector.<§^!2§>, param2:Vector.<§^!2§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§^!2§ = null;
         var _loc6_:int = 0;
      ...
      public static function §]q§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param1.§9!Z§;
         var _loc8_:Vector.<b2Vec2> = param1.§3!S§;
         var _loc9_:int = param4.§0!'§;
         var _loc10_:Vector.<b2Vec2> = param4.§9!Z§;
         _loc11_ = param2.R;
      ...
      public static function §?!>§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param2.§3!S§;
         _loc9_ = param5.R;
         _loc8_ = param4.§2&§;
      ...
      public static function §4!M§(param1:Vector.<§^!2§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param2.§3!S§;
         var _loc9_:int = param5.§0!'§;
         var _loc10_:Vector.<b2Vec2> = param5.§9!Z§;
         var _loc11_:Vector.<b2Vec2> = param5.§3!S§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§]U§.§4!-§ = param4;
         _loc20_.id.§]U§.§7!D§ = _loc21_;
         _loc20_.id.§]U§.§@!H§ = 0;
         _loc20_ = param1[1];
      ...
      public static function §-s§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:Vector.<§^!2§> = §7!L§;
         §4!M§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§0!'§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§9!Z§)[_loc16_];
         ...
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §4!I§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §"!M§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
      ...
      public static function §`!V§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§3c§ = b2Manifold.§in §;
         param1.m_localPoint.SetV(param2.§>w§);
         param1.§1J§.§^!#§();
         param1.§39§ = 1;
         param1.§+!S§[0].m_localPoint.SetV(param4.§>w§);
      ...
      public static function § !B§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc22_:Vector.<b2Vec2> = param2.§9!Z§;
         var _loc23_:Vector.<b2Vec2> = param2.§3!S§;
         var _loc24_:int = 0;
         ...
         if(_loc19_ < Number.MIN_VALUE)
         {
            param1.§39§ = 1;
            param1.§3c§ = b2Manifold.§<'§;
            param1.§1J§.SetV(_loc23_[_loc18_]);
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§39§ = 1;
            param1.§3c§ = b2Manifold.§<'§;
            param1.§1J§.x = _loc15_ - _loc27_.x;
            param1.§1J§.y = _loc16_ - _loc27_.y;
            param1.§1J§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§39§ = 1;
            param1.§3c§ = b2Manifold.§<'§;
            param1.§1J§.x = _loc15_ - _loc28_.x;
            param1.§1J§.y = _loc16_ - _loc28_.y;
            param1.§1J§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§+!S§[0].m_localPoint.SetV(param4.§>w§);
            param1.§+!S§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§39§ = 1;
            param1.§3c§ = b2Manifold.§<'§;
            param1.§1J§.x = _loc23_[_loc25_].x;
            param1.§1J§.y = _loc23_[_loc25_].y;
            param1.§1J§.Normalize();
