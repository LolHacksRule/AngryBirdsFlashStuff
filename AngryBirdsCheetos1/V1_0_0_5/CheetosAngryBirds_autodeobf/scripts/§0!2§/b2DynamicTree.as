package §0!2§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §+P§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
      ...
      public function §;!@§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            ...
            {
               _loc3_ = !!(this.§4!2§ >> _loc4_ & 1) ? _loc3_.child2 : _loc3_.child1;
               _loc4_ = _loc4_ + 1 & 31;
            }
            ++this.§4!2§;
            this.§76§(_loc3_);
      ...
      public function §,!<§(param1:Function, param2:b2AABB) : void
      {
         ...
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§=!W§(param2))
            {
               if(_loc5_.§+R§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§=!W§(_loc9_) != false)
            {
      ...
      private function § !9§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_.§+R§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§]!6§.x + _loc6_.aabb.§ 1§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§]!6§.y + _loc6_.aabb.§ 1§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§]!6§.x + _loc7_.aabb.§ 1§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§]!6§.y + _loc7_.aabb.§ 1§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         _loc5_.§7! § = null;
         _loc5_.aabb.§2!A§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            {
               _loc4_.aabb.§2!A§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
      ...
      private function §76§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc5_ = _loc3_.aabb;
               _loc3_.aabb = b2AABB.§2!A§(_loc3_.child1.aabb,_loc3_.child2.aabb);
