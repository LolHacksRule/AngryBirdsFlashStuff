package §0!2§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §1D§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§3c§ = §8U§;
            _loc7_ = this.§9M§.§%?§(param1.indexA[0]);
            ...
            this.§&9§.x = _loc15_ - _loc13_;
            this.§&9§.y = _loc16_ - _loc14_;
            this.§&9§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§3c§ = §<'§;
            _loc8_ = this.§9M§.§%?§(param1.indexA[0]);
            _loc9_ = this.§9M§.§%?§(param1.indexA[1]);
            _loc10_ = this.§?=§.§%?§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§&9§ = b2Math.§;!O§(b2Math.§`#§(_loc9_,_loc8_),1);
            this.§&9§.Normalize();
            _loc20_ = this.§&9§;
         ...
         else if(param1.indexA[0] == param1.indexA[0])
         {
            ...
            this.§&9§ = b2Math.§;!O§(b2Math.§`#§(_loc12_,_loc11_),1);
            this.§&9§.Normalize();
            _loc20_ = this.§&9§;
         ...
         else
         {
            ...
            _loc11_ = this.§?=§.§%?§(param1.indexB[0]);
            _loc12_ = this.§?=§.§%?§(param1.indexB[1]);
            _loc23_ = b2Math.§1!F§(param3,_loc7_);
            _loc24_ = b2Math.§2c§(param3.R,b2Math.§`#§(_loc9_,_loc8_));
            _loc25_ = b2Math.§1!F§(param5,_loc10_);
            _loc26_ = b2Math.§2c§(param5.R,b2Math.§`#§(_loc12_,_loc11_));
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§2a§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§2a§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §8U§:
               _loc3_ = b2Math.§ set§(param1.R,this.§&9§);
               _loc4_ = b2Math.§ set§(param2.R,this.§&9§.§9"§());
               _loc5_ = this.§9M§.§"9§(_loc3_);
               _loc6_ = this.§?=§.§"9§(_loc4_);
               _loc7_ = b2Math.§1!F§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§1!F§(param2,_loc6_)).x - _loc7_.x) * this.§&9§.x + (_loc8_.y - _loc7_.y) * this.§&9§.y);
            case §<'§:
               _loc10_ = b2Math.§2c§(param1.R,this.§&9§);
               _loc7_ = b2Math.§1!F§(param1,this.m_localPoint);
               _loc4_ = b2Math.§ set§(param2.R,_loc10_.§9"§());
               _loc6_ = this.§?=§.§"9§(_loc4_);
               return Number(((_loc8_ = b2Math.§1!F§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §-b§:
               _loc10_ = b2Math.§2c§(param2.R,this.§&9§);
               _loc8_ = b2Math.§1!F§(param2,this.m_localPoint);
               _loc3_ = b2Math.§ set§(param1.R,_loc10_.§9"§());
               _loc5_ = this.§9M§.§"9§(_loc3_);
               return Number(((_loc7_ = b2Math.§1!F§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
