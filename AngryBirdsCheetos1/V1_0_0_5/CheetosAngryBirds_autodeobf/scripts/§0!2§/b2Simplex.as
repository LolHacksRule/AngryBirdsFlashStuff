package §0!2§
{
   ...
   class b2Simplex
   {
      ...
      public var §9!Z§:Vector.<b2SimplexVertex>;
      ...
      function b2Simplex()
      {
         ...
         this.§9!Z§ = new Vector.<b2SimplexVertex>(3);
         super();
         this.§9!Z§[0] = this.m_v1;
         this.§9!Z§[1] = this.m_v2;
         this.§9!Z§[2] = this.m_v3;
      }
      ...
      public function §+!!§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         this.§]!A§ = param1.count;
         var _loc8_:Vector.<b2SimplexVertex> = this.§9!Z§;
         var _loc9_:int = 0;
         while(_loc9_ < this.§]!A§)
         {
            ...
            _loc10_.§9!J§ = b2Math.§1!F§(param3,_loc6_);
            _loc10_.§<j§ = b2Math.§1!F§(param5,_loc7_);
            _loc10_.§ a§ = b2Math.§`#§(_loc10_.§<j§,_loc10_.§9!J§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§]!A§ > 1)
      ...
      public function §1!B§(param1:b2SimplexCache) : void
      {
         param1.§0V§ = this.§'Y§();
         param1.count = uint(this.§]!A§);
         var _loc2_:Vector.<b2SimplexVertex> = this.§9!Z§;
         var _loc3_:int = 0;
         while(_loc3_ < this.§]!A§)
         {
      ...
      public function §3e§() : b2Vec2
      {
         ...
         {
            case 1:
               return this.m_v1.§ a§.§9"§();
            case 2:
               _loc1_ = b2Math.§`#§(this.m_v2.§ a§,this.m_v1.§ a§);
               _loc2_ = b2Math.§9-§(_loc1_,this.m_v1.§ a§.§9"§());
               if(_loc2_ > 0)
               {
      ...
      public function §`!S§() : b2Vec2
      {
         switch(this.§]!A§)
         {
            ...
            case 1:
               return this.m_v1.§ a§;
            case 2:
               return new b2Vec2(this.m_v1.a * this.m_v1.§ a§.x + this.m_v2.a * this.m_v2.§ a§.x,this.m_v1.a * this.m_v1.§ a§.y + this.m_v2.a * this.m_v2.§ a§.y);
            default:
               b2Settings.b2Assert(false);
               return new b2Vec2();
         }
      ...
      public function §<k§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§]!A§)
         {
            case 0:
               ...
               break;
            case 1:
               param1.SetV(this.m_v1.§9!J§);
               param2.SetV(this.m_v1.§<j§);
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§9!J§.x + this.m_v2.a * this.m_v2.§9!J§.x;
               param1.y = this.m_v1.a * this.m_v1.§9!J§.y + this.m_v2.a * this.m_v2.§9!J§.y;
               param2.x = this.m_v1.a * this.m_v1.§<j§.x + this.m_v2.a * this.m_v2.§<j§.x;
               param2.y = this.m_v1.a * this.m_v1.§<j§.y + this.m_v2.a * this.m_v2.§<j§.y;
               break;
            case 3:
               param2.x = param1.x = this.m_v1.a * this.m_v1.§9!J§.x + this.m_v2.a * this.m_v2.§9!J§.x + this.m_v3.a * this.m_v3.§9!J§.x;
               param2.y = param1.y = this.m_v1.a * this.m_v1.§9!J§.y + this.m_v2.a * this.m_v2.§9!J§.y + this.m_v3.a * this.m_v3.§9!J§.y;
               break;
            default:
               b2Settings.b2Assert(false);
         }
      ...
      public function §'Y§() : Number
      {
         switch(this.§]!A§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§`#§(this.m_v1.§ a§,this.m_v2.§ a§).§>8§();
            case 3:
               return b2Math.§9-§(b2Math.§`#§(this.m_v2.§ a§,this.m_v1.§ a§),b2Math.§`#§(this.m_v3.§ a§,this.m_v1.§ a§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      {
         var _loc1_:b2Vec2 = this.m_v1.§ a§;
         var _loc2_:b2Vec2 = this.m_v2.§ a§;
      ...
      public function Solve3() : void
      {
         ...
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§9-§(_loc4_,_loc9_)) * b2Math.§9-§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§9-§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§9-§(_loc1_,_loc2_);
