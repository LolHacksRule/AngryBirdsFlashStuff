package §!!R§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private var §4!7§:Vector.<DisplayObject>;
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§4!7§ = new Vector.<DisplayObject>(0);
      }
      
      override public function dispose() : void
      {
         var _loc1_:int = this.§4!7§.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            this.§4!7§[_loc2_].dispose();
            _loc2_++;
         }
         super.dispose();
      }
      ...
      public function addChildAt(param1:DisplayObject, param2:int) : void
      {
         ...
         {
            param1.§,q§();
            this.§4!7§.splice(param2,0,param1);
            param1.§`! §(this);
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§4!7§[param1];
            _loc3_.dispatchEvent(new Event(Event.§?]§,true));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§8!?§));
            }
            _loc3_.§`! §(null);
            this.§4!7§.splice(param1,1);
            if(param2)
            {
               _loc3_.dispose();
            }
      ...
      {
         var _loc2_:int = this.§4!7§.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            if(this.§4!7§[_loc3_].name == param1)
            {
               return this.§4!7§[_loc3_];
            }
            _loc3_++;
         }
         return null;
      ...
      {
         return this.§4!7§.indexOf(param1);
      }
      ...
      public function §[F§(param1:DisplayObject, param2:DisplayObject) : void
      {
         ...
         this.§5Q§(_loc3_,_loc4_);
      }
      
      public function §5Q§(param1:int, param2:int) : void
      {
         var _loc3_:DisplayObject = this.getChildAt(param1);
         var _loc4_:DisplayObject = this.getChildAt(param2);
         this.§4!7§[param1] = _loc4_;
         this.§4!7§[param2] = _loc3_;
      }
      
      public function §,!C§(param1:Function) : void
      {
         this.§4!7§ = this.§4!7§.sort(param1);
      }
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§4!7§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§4!7§.length;
         if(_loc3_ == 0)
         {
            §,r§(param1,§9]§);
            transformCoords(§9]§,0,0,§2T§);
            param2.x = §2T§.x;
            param2.y = §2T§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§4!7§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§4!7§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§4!7§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§4!7§[_loc6_];
            §,r§(_loc7_,§9]§);
            transformCoords(§9]§,_loc3_,_loc4_,§2T§);
            if(_loc8_ = _loc7_.hitTest(§2T§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§4!8§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§4!7§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§`;§();
               param1.§>]§(_loc5_);
      ...
      private function §]!@§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§4!7§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
