package §2k§
{
   ...
   public class Texture
   {
      ...
      public static function §"!1§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §2k§.Texture
      {
         return §&V§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §&V§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §2k§.Texture
      {
      ...
      public static function §'d§(param1:Context3D, param2:ByteArray) : §2k§.Texture
      {
         if(param1 == null)
         {
            throw new §@+§();
      ...
      public static function §'!T§(param1:§2k§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §2k§.Texture
      {
         var _loc4_:§2k§.Texture;
         (_loc4_ = new §8!'§(param1,param2)).§2!-§ = param3;
         return _loc4_;
      }
      
      public static function §"!7§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §2k§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§2k§.Texture = §&V§(param1,_loc6_,false,param5);
         if(!§ !+§.§+!§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§;Z§, param2:int, param3:int) : void
      {
         ...
         if(this.§2!-§)
         {
            ...
            param1.§6I§(param2,-this.§2!-§.x,-this.§2!-§.y);
            param1.§6I§(param2 + 1,-_loc4_,-this.§2!-§.y);
            param1.§6I§(param2 + 2,-this.§2!-§.x,-_loc5_);
            param1.§6I§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      ...
      public function get root() : §2k§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §2k§.Texture
      {
         return this;
      }
