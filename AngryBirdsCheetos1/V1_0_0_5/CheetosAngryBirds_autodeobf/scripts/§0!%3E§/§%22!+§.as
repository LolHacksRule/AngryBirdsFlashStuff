package §0!>§
{
   ...
   public class §"!+§
   {
      ...
      public static function §&2§() : String
      {
         ...
         var _loc5_:String;
         return (_loc5_ = §;I§(_loc2_ + _loc4_ + _loc3_ + counter++).toUpperCase()).substring(0,8) + _loc5_.substring(8,12) + _loc5_.substring(12,16) + _loc5_.substring(16,20) + _loc5_.substring(20,32);
      }
      ...
      {
         return §"r§(§1i§(§7!E§(param1),param1.length * 8));
      }
      
      private static function §1i§(param1:Array, param2:Number) : Array
      {
         ...
         while(_loc9_ < param1.length)
         {
            ...
            while(_loc15_ < 80)
            {
               ...
               _loc16_ = §7m§(§7m§(§[!>§(_loc4_,5),sha1_ft(_loc15_,_loc5_,_loc6_,_loc7_)),§7m§(§7m§(_loc8_,_loc3_[_loc15_]),sha1_kt(_loc15_)));
               _loc8_ = _loc7_;
               _loc7_ = _loc6_;
               _loc6_ = §[!>§(_loc5_,30);
               _loc5_ = _loc4_;
            ...
            _loc4_ = §7m§(_loc4_,_loc10_);
            _loc5_ = §7m§(_loc5_,_loc11_);
            _loc6_ = §7m§(_loc6_,_loc12_);
            _loc7_ = §7m§(_loc7_,_loc13_);
            _loc8_ = §7m§(_loc8_,_loc14_);
            _loc9_ += 16;
         }
      ...
      private static function §7m§(param1:Number, param2:Number) : Number
      {
      ...
      private static function §7!E§(param1:String) : Array
      {
