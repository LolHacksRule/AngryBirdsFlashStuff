package §,B§
{
   ...
   public class §?!X§
   {
      ...
      public static function §8?§(param1:XMLList, param2:XMLList, param3:XMLList) : void
      {
         var _loc4_:XML = null;
         §;!<§ = new Array();
      ...
      {
         §;!<§[§;!<§.length] = new §9x§(param1,param2,param3,param4,param5,param6,param7,param8);
      }
      
      public static function §<L§(param1:String) : §9x§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §;!<§.length)
         {
            if((§;!<§[_loc2_] as §9x§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §9x§(§;!<§[_loc2_]);
            }
            _loc2_++;
