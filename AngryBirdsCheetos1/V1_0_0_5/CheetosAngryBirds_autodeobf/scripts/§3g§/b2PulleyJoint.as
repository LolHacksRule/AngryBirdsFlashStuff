package §3g§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         this.m_maxLength1 = b2Math.§2!8§(param1.§+b§,this.§ !M§ - this.§'+§ * b2internal::9$);
         this.m_maxLength2 = b2Math.§2!8§(param1.§"D§,(this.§ !M§ - b2internal::9$) / this.§'+§);
         this.§8v§ = 0;
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.m_limitMass1 = _loc2_.§9g§ + _loc2_.§8>§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§9g§ + _loc3_.§8>§ * _loc22_ * _loc22_;
         ...
         {
            this.§8v§ *= param1.§5!B§;
            this.m_limitImpulse1 *= param1.§5!B§;
            this.m_limitImpulse2 *= param1.§5!B§;
            ...
            _loc2_.§0+§.x += _loc2_.§9g§ * _loc23_;
            _loc2_.§0+§.y += _loc2_.§9g§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§8>§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§0+§.x += _loc3_.§9g§ * _loc25_;
            _loc3_.§0+§.y += _loc3_.§9g§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§!u§ == b2internal::'5)
         {
            ...
            _loc20_ = this.§8v§;
            this.§8v§ = b2Math.§&f§(0,this.§8v§ + _loc19_);
            ...
            _loc2_.§0+§.x += _loc2_.§9g§ * _loc14_;
            _loc2_.§0+§.y += _loc2_.§9g§ * _loc15_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§!u§ == b2internal::'5)
         {
            ...
            _loc19_ = b2Math.§2a§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            ...
            _loc2_.m_sweep.c.x += _loc2_.§9g§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§9g§ * _loc14_;
