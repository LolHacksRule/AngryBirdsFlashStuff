   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§&!E§ && this.§^!H§ != b2internal::@!L)
         {
            ...
            _loc15_ = this.§>G§;
            _loc16_ = param1.§7?§ * this.§]d§;
            this.§>G§ = b2Math.§2a§(this.§>G§ + _loc14_,-_loc16_,_loc16_);
         ...
         if(this.§%+§ && this.§^!H§ != b2internal::1&)
         {
            ...
            _loc19_ = this.§@X§.§]!7§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§8v§.§[X§(_loc19_);
            if(this.§^!H§ == b2internal::1!6)
            {
            ...
            {
               this.§8v§.y = b2Math.§2!8§(this.§8v§.y,0);
            }
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§%+§)
         {
            ...
            if(b2Math.§<!K§(this.§-4§ - this.§%! §) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§2a§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§<!K§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§%! §)
            {
               _loc19_ = b2Math.§2a§(_loc34_ - this.§%! § + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§%! § - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§-4§)
            {
               _loc19_ = b2Math.§2a§(_loc34_ - this.§-4§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§@X§.§]!7§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::5!M;
