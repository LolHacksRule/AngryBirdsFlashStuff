package §3g§
{
   ...
   public class b2MouseJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§;!8§ = param1.§7?§ * (_loc5_ + param1.§7?§ * _loc6_);
         this.§;!8§ = this.§;!8§ != 0 ? Number(1 / this.§;!8§) : Number(0);
         this.§8S§ = param1.§7?§ * _loc6_ * this.§;!8§;
         ...
         _loc2_.§0+§.x += _loc11_ * this.§8v§.x;
         _loc2_.§0+§.y += _loc11_ * this.§8v§.y;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§8v§.x += _loc10_;
         this.§8v§.y += _loc11_;
         var _loc14_:Number = param1.§7?§ * this.§9Z§;
         if(this.§8v§.§8!%§() > _loc14_ * _loc14_)
         {
            this.§8v§.§5y§(_loc14_ / this.§8v§.§>8§());
         }
         _loc10_ = this.§8v§.x - _loc12_;
         _loc11_ = this.§8v§.y - _loc13_;
         _loc2_.§0+§.x += _loc2_.§9g§ * _loc10_;
         _loc2_.§0+§.y += _loc2_.§9g§ * _loc11_;
