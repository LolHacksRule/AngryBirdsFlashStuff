   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§<W§)
         {
            ...
            this.§8v§.z *= param1.§5!B§;
            _loc4_.§0+§.x -= _loc10_ * this.§8v§.x;
            _loc4_.§0+§.y -= _loc10_ * this.§8v§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§8v§.y - _loc7_ * this.§8v§.x + this.§8v§.z);
            _loc5_.§0+§.x += _loc11_ * this.§8v§.x;
            _loc5_.§0+§.y += _loc11_ * this.§8v§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc19_:Number = b2Math.§<!K§(_loc16_);
         if(_loc18_ > _loc17_)
         {
            _loc12_ *= 1;
            _loc13_ *= 1;
