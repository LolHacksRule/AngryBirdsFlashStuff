package §1!H§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §,b§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §2&§:b2Vec2;
      
      b2internal var §9!Z§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         §3c§ = b2internal::9!T;
         this.§2&§ = new b2Vec2();
         this.§9!Z§ = new Vector.<b2Vec2>();
         this.§3!S§ = new Vector.<b2Vec2>();
         §-!C§ = b2Settings.b2_polygonRadius;
         this.§2&§.§^!#§();
      }
      
      public static function §^L§(param1:Array, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§8J§(param1,param2);
         return _loc3_;
      }
      
      public static function §-3§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function § !5§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function include(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §+J§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§[X§(new b2Vec2(0,0));
            _loc3_.§[X§(_loc9_);
            _loc3_.§[X§(_loc10_);
            _loc3_.§5y§(_loc16_ * _loc7_);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §@q§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§5L§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§5L§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            while(_loc3_ < this.§0!'§)
            {
               this.§9!Z§[_loc3_].SetV(_loc2_.§9!Z§[_loc3_]);
      ...
      public function §8J§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function §1#§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§0!'§)
         {
            this.§9!Z§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§0!'§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§0!'§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§`#§(this.§9!Z§[_loc5_],this.§9!Z§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§8!%§() > Number.MIN_VALUE);
            this.§3!S§[_loc3_].SetV(b2Math.§;!O§(_loc6_,1));
            this.§3!S§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§2&§ = §+J§(this.§9!Z§,this.§0!'§);
      }
      ...
      public function §5=§(param1:Number, param2:Number) : void
      {
         this.§0!'§ = 4;
         this.§;g§(4);
         this.§9!Z§[0].Set(-param1,-param2);
         this.§9!Z§[1].Set(param1,-param2);
         this.§9!Z§[2].Set(param1,param2);
         this.§9!Z§[3].Set(-param1,param2);
         this.§3!S§[0].Set(0,-1);
         this.§3!S§[1].Set(1,0);
         this.§3!S§[2].Set(0,1);
         this.§3!S§[3].Set(-1,0);
      ...
      public function §?E§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§0!'§)
         {
            this.§9!Z§[_loc6_] = b2Math.§1!F§(_loc5_,this.§9!Z§[_loc6_]);
            this.§3!S§[_loc6_] = b2Math.§2c§(_loc5_.R,this.§3!S§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §-2§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§0!'§ = 2;
         this.§;g§(2);
         this.§9!Z§[0].SetV(param1);
         this.§9!Z§[1].SetV(param2);
         this.§2&§.x = 0.5 * (param1.x + param2.x);
         this.§2&§.y = 0.5 * (param1.y + param2.y);
         this.§3!S§[0] = b2Math.§;!O§(b2Math.§`#§(param2,param1),1);
         this.§3!S§[0].Normalize();
         this.§3!S§[1].x = -this.§3!S§[0].x;
         this.§3!S§[1].y = -this.§3!S§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§0!'§)
         {
            _loc6_ = (_loc9_ = this.§9!Z§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§3!S§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§]!6§.x = _loc5_ - b2internal::-!C;
         param1.§]!6§.y = _loc6_ - b2internal::-!C;
         param1.§ 1§.x = _loc7_ + b2internal::-!C;
         param1.§ 1§.y = _loc8_ + b2internal::-!C;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§0!'§ == 2)
         {
            param1.center.x = 0.5 * (this.§9!Z§[0].x + this.§9!Z§[1].x);
            param1.center.y = 0.5 * (this.§9!Z§[0].y + this.§9!Z§[1].y);
            param1.§?8§ = 0;
            param1.§@!V§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§0!'§)
         {
            _loc11_ = this.§9!Z§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§0!'§ ? this.§9!Z§[int(_loc10_ + 1)] : this.§9!Z§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§?8§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§@!V§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§ set§(param3.R,param1);
         ...
         {
            _loc7_[_loc12_] = b2Math.§"!&§(_loc5_,this.§9!Z§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§1!F§(param3,_loc24_.center));
                  return _loc24_.§?8§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§0!'§;
         var _loc14_:int = (_loc10_ + 1) % this.§0!'§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§9!Z§[_loc9_].x * (1 - _loc15_) + this.§9!Z§[_loc13_].x * _loc15_,this.§9!Z§[_loc9_].y * (1 - _loc15_) + this.§9!Z§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§9!Z§[_loc10_].x * (1 - _loc16_) + this.§9!Z§[_loc14_].x * _loc16_,this.§9!Z§[_loc10_].y * (1 - _loc16_) + this.§9!Z§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§9!Z§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§0!'§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§9!Z§[_loc12_];
            }
         ...
         _loc20_.§5y§(1 / _loc19_);
         param4.SetV(b2Math.§1!F§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §>!2§() : Vector.<b2Vec2>
      {
         return this.§9!Z§;
      }
      ...
      {
         var _loc2_:int = this.§9!Z§.length;
         while(_loc2_ < param1)
         {
            this.§9!Z§[_loc2_] = new b2Vec2();
