package §1!H§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc4_:Number = param1.position.x + (_loc3_.col1.x * this.§>w§.x + _loc3_.col2.x * this.§>w§.y);
         var _loc5_:Number = param1.position.y + (_loc3_.col1.y * this.§>w§.x + _loc3_.col2.y * this.§>w§.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc5_:Number = param3.position.x + (_loc4_.col1.x * this.§>w§.x + _loc4_.col2.x * this.§>w§.y);
         var _loc6_:Number = param3.position.y + (_loc4_.col1.y * this.§>w§.x + _loc4_.col2.y * this.§>w§.y);
         ...
         if(0 <= _loc15_ && _loc15_ <= param2.§,e§ * _loc13_)
         {
            _loc15_ /= _loc13_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         var _loc4_:Number = param2.position.x + (_loc3_.col1.x * this.§>w§.x + _loc3_.col2.x * this.§>w§.y);
         var _loc5_:Number = param2.position.y + (_loc3_.col1.y * this.§>w§.x + _loc3_.col2.y * this.§>w§.y);
         param1.§]!6§.Set(_loc4_ - b2internal::-!C,_loc5_ - b2internal::-!C);
         param1.§ 1§.Set(_loc4_ + b2internal::-!C,_loc5_ + b2internal::-!C);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§?8§ = param2 * b2Settings.b2_pi * b2internal::-!C * b2internal::-!C;
         param1.center.SetV(this.§>w§);
         param1.§@!V§ = param1.§?8§ * (0.5 * b2internal::-!C * b2internal::-!C + (this.§>w§.x * this.§>w§.x + this.§>w§.y * this.§>w§.y));
      }
      
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         var _loc9_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§1!F§(param3,this.§>w§);
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.§"!&§(param1,_loc5_) - param2)) < -b2internal::-!C + Number.MIN_VALUE)
         {
            return 0;
         }
