package §&S§
{
   ...
   public class §4!J§
   {
      ...
      public static function §^!3§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §8!V§(_loc2_);
         return §2+§.§^"§(_loc3_.readInt(),true) + §2+§.§^"§(_loc3_.readInt(),true) + §2+§.§^"§(_loc3_.readInt(),true) + §2+§.§^"§(_loc3_.readInt(),true) + §2+§.§^"§(_loc3_.readInt(),true);
      }
      
      public static function §]g§(param1:ByteArray) : String
      {
         var _loc2_:Array = §4!J§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §8!V§(_loc2_);
         return §2+§.§^"§(_loc3_.readInt(),true) + §2+§.§^"§(_loc3_.readInt(),true) + §2+§.§^"§(_loc3_.readInt(),true) + §2+§.§^"§(_loc3_.readInt(),true) + §2+§.§^"§(_loc3_.readInt(),true);
      }
      
      public static function §5!4§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §4!J§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §8!V§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §8!V§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
