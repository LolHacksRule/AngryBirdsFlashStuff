package §-r§
{
   ...
   class b2Simplex
   {
      ...
      public function §6!&§() : b2Vec2
      {
         ...
         switch(this.§ ]§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§5!B§(_loc1_,this.m_v1.§-T§.§"n§());
               if(_loc2_ > 0)
               {
      ...
      public function §?!?§() : Number
      {
         switch(this.§ ]§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§=_§(this.m_v1.§-T§,this.m_v2.§-T§).§2P§();
            case 3:
               return b2Math.§5!B§(b2Math.§=_§(this.m_v2.§-T§,this.m_v1.§-T§),b2Math.§=_§(this.m_v3.§-T§,this.m_v1.§-T§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc5_:Number = b2Math.§%!a§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§%!a§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§=_§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§%!a§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§%!a§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§=_§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§%!a§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§%!a§(_loc3_,_loc14_);
         var _loc18_:Number = -_loc15_;
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§5!B§(_loc4_,_loc9_)) * b2Math.§5!B§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§5!B§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§5!B§(_loc1_,_loc2_);
