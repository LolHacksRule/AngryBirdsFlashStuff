package §&!8§
{
   ...
   public class §,!D§
   {
      ...
      public static function §>s§(param1:MovieClip, param2:Boolean) : Array
      {
         ...
         _loc4_[3] = new b2Vec2((_loc3_.x + _loc3_.width) * § p§.§]!E§,_loc3_.y * § p§.§]!E§);
         _loc4_.reverse();
         return _loc4_;
      }
      ...
      public static function §"g§(param1:MovieClip, param2:Boolean) : Array
      {
         ...
         _loc3_[0] = _loc4_.width * § p§.§]!E§ / 2;
         _loc3_[1] = (_loc4_.x + _loc4_.width / 2) * § p§.§]!E§;
         _loc3_[2] = (_loc4_.y + _loc4_.height / 2) * § p§.§]!E§;
         return _loc3_;
      }
