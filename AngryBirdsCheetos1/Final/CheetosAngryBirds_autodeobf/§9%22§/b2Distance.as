package §9"§
{
   ...
   public class b2Distance
   {
      ...
      private static var §3f§:b2Simplex = new b2Simplex();
      
      private static var §2m§:Vector.<int> = new Vector.<int>(3);
      
      private static var §0!C§:Vector.<int> = new Vector.<int>(3);
      ...
      public static function §]!H§(param1:b2DistanceOutput, param2:b2SimplexCache, param3:b2DistanceInput) : void
      {
         ...
         var _loc15_:Number;
         var _loc14_:b2Vec2;
         var _loc16_:Number = _loc15_ = (_loc14_ = _loc8_.§"O§()).§27§();
         var _loc19_:int = 0;
         while(_loc19_ < 20)
         {
            _loc13_ = _loc8_.§#!A§;
            ...
            if((_loc16_ = (_loc18_ = _loc8_.§"O§()).§27§()) > _loc15_)
            {
            }
            _loc15_ = _loc16_;
         ...
         if(param3.§[!+§)
         {
            ...
            if(param1.§%!P§ > _loc23_ + _loc24_ && param1.§%!P§ > Number.MIN_VALUE)
            {
               ...
               param1.§^K§.y -= _loc24_ * _loc25_.y;
            }
            else
            {
               (_loc18_ = new b2Vec2()).x = 0.5 * (param1.§'[§.x + param1.§^K§.x);
               _loc18_.y = 0.5 * (param1.§'[§.y + param1.§^K§.y);
               param1.§'[§.x = param1.§^K§.x = _loc18_.x;
               param1.§'[§.y = param1.§^K§.y = _loc18_.y;
               param1.§%!P§ = 0;
            }
         }
      }
