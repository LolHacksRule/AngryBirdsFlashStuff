package §9"§
{
   ...
   class b2Simplex
   {
      ...
      public function §!!M§() : b2Vec2
      {
         ...
         switch(this.§#!A§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§0!Z§(_loc1_,this.m_v1.§?!Z§.§0R§());
               if(_loc2_ > 0)
               {
      ...
      public function §"O§() : b2Vec2
      {
         switch(this.§#!A§)
         {
            ...
            case 1:
               return this.m_v1.§?!Z§;
            case 2:
               return new b2Vec2(this.m_v1.a * this.m_v1.§?!Z§.x + this.m_v2.a * this.m_v2.§?!Z§.x,this.m_v1.a * this.m_v1.§?!Z§.y + this.m_v2.a * this.m_v2.§?!Z§.y);
            default:
               b2Settings.b2Assert(false);
               return new b2Vec2();
         }
      ...
      public function §&+§() : Number
      {
         switch(this.§#!A§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§4_§(this.m_v1.§?!Z§,this.m_v2.§?!Z§).§!Y§();
            case 3:
               return b2Math.§0!Z§(b2Math.§4_§(this.m_v2.§?!Z§,this.m_v1.§?!Z§),b2Math.§4_§(this.m_v3.§?!Z§,this.m_v1.§?!Z§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc5_:Number = b2Math.static(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.static(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§4_§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.static(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.static(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§4_§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.static(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.static(_loc3_,_loc14_);
         var _loc18_:Number = -_loc15_;
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§0!Z§(_loc4_,_loc9_)) * b2Math.§0!Z§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§0!Z§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§0!Z§(_loc1_,_loc2_);
