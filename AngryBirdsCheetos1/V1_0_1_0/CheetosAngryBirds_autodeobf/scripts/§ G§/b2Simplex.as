package § G§
{
   ...
   class b2Simplex
   {
      ...
      public function §1!B§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            _loc11_ = param1.§5L§;
            if((_loc12_ = this.§9M§()) < 0.5 * _loc11_ || 2 * _loc11_ < _loc12_ || _loc12_ < Number.MIN_VALUE)
            {
               this.§[B§ = 0;
            }
         }
      ...
      public function §`!S§() : b2Vec2
      {
         ...
         switch(this.§[B§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§2c§(_loc1_,this.m_v1.§+!!§.§<!#§());
               if(_loc2_ > 0)
               {
      ...
      public function §'Y§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§[B§)
         {
            ...
            case 1:
               ...
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§<j§.x + this.m_v2.a * this.m_v2.§<j§.x;
               param1.y = this.m_v1.a * this.m_v1.§<j§.y + this.m_v2.a * this.m_v2.§<j§.y;
               param2.x = this.m_v1.a * this.m_v1.§ a§.x + this.m_v2.a * this.m_v2.§ a§.x;
               param2.y = this.m_v1.a * this.m_v1.§ a§.y + this.m_v2.a * this.m_v2.§ a§.y;
               break;
            case 3:
               param2.x = param1.x = this.m_v1.a * this.m_v1.§<j§.x + this.m_v2.a * this.m_v2.§<j§.x + this.m_v3.a * this.m_v3.§<j§.x;
               param2.y = param1.y = this.m_v1.a * this.m_v1.§<j§.y + this.m_v2.a * this.m_v2.§<j§.y + this.m_v3.a * this.m_v3.§<j§.y;
               break;
            default:
               b2Settings.b2Assert(false);
         }
      ...
      public function §9M§() : Number
      {
         switch(this.§[B§)
         {
            ...
            case 3:
               return b2Math.§2c§(b2Math.§?d§(this.m_v2.§+!!§,this.m_v1.§+!!§),b2Math.§?d§(this.m_v3.§+!!§,this.m_v1.§+!!§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§2c§(_loc4_,_loc9_)) * b2Math.§2c§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§2c§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§2c§(_loc1_,_loc2_);
