package §3g§
{
   ...
   public class b2DistanceJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc13_:Number = _loc4_.§]m§ + _loc4_.§?0§ * _loc11_ * _loc11_ + _loc5_.§]m§ + _loc5_.§?0§ * _loc12_ * _loc12_;
         ...
         if(this.§"g§ > 0)
         {
            ...
            this.§;!8§ = param1.§%G§ * (_loc16_ + param1.§%G§ * _loc17_);
            this.§;!8§ = this.§;!8§ != 0 ? Number(1 / this.§;!8§) : Number(0);
            this.§ !Z§ = _loc14_ * param1.§%G§ * _loc17_ * this.§;!8§;
            this.§#!&§ = _loc13_ + this.§;!8§;
         ...
         if(param1.§%!+§)
         {
            ...
            _loc4_.§%=§.x -= _loc4_.§]m§ * _loc18_;
            _loc4_.§%=§.y -= _loc4_.§]m§ * _loc19_;
            _loc4_.m_angularVelocity -= _loc4_.§?0§ * (_loc6_ * _loc19_ - _loc7_ * _loc18_);
            _loc5_.§%=§.x += _loc5_.§]m§ * _loc18_;
            _loc5_.§%=§.y += _loc5_.§]m§ * _loc19_;
            _loc5_.m_angularVelocity += _loc5_.§?0§ * (_loc8_ * _loc19_ - _loc9_ * _loc18_);
         }
         else
         {
            this.§8v§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc3_.m_angularVelocity -= _loc3_.§?0§ * (_loc5_ * _loc17_ - _loc6_ * _loc16_);
         _loc4_.§%=§.x += _loc4_.§]m§ * _loc16_;
         _loc4_.§%=§.y += _loc4_.§]m§ * _loc17_;
         _loc4_.m_angularVelocity += _loc4_.§?0§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
      }
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         _loc3_.m_sweep.a -= _loc3_.§?0§ * (_loc5_ * _loc16_ - _loc6_ * _loc15_);
         _loc4_.m_sweep.c.x += _loc4_.§]m§ * _loc15_;
         _loc4_.m_sweep.c.y += _loc4_.§]m§ * _loc16_;
         _loc4_.m_sweep.a += _loc4_.§?0§ * (_loc8_ * _loc16_ - _loc9_ * _loc15_);
         _loc3_.§,M§();
         _loc4_.§,M§();
