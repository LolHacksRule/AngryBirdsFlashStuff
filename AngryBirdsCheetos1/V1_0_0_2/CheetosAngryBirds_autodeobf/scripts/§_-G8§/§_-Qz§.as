package §_-G8§
{
   ...
   public class §_-Qz§
   {
      ...
      public static function §_-9M§(param1:Stage) : void
      {
         ...
         §_-aC§ = param1;
         ExternalInterface.call(§_-zP§);
         ExternalInterface.call(§_-qh§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §_-8W§ = ExternalInterface.call(§_-FV§,ExternalInterface.objectID);
         if(§_-8W§ == §_-sx§)
         {
            return;
         }
      ...
      public static function get §_-Zz§() : int
      {
         return §_-8W§;
      }
      
      public static function get §_-jz§() : Boolean
      {
         return §_-e6§;
      }
      
      public static function set §_-jz§(param1:Boolean) : void
      {
         §_-e6§ = param1;
      }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §_-aC§.getObjectsUnderPoint(new Point(§_-aC§.mouseX,§_-aC§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
