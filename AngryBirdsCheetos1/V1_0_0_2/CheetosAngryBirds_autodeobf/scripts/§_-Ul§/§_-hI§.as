package §_-Ul§
{
   ...
   public class §_-hI§
   {
      ...
      public static function §_-ko§() : String
      {
         ...
         var _loc5_:String;
         return (_loc5_ = §_-fA§(_loc2_ + _loc4_ + _loc3_ + counter++).toUpperCase()).substring(0,8) + _loc5_.substring(8,12) + _loc5_.substring(12,16) + _loc5_.substring(16,20) + _loc5_.substring(20,32);
      }
      
      private static function §_-fA§(param1:String) : String
      {
         return §_-0-D§(param1);
      }
      
      private static function §_-0-D§(param1:String) : String
      {
         return §_-ON§(§_-qa§(§_-4d§(param1),param1.length * 8));
      }
      
      private static function §_-qa§(param1:Array, param2:Number) : Array
      {
         ...
         while(_loc9_ < param1.length)
         {
            ...
            while(_loc15_ < 80)
            {
               ...
               {
                  _loc3_[_loc15_] = §_-Go§(_loc3_[_loc15_ - 3] ^ _loc3_[_loc15_ - 8] ^ _loc3_[_loc15_ - 14] ^ _loc3_[_loc15_ - 16],1);
               }
               _loc16_ = §_-zJ§(§_-zJ§(§_-Go§(_loc4_,5),sha1_ft(_loc15_,_loc5_,_loc6_,_loc7_)),§_-zJ§(§_-zJ§(_loc8_,_loc3_[_loc15_]),sha1_kt(_loc15_)));
               _loc8_ = _loc7_;
               _loc7_ = _loc6_;
               _loc6_ = §_-Go§(_loc5_,30);
               _loc5_ = _loc4_;
               _loc4_ = _loc16_;
               _loc15_++;
            }
            _loc4_ = §_-zJ§(_loc4_,_loc10_);
            _loc5_ = §_-zJ§(_loc5_,_loc11_);
            _loc6_ = §_-zJ§(_loc6_,_loc12_);
            _loc7_ = §_-zJ§(_loc7_,_loc13_);
            _loc8_ = §_-zJ§(_loc8_,_loc14_);
            _loc9_ += 16;
         }
      ...
      private static function §_-zJ§(param1:Number, param2:Number) : Number
      {
      ...
      private static function §_-Go§(param1:Number, param2:Number) : Number
      {
         return param1 << param2 | param1 >>> 32 - param2;
      }
      
      private static function §_-4d§(param1:String) : Array
      {
      ...
      private static function §_-ON§(param1:Array) : String
      {
