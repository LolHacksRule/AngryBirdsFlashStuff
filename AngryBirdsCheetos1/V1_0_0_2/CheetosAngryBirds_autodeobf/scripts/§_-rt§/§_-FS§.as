package §_-rt§
{
   ...
   public class §_-FS§
   {
      ...
      public function §_-FS§(param1:*)
      {
         super();
         this.§_-cv§ = this.§_-hU§(param1);
      }
      ...
      private function §_-hU§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§_-jp§(param1 as String);
         }
         if(param1 is Number)
         {
         ...
         if(param1 is Array)
         {
            return this.§_-46§(param1 as Array);
         }
      ...
      private function §_-jp§(param1:String) : String
      {
      ...
      private function §_-46§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§_-hU§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §_-BN§(param1:Object) : String
      {
         ...
         if(classInfo.@name.toString() == "Object")
         {
            for(key in o)
            {
               ...
               if(!(value is Function))
               {
                  ...
                  s += this.§_-jp§(key) + ":" + this.§_-hU§(value);
               }
            }
         }
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§_-jp§(v.@name.toString()) + ":" + this.§_-hU§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
