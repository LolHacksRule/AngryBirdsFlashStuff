package §_-Jx§
{
   ...
   class b2SeparationFunction
   {
      ...
      public static const §_-WQ§:int = 1;
      ...
      public var §_-lK§:b2DistanceProxy;
      
      public var §_-gl§:b2DistanceProxy;
      
      public var §_-zO§:int;
      
      public var m_localPoint:b2Vec2;
      
      public var §_-WT§:b2Vec2;
      ...
      public function §_-M0§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§_-zO§ = §_-WQ§;
            _loc7_ = this.§_-lK§.§_-p5§(param1.indexA[0]);
            _loc10_ = this.§_-gl§.§_-p5§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§_-WT§.x = _loc15_ - _loc13_;
            this.§_-WT§.y = _loc16_ - _loc14_;
            this.§_-WT§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§_-zO§ = §_-IX§;
            _loc8_ = this.§_-lK§.§_-p5§(param1.indexA[0]);
            _loc9_ = this.§_-lK§.§_-p5§(param1.indexA[1]);
            _loc10_ = this.§_-gl§.§_-p5§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§_-WT§ = b2Math.§_-Gz§(b2Math.§_-Pq§(_loc9_,_loc8_),1);
            this.§_-WT§.Normalize();
            _loc20_ = this.§_-WT§;
         ...
         {
            this.§_-zO§ = §_-vC§;
            _loc11_ = this.§_-gl§.§_-p5§(param1.indexB[0]);
            _loc12_ = this.§_-gl§.§_-p5§(param1.indexB[1]);
            _loc7_ = this.§_-lK§.§_-p5§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§_-WT§ = b2Math.§_-Gz§(b2Math.§_-Pq§(_loc12_,_loc11_),1);
            this.§_-WT§.Normalize();
            _loc20_ = this.§_-WT§;
         ...
         else
         {
            ...
            _loc11_ = this.§_-gl§.§_-p5§(param1.indexB[0]);
            _loc12_ = this.§_-gl§.§_-p5§(param1.indexB[1]);
            _loc23_ = b2Math.§_-is§(param3,_loc7_);
            _loc24_ = b2Math.§_-WK§(param3.R,b2Math.§_-Pq§(_loc9_,_loc8_));
            _loc25_ = b2Math.§_-is§(param5,_loc10_);
            _loc26_ = b2Math.§_-WK§(param5.R,b2Math.§_-Pq§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§_-Pq§(_loc26_,_loc24_);
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§_-3V§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§_-3V§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §_-WQ§:
               _loc3_ = b2Math.§_-NJ§(param1.R,this.§_-WT§);
               _loc4_ = b2Math.§_-NJ§(param2.R,this.§_-WT§.§_-AB§());
               _loc5_ = this.§_-lK§.§_-y8§(_loc3_);
               _loc6_ = this.§_-gl§.§_-y8§(_loc4_);
               _loc7_ = b2Math.§_-is§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§_-is§(param2,_loc6_)).x - _loc7_.x) * this.§_-WT§.x + (_loc8_.y - _loc7_.y) * this.§_-WT§.y);
            case §_-IX§:
               _loc10_ = b2Math.§_-WK§(param1.R,this.§_-WT§);
               _loc7_ = b2Math.§_-is§(param1,this.m_localPoint);
               _loc4_ = b2Math.§_-NJ§(param2.R,_loc10_.§_-AB§());
               _loc6_ = this.§_-gl§.§_-y8§(_loc4_);
               return Number(((_loc8_ = b2Math.§_-is§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §_-vC§:
               _loc10_ = b2Math.§_-WK§(param2.R,this.§_-WT§);
               _loc8_ = b2Math.§_-is§(param2,this.m_localPoint);
               _loc3_ = b2Math.§_-NJ§(param1.R,_loc10_.§_-AB§());
               _loc5_ = this.§_-lK§.§_-y8§(_loc3_);
               return Number(((_loc7_ = b2Math.§_-is§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
