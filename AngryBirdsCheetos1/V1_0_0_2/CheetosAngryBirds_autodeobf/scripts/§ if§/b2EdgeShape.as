package § if§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      b2internal var §_-rC§:Number;
      
      b2internal var §_-D6§:b2Vec2;
      
      b2internal var §_-S7§:b2Vec2;
      ...
      b2internal var §_-VU§:b2EdgeShape;
      
      b2internal var §_-Yc§:b2EdgeShape;
      
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         this.§_-RT§ = new b2Vec2();
         this.m_v1 = new b2Vec2();
         this.m_v2 = new b2Vec2();
         this.m_coreV1 = new b2Vec2();
         this.m_coreV2 = new b2Vec2();
         this.§_-D6§ = new b2Vec2();
         this.§_-S7§ = new b2Vec2();
         this.m_cornerDir1 = new b2Vec2();
         this.m_cornerDir2 = new b2Vec2();
         super();
         §_-zO§ = b2internal::_-t9;
         this.§_-Yc§ = null;
         this.§_-VU§ = null;
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§_-S7§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§_-rC§ = this.§_-S7§.Normalize();
         this.§_-D6§.Set(this.§_-S7§.y,-this.§_-S7§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§_-D6§.x - this.§_-S7§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§_-D6§.y - this.§_-S7§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§_-D6§.x + this.§_-S7§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§_-D6§.y + this.§_-S7§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§_-D6§;
         this.m_cornerDir2.Set(-this.§_-D6§.x,-this.§_-D6§.y);
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§_-dK§ * _loc12_)
            {
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         if(_loc4_ < _loc6_)
         {
            param1.§_-jd§.x = _loc4_;
            param1.§_-V5§.x = _loc6_;
         }
         else
         {
            param1.§_-jd§.x = _loc6_;
            param1.§_-V5§.x = _loc4_;
         }
         if(_loc5_ < _loc7_)
         {
            param1.§_-jd§.y = _loc5_;
            param1.§_-V5§.y = _loc7_;
         }
         else
         {
            param1.§_-jd§.y = _loc7_;
            param1.§_-V5§.y = _loc5_;
         }
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§_-is§(param3,this.m_v1);
         var _loc7_:b2Vec2 = b2Math.§_-is§(param3,this.m_v2);
         var _loc8_:Number = b2Math.§_-Kt§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§_-Kt§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §_-O4§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §_-sF§() : b2EdgeShape
      {
         return this.§_-VU§;
      }
      
      public function §_-3Z§() : b2EdgeShape
      {
         return this.§_-Yc§;
      }
      
      public function § true§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
      ...
      b2internal function §_-4h§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§_-Yc§ = param1;
      ...
      b2internal function §_-t6§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§_-VU§ = param1;
