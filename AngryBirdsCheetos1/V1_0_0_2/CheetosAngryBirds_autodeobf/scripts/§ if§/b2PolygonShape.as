package § if§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §_-ao§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §_-9g§:b2Vec2;
      
      b2internal var §_-0F§:Vector.<b2Vec2>;
      
      b2internal var §_-yk§:Vector.<b2Vec2>;
      
      b2internal var §_-gw§:int;
      
      public function b2PolygonShape()
      {
         super();
         §_-zO§ = b2internal::_-Wf;
         this.§_-9g§ = new b2Vec2();
         this.§_-0F§ = new Vector.<b2Vec2>();
         this.§_-yk§ = new Vector.<b2Vec2>();
         §_-KL§ = b2Settings.b2_polygonRadius;
         this.§_-9g§.§_-t5§();
      }
      
      public static function §_-i4§(param1:Array, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-gZ§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-Yu§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-D5§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-BU§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-28§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-yQ§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§_-h§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §_-r7§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§_-IC§(param1,param2);
         return _loc3_;
      }
      
      public static function §_-0-T§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§_-5F§(new b2Vec2(0,0));
            _loc3_.§_-5F§(_loc9_);
            _loc3_.§_-5F§(_loc10_);
            _loc3_.§_-X-§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §_-do§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§_-NV§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§_-NV§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§_-9g§.SetV(_loc2_.§_-9g§);
            this.§_-gw§ = _loc2_.§_-gw§;
            this.§_-93§(this.§_-gw§);
            _loc3_ = 0;
            while(_loc3_ < this.§_-gw§)
            {
               this.§_-0F§[_loc3_].SetV(_loc2_.§_-0F§[_loc3_]);
               this.§_-yk§[_loc3_].SetV(_loc2_.§_-yk§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §_-gZ§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§_-D5§(_loc3_,param2);
      }
      
      public function §_-D5§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§_-gw§)
         {
            this.§_-0F§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§_-gw§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§_-gw§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§_-Pq§(this.§_-0F§[_loc5_],this.§_-0F§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§_-V4§() > Number.MIN_VALUE);
            this.§_-yk§[_loc3_].SetV(b2Math.§_-Gz§(_loc6_,1));
            this.§_-yk§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§_-9g§ = §_-0-T§(this.§_-0F§,this.§_-gw§);
      }
      
      public function §_-28§(param1:Number, param2:Number) : void
      {
         this.§_-gw§ = 4;
         this.§_-93§(4);
         this.§_-0F§[0].Set(-param1,-param2);
         this.§_-0F§[1].Set(param1,-param2);
         this.§_-0F§[2].Set(param1,param2);
         this.§_-0F§[3].Set(-param1,param2);
         this.§_-yk§[0].Set(0,-1);
         this.§_-yk§[1].Set(1,0);
         this.§_-yk§[2].Set(0,1);
         this.§_-yk§[3].Set(-1,0);
      ...
      public function §_-h§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§_-gw§ = 4;
         this.§_-93§(4);
         this.§_-0F§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§_-gw§)
         {
            this.§_-0F§[_loc6_] = b2Math.§_-is§(_loc5_,this.§_-0F§[_loc6_]);
            this.§_-yk§[_loc6_] = b2Math.§_-WK§(_loc5_.R,this.§_-yk§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §_-IC§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§_-gw§ = 2;
         this.§_-93§(2);
         this.§_-0F§[0].SetV(param1);
         this.§_-0F§[1].SetV(param2);
         this.§_-9g§.x = 0.5 * (param1.x + param2.x);
         this.§_-9g§.y = 0.5 * (param1.y + param2.y);
         this.§_-yk§[0] = b2Math.§_-Gz§(b2Math.§_-Pq§(param2,param1),1);
         this.§_-yk§[0].Normalize();
         this.§_-yk§[1].x = -this.§_-yk§[0].x;
         this.§_-yk§[1].y = -this.§_-yk§[0].y;
      }
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < this.§_-gw§)
         {
            _loc3_ = this.§_-0F§[_loc9_];
            _loc5_ = _loc7_ - _loc3_.x;
            _loc6_ = _loc8_ - _loc3_.y;
            _loc3_ = this.§_-yk§[_loc9_];
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§_-gw§)
         {
            _loc6_ = (_loc9_ = this.§_-0F§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§_-yk§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§_-jd§.x = _loc5_ - b2internal::_-KL;
         param1.§_-jd§.y = _loc6_ - b2internal::_-KL;
         param1.§_-V5§.x = _loc7_ + b2internal::_-KL;
         param1.§_-V5§.y = _loc8_ + b2internal::_-KL;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§_-gw§ == 2)
         {
            param1.center.x = 0.5 * (this.§_-0F§[0].x + this.§_-0F§[1].x);
            param1.center.y = 0.5 * (this.§_-0F§[0].y + this.§_-0F§[1].y);
            param1.§_-12§ = 0;
            param1.§_-2N§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§_-gw§)
         {
            _loc11_ = this.§_-0F§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§_-gw§ ? this.§_-0F§[int(_loc10_ + 1)] : this.§_-0F§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§_-12§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§_-2N§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§_-NJ§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§_-Kt§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§_-gw§)
         {
            _loc7_[_loc12_] = b2Math.§_-Kt§(_loc5_,this.§_-0F§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§_-is§(param3,_loc24_.center));
                  return _loc24_.§_-12§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§_-gw§;
         var _loc14_:int = (_loc10_ + 1) % this.§_-gw§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§_-0F§[_loc9_].x * (1 - _loc15_) + this.§_-0F§[_loc13_].x * _loc15_,this.§_-0F§[_loc9_].y * (1 - _loc15_) + this.§_-0F§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§_-0F§[_loc10_].x * (1 - _loc16_) + this.§_-0F§[_loc14_].x * _loc16_,this.§_-0F§[_loc10_].y * (1 - _loc16_) + this.§_-0F§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§_-0F§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§_-gw§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§_-0F§[_loc12_];
            }
         ...
         _loc20_.§_-X-§(1 / _loc19_);
         param4.SetV(b2Math.§_-is§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §_-ut§() : Vector.<b2Vec2>
      {
         return this.§_-0F§;
      }
      
      public function §_-Cd§() : Vector.<b2Vec2>
      {
         return this.§_-yk§;
      }
      
      public function §_-EM§(param1:b2Vec2) : int
      {
         var _loc5_:Number = NaN;
         var _loc2_:int = 0;
         var _loc3_:Number = this.§_-0F§[0].x * param1.x + this.§_-0F§[0].y * param1.y;
         var _loc4_:int = 1;
         while(_loc4_ < this.§_-gw§)
         {
      ...
      private function §_-xo§() : Boolean
      {
         return false;
      }
      
      private function §_-93§(param1:int) : void
      {
         var _loc2_:int = this.§_-0F§.length;
         while(_loc2_ < param1)
         {
            this.§_-0F§[_loc2_] = new b2Vec2();
            this.§_-yk§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
