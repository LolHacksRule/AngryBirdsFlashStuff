package §_-F2§
{
   public class b2Vec2
   {
      ...
      public static function §_-1l§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §_-5F§(param1:b2Vec2) : void
      {
         this.x += param1.x;
         this.y += param1.y;
      }
      ...
      public function §_-X-§(param1:Number) : void
      {
         this.x *= param1;
         this.y *= param1;
      }
      
      public function §_-N1§(param1:b2Mat22) : void
      {
      ...
      public function §_-0-c§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§_-Kt§(this,param1.col1);
         this.y = b2Math.§_-Kt§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      public function §_-kd§() : Number
      {
         return Math.sqrt(this.x * this.x + this.y * this.y);
      }
      
      public function §_-V4§() : Number
      {
      ...
      {
         return b2Math.§_-bU§(this.x) && b2Math.§_-bU§(this.y);
      }
   }
}
