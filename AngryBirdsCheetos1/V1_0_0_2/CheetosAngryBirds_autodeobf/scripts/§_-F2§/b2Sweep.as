package §_-F2§
{
   public class b2Sweep
   {
      ...
      public var §_-FO§:b2Vec2;
      
      public var a0:Number;
      
      public var a:Number;
      
      public var §_-4u§:Number;
      
      public function b2Sweep()
      {
         this.localCenter = new b2Vec2();
         this.c0 = new b2Vec2();
         this.§_-FO§ = new b2Vec2();
         super();
      }
      ...
      public function Set(param1:b2Sweep) : void
      {
         ...
         this.§_-FO§.SetV(param1.§_-FO§);
         this.a0 = param1.a0;
         this.a = param1.a;
         this.§_-4u§ = param1.§_-4u§;
      }
      ...
      public function §_-lD§(param1:b2Transform, param2:Number) : void
      {
         param1.position.x = (1 - param2) * this.c0.x + param2 * this.§_-FO§.x;
         param1.position.y = (1 - param2) * this.c0.y + param2 * this.§_-FO§.y;
      ...
      public function §_-px§(param1:Number) : void
      {
         ...
         if(this.§_-4u§ < param1 && 1 - this.§_-4u§ > Number.MIN_VALUE)
         {
            _loc2_ = (param1 - this.§_-4u§) / (1 - this.§_-4u§);
            this.c0.x = (1 - _loc2_) * this.c0.x + _loc2_ * this.§_-FO§.x;
            this.c0.y = (1 - _loc2_) * this.c0.y + _loc2_ * this.§_-FO§.y;
