package §_-H4§
{
   ...
   public class §_-m4§
   {
      ...
      public static var §_-XP§:ByteArray;
      ...
      public static function §_-4g§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-pg§(_loc2_);
         return §_-Oe§.§_-KM§(_loc3_.readInt(),true) + §_-Oe§.§_-KM§(_loc3_.readInt(),true) + §_-Oe§.§_-KM§(_loc3_.readInt(),true) + §_-Oe§.§_-KM§(_loc3_.readInt(),true) + §_-Oe§.§_-KM§(_loc3_.readInt(),true);
      }
      
      public static function §_-aX§(param1:ByteArray) : String
      {
         var _loc2_:Array = §_-m4§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §_-pg§(_loc2_);
         return §_-Oe§.§_-KM§(_loc3_.readInt(),true) + §_-Oe§.§_-KM§(_loc3_.readInt(),true) + §_-Oe§.§_-KM§(_loc3_.readInt(),true) + §_-Oe§.§_-KM§(_loc3_.readInt(),true) + §_-Oe§.§_-KM§(_loc3_.readInt(),true);
      }
      
      public static function §_-OI§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §_-m4§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-pg§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §_-pg§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
