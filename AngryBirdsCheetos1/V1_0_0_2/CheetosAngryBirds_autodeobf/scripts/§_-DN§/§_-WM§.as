package §_-DN§
{
   ...
   public class §_-WM§ extends §_-XW§
   {
       
      
      public function §_-WM§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§_-rn§(param1,param2);
      }
      
      protected function §_-rn§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc8_:int = 0;
         var _loc9_:int = 0;
         var _loc10_:§_-MN§ = null;
         var _loc11_:int = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         var _loc15_:Rectangle = null;
         var _loc16_:§_-F4§ = null;
         var _loc3_:Dictionary = this.§_-cf§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§_-zN§(_loc7_,_loc6_)]) == null)
            {
               ...
               {
                  _loc10_ = new §_-MN§(0,0,_loc11_,_loc12_,_loc13_,_loc14_);
               }
            }
            if(_loc10_)
            {
               _loc15_ = new Rectangle(_loc8_ + _loc10_.x,_loc9_ + _loc10_.y,_loc10_.width,_loc10_.height);
               (_loc16_ = new §_-F4§()).mName = _loc6_;
               _loc16_.§_-lT§ = _loc15_;
               _loc16_.§_-gL§ = _loc10_.pivotX;
               _loc16_.§_-q5§ = _loc10_.pivotY;
               _loc16_.§_-EL§ = §_-Lo§;
               §_-0B§(_loc16_);
            }
         }
      ...
      private function §_-zN§(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function §_-cf§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§_-zN§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §_-MN§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
