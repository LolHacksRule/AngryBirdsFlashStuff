package §_-ol§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§_-cR§.x * this.§_-NN§.x + (this.§_-Pi§ + this.§_-cR§.z) * this.§_-WT§.x),param1 * (this.§_-cR§.x * this.§_-NN§.y + (this.§_-Pi§ + this.§_-cR§.z) * this.§_-WT§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§_-18§ > Number.MIN_VALUE)
         {
            this.§_-18§ = 1 / this.§_-18§;
         }
         ...
         this.§_-0-8§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§_-0-8§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§_-0-8§.col2.x = this.§_-0-8§.col1.y;
         this.§_-0-8§.col2.y = _loc16_ + _loc17_;
         this.§_-0-8§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§_-0-8§.col3.x = this.§_-0-8§.col1.z;
         this.§_-0-8§.col3.y = this.§_-0-8§.col2.z;
         this.§_-0-8§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§_-j6§)
         {
         ...
         if(param1.§_-fo§)
         {
            ...
            _loc19_ = this.§_-cR§.x * this.§_-NN§.x + (this.§_-Pi§ + this.§_-cR§.z) * this.§_-WT§.x;
            _loc20_ = this.§_-cR§.x * this.§_-NN§.y + (this.§_-Pi§ + this.§_-cR§.z) * this.§_-WT§.y;
            _loc21_ = this.§_-cR§.x * this.m_s1 + this.§_-cR§.y + (this.§_-Pi§ + this.§_-cR§.z) * this.m_a1;
            _loc22_ = this.§_-cR§.x * this.m_s2 + this.§_-cR§.y + (this.§_-Pi§ + this.§_-cR§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§_-WT§.x * (_loc6_.x - _loc4_.x) + this.§_-WT§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§_-18§ * (this.§_-Z7§ - _loc14_);
            _loc16_ = this.§_-Pi§;
            _loc17_ = param1.§_-At§ * this.§_-0q§;
            this.§_-Pi§ = b2Math.§_-3V§(this.§_-Pi§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§_-Pi§ - _loc16_) * this.§_-WT§.x;
            _loc9_ = _loc15_ * this.§_-WT§.y;
         ...
         {
            _loc18_ = this.§_-WT§.x * (_loc6_.x - _loc4_.x) + this.§_-WT§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§_-cR§.Copy();
            _loc20_ = this.§_-0-8§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§_-cR§.§_-5F§(_loc20_);
            if(this.§_-5v§ == b2internal::_-2p)
            {
               this.§_-cR§.z = b2Math.§_-xk§(this.§_-cR§.z,0);
            }
            else if(this.§_-5v§ == b2internal::_-3g)
            {
               this.§_-cR§.z = b2Math.§_-E9§(this.§_-cR§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§_-cR§.z - _loc19_.z) * this.§_-0-8§.col3.x;
            _loc22_ = -_loc13_ - (this.§_-cR§.z - _loc19_.z) * this.§_-0-8§.col3.y;
            _loc23_ = this.§_-0-8§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§_-cR§.x = _loc23_.x;
            this.§_-cR§.y = _loc23_.y;
            _loc20_.x = this.§_-cR§.x - _loc19_.x;
            _loc20_.y = this.§_-cR§.y - _loc19_.y;
            _loc20_.z = this.§_-cR§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§_-NN§.x + _loc20_.z * this.§_-WT§.x;
            _loc9_ = _loc20_.x * this.§_-NN§.y + _loc20_.z * this.§_-WT§.y;
         ...
         {
            _loc24_ = this.§_-0-8§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§_-cR§.x += _loc24_.x;
            this.§_-cR§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§_-NN§.x;
            _loc9_ = _loc24_.x * this.§_-NN§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§_-j6§)
         {
            ...
            _loc35_ = this.§_-WT§.x * _loc26_ + this.§_-WT§.y * _loc27_;
            if(b2Math.§_-qe§(this.§_-PT§ - this.§_-4j§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§_-3V§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§_-qe§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§_-4j§)
            {
               _loc19_ = b2Math.§_-3V§(_loc35_ - this.§_-4j§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§_-4j§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§_-PT§)
            {
               _loc19_ = b2Math.§_-3V§(_loc35_ - this.§_-PT§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§_-PT§;
               _loc18_ = true;
            }
         }
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§ use§;
         _loc16_ = b2Math.§_-xk§(_loc16_,b2Math.§_-qe§(_loc29_));
         _loc17_ = b2Math.§_-qe§(_loc30_);
         if(_loc18_)
         {
            ...
            this.§_-0-8§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§_-0-8§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§_-0-8§.col2.x = this.§_-0-8§.col1.y;
            this.§_-0-8§.col2.y = _loc14_ + _loc15_;
            this.§_-0-8§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§_-0-8§.col3.x = this.§_-0-8§.col1.z;
            this.§_-0-8§.col3.y = this.§_-0-8§.col2.z;
            this.§_-0-8§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§_-0-8§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::_-y9;
            ...
            this.§_-0-8§.col1.Set(_loc36_,_loc37_,0);
            this.§_-0-8§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§_-0-8§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§_-NN§.x + _loc28_.z * this.§_-WT§.x;
         var _loc32_:Number = _loc28_.x * this.§_-NN§.y + _loc28_.z * this.§_-WT§.y;
         ...
         _loc6_.x -= b2internal::_-y9 * _loc31_;
         _loc6_.y -= b2internal::_-y9 * _loc32_;
         _loc7_ -= b2internal::_-Yh * _loc33_;
         _loc8_.x += b2internal::_-dJ * _loc31_;
         _loc8_.y += b2internal::_-dJ * _loc32_;
         _loc9_ += b2internal::_-ae * _loc34_;
