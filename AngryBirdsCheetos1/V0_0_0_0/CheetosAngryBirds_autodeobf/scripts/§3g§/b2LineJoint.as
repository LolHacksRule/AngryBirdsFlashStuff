package §3g§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§8v§.x * this.§5!§.x + (this.§>G§ + this.§8v§.y) * this.§&9§.x),param1 * (this.§8v§.x * this.§5!§.y + (this.§>G§ + this.§8v§.y) * this.§&9§.y));
      }
      ...
      public function §4[§() : Number
      {
         ...
         var _loc8_:b2Vec2;
         return Number((_loc8_ = _loc1_.§^T§(this.§9!M§)).x * _loc6_ + _loc8_.y * _loc7_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         b2internal::]?.SetV(_loc2_.§if§());
         b2internal::7U.SetV(_loc3_.§if§());
         ...
         §5%§ = _loc2_.§?0§;
         §2]§ = _loc3_.§?0§;
         this.§&9§.SetV(b2Math.§ set§(_loc6_.R,this.§9!M§));
         ...
         this.§9<§ = this.§9<§ > Number.MIN_VALUE ? Number(1 / this.§9<§) : Number(0);
         this.§5!§.SetV(b2Math.§ set§(_loc6_.R,this.§8o§));
         ...
         if(this.§%+§)
         {
            ...
            if(b2Math.§>8§(this.§-4§ - this.§%! §) < 2 * b2Settings.b2_linearSlop)
            {
               this.§^!H§ = b2internal::@!L;
            }
         ...
         if(param1.§%!+§)
         {
            ...
            this.§8v§.y *= param1.§#b§;
            this.§>G§ *= param1.§#b§;
            _loc19_ = this.§8v§.x * this.§5!§.x + (this.§>G§ + this.§8v§.y) * this.§&9§.x;
            _loc20_ = this.§8v§.x * this.§5!§.y + (this.§>G§ + this.§8v§.y) * this.§&9§.y;
            _loc21_ = this.§8v§.x * this.m_s1 + (this.§>G§ + this.§8v§.y) * this.m_a1;
            _loc22_ = this.§8v§.x * this.m_s2 + (this.§>G§ + this.§8v§.y) * this.m_a2;
            _loc2_.§%=§.x -= b2internal::5!M * _loc19_;
            _loc2_.§%=§.y -= b2internal::5!M * _loc20_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§&!E§ && this.§^!H§ != b2internal::@!L)
         {
            ...
            _loc14_ = this.§9<§ * (this.§+>§ - _loc13_);
            _loc15_ = this.§>G§;
            _loc16_ = param1.§%G§ * this.§]d§;
            this.§>G§ = b2Math.§?!&§(this.§>G§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§>G§ - _loc15_) * this.§&9§.x;
         ...
         if(this.§%+§ && this.§^!H§ != b2internal::1&)
         {
            ...
            _loc18_ = this.§8v§.Copy();
            _loc19_ = this.§@X§.§;!D§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§8v§.§`!§(_loc19_);
            if(this.§^!H§ == b2internal::1!6)
            {
               this.§8v§.y = b2Math.§2a§(this.§8v§.y,0);
            }
            else if(this.§^!H§ == b2internal::'5)
            {
               this.§8v§.y = b2Math.§&f§(this.§8v§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§8v§.y - _loc18_.y) * this.§@X§.col2.x;
            if(this.§@X§.col1.x != 0)
            {
            ...
            this.§8v§.x = _loc21_;
            _loc19_.x = this.§8v§.x - _loc18_.x;
            _loc19_.y = this.§8v§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§5!§.x + _loc19_.y * this.§&9§.x;
            _loc9_ = _loc19_.x * this.§5!§.y + _loc19_.y * this.§&9§.y;
         ...
         else
         {
            ...
            this.§8v§.x += _loc22_;
            _loc8_ = _loc22_ * this.§5!§.x;
            _loc9_ = _loc22_ * this.§5!§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc20_:b2Mat22 = b2Mat22.§"!Z§(_loc7_);
         var _loc21_:b2Mat22 = b2Mat22.§"!Z§(_loc9_);
         _loc10_ = _loc20_;
         ...
         if(this.§%+§)
         {
            this.§&9§ = b2Math.§ set§(_loc20_,this.§9!M§);
            ...
            {
               _loc19_ = b2Math.§?!&§(_loc34_ - this.§-4§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§-4§;
               _loc18_ = true;
            }
         }
         this.§5!§ = b2Math.§ set§(_loc20_,this.§8o§);
         ...
         _loc16_ = b2Math.§2a§(_loc16_,b2Math.§>8§(_loc29_));
         _loc17_ = 0;
         if(_loc18_)
         {
            ...
            this.§@X§.§;!D§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::5!M;
         ...
         var _loc30_:Number = _loc28_.x * this.§5!§.x + _loc28_.y * this.§&9§.x;
         var _loc31_:Number = _loc28_.x * this.§5!§.y + _loc28_.y * this.§&9§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::5!M * _loc30_;
         _loc6_.y -= b2internal::5!M * _loc31_;
         _loc7_ -= b2internal::5% * _loc32_;
         _loc8_.x += b2internal::+& * _loc30_;
         _loc8_.y += b2internal::+& * _loc31_;
         _loc9_ += b2internal::2] * _loc33_;
