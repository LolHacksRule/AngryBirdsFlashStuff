package §3g§
{
   ...
   public class b2RevoluteJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc8_ = _loc5_;
         var _loc10_:Number = _loc2_.§]m§;
         var _loc11_:Number = _loc3_.§]m§;
         var _loc12_:Number = _loc2_.§?0§;
         ...
         if(this.§%+§)
         {
            ...
            if(b2Math.§>8§(this.§#!<§ - this.§`!C§) < 2 * b2Settings.b2_angularSlop)
            {
               this.§^!H§ = b2internal::@!L;
            }
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc15_:Number = _loc2_.§]m§;
         var _loc16_:Number = _loc3_.§]m§;
         var _loc17_:Number = _loc2_.§?0§;
         var _loc18_:Number = _loc3_.§?0§;
         if(this.§&!E§ && this.§^!H§ != b2internal::@!L)
         {
            _loc19_ = _loc14_ - _loc12_ - this.§+>§;
            _loc20_ = this.§9<§ * -_loc19_;
            _loc21_ = this.§>G§;
            _loc22_ = param1.§%G§ * this.§[+§;
            this.§>G§ = b2Math.§?!&§(this.§>G§ + _loc20_,-_loc22_,_loc22_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§%+§ && this.§^!H§ != b2internal::1&)
         {
            ...
            if(this.§^!H§ == b2internal::@!L)
            {
               _loc3_ = b2Math.§?!&§(_loc25_ - this.§`!C§,-b2Settings.b2_maxAngularCorrection,b2Settings.b2_maxAngularCorrection);
            ...
            _loc5_.m_sweep.a -= _loc5_.§?0§ * _loc26_;
            _loc6_.m_sweep.a += _loc6_.§?0§ * _loc26_;
            _loc5_.§,M§();
            _loc6_.§,M§();
         }
         ...
         var _loc20_:Number = _loc5_.§]m§;
         var _loc21_:Number = _loc6_.§]m§;
         var _loc22_:Number = _loc5_.§?0§;
         ...
         this.§3Y§.§;q§(this.K2);
         this.§3Y§.§;q§(this.K3);
         this.§3Y§.§;!D§(§!s§,-_loc16_,-_loc17_);
         _loc10_ = §!s§.x;
         _loc11_ = §!s§.y;
         _loc5_.m_sweep.c.x -= _loc5_.§]m§ * _loc10_;
         _loc5_.m_sweep.c.y -= _loc5_.§]m§ * _loc11_;
         _loc5_.m_sweep.a -= _loc5_.§?0§ * (_loc12_ * _loc11_ - _loc13_ * _loc10_);
         _loc6_.m_sweep.c.x += _loc6_.§]m§ * _loc10_;
         _loc6_.m_sweep.c.y += _loc6_.§]m§ * _loc11_;
         _loc6_.m_sweep.a += _loc6_.§?0§ * (_loc14_ * _loc11_ - _loc15_ * _loc10_);
         _loc5_.§,M§();
         _loc6_.§,M§();
