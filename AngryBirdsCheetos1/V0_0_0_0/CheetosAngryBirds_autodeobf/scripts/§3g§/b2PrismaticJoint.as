   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§&!E§ && this.§^!H§ != b2internal::@!L)
         {
            ...
            _loc16_ = this.§>G§;
            _loc17_ = param1.§%G§ * this.§]d§;
            this.§>G§ = b2Math.§?!&§(this.§>G§ + _loc15_,-_loc17_,_loc17_);
         ...
         if(this.§%+§ && this.§^!H§ != b2internal::1&)
         {
            ...
            if(this.§^!H§ == b2internal::1!6)
            {
               this.§8v§.z = b2Math.§2a§(this.§8v§.z,0);
            }
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§%+§)
         {
            ...
            {
               _loc19_ = b2Math.§?!&§(_loc35_ - this.§-4§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
