package §-!C§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§94§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§6z§ = this.§94§.Normalize();
         this.§@!Q§.Set(this.§94§.y,-this.§94§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§@!Q§.x - this.§94§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§@!Q§.y - this.§94§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§@!Q§.x + this.§94§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§@!Q§.y + this.§94§.y) + this.m_v2.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§79§ * _loc12_)
            {
