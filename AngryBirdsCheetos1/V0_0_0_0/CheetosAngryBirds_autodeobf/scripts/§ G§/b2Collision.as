package § G§
{
   ...
   public class b2Collision
   {
      ...
      private static var §3!&§:Vector.<§&S§> = §7!L§();
      
      private static var s_clipPoints1:Vector.<§&S§> = §7!L§();
      
      private static var s_clipPoints2:Vector.<§&S§> = §7!L§();
      ...
      public static function §-`§(param1:Vector.<§&S§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc20_:§&S§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§^L§;
         var _loc8_:Vector.<b2Vec2> = param2.§0!'§;
         var _loc9_:int = param5.§^L§;
      ...
      public static function §`!V§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §"!6§[0] = _loc8_;
         var _loc9_:Number = §4!M§(§"!6§,param2,param3,param4,param5);
         _loc8_ = §"!6§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §9!<§[0] = _loc10_;
         var _loc11_:Number = §4!M§(§9!<§,param4,param5,param2,param3);
         _loc10_ = §9!<§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §4!I§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         ...
         if((_loc39_ = §]q§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §]q§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§39§.SetV(_loc27_);
      ...
      public static function §^!2§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§in § = 1;
            param1.§3c§ = b2Manifold.§-b§;
            param1.§39§.x = _loc15_ - _loc27_.x;
            param1.§39§.y = _loc16_ - _loc27_.y;
            param1.§39§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§in § = 1;
            param1.§3c§ = b2Manifold.§-b§;
            param1.§39§.x = _loc15_ - _loc28_.x;
            param1.§39§.y = _loc16_ - _loc28_.y;
            param1.§39§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§+!S§[0].m_localPoint.SetV(param4.§?8§);
            param1.§+!S§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§in § = 1;
            param1.§3c§ = b2Manifold.§-b§;
            param1.§39§.x = _loc23_[_loc25_].x;
            param1.§39§.y = _loc23_[_loc25_].y;
            param1.§39§.Normalize();
