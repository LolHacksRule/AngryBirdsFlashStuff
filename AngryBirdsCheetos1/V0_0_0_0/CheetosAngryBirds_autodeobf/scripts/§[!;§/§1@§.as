package §[!;§
{
   ...
   public class §1@§
   {
      ...
      private static function init() : void
      {
         ...
         §7i§[§,W§] = new Register(§,W§,"fragment output",3,0,§-1§ | override);
         ...
         while(_loc9_ < _loc10_ && this.§]§ == "")
         {
            ...
            else
            {
               ...
               if(_loc16_.flags & §"t§)
               {
                  ...
                  if(_loc7_ > §92§)
                  {
                     this.§]§ = "error: nesting to deep, maximum allowed is " + §92§ + ".";
                     break;
                  }
               }
               ...
               if(_loc8_ > §-!0§)
               {
                  this.§]§ = "error: too many opcodes. maximum is " + §-!0§ + ".";
                  break;
               }
               ...
               while(_loc21_ < _loc20_)
               {
                  ...
                  _loc31_ = _loc21_ == 2 && _loc16_.flags & § K§;
                  _loc32_ = 0;
                  _loc33_ = 0;
                  _loc34_ = 0;
                  if(_loc30_ && _loc22_)
