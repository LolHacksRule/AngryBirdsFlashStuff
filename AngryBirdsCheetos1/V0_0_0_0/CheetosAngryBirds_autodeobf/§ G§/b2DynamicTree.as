package § G§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §7=§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
         ...
         _loc3_.aabb.§,e§.x = param1.§,e§.x + _loc4_;
         _loc3_.aabb.§,e§.y = param1.§,e§.y + _loc5_;
         _loc3_.§7! § = param2;
         this.§76§(_loc3_);
         return _loc3_;
      }
      ...
      public function §]!T§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         ...
         param1.aabb.§,e§.x = param2.§,e§.x + _loc4_;
         param1.aabb.§,e§.y = param2.§,e§.y + _loc5_;
         this.§76§(param1);
         return true;
      }
      ...
      public function §`!8§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            ...
            {
               _loc3_ = !!(this.§24§ >> _loc4_ & 1) ? _loc3_.child2 : _loc3_.child1;
               _loc4_ = _loc4_ + 1 & 31;
            }
            ++this.§24§;
            this.§'!5§(_loc3_);
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         _loc9_.§,e§.y = Math.max(_loc3_.y,_loc11_);
      ...
      private function §76§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_.§#x§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§ 1§.x + _loc6_.aabb.§,e§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§ 1§.y + _loc6_.aabb.§,e§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§ 1§.x + _loc7_.aabb.§,e§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§ 1§.y + _loc7_.aabb.§,e§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         if(_loc4_)
         {
            ...
            while(!_loc4_.aabb.§2!A§(_loc5_.aabb))
            {
