package § G§
{
   ...
   public class b2TimeOfImpact
   {
      ...
      private static var §%v§:b2DistanceInput = new b2DistanceInput();
      ...
      private static var §4!K§:b2DistanceOutput = new b2DistanceOutput();
      ...
      public static function §=J§(param1:b2TOIInput) : Number
      {
         ...
         do
         {
            ...
            §%v§.§+]§ = §6+§;
            §%v§.§&!6§ = §=3§;
            b2Distance.§const§(§4!K§,§?!9§,§%v§);
            if(§4!K§.§ !@§ <= 0)
            {
               _loc8_ = 1;
               break;
            }
            §@P§.§1D§(§?!9§,_loc2_,§6+§,_loc3_,§=3§);
            if((_loc12_ = §@P§.Evaluate(§6+§,§=3§)) <= 0)
            {
               _loc8_ = 1;
               break;
            }
            if(_loc10_ == 0)
            {
               if(_loc12_ > _loc6_)
               {
                  _loc11_ = b2Math.§2a§(_loc6_ - _loc7_,0.75 * _loc6_);
               }
               else
               {
                  _loc11_ = b2Math.§2a§(_loc12_ - _loc7_,0.02 * _loc6_);
               }
            }
            ...
            _loc4_.§>B§(§6+§,_loc15_);
            _loc5_.§>B§(§=3§,_loc15_);
            if((_loc17_ = §@P§.Evaluate(§6+§,§=3§)) >= _loc11_)
            {
               _loc8_ = 1;
               break;
            }
            ...
            b2_toiMaxRootIters = b2Math.§2a§(b2_toiMaxRootIters,_loc18_);
         ...
         b2_toiMaxIters = b2Math.§2a§(b2_toiMaxIters,_loc10_);
         return _loc8_;
      }
   }
}
