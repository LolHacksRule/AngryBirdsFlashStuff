package §3g§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         this.m_groundAnchor1.x = param1.§,_§.x - this.§65§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§,_§.y - this.§65§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§1r§.x - this.§65§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§1r§.y - this.§65§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§4B§);
         this.m_localAnchor2.SetV(param1.§ !Q§);
         this.§'+§ = param1.§]7§;
         this.§ !M§ = param1.§,Z§ + this.§'+§ * param1.§ f§;
         this.m_maxLength1 = b2Math.§&f§(param1.§+b§,this.§ !M§ - this.§'+§ * b2internal::9$);
         this.m_maxLength2 = b2Math.§&f§(param1.§"D§,(this.§ !M§ - b2internal::9$) / this.§'+§);
         this.§8v§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§8v§ * this.m_u2.x,param1 * this.§8v§ * this.m_u2.y);
      }
      ...
      public function GetLength1() : Number
      {
         ...
         var _loc2_:Number = this.§65§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.§65§.m_xf.position.y + this.m_groundAnchor1.y;
      ...
      public function GetLength2() : Number
      {
         ...
         var _loc2_:Number = this.§65§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.§65§.m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc14_:Number = this.§65§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.§65§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.§65§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.§65§.m_xf.position.y + this.m_groundAnchor2.y;
         this.m_u1.Set(_loc10_ - _loc14_,_loc11_ - _loc15_);
         this.m_u2.Set(_loc12_ - _loc16_,_loc13_ - _loc17_);
         var _loc18_:Number = this.m_u1.§8!%§();
         var _loc19_:Number = this.m_u2.§8!%§();
         if(_loc18_ > b2Settings.b2_linearSlop)
         {
            this.m_u1.§?Q§(1 / _loc18_);
         }
         else
         {
            this.m_u1.§^!#§();
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§ !M§ - _loc18_ - this.§'+§ * _loc19_) > 0)
         {
            this.§!u§ = b2internal::1&;
            this.§8v§ = 0;
         }
         ...
         this.m_limitMass1 = _loc2_.§]m§ + _loc2_.§?0§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§]m§ + _loc3_.§?0§ * _loc22_ * _loc22_;
         this.§<Z§ = this.m_limitMass1 + this.§'+§ * this.§'+§ * this.m_limitMass2;
         ...
         {
            this.§8v§ *= param1.§#b§;
            this.m_limitImpulse1 *= param1.§#b§;
            this.m_limitImpulse2 *= param1.§#b§;
            _loc23_ = (-this.§8v§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§8v§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§'+§ * this.§8v§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§'+§ * this.§8v§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§%=§.x += _loc2_.§]m§ * _loc23_;
            _loc2_.§%=§.y += _loc2_.§]m§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§?0§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§%=§.x += _loc3_.§]m§ * _loc25_;
            _loc3_.§%=§.y += _loc3_.§]m§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§?0§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§8v§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§!u§ == b2internal::'5)
         {
            ...
            _loc20_ = this.§8v§;
            this.§8v§ = b2Math.§2a§(0,this.§8v§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§8v§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§'+§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§'+§ * _loc19_ * this.m_u2.y;
            _loc2_.§%=§.x += _loc2_.§]m§ * _loc14_;
            _loc2_.§%=§.y += _loc2_.§]m§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§?0§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§%=§.x += _loc3_.§]m§ * _loc16_;
            _loc3_.§%=§.y += _loc3_.§]m§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§?0§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
         if(this.m_limitState1 == b2internal::'5)
         {
            _loc10_ = _loc2_.§%=§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§%=§.y + _loc2_.m_angularVelocity * _loc5_;
            ...
            this.m_limitImpulse1 = b2Math.§2a§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == b2internal::'5)
         {
            _loc12_ = _loc3_.§%=§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§%=§.y + _loc3_.m_angularVelocity * _loc8_;
            ...
            this.m_limitImpulse2 = b2Math.§2a§(0,this.m_limitImpulse2 + _loc19_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal::2!D;
         var _loc3_:b2Body = b2internal::;B;
         var _loc5_:Number = this.§65§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.§65§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.§65§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.§65§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         if(this.§!u§ == b2internal::'5)
         {
            ...
            if(_loc18_ > b2Settings.b2_linearSlop)
            {
               this.m_u2.§?Q§(1 / _loc18_);
            }
            else
            {
               this.m_u2.§^!#§();
            }
            _loc19_ = this.§ !M§ - _loc17_ - this.§'+§ * _loc18_;
            _loc24_ = b2Math.§2a§(_loc24_,-_loc19_);
            ...
            _loc2_.m_sweep.a += _loc2_.§?0§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§]m§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§]m§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§?0§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§,M§();
            _loc3_.§,M§();
         }
         if(this.m_limitState1 == b2internal::'5)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§8!%§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::'5)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§8!%§()) > b2Settings.b2_linearSlop)
            {
