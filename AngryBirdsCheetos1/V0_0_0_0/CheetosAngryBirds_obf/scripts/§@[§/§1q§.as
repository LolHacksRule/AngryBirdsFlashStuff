package §@[§
{
   ...
   public class §1q§
   {
      ...
      private static var §%I§:Stage;
      
      private static var §8!1§:int;
      ...
      public static function §[I§(param1:Stage) : void
      {
         var _loc2_:Boolean = false;
                                    ...
                                    do
                                    {
                                       ...
                                       while(true)
                                       {
                                          if(!_loc2_)
                                          {
                                             ...
                                             while(!_loc2_)
                                             {
                                                §8!1§ = ExternalInterface.call(§]!9§,ExternalInterface.objectID);
                                                while(!_loc2_)
                                                {
                                                   if(_loc3_ || param1)
                                                   {
      ...
      public static function get static() : Boolean
      {
         return §+!Q§;
      }
      
      public static function set static(param1:Boolean) : void
      {
         var _loc2_:Boolean = false;
         var _loc3_:Boolean = true;
         if(_loc3_)
                        ...
                        if(!§§pop())
                        {
                           while(true)
                           {
                              ...
                              while(true)
                              {
                                 ...
                                 var _loc5_:Array;
                                 var _loc6_:DisplayObject = (_loc5_ = §%I§.getObjectsUnderPoint(new Point(§%I§.mouseX,§%I§.mouseY))).pop() as DisplayObject;
                                 addr133:
                                 if(_loc6_ != null)
                                 {
