package §_-i9§
{
   ...
   public class Texture
   {
      ...
      private var §_-6q§:Rectangle;
      
      private var §_-nC§:Boolean;
      ...
      public static function §_-6I§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §_-i9§.Texture
      {
         return §_-qA§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §_-qA§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §_-i9§.Texture
      {
         var _loc9_:BitmapData = null;
         var _loc10_:§_-fw§ = null;
         ...
         _loc10_ = new §_-fw§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§_-0A§.§_-CZ§)
         {
            _loc10_.§_-V9§(param2);
         }
         ...
         return new §_-DR§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §_-ue§(param1:Context3D, param2:ByteArray) : §_-i9§.Texture
      {
         if(param1 == null)
         {
            throw new §_-yF§();
         ...
         var _loc9_:§_-fw§ = new §_-fw§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§_-0A§.§_-CZ§)
         {
            _loc9_.§_-V9§(param2);
         }
      ...
      public static function §_-jQ§(param1:§_-i9§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §_-i9§.Texture
      {
         var _loc4_:§_-i9§.Texture;
         (_loc4_ = new §_-DR§(param1,param2)).§_-6q§ = param3;
         return _loc4_;
      }
      
      public static function §_-R7§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §_-i9§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§_-i9§.Texture = §_-qA§(param1,_loc6_,false,param5);
         if(!§_-0A§.§_-CZ§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§_-DS§, param2:int, param3:int) : void
      {
         ...
         if(this.§_-6q§)
         {
            ...
            _loc4_ = this.§_-6q§.width + this.§_-6q§.x - this.width;
            _loc5_ = this.§_-6q§.height + this.§_-6q§.y - this.height;
            param1.§_-Tx§(param2,-this.§_-6q§.x,-this.§_-6q§.y);
            param1.§_-Tx§(param2 + 1,-_loc4_,-this.§_-6q§.y);
            param1.§_-Tx§(param2 + 2,-this.§_-6q§.x,-_loc5_);
            param1.§_-Tx§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      
      public function get §_-vc§() : Rectangle
      {
         return !!this.§_-6q§ ? this.§_-6q§.clone() : new Rectangle(0,0,this.width,this.height);
      }
      ...
      public function get root() : §_-i9§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §_-i9§.Texture
      {
         return this;
      }
