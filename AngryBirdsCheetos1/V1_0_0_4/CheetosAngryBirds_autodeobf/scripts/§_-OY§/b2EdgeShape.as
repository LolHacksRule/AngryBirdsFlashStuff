package §_-OY§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      b2internal var §_-0M§:Number;
      
      b2internal var §_-61§:b2Vec2;
      
      b2internal var §_-qT§:b2Vec2;
      ...
      b2internal var §_-tB§:b2EdgeShape;
      
      b2internal var §_-UU§:b2EdgeShape;
      
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         this.§_-xt§ = new b2Vec2();
         this.m_v1 = new b2Vec2();
         this.m_v2 = new b2Vec2();
         this.m_coreV1 = new b2Vec2();
         this.m_coreV2 = new b2Vec2();
         this.§_-61§ = new b2Vec2();
         this.§_-qT§ = new b2Vec2();
         this.m_cornerDir1 = new b2Vec2();
         this.m_cornerDir2 = new b2Vec2();
         super();
         §_-Kg§ = b2internal::_-Jk;
         this.§_-UU§ = null;
         this.§_-tB§ = null;
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§_-qT§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§_-0M§ = this.§_-qT§.Normalize();
         this.§_-61§.Set(this.§_-qT§.y,-this.§_-qT§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§_-61§.x - this.§_-qT§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§_-61§.y - this.§_-qT§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§_-61§.x + this.§_-qT§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§_-61§.y + this.§_-qT§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§_-61§;
         this.m_cornerDir2.Set(-this.§_-61§.x,-this.§_-61§.y);
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§_-S2§ * _loc12_)
            {
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         if(_loc4_ < _loc6_)
         {
            param1.§_-00c§.x = _loc4_;
            param1.§_-ZN§.x = _loc6_;
         }
         else
         {
            param1.§_-00c§.x = _loc6_;
            param1.§_-ZN§.x = _loc4_;
         }
         if(_loc5_ < _loc7_)
         {
            param1.§_-00c§.y = _loc5_;
            param1.§_-ZN§.y = _loc7_;
         }
         else
         {
            param1.§_-00c§.y = _loc7_;
            param1.§_-ZN§.y = _loc5_;
         }
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§_-jR§(param3,this.m_v1);
         var _loc7_:b2Vec2 = b2Math.§_-jR§(param3,this.m_v2);
         var _loc8_:Number = b2Math.§_-kH§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§_-kH§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §_-M1§() : b2Vec2
      {
         return this.§_-61§;
      }
      
      public function §_-HC§() : b2Vec2
      {
         return this.§_-qT§;
      }
      ...
      public function §_-Cx§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §_-sV§() : b2EdgeShape
      {
         return this.§_-tB§;
      }
      
      public function §_-9K§() : b2EdgeShape
      {
         return this.§_-UU§;
      }
      
      public function §_-tO§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
      ...
      b2internal function §_-qd§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§_-UU§ = param1;
      ...
      b2internal function §_-Ic§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§_-tB§ = param1;
