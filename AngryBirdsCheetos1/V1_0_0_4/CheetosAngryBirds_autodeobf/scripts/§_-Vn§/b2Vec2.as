package §_-Vn§
{
   public class b2Vec2
   {
      ...
      public static function §_-h0§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §_-Ge§() : b2Vec2
      {
         return new b2Vec2(-this.x,-this.y);
      }
      
      public function §_-H8§() : void
      {
         this.x = -this.x;
         this.y = -this.y;
      }
      ...
      public function §_-vL§(param1:b2Vec2) : void
      {
         this.x += param1.x;
         this.y += param1.y;
      }
      
      public function §_-q0§(param1:b2Vec2) : void
      {
         this.x -= param1.x;
         this.y -= param1.y;
      }
      ...
      public function §_-L1§(param1:b2Mat22) : void
      {
      ...
      public function §_-L§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§_-kH§(this,param1.col1);
         this.y = b2Math.§_-kH§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      {
         return b2Math.§_-fM§(this.x) && b2Math.§_-fM§(this.y);
      }
   }
}
