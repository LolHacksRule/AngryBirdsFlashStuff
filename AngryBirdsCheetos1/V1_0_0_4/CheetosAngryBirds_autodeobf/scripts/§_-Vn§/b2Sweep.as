package §_-Vn§
{
   public class b2Sweep
   {
      ...
      public function Copy() : b2Sweep
      {
         ...
         _loc1_.a0 = this.a0;
         _loc1_.a = this.a;
         _loc1_.§_-4f§ = this.§_-4f§;
         return _loc1_;
      }
      
      public function §_-fs§(param1:b2Transform, param2:Number) : void
      {
      ...
      public function §_-Ng§(param1:Number) : void
      {
         ...
         if(this.§_-4f§ < param1 && 1 - this.§_-4f§ > Number.MIN_VALUE)
         {
            _loc2_ = (param1 - this.§_-4f§) / (1 - this.§_-4f§);
