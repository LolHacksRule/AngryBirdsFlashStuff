package §_-Y7§
{
   ...
   public class §_-Gz§
   {
      ...
      public static function §_-ZJ§() : String
      {
         ...
         var _loc5_:String;
         return (_loc5_ = §_-4h§(_loc2_ + _loc4_ + _loc3_ + counter++).toUpperCase()).substring(0,8) + _loc5_.substring(8,12) + _loc5_.substring(12,16) + _loc5_.substring(16,20) + _loc5_.substring(20,32);
      }
      
      private static function §_-4h§(param1:String) : String
      {
         return §_-0-U§(param1);
      }
      
      private static function §_-0-U§(param1:String) : String
      {
         return §_-J8§(§_-fd§(§_-7k§(param1),param1.length * 8));
      }
      
      private static function §_-fd§(param1:Array, param2:Number) : Array
      {
         ...
         while(_loc9_ < param1.length)
         {
            ...
            while(_loc15_ < 80)
            {
               ...
               {
                  _loc3_[_loc15_] = §_-b4§(_loc3_[_loc15_ - 3] ^ _loc3_[_loc15_ - 8] ^ _loc3_[_loc15_ - 14] ^ _loc3_[_loc15_ - 16],1);
               }
               _loc16_ = §finally§(§finally§(§_-b4§(_loc4_,5),sha1_ft(_loc15_,_loc5_,_loc6_,_loc7_)),§finally§(§finally§(_loc8_,_loc3_[_loc15_]),sha1_kt(_loc15_)));
               _loc8_ = _loc7_;
               _loc7_ = _loc6_;
               _loc6_ = §_-b4§(_loc5_,30);
               _loc5_ = _loc4_;
               _loc4_ = _loc16_;
               _loc15_++;
            }
            _loc4_ = §finally§(_loc4_,_loc10_);
            _loc5_ = §finally§(_loc5_,_loc11_);
            _loc6_ = §finally§(_loc6_,_loc12_);
            _loc7_ = §finally§(_loc7_,_loc13_);
            _loc8_ = §finally§(_loc8_,_loc14_);
            _loc9_ += 16;
         }
      ...
      private static function §finally§(param1:Number, param2:Number) : Number
      {
      ...
      private static function §_-b4§(param1:Number, param2:Number) : Number
      {
         return param1 << param2 | param1 >>> 32 - param2;
      }
      
      private static function §_-7k§(param1:String) : Array
      {
      ...
      private static function §_-J8§(param1:Array) : String
      {
