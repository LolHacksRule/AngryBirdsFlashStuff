package §_-Kz§
{
   ...
   public class b2Collision
   {
      ...
      private static var §_-i2§:Vector.<§_-c§> = §_-ZE§();
      
      private static var s_clipPoints1:Vector.<§_-c§> = §_-ZE§();
      
      private static var s_clipPoints2:Vector.<§_-c§> = §_-ZE§();
      
      private static var §_-005§:Vector.<int> = new Vector.<int>(1);
      
      private static var §_-gN§:Vector.<int> = new Vector.<int>(1);
      
      private static var §_-U-§:b2Vec2 = new b2Vec2();
      
      private static var §_-yy§:b2Vec2 = new b2Vec2();
      
      private static var §_-ie§:b2Vec2 = new b2Vec2();
      
      private static var §_-lZ§:b2Vec2 = new b2Vec2();
      
      private static var §_-e5§:b2Vec2 = new b2Vec2();
      ...
      public static function §_-pQ§(param1:Vector.<§_-c§>, param2:Vector.<§_-c§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§_-c§ = null;
         var _loc6_:int = 0;
      ...
      public static function §_-pP§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§_-Ta§;
         var _loc7_:Vector.<b2Vec2> = param1.§_-ja§;
         var _loc8_:Vector.<b2Vec2> = param1.§_-o8§;
         var _loc9_:int = param4.§_-Ta§;
         var _loc10_:Vector.<b2Vec2> = param4.§_-ja§;
         _loc11_ = param2.R;
      ...
      public static function §_-TR§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§_-Ta§;
         var _loc7_:Vector.<b2Vec2> = param2.§_-o8§;
         _loc9_ = param5.R;
         _loc8_ = param4.§_-Z5§;
         ...
         var _loc17_:Number = §_-pP§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §_-pP§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §_-pP§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §_-pP§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §_-vZ§(param1:Vector.<§_-c§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§_-c§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§_-Ta§;
         var _loc8_:Vector.<b2Vec2> = param2.§_-o8§;
         var _loc9_:int = param5.§_-Ta§;
         var _loc10_:Vector.<b2Vec2> = param5.§_-ja§;
         var _loc11_:Vector.<b2Vec2> = param5.§_-o8§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§_-Wp§.§_-t0§ = param4;
         _loc20_.id.§_-Wp§.§_-6B§ = _loc21_;
         _loc20_.id.§_-Wp§.§_-1o§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§_-Wp§.§_-t0§ = param4;
         _loc20_.id.§_-Wp§.§_-6B§ = _loc22_;
         _loc20_.id.§_-Wp§.§_-1o§ = 1;
      }
      
      private static function §_-ZE§() : Vector.<§_-c§>
      {
         var _loc1_:Vector.<§_-c§> = new Vector.<§_-c§>(2);
         _loc1_[0] = new §_-c§();
         _loc1_[1] = new §_-c§();
         return _loc1_;
      }
      
      public static function §_-NN§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§_-c§ = null;
         ...
         param1.§_-BX§ = 0;
         var _loc7_:Number = param2.§_-EG§ + param4.§_-EG§;
         var _loc8_:int = 0;
         §_-005§[0] = _loc8_;
         var _loc9_:Number = §_-TR§(§_-005§,param2,param3,param4,param5);
         _loc8_ = §_-005§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §_-gN§[0] = _loc10_;
         var _loc11_:Number = §_-TR§(§_-gN§,param4,param5,param2,param3);
         _loc10_ = §_-gN§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§_-Kg§ = b2Manifold.§_-VC§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§_-c§> = §_-i2§;
         §_-vZ§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§_-Ta§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§_-ja§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §_-U-§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §_-yy§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §_-ie§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §_-e5§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§_-c§> = s_clipPoints1;
         var _loc38_:Vector.<§_-c§> = s_clipPoints2;
         if((_loc39_ = §_-pQ§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §_-pQ§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§_-JV§.SetV(_loc27_);
         ...
         while(_loc41_ < b2Settings.b2_maxManifoldPoints)
         {
            ...
            if((_loc42_ = _loc31_.x * _loc6_.v.x + _loc31_.y * _loc6_.v.y - _loc34_) <= _loc7_)
            {
               ...
               _loc43_.m_id.§_-Wp§.§_-Em§ = _loc17_;
               _loc40_++;
            }
            _loc41_++;
         }
      ...
      public static function §_-q-§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§_-EG§ + param4.§_-EG§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§_-Kg§ = b2Manifold.§_-aM§;
         param1.m_localPoint.SetV(param2.§_-QL§);
         param1.§_-JV§.§return§();
         param1.§_-BX§ = 1;
         param1.§_-rg§[0].m_localPoint.SetV(param4.§_-QL§);
         param1.§_-rg§[0].m_id.key = 0;
      }
      
      public static function §_-Um§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§_-EG§ + param4.§_-EG§;
         var _loc21_:int = param2.§_-Ta§;
         var _loc22_:Vector.<b2Vec2> = param2.§_-ja§;
         var _loc23_:Vector.<b2Vec2> = param2.§_-o8§;
         var _loc24_:int = 0;
         ...
         if(_loc19_ < Number.MIN_VALUE)
         {
            param1.§_-BX§ = 1;
            param1.§_-Kg§ = b2Manifold.§_-VC§;
            param1.§_-JV§.SetV(_loc23_[_loc18_]);
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§_-BX§ = 1;
            param1.§_-Kg§ = b2Manifold.§_-VC§;
            param1.§_-JV§.x = _loc15_ - _loc27_.x;
            param1.§_-JV§.y = _loc16_ - _loc27_.y;
            param1.§_-JV§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§_-BX§ = 1;
            param1.§_-Kg§ = b2Manifold.§_-VC§;
            param1.§_-JV§.x = _loc15_ - _loc28_.x;
            param1.§_-JV§.y = _loc16_ - _loc28_.y;
            param1.§_-JV§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§_-rg§[0].m_localPoint.SetV(param4.§_-QL§);
            param1.§_-rg§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§_-BX§ = 1;
            param1.§_-Kg§ = b2Manifold.§_-VC§;
            param1.§_-JV§.x = _loc23_[_loc25_].x;
            param1.§_-JV§.y = _loc23_[_loc25_].y;
            param1.§_-JV§.Normalize();
      ...
      public static function §_-wl§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§_-00c§;
         var _loc4_:b2Vec2 = param1.§_-ZN§;
