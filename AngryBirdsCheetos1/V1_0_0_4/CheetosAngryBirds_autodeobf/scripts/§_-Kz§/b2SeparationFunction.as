package §_-Kz§
{
   ...
   class b2SeparationFunction
   {
      ...
      public static const §_-LX§:int = 1;
      ...
      public var §_-T6§:b2DistanceProxy;
      
      public var §_-aT§:b2DistanceProxy;
      
      public var §_-Kg§:int;
      
      public var m_localPoint:b2Vec2;
      
      public var §_-4C§:b2Vec2;
      ...
      public function §_-yN§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§_-Kg§ = §_-LX§;
            _loc7_ = this.§_-T6§.§_-QB§(param1.indexA[0]);
            _loc10_ = this.§_-aT§.§_-QB§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§_-4C§.x = _loc15_ - _loc13_;
            this.§_-4C§.y = _loc16_ - _loc14_;
            this.§_-4C§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§_-Kg§ = §_-VC§;
            _loc8_ = this.§_-T6§.§_-QB§(param1.indexA[0]);
            _loc9_ = this.§_-T6§.§_-QB§(param1.indexA[1]);
            _loc10_ = this.§_-aT§.§_-QB§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§_-4C§ = b2Math.§_-w§(b2Math.§_-FN§(_loc9_,_loc8_),1);
            this.§_-4C§.Normalize();
            _loc20_ = this.§_-4C§;
         ...
         {
            this.§_-Kg§ = §_-ma§;
            _loc11_ = this.§_-aT§.§_-QB§(param1.indexB[0]);
            _loc12_ = this.§_-aT§.§_-QB§(param1.indexB[1]);
            _loc7_ = this.§_-T6§.§_-QB§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§_-4C§ = b2Math.§_-w§(b2Math.§_-FN§(_loc12_,_loc11_),1);
            this.§_-4C§.Normalize();
            _loc20_ = this.§_-4C§;
         ...
         else
         {
            ...
            _loc11_ = this.§_-aT§.§_-QB§(param1.indexB[0]);
            _loc12_ = this.§_-aT§.§_-QB§(param1.indexB[1]);
            _loc23_ = b2Math.§_-jR§(param3,_loc7_);
            _loc24_ = b2Math.§_-E0§(param3.R,b2Math.§_-FN§(_loc9_,_loc8_));
            _loc25_ = b2Math.§_-jR§(param5,_loc10_);
            _loc26_ = b2Math.§_-E0§(param5.R,b2Math.§_-FN§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§_-FN§(_loc26_,_loc24_);
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§_-a4§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§_-a4§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §_-LX§:
               _loc3_ = b2Math.§_-dE§(param1.R,this.§_-4C§);
               _loc4_ = b2Math.§_-dE§(param2.R,this.§_-4C§.§_-Ge§());
               _loc5_ = this.§_-T6§.§_-cf§(_loc3_);
               _loc6_ = this.§_-aT§.§_-cf§(_loc4_);
               _loc7_ = b2Math.§_-jR§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§_-jR§(param2,_loc6_)).x - _loc7_.x) * this.§_-4C§.x + (_loc8_.y - _loc7_.y) * this.§_-4C§.y);
            case §_-VC§:
               _loc10_ = b2Math.§_-E0§(param1.R,this.§_-4C§);
               _loc7_ = b2Math.§_-jR§(param1,this.m_localPoint);
               _loc4_ = b2Math.§_-dE§(param2.R,_loc10_.§_-Ge§());
               _loc6_ = this.§_-aT§.§_-cf§(_loc4_);
               return Number(((_loc8_ = b2Math.§_-jR§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §_-ma§:
               _loc10_ = b2Math.§_-E0§(param2.R,this.§_-4C§);
               _loc8_ = b2Math.§_-jR§(param2,this.m_localPoint);
               _loc3_ = b2Math.§_-dE§(param1.R,_loc10_.§_-Ge§());
               _loc5_ = this.§_-T6§.§_-cf§(_loc3_);
               return Number(((_loc7_ = b2Math.§_-jR§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
