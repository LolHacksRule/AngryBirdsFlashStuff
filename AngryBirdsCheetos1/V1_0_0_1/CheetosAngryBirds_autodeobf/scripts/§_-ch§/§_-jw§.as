package §_-ch§
{
   ...
   public class §_-jw§
   {
      ...
      public static function §_-Eh§(param1:Stage) : void
      {
         ...
         §_-Ex§ = param1;
         ExternalInterface.call(§_-Vm§);
         ExternalInterface.call(§_-KC§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §_-nj§ = ExternalInterface.call(§_-M3§,ExternalInterface.objectID);
         if(§_-nj§ == §_-RA§)
         {
            return;
         }
      ...
      public static function get §_-el§() : int
      {
         return §_-nj§;
      }
      
      public static function get §_-PF§() : Boolean
      {
         return §_-w1§;
      }
      
      public static function set §_-PF§(param1:Boolean) : void
      {
         §_-w1§ = param1;
      }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §_-Ex§.getObjectsUnderPoint(new Point(§_-Ex§.mouseX,§_-Ex§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
