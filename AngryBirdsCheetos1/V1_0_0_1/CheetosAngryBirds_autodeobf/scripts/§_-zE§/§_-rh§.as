package §_-zE§
{
   ...
   public class §_-rh§
   {
      ...
      public function §_-rh§(param1:*)
      {
         super();
         this.§_-fG§ = this.§_-s8§(param1);
      }
      ...
      private function §_-s8§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§_-x9§(param1 as String);
         }
         if(param1 is Number)
         {
         ...
         if(param1 is Array)
         {
            return this.§_-7u§(param1 as Array);
         }
      ...
      private function §_-x9§(param1:String) : String
      {
      ...
      private function §_-7u§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§_-s8§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §_-T7§(param1:Object) : String
      {
         ...
         if(classInfo.@name.toString() == "Object")
         {
            for(key in o)
            {
               ...
               if(!(value is Function))
               {
                  ...
                  s += this.§_-x9§(key) + ":" + this.§_-s8§(value);
               }
            }
         }
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§_-x9§(v.@name.toString()) + ":" + this.§_-s8§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
