package §_-yI§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §_-Qz§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§_-f7§)
         {
            case b2Manifold.§_-qM§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§_-B0§[0].m_localPoint;
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§_-b2§.x = _loc19_ / _loc26_;
                  this.§_-b2§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§_-b2§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§_-b2§.x;
               _loc23_ = _loc16_ + param3 * this.§_-b2§.y;
               _loc24_ = _loc17_ - param5 * this.§_-b2§.x;
               _loc25_ = _loc18_ - param5 * this.§_-b2§.y;
               this.§_-B0§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§_-B0§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§_-86§:
               ...
               this.§_-b2§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§_-KL§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§_-B0§[_loc6_].m_localPoint;
                  ...
                  this.§_-B0§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§_-B0§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§_-LY§:
               ...
               while(_loc6_ < param1.§_-KL§)
               {
                  ...
                  this.§_-B0§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§_-B0§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
