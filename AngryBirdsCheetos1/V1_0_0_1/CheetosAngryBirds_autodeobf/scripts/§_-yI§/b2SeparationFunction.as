package §_-yI§
{
   ...
   class b2SeparationFunction
   {
      ...
      public static const §_-yz§:int = 1;
      ...
      public var §_-Ri§:b2DistanceProxy;
      
      public var §_-Dn§:b2DistanceProxy;
      
      public var §_-f7§:int;
      
      public var m_localPoint:b2Vec2;
      
      public var §_-40§:b2Vec2;
      ...
      public function §_-Qz§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§_-f7§ = §_-yz§;
            _loc7_ = this.§_-Ri§.§_-0-g§(param1.indexA[0]);
            _loc10_ = this.§_-Dn§.§_-0-g§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§_-40§.x = _loc15_ - _loc13_;
            this.§_-40§.y = _loc16_ - _loc14_;
            this.§_-40§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§_-f7§ = §_-86§;
            _loc8_ = this.§_-Ri§.§_-0-g§(param1.indexA[0]);
            _loc9_ = this.§_-Ri§.§_-0-g§(param1.indexA[1]);
            _loc10_ = this.§_-Dn§.§_-0-g§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§_-40§ = b2Math.§_-1F§(b2Math.§_-4g§(_loc9_,_loc8_),1);
            this.§_-40§.Normalize();
            _loc20_ = this.§_-40§;
         ...
         {
            this.§_-f7§ = §_-LY§;
            _loc11_ = this.§_-Dn§.§_-0-g§(param1.indexB[0]);
            _loc12_ = this.§_-Dn§.§_-0-g§(param1.indexB[1]);
            _loc7_ = this.§_-Ri§.§_-0-g§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§_-40§ = b2Math.§_-1F§(b2Math.§_-4g§(_loc12_,_loc11_),1);
            this.§_-40§.Normalize();
            _loc20_ = this.§_-40§;
         ...
         else
         {
            ...
            _loc11_ = this.§_-Dn§.§_-0-g§(param1.indexB[0]);
            _loc12_ = this.§_-Dn§.§_-0-g§(param1.indexB[1]);
            _loc23_ = b2Math.§_-GQ§(param3,_loc7_);
            _loc24_ = b2Math.§_-jK§(param3.R,b2Math.§_-4g§(_loc9_,_loc8_));
            _loc25_ = b2Math.§_-GQ§(param5,_loc10_);
            _loc26_ = b2Math.§_-jK§(param5.R,b2Math.§_-4g§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§_-4g§(_loc26_,_loc24_);
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§_-9P§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§_-9P§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §_-yz§:
               _loc3_ = b2Math.§_-8m§(param1.R,this.§_-40§);
               _loc4_ = b2Math.§_-8m§(param2.R,this.§_-40§.§_-oW§());
               _loc5_ = this.§_-Ri§.§_-pC§(_loc3_);
               _loc6_ = this.§_-Dn§.§_-pC§(_loc4_);
               _loc7_ = b2Math.§_-GQ§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§_-GQ§(param2,_loc6_)).x - _loc7_.x) * this.§_-40§.x + (_loc8_.y - _loc7_.y) * this.§_-40§.y);
            case §_-86§:
               _loc10_ = b2Math.§_-jK§(param1.R,this.§_-40§);
               _loc7_ = b2Math.§_-GQ§(param1,this.m_localPoint);
               _loc4_ = b2Math.§_-8m§(param2.R,_loc10_.§_-oW§());
               _loc6_ = this.§_-Dn§.§_-pC§(_loc4_);
               return Number(((_loc8_ = b2Math.§_-GQ§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §_-LY§:
               _loc10_ = b2Math.§_-jK§(param2.R,this.§_-40§);
               _loc8_ = b2Math.§_-GQ§(param2,this.m_localPoint);
               _loc3_ = b2Math.§_-8m§(param1.R,_loc10_.§_-oW§());
               _loc5_ = this.§_-Ri§.§_-pC§(_loc3_);
               return Number(((_loc7_ = b2Math.§_-GQ§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
