package §_-YA§
{
   ...
   public class §_-Q3§
   {
      ...
      public static var §_-Y3§:ByteArray;
       
      
      public function §_-Q3§()
      {
         super();
      }
      
      public static function §_-Bk§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-Km§(_loc2_);
         return §_-WH§.§_-fX§(_loc3_.readInt(),true) + §_-WH§.§_-fX§(_loc3_.readInt(),true) + §_-WH§.§_-fX§(_loc3_.readInt(),true) + §_-WH§.§_-fX§(_loc3_.readInt(),true) + §_-WH§.§_-fX§(_loc3_.readInt(),true);
      }
      
      public static function §_-98§(param1:ByteArray) : String
      {
         var _loc2_:Array = §_-Q3§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §_-Km§(_loc2_);
         return §_-WH§.§_-fX§(_loc3_.readInt(),true) + §_-WH§.§_-fX§(_loc3_.readInt(),true) + §_-WH§.§_-fX§(_loc3_.readInt(),true) + §_-WH§.§_-fX§(_loc3_.readInt(),true) + §_-WH§.§_-fX§(_loc3_.readInt(),true);
      }
      
      public static function §_-Zj§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §_-Q3§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §_-Km§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §_-Km§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
