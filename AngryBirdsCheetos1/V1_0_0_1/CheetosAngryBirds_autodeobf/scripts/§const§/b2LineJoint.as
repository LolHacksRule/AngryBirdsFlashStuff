package §const§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§_-gD§.x * this.§_-Bo§.x + (this.§_-4-§ + this.§_-gD§.y) * this.§_-40§.x),param1 * (this.§_-gD§.x * this.§_-Bo§.y + (this.§_-4-§ + this.§_-gD§.y) * this.§_-40§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§_-WQ§ = this.§_-WQ§ > Number.MIN_VALUE ? Number(1 / this.§_-WQ§) : Number(0);
         ...
         this.§_-1l§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§_-1l§.col2.x = this.§_-1l§.col1.y;
         this.§_-1l§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§_-8L§)
         {
         ...
         if(param1.§_-0X§)
         {
            ...
            _loc19_ = this.§_-gD§.x * this.§_-Bo§.x + (this.§_-4-§ + this.§_-gD§.y) * this.§_-40§.x;
            _loc20_ = this.§_-gD§.x * this.§_-Bo§.y + (this.§_-4-§ + this.§_-gD§.y) * this.§_-40§.y;
            _loc21_ = this.§_-gD§.x * this.m_s1 + (this.§_-4-§ + this.§_-gD§.y) * this.m_a1;
            _loc22_ = this.§_-gD§.x * this.m_s2 + (this.§_-4-§ + this.§_-gD§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§_-40§.x * (_loc6_.x - _loc4_.x) + this.§_-40§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§_-WQ§ * (this.§_-1L§ - _loc13_);
            _loc15_ = this.§_-4-§;
            _loc16_ = param1.§_-ec§ * this.§_-HX§;
            this.§_-4-§ = b2Math.§_-9P§(this.§_-4-§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§_-4-§ - _loc15_) * this.§_-40§.x;
            _loc9_ = _loc14_ * this.§_-40§.y;
         ...
         {
            _loc17_ = this.§_-40§.x * (_loc6_.x - _loc4_.x) + this.§_-40§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§_-gD§.Copy();
            _loc19_ = this.§_-1l§.§_-xM§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§_-gD§.§_-db§(_loc19_);
            if(this.§_-ly§ == b2internal::_-yU)
            {
               this.§_-gD§.y = b2Math.§_-5m§(this.§_-gD§.y,0);
            }
            else if(this.§_-ly§ == b2internal::_-mY)
            {
               this.§_-gD§.y = b2Math.§_-gF§(this.§_-gD§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§_-gD§.y - _loc18_.y) * this.§_-1l§.col2.x;
            if(this.§_-1l§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§_-1l§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§_-gD§.x = _loc21_;
            _loc19_.x = this.§_-gD§.x - _loc18_.x;
            _loc19_.y = this.§_-gD§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§_-Bo§.x + _loc19_.y * this.§_-40§.x;
            _loc9_ = _loc19_.x * this.§_-Bo§.y + _loc19_.y * this.§_-40§.y;
         ...
         else
         {
            if(this.§_-1l§.col1.x != 0)
            {
               _loc22_ = -_loc12_ / this.§_-1l§.col1.x;
            }
            else
            {
               _loc22_ = 0;
            ...
            this.§_-gD§.x += _loc22_;
            _loc8_ = _loc22_ * this.§_-Bo§.x;
            _loc9_ = _loc22_ * this.§_-Bo§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§_-8L§)
         {
            ...
            _loc34_ = this.§_-40§.x * _loc26_ + this.§_-40§.y * _loc27_;
            if(b2Math.§_-5C§(this.§_-SX§ - this.§_-zT§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§_-9P§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§_-5C§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§_-zT§)
            {
               _loc19_ = b2Math.§_-9P§(_loc34_ - this.§_-zT§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§_-zT§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§_-SX§)
            {
               _loc19_ = b2Math.§_-9P§(_loc34_ - this.§_-SX§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§_-SX§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§_-1l§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§_-1l§.col2.x = this.§_-1l§.col1.y;
            this.§_-1l§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§_-1l§.§_-xM§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::_-Ma;
         ...
         var _loc30_:Number = _loc28_.x * this.§_-Bo§.x + _loc28_.y * this.§_-40§.x;
         var _loc31_:Number = _loc28_.x * this.§_-Bo§.y + _loc28_.y * this.§_-40§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::_-Ma * _loc30_;
         _loc6_.y -= b2internal::_-Ma * _loc31_;
         _loc7_ -= b2internal::else  * _loc32_;
         _loc8_.x += b2internal::_-cY * _loc30_;
         _loc8_.y += b2internal::_-cY * _loc31_;
         _loc9_ += b2internal::_-Bp * _loc33_;
