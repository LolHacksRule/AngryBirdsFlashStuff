package com.rovio.Box2D.Dynamics
{
   ...
   public class b2Body
   {
      ...
      public function b2Body(param1:b2BodyDef, param2:b2World)
      {
         ...
         if(param1.bullet)
         {
            this.m_flags |= b2internal::<"+;
         }
         if(param1.fixedRotation)
         {
            this.m_flags |= b2internal::1!?;
         }
         if(param1.allowSleep)
         {
            this.m_flags |= b2internal::2!H;
         }
         if(param1.awake)
         {
            this.m_flags |= b2internal:: !];
         ...
         this.m_gravityScale = param1.gravityScale;
      ...
      public function CreateFixture(param1:b2FixtureDef) : b2Fixture
      {
         ...
         if(this.m_flags & b2internal::6!Q)
         {
      ...
      public function GetDefinition() : b2BodyDef
      {
         ...
         _loc1_.allowSleep = (this.m_flags & b2internal::2!H) == b2internal::2!H;
         _loc1_.angle = this.GetAngle();
         _loc1_.angularDamping = this.m_angularDamping;
         _loc1_.angularVelocity = this.m_angularVelocity;
         _loc1_.fixedRotation = (this.m_flags & b2internal::1!?) == b2internal::1!?;
         _loc1_.bullet = (this.m_flags & b2internal::<"+) == b2internal::<"+;
         _loc1_.awake = (this.m_flags & b2internal:: !]) == b2internal:: !];
      ...
      public function SetMassData(param1:b2MassData) : void
      {
         ...
         if(param1.I > 0 && (this.m_flags & b2internal::1!?) == 0)
         {
      ...
      public function ResetMassData() : void
      {
         ...
         if(this.m_I > 0 && (this.m_flags & b2internal::1!?) == 0)
         {
      ...
      {
         return (this.m_flags & b2internal::<"+) == b2internal::<"+;
      }
      ...
      {
         return (this.m_flags & b2internal::1!?) == b2internal::1!?;
      }
      ...
      {
         return (this.m_flags & b2internal::6!Q) == b2internal::6!Q;
      }
      
      public function IsSleepingAllowed() : Boolean
      {
         return (this.m_flags & b2internal::2!H) == b2internal::2!H;
      }
