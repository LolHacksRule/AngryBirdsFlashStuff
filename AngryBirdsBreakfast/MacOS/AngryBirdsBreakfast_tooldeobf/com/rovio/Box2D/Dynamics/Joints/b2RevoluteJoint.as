package com.rovio.Box2D.Dynamics.Joints
{
   ...
   public class b2RevoluteJoint extends b2Joint
   {
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.m_enableMotor && this.m_limitState != b2internal::8!E && !_loc19_)
         {
         ...
         if(this.m_enableLimit && this.m_limitState != b2internal::-!Z && !_loc19_)
         {
            _loc4_ = _loc2_.m_xf.R;
            ...
            if(this.m_limitState == b2internal::8!E)
            {
               this.m_impulse.Add(this.impulse3);
            }
            else if(this.m_limitState == b2internal::@<)
            {
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc8_:Number = 0;
         var _loc9_:Number = 0;
         if(this.m_enableLimit && this.m_limitState != b2internal::-!Z && !_loc7_)
         {
