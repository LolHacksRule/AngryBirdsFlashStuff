package com.angrybirds.engine
{
   ...
   public class LevelEngineBox2D
   {
      ...
      public function updateScrollAndScale(param1:Number, param2:Number) : void
      {
         ...
         if(USE_DEBUG_SPRITE)
         {
            _loc3_ = AngryBirdsEngine.smLevelMain.box2DToScreen(0,0);
      ...
      public function updateWorld(param1:Number) : Number
      {
         this.mTimeStepForLastUpdateMilliSeconds = UPDATE_TIME_STEP_MILLISECONDS;
         var _loc2_:int = this.getStepCount(param1);
      ...
      private function getStepCount(param1:Number) : int
      {
         var _loc2_:int = 0;
         while(param1 > 0)
         {
