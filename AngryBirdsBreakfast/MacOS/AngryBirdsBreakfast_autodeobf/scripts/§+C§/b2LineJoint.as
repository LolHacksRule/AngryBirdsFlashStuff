package §+C§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§0!F§.x * this.§"!g§.x + (this.§8!9§ + this.§0!F§.y) * this.§"q§.x),param1 * (this.§0!F§.x * this.§"!g§.y + (this.§8!9§ + this.§0!F§.y) * this.§"q§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§9q§ = this.§9q§ > Number.MIN_VALUE ? Number(1 / this.§9q§) : Number(0);
         ...
         if(param1.§?j§)
         {
            ...
            this.§0!F§.y *= param1.§-k§;
            this.§8!9§ *= param1.§-k§;
            _loc19_ = this.§0!F§.x * this.§"!g§.x + (this.§8!9§ + this.§0!F§.y) * this.§"q§.x;
            _loc20_ = this.§0!F§.x * this.§"!g§.y + (this.§8!9§ + this.§0!F§.y) * this.§"q§.y;
            _loc21_ = this.§0!F§.x * this.m_s1 + (this.§8!9§ + this.§0!F§.y) * this.m_a1;
            _loc22_ = this.§0!F§.x * this.m_s2 + (this.§8!9§ + this.§0!F§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§"q§.x * (_loc6_.x - _loc4_.x) + this.§"q§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§9q§ * (this.§0!9§ - _loc13_);
            _loc15_ = this.§8!9§;
            _loc16_ = param1.§`!9§ * this.§[D§;
            this.§8!9§ = b2Math.§&a§(this.§8!9§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§8!9§ - _loc15_) * this.§"q§.x;
            _loc9_ = _loc14_ * this.§"q§.y;
         ...
         {
            _loc17_ = this.§"q§.x * (_loc6_.x - _loc4_.x) + this.§"q§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§0!F§.Copy();
            _loc19_ = this.§#!N§.§=^§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§0!F§.§-!r§(_loc19_);
            if(this.§%!T§ == b2internal::@<)
            {
               this.§0!F§.y = b2Math.§"!8§(this.§0!F§.y,0);
            }
            else if(this.§%!T§ == b2internal::%S)
            {
               this.§0!F§.y = b2Math.§=t§(this.§0!F§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§0!F§.y - _loc18_.y) * this.§#!N§.col2.x;
            if(this.§#!N§.col1.x != 0)
            {
            ...
            this.§0!F§.x = _loc21_;
            _loc19_.x = this.§0!F§.x - _loc18_.x;
            _loc19_.y = this.§0!F§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§"!g§.x + _loc19_.y * this.§"q§.x;
            _loc9_ = _loc19_.x * this.§"!g§.y + _loc19_.y * this.§"q§.y;
         ...
         else
         {
            ...
            this.§0!F§.x += _loc22_;
            _loc8_ = _loc22_ * this.§"!g§.x;
            _loc9_ = _loc22_ * this.§"!g§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§ !§)
         {
            ...
            _loc34_ = this.§"q§.x * _loc26_ + this.§"q§.y * _loc27_;
            if(b2Math.§"!2§(this.§"b§ - this.§3!<§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§&a§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§"!2§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§3!<§)
            {
               _loc19_ = b2Math.§&a§(_loc34_ - this.§3!<§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§3!<§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§"b§)
            {
               _loc19_ = b2Math.§&a§(_loc34_ - this.§"b§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§#!N§.§=^§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::>+;
         ...
         var _loc30_:Number = _loc28_.x * this.§"!g§.x + _loc28_.y * this.§"q§.x;
         var _loc31_:Number = _loc28_.x * this.§"!g§.y + _loc28_.y * this.§"q§.y;
