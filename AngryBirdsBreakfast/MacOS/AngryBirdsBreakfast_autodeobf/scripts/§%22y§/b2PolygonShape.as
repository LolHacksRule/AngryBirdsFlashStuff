package §"y§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      b2internal static function §=N§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§?G§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§?G§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §2!A§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§!1§ ? int(_loc3_ + 1) : 0;
      ...
      public function §6_§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§7N§.x = 0.5 * (param1.x + param2.x);
         this.§7N§.y = 0.5 * (param1.y + param2.y);
         this.§0!O§[0] = b2Math.§+2§(b2Math.§";§(param2,param1),1);
         this.§0!O§[0].Normalize();
         this.§0!O§[1].x = -this.§0!O§[0].x;
         this.§0!O§[1].y = -this.§0!O§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§!1§)
         {
            _loc6_ = (_loc9_ = this.§-!L§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§0!O§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§?J§.x = _loc5_ - b2internal::,!;;
         param1.§?J§.y = _loc6_ - b2internal::,!;;
         param1.§1^§.x = _loc7_ + b2internal::,!;;
         param1.§1^§.y = _loc8_ + b2internal::,!;;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§!1§ == 2)
         {
            param1.center.x = 0.5 * (this.§-!L§[0].x + this.§-!L§[1].x);
            param1.center.y = 0.5 * (this.§-!L§[0].y + this.§-!L§[1].y);
            param1.§#!5§ = 0;
            param1.I = 0;
            return;
         }
         ...
         var _loc6_:Number = 0;
         var _loc10_:int = 0;
         while(_loc10_ < this.§!1§)
         {
            _loc11_ = this.§-!L§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§!1§ ? this.§-!L§[int(_loc10_ + 1)] : this.§-!L§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§7!c§(param1,param3.position);
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§!1§;
         var _loc14_:int = (_loc10_ + 1) % this.§!1§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§-!L§[_loc9_].x * (1 - _loc15_) + this.§-!L§[_loc13_].x * _loc15_,this.§-!L§[_loc9_].y * (1 - _loc15_) + this.§-!L§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§-!L§[_loc10_].x * (1 - _loc16_) + this.§-!L§[_loc14_].x * _loc16_,this.§-!L§[_loc10_].y * (1 - _loc16_) + this.§-!L§[_loc14_].y * _loc16_);
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§!1§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
