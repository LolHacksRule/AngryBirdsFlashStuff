package §^9§
{
   ...
   class b2Simplex
   {
      ...
      public function §^!0§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            _loc11_ = param1.§='§;
            if((_loc12_ = this.§3l§()) < 0.5 * _loc11_ || 2 * _loc11_ < _loc12_ || _loc12_ < Number.MIN_VALUE)
            {
               this.§=r§ = 0;
            }
         }
      ...
      public function §,!%§() : b2Vec2
      {
         ...
         switch(this.§=r§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§9""§(_loc1_,this.m_v1.§%6§.§4l§());
               if(_loc2_ > 0)
               {
      ...
      public function §&!#§() : b2Vec2
      {
         switch(this.§=r§)
         {
            ...
            case 1:
               return this.m_v1.§%6§;
            case 2:
               return new b2Vec2(this.m_v1.a * this.m_v1.§%6§.x + this.m_v2.a * this.m_v2.§%6§.x,this.m_v1.a * this.m_v1.§%6§.y + this.m_v2.a * this.m_v2.§%6§.y);
            default:
               b2Settings.b2Assert(false);
               return new b2Vec2();
         }
      ...
      public function §3l§() : Number
      {
         switch(this.§=r§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§";§(this.m_v1.§%6§,this.m_v2.§%6§).Length();
            case 3:
               return b2Math.§9""§(b2Math.§";§(this.m_v2.§%6§,this.m_v1.§%6§),b2Math.§";§(this.m_v3.§%6§,this.m_v1.§%6§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc5_:Number = b2Math.§7!c§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§7!c§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§";§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§7!c§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§7!c§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§";§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§7!c§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§7!c§(_loc3_,_loc14_);
