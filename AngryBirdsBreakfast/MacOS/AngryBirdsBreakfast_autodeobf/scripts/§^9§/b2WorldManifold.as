      ...
      public function §",§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         ...
         switch(param1.§6m§)
         {
            case b2Manifold.§1K§:
               ...
               this.§"A§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§"A§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§3!u§:
               _loc8_ = param2.R;
               _loc7_ = param1.§'c§;
               ...
               this.§[!l§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§26§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§"A§[_loc6_].m_localPoint;
                  ...
                  this.§"A§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§"A§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§8!p§:
               ...
               while(_loc6_ < param1.§26§)
               {
                  ...
                  this.§"A§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§"A§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
