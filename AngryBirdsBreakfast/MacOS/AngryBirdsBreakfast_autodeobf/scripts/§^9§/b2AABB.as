package §^9§
{
   ...
   public class b2AABB
   {
      ...
      {
         var _loc1_:Number = this.§1^§.x - this.§?J§.x;
         var _loc2_:Number = this.§1^§.y - this.§?J§.y;
         var _loc3_:Boolean = _loc1_ >= 0 && _loc2_ >= 0;
         return Boolean(_loc3_ && this.§?J§.§<?§() && this.§1^§.§<?§());
      }
      
      public function §`!8§() : b2Vec2
      {
         return new b2Vec2((this.§?J§.x + this.§1^§.x) / 2,(this.§?J§.y + this.§1^§.y) / 2);
      }
      
      public function §>x§() : b2Vec2
      {
         return new b2Vec2((this.§1^§.x - this.§?J§.x) / 2,(this.§1^§.y - this.§?J§.y) / 2);
      }
      ...
      public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput) : Boolean
      {
         ...
         {
            if(_loc5_ < this.§?J§.x || this.§1^§.x < _loc5_)
            {
               return false;
            }
         }
         ...
         {
            if(_loc6_ < this.§?J§.y || this.§1^§.y < _loc6_)
            {
               return false;
            }
         }
      ...
      {
         var _loc2_:Number = param1.§?J§.x - this.§1^§.x;
         var _loc3_:Number = param1.§?J§.y - this.§1^§.y;
         var _loc4_:Number = this.§?J§.x - param1.§1^§.x;
         var _loc5_:Number = this.§?J§.y - param1.§1^§.y;
