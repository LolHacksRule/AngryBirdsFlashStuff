package §^9§
{
   ...
   public class b2Collision
   {
      ...
      private static var §0!6§:Vector.<§6! §> = §'R§();
      
      private static var s_clipPoints1:Vector.<§6! §> = §'R§();
      
      private static var s_clipPoints2:Vector.<§6! §> = §'R§();
      
      private static var §=!1§:Vector.<int> = new Vector.<int>(1);
      
      private static var §&-§:Vector.<int> = new Vector.<int>(1);
      
      private static var §8a§:b2Vec2 = new b2Vec2();
      ...
      public static function §4!`§(param1:Vector.<§6! §>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         _loc20_.id.§?!>§.§5!q§ = param4;
         _loc20_.id.§?!>§.§95§ = _loc21_;
         _loc20_.id.§?!>§.§!"+§ = 0;
         _loc20_ = param1[1];
      ...
      public static function §#!s§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §=!1§[0] = _loc8_;
         var _loc9_:Number = §&!§(§=!1§,param2,param3,param4,param5);
         _loc8_ = §=!1§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §8a§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
      ...
      public static function §@8§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§!1§;
         var _loc22_:Vector.<b2Vec2> = param2.§-!L§;
         var _loc23_:Vector.<b2Vec2> = param2.§0!O§;
         var _loc24_:int = 0;
