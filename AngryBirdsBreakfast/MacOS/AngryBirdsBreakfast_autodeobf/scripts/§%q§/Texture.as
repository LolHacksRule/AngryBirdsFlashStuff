   ...
   public class Texture
   {
      ...
      public function adjustVertexData(param1:§3C§, param2:int, param3:int) : void
      {
         ...
         if(this.§2!n§)
         {
            ...
            _loc4_ = this.§2!n§.width + this.§2!n§.x - this.width;
            _loc5_ = this.§2!n§.height + this.§2!n§.y - this.height;
            param1.include(param2,-this.§2!n§.x,-this.§2!n§.y);
            param1.include(param2 + 1,-_loc4_,-this.§2!n§.y);
            param1.include(param2 + 2,-this.§2!n§.x,-_loc5_);
