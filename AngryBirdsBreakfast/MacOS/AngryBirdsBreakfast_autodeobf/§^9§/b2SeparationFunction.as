package §^9§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §",§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§6m§ = §,!b§;
            _loc7_ = this.§5"§.§0K§(param1.indexA[0]);
            _loc10_ = this.§]§.§0K§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§"q§.x = _loc15_ - _loc13_;
            this.§"q§.y = _loc16_ - _loc14_;
            this.§"q§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§6m§ = §3!u§;
            _loc8_ = this.§5"§.§0K§(param1.indexA[0]);
            _loc9_ = this.§5"§.§0K§(param1.indexA[1]);
            _loc10_ = this.§]§.§0K§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§"q§ = b2Math.§+2§(b2Math.§";§(_loc9_,_loc8_),1);
            this.§"q§.Normalize();
            _loc20_ = this.§"q§;
         ...
         {
            this.§6m§ = §8!p§;
            _loc11_ = this.§]§.§0K§(param1.indexB[0]);
            _loc12_ = this.§]§.§0K§(param1.indexB[1]);
            _loc7_ = this.§5"§.§0K§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§"q§ = b2Math.§+2§(b2Math.§";§(_loc12_,_loc11_),1);
            this.§"q§.Normalize();
            _loc20_ = this.§"q§;
         ...
         else
         {
            ...
            _loc11_ = this.§]§.§0K§(param1.indexB[0]);
            _loc12_ = this.§]§.§0K§(param1.indexB[1]);
            _loc23_ = b2Math.§!v§(param3,_loc7_);
            _loc24_ = b2Math.§"]§(param3.R,b2Math.§";§(_loc9_,_loc8_));
            _loc25_ = b2Math.§!v§(param5,_loc10_);
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         switch(this.§6m§)
         {
            case §,!b§:
               ...
               return Number(((_loc8_ = b2Math.§!v§(param2,_loc6_)).x - _loc7_.x) * this.§"q§.x + (_loc8_.y - _loc7_.y) * this.§"q§.y);
            case §3!u§:
               _loc10_ = b2Math.§"]§(param1.R,this.§"q§);
               _loc7_ = b2Math.§!v§(param1,this.m_localPoint);
               _loc4_ = b2Math.§3r§(param2.R,_loc10_.§4l§());
               _loc6_ = this.§]§.§0!e§(_loc4_);
               return Number(((_loc8_ = b2Math.§!v§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §8!p§:
               _loc10_ = b2Math.§"]§(param2.R,this.§"q§);
               _loc8_ = b2Math.§!v§(param2,this.m_localPoint);
               _loc3_ = b2Math.§3r§(param1.R,_loc10_.§4l§());
               _loc5_ = this.§5"§.§0!e§(_loc3_);
               return Number(((_loc7_ = b2Math.§!v§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
