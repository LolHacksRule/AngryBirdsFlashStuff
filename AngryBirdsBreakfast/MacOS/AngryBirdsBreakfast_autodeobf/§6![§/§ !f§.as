      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         else
         {
            ...
            while(_loc7_ < 4)
            {
               ...
               _loc3_ = _loc3_ < §9!s§.x ? Number(_loc3_) : Number(§9!s§.x);
               _loc4_ = _loc4_ > §9!s§.x ? Number(_loc4_) : Number(§9!s§.x);
               _loc5_ = _loc5_ < §9!s§.y ? Number(_loc5_) : Number(§9!s§.y);
               _loc6_ = _loc6_ > §9!s§.y ? Number(_loc6_) : Number(§9!s§.y);
               _loc7_++;
            }
         }
         param2.x = _loc3_;
