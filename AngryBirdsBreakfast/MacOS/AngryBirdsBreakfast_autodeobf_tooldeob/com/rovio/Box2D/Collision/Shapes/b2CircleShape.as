package com.rovio.Box2D.Collision.Shapes
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.lowerBound.Set(_loc4_ - b2internal::,!;,_loc5_ - b2internal::,!;);
         param1.upperBound.Set(_loc4_ + b2internal::,!;,_loc5_ + b2internal::,!;);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.mass = param2 * b2Settings.b2_pi * b2internal::,!; * b2internal::,!;;
         param1.center.SetV(this.m_p);
         param1.I = param1.mass * (0.5 * b2internal::,!; * b2internal::,!; + (this.m_p.x * this.m_p.x + this.m_p.y * this.m_p.y));
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.Dot(param1,_loc5_) - param2)) < -b2internal::,!; + Number.MIN_VALUE)
         {
            return 0;
         }
