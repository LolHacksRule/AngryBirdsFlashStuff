package com.rovio.utils
{
   public class LuaUtils
   {
      ...
      public static function luaToObject(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
      ...
      public static function normalizedLuaToObject(param1:String, param2:Boolean = false) : Object
      {
         var returnObject:Object = null;
      ...
      public static function normalizeLuaString(param1:String, param2:Boolean = false) : String
      {
         ...
         return fixArrays(param1,param2);
      }
      
      private static function fixArrays(param1:String, param2:Boolean) : String
      {
