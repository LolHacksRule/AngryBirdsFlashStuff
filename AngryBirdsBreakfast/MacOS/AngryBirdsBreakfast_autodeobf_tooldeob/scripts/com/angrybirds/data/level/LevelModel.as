package com.angrybirds.data.level
{
   ...
   public class LevelModel
   {
      ...
      public function getEagleScore(param1:LevelItemManager, param2:int) : int
      {
         ...
         var _loc4_:int = this.getMaxBirdScore();
         var _loc5_:int;
      ...
      public function setEagleScore(param1:int, param2:LevelItemManager, param3:int) : void
      {
         ...
         var _loc5_:int = this.getMaxBirdScore();
      ...
      public function getAsXML() : XML
      {
         ...
         {
            _loc1_ += " <Camera id=\"" + _loc2_.id + "\" leftBorder=\"" + _loc2_.left + "\" rightBorder=\"" + _loc2_.right + "\" topBorder=\"" + _loc2_.top + "\" bottomBorder=\"" + (_loc2_.top + LevelCamera.SCREEN_HEIGHT_B2) + "\"></Camera>";
         }
         _loc1_ += "</Cameras>";
