package com.rovio.Box2D.Dynamics.Joints
{
   ...
   public class b2MouseJoint extends b2Joint
   {
      ...
      public function b2MouseJoint(param1:b2MouseJointDef)
      {
         ...
         _loc2_ = this.m_target.x - b2internal::8!F.m_xf.position.x;
         var _loc3_:Number = this.m_target.y - b2internal::8!F.m_xf.position.y;
      ...
      {
         return b2internal::8!F.GetWorldPoint(this.m_localAnchor);
      }
