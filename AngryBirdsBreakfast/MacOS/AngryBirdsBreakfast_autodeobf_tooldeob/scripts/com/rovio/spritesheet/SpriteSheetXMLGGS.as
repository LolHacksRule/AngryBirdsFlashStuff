package com.rovio.spritesheet
{
   ...
   public class SpriteSheetXMLGGS extends SpriteSheetBase
   {
      ...
      {
         super(param3);
         this.parseData(param1,param2);
      }
      
      protected function parseData(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc8_:int = 0;
         var _loc9_:int = 0;
         var _loc10_:ClipArea = null;
         var _loc11_:int = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         var _loc15_:Rectangle = null;
         var _loc16_:SpriteRovio = null;
         var _loc3_:Dictionary = this.getImageClipAreas(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.getImageName(_loc7_,_loc6_)]) == null)
            {
      ...
      private function getImageName(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function getImageClipAreas(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.getImageName(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new ClipArea(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
