package com.rovio.factory
{
   ...
   public class Log
   {
      ...
      public static function logObjectProperties(param1:Object, param2:int = 1) : void
      {
      ...
      public static function setDisplayContainer(param1:DisplayObjectContainer, param2:int = 40, param3:int = 40, param4:int = 540, param5:int = 360, param6:int = -1) : void
      {
         if(!LOGGER_ENABLED)
         {
            return;
         ...
         mLogTextField.height = param5 - 40;
         mLogTextField.x = param2;
         mLogTextField.y = param3 + 40;
         ...
         mVersionTextField.width = param4;
         mVersionTextField.height = 20;
         mVersionTextField.x = param2;
         mVersionTextField.y = param3 + 20;
      ...
      public static function setKeys(param1:int = 113, param2:int = 115, param3:int = 114, param4:int = 117) : void
      {
      ...
      public static function setVersionInfo(param1:String) : void
      {
         sVersionInfo = param1;
      }
   }
