                     ...
                     if(!_loc9_)
                     {
                        if(!_loc9_)
                        {
                           ...
                           while(true)
                           {
                              this.§ !l§ = param5;
                              loop6:
                              for(; !(_loc9_ && param3); if(_loc8_ || param3)
                              {
                                 if(_loc8_)
                                 {
                                    return;
                        ...
                        while(true)
                        {
                           if(_loc4_ >= §<C§.length)
                           {
                              if(!_loc6_)
                              {
                                 ...
                                 if(!_loc6_)
                                 {
                                    §§push(§§pop() - this.§!b§ * this.§1X§);
                                 }
                                 §§pop().x = §§pop();
                              }
                              for(; !(_loc6_ && _loc2_); §§push(§§findproperty(y)),§§push(this.§4!D§),if(!(_loc6_ && _loc2_))
                              {
                                 §§push(§§pop() - this.§!b§ * this.§ !l§);
                              },§§pop().y = §§pop(),if(!(_loc6_ && param1))
                              {
                                 return;
                              })
                              {
