   ...
   public class TouchProcessor
   {
      ...
      public function advanceTime(param1:Number) : void
      {
         ...
         while(this.mQueue.length > 0)
         {
            ...
            for each(_loc5_ in this.mCurrentTouches)
            {
               if(_loc5_.phase == TouchPhase.BEGAN || _loc5_.phase == TouchPhase.MOVED)
               {
            ...
            for each(_loc6_ in sHoveringTouchData)
            {
               ...
               {
                  _loc6_.target.dispatchEvent(new TouchEvent(TouchEvent.TOUCH,this.mCurrentTouches,this.mShiftDown,this.mCtrlDown));
               }
            }
