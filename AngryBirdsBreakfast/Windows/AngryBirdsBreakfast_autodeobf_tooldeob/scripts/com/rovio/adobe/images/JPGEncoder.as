      ...
      private function initQuantTables(param1:int) : void
      {
         ...
         while(_loc7_ < 8)
         {
            ...
            while(_loc8_ < 8)
            {
               ...
               this.get[_loc2_] = 1 / (this.UVTable[this.ZigZag[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               _loc2_++;
               _loc8_++;
            }
            _loc7_++;
      ...
      public function encode(param1:BitmapData) : ByteArray
      {
         ...
         while(_loc5_ < param1.height)
         {
            ...
            while(_loc6_ < param1.width)
            {
               ...
               _loc3_ = this.processDU(this.UDU,this.get,_loc3_,this.UVDC_HT,this.UVAC_HT);
               _loc4_ = this.processDU(this.VDU,this.get,_loc4_,this.UVDC_HT,this.UVAC_HT);
               _loc6_ += 8;
            }
            _loc5_ += 8;
         }
