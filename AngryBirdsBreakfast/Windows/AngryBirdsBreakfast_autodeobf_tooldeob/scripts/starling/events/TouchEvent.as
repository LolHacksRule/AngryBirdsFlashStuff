package starling.events
{
   ...
   public class TouchEvent extends Event
   {
      ...
      {
         super(param1,param5);
         this.mTouches = !!param2 ? param2 : new Vector.<Touch>(0);
      ...
      public function getTouches(param1:DisplayObject, param2:String = null) : Vector.<Touch>
      {
         ...
         var _loc4_:int = this.mTouches.length;
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc7_ = (_loc6_ = this.mTouches[_loc5_]).target == param1 || param1 is DisplayObjectContainer && (param1 as DisplayObjectContainer).contains(_loc6_.target);
