package com.angrybirds.states.playstate.playview
{
   ...
   public class BasePlayView extends BasePlayStateView
   {
      ...
      override public function update(param1:Number) : void
      {
         ...
         if(this.mMightyEagleButtonState == MIGHTY_EAGLE_BUTTON_VISIBLE && !AngryBirdsEngine.mIsRunning.objects.isPigsAlive())
         {
            this.prepareHideMightyEagleButton();
         }
         if((this.mMightyEagleButtonState == MIGHTY_EAGLE_BUTTON_VISIBLE || this.mMightyEagleButtonState == MIGHTY_EAGLE_BUTTON_PREPARE_HIDE) && AngryBirdsEngine.mIsRunning.slingshot.mSlingShotState == LevelSlingshot.STATE_CELEBRATE)
         {
      ...
      protected function hideMightyEagleButton() : void
      {
         ...
         this.mMightyEagleButtonTween.onComplete = this.CollideCircles;
         this.mMightyEagleButtonTween.play();
      }
      
      protected function CollideCircles() : void
      {
         this.mMightyEagleButtonTween = TweenManager.instance.createTween(this.mContainerMightyEagle,{
            "scaleX":0,
            "scaleY":0
      ...
      {
         AngryBirdsEngine.mIsRunning.useMightyEagle();
