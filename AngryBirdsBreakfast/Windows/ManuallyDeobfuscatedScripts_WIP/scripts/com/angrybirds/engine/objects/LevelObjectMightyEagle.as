package com.angrybirds.engine.objects
{
   ...
   public class LevelObjectMightyEagle extends LevelObjectBird
   {
      ...
      {
         if(!this.mShadingStarted && mKeyCode > Tuner.MIGHTY_EAGLE_SHADING_DELAY)
         {
      ...
      protected function move(param1:Number, param2:ILevelObjectUpdateManager) : void
      {
         ...
         if(this.mTouchedGround)
         {
            ...
            _loc3_ = -1;
            if(mKeyCode > Tuner.MIGHTY_EAGLE_PIG_KILL_DELAY && !this.mPigsKilled)
            {
         ...
         moveToDirection(param1,new Point(1,_loc3_ * Tuner.MIGHTY_EAGLE_SHADING_DELAY),Tuner.MIGHTY_EAGLE_FLYING_SPEED);
      }
