package com.angrybirds.engine.objects
{
   ...
   public class LevelObjectBird extends LevelObjectAnimal
   {
      ...
      {
         return Math.min(AngryBirdsEngine.mIsRunning.damageParticleLimit,param1);
      }
      ...
      {
         this.mLastDamageTimeMilliSeconds = mKeyCode;
      }
      
      protected function get isCausingDamage() : Boolean
      {
         return mKeyCode - this.mLastDamageTimeMilliSeconds < BIRDS_NO_DAMAGE_TIME_BEFORE_REMOVAL;
      }
