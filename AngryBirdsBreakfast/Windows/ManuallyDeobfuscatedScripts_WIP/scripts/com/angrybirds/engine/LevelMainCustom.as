package com.angrybirds.engine
{
   ...
   import com.angrybirds.engine.camera.LevelMainCustom;
   import com.graphics.AnimationManagerCustom;
   import com.graphics.Clear;
   ...
   public class LevelMainCustom extends LevelMain
   {
      ...
      {
         return new LevelMainCustom(this,param1);
      }
      ...
      {
         return new Clear(stage.loaderInfo.parameters.assetsUrl || "",stage.loaderInfo.parameters.buildNumber || "",mLevelManager,LevelItemManagerCustom(mLevelItemManager));
      }
