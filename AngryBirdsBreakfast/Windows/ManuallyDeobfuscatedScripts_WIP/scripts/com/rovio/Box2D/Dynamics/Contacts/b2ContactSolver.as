   ...
   public class b2ContactSolver
   {
      ...
      public function Initialize(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            _loc18_ = b2Settings.b2MixFriction(_loc9_.GetFriction(),_loc10_.SetDensity());
            ...
            while(_loc29_ < _loc28_.pointCount)
            {
               ...
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               if((_loc38_ = _loc15_.m_invMass + _loc16_.m_invMass + _loc15_.m_invI * _loc36_ + _loc16_.m_invI * _loc37_) > 0)
               {
                  _loc31_.normalMass = 1 / _loc38_;
               }
               else
               {
                  _loc31_.normalMass = 0;
               }
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               if((_loc44_ = _loc15_.m_invMass + _loc16_.m_invMass + _loc15_.m_invI * _loc42_ + _loc16_.m_invI * _loc43_) > 0)
               {
                  _loc31_.tangentMass = 1 / _loc44_;
               }
               else
               {
                  _loc31_.tangentMass = 0;
               }
