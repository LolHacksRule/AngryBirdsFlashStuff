package com.rovio.ui.scroller
{
   ...
   public class HScroller
   {
      ...
      protected var mItemRendererWidth:Vector.<ScrollerItemRenderer>;
      
      protected var mItemRendererHeight:Vector.<ScrollerItemRenderer>;
      ...
      {
         this.mItemRendererWidth = new Vector.<ScrollerItemRenderer>(0);
         this.mItemRendererHeight = new Vector.<ScrollerItemRenderer>(0);
         super();
      ...
      public function setWidth(param1:Number) : void
      {
         ...
         while(this.mItemRendererHeight.length > this.mMaxItemsVisible)
         {
            _loc2_ = this.mItemRendererHeight.pop();
      ...
      protected function populate(param1:Boolean = true) : void
      {
         ...
         while(_loc2_ < this.mItemCount)
         {
            ...
            this.mItemRendererHeight.push(_loc3_);
            _loc2_++;
         }
         this.updatePositions();
      }
      ...
      protected function setTargetOffset(param1:int) : void
      {
         ...
         else if(this.mTargetOffset - param1 - this.points < -this.mData.length)
         {
            this.mTargetOffset = -(this.mData.length - this.points);
         }
         else
         {
      ...
      protected function updatePositions() : void
      {
         ...
         var _loc1_:int = this.mItemRendererHeight.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.mItemRendererHeight[_loc1_];
         ...
         while(_loc1_ < this.mData.length)
         {
            ...
            if(_loc3_ > -this.itemRendererWidth && _loc3_ < this.mMaskWidth && !this.hasRendererWithIndex(_loc1_))
            {
               ...
               _loc4_.index = _loc1_;
               _loc4_.x = _loc3_;
               this.mItemRendererHeight.push(_loc4_);
            }
            _loc1_++;
         }
      }
      ...
      protected function hide(param1:ScrollerItemRenderer) : void
      {
         ...
         this.mItemRendererHeight.splice(this.mItemRendererHeight.indexOf(param1),1);
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.mItemRendererHeight.length)
         {
            if(this.mItemRendererHeight[_loc2_].index == param1)
            {
               return true;
            }
            _loc2_++;
      ...
      {
         var _loc1_:ScrollerItemRenderer = null;
         for each(_loc1_ in this.mItemRendererHeight)
         {
      ...
      {
         var _loc1_:ScrollerItemRenderer = null;
         while(this.mItemRendererHeight.length > 0)
         {
            _loc1_ = this.mItemRendererHeight.pop();
      ...
      {
         if(this.mItemRendererWidth.length > 0)
         {
            return this.mItemRendererWidth.pop();
         }
      ...
      protected function returnRenderer(param1:ScrollerItemRenderer) : void
      {
         ...
         this.mItemRendererWidth.push(param1);
      }
