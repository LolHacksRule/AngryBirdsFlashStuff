package starling.extensions
{
   ...
   public class ParticleSystem extends DisplayObject implements IAnimatable
   {
      ...
      private var mTarget:Number = 0.0;
      ...
      private function expandBuffers(param1:Context3D) : Boolean
      {
         ...
         this.mVertexTextureBuffer.uploadFromByteArray(this.mVertexData.maxMotorForce,0,0,_loc2_ * 4);
      ...
      private function advance(param1:Matrix3D) : void
      {
         ...
         if(isNaN(this.mTarget) || this.mTarget == 0)
         {
            return;
         }
         var _loc2_:Number = this.mTarget;
         this.mTarget = 0;
