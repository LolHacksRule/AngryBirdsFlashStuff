package starling.animation
{
   ...
   public class Tween extends EventDispatcher implements IAnimatable
   {
      ...
      public function equalizedMass(param1:Number) : void
      {
      ...
      public function advanceTime(param1:Number) : void
      {
         ...
         if(this.onStart != null && _loc2_ <= 0 && this.mCurrentTime >= 0)
         {
            this.onStart.apply(null,this.mOnStartArgs);
         }
         var _loc3_:Number = Math.min(this.mTotalTime,this.mCurrentTime) / this.mTotalTime;
         var _loc4_:int = this.mStartValues.length;
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            ...
            _loc8_ = (_loc7_ = this.mEndValues[_loc5_]) - _loc6_;
         ...
         {
            this.onUpdate.apply(null,this.mOnUpdateArgs);
         }
         if(_loc2_ < this.mTotalTime && this.mCurrentTime >= this.mTotalTime)
         {
            ...
            {
               this.onComplete.apply(null,this.mOnCompleteArgs);
            }
         }
      }
