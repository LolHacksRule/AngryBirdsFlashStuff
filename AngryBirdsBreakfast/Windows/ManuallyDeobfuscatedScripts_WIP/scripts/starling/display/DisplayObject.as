package starling.display
{
   ...
   public class DisplayObject extends EventDispatcher
   {
      ...
      private static var USER_PROGRESS_SAVED:Matrix = new Matrix();
      ...
      public function getTransformationMatrix(param1:DisplayObject, param2:Matrix = null) : Matrix
      {
         ...
         USER_PROGRESS_SAVED.identity();
         _loc4_ = param1;
         while(_loc4_ != _loc3_)
         {
            _loc4_.getTransformationMatrix(_loc4_.mParent,sHelperMatrix);
            USER_PROGRESS_SAVED.concat(sHelperMatrix);
            _loc4_ = _loc4_.parent;
         }
         USER_PROGRESS_SAVED.invert();
         param2.concat(USER_PROGRESS_SAVED);
         return param2;
      }
      ...
      public function localToGlobal(param1:Point) : Point
      {
         ...
         return USER_PROGRESS_SAVED.transformPoint(param1);
      }
      ...
      function mShiftKey(param1:DisplayObjectContainer) : void
      {
