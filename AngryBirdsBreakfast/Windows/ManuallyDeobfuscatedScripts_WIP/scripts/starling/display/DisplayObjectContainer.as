package starling.display
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function initComplete(param1:DisplayObject) : void
      {
         var _loc2_:int = this.mChildren.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            if(param1.z < this.mChildren[_loc3_].z)
            {
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.mChildren[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.mChildren.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.mChildren[_loc6_];
            getTransformationMatrix(_loc7_,sHelperMatrix);
            transformCoords(sHelperMatrix,_loc3_,_loc4_,sHelperPoint);
            if(_loc8_ = _loc7_.hitTest(sHelperPoint,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:RenderSupport, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.mChildren[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.pushMatrix();
               param1.transformMatrix(_loc5_);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.getChildEventListeners(this,param1.type,_loc2_);
