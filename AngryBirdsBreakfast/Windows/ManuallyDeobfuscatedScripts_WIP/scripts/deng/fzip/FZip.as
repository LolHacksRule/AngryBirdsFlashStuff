   ...
   public class FZip extends EventDispatcher
   {
      ...
      public function serialize(param1:IDataOutput, param2:Boolean = false) : void
      {
         ...
         if(param1 != null && this.filesList.length > 0)
         {
            ...
            {
               if((_loc8_ = this.filesList[_loc7_] as FZipFile) != null)
               {
      ...
      {
         return this.addFileAtAt(!!this.filesList ? uint(this.filesList.length) : uint(0),param1,param2,param3,param4);
      }
      ...
      public function addFileAt(param1:uint, param2:String, param3:ByteArray = null, param4:Boolean = true) : FZipFile
      {
         ...
         var _loc5_:FZipFile;
         (_loc5_ = new FZipFile()).filename = param2;
      ...
      public function addFileAtAt(param1:uint, param2:String, param3:String, param4:String = "utf-8", param5:Boolean = true) : FZipFile
      {
         if(this.filesList == null)
         {
            this.filesList = [];
         ...
         var _loc6_:FZipFile;
         (_loc6_ = new FZipFile()).filename = param2;
      ...
      protected function SetZero(param1:IDataInput) : Boolean
      {
