package §;!§
{
   ...
   public class §#!J§ extends §;" §
   {
      ...
      override public function activate(param1:String) : void
      {
         ...
         this.§2!R§ = §6!!§.singleton.§<!S§.userProgress.§2p§(§&" §.currentLevel);
         var _loc3_:* = _loc2_ > this.§2!R§;
         if(_loc3_)
         {
            this.§9s§(_loc2_);
         }
         ...
         this.§0n§ = §'^§.§2Z§.§!!f§(this,{"mEagleScoreCounter":_loc2_},{"mEagleScoreCounter":0},_loc2_ / 100 * 4);
         this.§0n§.onComplete = this.§!!8§;
         this.§0n§.play();
      }
      ...
      {
         super.update(param1);
         if(int(this.mEagleScoreCounter) > this.§2!R§)
         {
