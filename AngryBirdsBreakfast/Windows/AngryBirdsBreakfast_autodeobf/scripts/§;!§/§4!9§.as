package §;!§
{
   ...
   public class §4!9§ extends §;" §
   {
      ...
      protected function §,"+§() : void
      {
         ...
         {
            if(-this.§&3§.x >= this.§62§[_loc1_].x && -this.§!b§ < this.§62§[_loc1_].x)
            {
               _loc2_ = 0;
      ...
      protected function §]!c§() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.§62§.length)
         {
            _loc2_ = this.§&3§.x + this.§62§[_loc1_].x;
            ...
            {
               this.§62§[_loc1_].mClip.alpha = 1 - _loc2_ / 1000;
            }
            if(this.§62§[_loc1_].mClip.alpha < 1)
            {
               (this.§62§[_loc1_] as §7!a§).setEnabled(false);
            }
            else
            {
               (this.§62§[_loc1_] as §7!a§).setEnabled(true);
            }
            _loc1_++;
         }
      }
      ...
      public function §1!;§() : void
      {
         ...
         while(_loc3_ < _loc2_.§4!5§)
         {
            ...
            this.§1!"§.push(_loc2_.§,U§(_loc3_));
            this.§7W§.push(_loc2_.§1!#§(_loc3_));
      ...
      protected function §?m§() : void
      {
         ...
         _loc3_ = this.§62§.length * _loc2_.width / 2 + _loc2_.width * 1.5;
      ...
      {
         this.§4q§ = true;
         if(param1 > this.§62§.length - 1)
         {
            param1 = this.§62§.length - 1;
         }
         else if(param1 < 0)
         {
            param1 = 0;
         ...
         var _loc3_:Number = -this.§62§[param1].x;
      ...
      protected function §8Q§() : void
      {
         ...
         this.§4q§ = false;
         §&" §.getEpisode(§&" §.currentEpisode).currentPage = this.§+A§;
      }
