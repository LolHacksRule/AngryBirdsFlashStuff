package
{
   ...
   import com.rovio.ui.popup.getContentAsString;
   ...
   public class AngryBirdsBase extends BasicGame
   {
      ...
      protected function setupPopupManager() : void
      {
         ...
         this.mTutorialPopupManager = new TutorialPopupManager(this.mPopupManager,this.mDataModel,getContentAsString.LAYER_INDEX_SCREEN);
         this.mPopupManager.addLayer(getContentAsString.LAYER_INDEX_VIEW_PORT,true,new Rectangle(0,0,-180,0));
         this.mPopupManager.addLayer(getContentAsString.LAYER_INDEX_SCREEN,true,new Rectangle(0,0,0,0));
      }
      ...
      protected function initializeManagers() : void
      {
         ...
         AngryBirdsEngine.mIsRunning = this.initializeLevelMain();
      ...
      {
         return XMLFactory.fromOctetStreamClass(UIEventListenerRovio);
      }
