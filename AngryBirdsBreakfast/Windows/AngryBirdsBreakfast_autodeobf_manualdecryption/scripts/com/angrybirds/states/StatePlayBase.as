package com.angrybirds.states
{
   ...
   public class StatePlayBase extends StateBaseLevel
   {
      ...
      override public function activate(param1:String) : void
      {
         ...
         {
            this.mLevelController = this.getGameLogicController(AngryBirdsEngine.mIsRunning);
         }
         AngryBirdsEngine.setController(this.mLevelController);
         if(AngryBirdsEngine.mIsRunning.mLevelTimeMilliSeconds == 0)
         {
            this.levelStarted();
         }
      ...
      override public function keyDown(param1:KeyboardEvent) : void
      {
         ...
         if(AngryBirdsEngine.DEBUG_MODE_ENABLED)
         {
            ...
            {
               case 87:
                  AngryBirdsEngine.mIsRunning.cheatKillAllThePigs();
                  break;
               case 66:
                  AngryBirdsEngine.mIsRunning.cheatKillAllTheDynamites();
            }
         }
      ...
      {
         var _loc1_:Number = AngryBirdsEngine.mIsRunning.camera.manualScale - AngryBirdsEngine.mIsRunning.camera.manualScaleMin;
         var _loc2_:Number = (AngryBirdsEngine.mIsRunning.camera.manualScaleMax - AngryBirdsEngine.mIsRunning.camera.manualScaleMin) / 2;
         if(_loc1_ > _loc2_)
         {
