   ...
   public class StateEpisodeSelection extends StateBaseLevel
   {
      ...
      protected function InitializeRegisters() : void
      {
         ...
         for each(_loc2_ in this.mEpisodes)
         {
            ...
            {
               _loc2_.Textfield_ME_Score.text.text = AngryBirdsBase.singleton.dataModel.userProgress.SetLimits(_loc3_) + "/" + AngryBirdsBase.singleton.dataModel.userProgress.getMaxEagleFeathersForEpisode(_loc3_);
            }
      ...
      protected function com.rovio.Box2D.Common() : void
      {
         var _loc3_:EpisodeModel = null;
      ...
      protected function addEpisode(param1:String, param2:Number, param3:EpisodeModel = null) : Number
      {
         ...
         if(param3)
         {
            ...
            {
               _loc4_.Textfield_ME_Score.text.text = AngryBirdsBase.singleton.dataModel.userProgress.SetLimits(param3) + "/" + AngryBirdsBase.singleton.dataModel.userProgress.getMaxEagleFeathersForEpisode(param3);
            }
         }
         return param2;
      }
