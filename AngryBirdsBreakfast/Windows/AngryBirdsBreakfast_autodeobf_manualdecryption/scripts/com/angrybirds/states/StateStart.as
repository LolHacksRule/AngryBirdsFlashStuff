package com.angrybirds.states
{
   ...
   public class StateStart extends StateBaseLevel
   {
      ...
      public function StateStart(param1:LevelManager, param2:LocalizationManager, param3:Boolean = false, param4:String = "LevelStartState")
      {
      ...
      override protected function init() : void
      {
         ...
         this.mEngineController = new SlowScrollController(AngryBirdsEngine.mIsRunning,mLevelManager);
      ...
      override public function activate(param1:String) : void
      {
         ...
         mUIView.getItemByName("MovieClip_ParticlesOff").setVisibility(!AngryBirdsEngine.LINEAR_SLEEP_TOLERANCE_SPACE());
      ...
      private function updateMenuButtons(param1:Number) : void
      {
         ...
         if(this.mIsOpenLeftMenu)
         {
            ...
            {
               this.mLeftMenuRotation += 0.3 * param1;
            }
            if(this.mLeftMenuRotation > 90)
            {
         ...
         if(this.mIsOpenRightMenu)
         {
            ...
            {
               this.mRightMenuRotation += 0.5 * param1;
               (mUIView.getItemByName("Container_MenuRightButtons") as UIContainerRovio).y = (mUIView.getItemByName("Container_MenuRightButtons") as UIContainerRovio).y - 0.5 * param1;
            }
            if(this.mRightMenuRotation > 180)
            {
            ...
            {
               this.mRightMenuPosY += 0.5 * param1;
            }
            if(this.mRightMenuPosY > this.mRightMenuHeight)
            {
      ...
      override protected function onUIInteraction(param1:int, param2:String, param3:UIEventListenerRovio) : void
      {
         ...
         switch(param2)
         {
            ...
            case "TOGGLE_PARTICLES":
               _loc4_ = !AngryBirdsEngine.LINEAR_SLEEP_TOLERANCE_SPACE();
               AngryBirdsEngine.setParticlesEnabled(_loc4_);
               mUIView.getItemByName("MovieClip_ParticlesOff").setVisibility(!_loc4_);
               break;
            ...
            case "SOUNDS_BUTTON":
               SoundEngine.playSound("Menu_Confirm");
               _loc5_ = !AngryBirdsBase.getSoundsEnabled();
               AngryBirdsBase.setSoundsEnabled(_loc5_);
               if(_loc5_)
               {
                  AngryBirdsBase.singleton.playThemeMusic();
               }
               mUIView.getItemByName("MovieClip_SoundsOff").setVisibility(!_loc5_);
               break;
