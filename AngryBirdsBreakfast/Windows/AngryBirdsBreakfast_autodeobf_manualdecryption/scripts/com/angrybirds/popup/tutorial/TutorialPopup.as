package com.angrybirds.popup.tutorial
{
   ...
   public class TutorialPopup extends AbstractPopup
   {
      ...
      protected static const mTutorialMusic:String = "bird_tutorial_1";
      ...
      override protected function show(param1:Boolean = false) : void
      {
         if(!mTutorialMusic)
         {
            mTutorialMusic = SoundEngine.playSound(mTutorialMusic,SoundEngine.DEFAULT_CHANNEL_NAME,int.MAX_VALUE);
         }
         super.show(param1);
      }
