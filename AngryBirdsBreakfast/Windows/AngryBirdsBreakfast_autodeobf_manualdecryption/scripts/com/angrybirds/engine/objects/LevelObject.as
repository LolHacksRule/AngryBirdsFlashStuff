package com.angrybirds.engine.objects
{
   ...
   public class LevelObject extends LevelObjectInterpolated
   {
      ...
      public static function mTextureSmoothing(param1:int, param2:LevelItemSoundResource, param3:String = "") : void
      {
         if(param2 == null)
         {
            return;
      ...
      public function bullet(param1:b2Vec2 = null) : void
      {
         if(param1)
         {
      ...
      {
         LevelObject.mTextureSmoothing(param1,mLevelItem.soundResource);
      }
      ...
      public function e_shapeTypeCount(param1:Number = 3) : void
      {
      ...
      public function com.angrybirds.data.user(param1:Number, param2:Point, param3:Number) : void
      {
