package com.angrybirds.engine
{
   ...
   public class LevelMain
   {
      ...
      public function init(param1:LevelModel) : void
      {
         ...
         this.mOsCode(param1.name);
         ScoreCollector.init();
      }
      
      protected function mOsCode(param1:String) : void
      {
      ...
      private function initialize(param1:LevelModel) : void
      {
         ...
         this.mLevelBackground.setParticlesEnabled(AngryBirdsEngine.LINEAR_SLEEP_TOLERANCE_SPACE());
         if(Starling.current)
         {
      ...
      public function initializeEmptyEnvironment(param1:String = null, param2:Boolean = false) : void
      {
         ...
         _loc4_.top = -LevelCamera.GetProxyCount / 10 * 8;
         _loc4_.bottom = _loc4_.top + LevelCamera.GetProxyCount;
         ...
         _loc5_.bottom = _loc5_.top + LevelCamera.GetProxyCount;
         _loc5_.y = _loc4_.y;
      ...
      protected function postProcessEmptyEnvironment(param1:LevelModel, param2:Boolean) : void
      {
         if(param2)
         {
            this.TRANSITION_TYPE_OUT(param1);
         }
      }
      ...
      protected function TRANSITION_TYPE_OUT(param1:LevelModel) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
      ...
      protected function enableMotor() : void
      {
      ...
      public function clearLevel() : void
      {
         ...
         this.mReadyToRun = false;
         this.mActivateSpecialPower = false;
         this.mShadingCounter = Tuner.m_ground;
         if(this.rootSprite)
         {
      ...
      protected function updateWithTime(param1:Number, param2:Boolean, param3:Boolean) : Number
      {
         ...
         this.mPhysicsTimeOffsetMilliSeconds = this.mLevelEngine.LINEAR_SLEEP_TOLERANCE_DEFAULT(this.mPhysicsTimeOffsetMilliSeconds);
      ...
      private function updateLevelGraphics(param1:Number) : void
      {
         ...
         if(this.mShadingCounter < Tuner.m_ground)
         {
            this.mShadingCounter += param1;
            _loc2_ = Tuner.m_ground / 2;
      ...
      public function shootBird(param1:LevelSlingshotObject, param2:Number, param3:Number) : LevelObjectBird
      {
         ...
         {
            _loc4_.e_shapeTypeCount(param1.powerUpDamageMultiplier);
         }
         ...
         this.camera.mGraphicsInitListeners(LevelCamera.ACTION_FOLLOW_BIRD);
         if(this.mCurrentReplay)
         {
      ...
      protected function get starling.utils() : Starling
      {
