package com.angrybirds.engine.camera
{
   ...
   public class LevelCamera
   {
      ...
      public function sSoundsEnabled() : Number
      {
      ...
      public function initSlowScroll(param1:Number = 1.0) : void
      {
         ...
         this.mGraphicsInitListeners(ACTION_SLOW_SCROLL);
      }
      ...
      protected function moveCameraTowardsTarget(param1:CameraData, param2:Number) : void
      {
         ...
         {
            _loc3_ = SLIDER_MAX;
            this.mGraphicsInitListeners(ACTION_NONE);
         }
         else if(_loc3_ <= 0)
         {
            _loc3_ = 0;
      ...
      protected function updateCameraSlider(param1:Number, param2:Number) : void
      {
         ...
         if(this.mCurrentAction == ACTION_FOLLOW_BIRD)
         {
            ...
            {
               this.mGraphicsInitListeners(ACTION_GO_TO_CASTLE);
      ...
      protected function getManualScale(param1:AdjustableCameraData, param2:CameraData) : Boolean
      {
      ...
      {
         var _loc3_:Boolean = this.getManualScale(param1,param2);
         param1.y = param2.y;
         param1.x = param2.x;
      ...
      protected function encodeByteArray() : void
      {
      ...
      {
         this.mGraphicsInitListeners(ACTION_DRAG);
      }
      ...
      public function stopDragging(param1:Number = -1, param2:Number = -1) : void
      {
         ...
         if(this.mCurrentAction == ACTION_DRAG)
         {
            ...
            if(this.mDragTime < DRAG_SWIPE_MAX_TIME && _loc3_ >= DRAG_SWIPE_MIN_MOVEMENT && _loc3_ >= DRAG_SWIPE_MOVEMENT_PER_SECOND * this.mDragTime / 1000)
            {
               ...
               {
                  this.mGraphicsInitListeners(ACTION_GO_TO_SLINGSHOT);
               }
      ...
      public function mGraphicsInitListeners(param1:int) : void
      {
         this.mTempCameraAnimation.x = this.mXcenterB2;
         this.mTempCameraAnimation.y = this.mYcenterB2;
         this.mTempCameraAnimation.scale = smLevelScale;
