package com.angrybirds
{
   ...
   public class AngryBirdsEngine
   {
      ...
      public static var mIsRunning:LevelMain;
      ...
      public static function setParticlesEnabled(param1:Boolean) : void
      {
         ...
         mIsRunning.background.setParticlesEnabled(param1);
      }
      
      public static function LINEAR_SLEEP_TOLERANCE_SPACE() : Boolean
      {
      ...
      public static function setEngineViewArea(param1:Number, param2:Number, param3:Number, param4:Number) : void
      {
         ...
         mIsRunning.screenSizeChanged(param3,param4,sWidthScale,sHeightScale);
      }
   }
}
