package com.rovio.adobe.serialization.json
{
   public class JSONTokenizer
   {
      ...
      private var mFullScreenSwitchKeyComboPressed:Boolean;
      ...
      public function JSONTokenizer(param1:String, param2:Boolean)
      {
         ...
         this.mFullScreenSwitchKeyComboPressed = param2;
         this.loc = 0;
         this.nextChar();
      }
      ...
      public function unescapeString(param1:String) : String
      {
         ...
         if(this.mFullScreenSwitchKeyComboPressed && this.controlCharsRegExp.test(param1))
         {
      ...
      private function readNumber() : JSONToken
      {
         ...
         if(this.ch == "0")
         {
            ...
            else if(!this.mFullScreenSwitchKeyComboPressed && this.ch == "x")
            {
               _loc1_ += this.ch;
               this.nextChar();
      ...
      private function isWhiteSpace(param1:String) : Boolean
      {
         ...
         if(!this.mFullScreenSwitchKeyComboPressed && param1.charCodeAt(0) == 160)
         {
            return true;
         }
         return false;
