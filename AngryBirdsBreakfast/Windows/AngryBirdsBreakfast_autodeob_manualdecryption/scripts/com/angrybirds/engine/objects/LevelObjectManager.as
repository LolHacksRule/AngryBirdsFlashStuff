   ...
   public class LevelObjectManager implements ILevelObjectUpdateManager
   {
      ...
      private function generateGroundTexture() : void
      {
         ...
         if(_loc1_)
         {
            ...
            this.mCtrlKey(_loc17_.rect,_loc17_,_loc12_ * _loc18_);
      ...
      private function mCtrlKey(param1:Rectangle, param2:BitmapData, param3:Number) : void
      {
      ...
      protected function addObjectFromModel(param1:LevelObjectModel, param2:int, param3:Boolean = false, param4:Boolean = false, param5:Boolean = true, param6:Number = 1.0, param7:Boolean = false) : LevelObjectBase
      {
         ...
         if(param7)
         {
            this.mObjectSprite.initComplete(_loc8_);
         }
         else
         {
            this.mOverlaySprite.initComplete(_loc8_);
         }
         if(param3)
         {
      ...
      protected function groupIndex(param1:LevelObject, param2:LevelObject) : Number
      {
         if(param2 is LevelObjectBird)
         {
            return 0;
      ...
      {
         var _loc4_:Number = this.groupIndex(param1,param2);
         var _loc5_:Number = this.groupIndex(param2,param1);
      ...
      public function objectCollision(param1:LevelObjectBase, param2:LevelObjectBase, param3:b2Contact) : Boolean
      {
         ...
         if(_loc4_ is LevelObjectBird)
         {
            if(_loc12_ <= 0)
            {
               ...
               this.getPrismaticJointBuffer(_loc4_ as LevelObjectBird,_loc6_ * _loc9_,_loc8_,_loc16_);
               return false;
            }
         }
         if(_loc5_ is LevelObjectBird)
         {
            if(_loc11_ <= 0)
            {
               ...
               this.getPrismaticJointBuffer(_loc5_ as LevelObjectBird,_loc6_ * _loc10_,_loc7_,_loc17_);
               return false;
            }
         }
      ...
      protected function getPrismaticJointBuffer(param1:LevelObjectBird, param2:Number, param3:Number, param4:Number) : void
      {
         if(param2 == 0)
         {
            return;
