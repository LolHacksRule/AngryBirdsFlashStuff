package §0"D§
{
   ...
   public class §!#S§
   {
      ...
      public static function §-6§(param1:Rectangle, param2:Rectangle, param3:Rectangle = null) : Rectangle
      {
         if(param3 == null)
         {
      ...
      public static function §!"P§(param1:Rectangle, param2:Rectangle, param3:String = "showAll", param4:Boolean = false, param5:Rectangle = null) : Rectangle
      {
         if(!§0! §.§,"O§(param3))
         {
         ...
         if(param3 == §0! §.§3$A§)
         {
            ...
            if(param4)
            {
               _loc10_ = §4q§(_loc10_,false);
            }
         }
         else if(param3 == §0! §.§2"V§)
         {
            _loc10_ = _loc8_ > _loc9_ ? Number(_loc8_) : Number(_loc9_);
            if(param4)
            {
               _loc10_ = §4q§(_loc10_,true);
            }
         }
         _loc6_ *= _loc10_;
         _loc7_ *= _loc10_;
      ...
      private static function §4q§(param1:Number, param2:Boolean) : Number
      {
         var _loc3_:Number = 1;
         if(param2)
         {
