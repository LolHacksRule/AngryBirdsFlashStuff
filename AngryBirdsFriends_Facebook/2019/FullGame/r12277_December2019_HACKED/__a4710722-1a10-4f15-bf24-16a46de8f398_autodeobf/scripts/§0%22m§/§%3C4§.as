package §0"m§
{
   public class §<4§
   {
      ...
      public static function get §3"1§() : §<4§
      {
         return §!#m§;
      }
      ...
      {
         return §@"A§[this.randRange(0,§@"A§.length - 1)];
      }
      
      public function §2#V§() : String
      {
         return §&7§[this.randRange(0,§&7§.length - 1)];
      }
