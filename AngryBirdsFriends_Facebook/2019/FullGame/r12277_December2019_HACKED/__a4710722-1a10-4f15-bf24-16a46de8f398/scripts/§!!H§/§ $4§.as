package §!!H§
{
   ...
   public class § $4§
   {
      ...
      protected static var §,!H§:Font = new AngryBirdsFont();
      ...
      public static function §[$0§(param1:Number) : Boolean
      {
         ...
         return Number(_loc3_ - param1) < §%2§.§7"m§;
      }
      
      public static function §"#n§(param1:§8#E§) : void
      {
         if(!param1)
         {
            return;
         ...
         {
            §,#b§(AngryBirdsBase.singleton.dataModel).§^"O§.§""C§(§ !G§.§-y§,[param1.id]);
         }
         var _loc2_:int = §,#b§(AngryBirdsBase.singleton.dataModel).§0$6§.indexOf(param1.id);
         if(_loc2_ > -1)
         {
            §,#b§(AngryBirdsBase.singleton.dataModel).§0$6§.splice(_loc2_,1);
         }
         var _loc3_:int = 0;
         while(_loc3_ < param1.§+!2§())
         {
            _loc2_ = §,#b§(AngryBirdsBase.singleton.dataModel).§'$2§.indexOf(param1.id + param1.getPricePoint(_loc3_).price);
            if(_loc2_ > -1)
            {
               §,#b§(AngryBirdsBase.singleton.dataModel).§^"O§.§""C§(§ !G§.§-y§,[param1.id + param1.getPricePoint(_loc3_).price]);
               §,#b§(AngryBirdsBase.singleton.dataModel).§'$2§.splice(_loc2_,1);
            }
            _loc3_++;
         }
         (§+!p§.§;"-§ as §^"a§).§,#@§();
      ...
      public static function §'#d§(param1:TextField, param2:String, param3:Number = 0) : void
      {
      ...
      public static function §]#"§(param1:int) : String
      {
      ...
      public static function §1"n§(param1:Number) : Array
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc8_:int = 0;
      ...
      public static function §#L§(param1:String, param2:String, param3:MovieClip) : void
      {
         var _loc5_:int = 0;
         var _loc6_:MovieClip = null;
         var _loc4_:Class;
         if(_loc4_ = §=@§.§9!x§(param1,false,false))
         {
            _loc5_ = 1;
