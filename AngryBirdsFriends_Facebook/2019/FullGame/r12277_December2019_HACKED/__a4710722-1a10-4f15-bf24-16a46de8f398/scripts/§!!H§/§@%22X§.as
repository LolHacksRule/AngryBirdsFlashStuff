package §!!H§
{
   public class §@"X§
   {
      ...
      {
         return §1!r§(§ #e§(param1,param2),param2);
      }
      ...
      public static function § #e§(param1:String, param2:String) : String
      {
         ...
         {
            param1 = § #e§(param1.substring(1),param2);
         }
         return param1;
      }
      
      public static function §1!r§(param1:String, param2:String) : String
      {
         param2 = §+!y§(param2);
         if(param1.charAt(param1.length - 1) == param2)
         {
            param1 = §1!r§(param1.substring(0,param1.length - 1),param2);
         }
         return param1;
      }
