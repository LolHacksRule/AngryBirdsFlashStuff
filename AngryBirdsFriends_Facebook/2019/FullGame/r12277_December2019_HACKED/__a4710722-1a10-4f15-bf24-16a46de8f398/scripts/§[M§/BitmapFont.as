package §[M§
{
   ...
   public class BitmapFont
   {
      ...
      public static const §1!0§:int = -1;
      
      public static const §#!R§:String = "mini";
      
      private static const §%!-§:int = 32;
      
      private static const §^a§:int = 9;
      
      private static const §""`§:int = 10;
      
      private static const §8!]§:int = 13;
      ...
      public function BitmapFont(param1:Texture = null, param2:XML = null)
      {
         ...
         this.§-#3§ = "unknown";
         this.§;"E§ = this.§3#K§ = this.§[$7§ = 14;
         this.§+!E§ = param1;
         this.§=>§ = new Dictionary();
         this.§^!R§ = new Image(param1);
      ...
      private function §&r§(param1:XML) : void
      {
         ...
         var _loc2_:Number = this.§+!E§.scale;
         var _loc3_:Rectangle = this.§+!E§.frame;
         this.§-#3§ = param1.info.attribute("face");
         this.§3#K§ = parseFloat(param1.info.attribute("size")) / _loc2_;
         this.§;"E§ = parseFloat(param1.common.attribute("lineHeight")) / _loc2_;
         this.§[$7§ = parseFloat(param1.common.attribute("base")) / _loc2_;
         if(param1.info.attribute("smooth").toString() == "0")
         {
            this.smoothing = Image.§"m§;
         }
         if(this.§3#K§ <= 0)
         {
            this.§3#K§ = this.§3#K§ == 0 ? Number(16) : Number(this.§3#K§ * -1);
         }
         for each(_loc4_ in param1.chars.char)
         {
            ...
            _loc11_ = Texture.§;&§(this.§+!E§,_loc10_);
            _loc12_ = new §=#e§(_loc6_,_loc11_,_loc7_,_loc8_,_loc9_);
            this.§2!+§(_loc6_,_loc12_);
         }
         for each(_loc5_ in param1.kernings.kerning)
         {
            ...
            if(_loc14_ in this.§=>§)
            {
               this.§4"n§(_loc14_).§5!e§(_loc13_,_loc15_);
            }
         }
      }
      
      public function §4"n§(param1:int) : §=#e§
      {
         return this.§=>§[param1];
      }
      
      public function §2!+§(param1:int, param2:§=#e§) : void
      {
         this.§=>§[param1] = param2;
      }
      
      public function §8D§(param1:Number, param2:Number, param3:String, param4:Number = -1, param5:uint = 16777215, param6:String = "center", param7:String = "center", param8:Boolean = true, param9:Boolean = true) : Sprite
      {
         var _loc14_:CharLocation = null;
         var _loc15_:Image = null;
         var _loc10_:Vector.<CharLocation>;
         var _loc11_:int = (_loc10_ = this.§;$8§(param1,param2,param3,param4,param6,param7,param8,param9)).length;
         var _loc12_:Sprite = new Sprite();
         var _loc13_:int = 0;
         while(_loc13_ < _loc11_)
         {
            (_loc15_ = (_loc14_ = _loc10_[_loc13_]).char.§3!;§()).x = _loc14_.x;
            _loc15_.y = _loc14_.y;
      ...
      public function §`#K§(param1:§6!`§, param2:Number, param3:Number, param4:String, param5:Number = -1, param6:uint = 16777215, param7:String = "center", param8:String = "center", param9:Boolean = true, param10:Boolean = true) : void
      {
         var _loc14_:CharLocation = null;
         var _loc11_:Vector.<CharLocation>;
         var _loc12_:int = (_loc11_ = this.§;$8§(param2,param3,param4,param5,param7,param8,param9,param10)).length;
         this.§^!R§.color = param6;
         if(_loc12_ > 8192)
         {
         ...
         while(_loc13_ < _loc12_)
         {
            ...
            this.§^!R§.texture = _loc14_.char.texture;
            this.§^!R§.§"$"§();
            this.§^!R§.x = _loc14_.x;
            this.§^!R§.y = _loc14_.y;
            this.§^!R§.scaleX = this.§^!R§.scaleY = _loc14_.scale;
            param1.§6!+§(this.§^!R§);
            _loc13_++;
         }
      }
      
      private function §;$8§(param1:Number, param2:Number, param3:String, param4:Number = -1, param5:String = "center", param6:String = "center", param7:Boolean = true, param8:Boolean = true) : Vector.<CharLocation>
      {
         ...
         while(!_loc10_)
         {
            ...
            if(this.§;"E§ <= _loc14_)
            {
               ...
               while(_loc26_ < _loc12_)
               {
                  ...
                  _loc29_ = this.§4"n§(_loc28_);
                  if(_loc28_ == §""`§ || _loc28_ == §8!]§)
                  {
                     _loc27_ = true;
                  }
                  else if(_loc29_ != null)
                  {
                     if(_loc28_ == §%!-§ || _loc28_ == §^a§)
                     {
                        _loc21_ = _loc26_;
                     }
                     if(param8)
                     {
                        _loc23_ += _loc29_.§+#i§(_loc22_);
                     }
         ...
         var _loc18_:Number = _loc24_ + this.§;"E§;
         var _loc19_:int = 0;
         if(param6 == §=#?§.BOTTOM)
         {
      ...
      {
         return this.§^!R§.smoothing;
      }
      
      public function set smoothing(param1:int) : void
      {
         this.§^!R§.smoothing = param1;
      }
...
class CharLocation
{
   ...
   function CharLocation(param1:§=#e§)
   {
      super();
      this.char = param1;
   }
