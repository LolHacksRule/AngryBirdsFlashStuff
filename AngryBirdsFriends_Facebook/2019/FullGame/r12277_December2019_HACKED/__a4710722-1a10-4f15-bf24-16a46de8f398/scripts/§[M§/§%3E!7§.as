package §[M§
{
   ...
   class §>!7§
   {
      ...
      {
         var _loc1_:BitmapData = new BitmapData(§`"O§,§6N§);
         var _loc2_:ByteArray = new ByteArray();
         var _loc3_:int = §6#c§.length;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc2_.writeUnsignedInt(§6#c§[_loc4_]);
            _loc4_++;
         }
         _loc2_.uncompress();
         _loc1_.setPixels(new Rectangle(0,0,§`"O§,§6N§),_loc2_);
         return Texture.§&#<§(null,_loc1_,false);
      }
