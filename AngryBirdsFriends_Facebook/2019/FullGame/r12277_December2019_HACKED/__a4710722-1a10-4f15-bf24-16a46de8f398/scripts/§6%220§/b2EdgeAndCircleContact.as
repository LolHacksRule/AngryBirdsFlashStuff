package §6"0§
{
   ...
   public class b2EdgeAndCircleContact extends b2Contact
   {
      ...
      override b2internal function Evaluate() : void
      {
         ...
         this.§8!v§(b2internal::[!2,b2internal::#";.GetShape() as b2EdgeShape,_loc1_.m_xf,b2internal::0#0.GetShape() as b2CircleShape,_loc2_.m_xf);
      }
      
      private function §8!v§(param1:b2Manifold, param2:b2EdgeShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
      }
   }
}
