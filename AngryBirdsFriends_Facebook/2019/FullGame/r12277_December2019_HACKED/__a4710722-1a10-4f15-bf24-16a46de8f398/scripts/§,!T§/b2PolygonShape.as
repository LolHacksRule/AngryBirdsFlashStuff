package §,!T§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §!"_§:b2Mat22 = new b2Mat22();
      ...
      b2internal var §,j§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         this.§,j§ = new Vector.<b2Vec2>();
         §?#o§ = b2Settings.b2_polygonRadius;
         this.§?N§.§%"N§();
      }
      
      public static function §>"t§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function §7#b§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §9#r§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§1!p§(param1,param2);
         return _loc3_;
      }
      
      public static function §^$0§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§8!Y§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §<"L§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §%!t§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§?$6§(new b2Vec2(0,0));
            _loc3_.§?$6§(_loc9_);
            _loc3_.§?$6§(_loc10_);
            _loc3_.§%!G§(_loc16_ * _loc7_);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §&$4§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§2"y§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§2"y§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            while(_loc3_ < this.§;!p§)
            {
               ...
               this.§,j§[_loc3_].SetV(_loc2_.§,j§[_loc3_]);
               _loc3_++;
            }
         }
      }
      ...
      public function §["4§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§;!p§)
         {
            this.§?#b§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§;!p§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§;!p§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§5#w§(this.§?#b§[_loc5_],this.§?#b§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§&A§() > Number.MIN_VALUE);
            this.§,j§[_loc3_].SetV(b2Math.§&"_§(_loc6_,1));
            this.§,j§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§?N§ = §%!t§(this.§?#b§,this.§;!p§);
      }
      
      public function §1!p§(param1:Number, param2:Number) : void
      {
         this.§;!p§ = 4;
         this.§6#r§(4);
         this.§?#b§[0].Set(-param1,-param2);
         this.§?#b§[1].Set(param1,-param2);
         this.§?#b§[2].Set(param1,param2);
         this.§?#b§[3].Set(-param1,param2);
         this.§,j§[0].Set(0,-1);
         this.§,j§[1].Set(1,0);
         this.§,j§[2].Set(0,1);
         this.§,j§[3].Set(-1,0);
      ...
      public function §8!Y§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§;!p§ = 4;
         this.§6#r§(4);
         this.§?#b§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§;!p§)
         {
            this.§?#b§[_loc6_] = b2Math.§6#k§(_loc5_,this.§?#b§[_loc6_]);
            this.§,j§[_loc6_] = b2Math.§;"V§(_loc5_.R,this.§,j§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §^!Z§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§;!p§ = 2;
         this.§6#r§(2);
         this.§?#b§[0].SetV(param1);
         this.§?#b§[1].SetV(param2);
         this.§?N§.x = 0.5 * (param1.x + param2.x);
         this.§?N§.y = 0.5 * (param1.y + param2.y);
         this.§,j§[0] = b2Math.§&"_§(b2Math.§5#w§(param2,param1),1);
         this.§,j§[0].Normalize();
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§;!p§)
         {
            _loc6_ = (_loc9_ = this.§?#b§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§,j§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§4#1§.x = _loc5_ - b2internal::?#o;
         param1.§4#1§.y = _loc6_ - b2internal::?#o;
         param1.§,!W§.x = _loc7_ + b2internal::?#o;
         param1.§,!W§.y = _loc8_ + b2internal::?#o;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§;!p§ == 2)
         {
            param1.center.x = 0.5 * (this.§?#b§[0].x + this.§?#b§[1].x);
            param1.center.y = 0.5 * (this.§?#b§[0].y + this.§?#b§[1].y);
            param1.§>#0§ = 0;
            param1.§ $=§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§;!p§)
         {
            _loc11_ = this.§?#b§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§;!p§ ? this.§?#b§[int(_loc10_ + 1)] : this.§?#b§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§,#4§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§-"C§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§-"C§(_loc5_,this.§?#b§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§6#k§(param3,_loc24_.center));
                  return _loc24_.§>#0§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§;!p§;
         var _loc14_:int = (_loc10_ + 1) % this.§;!p§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§?#b§[_loc9_].x * (1 - _loc15_) + this.§?#b§[_loc13_].x * _loc15_,this.§?#b§[_loc9_].y * (1 - _loc15_) + this.§?#b§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§?#b§[_loc10_].x * (1 - _loc16_) + this.§?#b§[_loc14_].x * _loc16_,this.§?#b§[_loc10_].y * (1 - _loc16_) + this.§?#b§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§?#b§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§;!p§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§?#b§[_loc12_];
            }
         ...
         _loc20_.§%!G§(1 / _loc19_);
         param4.SetV(b2Math.§6#k§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §;"j§() : Vector.<b2Vec2>
      {
         return this.§?#b§;
      }
      
      public function §6"-§() : Vector.<b2Vec2>
      {
         return this.§,j§;
      }
      ...
      private function §6#r§(param1:int) : void
      {
         var _loc2_:int = this.§?#b§.length;
         while(_loc2_ < param1)
         {
            this.§?#b§[_loc2_] = new b2Vec2();
            this.§,j§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
