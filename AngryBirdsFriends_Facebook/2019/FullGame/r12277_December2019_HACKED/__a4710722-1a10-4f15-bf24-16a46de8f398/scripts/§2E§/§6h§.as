package §2E§
{
   ...
   public class §6h§
   {
      ...
      public static function §<#E§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         jsonString = §`!a§(luaString,emptyObjectAsArray);
         try
         {
      ...
      public static function §`!a§(param1:String, param2:Boolean = false) : String
      {
         ...
         return §7#E§(param1,param2);
      }
      
      private static function §7#E§(param1:String, param2:Boolean) : String
      {
      ...
      private static function §]#d§(param1:Object, param2:int) : String
      {
         var _loc4_:* = null;
         var _loc5_:int = 0;
         param2++;
         ...
         for(_loc4_ in param1)
         {
            ...
            _loc3_ += _loc4_ + " = " + §3#n§(param1[_loc4_],param2);
            if(param2 > 1)
            {
               _loc3_ += ",";
            }
      ...
      private static function §3#n§(param1:*, param2:int) : String
      {
         ...
         else
         {
            ...
            if(param1 is Array)
            {
               ...
               {
                  _loc3_ += §3#n§(param1[_loc6_],param2) + (_loc6_ < param1.length - 1 ? "," : "");
                  _loc6_++;
               }
               return _loc3_ + "}";
            }
