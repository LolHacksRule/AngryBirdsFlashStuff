package §9$A§
{
   ...
   public class b2Collision
   {
      ...
      private static var §1#=§:Vector.<§-!T§> = §,!s§();
      
      private static var s_clipPoints1:Vector.<§-!T§> = §,!s§();
      
      private static var s_clipPoints2:Vector.<§-!T§> = §,!s§();
      
      private static var §"]§:Vector.<int> = new Vector.<int>(1);
      
      private static var §!n§:Vector.<int> = new Vector.<int>(1);
      ...
      private static var §9"A§:b2Vec2 = new b2Vec2();
      ...
      public static function § "d§(param1:Vector.<§-!T§>, param2:Vector.<§-!T§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§-!T§ = null;
         var _loc6_:int = 0;
      ...
      public static function §^"d§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         int(param1.§;!p§);
         var _loc7_:Vector.<b2Vec2> = param1.§?#b§;
         var _loc8_:Vector.<b2Vec2> = param1.§,j§;
         var _loc9_:int = param4.§;!p§;
         var _loc10_:Vector.<b2Vec2> = param4.§?#b§;
         _loc11_ = param2.R;
      ...
      public static function §"%§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§;!p§;
         var _loc7_:Vector.<b2Vec2> = param2.§,j§;
         _loc9_ = param5.R;
         _loc8_ = param4.§?N§;
         ...
         var _loc17_:Number = §^"d§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §^"d§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §^"d§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §^"d§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §+#6§(param1:Vector.<§-!T§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc23_:Number = NaN;
         int(param2.§;!p§);
         var _loc8_:Vector.<b2Vec2> = param2.§,j§;
         var _loc9_:int = param5.§;!p§;
         var _loc10_:Vector.<b2Vec2> = param5.§?#b§;
         var _loc11_:Vector.<b2Vec2> = param5.§,j§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§+"n§.§3!q§ = param4;
         _loc20_.id.§+"n§.§##Q§ = _loc21_;
         _loc20_.id.§+"n§.§#!Z§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§+"n§.§3!q§ = param4;
         _loc20_.id.§+"n§.§##Q§ = _loc22_;
         _loc20_.id.§+"n§.§#!Z§ = 1;
      }
      
      private static function §,!s§() : Vector.<§-!T§>
      {
         var _loc1_:Vector.<§-!T§> = new Vector.<§-!T§>(2);
         _loc1_[0] = new §-!T§();
         _loc1_[1] = new §-!T§();
         return _loc1_;
      }
      
      public static function §6z§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§-!T§ = null;
         ...
         var _loc10_:int = 0;
         §!n§[0] = _loc10_;
         var _loc11_:Number = §"%§(§!n§,param4,param5,param2,param3);
         _loc10_ = §!n§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§ "u§ = b2Manifold.§]"d§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§-!T§> = §1#=§;
         §+#6§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§;!p§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§?#b§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §[o§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §?$5§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §`!i§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §'"8§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§-!T§> = s_clipPoints1;
         var _loc38_:Vector.<§-!T§> = s_clipPoints2;
         if(int(§ "d§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if(int(§ "d§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§]"§.SetV(_loc27_);
      ...
      public static function §@#8§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§ "u§ = b2Manifold.§8"W§;
         param1.m_localPoint.SetV(param2.§>4§);
         param1.§]"§.§%"N§();
         param1.§?#Z§ = 1;
         param1.§7#K§[0].m_localPoint.SetV(param4.§>4§);
         param1.§7#K§[0].m_id.key = 0;
      }
      
      public static function §;#O§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§;!p§;
         var _loc22_:Vector.<b2Vec2> = param2.§?#b§;
         var _loc23_:Vector.<b2Vec2> = param2.§,j§;
         var _loc24_:int = 0;
      ...
      public static function §!"j§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§4#1§;
