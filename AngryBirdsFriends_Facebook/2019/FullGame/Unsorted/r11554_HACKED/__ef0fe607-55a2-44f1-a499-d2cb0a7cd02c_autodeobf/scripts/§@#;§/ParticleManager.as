package §@#;§
{
   ...
   public class ParticleManager
   {
      ...
      private static var §>#0§:Vector.<Texture> = new Vector.<Texture>();
      ...
      public static function §0c§(param1:String, param2:§=#;§) : §&A§
      {
         var _loc3_:ParticleResource = §continue§(param1);
         if(!_loc3_)
         {
            return null;
         }
         ...
         if(§>#0§.indexOf(_loc5_) < 0)
         {
            §>#0§.push(_loc5_);
         }
         return new §&A§(_loc3_.config,_loc5_);
      }
      
      private static function §continue§(param1:String) : ParticleResource
      {
