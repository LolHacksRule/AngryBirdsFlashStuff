package §0J§
{
   ...
   public class b2AABB
   {
      ...
      {
         var _loc1_:Number = this.§='§.x - this.§3"]§.x;
         var _loc2_:Number = this.§='§.y - this.§3"]§.y;
         var _loc3_:Boolean = _loc1_ >= 0 && _loc2_ >= 0;
         return Boolean(_loc3_ && this.§3"]§.§&#=§() && this.§='§.§&#=§());
      }
      
      public function §&p§() : b2Vec2
      {
         return new b2Vec2((this.§3"]§.x + this.§='§.x) / 2,(this.§3"]§.y + this.§='§.y) / 2);
      }
      
      public function §!$#§() : b2Vec2
      {
         return new b2Vec2((this.§='§.x - this.§3"]§.x) / 2,(this.§='§.y - this.§3"]§.y) / 2);
      }
      
      public function §8"B§(param1:b2AABB) : Boolean
      {
      ...
      public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput) : Boolean
      {
         ...
         {
            if(_loc5_ < this.§3"]§.x || this.§='§.x < _loc5_)
            {
               return false;
            }
         }
         ...
         {
            if(_loc6_ < this.§3"]§.y || this.§='§.y < _loc6_)
            {
               return false;
            }
         }
      ...
      {
         var _loc2_:Number = param1.§3"]§.x - this.§='§.x;
         var _loc3_:Number = param1.§3"]§.y - this.§='§.y;
         var _loc4_:Number = this.§3"]§.x - param1.§='§.x;
         var _loc5_:Number = this.§3"]§.y - param1.§='§.y;
