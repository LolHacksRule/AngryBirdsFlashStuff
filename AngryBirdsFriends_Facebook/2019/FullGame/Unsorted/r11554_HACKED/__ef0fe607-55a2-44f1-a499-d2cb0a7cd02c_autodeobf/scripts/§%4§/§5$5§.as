package §%4§
{
   ...
   public class §5$5§ extends §]#X§
   {
      
      public static const MULTIPLIER_STRING:String = "x ";
      
      private static const §4D§:String = "ButtonBGSmallDefault";
      ...
      public function §5$5§(param1:int, param2:§<#a§, param3:String, param4:String, param5:String)
      {
      ...
      {
         §>"k§[§4D§].gotoAndStop("Active_Up_Default");
      }
