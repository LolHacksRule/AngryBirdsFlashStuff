package §!"e§
{
   ...
   public class §"?§ extends §?!F§
   {
      ...
      public static function §@"M§(param1:String) : int
      {
         ...
         {
            if(param1.toUpperCase() == §@#m§.§?q§.items.§%#Z§[_loc2_].name.toUpperCase())
            {
               return _loc2_;
            }
            _loc2_++;
      ...
      public static function §-C§() : Array
      {
         ...
         {
            _loc6_ = §@#m§.§?q§.items.§%#Z§[_loc5_].name;
            _loc3_ = new §2"O§.§`>§("Icon_" + _loc6_)();
      ...
      public static function §=>§() : Array
      {
         ...
         var _loc4_:Array = [];
         var _loc5_:Array = [];
         var _loc6_:Class = §2"O§.§`>§("Repeater_Button_Editor_Items");
         var _loc7_:Class = §2"O§.§`>§("Repeater_Button_Editor_Items_Buy");
         var _loc8_:Class = §2"O§.§`>§("Repeater_Button_Editor_Items_LimitedTime");
         var _loc9_:Class = §2"O§.§`>§("Repeater_Button_Editor_Items_StarLimit");
         var _loc10_:Class = §2"O§.§`>§("Repeater_Button_Editor_Items_OnSale");
         var _loc11_:Class = §2"O§.§`>§("Tag_New");
         var _loc12_:int = §'"a§.§`!R§.getTotalStars();
         var _loc13_:Number = 0;
         while(_loc13_ < §@#m§.§?q§.items.§%#Z§.length)
         {
            _loc15_ = §@#m§.§?q§.items.§%#Z§[_loc13_].name as String;
            _loc16_ = §@#m§.§?q§.items.§%Z§(_loc15_);
            _loc4_[_loc13_] = [];
            _loc5_[_loc13_] = [];
            for each(_loc17_ in AvatarCreatorPopup.§@&§)
            {
               ...
               while(_loc19_ < _loc16_.length)
               {
                  ...
                  if(_loc17_.itemId == _loc18_.mId)
                  {
                     ...
                     _loc20_ = AvatarCreatorPopup.§4#b§(_loc18_.mId);
                     _loc21_ = AvatarCreatorPopup.§ "a§(_loc18_.mId);
                     _loc22_ = AvatarCreatorPopup.§-#J§(_loc18_.mId);
                     _loc23_ = AvatarCreatorPopup.§`"§(_loc18_.mId);
                     _loc24_ = AvatarCreatorPopup.§>"1§(_loc18_.mId);
            ...
            {
               _loc3_ = §2"O§.§`>§("Inventory_Item_None");
               _loc2_ = new _loc3_();
         ...
         return §3J§(_loc4_,_loc5_);
      }
      
      private static function §3J§(param1:Array, param2:Array) : Array
      {
      ...
      public function §4"l§() : void
      {
         ...
         §=R§("Repeater_Items","Repeater_Items_Tab_0");
         ...
         §=R§("Repeater_Tabs","Repeater_Tabs_Tab_0");
         var _loc3_:int = 0;
         while(_loc3_ < §@#m§.§?q§.items.§%#Z§.length)
         {
            _loc4_ = §@#m§.§?q§.items.§%#Z§[_loc3_].name;
            _loc1_.§[e§("Repeater_Items_Tab_" + _loc3_).§'"g§(_loc4_);
            _loc3_++;
         }
      }
   }
