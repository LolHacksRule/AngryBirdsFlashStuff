package §'!O§
{
   public class §@"d§ extends §@P§
   {
      ...
      public function §@"d§(param1:String, param2:int, param3:int, param4:String, param5:Number, param6:String, param7:String, param8:String)
      {
         super(param1,param2,param3,param4,param5,param6,param7,param8);
      }
      
      public function §0#M§(param1:Object, param2:Object, param3:Object) : void
      {
         var _loc4_:Object = null;
         var _loc5_:Object = null;
         for each(_loc4_ in param1)
         {
            this.§]$%§(_loc4_,false,param3);
         }
         for each(_loc5_ in param2)
         {
            this.§]$%§(_loc5_,true,param3);
         }
      }
      
      private function §]$%§(param1:Object, param2:Boolean, param3:Object) : void
      {
         ...
         var _loc19_:§'"8§ = new §'"8§(_loc4_,_loc5_,_loc9_,null,_loc8_,_loc7_,_loc10_,_loc11_,_loc12_,param2,_loc13_,_loc14_,_loc15_,_loc16_,_loc17_,_loc18_);
         for each(_loc20_ in param1.animations)
         {
            for(_loc22_ in param3)
            {
               if(_loc20_ == _loc22_)
               {
                  ...
                  _loc19_.§&!`§(_loc20_,_loc23_.type,_loc23_.tween,_loc24_,_loc25_,_loc26_,_loc23_.trigger,_loc27_,_loc23_.audio,_loc23_.audioVolume,_loc23_.audioLoop,_loc28_,_loc29_);
                  break;
               }
            }
         }
