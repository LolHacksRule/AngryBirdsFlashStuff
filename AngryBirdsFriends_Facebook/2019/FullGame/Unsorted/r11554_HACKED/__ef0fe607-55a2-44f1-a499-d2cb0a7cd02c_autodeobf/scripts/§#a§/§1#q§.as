package §#a§
{
   ...
   public class §1#q§
   {
      ...
      {
         this.§!l§ = this.§ U§.mask.height = param1;
      }
      ...
      protected function §%!7§(param1:Boolean = true) : void
      {
         ...
         this.calculateMargin();
         var _loc2_:int = 0;
         while(_loc2_ < this.§8"d§)
         {
            _loc3_ = this.§3"C§();
            this.§ U§.addChild(_loc3_);
            _loc3_.index = _loc2_;
            this.§0#d§(_loc3_,this.data[_loc2_]);
            this.§9n§.push(_loc3_);
            _loc2_++;
         }
         this.updatePositions();
      ...
      protected function §0#d§(param1:§<#h§, param2:Object) : void
      {
         param1.data = param2;
      }
      ...
      public function §%6§(param1:Array, param2:Boolean = true) : void
      {
         this.§"""§ = param1;
         this.clear();
         if(this.§"""§)
      ...
      protected function updatePositions() : void
      {
         ...
         while(_loc1_ < this.§"""§.length)
         {
            ...
            if(_loc3_ > -this.§@#v§ && _loc3_ < this.§<#@§ && !this.§^$ §(_loc1_))
            {
               _loc4_ = this.§3"C§();
               this.§ U§.addChild(_loc4_);
               this.§0#d§(_loc4_,this.§"""§[_loc1_]);
               _loc4_.index = _loc1_;
               _loc4_.x = _loc3_;
               this.§9n§.push(_loc4_);
            }
      ...
      protected function hide(param1:§<#h§) : void
      {
         this.§ U§.removeChild(param1);
         this.§9n§.splice(this.§9n§.indexOf(param1),1);
         this.§4$%§(param1);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.§0#d§(_loc1_,this.§"""§[_loc1_.index]);
         }
      }
