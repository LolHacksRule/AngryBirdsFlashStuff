package §`# §
{
   public class b2Vec2
   {
      ...
      public function §1t§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§4"P§(this,param1.col1);
         this.y = b2Math.§4"P§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      public function §1!K§(param1:b2Vec2) : void
      {
