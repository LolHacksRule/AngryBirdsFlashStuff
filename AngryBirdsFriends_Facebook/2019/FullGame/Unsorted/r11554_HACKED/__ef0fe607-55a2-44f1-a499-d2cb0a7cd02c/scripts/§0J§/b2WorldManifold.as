package §0J§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §7##§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§'!A§)
         {
            case b2Manifold.§["0§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§%R§[0].m_localPoint;
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§8#5§.x = _loc19_ / _loc26_;
                  this.§8#5§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§8#5§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§8#5§.x;
               _loc23_ = _loc16_ + param3 * this.§8#5§.y;
               _loc24_ = _loc17_ - param5 * this.§8#5§.x;
               _loc25_ = _loc18_ - param5 * this.§8#5§.y;
               this.§%R§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§%R§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§2r§:
               _loc8_ = param2.R;
               _loc7_ = param1.§ ;§;
               ...
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§%R§[_loc6_].m_localPoint;
                  ...
                  this.§%R§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§%R§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§@#1§:
               ...
               while(_loc6_ < param1.§?!j§)
               {
                  ...
                  this.§%R§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§%R§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
