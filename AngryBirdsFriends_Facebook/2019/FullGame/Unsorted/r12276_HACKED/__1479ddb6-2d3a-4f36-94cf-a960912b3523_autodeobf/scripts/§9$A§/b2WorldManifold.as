package §9$A§
{
   ...
   public class b2WorldManifold
   {
      ...
      public var §1"l§:b2Vec2;
      
      public var §7#K§:Vector.<b2Vec2>;
      
      public function b2WorldManifold()
      {
         this.§1"l§ = new b2Vec2();
         super();
         this.§7#K§ = new Vector.<b2Vec2>(b2Settings.b2_maxManifoldPoints);
         var _loc1_:int = 0;
         while(_loc1_ < b2Settings.b2_maxManifoldPoints)
         {
            this.§7#K§[_loc1_] = new b2Vec2();
            _loc1_++;
         }
      }
      
      public function §80§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§ "u§)
         {
            case b2Manifold.§8"W§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§7#K§[0].m_localPoint;
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§1"l§.x = _loc19_ / _loc26_;
                  this.§1"l§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§1"l§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§1"l§.x;
               _loc23_ = _loc16_ + param3 * this.§1"l§.y;
               _loc24_ = _loc17_ - param5 * this.§1"l§.x;
               _loc25_ = _loc18_ - param5 * this.§1"l§.y;
               this.§7#K§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§7#K§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§]"d§:
               _loc8_ = param2.R;
               _loc7_ = param1.§]"§;
               ...
               this.§1"l§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§?#Z§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§7#K§[_loc6_].m_localPoint;
                  ...
                  this.§7#K§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§7#K§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§3w§:
               ...
               while(_loc6_ < param1.§?#Z§)
               {
                  ...
                  this.§7#K§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§7#K§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
