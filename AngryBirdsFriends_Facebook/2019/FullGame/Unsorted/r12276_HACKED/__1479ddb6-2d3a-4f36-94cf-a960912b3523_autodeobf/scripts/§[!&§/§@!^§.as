package §[!&§
{
   ...
   public class §@!^§ extends §`#D§
   {
      ...
      protected function §^!Q§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         var _loc16_:§""B§ = null;
         var _loc3_:Dictionary = this.§6$2§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§[!V§(_loc7_,_loc6_)]) == null)
            {
      ...
      private function §[!V§(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function §6$2§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§[!V§(_loc4_,_loc6_.@name);
