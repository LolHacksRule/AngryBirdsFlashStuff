package §1#F§
{
   public class b2Settings
   {
      ...
      public static const §`!K§:Number = 0.005;
      
      public static const §1$D§:Number = 0.007;
      
      public static var b2_linearSlop:Number = §%#0§;
      
      public static const §8"3§:Number = b2_linearSlop - §`!K§;
      ...
      public static var b2_linearSleepTolerance:Number = §=T§;
