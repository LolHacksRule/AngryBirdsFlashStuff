package §,!M§
{
   ...
   public class SHA1
   {
      ...
      public static function §0c§(param1:String) : String
      {
         ...
         return §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true);
      }
      
      public static function hashBytes(param1:ByteArray) : String
      {
         var _loc2_:Array = SHA1.§9#;§(param1);
         var _loc3_:ByteArray = §#"B§(_loc2_);
         return §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc6_:uint = 0;
         var _loc2_:Array = SHA1.§;"7§(param1);
         var _loc3_:ByteArray = §#"B§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
