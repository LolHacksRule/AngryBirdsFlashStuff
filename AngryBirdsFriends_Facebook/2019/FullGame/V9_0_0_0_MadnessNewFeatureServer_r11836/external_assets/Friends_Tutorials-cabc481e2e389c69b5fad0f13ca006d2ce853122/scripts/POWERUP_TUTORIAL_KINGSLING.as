package
{
   ...
   public dynamic class POWERUP_TUTORIAL_KINGSLING extends MovieClip
   {
       
      
      public function POWERUP_TUTORIAL_KINGSLING()
      {
         super();
      }
      ...
      public function addCollisionParticles(param1:Number, param2:Number, param3:Class = null, param4:Number = 1) : void
      {
         ...
         var defaultParticleClass:Class = WoodParticle;
