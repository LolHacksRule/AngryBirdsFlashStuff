package com.angrybirds.states.tournament.branded
{
   ...
   public class StateTournamentLevelSelectionBranded extends StateTournamentLevelSelection
   {
      ...
      override protected function init() : void
      {
         ...
         {
            brandedFrameLabel = smTournamentBrand;
         }
         else
         {
            brandedFrameLabel = TournamentModel.instance.tournamentRules.brandedFrameLabel;
         }
         ...
         var themedMusic:String = "THEME_MUSIC_" + brandedFrameLabel;
         if(AssetCache.assetInCache(themedMusic))
         {
            musicManager = AngryBirdsFacebook.sSingleton.getThemeMusicManager();
            musicManager.playSongWithFade(themedMusic);
         }
      }
