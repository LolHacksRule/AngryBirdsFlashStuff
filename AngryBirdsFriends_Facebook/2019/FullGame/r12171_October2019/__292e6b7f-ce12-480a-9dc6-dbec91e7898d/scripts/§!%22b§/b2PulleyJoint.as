package §!"b§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §9?§:Number = 2;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§-!H§ = b2internal::6#6.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§""X§.x - this.§-!H§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§""X§.y - this.§-!H§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§&C§.x - this.§-!H§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§&C§.y - this.§-!H§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§,#D§);
         this.m_localAnchor2.SetV(param1.§?#d§);
         this.§3$@§ = param1.§5#b§;
         this.§5V§ = param1.§3!Y§ + this.§3$@§ * param1.§#X§;
         this.m_maxLength1 = b2Math.§!#K§(param1.§ L§,this.§5V§ - this.§3$@§ * b2internal::9?);
         this.m_maxLength2 = b2Math.§!#K§(param1.§]";§,(this.§5V§ - b2internal::9?) / this.§3$@§);
         this.§9b§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§9b§ * this.m_u2.x,param1 * this.§9b§ * this.m_u2.y);
      }
      ...
      public function §9_§() : b2Vec2
      {
         var _loc1_:b2Vec2 = this.§-!H§.m_xf.position.Copy();
         _loc1_.§0#3§(this.m_groundAnchor1);
         return _loc1_;
      }
      
      public function §0K§() : b2Vec2
      {
         var _loc1_:b2Vec2 = this.§-!H§.m_xf.position.Copy();
         _loc1_.§0#3§(this.m_groundAnchor2);
         return _loc1_;
      }
      
      public function GetLength1() : Number
      {
         var _loc1_:b2Vec2 = b2internal::6#6.GetWorldPoint(this.m_localAnchor1);
         var _loc2_:Number = this.§-!H§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.§-!H§.m_xf.position.y + this.m_groundAnchor1.y;
      ...
      {
         var _loc1_:b2Vec2 = b2internal::]#j.GetWorldPoint(this.m_localAnchor2);
         var _loc2_:Number = this.§-!H§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.§-!H§.m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc14_:Number = this.§-!H§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.§-!H§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.§-!H§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.§-!H§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§5V§ - _loc18_ - this.§3$@§ * _loc19_) > 0)
         {
            this.§#!R§ = b2internal::&A;
            this.§9b§ = 0;
         }
         ...
         this.m_limitMass1 = _loc2_.§<A§ + _loc2_.§2k§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§<A§ + _loc3_.§2k§ * _loc22_ * _loc22_;
         this.§4#<§ = this.m_limitMass1 + this.§3$@§ * this.§3$@§ * this.m_limitMass2;
         ...
         {
            this.§9b§ *= param1.§%!U§;
            this.m_limitImpulse1 *= param1.§%!U§;
            this.m_limitImpulse2 *= param1.§%!U§;
            _loc23_ = (-this.§9b§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§9b§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§3$@§ * this.§9b§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§3$@§ * this.§9b§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§^%§.x += _loc2_.§<A§ * _loc23_;
            _loc2_.§^%§.y += _loc2_.§<A§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§2k§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§^%§.x += _loc3_.§<A§ * _loc25_;
            _loc3_.§^%§.y += _loc3_.§<A§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§2k§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§9b§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§#!R§ == b2internal::?b)
         {
            ...
            _loc19_ = this.§4#<§ * -_loc18_;
            _loc20_ = this.§9b§;
            this.§9b§ = b2Math.§="Z§(0,this.§9b§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§9b§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§3$@§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§3$@§ * _loc19_ * this.m_u2.y;
            _loc2_.§^%§.x += _loc2_.§<A§ * _loc14_;
            _loc2_.§^%§.y += _loc2_.§<A§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§2k§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§^%§.x += _loc3_.§<A§ * _loc16_;
            _loc3_.§^%§.y += _loc3_.§<A§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§2k§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
         if(this.m_limitState1 == b2internal::?b)
         {
            _loc10_ = _loc2_.§^%§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§^%§.y + _loc2_.m_angularVelocity * _loc5_;
            ...
            this.m_limitImpulse1 = b2Math.§="Z§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == b2internal::?b)
         {
            _loc12_ = _loc3_.§^%§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§^%§.y + _loc3_.m_angularVelocity * _loc8_;
            ...
            this.m_limitImpulse2 = b2Math.§="Z§(0,this.m_limitImpulse2 + _loc19_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal::6#6;
         var _loc3_:b2Body = b2internal::]#j;
         var _loc5_:Number = this.§-!H§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.§-!H§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.§-!H§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.§-!H§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         if(this.§#!R§ == b2internal::?b)
         {
            ...
            if(_loc18_ > b2Settings.b2_linearSlop)
            {
               this.m_u2.§#"I§(1 / _loc18_);
            }
            else
            {
               this.m_u2.§3-§();
            }
            _loc19_ = this.§5V§ - _loc17_ - this.§3$@§ * _loc18_;
            _loc24_ = b2Math.§="Z§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§!!7§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§4#<§ * _loc19_) * this.m_u1.x;
            ...
            _loc2_.m_sweep.a += _loc2_.§2k§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§<A§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§<A§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§2k§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§&" §();
            _loc3_.§&" §();
         }
         if(this.m_limitState1 == b2internal::?b)
