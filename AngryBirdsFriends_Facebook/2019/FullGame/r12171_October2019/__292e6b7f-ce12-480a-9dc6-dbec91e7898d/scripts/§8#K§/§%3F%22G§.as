package §8#K§
{
   ...
   public class §?"G§
   {
         ...
         for each(_loc2_ in param1.Shape)
         {
            if(_loc2_.@shape == "CIRCLE" || _loc2_.@shape == "POLYGON" || _loc2_.@shape == "NONE")
            {
               ...
               if(_loc4_ == "CIRCLE")
               {
                  ...
                  this.§""O§(_loc3_,_loc4_,_loc7_,_loc5_);
               }
               else
               {
                  this.§="p§(_loc3_,_loc4_,_loc5_,_loc2_.@flipAngleCorrection);
               }
            }
            else
            {
      ...
      {
         this.§`V§[param1.toLowerCase()] = new §`!j§(param3,param4,param1);
      }
      
      public function §="p§(param1:String, param2:String, param3:Array, param4:Number) : void
      {
         var _loc5_:§46§ = new §^r§(Vector.<b2Vec2>(param3),param1);
         this.§`V§[param1.toLowerCase()] = _loc5_;
      }
      
      public function §""O§(param1:String, param2:String, param3:Number, param4:Array) : void
      {
         var _loc5_:§46§ = new §=$'§(param3,new Point(param4[0].x,param4[0].y),param1);
         this.§`V§[param1.toLowerCase()] = _loc5_;
      }
      
      public function §>"§(param1:String) : §46§
      {
         var _loc2_:§46§ = this.§`V§[param1.toLowerCase()];
         if(!_loc2_)
         {
