package §,#E§
{
   ...
   public class b2Collision
   {
      ...
      private static var §?!I§:Vector.<§^x§> = §&#<§();
      
      private static var s_clipPoints1:Vector.<§^x§> = §&#<§();
      
      private static var s_clipPoints2:Vector.<§^x§> = §&#<§();
      ...
      private static var §8"7§:b2Vec2 = new b2Vec2();
      ...
      public static function §"$,§(param1:Vector.<§^x§>, param2:Vector.<§^x§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§^x§ = null;
         var _loc6_:int = 0;
      ...
      public static function §,$@§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param1.§9"+§;
         var _loc9_:int = param4.§5#]§;
         var _loc10_:Vector.<b2Vec2> = param4.§!$3§;
         _loc11_ = param2.R;
      ...
      public static function §4"T§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§5#]§;
         var _loc7_:Vector.<b2Vec2> = param2.§9"+§;
         _loc9_ = param5.R;
         _loc8_ = param4.§4$+§;
         ...
         var _loc17_:Number = §,$@§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §,$@§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §,$@§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §,$@§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §]a§(param1:Vector.<§^x§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§^x§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§5#]§;
         var _loc8_:Vector.<b2Vec2> = param2.§9"+§;
         var _loc9_:int = param5.§5#]§;
         var _loc10_:Vector.<b2Vec2> = param5.§!$3§;
         var _loc11_:Vector.<b2Vec2> = param5.§9"+§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§ !E§.§;#J§ = param4;
         _loc20_.id.§ !E§.§=!e§ = _loc21_;
         _loc20_.id.§ !E§.§7#!§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§ !E§.§;#J§ = param4;
         _loc20_.id.§ !E§.§=!e§ = _loc22_;
         _loc20_.id.§ !E§.§7#!§ = 1;
      }
      
      private static function §&#<§() : Vector.<§^x§>
      {
         var _loc1_:Vector.<§^x§> = new Vector.<§^x§>(2);
         _loc1_[0] = new §^x§();
         _loc1_[1] = new §^x§();
         return _loc1_;
      }
      
      public static function §7o§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§^x§ = null;
         ...
         param1.§!!p§ = 0;
         var _loc7_:Number = param2.§&"7§ + param4.§&"7§;
         var _loc8_:int = 0;
         §?[§[0] = _loc8_;
         var _loc9_:Number = §4"T§(§?[§,param2,param3,param4,param5);
         _loc8_ = §?[§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §=#&§[0] = _loc10_;
         var _loc11_:Number = §4"T§(§=#&§,param4,param5,param2,param3);
         _loc10_ = §=#&§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§#!T§ = b2Manifold.§4^§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§^x§> = §?!I§;
         §]a§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§5#]§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§!$3§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §@y§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §&$§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         ...
         var _loc37_:Vector.<§^x§> = s_clipPoints1;
         var _loc38_:Vector.<§^x§> = s_clipPoints2;
      ...
      public static function §@D§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§&"7§ + param4.§&"7§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§#!T§ = b2Manifold.§9x§;
         param1.m_localPoint.SetV(param2.§]##§);
         param1.§true §.§3-§();
         param1.§!!p§ = 1;
         param1.§3!-§[0].m_localPoint.SetV(param4.§]##§);
         param1.§3!-§[0].m_id.key = 0;
      }
      
      public static function §&!k§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§&"7§ + param4.§&"7§;
         var _loc21_:int = param2.§5#]§;
         var _loc22_:Vector.<b2Vec2> = param2.§!$3§;
         var _loc23_:Vector.<b2Vec2> = param2.§9"+§;
         var _loc24_:int = 0;
         ...
         if(_loc19_ < Number.MIN_VALUE)
         {
            param1.§!!p§ = 1;
            param1.§#!T§ = b2Manifold.§4^§;
            param1.§true §.SetV(_loc23_[_loc18_]);
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§!!p§ = 1;
            param1.§#!T§ = b2Manifold.§4^§;
            param1.§true §.x = _loc15_ - _loc27_.x;
            param1.§true §.y = _loc16_ - _loc27_.y;
            param1.§true §.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§!!p§ = 1;
            param1.§#!T§ = b2Manifold.§4^§;
            param1.§true §.x = _loc15_ - _loc28_.x;
            param1.§true §.y = _loc16_ - _loc28_.y;
            param1.§true §.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§3!-§[0].m_localPoint.SetV(param4.§]##§);
            param1.§3!-§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§!!p§ = 1;
            param1.§#!T§ = b2Manifold.§4^§;
            param1.§true §.x = _loc23_[_loc25_].x;
            param1.§true §.y = _loc23_[_loc25_].y;
            param1.§true §.Normalize();
