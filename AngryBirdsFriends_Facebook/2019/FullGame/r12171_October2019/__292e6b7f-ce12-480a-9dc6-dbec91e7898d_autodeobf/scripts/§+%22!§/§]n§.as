package §+"!§
{
   ...
   class §]n§
   {
      ...
      {
         var _loc1_:BitmapData = new BitmapData(§!$ §,§4!o§);
         var _loc2_:ByteArray = new ByteArray();
         var _loc3_:int = §2$0§.length;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc2_.writeUnsignedInt(§2$0§[_loc4_]);
            _loc4_++;
         }
         _loc2_.uncompress();
         _loc1_.setPixels(new Rectangle(0,0,§!$ §,§4!o§),_loc2_);
         return Texture.§4"§(null,_loc1_,false);
      }
