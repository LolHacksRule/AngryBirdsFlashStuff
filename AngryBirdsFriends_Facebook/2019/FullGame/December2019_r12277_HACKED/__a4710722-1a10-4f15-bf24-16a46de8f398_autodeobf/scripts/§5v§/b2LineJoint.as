package §5v§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§]#N§.x * this.§4#;§.x + (this.§]0§ + this.§]#N§.y) * this.§%"@§.x),param1 * (this.§]#N§.x * this.§4#;§.y + (this.§]0§ + this.§]#N§.y) * this.§%"@§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§2#9§ = this.§2#9§ > Number.MIN_VALUE ? Number(1 / this.§2#9§) : Number(0);
         ...
         this.§0#_§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§0#_§.col2.x = this.§0#_§.col1.y;
         this.§0#_§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§>$,§)
         {
         ...
         if(param1.§+L§)
         {
            ...
            this.§]#N§.y *= param1.§1$5§;
            this.§]0§ *= param1.§1$5§;
            _loc19_ = this.§]#N§.x * this.§4#;§.x + (this.§]0§ + this.§]#N§.y) * this.§%"@§.x;
            _loc20_ = this.§]#N§.x * this.§4#;§.y + (this.§]0§ + this.§]#N§.y) * this.§%"@§.y;
            _loc21_ = this.§]#N§.x * this.m_s1 + (this.§]0§ + this.§]#N§.y) * this.m_a1;
            _loc22_ = this.§]#N§.x * this.m_s2 + (this.§]0§ + this.§]#N§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§,%§ && this.§1!-§ != b2internal::+$3)
         {
            ...
            _loc14_ = this.§2#9§ * (this.§1#0§ - _loc13_);
            _loc15_ = this.§]0§;
            _loc16_ = param1.dt * this.§%"1§;
            this.§]0§ = b2Math.§-$"§(this.§]0§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§]0§ - _loc15_) * this.§%"@§.x;
         ...
         if(this.§>$,§ && this.§1!-§ != b2internal::#"a)
         {
            ...
            _loc18_ = this.§]#N§.Copy();
            _loc19_ = this.§0#_§.§5R§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§]#N§.§?$6§(_loc19_);
            if(this.§1!-§ == b2internal::@$D)
            {
               this.§]#N§.y = b2Math.§&V§(this.§]#N§.y,0);
            }
            else if(this.§1!-§ == b2internal::&!=)
            {
               this.§]#N§.y = b2Math.§ 3§(this.§]#N§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§]#N§.y - _loc18_.y) * this.§0#_§.col2.x;
            if(this.§0#_§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§0#_§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§]#N§.x = _loc21_;
            _loc19_.x = this.§]#N§.x - _loc18_.x;
            _loc19_.y = this.§]#N§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§4#;§.x + _loc19_.y * this.§%"@§.x;
            _loc9_ = _loc19_.x * this.§4#;§.y + _loc19_.y * this.§%"@§.y;
         ...
         else
         {
            if(this.§0#_§.col1.x != 0)
            {
               _loc22_ = -_loc12_ / this.§0#_§.col1.x;
            }
            else
            {
               _loc22_ = 0;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§>$,§)
         {
            ...
            {
               _loc19_ = b2Math.§-$"§(_loc34_ - this.§]1§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
         ...
         if(_loc18_)
         {
            ...
            this.§0#_§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§0#_§.col2.x = this.§0#_§.col1.y;
            this.§0#_§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§0#_§.§5R§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::9"K;
         ...
         var _loc30_:Number = _loc28_.x * this.§4#;§.x + _loc28_.y * this.§%"@§.x;
         var _loc31_:Number = _loc28_.x * this.§4#;§.y + _loc28_.y * this.§%"@§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::9"K * _loc30_;
         _loc6_.y -= b2internal::9"K * _loc31_;
         _loc7_ -= b2internal::4#P * _loc32_;
