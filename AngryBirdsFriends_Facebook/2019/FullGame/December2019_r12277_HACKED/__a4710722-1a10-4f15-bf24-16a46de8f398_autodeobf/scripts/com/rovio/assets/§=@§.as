package com.rovio.assets
{
   ...
   public class §=@§
   {
      ...
      public static function §["v§(param1:String, param2:Class) : void
      {
      }
      
      public static function §8!l§(param1:String) : Boolean
      {
         return ApplicationDomain.currentDomain.hasDefinition(param1);
      }
      
      public static function §9!x§(param1:String, param2:Boolean = true, param3:Boolean = true) : Class
      {
         var _loc4_:* = null;
