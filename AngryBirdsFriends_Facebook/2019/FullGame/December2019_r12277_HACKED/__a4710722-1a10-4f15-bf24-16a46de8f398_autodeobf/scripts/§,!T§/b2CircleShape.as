package §,!T§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc4_:Number = param1.position.x + (_loc3_.col1.x * this.§>4§.x + _loc3_.col2.x * this.§>4§.y);
         var _loc5_:Number = param1.position.y + (_loc3_.col1.y * this.§>4§.x + _loc3_.col2.y * this.§>4§.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc5_:Number = param3.position.x + (_loc4_.col1.x * this.§>4§.x + _loc4_.col2.x * this.§>4§.y);
         var _loc6_:Number = param3.position.y + (_loc4_.col1.y * this.§>4§.x + _loc4_.col2.y * this.§>4§.y);
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         var _loc4_:Number = param2.position.x + (_loc3_.col1.x * this.§>4§.x + _loc3_.col2.x * this.§>4§.y);
         var _loc5_:Number = param2.position.y + (_loc3_.col1.y * this.§>4§.x + _loc3_.col2.y * this.§>4§.y);
         param1.§4#1§.Set(_loc4_ - b2internal::?#o,_loc5_ - b2internal::?#o);
         param1.§,!W§.Set(_loc4_ + b2internal::?#o,_loc5_ + b2internal::?#o);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§>#0§ = param2 * b2Settings.b2_pi * b2internal::?#o * b2internal::?#o;
         param1.center.SetV(this.§>4§);
         param1.§ $=§ = param1.§>#0§ * (0.5 * b2internal::?#o * b2internal::?#o + (this.§>4§.x * this.§>4§.x + this.§>4§.y * this.§>4§.y));
      }
      
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         var _loc9_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§6#k§(param3,this.§>4§);
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.§-"C§(param1,_loc5_) - param2)) < -b2internal::?#o + Number.MIN_VALUE)
         {
            return 0;
         }
