package §6!R§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§&$B§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §85§(param1:Number) : Boolean
      {
      ...
      public static function §;!6§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         return param1.x * param2.y - param1.y * param2.x;
      }
      
      public static function §&"_§(param1:b2Vec2, param2:Number) : b2Vec2
      {
      ...
      public static function §;"V§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return new b2Vec2(§-"C§(param2,param1.col1),§-"C§(param2,param1.col2));
      }
      
      public static function §6#k§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         _loc3_ = §;"V§(param1.R,param2);
         _loc3_.x += param1.position.x;
         _loc3_.y += param1.position.y;
         return _loc3_;
      }
      
      public static function §0!l§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         var _loc4_:Number = NaN;
         _loc3_ = §5#w§(param2,param1.position);
      ...
      public static function §35§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1.x + param2.x,param1.y + param2.y);
      }
      
      public static function §5#w§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1.x - param2.x,param1.y - param2.y);
      }
      ...
      {
         return b2Mat22.§&$B§(§35§(param1.col1,param2.col1),§35§(param1.col2,param2.col2));
      }
      
      public static function §?b§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§&$B§(§;"V§(param1,param2.col1),§;"V§(param1,param2.col2));
      }
      
      public static function §]p§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§-"C§(param1.col1,param2.col1),§-"C§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§-"C§(param1.col1,param2.col2),§-"C§(param1.col2,param2.col2));
         return b2Mat22.§&$B§(_loc3_,_loc4_);
      }
      ...
      public static function §7"s§(param1:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§&$B§(§7"s§(param1.col1),§7"s§(param1.col2));
      }
      ...
      {
         return new b2Vec2(§ 3§(param1.x,param2.x),§ 3§(param1.y,param2.y));
      }
      ...
      {
         return §?#H§(param2,§;#i§(param1,param3));
      }
      ...
      public static function §5!Z§() : Number
      {
