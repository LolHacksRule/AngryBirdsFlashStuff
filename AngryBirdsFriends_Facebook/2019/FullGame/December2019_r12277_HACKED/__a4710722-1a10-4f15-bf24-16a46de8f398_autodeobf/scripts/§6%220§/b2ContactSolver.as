package §6"0§
{
   ...
   public class b2ContactSolver
   {
      ...
      public function b2ContactSolver()
      {
         ...
         while(_loc1_ < 300)
         {
            this.§0$!§[_loc1_] = new b2ContactConstraint();
            _loc1_++;
         }
      }
      
      public function §80§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            b2Settings.b2Assert(_loc17_.§?#Z§ > 0);
            §"!^§.§80§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §"!^§.§1"l§.x;
            _loc27_ = §"!^§.§1"l§.y;
            (_loc28_ = this.§0$!§[_loc6_]).§,E§ = _loc15_;
            _loc28_.§&$7§ = _loc16_;
            _loc28_.§9e§ = _loc17_;
            ...
            _loc28_.§5!?§.x = _loc17_.§]"§.x;
            _loc28_.§5!?§.y = _loc17_.§]"§.y;
            _loc28_.localPoint.x = _loc17_.m_localPoint.x;
            _loc28_.localPoint.y = _loc17_.m_localPoint.y;
            _loc28_.radius = _loc13_ + _loc14_;
            _loc28_.type = _loc17_.§ "u§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§#"v§)
            {
               _loc30_ = _loc17_.§7#K§[_loc29_];
               (_loc31_ = _loc28_.§["+§[_loc29_]).normalImpulse = _loc30_.§8"r§;
               _loc31_.tangentImpulse = _loc30_.§-[§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§-j§.x = §"!^§.§7#K§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§-j§.y = §"!^§.§7#K§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§"$8§.x = §"!^§.§7#K§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§"$8§.y = §"!^§.§7#K§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               if((_loc38_ = _loc15_.§0#d§ + _loc16_.§0#d§ + _loc15_.§!!!§ * _loc36_ + _loc16_.§!!!§ * _loc37_) > 0)
               {
                  _loc31_.§8S§ = 1 / _loc38_;
               }
               else
               {
                  _loc31_.§8S§ = 0;
               }
               _loc39_ = (_loc39_ = _loc15_.§!#v§ * _loc15_.§0#d§ + _loc16_.§!#v§ * _loc16_.§0#d§) + (_loc15_.§!#v§ * _loc15_.§!!!§ * _loc36_ + _loc16_.§!#v§ * _loc16_.§!!!§ * _loc37_);
               _loc31_.§0!0§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               if((_loc44_ = _loc15_.§0#d§ + _loc16_.§0#d§ + _loc15_.§!!!§ * _loc42_ + _loc16_.§!!!§ * _loc43_) > 0)
               {
                  _loc31_.§`<§ = 1 / _loc44_;
               }
               else
         ...
         while(_loc5_ < this.§9#3§)
         {
            ...
            if(param1.§+L§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc20_.normalImpulse *= param1.§1$5§;
                  _loc20_.tangentImpulse *= param1.§1$5§;
                  ...
                  _loc7_.§=!c§.x -= _loc9_ * _loc21_;
                  _loc7_.§=!c§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§"$8§.x * _loc22_ - _loc20_.§"$8§.y * _loc21_);
                  _loc8_.§=!c§.x += _loc11_ * _loc21_;
                  _loc8_.§=!c§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§9#3§)
         {
            _loc26_ = (_loc25_ = this.§0$!§[_loc24_]).§,E§;
            _loc27_ = _loc25_.§&$7§;
            ...
            _loc1_ = 0;
            while(_loc1_ < _loc25_.§#"v§)
            {
               _loc2_ = _loc25_.§["+§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§"$8§.y - _loc30_.x + _loc28_ * _loc2_.§-j§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§"$8§.x - _loc30_.y - _loc28_ * _loc2_.§-j§.x;
            ...
            if(_loc25_.§#"v§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§8S§ * (_loc9_ - _loc2_.§6#;§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§"$8§.y - _loc30_.x + _loc28_ * _loc43_.§-j§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§"$8§.x - _loc30_.y - _loc28_ * _loc43_.§-j§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§"$8§.y - _loc30_.x + _loc28_ * _loc44_.§-j§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§"$8§.x - _loc30_.y - _loc28_ * _loc44_.§-j§.x;
               ...
               _loc56_ = -((_loc22_ = _loc25_.§8S§).col1.x * _loc53_ + _loc22_.col2.x * _loc54_);
      ...
      public function §3#E§() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.§9#3§)
         {
            _loc2_ = this.§0$!§[_loc1_];
            _loc3_ = _loc2_.§9e§;
            _loc4_ = 0;
            while(_loc4_ < _loc2_.§#"v§)
            {
               _loc5_ = _loc3_.§7#K§[_loc4_];
               _loc6_ = _loc2_.§["+§[_loc4_];
               _loc5_.§8"r§ = _loc6_.normalImpulse;
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         {
            _loc5_ = (_loc4_ = this.§0$!§[_loc3_]).§,E§;
            _loc6_ = _loc4_.§&$7§;
            _loc7_ = _loc5_.§!#v§ * _loc5_.§0#d§;
            _loc8_ = _loc5_.§!#v§ * _loc5_.§!!!§;
            _loc9_ = _loc6_.§!#v§ * _loc6_.§0#d§;
            _loc10_ = _loc6_.§!#v§ * _loc6_.§!!!§;
            §=#O§.§80§(_loc4_);
            _loc11_ = §=#O§.§1"l§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§#"v§)
            {
               _loc13_ = _loc4_.§["+§[_loc12_];
               _loc14_ = §=#O§.§7#K§[_loc12_];
               _loc15_ = §=#O§.§>_§[_loc12_];
               ...
               _loc22_ = (_loc21_ = -_loc13_.§0!0§ * _loc20_) * _loc11_.x;
