package §?o§
{
   ...
   public class § !B§ extends § ^§
   {
      ...
      private static const §?9§:Number = 4;
       
      
      protected var §^"§:Number = 4.0;
      
      protected var §?#j§:Vector.<§]$,§> = null;
      ...
      protected function readFromLua(param1:String) : void
      {
         ...
         var _loc2_:String = §6h§.§`!a§(param1);
         _loc3_ = §6h§.§?$;§(_loc2_);
         this.§;#8§(_loc3_);
         §0f§ = this.convertName(_loc3_.theme);
         §8!u§ = new Vector.<§"!6§>();
         mBirds = new Vector.<§;"U§>();
         §!#4§ = new Vector.<§@$<§>();
         _loc4_ = _loc3_.physicsToWorld;
         this.§^"§ = _loc3_.gravityForceMultiplier !== undefined ? Number(_loc3_.gravityForceMultiplier) : Number(§?9§);
         if(_loc3_.worldGravity)
         {
            §%!i§ = _loc3_.worldGravity;
         }
         §&M§ = _loc3_.scores.MightyEagle;
         §8"A§ = _loc3_.scores.Gold;
         §0"_§ = _loc3_.scores.Silver;
         var _loc5_:§"!6§ = this.§!E§(_loc3_.castleCameraData,_loc4_,§"!6§.CASTLE);
         var _loc6_:§"!6§ = this.§!E§(_loc3_.birdCameraData,_loc4_,§"!6§.SLINGSHOT);
         §8!u§.push(_loc5_);
         §8!u§.push(_loc6_);
         var _loc7_:Vector.<String> = this.§%"v§(_loc3_.world,_loc2_);
         this.§#K§(_loc3_.world,_loc7_);
         var _loc8_:Vector.<String> = this.§""h§(_loc3_.joints,_loc2_);
         this.§[!j§(_loc3_.joints,_loc8_);
      ...
      private function §%"v§(param1:Object, param2:String) : Vector.<String>
      {
         return this.§%"s§(param1,param2,"world");
      }
      
      private function §""h§(param1:Object, param2:String) : Vector.<String>
      {
         return this.§%"s§(param1,param2,"joints");
      }
      
      private function §%"s§(param1:Object, param2:String, param3:String) : Vector.<String>
      {
         var _loc5_:§+!h§ = null;
      ...
      private function §]#$§(param1:Object) : void
      {
         ...
         _loc2_.x = param1.x;
         _loc2_.y = param1.y;
         _loc2_.shape = new §,#V§(param1.radius);
         _loc2_.type = param1.definition;
         _loc2_.angle = this.§5H§(param1.angle);
         _loc2_.§ W§ = param1.gravitationMinForce;
      ...
      protected function §]$;§(param1:Object, param2:int) : §@$<§
      {
         var _loc3_:§@$<§ = null;
         var _loc4_:§9#t§ = null;
         var _loc5_:§3$C§ = null;
         ...
         {
            (_loc4_ = new §9#t§()).explosionRadius = param1.explosionRadius;
         ...
         {
            (_loc5_ = new §3$C§()).shotPattern = param1.shotPattern;
            _loc3_ = _loc5_;
         }
         ...
         {
            (_loc6_ = new §;y§()).§5$§.initialize(param1.triggerEvents.onDestroyed);
            _loc3_ = _loc6_;
         }
         _loc3_.x = param1.x;
         _loc3_.y = param1.y;
         ...
         _loc3_.angle = this.§5H§(param1.angle);
         ...
         if(param1.events)
         {
            _loc10_ = new Vector.<§3s§>();
            _loc11_ = 0;
            while(_loc11_ < param1.events.length)
            {
               _loc12_ = param1.events[_loc11_];
               _loc10_.push(new §3s§(_loc12_.name,_loc12_.parameters,_loc12_.trigger));
               _loc11_++;
            }
            _loc3_.§9"-§(_loc10_);
         }
         ...
         §!#4§.push(_loc3_);
         if(this.§]"B§[param1.name] != null)
         {
            throw new Error("Invalid level! Two objects with the same name: " + param1.name);
         }
         this.§]"B§[param1.name] = param2;
         return _loc3_;
      }
      
      private function §[!j§(param1:Object, param2:Vector.<String>) : void
      {
      ...
      private function §!E§(param1:Object, param2:Number, param3:String) : §"!6§
      {
         var _loc4_:§"!6§ = new §"!6§();
         var _loc5_:Object = null;
         if(param1.ipad)
      ...
      protected function §5H§(param1:Number) : Number
      {
