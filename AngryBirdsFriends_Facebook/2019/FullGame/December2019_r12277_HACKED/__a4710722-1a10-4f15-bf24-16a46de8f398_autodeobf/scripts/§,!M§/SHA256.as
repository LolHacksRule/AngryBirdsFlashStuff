package §,!M§
{
   ...
   public class SHA256
   {
      ...
      public static function §0c§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §#"B§(_loc2_);
         return §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true);
      }
      
      public static function hashBytes(param1:ByteArray) : String
      {
         var _loc2_:Array = §9#;§(param1);
         var _loc3_:ByteArray = §#"B§(_loc2_);
         return §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true) + §;"!§.§7]§(_loc3_.readInt(),true);
      }
      ...
      private static function §#"B§(param1:Array) : ByteArray
      {
         var _loc15_:int = 0;
         var _loc16_:int = 0;
         var _loc17_:int = 0;
         ...
         while(_loc13_ < _loc11_)
         {
            ...
            while(_loc23_ < 64)
            {
               ...
               {
                  _loc30_ = §;"!§.§,">§(_loc12_[_loc23_ - 15],7) ^ §;"!§.§,">§(_loc12_[_loc23_ - 15],18) ^ _loc12_[_loc23_ - 15] >>> 3;
                  _loc31_ = §;"!§.§,">§(_loc12_[_loc23_ - 2],17) ^ §;"!§.§,">§(_loc12_[_loc23_ - 2],19) ^ _loc12_[_loc23_ - 2] >>> 10;
                  _loc12_[_loc23_] = _loc12_[_loc23_ - 16] + _loc30_ + _loc12_[_loc23_ - 7] + _loc31_;
               }
               _loc24_ = §;"!§.§,">§(_loc15_,2) ^ §;"!§.§,">§(_loc15_,13) ^ §;"!§.§,">§(_loc15_,22);
               _loc25_ = _loc15_ & _loc16_ ^ _loc15_ & _loc17_ ^ _loc16_ & _loc17_;
               _loc26_ = _loc24_ + _loc25_;
               _loc27_ = §;"!§.§,">§(_loc19_,6) ^ §;"!§.§,">§(_loc19_,11) ^ §;"!§.§,">§(_loc19_,25);
