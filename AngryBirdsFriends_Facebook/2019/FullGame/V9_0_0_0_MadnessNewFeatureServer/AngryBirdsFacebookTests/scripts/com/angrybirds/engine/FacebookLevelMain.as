package com.angrybirds.engine
{
   ...
   import com.angrybirds.engine.background.LevelBackgroundFriends;
   ...
   public class FacebookLevelMain extends LevelMainSpace
   {
      ...
      override protected function initializeLevelBackground(name:String, groundLevel:Number, textureManager:TextureManager, minimumScale:Number) : LevelBackground
      {
         ...
         if(levelItemManagerSpace)
         {
            soundManager = levelItemManagerSpace.soundManager;
         }
         return new LevelBackgroundFriends(this,background,groundLevel,textureManager,minimumScale,soundManager,!Starling.isSoftware);
      }
