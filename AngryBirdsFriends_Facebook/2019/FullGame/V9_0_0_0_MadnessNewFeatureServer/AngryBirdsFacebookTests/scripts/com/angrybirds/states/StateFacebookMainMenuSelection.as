package com.angrybirds.states
{
   ...
   public class StateFacebookMainMenuSelection extends StateBaseLevel implements IVirtualPageView, INavigable, IWalletContainer
   {
      ...
      private var mOverlappingTournamentButton:UIComponentRovio;
      
      private var mOverlappingTournamentsTimeLeftTF:TextField;
      ...
      override protected function init() : void
      {
         ...
         this.mTournamentButton = mUIView.getItemByName("Button_Tournament");
         this.mOverlappingTournamentButton = mUIView.getItemByName("Button_Overlapping_Tournaments");
      }
      ...
      override public function activate(previousState:String) : void
      {
         ...
         TournamentModel.instance.addEventListener(TournamentEvent.TOURNAMENT_LOADED,this.onTournamentLoaded);
      ...
      private function onTournamentLoaded(e:TournamentEvent) : void
      {
         TournamentModel.instance.removeEventListener(TournamentEvent.TOURNAMENT_LOADED,this.onTournamentLoaded);
         ...
         {
            TournamentModel.instance.addEventListener(TournamentEvent.ALL_MAIN_MENU_DATA_LOADED,this.onTournamentAllDataLoaded);
            TournamentModel.instance.loadMainMenuData();
         }
      }
      
      private function onTournamentAllDataLoaded(e:TournamentEvent) : void
      {
         this.updateView();
         if(LeagueModel.instance.active)
         {
            ...
            LeagueModel.instance.loadData(TournamentModel.instance.getCurrentTournamentId());
         }
         this.injectData();
      }
      ...
      private function onAllLeagueDataLoaded(e:LeagueEvent) : void
      {
         ...
         if(!TournamentModel.instance.isOverlappingTournamentsEnabled() && StateTournamentLevelSelection.getCheckTheTournamentForResults() > 0)
         {
            if(LeagueModel.instance.unconcludedResult)
            {
               ...
               {
                  StateTournamentResults.smClaimTournamentId = StateTournamentLevelSelection.getCheckTheTournamentForResults();
                  StateTournamentLevelSelection.checkTheTournamentForResults(0);
      ...
      {
         this.initializeOverlappingTournamentRules();
      ...
      private function injectData() : void
      {
         ...
         var scoreData:Array = [];
         var tournamentPlayingFriends:Array = TournamentModel.instance.getTournamentPlayingFriends();
         CachedFacebookFriends.challengeCandidates = new Vector.<UserTournamentScoreVO>();
         var lowestCoinReward:int = 0;
         var fbUserProgress:FacebookUserProgress = AngryBirdsBase.singleton.dataModel.userProgress as FacebookUserProgress;
      ...
      {
         var brandedFrameLabel:String = null;
         var brandName:String = null;
         var cls:Class = null;
         var mainMenuLogo:MovieClip = null;
         var buttonMc:MovieClip = null;
         var brandedVersion:MovieClip = null;
         if(!this.mTournamentButton.visible)
         {
            return;
         }
         ...
         if(mUIView)
         {
            buttonContainer = this.mTournamentButton.mClip.Button_Graphic;
         ...
         this.mOverlappingTournamentsTimeLeftTF = null;
         if(TournamentModel.instance.currentTournament && mUIView)
         {
            brandedFrameLabel = TournamentModel.instance.currentTournament.brandedTournamentAssetId;
            if(brandedFrameLabel)
            {
               brandedFrameLabel = brandedFrameLabel.toUpperCase();
               brandName = this.MAIN_MENU_TOURNAMENT_BUTTON_PREFIX + brandedFrameLabel;
               ...
               brandName = this.MAIN_MENU_BRANDED_LOGO_PREFIX + brandedFrameLabel;
               cls = AssetCache.getAssetFromCache(brandName,false,false);
               if(cls)
               {
      ...
      private function initializeOverlappingTournamentRules() : void
      {
         this.mTournamentButton.visible = !TournamentModel.instance.isOverlappingTournamentsEnabled();
         this.mOverlappingTournamentButton.visible = TournamentModel.instance.isOverlappingTournamentsEnabled();
      }
      ...
      private function showTournamentRuleGraphics(tournamentRule:TournamentRules, isTeaser:Boolean = false) : void
      {
         ...
         if(tournamentRule.chapterSelectionGraphics != null)
         {
            ...
            {
               graphicId = tournamentRule.chapterSelectionGraphics[i];
      ...
      protected function showUsersTournamentRank() : void
      {
         ...
         var clip:MovieClip = MovieClip(this.mTournamentButton.mClip.getChildByName("Button_Graphic"));
      ...
      override protected function update(deltaTime:Number) : void
      {
         ...
         if(this.mTournamentButton.visible)
         {
            ...
            {
               clip = MovieClip(this.mTournamentButton.mClip.getChildByName("Button_Graphic"));
            ...
            this.mTimeLeftTF.text = TournamentModel.instance.getTournamentTimeLeftAsPrettyString()[0] + " left!";
         }
         else if(this.mOverlappingTournamentButton.visible)
         {
            if(this.mOverlappingTournamentsTimeLeftTF == null)
            {
               clip = MovieClip(this.mOverlappingTournamentButton.mClip.getChildByName("OverlappingTournamentsButtonGraphic"));
               this.mOverlappingTournamentsTimeLeftTF = TextField(clip.getChildByName("Text_OverlappingTournamentsLeft"));
            }
            this.mOverlappingTournamentsTimeLeftTF.text = TournamentModel.instance.getOverlappingTournamentsTimeLeftAsPrettyString()[0];
         }
      }
      ...
      override protected function onUIInteraction(eventIndex:int, eventName:String, component:UIEventListenerRovio) : void
      {
         ...
         switch(eventName)
         {
            ...
            case "OVERLAPPING_TOURNAMENTS_MENU":
               ...
               fn = function(event:Event):void
               {
                  var loader:URLLoader = event.currentTarget as URLLoader;
                  loader.removeEventListener(Event.COMPLETE,InitDataLoader.onErasureStateLoaded);
                  loader.removeEventListener(IOErrorEvent.IO_ERROR,fn);
               ...
               InitDataLoader.loadGDPRErasureState(InitDataLoader.onErasureStateLoaded,fn);
               break;
            case "LEVELS":
               SoundEngine.playSound("Menu_Confirm",SoundEngine.UI_CHANNEL);
               fn = function(event:Event):void
      ...
      {
         TournamentModel.instance.removeEventListener(TournamentEvent.ALL_MAIN_MENU_DATA_LOADED,this.onTournamentAllDataLoaded);
         super.deActivate();
         this.stopTweens();
