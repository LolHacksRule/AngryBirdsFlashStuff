package com.angrybirds.data.level.item
{
   ...
   public class LevelItemSpace extends LevelItem
   {
      ...
      public function playSoundLua(soundGroupName:String, soundChannel:String = null, loopCount:Number = 0, startTime:Number = 0) : SoundEffect
      {
         var playedSound:SoundEffect = null;
         if(this.mSoundManagerLua)
         {
            playedSound = this.mSoundManagerLua.playSound(soundGroupName,soundChannel,loopCount,startTime);
         }
         return playedSound;
      }
