package §]!o§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §9#A§:b2Mat22 = new b2Mat22();
      ...
      public function b2PolygonShape()
      {
         ...
         §,"k§ = b2Settings.b2_polygonRadius;
         this.§&!G§.§5J§();
      }
      
      public static function §@"w§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function §?!K§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §3![§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         ...
         (_loc5_ = new b2PolygonShape()).§,"5§(param1,param2,param3,param4);
         return _loc5_;
      }
      ...
      public static function §4N§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
      ...
      b2internal static function §&#$§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§#$C§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§#$C§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §#"L§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function §-!-§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§["w§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§?"S§(this.§["q§[_loc5_],this.§["q§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§&!X§() > Number.MIN_VALUE);
            this.§>w§[_loc3_].SetV(b2Math.§ !e§(_loc6_,1));
            this.§>w§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§&!G§ = §4N§(this.§["q§,this.§["w§);
      }
      ...
      public function §,"5§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§["w§ = 4;
         this.§<z§(4);
         this.§["q§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§["w§)
         {
            this.§["q§[_loc6_] = b2Math.§=!t§(_loc5_,this.§["q§[_loc6_]);
            this.§>w§[_loc6_] = b2Math.§`!X§(_loc5_.R,this.§>w§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §?!#§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§>w§[0] = b2Math.§ !e§(b2Math.§?"S§(param2,param1),1);
         this.§>w§[0].Normalize();
         this.§>w§[1].x = -this.§>w§[0].x;
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§["w§)
         {
            _loc6_ = (_loc9_ = this.§["q§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§>w§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§3"]§.x = _loc5_ - b2internal::,"k;
         param1.§3"]§.y = _loc6_ - b2internal::,"k;
         param1.§='§.x = _loc7_ + b2internal::,"k;
         param1.§='§.y = _loc8_ + b2internal::,"k;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         while(_loc10_ < this.§["w§)
         {
            ...
            _loc12_ = _loc10_ + 1 < this.§["w§ ? this.§["q§[int(_loc10_ + 1)] : this.§["q§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§5L§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§4"P§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§4"P§(_loc5_,this.§["q§[_loc12_]) - _loc6_;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§["w§;
         var _loc14_:int = (_loc10_ + 1) % this.§["w§;
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§["w§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
