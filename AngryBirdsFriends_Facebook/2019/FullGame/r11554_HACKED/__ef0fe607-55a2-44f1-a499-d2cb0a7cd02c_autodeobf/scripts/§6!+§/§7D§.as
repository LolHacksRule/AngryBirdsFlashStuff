package §6!+§
{
   ...
   class §7D§
   {
      ...
      {
         var _loc1_:BitmapData = new BitmapData(§]!V§,§1!0§);
         var _loc2_:ByteArray = new ByteArray();
         var _loc3_:int = §2#P§.length;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc2_.writeUnsignedInt(§2#P§[_loc4_]);
            _loc4_++;
         }
         _loc2_.uncompress();
         _loc1_.setPixels(new Rectangle(0,0,§]!V§,§1!0§),_loc2_);
         return Texture.§;$3§(null,_loc1_,false);
      }
