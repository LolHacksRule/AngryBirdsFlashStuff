package § !D§
{
   ...
   public class §3!]§
   {
      ...
      public function §3!]§(param1:Sprite, param2:§4!8§, param3:Boolean = false)
      {
         super();
         this.§ U§ = param1;
         this.§!#A§ = param2;
      ...
      private function §+$B§(param1:int) : Vector.<int>
      {
         var _loc3_:int = 0;
      ...
      private function §-B§(param1:Vector.<int>) : Vector.<DisplayObject>
      {
         ...
         {
            (_loc4_ = this.§!#A§.getFrame(_loc3_)).pivotX = 0;
            _loc4_.pivotY = 0;
            _loc2_.push(_loc4_);
         }
         return _loc2_;
