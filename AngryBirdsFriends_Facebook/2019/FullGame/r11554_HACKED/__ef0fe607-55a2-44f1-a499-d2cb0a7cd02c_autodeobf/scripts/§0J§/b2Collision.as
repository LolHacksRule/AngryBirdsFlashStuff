package §0J§
{
   ...
   public class b2Collision
   {
      ...
      private static var §7#0§:Vector.<§4#c§> = §9![§();
      
      private static var s_clipPoints1:Vector.<§4#c§> = §9![§();
      
      private static var s_clipPoints2:Vector.<§4#c§> = §9![§();
      
      private static var §+#7§:Vector.<int> = new Vector.<int>(1);
      
      private static var §?[§:Vector.<int> = new Vector.<int>(1);
      
      private static var §9#9§:b2Vec2 = new b2Vec2();
      ...
      public static function §#!N§(param1:Vector.<§4#c§>, param2:Vector.<§4#c§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§4#c§ = null;
         var _loc6_:int = 0;
      ...
      public static function §!#u§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param1.§>w§;
         var _loc9_:int = param4.§["w§;
      ...
      public static function §]"+§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§["w§;
         var _loc7_:Vector.<b2Vec2> = param2.§>w§;
         _loc9_ = param5.R;
         _loc8_ = param4.§&!G§;
         ...
         var _loc17_:Number = §!#u§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §!#u§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §!#u§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §!#u§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §?!c§(param1:Vector.<§4#c§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§4#c§ = null;
         var _loc23_:Number = NaN;
         int(param2.§["w§);
         var _loc8_:Vector.<b2Vec2> = param2.§>w§;
         var _loc9_:int = param5.§["w§;
         var _loc10_:Vector.<b2Vec2> = param5.§["q§;
         var _loc11_:Vector.<b2Vec2> = param5.§>w§;
         _loc12_ = param3.R;
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§>!+§.§7[§ = param4;
         _loc20_.id.§>!+§.§%#B§ = _loc22_;
         _loc20_.id.§>!+§.§ 6§ = 1;
      }
      
      private static function §9![§() : Vector.<§4#c§>
      {
         var _loc1_:Vector.<§4#c§> = new Vector.<§4#c§>(2);
         _loc1_[0] = new §4#c§();
         _loc1_[1] = new §4#c§();
         return _loc1_;
      }
      
      public static function §6!K§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§4#c§ = null;
         ...
         param1.§?!j§ = 0;
         var _loc7_:Number = param2.§,"k§ + param4.§,"k§;
         var _loc8_:int = 0;
         §+#7§[0] = _loc8_;
         var _loc9_:Number = §]"+§(§+#7§,param2,param3,param4,param5);
         _loc8_ = §+#7§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§'!A§ = b2Manifold.§2r§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§4#c§> = §7#0§;
         §?!c§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§["w§;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §9#9§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §&#h§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §%#t§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §<$C§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§4#c§> = s_clipPoints1;
         var _loc38_:Vector.<§4#c§> = s_clipPoints2;
         if(int(§#!N§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if(int(§#!N§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§ ;§.SetV(_loc27_);
      ...
      public static function §7"q§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§,"k§ + param4.§,"k§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§'!A§ = b2Manifold.§["0§;
         param1.m_localPoint.SetV(param2.§5!A§);
         param1.§ ;§.§5J§();
         param1.§?!j§ = 1;
         param1.§%R§[0].m_localPoint.SetV(param4.§5!A§);
         param1.§%R§[0].m_id.key = 0;
      }
      
      public static function §2!1§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§,"k§ + param4.§,"k§;
         var _loc21_:int = param2.§["w§;
         var _loc22_:Vector.<b2Vec2> = param2.§["q§;
         var _loc23_:Vector.<b2Vec2> = param2.§>w§;
         var _loc24_:int = 0;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§?!j§ = 1;
            param1.§'!A§ = b2Manifold.§2r§;
            param1.§ ;§.x = _loc15_ - _loc27_.x;
            param1.§ ;§.y = _loc16_ - _loc27_.y;
            param1.§ ;§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§?!j§ = 1;
            param1.§'!A§ = b2Manifold.§2r§;
            param1.§ ;§.x = _loc15_ - _loc28_.x;
            param1.§ ;§.y = _loc16_ - _loc28_.y;
            param1.§ ;§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§%R§[0].m_localPoint.SetV(param4.§5!A§);
            param1.§%R§[0].m_id.key = 0;
      ...
      public static function §!"5§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§3"]§;
