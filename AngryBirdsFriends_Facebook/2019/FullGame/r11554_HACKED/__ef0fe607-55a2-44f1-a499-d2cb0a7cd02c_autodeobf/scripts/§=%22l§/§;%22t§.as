package §="l§
{
   ...
   public class §;"t§ extends §;#f§
   {
      ...
      public function §;"t§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§3#d§(param1,param2);
      }
      
      protected function §3#d§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§?!_§(_loc7_,_loc6_)]) == null)
            {
      ...
      private function §?!_§(param1:String, param2:String) : String
      {
      ...
      private function §`$-§(param1:Vector.<XML>) : Dictionary
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§?!_§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §5f§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
