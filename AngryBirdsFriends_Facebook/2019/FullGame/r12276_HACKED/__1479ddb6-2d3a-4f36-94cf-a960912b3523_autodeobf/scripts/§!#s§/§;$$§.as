package §!#s§
{
   ...
   public class §;$$§
   {
      ...
      {
         this.§!"%§ = this.§]#+§.mask.height = param1;
      }
      
      protected function §<#z§(param1:Boolean = true) : void
      {
         var _loc3_:§ !Q§ = null;
         if(param1)
         {
      ...
      protected function §;"&§(param1:§ !Q§, param2:Object) : void
      {
         param1.data = param2;
      }
      ...
      {
         if(!this.§6"G§ || this.§6"G§.length == this.§7"i§)
         {
            return;
         }
         this.§;$?§(param1);
      ...
      protected function updatePositions() : void
      {
         ...
         while(_loc1_ < this.§6"G§.length)
         {
            ...
            if(_loc3_ > -this.§8!r§ && _loc3_ < this.§-#5§ && !this.§<e§(_loc1_))
            {
               _loc4_ = this.§6"8§();
               this.§]#+§.addChild(_loc4_);
               this.§;"&§(_loc4_,this.§6"G§[_loc1_]);
               _loc4_.index = _loc1_;
               _loc4_.x = _loc3_;
               this.§=#]§.push(_loc4_);
            }
      ...
      protected function hide(param1:§ !Q§) : void
      {
      ...
      public function refresh() : void
      {
         ...
         {
            this.§;"&§(_loc1_,this.§6"G§[_loc1_.index]);
         }
      }
