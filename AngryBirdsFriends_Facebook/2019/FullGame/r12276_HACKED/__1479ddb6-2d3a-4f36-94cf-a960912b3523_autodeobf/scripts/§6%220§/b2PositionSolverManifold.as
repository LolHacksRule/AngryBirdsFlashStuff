package §6"0§
{
   ...
   class b2PositionSolverManifold
   {
      ...
      public var §>_§:Vector.<Number>;
      
      function b2PositionSolverManifold()
      {
         super();
         this.§1"l§ = new b2Vec2();
         this.§>_§ = new Vector.<Number>(b2Settings.b2_maxManifoldPoints);
      ...
      public function §80§(param1:b2ContactConstraint) : void
      {
         var _loc2_:int = 0;
         ...
         b2Settings.b2Assert(param1.§#"v§ > 0);
         switch(param1.type)
         {
            case b2Manifold.§8"W§:
               _loc5_ = param1.§,E§.m_xf.R;
               _loc6_ = param1.localPoint;
               _loc9_ = param1.§,E§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc10_ = param1.§,E§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               ...
               if((_loc15_ = _loc13_ * _loc13_ + _loc14_ * _loc14_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§1"l§.x = _loc13_ / _loc16_;
                  this.§1"l§.y = _loc14_ / _loc16_;
               }
               else
               {
                  this.§1"l§.x = 1;
               ...
               this.§7#K§[0].x = 0.5 * (_loc9_ + _loc11_);
               this.§7#K§[0].y = 0.5 * (_loc10_ + _loc12_);
               this.§>_§[0] = _loc13_ * this.§1"l§.x + _loc14_ * this.§1"l§.y - param1.radius;
               break;
            case b2Manifold.§]"d§:
               _loc5_ = param1.§,E§.m_xf.R;
               _loc6_ = param1.§5!?§;
               this.§1"l§.x = _loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y;
               this.§1"l§.y = _loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y;
               _loc5_ = param1.§,E§.m_xf.R;
               _loc6_ = param1.localPoint;
               ...
               while(_loc2_ < param1.§#"v§)
               {
                  ...
                  this.§>_§[_loc2_] = (_loc3_ - _loc7_) * this.§1"l§.x + (_loc4_ - _loc8_) * this.§1"l§.y - param1.radius;
                  this.§7#K§[_loc2_].x = _loc3_;
                  this.§7#K§[_loc2_].y = _loc4_;
                  _loc2_++;
               }
               break;
            case b2Manifold.§3w§:
               ...
               while(_loc2_ < param1.§#"v§)
               {
                  ...
                  this.§>_§[_loc2_] = (_loc3_ - _loc7_) * this.§1"l§.x + (_loc4_ - _loc8_) * this.§1"l§.y - param1.radius;
                  this.§7#K§[_loc2_].Set(_loc3_,_loc4_);
                  _loc2_++;
               }
               this.§1"l§.x *= -1;
               this.§1"l§.y *= -1;
