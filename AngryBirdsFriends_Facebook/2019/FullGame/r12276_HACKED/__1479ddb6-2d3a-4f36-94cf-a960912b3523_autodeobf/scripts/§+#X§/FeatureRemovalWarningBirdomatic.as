package §+#X§
{
   ...
   public class FeatureRemovalWarningBirdomatic extends AbstractPopup
   {
      
      public static const ID:String = "FeatureRemovalWarningBirdomatic";
       
      
      public function FeatureRemovalWarningBirdomatic(param1:int, param2:int)
      {
         super(param1,param2,§&n§.§7a§.Views.PopupView_FeatureRemovalWarningBirdOMatic[0],ID);
      }
