package §#Z§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private static var §?S§:Vector.<DisplayObject> = new Vector.<DisplayObject>(0);
      ...
      {
         var _loc1_:int = this.§8"_§.length - 1;
         while(_loc1_ >= 0)
         {
            this.§8"_§[_loc1_].dispose();
            _loc1_--;
         }
         super.dispose();
      }
      ...
      public function §'!Q§(param1:DisplayObject) : void
      {
         var _loc2_:int = this.§8"_§.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            if(param1.z < this.§8"_§[_loc3_].z)
            {
      ...
      {
         var _loc3_:int = this.§8"_§.length;
         if(param2 >= 0 && param2 <= _loc3_)
         {
            ...
            {
               this.§8"_§.splice(param2,0,param1);
            }
            param1.§!z§(this);
            return param1;
         }
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : DisplayObject
      {
         ...
         {
            _loc3_ = this.§8"_§[param1];
            _loc3_.§!z§(null);
            param1 = this.§8"_§.indexOf(_loc3_);
            if(param1 >= 0)
            {
               this.§8"_§.splice(param1,1);
            }
            if(param2)
            {
               _loc3_.dispose();
      ...
      public function getChildByName(param1:String) : DisplayObject
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(this.§8"_§[_loc3_].name == param1)
            {
               return this.§8"_§[_loc3_];
            }
            _loc3_++;
         }
         return null;
      ...
      public function §<#U§(param1:String) : DisplayObject
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(this.§8"_§[_loc3_] is DisplayObjectContainer)
            {
               if(_loc4_ = (this.§8"_§[_loc3_] as DisplayObjectContainer).§<#U§(param1))
               {
                  return _loc4_;
               }
            }
      ...
      {
         return this.§8"_§.indexOf(param1);
      }
      ...
      public function setChildIndex(param1:DisplayObject, param2:int) : void
      {
         ...
         this.§8"_§.splice(_loc3_,1);
         this.§8"_§.splice(param2,0,param1);
      }
      
      public function §6#n§(param1:DisplayObject, param2:DisplayObject) : void
      {
         var _loc3_:int = this.getChildIndex(param1);
      ...
      public function §5#%§(param1:int, param2:int) : void
      {
         ...
         this.§8"_§[param1] = _loc4_;
         this.§8"_§[param2] = _loc3_;
      }
      
      public function §-h§(param1:Function) : void
      {
         this.§8"_§ = this.§8"_§.sort(param1);
      }
      
      public function §5!2§(param1:String, param2:int) : void
      {
         this.§8"_§.sortOn(param1,param2);
      }
      
      public function §`"F§(param1:Object, param2:int) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            _loc5_ = this.§8"_§[_loc4_];
            param1[_loc5_.name] = _loc5_;
            _loc5_.§[,§ = param2;
            if(_loc5_ is DisplayObjectContainer)
            {
               (_loc5_ as DisplayObjectContainer).§`"F§(param1,param2);
            }
            _loc4_++;
         }
      }
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         if(_loc3_ == 0)
         {
            §?P§(param1,§5y§);
            § #r§.§7t§(§5y§,0,0,§7!o§);
            param2.setTo(§7!o§.x,§7!o§.y,0,0);
            return param2;
         }
         if(_loc3_ == 1)
         {
            return this.§8"_§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§8"_§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc6_:int = int(this.§8"_§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§8"_§[_loc6_];
            §?P§(_loc7_,§5y§);
            § #r§.§7t§(§5y§,_loc3_,_loc4_,§7!o§);
            if(_loc8_ = _loc7_.hitTest(§7!o§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§""F§, param2:Number) : void
      {
         ...
         var _loc4_:int = this.§8"_§.length;
         var _loc5_:int = param1.blendMode;
         var _loc6_:int = 0;
         while(_loc6_ < _loc4_)
         {
            if((_loc7_ = this.§8"_§[_loc6_]).§+3§)
            {
      ...
      public function §>#@§(param1:Event) : void
      {
         ...
         var _loc2_:int = §?S§.length;
         this.§6E§(this,param1.type,§?S§);
         var _loc3_:int = §?S§.length;
         var _loc4_:int = _loc2_;
         while(_loc4_ < _loc3_)
         {
            §?S§[_loc4_].dispatchEvent(param1);
            _loc4_++;
         }
         §?S§.length = _loc2_;
      }
      
      public function §"!C§(param1:String, param2:Object = null) : void
      {
         var _loc3_:Event = Event.§!4§(param1,false,param2);
         this.§>#@§(_loc3_);
         Event.§-!3§(_loc3_);
      }
      
      private function §6E§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§8"_§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
               this.§6E§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
