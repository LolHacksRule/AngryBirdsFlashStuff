package §;!=§
{
   ...
   public interface §]!m§
   {
      ...
      function §##Q§(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:int = -1, param8:Boolean = true, param9:Boolean = true) : void;
      ...
      function §-"k§(param1:String, param2:Number, param3:Number, param4:Number, param5:int, param6:Number = 0.0, param7:Number = 0.0, param8:Number = 1.0, param9:Boolean = false, param10:Boolean = false) : §'#N§;
      ...
      function removeObject(param1:§'#N§, param2:Boolean = false, param3:Boolean = false) : void;
      
      function §2,§(param1:§'#N§) : Boolean;
      
      function get objectCount() : int;
      
      function §0!l§(param1:String) : §&2§;
      
      function getObject(param1:int) : §'#N§;
      
      function getObjectFromPoint(param1:Number, param2:Number) : §>"G§;
      
      function §!"#§(param1:Boolean) : void;
      
      function §-!D§(param1:Boolean, param2:Number = 0, param3:Number = 0, param4:Number = 0) : void;
