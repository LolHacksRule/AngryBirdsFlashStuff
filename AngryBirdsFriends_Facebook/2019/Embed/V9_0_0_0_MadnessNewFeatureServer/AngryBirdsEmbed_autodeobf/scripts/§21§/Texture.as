package §21§
{
   ...
   public class Texture
   {
      ...
      public static function § !M§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §21§.Texture
      {
         return §"y§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §"y§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §21§.Texture
      {
         ...
         _loc10_ = new §47§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§2t§.§5S§)
         {
            _loc10_.§8k§(param2);
         }
         ...
         return new §each §(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §6y§(param1:Context3D, param2:ByteArray) : §21§.Texture
      {
         if(param1 == null)
         {
            throw new §>#§();
         ...
         var _loc9_:§47§ = new §47§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§2t§.§5S§)
         {
            _loc9_.§8k§(param2);
         }
      ...
      public static function §5N§(param1:§21§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §21§.Texture
      {
         var _loc4_:§21§.Texture;
         (_loc4_ = new §each §(param1,param2)).§'^§ = param3;
         return _loc4_;
      }
      
      public static function §&>§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §21§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§21§.Texture = §"y§(param1,_loc6_,false,param5);
         if(!§2t§.§5S§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§6B§, param2:int, param3:int) : void
      {
         ...
         if(this.§'^§)
         {
            ...
            param1.§6E§(param2,-this.§'^§.x,-this.§'^§.y);
            param1.§6E§(param2 + 1,-_loc4_,-this.§'^§.y);
            param1.§6E§(param2 + 2,-this.§'^§.x,-_loc5_);
            param1.§6E§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      ...
      public function get root() : §21§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §21§.Texture
      {
         return this;
      }
