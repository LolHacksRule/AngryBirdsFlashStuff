package §1!K§
{
   public class §==§
   {
      ...
      public static function get §8D§() : Array
      {
         return §],§;
      }
      ...
      {
         §],§[§],§.length] = new §'T§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10);
      }
      
      public static function §]R§(param1:String) : §'T§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §],§.length)
         {
            if((§],§[_loc2_] as §'T§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §],§[_loc2_] as §'T§;
            }
            _loc2_++;
