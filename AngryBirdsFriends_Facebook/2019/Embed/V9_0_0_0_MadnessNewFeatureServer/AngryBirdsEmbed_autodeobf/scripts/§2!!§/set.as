package §2!!§
{
   ...
   public class set extends §4!+§
   {
      ...
      {
         super(param3);
         this.§10§(param1,param2);
      }
      
      protected function §10§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§'o§(_loc7_,_loc6_)]) == null)
            {
      ...
      private function §'o§(param1:String, param2:String) : String
      {
      ...
      private function §4!-§(param1:Vector.<XML>) : Dictionary
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§'o§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §8I§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
