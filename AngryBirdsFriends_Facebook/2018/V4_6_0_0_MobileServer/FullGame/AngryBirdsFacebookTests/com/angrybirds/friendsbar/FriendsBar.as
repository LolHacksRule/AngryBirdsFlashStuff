package com.angrybirds.friendsbar
{
   ...
   public class FriendsBar extends Sprite implements INavigable
   {
      ...
      private var mLeagueProgBar:MovieClip;
      ...
      private function init() : void
      {
         ...
         this.mLeagueProgBar = this.mFriendsBarGraphic.mcLeagueProgBar as MovieClip;
         this.mLeagueProgBar.visible = false;
         this.mLeagueProgBar.addEventListener(MouseEvent.CLICK,this.onLeagueSettingsClicked);
         this.mLeagueProgBar.buttonMode = true;
         this.mLeagueProgBar.useHandCursor = true;
         this.mLeagueProgBar.mouseChildren = false;
      ...
      private function changeTab(tab:String, saveSelection:Boolean = true) : void
      {
         ...
         this.mFriendsBarGraphic.mcButtonsContainer.btnShopLarge.visible = this.mSelectedTab == TAB_LEAGUE;
         if(this.mSelectedTab == TAB_DEFAULT)
         {
            this.updateAvatarShopButton(DataModelFriends(AngryBirdsBase.singleton.dataModel).hasAvatarShopNewItems);
         }
      ...
      public function changeScoreList(type:int, scrollToUserIndex:int = -1) : void
      {
         ...
         switch(type)
         {
            ...
            case SCORE_LIST_TYPE_LEAGUE:
               ...
               if(this.mScoreListLeagueData)
               {
                  this.mLeagueProgBar.visible = true;
            ...
            case SCORE_LIST_TYPE_LAST_WEEK_LEAGUE:
               ...
               {
                  this.mLeagueProgBar.visible = true;
                  this.displayLeagueIcon(this.mScoreListLastWeekLeagueData.leagueId);
            ...
            case SCORE_LIST_TYPE_LAST_WEEK_LEAGUE_UNCONCLUDED:
               ...
               {
                  this.mLeagueProgBar.visible = true;
                  this.displayLeagueIcon(this.mScoreListLastWeekLeagueUnconcludedData.leagueId);
      ...
      private function displayLeagueIcon(leagueID:String) : void
      {
         var ld:LeagueDefinition = null;
         var playerLeagueProfile:Object = null;
         ...
         {
            this.mLeagueProgBar.getChildByName(ld.id).visible = ld.id == leagueID;
         }
         playerLeagueProfile = LeagueModel.instance.getPlayerProfileForLeague();
         if(playerLeagueProfile)
         {
            ...
            fullFillWidth = 156.1;
            barFillUpWidth = (currentLeagueRating - currentLeagueRatingMin) / (currentLeagueRatingMax - currentLeagueRatingMin);
            clipRect = new Rectangle(0,0,fullFillWidth * barFillUpWidth,this.mLeagueProgBar.height);
            this.mLeagueProgBar.ProgBarFill.scrollRect = clipRect;
            if(currentLeagueRatingMax < 1000)
            {
               this.mLeagueProgBar.ProgText01.visible = true;
               this.mLeagueProgBar.ProgText02.visible = false;
               this.mLeagueProgBar.ProgText03.visible = false;
               this.mLeagueProgBar.ProgText01.text = currentLeagueRating + "/" + currentLeagueRatingMax;
            }
            else if(currentLeagueRatingMax < 10000)
            {
               this.mLeagueProgBar.ProgText01.visible = false;
               this.mLeagueProgBar.ProgText02.visible = true;
               this.mLeagueProgBar.ProgText03.visible = false;
               this.mLeagueProgBar.ProgText02.text = currentLeagueRating + "/" + currentLeagueRatingMax;
            }
            else
            {
               this.mLeagueProgBar.ProgText01.visible = false;
               this.mLeagueProgBar.ProgText02.visible = false;
               this.mLeagueProgBar.ProgText03.visible = true;
               this.mLeagueProgBar.ProgText03.text = currentLeagueRating + "/" + currentLeagueRatingMax;
            }
         }
         else
         {
