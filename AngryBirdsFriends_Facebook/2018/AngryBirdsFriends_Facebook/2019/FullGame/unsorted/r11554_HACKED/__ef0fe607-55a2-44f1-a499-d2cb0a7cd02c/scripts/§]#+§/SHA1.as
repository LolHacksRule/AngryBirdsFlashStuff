package §]#+§
{
   ...
   public class SHA1
   {
      ...
      public static function §-$8§(param1:String) : String
      {
         ...
         return §`#a§.§4!!§(_loc3_.readInt(),true) + §`#a§.§4!!§(_loc3_.readInt(),true) + §`#a§.§4!!§(_loc3_.readInt(),true) + §`#a§.§4!!§(_loc3_.readInt(),true) + §`#a§.§4!!§(_loc3_.readInt(),true);
      }
      
      public static function hashBytes(param1:ByteArray) : String
      {
         var _loc2_:Array = SHA1.§5!B§(param1);
         var _loc3_:ByteArray = §6#&§(_loc2_);
         return §`#a§.§4!!§(_loc3_.readInt(),true) + §`#a§.§4!!§(_loc3_.readInt(),true) + §`#a§.§4!!§(_loc3_.readInt(),true) + §`#a§.§4!!§(_loc3_.readInt(),true) + §`#a§.§4!!§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc6_:uint = 0;
         var _loc2_:Array = SHA1.§`#0§(param1);
         var _loc3_:ByteArray = §6#&§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
