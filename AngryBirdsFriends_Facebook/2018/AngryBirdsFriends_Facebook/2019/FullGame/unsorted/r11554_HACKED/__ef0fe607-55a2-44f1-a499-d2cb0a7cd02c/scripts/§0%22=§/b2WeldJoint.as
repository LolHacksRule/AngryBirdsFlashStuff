   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§`#=§)
         {
            ...
            this.§]"5§.y *= param1.§9]§;
            this.§]"5§.z *= param1.§9]§;
            _loc4_.§8!z§.x -= _loc10_ * this.§]"5§.x;
            _loc4_.§8!z§.y -= _loc10_ * this.§]"5§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§]"5§.y - _loc7_ * this.§]"5§.x + this.§]"5§.z);
            _loc5_.§8!z§.x += _loc11_ * this.§]"5§.x;
            _loc5_.§8!z§.y += _loc11_ * this.§]"5§.y;
            _loc5_.m_angularVelocity += _loc13_ * (_loc8_ * this.§]"5§.y - _loc9_ * this.§]"5§.x + this.§]"5§.z);
         }
         else
         {
            this.§]"5§.§5J§();
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§7#B§.Solve33(_loc21_,-_loc18_,-_loc19_,-_loc20_);
         this.§]"5§.§1!]§(_loc21_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc19_:Number = b2Math.§6!8§(_loc16_);
         if(_loc18_ > _loc17_)
         {
            _loc12_ *= 1;
            _loc13_ *= 1;
         ...
         this.§7#B§.Solve33(_loc20_,-_loc14_,-_loc15_,-_loc16_);
