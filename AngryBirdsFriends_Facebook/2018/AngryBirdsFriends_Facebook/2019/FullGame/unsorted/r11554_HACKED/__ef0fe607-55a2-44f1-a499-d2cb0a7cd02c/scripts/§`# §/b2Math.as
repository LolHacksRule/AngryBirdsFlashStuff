package §`# §
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§5P§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §4"P§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §5L§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§4"P§(param2,param1.col1),§4"P§(param2,param1.col2));
      }
      
      public static function §=!t§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         _loc3_ = §`!X§(param1.R,param2);
         _loc3_.x += param1.position.x;
         _loc3_.y += param1.position.y;
         return _loc3_;
      }
      
      public static function §5v§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         var _loc4_:Number = NaN;
         _loc3_ = §?"S§(param2,param1.position);
      ...
      public static function §?"S§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1.x - param2.x,param1.y - param2.y);
      }
      
      public static function §3$4§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §+!p§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         var _loc3_:Number = param1.x - param2.x;
         var _loc4_:Number = param1.y - param2.y;
      ...
      public static function §+"p§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§5P§(§<"U§(param1.col1,param2.col1),§<"U§(param1.col2,param2.col2));
      }
      
      public static function §5!`§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§5P§(§`!X§(param1,param2.col1),§`!X§(param1,param2.col2));
      }
      
      public static function §6"[§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§4"P§(param1.col1,param2.col1),§4"P§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§4"P§(param1.col1,param2.col2),§4"P§(param1.col2,param2.col2));
         return b2Mat22.§5P§(_loc3_,_loc4_);
      }
      
      public static function §6!8§(param1:Number) : Number
      {
         return param1 > 0 ? Number(param1) : Number(-param1);
      }
      
      public static function §!!N§(param1:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§6!8§(param1.x),§6!8§(param1.y));
      }
      
      public static function § "z§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§5P§(§!!N§(param1.col1),§!!N§(param1.col2));
      }
      
      public static function §9!6§(param1:Number, param2:Number) : Number
      {
         return param1 < param2 ? Number(param1) : Number(param2);
      }
      
      public static function §1!K§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§9!6§(param1.x,param2.x),§9!6§(param1.y,param2.y));
      }
      ...
      public static function §^"m§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §,!J§(param2,§1!K§(param1,param3));
      }
      
      public static function §!#O§(param1:Array, param2:Array) : void
      {
         var _loc3_:* = param1[0];
         param1[0] = param2[0];
         param2[0] = _loc3_;
      ...
      public static function §"#W§(param1:uint) : uint
      {
      ...
      public static function §`!T§(param1:uint) : Boolean
      {
