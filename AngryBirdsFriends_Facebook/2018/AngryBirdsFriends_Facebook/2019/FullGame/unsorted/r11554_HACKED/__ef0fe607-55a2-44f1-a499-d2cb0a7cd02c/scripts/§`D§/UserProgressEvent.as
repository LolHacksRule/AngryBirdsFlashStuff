package §`D§
{
   ...
   public class UserProgressEvent extends Event
   {
      ...
      public static const §5"q§:String = "OnMightyEagleTimerComplete";
      
      public static const §'$5§:String = "userProgressSaved";
      
      public static const §2!D§:String = "levelProgressSaved";
