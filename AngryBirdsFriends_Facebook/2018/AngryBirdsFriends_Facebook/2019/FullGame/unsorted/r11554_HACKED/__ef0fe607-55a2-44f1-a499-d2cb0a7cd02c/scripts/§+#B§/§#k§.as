package §+#B§
{
   ...
   public class §#k§
   {
      ...
      public static function §?"m§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         jsonString = § "R§(luaString,emptyObjectAsArray);
         try
         {
      ...
      public static function § "R§(param1:String, param2:Boolean = false) : String
      {
      ...
      private static function §!!2§(param1:String, param2:Boolean) : String
      {
      ...
      public static function §#V§(param1:Object) : String
      {
         return §"!3§(param1,0);
      }
      ...
      private static function §"!3§(param1:Object, param2:int) : String
      {
         ...
         for(_loc4_ in param1)
         {
            ...
            _loc3_ += _loc4_ + " = " + §6S§(param1[_loc4_],param2);
            if(param2 > 1)
            {
               _loc3_ += ",";
            }
      ...
      private static function §6S§(param1:*, param2:int) : String
      {
         ...
         else
         {
            ...
            if(param1 is Array)
            {
               ...
               {
                  _loc3_ += §6S§(param1[_loc6_],param2) + (_loc6_ < param1.length - 1 ? "," : "");
                  _loc6_++;
               }
               return _loc3_ + "}";
            }
