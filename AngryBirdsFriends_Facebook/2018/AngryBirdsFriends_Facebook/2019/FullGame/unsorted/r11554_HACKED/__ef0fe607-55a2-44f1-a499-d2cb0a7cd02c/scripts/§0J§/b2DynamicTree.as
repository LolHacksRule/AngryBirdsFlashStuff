package §0J§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §5!0§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         var _loc4_:Number = NaN;
         var _loc5_:Number = NaN;
         b2Settings.b2Assert(param1.§8o§());
         if(param1.aabb.§8"B§(param2))
         {
            return false;
         }
         this.§+$;§(param1);
      ...
      public function §9!&§(param1:b2DynamicTreeNode) : b2AABB
      {
         return param1.aabb;
      }
      ...
      public function §0!8§(param1:Function, param2:b2AABB, param3:b2DynamicTreeNode = null) : void
      {
         ...
         while(_loc5_ > 0)
         {
            if((_loc6_ = _loc4_[--_loc5_]).aabb.§!"5§(param2))
            {
               if(_loc6_.§8o§())
               {
                  if(param3)
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc7_:b2Vec2 = b2Math.§!!N§(_loc6_);
         var _loc8_:Number = param2.§6!I§;
         ...
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§!"5§(_loc9_) != false)
            {
      ...
      private function §7#1§(param1:b2DynamicTreeNode) : void
      {
      ...
      private function §<3§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_.§8o§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§3"]§.x + _loc6_.aabb.§='§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§3"]§.y + _loc6_.aabb.§='§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§3"]§.x + _loc7_.aabb.§='§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§3"]§.y + _loc7_.aabb.§='§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         _loc5_.§@"Z§ = null;
         _loc5_.aabb.§,"Z§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            while(!_loc4_.aabb.§8"B§(_loc5_.aabb))
            {
               _loc4_.aabb.§,"Z§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
