      ...
      public function §<!Y§(param1:XMLList) : void
      {
         ...
         for each(_loc2_ in param1.Shape)
         {
            ...
            else
            {
               ...
               this.§2#O§(_loc2_.@id,_loc2_.@shape,_loc2_.@width,_loc2_.@height,_loc2_.@flipAngleCorrection);
            }
         }
      }
      
      public function §2#O§(param1:String, param2:String, param3:Number, param4:Number, param5:Number) : void
      {
         this.§<$B§[param1.toLowerCase()] = new §3"<§(param3,param4,param1);
      }
      
      public function §;#!§(param1:String, param2:String, param3:Array, param4:Number) : void
      {
         var _loc5_:§+#c§ = new §;#7§(Vector.<b2Vec2>(param3),param1);
         this.§<$B§[param1.toLowerCase()] = _loc5_;
      }
      
      public function §^S§(param1:String, param2:String, param3:Number, param4:Array) : void
      {
         var _loc5_:§+#c§ = new §0F§(param3,new Point(param4[0].x,param4[0].y),param1);
         this.§<$B§[param1.toLowerCase()] = _loc5_;
      }
      
      public function §6#;§(param1:String) : §+#c§
      {
         var _loc2_:§+#c§ = this.§<$B§[param1.toLowerCase()];
         if(!_loc2_)
         {
