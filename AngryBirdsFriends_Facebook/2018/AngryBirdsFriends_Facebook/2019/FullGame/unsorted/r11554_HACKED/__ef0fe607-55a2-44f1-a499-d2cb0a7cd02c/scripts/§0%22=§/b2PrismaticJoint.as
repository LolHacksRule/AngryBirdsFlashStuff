package §0"=§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§]"5§.x * this.§return§.x + (this.§%!Z§ + this.§]"5§.z) * this.§4;§.x),param1 * (this.§]"5§.x * this.§return§.y + (this.§%!Z§ + this.§]"5§.z) * this.§4;§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§`#=§)
         {
            ...
            this.§]"5§.y *= param1.§9]§;
            this.§%!Z§ *= param1.§9]§;
            _loc19_ = this.§]"5§.x * this.§return§.x + (this.§%!Z§ + this.§]"5§.z) * this.§4;§.x;
            _loc20_ = this.§]"5§.x * this.§return§.y + (this.§%!Z§ + this.§]"5§.z) * this.§4;§.y;
            _loc21_ = this.§]"5§.x * this.m_s1 + this.§]"5§.y + (this.§%!Z§ + this.§]"5§.z) * this.m_a1;
            _loc22_ = this.§]"5§.x * this.m_s2 + this.§]"5§.y + (this.§%!Z§ + this.§]"5§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§4"q§ && this.§=T§ != b2internal::^#T)
         {
            ...
            _loc15_ = this.§4!i§ * (this.§3#,§ - _loc14_);
            _loc16_ = this.§%!Z§;
            _loc17_ = param1.dt * this.§`I§;
            this.§%!Z§ = b2Math.§%!"§(this.§%!Z§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§%!Z§ - _loc16_) * this.§4;§.x;
         ...
         if(this.§<#l§ && this.§=T§ != b2internal::0#W)
         {
            ...
            if(this.§=T§ == b2internal::`!S)
            {
               this.§]"5§.z = b2Math.§"8§(this.§]"5§.z,0);
            }
            else if(this.§=T§ == b2internal::#"o)
            {
               this.§]"5§.z = b2Math.§9!6§(this.§]"5§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§]"5§.z - _loc19_.z) * this.§`#^§.col3.x;
            _loc22_ = -_loc13_ - (this.§]"5§.z - _loc19_.z) * this.§`#^§.col3.y;
            _loc23_ = this.§`#^§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§]"5§.x = _loc23_.x;
            this.§]"5§.y = _loc23_.y;
            _loc20_.x = this.§]"5§.x - _loc19_.x;
            _loc20_.y = this.§]"5§.y - _loc19_.y;
            _loc20_.z = this.§]"5§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§return§.x + _loc20_.z * this.§4;§.x;
            _loc9_ = _loc20_.x * this.§return§.y + _loc20_.z * this.§4;§.y;
         ...
         else
         {
            ...
            this.§]"5§.x += _loc24_.x;
            this.§]"5§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§return§.x;
            _loc9_ = _loc24_.x * this.§return§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§<#l§)
         {
            ...
            if(b2Math.§6!8§(this.§3"X§ - this.§3#j§) < 2 * b2Settings.b2_linearSlop)
            {
               ...
               _loc16_ = b2Math.§6!8§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§3#j§)
            {
               _loc19_ = b2Math.§%!"§(_loc35_ - this.§3#j§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§3#j§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§3"X§)
            {
               _loc19_ = b2Math.§%!"§(_loc35_ - this.§3"X§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§3"X§;
               _loc18_ = true;
            }
         }
         ...
         var _loc31_:Number = _loc28_.x * this.§return§.x + _loc28_.z * this.§4;§.x;
         var _loc32_:Number = _loc28_.x * this.§return§.y + _loc28_.z * this.§4;§.y;
         ...
         _loc6_.x -= b2internal::1l * _loc31_;
         _loc6_.y -= b2internal::1l * _loc32_;
         _loc7_ -= b2internal::"!z * _loc33_;
         _loc8_.x += b2internal::0X * _loc31_;
         _loc8_.y += b2internal::0X * _loc32_;
         _loc9_ += b2internal::6"& * _loc34_;
