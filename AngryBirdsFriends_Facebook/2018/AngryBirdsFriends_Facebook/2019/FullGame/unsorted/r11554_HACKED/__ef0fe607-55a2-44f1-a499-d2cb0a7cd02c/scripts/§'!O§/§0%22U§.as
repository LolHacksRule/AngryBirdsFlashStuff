package §'!O§
{
   public class §0"U§ extends §@P§
   {
      ...
      protected var §4!z§:Array;
      
      protected var §+T§:Boolean;
      
      public function §0"U§(param1:String, param2:int, param3:int, param4:String, param5:String, param6:String, param7:String, param8:String, param9:String, param10:String, param11:Number, param12:Number, param13:Array)
      {
      ...
      private function §]$%§(param1:Object, param2:Boolean = false) : void
      {
         ...
         var _loc7_:Number = (!!param1.scale ? param1.scale : 1) * this.§6z§;
         ...
         if(_loc22_ = param1.elements)
         {
            if((_loc24_ = _loc22_.amount) > 0)
            {
               ...
               _loc21_.§ !M§(_loc24_,_loc25_,_loc26_,_loc27_,_loc28_,_loc29_,_loc30_,_loc31_,_loc32_,_loc33_);
            }
         }
         §2#F§.push(_loc21_);
      }
      
      public function static(param1:Array, param2:Array) : void
      {
