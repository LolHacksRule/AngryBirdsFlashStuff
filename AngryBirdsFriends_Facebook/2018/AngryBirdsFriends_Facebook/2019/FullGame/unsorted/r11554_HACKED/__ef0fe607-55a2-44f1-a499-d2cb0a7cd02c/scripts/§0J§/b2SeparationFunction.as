package §0J§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §7##§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§'!A§ = §56§;
            _loc7_ = this.§<"Z§.§2"m§(param1.indexA[0]);
            _loc10_ = this.§8!o§.§2"m§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§'!A§ = §2r§;
            _loc8_ = this.§<"Z§.§2"m§(param1.indexA[0]);
            _loc9_ = this.§<"Z§.§2"m§(param1.indexA[1]);
            _loc10_ = this.§8!o§.§2"m§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§4;§ = b2Math.§ !e§(b2Math.§?"S§(_loc9_,_loc8_),1);
            this.§4;§.Normalize();
            _loc20_ = this.§4;§;
         ...
         {
            this.§'!A§ = §@#1§;
            _loc11_ = this.§8!o§.§2"m§(param1.indexB[0]);
            _loc12_ = this.§8!o§.§2"m§(param1.indexB[1]);
            _loc7_ = this.§<"Z§.§2"m§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§4;§ = b2Math.§ !e§(b2Math.§?"S§(_loc12_,_loc11_),1);
            this.§4;§.Normalize();
            _loc20_ = this.§4;§;
         ...
         else
         {
            ...
            _loc11_ = this.§8!o§.§2"m§(param1.indexB[0]);
            _loc12_ = this.§8!o§.§2"m§(param1.indexB[1]);
            b2Math.§=!t§(param3,_loc7_);
            _loc24_ = b2Math.§`!X§(param3.R,b2Math.§?"S§(_loc9_,_loc8_));
            b2Math.§=!t§(param5,_loc10_);
            _loc26_ = b2Math.§`!X§(param5.R,b2Math.§?"S§(_loc12_,_loc11_));
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §56§:
               _loc3_ = b2Math.§5L§(param1.R,this.§4;§);
               _loc4_ = b2Math.§5L§(param2.R,this.§4;§.§%!C§());
               _loc5_ = this.§<"Z§.§-6§(_loc3_);
               _loc6_ = this.§8!o§.§-6§(_loc4_);
               _loc7_ = b2Math.§=!t§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§=!t§(param2,_loc6_)).x - _loc7_.x) * this.§4;§.x + (_loc8_.y - _loc7_.y) * this.§4;§.y);
            case §2r§:
               _loc10_ = b2Math.§`!X§(param1.R,this.§4;§);
               _loc7_ = b2Math.§=!t§(param1,this.m_localPoint);
               _loc4_ = b2Math.§5L§(param2.R,_loc10_.§%!C§());
               _loc6_ = this.§8!o§.§-6§(_loc4_);
               return Number(((_loc8_ = b2Math.§=!t§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §@#1§:
               _loc10_ = b2Math.§`!X§(param2.R,this.§4;§);
               _loc8_ = b2Math.§=!t§(param2,this.m_localPoint);
               _loc3_ = b2Math.§5L§(param1.R,_loc10_.§%!C§());
               _loc5_ = this.§<"Z§.§-6§(_loc3_);
               return Number(((_loc7_ = b2Math.§=!t§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
