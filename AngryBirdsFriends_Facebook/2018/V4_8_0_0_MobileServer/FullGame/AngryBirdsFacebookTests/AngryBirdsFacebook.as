package
{
   ...
   public class AngryBirdsFacebook extends AngryBirdsBase implements IVirtualPageView, IAngryBirdsFacebook
   {
      ...
      public function AngryBirdsFacebook(canvas:ApplicationCanvas)
      {
         ...
         SERVER_ROOT = canvas.stage.loaderInfo.parameters.serverRoot || (!!DEBUG_MODE_ENABLED ? "http://angrybirds-facebook-dev.appspot.com" : "http://angrybirds-facebook-dev.appspot.com");
