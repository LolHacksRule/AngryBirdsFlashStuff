package com.angrybirds.data
{
   ...
   public class ItemsInventory extends EventDispatcher
   {
      ...
      protected function onInventoryLoadedRetryMechanism(e:Event) : void
      {
         ...
         if(!result || result.length == 0)
         {
            ...
            else
            {
               ...
               this.mInventoryLoader = null;
               AngryBirdsBase.singleton.popupManager.openPopup(new ErrorPopup(PopupLayerIndexFacebook.ERROR,PopupPriorityType.TOP,ErrorPopup.ERROR_GENERAL));
            }
         }
         else
         {
      ...
      {
         if(powerupId == PowerupType.sBoombox.identifier)
         {
            return 10000;
         }
      ...
      public function usePowerup(powerupId:String) : void
      {
         ...
         {
            throw new Error("Can\'t user powerup " + powerupId + ", user doesn\'t have any left.");
         }
