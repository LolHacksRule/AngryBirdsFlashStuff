package §?"#§
{
   ...
   public class §`#B§ extends §=!I§
   {
      ...
      public function §`#B§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§0!O§(param1,param2);
      }
      
      protected function §0!O§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§1#`§(_loc7_,_loc6_)]) == null)
            {
      ...
      private function §1#`§(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function §#!N§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§1#`§(_loc4_,_loc6_.@name);
