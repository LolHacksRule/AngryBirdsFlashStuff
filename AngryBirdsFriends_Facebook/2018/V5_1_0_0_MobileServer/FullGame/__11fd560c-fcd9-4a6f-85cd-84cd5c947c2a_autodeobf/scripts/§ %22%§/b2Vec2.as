package § "%§
{
   public class b2Vec2
   {
      ...
      public function §9!s§(param1:b2Vec2) : void
      {
         this.x -= param1.x;
         this.y -= param1.y;
      }
      ...
      {
         var _loc2_:Number = b2Math.§=7§(this,param1.col1);
         this.y = b2Math.§=7§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      {
         return b2Math.§;#R§(this.x) && b2Math.§;#R§(this.y);
      }
   }
}
