package § "%§
{
   public class b2Math
   {
      ...
      public static function §;#R§(param1:Number) : Boolean
      {
      ...
      public static function §4!B§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §4!p§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return new b2Vec2(§=7§(param2,param1.col1),§=7§(param2,param1.col2));
      }
      
      public static function §&Q§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         _loc3_ = §4!p§(param1.R,param2);
      ...
      public static function §3n§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      {
         return b2Mat22.§ !h§(§]!C§(param1.col1,param2.col1),§]!C§(param1.col2,param2.col2));
      }
      
      public static function §-#R§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§ !h§(§4!p§(param1,param2.col1),§4!p§(param1,param2.col2));
      }
      
      public static function § #E§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§=7§(param1.col1,param2.col1),§=7§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§=7§(param1.col1,param2.col2),§=7§(param1.col2,param2.col2));
      ...
      public static function §0y§(param1:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§[^§(param1.x),§[^§(param1.y));
      }
      
      public static function §%d§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§ !h§(§0y§(param1.col1),§0y§(param1.col2));
      }
      ...
      public static function §<"L§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §^!H§(param2,§ <§(param1,param3));
      }
      ...
      public static function §8#k§() : Number
      {
      ...
      public static function §=!r§(param1:uint) : Boolean
      {
