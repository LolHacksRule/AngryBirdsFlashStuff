package §!'§
{
   ...
   public class §##Q§ extends §8! §
   {
      ...
      public function §##Q§(param1:§`#+§, param2:§34§, param3:String, param4:int, param5:int, param6:Number, param7:Number, param8:Number, param9:String, param10:int, param11:Number = 0, param12:Number = 0, param13:Number = 0, param14:Number = 0, param15:Number = 1, param16:Number = -1, param17:Boolean = false, param18:Number = 0)
      {
