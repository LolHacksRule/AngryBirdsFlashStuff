package §5!D§
{
   ...
   public class §]"L§
   {
      ...
      public static function §5M§(param1:Rectangle, param2:Rectangle, param3:Rectangle = null) : Rectangle
      {
         if(param3 == null)
         {
      ...
      public static function §`$9§(param1:Rectangle, param2:Rectangle, param3:String = "showAll", param4:Boolean = false, param5:Rectangle = null) : Rectangle
      {
         if(!§!E§.§5"2§(param3))
         {
