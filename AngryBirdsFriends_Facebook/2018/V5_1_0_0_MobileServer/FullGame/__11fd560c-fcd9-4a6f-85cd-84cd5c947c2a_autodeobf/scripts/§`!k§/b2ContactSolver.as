   ...
   public class b2ContactSolver
   {
      ...
      public function §?#W§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            _loc20_ = _loc15_.§4!I§.x;
            _loc21_ = _loc15_.§4!I§.y;
            _loc22_ = _loc16_.§4!I§.x;
            _loc23_ = _loc16_.§4!I§.y;
            _loc24_ = _loc15_.m_angularVelocity;
            _loc25_ = _loc16_.m_angularVelocity;
            b2Settings.b2Assert(_loc17_.§%!+§ > 0);
            §>#&§.§?#W§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §>#&§.§=u§.x;
            _loc27_ = §>#&§.§=u§.y;
            ...
            _loc28_.§>#R§.x = _loc17_.§8&§.x;
            _loc28_.§>#R§.y = _loc17_.§8&§.y;
            _loc28_.localPoint.x = _loc17_.m_localPoint.x;
            _loc28_.localPoint.y = _loc17_.m_localPoint.y;
            _loc28_.radius = _loc13_ + _loc14_;
            _loc28_.type = _loc17_.§"#W§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§7!$§)
            {
               _loc30_ = _loc17_.§"!e§[_loc29_];
               (_loc31_ = _loc28_.§;$$§[_loc29_]).normalImpulse = _loc30_.§@#t§;
               _loc31_.tangentImpulse = _loc30_.§2!x§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§%'§.x = §>#&§.§"!e§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§%'§.y = §>#&§.§"!e§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§,!A§.x = §>#&§.§"!e§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§,!A§.y = §>#&§.§"!e§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               if((_loc38_ = _loc15_.§@P§ + _loc16_.§@P§ + _loc15_.§ !q§ * _loc36_ + _loc16_.§ !q§ * _loc37_) > 0)
               {
                  _loc31_.§%##§ = 1 / _loc38_;
               }
               else
               ...
               _loc39_ = (_loc39_ = _loc15_.§?"-§ * _loc15_.§@P§ + _loc16_.§?"-§ * _loc16_.§@P§) + (_loc15_.§?"-§ * _loc15_.§ !q§ * _loc36_ + _loc16_.§?"-§ * _loc16_.§ !q§ * _loc37_);
               _loc31_.§9$5§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               if((_loc44_ = _loc15_.§@P§ + _loc16_.§@P§ + _loc15_.§ !q§ * _loc42_ + _loc16_.§ !q§ * _loc43_) > 0)
               {
                  _loc31_.§!!w§ = 1 / _loc44_;
               }
               else
               ...
               {
                  _loc31_.§[$2§ = -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§7!$§ == 2)
            {
               ...
               {
                  _loc28_.§4#W§.col1.Set(_loc58_,_loc60_);
                  _loc28_.§4#W§.col2.Set(_loc60_,_loc59_);
                  _loc28_.§4#W§.§+"B§(_loc28_.§%##§);
               }
               else
               {
                  _loc28_.§7!$§ = 1;
         ...
         while(_loc5_ < this.§="I§)
         {
            ...
            if(param1.§##q§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc20_.normalImpulse *= param1.§4$B§;
                  _loc20_.tangentImpulse *= param1.§4$B§;
                  ...
                  _loc7_.§4!I§.x -= _loc9_ * _loc21_;
                  _loc7_.§4!I§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§,!A§.x * _loc22_ - _loc20_.§,!A§.y * _loc21_);
                  _loc8_.§4!I§.x += _loc11_ * _loc21_;
                  _loc8_.§4!I§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         while(_loc24_ < this.§="I§)
         {
            ...
            while(_loc1_ < _loc25_.§7!$§)
            {
               ...
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§,!A§.y - _loc30_.x + _loc28_ * _loc2_.§%'§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§,!A§.x - _loc30_.y - _loc28_ * _loc2_.§%'§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§!!w§ * -_loc10_;
               _loc12_ = _loc40_ * _loc2_.normalImpulse;
               _loc14_ = (_loc11_ = (_loc13_ = b2Math.§0"k§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_)) - _loc2_.tangentImpulse) * _loc38_;
            ...
            if(_loc25_.§7!$§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§%##§ * (_loc9_ - _loc2_.§[$2§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§,!A§.y - _loc30_.x + _loc28_ * _loc43_.§%'§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§,!A§.x - _loc30_.y - _loc28_ * _loc43_.§%'§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§,!A§.y - _loc30_.x + _loc28_ * _loc44_.§%'§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§,!A§.x - _loc30_.y - _loc28_ * _loc44_.§%'§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§[$2§;
               _loc54_ = _loc52_ - _loc44_.§[$2§;
               _loc22_ = _loc25_.§4#W§;
               ...
               else
               {
                  ...
                  _loc57_ = 0;
                  _loc51_ = 0;
                  _loc52_ = _loc25_.§4#W§.col1.y * _loc56_ + _loc54_;
                  ...
                  else
                  {
                     ...
                     _loc51_ = _loc25_.§4#W§.col2.x * _loc57_ + _loc53_;
                     _loc52_ = 0;
      ...
      public function §!!D§() : void
      {
         ...
         while(_loc1_ < this.§="I§)
         {
            ...
            {
               _loc5_ = _loc3_.§"!e§[_loc4_];
               _loc6_ = _loc2_.§;$$§[_loc4_];
               _loc5_.§@#t§ = _loc6_.normalImpulse;
               _loc5_.§2!x§ = _loc6_.tangentImpulse;
               _loc4_++;
            }
            _loc1_++;
         }
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§="I§)
         {
            ...
            _loc8_ = _loc5_.§?"-§ * _loc5_.§ !q§;
            _loc9_ = _loc6_.§?"-§ * _loc6_.§@P§;
            _loc10_ = _loc6_.§?"-§ * _loc6_.§ !q§;
            §&M§.§?#W§(_loc4_);
            _loc11_ = §&M§.§=u§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§7!$§)
            {
               ...
               _loc20_ = b2Math.§0"k§(param1 * (_loc15_ + b2Settings.b2_linearSlop),-b2Settings.b2_maxLinearCorrection,0);
               _loc22_ = (_loc21_ = -_loc13_.§9$5§ * _loc20_) * _loc11_.x;
