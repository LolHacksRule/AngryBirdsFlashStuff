package § "x§
{
   ...
   class §;!!§
   {
      ...
      {
         var _loc1_:BitmapData = new BitmapData(§6#!§,§+$@§);
         var _loc2_:ByteArray = new ByteArray();
         var _loc3_:int = §#e§.length;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc2_.writeUnsignedInt(§#e§[_loc4_]);
            _loc4_++;
         }
         _loc2_.uncompress();
         _loc1_.setPixels(new Rectangle(0,0,§6#!§,§+$@§),_loc2_);
         return Texture.§1!b§(null,_loc1_,false);
      }
