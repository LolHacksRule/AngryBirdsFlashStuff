package §+$?§
{
   ...
   public class §4$6§ implements §2!p§
   {
      ...
      public function §"!h§(param1:Avatar) : void
      {
      }
      ...
      public function render(param1:String, param2:Function, param3:int = 50, param4:Boolean = false, param5:Object = null, param6:Avatar = null, param7:int = 0, param8:Boolean = false, param9:Number = 0.4) : BitmapData
      {
         ...
         if(!param6)
         {
            ...
            {
               if(_loc16_.§=#s§ == "CategoryBirds")
               {
                  _loc17_ = §^#y§.§6!§.characters.§0Z§(_loc16_.mId);
         ...
         if(param6)
         {
            _loc13_.§6"w§(param6,100,170 + param7,true);
         }
         ...
         if(param6)
         {
            ...
            {
               if(_loc18_.§=#s§ != "CategoryBirds" && _loc18_.§=#s§ != "CategoryBackgrounds")
               {
                  param6.§-!M§(_loc18_);
               }
               if(_loc18_.§=#s§ == "CategoryBackgrounds")
               {
                  param6.§86§(_loc18_.mId);
               }
            }
            _loc15_ = param6.§,"=§();
            if(param5)
