package §8$@§
{
   ...
   public class §^"?§
   {
      ...
      public static function §%$<§(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number) : §="6§
      {
         ...
         while(_loc17_ < 2)
         {
            _loc12_[_loc17_] = §^X§(_loc8_,_loc9_,_loc14_[_loc17_].x,_loc14_[_loc17_].y);
         ...
         var _loc19_:§="6§;
         (_loc19_ = new §="6§()).§`"L§ = Math.sqrt(_loc16_);
         _loc19_.§%#d§ = _loc18_;
         return _loc19_;
      }
