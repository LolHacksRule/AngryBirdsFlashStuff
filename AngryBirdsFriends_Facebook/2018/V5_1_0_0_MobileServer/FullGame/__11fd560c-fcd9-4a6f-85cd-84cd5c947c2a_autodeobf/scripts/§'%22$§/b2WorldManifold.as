package §'"$§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §?#W§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§"#W§)
         {
            case b2Manifold.§@!1§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§"!e§[0].m_localPoint;
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§=u§.x = _loc19_ / _loc26_;
                  this.§=u§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§=u§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§=u§.x;
               _loc23_ = _loc16_ + param3 * this.§=u§.y;
               _loc24_ = _loc17_ - param5 * this.§=u§.x;
               _loc25_ = _loc18_ - param5 * this.§=u§.y;
               this.§"!e§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§"!e§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§"# §:
               _loc8_ = param2.R;
               _loc7_ = param1.§8&§;
               ...
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§"!e§[_loc6_].m_localPoint;
                  ...
                  this.§"!e§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§"!e§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§,!P§:
               ...
               while(_loc6_ < param1.§%!+§)
               {
                  ...
                  this.§"!e§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§"!e§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
