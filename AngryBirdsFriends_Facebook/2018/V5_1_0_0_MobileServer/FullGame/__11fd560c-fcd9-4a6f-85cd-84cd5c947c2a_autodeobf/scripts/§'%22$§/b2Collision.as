package §'"$§
{
   ...
   public class b2Collision
   {
      ...
      private static var §37§:Vector.<§[R§> = §[#$§();
      ...
      private static var § "S§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function § !x§(param1:Vector.<§[R§>, param2:Vector.<§[R§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§[R§ = null;
         var _loc6_:int = 0;
      ...
      public static function § if§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
      ...
      public static function §,"W§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = § if§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = § if§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = § if§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = § if§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §,"n§(param1:Vector.<§[R§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         _loc20_.id.§&!d§.§3F§ = param4;
         _loc20_.id.§&!d§.§@#g§ = _loc21_;
         _loc20_.id.§&!d§.§]#Q§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§&!d§.§3F§ = param4;
         _loc20_.id.§&!d§.§@#g§ = _loc22_;
         _loc20_.id.§&!d§.§]#Q§ = 1;
      }
      
      private static function §[#$§() : Vector.<§[R§>
      {
      ...
      public static function § o§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §`!5§[0] = _loc8_;
         var _loc9_:Number = §,"W§(§`!5§,param2,param3,param4,param5);
         _loc8_ = §`!5§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         § "S§[0] = _loc10_;
         var _loc11_:Number = §,"W§(§ "S§,param4,param5,param2,param3);
         _loc10_ = § "S§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§[R§> = §37§;
         §,"n§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §>"L§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §""9§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §3!]§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §`#7§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§[R§> = s_clipPoints1;
         var _loc38_:Vector.<§[R§> = s_clipPoints2;
         if((_loc39_ = § !x§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = § !x§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§8&§.SetV(_loc27_);
      ...
      public static function §%#u§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§"#W§ = b2Manifold.§@!1§;
         param1.m_localPoint.SetV(param2.§@#U§);
         param1.§8&§.§#!t§();
         param1.§%!+§ = 1;
         param1.§"!e§[0].m_localPoint.SetV(param4.§@#U§);
         param1.§"!e§[0].m_id.key = 0;
      }
      
      public static function §4!?§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§%!+§ = 1;
            param1.§"#W§ = b2Manifold.§"# §;
            param1.§8&§.x = _loc15_ - _loc27_.x;
            param1.§8&§.y = _loc16_ - _loc27_.y;
            param1.§8&§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§%!+§ = 1;
            param1.§"#W§ = b2Manifold.§"# §;
            param1.§8&§.x = _loc15_ - _loc28_.x;
            param1.§8&§.y = _loc16_ - _loc28_.y;
            param1.§8&§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§"!e§[0].m_localPoint.SetV(param4.§@#U§);
            param1.§"!e§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§%!+§ = 1;
            param1.§"#W§ = b2Manifold.§"# §;
            param1.§8&§.x = _loc23_[_loc25_].x;
            param1.§8&§.y = _loc23_[_loc25_].y;
            param1.§8&§.Normalize();
