package §+!W§
{
   ...
   public class SHA256
   {
      ...
      public static function §%$6§(param1:String) : String
      {
         ...
         return § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true);
      }
      
      public static function hashBytes(param1:ByteArray) : String
      {
         var _loc2_:Array = §9"k§(param1);
         var _loc3_:ByteArray = §>R§(_loc2_);
         return § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true);
      }
      ...
      private static function §>R§(param1:Array) : ByteArray
      {
         ...
         while(_loc13_ < _loc11_)
         {
            ...
            while(_loc23_ < 64)
            {
               ...
               {
                  _loc30_ = § "L§.§6f§(_loc12_[_loc23_ - 15],7) ^ § "L§.§6f§(_loc12_[_loc23_ - 15],18) ^ _loc12_[_loc23_ - 15] >>> 3;
                  _loc31_ = § "L§.§6f§(_loc12_[_loc23_ - 2],17) ^ § "L§.§6f§(_loc12_[_loc23_ - 2],19) ^ _loc12_[_loc23_ - 2] >>> 10;
                  _loc12_[_loc23_] = _loc12_[_loc23_ - 16] + _loc30_ + _loc12_[_loc23_ - 7] + _loc31_;
               }
               _loc24_ = § "L§.§6f§(_loc15_,2) ^ § "L§.§6f§(_loc15_,13) ^ § "L§.§6f§(_loc15_,22);
               _loc25_ = _loc15_ & _loc16_ ^ _loc15_ & _loc17_ ^ _loc16_ & _loc17_;
               _loc26_ = _loc24_ + _loc25_;
               _loc27_ = § "L§.§6f§(_loc19_,6) ^ § "L§.§6f§(_loc19_,11) ^ § "L§.§6f§(_loc19_,25);
      ...
      private static function §9"k§(param1:ByteArray) : Array
      {
      ...
      private static function §<!X§(param1:String) : Array
      {
