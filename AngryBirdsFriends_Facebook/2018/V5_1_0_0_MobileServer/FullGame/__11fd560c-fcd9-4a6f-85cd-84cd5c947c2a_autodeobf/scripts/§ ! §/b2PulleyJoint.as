package § ! §
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§!#r§ = b2internal::3!^.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§4!&§.x - this.§!#r§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§4!&§.y - this.§!#r§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§,#8§.x - this.§!#r§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§,#8§.y - this.§!#r§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§#"z§);
         this.m_localAnchor2.SetV(param1.§>#C§);
         this.§7#j§ = param1.§+e§;
         this.§ #,§ = param1.§&$#§ + this.§7#j§ * param1.§#"G§;
         this.m_maxLength1 = b2Math.§;$0§(param1.§]"d§,this.§ #,§ - this.§7#j§ * b2internal::3$@);
         this.m_maxLength2 = b2Math.§;$0§(param1.§6#<§,(this.§ #,§ - b2internal::3$@) / this.§7#j§);
         this.§1#a§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§1#a§ * this.m_u2.x,param1 * this.§1#a§ * this.m_u2.y);
      }
      ...
      {
         var _loc1_:b2Vec2 = b2internal::3!^.GetWorldPoint(this.m_localAnchor1);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§ #,§ - _loc18_ - this.§7#j§ * _loc19_) > 0)
         {
            this.§+!%§ = b2internal::7m;
            this.§1#a§ = 0;
         }
         ...
         {
            this.m_limitState1 = b2internal::7m;
            this.m_limitImpulse1 = 0;
         }
         else
         {
         ...
         {
            this.m_limitState2 = b2internal::7m;
            this.m_limitImpulse2 = 0;
         }
         else
         {
         ...
         this.m_limitMass1 = _loc2_.§@P§ + _loc2_.§ !q§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§@P§ + _loc3_.§ !q§ * _loc22_ * _loc22_;
         this.§=§ = this.m_limitMass1 + this.§7#j§ * this.§7#j§ * this.m_limitMass2;
         ...
         {
            this.§1#a§ *= param1.§4$B§;
            this.m_limitImpulse1 *= param1.§4$B§;
            this.m_limitImpulse2 *= param1.§4$B§;
            _loc23_ = (-this.§1#a§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§1#a§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§7#j§ * this.§1#a§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§7#j§ * this.§1#a§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§4!I§.x += _loc2_.§@P§ * _loc23_;
            _loc2_.§4!I§.y += _loc2_.§@P§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§ !q§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§4!I§.x += _loc3_.§@P§ * _loc25_;
            _loc3_.§4!I§.y += _loc3_.§@P§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§+!%§ == b2internal::`!)
         {
            _loc10_ = _loc2_.§4!I§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§4!I§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§4!I§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§4!I§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§7#j§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§=§ * -_loc18_;
            _loc20_ = this.§1#a§;
            this.§1#a§ = b2Math.§'!`§(0,this.§1#a§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§1#a§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§7#j§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§7#j§ * _loc19_ * this.m_u2.y;
            _loc2_.§4!I§.x += _loc2_.§@P§ * _loc14_;
            _loc2_.§4!I§.y += _loc2_.§@P§ * _loc15_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§+!%§ == b2internal::`!)
         {
            ...
            if(_loc18_ > b2Settings.b2_linearSlop)
            {
               this.m_u2.§8!O§(1 / _loc18_);
            }
            else
            {
               this.m_u2.§#!t§();
            }
            _loc19_ = this.§ #,§ - _loc17_ - this.§7#j§ * _loc18_;
            _loc24_ = b2Math.§'!`§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§0"k§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§=§ * _loc19_) * this.m_u1.x;
            _loc14_ = -_loc20_ * this.m_u1.y;
            _loc15_ = -this.§7#j§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§7#j§ * _loc20_ * this.m_u2.y;
