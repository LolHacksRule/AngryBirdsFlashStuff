package § ! §
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§1#a§.x * this.§2#M§.x + (this.§8#Z§ + this.§1#a§.y) * this.§^;§.x),param1 * (this.§1#a§.x * this.§2#M§.y + (this.§8#Z§ + this.§1#a§.y) * this.§^;§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§9!h§ = this.§9!h§ > Number.MIN_VALUE ? Number(1 / this.§9!h§) : Number(0);
         ...
         if(param1.§##q§)
         {
            ...
            this.§8#Z§ *= param1.§4$B§;
            _loc19_ = this.§1#a§.x * this.§2#M§.x + (this.§8#Z§ + this.§1#a§.y) * this.§^;§.x;
            _loc20_ = this.§1#a§.x * this.§2#M§.y + (this.§8#Z§ + this.§1#a§.y) * this.§^;§.y;
            _loc21_ = this.§1#a§.x * this.m_s1 + (this.§8#Z§ + this.§1#a§.y) * this.m_a1;
            _loc22_ = this.§1#a§.x * this.m_s2 + (this.§8#Z§ + this.§1#a§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§=#E§ && this.§ z§ != b2internal::]H)
         {
            ...
            _loc14_ = this.§9!h§ * (this.§3C§ - _loc13_);
            _loc15_ = this.§8#Z§;
            _loc16_ = param1.dt * this.§4v§;
            this.§8#Z§ = b2Math.§0"k§(this.§8#Z§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§8#Z§ - _loc15_) * this.§^;§.x;
         ...
         if(this.§3!f§ && this.§ z§ != b2internal::7m)
         {
            ...
            _loc18_ = this.§1#a§.Copy();
            _loc19_ = this.§%#W§.§3!Z§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§1#a§.§<I§(_loc19_);
            if(this.§ z§ == b2internal::=!A)
            {
               this.§1#a§.y = b2Math.§'!`§(this.§1#a§.y,0);
            }
            else if(this.§ z§ == b2internal::`!)
            {
               this.§1#a§.y = b2Math.§;$0§(this.§1#a§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§1#a§.y - _loc18_.y) * this.§%#W§.col2.x;
            if(this.§%#W§.col1.x != 0)
            {
            ...
            this.§1#a§.x = _loc21_;
            _loc19_.x = this.§1#a§.x - _loc18_.x;
            _loc19_.y = this.§1#a§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§2#M§.x + _loc19_.y * this.§^;§.x;
            _loc9_ = _loc19_.x * this.§2#M§.y + _loc19_.y * this.§^;§.y;
         ...
         else
         {
            ...
            this.§1#a§.x += _loc22_;
            _loc8_ = _loc22_ * this.§2#M§.x;
            _loc9_ = _loc22_ * this.§2#M§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§3!f§)
         {
            ...
            if(b2Math.§[^§(this.§9!>§ - this.§5$B§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§0"k§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§[^§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§5$B§)
            {
               _loc19_ = b2Math.§0"k§(_loc34_ - this.§5$B§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§5$B§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§9!>§)
            {
               _loc19_ = b2Math.§0"k§(_loc34_ - this.§9!>§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§%#W§.§3!Z§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::-"+;
         ...
         var _loc30_:Number = _loc28_.x * this.§2#M§.x + _loc28_.y * this.§^;§.x;
         var _loc31_:Number = _loc28_.x * this.§2#M§.y + _loc28_.y * this.§^;§.y;
         ...
         _loc8_.x += b2internal::!!E * _loc30_;
         _loc8_.y += b2internal::!!E * _loc31_;
         _loc9_ += b2internal::"#P * _loc33_;
