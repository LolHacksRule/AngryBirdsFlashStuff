package com.angrybirds.popups
{
   ...
   public class WarningPopup extends AbstractPopup
   {
      ...
      public function WarningPopup(layerIndex:int, priority:int, text:String = "The pigs are messing with our servers!\r\rIf this happens again please reload the game.", title:String = "Oops!", errorImageLabel:String = "0", allowResume:Boolean = true, id:String = "WarningPopup")
      {
