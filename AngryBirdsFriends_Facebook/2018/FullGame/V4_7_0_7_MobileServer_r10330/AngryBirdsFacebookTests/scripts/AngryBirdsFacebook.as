package
{
   ...
   public class AngryBirdsFacebook extends AngryBirdsBase implements IVirtualPageView, IAngryBirdsFacebook
   {
      ...
      protected static var mFacebookTournamentBrandedViewLibraryBin:Class = AngryBirdsFacebook_mFacebookTournamentBrandedViewLibraryBin;
      ...
      public function AngryBirdsFacebook(canvas:ApplicationCanvas)
      {
         ...
         SERVER_ROOT = canvas.stage.loaderInfo.parameters.serverRoot || (!!DEBUG_MODE_ENABLED ? "https://madness-dot-angrybirds-friends-new-feature.appspot.com/" : "http://angrybirds-facebook-dev.appspot.com");
      ...
      protected function initDataFromServer() : void
      {
         ...
         if(!facebookUserId)
         {
            throw new Error("Did not receive a facebook user ID.",ErrorCode.NO_FACEBOOK_ID);
         }
