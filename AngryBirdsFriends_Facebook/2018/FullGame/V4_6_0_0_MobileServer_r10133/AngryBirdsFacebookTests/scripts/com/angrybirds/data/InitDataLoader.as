package com.angrybirds.data
{
   ...
   public class InitDataLoader
   {
      ...
      {
         var urlReq:URLRequest = AngryBirdsFacebook.sSingleton.graphAPICaller.createGraphAPIRequest("https://graph.facebook.com/" + AngryBirdsFacebook.FB_API_VERSION + "/me/invitable_friends/");
         var urlLoad:RetryingURLLoader = new RetryingURLLoader(urlReq);
         urlLoad.addEventListener(Event.COMPLETE,onInviteCandidatesLoaded);
      ...
      protected static function onInviteCandidatesLoaded(e:Event) : void
      {
         ...
         FriendsDataCache.injectInviteFriendsData(jsonOb.data);
         reduceDataLoaderCounter();
      }
