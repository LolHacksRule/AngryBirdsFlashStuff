package com.rovio.utils
{
   ...
   public class FacebookAnalyticsCollector
   {
      ...
      private static const ANALYTICS_URL_DEBUG:String = "https://smoke.rovio.com";
      
      private static const ANALYTICS_URL_STAGING:String = "https://mist.rovio.com";
      
      private static const ANALYTICS_URL_LIVE:String = "https://cloud.rovio.com";
      
      private static const EVENT_COLLECTOR:String = "/collector/1.0/events";
      ...
      protected function onTimerReachedInterval(event:TimerEvent) : void
      {
         ...
         if(this.mAnalyticsEvents && this.mAnalyticsEvents.length > 0 && !this.mSendingInProgress && this.mEnabled)
         {
            ...
            dataObject.token = this.getAccessToken();
            dataObject.events = this.getAnalyticsEvents();
            requestHeaders = [new URLRequestHeader("Content-Type","application/json")];
            this.sendData(EVENT_COLLECTOR,this.onEventsBatchSent,dataObject,this.CONTENT_TYPE_APPLICATION_JSON,requestHeaders,true);
         }
      }
      ...
      public function sendData(url:String, callBack:Function, parameters:Object = null, contentType:String = null, requestHeaders:Array = null, requireAccessToken:Boolean = false) : void
      {
         ...
         if(parameters)
         {
            ...
            {
               requestData[parameterName] = parameters[parameterName];
            }
         }
      ...
      public function trackLevelEndedEvent(passed:Boolean, levelId:String, chapterName:String, noOfBirdsUsed:Number, noOfBirdsAvailable:Number, noOfStars:Number, usedPowerups:Array, score:Number, firstTimeCompleted:Boolean = false, firstTimeThreeStars:Boolean = false, firstTime100:Boolean = false, mightyEagleUsed:Boolean = false, feathersPercentage:int = 0) : void
      {
      ...
      private function createAnalyticsEvents(eventName:String, parameters:Vector.<AnalyticsEventParameter>, isFirstTime:Boolean = false, testCase:String = "", testGroup:String = "") : void
      {
         ...
         if(this.mEnabled)
         {
            this.getAnalyticsEvents().push(new AnalyticsEvent(eventName,this.nowDateFormatted(),parameters));
         }
      }
      ...
      private function nowDateFormatted() : String
      {
         var d:Date = new Date();
      ...
      public function formatDate(d:Date) : String
      {
         ...
         return dtf.format(d) + StringUtil.substitute(".{0}{1}:{2}",d.milliseconds.toString().slice(0,2),hour,min);
      }
