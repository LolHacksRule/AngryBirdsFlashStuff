package §=§#0
{
   ...
   public class §>"8§
   {
      ...
      public function §=#8§() : void
      {
         ...
         {
            this.§'#f§.removeChild(this.§4$!§[_loc1_]);
            _loc1_++;
         }
         this.§4$!§.splice(0,this.§4$!§.length);
         _loc1_ = 0;
         while(_loc1_ < this.§8#f§.length)
         {
            _loc2_ = this.§!"<§();
            _loc2_.index = _loc1_;
            _loc2_.data = this.§8#f§[_loc1_];
            this.§4$!§.push(_loc2_);
      ...
      {
         if(this.§;=§ - param1 > 0 || this.§;=§ - param1 - this.§=#V§ < -this.§8#f§.length)
         {
            return true;
         }
         return false;
      ...
      public function updatePositions() : void
      {
         ...
         while(_loc1_ < this.§8#f§.length)
         {
            ...
            if(_loc3_ > -this.§4!2§ && _loc3_ < this.§9"z§ - this.§4!2§ && !this.§>@§(_loc1_))
            {
               _loc4_ = this.§!"<§();
               this.§'#f§.addChild(_loc4_);
               _loc4_.data = this.§8#f§[_loc1_];
               _loc4_.index = _loc1_;
               _loc4_.x = _loc3_;
               this.§4$!§.push(_loc4_);
            }
      ...
      public function refresh() : void
      {
         ...
         {
            _loc1_.data = this.§8#f§[_loc1_.index];
         }
      }
