package §!H§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         return _loc4_ * _loc4_ + _loc5_ * _loc5_ <= b2internal::5#n * b2internal::5#n;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc9_:Number = _loc7_ * _loc7_ + _loc8_ * _loc8_ - b2internal::5#n * b2internal::5#n;
         ...
         if(0 <= _loc15_ && _loc15_ <= param2.§^#V§ * _loc13_)
         {
            _loc15_ /= _loc13_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§@`§.Set(_loc4_ - b2internal::5#n,_loc5_ - b2internal::5#n);
         param1.§=!F§.Set(_loc4_ + b2internal::5#n,_loc5_ + b2internal::5#n);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§>#+§ = param2 * b2Settings.b2_pi * b2internal::5#n * b2internal::5#n;
         param1.center.SetV(this.§>#>§);
         param1.§-$@§ = param1.§>#+§ * (0.5 * b2internal::5#n * b2internal::5#n + (this.§>#>§.x * this.§>#>§.x + this.§>#>§.y * this.§>#>§.y));
      }
      
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         var _loc9_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§9!0§(param3,this.§>#>§);
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.§@$+§(param1,_loc5_) - param2)) < -b2internal::5#n + Number.MIN_VALUE)
         {
            return 0;
         }
         if(_loc6_ > b2internal::5#n)
         {
            param4.SetV(_loc5_);
            return Math.PI * b2internal::5#n * b2internal::5#n;
         }
         var _loc7_:Number = b2internal::5#n * b2internal::5#n;
         var _loc8_:Number = _loc6_ * _loc6_;
         _loc9_ = _loc7_ * (Math.asin(_loc6_ / b2internal::5#n) + Math.PI / 2) + _loc6_ * Math.sqrt(_loc7_ - _loc8_);
      ...
      public function §7#s§() : b2Vec2
      {
         return this.§>#>§;
      }
      
      public function §6a§(param1:b2Vec2) : void
      {
         this.§>#>§.SetV(param1);
      }
