package com.angrybirds.data.level.theme
{
   public class LevelThemeBackgroundFriends extends LevelThemeBackground
   {
      ...
      private function initializeLayer(layerData:Object, foreground:Boolean, animationObjects:Object) : void
      {
         ...
         var layer:LevelThemeBackgroundLayer = new LevelThemeBackgroundLayer(spriteName,spriteNames,frameTime,sky,scale,speed,offsetX,offsetY,velocityX,foreground,tileable,optional,moveStartOffsetX,moveEndOffsetX,highQuality,layerVisibility);
