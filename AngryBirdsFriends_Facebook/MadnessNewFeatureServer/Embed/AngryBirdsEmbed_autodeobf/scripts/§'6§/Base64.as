package §'6§
{
   ...
   public class Base64
   {
      ...
      private static const §@!I§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §5U§(param1:ByteArray) : String
      {
      ...
      {
         var _loc2_:ByteArray = §6s§(param1);
         return _loc2_.readUTFBytes(_loc2_.length);
      }
      
      public static function §6s§(param1:String) : ByteArray
      {
         var _loc6_:uint = 0;
         var _loc7_:uint = 0;
         var _loc2_:ByteArray = new ByteArray();
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §@!I§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
