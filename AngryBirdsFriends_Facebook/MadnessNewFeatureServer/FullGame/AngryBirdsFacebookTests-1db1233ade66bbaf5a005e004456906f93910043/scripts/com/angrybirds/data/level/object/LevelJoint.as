package com.angrybirds.data.level.object
{
   ...
   public class LevelJoint extends LevelJointModel
   {
      ...
      private var mSetValuesToDefault:Boolean = false;
      ...
      public function get setValuesToDefault() : Boolean
      {
         return this.mSetValuesToDefault;
      }
      
      public function set setValuesToDefault(value:Boolean) : void
      {
         this.mSetValuesToDefault = value;
      }
   }
}
