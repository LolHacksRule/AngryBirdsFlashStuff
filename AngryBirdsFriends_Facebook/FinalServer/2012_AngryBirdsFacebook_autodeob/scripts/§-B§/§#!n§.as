package §-B§
{
   ...
   public class §#!n§ extends §]!<§
   {
      ...
      public function §#!n§(param1:XML, param2:§?!j§, param3:MovieClip = null)
      {
         this.§ ]§ = new Rectangle();
      ...
      private function startDrag(param1:Event = null) : void
      {
         if(mClip.stage)
         {
            ...
            this.mDragging = true;
            mClip.stage.addEventListener(MouseEvent.MOUSE_MOVE,this.§2!U§);
      ...
      private function stopDrag(param1:Event = null) : void
      {
         ...
         if(mClip.stage)
         {
            mClip.stage.removeEventListener(MouseEvent.MOUSE_MOVE,this.§2!U§);
