package §=%§
{
   ...
   public class §[J§
   {
      ...
      public static function §<n§(param1:XMLList) : void
      {
         ...
         for each(_loc2_ in param1.Shape)
         {
            ...
            else
            {
               ...
               § 1§(_loc2_.@id,_loc2_.@shape,_loc2_.@width,_loc2_.@height,_loc2_.@flipAngleCorrection);
            }
         }
      }
      
      public static function § 1§(param1:String, param2:String, param3:Number, param4:Number, param5:Number) : void
      {
         §3g§[§3g§.length] = new §&-§(param1,param2,param3,param4,param5);
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < §3g§.length)
         {
            if((§3g§[_loc2_] as §&-§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §&-§(§3g§[_loc2_]);
            }
            _loc2_++;
