package §"G§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§^"8§.x * this.§<3§.x + (this.§`;§ + this.§^"8§.z) * this.§;!F§.x),param1 * (this.§^"8§.x * this.§<3§.y + (this.§`;§ + this.§^"8§.z) * this.§;!F§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§@"9§)
         {
            ...
            this.§^"8§.y *= param1.§0#§;
            this.§`;§ *= param1.§0#§;
            _loc19_ = this.§^"8§.x * this.§<3§.x + (this.§`;§ + this.§^"8§.z) * this.§;!F§.x;
            _loc20_ = this.§^"8§.x * this.§<3§.y + (this.§`;§ + this.§^"8§.z) * this.§;!F§.y;
            _loc21_ = this.§^"8§.x * this.m_s1 + this.§^"8§.y + (this.§`;§ + this.§^"8§.z) * this.m_a1;
            _loc22_ = this.§^"8§.x * this.m_s2 + this.§^"8§.y + (this.§`;§ + this.§^"8§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§,7§ && this.§ !5§ != b2internal:: j)
         {
            ...
            _loc15_ = this.§1!T§ * (this.§3!?§ - _loc14_);
            _loc16_ = this.§`;§;
            _loc17_ = param1.§&!K§ * this.§0=§;
            this.§`;§ = b2Math.§&+§(this.§`;§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§`;§ - _loc16_) * this.§;!F§.x;
         ...
         if(this.§<!f§ && this.§ !5§ != b2internal::;7)
         {
            ...
            if(this.§ !5§ == b2internal::#N)
            {
               this.§^"8§.z = b2Math.§4!3§(this.§^"8§.z,0);
            }
            else if(this.§ !5§ == b2internal::!c)
            {
               this.§^"8§.z = b2Math.§>!]§(this.§^"8§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§^"8§.z - _loc19_.z) * this.§^h§.col3.x;
            _loc22_ = -_loc13_ - (this.§^"8§.z - _loc19_.z) * this.§^h§.col3.y;
            ...
            _loc8_ = _loc20_.x * this.§<3§.x + _loc20_.z * this.§;!F§.x;
            _loc9_ = _loc20_.x * this.§<3§.y + _loc20_.z * this.§;!F§.y;
         ...
         else
         {
            ...
            this.§^"8§.x += _loc24_.x;
            this.§^"8§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§<3§.x;
            _loc9_ = _loc24_.x * this.§<3§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§<!f§)
         {
            ...
            {
               _loc19_ = b2Math.§&+§(_loc35_ - this.§8[§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§4!i§;
         _loc16_ = b2Math.§4!3§(_loc16_,b2Math.§?h§(_loc29_));
         _loc17_ = b2Math.§?h§(_loc30_);
         if(_loc18_)
         {
         ...
         var _loc31_:Number = _loc28_.x * this.§<3§.x + _loc28_.z * this.§;!F§.x;
         var _loc32_:Number = _loc28_.x * this.§<3§.y + _loc28_.z * this.§;!F§.y;
         ...
         _loc6_.x -= b2internal::@f * _loc31_;
         _loc6_.y -= b2internal::@f * _loc32_;
         _loc7_ -= b2internal::4v * _loc33_;
         _loc8_.x += b2internal::+" * _loc31_;
         _loc8_.y += b2internal::+" * _loc32_;
         _loc9_ += b2internal::#f * _loc34_;
