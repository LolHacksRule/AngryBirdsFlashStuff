package §7F§
{
   public class b2Vec2
   {
      ...
      public function §5X§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§"V§(this,param1.col1);
         this.y = b2Math.§"V§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      public function §2s§(param1:b2Vec2) : void
      {
