package §5#D§
{
   ...
   public class SHA1
   {
      ...
      public static function §!"a§(param1:String) : String
      {
         ...
         return § try§.§7R§(_loc3_.readInt(),true) + § try§.§7R§(_loc3_.readInt(),true) + § try§.§7R§(_loc3_.readInt(),true) + § try§.§7R§(_loc3_.readInt(),true) + § try§.§7R§(_loc3_.readInt(),true);
      }
      
      public static function hashBytes(param1:ByteArray) : String
      {
         var _loc2_:Array = SHA1.§=!_§(param1);
         var _loc3_:ByteArray = §8#s§(_loc2_);
         return § try§.§7R§(_loc3_.readInt(),true) + § try§.§7R§(_loc3_.readInt(),true) + § try§.§7R§(_loc3_.readInt(),true) + § try§.§7R§(_loc3_.readInt(),true) + § try§.§7R§(_loc3_.readInt(),true);
      }
