package §,#E§
{
   ...
   class b2Simplex
   {
      ...
      public var §!$3§:Vector.<b2SimplexVertex>;
      ...
      function b2Simplex()
      {
         ...
         this.§!$3§ = new Vector.<b2SimplexVertex>(3);
         super();
         this.§!$3§[0] = this.m_v1;
         this.§!$3§[1] = this.m_v2;
         this.§!$3§[2] = this.m_v3;
      ...
      public function §-!I§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         this.§>"$§ = param1.count;
         var _loc8_:Vector.<b2SimplexVertex> = this.§!$3§;
         var _loc9_:int = 0;
         while(_loc9_ < this.§>"$§)
         {
            ...
            _loc10_.§%#E§ = b2Math.§ W§(param3,_loc6_);
            _loc10_.§'y§ = b2Math.§ W§(param5,_loc7_);
            _loc10_.w = b2Math.§7q§(_loc10_.§'y§,_loc10_.§%#E§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§>"$§ > 1)
      ...
      public function §8"U§(param1:b2SimplexCache) : void
      {
         param1.§2!_§ = this.§`E§();
         param1.count = uint(this.§>"$§);
         var _loc2_:Vector.<b2SimplexVertex> = this.§!$3§;
         var _loc3_:int = 0;
         while(_loc3_ < this.§>"$§)
         {
      ...
      public function §4!J§() : b2Vec2
      {
         ...
         {
            case 1:
               return this.m_v1.w.§7!5§();
            case 2:
               _loc1_ = b2Math.§7q§(this.m_v2.w,this.m_v1.w);
               _loc2_ = b2Math.§<!$§(_loc1_,this.m_v1.w.§7!5§());
               if(_loc2_ > 0)
               {
                  return b2Math.§+"Y§(1,_loc1_);
               }
               return b2Math.§="a§(_loc1_,1);
               break;
            default:
      ...
      public function §2"A§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§>"$§)
         {
            case 0:
      ...
      public function §`E§() : Number
      {
         switch(this.§>"$§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§7q§(this.m_v1.w,this.m_v2.w).Length();
            case 3:
               return b2Math.§<!$§(b2Math.§7q§(this.m_v2.w,this.m_v1.w),b2Math.§7q§(this.m_v3.w,this.m_v1.w));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve2() : void
      {
         ...
         var _loc3_:b2Vec2 = b2Math.§7q§(_loc2_,_loc1_);
         var _loc4_:Number;
