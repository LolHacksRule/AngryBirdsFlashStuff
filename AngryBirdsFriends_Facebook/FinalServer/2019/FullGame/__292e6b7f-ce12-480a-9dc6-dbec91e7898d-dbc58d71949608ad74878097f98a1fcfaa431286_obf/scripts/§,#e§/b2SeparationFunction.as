package §,#E§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §&N§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§#!T§ = §,";§;
            _loc7_ = this.§49§.§+"1§(param1.indexA[0]);
            _loc10_ = this.§;%§.§+"1§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§#!T§ = §4^§;
            _loc8_ = this.§49§.§+"1§(param1.indexA[0]);
            _loc9_ = this.§49§.§+"1§(param1.indexA[1]);
            _loc10_ = this.§;%§.§+"1§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§"#1§ = b2Math.§="a§(b2Math.§7q§(_loc9_,_loc8_),1);
            this.§"#1§.Normalize();
            _loc20_ = this.§"#1§;
         ...
         {
            this.§#!T§ = §0!p§;
            _loc11_ = this.§;%§.§+"1§(param1.indexB[0]);
            _loc12_ = this.§;%§.§+"1§(param1.indexB[1]);
            _loc7_ = this.§49§.§+"1§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§"#1§ = b2Math.§="a§(b2Math.§7q§(_loc12_,_loc11_),1);
            this.§"#1§.Normalize();
            _loc20_ = this.§"#1§;
         ...
         else
         {
            ...
            _loc24_ = b2Math.§&!@§(param3.R,b2Math.§7q§(_loc9_,_loc8_));
            _loc25_ = b2Math.§ W§(param5,_loc10_);
            _loc26_ = b2Math.§&!@§(param5.R,b2Math.§7q§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§7q§(_loc26_,_loc24_);
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §,";§:
               _loc3_ = b2Math.§6"`§(param1.R,this.§"#1§);
               _loc4_ = b2Math.§6"`§(param2.R,this.§"#1§.§7!5§());
               _loc5_ = this.§49§.§2"h§(_loc3_);
               _loc6_ = this.§;%§.§2"h§(_loc4_);
               _loc7_ = b2Math.§ W§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§ W§(param2,_loc6_)).x - _loc7_.x) * this.§"#1§.x + (_loc8_.y - _loc7_.y) * this.§"#1§.y);
            case §4^§:
               _loc10_ = b2Math.§&!@§(param1.R,this.§"#1§);
               _loc7_ = b2Math.§ W§(param1,this.m_localPoint);
               _loc4_ = b2Math.§6"`§(param2.R,_loc10_.§7!5§());
               _loc6_ = this.§;%§.§2"h§(_loc4_);
            ...
            case §0!p§:
               ...
               _loc3_ = b2Math.§6"`§(param1.R,_loc10_.§7!5§());
               _loc5_ = this.§49§.§2"h§(_loc3_);
