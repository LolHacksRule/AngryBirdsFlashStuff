package §!"b§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§9b§.x * this.§2#2§.x + (this.§<!T§ + this.§9b§.y) * this.§"#1§.x),param1 * (this.§9b§.x * this.§2#2§.y + (this.§<!T§ + this.§9b§.y) * this.§"#1§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§0"R§ = this.§0"R§ > Number.MIN_VALUE ? Number(1 / this.§0"R§) : Number(0);
         ...
         this.§3"5§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§3"5§.col2.x = this.§3"5§.col1.y;
         this.§3"5§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§'!R§)
         {
         ...
         if(param1.§^q§)
         {
            ...
            this.§9b§.y *= param1.§%!U§;
            this.§<!T§ *= param1.§%!U§;
            _loc19_ = this.§9b§.x * this.§2#2§.x + (this.§<!T§ + this.§9b§.y) * this.§"#1§.x;
            _loc20_ = this.§9b§.x * this.§2#2§.y + (this.§<!T§ + this.§9b§.y) * this.§"#1§.y;
            _loc21_ = this.§9b§.x * this.m_s1 + (this.§<!T§ + this.§9b§.y) * this.m_a1;
            _loc22_ = this.§9b§.x * this.m_s2 + (this.§<!T§ + this.§9b§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§%$+§ && this.§!!t§ != b2internal:: "$)
         {
            ...
            _loc14_ = this.§0"R§ * (this.§9!e§ - _loc13_);
            _loc15_ = this.§<!T§;
            _loc16_ = param1.dt * this.§5"e§;
            this.§<!T§ = b2Math.§!!7§(this.§<!T§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§<!T§ - _loc15_) * this.§"#1§.x;
         ...
         if(this.§'!R§ && this.§!!t§ != b2internal::&A)
         {
            ...
            _loc18_ = this.§9b§.Copy();
            _loc19_ = this.§3"5§.§"!p§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§9b§.§0#3§(_loc19_);
            if(this.§!!t§ == b2internal::-I)
            {
               this.§9b§.y = b2Math.§="Z§(this.§9b§.y,0);
            }
            else if(this.§!!t§ == b2internal::?b)
            {
               this.§9b§.y = b2Math.§!#K§(this.§9b§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§9b§.y - _loc18_.y) * this.§3"5§.col2.x;
            if(this.§3"5§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§3"5§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§9b§.x = _loc21_;
            _loc19_.x = this.§9b§.x - _loc18_.x;
            _loc19_.y = this.§9b§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§2#2§.x + _loc19_.y * this.§"#1§.x;
            _loc9_ = _loc19_.x * this.§2#2§.y + _loc19_.y * this.§"#1§.y;
         ...
         else
         {
            if(this.§3"5§.col1.x != 0)
            {
               _loc22_ = -_loc12_ / this.§3"5§.col1.x;
            }
            else
            {
               _loc22_ = 0;
            ...
            this.§9b§.x += _loc22_;
            _loc8_ = _loc22_ * this.§2#2§.x;
            _loc9_ = _loc22_ * this.§2#2§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§'!R§)
         {
            ...
            if(b2Math.§0!2§(this.§>#F§ - this.§8#S§) < 2 * b2Settings.b2_linearSlop)
            {
               ...
               _loc16_ = b2Math.§0!2§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§8#S§)
            {
               _loc19_ = b2Math.§!!7§(_loc34_ - this.§8#S§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§8#S§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§>#F§)
            {
               _loc19_ = b2Math.§!!7§(_loc34_ - this.§>#F§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§3"5§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§3"5§.col2.x = this.§3"5§.col1.y;
            this.§3"5§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§3"5§.§"!p§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::3$#;
         ...
         var _loc30_:Number = _loc28_.x * this.§2#2§.x + _loc28_.y * this.§"#1§.x;
         var _loc31_:Number = _loc28_.x * this.§2#2§.y + _loc28_.y * this.§"#1§.y;
         ...
         _loc8_.x += b2internal::include * _loc30_;
         _loc8_.y += b2internal::include * _loc31_;
         _loc9_ += b2internal::0#4 * _loc33_;
