package §,#E§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §&N§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§#!T§)
         {
            case b2Manifold.§9x§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§3!-§[0].m_localPoint;
               ...
               this.§3!-§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§3!-§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§4^§:
               _loc8_ = param2.R;
               _loc7_ = param1.§true §;
               ...
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§3!-§[_loc6_].m_localPoint;
                  ...
                  this.§3!-§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§3!-§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§0!p§:
               ...
               while(_loc6_ < param1.§!!p§)
               {
                  ...
                  this.§3!-§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§3!-§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
