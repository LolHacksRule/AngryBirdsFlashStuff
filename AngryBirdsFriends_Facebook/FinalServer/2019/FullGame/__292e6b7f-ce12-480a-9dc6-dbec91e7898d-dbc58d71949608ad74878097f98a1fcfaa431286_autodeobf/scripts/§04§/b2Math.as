package §04§
{
   public class b2Math
   {
      ...
      public static function §="a§(param1:b2Vec2, param2:Number) : b2Vec2
      {
      ...
      public static function §%!1§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         ...
         _loc3_ = §7q§(param2,param1.position);
      ...
      public static function §7q§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1.x - param2.x,param1.y - param2.y);
      }
      ...
      public static function §4"1§(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§;"3§(§%#§(param1.col1,param2.col1),§%#§(param1.col2,param2.col2));
      }
      
      public static function §use §(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§;"3§(§&!@§(param1,param2.col1),§&!@§(param1,param2.col2));
      }
      ...
      {
         return new b2Vec2(§0!2§(param1.x),§0!2§(param1.y));
      }
      
      public static function § #3§(param1:b2Mat22) : b2Mat22
      {
      ...
      {
         return §[#F§(param2,§+F§(param1,param3));
      }
      ...
      public static function §<!D§(param1:uint) : uint
      {
      ...
      public static function §2#F§(param1:uint) : Boolean
      {
