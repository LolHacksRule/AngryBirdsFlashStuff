package §04§
{
   public class b2Vec2
   {
      ...
      public static function §!"i§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §0#3§(param1:b2Vec2) : void
      {
         this.x += param1.x;
         this.y += param1.y;
      }
      ...
      public function §5#1§(param1:b2Mat22) : void
      {
