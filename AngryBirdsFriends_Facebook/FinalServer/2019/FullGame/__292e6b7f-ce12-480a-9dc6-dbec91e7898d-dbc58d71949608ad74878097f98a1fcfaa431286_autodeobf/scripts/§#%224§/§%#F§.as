package §#"4§
{
   ...
   public class §%#F§
   {
      ...
      public static function §@"b§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         jsonString = §%3§(luaString,emptyObjectAsArray);
         try
         {
      ...
      public static function §%3§(param1:String, param2:Boolean = false) : String
      {
      ...
      private static function §<#R§(param1:Object, param2:int) : String
      {
         var _loc4_:* = null;
         var _loc5_:int = 0;
         param2++;
