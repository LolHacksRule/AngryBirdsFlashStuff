package §^w§
{
   ...
   public class SWFWheel
   {
      ...
      public static function initialize(param1:Stage) : void
      {
         ...
         §]"A§ = param1;
         ExternalInterface.call(§6"n§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §&#1§ = ExternalInterface.call(§!#m§,ExternalInterface.objectID);
         if(§&#1§ == §4L§)
         {
            return;
         }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §]"A§.getObjectsUnderPoint(new Point(§]"A§.mouseX,§]"A§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
