package §1#I§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         return _loc4_ * _loc4_ + _loc5_ * _loc5_ <= b2internal::&"7 * b2internal::&"7;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc9_:Number = _loc7_ * _loc7_ + _loc8_ * _loc8_ - b2internal::&"7 * b2internal::&"7;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§##N§.Set(_loc4_ - b2internal::&"7,_loc5_ - b2internal::&"7);
         param1.§#r§.Set(_loc4_ + b2internal::&"7,_loc5_ + b2internal::&"7);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§="-§ = param2 * b2Settings.b2_pi * b2internal::&"7 * b2internal::&"7;
         param1.center.SetV(this.§]##§);
         param1.§&n§ = param1.§="-§ * (0.5 * b2internal::&"7 * b2internal::&"7 + (this.§]##§.x * this.§]##§.x + this.§]##§.y * this.§]##§.y));
      }
      
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         var _loc9_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§ W§(param3,this.§]##§);
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.§!"+§(param1,_loc5_) - param2)) < -b2internal::&"7 + Number.MIN_VALUE)
         {
            return 0;
         }
         if(_loc6_ > b2internal::&"7)
         {
            param4.SetV(_loc5_);
            return Math.PI * b2internal::&"7 * b2internal::&"7;
         }
         var _loc7_:Number = b2internal::&"7 * b2internal::&"7;
         var _loc8_:Number = _loc6_ * _loc6_;
         _loc9_ = _loc7_ * (Math.asin(_loc6_ / b2internal::&"7) + Math.PI / 2) + _loc6_ * Math.sqrt(_loc7_ - _loc8_);
