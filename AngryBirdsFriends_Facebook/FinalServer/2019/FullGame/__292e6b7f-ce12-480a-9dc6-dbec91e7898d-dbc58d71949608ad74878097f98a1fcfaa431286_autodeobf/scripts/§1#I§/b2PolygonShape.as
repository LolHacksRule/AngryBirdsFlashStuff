package §1#I§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §3!T§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §4$+§:b2Vec2;
      
      b2internal var §!$3§:Vector.<b2Vec2>;
      
      b2internal var §9"+§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         §#!T§ = b2internal::#!J;
         this.§4$+§ = new b2Vec2();
         this.§!$3§ = new Vector.<b2Vec2>();
         this.§9"+§ = new Vector.<b2Vec2>();
         §&"7§ = b2Settings.b2_polygonRadius;
         this.§4$+§.§3-§();
      }
      ...
      public static function §,!r§(param1:Array, param2:Number) : b2PolygonShape
      {
         ...
         _loc3_.§4#j§(param1,param2);
         return _loc3_;
      }
      
      public static function §-#A§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§3$2§(param1,param2);
         return _loc3_;
      }
      ...
      public static function §>#e§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
      ...
      b2internal static function §["k§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§4$+§.SetV(_loc2_.§4$+§);
            this.§5#]§ = _loc2_.§5#]§;
            this.§#o§(this.§5#]§);
            _loc3_ = 0;
            while(_loc3_ < this.§5#]§)
            {
               this.§!$3§[_loc3_].SetV(_loc2_.§!$3§[_loc3_]);
               this.§9"+§[_loc3_].SetV(_loc2_.§9"+§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §4#j§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§3$2§(_loc3_,param2);
      }
      
      public function §3$2§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§5#]§)
         {
            this.§!$3§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§5#]§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§5#]§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§7q§(this.§!$3§[_loc5_],this.§!$3§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§-#!§() > Number.MIN_VALUE);
            this.§9"+§[_loc3_].SetV(b2Math.§="a§(_loc6_,1));
            this.§9"+§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§4$+§ = §<"§(this.§!$3§,this.§5#]§);
      }
      ...
      public function §5![§(param1:Number, param2:Number) : void
      {
         this.§5#]§ = 4;
         this.§#o§(4);
         this.§!$3§[0].Set(-param1,-param2);
         this.§!$3§[1].Set(param1,-param2);
         this.§!$3§[2].Set(param1,param2);
         this.§!$3§[3].Set(-param1,param2);
         this.§9"+§[0].Set(0,-1);
         this.§9"+§[1].Set(1,0);
         this.§9"+§[2].Set(0,1);
         this.§9"+§[3].Set(-1,0);
      ...
      public function § "n§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§5#]§)
         {
            this.§!$3§[_loc6_] = b2Math.§ W§(_loc5_,this.§!$3§[_loc6_]);
            this.§9"+§[_loc6_] = b2Math.§&!@§(_loc5_.R,this.§9"+§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §]!F§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§5#]§ = 2;
         this.§#o§(2);
         this.§!$3§[0].SetV(param1);
         this.§!$3§[1].SetV(param2);
         this.§4$+§.x = 0.5 * (param1.x + param2.x);
         this.§4$+§.y = 0.5 * (param1.y + param2.y);
         this.§9"+§[0] = b2Math.§="a§(b2Math.§7q§(param2,param1),1);
         this.§9"+§[0].Normalize();
         this.§9"+§[1].x = -this.§9"+§[0].x;
         this.§9"+§[1].y = -this.§9"+§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§5#]§)
         {
            _loc6_ = (_loc9_ = this.§!$3§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§9"+§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§##N§.x = _loc5_ - b2internal::&"7;
         param1.§##N§.y = _loc6_ - b2internal::&"7;
         param1.§#r§.x = _loc7_ + b2internal::&"7;
         param1.§#r§.y = _loc8_ + b2internal::&"7;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§5#]§ == 2)
         {
            param1.center.x = 0.5 * (this.§!$3§[0].x + this.§!$3§[1].x);
            param1.center.y = 0.5 * (this.§!$3§[0].y + this.§!$3§[1].y);
            param1.§="-§ = 0;
            param1.§&n§ = 0;
            return;
         }
         ...
         var _loc6_:Number = 0;
         var _loc10_:int = 0;
         while(_loc10_ < this.§5#]§)
         {
            _loc11_ = this.§!$3§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§5#]§ ? this.§!$3§[int(_loc10_ + 1)] : this.§!$3§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§6"`§(param3.R,param1);
         ...
         {
            _loc7_[_loc12_] = b2Math.§!"+§(_loc5_,this.§!$3§[_loc12_]) - _loc6_;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§5#]§;
         var _loc14_:int = (_loc10_ + 1) % this.§5#]§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§!$3§[_loc9_].x * (1 - _loc15_) + this.§!$3§[_loc13_].x * _loc15_,this.§!$3§[_loc9_].y * (1 - _loc15_) + this.§!$3§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§!$3§[_loc10_].x * (1 - _loc16_) + this.§!$3§[_loc14_].x * _loc16_,this.§!$3§[_loc10_].y * (1 - _loc16_) + this.§!$3§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§!$3§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§5#]§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§!$3§[_loc12_];
            }
      ...
      public function §8"-§() : Vector.<b2Vec2>
      {
         return this.§9"+§;
      }
      ...
      private function §#o§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            this.§!$3§[_loc2_] = new b2Vec2();
            this.§9"+§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
