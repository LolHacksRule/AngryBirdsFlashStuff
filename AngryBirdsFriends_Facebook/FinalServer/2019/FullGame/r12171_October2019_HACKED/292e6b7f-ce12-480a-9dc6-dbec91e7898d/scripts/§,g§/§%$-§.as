package §,g§
{
   ...
   public class §%$-§
   {
      ...
      private static var §6U§:Array = §3"I§();
      ...
      private static function §3"I§() : Array
      {
         var _loc2_:uint = 0;
         var _loc3_:uint = 0;
         var _loc4_:uint = 0;
      ...
      public static function §&"M§(param1:ByteArray, param2:uint = 0, param3:uint = 0) : uint
      {
         ...
         while(_loc4_ < param3)
         {
            _loc5_ = uint(§6U§[(_loc5_ ^ param1[_loc4_]) & 255]) ^ _loc5_ >>> 8;
            _loc4_++;
         }
         return _loc5_ ^ 4294967295;
      }
      
      public static function § $7§(param1:ByteArray, param2:uint = 0, param3:uint = 0) : uint
      {
         if(param2 >= param1.length)
         {
            param2 = param1.length;
