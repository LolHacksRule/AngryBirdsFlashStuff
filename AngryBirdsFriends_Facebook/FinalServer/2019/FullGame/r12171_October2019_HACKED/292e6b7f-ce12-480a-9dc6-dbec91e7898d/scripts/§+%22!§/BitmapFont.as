package §+"!§
{
   ...
   public class BitmapFont
   {
      ...
      public static const §=#t§:String = "mini";
      
      private static const §>#y§:int = 32;
      
      private static const §4#Z§:int = 9;
      
      private static const §8#J§:int = 10;
      
      private static const §`s§:int = 13;
      ...
      private var §@#y§:Vector.<CharLocation>;
      ...
      public function BitmapFont(param1:Texture = null, param2:XML = null)
      {
         ...
         this.§&$"§ = "unknown";
         this.§;#Z§ = this.§;$9§ = this.§%R§ = 14;
         this.§[!-§ = param1;
         this.§`!H§ = new Dictionary();
         this.§%#s§ = new Image(param1);
         this.§@#y§ = new Vector.<CharLocation>(0);
         if(param2)
         {
            this.§?0§(param2);
         }
      ...
      private function §?0§(param1:XML) : void
      {
         ...
         var _loc3_:Rectangle = this.§[!-§.frame;
         this.§&$"§ = param1.info.attribute("face");
         this.§;$9§ = parseFloat(param1.info.attribute("size")) / _loc2_;
         this.§;#Z§ = parseFloat(param1.common.attribute("lineHeight")) / _loc2_;
         this.§%R§ = parseFloat(param1.common.attribute("base")) / _loc2_;
         if(param1.info.attribute("smooth").toString() == "0")
         {
            this.smoothing = Image.§0#s§;
         }
         if(this.§;$9§ <= 0)
         {
            this.§;$9§ = this.§;$9§ == 0 ? Number(16) : Number(this.§;$9§ * -1);
         }
         for each(_loc4_ in param1.chars.char)
         {
            ...
            _loc11_ = Texture.§;<§(this.§[!-§,_loc10_);
            _loc12_ = new §%!d§(_loc6_,_loc11_,_loc7_,_loc8_,_loc9_);
            this.§-!i§(_loc6_,_loc12_);
         }
         for each(_loc5_ in param1.kernings.kerning)
         {
            ...
            if(_loc14_ in this.§`!H§)
            {
               this.§!#Y§(_loc14_).§0X§(_loc13_,_loc15_);
            }
         }
      }
      
      public function §!#Y§(param1:int) : §%!d§
      {
         return this.§`!H§[param1];
      }
      
      public function §-!i§(param1:int, param2:§%!d§) : void
      {
         this.§`!H§[param1] = param2;
      }
      
      public function §3"D§(param1:Number, param2:Number, param3:String, param4:Number = -1, param5:uint = 16777215, param6:String = "center", param7:String = "center", param8:Boolean = true, param9:Boolean = true) : Sprite
      {
         var _loc14_:CharLocation = null;
         var _loc15_:Image = null;
         var _loc10_:Vector.<CharLocation>;
         var _loc11_:int = (_loc10_ = this.§;! §(param1,param2,param3,param4,param6,param7,param8,param9)).length;
         var _loc12_:Sprite = new Sprite();
         var _loc13_:int = 0;
         while(_loc13_ < _loc11_)
         {
            (_loc15_ = (_loc14_ = _loc10_[_loc13_]).char.§2j§()).x = _loc14_.x;
            _loc15_.y = _loc14_.y;
      ...
      public function §##2§(param1:§^n§, param2:Number, param3:Number, param4:String, param5:Number = -1, param6:uint = 16777215, param7:String = "center", param8:String = "center", param9:Boolean = true, param10:Boolean = true) : void
      {
         var _loc14_:CharLocation = null;
         var _loc11_:Vector.<CharLocation>;
         var _loc12_:int = (_loc11_ = this.§;! §(param2,param3,param4,param5,param7,param8,param9,param10)).length;
         this.§%#s§.color = param6;
         if(_loc12_ > 8192)
         {
         ...
         while(_loc13_ < _loc12_)
         {
            ...
            this.§%#s§.texture = _loc14_.char.texture;
            this.§%#s§.§?!#§();
            this.§%#s§.x = _loc14_.x;
            this.§%#s§.y = _loc14_.y;
            this.§%#s§.scaleX = this.§%#s§.scaleY = _loc14_.scale;
            param1.§5!S§(this.§%#s§);
            _loc13_++;
         }
      }
      
      private function §;! §(param1:Number, param2:Number, param3:String, param4:Number = -1, param5:String = "center", param6:String = "center", param7:Boolean = true, param8:Boolean = true) : Vector.<CharLocation>
      {
         ...
         while(!_loc10_)
         {
            ...
            if(this.§;#Z§ <= _loc14_)
            {
               ...
               while(_loc26_ < _loc12_)
               {
                  ...
                  _loc29_ = this.§!#Y§(_loc28_);
                  if(_loc28_ == §8#J§ || _loc28_ == §`s§)
                  {
                     _loc27_ = true;
                  }
                  else if(_loc29_ != null)
                  {
                     if(_loc28_ == §>#y§ || _loc28_ == §4#Z§)
                     {
                        _loc21_ = _loc26_;
                     }
                     if(param8)
                     {
                        _loc23_ += _loc29_.§]"z§(_loc22_);
                     }
                     (_loc11_ = !!this.§@#y§.length ? this.§@#y§.pop() : new CharLocation(_loc29_)).char = _loc29_;
         ...
         var _loc18_:Number = _loc24_ + this.§;#Z§;
         var _loc19_:int = 0;
         if(param6 == §>#3§.BOTTOM)
         {
            _loc19_ = _loc14_ - _loc18_;
         }
         else if(param6 == §>#3§.CENTER)
         {
...
class CharLocation
{
   ...
   function CharLocation(param1:§%!d§)
   {
      super();
      this.char = param1;
   }
