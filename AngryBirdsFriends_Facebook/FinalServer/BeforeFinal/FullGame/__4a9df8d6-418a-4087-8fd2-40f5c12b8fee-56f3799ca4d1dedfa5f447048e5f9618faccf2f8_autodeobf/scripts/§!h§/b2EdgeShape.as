package §!H§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      b2internal var §0"v§:b2EdgeShape;
      
      b2internal var §5"i§:b2EdgeShape;
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§"#7§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§5%§ = this.§"#7§.Normalize();
         this.§+$8§.Set(this.§"#7§.y,-this.§"#7§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§+$8§.x - this.§"#7§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§+$8§.y - this.§"#7§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§+$8§.x + this.§"#7§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§+$8§.y + this.§"#7§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§+$8§;
         this.m_cornerDir2.Set(-this.§+$8§.x,-this.§+$8§.y);
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§9!0§(param3,this.m_v1);
         var _loc7_:b2Vec2 = b2Math.§9!0§(param3,this.m_v2);
      ...
      public function §9"Y§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
      ...
      b2internal function §3^§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§5"i§ = param1;
