package §,#=§
{
   ...
   public class §=t§
   {
      ...
      public static function §3"@§(param1:Rectangle, param2:Rectangle, param3:Rectangle = null) : Rectangle
      {
         if(param3 == null)
         {
      ...
      public static function §[#L§(param1:Rectangle, param2:Rectangle, param3:String = "showAll", param4:Boolean = false, param5:Rectangle = null) : Rectangle
      {
         if(!§`#y§.§3!v§(param3))
         {
      ...
      private static function §,!8§(param1:Number, param2:Boolean) : Number
      {
         var _loc3_:Number = 1;
         if(param2)
         {
