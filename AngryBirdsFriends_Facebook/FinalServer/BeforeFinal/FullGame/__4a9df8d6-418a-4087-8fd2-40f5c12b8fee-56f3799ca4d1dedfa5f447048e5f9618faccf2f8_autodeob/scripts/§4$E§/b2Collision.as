package §4$E§
{
   ...
   public class b2Collision
   {
      ...
      private static var §=$4§:Vector.<§&#L§> = §@!H§();
      
      private static var s_clipPoints1:Vector.<§&#L§> = §@!H§();
      
      private static var s_clipPoints2:Vector.<§&#L§> = §@!H§();
      
      private static var §-!E§:Vector.<int> = new Vector.<int>(1);
      
      private static var §#"o§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §-"^§(param1:Vector.<§&#L§>, param2:Vector.<§&#L§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§&#L§ = null;
         var _loc6_:int = 0;
      ...
      public static function §@$3§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§39§;
         var _loc7_:Vector.<b2Vec2> = param1.§&!g§;
         var _loc8_:Vector.<b2Vec2> = param1.§9"K§;
         var _loc9_:int = param4.§39§;
         var _loc10_:Vector.<b2Vec2> = param4.§&!g§;
         _loc11_ = param2.R;
      ...
      public static function §"!y§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§39§;
         var _loc7_:Vector.<b2Vec2> = param2.§9"K§;
         _loc9_ = param5.R;
         _loc8_ = param4.§!!h§;
         ...
         var _loc17_:Number = §@$3§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §@$3§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §@$3§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §@$3§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §,#%§(param1:Vector.<§&#L§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§&#L§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§39§;
         var _loc8_:Vector.<b2Vec2> = param2.§9"K§;
         var _loc9_:int = param5.§39§;
         var _loc10_:Vector.<b2Vec2> = param5.§&!g§;
         var _loc11_:Vector.<b2Vec2> = param5.§9"K§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§7!§.§+d§ = param4;
         _loc20_.id.§7!§.§<#B§ = _loc21_;
         _loc20_.id.§7!§.§;$-§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§7!§.§+d§ = param4;
         _loc20_.id.§7!§.§<#B§ = _loc22_;
         _loc20_.id.§7!§.§;$-§ = 1;
      }
      
      private static function §@!H§() : Vector.<§&#L§>
      {
         var _loc1_:Vector.<§&#L§> = new Vector.<§&#L§>(2);
         _loc1_[0] = new §&#L§();
         _loc1_[1] = new §&#L§();
         return _loc1_;
      }
      
      public static function §2$@§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§&#L§ = null;
         ...
         param1.§`!o§ = 0;
         var _loc7_:Number = param2.§5#n§ + param4.§5#n§;
         var _loc8_:int = 0;
         §-!E§[0] = _loc8_;
         var _loc9_:Number = §"!y§(§-!E§,param2,param3,param4,param5);
         _loc8_ = §-!E§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §#"o§[0] = _loc10_;
         var _loc11_:Number = §"!y§(§#"o§,param4,param5,param2,param3);
         _loc10_ = §#"o§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§5"F§ = b2Manifold.§%!^§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§&#L§> = §=$4§;
         §,#%§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§39§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§&!g§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §^$3§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §""Z§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         ...
         var _loc37_:Vector.<§&#L§> = s_clipPoints1;
         var _loc38_:Vector.<§&#L§> = s_clipPoints2;
      ...
      public static function §#!A§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§5#n§ + param4.§5#n§;
         ...
         param1.§&#t§.§1c§();
         param1.§`!o§ = 1;
         param1.§"f§[0].m_localPoint.SetV(param4.§>#>§);
      ...
      public static function §]v§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§5#n§ + param4.§5#n§;
         var _loc21_:int = param2.§39§;
         var _loc22_:Vector.<b2Vec2> = param2.§&!g§;
         var _loc23_:Vector.<b2Vec2> = param2.§9"K§;
         var _loc24_:int = 0;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§`!o§ = 1;
            param1.§5"F§ = b2Manifold.§%!^§;
            param1.§&#t§.x = _loc15_ - _loc27_.x;
            param1.§&#t§.y = _loc16_ - _loc27_.y;
            param1.§&#t§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§`!o§ = 1;
            param1.§5"F§ = b2Manifold.§%!^§;
            param1.§&#t§.x = _loc15_ - _loc28_.x;
            param1.§&#t§.y = _loc16_ - _loc28_.y;
            param1.§&#t§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§"f§[0].m_localPoint.SetV(param4.§>#>§);
            param1.§"f§[0].m_id.key = 0;
      ...
      public static function §9#]§(param1:b2AABB, param2:b2AABB) : Boolean
      {
