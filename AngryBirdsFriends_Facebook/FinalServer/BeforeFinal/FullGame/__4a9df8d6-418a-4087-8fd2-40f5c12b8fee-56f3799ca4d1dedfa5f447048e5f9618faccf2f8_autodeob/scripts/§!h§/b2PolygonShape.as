package §!H§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      b2internal var §&!g§:Vector.<b2Vec2>;
      
      b2internal var §9"K§:Vector.<b2Vec2>;
      
      b2internal var §39§:int;
      ...
      public function b2PolygonShape()
      {
         ...
         §5"F§ = b2internal::?6;
         this.§!!h§ = new b2Vec2();
         this.§&!g§ = new Vector.<b2Vec2>();
         this.§9"K§ = new Vector.<b2Vec2>();
         §5#n§ = b2Settings.b2_polygonRadius;
         this.§!!h§.§1c§();
      }
      
      public static function §#!J§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function §`!K§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§^!;§(param1,param2);
         return _loc3_;
      ...
      public static function §&$;§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         ...
         (_loc5_ = new b2PolygonShape()).§-K§(param1,param2,param3,param4);
         return _loc5_;
      }
      ...
      public static function §+"9§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
      ...
      b2internal static function §5"h§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§]!8§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§]!8§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§!!h§.SetV(_loc2_.§!!h§);
            this.§39§ = _loc2_.§39§;
            this.§-$,§(this.§39§);
            _loc3_ = 0;
            while(_loc3_ < this.§39§)
            {
               this.§&!g§[_loc3_].SetV(_loc2_.§&!g§[_loc3_]);
               this.§9"K§[_loc3_].SetV(_loc2_.§9"K§[_loc3_]);
               _loc3_++;
            }
         }
      }
      ...
      public function §^!;§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§39§)
         {
            this.§&!g§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§39§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§39§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§7!5§(this.§&!g§[_loc5_],this.§&!g§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§?#&§() > Number.MIN_VALUE);
            this.§9"K§[_loc3_].SetV(b2Math.§`!Q§(_loc6_,1));
            this.§9"K§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§!!h§ = §+"9§(this.§&!g§,this.§39§);
      }
      ...
      public function §&#U§(param1:Number, param2:Number) : void
      {
         this.§39§ = 4;
         this.§-$,§(4);
         this.§&!g§[0].Set(-param1,-param2);
         this.§&!g§[1].Set(param1,-param2);
         this.§&!g§[2].Set(param1,param2);
         this.§&!g§[3].Set(-param1,param2);
         this.§9"K§[0].Set(0,-1);
         this.§9"K§[1].Set(1,0);
         this.§9"K§[2].Set(0,1);
         this.§9"K§[3].Set(-1,0);
      ...
      public function §-K§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§39§ = 4;
         this.§-$,§(4);
         this.§&!g§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§39§)
         {
            this.§&!g§[_loc6_] = b2Math.§9!0§(_loc5_,this.§&!g§[_loc6_]);
            this.§9"K§[_loc6_] = b2Math.§4!i§(_loc5_.R,this.§9"K§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §'!<§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§39§ = 2;
         this.§-$,§(2);
         this.§&!g§[0].SetV(param1);
         this.§&!g§[1].SetV(param2);
         this.§!!h§.x = 0.5 * (param1.x + param2.x);
         this.§!!h§.y = 0.5 * (param1.y + param2.y);
         this.§9"K§[0] = b2Math.§`!Q§(b2Math.§7!5§(param2,param1),1);
         this.§9"K§[0].Normalize();
         this.§9"K§[1].x = -this.§9"K§[0].x;
         this.§9"K§[1].y = -this.§9"K§[0].y;
      }
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < this.§39§)
         {
            _loc3_ = this.§&!g§[_loc9_];
            _loc5_ = _loc7_ - _loc3_.x;
            _loc6_ = _loc8_ - _loc3_.y;
            _loc3_ = this.§9"K§[_loc9_];
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§39§)
         {
            _loc6_ = (_loc9_ = this.§&!g§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§9"K§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§@`§.x = _loc5_ - b2internal::5#n;
         param1.§@`§.y = _loc6_ - b2internal::5#n;
         param1.§=!F§.x = _loc7_ + b2internal::5#n;
         param1.§=!F§.y = _loc8_ + b2internal::5#n;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§39§ == 2)
         {
            param1.center.x = 0.5 * (this.§&!g§[0].x + this.§&!g§[1].x);
            param1.center.y = 0.5 * (this.§&!g§[0].y + this.§&!g§[1].y);
            param1.§>#+§ = 0;
            param1.§-$@§ = 0;
            return;
         }
         ...
         var _loc6_:Number = 0;
         var _loc10_:int = 0;
         while(_loc10_ < this.§39§)
         {
            _loc11_ = this.§&!g§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§39§ ? this.§&!g§[int(_loc10_ + 1)] : this.§&!g§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§?"K§(param3.R,param1);
         ...
         {
            _loc7_[_loc12_] = b2Math.§@$+§(_loc5_,this.§&!g§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§9!0§(param3,_loc24_.center));
                  return _loc24_.§>#+§;
               }
               return 0;
               break;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§&!g§[_loc9_].x * (1 - _loc15_) + this.§&!g§[_loc13_].x * _loc15_,this.§&!g§[_loc9_].y * (1 - _loc15_) + this.§&!g§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§&!g§[_loc10_].x * (1 - _loc16_) + this.§&!g§[_loc14_].x * _loc16_,this.§&!g§[_loc10_].y * (1 - _loc16_) + this.§&!g§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§&!g§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§39§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§&!g§[_loc12_];
            }
         ...
         _loc20_.§?$'§(1 / _loc19_);
         param4.SetV(b2Math.§9!0§(param3,_loc20_));
         return _loc19_;
      }
      ...
      private function §-$,§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            this.§&!g§[_loc2_] = new b2Vec2();
            this.§9"K§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
