package §4$E§
{
   ...
   class b2Simplex
   {
      ...
      public var §&!g§:Vector.<b2SimplexVertex>;
      ...
      function b2Simplex()
      {
         ...
         this.§&!g§ = new Vector.<b2SimplexVertex>(3);
         super();
         this.§&!g§[0] = this.m_v1;
         this.§&!g§[1] = this.m_v2;
         this.§&!g§[2] = this.m_v3;
      ...
      public function §1§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         this.§7"C§ = param1.count;
         var _loc8_:Vector.<b2SimplexVertex> = this.§&!g§;
         var _loc9_:int = 0;
         while(_loc9_ < this.§7"C§)
         {
            ...
            _loc10_.§^f§ = b2Math.§9!0§(param3,_loc6_);
            _loc10_.§@F§ = b2Math.§9!0§(param5,_loc7_);
            _loc10_.w = b2Math.§7!5§(_loc10_.§@F§,_loc10_.§^f§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§7"C§ > 1)
         {
            _loc11_ = param1.§5#C§;
            if((_loc12_ = this.§@m§()) < 0.5 * _loc11_ || 2 * _loc11_ < _loc12_ || _loc12_ < Number.MIN_VALUE)
            {
               this.§7"C§ = 0;
            }
         }
      ...
      public function §1"3§(param1:b2SimplexCache) : void
      {
         param1.§5#C§ = this.§@m§();
         param1.count = uint(this.§7"C§);
         var _loc2_:Vector.<b2SimplexVertex> = this.§&!g§;
         var _loc3_:int = 0;
         while(_loc3_ < this.§7"C§)
         {
      ...
      public function §3"M§() : b2Vec2
      {
         ...
         {
            case 1:
               return this.m_v1.w.§ !X§();
            case 2:
               _loc1_ = b2Math.§7!5§(this.m_v2.w,this.m_v1.w);
               _loc2_ = b2Math.§9"D§(_loc1_,this.m_v1.w.§ !X§());
               if(_loc2_ > 0)
               {
                  return b2Math.§4!#§(1,_loc1_);
               }
               return b2Math.§`!Q§(_loc1_,1);
               break;
            default:
      ...
      public function §`'§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§7"C§)
         {
            case 0:
               ...
               break;
            case 1:
               param1.SetV(this.m_v1.§^f§);
               param2.SetV(this.m_v1.§@F§);
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§^f§.x + this.m_v2.a * this.m_v2.§^f§.x;
               param1.y = this.m_v1.a * this.m_v1.§^f§.y + this.m_v2.a * this.m_v2.§^f§.y;
               param2.x = this.m_v1.a * this.m_v1.§@F§.x + this.m_v2.a * this.m_v2.§@F§.x;
               param2.y = this.m_v1.a * this.m_v1.§@F§.y + this.m_v2.a * this.m_v2.§@F§.y;
               break;
            case 3:
               param2.x = param1.x = this.m_v1.a * this.m_v1.§^f§.x + this.m_v2.a * this.m_v2.§^f§.x + this.m_v3.a * this.m_v3.§^f§.x;
               param2.y = param1.y = this.m_v1.a * this.m_v1.§^f§.y + this.m_v2.a * this.m_v2.§^f§.y + this.m_v3.a * this.m_v3.§^f§.y;
               break;
            default:
               b2Settings.b2Assert(false);
         }
      ...
      public function §@m§() : Number
      {
         switch(this.§7"C§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§7!5§(this.m_v1.w,this.m_v2.w).Length();
            case 3:
               return b2Math.§9"D§(b2Math.§7!5§(this.m_v2.w,this.m_v1.w),b2Math.§7!5§(this.m_v3.w,this.m_v1.w));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve2() : void
      {
         ...
         var _loc3_:b2Vec2 = b2Math.§7!5§(_loc2_,_loc1_);
         var _loc4_:Number;
