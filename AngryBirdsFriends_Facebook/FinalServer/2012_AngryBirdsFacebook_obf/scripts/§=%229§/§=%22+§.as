package §="9§
{
   ...
   public class §="+§
   {
      ...
      public static var §8!6§:ByteArray;
      ...
      public static function §%"$§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §7"G§(_loc2_);
         return §<"F§.§+!h§(_loc3_.readInt(),true) + §<"F§.§+!h§(_loc3_.readInt(),true) + §<"F§.§+!h§(_loc3_.readInt(),true) + §<"F§.§+!h§(_loc3_.readInt(),true) + §<"F§.§+!h§(_loc3_.readInt(),true);
      }
      
      public static function §1W§(param1:ByteArray) : String
      {
      ...
      private static function §7"G§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
