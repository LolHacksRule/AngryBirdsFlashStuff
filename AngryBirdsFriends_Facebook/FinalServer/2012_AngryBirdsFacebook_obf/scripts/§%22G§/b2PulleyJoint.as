package §"G§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§>"3§ = b2internal::3"6.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§8!<§.x - this.§>"3§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§8!<§.y - this.§>"3§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§6Y§.x - this.§>"3§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§6Y§.y - this.§>"3§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§!d§);
         this.m_localAnchor2.SetV(param1.§;!9§);
         this.§ ;§ = param1.§'E§;
         this.§5!Y§ = param1.§'!t§ + this.§ ;§ * param1.§%O§;
         this.m_maxLength1 = b2Math.§>!]§(param1.§;!"§,this.§5!Y§ - this.§ ;§ * b2internal::&g);
         this.m_maxLength2 = b2Math.§>!]§(param1.§&!G§,(this.§5!Y§ - b2internal::&g) / this.§ ;§);
         this.§^"8§ = 0;
      ...
      {
         var _loc1_:b2Vec2 = b2internal::3"6.GetWorldPoint(this.m_localAnchor1);
      ...
      {
         var _loc1_:b2Vec2 = b2internal::<X.GetWorldPoint(this.m_localAnchor2);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§5!Y§ - _loc18_ - this.§ ;§ * _loc19_) > 0)
         {
            this.§@"D§ = b2internal::;7;
            this.§^"8§ = 0;
         }
         ...
         this.m_limitMass1 = _loc2_.§6!j§ + _loc2_.§6!$§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§6!j§ + _loc3_.§6!$§ * _loc22_ * _loc22_;
         this.§0l§ = this.m_limitMass1 + this.§ ;§ * this.§ ;§ * this.m_limitMass2;
         ...
         if(param1.§@"9§)
         {
            ...
            _loc25_ = (-this.§ ;§ * this.§^"8§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§ ;§ * this.§^"8§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§,!1§.x += _loc2_.§6!j§ * _loc23_;
            _loc2_.§,!1§.y += _loc2_.§6!j§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§6!$§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§,!1§.x += _loc3_.§6!j§ * _loc25_;
            _loc3_.§,!1§.y += _loc3_.§6!j§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§@"D§ == b2internal::!c)
         {
            ...
            _loc19_ = this.§0l§ * -_loc18_;
            _loc20_ = this.§^"8§;
            this.§^"8§ = b2Math.§4!3§(0,this.§^"8§ + _loc19_);
            ...
            _loc2_.§,!1§.x += _loc2_.§6!j§ * _loc14_;
            _loc2_.§,!1§.y += _loc2_.§6!j§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§6!$§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§,!1§.x += _loc3_.§6!j§ * _loc16_;
            _loc3_.§,!1§.y += _loc3_.§6!j§ * _loc17_;
         ...
         if(this.m_limitState1 == b2internal::!c)
         {
            ...
            this.m_limitImpulse1 = b2Math.§4!3§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == b2internal::!c)
         {
            ...
            this.m_limitImpulse2 = b2Math.§4!3§(0,this.m_limitImpulse2 + _loc19_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§@"D§ == b2internal::!c)
         {
            ...
            _loc19_ = this.§5!Y§ - _loc17_ - this.§ ;§ * _loc18_;
            _loc24_ = b2Math.§4!3§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§&+§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§0l§ * _loc19_) * this.m_u1.x;
            _loc14_ = -_loc20_ * this.m_u1.y;
            _loc15_ = -this.§ ;§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§ ;§ * _loc20_ * this.m_u2.y;
            _loc2_.m_sweep.c.x += _loc2_.§6!j§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§6!j§ * _loc14_;
            _loc2_.m_sweep.a += _loc2_.§6!$§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§6!j§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§6!j§ * _loc16_;
