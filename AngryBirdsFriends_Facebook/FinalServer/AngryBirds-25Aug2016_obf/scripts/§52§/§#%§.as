   ...
   public class §#%§ extends §-!N§
   {
      ...
      public static function §&"y§(param1:Number, param2:Number, param3:int, param4:int, param5:int) : void
      {
         ...
         while(_loc8_ < _loc6_)
         {
            ...
            §>"$§.§3#'§.particles.addSimpleParticle("STAR_PARTICLE",§=$4§.PARTICLE_NAME_BLOCK_DESTRUCTION_PARTICLES,§5"6§.PARTICLE_GROUP_GAME_EFFECTS,§=$4§.PARTICLE_TYPE_KINETIC_PARTICLE,param1,param2,750,"",§=$4§.getParticleMaterialFromEngineMaterial("BIRD_RED"),_loc10_ * Math.cos(_loc9_) * _loc7_,-_loc10_ * Math.sin(_loc9_) * _loc7_,5,_loc10_ * 20,Math.sqrt(_loc7_));
            _loc8_++;
         }
      }
      ...
      override protected function initThemeGraphicsManager() : §,"A§
      {
         ...
         var _loc2_:String = this.§>A§.loaderInfo.parameters.buildNumber || "";
         return new §+$#§(_loc1_,_loc2_,mLevelManager,§3Z§(§#o§));
      }
      ...
      override protected function initThemeSoundsManager() : §,"A§
      {
         var _loc1_:String = §8G§.§%#S§.§^!G§();
         var _loc2_:String = this.§>A§.loaderInfo.parameters.buildNumber || "";
         return new §+$#§(_loc1_,_loc2_,mLevelManager,§3Z§(§#o§),false);
      }
