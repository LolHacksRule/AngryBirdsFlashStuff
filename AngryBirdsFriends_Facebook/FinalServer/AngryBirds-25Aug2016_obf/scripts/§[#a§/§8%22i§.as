package §[#a§
{
   ...
   public class §8"i§ extends §-k§
   {
      ...
      {
         var _loc2_:Number = 3;
         param1.addParticle(§=$4§.§9J§,§5"6§.PARTICLE_GROUP_GAME_EFFECTS,§=$4§.PARTICLE_TYPE_KINETIC_PARTICLE,getBody().GetPosition().x - _loc2_ + Math.random() * (_loc2_ * 2),getBody().GetPosition().y - _loc2_ + Math.random() * (_loc2_ * 2),3500,"",§=$4§.getParticleMaterialFromEngineMaterial(itemName),0,0,1,0,4);
      }
