package §3"q§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §1[§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§6"&§ = §<!#§;
            _loc7_ = this.§##u§.§3"e§(param1.indexA[0]);
            _loc10_ = this.§%#5§.§3"e§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§6"j§.x = _loc15_ - _loc13_;
            this.§6"j§.y = _loc16_ - _loc14_;
            this.§6"j§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§6"&§ = §,#§;
            _loc8_ = this.§##u§.§3"e§(param1.indexA[0]);
            _loc9_ = this.§##u§.§3"e§(param1.indexA[1]);
            _loc10_ = this.§%#5§.§3"e§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§6"j§ = b2Math.§ !Z§(b2Math.§>!6§(_loc9_,_loc8_),1);
            this.§6"j§.Normalize();
            _loc20_ = this.§6"j§;
         ...
         {
            this.§6"&§ = §-!J§;
            _loc11_ = this.§%#5§.§3"e§(param1.indexB[0]);
            _loc12_ = this.§%#5§.§3"e§(param1.indexB[1]);
            _loc7_ = this.§##u§.§3"e§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§6"j§ = b2Math.§ !Z§(b2Math.§>!6§(_loc12_,_loc11_),1);
            this.§6"j§.Normalize();
            _loc20_ = this.§6"j§;
         ...
         else
         {
            ...
            _loc11_ = this.§%#5§.§3"e§(param1.indexB[0]);
            _loc12_ = this.§%#5§.§3"e§(param1.indexB[1]);
            b2Math.§0#O§(param3,_loc7_);
            _loc24_ = b2Math.§@6§(param3.R,b2Math.§>!6§(_loc9_,_loc8_));
            b2Math.§0#O§(param5,_loc10_);
            _loc26_ = b2Math.§@6§(param5.R,b2Math.§>!6§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§>!6§(_loc26_,_loc24_);
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§9#V§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if(Number((_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               Number(0);
               _loc21_ = b2Math.§9#V§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §<!#§:
               _loc3_ = b2Math.§'h§(param1.R,this.§6"j§);
               _loc4_ = b2Math.§'h§(param2.R,this.§6"j§.§6#5§());
               _loc5_ = this.§##u§.§[!t§(_loc3_);
               _loc6_ = this.§%#5§.§[!t§(_loc4_);
               _loc7_ = b2Math.§0#O§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§0#O§(param2,_loc6_)).x - _loc7_.x) * this.§6"j§.x + (_loc8_.y - _loc7_.y) * this.§6"j§.y);
            case §,#§:
               _loc10_ = b2Math.§@6§(param1.R,this.§6"j§);
               _loc7_ = b2Math.§0#O§(param1,this.m_localPoint);
               _loc4_ = b2Math.§'h§(param2.R,_loc10_.§6#5§());
               _loc6_ = this.§%#5§.§[!t§(_loc4_);
               return Number(((_loc8_ = b2Math.§0#O§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §-!J§:
               _loc10_ = b2Math.§@6§(param2.R,this.§6"j§);
               _loc8_ = b2Math.§0#O§(param2,this.m_localPoint);
               _loc3_ = b2Math.§'h§(param1.R,_loc10_.§6#5§());
               _loc5_ = this.§##u§.§[!t§(_loc3_);
               return Number(((_loc7_ = b2Math.§0#O§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
