package §?"R§
{
   ...
   public class QuickPurchasePopup extends AbstractPopup implements §@#@§, § 1§, §@J§
   {
      ...
      override protected function show(param1:Boolean = false) : void
      {
         ...
         var _loc3_:String = this.§""Q§.currencyID == ("IVC" || §=]§.§;Q§) ? _loc2_.toString() : (AngryBirdsBase.singleton.dataModel as §+3§).currencyModel.getPriceTag(_loc2_,true,"",this.§""Q§.currencyID);
         ...
         this.§#!r§ = this.§""Q§.currencyID == ("IVC" || §=]§.§;Q§);
      ...
      {
         var _loc3_:§%"K§ = null;
         var _loc2_:* = this.§""Q§.currencyID == ("IVC" || §=]§.§;Q§);
         this.§]j§(false);
         if(_loc2_)
         {
