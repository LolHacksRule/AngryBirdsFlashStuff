package §7$?§
{
   ...
   public class §7"T§
   {
      ...
      public static function §=!m§(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number) : §,"6§
      {
         ...
         var _loc19_:§,"6§;
         (_loc19_ = new §,"6§()).§9J§ = Math.sqrt(_loc16_);
         _loc19_.§4E§ = _loc18_;
         return _loc19_;
      }
