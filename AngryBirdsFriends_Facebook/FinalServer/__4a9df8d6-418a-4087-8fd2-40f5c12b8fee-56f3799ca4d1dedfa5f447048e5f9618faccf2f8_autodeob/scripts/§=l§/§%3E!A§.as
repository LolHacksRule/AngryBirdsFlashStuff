package §=l§
{
   ...
   public class §>!A§
   {
      ...
      {
         super();
         this.jsonString = this.§59§(param1);
      }
      ...
      private function §59§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§8"-§(param1 as String);
         }
         if(param1 is Number)
         {
      ...
      private function §8"-§(param1:String) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§8"-§(v.@name.toString()) + ":" + this.§59§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
