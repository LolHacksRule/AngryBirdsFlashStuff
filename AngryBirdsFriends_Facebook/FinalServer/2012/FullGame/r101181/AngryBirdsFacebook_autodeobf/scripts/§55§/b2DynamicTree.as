   ...
   public class b2DynamicTree
   {
      ...
      public function §]!N§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            ...
            {
               _loc3_ = !!(this.§7!b§ >> _loc4_ & 1) ? _loc3_.child2 : _loc3_.child1;
               _loc4_ = _loc4_ + 1 & 31;
            }
            ++this.§7!b§;
            this.§91§(_loc3_);
      ...
      private function §2!,§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_.§+F§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§!8§.x + _loc6_.aabb.§,f§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§!8§.y + _loc6_.aabb.§,f§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§!8§.x + _loc7_.aabb.§,f§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§!8§.y + _loc7_.aabb.§,f§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
