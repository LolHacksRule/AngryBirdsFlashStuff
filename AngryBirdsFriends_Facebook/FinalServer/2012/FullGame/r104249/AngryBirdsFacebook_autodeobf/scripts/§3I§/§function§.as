package §3I§
{
   ...
   public class §function§
   {
      ...
      public function §function§(param1:*)
      {
         super();
         this.jsonString = this.§%!#§(param1);
      }
      ...
      private function §%!#§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§%!_§(param1 as String);
         }
         if(param1 is Number)
         {
         ...
         if(param1 is Array)
         {
            return this.§;g§(param1 as Array);
         }
         if(param1 is Object && param1 != null)
         {
            return this.§8!j§(param1);
         }
         return "null";
      }
      
      private function §%!_§(param1:String) : String
      {
      ...
      private function §;g§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
      ...
      private function §8!j§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§%!_§(v.@name.toString()) + ":" + this.§%!#§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
