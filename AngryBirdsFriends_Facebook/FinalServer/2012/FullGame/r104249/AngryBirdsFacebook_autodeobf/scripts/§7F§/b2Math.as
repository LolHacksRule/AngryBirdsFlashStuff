package §7F§
{
   public class b2Math
   {
      ...
      public static function §2!8§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return new b2Vec2(§"V§(param2,param1.col1),§"V§(param2,param1.col2));
      }
      
      public static function §]D§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         _loc3_ = §2!8§(param1.R,param2);
         _loc3_.x += param1.position.x;
         _loc3_.y += param1.position.y;
         return _loc3_;
      }
      
      public static function §,a§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         var _loc4_:Number = NaN;
         _loc3_ = §5x§(param2,param1.position);
      ...
      public static function §5x§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1.x - param2.x,param1.y - param2.y);
      }
      ...
      public static function §0!k§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         var _loc3_:Number = param1.x - param2.x;
         var _loc4_:Number = param1.y - param2.y;
      ...
      {
         return b2Mat22.§3!`§(§'O§(param1.col1,param2.col1),§'O§(param1.col2,param2.col2));
      }
      
      public static function §1T§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§3!`§(§2!8§(param1,param2.col1),§2!8§(param1,param2.col2));
      }
      
      public static function §?!U§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§"V§(param1.col1,param2.col1),§"V§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§"V§(param1.col1,param2.col2),§"V§(param1.col2,param2.col2));
         return b2Mat22.§3!`§(_loc3_,_loc4_);
      }
      
      public static function §?h§(param1:Number) : Number
      {
         return param1 > 0 ? Number(param1) : Number(-param1);
      }
      
      public static function §'0§(param1:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§?h§(param1.x),§?h§(param1.y));
      }
      
      public static function §44§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§3!`§(§'0§(param1.col1),§'0§(param1.col2));
      }
      ...
      public static function §2s§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§>!]§(param1.x,param2.x),§>!]§(param1.y,param2.y));
      }
      
      public static function §4!3§(param1:Number, param2:Number) : Number
      {
         return param1 > param2 ? Number(param1) : Number(param2);
      }
      ...
      {
         return new b2Vec2(§4!3§(param1.x,param2.x),§4!3§(param1.y,param2.y));
      }
      ...
      public static function §,g§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §,&§(param2,§2s§(param1,param3));
      }
      ...
      public static function §8Z§() : Number
      {
