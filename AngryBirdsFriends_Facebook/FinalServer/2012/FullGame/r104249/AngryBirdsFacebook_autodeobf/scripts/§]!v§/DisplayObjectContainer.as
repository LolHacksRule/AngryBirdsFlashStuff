package §]!v§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function §5!N§(param1:DisplayObject) : void
      {
         var _loc2_:int = this.§<!t§.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            if(param1.z < this.§<!t§[_loc3_].z)
            {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            ...
            §["+§(_loc7_,§"5§);
            transformCoords(§"5§,_loc3_,_loc4_,§!'§);
      ...
      public function §4!J§(param1:Event) : void
      {
         if(param1.bubbles)
         {
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§#_§(this,param1.type,_loc2_);
      ...
      private function §#_§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               this.§#_§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
