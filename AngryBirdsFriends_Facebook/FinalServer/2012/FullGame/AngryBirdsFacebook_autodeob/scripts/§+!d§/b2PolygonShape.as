package §+!d§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §&I§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §>!s§:b2Vec2;
      
      b2internal var §?z§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         §6N§ = b2internal::-c;
         this.§>!s§ = new b2Vec2();
         this.§?z§ = new Vector.<b2Vec2>();
         this.§^!4§ = new Vector.<b2Vec2>();
         §,0§ = b2Settings.b2_polygonRadius;
         this.§>!s§.§%"0§();
      }
      
      public static function §'!O§(param1:Array, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§5!Z§(param1,param2);
         return _loc3_;
      }
      
      public static function §22§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §3"$§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§5w§(param1,param2);
         return _loc3_;
      }
      
      public static function §'q§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§"S§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §9F§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      b2internal static function §9!N§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            while(_loc3_ < this.§@!N§)
            {
               this.§?z§[_loc3_].SetV(_loc2_.§?z§[_loc3_]);
      ...
      public function §5!Z§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function §<"I§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§@!N§)
         {
            this.§?z§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§@!N§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§@!N§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§5x§(this.§?z§[_loc5_],this.§?z§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§>C§() > Number.MIN_VALUE);
            this.§^!4§[_loc3_].SetV(b2Math.§[n§(_loc6_,1));
            this.§^!4§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§>!s§ = §#!b§(this.§?z§,this.§@!N§);
      }
      ...
      public function §5w§(param1:Number, param2:Number) : void
      {
         this.§@!N§ = 4;
         this.§8t§(4);
         this.§?z§[0].Set(-param1,-param2);
         this.§?z§[1].Set(param1,-param2);
         this.§?z§[2].Set(param1,param2);
         this.§?z§[3].Set(-param1,param2);
         this.§^!4§[0].Set(0,-1);
         this.§^!4§[1].Set(1,0);
         this.§^!4§[2].Set(0,1);
         this.§^!4§[3].Set(-1,0);
      ...
      public function §"S§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§@!N§ = 4;
         this.§8t§(4);
         this.§?z§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§@!N§)
         {
            this.§?z§[_loc6_] = b2Math.§]D§(_loc5_,this.§?z§[_loc6_]);
            this.§^!4§[_loc6_] = b2Math.§2!8§(_loc5_.R,this.§^!4§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §%!1§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§@!N§ = 2;
         this.§8t§(2);
         this.§?z§[0].SetV(param1);
         this.§?z§[1].SetV(param2);
         this.§>!s§.x = 0.5 * (param1.x + param2.x);
         this.§>!s§.y = 0.5 * (param1.y + param2.y);
         this.§^!4§[0] = b2Math.§[n§(b2Math.§5x§(param2,param1),1);
         this.§^!4§[0].Normalize();
         this.§^!4§[1].x = -this.§^!4§[0].x;
         this.§^!4§[1].y = -this.§^!4§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§@!N§)
         {
            _loc6_ = (_loc9_ = this.§?z§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§^!4§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§ !K§.x = _loc5_ - b2internal::,0;
         param1.§ !K§.y = _loc6_ - b2internal::,0;
         param1.§5!j§.x = _loc7_ + b2internal::,0;
         param1.§5!j§.y = _loc8_ + b2internal::,0;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§@!N§ == 2)
         {
            param1.center.x = 0.5 * (this.§?z§[0].x + this.§?z§[1].x);
            param1.center.y = 0.5 * (this.§?z§[0].y + this.§?z§[1].y);
            param1.§>!;§ = 0;
            param1.§="?§ = 0;
            return;
         }
         ...
         var _loc6_:Number = 0;
         var _loc10_:int = 0;
         while(_loc10_ < this.§@!N§)
         {
            _loc11_ = this.§?z§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§@!N§ ? this.§?z§[int(_loc10_ + 1)] : this.§?z§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§>!J§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§"V§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§"V§(_loc5_,this.§?z§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§]D§(param3,_loc24_.center));
                  return _loc24_.§>!;§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§@!N§;
         var _loc14_:int = (_loc10_ + 1) % this.§@!N§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§?z§[_loc9_].x * (1 - _loc15_) + this.§?z§[_loc13_].x * _loc15_,this.§?z§[_loc9_].y * (1 - _loc15_) + this.§?z§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§?z§[_loc10_].x * (1 - _loc16_) + this.§?z§[_loc14_].x * _loc16_,this.§?z§[_loc10_].y * (1 - _loc16_) + this.§?z§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§?z§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§@!N§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§?z§[_loc12_];
            }
         ...
         _loc20_.§ !>§(1 / _loc19_);
         param4.SetV(b2Math.§]D§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §<!k§() : Vector.<b2Vec2>
      {
         return this.§^!4§;
      }
