package § !0§
{
   ...
   public class b2Collision
   {
      ...
      private static var §'"F§:Vector.<§"=§> = §4!q§();
      
      private static var s_clipPoints1:Vector.<§"=§> = §4!q§();
      
      private static var s_clipPoints2:Vector.<§"=§> = §4!q§();
      
      private static var §'" §:Vector.<int> = new Vector.<int>(1);
      
      private static var §'"2§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §`+§(param1:Vector.<§"=§>, param2:Vector.<§"=§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§"=§ = null;
         var _loc6_:int = 0;
      ...
      public static function §6"0§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§@!N§;
         var _loc7_:Vector.<b2Vec2> = param1.§?z§;
         var _loc8_:Vector.<b2Vec2> = param1.§^!4§;
         var _loc9_:int = param4.§@!N§;
         var _loc10_:Vector.<b2Vec2> = param4.§?z§;
         _loc11_ = param2.R;
      ...
      public static function §`"-§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param2.§^!4§;
         _loc9_ = param5.R;
         _loc8_ = param4.§>!s§;
         ...
         var _loc17_:Number = §6"0§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §6"0§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §6"0§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §6"0§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §7!k§(param1:Vector.<§"=§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param2.§^!4§;
         var _loc9_:int = param5.§@!N§;
         var _loc10_:Vector.<b2Vec2> = param5.§?z§;
         var _loc11_:Vector.<b2Vec2> = param5.§^!4§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§0!5§.§2r§ = param4;
         _loc20_.id.§0!5§.§]v§ = _loc21_;
         _loc20_.id.§0!5§.§2!4§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§0!5§.§2r§ = param4;
         _loc20_.id.§0!5§.§]v§ = _loc22_;
         _loc20_.id.§0!5§.§2!4§ = 1;
      }
      
      private static function §4!q§() : Vector.<§"=§>
      {
      ...
      public static function §%!O§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§"=§ = null;
         ...
         param1.§<"5§ = 0;
         var _loc7_:Number = param2.§,0§ + param4.§,0§;
         var _loc8_:int = 0;
         §'" §[0] = _loc8_;
         ...
         var _loc10_:int = 0;
         §'"2§[0] = _loc10_;
         var _loc11_:Number = §`"-§(§'"2§,param4,param5,param2,param3);
         _loc10_ = §'"2§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§6N§ = b2Manifold.§=F§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§"=§> = §'"F§;
         §7!k§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§@!N§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§?z§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §^!c§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §,!3§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §>!R§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §+!q§;
         _loc20_ = _loc14_.R;
         ...
         if((_loc39_ = §`+§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §`+§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§^Y§.SetV(_loc27_);
      ...
      public static function §4"1§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§,0§ + param4.§,0§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§6N§ = b2Manifold.§>O§;
         param1.m_localPoint.SetV(param2.§3!R§);
         param1.§^Y§.§%"0§();
         param1.§<"5§ = 1;
         param1.§%&§[0].m_localPoint.SetV(param4.§3!R§);
         param1.§%&§[0].m_id.key = 0;
      }
      
      public static function §"!G§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§,0§ + param4.§,0§;
         var _loc21_:int = param2.§@!N§;
         var _loc22_:Vector.<b2Vec2> = param2.§?z§;
         var _loc23_:Vector.<b2Vec2> = param2.§^!4§;
         var _loc24_:int = 0;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§<"5§ = 1;
            param1.§6N§ = b2Manifold.§=F§;
            param1.§^Y§.x = _loc15_ - _loc27_.x;
            param1.§^Y§.y = _loc16_ - _loc27_.y;
            param1.§^Y§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§<"5§ = 1;
            param1.§6N§ = b2Manifold.§=F§;
            param1.§^Y§.x = _loc15_ - _loc28_.x;
            param1.§^Y§.y = _loc16_ - _loc28_.y;
            param1.§^Y§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§%&§[0].m_localPoint.SetV(param4.§3!R§);
            param1.§%&§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§<"5§ = 1;
            param1.§6N§ = b2Manifold.§=F§;
            param1.§^Y§.x = _loc23_[_loc25_].x;
            param1.§^Y§.y = _loc23_[_loc25_].y;
            param1.§^Y§.Normalize();
      ...
      {
         var _loc3_:b2Vec2 = param2.§ !K§;
         var _loc4_:b2Vec2 = param1.§5!j§;
