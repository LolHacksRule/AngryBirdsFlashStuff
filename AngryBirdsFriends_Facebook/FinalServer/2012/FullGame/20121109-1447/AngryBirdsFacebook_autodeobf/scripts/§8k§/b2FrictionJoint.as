package §8k§
{
   ...
   public class b2FrictionJoint extends b2Joint
   {
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc18_ = param1.§4"?§ * this.§?<§;
         this.§+`§ = b2Math.§<O§(this.§+`§ + _loc20_,-_loc18_,_loc18_);
         _loc20_ = this.§+`§ - _loc21_;
         _loc7_ -= _loc12_ * _loc20_;
         _loc9_ += _loc13_ * _loc20_;
         var _loc22_:Number = _loc8_.x - _loc9_ * _loc17_ - _loc6_.x + _loc7_ * _loc15_;
         var _loc23_:Number = _loc8_.y + _loc9_ * _loc16_ - _loc6_.y - _loc7_ * _loc14_;
         var _loc24_:b2Vec2 = b2Math.§?"1§(this.§<"D§,new b2Vec2(-_loc22_,-_loc23_));
         var _loc25_:b2Vec2 = this.§@!2§.Copy();
         this.§@!2§.§&3§(_loc24_);
         _loc18_ = param1.§4"?§ * this.§6!_§;
         if(this.§@!2§.§`p§() > _loc18_ * _loc18_)
         {
            this.§@!2§.Normalize();
            this.§@!2§.§8`§(_loc18_);
         }
         _loc24_ = b2Math.§0!1§(this.§@!2§,_loc25_);
