package §<!`§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§+!@§ = this.§4!$§.Normalize();
         this.§9+§.Set(this.§4!$§.y,-this.§4!$§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§9+§.x - this.§4!$§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§9+§.y - this.§4!$§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§9+§.x + this.§4!$§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§9+§.y + this.§4!$§.y) + this.m_v2.y);
