package §<!`§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc4_:Number = param1.position.x + (_loc3_.col1.x * this.§ m§.x + _loc3_.col2.x * this.§ m§.y);
         var _loc5_:Number = param1.position.y + (_loc3_.col1.y * this.§ m§.x + _loc3_.col2.y * this.§ m§.y);
         _loc4_ = param2.x - _loc4_;
         _loc5_ = param2.y - _loc5_;
         return _loc4_ * _loc4_ + _loc5_ * _loc5_ <= b2internal::%I * b2internal::%I;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc5_:Number = param3.position.x + (_loc4_.col1.x * this.§ m§.x + _loc4_.col2.x * this.§ m§.y);
         var _loc6_:Number = param3.position.y + (_loc4_.col1.y * this.§ m§.x + _loc4_.col2.y * this.§ m§.y);
         var _loc7_:Number = param2.p1.x - _loc5_;
         _loc8_ = param2.p1.y - _loc6_;
         var _loc9_:Number = _loc7_ * _loc7_ + _loc8_ * _loc8_ - b2internal::%I * b2internal::%I;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         var _loc4_:Number = param2.position.x + (_loc3_.col1.x * this.§ m§.x + _loc3_.col2.x * this.§ m§.y);
         var _loc5_:Number = param2.position.y + (_loc3_.col1.y * this.§ m§.x + _loc3_.col2.y * this.§ m§.y);
         param1.§!8§.Set(_loc4_ - b2internal::%I,_loc5_ - b2internal::%I);
         param1.§,f§.Set(_loc4_ + b2internal::%I,_loc5_ + b2internal::%I);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§7!^§ = param2 * b2Settings.b2_pi * b2internal::%I * b2internal::%I;
         param1.center.SetV(this.§ m§);
         param1.§^s§ = param1.§7!^§ * (0.5 * b2internal::%I * b2internal::%I + (this.§ m§.x * this.§ m§.x + this.§ m§.y * this.§ m§.y));
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.§+'§(param1,_loc5_) - param2)) < -b2internal::%I + Number.MIN_VALUE)
         {
            return 0;
         }
         if(_loc6_ > b2internal::%I)
         {
            param4.SetV(_loc5_);
            return Math.PI * b2internal::%I * b2internal::%I;
         }
         var _loc7_:Number = b2internal::%I * b2internal::%I;
         var _loc8_:Number = _loc6_ * _loc6_;
         _loc9_ = _loc7_ * (Math.asin(_loc6_ / b2internal::%I) + Math.PI / 2) + _loc6_ * Math.sqrt(_loc7_ - _loc8_);
