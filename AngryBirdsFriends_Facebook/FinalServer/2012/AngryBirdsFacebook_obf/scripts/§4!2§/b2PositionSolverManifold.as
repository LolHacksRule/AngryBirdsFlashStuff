package §4!2§
{
   ...
   class b2PositionSolverManifold
   {
      ...
      private static var §7!6§:b2Vec2 = new b2Vec2();
      ...
      public function §,!9§(param1:b2ContactConstraint) : void
      {
         ...
         switch(param1.type)
         {
            case b2Manifold.§>O§:
               ...
               _loc9_ = param1.§4"?§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc10_ = param1.§4"?§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               _loc5_ = param1.§+H§.m_xf.R;
               _loc6_ = param1.§0!R§[0].localPoint;
               ...
               this.§,_§[0] = _loc13_ * this.§="-§.x + _loc14_ * this.§="-§.y - param1.radius;
               break;
            case b2Manifold.§=F§:
               _loc5_ = param1.§4"?§.m_xf.R;
               _loc6_ = param1.§#8§;
               ...
               {
                  _loc6_ = param1.§0!R§[_loc2_].localPoint;
                  ...
                  this.§,_§[_loc2_] = (_loc3_ - _loc7_) * this.§="-§.x + (_loc4_ - _loc8_) * this.§="-§.y - param1.radius;
