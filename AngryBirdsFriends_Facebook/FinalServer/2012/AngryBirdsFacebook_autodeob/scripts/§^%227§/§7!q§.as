package §^"7§
{
   ...
   public class §7!q§ extends §]V§
   {
       
      
      public function §7!q§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§5"B§(param1,param2);
      }
      
      protected function §5"B§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§%'§(_loc7_,_loc6_)]) == null)
            {
               ...
               {
                  _loc10_ = new §5!8§(0,0,_loc11_,_loc12_,_loc13_,_loc14_);
               }
            }
            if(_loc10_)
            {
               ...
               _loc16_.§--§ = _loc15_;
               _loc16_.§1m§ = _loc10_.pivotX;
               _loc16_.§;!Q§ = _loc10_.pivotY;
               _loc16_.§&=§ = §<!q§;
               §%!p§(_loc16_);
            }
         }
         ...
         for each(_loc3_ in param1)
         {
            ...
            for each(_loc6_ in _loc5_)
            {
               ...
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §5!8§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
