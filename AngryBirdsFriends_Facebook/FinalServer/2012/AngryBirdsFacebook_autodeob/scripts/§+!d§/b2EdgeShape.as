package §+!d§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§,!O§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§9-§ = this.§,!O§.Normalize();
         this.§="-§.Set(this.§,!O§.y,-this.§,!O§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§="-§.x - this.§,!O§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§="-§.y - this.§,!O§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§="-§.x + this.§,!O§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§="-§.y + this.§,!O§.y) + this.m_v2.y);
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§]D§(param3,this.m_v1);
         var _loc7_:b2Vec2 = b2Math.§]D§(param3,this.m_v2);
         var _loc8_:Number = b2Math.§"V§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§"V§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §%"J§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
