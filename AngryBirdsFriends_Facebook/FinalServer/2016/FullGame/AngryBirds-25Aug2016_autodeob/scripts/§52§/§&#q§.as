   ...
   public class §&#q§ extends §@M§
   {
      ...
      public function §]M§() : Boolean
      {
         ...
         while(_loc6_ < _loc3_)
         {
            ...
            §#""§.particles.addParticle(§=$4§.§9J§,§5"6§.PARTICLE_GROUP_GAME_EFFECTS,§=$4§.PARTICLE_TYPE_KINETIC_PARTICLE,§+!5§,§'! §,1250,"",§=$4§.getParticleMaterialFromEngineMaterial("BIRD_RED"),_loc12_ * Math.cos(_loc11_) * 1,-_loc12_ * Math.sin(_loc11_) * 1,5,_loc12_ * 20,Math.sqrt(1));
            _loc6_++;
         }
         var _loc7_:§1!X§ = null;
         if(mBirds.length > 0)
      ...
      private function §#$1§(param1:String, param2:String, param3:int) : void
      {
         ...
         var _loc8_:Number = §+!5§ / §#!,§.§?$#§ + _loc6_ / 2 + -15;
         var _loc9_:Number = §'! § / §#!,§.§?$#§ + _loc7_ + -13;
         if(!this.§%#4§)
         {
            this.§%#4§ = new Vector.<§&#^§>();
         }
