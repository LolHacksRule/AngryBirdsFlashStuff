package §?!c§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §set §:b2Mat22 = new b2Mat22();
       
      
      b2internal var §"#N§:b2Vec2;
      
      b2internal var §[#k§:Vector.<b2Vec2>;
      
      b2internal var §5#1§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         §6"&§ = b2internal::0#N;
         this.§"#N§ = new b2Vec2();
         this.§[#k§ = new Vector.<b2Vec2>();
         this.§5#1§ = new Vector.<b2Vec2>();
         §0#I§ = b2Settings.b2_polygonRadius;
         this.§"#N§.§,[§();
      }
      
      public static function §0#a§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function §="v§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§4"M§(param1,param2);
         return _loc3_;
      }
      
      public static function §<"E§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §;$6§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§7"F§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §@$4§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §3g§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            {
               this.§[#k§[_loc3_].SetV(_loc2_.§[#k§[_loc3_]);
               this.§5#1§[_loc3_].SetV(_loc2_.§5#1§[_loc3_]);
               _loc3_++;
            }
         }
      }
      ...
      public function §=!#§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§4"M§(_loc3_,param2);
      }
      
      public function §4"M§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§3!O§)
         {
            this.§[#k§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§3!O§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§3!O§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§>!6§(this.§[#k§[_loc5_],this.§[#k§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§>#%§() > Number.MIN_VALUE);
            this.§5#1§[_loc3_].SetV(b2Math.§ !Z§(_loc6_,1));
            this.§5#1§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§"#N§ = §3g§(this.§[#k§,this.§3!O§);
      }
      ...
      public function § #7§(param1:Number, param2:Number) : void
      {
         this.§3!O§ = 4;
         this.§7!t§(4);
         this.§[#k§[0].Set(-param1,-param2);
         this.§[#k§[1].Set(param1,-param2);
         this.§[#k§[2].Set(param1,param2);
         this.§[#k§[3].Set(-param1,param2);
         this.§5#1§[0].Set(0,-1);
         this.§5#1§[1].Set(1,0);
         this.§5#1§[2].Set(0,1);
         this.§5#1§[3].Set(-1,0);
      ...
      public function §7"F§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§3!O§ = 4;
         this.§7!t§(4);
         this.§[#k§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§3!O§)
         {
            this.§[#k§[_loc6_] = b2Math.§0#O§(_loc5_,this.§[#k§[_loc6_]);
            this.§5#1§[_loc6_] = b2Math.§@6§(_loc5_.R,this.§5#1§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §>b§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§3!O§ = 2;
         this.§7!t§(2);
         this.§[#k§[0].SetV(param1);
         this.§[#k§[1].SetV(param2);
         this.§"#N§.x = 0.5 * (param1.x + param2.x);
         this.§"#N§.y = 0.5 * (param1.y + param2.y);
         this.§5#1§[0] = b2Math.§ !Z§(b2Math.§>!6§(param2,param1),1);
         this.§5#1§[0].Normalize();
         this.§5#1§[1].x = -this.§5#1§[0].x;
         this.§5#1§[1].y = -this.§5#1§[0].y;
      }
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < this.§3!O§)
         {
            _loc3_ = this.§[#k§[_loc9_];
            _loc5_ = _loc7_ - _loc3_.x;
            _loc6_ = _loc8_ - _loc3_.y;
            _loc3_ = this.§5#1§[_loc9_];
            if(Number(_loc3_.x * _loc5_ + _loc3_.y * _loc6_) > 0)
            {
               return false;
            }
            _loc9_++;
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§3!O§)
         {
            _loc6_ = (_loc9_ = this.§[#k§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§5#1§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§6G§.x = _loc5_ - b2internal::0#I;
         param1.§6G§.y = _loc6_ - b2internal::0#I;
         param1.§%G§.x = _loc7_ + b2internal::0#I;
         param1.§%G§.y = _loc8_ + b2internal::0#I;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§3!O§ == 2)
         {
            param1.center.x = 0.5 * (this.§[#k§[0].x + this.§[#k§[1].x);
            param1.center.y = 0.5 * (this.§[#k§[0].y + this.§[#k§[1].y);
            param1.§4!-§ = 0;
            param1.§1<§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§3!O§)
         {
            _loc11_ = this.§[#k§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§3!O§ ? this.§[#k§[int(_loc10_ + 1)] : this.§[#k§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§4!-§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§1<§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§'h§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§&#3§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§3!O§)
         {
            _loc7_[_loc12_] = b2Math.§&#3§(_loc5_,this.§[#k§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§0#O§(param3,_loc24_.center));
                  return _loc24_.§4!-§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§3!O§;
         var _loc14_:int = (_loc10_ + 1) % this.§3!O§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§[#k§[_loc9_].x * (1 - _loc15_) + this.§[#k§[_loc13_].x * _loc15_,this.§[#k§[_loc9_].y * (1 - _loc15_) + this.§[#k§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§[#k§[_loc10_].x * (1 - _loc16_) + this.§[#k§[_loc14_].x * _loc16_,this.§[#k§[_loc10_].y * (1 - _loc16_) + this.§[#k§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§[#k§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§3!O§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§[#k§[_loc12_];
            }
         ...
         _loc20_.§2#<§(1 / _loc19_);
         param4.SetV(b2Math.§0#O§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §+"M§() : Vector.<b2Vec2>
      {
         return this.§5#1§;
      }
      
      public function §^!T§(param1:b2Vec2) : int
      {
         var _loc5_:Number = NaN;
         var _loc2_:int = 0;
         var _loc3_:Number = this.§[#k§[0].x * param1.x + this.§[#k§[0].y * param1.y;
         var _loc4_:int = 1;
         while(_loc4_ < this.§3!O§)
         {
      ...
      private function §7!t§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            this.§[#k§[_loc2_] = new b2Vec2();
            this.§5#1§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
