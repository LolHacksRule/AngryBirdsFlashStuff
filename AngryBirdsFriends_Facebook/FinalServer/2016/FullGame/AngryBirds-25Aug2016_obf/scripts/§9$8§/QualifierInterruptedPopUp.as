   ...
   public class QualifierInterruptedPopUp extends AbstractPopup
   {
      ...
      private function § !P§() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            _loc3_.visible = _loc4_.visible = false;
            _loc2_++;
         }
         this.§## §();
         this.§<"O§();
      ...
      private function §@!>§() : void
      {
         ...
         this.§1"l§.scaleX = this.§1"l§.scaleY = 0;
         rankUpTween.play();
      ...
      private function §<"O§() : void
      {
         ...
         if(§^!5§ != null)
         {
            ...
            while(_loc4_ < _loc1_)
            {
               ...
               _loc8_.scaleX = _loc8_.scaleY = 1.1;
               _loc8_.x += 3;
               _loc8_.y += 3;
