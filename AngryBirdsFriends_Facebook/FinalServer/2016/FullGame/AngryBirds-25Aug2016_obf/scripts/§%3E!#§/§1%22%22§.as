package §>!#§
{
   ...
   public class §1""§
   {
      ...
      public static function §]!e§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         jsonString = §57§(luaString,emptyObjectAsArray);
         try
         {
      ...
      public static function §57§(param1:String, param2:Boolean = false) : String
      {
         ...
         return §3"M§(param1,param2);
      }
      
      private static function §3"M§(param1:String, param2:Boolean) : String
      {
         ...
         var _loc14_:int = 0;
         var _loc15_:int;
         var _loc16_:int = _loc15_ = param1.indexOf(_loc3_);
         ...
         while(_loc15_ >= 0 || _loc17_ >= 0)
         {
            ...
            else
            {
               ...
               _loc19_ = false;
               if(_loc18_.indexOf(_loc3_,1) < 0)
               {
                  if(_loc18_.indexOf(_loc7_,1) < 0)
                  {
               ...
               else if((_loc24_ = _loc18_.indexOf(_loc7_,1)) < 0)
               {
                  _loc19_ = true;
               }
               else if((_loc25_ = _loc18_.indexOf(_loc3_,1)) > 0 && _loc24_ > _loc25_)
               {
                  _loc19_ = true;
               }
               if(_loc19_)
               ...
               _loc17_ = param1.indexOf(_loc4_,_loc17_ + 1);
            }
            _loc15_ = param1.indexOf(_loc3_,_loc16_ + 1);
         }
         _loc14_ = 0;
         while(_loc14_ < _loc10_.length)
         {
            ...
            param1 = _loc26_ + _loc5_ + _loc27_ + _loc6_ + _loc28_;
            _loc14_++;
         }
         ...
         while(_loc14_ >= 0)
         {
            ...
            param1 = _loc29_ + _loc4_ + _loc30_;
            _loc29_ = param1.substring(0,_loc15_);
            _loc30_ = param1.substring(_loc15_);
            param1 = _loc29_ + _loc3_ + _loc30_;
            _loc14_--;
         }
         return param1;
      }
      
      public static function §8#I§(param1:Object) : String
      {
         return §="e§(param1,0);
      }
      
      private static function §="e§(param1:Object, param2:int) : String
      {
         var _loc4_:* = null;
         var _loc5_:int = 0;
         param2++;
         ...
         for(_loc4_ in param1)
         {
            ...
            _loc3_ += _loc4_ + " = " + §@#s§(param1[_loc4_],param2);
            if(param2 > 1)
            {
               _loc3_ += ",";
            }
      ...
      private static function §@#s§(param1:*, param2:int) : String
      {
         ...
         else
         {
            ...
            if(param1 is Array)
            {
               ...
               {
                  _loc3_ += §@#s§(param1[_loc6_],param2) + (_loc6_ < param1.length - 1 ? "," : "");
                  _loc6_++;
               }
               return _loc3_ + "}";
            }
