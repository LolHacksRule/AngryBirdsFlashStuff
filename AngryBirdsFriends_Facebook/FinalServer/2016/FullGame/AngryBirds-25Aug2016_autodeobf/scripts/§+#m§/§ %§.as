package §+#m§
{
   ...
   public class § %§ extends §=#S§
   {
      ...
      protected function §#!$§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         var _loc16_:§%D§ = null;
         var _loc3_:Dictionary = this.§0"6§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§,i§(_loc7_,_loc6_)]) == null)
            {
      ...
      private function §0"6§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§,i§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §&"Y§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
