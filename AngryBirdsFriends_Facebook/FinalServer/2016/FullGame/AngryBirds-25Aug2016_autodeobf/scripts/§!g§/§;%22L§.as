package §!g§
{
   ...
   public class §;"L§
   {
      ...
      public static function §9"T§(param1:String) : String
      {
         var _loc2_:Array = §7%§(param1);
         var _loc3_:ByteArray = §<"T§(_loc2_);
         return §]"h§.§!D§(_loc3_.readInt(),true) + §]"h§.§!D§(_loc3_.readInt(),true) + §]"h§.§!D§(_loc3_.readInt(),true) + §]"h§.§!D§(_loc3_.readInt(),true) + §]"h§.§!D§(_loc3_.readInt(),true);
      }
      
      public static function §7"C§(param1:ByteArray) : String
      {
         var _loc2_:Array = §;"L§.§,#s§(param1);
         var _loc3_:ByteArray = §<"T§(_loc2_);
         return §]"h§.§!D§(_loc3_.readInt(),true) + §]"h§.§!D§(_loc3_.readInt(),true) + §]"h§.§!D§(_loc3_.readInt(),true) + §]"h§.§!D§(_loc3_.readInt(),true) + §]"h§.§!D§(_loc3_.readInt(),true);
      }
      ...
      private static function §<"T§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         ...
         _loc11_.position = 0;
         §"$8§ = new ByteArray();
         §"$8§.writeBytes(_loc11_);
         §"$8§.position = 0;
         return _loc11_;
      }
      
      private static function §,#s§(param1:ByteArray) : Array
      {
