package §?o§
{
   ...
   public class §,!W§
   {
      ...
      private function §=#v§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§%g§(param1 as String);
         }
         if(param1 is Number)
         {
         ...
         if(param1 is Array)
         {
            return this.§1g§(param1 as Array);
         }
      ...
      private function §1g§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§=#v§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §5#4§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§%g§(v.@name.toString()) + ":" + this.§=#v§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
