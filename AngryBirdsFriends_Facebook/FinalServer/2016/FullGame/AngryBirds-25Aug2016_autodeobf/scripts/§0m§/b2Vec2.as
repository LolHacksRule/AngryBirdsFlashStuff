package §0m§
{
   public class b2Vec2
   {
      ...
      public static function §'"n§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §9"j§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§&#3§(this,param1.col1);
      ...
      {
         return b2Math.§6!Y§(this.x) && b2Math.§6!Y§(this.y);
      }
   }
}
