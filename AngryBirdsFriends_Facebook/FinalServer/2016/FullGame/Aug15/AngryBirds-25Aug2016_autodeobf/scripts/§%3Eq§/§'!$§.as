package §>q§
{
   ...
   public class §'!$§ extends §@#a§
   {
      ...
      private static const §8$&§:String = "ButtonBGSmallDefault";
      ...
      public function §'!$§(param1:int, param2:§6!J§, param3:String, param4:String, param5:String)
      {
      ...
      {
         §>"'§[§8$&§].gotoAndStop("Active_Up_Default");
      }
