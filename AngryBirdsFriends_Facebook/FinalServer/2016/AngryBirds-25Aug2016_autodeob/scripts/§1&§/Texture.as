package §1&§
{
   ...
   public class Texture
   {
      ...
      public static function §?v§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false, param5:Number = 1) : §1&§.Texture
      {
         return §@"c§(param1,param2.bitmapData,param3,param4,param5);
      }
      
      public static function §@"c§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false, param5:Number = 1) : §1&§.Texture
      {
         ...
         _loc11_ = new §"!g§(_loc12_,Context3DTextureFormat.BGRA,_loc8_,_loc9_,param3,true,param4,param5);
         if(Starling.§!!b§)
         {
            _loc11_.§=#F§(param2);
         }
         ...
         return new §`#G§(_loc11_,new Rectangle(0,0,_loc6_ / param5,_loc7_ / param5),true);
      }
      
      public static function §;[§(param1:Context3D, param2:ByteArray, param3:Number = 1, param4:Boolean = true, param5:Function = null) : §1&§.Texture
      {
         var eventType:String = null;
         var nativeTexture:flash.display3D.textures.Texture = null;
         var concreteTexture:§"!g§ = null;
         ...
         concreteTexture = new §"!g§(nativeTexture,atfData.format,atfData.width,atfData.height,useMipMaps && atfData.§5"H§ > 1,false,false,scale);
         if(Starling.§!!b§)
         {
            concreteTexture.§=#F§(atfData);
         }
         if(async)
         {
      ...
      public static function §!!A§(param1:Context3D, param2:int, param3:int, param4:uint = 4.294967295E9, param5:Boolean = false, param6:Number = -1) : §1&§.Texture
      {
         if(param6 <= 0)
         {
            param6 = Starling.§0h§;
         ...
         var _loc8_:§1&§.Texture = §@"c§(param1,_loc7_,false,param5,param6);
         if(!Starling.§!!b§)
         {
            _loc7_.dispose();
         }
      ...
      public static function §1##§(param1:Context3D, param2:int = 64, param3:int = 64, param4:Boolean = false, param5:Boolean = true, param6:Number = -1) : §1&§.Texture
      {
         if(param6 <= 0)
         {
            param6 = Starling.§0h§;
         ...
         var _loc13_:§"!g§ = new §"!g§(_loc12_,_loc11_,_loc9_,_loc10_,false,param4,param5,param6);
         if(_loc7_ == _loc9_ && _loc8_ == _loc10_)
         {
            return _loc13_;
         }
         return new §`#G§(_loc13_,new Rectangle(0,0,param2,param3),true);
      }
      
      public static function §2!b§(param1:§1&§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §1&§.Texture
      {
         var _loc4_:§1&§.Texture;
         (_loc4_ = new §`#G§(param1,param2)).§6!I§ = param3;
         return _loc4_;
      }
      ...
      public function adjustVertexData(param1:§,#@§, param2:int, param3:int) : void
      {
         ...
         if(this.§6!I§)
         {
            ...
            _loc4_ = this.§6!I§.width + this.§6!I§.x - this.width;
            _loc5_ = this.§6!I§.height + this.§6!I§.y - this.height;
            param1.§="+§(param2,-this.§6!I§.x,-this.§6!I§.y);
            param1.§="+§(param2 + 1,-_loc4_,-this.§6!I§.y);
            param1.§="+§(param2 + 2,-this.§6!I§.x,-_loc5_);
      ...
      {
         return !!this.§6!I§ ? this.§6!I§.clone() : new Rectangle(0,0,this.width,this.height);
      }
      ...
      public function get parent() : §1&§.Texture
      {
         return this;
      }
