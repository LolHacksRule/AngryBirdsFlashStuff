package §2,§
{
   ...
   class §@$5§
   {
      ...
      {
         var _loc1_:BitmapData = new BitmapData(§="t§,§8"w§);
         var _loc2_:ByteArray = new ByteArray();
         var _loc3_:int = §[!a§.length;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc2_.writeUnsignedInt(§[!a§[_loc4_]);
            _loc4_++;
         }
         _loc2_.uncompress();
         _loc1_.setPixels(new Rectangle(0,0,§="t§,§8"w§),_loc2_);
         return Texture.§@"c§(null,_loc1_,false);
      }
