      ...
      public function §5"'§() : b2Vec2
      {
         ...
         switch(this.§=!4§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§]c§(_loc1_,this.m_v1.§&!t§.§9l§());
               if(_loc2_ > 0)
               {
      ...
      public function §22§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§=!4§)
         {
            ...
            case 2:
               ...
               param2.x = this.m_v1.a * this.m_v1.§9!U§.x + this.m_v2.a * this.m_v2.§9!U§.x;
               param2.y = this.m_v1.a * this.m_v1.§9!U§.y + this.m_v2.a * this.m_v2.§9!U§.y;
               break;
            case 3:
