package §"a§
{
   ...
   public class §0!B§
   {
               ...
               for each(_loc9_ in [true,false])
               {
                  for each(_loc10_ in [true,false])
                  {
                     for each(_loc11_ in _loc8_)
                     {
                        ...
                        _loc3_.§?!i§(Context3DProgramType.FRAGMENT,_loc5_.replace("???",_loc12_.join()));
                        _loc1_.§'!Q§(§[!P§(_loc6_,_loc10_,_loc9_,_loc11_,_loc7_),_loc2_.§,"T§,_loc3_.§,"T§);
                     }
                  }
               }
            }
      ...
      public function render(param1:Context3D, param2:Matrix3D, param3:Number = 1.0) : void
      {
         ...
         var _loc5_:* = param3 != 1;
         var _loc6_:String = !!this.§1"Q§ ? §[!P§(_loc5_,this.§1"Q§.mipMapping,this.§1"Q§.repeat,this.§!!@§,this.§6#§) : §;w§(_loc5_);
         §>w§.§+!p§(param1,_loc4_);
         this.§9"#§(param1);
         param1.setProgram(§!"J§.§1&§.§ z§(_loc6_));
         param1.setVertexBufferAt(0,this.§1!2§,§`b§.§%!V§,Context3DVertexBufferFormat.FLOAT_3);
         if(this.§1"Q§ == null || this.§6#§)
         {
            param1.setVertexBufferAt(2,this.§[!'§,§`b§.§<!W§,Context3DVertexBufferFormat.FLOAT_4);
         }
      ...
      public function §;!T§(param1:§5T§, param2:Number, param3:Texture, param4:String, param5:Matrix3D) : void
      {
         ...
         if(this.§^1§ == 0)
         {
            this.§1"Q§ = param3;
            this.§!!@§ = param4;
            this.§^!S§.§7!F§(!!param3 ? Boolean(param3.premultipliedAlpha) : true,false);
      ...
      {
         if(this.§1"Q§ != null && param2 != null)
         {
            return this.§1"Q§.root != param2.root || this.§1"Q§.repeat != param2.repeat || this.§!!@§ != param3 || this.§6#§ != param1.useColor || this.§^1§ == 8192;
         }
         if(this.§1"Q§ == null && param2 == null)
         {
            return false;
         }
         return this.§^1§ != 0 || this.§6#§ != (param1.useColor || param4 != 1);
      }
   }
}
