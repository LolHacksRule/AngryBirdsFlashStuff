package §,,§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§2!_§.x * this.§@!L§.x + (this.§3!1§ + this.§2!_§.y) * this.§1!?§.x),param1 * (this.§2!_§.x * this.§@!L§.y + (this.§3!1§ + this.§2!_§.y) * this.§1!?§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§9!S§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§9!S§.col2.x = this.§9!S§.col1.y;
         this.§9!S§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§9!=§)
         {
         ...
         if(param1.§@I§)
         {
            ...
            this.§2!_§.y *= param1.§]'§;
            this.§3!1§ *= param1.§]'§;
            _loc19_ = this.§2!_§.x * this.§@!L§.x + (this.§3!1§ + this.§2!_§.y) * this.§1!?§.x;
            _loc20_ = this.§2!_§.x * this.§@!L§.y + (this.§3!1§ + this.§2!_§.y) * this.§1!?§.y;
            _loc21_ = this.§2!_§.x * this.m_s1 + (this.§3!1§ + this.§2!_§.y) * this.m_a1;
            _loc22_ = this.§2!_§.x * this.m_s2 + (this.§3!1§ + this.§2!_§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§3!A§ && this.§@!3§ != b2internal::;!F)
         {
            ...
            _loc14_ = this.§!K§ * (this.§+"$§ - _loc13_);
            _loc15_ = this.§3!1§;
            _loc16_ = param1.§;J§ * this.§ !I§;
            this.§3!1§ = b2Math.§1"T§(this.§3!1§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§3!1§ - _loc15_) * this.§1!?§.x;
         ...
         if(this.§9!=§ && this.§@!3§ != b2internal::>Q)
         {
            ...
            _loc18_ = this.§2!_§.Copy();
            _loc19_ = this.§9!S§.§+!o§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§2!_§.§6"3§(_loc19_);
            if(this.§@!3§ == b2internal::93)
            {
               this.§2!_§.y = b2Math.§["2§(this.§2!_§.y,0);
            }
            else if(this.§@!3§ == b2internal::,!E)
            {
               this.§2!_§.y = b2Math.§@U§(this.§2!_§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§2!_§.y - _loc18_.y) * this.§9!S§.col2.x;
            if(this.§9!S§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§9!S§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§2!_§.x = _loc21_;
            _loc19_.x = this.§2!_§.x - _loc18_.x;
            _loc19_.y = this.§2!_§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§@!L§.x + _loc19_.y * this.§1!?§.x;
            _loc9_ = _loc19_.x * this.§@!L§.y + _loc19_.y * this.§1!?§.y;
         ...
         else
         {
            if(this.§9!S§.col1.x != 0)
            {
               _loc22_ = -_loc12_ / this.§9!S§.col1.x;
            }
            else
            {
               _loc22_ = 0;
            ...
            this.§2!_§.x += _loc22_;
            _loc8_ = _loc22_ * this.§@!L§.x;
            _loc9_ = _loc22_ * this.§@!L§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§9!=§)
         {
            ...
            if(b2Math.§#X§(this.§1!K§ - this.§4"'§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§1"T§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§#X§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§4"'§)
            {
               _loc19_ = b2Math.§1"T§(_loc34_ - this.§4"'§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§4"'§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§1!K§)
            {
               _loc19_ = b2Math.§1"T§(_loc34_ - this.§1!K§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§1!K§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§9!S§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§9!S§.col2.x = this.§9!S§.col1.y;
            this.§9!S§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§9!S§.§+!o§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::1!x;
         ...
         var _loc30_:Number = _loc28_.x * this.§@!L§.x + _loc28_.y * this.§1!?§.x;
         var _loc31_:Number = _loc28_.x * this.§@!L§.y + _loc28_.y * this.§1!?§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::1!x * _loc30_;
         _loc6_.y -= b2internal::1!x * _loc31_;
