package §4$E§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §1!W§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§5"F§)
         {
            case b2Manifold.§&$§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§+$8§.x = _loc19_ / _loc26_;
                  this.§+$8§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§+$8§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§+$8§.x;
               _loc23_ = _loc16_ + param3 * this.§+$8§.y;
               _loc24_ = _loc17_ - param5 * this.§+$8§.x;
               _loc25_ = _loc18_ - param5 * this.§+$8§.y;
            ...
            case b2Manifold.§%!^§:
               ...
               this.§+$8§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§`!o§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§"f§[_loc6_].m_localPoint;
                  ...
                  this.§"f§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§"f§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§!"i§:
               ...
               while(_loc6_ < param1.§`!o§)
               {
                  ...
                  this.§"f§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§"f§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
