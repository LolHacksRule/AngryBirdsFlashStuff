package §;"H§
{
   ...
   public class SHA1
   {
      ...
      public static function §,"O§(param1:String) : String
      {
         ...
         return §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true);
      }
      
      public static function hashBytes(param1:ByteArray) : String
      {
         var _loc2_:Array = SHA1.§+$@§(param1);
         var _loc3_:ByteArray = §##n§(_loc2_);
         return §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true);
      }
