package §;$%§
{
   ...
   public class §,#;§
   {
      ...
      public static function §4"Z§(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number) : §"c§
      {
         ...
         while(_loc17_ < 2)
         {
            _loc12_[_loc17_] = §1"[§(_loc8_,_loc9_,_loc14_[_loc17_].x,_loc14_[_loc17_].y);
         ...
         var _loc19_:§"c§;
         (_loc19_ = new §"c§()).§-!i§ = Math.sqrt(_loc16_);
         _loc19_.§<#L§ = _loc18_;
         return _loc19_;
      }
