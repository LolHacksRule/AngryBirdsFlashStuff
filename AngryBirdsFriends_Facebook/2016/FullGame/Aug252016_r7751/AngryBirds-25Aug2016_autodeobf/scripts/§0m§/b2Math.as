package §0m§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§=Y§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §6!Y§(param1:Number) : Boolean
      {
      ...
      public static function §0!M§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §0#O§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §8$7§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         var _loc4_:Number = NaN;
         _loc3_ = §>!6§(param2,param1.position);
      ...
      public static function §9#u§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         var _loc3_:Number = param1.x - param2.x;
         var _loc4_:Number = param1.y - param2.y;
      ...
      public static function §-#X§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§=Y§(§&#d§(param1.col1,param2.col1),§&#d§(param1.col2,param2.col2));
      }
      
      public static function §8"j§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§=Y§(§@6§(param1,param2.col1),§@6§(param1,param2.col2));
      }
      
      public static function §5"G§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         ...
         return b2Mat22.§=Y§(_loc3_,_loc4_);
      }
      ...
      {
         return b2Mat22.§=Y§(§=#"§(param1.col1),§=#"§(param1.col2));
      }
      ...
      public static function §;"d§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§1a§(param1.x,param2.x),§1a§(param1.y,param2.y));
      }
      ...
      {
         return §;!o§(param2,§;"d§(param1,param3));
      }
      ...
      public static function §6!5§(param1:Number, param2:Number) : Number
      {
      ...
      public static function §0#t§(param1:uint) : Boolean
      {
