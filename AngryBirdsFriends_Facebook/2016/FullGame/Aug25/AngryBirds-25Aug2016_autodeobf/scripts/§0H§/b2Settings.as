package §0H§
{
   public class b2Settings
   {
      ...
      public static const §^#e§:int = 65535;
      ...
      public static const §["7§:Number = 0.05;
      
      public static const §!"7§:Number = 0.005;
      
      public static const §4"#§:Number = 0.007;
      
      public static var b2_linearSlop:Number = §["7§;
      
      public static const §1M§:Number = b2_linearSlop - §!"7§;
      ...
      public static const §6#Z§:Number = 0.1;
      
      public static const §="C§:Number = 0.01;
      
      public static const §8>§:Number = 0.1;
      
      public static var b2_linearSleepTolerance:Number = §6#Z§;
