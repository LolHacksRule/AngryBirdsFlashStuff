package §#v§
{
   public class §@#?§ extends §2"+§
   {
      ...
      protected static function §%#k§() : void
      {
      ...
      override public function readDataFromJSON(param1:String) : void
      {
         ...
         var _loc3_:Number = 0;
         while(_loc3_ < §3!2§.length)
         {
            §3!2§[_loc3_].angle = §3!2§[_loc3_].angle;
            _loc3_++;
         }
         this.§=#d§ = "";
         if(_loc2_.optimalPowerup)
         {
            this.§=#d§ = _loc2_.optimalPowerup;
         }
         if(_loc2_.borderTop)
         {
            §%! § = _loc2_.borderTop;
      ...
      public function §9#6§(param1:String) : Boolean
      {
         var _loc2_:Number = 0;
         while(_loc2_ < §3!2§.length)
         {
            if(§3!2§[_loc2_].type == param1)
            {
               return true;
            }
            _loc2_++;
