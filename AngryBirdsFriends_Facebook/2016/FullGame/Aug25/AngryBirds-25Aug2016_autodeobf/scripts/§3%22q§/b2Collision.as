package §3"q§
{
   ...
   public class b2Collision
   {
      ...
      private static var §]#e§:Vector.<§?!1§> = § k§();
      
      private static var s_clipPoints1:Vector.<§?!1§> = § k§();
      
      private static var s_clipPoints2:Vector.<§?!1§> = § k§();
      
      private static var §1#7§:Vector.<int> = new Vector.<int>(1);
      
      private static var §`#v§:Vector.<int> = new Vector.<int>(1);
      
      private static var §!#e§:b2Vec2 = new b2Vec2();
      
      private static var §&7§:b2Vec2 = new b2Vec2();
      
      private static var §9"F§:b2Vec2 = new b2Vec2();
      ...
      public static function §!"W§(param1:Vector.<§?!1§>, param2:Vector.<§?!1§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§?!1§ = null;
         var _loc6_:int = 0;
      ...
      public static function §<!a§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         int(param1.§3!O§);
         var _loc7_:Vector.<b2Vec2> = param1.§[#k§;
         var _loc8_:Vector.<b2Vec2> = param1.§5#1§;
         var _loc9_:int = param4.§3!O§;
         var _loc10_:Vector.<b2Vec2> = param4.§[#k§;
         _loc11_ = param2.R;
      ...
      public static function §%$<§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§3!O§;
         var _loc7_:Vector.<b2Vec2> = param2.§5#1§;
         _loc9_ = param5.R;
         _loc8_ = param4.§"#N§;
         ...
         var _loc17_:Number = §<!a§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §<!a§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §<!a§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §<!a§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §1"z§(param1:Vector.<§?!1§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc23_:Number = NaN;
         int(param2.§3!O§);
         var _loc8_:Vector.<b2Vec2> = param2.§5#1§;
         var _loc9_:int = param5.§3!O§;
         var _loc10_:Vector.<b2Vec2> = param5.§[#k§;
         var _loc11_:Vector.<b2Vec2> = param5.§5#1§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§,"p§.§?!e§ = param4;
         _loc20_.id.§,"p§.§]$3§ = _loc21_;
         _loc20_.id.§,"p§.§<V§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§,"p§.§?!e§ = param4;
         _loc20_.id.§,"p§.§]$3§ = _loc22_;
         _loc20_.id.§,"p§.§<V§ = 1;
      }
      
      private static function § k§() : Vector.<§?!1§>
      {
      ...
      public static function §<#C§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§?!1§ = null;
         ...
         param1.§+!P§ = 0;
         var _loc7_:Number = param2.§0#I§ + param4.§0#I§;
         var _loc8_:int = 0;
         §1#7§[0] = _loc8_;
         var _loc9_:Number = §%$<§(§1#7§,param2,param3,param4,param5);
         _loc8_ = §1#7§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §`#v§[0] = _loc10_;
         var _loc11_:Number = §%$<§(§`#v§,param4,param5,param2,param3);
         _loc10_ = §`#v§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§?!1§> = §]#e§;
         §1"z§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§3!O§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§[#k§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §!#e§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §&7§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §9"F§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §1![§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§?!1§> = s_clipPoints1;
         var _loc38_:Vector.<§?!1§> = s_clipPoints2;
         if(int(§!"W§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if(int(§!"W§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§7"8§.SetV(_loc27_);
         ...
         while(_loc41_ < b2Settings.b2_maxManifoldPoints)
         {
            ...
            if(Number(_loc31_.x * _loc6_.v.x + _loc31_.y * _loc6_.v.y - _loc34_) <= _loc7_)
            {
               _loc43_ = param1.§8#N§[_loc40_];
               _loc20_ = _loc15_.R;
      ...
      public static function §&#J§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§0#I§ + param4.§0#I§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§6"&§ = b2Manifold.§8N§;
         param1.m_localPoint.SetV(param2.§9#c§);
         param1.§7"8§.§,[§();
         param1.§+!P§ = 1;
         param1.§8#N§[0].m_localPoint.SetV(param4.§9#c§);
         param1.§8#N§[0].m_id.key = 0;
      }
      ...
      public static function §;d§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§0#I§ + param4.§0#I§;
         var _loc21_:int = param2.§3!O§;
         var _loc22_:Vector.<b2Vec2> = param2.§[#k§;
         var _loc23_:Vector.<b2Vec2> = param2.§5#1§;
         var _loc24_:int = 0;
         ...
         if(_loc19_ < Number.MIN_VALUE)
         {
            param1.§+!P§ = 1;
            param1.§6"&§ = b2Manifold.§,#§;
            param1.§7"8§.SetV(_loc23_[_loc18_]);
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§+!P§ = 1;
            param1.§6"&§ = b2Manifold.§,#§;
            param1.§7"8§.x = _loc15_ - _loc27_.x;
            param1.§7"8§.y = _loc16_ - _loc27_.y;
            param1.§7"8§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§+!P§ = 1;
            param1.§6"&§ = b2Manifold.§,#§;
            param1.§7"8§.x = _loc15_ - _loc28_.x;
            param1.§7"8§.y = _loc16_ - _loc28_.y;
            param1.§7"8§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§8#N§[0].m_localPoint.SetV(param4.§9#c§);
            param1.§8#N§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§+!P§ = 1;
            param1.§6"&§ = b2Manifold.§,#§;
            param1.§7"8§.x = _loc23_[_loc25_].x;
            param1.§7"8§.y = _loc23_[_loc25_].y;
            param1.§7"8§.Normalize();
      ...
      public static function §4"t§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§6G§;
         var _loc4_:b2Vec2 = param1.§%G§;
