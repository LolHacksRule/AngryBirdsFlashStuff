package §46§
{
   ...
   public class §&"§ extends §+!$§
   {
      ...
      {
         var _loc2_:§&"§ = new §&"§(param1.type,param1.index1,param1.index2,param1.point1,param1.point2,param1.§%K§,param1.§+!A§,param1.lowerLimit,param1.upperLimit,param1.§@!N§,param1.motorSpeed,param1.§2K§,param1.maxTorque);
         _loc2_.§8X§ = param1.§8X§;
      ...
      public function get §1V§() : b2Joint
      {
         return this.§=[§;
      }
      
      public function set §1V§(param1:b2Joint) : void
      {
         this.§=[§ = param1;
      }
