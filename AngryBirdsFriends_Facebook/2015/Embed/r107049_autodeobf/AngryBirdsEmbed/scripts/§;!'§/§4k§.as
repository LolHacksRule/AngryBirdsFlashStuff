   ...
   public class §4k§
   {
      ...
      public static function §>,§(param1:XMLList, param2:XMLList, param3:XMLList) : void
      {
         ...
         for each(_loc4_ in param1.Material)
         {
            ...
            §9!0§(_loc4_.@id,_loc4_.@bodyType,_loc4_.@density,_loc4_.@friction,_loc4_.@restitution,_loc4_.@strength,_loc4_.@defence,_loc4_.@colors);
         }
         §2]§(param2,param3);
      }
      ...
      public static function §9!0§(param1:String, param2:String, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : void
      {
         §1Q§[§1Q§.length] = new §3!6§(param1,param2,param3,param4,param5,param6,param7,param8);
      }
      
      public static function §[I§(param1:String) : §3!6§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §1Q§.length)
         {
            if((§1Q§[_loc2_] as §3!6§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §3!6§(§1Q§[_loc2_]);
            }
            _loc2_++;
         }
