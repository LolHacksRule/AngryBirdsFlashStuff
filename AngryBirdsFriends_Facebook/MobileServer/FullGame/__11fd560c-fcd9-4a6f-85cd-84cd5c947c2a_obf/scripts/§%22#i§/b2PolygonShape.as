package §"#i§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §`#H§:b2Mat22 = new b2Mat22();
      ...
      public static function §>r§(param1:Array, param2:Number) : b2PolygonShape
      {
         ...
         _loc3_.§6#T§(param1,param2);
         return _loc3_;
      }
      
      public static function §?"o§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §[v§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
      ...
      public static function §1"H§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §&#P§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
      ...
      public function §6#T§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function §`!L§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§?"h§)
         {
            this.§&#>§[_loc6_] = b2Math.§&Q§(_loc5_,this.§&#>§[_loc6_]);
            this.§;#]§[_loc6_] = b2Math.§4!p§(_loc5_.R,this.§;#]§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §-!"§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§;#]§[0] = b2Math.§^#C§(b2Math.§ $$§(param2,param1),1);
         this.§;#]§[0].Normalize();
         this.§;#]§[1].x = -this.§;#]§[0].x;
         this.§;#]§[1].y = -this.§;#]§[0].y;
      }
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§!O§.x = _loc7_ + b2internal::?!>;
         param1.§!O§.y = _loc8_ + b2internal::?!>;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         while(_loc10_ < this.§?"h§)
         {
            ...
            _loc12_ = _loc10_ + 1 < this.§?"h§ ? this.§&#>§[int(_loc10_ + 1)] : this.§&#>§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§&Z§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§2"C§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§=7§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§=7§(_loc5_,this.§&#>§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§&Q§(param3,_loc24_.center));
                  return _loc24_.§&Z§;
               }
               return 0;
               break;
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§?"h§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
         ...
         _loc20_.§8!O§(1 / _loc19_);
         param4.SetV(b2Math.§&Q§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §2!Z§() : Vector.<b2Vec2>
      {
         return this.§&#>§;
      }
      ...
      public function §8Z§(param1:b2Vec2) : int
      {
      ...
      private function §7!w§(param1:int) : void
      {
