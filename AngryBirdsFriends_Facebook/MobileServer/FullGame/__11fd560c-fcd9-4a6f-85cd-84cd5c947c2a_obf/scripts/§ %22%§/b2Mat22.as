package § "%§
{
   public class b2Mat22
   {
      ...
      public static function §]8§(param1:Number) : b2Mat22
      {
      ...
      public function § "u§(param1:b2Mat22) : void
      {
      ...
      public function §3!Z§(param1:b2Vec2, param2:Number, param3:Number) : b2Vec2
      {
