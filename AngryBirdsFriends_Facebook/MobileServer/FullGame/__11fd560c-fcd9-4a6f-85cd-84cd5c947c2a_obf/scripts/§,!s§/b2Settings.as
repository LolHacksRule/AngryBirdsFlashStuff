package §,!s§
{
   public class b2Settings
   {
      ...
      public static const §7#o§:Number = 0.05;
      
      public static const §2#F§:Number = 0.005;
      
      public static const §;"C§:Number = 0.007;
      
      public static var b2_linearSlop:Number = §7#o§;
      
      public static const §>!"§:Number = b2_linearSlop - §2#F§;
      ...
      public static const §?#D§:Number = 0.1;
      
      public static var b2_linearSleepTolerance:Number = §@#E§;
