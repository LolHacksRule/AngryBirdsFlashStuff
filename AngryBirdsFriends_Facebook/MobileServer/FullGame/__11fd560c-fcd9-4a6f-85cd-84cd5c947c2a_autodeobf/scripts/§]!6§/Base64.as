package §]!6§
{
   ...
   public class Base64
   {
      ...
      private static const §;#d§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §0"w§(param1:String) : String
      {
      ...
      public static function §<!b§(param1:String) : ByteArray
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §;#d§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
