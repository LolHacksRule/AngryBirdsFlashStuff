package §+!W§
{
   ...
   public class SHA1
   {
      ...
      public static function §%$6§(param1:String) : String
      {
         ...
         return § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true);
      }
      
      public static function hashBytes(param1:ByteArray) : String
      {
         var _loc2_:Array = SHA1.§9"k§(param1);
         var _loc3_:ByteArray = §>R§(_loc2_);
         return § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true) + § "L§.§3#]§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc6_:uint = 0;
         var _loc2_:Array = SHA1.§<!X§(param1);
         var _loc3_:ByteArray = §>R§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
