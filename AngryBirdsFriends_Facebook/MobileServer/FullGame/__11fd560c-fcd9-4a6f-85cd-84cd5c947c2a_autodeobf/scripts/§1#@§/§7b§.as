package §1#@§
{
   ...
   public class §7b§
   {
      ...
      public function §7b§(param1:*)
      {
         super();
         this.jsonString = this.§7"J§(param1);
      }
      ...
      private function §7"J§(param1:*) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§5#=§(v.@name.toString()) + ":" + this.§7"J§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
