package com.angrybirds.friendsbar.data
{
   ...
   public class HighScoreListManager
   {
      ...
      public function getScoresForLevel(episode:String, levelId:String, tournamentScores:Boolean = false, useCache:Boolean = true) : CachedFacebookFriends
      {
         ...
         return this.mLevelsScores[levelId] = new CachedFacebookFriends(this.mUserId,this.mUserName,this.mServerRoot + "/scores/getLevelScores?limit=1000&episode=" + episode + "&level=" + levelId + "&" + TournamentModel.instance.getCurrentTournamentIdParameter(),false,null,true,tournamentScores,false);
      }
