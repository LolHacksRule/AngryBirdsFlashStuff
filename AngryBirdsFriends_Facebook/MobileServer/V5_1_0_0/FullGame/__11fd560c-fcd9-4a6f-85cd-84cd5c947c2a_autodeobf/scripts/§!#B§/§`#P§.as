package §!#B§
{
   ...
   public class §`#P§
   {
      ...
      {
         this.§]"]§ = this.§4"D§.mask.height = param1;
      }
      ...
      protected function §-!P§(param1:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.§>"u§();
            this.§4"D§.addChild(_loc3_);
            _loc3_.index = _loc2_;
            this.§12§(_loc3_,this.data[_loc2_]);
            this.§2"k§.push(_loc3_);
            _loc2_++;
         }
         this.updatePositions();
      }
      
      protected function §12§(param1:§;+§, param2:Object) : void
      {
         param1.data = param2;
      }
      ...
      protected function updatePositions() : void
      {
         ...
         while(_loc1_ < this.§["[§.length)
         {
            ...
            if(_loc3_ > -this.§"$>§ && _loc3_ < this.§5"S§ && !this.§6"$§(_loc1_))
            {
               _loc4_ = this.§>"u§();
               this.§4"D§.addChild(_loc4_);
               this.§12§(_loc4_,this.§["[§[_loc1_]);
               _loc4_.index = _loc1_;
               _loc4_.x = _loc3_;
      ...
      protected function hide(param1:§;+§) : void
      {
         ...
         this.§2"k§.splice(this.§2"k§.indexOf(param1),1);
         this.§`"4§(param1);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.§12§(_loc1_,this.§["[§[_loc1_.index]);
         }
      }
