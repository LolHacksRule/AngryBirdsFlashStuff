package §8§#8
{
   ...
   public interface §&#V§
   {
      ...
      function §5#A§(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:int = -1, param8:Boolean = true, param9:Boolean = true) : void;
      ...
      function §;"o§(param1:String, param2:Number, param3:Number, param4:Number, param5:int, param6:Number = 0.0, param7:Number = 0.0, param8:Number = 1.0, param9:Boolean = false, param10:Boolean = false) : §,#5§;
      ...
      function §4#C§(param1:String, param2:int, param3:int, param4:Number, param5:Number, param6:Number, param7:Number, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0, param13:Number = 1, param14:int = -1, param15:Boolean = false) : void;
      
      function removeObject(param1:§,#5§, param2:Boolean = false, param3:Boolean = false) : void;
      
      function §'#9§(param1:§,#5§) : Boolean;
      
      function get objectCount() : int;
      
      function §%"c§(param1:String) : §4U§;
      
      function getObject(param1:int) : §,#5§;
      
      function getObjectFromPoint(param1:Number, param2:Number) : §4!y§;
      
      function §6$6§(param1:Boolean) : void;
      
      function §""x§(param1:Boolean, param2:Number = 0, param3:Number = 0, param4:Number = 0) : void;
      
      function destroyAllJoints() : void;
      
      function getForceAtPoint(param1:Number, param2:Number, param3:Number, param4:b2Vec2) : b2Vec2;
      
      function get §9"]§() : Number;
   }
}
