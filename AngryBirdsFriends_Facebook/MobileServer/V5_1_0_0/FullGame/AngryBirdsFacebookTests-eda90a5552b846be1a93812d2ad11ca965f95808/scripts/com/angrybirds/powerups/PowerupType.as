package com.angrybirds.powerups
{
   public class PowerupType
   {
      ...
      public static const sLaserSight:PowerupDefinition = new PowerupDefinition("LaserSight","Sling Scope","Button_PowerUp3","POWERUP3",["LaserSightSubscriptionTournament"],"Looking for the perfect shot? Use Sling Scope laser targeting for pinpoint precision!","Aim to please! Infinite Sling Scope for this week\'s tournament.");
      ...
      public static const sBoombox:PowerupDefinition = new PowerupDefinition("BoomBox","Boombox","Button_PowerUp8","POWERUP8",null,"Have a blast and blow up the pigs with the Boombox power-up.","",false);
      ...
      public static const sPowerupsTournament:Array = [sBirdFood,sExtraSpeed,sLaserSight,sEarthquake,sBoombox,sExtraBird];
      
      public static const sPowerupsStorymode:Array = [sBirdFood,sExtraSpeed,sLaserSight,sEarthquake,sMightyEagle,sBoombox,sExtraBird];
      
      public static const sPowerupsStorymodeWonderland:Array = [sBirdFood,sExtraSpeed,sLaserSight,sEarthquake,sMushroom,sMightyEagle,sBoombox,sExtraBird];
