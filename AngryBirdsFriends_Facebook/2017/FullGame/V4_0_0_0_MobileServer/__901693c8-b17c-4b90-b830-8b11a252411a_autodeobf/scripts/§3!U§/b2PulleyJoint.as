package §3!U§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§[m§ = b2internal::!"2.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§;0§.x - this.§[m§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§;0§.y - this.§[m§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§3!"§.x - this.§[m§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§3!"§.y - this.§[m§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§?#O§);
         this.m_localAnchor2.SetV(param1.§ b§);
         this.§>"l§ = param1.§3"g§;
         this.§!"G§ = param1.§4#D§ + this.§>"l§ * param1.§=$=§;
         this.m_maxLength1 = b2Math.§'Q§(param1.§^!6§,this.§!"G§ - this.§>"l§ * b2internal::]! );
         this.m_maxLength2 = b2Math.§'Q§(param1.§>!K§,(this.§!"G§ - b2internal::]! ) / this.§>"l§);
         this.§<#e§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§<#e§ * this.m_u2.x,param1 * this.§<#e§ * this.m_u2.y);
      }
      ...
      public function §59§() : b2Vec2
      {
         var _loc1_:b2Vec2 = this.§[m§.m_xf.position.Copy();
      ...
      public function GetLength1() : Number
      {
         ...
         var _loc2_:Number = this.§[m§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.§[m§.m_xf.position.y + this.m_groundAnchor1.y;
      ...
      {
         var _loc1_:b2Vec2 = b2internal::?s.GetWorldPoint(this.m_localAnchor2);
         var _loc2_:Number = this.§[m§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.§[m§.m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc14_:Number = this.§[m§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.§[m§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.§[m§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.§[m§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§!"G§ - _loc18_ - this.§>"l§ * _loc19_) > 0)
         {
            this.§4"[§ = b2internal:: #f;
            this.§<#e§ = 0;
         }
         ...
         this.m_limitMass1 = _loc2_.§"#z§ + _loc2_.§["p§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§"#z§ + _loc3_.§["p§ * _loc22_ * _loc22_;
         this.§+"t§ = this.m_limitMass1 + this.§>"l§ * this.§>"l§ * this.m_limitMass2;
         ...
         if(param1.§,!D§)
         {
            ...
            _loc23_ = (-this.§<#e§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§<#e§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§>"l§ * this.§<#e§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§>"l§ * this.§<#e§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§ ![§.x += _loc2_.§"#z§ * _loc23_;
            _loc2_.§ ![§.y += _loc2_.§"#z§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§["p§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§ ![§.x += _loc3_.§"#z§ * _loc25_;
            _loc3_.§ ![§.y += _loc3_.§"#z§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§["p§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§<#e§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§4"[§ == b2internal::;">)
         {
            ...
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§>"l§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§+"t§ * -_loc18_;
            _loc20_ = this.§<#e§;
            this.§<#e§ = b2Math.§[#1§(0,this.§<#e§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§<#e§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§>"l§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§>"l§ * _loc19_ * this.m_u2.y;
            _loc2_.§ ![§.x += _loc2_.§"#z§ * _loc14_;
            _loc2_.§ ![§.y += _loc2_.§"#z§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§["p§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§ ![§.x += _loc3_.§"#z§ * _loc16_;
            _loc3_.§ ![§.y += _loc3_.§"#z§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§["p§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
         if(this.m_limitState1 == b2internal::;">)
         {
            ...
            this.m_limitImpulse1 = b2Math.§[#1§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == b2internal::;">)
         {
            ...
            this.m_limitImpulse2 = b2Math.§[#1§(0,this.m_limitImpulse2 + _loc19_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal::!"2;
         var _loc3_:b2Body = b2internal::?s;
         var _loc5_:Number = this.§[m§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.§[m§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.§[m§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.§[m§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         if(this.§4"[§ == b2internal::;">)
         {
            ...
            if(_loc18_ > b2Settings.b2_linearSlop)
            {
               this.m_u2.§@o§(1 / _loc18_);
            }
            else
            {
               this.m_u2.§2!9§();
            }
            _loc19_ = this.§!"G§ - _loc17_ - this.§>"l§ * _loc18_;
            _loc24_ = b2Math.§[#1§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§0"E§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§+"t§ * _loc19_) * this.m_u1.x;
            _loc14_ = -_loc20_ * this.m_u1.y;
            _loc15_ = -this.§>"l§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§>"l§ * _loc20_ * this.m_u2.y;
            _loc2_.m_sweep.c.x += _loc2_.§"#z§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§"#z§ * _loc14_;
            _loc2_.m_sweep.a += _loc2_.§["p§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§"#z§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§"#z§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§["p§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§6!=§();
            _loc3_.§6!=§();
         }
         if(this.m_limitState1 == b2internal::;">)
