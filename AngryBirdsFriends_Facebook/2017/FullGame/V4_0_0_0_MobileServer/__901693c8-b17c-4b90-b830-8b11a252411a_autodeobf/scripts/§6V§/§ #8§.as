package §6V§
{
   ...
   public class § #8§
   {
      ...
      public static function §8#H§(param1:DisplayObject) : ByteArray
      {
         var _loc2_:BitmapData = §'#C§(param1);
         return §6!!§.encode(_loc2_);
      }
      ...
      public static function §="%§(param1:String, param2:Function) : void
      {
         ...
         var _loc4_:ByteArray = Base64.§8#z§(param1);
         §=#g§(_loc4_,param2);
      }
      
      public static function §=#g§(param1:ByteArray, param2:Function) : void
      {
