package §^#]§
{
   ...
   public class §@!g§
   {
      ...
      public static function §=F§(param1:Number) : Boolean
      {
         ...
         var _loc4_:Number;
         return (_loc4_ = _loc3_ - param1) < §@!^§.§6t§;
      }
      
      public static function §;n§(param1:§2#i§) : void
      {
         if(!param1)
         {
            return;
         ...
         {
            §`]§(AngryBirdsBase.singleton.dataModel).§ in§.§?!;§(§,!z§.§^!?§,[param1.id]);
         }
         var _loc2_:int = §`]§(AngryBirdsBase.singleton.dataModel).§^#h§.indexOf(param1.id);
         if(_loc2_ > -1)
         {
            §`]§(AngryBirdsBase.singleton.dataModel).§^#h§.splice(_loc2_,1);
         }
         var _loc3_:int = 0;
         while(_loc3_ < param1.§]$4§())
         {
            _loc2_ = §`]§(AngryBirdsBase.singleton.dataModel).§!"z§.indexOf(param1.id + param1.getPricePoint(_loc3_).price);
            if(_loc2_ > -1)
            {
               §`]§(AngryBirdsBase.singleton.dataModel).§ in§.§?!;§(§,!z§.§^!?§,[param1.id + param1.getPricePoint(_loc3_).price]);
               §`]§(AngryBirdsBase.singleton.dataModel).§!"z§.splice(_loc2_,1);
            }
            _loc3_++;
         }
         (§!#A§.§>q§ as §-#+§).§4"T§();
      ...
      public static function §["1§(param1:TextField, param2:String, param3:Number = 0) : void
      {
      ...
      public static function §else §(param1:int) : String
      {
      ...
      public static function §?$5§(param1:String, param2:String, param3:MovieClip) : void
      {
         var _loc5_:int = 0;
         var _loc6_:MovieClip = null;
         var _loc4_:Class;
         if(_loc4_ = §+$#§.§["`§(param1,false,false))
         {
            _loc5_ = 1;
