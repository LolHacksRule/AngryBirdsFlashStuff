package §%!9§
{
   public class b2Vec2
   {
      ...
      public function §6K§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§<"4§(this,param1.col1);
         this.y = b2Math.§<"4§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      public function §6#M§(param1:Number) : void
      {
         var _loc2_:Number = this.x;
         this.x = -param1 * this.y;
         this.y = param1 * _loc2_;
