package §?$9§
{
   ...
   public class §2#1§ extends §7"H§
   {
       
      
      public function §2#1§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
      ...
      protected function §6$!§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§3#S§(_loc7_,_loc6_)]) == null)
            {
      ...
      private function §3#S§(param1:String, param2:String) : String
      {
      ...
      private function §`§(param1:Vector.<XML>) : Dictionary
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§3#S§(_loc4_,_loc6_.@name);
