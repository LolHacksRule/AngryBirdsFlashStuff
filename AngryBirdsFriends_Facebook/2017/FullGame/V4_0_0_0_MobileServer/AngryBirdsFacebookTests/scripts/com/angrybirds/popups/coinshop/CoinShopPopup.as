package com.angrybirds.popups.coinshop
{
   ...
   public class CoinShopPopup extends AbstractPopup implements IWalletContainer, IVirtualPageView, INavigable
   {
      ...
      {
         if(mContainer.getItemByName(PAY_BY_CREDIT_BUTTON_NAME) && mContainer.getItemByName(PAY_BY_MOBILE_BUTTON_NAME) && mContainer.getItemByName(EARN_BY_BIRD_COINS_BUTTON_NAME))
         {
