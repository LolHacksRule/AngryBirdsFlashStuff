   ...
   public class LevelItemMaterialManager
   {
      ...
      public function loadMaterials(materials:XMLList, damageMultipliers:XMLList, velocityMultipliers:XMLList) : void
      {
         ...
         for each(material in materials.Material)
         {
            ...
            this.newMaterial(material.@id,LevelItemMaterial.getBodyTypeFromString(material.@bodyType),material.@density,material.@friction,material.@restitution,material.@strength,material.@defence,material.@colors);
         }
      ...
      public function newMaterial(aName:String, bodyType:int, density:Number, friction:Number, restitution:Number, strength:Number, defence:Number, colors:Number) : LevelItemMaterial
      {
         var material:LevelItemMaterial = new LevelItemMaterial(aName,bodyType,density,friction,restitution,strength,defence,colors);
