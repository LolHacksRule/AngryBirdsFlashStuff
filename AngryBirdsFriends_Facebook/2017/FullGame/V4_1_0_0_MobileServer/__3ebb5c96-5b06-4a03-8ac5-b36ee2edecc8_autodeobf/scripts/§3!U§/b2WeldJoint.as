package §3!U§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc7_ = this.§8!s§.y - _loc4_.m_sweep.localCenter.y;
         ...
         if(param1.§,!D§)
         {
            ...
            this.§<#e§.y *= param1.§##y§;
            this.§<#e§.z *= param1.§##y§;
            _loc4_.§ ![§.x -= _loc10_ * this.§<#e§.x;
            _loc4_.§ ![§.y -= _loc10_ * this.§<#e§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§<#e§.y - _loc7_ * this.§<#e§.x + this.§<#e§.z);
            _loc5_.§ ![§.x += _loc11_ * this.§<#e§.x;
            _loc5_.§ ![§.y += _loc11_ * this.§<#e§.y;
            _loc5_.m_angularVelocity += _loc13_ * (_loc8_ * this.§<#e§.y - _loc9_ * this.§<#e§.x + this.§<#e§.z);
         }
         else
         {
            this.§<#e§.§2!9§();
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc5_:b2Body = b2internal::?s;
         _loc2_ = _loc4_.m_xf.R;
         var _loc6_:Number = this.§8!s§.x - _loc4_.m_sweep.localCenter.x;
         ...
         var _loc16_:Number = _loc5_.m_sweep.a - _loc4_.m_sweep.a - this.§try§;
