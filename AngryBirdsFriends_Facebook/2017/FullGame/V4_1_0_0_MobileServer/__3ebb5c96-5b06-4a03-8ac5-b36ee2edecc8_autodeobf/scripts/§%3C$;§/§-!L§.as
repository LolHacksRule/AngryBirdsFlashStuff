package §<$;§
{
   ...
   class §-!L§
   {
      ...
      {
         var _loc1_:BitmapData = new BitmapData(§ !;§,§=!A§);
         var _loc2_:ByteArray = new ByteArray();
         var _loc3_:int = §%"T§.length;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc2_.writeUnsignedInt(§%"T§[_loc4_]);
            _loc4_++;
         }
         _loc2_.uncompress();
         _loc1_.setPixels(new Rectangle(0,0,§ !;§,§=!A§),_loc2_);
         return Texture.§!"I§(null,_loc1_,false);
      }
