package §1#=§
{
   ...
   public class §?$8§
   {
      ...
      public function §]V§() : void
      {
         ...
         {
            this.§'$&§.removeChild(this.§]B§[_loc1_]);
            _loc1_++;
         }
      ...
      public function §&#C§(param1:int) : Boolean
      {
         if(this.§+!g§ - param1 > 0 || this.§+!g§ - param1 - this.§0#?§ < -this.§]!$§.length)
         {
            return true;
         }
         return false;
      ...
      public function updatePositions() : void
      {
         ...
         while(_loc1_ < this.§]!$§.length)
         {
            ...
            if(_loc3_ > -this.§#"Y§ && _loc3_ < this.§0O§ - this.§#"Y§ && !this.§"D§(_loc1_))
            {
               _loc4_ = this.§;!Z§();
