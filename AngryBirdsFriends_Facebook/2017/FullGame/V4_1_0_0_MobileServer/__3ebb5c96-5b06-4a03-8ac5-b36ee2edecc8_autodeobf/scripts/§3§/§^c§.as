package §3§#9
{
   ...
   public class §^c§
   {
      ...
      public static function §]t§(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number) : §try §
      {
         ...
         while(_loc17_ < 2)
         {
            _loc12_[_loc17_] = §0!P§(_loc8_,_loc9_,_loc14_[_loc17_].x,_loc14_[_loc17_].y);
         ...
         var _loc19_:§try §;
         (_loc19_ = new §try §()).§0!j§ = Math.sqrt(_loc16_);
         _loc19_.§,#v§ = _loc18_;
         return _loc19_;
      }
      
      public static function §0!P§(param1:Number, param2:Number, param3:Number, param4:Number) : Number
      {
