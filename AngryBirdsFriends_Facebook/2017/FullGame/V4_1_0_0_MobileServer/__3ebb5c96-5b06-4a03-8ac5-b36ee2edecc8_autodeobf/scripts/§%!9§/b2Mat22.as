package §%!9§
{
   public class b2Mat22
   {
      ...
      public static function §%"l§(param1:Number) : b2Mat22
      {
      ...
      public static function §;!I§(param1:b2Vec2, param2:b2Vec2) : b2Mat22
      {
      ...
      public function §?!A§(param1:b2Vec2, param2:b2Vec2) : void
      {
      ...
      public function §2"Q§(param1:b2Mat22) : void
      {
         this.col1.SetV(param1.col1);
         this.col2.SetV(param1.col2);
      }
      
      public function §4"4§(param1:b2Mat22) : void
      {
      ...
      public function §<g§(param1:b2Mat22) : b2Mat22
      {
      ...
      public function §78§(param1:b2Vec2, param2:Number, param3:Number) : b2Vec2
      {
