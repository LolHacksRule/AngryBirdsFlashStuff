package §##-§
{
   ...
   public class SHA256
   {
      ...
      public static function §0"x§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §9v§(_loc2_);
         return §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true);
      }
      
      public static function hashBytes(param1:ByteArray) : String
      {
         var _loc2_:Array = §[!c§(param1);
         var _loc3_:ByteArray = §9v§(_loc2_);
         return §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true);
      }
      ...
      private static function §9v§(param1:Array) : ByteArray
      {
         var _loc15_:int = 0;
         var _loc16_:int = 0;
         var _loc17_:int = 0;
         ...
         while(_loc13_ < _loc11_)
         {
            ...
            while(_loc23_ < 64)
            {
               ...
               {
                  _loc30_ = §=!h§.§ $1§(_loc12_[_loc23_ - 15],7) ^ §=!h§.§ $1§(_loc12_[_loc23_ - 15],18) ^ _loc12_[_loc23_ - 15] >>> 3;
                  _loc31_ = §=!h§.§ $1§(_loc12_[_loc23_ - 2],17) ^ §=!h§.§ $1§(_loc12_[_loc23_ - 2],19) ^ _loc12_[_loc23_ - 2] >>> 10;
                  _loc12_[_loc23_] = _loc12_[_loc23_ - 16] + _loc30_ + _loc12_[_loc23_ - 7] + _loc31_;
               }
               _loc24_ = §=!h§.§ $1§(_loc15_,2) ^ §=!h§.§ $1§(_loc15_,13) ^ §=!h§.§ $1§(_loc15_,22);
               _loc25_ = _loc15_ & _loc16_ ^ _loc15_ & _loc17_ ^ _loc16_ & _loc17_;
               _loc26_ = _loc24_ + _loc25_;
               _loc27_ = §=!h§.§ $1§(_loc19_,6) ^ §=!h§.§ $1§(_loc19_,11) ^ §=!h§.§ $1§(_loc19_,25);
      ...
      private static function §[!c§(param1:ByteArray) : Array
      {
