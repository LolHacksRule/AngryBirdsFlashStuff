package §9#K§
{
   public class b2Settings
   {
      ...
      public static const §6!`§:int = 65535;
      ...
      public static const §1"@§:Number = 0.05;
      
      public static const §8#v§:Number = 0.005;
      
      public static const §##D§:Number = 0.007;
      
      public static var b2_linearSlop:Number = §1"@§;
      
      public static const §1#d§:Number = b2_linearSlop - §8#v§;
      ...
      public static const §#M§:Number = 0.01;
      
      public static const §+W§:Number = 0.1;
      
      public static var b2_linearSleepTolerance:Number = §^"z§;
