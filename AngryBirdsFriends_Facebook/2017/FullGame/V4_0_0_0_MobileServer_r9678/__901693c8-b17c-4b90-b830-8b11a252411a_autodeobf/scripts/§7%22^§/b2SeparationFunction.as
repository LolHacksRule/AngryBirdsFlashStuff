package §7"^§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §6#Y§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§9!a§ = §^#z§;
            _loc7_ = this.§<"W§.§^!v§(param1.indexA[0]);
            _loc10_ = this.§6!<§.§^!v§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§3#h§.x = _loc15_ - _loc13_;
            this.§3#h§.y = _loc16_ - _loc14_;
            this.§3#h§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§9!a§ = § ">§;
            _loc8_ = this.§<"W§.§^!v§(param1.indexA[0]);
            _loc9_ = this.§<"W§.§^!v§(param1.indexA[1]);
            _loc10_ = this.§6!<§.§^!v§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§3#h§ = b2Math.§""d§(b2Math.§ "&§(_loc9_,_loc8_),1);
            this.§3#h§.Normalize();
            _loc20_ = this.§3#h§;
         ...
         {
            this.§9!a§ = §"c§;
            _loc11_ = this.§6!<§.§^!v§(param1.indexB[0]);
            _loc12_ = this.§6!<§.§^!v§(param1.indexB[1]);
            _loc7_ = this.§<"W§.§^!v§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§3#h§ = b2Math.§""d§(b2Math.§ "&§(_loc12_,_loc11_),1);
            this.§3#h§.Normalize();
            _loc20_ = this.§3#h§;
         ...
         else
         {
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§0"E§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§0"E§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §^#z§:
               _loc3_ = b2Math.§%§(param1.R,this.§3#h§);
               _loc4_ = b2Math.§%§(param2.R,this.§3#h§.§',§());
               _loc5_ = this.§<"W§.§5#<§(_loc3_);
               _loc6_ = this.§6!<§.§5#<§(_loc4_);
               _loc7_ = b2Math.§^#j§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§^#j§(param2,_loc6_)).x - _loc7_.x) * this.§3#h§.x + (_loc8_.y - _loc7_.y) * this.§3#h§.y);
            case § ">§:
               _loc10_ = b2Math.§`$%§(param1.R,this.§3#h§);
            ...
            case §"c§:
               _loc10_ = b2Math.§`$%§(param2.R,this.§3#h§);
