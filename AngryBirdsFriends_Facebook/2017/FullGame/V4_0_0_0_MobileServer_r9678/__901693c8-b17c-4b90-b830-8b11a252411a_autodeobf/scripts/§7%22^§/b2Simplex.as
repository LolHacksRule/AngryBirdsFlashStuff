   ...
   class b2Simplex
   {
      ...
      public function § &§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         while(_loc9_ < this.§]"A§)
         {
            ...
            _loc10_.§,9§ = b2Math.§^#j§(param3,_loc6_);
            _loc10_.§7#%§ = b2Math.§^#j§(param5,_loc7_);
            _loc10_.w = b2Math.§ "&§(_loc10_.§7#%§,_loc10_.§,9§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§]"A§ > 1)
      ...
      public function §"j§() : b2Vec2
      {
         ...
         switch(this.§]"A§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§?"l§(_loc1_,this.m_v1.w.§',§());
               if(_loc2_ > 0)
               {
                  return b2Math.§6#M§(1,_loc1_);
               }
               return b2Math.§""d§(_loc1_,1);
               break;
            default:
      ...
      public function §6"9§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§]"A§)
         {
            case 0:
      ...
      public function §"i§() : Number
      {
         switch(this.§]"A§)
         {
            ...
            case 3:
               return b2Math.§?"l§(b2Math.§ "&§(this.m_v2.w,this.m_v1.w),b2Math.§ "&§(this.m_v3.w,this.m_v1.w));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§?"l§(_loc4_,_loc9_)) * b2Math.§?"l§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§?"l§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§?"l§(_loc1_,_loc2_);
