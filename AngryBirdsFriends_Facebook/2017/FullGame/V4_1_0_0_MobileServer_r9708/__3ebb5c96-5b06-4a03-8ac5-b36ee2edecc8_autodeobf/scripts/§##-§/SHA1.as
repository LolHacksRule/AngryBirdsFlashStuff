package §##-§
{
   ...
   public class SHA1
   {
      ...
      public static function §0"x§(param1:String) : String
      {
         ...
         return §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true);
      }
      
      public static function hashBytes(param1:ByteArray) : String
      {
         var _loc2_:Array = SHA1.§[!c§(param1);
         var _loc3_:ByteArray = §9v§(_loc2_);
         return §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true) + §=!h§.§@!Y§(_loc3_.readInt(),true);
      }
