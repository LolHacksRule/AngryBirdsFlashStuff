package §7"^§
{
   ...
   public class b2Collision
   {
      ...
      private static var §="e§:Vector.<§0!a§> = §<U§();
      
      private static var s_clipPoints1:Vector.<§0!a§> = §<U§();
      
      private static var s_clipPoints2:Vector.<§0!a§> = §<U§();
      
      private static var §2!G§:Vector.<int> = new Vector.<int>(1);
      ...
      private static var §9"b§:b2Vec2 = new b2Vec2();
      
      private static var §4"m§:b2Vec2 = new b2Vec2();
      ...
      public static function §2N§(param1:Vector.<§0!a§>, param2:Vector.<§0!a§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§0!a§ = null;
         var _loc6_:int = 0;
      ...
      public static function §;#V§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §8#^§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §8#^§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §8#^§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §8#^§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §=#r§(param1:Vector.<§0!a§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§0!a§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§>#B§;
         var _loc8_:Vector.<b2Vec2> = param2.§2$§;
         var _loc9_:int = param5.§>#B§;
         ...
         _loc20_.id.§&0§.§4#R§ = param4;
         _loc20_.id.§&0§.§@!U§ = _loc21_;
         _loc20_.id.§&0§.§+^§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§&0§.§4#R§ = param4;
         _loc20_.id.§&0§.§@!U§ = _loc22_;
         _loc20_.id.§&0§.§+^§ = 1;
      }
      
      private static function §<U§() : Vector.<§0!a§>
      {
         var _loc1_:Vector.<§0!a§> = new Vector.<§0!a§>(2);
         _loc1_[0] = new §0!a§();
         _loc1_[1] = new §0!a§();
         return _loc1_;
      }
      
      public static function §&#9§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§0!a§ = null;
         ...
         param1.§@"i§ = 0;
         var _loc7_:Number = param2.§[1§ + param4.§[1§;
         var _loc8_:int = 0;
         §2!G§[0] = _loc8_;
         var _loc9_:Number = §;#V§(§2!G§,param2,param3,param4,param5);
         _loc8_ = §2!G§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§9!a§ = b2Manifold.§ ">§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§0!a§> = §="e§;
         §=#r§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§>#B§;
         ...
         var _loc37_:Vector.<§0!a§> = s_clipPoints1;
         var _loc38_:Vector.<§0!a§> = s_clipPoints2;
         if((_loc39_ = §2N§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §2N§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§#!F§.SetV(_loc27_);
      ...
      public static function §+=§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§[1§ + param4.§[1§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§9!a§ = b2Manifold.§ "2§;
         param1.m_localPoint.SetV(param2.§6"a§);
         param1.§#!F§.§2!9§();
         param1.§@"i§ = 1;
         param1.§,"m§[0].m_localPoint.SetV(param4.§6"a§);
         param1.§,"m§[0].m_id.key = 0;
      }
      ...
      public static function §%#&§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§[1§ + param4.§[1§;
         var _loc21_:int = param2.§>#B§;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§@"i§ = 1;
            param1.§9!a§ = b2Manifold.§ ">§;
            param1.§#!F§.x = _loc15_ - _loc27_.x;
            param1.§#!F§.y = _loc16_ - _loc27_.y;
            param1.§#!F§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§@"i§ = 1;
            param1.§9!a§ = b2Manifold.§ ">§;
            param1.§#!F§.x = _loc15_ - _loc28_.x;
            param1.§#!F§.y = _loc16_ - _loc28_.y;
            param1.§#!F§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§,"m§[0].m_localPoint.SetV(param4.§6"a§);
            param1.§,"m§[0].m_id.key = 0;
      ...
      {
         var _loc3_:b2Vec2 = param2.§""x§;
         var _loc4_:b2Vec2 = param1.§%"i§;
