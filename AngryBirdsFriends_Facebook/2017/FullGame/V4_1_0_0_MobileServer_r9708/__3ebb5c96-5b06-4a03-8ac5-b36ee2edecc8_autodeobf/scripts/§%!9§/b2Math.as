package §%!9§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§;!I§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §""d§(param1:b2Vec2, param2:Number) : b2Vec2
      {
         return new b2Vec2(param2 * param1.y,-param2 * param1.x);
      }
      
      public static function §6#M§(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §=9§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
      ...
      public static function §3#t§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §?#A§(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§;!I§(§3#t§(param1.col1,param2.col1),§3#t§(param1.col2,param2.col2));
      }
      
      public static function §2!f§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§;!I§(§`$%§(param1,param2.col1),§`$%§(param1,param2.col2));
      }
      ...
      public static function §7$$§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         ...
         return b2Mat22.§;!I§(_loc3_,_loc4_);
      }
      ...
      public static function §-"a§(param1:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§^"§(param1.x),§^"§(param1.y));
      }
      
      public static function §18§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§;!I§(§-"a§(param1.col1),§-"a§(param1.col2));
      }
      ...
      public static function §0"E§(param1:Number, param2:Number, param3:Number) : Number
      {
         return param1 < param2 ? Number(param2) : (param1 > param3 ? Number(param3) : Number(param1));
      }
      
      public static function §0#5§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §#"W§(param2,§?#_§(param1,param3));
      }
      
      public static function §'!c§(param1:Array, param2:Array) : void
      {
         var _loc3_:* = param1[0];
         param1[0] = param2[0];
         param2[0] = _loc3_;
      ...
      public static function §0V§(param1:uint) : uint
      {
      ...
      public static function §9"X§(param1:uint) : Boolean
      {
