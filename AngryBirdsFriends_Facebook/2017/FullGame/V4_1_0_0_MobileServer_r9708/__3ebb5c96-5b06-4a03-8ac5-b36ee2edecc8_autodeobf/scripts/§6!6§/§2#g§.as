package §6!6§
{
   public class §2#g§ extends §6!r§
   {
       
      
      public function §2#g§(param1:String, param2:int, param3:int, param4:String, param5:Number, param6:String, param7:String, param8:String)
      {
         super(param1,param2,param3,param4,param5,param6,param7,param8);
      }
      
      public function §^#v§(param1:Object, param2:Object) : void
      {
      ...
      private function §9!,§(param1:Object, param2:Boolean = false) : void
      {
         ...
         var _loc15_:§%#1§ = new §%#1§(_loc3_,null,_loc6_,_loc5_,_loc7_,_loc8_,_loc9_,param2,_loc10_,_loc11_,_loc12_,_loc13_,_loc14_);
         § #r§.push(_loc15_);
      }
   }
}
