package §+#f§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      b2internal var § #y§:b2EdgeShape;
      
      b2internal var §9!3§:b2EdgeShape;
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§&$0§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§4!@§ = this.§&$0§.Normalize();
         this.§]q§.Set(this.§&$0§.y,-this.§&$0§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§]q§.x - this.§&$0§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§]q§.y - this.§&$0§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§]q§.x + this.§&$0§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§]q§.y + this.§&$0§.y) + this.m_v2.y);
      ...
      public function §2S§(param1:b2Transform) : b2Vec2
      {
      ...
      b2internal function §7f§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§9!3§ = param1;
