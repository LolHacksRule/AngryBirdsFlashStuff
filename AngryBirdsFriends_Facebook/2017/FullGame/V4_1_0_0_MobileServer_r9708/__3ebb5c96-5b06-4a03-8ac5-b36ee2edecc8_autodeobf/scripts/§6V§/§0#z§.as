package §6V§
{
   ...
   public class §0#z§
   {
      ...
      public static function §1!7§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         jsonString = §`!m§(luaString,emptyObjectAsArray);
         try
         {
      ...
      public static function §40§(param1:String, param2:Boolean = false) : Object
      {
         var returnObject:Object = null;
      ...
      public static function §`!m§(param1:String, param2:Boolean = false) : String
      {
         ...
         return §6!d§(param1,param2);
      }
      
      private static function §6!d§(param1:String, param2:Boolean) : String
      {
      ...
      private static function §7!l§(param1:Object, param2:int) : String
      {
         var _loc4_:* = null;
         var _loc5_:int = 0;
         param2++;
         ...
         for(_loc4_ in param1)
         {
            ...
            _loc3_ += _loc4_ + " = " + §%E§(param1[_loc4_],param2);
            if(param2 > 1)
            {
               _loc3_ += ",";
            }
      ...
      private static function §%E§(param1:*, param2:int) : String
      {
         ...
         else
         {
            ...
            if(param1 is Array)
            {
               ...
               {
                  _loc3_ += §%E§(param1[_loc6_],param2) + (_loc6_ < param1.length - 1 ? "," : "");
                  _loc6_++;
               }
               return _loc3_ + "}";
            }
