package §->§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function §8;§(param1:DisplayObject, param2:DisplayObject) : void
      {
         ...
         this.§2!7§(_loc3_,_loc4_);
      }
      
      public function §2!7§(param1:int, param2:int) : void
      {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            ...
            § I§(_loc7_,§0j§);
            transformCoords(§0j§,_loc3_,_loc4_,§2n§);
            if(_loc8_ = _loc7_.hitTest(§2n§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      public function §[R§(param1:Event) : void
      {
         if(param1.bubbles)
         {
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§=b§(this,param1.type,_loc2_);
      ...
      private function §=b§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               this.§=b§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
