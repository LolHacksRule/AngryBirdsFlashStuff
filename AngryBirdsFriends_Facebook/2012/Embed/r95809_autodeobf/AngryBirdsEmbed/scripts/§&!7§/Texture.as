package §&!7§
{
   ...
   public class Texture
   {
      ...
      public static function §4?§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §&!7§.Texture
      {
         return §4&§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §4&§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §&!7§.Texture
      {
         ...
         _loc10_ = new §?U§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§3! §.§;!=§)
         {
            _loc10_.§0s§(param2);
         }
      ...
      public static function §4i§(param1:Context3D, param2:ByteArray) : §&!7§.Texture
      {
         if(param1 == null)
         {
            throw new §>O§();
         ...
         var _loc9_:§?U§ = new §?U§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§3! §.§;!=§)
         {
            _loc9_.§0s§(param2);
         }
      ...
      public static function §9!1§(param1:§&!7§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §&!7§.Texture
      {
         var _loc4_:§&!7§.Texture;
         (_loc4_ = new §&6§(param1,param2)).§'H§ = param3;
         return _loc4_;
      }
      
      public static function §0g§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §&!7§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§&!7§.Texture = §4&§(param1,_loc6_,false,param5);
         if(!§3! §.§;!=§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§?!5§, param2:int, param3:int) : void
      {
         ...
         if(this.§'H§)
         {
            ...
            param1.§'c§(param2,-this.§'H§.x,-this.§'H§.y);
            param1.§'c§(param2 + 1,-_loc4_,-this.§'H§.y);
            param1.§'c§(param2 + 2,-this.§'H§.x,-_loc5_);
            param1.§'c§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      
      public function get §>Z§() : Rectangle
      {
