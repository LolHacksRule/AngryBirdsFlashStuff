package §?m§
{
   ...
   public class SWFWheel
   {
      ...
      public static function initialize(param1:Stage) : void
      {
         ...
         _stage = param1;
         ExternalInterface.call(§ e§);
         ExternalInterface.call(§>&§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §4!0§ = ExternalInterface.call(§1!!§,ExternalInterface.objectID);
         if(§4!0§ == §6;§)
         {
            return;
         }
      ...
      public static function get §75§() : Boolean
      {
         return §`!@§;
      }
      
      public static function set §75§(param1:Boolean) : void
      {
         §`!@§ = param1;
      }
