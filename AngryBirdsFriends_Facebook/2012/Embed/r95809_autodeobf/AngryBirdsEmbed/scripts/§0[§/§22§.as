package §0[§
{
   ...
   public class §22§ extends §!!6§
   {
      
      public static var §'!8§:Boolean = false;
       
      
      public function §22§(param1:Object, param2:BitmapData)
      {
         super(param2);
         this.§#+§(param1);
      }
      
      private static function §;C§(param1:§4Q§, param2:int, param3:int) : void
      {
         if(param1.§@v§.top < 0)
         {
            param1.§@v§.top = 0;
