package §[V§
{
   ...
   public class §2!@§ extends §1;§
   {
      ...
      public function §3!3§(param1:MovieClip, param2:String = null, param3:int = 0) : void
      {
         ...
         {
            mClip.addChildAt(this.§1!+§,this.§2m§ - 1);
         }
      }
      ...
      override public function setComponentState(param1:String) : void
      {
         ...
         if(this.§1!+§ && (mParentContainer.mParentContainer as §#G§).§,!1§)
         {
            if(param1 == COMPONENT_STATE_ACTIVE_DEFAULT)
            {
               this.§1!+§.filters = [(mParentContainer.mParentContainer as §#G§).§,!1§];
            }
            else
            {
               this.§1!+§.filters = [];
