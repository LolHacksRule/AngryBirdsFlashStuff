package §!T§
{
   ...
   public class §>G§
   {
      ...
      public static function §`z§(param1:XMLList, param2:XMLList, param3:XMLList) : void
      {
         var _loc4_:XML = null;
         §1m§ = new Array();
      ...
      public static function §+W§(param1:XMLList, param2:XMLList) : void
      {
         var _loc3_:XML = null;
         var _loc4_:§^^§ = null;
         for each(_loc3_ in param1.Material)
         {
            if(_loc4_ = §=g§(_loc3_.@id))
            {
               _loc4_.§^!3§(_loc3_);
            }
            else
      ...
      {
         §1m§[§1m§.length] = new §^^§(param1,param2,param3,param4,param5,param6,param7,param8);
      }
      
      public static function §=g§(param1:String) : §^^§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §1m§.length)
         {
            if((§1m§[_loc2_] as §^^§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §^^§(§1m§[_loc2_]);
            }
            _loc2_++;
