package §`t§
{
   ...
   public class §0V§
   {
      ...
      public function §0V§(param1:*)
      {
         super();
         this.§@a§ = this.§6g§(param1);
      }
      ...
      private function §6g§(param1:*) : String
      {
      ...
      private function §6!"§(param1:Array) : String
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§6g§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §'!5§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§`!<§(v.@name.toString()) + ":" + this.§6g§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
