package §-z§
{
   ...
   public class §1!$§ extends §0w§
   {
      ...
      protected function §;H§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc16_:§%i§ = null;
         var _loc3_:Dictionary = this.§3!2§(param2);
      ...
      private function §3!2§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
