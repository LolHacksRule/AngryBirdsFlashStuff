package §[n§
{
   ...
   public class §7!@§
   {
      ...
      private function §8W§(param1:Array) : void
      {
         var _loc2_:Array = null;
         var _loc3_:String = null;
         if(param1 != null)
         {
            _loc2_ = this.§7Q§(param1);
      ...
      private function §7Q§(param1:Array) : Array
      {
         var _loc3_:String = null;
         var _loc2_:Array = [];
      ...
      protected function §%0§(param1:String, param2:Array) : Boolean
      {
         ...
         try
         {
            this.§4!'§[name] = this.§76§(frameNames);
         }
         catch(e:Error)
         {
            result = false;
      ...
      private function §76§(param1:Array) : §2!9§
      {
         var _loc3_:String = null;
         var _loc4_:§#H§ = null;
         var _loc2_:§2!9§ = new §2!9§();
         for each(_loc3_ in param1)
         {
            _loc4_ = this.§^s§.§&P§(_loc3_);
      ...
      protected function §7!<§(param1:String, param2:Array) : void
      {
         ...
         for each(_loc4_ in param2)
         {
            _loc5_ = _loc4_[0];
            _loc6_ = _loc4_[1];
            _loc3_.§%0§(_loc5_,this.§76§(_loc6_));
         }
         this.§4!'§[param1] = _loc3_;
      }
      
      public function § E§(param1:String) : §2!9§
      {
