package §3&§
{
   ...
   public class SWFWheel
   {
      ...
      public static const §9!9§:int = 1;
      
      public static const §,l§:int = 2;
      
      public static const §?u§:String = "SWFWheel.join";
      
      public static const §6!E§:String = "SWFWheel.getState";
      ...
      public static function initialize(param1:Stage) : void
      {
         ...
         §8!>§ = ExternalInterface.call(§6!E§,ExternalInterface.objectID);
         if(§8!>§ == § !>§)
         {
            return;
         }
      ...
      public static function get §8v§() : int
      {
         return §8!>§;
      }
