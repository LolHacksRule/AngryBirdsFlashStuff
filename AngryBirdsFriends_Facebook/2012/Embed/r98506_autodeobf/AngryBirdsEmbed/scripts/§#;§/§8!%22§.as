package §#;§
{
   ...
   public class §8!"§ extends b2ContactListener
   {
      ...
      {
         var _loc2_:Boolean = this.§+!@§.§3!3§.objects.objectCollision(param1.GetFixtureA().GetBody().GetUserData(),param1.GetFixtureB().GetBody().GetUserData());
         if(_loc2_)
         {
