package §^V§
{
   ...
   public class §-A§
   {
      ...
      public static function §<!A§(param1:XMLList) : void
      {
         ...
         for each(_loc2_ in param1.Shape)
         {
            if(_loc2_.@shape == "CIRCLE" || _loc2_.@shape == "POLYGON" || _loc2_.@shape == "NONE")
            {
               ...
               {
                  § x§(_loc3_,_loc4_,_loc5_,_loc2_.@flipAngleCorrection);
               }
            }
            else
            {
               ...
               §%!3§(_loc2_.@id,_loc2_.@shape,_loc2_.@width,_loc2_.@height,_loc2_.@flipAngleCorrection);
            }
         }
      }
      
      public static function §%!3§(param1:String, param2:String, param3:Number, param4:Number, param5:Number) : void
      {
         §[2§[§[2§.length] = new §4a§(param1,param2,param3,param4,param5);
      }
      
      public static function § x§(param1:String, param2:String, param3:Array, param4:Number) : void
      {
         var _loc5_:§4a§;
         (_loc5_ = new §4a§(param1,param2,-1,-1,param4)).§;@§(param3);
         _loc5_.§[O§();
         §[2§[§[2§.length] = _loc5_;
      }
      ...
      {
         var _loc5_:§4a§;
         (_loc5_ = new §4a§(param1,param2,param3,param3)).§;@§(param4);
         §[2§[§[2§.length] = _loc5_;
      }
      
      public static function §2m§(param1:String) : §4a§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §[2§.length)
         {
            if((§[2§[_loc2_] as §4a§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §4a§(§[2§[_loc2_]);
            }
            _loc2_++;
