package §#+§
{
   public class §61§
   {
      ...
      public static function get §0q§() : Array
      {
         return §[!9§;
      }
      ...
      {
         §[!9§[§[!9§.length] = new §^i§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10);
      }
      
      public static function §5!7§(param1:String) : §^i§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §[!9§.length)
         {
            if((§[!9§[_loc2_] as §^i§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §[!9§[_loc2_] as §^i§;
            }
            _loc2_++;
         }
         return null;
      ...
      public static function §46§() : String
      {
         var _loc1_:int = Math.random() * §[!9§.length;
         return (§[!9§[_loc1_] as §^i§).mName;
      }
   }
}
