package §>K§
{
   ...
   public class §@U§
   {
      ...
      {
         var _loc2_:BitmapData = §5B§(param1);
         return §[!J§.encode(_loc2_);
      }
      
      public static function §!]§(param1:DisplayObject, param2:Number) : ByteArray
      {
         var _loc3_:BitmapData = §5B§(param1);
         var _loc4_:§1!H§;
         return (_loc4_ = new §1!H§(param2)).encode(_loc3_);
      }
      
      public static function §5B§(param1:DisplayObject) : BitmapData
      {
      ...
      public static function §1!8§(param1:String, param2:Function) : void
      {
