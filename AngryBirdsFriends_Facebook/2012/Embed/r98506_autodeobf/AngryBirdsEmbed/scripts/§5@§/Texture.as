package §5@§
{
   ...
   public class Texture
   {
      ...
      public static function §?=§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §5@§.Texture
      {
         return §%9§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §%9§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §5@§.Texture
      {
         ...
         _loc10_ = new §,N§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§8o§.§6m§)
         {
            _loc10_.§9!$§(param2);
         }
         ...
         return new §8!<§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §;!,§(param1:Context3D, param2:ByteArray) : §5@§.Texture
      {
         if(param1 == null)
         {
            throw new §@1§();
         ...
         var _loc9_:§,N§ = new §,N§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§8o§.§6m§)
         {
            _loc9_.§9!$§(param2);
         }
      ...
      public static function §8;§(param1:§5@§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §5@§.Texture
      {
         var _loc4_:§5@§.Texture;
         (_loc4_ = new §8!<§(param1,param2)).§+X§ = param3;
         return _loc4_;
      }
      
      public static function §@!B§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §5@§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§5@§.Texture = §%9§(param1,_loc6_,false,param5);
         if(!§8o§.§6m§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§&H§, param2:int, param3:int) : void
      {
         ...
         if(this.§+X§)
         {
            ...
            _loc4_ = this.§+X§.width + this.§+X§.x - this.width;
            _loc5_ = this.§+X§.height + this.§+X§.y - this.height;
            param1.§;!=§(param2,-this.§+X§.x,-this.§+X§.y);
            param1.§;!=§(param2 + 1,-_loc4_,-this.§+X§.y);
            param1.§;!=§(param2 + 2,-this.§+X§.x,-_loc5_);
      ...
      {
         return !!this.§+X§ ? this.§+X§.clone() : new Rectangle(0,0,this.width,this.height);
      }
