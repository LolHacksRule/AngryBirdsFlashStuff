package §',§
{
   ...
   public class §8f§ extends §6H§
   {
       
      
      public function §8f§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§7g§(param1,param2);
      }
      
      protected function §7g§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc16_:§<v§ = null;
         var _loc3_:Dictionary = this.§`f§(param2);
      ...
      private function §`f§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§9!?§(_loc4_,_loc6_.@name);
