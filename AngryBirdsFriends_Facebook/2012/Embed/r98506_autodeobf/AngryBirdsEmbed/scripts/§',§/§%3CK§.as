package §',§
{
   ...
   public class §<K§ extends §6H§
   {
      ...
      private static function §5!B§(param1:§<v§, param2:int, param3:int) : void
      {
         if(param1.§?!$§.top < 0)
         {
            param1.§?!$§.top = 0;
      ...
      protected function §7g§(param1:Object) : void
      {
         var _loc4_:* = null;
