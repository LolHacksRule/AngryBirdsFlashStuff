package §-!'§
{
   ...
   public class §in § extends § >§
   {
      ...
      public function §in §(param1:XML, param2:§in §, param3:§&"§, param4:MovieClip = null)
      {
         var _loc5_:XML = null;
         var _loc6_:XML = null;
         var _loc7_:XML = null;
         ...
         {
            this.§%!;§.push(new §in §(_loc5_,this,null));
         }
         for each(_loc6_ in param1.Repeater)
         {
            this.§%!;§.push(new §#7§(_loc6_,this,null));
         }
         for each(_loc7_ in param1.Button)
         {
            this.§%!;§.push(new §;f§(_loc7_,this));
         }
         for each(_loc8_ in param1.TextField)
         {
            this.§%!;§.push(new §&!H§(_loc8_,this));
         }
         ...
         {
            this.§%!;§.push(new § !4§(_loc10_,this));
         }
         for each(_loc11_ in param1.Slider)
         {
            this.§%!;§.push(new §>U§(_loc11_,this));
         }
      ...
      public function §4g§(param1:§ >§) : void
      {
      ...
      public function §8!$§(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            {
               §1a§.log("WARNING: UIContainer(" + mName + ") setItemVisibility can not be done because item " + param1 + " does not exist");
            }
         }
      }
      ...
      public function getItemByName(param1:String) : § >§
      {
         ...
         for each(_loc2_ in this.§%!;§)
         {
            ...
            if(_loc2_ is §in §)
            {
               _loc3_ = (_loc2_ as §in §).getItemByName(param1);
               if(_loc3_ != null)
               {
                  return _loc3_;
               }
