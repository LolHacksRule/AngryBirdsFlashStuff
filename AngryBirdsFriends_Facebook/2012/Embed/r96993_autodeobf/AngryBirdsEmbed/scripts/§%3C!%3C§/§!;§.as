package §<!<§
{
   ...
   public class §!;§
   {
      ...
      {
         §4@§[§4@§.length] = new §>'§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13);
      }
      
      public static function §2p§(param1:String) : §>'§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §4@§.length)
         {
            if(§>'§(§4@§[_loc2_]).mName.toLowerCase() == param1.toLowerCase())
            {
               return §>'§(§4@§[_loc2_]);
            }
            _loc2_++;
         }
         §1a§.log("WARNING: LevelItemResourcePaths -> getResourcePathSound request has no return value, this path does not exist: " + param1);
         return null;
      }
   }
}
