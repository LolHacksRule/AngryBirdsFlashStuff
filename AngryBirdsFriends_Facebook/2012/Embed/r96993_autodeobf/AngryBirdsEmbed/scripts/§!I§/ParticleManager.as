package §!I§
{
   ...
   public class ParticleManager
   {
      ...
      private static var §9i§:Vector.<Texture> = new Vector.<Texture>();
      ...
      public static function §;l§(param1:String, param2:§3W§) : §`%§
      {
         ...
         var _loc5_:Texture = param2.§=_§(_loc3_.bitmapData,_loc4_);
         if(§9i§.indexOf(_loc5_) < 0)
         {
            §9i§.push(_loc5_);
         }
