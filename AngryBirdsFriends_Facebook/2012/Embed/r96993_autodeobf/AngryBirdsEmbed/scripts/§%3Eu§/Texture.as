package §>u§
{
   ...
   public class Texture
   {
      ...
      public static function §`P§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §>u§.Texture
      {
         return §#n§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §#n§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §>u§.Texture
      {
      ...
      public static function §0!"§(param1:Context3D, param2:ByteArray) : §>u§.Texture
      {
         if(param1 == null)
         {
            throw new §8[§();
      ...
      public static function §]C§(param1:§>u§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §>u§.Texture
      {
         var _loc4_:§>u§.Texture;
         (_loc4_ = new §'!?§(param1,param2)).§#!7§ = param3;
         return _loc4_;
      }
      
      public static function § !?§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §>u§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§>u§.Texture = §#n§(param1,_loc6_,false,param5);
         if(!§<n§.§>m§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§=§, param2:int, param3:int) : void
      {
         ...
         if(this.§#!7§)
         {
            ...
            param1.§;!$§(param2,-this.§#!7§.x,-this.§#!7§.y);
            param1.§;!$§(param2 + 1,-_loc4_,-this.§#!7§.y);
            param1.§;!$§(param2 + 2,-this.§#!7§.x,-_loc5_);
      ...
      public function get root() : §>u§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §>u§.Texture
      {
         return this;
      }
