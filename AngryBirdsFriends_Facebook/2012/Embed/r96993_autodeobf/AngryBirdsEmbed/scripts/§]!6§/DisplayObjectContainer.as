   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         if(param1 >= 0 && param1 < this.numChildren)
         {
            ...
            _loc3_.dispatchEvent(new Event(Event.§[B§,true));
            if(stage)
            {
      ...
      public function §try§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            ...
            §5D§(_loc7_,§'i§);
            transformCoords(§'i§,_loc3_,_loc4_,§1+§);
            if(_loc8_ = _loc7_.hitTest(§1+§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
