package §`i§
{
   ...
   public class §[F§ extends b2ContactListener
   {
      ...
      {
         var _loc2_:Boolean = this.§8I§.§"8§.objects.objectCollision(param1.GetFixtureA().GetBody().GetUserData(),param1.GetFixtureB().GetBody().GetUserData());
         if(_loc2_)
         {
