package §;!%§
{
   ...
   public class §?W§
   {
      ...
      private function §=!<§(param1:*) : String
      {
         ...
         if(param1 is Array)
         {
            return this.§1k§(param1 as Array);
         }
      ...
      private function §1k§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
      ...
      private function §5c§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§use §(v.@name.toString()) + ":" + this.§=!<§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
