package §8j§
{
   ...
   public class §=§
   {
      ...
      {
         this.§=A§ = new Vector.<Number>(12,true);
         super();
         this.§%0§ = new ByteArray();
         this.§%0§.endian = Endian.LITTLE_ENDIAN;
         this.§%0§.length = param1 * §;[§ * §!g§;
         var _loc3_:int = 0;
         while(_loc3_ < param1 * §;[§)
         {
            this.§%0§.writeFloat(0);
         ...
         this.§0!#§ = new Vector.<Number>(param1 * §@+§,true);
      ...
      public function copyTo(param1:§=§, param2:int, param3:Number, param4:Boolean, param5:Matrix3D) : void
      {
         ...
         if(param5)
         {
            param5.transformVectors(this.§"! §,this.§=A§);
            _loc8_ = 0;
            while(_loc8_ < _loc6_)
            {
               var _loc14_:*;
      ...
      public function §4J§(param1:int, param2:Number, param3:Number) : void
      {
      ...
      public function §]h§(param1:int, param2:Vector3D) : void
      {
      ...
      public function §78§(param1:int, param2:uint, param3:Number = 1.0) : void
      {
         var _loc4_:Number = (_loc4_ = !!this.§0m§ ? Number(param3) : Number(1)) / 255;
         var _loc5_:Number = §7f§.§[H§(param2) * _loc4_;
         var _loc6_:Number = §7f§.§'X§(param2) * _loc4_;
         var _loc7_:Number = §7f§.§"?§(param2) * _loc4_;
         this.§5h§(param1,1,_loc5_,_loc6_,_loc7_,param3);
      }
      
      private function §5h§(param1:int, param2:int, param3:Number, param4:Number, param5:Number, param6:Number) : void
      {
      ...
      public function §?U§(param1:int) : uint
      {
         ...
         var _loc3_:Number = !!this.§0m§ ? Number(this.§0!#§[_loc2_ + 3]) : Number(1);
         if(_loc3_ == 0)
         {
            return 0;
         }
         ...
         return §7f§.§%V§(_loc4_,_loc5_,_loc6_);
      }
      ...
      public function §=;§(param1:int, param2:Number) : void
      {
         ...
         if(this.§0m§)
         {
            this.§78§(param1,this.§?U§(param1),param2);
         }
         else
         {
            _loc3_ = param1 * §@+§ + 3;
      ...
      public function §4!@§(param1:int, param2:Matrix3D) : void
      {
         var _loc3_:int = param1 * §@6§;
         this.§=A§[0] = this.§"! §[_loc3_];
         this.§=A§[1] = this.§"! §[_loc3_ + 1];
         this.§=A§[2] = this.§"! §[_loc3_ + 2];
         param2.transformVectors(this.§=A§,this.§=A§);
         this.§"! §[_loc3_] = this.§=A§[0];
         this.§"! §[_loc3_ + 1] = this.§=A§[1];
         this.§"! §[_loc3_ + 2] = this.§=A§[2];
      }
      ...
      public function §'K§(param1:uint, param2:Number = 1.0) : void
      {
         ...
         var _loc3_:Number = !!this.§0m§ ? Number(param2) : Number(1);
         _loc3_ /= 255;
         var _loc4_:Number = §7f§.§[H§(param1) * _loc3_;
         var _loc5_:Number = §7f§.§'X§(param1) * _loc3_;
         var _loc6_:Number = §7f§.§"?§(param1) * _loc3_;
         this.§5h§(0,this.§%y§,_loc4_,_loc5_,_loc6_,param2);
      }
      ...
      public function setPremultipliedAlpha(param1:Boolean, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            ...
            {
               _loc5_ = this.§>!?§(0);
               _loc6_ = !!this.§0m§ ? Number(_loc5_) : Number(1);
      ...
      public function get §%F§() : Vector.<Number>
      {
         return this.§0!#§;
      }
