package §<!<§
{
   public class §2r§
   {
      ...
      public static function §7k§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
      ...
      private static function §4<§(param1:String, param2:Boolean) : String
      {
         ...
         for(; _loc11_ >= 0 || _loc13_ >= 0; _loc11_ = param1.indexOf("{",_loc12_ + 1))
         {
            ...
            {
               §§push(_loc15_.indexOf(":",1) < 0);
               if(!(_loc15_.indexOf(":",1) < 0))
               {
                  §§pop();
                  if(_loc15_.indexOf(":",1) > _loc15_.indexOf("{",1) && _loc15_.indexOf("{",1) > 0)
                  {
                     _loc16_ = true;
                     addr160:
                     if(_loc16_)
