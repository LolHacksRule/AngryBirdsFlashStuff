package §6!d§
{
   ...
   public class b2Collision
   {
      ...
      private static var §5=§:Vector.<§-!T§> = §3h§();
      
      private static var s_clipPoints1:Vector.<§-!T§> = §3h§();
      
      private static var s_clipPoints2:Vector.<§-!T§> = §3h§();
      
      private static var §1h§:Vector.<int> = new Vector.<int>(1);
      
      private static var §5^§:Vector.<int> = new Vector.<int>(1);
      
      private static var §5!O§:b2Vec2 = new b2Vec2();
      
      private static var §3z§:b2Vec2 = new b2Vec2();
      
      private static var §'!L§:b2Vec2 = new b2Vec2();
      
      private static var §5!d§:b2Vec2 = new b2Vec2();
      
      private static var §6!A§:b2Vec2 = new b2Vec2();
      ...
      public static function §^!&§(param1:Vector.<§-!T§>, param2:Vector.<§-!T§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§-!T§ = null;
         var _loc6_:int = 0;
      ...
      public static function §,!o§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§-y§;
         var _loc7_:Vector.<b2Vec2> = param1.§>P§;
         var _loc8_:Vector.<b2Vec2> = param1.§'h§;
         var _loc9_:int = param4.§-y§;
         var _loc10_:Vector.<b2Vec2> = param4.§>P§;
         _loc11_ = param2.R;
      ...
      public static function §@"?§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param2.§'h§;
         _loc9_ = param5.R;
         _loc8_ = param4.§'g§;
         ...
         var _loc17_:Number = §,!o§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §,!o§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §,!o§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §,!o§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §&E§(param1:Vector.<§-!T§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param2.§'h§;
         var _loc9_:int = param5.§-y§;
         var _loc10_:Vector.<b2Vec2> = param5.§>P§;
         var _loc11_:Vector.<b2Vec2> = param5.§'h§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§1Y§.§&!'§ = param4;
         _loc20_.id.§1Y§.§3!D§ = _loc21_;
         _loc20_.id.§1Y§.§6b§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§1Y§.§&!'§ = param4;
         _loc20_.id.§1Y§.§3!D§ = _loc22_;
         _loc20_.id.§1Y§.§6b§ = 1;
      }
      
      private static function §3h§() : Vector.<§-!T§>
      {
      ...
      public static function §!!+§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §1h§[0] = _loc8_;
         var _loc9_:Number = §@"?§(§1h§,param2,param3,param4,param5);
         _loc8_ = §1h§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§-!T§> = §5=§;
         §&E§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§-y§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§>P§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §5!O§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §3z§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §'!L§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §6!A§;
         _loc20_ = _loc14_.R;
      ...
      public static function §9u§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§=""§ = b2Manifold.§8`§;
         param1.m_localPoint.SetV(param2.§0!S§);
         param1.§;h§.§]!;§();
         param1.§`p§ = 1;
         param1.§"r§[0].m_localPoint.SetV(param4.§0!S§);
      ...
      public static function §!!;§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§^s§ + param4.§^s§;
         var _loc21_:int = param2.§-y§;
         var _loc22_:Vector.<b2Vec2> = param2.§>P§;
         var _loc23_:Vector.<b2Vec2> = param2.§'h§;
         var _loc24_:int = 0;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§`p§ = 1;
            param1.§=""§ = b2Manifold.§#!a§;
            param1.§;h§.x = _loc15_ - _loc27_.x;
            param1.§;h§.y = _loc16_ - _loc27_.y;
            param1.§;h§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§`p§ = 1;
            param1.§=""§ = b2Manifold.§#!a§;
            param1.§;h§.x = _loc15_ - _loc28_.x;
            param1.§;h§.y = _loc16_ - _loc28_.y;
            param1.§;h§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§"r§[0].m_localPoint.SetV(param4.§0!S§);
            param1.§"r§[0].m_id.key = 0;
      ...
      public static function §6!v§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§=!h§;
         var _loc4_:b2Vec2 = param1.§5"0§;
