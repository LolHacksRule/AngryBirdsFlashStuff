package §&I§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      b2internal var §>P§:Vector.<b2Vec2>;
      ...
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§9x§(param1,param2);
         return _loc3_;
      }
      
      public static function §2P§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §6"4§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§3!C§(param1,param2,param3,param4);
         return _loc5_;
      }
      ...
      b2internal static function §=!`§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§3>§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§3>§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            while(_loc3_ < this.§-y§)
            {
               this.§>P§[_loc3_].SetV(_loc2_.§>P§[_loc3_]);
      ...
      public function §`I§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§9x§(_loc3_,param2);
      }
      
      public function §9x§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§-y§)
         {
            this.§>P§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§-y§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§-y§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§@!W§(this.§>P§[_loc5_],this.§>P§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§1]§() > Number.MIN_VALUE);
            this.§'h§[_loc3_].SetV(b2Math.§61§(_loc6_,1));
            this.§'h§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§'g§ = §#!$§(this.§>P§,this.§-y§);
      }
      ...
      public function §'W§(param1:Number, param2:Number) : void
      {
         this.§-y§ = 4;
         this.§7,§(4);
         this.§>P§[0].Set(-param1,-param2);
         this.§>P§[1].Set(param1,-param2);
         this.§>P§[2].Set(param1,param2);
         this.§>P§[3].Set(-param1,param2);
         this.§'h§[0].Set(0,-1);
         this.§'h§[1].Set(1,0);
         this.§'h§[2].Set(0,1);
         this.§'h§[3].Set(-1,0);
      ...
      public function §3!C§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§-y§ = 4;
         this.§7,§(4);
         this.§>P§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§-y§)
         {
            this.§>P§[_loc6_] = b2Math.§0!6§(_loc5_,this.§>P§[_loc6_]);
            this.§'h§[_loc6_] = b2Math.§#-§(_loc5_.R,this.§'h§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §-!x§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§-y§ = 2;
         this.§7,§(2);
         this.§>P§[0].SetV(param1);
         this.§>P§[1].SetV(param2);
         this.§'g§.x = 0.5 * (param1.x + param2.x);
         this.§'g§.y = 0.5 * (param1.y + param2.y);
         this.§'h§[0] = b2Math.§61§(b2Math.§@!W§(param2,param1),1);
         this.§'h§[0].Normalize();
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§-y§)
         {
            _loc6_ = (_loc9_ = this.§>P§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§=!h§.x = _loc5_ - b2internal::^s;
         param1.§=!h§.y = _loc6_ - b2internal::^s;
         param1.§5"0§.x = _loc7_ + b2internal::^s;
         param1.§5"0§.y = _loc8_ + b2internal::^s;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§-y§ == 2)
         {
            param1.center.x = 0.5 * (this.§>P§[0].x + this.§>P§[1].x);
            param1.center.y = 0.5 * (this.§>P§[0].y + this.§>P§[1].y);
            param1.§9%§ = 0;
            param1.§;x§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§-y§)
         {
            _loc11_ = this.§>P§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§-y§ ? this.§>P§[int(_loc10_ + 1)] : this.§>P§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§]!U§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§5q§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§-y§)
         {
            _loc7_[_loc12_] = b2Math.§5q§(_loc5_,this.§>P§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§0!6§(param3,_loc24_.center));
                  return _loc24_.§9%§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§-y§;
         var _loc14_:int = (_loc10_ + 1) % this.§-y§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§>P§[_loc9_].x * (1 - _loc15_) + this.§>P§[_loc13_].x * _loc15_,this.§>P§[_loc9_].y * (1 - _loc15_) + this.§>P§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§>P§[_loc10_].x * (1 - _loc16_) + this.§>P§[_loc14_].x * _loc16_,this.§>P§[_loc10_].y * (1 - _loc16_) + this.§>P§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§>P§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§-y§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§>P§[_loc12_];
            }
         ...
         _loc20_.§@T§(1 / _loc19_);
         param4.SetV(b2Math.§0!6§(param3,_loc20_));
         return _loc19_;
      }
      ...
      {
         var _loc2_:int = this.§>P§.length;
         while(_loc2_ < param1)
         {
            this.§>P§[_loc2_] = new b2Vec2();
