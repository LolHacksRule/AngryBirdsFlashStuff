package §<L§
{
   ...
   public class Texture
   {
      ...
      public static function §=$§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §<L§.Texture
      {
         return §3"8§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §3"8§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §<L§.Texture
      {
      ...
      public static function §`!c§(param1:Context3D, param2:ByteArray) : §<L§.Texture
      {
         if(param1 == null)
         {
            throw new §1!+§();
      ...
      public static function §>!W§(param1:§<L§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §<L§.Texture
      {
         var _loc4_:§<L§.Texture;
         (_loc4_ = new §0#§(param1,param2)).§"W§ = param3;
         return _loc4_;
      }
      
      public static function §<b§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §<L§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§<L§.Texture = §3"8§(param1,_loc6_,false,param5);
         if(!§5!H§.§7"4§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§2!%§, param2:int, param3:int) : void
      {
         ...
         if(this.§"W§)
         {
            ...
            param1.§-!g§(param2,-this.§"W§.x,-this.§"W§.y);
            param1.§-!g§(param2 + 1,-_loc4_,-this.§"W§.y);
            param1.§-!g§(param2 + 2,-this.§"W§.x,-_loc5_);
