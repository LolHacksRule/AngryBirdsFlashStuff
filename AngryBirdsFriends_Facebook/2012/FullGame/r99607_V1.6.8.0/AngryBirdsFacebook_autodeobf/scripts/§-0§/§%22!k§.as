package §-0§
{
   ...
   public class §"!k§
   {
      ...
      public static function §1§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §>!A§(_loc2_);
         return §3!K§.§@!i§(_loc3_.readInt(),true) + §3!K§.§@!i§(_loc3_.readInt(),true) + §3!K§.§@!i§(_loc3_.readInt(),true) + §3!K§.§@!i§(_loc3_.readInt(),true) + §3!K§.§@!i§(_loc3_.readInt(),true);
      }
      
      public static function §>!;§(param1:ByteArray) : String
      {
         var _loc2_:Array = §"!k§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §>!A§(_loc2_);
         return §3!K§.§@!i§(_loc3_.readInt(),true) + §3!K§.§@!i§(_loc3_.readInt(),true) + §3!K§.§@!i§(_loc3_.readInt(),true) + §3!K§.§@!i§(_loc3_.readInt(),true) + §3!K§.§@!i§(_loc3_.readInt(),true);
      }
      
      public static function §4!H§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §"!k§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §>!A§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §>!A§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
