package §'_§
{
   ...
   public class §=L§
   {
      ...
      public static const §4m§:Number = 100;
      ...
      public static function §+!F§(param1:MovieClip, param2:Boolean) : Array
      {
         ...
         if(param2)
         {
            _loc3_.x *= §4m§ / 100;
            _loc3_.y *= §4m§ / 100;
            _loc3_.height *= §4m§ / 100;
            _loc3_.width *= §4m§ / 100;
         }
         _loc4_[0] = new b2Vec2(_loc3_.x * §[!;§.§4!O§,_loc3_.y * §[!;§.§4!O§);
         _loc4_[1] = new b2Vec2(_loc3_.x * §[!;§.§4!O§,(_loc3_.y + _loc3_.height) * §[!;§.§4!O§);
         _loc4_[2] = new b2Vec2((_loc3_.x + _loc3_.width) * §[!;§.§4!O§,(_loc3_.y + _loc3_.height) * §[!;§.§4!O§);
         _loc4_[3] = new b2Vec2((_loc3_.x + _loc3_.width) * §[!;§.§4!O§,_loc3_.y * §[!;§.§4!O§);
         _loc4_.reverse();
         return _loc4_;
      }
      ...
      public static function §"!t§(param1:MovieClip, param2:Boolean) : Array
      {
         ...
         if(param2)
         {
            _loc4_.x *= §4m§ / 100;
            _loc4_.y *= §4m§ / 100;
            _loc4_.height *= §4m§ / 100;
            _loc4_.width *= §4m§ / 100;
         }
         if(_loc4_.width != _loc4_.height)
         {
         }
         _loc3_[0] = _loc4_.width * §[!;§.§4!O§ / 2;
         _loc3_[1] = (_loc4_.x + _loc4_.width / 2) * §[!;§.§4!O§;
         _loc3_[2] = (_loc4_.y + _loc4_.height / 2) * §[!;§.§4!O§;
         return _loc3_;
      }
      ...
      public static function §%"'§(param1:MovieClip) : Array
      {
         ...
         while(_loc4_ < _loc3_.numChildren)
         {
            ...
            _loc2_[_loc4_].Set((_loc5_.getRect(param1).x + _loc5_.getRect(param1).width / 2) * §[!;§.§4!O§,(_loc5_.getRect(param1).y + _loc5_.getRect(param1).height / 2) * §[!;§.§4!O§);
            _loc4_++;
         }
         _loc2_.reverse();
         if(_loc2_.length < 3)
