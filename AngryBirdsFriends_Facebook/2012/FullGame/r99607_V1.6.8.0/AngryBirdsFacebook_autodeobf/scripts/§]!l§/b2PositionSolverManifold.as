package §]!l§
{
   ...
   class b2PositionSolverManifold
   {
      ...
      public var §4!f§:Vector.<Number>;
      
      function b2PositionSolverManifold()
      {
         super();
         this.§[§ = new b2Vec2();
         this.§4!f§ = new Vector.<Number>(b2Settings.b2_maxManifoldPoints);
      ...
      public function §&!j§(param1:b2ContactConstraint) : void
      {
         var _loc2_:int = 0;
         ...
         switch(param1.type)
         {
            case b2Manifold.§8`§:
               ...
               _loc9_ = param1.§3"$§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc10_ = param1.§3"$§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               _loc5_ = param1.§?!A§.m_xf.R;
               _loc6_ = param1.§&";§[0].localPoint;
               _loc11_ = param1.§?!A§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc12_ = param1.§?!A§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               ...
               this.§4!f§[0] = _loc13_ * this.§[§.x + _loc14_ * this.§[§.y - param1.radius;
               break;
            case b2Manifold.§#!a§:
               _loc5_ = param1.§3"$§.m_xf.R;
               _loc6_ = param1.§-!1§;
               ...
               while(_loc2_ < param1.§?""§)
               {
                  ...
                  _loc3_ = param1.§?!A§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
                  _loc4_ = param1.§?!A§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
                  this.§4!f§[_loc2_] = (_loc3_ - _loc7_) * this.§[§.x + (_loc4_ - _loc8_) * this.§[§.y - param1.radius;
            ...
            case b2Manifold.§!"'§:
               ...
               _loc5_ = param1.§?!A§.m_xf.R;
               _loc6_ = param1.localPoint;
               _loc7_ = param1.§?!A§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc8_ = param1.§?!A§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               _loc5_ = param1.§3"$§.m_xf.R;
               _loc2_ = 0;
               while(_loc2_ < param1.§?""§)
               {
