package §+A§
{
   ...
   public class SWFWheel
   {
      ...
      public static function get §2n§() : Boolean
      {
         return §=!7§;
      }
      
      public static function set §2n§(param1:Boolean) : void
      {
         §=!7§ = param1;
      }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §1I§.getObjectsUnderPoint(new Point(§1I§.mouseX,§1I§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
