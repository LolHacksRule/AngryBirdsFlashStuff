package §!D§
{
   ...
   class b2PositionSolverManifold
   {
      ...
      private static var §0Q§:b2Vec2 = new b2Vec2();
      ...
      public function §`!r§(param1:b2ContactConstraint) : void
      {
         ...
         switch(param1.type)
         {
            case b2Manifold.§9M§:
               ...
               _loc9_ = param1.§!!v§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc10_ = param1.§!!v§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
            ...
            case b2Manifold.§;1§:
               ...
               while(_loc2_ < param1.§<?§)
               {
                  ...
                  this.§,M§[_loc2_] = (_loc3_ - _loc7_) * this.§9+§.x + (_loc4_ - _loc8_) * this.§9+§.y - param1.radius;
                  this.§1!d§[_loc2_].x = _loc3_;
                  this.§1!d§[_loc2_].y = _loc4_;
                  _loc2_++;
               }
               break;
            case b2Manifold.§#[§:
               ...
               while(_loc2_ < param1.§<?§)
               {
                  ...
                  this.§,M§[_loc2_] = (_loc3_ - _loc7_) * this.§9+§.x + (_loc4_ - _loc8_) * this.§9+§.y - param1.radius;
                  this.§1!d§[_loc2_].Set(_loc3_,_loc4_);
                  _loc2_++;
               }
               this.§9+§.x *= -1;
               this.§9+§.y *= -1;
