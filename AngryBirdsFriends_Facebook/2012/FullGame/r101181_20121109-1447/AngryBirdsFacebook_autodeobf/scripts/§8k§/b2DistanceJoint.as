package §8k§
{
   ...
   public class b2DistanceJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * this.§0!y§ * this.§8"=§.x,param1 * this.§0!y§ * this.§8"=§.y);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc13_:Number = _loc4_.§["A§ + _loc4_.§"g§ * _loc11_ * _loc11_ + _loc5_.§["A§ + _loc5_.§"g§ * _loc12_ * _loc12_;
         this.§+J§ = _loc13_ != 0 ? Number(1 / _loc13_) : Number(0);
         if(this.§7"E§ > 0)
         {
            _loc14_ = _loc10_ - this.§+!@§;
            _loc15_ = 2 * Math.PI * this.§7"E§;
            _loc16_ = 2 * this.§+J§ * this.§,c§ * _loc15_;
            _loc17_ = this.§+J§ * _loc15_ * _loc15_;
            this.§[E§ = param1.§4"?§ * (_loc16_ + param1.§4"?§ * _loc17_);
            this.§[E§ = this.§[E§ != 0 ? Number(1 / this.§[E§) : Number(0);
            this.§?V§ = _loc14_ * param1.§4"?§ * _loc17_ * this.§[E§;
            this.§+J§ = _loc13_ + this.§[E§;
            this.§+J§ = this.§+J§ != 0 ? Number(1 / this.§+J§) : Number(0);
         }
         if(param1.§'i§)
         {
            this.§0!y§ *= param1.§ ,§;
            _loc18_ = this.§0!y§ * this.§8"=§.x;
            _loc19_ = this.§0!y§ * this.§8"=§.y;
            _loc4_.§="8§.x -= _loc4_.§["A§ * _loc18_;
            _loc4_.§="8§.y -= _loc4_.§["A§ * _loc19_;
            _loc4_.m_angularVelocity -= _loc4_.§"g§ * (_loc6_ * _loc19_ - _loc7_ * _loc18_);
            _loc5_.§="8§.x += _loc5_.§["A§ * _loc18_;
            _loc5_.§="8§.y += _loc5_.§["A§ * _loc19_;
            _loc5_.m_angularVelocity += _loc5_.§"g§ * (_loc8_ * _loc19_ - _loc9_ * _loc18_);
         }
         else
         {
            this.§0!y§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = _loc2_.col1.y * _loc8_ + _loc2_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         var _loc10_:Number = _loc3_.§="8§.x + -_loc3_.m_angularVelocity * _loc6_;
         var _loc11_:Number = _loc3_.§="8§.y + _loc3_.m_angularVelocity * _loc5_;
         var _loc12_:Number = _loc4_.§="8§.x + -_loc4_.m_angularVelocity * _loc9_;
         var _loc13_:Number = _loc4_.§="8§.y + _loc4_.m_angularVelocity * _loc8_;
         var _loc14_:Number = this.§8"=§.x * (_loc12_ - _loc10_) + this.§8"=§.y * (_loc13_ - _loc11_);
         var _loc15_:Number = -this.§+J§ * (_loc14_ + this.§?V§ + this.§[E§ * this.§0!y§);
         this.§0!y§ += _loc15_;
         ...
         _loc3_.m_angularVelocity -= _loc3_.§"g§ * (_loc5_ * _loc17_ - _loc6_ * _loc16_);
         _loc4_.§="8§.x += _loc4_.§["A§ * _loc16_;
         _loc4_.§="8§.y += _loc4_.§["A§ * _loc17_;
         _loc4_.m_angularVelocity += _loc4_.§"g§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
      }
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         _loc13_ = b2Math.§<O§(_loc13_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
         ...
         _loc3_.m_sweep.a -= _loc3_.§"g§ * (_loc5_ * _loc16_ - _loc6_ * _loc15_);
         _loc4_.m_sweep.c.x += _loc4_.§["A§ * _loc15_;
         _loc4_.m_sweep.c.y += _loc4_.§["A§ * _loc16_;
         _loc4_.m_sweep.a += _loc4_.§"g§ * (_loc8_ * _loc16_ - _loc9_ * _loc15_);
         _loc3_.§,6§();
         _loc4_.§,6§();
