package §!D§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §^r§:b2WorldManifold = new b2WorldManifold();
      ...
      public function §`!r§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            _loc17_ = _loc5_.§1t§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§0o§(),_loc10_.§0o§());
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§]!g§(),_loc10_.§]!g§());
            _loc20_ = _loc15_.§="8§.x;
            _loc21_ = _loc15_.§="8§.y;
            _loc22_ = _loc16_.§="8§.x;
            _loc23_ = _loc16_.§="8§.y;
            ...
            b2Settings.b2Assert(_loc17_.§^M§ > 0);
            §^r§.§`!r§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §^r§.§9+§.x;
            _loc27_ = §^r§.§9+§.y;
            (_loc28_ = this.§#!$§[_loc6_]).§!!v§ = _loc15_;
            _loc28_.§'!4§ = _loc16_;
            _loc28_.§;!N§ = _loc17_;
            ...
            _loc28_.§=!,§.x = _loc17_.§%C§.x;
            _loc28_.§=!,§.y = _loc17_.§%C§.y;
            ...
            {
               _loc30_ = _loc17_.§1!d§[_loc29_];
               (_loc31_ = _loc28_.§+V§[_loc29_]).normalImpulse = _loc30_.§[!h§;
               _loc31_.tangentImpulse = _loc30_.§%!7§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§1!>§.x = §^r§.§1!d§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§1!>§.y = §^r§.§1!d§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§<!P§.x = §^r§.§1!d§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§<!P§.y = §^r§.§1!d§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§["A§ + _loc16_.§["A§ + _loc15_.§"g§ * _loc36_ + _loc16_.§"g§ * _loc37_;
               _loc31_.§?`§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§+J§ * _loc15_.§["A§ + _loc16_.§+J§ * _loc16_.§["A§) + (_loc15_.§+J§ * _loc15_.§"g§ * _loc36_ + _loc16_.§+J§ * _loc16_.§"g§ * _loc37_);
               _loc31_.§>"=§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§["A§ + _loc16_.§["A§ + _loc15_.§"g§ * _loc42_ + _loc16_.§"g§ * _loc43_;
               _loc31_.§9!%§ = 1 / _loc44_;
               _loc31_.§4!q§ = 0;
               ...
               {
                  _loc31_.§4!q§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§<?§ == 2)
            {
               ...
               _loc52_ = _loc16_.§["A§;
               _loc53_ = _loc16_.§"g§;
               _loc54_ = _loc48_.§1!>§.x * _loc27_ - _loc48_.§1!>§.y * _loc26_;
               _loc55_ = _loc48_.§<!P§.x * _loc27_ - _loc48_.§<!P§.y * _loc26_;
               _loc56_ = _loc49_.§1!>§.x * _loc27_ - _loc49_.§1!>§.y * _loc26_;
               _loc57_ = _loc49_.§<!P§.x * _loc27_ - _loc49_.§<!P§.y * _loc26_;
         ...
         while(_loc5_ < this.§=!3§)
         {
            ...
            if(param1.§'i§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§<!P§.x * _loc22_ - _loc20_.§<!P§.y * _loc21_);
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§=!3§)
         {
            _loc26_ = (_loc25_ = this.§#!$§[_loc24_]).§!!v§;
            _loc27_ = _loc25_.§'!4§;
            ...
            while(_loc1_ < _loc25_.§<?§)
            {
               ...
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§<!P§.y - _loc30_.x + _loc28_ * _loc2_.§1!>§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§<!P§.x - _loc30_.y - _loc28_ * _loc2_.§1!>§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§9!%§ * -_loc10_;
               _loc12_ = _loc40_ * _loc2_.normalImpulse;
               _loc14_ = (_loc11_ = (_loc13_ = b2Math.§<O§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_)) - _loc2_.tangentImpulse) * _loc38_;
               ...
               _loc29_ += _loc35_ * (_loc2_.§<!P§.x * _loc15_ - _loc2_.§<!P§.y * _loc14_);
            ...
            if(_loc25_.§<?§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§?`§ * (_loc9_ - _loc2_.§4!q§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§<!P§.y - _loc30_.x + _loc28_ * _loc43_.§1!>§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§<!P§.x - _loc30_.y - _loc28_ * _loc43_.§1!>§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§<!P§.y - _loc30_.x + _loc28_ * _loc44_.§1!>§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§<!P§.x - _loc30_.y - _loc28_ * _loc44_.§1!>§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§4!q§;
               _loc54_ = _loc52_ - _loc44_.§4!q§;
               _loc22_ = _loc25_.K;
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc29_ += _loc35_ * (_loc43_.§<!P§.x * _loc19_ - _loc43_.§<!P§.y * _loc18_ + _loc44_.§<!P§.x * _loc21_ - _loc44_.§<!P§.y * _loc20_);
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§=!3§)
         {
            ...
            _loc6_ = _loc4_.§'!4§;
            _loc7_ = _loc5_.§+J§ * _loc5_.§["A§;
            _loc8_ = _loc5_.§+J§ * _loc5_.§"g§;
            _loc9_ = _loc6_.§+J§ * _loc6_.§["A§;
            _loc10_ = _loc6_.§+J§ * _loc6_.§"g§;
            §[D§.§`!r§(_loc4_);
            _loc11_ = §[D§.§9+§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§<?§)
            {
               ...
               _loc20_ = b2Math.§<O§(param1 * (_loc15_ + b2Settings.b2_linearSlop),-b2Settings.b2_maxLinearCorrection,0);
