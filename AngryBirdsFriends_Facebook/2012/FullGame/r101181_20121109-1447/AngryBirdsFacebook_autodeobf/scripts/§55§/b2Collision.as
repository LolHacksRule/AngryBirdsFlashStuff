package §55§
{
   ...
   public class b2Collision
   {
      ...
      private static var §%L§:Vector.<int> = new Vector.<int>(1);
      ...
      private static var §8I§:b2Vec2 = new b2Vec2();
      
      private static var §1!x§:b2Vec2 = new b2Vec2();
      ...
      public static function §^!e§(param1:Vector.<§6"1§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§0y§;
         var _loc8_:Vector.<b2Vec2> = param2.§6"!§;
         var _loc9_:int = param5.§0y§;
         ...
         _loc20_.id.§'"B§.§%i§ = param4;
         _loc20_.id.§'"B§.§,!0§ = _loc21_;
         _loc20_.id.§'"B§.§!O§ = 0;
         _loc20_ = param1[1];
      ...
      public static function §]!1§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §%L§[0] = _loc8_;
         var _loc9_:Number = §%!d§(§%L§,param2,param3,param4,param5);
         _loc8_ = §%L§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §]@§[0] = _loc10_;
         var _loc11_:Number = §%!d§(§]@§,param4,param5,param2,param3);
         _loc10_ = §]@§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§6"1§> = §5Z§;
         §^!e§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§0y§;
         ...
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §+c§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §8I§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §57§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§6"1§> = s_clipPoints1;
         var _loc38_:Vector.<§6"1§> = s_clipPoints2;
      ...
      public static function §>!2§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§^M§ = 1;
            param1.§<";§ = b2Manifold.§;1§;
            param1.§%C§.x = _loc15_ - _loc28_.x;
            param1.§%C§.y = _loc16_ - _loc28_.y;
            param1.§%C§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§1!d§[0].m_localPoint.SetV(param4.§ m§);
            param1.§1!d§[0].m_id.key = 0;
