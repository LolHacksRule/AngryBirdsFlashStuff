package § !0§
{
   ...
   class b2SeparationFunction
   {
      ...
      public var §0!m§:b2DistanceProxy;
      ...
      public function §,!9§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§6N§ = §+E§;
            _loc7_ = this.§,`§.§!v§(param1.indexA[0]);
            _loc10_ = this.§0!m§.§!v§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§6N§ = §=F§;
            _loc8_ = this.§,`§.§!v§(param1.indexA[0]);
            _loc9_ = this.§,`§.§!v§(param1.indexA[1]);
            _loc10_ = this.§0!m§.§!v§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§;!F§ = b2Math.§[n§(b2Math.§5x§(_loc9_,_loc8_),1);
            this.§;!F§.Normalize();
            _loc20_ = this.§;!F§;
         ...
         {
            this.§6N§ = §]!7§;
            _loc11_ = this.§0!m§.§!v§(param1.indexB[0]);
            _loc12_ = this.§0!m§.§!v§(param1.indexB[1]);
            _loc7_ = this.§,`§.§!v§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§;!F§ = b2Math.§[n§(b2Math.§5x§(_loc12_,_loc11_),1);
            this.§;!F§.Normalize();
            _loc20_ = this.§;!F§;
         ...
         else
         {
            ...
            _loc24_ = b2Math.§2!8§(param3.R,b2Math.§5x§(_loc9_,_loc8_));
            _loc25_ = b2Math.§]D§(param5,_loc10_);
            _loc26_ = b2Math.§2!8§(param5.R,b2Math.§5x§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§5x§(_loc26_,_loc24_);
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §+E§:
               _loc3_ = b2Math.§>!J§(param1.R,this.§;!F§);
               _loc4_ = b2Math.§>!J§(param2.R,this.§;!F§.§7E§());
               _loc5_ = this.§,`§.§#b§(_loc3_);
               _loc6_ = this.§0!m§.§#b§(_loc4_);
               _loc7_ = b2Math.§]D§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§]D§(param2,_loc6_)).x - _loc7_.x) * this.§;!F§.x + (_loc8_.y - _loc7_.y) * this.§;!F§.y);
            case §=F§:
               _loc10_ = b2Math.§2!8§(param1.R,this.§;!F§);
               _loc7_ = b2Math.§]D§(param1,this.m_localPoint);
               _loc4_ = b2Math.§>!J§(param2.R,_loc10_.§7E§());
               _loc6_ = this.§0!m§.§#b§(_loc4_);
               return Number(((_loc8_ = b2Math.§]D§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §]!7§:
               _loc10_ = b2Math.§2!8§(param2.R,this.§;!F§);
               _loc8_ = b2Math.§]D§(param2,this.m_localPoint);
               _loc3_ = b2Math.§>!J§(param1.R,_loc10_.§7E§());
               _loc5_ = this.§,`§.§#b§(_loc3_);
