package §-B§
{
   ...
   public class §?!j§ extends §&G§
   {
      ...
      public function §?!j§(param1:XML, param2:§?!j§, param3:§^0§, param4:MovieClip = null)
      {
         var _loc5_:XML = null;
         var _loc6_:XML = null;
         var _loc7_:XML = null;
         ...
         {
            this.§!!&§.push(new §?!j§(_loc5_,this,null));
         }
         ...
         {
            this.§!!&§.push(new §#p§(_loc8_,this));
         }
         for each(_loc9_ in param1.MovieClip)
         {
            this.§!!&§.push(new §="0§(_loc9_,this));
         }
      ...
      public function §2C§(param1:§&G§) : void
      {
      ...
      public function §'!@§(param1:§&G§) : void
      {
         if(this.§!!&§.indexOf(param1) < 0)
         {
            ...
            param1.setVisibility(this.§3!Y§ && param1.§3!Y§);
