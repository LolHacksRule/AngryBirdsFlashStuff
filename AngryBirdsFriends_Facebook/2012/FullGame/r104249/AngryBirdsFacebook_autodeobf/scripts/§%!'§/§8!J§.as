package §%!'§
{
   ...
   public class §8!J§
   {
      ...
      public static function §[!Y§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         jsonString = §7"§(luaString,emptyObjectAsArray);
         try
         {
      ...
      public static function §8b§(param1:String, param2:Boolean = false) : Object
      {
         var returnObject:Object = null;
      ...
      public static function §7"§(param1:String, param2:Boolean = false) : String
      {
      ...
      private static function §"!i§(param1:String, param2:Boolean) : String
      {
      ...
      private static function §5"E§(param1:Object, param2:int) : String
      {
         var _loc4_:* = null;
         var _loc5_:int = 0;
         param2++;
         ...
         for(_loc4_ in param1)
         {
            ...
            _loc3_ += _loc4_ + " = " + §-V§(param1[_loc4_],param2);
            if(param2 > 1)
            {
               _loc3_ += ",";
            }
      ...
      private static function §-V§(param1:*, param2:int) : String
      {
         ...
         else
         {
            ...
            if(param1 is Array)
            {
               ...
               {
                  _loc3_ += !!(§-V§(param1[_loc6_],param2) + (_loc6_ < param1.length - 1)) ? "," : "";
                  _loc6_++;
               }
               return _loc3_ + "}";
            }
