package §?7§
{
   ...
   public class Texture
   {
      ...
      public static function §^!I§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §?7§.Texture
      {
         return §'!V§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §'!V§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §?7§.Texture
      {
         ...
         _loc10_ = new §99§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§1!D§.§5""§)
         {
            _loc10_.§!D§(param2);
         }
      ...
      public static function §"!H§(param1:Context3D, param2:ByteArray) : §?7§.Texture
      {
         if(param1 == null)
         {
            throw new §?@§();
         ...
         var _loc9_:§99§ = new §99§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§1!D§.§5""§)
         {
            _loc9_.§!D§(param2);
         }
      ...
      public static function §&!N§(param1:§?7§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §?7§.Texture
      {
         ...
         (_loc4_ = new §]"0§(param1,param2)).§08§ = param3;
         return _loc4_;
      }
      
      public static function §%!H§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §?7§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§?7§.Texture = §'!V§(param1,_loc6_,false,param5);
         if(!§1!D§.§5""§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§`g§, param2:int, param3:int) : void
      {
         ...
         if(this.§08§)
         {
            ...
            _loc4_ = this.§08§.width + this.§08§.x - this.width;
            _loc5_ = this.§08§.height + this.§08§.y - this.height;
            param1.§!!'§(param2,-this.§08§.x,-this.§08§.y);
            param1.§!!'§(param2 + 1,-_loc4_,-this.§08§.y);
            param1.§!!'§(param2 + 2,-this.§08§.x,-_loc5_);
      ...
      {
         return !!this.§08§ ? this.§08§.clone() : new Rectangle(0,0,this.width,this.height);
      }
