package § "&§
{
   ...
   public class §-!n§
   {
      ...
      public function §-!n§(param1:Number = 50)
      {
      ...
      private function §[$§(param1:int) : void
      {
         ...
         while(_loc7_ < 8)
         {
            ...
            while(_loc8_ < 8)
            {
               this.§@!n§[_loc2_] = 1 / (this.§&!l§[this.§]"?§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               this.§&"0§[_loc2_] = 1 / (this.§"+§[this.§]"?§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               _loc2_++;
               _loc8_++;
            }
            _loc7_++;
      ...
      private function §0!E§(param1:Array, param2:Array) : Array
      {
         var _loc7_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:int = 0;
      ...
      {
         this.§4F§ = this.§0!E§(this.§&!e§,this.§?T§);
         this.§'!<§ = this.§0!E§(this.§'z§,this.§ I§);
         this.§'@§ = this.§0!E§(this.§&!0§,this.§`m§);
         this.§ "7§ = this.§0!E§(this.§3"-§,this.§<!X§);
      }
      ...
      private function §-_§(param1:§<1§) : void
      {
      ...
      private function §4"H§(param1:Array, param2:Array) : Array
      {
         var _loc3_:Number = NaN;
      ...
      private function §?"7§(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         ...
         var _loc9_:Array = this.§4"H§(param1,param2);
         _loc8_ = 0;
         while(_loc8_ < 64)
         {
         ...
         while(_loc8_ <= _loc11_)
         {
            ...
            this.§-_§(param5[_loc13_ * 16 + this.category[32767 + this.§@!,§[_loc8_]]]);
            this.§-_§(this.§?l§[32767 + this.§@!,§[_loc8_]]);
            _loc8_++;
         }
         if(_loc11_ != 63)
         {
      ...
      public function encode(param1:BitmapData) : ByteArray
      {
         ...
         while(_loc5_ < param1.height)
         {
            ...
            while(_loc6_ < param1.width)
            {
               ...
               _loc2_ = this.§?"7§(this.§`D§,this.§@!n§,_loc2_,this.§4F§,this.§'@§);
               _loc3_ = this.§?"7§(this.§<!9§,this.§&"0§,_loc3_,this.§'!<§,this.§ "7§);
               _loc4_ = this.§?"7§(this.§ !l§,this.§&"0§,_loc4_,this.§'!<§,this.§ "7§);
               _loc6_ += 8;
            }
            _loc5_ += 8;
         }
