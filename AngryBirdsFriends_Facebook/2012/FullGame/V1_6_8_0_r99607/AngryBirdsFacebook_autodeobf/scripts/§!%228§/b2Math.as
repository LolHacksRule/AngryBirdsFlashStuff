package §!"8§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§8!+§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §'!l§(param1:Number) : Boolean
      {
         return isFinite(param1);
      }
      
      public static function §5q§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         return param1.x * param2.x + param1.y * param2.y;
      }
      
      public static function §22§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         return param1.x * param2.y - param1.y * param2.x;
      }
      
      public static function §61§(param1:b2Vec2, param2:Number) : b2Vec2
      {
      ...
      {
         return new b2Vec2(§5q§(param2,param1.col1),§5q§(param2,param1.col2));
      }
      
      public static function §0!6§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §5"2§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         var _loc4_:Number = NaN;
         _loc3_ = §@!W§(param2,param1.position);
      ...
      public static function §2"0§(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§8!+§(§1"=§(param1.col1,param2.col1),§1"=§(param1.col2,param2.col2));
      }
      
      public static function §@z§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§8!+§(§#-§(param1,param2.col1),§#-§(param1,param2.col2));
      }
      
      public static function §^-§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§5q§(param1.col1,param2.col1),§5q§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§5q§(param1.col1,param2.col2),§5q§(param1.col2,param2.col2));
         return b2Mat22.§8!+§(_loc3_,_loc4_);
      }
      ...
      {
         return new b2Vec2(§'!I§(param1.x),§'!I§(param1.y));
      }
      
      public static function §[!=§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§8!+§(§[!k§(param1.col1),§[!k§(param1.col2));
      }
      
      public static function §6J§(param1:Number, param2:Number) : Number
      {
      ...
      {
         return new b2Vec2(§6J§(param1.x,param2.x),§6J§(param1.y,param2.y));
      }
      ...
      public static function §0k§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§&z§(param1.x,param2.x),§&z§(param1.y,param2.y));
      }
      
      public static function §`!L§(param1:Number, param2:Number, param3:Number) : Number
      {
         return param1 < param2 ? Number(param2) : (param1 > param3 ? Number(param3) : Number(param1));
      }
      
      public static function §,!2§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §0k§(param2,§]!&§(param1,param3));
      }
      ...
      public static function §6I§(param1:uint) : Boolean
      {
