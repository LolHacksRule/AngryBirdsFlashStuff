package §&I§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§1!'§ = this.§3"@§.Normalize();
         this.§[§.Set(this.§3"@§.y,-this.§3"@§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§[§.x - this.§3"@§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§[§.y - this.§3"@§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§[§.x + this.§3"@§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§[§.y + this.§3"@§.y) + this.m_v2.y);
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§0!6§(param3,this.m_v1);
         var _loc7_:b2Vec2 = b2Math.§0!6§(param3,this.m_v2);
         var _loc8_:Number = b2Math.§5q§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§5q§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §4S§() : b2EdgeShape
      {
         return this.§+!>§;
      }
