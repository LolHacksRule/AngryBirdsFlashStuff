package §]!l§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §2X§:b2WorldManifold = new b2WorldManifold();
      
      private static var §^F§:b2PositionSolverManifold = new b2PositionSolverManifold();
       
      
      private var §5!B§:b2TimeStep;
      
      private var §0!k§;
      
      b2internal var §1,§:Vector.<b2ContactConstraint>;
      
      private var §6"2§:int;
      
      public function b2ContactSolver()
      {
         this.§5!B§ = new b2TimeStep();
         this.§1,§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §&!j§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§0!k§ = param4;
         this.§6"2§ = param3;
         while(this.§1,§.length < this.§6"2§)
         {
            this.§1,§[this.§1,§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            ...
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§%r§(),_loc10_.§%r§());
            _loc20_ = _loc15_.§>! §.x;
            _loc21_ = _loc15_.§>! §.y;
            _loc22_ = _loc16_.§>! §.x;
            _loc23_ = _loc16_.§>! §.y;
            ...
            §2X§.§&!j§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §2X§.§[§.x;
            _loc27_ = §2X§.§[§.y;
            (_loc28_ = this.§1,§[_loc6_]).§3"$§ = _loc15_;
            _loc28_.§?!A§ = _loc16_;
            _loc28_.§5]§ = _loc17_;
            ...
            _loc28_.§-!1§.x = _loc17_.§;h§.x;
            _loc28_.§-!1§.y = _loc17_.§;h§.y;
            ...
            while(_loc29_ < _loc28_.§?""§)
            {
               ...
               (_loc31_ = _loc28_.§&";§[_loc29_]).normalImpulse = _loc30_.§,![§;
               _loc31_.tangentImpulse = _loc30_.§6"&§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§7p§.x = §2X§.§"r§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§7p§.y = §2X§.§"r§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§[!1§.x = §2X§.§"r§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§[!1§.y = §2X§.§"r§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§^1§ + _loc16_.§^1§ + _loc15_.§?y§ * _loc36_ + _loc16_.§?y§ * _loc37_;
               _loc31_.§9!^§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§''§ * _loc15_.§^1§ + _loc16_.§''§ * _loc16_.§^1§) + (_loc15_.§''§ * _loc15_.§?y§ * _loc36_ + _loc16_.§''§ * _loc16_.§?y§ * _loc37_);
               _loc31_.§^!0§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§^1§ + _loc16_.§^1§ + _loc15_.§?y§ * _loc42_ + _loc16_.§?y§ * _loc43_;
               _loc31_.§8!F§ = 1 / _loc44_;
               _loc31_.§?"8§ = 0;
               ...
               {
                  _loc31_.§?"8§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§?""§ == 2)
            {
               ...
               _loc52_ = _loc16_.§^1§;
               _loc53_ = _loc16_.§?y§;
               _loc54_ = _loc48_.§7p§.x * _loc27_ - _loc48_.§7p§.y * _loc26_;
               _loc55_ = _loc48_.§[!1§.x * _loc27_ - _loc48_.§[!1§.y * _loc26_;
               _loc56_ = _loc49_.§7p§.x * _loc27_ - _loc49_.§7p§.y * _loc26_;
               _loc57_ = _loc49_.§[!1§.x * _loc27_ - _loc49_.§[!1§.y * _loc26_;
               ...
               {
                  _loc28_.§49§.col1.Set(_loc58_,_loc60_);
                  _loc28_.§49§.col2.Set(_loc60_,_loc59_);
                  _loc28_.§49§.§%!v§(_loc28_.§9!^§);
               }
               else
               {
                  _loc28_.§?""§ = 1;
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.§6"2§)
         {
            _loc7_ = (_loc6_ = this.§1,§[_loc5_]).§3"$§;
            _loc8_ = _loc6_.§?!A§;
            _loc9_ = _loc7_.§^1§;
            _loc10_ = _loc7_.§?y§;
            _loc11_ = _loc8_.§^1§;
            ...
            if(param1.§+!D§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc20_.normalImpulse *= param1.§=G§;
                  _loc20_.tangentImpulse *= param1.§=G§;
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§7p§.x * _loc22_ - _loc20_.§7p§.y * _loc21_);
                  _loc7_.§>! §.x -= _loc9_ * _loc21_;
                  _loc7_.§>! §.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§[!1§.x * _loc22_ - _loc20_.§[!1§.y * _loc21_);
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§6"2§)
         {
            _loc26_ = (_loc25_ = this.§1,§[_loc24_]).§3"$§;
            _loc27_ = _loc25_.§?!A§;
            ...
            while(_loc1_ < _loc25_.§?""§)
            {
               ...
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§[!1§.y - _loc30_.x + _loc28_ * _loc2_.§7p§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§[!1§.x - _loc30_.y - _loc28_ * _loc2_.§7p§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§8!F§ * -_loc10_;
               _loc12_ = _loc40_ * _loc2_.normalImpulse;
               _loc14_ = (_loc11_ = (_loc13_ = b2Math.§`!L§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_)) - _loc2_.tangentImpulse) * _loc38_;
               _loc15_ = _loc11_ * _loc39_;
               _loc30_.x -= _loc32_ * _loc14_;
               _loc30_.y -= _loc32_ * _loc15_;
               _loc28_ -= _loc33_ * (_loc2_.§7p§.x * _loc15_ - _loc2_.§7p§.y * _loc14_);
               _loc31_.x += _loc34_ * _loc14_;
               _loc31_.y += _loc34_ * _loc15_;
               _loc29_ += _loc35_ * (_loc2_.§[!1§.x * _loc15_ - _loc2_.§[!1§.y * _loc14_);
            ...
            if(_loc25_.§?""§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§9!^§ * (_loc9_ - _loc2_.§?"8§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§[!1§.y - _loc30_.x + _loc28_ * _loc43_.§7p§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§[!1§.x - _loc30_.y - _loc28_ * _loc43_.§7p§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§[!1§.y - _loc30_.x + _loc28_ * _loc44_.§7p§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§[!1§.x - _loc30_.y - _loc28_ * _loc44_.§7p§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§?"8§;
               _loc54_ = _loc52_ - _loc44_.§?"8§;
               _loc22_ = _loc25_.§49§;
               _loc53_ -= _loc22_.col1.x * _loc45_ + _loc22_.col2.x * _loc46_;
               _loc54_ -= _loc22_.col1.y * _loc45_ + _loc22_.col2.y * _loc46_;
               _loc55_ = 0.001;
               _loc56_ = -((_loc22_ = _loc25_.§9!^§).col1.x * _loc53_ + _loc22_.col2.x * _loc54_);
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§7p§.x * _loc19_ - _loc43_.§7p§.y * _loc18_ + _loc44_.§7p§.x * _loc21_ - _loc44_.§7p§.y * _loc20_);
                  _loc31_.x += _loc34_ * (_loc18_ + _loc20_);
                  _loc31_.y += _loc34_ * (_loc19_ + _loc21_);
                  _loc29_ += _loc35_ * (_loc43_.§[!1§.x * _loc19_ - _loc43_.§[!1§.y * _loc18_ + _loc44_.§[!1§.x * _loc21_ - _loc44_.§[!1§.y * _loc20_);
                  _loc43_.normalImpulse = _loc56_;
                  _loc44_.normalImpulse = _loc57_;
               }
               else
               {
                  _loc56_ = -_loc43_.§9!^§ * _loc53_;
                  _loc57_ = 0;
                  _loc51_ = 0;
                  _loc52_ = _loc25_.§49§.col1.y * _loc56_ + _loc54_;
                  ...
                  {
                     _loc56_ = 0;
                     _loc57_ = -_loc44_.§9!^§ * _loc54_;
                     _loc51_ = _loc25_.§49§.col2.x * _loc57_ + _loc53_;
                     _loc52_ = 0;
      ...
      public function §80§() : void
      {
         ...
         while(_loc1_ < this.§6"2§)
         {
            ...
            while(_loc4_ < _loc2_.§?""§)
            {
               ...
               _loc5_.§6"&§ = _loc6_.tangentImpulse;
               _loc4_++;
            }
            _loc1_++;
         }
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:Number = 0;
         var _loc3_:int = 0;
         while(_loc3_ < this.§6"2§)
         {
            _loc5_ = (_loc4_ = this.§1,§[_loc3_]).§3"$§;
            _loc6_ = _loc4_.§?!A§;
            _loc7_ = _loc5_.§''§ * _loc5_.§^1§;
            _loc8_ = _loc5_.§''§ * _loc5_.§?y§;
            _loc9_ = _loc6_.§''§ * _loc6_.§^1§;
            _loc10_ = _loc6_.§''§ * _loc6_.§?y§;
            §^F§.§&!j§(_loc4_);
            _loc11_ = §^F§.§[§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§?""§)
            {
               ...
               _loc20_ = b2Math.§`!L§(param1 * (_loc15_ + b2Settings.b2_linearSlop),-b2Settings.b2_maxLinearCorrection,0);
               _loc22_ = (_loc21_ = -_loc13_.§^!0§ * _loc20_) * _loc11_.x;
