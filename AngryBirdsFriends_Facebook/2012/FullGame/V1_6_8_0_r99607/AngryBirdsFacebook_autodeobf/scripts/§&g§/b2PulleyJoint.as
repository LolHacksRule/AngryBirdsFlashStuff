package §&g§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §8!k§:Number = 2;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§`"6§ = b2internal::5!A.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§^X§.x - this.§`"6§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§^X§.y - this.§`"6§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§[!5§.x - this.§`"6§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§[!5§.y - this.§`"6§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§'!v§);
         this.m_localAnchor2.SetV(param1.§?!m§);
         this.§?§ = param1.§<!]§;
         this.§^"5§ = param1.§=!J§ + this.§?§ * param1.§'"0§;
         this.m_maxLength1 = b2Math.§6J§(param1.§"!K§,this.§^"5§ - this.§?§ * b2internal::8!k);
         this.m_maxLength2 = b2Math.§6J§(param1.§3!X§,(this.§^"5§ - b2internal::8!k) / this.§?§);
         this.§"!J§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§"!J§ * this.m_u2.x,param1 * this.§"!J§ * this.m_u2.y);
      }
      ...
      {
         var _loc1_:b2Vec2 = this.§`"6§.m_xf.position.Copy();
         _loc1_.§>!?§(this.m_groundAnchor1);
         return _loc1_;
      }
      
      public function §2!5§() : b2Vec2
      {
         var _loc1_:b2Vec2 = this.§`"6§.m_xf.position.Copy();
      ...
      {
         var _loc1_:b2Vec2 = b2internal::5!A.GetWorldPoint(this.m_localAnchor1);
         var _loc2_:Number = this.§`"6§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.§`"6§.m_xf.position.y + this.m_groundAnchor1.y;
      ...
      {
         var _loc1_:b2Vec2 = b2internal:: k.GetWorldPoint(this.m_localAnchor2);
         var _loc2_:Number = this.§`"6§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.§`"6§.m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc14_:Number = this.§`"6§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.§`"6§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.§`"6§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.§`"6§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§^"5§ - _loc18_ - this.§?§ * _loc19_) > 0)
         {
            this.§&!h§ = b2internal::9!5;
            this.§"!J§ = 0;
         }
         else
         {
            this.§&!h§ = b2internal::0J;
         }
         if(_loc18_ < this.m_maxLength1)
         {
            this.m_limitState1 = b2internal::9!5;
            this.m_limitImpulse1 = 0;
         }
         else
         {
            this.m_limitState1 = b2internal::0J;
         }
         if(_loc19_ < this.m_maxLength2)
         {
            this.m_limitState2 = b2internal::9!5;
            this.m_limitImpulse2 = 0;
         }
         else
         {
            this.m_limitState2 = b2internal::0J;
         }
         var _loc21_:Number = _loc5_ * this.m_u1.y - _loc6_ * this.m_u1.x;
         var _loc22_:Number = _loc8_ * this.m_u2.y - _loc9_ * this.m_u2.x;
         this.m_limitMass1 = _loc2_.§^1§ + _loc2_.§?y§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§^1§ + _loc3_.§?y§ * _loc22_ * _loc22_;
         this.§#"4§ = this.m_limitMass1 + this.§?§ * this.§?§ * this.m_limitMass2;
         ...
         {
            this.§"!J§ *= param1.§=G§;
            this.m_limitImpulse1 *= param1.§=G§;
            this.m_limitImpulse2 *= param1.§=G§;
            _loc23_ = (-this.§"!J§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§"!J§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§?§ * this.§"!J§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§?§ * this.§"!J§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§>! §.x += _loc2_.§^1§ * _loc23_;
            _loc2_.§>! §.y += _loc2_.§^1§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§?y§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§>! §.x += _loc3_.§^1§ * _loc25_;
            _loc3_.§>! §.y += _loc3_.§^1§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§?y§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§"!J§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§&!h§ == b2internal::0J)
         {
            ...
            _loc20_ = this.§"!J§;
            this.§"!J§ = b2Math.§&z§(0,this.§"!J§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§"!J§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§?§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§?§ * _loc19_ * this.m_u2.y;
            _loc2_.§>! §.x += _loc2_.§^1§ * _loc14_;
            _loc2_.§>! §.y += _loc2_.§^1§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§?y§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§>! §.x += _loc3_.§^1§ * _loc16_;
            _loc3_.§>! §.y += _loc3_.§^1§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§?y§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
         if(this.m_limitState1 == b2internal::0J)
         {
            _loc10_ = _loc2_.§>! §.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§>! §.y + _loc2_.m_angularVelocity * _loc5_;
         ...
         if(this.m_limitState2 == b2internal::0J)
         {
            _loc12_ = _loc3_.§>! §.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§>! §.y + _loc3_.m_angularVelocity * _loc8_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal::5!A;
         var _loc3_:b2Body = b2internal:: k;
         var _loc5_:Number = this.§`"6§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.§`"6§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.§`"6§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.§`"6§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         if(this.§&!h§ == b2internal::0J)
         {
            ...
            _loc19_ = this.§^"5§ - _loc17_ - this.§?§ * _loc18_;
            _loc24_ = b2Math.§&z§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§`!L§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            ...
            _loc2_.m_sweep.a += _loc2_.§?y§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§^1§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§^1§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§?y§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§?=§();
            _loc3_.§?=§();
         }
         if(this.m_limitState1 == b2internal::0J)
