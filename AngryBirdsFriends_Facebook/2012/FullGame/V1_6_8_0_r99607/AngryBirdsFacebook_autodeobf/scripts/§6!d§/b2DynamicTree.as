package §6!d§
{
   ...
   public class b2DynamicTree
   {
      ...
      private var §1q§:b2DynamicTreeNode;
      
      private var §?!p§:b2DynamicTreeNode;
      ...
      public function §`!;§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
         ...
         _loc3_.aabb.§5"0§.x = param1.§5"0§.x + _loc4_;
         _loc3_.aabb.§5"0§.y = param1.§5"0§.y + _loc5_;
         _loc3_.§#"@§ = param2;
         this.§#&§(_loc3_);
         return _loc3_;
      }
      ...
      public function §""$§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         ...
         param1.aabb.§5"0§.x = param2.§5"0§.x + _loc4_;
         param1.aabb.§5"0§.y = param2.§5"0§.y + _loc5_;
         this.§#&§(param1);
         return true;
      }
      ...
      public function §+!M§(param1:Function, param2:b2AABB) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc7_:*;
         _loc3_[_loc7_ = _loc4_++] = this.§1q§;
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§6!v§(param2))
            {
               if(_loc5_.§^!i§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         _loc9_.§5"0§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§5"0§.y = Math.max(_loc3_.y,_loc11_);
         var _loc12_:Vector.<b2DynamicTreeNode> = new Vector.<b2DynamicTreeNode>();
         var _loc13_:int = 0;
         var _loc19_:*;
         _loc12_[_loc19_ = _loc13_++] = this.§1q§;
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§6!v§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§@!8§();
               _loc16_ = _loc14_.aabb.§44§();
      ...
      private function §!!X§() : b2DynamicTreeNode
      {
         var _loc1_:b2DynamicTreeNode = null;
         if(this.§?!p§)
         {
            _loc1_ = this.§?!p§;
            this.§?!p§ = _loc1_.parent;
            _loc1_.parent = null;
            _loc1_.child1 = null;
            _loc1_.child2 = null;
            return _loc1_;
      ...
      private function §0!p§(param1:b2DynamicTreeNode) : void
      {
         param1.parent = this.§?!p§;
         this.§?!p§ = param1;
      }
      ...
      private function §#&§(param1:b2DynamicTreeNode) : void
      {
         ...
         var _loc3_:b2DynamicTreeNode = this.§1q§;
         if(_loc3_.§^!i§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§=!h§.x + _loc6_.aabb.§5"0§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§=!h§.y + _loc6_.aabb.§5"0§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§=!h§.x + _loc7_.aabb.§5"0§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§=!h§.y + _loc7_.aabb.§5"0§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         (_loc5_ = this.§!!X§()).parent = _loc4_;
         _loc5_.§#"@§ = null;
         _loc5_.aabb.§6e§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            {
               _loc4_.aabb.§6e§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
      ...
      private function §6B§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc5_ = _loc3_.aabb;
               _loc3_.aabb = b2AABB.§6e§(_loc3_.child1.aabb,_loc3_.child2.aabb);
