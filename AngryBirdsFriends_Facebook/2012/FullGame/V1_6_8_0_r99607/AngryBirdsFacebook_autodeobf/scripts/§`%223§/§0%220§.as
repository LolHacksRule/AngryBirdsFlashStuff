package §`"3§
{
   ...
   public class §0"0§
   {
      ...
      public function §0"0§(param1:*)
      {
         super();
         this.§-!f§ = this.§4J§(param1);
      }
      ...
      private function §4J§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§5"B§(param1 as String);
         }
         if(param1 is Number)
         {
         ...
         if(param1 is Array)
         {
            return this.§;!m§(param1 as Array);
         }
         if(param1 is Object && param1 != null)
         {
            return this.§5_§(param1);
         }
         return "null";
      }
      
      private function §5"B§(param1:String) : String
      {
      ...
      private function §;!m§(param1:Array) : String
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§4J§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §5_§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§5"B§(v.@name.toString()) + ":" + this.§4J§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
