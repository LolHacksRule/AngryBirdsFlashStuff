package §9"%§
{
   ...
   public class §8!Y§
   {
      ...
      private static function §,k§(param1:*) : *
      {
         var _loc2_:* = null;
      ...
      private static function §,!G§(param1:String) : Boolean
      {
