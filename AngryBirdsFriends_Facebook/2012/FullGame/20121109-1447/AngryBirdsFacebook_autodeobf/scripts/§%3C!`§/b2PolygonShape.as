   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      public static function §0!#§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc3_.§&3§(_loc9_);
            _loc3_.§&3§(_loc10_);
            _loc3_.§8`§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §"[§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§-!o§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§-!o§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function § !r§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§0y§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§0!1§(this.§@"2§[_loc5_],this.§@"2§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§`p§() > Number.MIN_VALUE);
            this.§6"!§[_loc3_].SetV(b2Math.§8E§(_loc6_,1));
            this.§6"!§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§&!3§ = §0!#§(this.§@"2§,this.§0y§);
      }
      ...
      public function §1">§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§6"!§[0] = b2Math.§8E§(b2Math.§0!1§(param2,param1),1);
         this.§6"!§[0].Normalize();
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§0y§)
         {
            _loc6_ = (_loc9_ = this.§@"2§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§6"!§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§!8§.x = _loc5_ - b2internal::%I;
         param1.§!8§.y = _loc6_ - b2internal::%I;
         param1.§,f§.x = _loc7_ + b2internal::%I;
         param1.§,f§.y = _loc8_ + b2internal::%I;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§0y§)
         {
            _loc7_[_loc12_] = b2Math.§+'§(_loc5_,this.§@"2§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§2C§(param3,_loc24_.center));
                  return _loc24_.§7!^§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§0y§;
         var _loc14_:int = (_loc10_ + 1) % this.§0y§;
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§0y§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
         ...
         _loc20_.§8`§(1 / _loc19_);
         param4.SetV(b2Math.§2C§(param3,_loc20_));
         return _loc19_;
      }
