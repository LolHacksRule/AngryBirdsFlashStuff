package §8k§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§0!y§.x * this.§4!c§.x + (this.§ b§ + this.§0!y§.y) * this.§<!j§.x),param1 * (this.§0!y§.x * this.§4!c§.y + (this.§ b§ + this.§0!y§.y) * this.§<!j§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§""C§ = this.§""C§ > Number.MIN_VALUE ? Number(1 / this.§""C§) : Number(0);
         ...
         this.§1!o§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§1!o§.col2.x = this.§1!o§.col1.y;
         this.§1!o§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§=!1§)
         {
         ...
         if(param1.§'i§)
         {
            ...
            this.§0!y§.y *= param1.§ ,§;
            this.§ b§ *= param1.§ ,§;
            _loc19_ = this.§0!y§.x * this.§4!c§.x + (this.§ b§ + this.§0!y§.y) * this.§<!j§.x;
            _loc20_ = this.§0!y§.x * this.§4!c§.y + (this.§ b§ + this.§0!y§.y) * this.§<!j§.y;
            _loc21_ = this.§0!y§.x * this.m_s1 + (this.§ b§ + this.§0!y§.y) * this.m_a1;
            _loc22_ = this.§0!y§.x * this.m_s2 + (this.§ b§ + this.§0!y§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§<!j§.x * (_loc6_.x - _loc4_.x) + this.§<!j§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§""C§ * (this.§%p§ - _loc13_);
            _loc15_ = this.§ b§;
            _loc16_ = param1.§4"?§ * this.§ !m§;
            this.§ b§ = b2Math.§<O§(this.§ b§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§ b§ - _loc15_) * this.§<!j§.x;
            _loc9_ = _loc14_ * this.§<!j§.y;
         ...
         {
            _loc17_ = this.§<!j§.x * (_loc6_.x - _loc4_.x) + this.§<!j§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§0!y§.Copy();
            _loc19_ = this.§1!o§.§#!6§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§0!y§.§&3§(_loc19_);
            if(this.§#Q§ == b2internal::+p)
            {
               this.§0!y§.y = b2Math.§2Y§(this.§0!y§.y,0);
            }
            else if(this.§#Q§ == b2internal::9!i)
            {
               this.§0!y§.y = b2Math.§]"=§(this.§0!y§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§0!y§.y - _loc18_.y) * this.§1!o§.col2.x;
            if(this.§1!o§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§1!o§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§0!y§.x = _loc21_;
            _loc19_.x = this.§0!y§.x - _loc18_.x;
            _loc19_.y = this.§0!y§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§4!c§.x + _loc19_.y * this.§<!j§.x;
            _loc9_ = _loc19_.x * this.§4!c§.y + _loc19_.y * this.§<!j§.y;
         ...
         else
         {
            if(this.§1!o§.col1.x != 0)
            {
               _loc22_ = -_loc12_ / this.§1!o§.col1.x;
            }
            else
            {
               _loc22_ = 0;
            ...
            this.§0!y§.x += _loc22_;
            _loc8_ = _loc22_ * this.§4!c§.x;
            _loc9_ = _loc22_ * this.§4!c§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§=!1§)
         {
            ...
            _loc34_ = this.§<!j§.x * _loc26_ + this.§<!j§.y * _loc27_;
            if(b2Math.§"p§(this.§9!H§ - this.§%R§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§<O§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§"p§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§%R§)
            {
               _loc19_ = b2Math.§<O§(_loc34_ - this.§%R§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§%R§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§9!H§)
            {
               _loc19_ = b2Math.§<O§(_loc34_ - this.§9!H§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§9!H§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§1!o§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§1!o§.col2.x = this.§1!o§.col1.y;
            this.§1!o§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§1!o§.§#!6§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::>!m;
         ...
         var _loc30_:Number = _loc28_.x * this.§4!c§.x + _loc28_.y * this.§<!j§.x;
         var _loc31_:Number = _loc28_.x * this.§4!c§.y + _loc28_.y * this.§<!j§.y;
         ...
         _loc7_ -= b2internal::;!o * _loc32_;
         _loc8_.x += b2internal::&!W * _loc30_;
         _loc8_.y += b2internal::&!W * _loc31_;
         _loc9_ += b2internal::7m * _loc33_;
