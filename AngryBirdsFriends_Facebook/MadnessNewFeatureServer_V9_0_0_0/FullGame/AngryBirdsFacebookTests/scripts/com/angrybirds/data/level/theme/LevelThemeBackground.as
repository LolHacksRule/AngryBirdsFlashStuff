package com.angrybirds.data.level.theme
{
   public class LevelThemeBackground
   {
      ...
      public function addLayer(spriteName:String, spriteNames:Array, frameTime:Number, color:String, scale:Number, speed:Number, xOffset:Number, yOffset:Number, velocityX:Number, foreground:Boolean, tileable:Boolean, optional:Boolean, moveStartOffsetX:Number, moveEndOffsetX:Number, highQuality:Boolean = false, visible:Boolean = true) : LevelThemeBackgroundLayer
      {
         var layer:LevelThemeBackgroundLayer = new LevelThemeBackgroundLayer(spriteName,spriteNames,frameTime,color,scale,speed,xOffset,yOffset,velocityX,foreground,tileable,optional,moveStartOffsetX,moveEndOffsetX,highQuality,visible);
