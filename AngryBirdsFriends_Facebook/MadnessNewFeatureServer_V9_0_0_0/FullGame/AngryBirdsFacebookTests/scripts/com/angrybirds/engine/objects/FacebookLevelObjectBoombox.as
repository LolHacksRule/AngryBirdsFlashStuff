package com.angrybirds.engine.objects
{
   ...
   public class FacebookLevelObjectBoombox extends LevelObject
   {
      ...
      {
         if(damagingObject == this.mParachuteObject || damagingObject && damagingObject.levelItem.specialtyAvailableAfterCollision)
         {
            return health;
         }
         ...
         return super.applyDamage(damage,updateManager,damagingObject,addScore,ignoreDefence);
      }
      ...
      private function initParachute(updateManager:ILevelObjectUpdateManager) : void
      {
         ...
         var angleAdd:Number = 360 / 20;
         for(var counter:int = 0; counter < 20; counter++)
         {
