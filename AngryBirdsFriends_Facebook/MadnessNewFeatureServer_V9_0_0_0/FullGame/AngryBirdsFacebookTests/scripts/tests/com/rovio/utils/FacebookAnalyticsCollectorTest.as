package tests.com.rovio.utils
{
   ...
   public class FacebookAnalyticsCollectorTest
   {
      ...
      public function testTrackLevelStartedEvent() : void
      {
         ...
         FacebookAnalyticsCollector.getInstance().trackLevelStartedEvent("2000-1",-1,"Poached Eggs",3,3);
         ...
         assertEquals("2000-1",requestData["events"][0].parameters[0].value);
      }
      ...
      {
         var parameterName:* = null;
         FacebookAnalyticsCollector.getInstance().trackLevelEndedEvent(false,"2000-1",-1,"Poached Eggs",1,4,0,["ExtraSpeed"],20000,false);
         var data:Object = new Object();
         data.events = FacebookAnalyticsCollector.getInstance().getAnalyticsEvents();
         var requestData:URLVariables = new URLVariables();
         for(parameterName in data)
      ...
      {
         var parameterName:* = null;
         FacebookAnalyticsCollector.getInstance().trackLevelEndedEvent(true,"2000-1",-1,"Poached Eggs",1,4,3,["LaserSight","Earthquake"],20000,true);
         var data:Object = new Object();
         data.events = FacebookAnalyticsCollector.getInstance().getAnalyticsEvents();
         var requestData:URLVariables = new URLVariables();
         for(parameterName in data)
