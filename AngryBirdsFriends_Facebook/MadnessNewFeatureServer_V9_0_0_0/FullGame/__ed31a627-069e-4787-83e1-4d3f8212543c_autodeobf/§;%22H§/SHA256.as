package §;"H§
{
   ...
   public class SHA256
   {
      ...
      public static function §,"O§(param1:String) : String
      {
         ...
         return §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true) + §5Q§.§-"G§(_loc3_.readInt(),true);
      }
      ...
      private static function §##n§(param1:Array) : ByteArray
      {
         ...
         while(_loc13_ < _loc11_)
         {
            ...
            while(_loc23_ < 64)
            {
               ...
               {
                  _loc30_ = §5Q§.§else§(_loc12_[_loc23_ - 15],7) ^ §5Q§.§else§(_loc12_[_loc23_ - 15],18) ^ _loc12_[_loc23_ - 15] >>> 3;
                  _loc31_ = §5Q§.§else§(_loc12_[_loc23_ - 2],17) ^ §5Q§.§else§(_loc12_[_loc23_ - 2],19) ^ _loc12_[_loc23_ - 2] >>> 10;
                  _loc12_[_loc23_] = _loc12_[_loc23_ - 16] + _loc30_ + _loc12_[_loc23_ - 7] + _loc31_;
               }
               _loc24_ = §5Q§.§else§(_loc15_,2) ^ §5Q§.§else§(_loc15_,13) ^ §5Q§.§else§(_loc15_,22);
               _loc25_ = _loc15_ & _loc16_ ^ _loc15_ & _loc17_ ^ _loc16_ & _loc17_;
               _loc26_ = _loc24_ + _loc25_;
               _loc27_ = §5Q§.§else§(_loc19_,6) ^ §5Q§.§else§(_loc19_,11) ^ §5Q§.§else§(_loc19_,25);
