package §&!D§
{
   ...
   class §-J§
   {
      ...
      {
         var _loc1_:BitmapData = new BitmapData(§]#N§,§4";§);
         var _loc2_:ByteArray = new ByteArray();
         var _loc3_:int = §7G§.length;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc2_.writeUnsignedInt(§7G§[_loc4_]);
            _loc4_++;
         }
         _loc2_.uncompress();
         _loc1_.setPixels(new Rectangle(0,0,§]#N§,§4";§),_loc2_);
         return Texture.§0#B§(null,_loc1_,false);
      }
