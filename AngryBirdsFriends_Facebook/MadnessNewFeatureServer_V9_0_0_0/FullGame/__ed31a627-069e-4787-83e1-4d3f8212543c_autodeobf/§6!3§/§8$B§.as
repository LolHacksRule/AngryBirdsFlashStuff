package §6!3§
{
   ...
   public interface §8$B§
   {
       
      
      function addExplosion(param1:int, param2:Number, param3:Number, param4:int = -1) : void;
      
      function §;"8§(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:int = -1, param8:Boolean = true, param9:Boolean = true) : void;
      ...
      function §3P§(param1:String, param2:Number, param3:Number, param4:Number, param5:int, param6:Number = 0.0, param7:Number = 0.0, param8:Number = 1.0, param9:Boolean = false, param10:Boolean = false) : §!y§;
      ...
      function §9!_§(param1:String, param2:int, param3:int, param4:Number, param5:Number, param6:Number, param7:Number, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0, param13:Number = 1, param14:int = -1, param15:Boolean = false) : void;
      
      function removeObject(param1:§!y§, param2:Boolean = false, param3:Boolean = false) : void;
      
      function §[=§(param1:§!y§) : Boolean;
      
      function get objectCount() : int;
      
      function §?e§(param1:String) : §?$>§;
      
      function getObject(param1:int) : §!y§;
      
      function getObjectFromPoint(param1:Number, param2:Number) : §;!U§;
      
      function §&$8§(param1:Boolean) : void;
