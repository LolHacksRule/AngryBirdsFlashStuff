package com.angrybirds.engine.particles
{
   ...
   public class FacebookLevelParticleManager extends LevelParticleManager
   {
      ...
      public function addFireBurningEffect(x:Number, y:Number, scale:Number) : void
      {
         AngryBirdsEngine.smLevelMain.particles.addSimpleParticle("FIREORB_FLAME",LevelParticle.PARTICLE_NAME_EXPLOSIONS_PARTICLE,LevelParticleManager.PARTICLE_GROUP_FOREGROUND_EFFECTS,LevelParticle.PARTICLE_TYPE_KINETIC_PARTICLE,x,y,600,"",LevelParticle.PARTICLE_MATERIAL_BLOCKS_MISC,0,0,0,0,scale,14,true);
      }
