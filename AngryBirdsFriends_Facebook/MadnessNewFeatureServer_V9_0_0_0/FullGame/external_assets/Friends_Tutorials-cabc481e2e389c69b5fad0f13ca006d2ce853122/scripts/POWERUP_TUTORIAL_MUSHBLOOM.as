package
{
   ...
   public dynamic class POWERUP_TUTORIAL_MUSHBLOOM extends MovieClip
   {
       
      
      public function POWERUP_TUTORIAL_MUSHBLOOM()
      {
         super();
      }
      ...
      public function addCollisionParticles(param1:Number, param2:Number, param3:Class = null, param4:Number = 1) : void
      {
         ...
         var defaultParticleClass:Class = StoneParticle;
