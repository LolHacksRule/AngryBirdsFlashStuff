   ...
   public class §[o§ extends §4!M§
   {
      ...
      protected function §=!%§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§86§(_loc7_,_loc6_)]) == null)
            {
      ...
      private function §86§(param1:String, param2:String) : String
      {
      ...
      private function §>V§(param1:Vector.<XML>) : Dictionary
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§86§(_loc4_,_loc6_.@name);
