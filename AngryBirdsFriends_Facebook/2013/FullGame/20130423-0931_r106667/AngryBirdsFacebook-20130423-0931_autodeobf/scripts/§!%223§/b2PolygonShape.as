   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      public static function §5!I§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§6"3§(new b2Vec2(0,0));
            _loc3_.§6"3§(_loc9_);
            _loc3_.§6"3§(_loc10_);
            _loc3_.§!!L§(_loc16_ * _loc7_);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §-1§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§8"Q§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §-!;§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§4C§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§9N§(this.§["8§[_loc5_],this.§["8§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§03§() > Number.MIN_VALUE);
            this.§0!3§[_loc3_].SetV(b2Math.§@!§(_loc6_,1));
            this.§0!3§[_loc3_].Normalize();
            _loc3_++;
         }
      ...
      public function §,_§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§1!F§.x = 0.5 * (param1.x + param2.x);
         this.§1!F§.y = 0.5 * (param1.y + param2.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§4C§)
         {
            _loc6_ = (_loc9_ = this.§["8§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§0!3§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§8"S§.x = _loc5_ - b2internal::0!_;
         param1.§8"S§.y = _loc6_ - b2internal::0!_;
         param1.§4B§.x = _loc7_ + b2internal::0!_;
         param1.§4B§.y = _loc8_ + b2internal::0!_;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§4C§ == 2)
         {
            param1.center.x = 0.5 * (this.§["8§[0].x + this.§["8§[1].x);
            param1.center.y = 0.5 * (this.§["8§[0].y + this.§["8§[1].y);
            param1.§'"N§ = 0;
            param1.§@!6§ = 0;
            return;
         }
         ...
         param1.§'"N§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§@!6§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§60§(param3.R,param1);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§4C§)
         {
            _loc7_[_loc12_] = b2Math.§[!3§(_loc5_,this.§["8§[_loc12_]) - _loc6_;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§4C§;
         var _loc14_:int = (_loc10_ + 1) % this.§4C§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§["8§[_loc9_].x * (1 - _loc15_) + this.§["8§[_loc13_].x * _loc15_,this.§["8§[_loc9_].y * (1 - _loc15_) + this.§["8§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§["8§[_loc10_].x * (1 - _loc16_) + this.§["8§[_loc14_].x * _loc16_,this.§["8§[_loc10_].y * (1 - _loc16_) + this.§["8§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§["8§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§4C§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§["8§[_loc12_];
            }
