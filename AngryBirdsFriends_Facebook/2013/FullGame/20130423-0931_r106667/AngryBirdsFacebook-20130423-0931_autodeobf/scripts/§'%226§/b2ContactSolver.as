package §'"6§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §0e§:b2WorldManifold = new b2WorldManifold();
      
      private static var §]!D§:b2PositionSolverManifold = new b2PositionSolverManifold();
      ...
      public function §6!Q§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§>!`§ = param4;
         this.§%f§ = param3;
         while(this.§6o§.length < this.§%f§)
         {
            this.§6o§[this.§6o§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            ...
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§-"E§(),_loc10_.§-"E§());
            _loc20_ = _loc15_.§"!_§.x;
            _loc21_ = _loc15_.§"!_§.y;
            _loc22_ = _loc16_.§"!_§.x;
            _loc23_ = _loc16_.§"!_§.y;
            ...
            §0e§.§6!Q§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §0e§.§0"#§.x;
            _loc27_ = §0e§.§0"#§.y;
            (_loc28_ = this.§6o§[_loc6_]).§`y§ = _loc15_;
            _loc28_.§8!7§ = _loc16_;
            _loc28_.§=_§ = _loc17_;
            ...
            _loc28_.§^P§.x = _loc17_.§3=§.x;
            _loc28_.§^P§.y = _loc17_.§3=§.y;
            ...
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§=!7§)
            {
               _loc30_ = _loc17_.§4!_§[_loc29_];
               (_loc31_ = _loc28_.§]!@§[_loc29_]).normalImpulse = _loc30_.§#!5§;
               _loc31_.tangentImpulse = _loc30_.§@"%§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§2J§.x = §0e§.§4!_§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§2J§.y = §0e§.§4!_§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§5Y§.x = §0e§.§4!_§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§5Y§.y = §0e§.§4!_§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§-@§ + _loc16_.§-@§ + _loc15_.§,H§ * _loc36_ + _loc16_.§,H§ * _loc37_;
               _loc31_.§+"G§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§,!v§ * _loc15_.§-@§ + _loc16_.§,!v§ * _loc16_.§-@§) + (_loc15_.§,!v§ * _loc15_.§,H§ * _loc36_ + _loc16_.§,!v§ * _loc16_.§,H§ * _loc37_);
               _loc31_.§1"3§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§-@§ + _loc16_.§-@§ + _loc15_.§,H§ * _loc42_ + _loc16_.§,H§ * _loc43_;
               _loc31_.§ w§ = 1 / _loc44_;
               _loc31_.§3!5§ = 0;
               ...
               {
                  _loc31_.§3!5§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§=!7§ == 2)
            {
               ...
               _loc52_ = _loc16_.§-@§;
               _loc53_ = _loc16_.§,H§;
               _loc54_ = _loc48_.§2J§.x * _loc27_ - _loc48_.§2J§.y * _loc26_;
               _loc55_ = _loc48_.§5Y§.x * _loc27_ - _loc48_.§5Y§.y * _loc26_;
               _loc56_ = _loc49_.§2J§.x * _loc27_ - _loc49_.§2J§.y * _loc26_;
               _loc57_ = _loc49_.§5Y§.x * _loc27_ - _loc49_.§5Y§.y * _loc26_;
         ...
         while(_loc5_ < this.§%f§)
         {
            ...
            if(param1.§@I§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§2J§.x * _loc22_ - _loc20_.§2J§.y * _loc21_);
                  _loc7_.§"!_§.x -= _loc9_ * _loc21_;
                  _loc7_.§"!_§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§5Y§.x * _loc22_ - _loc20_.§5Y§.y * _loc21_);
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         {
            _loc26_ = (_loc25_ = this.§6o§[_loc24_]).§`y§;
            _loc27_ = _loc25_.§8!7§;
            ...
            _loc1_ = 0;
            while(_loc1_ < _loc25_.§=!7§)
            {
               _loc2_ = _loc25_.§]!@§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§5Y§.y - _loc30_.x + _loc28_ * _loc2_.§2J§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§5Y§.x - _loc30_.y - _loc28_ * _loc2_.§2J§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§ w§ * -_loc10_;
               _loc12_ = _loc40_ * _loc2_.normalImpulse;
               _loc14_ = (_loc11_ = (_loc13_ = b2Math.§1"T§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_)) - _loc2_.tangentImpulse) * _loc38_;
               _loc15_ = _loc11_ * _loc39_;
               _loc30_.x -= _loc32_ * _loc14_;
               _loc30_.y -= _loc32_ * _loc15_;
               _loc28_ -= _loc33_ * (_loc2_.§2J§.x * _loc15_ - _loc2_.§2J§.y * _loc14_);
               _loc31_.x += _loc34_ * _loc14_;
               _loc31_.y += _loc34_ * _loc15_;
               _loc29_ += _loc35_ * (_loc2_.§5Y§.x * _loc15_ - _loc2_.§5Y§.y * _loc14_);
            ...
            if(_loc25_.§=!7§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§+"G§ * (_loc9_ - _loc2_.§3!5§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§5Y§.y - _loc30_.x + _loc28_ * _loc43_.§2J§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§5Y§.x - _loc30_.y - _loc28_ * _loc43_.§2J§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§5Y§.y - _loc30_.x + _loc28_ * _loc44_.§2J§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§5Y§.x - _loc30_.y - _loc28_ * _loc44_.§2J§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§3!5§;
               _loc54_ = _loc52_ - _loc44_.§3!5§;
               _loc22_ = _loc25_.K;
               _loc53_ -= _loc22_.col1.x * _loc45_ + _loc22_.col2.x * _loc46_;
               _loc54_ -= _loc22_.col1.y * _loc45_ + _loc22_.col2.y * _loc46_;
               _loc55_ = 0.001;
               _loc56_ = -((_loc22_ = _loc25_.§+"G§).col1.x * _loc53_ + _loc22_.col2.x * _loc54_);
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§2J§.x * _loc19_ - _loc43_.§2J§.y * _loc18_ + _loc44_.§2J§.x * _loc21_ - _loc44_.§2J§.y * _loc20_);
                  _loc31_.x += _loc34_ * (_loc18_ + _loc20_);
                  _loc31_.y += _loc34_ * (_loc19_ + _loc21_);
                  _loc29_ += _loc35_ * (_loc43_.§5Y§.x * _loc19_ - _loc43_.§5Y§.y * _loc18_ + _loc44_.§5Y§.x * _loc21_ - _loc44_.§5Y§.y * _loc20_);
                  _loc43_.normalImpulse = _loc56_;
                  _loc44_.normalImpulse = _loc57_;
               }
               else
               {
                  _loc56_ = -_loc43_.§+"G§ * _loc53_;
                  _loc57_ = 0;
                  _loc51_ = 0;
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§%f§)
         {
            ...
            _loc6_ = _loc4_.§8!7§;
            _loc7_ = _loc5_.§,!v§ * _loc5_.§-@§;
            _loc8_ = _loc5_.§,!v§ * _loc5_.§,H§;
            _loc9_ = _loc6_.§,!v§ * _loc6_.§-@§;
            _loc10_ = _loc6_.§,!v§ * _loc6_.§,H§;
            §]!D§.§6!Q§(_loc4_);
            _loc11_ = §]!D§.§0"#§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§=!7§)
            {
               _loc13_ = _loc4_.§]!@§[_loc12_];
               _loc14_ = §]!D§.§4!_§[_loc12_];
               _loc15_ = §]!D§.§ !'§[_loc12_];
               ...
               _loc20_ = b2Math.§1"T§(param1 * (_loc15_ + b2Settings.b2_linearSlop),-b2Settings.b2_maxLinearCorrection,0);
               _loc22_ = (_loc21_ = -_loc13_.§1"3§ * _loc20_) * _loc11_.x;
