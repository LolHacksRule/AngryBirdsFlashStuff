package §'"-§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §!!$§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
         ...
         _loc3_.aabb.§8"S§.x = param1.§8"S§.x - _loc4_;
         _loc3_.aabb.§8"S§.y = param1.§8"S§.y - _loc5_;
         _loc3_.aabb.§4B§.x = param1.§4B§.x + _loc4_;
         _loc3_.aabb.§4B§.y = param1.§4B§.y + _loc5_;
         _loc3_.§-!"§ = param2;
         this.§?" §(_loc3_);
         return _loc3_;
      }
      ...
      public function § c§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         ...
         param1.aabb.§8"S§.x = param2.§8"S§.x - _loc4_;
         param1.aabb.§8"S§.y = param2.§8"S§.y - _loc5_;
         param1.aabb.§4B§.x = param2.§4B§.x + _loc4_;
         param1.aabb.§4B§.y = param2.§4B§.y + _loc5_;
         this.§?" §(param1);
         return true;
      }
      ...
      public function §^"Y§(param1:Function, param2:b2AABB) : void
      {
         ...
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§9e§(param2))
            {
               if(_loc5_.§3!n§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         _loc9_.§8"S§.x = Math.min(_loc3_.x,_loc10_);
         _loc9_.§8"S§.y = Math.min(_loc3_.y,_loc11_);
         _loc9_.§4B§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§4B§.y = Math.max(_loc3_.y,_loc11_);
         ...
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§9e§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§4P§();
               _loc16_ = _loc14_.aabb.§+M§();
      ...
      private function §?" §(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_.§3!n§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§8"S§.x + _loc6_.aabb.§4B§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§8"S§.y + _loc6_.aabb.§4B§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§8"S§.x + _loc7_.aabb.§4B§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§8"S§.y + _loc7_.aabb.§4B§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         _loc5_.§-!"§ = null;
         _loc5_.aabb.§9!-§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            while(!_loc4_.aabb.§?"3§(_loc5_.aabb))
            {
               _loc4_.aabb.§9!-§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
