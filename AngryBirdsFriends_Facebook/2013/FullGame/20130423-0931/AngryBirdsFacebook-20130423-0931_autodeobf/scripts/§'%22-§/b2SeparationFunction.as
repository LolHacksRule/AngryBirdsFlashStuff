package §'"-§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §6!Q§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§<"@§ = §1!6§;
            _loc7_ = this.§8"P§.§,"-§(param1.indexA[0]);
         ...
         {
            this.§<"@§ = §[!7§;
            _loc8_ = this.§8"P§.§,"-§(param1.indexA[0]);
            _loc9_ = this.§8"P§.§,"-§(param1.indexA[1]);
            _loc10_ = this.§+!_§.§,"-§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§1!?§ = b2Math.§@!§(b2Math.§9N§(_loc9_,_loc8_),1);
            this.§1!?§.Normalize();
            _loc20_ = this.§1!?§;
         ...
         else if(param1.indexA[0] == param1.indexA[0])
         {
            ...
            this.§1!?§ = b2Math.§@!§(b2Math.§9N§(_loc12_,_loc11_),1);
            this.§1!?§.Normalize();
            _loc20_ = this.§1!?§;
         ...
         else
         {
            ...
            _loc24_ = b2Math.§5!w§(param3.R,b2Math.§9N§(_loc9_,_loc8_));
            _loc25_ = b2Math.§^T§(param5,_loc10_);
            _loc26_ = b2Math.§5!w§(param5.R,b2Math.§9N§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§9N§(_loc26_,_loc24_);
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§1"T§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§1"T§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         switch(this.§<"@§)
         {
            case §1!6§:
               ...
               return Number(((_loc8_ = b2Math.§^T§(param2,_loc6_)).x - _loc7_.x) * this.§1!?§.x + (_loc8_.y - _loc7_.y) * this.§1!?§.y);
            case §[!7§:
