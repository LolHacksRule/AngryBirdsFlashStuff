package §;!;§
{
   public class §7F§
   {
      ...
      {
         §7]§[§7]§.length] = new §4G§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10);
      }
      ...
      public static function §=#§(param1:String) : §4G§
      {
         ...
         {
            if((§7]§[_loc2_] as §4G§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §7]§[_loc2_] as §4G§;
            }
            _loc2_++;
         }
         return null;
