package §;'§
{
   ...
   public class §>-§
   {
      ...
      public static const MIGHTY_EAGLE_Y_CHANGE:Number = Math.sin(§@!4§.§&!D§(MIGHTY_EAGLE_FLYING_ANGLE));
      
      public static const MIGHTY_EAGLE_X_DIRECTION:Number = 1;
      
      public static const §4$§:Number = 1500;
      
      public static const §>4§:Number = 0.7;
      
      public static const §?U§:Number = 0.2;
      
      public static const §;t§:Number = 8.8;
      
      public static const §9=§:Number = 2400;
      
      public static const §>;§:Number = 1;
      
      public static const §^!3§:Number = 0.15;
      ...
      public static const §,T§:Number = 6 * §^!7§;
      ...
      public static const §9F§:Number = 1.3;
      
      public static const §+t§:Number = 1.3;
      
      public static const §03§:Number = 1.3;
      ...
      public static const §+b§:Number = 1.5;
      
      public static const §5!M§:Number = 1.2;
      
      public static const §^,§:Number = 1.25;
      
      public static const §!E§:Number = 1.2;
      
      public static const §&!H§:Number = 1.25;
      
      public static var §&a§:int = 60;
      ...
      public static const §"x§:int = 25;
      
      public static const §^@§:int = 1;
      
      public static const §+T§:Number = 70;
      
      public static const §;A§:Number = 10;
      
      public static const §#z§:Number = 1000;
      
      public static const §1!G§:Number = 1.3;
      
      public static const §6B§:Number = 7.5;
      ...
      public static const §;!B§:Number = 0.15;
