package §"X§
{
   ...
   public class Texture
   {
      ...
      public static function §-!4§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §"X§.Texture
      {
         return §^!I§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §^!I§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §"X§.Texture
      {
         ...
         return new §#!L§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §3!9§(param1:Context3D, param2:ByteArray) : §"X§.Texture
      {
         if(param1 == null)
         {
            throw new §%!-§();
      ...
      public static function §?=§(param1:§"X§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §"X§.Texture
      {
         var _loc4_:§"X§.Texture;
         (_loc4_ = new §#!L§(param1,param2)).§'!C§ = param3;
         return _loc4_;
      }
      
      public static function §'y§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §"X§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§"X§.Texture = §^!I§(param1,_loc6_,false,param5);
         if(!§5!@§.§%!;§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§^d§, param2:int, param3:int) : void
      {
         ...
         if(this.§'!C§)
         {
            ...
            _loc4_ = this.§'!C§.width + this.§'!C§.x - this.width;
            _loc5_ = this.§'!C§.height + this.§'!C§.y - this.height;
            param1.§''§(param2,-this.§'!C§.x,-this.§'!C§.y);
            param1.§''§(param2 + 1,-_loc4_,-this.§'!C§.y);
            param1.§''§(param2 + 2,-this.§'!C§.x,-_loc5_);
      ...
      {
         return !!this.§'!C§ ? this.§'!C§.clone() : new Rectangle(0,0,this.width,this.height);
      }
      ...
      public function get root() : §"X§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §"X§.Texture
      {
         return this;
      }
