package §;^§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private var §2!0§:Vector.<DisplayObject>;
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§2!0§ = new Vector.<DisplayObject>(0);
      }
      
      override public function dispose() : void
      {
         var _loc1_:int = this.§2!0§.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            this.§2!0§[_loc2_].dispose();
            _loc2_++;
         }
         super.dispose();
      }
      ...
      public function §9s§(param1:DisplayObject) : void
      {
         var _loc2_:int = this.§2!0§.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            if(param1.z < this.§2!0§[_loc3_].z)
            {
      ...
      public function addChildAt(param1:DisplayObject, param2:int) : void
      {
         ...
         {
            param1.§#`§();
            this.§2!0§.splice(param2,0,param1);
            param1.§<3§(this);
            return;
         }
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§2!0§[param1];
            _loc3_.§<3§(null);
            this.§2!0§.splice(param1,1);
            if(param2)
            {
               _loc3_.dispose();
            }
      ...
      public function §;m§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      public function getChildByName(param1:String) : DisplayObject
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(this.§2!0§[_loc3_].name == param1)
            {
               return this.§2!0§[_loc3_];
            }
            _loc3_++;
         }
         return null;
      ...
      {
         return this.§2!0§.indexOf(param1);
      }
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§2!0§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§2!0§.length;
         if(_loc3_ == 0)
         {
            §+9§(param1,§,!!§);
            transformCoords(§,!!§,0,0,§%h§);
            param2.x = §%h§.x;
            param2.y = §%h§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§2!0§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§2!0§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§2!0§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§2!0§[_loc6_];
            §+9§(_loc7_,§,!!§);
            transformCoords(§,!!§,_loc3_,_loc4_,§%h§);
      ...
      override public function render(param1:§!0§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§2!0§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§[S§();
               param1.§=!7§(_loc5_);
      ...
      private function §,K§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§2!0§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
