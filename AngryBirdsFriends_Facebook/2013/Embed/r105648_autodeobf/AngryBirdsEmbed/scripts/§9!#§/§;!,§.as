package §9!#§
{
   ...
   public class §;!,§
   {
      ...
      {
         §=! §[§=! §.length] = new §+5§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13);
      }
      ...
      public static function §+;§(param1:String) : §+5§
      {
         ...
         while(_loc2_ < §=! §.length)
         {
            if(§+5§(§=! §[_loc2_]).mName.toLowerCase() == param1.toLowerCase())
            {
               return §+5§(§=! §[_loc2_]);
            }
            _loc2_++;
