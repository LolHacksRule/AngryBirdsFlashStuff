package §9!#§
{
   ...
   public class §]F§
   {
         ...
         for each(_loc2_ in param1.Shape)
         {
            if(_loc2_.@shape == "CIRCLE" || _loc2_.@shape == "POLYGON" || _loc2_.@shape == "NONE")
            {
               ...
               if(_loc4_ == "CIRCLE")
               {
                  ...
                  §6W§(_loc3_,_loc4_,_loc7_,_loc5_);
               }
               else
               {
                  §&v§(_loc3_,_loc4_,_loc5_,_loc2_.@flipAngleCorrection);
               }
            }
            else
            {
      ...
      {
         §?W§[§?W§.length] = new §8U§(param1,param2,param3,param4,param5);
      }
      
      public static function §&v§(param1:String, param2:String, param3:Array, param4:Number) : void
      {
         var _loc5_:§8U§;
         (_loc5_ = new §8U§(param1,param2,-1,-1,param4)).§,_§(param3);
         _loc5_.§&-§();
         §?W§[§?W§.length] = _loc5_;
      }
      
      public static function §6W§(param1:String, param2:String, param3:Number, param4:Array) : void
      {
         var _loc5_:§8U§;
         (_loc5_ = new §8U§(param1,param2,param3,param3)).§,_§(param4);
         §?W§[§?W§.length] = _loc5_;
      }
      
      public static function §9!6§(param1:String) : §8U§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §?W§.length)
         {
            if((§?W§[_loc2_] as §8U§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §8U§(§?W§[_loc2_]);
            }
            _loc2_++;
