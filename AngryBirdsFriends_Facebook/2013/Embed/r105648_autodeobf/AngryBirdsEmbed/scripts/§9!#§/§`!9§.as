package §9!#§
{
   ...
   public class §`!9§
   {
      ...
      public static function §0!,§(param1:XMLList, param2:XMLList, param3:XMLList) : void
      {
         var _loc4_:XML = null;
         §95§ = new Array();
         for each(_loc4_ in param1.Material)
         {
            ...
            §"r§(_loc4_.@id,_loc4_.@bodyType,_loc4_.@density,_loc4_.@friction,_loc4_.@restitution,_loc4_.@strength,_loc4_.@defence,_loc4_.@colors);
         }
         §+B§(param2,param3);
      }
      ...
      public static function §"r§(param1:String, param2:String, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : void
      {
         §95§[§95§.length] = new §-!'§(param1,param2,param3,param4,param5,param6,param7,param8);
      }
      
      public static function §4!#§(param1:String) : §-!'§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §95§.length)
         {
            if((§95§[_loc2_] as §-!'§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §-!'§(§95§[_loc2_]);
            }
            _loc2_++;
