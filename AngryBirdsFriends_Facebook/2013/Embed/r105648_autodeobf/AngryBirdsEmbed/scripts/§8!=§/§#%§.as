package §8!=§
{
   ...
   public class §#%§
   {
      ...
      public static function §7%§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         jsonString = §'!1§(luaString,emptyObjectAsArray);
         try
         {
      ...
      public static function §,!J§(param1:String, param2:Boolean = false) : Object
      {
         var returnObject:Object = null;
      ...
      public static function §'!1§(param1:String, param2:Boolean = false) : String
      {
         ...
         return §0v§(param1,param2);
      }
      
      private static function §0v§(param1:String, param2:Boolean) : String
      {
      ...
      public static function §45§(param1:Object) : String
      {
         return §%!>§(param1,0);
      }
      ...
      private static function §%!>§(param1:Object, param2:int) : String
      {
         ...
         for(_loc4_ in param1)
         {
            ...
            _loc3_ += _loc4_ + " = " + §0q§(param1[_loc4_],param2);
            if(param2 > 1)
            {
               _loc3_ += ",";
            }
      ...
      private static function §0q§(param1:*, param2:int) : String
      {
         ...
         else
         {
            ...
            if(param1 is Array)
            {
               ...
               {
                  _loc3_ += !!(§0q§(param1[_loc6_],param2) + (_loc6_ < param1.length - 1)) ? "," : "";
                  _loc6_++;
               }
               return _loc3_ + "}";
            }
