package §=!K§
{
   ...
   public class §]!%§
   {
      ...
      private function §3C§(param1:Array) : Array
      {
         var _loc3_:String = null;
         var _loc2_:Array = [];
      ...
      private function §]a§(param1:Array) : §#4§
      {
         var _loc3_:String = null;
         var _loc4_:§@p§ = null;
         var _loc2_:§#4§ = new §#4§();
      ...
      protected function §#1§(param1:String, param2:Array) : void
      {
         ...
         var _loc3_:§4!0§ = new §4!0§();
         for each(_loc4_ in param2)
         {
            _loc5_ = _loc4_[0];
            _loc6_ = _loc4_[1];
            _loc3_.§'!G§(_loc5_,this.§]a§(_loc6_));
         }
         this.§>E§[param1] = _loc3_;
      }
      
      public function §]C§(param1:String) : §#4§
      {
