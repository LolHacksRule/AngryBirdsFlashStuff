package §[v§
{
   ...
   public class §7e§
   {
      ...
      private function §99§(param1:Array) : void
      {
      ...
      private function §<G§(param1:Array) : §03§
      {
         var _loc3_:String = null;
         var _loc4_:§'P§ = null;
         var _loc2_:§03§ = new §03§();
         for each(_loc3_ in param1)
         {
            _loc4_ = this.§4d§.§4`§(_loc3_);
      ...
      public function § +§(param1:String) : §03§
      {
