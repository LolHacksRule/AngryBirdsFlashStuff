package §3;§
{
   ...
   public class §"]§ extends §"#§
   {
      ...
      protected function §^!&§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         var _loc16_:§6!J§ = null;
         var _loc3_:Dictionary = this.§@i§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§6w§(_loc7_,_loc6_)]) == null)
            {
            ...
            if(_loc10_)
            {
               ...
               (_loc16_ = new §6!J§()).mName = _loc6_;
               _loc16_.§&f§ = _loc15_;
               _loc16_.§9!9§ = _loc10_.pivotX;
      ...
      private function §6w§(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function §@i§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§6w§(_loc4_,_loc6_.@name);
