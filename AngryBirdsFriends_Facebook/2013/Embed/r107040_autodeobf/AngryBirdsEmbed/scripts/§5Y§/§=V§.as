package §5Y§
{
   public class §=V§
   {
      ...
      {
         §#F§[§#F§.length] = new §+!C§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10);
      }
      
      public static function §59§(param1:String) : §+!C§
      {
         var _loc2_:int = 0;
