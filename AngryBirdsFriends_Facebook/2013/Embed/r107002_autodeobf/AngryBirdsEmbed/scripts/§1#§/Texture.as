package §1#§
{
   ...
   public class Texture
   {
      ...
      public static function §1!@§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §1#§.Texture
      {
         return §>!E§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §>!E§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §1#§.Texture
      {
         ...
         _loc10_ = new §^y§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§,L§.§;!;§)
         {
            _loc10_.§#^§(param2);
         }
         ...
         return new §-!E§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §@S§(param1:Context3D, param2:ByteArray) : §1#§.Texture
      {
         if(param1 == null)
         {
            throw new §7k§();
         ...
         var _loc9_:§^y§ = new §^y§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§,L§.§;!;§)
         {
            _loc9_.§#^§(param2);
         }
      ...
      public static function §9P§(param1:§1#§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §1#§.Texture
      {
         var _loc4_:§1#§.Texture;
         (_loc4_ = new §-!E§(param1,param2)).§3<§ = param3;
         return _loc4_;
      }
      
      public static function §9q§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §1#§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§1#§.Texture = §>!E§(param1,_loc6_,false,param5);
         if(!§,L§.§;!;§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§ !#§, param2:int, param3:int) : void
      {
         ...
         if(this.§3<§)
         {
            ...
            _loc4_ = this.§3<§.width + this.§3<§.x - this.width;
            _loc5_ = this.§3<§.height + this.§3<§.y - this.height;
            param1.§2O§(param2,-this.§3<§.x,-this.§3<§.y);
            param1.§2O§(param2 + 1,-_loc4_,-this.§3<§.y);
            param1.§2O§(param2 + 2,-this.§3<§.x,-_loc5_);
            param1.§2O§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      ...
      public function get root() : §1#§.Texture
      {
         return null;
      }
