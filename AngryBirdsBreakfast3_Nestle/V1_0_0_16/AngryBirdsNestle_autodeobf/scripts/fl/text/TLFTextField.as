package fl.text
{
   ...
   public class TLFTextField extends Sprite
   {
      ...
      public function get maxScrollV() : int
      {
         ...
         var _loc5_:int = (int(!this._containerManager.columnCount || this._containerManager.columnCount == FormatValue.AUTO ? 1 : int(int(this._containerManager.columnCount)))) - 1;
