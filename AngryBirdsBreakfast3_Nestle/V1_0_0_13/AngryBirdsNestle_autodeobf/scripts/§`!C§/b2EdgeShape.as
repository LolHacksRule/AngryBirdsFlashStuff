package §`!C§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§4!s§ = this.§<!&§.Normalize();
         this.§1!G§.Set(this.§<!&§.y,-this.§<!&§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§1!G§.x - this.§<!&§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§1!G§.y - this.§<!&§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§1!G§.x + this.§<!&§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§1!G§.y + this.§<!&§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§1!G§;
         this.m_cornerDir2.Set(-this.§1!G§.x,-this.§1!G§.y);
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§,J§ * _loc12_)
            {
      ...
      public function §5Q§() : b2EdgeShape
      {
         return this.§+j§;
      }
      ...
      b2internal function §7w§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§+j§ = param1;
