package §,H§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§9!z§.x * this.§%"4§.x + (this.§!<§ + this.§9!z§.z) * this.§7!;§.x),param1 * (this.§9!z§.x * this.§%"4§.y + (this.§!<§ + this.§9!z§.z) * this.§7!;§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§#=§)
         {
            ...
            this.§9!z§.y *= param1.§6!'§;
            this.§!<§ *= param1.§6!'§;
            _loc19_ = this.§9!z§.x * this.§%"4§.x + (this.§!<§ + this.§9!z§.z) * this.§7!;§.x;
            _loc20_ = this.§9!z§.x * this.§%"4§.y + (this.§!<§ + this.§9!z§.z) * this.§7!;§.y;
            _loc21_ = this.§9!z§.x * this.m_s1 + this.§9!z§.y + (this.§!<§ + this.§9!z§.z) * this.m_a1;
            _loc22_ = this.§9!z§.x * this.m_s2 + this.§9!z§.y + (this.§!<§ + this.§9!z§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§>!J§ && this.§'!m§ != b2internal::8!4)
         {
            ...
            _loc15_ = this.§9!t§ * (this.§ 6§ - _loc14_);
            _loc16_ = this.§!<§;
            _loc17_ = param1.§>!`§ * this.§]&§;
            this.§!<§ = b2Math.§8M§(this.§!<§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§!<§ - _loc16_) * this.§7!;§.x;
         ...
         if(this.§0Y§ && this.§'!m§ != b2internal::6"%)
         {
            ...
            _loc19_ = this.§9!z§.Copy();
            _loc20_ = this.§#![§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§9!z§.§package§(_loc20_);
            if(this.§'!m§ == b2internal::44)
            {
               this.§9!z§.z = b2Math.§[k§(this.§9!z§.z,0);
            }
            else if(this.§'!m§ == b2internal::<B)
            {
               this.§9!z§.z = b2Math.§?P§(this.§9!z§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§9!z§.z - _loc19_.z) * this.§#![§.col3.x;
            _loc22_ = -_loc13_ - (this.§9!z§.z - _loc19_.z) * this.§#![§.col3.y;
            _loc23_ = this.§#![§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§9!z§.x = _loc23_.x;
            this.§9!z§.y = _loc23_.y;
            _loc20_.x = this.§9!z§.x - _loc19_.x;
            _loc20_.y = this.§9!z§.y - _loc19_.y;
            _loc20_.z = this.§9!z§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§%"4§.x + _loc20_.z * this.§7!;§.x;
            _loc9_ = _loc20_.x * this.§%"4§.y + _loc20_.z * this.§7!;§.y;
         ...
         else
         {
            ...
            this.§9!z§.x += _loc24_.x;
            this.§9!z§.y += _loc24_.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§0Y§)
         {
            ...
            if(b2Math.§<#§(this.§ !9§ - this.§^+§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§8M§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§<#§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§^+§)
            {
               _loc19_ = b2Math.§8M§(_loc35_ - this.§^+§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§^+§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§ !9§)
            {
               _loc19_ = b2Math.§8M§(_loc35_ - this.§ !9§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§9!=§;
         ...
         var _loc31_:Number = _loc28_.x * this.§%"4§.x + _loc28_.z * this.§7!;§.x;
         var _loc32_:Number = _loc28_.x * this.§%"4§.y + _loc28_.z * this.§7!;§.y;
         ...
         _loc7_ -= b2internal::4!A * _loc33_;
         _loc8_.x += b2internal::9!j * _loc31_;
         _loc8_.y += b2internal::9!j * _loc32_;
         _loc9_ += b2internal::+!_ * _loc34_;
