package §,H§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §0_§:Number = 2;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§@" § = b2internal::3v.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§%!;§.x - this.§@" §.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§%!;§.y - this.§@" §.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§!j§.x - this.§@" §.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§!j§.y - this.§@" §.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§'&§);
         this.m_localAnchor2.SetV(param1.§%"0§);
         this.§8B§ = param1.§%"7§;
         this.§+!>§ = param1.§8r§ + this.§8B§ * param1.§<!5§;
         this.m_maxLength1 = b2Math.§?P§(param1.§'!E§,this.§+!>§ - this.§8B§ * b2internal::0_);
         this.m_maxLength2 = b2Math.§?P§(param1.§!!'§,(this.§+!>§ - b2internal::0_) / this.§8B§);
         this.§9!z§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§9!z§ * this.m_u2.x,param1 * this.§9!z§ * this.m_u2.y);
      }
      ...
      public function §7""§() : b2Vec2
      {
         ...
         _loc1_.§package§(this.m_groundAnchor1);
         return _loc1_;
      }
      ...
      {
         var _loc1_:b2Vec2 = this.§@" §.m_xf.position.Copy();
         _loc1_.§package§(this.m_groundAnchor2);
         return _loc1_;
      }
      
      public function GetLength1() : Number
      {
         var _loc1_:b2Vec2 = b2internal::3v.GetWorldPoint(this.m_localAnchor1);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§+!>§ - _loc18_ - this.§8B§ * _loc19_) > 0)
         {
            this.§<t§ = b2internal::6"%;
            this.§9!z§ = 0;
         }
         ...
         this.m_limitMass1 = _loc2_.§;!R§ + _loc2_.§1!k§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§;!R§ + _loc3_.§1!k§ * _loc22_ * _loc22_;
         this.§=b§ = this.m_limitMass1 + this.§8B§ * this.§8B§ * this.m_limitMass2;
         ...
         {
            this.§9!z§ *= param1.§6!'§;
            this.m_limitImpulse1 *= param1.§6!'§;
            this.m_limitImpulse2 *= param1.§6!'§;
            _loc23_ = (-this.§9!z§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§9!z§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§8B§ * this.§9!z§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§8B§ * this.§9!z§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§ Y§.x += _loc2_.§;!R§ * _loc23_;
            _loc2_.§ Y§.y += _loc2_.§;!R§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§1!k§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§ Y§.x += _loc3_.§;!R§ * _loc25_;
            _loc3_.§ Y§.y += _loc3_.§;!R§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§1!k§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§9!z§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc10_ = _loc2_.§ Y§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§ Y§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§ Y§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§ Y§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§8B§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§=b§ * -_loc18_;
            _loc20_ = this.§9!z§;
            this.§9!z§ = b2Math.§[k§(0,this.§9!z§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§9!z§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§8B§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§8B§ * _loc19_ * this.m_u2.y;
            _loc2_.§ Y§.x += _loc2_.§;!R§ * _loc14_;
            _loc2_.§ Y§.y += _loc2_.§;!R§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§1!k§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§ Y§.x += _loc3_.§;!R§ * _loc16_;
            _loc3_.§ Y§.y += _loc3_.§;!R§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§1!k§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
         if(this.m_limitState1 == b2internal::<B)
         {
            ...
            this.m_limitImpulse1 = b2Math.§[k§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == b2internal::<B)
         {
            ...
            this.m_limitImpulse2 = b2Math.§[k§(0,this.m_limitImpulse2 + _loc19_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§<t§ == b2internal::<B)
         {
            ...
            _loc19_ = this.§+!>§ - _loc17_ - this.§8B§ * _loc18_;
            _loc24_ = b2Math.§[k§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§8M§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§=b§ * _loc19_) * this.m_u1.x;
            _loc14_ = -_loc20_ * this.m_u1.y;
            _loc15_ = -this.§8B§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§8B§ * _loc20_ * this.m_u2.y;
            _loc2_.m_sweep.c.x += _loc2_.§;!R§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§;!R§ * _loc14_;
            _loc2_.m_sweep.a += _loc2_.§1!k§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§;!R§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§;!R§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§1!k§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§>#§();
            _loc3_.§>#§();
         }
         if(this.m_limitState1 == b2internal::<B)
