package §'I§
{
   public class b2Settings
   {
      ...
      public static const §8!n§:int = 65535;
      ...
      public static const §throw§:Number = 0.05;
      
      public static const §<!U§:Number = 0.005;
      
      public static const §[]§:Number = 0.007;
      
      public static var b2_linearSlop:Number = §throw§;
      
      public static const §'$§:Number = b2_linearSlop - §<!U§;
      ...
      public static const §7!4§:Number = 0.1;
      
      public static const §else §:Number = 0.01;
      
      public static const §,!F§:Number = 0.1;
      
      public static var b2_linearSleepTolerance:Number = §7!4§;
