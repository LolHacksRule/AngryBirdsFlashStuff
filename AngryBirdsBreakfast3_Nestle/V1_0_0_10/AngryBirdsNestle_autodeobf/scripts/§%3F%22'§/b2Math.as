package §?"'§
{
   public class b2Math
   {
      ...
      public static function §<_§(param1:Number, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(-param1 * param2.y,param1 * param2.x);
      }
      
      public static function §2&§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §#T§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         ...
         _loc3_ = §?7§(param2,param1.position);
      ...
      public static function §3P§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§&!2§(§]!'§(param1.col1,param2.col1),§]!'§(param1.col2,param2.col2));
      }
      
      public static function §=!s§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§&!2§(§2&§(param1,param2.col1),§2&§(param1,param2.col2));
      }
      
      public static function §1!y§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
      ...
      public static function §4!N§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §default§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§[k§(param1.x,param2.x),§[k§(param1.y,param2.y));
      }
      
      public static function §8M§(param1:Number, param2:Number, param3:Number) : Number
      {
         return param1 < param2 ? Number(param2) : (param1 > param3 ? Number(param3) : Number(param1));
      }
      
      public static function § each§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §default§(param2,§4!N§(param1,param3));
      }
      ...
      public static function §71§(param1:Number, param2:Number) : Number
      {
         var _loc3_:Number = Math.random();
         return Number((param2 - param1) * _loc3_ + param1);
      }
      
      public static function §8!!§(param1:uint) : uint
      {
      ...
      public static function §8!I§(param1:uint) : Boolean
      {
