package §#!]§
{
   ...
   public class StateEpisodeSelection extends §3_§
   {
      ...
      {
         var _loc3_:§4<§ = null;
         this.§#J§ = §4!q§.getItemByName("Container_ChapterSelection") as §%n§;
         this.§@!x§ = [];
         this.§?!4§ = [];
         var _loc1_:Number = 0;
         this.§^=§ = new Sprite();
      ...
      protected function §]E§(param1:String, param2:Number, param3:§4<§ = null) : Number
      {
         ...
         _loc4_.addEventListener(MouseEvent.CLICK,this.§4T§);
      ...
      private function §8!]§(param1:MouseEvent) : void
      {
         if(!this.§9W§)
         {
            this.§!]§(this.§?!4§.indexOf(param1.target));
         }
      }
      ...
      protected function §!]§(param1:int) : void
      {
         ...
         this.§=!j§ = §%"!§.§&!;§.§"!]§(this.§^=§,{"x":_loc2_},null,_loc4_,§'H§.easeOut);
         this.§=!j§.onComplete = this.§`"2§;
         this.§=!j§.play();
      }
