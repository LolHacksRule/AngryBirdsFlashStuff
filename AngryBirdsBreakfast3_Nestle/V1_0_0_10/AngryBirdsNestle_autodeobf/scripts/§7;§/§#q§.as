package §7;§
{
   ...
   public class §#q§ extends §<!-§
   {
      ...
      public static const §0!d§:String = "transition_lop";
      ...
      public function §#q§(param1:Vector.<MovieClip>, param2:Stage, param3:Number = 41.666666666666664)
      {
         super(param1,param2);
         this.§-"&§ = 0;
      ...
      protected function §^!$§(param1:int) : void
      {
         ...
         if(_loc3_)
         {
            if(_loc4_ = §+M§.loop && !§9!#§)
            {
               if(_loc2_.name == "MovieClip_TutorialClip" && §+M§.type == §'"+§.§4!k§)
               {
                  _loc5_ = "loop_run";
               ...
               {
                  _loc6_ = §+M§.defaultStartLabel != "" ? §+M§.defaultStartLabel : "";
                  if((_loc7_ = §+M§.startLabel != "" ? §+M§.startLabel : _loc6_) != "")
                  {
