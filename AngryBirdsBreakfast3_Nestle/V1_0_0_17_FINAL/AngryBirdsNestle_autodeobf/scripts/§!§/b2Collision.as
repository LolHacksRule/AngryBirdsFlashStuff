package §!§
{
   ...
   public class b2Collision
   {
      ...
      private static var §>" §:Vector.<§8!b§> = §6" §();
      
      private static var s_clipPoints1:Vector.<§8!b§> = §6" §();
      
      private static var s_clipPoints2:Vector.<§8!b§> = §6" §();
      
      private static var §1J§:Vector.<int> = new Vector.<int>(1);
      
      private static var §-'§:Vector.<int> = new Vector.<int>(1);
      
      private static var §<q§:b2Vec2 = new b2Vec2();
      
      private static var §3!P§:b2Vec2 = new b2Vec2();
      ...
      public static function §#!i§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §8d§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §8d§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §8d§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §8d§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §<"!§(param1:Vector.<§8!b§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         _loc20_.id.§;!m§.§]u§ = param4;
         _loc20_.id.§;!m§.§@!q§ = _loc21_;
         _loc20_.id.§;!m§.§]"0§ = 0;
         _loc20_ = param1[1];
      ...
      public static function §6!u§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §1J§[0] = _loc8_;
         var _loc9_:Number = §#!i§(§1J§,param2,param3,param4,param5);
         _loc8_ = §1J§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §-'§[0] = _loc10_;
         var _loc11_:Number = §#!i§(§-'§,param4,param5,param2,param3);
         _loc10_ = §-'§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc37_:Vector.<§8!b§> = s_clipPoints1;
         var _loc38_:Vector.<§8!b§> = s_clipPoints2;
         if((_loc39_ = §6!k§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §6!k§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§4!D§.SetV(_loc27_);
      ...
      public static function §94§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc23_:Vector.<b2Vec2> = param2.§6"0§;
         var _loc24_:int = 0;
         ...
         if(_loc19_ < Number.MIN_VALUE)
         {
            param1.§4!5§ = 1;
            param1.§5Q§ = b2Manifold.§'h§;
            param1.§4!D§.SetV(_loc23_[_loc18_]);
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§4!5§ = 1;
            param1.§5Q§ = b2Manifold.§'h§;
            param1.§4!D§.x = _loc15_ - _loc27_.x;
            param1.§4!D§.y = _loc16_ - _loc27_.y;
            param1.§4!D§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§4!5§ = 1;
            param1.§5Q§ = b2Manifold.§'h§;
            param1.§4!D§.x = _loc15_ - _loc28_.x;
            param1.§4!D§.y = _loc16_ - _loc28_.y;
            param1.§4!D§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§`9§[0].m_localPoint.SetV(param4.§[N§);
            param1.§`9§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§4!5§ = 1;
            param1.§5Q§ = b2Manifold.§'h§;
            param1.§4!D§.x = _loc23_[_loc25_].x;
            param1.§4!D§.y = _loc23_[_loc25_].y;
            param1.§4!D§.Normalize();
