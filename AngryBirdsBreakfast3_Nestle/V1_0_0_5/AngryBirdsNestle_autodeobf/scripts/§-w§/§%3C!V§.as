package §-w§
{
   ...
   public class §<!V§ extends §;j§
   {
      ...
      public static const §38§:String = "transition_lop";
      ...
      public function §<!V§(param1:Vector.<MovieClip>, param2:Stage, param3:Number = 41.666666666666664)
      {
         super(param1,param2);
         this.§?H§ = 0;
      ...
      protected function §1`§(param1:int) : void
      {
         ...
         if(_loc3_)
         {
            if(_loc4_ = §!!A§.loop && !§^7§)
            {
               if(_loc2_.name == "MovieClip_TutorialClip" && §!!A§.type == §&"§.§-"$§)
               {
                  _loc5_ = "loop_run";
                  _loc2_.gotoAndStop(_loc5_);
                  dispatchEvent(new Event(§38§));
               }
               else
               {
                  _loc6_ = §!!A§.defaultStartLabel != "" ? §!!A§.defaultStartLabel : "";
                  if((_loc7_ = §!!A§.startLabel != "" ? §!!A§.startLabel : _loc6_) != "")
                  {
