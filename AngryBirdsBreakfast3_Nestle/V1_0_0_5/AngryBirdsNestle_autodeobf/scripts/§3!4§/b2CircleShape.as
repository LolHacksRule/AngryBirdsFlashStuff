package §3!4§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§#!i§.Set(_loc4_ - b2internal::`!,,_loc5_ - b2internal::`!,);
         param1.§4`§.Set(_loc4_ + b2internal::`!,,_loc5_ + b2internal::`!,);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§var § = param2 * b2Settings.b2_pi * b2internal::`!, * b2internal::`!,;
         param1.center.SetV(this.§+w§);
         param1.I = param1.§var § * (0.5 * b2internal::`!, * b2internal::`!, + (this.§+w§.x * this.§+w§.x + this.§+w§.y * this.§+w§.y));
      }
      
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         var _loc9_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§6!D§(param3,this.§+w§);
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.§6§(param1,_loc5_) - param2)) < -b2internal::`!, + Number.MIN_VALUE)
         {
            return 0;
         }
