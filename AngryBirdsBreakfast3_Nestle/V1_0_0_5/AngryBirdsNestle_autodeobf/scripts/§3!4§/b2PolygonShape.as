package §3!4§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      public static function §>!7§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§%!O§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §9!p§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §5E§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc3_.§!"§(_loc9_);
            _loc3_.§!"§(_loc10_);
            _loc3_.§?Y§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §0!y§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§,!Q§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§,!Q§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §,!P§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§5!O§(_loc3_,param2);
      }
      
      public function §5!O§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§-!;§)
         {
            ...
            _loc6_ = b2Math.§[I§(this.§[U§[_loc5_],this.§[U§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§`!x§() > Number.MIN_VALUE);
            this.§[L§[_loc3_].SetV(b2Math.§9v§(_loc6_,1));
            this.§[L§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§1Q§ = §5E§(this.§[U§,this.§-!;§);
      }
      ...
      public function §%!O§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§-!;§)
         {
            this.§[U§[_loc6_] = b2Math.§6!D§(_loc5_,this.§[U§[_loc6_]);
            this.§[L§[_loc6_] = b2Math.§+n§(_loc5_.R,this.§[L§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §`!n§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§1Q§.x = 0.5 * (param1.x + param2.x);
         this.§1Q§.y = 0.5 * (param1.y + param2.y);
         this.§[L§[0] = b2Math.§9v§(b2Math.§[I§(param2,param1),1);
         this.§[L§[0].Normalize();
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§#!i§.x = _loc5_ - b2internal::`!,;
         param1.§#!i§.y = _loc6_ - b2internal::`!,;
         param1.§4`§.x = _loc7_ + b2internal::`!,;
         param1.§4`§.y = _loc8_ + b2internal::`!,;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         while(_loc10_ < this.§-!;§)
         {
            ...
            _loc12_ = _loc10_ + 1 < this.§-!;§ ? this.§[U§[int(_loc10_ + 1)] : this.§[U§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§6§(param1,param3.position);
         ...
         while(_loc12_ < this.§-!;§)
         {
            _loc7_[_loc12_] = b2Math.§6§(_loc5_,this.§[U§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§6!D§(param3,_loc24_.center));
                  return _loc24_.§var §;
               }
               return 0;
               break;
         ...
         _loc20_.§?Y§(1 / _loc19_);
         param4.SetV(b2Math.§6!D§(param3,_loc20_));
         return _loc19_;
      }
