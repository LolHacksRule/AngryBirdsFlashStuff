package §0!$§
{
   ...
   public class Base64
   {
      ...
      private static const §'!v§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      {
         var _loc2_:ByteArray = §9!l§(param1);
         return _loc2_.readUTFBytes(_loc2_.length);
      }
      
      public static function §9!l§(param1:String) : ByteArray
      {
         var _loc6_:uint = 0;
         var _loc7_:uint = 0;
         var _loc2_:ByteArray = new ByteArray();
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §'!v§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
