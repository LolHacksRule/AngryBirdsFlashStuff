package §2W§
{
   public class §5=§
   {
      ...
      public static function §2!-§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         jsonString = §<!4§(luaString,emptyObjectAsArray);
         try
         {
      ...
      public static function §<!4§(param1:String, param2:Boolean = false) : String
      {
