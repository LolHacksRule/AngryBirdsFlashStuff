package §!;§
{
   ...
   public class b2Collision
   {
      ...
      private static var §#S§:Vector.<§5!"§> = §6!e§();
      
      private static var s_clipPoints1:Vector.<§5!"§> = §6!e§();
      
      private static var s_clipPoints2:Vector.<§5!"§> = §6!e§();
      ...
      private static var §7!b§:b2Vec2 = new b2Vec2();
      ...
      public static function §9c§(param1:Vector.<§5!"§>, param2:Vector.<§5!"§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§5!"§ = null;
         var _loc6_:int = 0;
      ...
      public static function §9!x§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
      ...
      public static function §90§(param1:Vector.<§5!"§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         _loc20_.id.§4!J§.§`!X§ = param4;
         _loc20_.id.§4!J§.§&!m§ = _loc21_;
         _loc20_.id.§4!J§.§?!D§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§4!J§.§`!X§ = param4;
         _loc20_.id.§4!J§.§&!m§ = _loc22_;
         _loc20_.id.§4!J§.§?!D§ = 1;
      }
      
      private static function §6!e§() : Vector.<§5!"§>
      {
      ...
      public static function §%!3§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§5!"§ = null;
         ...
         var _loc8_:int = 0;
         §+u§[0] = _loc8_;
         var _loc9_:Number = §9!x§(§+u§,param2,param3,param4,param5);
         _loc8_ = §+u§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §+!x§[0] = _loc10_;
         var _loc11_:Number = §9!x§(§+!x§,param4,param5,param2,param3);
         _loc10_ = §+!x§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§5!"§> = §#S§;
         §90§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         ...
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = each).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §7!b§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         ...
         if((_loc39_ = §9c§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §9c§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§"!=§.SetV(_loc27_);
      ...
      public static function §=!@§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§0"§ = b2Manifold.§&d§;
         param1.m_localPoint.SetV(param2.§+w§);
         param1.§"!=§.§9N§();
         param1.§8!S§ = 1;
         param1.§&"#§[0].m_localPoint.SetV(param4.§+w§);
         param1.§&"#§[0].m_id.key = 0;
      }
      ...
      public static function §[Z§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc23_:Vector.<b2Vec2> = param2.§[L§;
         var _loc24_:int = 0;
