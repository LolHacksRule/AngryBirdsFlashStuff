package §!;§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §3!N§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         var _loc4_:Number = NaN;
         var _loc5_:Number = NaN;
         b2Settings.b2Assert(param1.§=!D§());
      ...
      public function §0!O§(param1:b2DynamicTreeNode) : b2AABB
      {
         return param1.aabb;
      }
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc5_:b2Vec2;
         (_loc5_ = b2Math.§[I§(_loc3_,_loc4_)).Normalize();
         var _loc6_:b2Vec2 = b2Math.§9y§(1,_loc5_);
         ...
         _loc9_.§#!i§.x = Math.min(_loc3_.x,_loc10_);
         _loc9_.§#!i§.y = Math.min(_loc3_.y,_loc11_);
         ...
         while(_loc13_ > 0)
         {
            ...
            {
               _loc15_ = _loc14_.aabb.§=!0§();
               _loc16_ = _loc14_.aabb.§3!j§();
      ...
      private function §[!I§(param1:b2DynamicTreeNode) : void
      {
         ...
         var _loc2_:b2Vec2 = param1.aabb.§=!0§();
         ...
         if(_loc3_.§=!D§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§#!i§.x + _loc6_.aabb.§4`§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§#!i§.y + _loc6_.aabb.§4`§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§#!i§.x + _loc7_.aabb.§4`§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§#!i§.y + _loc7_.aabb.§4`§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
      ...
      private function §0!7§(param1:b2DynamicTreeNode) : void
      {
