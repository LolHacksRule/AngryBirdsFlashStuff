package §-!A§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§&g§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §9v§(param1:b2Vec2, param2:Number) : b2Vec2
      {
         return new b2Vec2(param2 * param1.y,-param2 * param1.x);
      }
      
      public static function §9y§(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return new b2Vec2(§6§(param2,param1.col1),§6§(param2,param1.col2));
      }
      
      public static function §6!D§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §^[§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         ...
         _loc3_ = §[I§(param2,param1.position);
      ...
      {
         return b2Mat22.§&g§(§<!T§(param1.col1,param2.col1),§<!T§(param1.col2,param2.col2));
      }
      
      public static function §%!-§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§&g§(§+n§(param1,param2.col1),§+n§(param1,param2.col2));
      }
      
      public static function §0?§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§6§(param1.col1,param2.col1),§6§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§6§(param1.col1,param2.col2),§6§(param1.col2,param2.col2));
         return b2Mat22.§&g§(_loc3_,_loc4_);
      }
      ...
      public static function §3!a§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§&g§(§>!§(param1.col1),§>!§(param1.col2));
      }
      ...
      public static function §7!t§() : Number
      {
         return Math.random() * 2 - 1;
      }
      
      public static function §4!S§(param1:Number, param2:Number) : Number
      {
