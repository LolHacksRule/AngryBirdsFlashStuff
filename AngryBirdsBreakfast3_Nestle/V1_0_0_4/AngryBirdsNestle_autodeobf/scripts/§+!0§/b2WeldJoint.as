package §+!0§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = this.§'b§.y - _loc5_.m_sweep.localCenter.y;
         ...
         if(param1.§3!`§)
         {
            ...
            this.§[!a§.y *= param1.§%!k§;
            this.§[!a§.z *= param1.§%!k§;
            _loc4_.§]!1§.x -= _loc10_ * this.§[!a§.x;
            _loc4_.§]!1§.y -= _loc10_ * this.§[!a§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§[!a§.y - _loc7_ * this.§[!a§.x + this.§[!a§.z);
            _loc5_.§]!1§.x += _loc11_ * this.§[!a§.x;
            _loc5_.§]!1§.y += _loc11_ * this.§[!a§.y;
            _loc5_.m_angularVelocity += _loc13_ * (_loc8_ * this.§[!a§.y - _loc9_ * this.§[!a§.x + this.§[!a§.z);
         }
         else
         {
            this.§[!a§.§'p§();
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§1i§.Solve33(_loc21_,-_loc18_,-_loc19_,-_loc20_);
         this.§[!a§.§%!d§(_loc21_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.m_xf.R;
         var _loc8_:Number = this.§'b§.x - _loc5_.m_sweep.localCenter.x;
         ...
         var _loc19_:Number = b2Math.§-Z§(_loc16_);
         if(_loc18_ > _loc17_)
         {
            _loc12_ *= 1;
            _loc13_ *= 1;
         ...
         this.§1i§.Solve33(_loc20_,-_loc14_,-_loc15_,-_loc16_);
