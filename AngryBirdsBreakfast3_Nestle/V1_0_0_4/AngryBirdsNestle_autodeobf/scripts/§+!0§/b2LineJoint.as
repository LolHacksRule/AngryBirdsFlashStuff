package §+!0§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§[!a§.x * this.§+w§.x + (this.§>!8§ + this.§[!a§.y) * this.§,4§.x),param1 * (this.§[!a§.x * this.§+w§.y + (this.§>!8§ + this.§[!a§.y) * this.§,4§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§?o§ = this.§?o§ > Number.MIN_VALUE ? Number(1 / this.§?o§) : Number(0);
         ...
         this.§0!b§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§0!b§.col2.x = this.§0!b§.col1.y;
         this.§0!b§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§3!,§)
         {
         ...
         if(param1.§3!`§)
         {
            ...
            this.§[!a§.y *= param1.§%!k§;
            this.§>!8§ *= param1.§%!k§;
            _loc19_ = this.§[!a§.x * this.§+w§.x + (this.§>!8§ + this.§[!a§.y) * this.§,4§.x;
            _loc20_ = this.§[!a§.x * this.§+w§.y + (this.§>!8§ + this.§[!a§.y) * this.§,4§.y;
            _loc21_ = this.§[!a§.x * this.m_s1 + (this.§>!8§ + this.§[!a§.y) * this.m_a1;
            _loc22_ = this.§[!a§.x * this.m_s2 + (this.§>!8§ + this.§[!a§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§@",§ && this.§@!,§ != b2internal::," )
         {
            ...
            _loc14_ = this.§?o§ * (this.§^!Z§ - _loc13_);
            _loc15_ = this.§>!8§;
            _loc16_ = param1.§ !&§ * this.§'"%§;
            this.§>!8§ = b2Math.§!P§(this.§>!8§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§>!8§ - _loc15_) * this.§,4§.x;
         ...
         if(this.§3!,§ && this.§@!,§ != b2internal::!_)
         {
            ...
            _loc18_ = this.§[!a§.Copy();
            _loc19_ = this.§0!b§.§]!3§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§[!a§.§%!d§(_loc19_);
            if(this.§@!,§ == b2internal::<E)
            {
               this.§[!a§.y = b2Math.§=Q§(this.§[!a§.y,0);
            }
            else if(this.§@!,§ == b2internal::&!;)
            {
               this.§[!a§.y = b2Math.§2!I§(this.§[!a§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§[!a§.y - _loc18_.y) * this.§0!b§.col2.x;
            if(this.§0!b§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§0!b§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§[!a§.x = _loc21_;
            _loc19_.x = this.§[!a§.x - _loc18_.x;
            _loc19_.y = this.§[!a§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§+w§.x + _loc19_.y * this.§,4§.x;
            _loc9_ = _loc19_.x * this.§+w§.y + _loc19_.y * this.§,4§.y;
         ...
         else
         {
            if(this.§0!b§.col1.x != 0)
            {
               _loc22_ = -_loc12_ / this.§0!b§.col1.x;
            }
            else
            {
               _loc22_ = 0;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§3!,§)
         {
            ...
            if(b2Math.§-Z§(this.§+",§ - this.§ w§) < 2 * b2Settings.b2_linearSlop)
            {
               ...
               _loc16_ = b2Math.§-Z§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§ w§)
            {
               _loc19_ = b2Math.§!P§(_loc34_ - this.§ w§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§ w§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§+",§)
            {
               _loc19_ = b2Math.§!P§(_loc34_ - this.§+",§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§0!b§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§0!b§.col2.x = this.§0!b§.col1.y;
            this.§0!b§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§0!b§.§]!3§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::88;
