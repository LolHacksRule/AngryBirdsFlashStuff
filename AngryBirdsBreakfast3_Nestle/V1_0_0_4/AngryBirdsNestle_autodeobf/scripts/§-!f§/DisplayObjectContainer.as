package §-!f§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function §24§(param1:DisplayObject, param2:DisplayObject) : void
      {
         var _loc3_:int = this.getChildIndex(param1);
         ...
         this.§13§(_loc3_,_loc4_);
      }
      
      public function §13§(param1:int, param2:int) : void
      {
      ...
      public function §7!o§(param1:Function) : void
      {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§<!+§[_loc6_];
            §"!$§(_loc7_,§^4§);
            transformCoords(§^4§,_loc3_,_loc4_,§"! §);
