package §7"+§
{
   ...
   public class Texture
   {
      ...
      public static function §"h§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §7"+§.Texture
      {
         return §+1§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §+1§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §7"+§.Texture
      {
         ...
         _loc10_ = new §7!+§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§<!D§.§6!0§)
         {
            _loc10_.§"!6§(param2);
         }
      ...
      public static function §8!c§(param1:Context3D, param2:ByteArray) : §7"+§.Texture
      {
         if(param1 == null)
         {
            throw new §&!h§();
         ...
         var _loc9_:§7!+§ = new §7!+§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§<!D§.§6!0§)
         {
            _loc9_.§"!6§(param2);
         }
      ...
      public static function §<!f§(param1:§7"+§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §7"+§.Texture
      {
         var _loc4_:§7"+§.Texture;
         (_loc4_ = new §,!x§(param1,param2)).§if§ = param3;
         return _loc4_;
      }
      
      public static function §`!K§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §7"+§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§7"+§.Texture = §+1§(param1,_loc6_,false,param5);
         if(!§<!D§.§6!0§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§=>§, param2:int, param3:int) : void
      {
         ...
         if(this.§if§)
         {
            ...
            _loc4_ = this.§if§.width + this.§if§.x - this.width;
            _loc5_ = this.§if§.height + this.§if§.y - this.height;
            param1.§,=§(param2,-this.§if§.x,-this.§if§.y);
            param1.§,=§(param2 + 1,-_loc4_,-this.§if§.y);
            param1.§,=§(param2 + 2,-this.§if§.x,-_loc5_);
      ...
      {
         return !!this.§if§ ? this.§if§.clone() : new Rectangle(0,0,this.width,this.height);
      }
