package §4!V§
{
   ...
   public class §continue§
   {
      ...
      public function §continue§(param1:*)
      {
         super();
         this.jsonString = this.§4!W§(param1);
      }
      ...
      private function §4!W§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§6!T§(param1 as String);
         }
         if(param1 is Number)
         {
      ...
      private function §6!T§(param1:String) : String
      {
      ...
      private function §%!o§(param1:Array) : String
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§4!W§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §+!H§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§6!T§(v.@name.toString()) + ":" + this.§4!W§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
