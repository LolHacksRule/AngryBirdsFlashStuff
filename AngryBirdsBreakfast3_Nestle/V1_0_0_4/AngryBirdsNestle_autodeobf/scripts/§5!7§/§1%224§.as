package §5!7§
{
   ...
   public class §1"4§ extends §[2§
   {
       
      
      private var § !w§:Vector.<b2Vec2>;
      
      public function §1"4§(param1:Vector.<b2Vec2>)
      {
         this.§ !w§ = param1;
         var _loc2_:Array = this.§&Z§();
      ...
      public function get §5!,§() : Vector.<b2Vec2>
      {
         return this.§ !w§;
      }
