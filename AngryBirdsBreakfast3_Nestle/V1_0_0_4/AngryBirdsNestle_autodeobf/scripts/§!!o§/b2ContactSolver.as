package §!!o§
{
   ...
   public class b2ContactSolver
   {
      ...
      b2internal var § else§:Vector.<b2ContactConstraint>;
      ...
      public function b2ContactSolver()
      {
         ...
         this.§ else§ = new Vector.<b2ContactConstraint>();
         super();
      }
      ...
      public function §,n§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§?!R§ = param4;
         this.§<!`§ = param3;
         while(this.§ else§.length < this.§<!`§)
         {
            this.§ else§[this.§ else§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            ...
            _loc17_ = _loc5_.§3!5§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§3"0§(),_loc10_.§3"0§());
            ...
            _loc26_ = §?""§.§&z§.x;
            _loc27_ = §?""§.§&z§.y;
            (_loc28_ = this.§ else§[_loc6_]).§6z§ = _loc15_;
            _loc28_.§@! § = _loc16_;
            _loc28_.§`e§ = _loc17_;
            ...
            _loc28_.§&!W§.x = _loc17_.§=!5§.x;
            _loc28_.§&!W§.y = _loc17_.§=!5§.y;
            _loc28_.localPoint.x = _loc17_.m_localPoint.x;
            _loc28_.localPoint.y = _loc17_.m_localPoint.y;
            _loc28_.radius = _loc13_ + _loc14_;
            _loc28_.type = _loc17_.§^Z§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§`!6§)
            {
               _loc30_ = _loc17_.§@!_§[_loc29_];
               (_loc31_ = _loc28_.§2l§[_loc29_]).normalImpulse = _loc30_.§-!V§;
               _loc31_.tangentImpulse = _loc30_.§#G§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§>!=§.x = §?""§.§@!_§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§>!=§.y = §?""§.§@!_§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§2!D§.x = §?""§.§@!_§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§2!D§.y = §?""§.§@!_§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               if((_loc38_ = _loc15_.§^!u§ + _loc16_.§^!u§ + _loc15_.§;!A§ * _loc36_ + _loc16_.§;!A§ * _loc37_) > 0)
               {
                  _loc31_.§^d§ = 1 / _loc38_;
               }
               else
               ...
               _loc39_ = (_loc39_ = _loc15_.§1i§ * _loc15_.§^!u§ + _loc16_.§1i§ * _loc16_.§^!u§) + (_loc15_.§1i§ * _loc15_.§;!A§ * _loc36_ + _loc16_.§1i§ * _loc16_.§;!A§ * _loc37_);
               _loc31_.§+!s§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               if((_loc44_ = _loc15_.§^!u§ + _loc16_.§^!u§ + _loc15_.§;!A§ * _loc42_ + _loc16_.§;!A§ * _loc43_) > 0)
               {
                  _loc31_.§^!M§ = 1 / _loc44_;
               }
               else
               ...
               {
                  _loc31_.§1!9§ = -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§`!6§ == 2)
            {
               _loc48_ = _loc28_.§2l§[0];
               _loc49_ = _loc28_.§2l§[1];
               _loc50_ = _loc15_.§^!u§;
               _loc51_ = _loc15_.§;!A§;
               _loc52_ = _loc16_.§^!u§;
               _loc53_ = _loc16_.§;!A§;
               _loc54_ = _loc48_.§>!=§.x * _loc27_ - _loc48_.§>!=§.y * _loc26_;
               _loc55_ = _loc48_.§2!D§.x * _loc27_ - _loc48_.§2!D§.y * _loc26_;
               _loc56_ = _loc49_.§>!=§.x * _loc27_ - _loc49_.§>!=§.y * _loc26_;
               _loc57_ = _loc49_.§2!D§.x * _loc27_ - _loc49_.§2!D§.y * _loc26_;
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         while(_loc5_ < this.§<!`§)
         {
            _loc7_ = (_loc6_ = this.§ else§[_loc5_]).§6z§;
            _loc8_ = _loc6_.§@! §;
            _loc9_ = _loc7_.§^!u§;
            _loc10_ = _loc7_.§;!A§;
            _loc11_ = _loc8_.§^!u§;
            ...
            if(param1.§3!`§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§2!D§.x * _loc22_ - _loc20_.§2!D§.y * _loc21_);
            ...
            else
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  (_loc23_ = _loc6_.§2l§[_loc18_]).normalImpulse = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         while(_loc24_ < this.§<!`§)
         {
            _loc26_ = (_loc25_ = this.§ else§[_loc24_]).§6z§;
            _loc27_ = _loc25_.§@! §;
            ...
            {
               _loc2_ = _loc25_.§2l§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§2!D§.y - _loc30_.x + _loc28_ * _loc2_.§>!=§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§2!D§.x - _loc30_.y - _loc28_ * _loc2_.§>!=§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§^!M§ * -_loc10_;
               ...
               _loc29_ += _loc35_ * (_loc2_.§2!D§.x * _loc15_ - _loc2_.§2!D§.y * _loc14_);
            ...
            if(_loc25_.§`!6§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§^d§ * (_loc9_ - _loc2_.§1!9§);
            ...
            {
               _loc43_ = _loc25_.§2l§[0];
               _loc44_ = _loc25_.§2l§[1];
               _loc45_ = _loc43_.normalImpulse;
               _loc46_ = _loc44_.normalImpulse;
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§2!D§.y - _loc30_.x + _loc28_ * _loc43_.§>!=§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§2!D§.x - _loc30_.y - _loc28_ * _loc43_.§>!=§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§2!D§.y - _loc30_.x + _loc28_ * _loc44_.§>!=§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§2!D§.x - _loc30_.y - _loc28_ * _loc44_.§>!=§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§1!9§;
               _loc54_ = _loc52_ - _loc44_.§1!9§;
               _loc22_ = _loc25_.K;
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc29_ += _loc35_ * (_loc43_.§2!D§.x * _loc19_ - _loc43_.§2!D§.y * _loc18_ + _loc44_.§2!D§.x * _loc21_ - _loc44_.§2!D§.y * _loc20_);
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§<!`§)
         {
            _loc5_ = (_loc4_ = this.§ else§[_loc3_]).§6z§;
            _loc6_ = _loc4_.§@! §;
            _loc7_ = _loc5_.§1i§ * _loc5_.§^!u§;
            _loc8_ = _loc5_.§1i§ * _loc5_.§;!A§;
            _loc9_ = _loc6_.§1i§ * _loc6_.§^!u§;
            _loc10_ = _loc6_.§1i§ * _loc6_.§;!A§;
            §8!'§.§,n§(_loc4_);
            _loc11_ = §8!'§.§&z§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§`!6§)
            {
               _loc13_ = _loc4_.§2l§[_loc12_];
               _loc14_ = §8!'§.§@!_§[_loc12_];
               _loc15_ = §8!'§.§+!P§[_loc12_];
               ...
               _loc22_ = (_loc21_ = -_loc13_.§+!s§ * _loc20_) * _loc11_.x;
