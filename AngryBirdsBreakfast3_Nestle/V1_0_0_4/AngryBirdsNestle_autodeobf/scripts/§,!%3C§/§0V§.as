package §,!<§
{
   ...
   public class §0V§
   {
      ...
      public static var §3q§:ByteArray;
      ...
      public static function §"e§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §2!U§(_loc2_);
         return §3!q§.§4"1§(_loc3_.readInt(),true) + §3!q§.§4"1§(_loc3_.readInt(),true) + §3!q§.§4"1§(_loc3_.readInt(),true) + §3!q§.§4"1§(_loc3_.readInt(),true) + §3!q§.§4"1§(_loc3_.readInt(),true);
      }
      
      public static function §]o§(param1:ByteArray) : String
      {
         var _loc2_:Array = §0V§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §2!U§(_loc2_);
         return §3!q§.§4"1§(_loc3_.readInt(),true) + §3!q§.§4"1§(_loc3_.readInt(),true) + §3!q§.§4"1§(_loc3_.readInt(),true) + §3!q§.§4"1§(_loc3_.readInt(),true) + §3!q§.§4"1§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc6_:uint = 0;
         var _loc2_:Array = §0V§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §2!U§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §2!U§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
