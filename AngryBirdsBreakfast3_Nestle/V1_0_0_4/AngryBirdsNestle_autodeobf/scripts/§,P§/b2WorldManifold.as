         ...
         switch(param1.§^Z§)
         {
            case b2Manifold.§1X§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§&z§.x = _loc19_ / _loc26_;
                  this.§&z§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§&z§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§&z§.x;
               _loc23_ = _loc16_ + param3 * this.§&z§.y;
               _loc24_ = _loc17_ - param5 * this.§&z§.x;
               _loc25_ = _loc18_ - param5 * this.§&z§.y;
