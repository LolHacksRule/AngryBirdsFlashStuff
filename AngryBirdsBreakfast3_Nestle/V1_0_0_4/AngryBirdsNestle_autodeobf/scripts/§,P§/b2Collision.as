package §,P§
{
   ...
   public class b2Collision
   {
      ...
      private static var §!c§:Vector.<§5!c§> = §@W§();
      
      private static var s_clipPoints1:Vector.<§5!c§> = §@W§();
      
      private static var s_clipPoints2:Vector.<§5!c§> = §@W§();
      
      private static var §>0§:Vector.<int> = new Vector.<int>(1);
      
      private static var §<r§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §?4§(param1:Vector.<§5!c§>, param2:Vector.<§5!c§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§5!c§ = null;
         var _loc6_:int = 0;
      ...
      public static function § "5§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc6_:int = param1.§`!J§;
         var _loc7_:Vector.<b2Vec2> = param1.§%!R§;
         var _loc8_:Vector.<b2Vec2> = param1.§!!h§;
         var _loc9_:int = param4.§`!J§;
         var _loc10_:Vector.<b2Vec2> = param4.§%!R§;
         _loc11_ = param2.R;
      ...
      public static function §8"5§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
      ...
      public static function §&" §(param1:Vector.<§5!c§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§5!c§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§`!J§;
         var _loc8_:Vector.<b2Vec2> = param2.§!!h§;
         var _loc9_:int = param5.§`!J§;
         var _loc10_:Vector.<b2Vec2> = param5.§%!R§;
         ...
         _loc20_.id.§>Z§.§5!o§ = param4;
         _loc20_.id.§>Z§.§7![§ = _loc21_;
         _loc20_.id.§>Z§.§^g§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§>Z§.§5!o§ = param4;
         _loc20_.id.§>Z§.§7![§ = _loc22_;
         _loc20_.id.§>Z§.§^g§ = 1;
      }
      
      private static function §@W§() : Vector.<§5!c§>
      {
         var _loc1_:Vector.<§5!c§> = new Vector.<§5!c§>(2);
         _loc1_[0] = new §5!c§();
         _loc1_[1] = new §5!c§();
         return _loc1_;
      }
      ...
      public static function §2""§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         param1.§"!;§ = 0;
         var _loc7_:Number = param2.§4=§ + param4.§4=§;
         var _loc8_:int = 0;
         §>0§[0] = _loc8_;
         var _loc9_:Number = §8"5§(§>0§,param2,param3,param4,param5);
         _loc8_ = §>0§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §<r§[0] = _loc10_;
         var _loc11_:Number = §8"5§(§<r§,param4,param5,param2,param3);
         _loc10_ = §<r§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§5!c§> = §!c§;
         §&" §(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§`!J§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§%!R§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §<!n§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §=J§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §-!T§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §@z§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§5!c§> = s_clipPoints1;
         var _loc38_:Vector.<§5!c§> = s_clipPoints2;
      ...
      public static function §=!$§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§4=§ + param4.§4=§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§^Z§ = b2Manifold.§1X§;
         param1.m_localPoint.SetV(param2.§^7§);
         param1.§=!5§.§'p§();
         param1.§"!;§ = 1;
         param1.§@!_§[0].m_localPoint.SetV(param4.§^7§);
         param1.§@!_§[0].m_id.key = 0;
      }
      
      public static function §8!P§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§4=§ + param4.§4=§;
         var _loc21_:int = param2.§`!J§;
         var _loc22_:Vector.<b2Vec2> = param2.§%!R§;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§"!;§ = 1;
            param1.§^Z§ = b2Manifold.§`!&§;
            param1.§=!5§.x = _loc15_ - _loc27_.x;
            param1.§=!5§.y = _loc16_ - _loc27_.y;
            param1.§=!5§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§"!;§ = 1;
            param1.§^Z§ = b2Manifold.§`!&§;
            param1.§=!5§.x = _loc15_ - _loc28_.x;
            param1.§=!5§.y = _loc16_ - _loc28_.y;
            param1.§=!5§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§@!_§[0].m_localPoint.SetV(param4.§^7§);
            param1.§@!_§[0].m_id.key = 0;
      ...
      {
         var _loc3_:b2Vec2 = param2.§=V§;
         var _loc4_:b2Vec2 = param1.§;!T§;
