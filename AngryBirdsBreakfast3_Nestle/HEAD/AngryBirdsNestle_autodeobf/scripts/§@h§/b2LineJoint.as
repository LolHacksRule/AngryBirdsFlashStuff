package §@h§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§6!h§.x * this.§-D§.x + (this.§8!`§ + this.§6!h§.y) * this.§0E§.x),param1 * (this.§6!h§.x * this.§-D§.y + (this.§8!`§ + this.§6!h§.y) * this.§0E§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§=!l§ = this.§=!l§ > Number.MIN_VALUE ? Number(1 / this.§=!l§) : Number(0);
         ...
         if(param1.§-"'§)
         {
            ...
            this.§6!h§.y *= param1.§`!s§;
            this.§8!`§ *= param1.§`!s§;
            _loc19_ = this.§6!h§.x * this.§-D§.x + (this.§8!`§ + this.§6!h§.y) * this.§0E§.x;
            _loc20_ = this.§6!h§.x * this.§-D§.y + (this.§8!`§ + this.§6!h§.y) * this.§0E§.y;
            _loc21_ = this.§6!h§.x * this.m_s1 + (this.§8!`§ + this.§6!h§.y) * this.m_a1;
            _loc22_ = this.§6!h§.x * this.m_s2 + (this.§8!`§ + this.§6!h§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§0E§.x * (_loc6_.x - _loc4_.x) + this.§0E§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§=!l§ * (this.§%! § - _loc13_);
            _loc15_ = this.§8!`§;
            _loc16_ = param1.§"!n§ * this.§4"$§;
            this.§8!`§ = b2Math.§ !X§(this.§8!`§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§8!`§ - _loc15_) * this.§0E§.x;
            _loc9_ = _loc14_ * this.§0E§.y;
         ...
         {
            _loc17_ = this.§0E§.x * (_loc6_.x - _loc4_.x) + this.§0E§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§6!h§.Copy();
            _loc19_ = this.§ U§.§`"5§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§6!h§.§?4§(_loc19_);
            if(this.§@'§ == b2internal::-!V)
            {
               this.§6!h§.y = b2Math.§1r§(this.§6!h§.y,0);
            }
            else if(this.§@'§ == b2internal::8!p)
            {
               this.§6!h§.y = b2Math.§5!!§(this.§6!h§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§6!h§.y - _loc18_.y) * this.§ U§.col2.x;
            if(this.§ U§.col1.x != 0)
            {
            ...
            this.§6!h§.x = _loc21_;
            _loc19_.x = this.§6!h§.x - _loc18_.x;
            _loc19_.y = this.§6!h§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§-D§.x + _loc19_.y * this.§0E§.x;
            _loc9_ = _loc19_.x * this.§-D§.y + _loc19_.y * this.§0E§.y;
         ...
         else
         {
            ...
            this.§6!h§.x += _loc22_;
            _loc8_ = _loc22_ * this.§-D§.x;
            _loc9_ = _loc22_ * this.§-D§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§2!%§)
         {
            ...
            _loc34_ = this.§0E§.x * _loc26_ + this.§0E§.y * _loc27_;
            if(b2Math.§71§(this.§`"$§ - this.§>!Z§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§ !X§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§71§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§>!Z§)
            {
               _loc19_ = b2Math.§ !X§(_loc34_ - this.§>!Z§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§>!Z§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§`"$§)
            {
               _loc19_ = b2Math.§ !X§(_loc34_ - this.§`"$§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§ U§.§`"5§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::^i;
         ...
         var _loc30_:Number = _loc28_.x * this.§-D§.x + _loc28_.y * this.§0E§.x;
         var _loc31_:Number = _loc28_.x * this.§-D§.y + _loc28_.y * this.§0E§.y;
         ...
         _loc8_.x += b2internal::5b * _loc30_;
         _loc8_.y += b2internal::5b * _loc31_;
         _loc9_ += b2internal::'Q * _loc33_;
