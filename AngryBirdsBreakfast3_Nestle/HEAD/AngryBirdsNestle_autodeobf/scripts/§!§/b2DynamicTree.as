package §!§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §=!b§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
         ...
         _loc3_.aabb.§3!E§.x = param1.§3!E§.x + _loc4_;
         _loc3_.aabb.§3!E§.y = param1.§3!E§.y + _loc5_;
      ...
      public function §;!n§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         ...
         param1.aabb.§3!E§.x = param2.§3!E§.x + _loc4_;
         param1.aabb.§3!E§.y = param2.§3!E§.y + _loc5_;
         this.§<!^§(param1);
         return true;
      }
      ...
      public function §^C§(param1:Function, param2:b2AABB) : void
      {
         ...
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§4I§(param2))
            {
               if(_loc5_.§5!@§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc8_:Number = param2.§9!Y§;
         _loc9_ = new b2AABB();
         _loc10_ = _loc3_.x + _loc8_ * (_loc4_.x - _loc3_.x);
         _loc11_ = _loc3_.y + _loc8_ * (_loc4_.y - _loc3_.y);
         _loc9_.§&1§.x = Math.min(_loc3_.x,_loc10_);
         _loc9_.§&1§.y = Math.min(_loc3_.y,_loc11_);
         _loc9_.§3!E§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§3!E§.y = Math.max(_loc3_.y,_loc11_);
         ...
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§4I§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§!!<§();
               _loc16_ = _loc14_.aabb.§8!V§();
      ...
      private function §<!^§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_.§5!@§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§&1§.x + _loc6_.aabb.§3!E§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§&1§.y + _loc6_.aabb.§3!E§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§&1§.x + _loc7_.aabb.§3!E§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§&1§.y + _loc7_.aabb.§3!E§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         if(_loc4_)
         {
            ...
            while(!_loc4_.aabb.get(_loc5_.aabb))
            {
