package §!§
{
   ...
   class b2Simplex
   {
      ...
      public function §&"5§() : b2Vec2
      {
         ...
         switch(this.§6]§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§@!I§(_loc1_,this.m_v1.§!R§.§2T§());
               if(_loc2_ > 0)
               {
                  return b2Math.§0!p§(1,_loc1_);
               }
      ...
      public function §6!?§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§6]§)
         {
            ...
            case 1:
               ...
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§^t§.x + this.m_v2.a * this.m_v2.§^t§.x;
               param1.y = this.m_v1.a * this.m_v1.§^t§.y + this.m_v2.a * this.m_v2.§^t§.y;
               param2.x = this.m_v1.a * this.m_v1.§%Z§.x + this.m_v2.a * this.m_v2.§%Z§.x;
               param2.y = this.m_v1.a * this.m_v1.§%Z§.y + this.m_v2.a * this.m_v2.§%Z§.y;
               break;
            case 3:
               param2.x = param1.x = this.m_v1.a * this.m_v1.§^t§.x + this.m_v2.a * this.m_v2.§^t§.x + this.m_v3.a * this.m_v3.§^t§.x;
               param2.y = param1.y = this.m_v1.a * this.m_v1.§^t§.y + this.m_v2.a * this.m_v2.§^t§.y + this.m_v3.a * this.m_v3.§^t§.y;
               break;
            default:
               b2Settings.b2Assert(false);
         }
      ...
      public function §+u§() : Number
      {
         switch(this.§6]§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§1"5§(this.m_v1.§!R§,this.m_v2.§!R§).Length();
            case 3:
      ...
      public function Solve3() : void
      {
         ...
         var _loc5_:Number = b2Math.§,w§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§,w§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§1"5§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§,w§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§,w§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§1"5§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§,w§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§,w§(_loc3_,_loc14_);
