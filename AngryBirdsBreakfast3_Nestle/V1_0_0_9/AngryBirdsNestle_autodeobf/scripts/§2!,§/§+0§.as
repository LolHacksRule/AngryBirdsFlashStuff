package §2!,§
{
   ...
   public class §+0§ extends §,!#§
   {
      ...
      {
         var _loc1_:String = (§-!2§.§7O§ as AngryBirdsCustom).§-"'§.§!"3§(§^2§.§&!;§.§]T§()).brand;
         §;"#§.getItemByName("MovieClip_Nesquik").setVisibility(_loc1_ == §!"&§.§7!l§);
         §;"#§.getItemByName("MovieClip_Chocapic").setVisibility(_loc1_ == §!"&§.§]!m§);
         §;"#§.getItemByName("MovieClip_KokoKrunch").setVisibility(_loc1_ == §!"&§.§"^§);
      }
