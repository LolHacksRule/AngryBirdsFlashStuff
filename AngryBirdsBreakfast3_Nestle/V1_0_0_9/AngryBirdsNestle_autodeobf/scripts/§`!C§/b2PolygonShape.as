package §`!C§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      public static function §#!U§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§8!p§(param1,param2);
         return _loc3_;
      }
      
      public static function §&v§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §,t§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         ...
         (_loc5_ = new b2PolygonShape()).§7E§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §24§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §-!c§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§package§(new b2Vec2(0,0));
            _loc3_.§package§(_loc9_);
            _loc3_.§package§(_loc10_);
      ...
      b2internal static function §'!9§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§3!w§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§3!w§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §+!,§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§8!p§(_loc3_,param2);
      }
      
      public function §8!p§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§[i§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§?7§(this.§=!F§[_loc5_],this.§=!F§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§!!+§() > Number.MIN_VALUE);
            this.§;`§[_loc3_].SetV(b2Math.§<!+§(_loc6_,1));
            this.§;`§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§,V§ = §-!c§(this.§=!F§,this.§[i§);
      }
      ...
      public function §7E§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§[i§ = 4;
         this.§,O§(4);
         this.§=!F§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§[i§)
         {
            this.§=!F§[_loc6_] = b2Math.§2!]§(_loc5_,this.§=!F§[_loc6_]);
            this.§;`§[_loc6_] = b2Math.§2&§(_loc5_.R,this.§;`§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §4!'§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§;`§[0] = b2Math.§<!+§(b2Math.§?7§(param2,param1),1);
         this.§;`§[0].Normalize();
         this.§;`§[1].x = -this.§;`§[0].x;
         this.§;`§[1].y = -this.§;`§[0].y;
      }
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§6!§.x = _loc5_ - b2internal::>";
         param1.§6!§.y = _loc6_ - b2internal::>";
         param1.§5!'§.x = _loc7_ + b2internal::>";
         param1.§5!'§.y = _loc8_ + b2internal::>";
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         while(_loc10_ < this.§[i§)
         {
            ...
            _loc12_ = _loc10_ + 1 < this.§[i§ ? this.§=!F§[int(_loc10_ + 1)] : this.§=!F§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         {
            _loc7_[_loc12_] = b2Math.§>$§(_loc5_,this.§=!F§[_loc12_]) - _loc6_;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§[i§;
         var _loc14_:int = (_loc10_ + 1) % this.§[i§;
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§[i§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
      ...
      public function §%!0§(param1:b2Vec2) : int
      {
