package §+!<§
{
   ...
   public class §,!v§
   {
      ...
      public function §,!v§(param1:§%n§, param2:§?!#§)
      {
         super();
         this.§=e§ = param1;
         this.§#"7§ = param2;
      ...
      private function §6"$§(param1:TextField) : Number
      {
         var _loc2_:TextLineMetrics = param1.getLineMetrics(0);
         return _loc2_.width;
      }
      
      private function §"!o§(param1:TextField) : void
      {
      ...
      {
         this.deActivate();
         this.§#"7§.§'2§.removeEventListener(LoginHandlerEvent.§ %§,this.§;!c§);
         this.§#"7§.§'2§.removeEventListener(LoginHandlerEvent.ERROR,this.§]!]§);
      ...
      public function §?!i§() : void
      {
         ...
         this.§#"7§.§'2§.addEventListener(LoginHandlerEvent.§ %§,this.§;!c§);
         this.§#"7§.§'2§.addEventListener(LoginHandlerEvent.ERROR,this.§]!]§);
      ...
      private function §;!c§(param1:LoginHandlerEvent) : void
      {
         ...
         this.§#"7§.stage.removeEventListener(KeyboardEvent.KEY_DOWN,this.§'!U§);
         this.§#"7§.close();
         (§-!2§.§7O§ as AngryBirdsCustom).§]a§(§=A§.§]!y§);
      }
