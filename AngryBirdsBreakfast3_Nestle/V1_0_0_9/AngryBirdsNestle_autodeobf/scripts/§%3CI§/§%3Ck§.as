package §<I§
{
   ...
   public class §<k§
   {
      ...
      public static var §8w§:ByteArray;
      ...
      public static function §`8§(param1:String) : String
      {
         ...
         return §?i§.§6"-§(_loc3_.readInt(),true) + §?i§.§6"-§(_loc3_.readInt(),true) + §?i§.§6"-§(_loc3_.readInt(),true) + §?i§.§6"-§(_loc3_.readInt(),true) + §?i§.§6"-§(_loc3_.readInt(),true);
      }
      ...
      public static function §3n§(param1:String) : String
      {
         var _loc6_:uint = 0;
