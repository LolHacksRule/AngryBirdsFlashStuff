package §?"'§
{
   public class b2Vec2
   {
      ...
      public static function §+!W§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §package§(param1:b2Vec2) : void
      {
         this.x += param1.x;
         this.y += param1.y;
      }
      
      public function include(param1:b2Vec2) : void
      {
         this.x -= param1.x;
         this.y -= param1.y;
      }
      ...
      public function §4!N§(param1:b2Vec2) : void
      {
