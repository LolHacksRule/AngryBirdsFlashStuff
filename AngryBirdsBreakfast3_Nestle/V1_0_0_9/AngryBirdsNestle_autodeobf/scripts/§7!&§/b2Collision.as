package §7!&§
{
   ...
   public class b2Collision
   {
      ...
      private static var §4!w§:Vector.<§,,§> = §-5§();
      
      private static var s_clipPoints1:Vector.<§,,§> = §-5§();
      
      private static var s_clipPoints2:Vector.<§,,§> = §-5§();
      ...
      private static var §4!B§:b2Vec2 = new b2Vec2();
      ...
      public static function §5Z§(param1:Vector.<§,,§>, param2:Vector.<§,,§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§,,§ = null;
         var _loc6_:int = 0;
      ...
      public static function §8!t§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§[i§;
         var _loc7_:Vector.<b2Vec2> = param1.§=!F§;
         var _loc8_:Vector.<b2Vec2> = param1.§;`§;
         var _loc9_:int = param4.§[i§;
      ...
      public static function §;" §(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §8!t§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §8!t§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §8!t§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §8!t§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §']§(param1:Vector.<§,,§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc20_:§,,§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§[i§;
         var _loc8_:Vector.<b2Vec2> = param2.§;`§;
         var _loc9_:int = param5.§[i§;
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§]u§.§`#§ = param4;
         _loc20_.id.§]u§.§?!F§ = _loc22_;
         _loc20_.id.§]u§.§`R§ = 1;
      }
      
      private static function §-5§() : Vector.<§,,§>
      {
      ...
      public static function §31§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§,,§ = null;
         ...
         var _loc10_:int = 0;
         §#9§[0] = _loc10_;
         var _loc11_:Number = §;" §(§#9§,param4,param5,param2,param3);
         _loc10_ = §#9§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§[!5§ = b2Manifold.§6!p§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§,,§> = §4!w§;
         §']§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§[i§;
         ...
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §4!B§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         ...
         if((_loc39_ = §5Z§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §5Z§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
      ...
      public static function §[f§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§[!5§ = b2Manifold.§2l§;
         param1.m_localPoint.SetV(param2.§=g§);
         param1.§<!y§.§6!c§();
         param1.§<X§ = 1;
         param1.§#$§[0].m_localPoint.SetV(param4.§=g§);
         param1.§#$§[0].m_id.key = 0;
      }
      ...
      public static function § "0§(param1:b2AABB, param2:b2AABB) : Boolean
      {
