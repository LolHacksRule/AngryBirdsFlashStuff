package §8!$§
{
   ...
   public class Base64
   {
      ...
      private static const §1N§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §`!V§(param1:ByteArray) : String
      {
         ...
         while(param1.bytesAvailable > 0)
         {
            ...
            {
               _loc2_ += §1N§.charAt(_loc4_[_loc7_]);
               _loc7_++;
            }
         }
         return _loc2_;
      ...
      public static function §9!;§(param1:String) : ByteArray
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §1N§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
