package §`!B§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private var §+5§:Vector.<DisplayObject>;
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§+5§ = new Vector.<DisplayObject>(0);
      }
      ...
      public function §7!7§(param1:DisplayObject, param2:DisplayObject) : void
      {
         var _loc3_:int = this.getChildIndex(param1);
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§+5§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            ...
            §6"7§(_loc7_,§9!b§);
            transformCoords(§9!b§,_loc3_,_loc4_,§0!S§);
            if(_loc8_ = _loc7_.hitTest(§0!S§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§`J§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§+5§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§5"2§();
               param1.§@&§(_loc5_);
