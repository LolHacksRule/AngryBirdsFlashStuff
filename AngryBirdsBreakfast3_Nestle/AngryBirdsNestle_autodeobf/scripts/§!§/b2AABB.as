package §!§
{
   ...
   public class b2AABB
   {
      ...
      {
         var _loc1_:Number = this.§3!E§.x - this.§&1§.x;
         var _loc2_:Number = this.§3!E§.y - this.§&1§.y;
         var _loc3_:Boolean = _loc1_ >= 0 && _loc2_ >= 0;
         return Boolean(_loc3_ && this.§&1§.§'!]§() && this.§3!E§.§'!]§());
      }
      
      public function §!!<§() : b2Vec2
      {
         return new b2Vec2((this.§&1§.x + this.§3!E§.x) / 2,(this.§&1§.y + this.§3!E§.y) / 2);
      }
      
      public function §8!V§() : b2Vec2
      {
         return new b2Vec2((this.§3!E§.x - this.§&1§.x) / 2,(this.§3!E§.y - this.§&1§.y) / 2);
      }
      ...
      public function get(param1:b2AABB) : Boolean
      {
         ...
         _loc2_ = _loc2_ && param1.§3!E§.x <= this.§3!E§.x;
         return Boolean(_loc2_ && param1.§3!E§.y <= this.§3!E§.y);
      }
      ...
      public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput) : Boolean
      {
         ...
         {
            if(_loc5_ < this.§&1§.x || this.§3!E§.x < _loc5_)
            {
               return false;
            }
         }
         else
         {
            ...
            _loc14_ = (this.§3!E§.x - _loc5_) * _loc12_;
            _loc16_ = -1;
            if(_loc13_ > _loc14_)
            {
               _loc15_ = _loc13_;
         ...
         {
            if(_loc6_ < this.§&1§.y || this.§3!E§.y < _loc6_)
            {
               return false;
            }
         }
         else
         {
            ...
            _loc14_ = (this.§3!E§.y - _loc6_) * _loc12_;
            _loc16_ = -1;
            if(_loc13_ > _loc14_)
            {
               _loc15_ = _loc13_;
      ...
      {
         var _loc2_:Number = param1.§&1§.x - this.§3!E§.x;
         var _loc3_:Number = param1.§&1§.y - this.§3!E§.y;
         var _loc4_:Number = this.§&1§.x - param1.§3!E§.x;
         var _loc5_:Number = this.§&1§.y - param1.§3!E§.y;
      ...
      public function §?z§(param1:b2AABB, param2:b2AABB) : void
      {
         ...
         this.§3!E§.x = Math.max(param1.§3!E§.x,param2.§3!E§.x);
         this.§3!E§.y = Math.max(param1.§3!E§.y,param2.§3!E§.y);
      }
   }
}
