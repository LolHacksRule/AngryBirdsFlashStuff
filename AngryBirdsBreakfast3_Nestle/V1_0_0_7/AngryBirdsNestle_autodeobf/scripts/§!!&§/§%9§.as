package §!!&§
{
   public class §%9§
   {
      ...
      public static function §&"#§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         jsonString = §46§(luaString,emptyObjectAsArray);
         try
         {
      ...
      public static function §=!p§(param1:String, param2:Boolean = false) : Object
      {
         var returnObject:Object = null;
      ...
      public static function §46§(param1:String, param2:Boolean = false) : String
      {
      ...
      private static function §`!S§(param1:String, param2:Boolean) : String
      {
