package §!!&§
{
   ...
   public class §&"&§
   {
      ...
      public static const §9Q§:String = "Container_";
      
      public static const §4!;§:String = "MovieClip_";
      
      public static const §6"§:Vector.<String> = new <String>[§9Q§,§4!;§];
      ...
      private static function §=!R§(param1:MovieClip, param2:Vector.<String>) : Boolean
      {
