package § !Q§
{
   ...
   public class Base64
   {
      ...
      private static const §9!S§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §;!Y§(param1:ByteArray) : String
      {
         ...
         while(param1.bytesAvailable > 0)
         {
            ...
            {
               _loc2_ += §9!S§.charAt(_loc4_[_loc7_]);
               _loc7_++;
            }
         }
         return _loc2_;
      ...
      {
         var _loc2_:ByteArray = §"!w§(param1);
         return _loc2_.readUTFBytes(_loc2_.length);
      }
      
      public static function §"!w§(param1:String) : ByteArray
      {
         var _loc6_:uint = 0;
         var _loc7_:uint = 0;
         var _loc2_:ByteArray = new ByteArray();
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §9!S§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
