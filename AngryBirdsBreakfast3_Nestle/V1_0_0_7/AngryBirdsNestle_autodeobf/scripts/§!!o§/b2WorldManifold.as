package §!!o§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §7!Q§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§%"+§)
         {
            case b2Manifold.§=!$§:
               ...
               this.§<!7§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§<!7§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§?!0§:
               _loc8_ = param2.R;
               _loc7_ = param1.§<V§;
               ...
               this.§]"3§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§0#§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§<!7§[_loc6_].m_localPoint;
                  ...
                  this.§<!7§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§<!7§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§%",§:
               ...
               while(_loc6_ < param1.§0#§)
               {
                  ...
                  this.§<!7§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§<!7§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
