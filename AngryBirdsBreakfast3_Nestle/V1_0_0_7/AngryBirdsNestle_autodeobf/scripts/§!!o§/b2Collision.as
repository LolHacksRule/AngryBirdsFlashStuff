package §!!o§
{
   ...
   public class b2Collision
   {
      ...
      private static var §6!k§:Vector.<§4""§> = §3w§();
      
      private static var s_clipPoints1:Vector.<§4""§> = §3w§();
      
      private static var s_clipPoints2:Vector.<§4""§> = §3w§();
      
      private static var §3n§:Vector.<int> = new Vector.<int>(1);
      
      private static var §'!T§:Vector.<int> = new Vector.<int>(1);
      
      private static var §-""§:b2Vec2 = new b2Vec2();
      
      private static var §]!n§:b2Vec2 = new b2Vec2();
      
      private static var §6t§:b2Vec2 = new b2Vec2();
      ...
      public static function §='§(param1:Vector.<§4""§>, param2:Vector.<§4""§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§4""§ = null;
         var _loc6_:int = 0;
      ...
      public static function §7"#§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§1Z§;
         var _loc7_:Vector.<b2Vec2> = param1.§[!Q§;
         var _loc8_:Vector.<b2Vec2> = param1.§8_§;
         var _loc9_:int = param4.§1Z§;
      ...
      public static function §"!@§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§1Z§;
         var _loc7_:Vector.<b2Vec2> = param2.§8_§;
         _loc9_ = param5.R;
         _loc8_ = param4.§+y§;
         ...
         var _loc17_:Number = §7"#§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §7"#§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §7"#§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §7"#§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §<p§(param1:Vector.<§4""§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§4""§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§1Z§;
         var _loc8_:Vector.<b2Vec2> = param2.§8_§;
         var _loc9_:int = param5.§1Z§;
         var _loc10_:Vector.<b2Vec2> = param5.§[!Q§;
         var _loc11_:Vector.<b2Vec2> = param5.§8_§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§9!C§.§[y§ = param4;
         _loc20_.id.§9!C§.§9"$§ = _loc21_;
         _loc20_.id.§9!C§.§[§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§9!C§.§[y§ = param4;
         _loc20_.id.§9!C§.§9"$§ = _loc22_;
         _loc20_.id.§9!C§.§[§ = 1;
      }
      
      private static function §3w§() : Vector.<§4""§>
      {
         var _loc1_:Vector.<§4""§> = new Vector.<§4""§>(2);
         _loc1_[0] = new §4""§();
         _loc1_[1] = new §4""§();
         return _loc1_;
      }
      ...
      public static function §8!§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         param1.§0#§ = 0;
         var _loc7_:Number = param2.§;J§ + param4.§;J§;
         var _loc8_:int = 0;
         §3n§[0] = _loc8_;
         var _loc9_:Number = §"!@§(§3n§,param2,param3,param4,param5);
         _loc8_ = §3n§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §'!T§[0] = _loc10_;
         var _loc11_:Number = §"!@§(§'!T§,param4,param5,param2,param3);
         _loc10_ = §'!T§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§4""§> = §6!k§;
         §<p§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§1Z§;
         ...
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §]!n§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §6t§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §^m§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§4""§> = s_clipPoints1;
         var _loc38_:Vector.<§4""§> = s_clipPoints2;
      ...
      public static function §,Q§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§;J§ + param4.§;J§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§%"+§ = b2Manifold.§=!$§;
         param1.m_localPoint.SetV(param2.§#F§);
         param1.§<V§.§`5§();
         param1.§0#§ = 1;
         param1.§<!7§[0].m_localPoint.SetV(param4.§#F§);
      ...
      public static function §+!g§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§;J§ + param4.§;J§;
         var _loc21_:int = param2.§1Z§;
         var _loc22_:Vector.<b2Vec2> = param2.§[!Q§;
         var _loc23_:Vector.<b2Vec2> = param2.§8_§;
         var _loc24_:int = 0;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§0#§ = 1;
            param1.§%"+§ = b2Manifold.§?!0§;
            param1.§<V§.x = _loc15_ - _loc27_.x;
            param1.§<V§.y = _loc16_ - _loc27_.y;
            param1.§<V§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§0#§ = 1;
            param1.§%"+§ = b2Manifold.§?!0§;
            param1.§<V§.x = _loc15_ - _loc28_.x;
            param1.§<V§.y = _loc16_ - _loc28_.y;
            param1.§<V§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§<!7§[0].m_localPoint.SetV(param4.§#F§);
            param1.§<!7§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§0#§ = 1;
            param1.§%"+§ = b2Manifold.§?!0§;
            param1.§<V§.x = _loc23_[_loc25_].x;
            param1.§<V§.y = _loc23_[_loc25_].y;
            param1.§<V§.Normalize();
      ...
      public static function §?"2§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§;!q§;
