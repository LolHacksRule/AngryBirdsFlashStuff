package §!!i§
{
   ...
   public class §>Y§ extends §-L§
   {
      ...
      public static const §'!z§:String = "transition_lop";
      ...
      public function §>Y§(param1:Vector.<MovieClip>, param2:Stage, param3:Number = 41.666666666666664)
      {
         super(param1,param2);
         this.§53§ = 0;
      ...
      protected function §[v§(param1:int) : void
      {
         ...
         if(_loc3_)
         {
            if(_loc4_ = §5#§.loop && !§>!E§)
            {
               if(_loc2_.name == "MovieClip_TutorialClip" && §5#§.type == §[!d§.§5M§)
               {
                  _loc5_ = "loop_run";
               ...
               {
                  _loc6_ = §5#§.defaultStartLabel != "" ? §5#§.defaultStartLabel : "";
                  if((_loc7_ = §5#§.startLabel != "" ? §5#§.startLabel : _loc6_) != "")
                  {
