package §-!2§
{
   public class b2Mat22
   {
      ...
      public static function §?!X§(param1:Number) : b2Mat22
      {
      ...
      public function §3!t§(param1:b2Vec2, param2:b2Vec2) : void
      {
      ...
      public function §[w§(param1:b2Mat22) : void
      {
      ...
      public function § n§(param1:b2Mat22) : b2Mat22
      {
      ...
      public function §9!§(param1:b2Vec2, param2:Number, param3:Number) : b2Vec2
      {
