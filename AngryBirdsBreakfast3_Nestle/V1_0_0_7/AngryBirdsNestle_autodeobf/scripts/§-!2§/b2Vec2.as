package §-!2§
{
   public class b2Vec2
   {
      ...
      public static function §!d§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §?!v§(param1:b2Mat22) : void
      {
      ...
      public function §3!X§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§`1§(this,param1.col1);
      ...
      {
         return b2Math.§;3§(this.x) && b2Math.§;3§(this.y);
      }
   }
}
