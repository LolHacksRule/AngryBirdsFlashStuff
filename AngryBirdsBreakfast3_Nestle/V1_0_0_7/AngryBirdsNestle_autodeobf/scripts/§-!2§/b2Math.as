package §-!2§
{
   public class b2Math
   {
      ...
      public static function §>5§(param1:b2Vec2, param2:Number) : b2Vec2
      {
         return new b2Vec2(param2 * param1.y,-param2 * param1.x);
      }
      
      public static function §8c§(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §0!l§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         ...
         _loc3_ = §"H§(param2,param1.position);
      ...
      public static function §5k§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§!f§(§'s§(param1.col1,param2.col1),§'s§(param1.col2,param2.col2));
      }
      
      public static function §25§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§!f§(§]!%§(param1,param2.col1),§]!%§(param1,param2.col2));
      }
      ...
      public static function §;!g§(param1:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§!f§(§;!g§(param1.col1),§;!g§(param1.col2));
      }
      ...
      public static function §1!j§(param1:Number, param2:Number) : Number
      {
         var _loc3_:Number = Math.random();
         return Number((param2 - param1) * _loc3_ + param1);
      }
      
      public static function §8e§(param1:uint) : uint
      {
