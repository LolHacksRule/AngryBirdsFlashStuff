package § !=§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function §3E§(param1:DisplayObject) : void
      {
      ...
      public function §9!4§(param1:DisplayObject, param2:DisplayObject) : void
      {
         var _loc3_:int = this.getChildIndex(param1);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§<"!§[_loc6_];
            §@!-§(_loc7_,§7!y§);
            transformCoords(§7!y§,_loc3_,_loc4_,§2""§);
      ...
      public function §9g§(param1:Event) : void
      {
         if(param1.bubbles)
         {
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§+3§(this,param1.type,_loc2_);
