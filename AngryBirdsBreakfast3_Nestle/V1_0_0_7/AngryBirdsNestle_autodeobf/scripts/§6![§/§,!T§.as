package §6![§
{
   ...
   public class §,!T§
   {
      ...
      public static function §>g§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §8!3§(_loc2_);
         return §#H§.§]"%§(_loc3_.readInt(),true) + §#H§.§]"%§(_loc3_.readInt(),true) + §#H§.§]"%§(_loc3_.readInt(),true) + §#H§.§]"%§(_loc3_.readInt(),true) + §#H§.§]"%§(_loc3_.readInt(),true);
      }
      ...
      private static function §8!3§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
