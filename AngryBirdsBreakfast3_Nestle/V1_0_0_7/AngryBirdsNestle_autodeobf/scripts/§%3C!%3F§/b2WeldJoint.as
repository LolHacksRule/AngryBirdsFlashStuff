package §<!?§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc7_ = this.§83§.y - _loc4_.m_sweep.localCenter.y;
         _loc3_ = _loc2_.col1.x * _loc6_ + _loc2_.col2.x * _loc7_;
         _loc7_ = _loc2_.col1.y * _loc6_ + _loc2_.col2.y * _loc7_;
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.m_xf.R;
         _loc8_ = this.§18§.x - _loc5_.m_sweep.localCenter.x;
         _loc9_ = this.§18§.y - _loc5_.m_sweep.localCenter.y;
         ...
         if(param1.§'!t§)
         {
            ...
            this.§1E§.z *= param1.§1!m§;
            _loc4_.§3N§.x -= _loc10_ * this.§1E§.x;
            _loc4_.§3N§.y -= _loc10_ * this.§1E§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§1E§.y - _loc7_ * this.§1E§.x + this.§1E§.z);
            _loc5_.§3N§.x += _loc11_ * this.§1E§.x;
            _loc5_.§3N§.y += _loc11_ * this.§1E§.y;
            _loc5_.m_angularVelocity += _loc13_ * (_loc8_ * this.§1E§.y - _loc9_ * this.§1E§.x + this.§1E§.z);
         }
         else
         {
            this.§1E§.§`5§();
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§+s§.Solve33(_loc21_,-_loc18_,-_loc19_,-_loc20_);
         this.§1E§.§3!j§(_loc21_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc5_:b2Body = b2internal::]!0;
         _loc2_ = _loc4_.m_xf.R;
         var _loc6_:Number = this.§83§.x - _loc4_.m_sweep.localCenter.x;
         var _loc7_:Number = this.§83§.y - _loc4_.m_sweep.localCenter.y;
         _loc3_ = _loc2_.col1.x * _loc6_ + _loc2_.col2.x * _loc7_;
         _loc7_ = _loc2_.col1.y * _loc6_ + _loc2_.col2.y * _loc7_;
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.m_xf.R;
         var _loc8_:Number = this.§18§.x - _loc5_.m_sweep.localCenter.x;
         ...
         this.§+s§.Solve33(_loc20_,-_loc14_,-_loc15_,-_loc16_);
