package §<!?§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§1E§.x * this.§!"2§.x + (this.§7l§ + this.§1E§.z) * this.§+!V§.x),param1 * (this.§1E§.x * this.§!"2§.y + (this.§7l§ + this.§1E§.z) * this.§+!V§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§'!t§)
         {
            ...
            this.§7l§ *= param1.§1!m§;
            _loc19_ = this.§1E§.x * this.§!"2§.x + (this.§7l§ + this.§1E§.z) * this.§+!V§.x;
            _loc20_ = this.§1E§.x * this.§!"2§.y + (this.§7l§ + this.§1E§.z) * this.§+!V§.y;
            _loc21_ = this.§1E§.x * this.m_s1 + this.§1E§.y + (this.§7l§ + this.§1E§.z) * this.m_a1;
            _loc22_ = this.§1E§.x * this.m_s2 + this.§1E§.y + (this.§7l§ + this.§1E§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§+!V§.x * (_loc6_.x - _loc4_.x) + this.§+!V§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§"P§ * (this.§4-§ - _loc14_);
            _loc16_ = this.§7l§;
            _loc17_ = param1.§&c§ * this.§#!j§;
            this.§7l§ = b2Math.§+u§(this.§7l§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§7l§ - _loc16_) * this.§+!V§.x;
            _loc9_ = _loc15_ * this.§+!V§.y;
         ...
         {
            _loc18_ = this.§+!V§.x * (_loc6_.x - _loc4_.x) + this.§+!V§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§1E§.Copy();
            _loc20_ = this.§ !V§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§1E§.§3!j§(_loc20_);
            if(this.§@x§ == b2internal::<!L)
            {
               this.§1E§.z = b2Math.§&<§(this.§1E§.z,0);
            }
            else if(this.§@x§ == b2internal::9!`)
            {
               this.§1E§.z = b2Math.§2a§(this.§1E§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§1E§.z - _loc19_.z) * this.§ !V§.col3.x;
            _loc22_ = -_loc13_ - (this.§1E§.z - _loc19_.z) * this.§ !V§.col3.y;
            _loc23_ = this.§ !V§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§1E§.x = _loc23_.x;
            this.§1E§.y = _loc23_.y;
            _loc20_.x = this.§1E§.x - _loc19_.x;
            _loc20_.y = this.§1E§.y - _loc19_.y;
            _loc20_.z = this.§1E§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§!"2§.x + _loc20_.z * this.§+!V§.x;
            _loc9_ = _loc20_.x * this.§!"2§.y + _loc20_.z * this.§+!V§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§9!y§)
         {
            ...
            _loc35_ = this.§+!V§.x * _loc26_ + this.§+!V§.y * _loc27_;
            if(b2Math.§!!<§(this.§ P§ - this.§[5§) < 2 * b2Settings.b2_linearSlop)
            {
            ...
            {
               _loc19_ = b2Math.§+u§(_loc35_ - this.§[5§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§[5§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§ P§)
            {
               _loc19_ = b2Math.§+u§(_loc35_ - this.§ P§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§7?§;
         ...
         var _loc31_:Number = _loc28_.x * this.§!"2§.x + _loc28_.z * this.§+!V§.x;
         var _loc32_:Number = _loc28_.x * this.§!"2§.y + _loc28_.z * this.§+!V§.y;
