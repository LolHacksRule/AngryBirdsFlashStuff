package §!r§
{
   public class b2Settings
   {
      ...
      public static const §"h§:int = 65535;
      ...
      public static const §%a§:Number = 0.005;
      
      public static const §5"$§:Number = 0.007;
      
      public static var b2_linearSlop:Number = §=2§;
      
      public static const §]t§:Number = b2_linearSlop - §%a§;
      ...
      public static const §5!A§:Number = 0.1;
      
      public static var b2_linearSleepTolerance:Number = §^!6§;
