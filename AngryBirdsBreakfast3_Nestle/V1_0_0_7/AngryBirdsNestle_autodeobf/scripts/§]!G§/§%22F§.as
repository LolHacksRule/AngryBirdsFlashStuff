   ...
   public class §"F§
   {
      ...
      private function §5L§(param1:int) : void
      {
         ...
         while(_loc7_ < 8)
         {
            ...
            while(_loc8_ < 8)
            {
               this.§]!k§[_loc2_] = 1 / (this.§"f§[this.§!!O§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               this.§!6§[_loc2_] = 1 / (this.§22§[this.§!!O§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               _loc2_++;
               _loc8_++;
            }
            _loc7_++;
      ...
      {
         this.§"d§ = this.§,!-§(this.§?"0§,this.§1]§);
         this.§]!T§ = this.§,!-§(this.§=V§,this.§=^§);
         this.§`8§ = this.§,!-§(this.§`" §,this.§"X§);
         this.§'!w§ = this.§,!-§(this.§'!?§,this.§`!F§);
      }
      ...
      private function §3!g§(param1:int, param2:int) : void
      {
         this.§,5§(65472);
         this.§,5§(17);
         this.writeByte(8);
      ...
      private function §-!v§(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         ...
         while(_loc8_ < 64)
         {
            this.§4!t§[this.§!!O§[_loc8_]] = _loc9_[_loc8_];
            _loc8_++;
         }
         var _loc10_:int = this.§4!t§[0] - param3;
         param3 = this.§4!t§[0];
         if(_loc10_ == 0)
         {
            this.§?!!§(param4[0]);
         ...
         var _loc11_:int = 63;
         while(_loc11_ > 0 && this.§4!t§[_loc11_] == 0)
         {
            _loc11_--;
         }
         if(_loc11_ == 0)
         ...
         {
            _loc12_ = _loc8_;
            while(this.§4!t§[_loc8_] == 0 && _loc8_ <= _loc11_)
            {
               _loc8_++;
            }
            ...
            this.§?!!§(param5[_loc13_ * 16 + this.category[32767 + this.§4!t§[_loc8_]]]);
            this.§?!!§(this.§<!i§[32767 + this.§4!t§[_loc8_]]);
            _loc8_++;
         }
         if(_loc11_ != 63)
         {
      ...
      private function §7!7§(param1:BitmapData, param2:int, param3:int) : void
      {
         var _loc6_:int = 0;
         var _loc7_:uint = 0;
         var _loc8_:Number = NaN;
      ...
      public function encode(param1:BitmapData) : ByteArray
      {
         ...
         this.§[7§();
         this.§'a§();
         this.§3!g§(param1.width,param1.height);
         this.§'!>§();
         this.§#V§();
         var _loc2_:Number = 0;
         var _loc3_:Number = 0;
         ...
         while(_loc5_ < param1.height)
         {
            ...
            {
               this.§7!7§(param1,_loc6_,_loc5_);
               _loc2_ = this.§-!v§(this.§'R§,this.§]!k§,_loc2_,this.§"d§,this.§`8§);
               _loc3_ = this.§-!v§(this.§4!@§,this.§!6§,_loc3_,this.§]!T§,this.§'!w§);
               _loc4_ = this.§-!v§(this.§`§,this.§!6§,_loc4_,this.§]!T§,this.§'!w§);
               _loc6_ += 8;
            }
            _loc5_ += 8;
         }
         if(this.§1S§ >= 0)
         {
            (_loc7_ = new §=9§()).len = this.§1S§ + 1;
            _loc7_.val = (1 << this.§1S§ + 1) - 1;
            this.§?!!§(_loc7_);
         }
         this.§,5§(65497);
         return this.§+N§;
