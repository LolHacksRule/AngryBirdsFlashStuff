package §,!k§
{
   public class b2Math
   {
      ...
      public static function §8N§(param1:b2Vec2, param2:Number) : b2Vec2
      {
      ...
      public static function §]!3§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1.col1.x * param2.x + param1.col2.x * param2.y,param1.col1.y * param2.x + param1.col2.y * param2.y);
      }
      
      public static function §5!8§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§>!m§(param2,param1.col1),§>!m§(param2,param1.col2));
      }
      
      public static function §0Y§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         _loc3_ = §]!3§(param1.R,param2);
      ...
      public static function §#R§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         ...
         _loc3_ = §5!y§(param2,param1.position);
      ...
      public static function §5!y§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1.x - param2.x,param1.y - param2.y);
      }
      ...
      {
         return b2Mat22.§9@§(§'"%§(param1.col1,param2.col1),§'"%§(param1.col2,param2.col2));
      }
      
      public static function §[l§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§9@§(§]!3§(param1,param2.col1),§]!3§(param1,param2.col2));
      }
      ...
      {
         return b2Mat22.§9@§(§?D§(param1.col1),§?D§(param1.col2));
      }
      ...
      public static function § in§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return §&!y§(param2,§ in§(param1,param3));
      }
      ...
      public static function §1J§() : Number
      {
         return Math.random() * 2 - 1;
      }
      
      public static function §1!r§(param1:Number, param2:Number) : Number
      {
         var _loc3_:Number = Math.random();
         return Number((param2 - param1) * _loc3_ + param1);
      }
      
      public static function §2!H§(param1:uint) : uint
      {
