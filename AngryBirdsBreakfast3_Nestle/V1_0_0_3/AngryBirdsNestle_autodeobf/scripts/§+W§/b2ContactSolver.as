package §+W§
{
   ...
   public class b2ContactSolver
   {
      ...
      {
         this.§9w§ = new b2TimeStep();
         this.§ +§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §2f§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§ !W§(),_loc10_.§ !W§());
            _loc20_ = _loc15_.§1N§.x;
            _loc21_ = _loc15_.§1N§.y;
            _loc22_ = _loc16_.§1N§.x;
            _loc23_ = _loc16_.§1N§.y;
            _loc24_ = _loc15_.m_angularVelocity;
            _loc25_ = _loc16_.m_angularVelocity;
            b2Settings.b2Assert(_loc17_.§%!x§ > 0);
            §^4§.§2f§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §^4§.§-§.x;
            _loc27_ = §^4§.§-§.y;
            (_loc28_ = this.§ +§[_loc6_]).§>q§ = _loc15_;
            _loc28_.§6!,§ = _loc16_;
            _loc28_.§"0§ = _loc17_;
            ...
            _loc28_.§,O§.x = _loc17_.§+!B§.x;
            _loc28_.§,O§.y = _loc17_.§+!B§.y;
            ...
            while(_loc29_ < _loc28_.§-o§)
            {
               ...
               (_loc31_ = _loc28_.§4^§[_loc29_]).normalImpulse = _loc30_.§<5§;
               _loc31_.tangentImpulse = _loc30_.§#!u§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§'d§.x = §^4§.§;!O§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§'d§.y = §^4§.§;!O§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§7"2§.x = §^4§.§;!O§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§7"2§.y = §^4§.§;!O§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               if((_loc38_ = _loc15_.§1!#§ + _loc16_.§1!#§ + _loc15_.§+%§ * _loc36_ + _loc16_.§+%§ * _loc37_) > 0)
               {
                  _loc31_.§6!s§ = 1 / _loc38_;
               }
               else
               {
                  _loc31_.§6!s§ = 0;
               }
               _loc39_ = (_loc39_ = _loc15_.§]B§ * _loc15_.§1!#§ + _loc16_.§]B§ * _loc16_.§1!#§) + (_loc15_.§]B§ * _loc15_.§+%§ * _loc36_ + _loc16_.§]B§ * _loc16_.§+%§ * _loc37_);
               _loc31_.§ V§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               if((_loc44_ = _loc15_.§1!#§ + _loc16_.§1!#§ + _loc15_.§+%§ * _loc42_ + _loc16_.§+%§ * _loc43_) > 0)
               {
                  _loc31_.§;!?§ = 1 / _loc44_;
               }
               else
               ...
               {
                  _loc31_.§6W§ = -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§-o§ == 2)
            {
               ...
               _loc52_ = _loc16_.§1!#§;
               _loc53_ = _loc16_.§+%§;
               _loc54_ = _loc48_.§'d§.x * _loc27_ - _loc48_.§'d§.y * _loc26_;
               _loc55_ = _loc48_.§7"2§.x * _loc27_ - _loc48_.§7"2§.y * _loc26_;
               _loc56_ = _loc49_.§'d§.x * _loc27_ - _loc49_.§'d§.y * _loc26_;
               _loc57_ = _loc49_.§7"2§.x * _loc27_ - _loc49_.§7"2§.y * _loc26_;
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         while(_loc5_ < this.§`$§)
         {
            ...
            if(param1.§0!_§)
            {
               ...
               {
                  _loc20_ = _loc6_.§4^§[_loc18_];
                  _loc20_.normalImpulse *= param1.§#v§;
                  _loc20_.tangentImpulse *= param1.§#v§;
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§'d§.x * _loc22_ - _loc20_.§'d§.y * _loc21_);
                  _loc7_.§1N§.x -= _loc9_ * _loc21_;
                  _loc7_.§1N§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§7"2§.x * _loc22_ - _loc20_.§7"2§.y * _loc21_);
                  _loc8_.§1N§.x += _loc11_ * _loc21_;
                  _loc8_.§1N§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  (_loc23_ = _loc6_.§4^§[_loc18_]).normalImpulse = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         while(_loc24_ < this.§`$§)
         {
            _loc26_ = (_loc25_ = this.§ +§[_loc24_]).§>q§;
            _loc27_ = _loc25_.§6!,§;
            ...
            {
               _loc2_ = _loc25_.§4^§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§7"2§.y - _loc30_.x + _loc28_ * _loc2_.§'d§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§7"2§.x - _loc30_.y - _loc28_ * _loc2_.§'d§.x;
               ...
               _loc28_ -= _loc33_ * (_loc2_.§'d§.x * _loc15_ - _loc2_.§'d§.y * _loc14_);
               _loc31_.x += _loc34_ * _loc14_;
               _loc31_.y += _loc34_ * _loc15_;
               _loc29_ += _loc35_ * (_loc2_.§7"2§.x * _loc15_ - _loc2_.§7"2§.y * _loc14_);
            ...
            if(_loc25_.§-o§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§6!s§ * (_loc9_ - _loc2_.§6W§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§7"2§.y - _loc30_.x + _loc28_ * _loc43_.§'d§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§7"2§.x - _loc30_.y - _loc28_ * _loc43_.§'d§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§7"2§.y - _loc30_.x + _loc28_ * _loc44_.§'d§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§7"2§.x - _loc30_.y - _loc28_ * _loc44_.§'d§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§6W§;
               _loc54_ = _loc52_ - _loc44_.§6W§;
               _loc22_ = _loc25_.K;
               _loc53_ -= _loc22_.col1.x * _loc45_ + _loc22_.col2.x * _loc46_;
               _loc54_ -= _loc22_.col1.y * _loc45_ + _loc22_.col2.y * _loc46_;
               _loc55_ = 0.001;
               _loc56_ = -((_loc22_ = _loc25_.§6!s§).col1.x * _loc53_ + _loc22_.col2.x * _loc54_);
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§'d§.x * _loc19_ - _loc43_.§'d§.y * _loc18_ + _loc44_.§'d§.x * _loc21_ - _loc44_.§'d§.y * _loc20_);
                  _loc31_.x += _loc34_ * (_loc18_ + _loc20_);
                  _loc31_.y += _loc34_ * (_loc19_ + _loc21_);
                  _loc29_ += _loc35_ * (_loc43_.§7"2§.x * _loc19_ - _loc43_.§7"2§.y * _loc18_ + _loc44_.§7"2§.x * _loc21_ - _loc44_.§7"2§.y * _loc20_);
                  _loc43_.normalImpulse = _loc56_;
                  _loc44_.normalImpulse = _loc57_;
               }
               else
               {
                  _loc56_ = -_loc43_.§6!s§ * _loc53_;
                  _loc57_ = 0;
                  _loc51_ = 0;
      ...
      public function §?y§() : void
      {
         ...
         while(_loc1_ < this.§`$§)
         {
            ...
            while(_loc4_ < _loc2_.§-o§)
            {
               ...
               _loc6_ = _loc2_.§4^§[_loc4_];
               _loc5_.§<5§ = _loc6_.normalImpulse;
               _loc5_.§#!u§ = _loc6_.tangentImpulse;
               _loc4_++;
            }
            _loc1_++;
         }
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§`$§)
         {
            _loc5_ = (_loc4_ = this.§ +§[_loc3_]).§>q§;
            _loc6_ = _loc4_.§6!,§;
            _loc7_ = _loc5_.§]B§ * _loc5_.§1!#§;
            _loc8_ = _loc5_.§]B§ * _loc5_.§+%§;
            _loc9_ = _loc6_.§]B§ * _loc6_.§1!#§;
            _loc10_ = _loc6_.§]B§ * _loc6_.§+%§;
            §="#§.§2f§(_loc4_);
            _loc11_ = §="#§.§-§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§-o§)
            {
               _loc13_ = _loc4_.§4^§[_loc12_];
               _loc14_ = §="#§.§;!O§[_loc12_];
               _loc15_ = §="#§.§3!5§[_loc12_];
