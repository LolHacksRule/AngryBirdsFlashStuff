package §#"2§
{
   ...
   public class §%V§
   {
      ...
      private static var §4!2§:Boolean = false;
      ...
      public static function encode(param1:BitmapData) : ByteArray
      {
         ...
         _loc4_.compress();
         §9i§(_loc2_,1229209940,_loc4_);
         §9i§(_loc2_,1229278788,null);
         return _loc2_;
      }
      
      private static function §9i§(param1:ByteArray, param2:uint, param3:ByteArray) : void
      {
         var _loc8_:uint = 0;
         var _loc9_:uint = 0;
         var _loc10_:uint = 0;
         ...
         {
            _loc8_ = uint(§+P§[(_loc8_ ^ param1.readUnsignedByte()) & uint(255)] ^ uint(_loc8_ >>> 8));
            _loc7_++;
         }
