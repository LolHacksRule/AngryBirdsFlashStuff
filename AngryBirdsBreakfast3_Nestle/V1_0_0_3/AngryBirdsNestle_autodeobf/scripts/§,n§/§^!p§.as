package §,n§
{
   public class §^!p§
   {
      ...
      private function §^!A§() : §2!%§
      {
         ...
         var _loc2_:§2!%§ = new §2!%§();
         _loc2_.type = §9!y§.§?!g§;
         _loc2_.value = this.§-"0§(this.jsonString.substr(this.§<!n§,_loc1_ - this.§<!n§));
         this.§<!n§ = _loc1_ + 1;
         this.§&"4§();
         return _loc2_;
      }
      ...
      {
         return this.§<!;§ = this.jsonString.charAt(this.§<!n§++);
      }
      ...
      private function §,"1§(param1:String) : Boolean
      {
         ...
         if(!this.§8o§ && param1.charCodeAt(0) == 160)
         {
            return true;
         }
         return false;
      ...
      {
         throw new JSONParseError(param1,this.§<!n§,this.jsonString);
      }
   }
}
