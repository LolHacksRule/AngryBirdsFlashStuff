   ...
   public class b2FrictionJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§0!_§)
         {
            ...
            this.§`7§ *= param1.§#v§;
            _loc15_ = this.§!!,§;
            _loc4_.§1N§.x -= _loc10_ * _loc15_.x;
            _loc4_.§1N§.y -= _loc10_ * _loc15_.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * _loc15_.y - _loc7_ * _loc15_.x + this.§`7§);
            _loc5_.§1N§.x += _loc11_ * _loc15_.x;
            _loc5_.§1N§.y += _loc11_ * _loc15_.y;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc18_ = param1.§<"3§ * this.§[!;§;
         this.§`7§ = b2Math.§[§(this.§`7§ + _loc20_,-_loc18_,_loc18_);
         _loc20_ = this.§`7§ - _loc21_;
         _loc7_ -= _loc12_ * _loc20_;
         _loc9_ += _loc13_ * _loc20_;
         var _loc22_:Number = _loc8_.x - _loc9_ * _loc17_ - _loc6_.x + _loc7_ * _loc15_;
         var _loc23_:Number = _loc8_.y + _loc9_ * _loc16_ - _loc6_.y - _loc7_ * _loc14_;
         var _loc24_:b2Vec2 = b2Math.§]!3§(this.§7" §,new b2Vec2(-_loc22_,-_loc23_));
         var _loc25_:b2Vec2 = this.§!!,§.Copy();
         this.§!!,§.§0<§(_loc24_);
         _loc18_ = param1.§<"3§ * this.§&j§;
         if(this.§!!,§.§"-§() > _loc18_ * _loc18_)
         {
            this.§!!,§.Normalize();
            this.§!!,§.§%"§(_loc18_);
         }
         _loc24_ = b2Math.§5!y§(this.§!!,§,_loc25_);
