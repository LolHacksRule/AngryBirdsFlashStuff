package §>H§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §5!9§:Number = 2;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§,`§ = b2internal::9!>.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§ "1§.x - this.§,`§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§ "1§.y - this.§,`§.m_xf.position.y;
         ...
         this.§["0§ = param1.§-&§;
         this.§%!L§ = param1.§^!w§ + this.§["0§ * param1.§8!T§;
         this.m_maxLength1 = b2Math.§,A§(param1.§<b§,this.§%!L§ - this.§["0§ * b2internal::5!9);
         this.m_maxLength2 = b2Math.§,A§(param1.§6e§,(this.§%!L§ - b2internal::5!9) / this.§["0§);
         this.§@_§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§@_§ * this.m_u2.x,param1 * this.§@_§ * this.m_u2.y);
      }
      ...
      {
         var _loc1_:b2Vec2 = b2internal::9!>.GetWorldPoint(this.m_localAnchor1);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§%!L§ - _loc18_ - this.§["0§ * _loc19_) > 0)
         {
            this.§&s§ = b2internal::@-;
            this.§@_§ = 0;
         }
         ...
         {
            this.m_limitState1 = b2internal::7Z;
         }
         ...
         {
            this.m_limitState2 = b2internal::7Z;
         }
         var _loc21_:Number = _loc5_ * this.m_u1.y - _loc6_ * this.m_u1.x;
         var _loc22_:Number = _loc8_ * this.m_u2.y - _loc9_ * this.m_u2.x;
         this.m_limitMass1 = _loc2_.§1!#§ + _loc2_.§+%§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§1!#§ + _loc3_.§+%§ * _loc22_ * _loc22_;
         this.§1"!§ = this.m_limitMass1 + this.§["0§ * this.§["0§ * this.m_limitMass2;
         ...
         {
            this.§@_§ *= param1.§#v§;
            this.m_limitImpulse1 *= param1.§#v§;
            this.m_limitImpulse2 *= param1.§#v§;
            _loc23_ = (-this.§@_§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§@_§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§["0§ * this.§@_§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§["0§ * this.§@_§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§1N§.x += _loc2_.§1!#§ * _loc23_;
            _loc2_.§1N§.y += _loc2_.§1!#§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§+%§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§1N§.x += _loc3_.§1!#§ * _loc25_;
            _loc3_.§1N§.y += _loc3_.§1!#§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = _loc4_.col1.y * _loc8_ + _loc4_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         if(this.§&s§ == b2internal::7Z)
         {
            _loc10_ = _loc2_.§1N§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§1N§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§1N§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§1N§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§["0§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§1"!§ * -_loc18_;
            _loc20_ = this.§@_§;
            this.§@_§ = b2Math.§+z§(0,this.§@_§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§@_§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§["0§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§["0§ * _loc19_ * this.m_u2.y;
            _loc2_.§1N§.x += _loc2_.§1!#§ * _loc14_;
            _loc2_.§1N§.y += _loc2_.§1!#§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§+%§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§1N§.x += _loc3_.§1!#§ * _loc16_;
            _loc3_.§1N§.y += _loc3_.§1!#§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§+%§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
         if(this.m_limitState1 == b2internal::7Z)
         {
            _loc10_ = _loc2_.§1N§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§1N§.y + _loc2_.m_angularVelocity * _loc5_;
         ...
         if(this.m_limitState2 == b2internal::7Z)
         {
            _loc12_ = _loc3_.§1N§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§1N§.y + _loc3_.m_angularVelocity * _loc8_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§&s§ == b2internal::7Z)
         {
            ...
            _loc19_ = this.§%!L§ - _loc17_ - this.§["0§ * _loc18_;
