package §>H§
{
   ...
   public class b2DistanceJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * this.§@_§ * this.§@!8§.x,param1 * this.§@_§ * this.§@!8§.y);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc13_:Number = _loc4_.§1!#§ + _loc4_.§+%§ * _loc11_ * _loc11_ + _loc5_.§1!#§ + _loc5_.§+%§ * _loc12_ * _loc12_;
         this.§]B§ = _loc13_ != 0 ? Number(1 / _loc13_) : Number(0);
         if(this.§2u§ > 0)
         {
            _loc14_ = _loc10_ - this.§#!s§;
            _loc15_ = 2 * Math.PI * this.§2u§;
            _loc16_ = 2 * this.§]B§ * this.§;!W§ * _loc15_;
            _loc17_ = this.§]B§ * _loc15_ * _loc15_;
            this.§0p§ = param1.§<"3§ * (_loc16_ + param1.§<"3§ * _loc17_);
            this.§0p§ = this.§0p§ != 0 ? Number(1 / this.§0p§) : Number(0);
            this.§<=§ = _loc14_ * param1.§<"3§ * _loc17_ * this.§0p§;
            this.§]B§ = _loc13_ + this.§0p§;
            this.§]B§ = this.§]B§ != 0 ? Number(1 / this.§]B§) : Number(0);
         }
         if(param1.§0!_§)
         {
            this.§@_§ *= param1.§#v§;
            _loc18_ = this.§@_§ * this.§@!8§.x;
            _loc19_ = this.§@_§ * this.§@!8§.y;
            _loc4_.§1N§.x -= _loc4_.§1!#§ * _loc18_;
            _loc4_.§1N§.y -= _loc4_.§1!#§ * _loc19_;
            _loc4_.m_angularVelocity -= _loc4_.§+%§ * (_loc6_ * _loc19_ - _loc7_ * _loc18_);
            _loc5_.§1N§.x += _loc5_.§1!#§ * _loc18_;
            _loc5_.§1N§.y += _loc5_.§1!#§ * _loc19_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = _loc2_.col1.y * _loc8_ + _loc2_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         var _loc10_:Number = _loc3_.§1N§.x + -_loc3_.m_angularVelocity * _loc6_;
         var _loc11_:Number = _loc3_.§1N§.y + _loc3_.m_angularVelocity * _loc5_;
         var _loc12_:Number = _loc4_.§1N§.x + -_loc4_.m_angularVelocity * _loc9_;
         var _loc13_:Number = _loc4_.§1N§.y + _loc4_.m_angularVelocity * _loc8_;
         var _loc14_:Number = this.§@!8§.x * (_loc12_ - _loc10_) + this.§@!8§.y * (_loc13_ - _loc11_);
         var _loc15_:Number = -this.§]B§ * (_loc14_ + this.§<=§ + this.§0p§ * this.§@_§);
         this.§@_§ += _loc15_;
         ...
         _loc4_.§1N§.x += _loc4_.§1!#§ * _loc16_;
         _loc4_.§1N§.y += _loc4_.§1!#§ * _loc17_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         _loc10_ /= _loc12_;
         _loc11_ /= _loc12_;
         var _loc13_:Number = _loc12_ - this.§#!s§;
