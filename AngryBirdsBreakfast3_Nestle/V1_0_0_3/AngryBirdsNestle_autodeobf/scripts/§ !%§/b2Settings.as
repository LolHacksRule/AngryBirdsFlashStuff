package § !%§
{
   public class b2Settings
   {
      ...
      public static const §]U§:Number = 0.05;
      
      private static const §@!j§:Number = 0.005;
      
      public static const §]&§:Number = §@!j§ + 0.002;
      
      public static const § !s§:Number = §]&§ - §@!j§;
      
      public static var b2_linearSlop:Number = §]U§;
      ...
      public static const §,L§:Number = 0.01;
      
      public static const §<g§:Number = 0.1;
      
      public static var b2_linearSleepTolerance:Number = §&!5§;
