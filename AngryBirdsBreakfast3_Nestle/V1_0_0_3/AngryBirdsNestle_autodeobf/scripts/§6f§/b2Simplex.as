   ...
   class b2Simplex
   {
      ...
      public function §%!z§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         while(_loc9_ < this.§[d§)
         {
            ...
            _loc10_.§#!,§ = b2Math.§0Y§(param3,_loc6_);
            _loc10_.§8r§ = b2Math.§0Y§(param5,_loc7_);
            _loc10_.§3`§ = b2Math.§5!y§(_loc10_.§8r§,_loc10_.§#!,§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§[d§ > 1)
         {
            _loc11_ = param1.§7!N§;
            if((_loc12_ = this.§4O§()) < 0.5 * _loc11_ || 2 * _loc11_ < _loc12_ || _loc12_ < Number.MIN_VALUE)
            {
               this.§[d§ = 0;
            }
         }
      ...
      public function §;I§(param1:b2SimplexCache) : void
      {
         param1.§7!N§ = this.§4O§();
      ...
      public function §;M§() : b2Vec2
      {
         ...
         {
            case 1:
               return this.m_v1.§3`§.§6C§();
            case 2:
               _loc1_ = b2Math.§5!y§(this.m_v2.§3`§,this.m_v1.§3`§);
               _loc2_ = b2Math.§>" §(_loc1_,this.m_v1.§3`§.§6C§());
               if(_loc2_ > 0)
               {
                  return b2Math.§ K§(1,_loc1_);
               }
               return b2Math.§8N§(_loc1_,1);
               break;
            default:
      ...
      public function §="1§() : b2Vec2
      {
         switch(this.§[d§)
         {
            ...
            case 1:
               return this.m_v1.§3`§;
            case 2:
               return new b2Vec2(this.m_v1.a * this.m_v1.§3`§.x + this.m_v2.a * this.m_v2.§3`§.x,this.m_v1.a * this.m_v1.§3`§.y + this.m_v2.a * this.m_v2.§3`§.y);
            default:
               b2Settings.b2Assert(false);
               return new b2Vec2();
         }
      ...
      public function each(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§[d§)
         {
            case 0:
            ...
            case 1:
               ...
               param2.SetV(this.m_v1.§8r§);
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§#!,§.x + this.m_v2.a * this.m_v2.§#!,§.x;
               param1.y = this.m_v1.a * this.m_v1.§#!,§.y + this.m_v2.a * this.m_v2.§#!,§.y;
               param2.x = this.m_v1.a * this.m_v1.§8r§.x + this.m_v2.a * this.m_v2.§8r§.x;
               param2.y = this.m_v1.a * this.m_v1.§8r§.y + this.m_v2.a * this.m_v2.§8r§.y;
               break;
            case 3:
      ...
      public function §4O§() : Number
      {
         switch(this.§[d§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§5!y§(this.m_v1.§3`§,this.m_v2.§3`§).Length();
            case 3:
               return b2Math.§>" §(b2Math.§5!y§(this.m_v2.§3`§,this.m_v1.§3`§),b2Math.§5!y§(this.m_v3.§3`§,this.m_v1.§3`§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      {
         var _loc1_:b2Vec2 = this.m_v1.§3`§;
         var _loc2_:b2Vec2 = this.m_v2.§3`§;
         var _loc3_:b2Vec2 = b2Math.§5!y§(_loc2_,_loc1_);
         var _loc4_:Number;
