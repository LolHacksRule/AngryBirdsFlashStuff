package §6f§
{
   ...
   class b2SeparationFunction
   {
      ...
      public var §2!r§:b2DistanceProxy;
      ...
      public function §2f§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§=!;§ = §0!!§;
            _loc7_ = this.§2!r§.§,!T§(param1.indexA[0]);
            _loc10_ = this.§<K§.§,!T§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§=!;§ = §7m§;
            _loc8_ = this.§2!r§.§,!T§(param1.indexA[0]);
            _loc9_ = this.§2!r§.§,!T§(param1.indexA[1]);
            _loc10_ = this.§<K§.§,!T§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§@!;§ = b2Math.§8N§(b2Math.§5!y§(_loc9_,_loc8_),1);
            this.§@!;§.Normalize();
            _loc20_ = this.§@!;§;
         ...
         {
            this.§=!;§ = §]!W§;
            _loc11_ = this.§<K§.§,!T§(param1.indexB[0]);
            _loc12_ = this.§<K§.§,!T§(param1.indexB[1]);
            _loc7_ = this.§2!r§.§,!T§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§@!;§ = b2Math.§8N§(b2Math.§5!y§(_loc12_,_loc11_),1);
            this.§@!;§.Normalize();
            _loc20_ = this.§@!;§;
         ...
         else
         {
            ...
            _loc11_ = this.§<K§.§,!T§(param1.indexB[0]);
            _loc12_ = this.§<K§.§,!T§(param1.indexB[1]);
            _loc23_ = b2Math.§0Y§(param3,_loc7_);
            _loc24_ = b2Math.§]!3§(param3.R,b2Math.§5!y§(_loc9_,_loc8_));
            _loc25_ = b2Math.§0Y§(param5,_loc10_);
            _loc26_ = b2Math.§]!3§(param5.R,b2Math.§5!y§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§5!y§(_loc26_,_loc24_);
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §0!!§:
               _loc3_ = b2Math.§5!8§(param1.R,this.§@!;§);
               _loc4_ = b2Math.§5!8§(param2.R,this.§@!;§.§6C§());
               _loc5_ = this.§2!r§.§0u§(_loc3_);
               _loc6_ = this.§<K§.§0u§(_loc4_);
               _loc7_ = b2Math.§0Y§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§0Y§(param2,_loc6_)).x - _loc7_.x) * this.§@!;§.x + (_loc8_.y - _loc7_.y) * this.§@!;§.y);
            case §7m§:
               _loc10_ = b2Math.§]!3§(param1.R,this.§@!;§);
               _loc7_ = b2Math.§0Y§(param1,this.m_localPoint);
               _loc4_ = b2Math.§5!8§(param2.R,_loc10_.§6C§());
               _loc6_ = this.§<K§.§0u§(_loc4_);
               return Number(((_loc8_ = b2Math.§0Y§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §]!W§:
               _loc10_ = b2Math.§]!3§(param2.R,this.§@!;§);
               _loc8_ = b2Math.§0Y§(param2,this.m_localPoint);
               _loc3_ = b2Math.§5!8§(param1.R,_loc10_.§6C§());
               _loc5_ = this.§2!r§.§0u§(_loc3_);
               return Number(((_loc7_ = b2Math.§0Y§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
