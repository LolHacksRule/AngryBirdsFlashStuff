package §6f§
{
   ...
   public class b2Collision
   {
      ...
      private static var §3!=§:Vector.<§3k§> = §0S§();
      
      private static var s_clipPoints1:Vector.<§3k§> = §0S§();
      
      private static var s_clipPoints2:Vector.<§3k§> = §0S§();
      ...
      public static function §%!,§(param1:Vector.<§3k§>, param2:Vector.<§3k§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§3k§ = null;
         var _loc6_:int = 0;
      ...
      public static function §6!k§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§?3§;
         var _loc7_:Vector.<b2Vec2> = param1.§]x§;
         var _loc8_:Vector.<b2Vec2> = param1.§3C§;
         var _loc9_:int = param4.§?3§;
      ...
      public static function §5&§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§?3§;
         var _loc7_:Vector.<b2Vec2> = param2.§3C§;
         _loc9_ = param5.R;
         _loc8_ = param4.§6w§;
         ...
         var _loc17_:Number = §6!k§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §6!k§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §6!k§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §6!k§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §2!m§(param1:Vector.<§3k§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§3k§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§?3§;
         var _loc8_:Vector.<b2Vec2> = param2.§3C§;
         var _loc9_:int = param5.§?3§;
         var _loc10_:Vector.<b2Vec2> = param5.§]x§;
         var _loc11_:Vector.<b2Vec2> = param5.§3C§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§&!D§.§2<§ = param4;
         _loc20_.id.§&!D§.§4!w§ = _loc21_;
         _loc20_.id.§&!D§.§"!H§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§&!D§.§2<§ = param4;
         _loc20_.id.§&!D§.§4!w§ = _loc22_;
         _loc20_.id.§&!D§.§"!H§ = 1;
      }
      
      private static function §0S§() : Vector.<§3k§>
      {
         var _loc1_:Vector.<§3k§> = new Vector.<§3k§>(2);
         _loc1_[0] = new §3k§();
         _loc1_[1] = new §3k§();
         return _loc1_;
      }
      
      public static function §^!i§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§3k§ = null;
         ...
         param1.§%!x§ = 0;
         var _loc7_:Number = param2.§["2§ + param4.§["2§;
         var _loc8_:int = 0;
         §%3§[0] = _loc8_;
         var _loc9_:Number = §5&§(§%3§,param2,param3,param4,param5);
         _loc8_ = §%3§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §="-§[0] = _loc10_;
         var _loc11_:Number = §5&§(§="-§,param4,param5,param2,param3);
         _loc10_ = §="-§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§=!;§ = b2Manifold.§7m§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§3k§> = §3!=§;
         §2!m§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§?3§;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §@!M§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §>!>§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §]2§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         ...
         var _loc37_:Vector.<§3k§> = s_clipPoints1;
         var _loc38_:Vector.<§3k§> = s_clipPoints2;
      ...
      public static function §3q§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§["2§ + param4.§["2§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§=!;§ = b2Manifold.§#!F§;
         param1.m_localPoint.SetV(param2.§1b§);
         param1.§+!B§.§2!n§();
         param1.§%!x§ = 1;
         param1.§;!O§[0].m_localPoint.SetV(param4.§1b§);
         param1.§;!O§[0].m_id.key = 0;
      }
      
      public static function §^!E§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§["2§ + param4.§["2§;
         var _loc21_:int = param2.§?3§;
         var _loc22_:Vector.<b2Vec2> = param2.§]x§;
         var _loc23_:Vector.<b2Vec2> = param2.§3C§;
         var _loc24_:int = 0;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§%!x§ = 1;
            param1.§=!;§ = b2Manifold.§7m§;
            param1.§+!B§.x = _loc15_ - _loc27_.x;
            param1.§+!B§.y = _loc16_ - _loc27_.y;
            param1.§+!B§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§%!x§ = 1;
            param1.§=!;§ = b2Manifold.§7m§;
            param1.§+!B§.x = _loc15_ - _loc28_.x;
            param1.§+!B§.y = _loc16_ - _loc28_.y;
            param1.§+!B§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§;!O§[0].m_localPoint.SetV(param4.§1b§);
            param1.§;!O§[0].m_id.key = 0;
      ...
      {
         var _loc3_:b2Vec2 = param2.§-Z§;
         var _loc4_:b2Vec2 = param1.§7^§;
