package §!T§
{
   ...
   public class §`v§
   {
      ...
      public static function §catch§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §-D§(_loc2_);
         return §;!a§.§?!q§(_loc3_.readInt(),true) + §;!a§.§?!q§(_loc3_.readInt(),true) + §;!a§.§?!q§(_loc3_.readInt(),true) + §;!a§.§?!q§(_loc3_.readInt(),true) + §;!a§.§?!q§(_loc3_.readInt(),true);
      }
      
      public static function §?"3§(param1:ByteArray) : String
      {
         var _loc2_:Array = §`v§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §-D§(_loc2_);
         return §;!a§.§?!q§(_loc3_.readInt(),true) + §;!a§.§?!q§(_loc3_.readInt(),true) + §;!a§.§?!q§(_loc3_.readInt(),true) + §;!a§.§?!q§(_loc3_.readInt(),true) + §;!a§.§?!q§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc6_:uint = 0;
         var _loc2_:Array = §`v§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §-D§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
