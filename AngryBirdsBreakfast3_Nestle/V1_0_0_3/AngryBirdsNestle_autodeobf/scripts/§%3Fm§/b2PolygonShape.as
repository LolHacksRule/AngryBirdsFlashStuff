package §?m§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §1!L§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §6w§:b2Vec2;
      
      b2internal var §]x§:Vector.<b2Vec2>;
      
      b2internal var §3C§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         §=!;§ = b2internal::!Y;
         this.§6w§ = new b2Vec2();
         this.§]x§ = new Vector.<b2Vec2>();
         this.§3C§ = new Vector.<b2Vec2>();
         §["2§ = b2Settings.b2_polygonRadius;
         this.§6w§.§2!n§();
      }
      
      public static function §9!D§(param1:Array, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§7!S§(param1,param2);
         return _loc3_;
      }
      
      public static function §-P§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §`!L§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§2!E§(param1,param2);
         return _loc3_;
      }
      
      public static function §3!T§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
      ...
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§13§(param1,param2);
         return _loc3_;
      }
      
      public static function §,b§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
      ...
      b2internal static function §4!O§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§`K§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§`K§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§6w§.SetV(_loc2_.§6w§);
            this.§?3§ = _loc2_.§?3§;
            this.§,!P§(this.§?3§);
            _loc3_ = 0;
            while(_loc3_ < this.§?3§)
            {
               this.§]x§[_loc3_].SetV(_loc2_.§]x§[_loc3_]);
               this.§3C§[_loc3_].SetV(_loc2_.§3C§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §7!S§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function § z§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§?3§)
         {
            this.§]x§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§?3§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§?3§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§5!y§(this.§]x§[_loc5_],this.§]x§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§"-§() > Number.MIN_VALUE);
            this.§3C§[_loc3_].SetV(b2Math.§8N§(_loc6_,1));
            this.§3C§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§6w§ = §,b§(this.§]x§,this.§?3§);
      }
      
      public function §2!E§(param1:Number, param2:Number) : void
      {
         this.§?3§ = 4;
         this.§,!P§(4);
         this.§]x§[0].Set(-param1,-param2);
         this.§]x§[1].Set(param1,-param2);
         this.§]x§[2].Set(param1,param2);
         this.§]x§[3].Set(-param1,param2);
         this.§3C§[0].Set(0,-1);
         this.§3C§[1].Set(1,0);
         this.§3C§[2].Set(0,1);
         this.§3C§[3].Set(-1,0);
      ...
      public function §?2§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§?3§)
         {
            this.§]x§[_loc6_] = b2Math.§0Y§(_loc5_,this.§]x§[_loc6_]);
            this.§3C§[_loc6_] = b2Math.§]!3§(_loc5_.R,this.§3C§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §13§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§?3§ = 2;
         this.§,!P§(2);
         this.§]x§[0].SetV(param1);
         this.§]x§[1].SetV(param2);
         this.§6w§.x = 0.5 * (param1.x + param2.x);
         this.§6w§.y = 0.5 * (param1.y + param2.y);
         this.§3C§[0] = b2Math.§8N§(b2Math.§5!y§(param2,param1),1);
         this.§3C§[0].Normalize();
         this.§3C§[1].x = -this.§3C§[0].x;
         this.§3C§[1].y = -this.§3C§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§?3§)
         {
            _loc6_ = (_loc9_ = this.§]x§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§3C§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§-Z§.x = _loc5_ - b2internal::["2;
         param1.§-Z§.y = _loc6_ - b2internal::["2;
         param1.§7^§.x = _loc7_ + b2internal::["2;
         param1.§7^§.y = _loc8_ + b2internal::["2;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§?3§ == 2)
         {
            param1.center.x = 0.5 * (this.§]x§[0].x + this.§]x§[1].x);
            param1.center.y = 0.5 * (this.§]x§[0].y + this.§]x§[1].y);
            param1.§?<§ = 0;
            param1.I = 0;
            return;
         }
         ...
         var _loc6_:Number = 0;
         var _loc10_:int = 0;
         while(_loc10_ < this.§?3§)
         {
            _loc11_ = this.§]x§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§?3§ ? this.§]x§[int(_loc10_ + 1)] : this.§]x§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§5!8§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§>!m§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§>!m§(_loc5_,this.§]x§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§0Y§(param3,_loc24_.center));
                  return _loc24_.§?<§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§?3§;
         var _loc14_:int = (_loc10_ + 1) % this.§?3§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§]x§[_loc9_].x * (1 - _loc15_) + this.§]x§[_loc13_].x * _loc15_,this.§]x§[_loc9_].y * (1 - _loc15_) + this.§]x§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§]x§[_loc10_].x * (1 - _loc16_) + this.§]x§[_loc14_].x * _loc16_,this.§]x§[_loc10_].y * (1 - _loc16_) + this.§]x§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§]x§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§?3§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§]x§[_loc12_];
            }
         ...
         _loc20_.§%"§(1 / _loc19_);
         param4.SetV(b2Math.§0Y§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §5!b§() : Vector.<b2Vec2>
      {
         return this.§3C§;
      }
      ...
      private function §,!P§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            this.§]x§[_loc2_] = new b2Vec2();
            this.§3C§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
