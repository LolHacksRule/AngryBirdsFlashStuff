package §2J§
{
   ...
   public class §6!<§
   {
      ...
      private function § !t§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§"5§(param1 as String);
         }
         if(param1 is Number)
         {
         ...
         if(param1 is Array)
         {
            return this.§1!3§(param1 as Array);
         }
         if(param1 is Object && param1 != null)
         {
            return this.§4!m§(param1);
         }
         return "null";
      }
      ...
      private function §1!3§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§ !t§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §4!m§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§"5§(v.@name.toString()) + ":" + this.§ !t§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
