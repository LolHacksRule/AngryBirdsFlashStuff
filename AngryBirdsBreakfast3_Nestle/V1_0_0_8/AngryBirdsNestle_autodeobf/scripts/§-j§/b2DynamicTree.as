package §-j§
{
   ...
   public class b2DynamicTree
   {
      ...
      private var §4!F§:b2DynamicTreeNode;
      
      private var §92§:b2DynamicTreeNode;
      ...
      public function §3!?§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
         ...
         _loc3_.aabb.§use§.x = param1.§use§.x - _loc4_;
         _loc3_.aabb.§use§.y = param1.§use§.y - _loc5_;
      ...
      public function §?8§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         ...
         param1.aabb.§use§.x = param2.§use§.x - _loc4_;
         param1.aabb.§use§.y = param2.§use§.y - _loc5_;
      ...
      public function §?!d§(param1:b2DynamicTreeNode) : b2AABB
      {
         return param1.aabb;
      }
      ...
      public function § " §(param1:Function, param2:b2AABB) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc7_:*;
         _loc3_[_loc7_ = _loc4_++] = this.§4!F§;
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§^s§(param2))
            {
               if(_loc5_.§<!_§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         _loc9_.§use§.x = Math.min(_loc3_.x,_loc10_);
         _loc9_.§use§.y = Math.min(_loc3_.y,_loc11_);
         _loc9_.§6&§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§6&§.y = Math.max(_loc3_.y,_loc11_);
         var _loc12_:Vector.<b2DynamicTreeNode> = new Vector.<b2DynamicTreeNode>();
         var _loc13_:int = 0;
         var _loc19_:*;
         _loc12_[_loc19_ = _loc13_++] = this.§4!F§;
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§^s§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§;!M§();
      ...
      private function §7!@§(param1:b2DynamicTreeNode) : void
      {
         param1.parent = this.§92§;
         this.§92§ = param1;
      }
      ...
      private function §+!e§(param1:b2DynamicTreeNode) : void
      {
         ...
         {
            this.§4!F§ = param1;
            this.§4!F§.parent = null;
            return;
         }
         var _loc2_:b2Vec2 = param1.aabb.§;!M§();
         var _loc3_:b2DynamicTreeNode = this.§4!F§;
         if(_loc3_.§<!_§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§use§.x + _loc6_.aabb.§6&§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§use§.y + _loc6_.aabb.§6&§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§use§.x + _loc7_.aabb.§6&§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§use§.y + _loc7_.aabb.§6&§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         _loc5_.aabb.§8"7§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            while(!_loc4_.aabb.§2!#§(_loc5_.aabb))
            {
               _loc4_.aabb.§8"7§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
      ...
      private function §+!G§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc5_ = _loc3_.aabb;
               _loc3_.aabb = b2AABB.§8"7§(_loc3_.child1.aabb,_loc3_.child2.aabb);
               if(_loc5_.§2!#§(_loc3_.aabb))
               {
                  break;
               }
