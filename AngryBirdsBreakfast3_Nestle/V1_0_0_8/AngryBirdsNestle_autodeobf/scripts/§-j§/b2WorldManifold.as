package §-j§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §3!,§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§5"6§)
         {
            case b2Manifold.§2!1§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§3b§.x = _loc19_ / _loc26_;
                  this.§3b§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§3b§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§3b§.x;
               _loc23_ = _loc16_ + param3 * this.§3b§.y;
               _loc24_ = _loc17_ - param5 * this.§3b§.x;
               _loc25_ = _loc18_ - param5 * this.§3b§.y;
