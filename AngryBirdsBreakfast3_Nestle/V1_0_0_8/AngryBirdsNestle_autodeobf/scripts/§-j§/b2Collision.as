package §-j§
{
   ...
   public class b2Collision
   {
      ...
      private static var §3!x§:Vector.<int> = new Vector.<int>(1);
      ...
      private static var §57§:b2Vec2 = new b2Vec2();
      ...
      public static function §5=§(param1:Vector.<§""#§>, param2:Vector.<§""#§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§""#§ = null;
         var _loc6_:int = 0;
      ...
      public static function §,q§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc6_:int = param1.§4k§;
         var _loc7_:Vector.<b2Vec2> = param1.§5P§;
         var _loc8_:Vector.<b2Vec2> = param1.§!"%§;
         var _loc9_:int = param4.§4k§;
         var _loc10_:Vector.<b2Vec2> = param4.§5P§;
         _loc11_ = param2.R;
      ...
      public static function §implements§(param1:Vector.<§""#§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§""#§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§4k§;
         var _loc8_:Vector.<b2Vec2> = param2.§!"%§;
         var _loc9_:int = param5.§4k§;
         var _loc10_:Vector.<b2Vec2> = param5.§5P§;
         ...
         _loc20_.id.§1S§.§-N§ = param4;
         _loc20_.id.§1S§.§"!B§ = _loc21_;
         _loc20_.id.§1S§.§<r§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§1S§.§-N§ = param4;
         _loc20_.id.§1S§.§"!B§ = _loc22_;
         _loc20_.id.§1S§.§<r§ = 1;
      }
      
      private static function §`!6§() : Vector.<§""#§>
      {
      ...
      public static function §^@§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc10_:int = 0;
         §3!x§[0] = _loc10_;
         var _loc11_:Number = §'",§(§3!x§,param4,param5,param2,param3);
         _loc10_ = §3!x§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§5"6§ = b2Manifold.§ 2§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§""#§> = §`a§;
         §implements§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§4k§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§5P§)[_loc16_];
         ...
         if((_loc39_ = §5=§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §5=§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
      ...
      public static function §8"0§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§5"6§ = b2Manifold.§2!1§;
         param1.m_localPoint.SetV(param2.§5",§);
         param1.§%"5§.§3S§();
         param1.§^"§ = 1;
         param1.§>!&§[0].m_localPoint.SetV(param4.§5",§);
         param1.§>!&§[0].m_id.key = 0;
      }
      
      public static function §7x§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§4k§;
         var _loc22_:Vector.<b2Vec2> = param2.§5P§;
      ...
      {
         var _loc3_:b2Vec2 = param2.§use§;
         var _loc4_:b2Vec2 = param1.§6&§;
