package §7!F§
{
   public class b2Settings
   {
      ...
      public static const §8W§:Number = 0.005;
      
      public static const §5!J§:Number = 0.007;
      
      public static var b2_linearSlop:Number = §0!?§;
      
      public static const §7L§:Number = b2_linearSlop - §8W§;
      ...
      public static const §6b§:Number = 0.1;
      
      public static var b2_linearSleepTolerance:Number = §``§;
