package §"s§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§+f§.x * this.§!!v§.x + (this.§>h§ + this.§+f§.y) * this.§3o§.x),param1 * (this.§+f§.x * this.§!!v§.y + (this.§>h§ + this.§+f§.y) * this.§3o§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§;S§ = this.§;S§ > Number.MIN_VALUE ? Number(1 / this.§;S§) : Number(0);
         ...
         this.§]!Y§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§]!Y§.col2.x = this.§]!Y§.col1.y;
         this.§]!Y§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§1J§)
         {
         ...
         if(param1.§8"4§)
         {
            ...
            this.§+f§.y *= param1.§1!+§;
            this.§>h§ *= param1.§1!+§;
            _loc19_ = this.§+f§.x * this.§!!v§.x + (this.§>h§ + this.§+f§.y) * this.§3o§.x;
            _loc20_ = this.§+f§.x * this.§!!v§.y + (this.§>h§ + this.§+f§.y) * this.§3o§.y;
            _loc21_ = this.§+f§.x * this.m_s1 + (this.§>h§ + this.§+f§.y) * this.m_a1;
            _loc22_ = this.§+f§.x * this.m_s2 + (this.§>h§ + this.§+f§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§3o§.x * (_loc6_.x - _loc4_.x) + this.§3o§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§;S§ * (this.§0Y§ - _loc13_);
            _loc15_ = this.§>h§;
            _loc16_ = param1.§>!W§ * this.§3!8§;
            this.§>h§ = b2Math.§1!s§(this.§>h§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§>h§ - _loc15_) * this.§3o§.x;
            _loc9_ = _loc14_ * this.§3o§.y;
         ...
         {
            _loc17_ = this.§3o§.x * (_loc6_.x - _loc4_.x) + this.§3o§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§+f§.Copy();
            _loc19_ = this.§]!Y§.§;%§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§+f§.§6f§(_loc19_);
            if(this.§6!s§ == b2internal::,!?)
            {
               this.§+f§.y = b2Math.§5I§(this.§+f§.y,0);
            }
            else if(this.§6!s§ == b2internal::&!d)
            {
               this.§+f§.y = b2Math.§0"8§(this.§+f§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§+f§.y - _loc18_.y) * this.§]!Y§.col2.x;
            if(this.§]!Y§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§]!Y§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§+f§.x = _loc21_;
            _loc19_.x = this.§+f§.x - _loc18_.x;
            _loc19_.y = this.§+f§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§!!v§.x + _loc19_.y * this.§3o§.x;
            _loc9_ = _loc19_.x * this.§!!v§.y + _loc19_.y * this.§3o§.y;
         ...
         else
         {
            ...
            this.§+f§.x += _loc22_;
            _loc8_ = _loc22_ * this.§!!v§.x;
            _loc9_ = _loc22_ * this.§!!v§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§1J§)
         {
            ...
            _loc34_ = this.§3o§.x * _loc26_ + this.§3o§.y * _loc27_;
            if(b2Math.§-L§(this.§%!5§ - this.§[B§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§1!s§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§-L§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§[B§)
            {
               _loc19_ = b2Math.§1!s§(_loc34_ - this.§[B§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§[B§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§%!5§)
            {
               _loc19_ = b2Math.§1!s§(_loc34_ - this.§%!5§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§%!5§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§]!Y§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§]!Y§.col2.x = this.§]!Y§.col1.y;
            this.§]!Y§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§]!Y§.§;%§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::1!-;
         ...
         var _loc30_:Number = _loc28_.x * this.§!!v§.x + _loc28_.y * this.§3o§.x;
         var _loc31_:Number = _loc28_.x * this.§!!v§.y + _loc28_.y * this.§3o§.y;
