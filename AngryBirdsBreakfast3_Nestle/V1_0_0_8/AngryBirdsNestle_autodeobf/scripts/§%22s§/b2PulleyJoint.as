package §"s§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §0S§:Number = 2;
       
      
      private var §4S§:b2Body;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§4S§ = b2internal::;l.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§+'§.x - this.§4S§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§+'§.y - this.§4S§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§ !]§.x - this.§4S§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§ !]§.y - this.§4S§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§#J§);
         this.m_localAnchor2.SetV(param1.§7!A§);
         this.§!w§ = param1.§3!@§;
         this.§,"§ = param1.§<!B§ + this.§!w§ * param1.§7!u§;
         this.m_maxLength1 = b2Math.§0"8§(param1.§5x§,this.§,"§ - this.§!w§ * b2internal::0S);
         this.m_maxLength2 = b2Math.§0"8§(param1.§,!f§,(this.§,"§ - b2internal::0S) / this.§!w§);
         this.§+f§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§+f§ * this.m_u2.x,param1 * this.§+f§ * this.m_u2.y);
      }
      ...
      public function §9!s§() : b2Vec2
      {
         var _loc1_:b2Vec2 = this.§4S§.m_xf.position.Copy();
         _loc1_.§6f§(this.m_groundAnchor1);
         return _loc1_;
      }
      ...
      {
         var _loc1_:b2Vec2 = this.§4S§.m_xf.position.Copy();
         _loc1_.§6f§(this.m_groundAnchor2);
         return _loc1_;
      }
      
      public function GetLength1() : Number
      {
         var _loc1_:b2Vec2 = b2internal::;l.GetWorldPoint(this.m_localAnchor1);
         var _loc2_:Number = this.§4S§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.§4S§.m_xf.position.y + this.m_groundAnchor1.y;
      ...
      {
         var _loc1_:b2Vec2 = b2internal::2z.GetWorldPoint(this.m_localAnchor2);
         var _loc2_:Number = this.§4S§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.§4S§.m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc14_:Number = this.§4S§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.§4S§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.§4S§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.§4S§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§,"§ - _loc18_ - this.§!w§ * _loc19_) > 0)
         {
            this.§1e§ = b2internal::4!0;
            this.§+f§ = 0;
         }
         else
         {
            this.§1e§ = b2internal::&!d;
         }
         if(_loc18_ < this.m_maxLength1)
         {
            this.m_limitState1 = b2internal::4!0;
            this.m_limitImpulse1 = 0;
         }
         else
         {
            this.m_limitState1 = b2internal::&!d;
         }
         if(_loc19_ < this.m_maxLength2)
         {
            this.m_limitState2 = b2internal::4!0;
            this.m_limitImpulse2 = 0;
         }
         else
         {
            this.m_limitState2 = b2internal::&!d;
         }
         var _loc21_:Number = _loc5_ * this.m_u1.y - _loc6_ * this.m_u1.x;
         var _loc22_:Number = _loc8_ * this.m_u2.y - _loc9_ * this.m_u2.x;
         this.m_limitMass1 = _loc2_.§]p§ + _loc2_.§;!$§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§]p§ + _loc3_.§;!$§ * _loc22_ * _loc22_;
         this.§?O§ = this.m_limitMass1 + this.§!w§ * this.§!w§ * this.m_limitMass2;
         ...
         {
            this.§+f§ *= param1.§1!+§;
            this.m_limitImpulse1 *= param1.§1!+§;
            this.m_limitImpulse2 *= param1.§1!+§;
            _loc23_ = (-this.§+f§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§+f§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§!w§ * this.§+f§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§!w§ * this.§+f§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§;B§.x += _loc2_.§]p§ * _loc23_;
            _loc2_.§;B§.y += _loc2_.§]p§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§;!$§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§;B§.x += _loc3_.§]p§ * _loc25_;
            _loc3_.§;B§.y += _loc3_.§]p§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = _loc4_.col1.y * _loc8_ + _loc4_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         if(this.§1e§ == b2internal::&!d)
         {
            _loc10_ = _loc2_.§;B§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§;B§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§;B§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§;B§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§!w§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§?O§ * -_loc18_;
            _loc20_ = this.§+f§;
            this.§+f§ = b2Math.§5I§(0,this.§+f§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§+f§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§!w§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§!w§ * _loc19_ * this.m_u2.y;
            _loc2_.§;B§.x += _loc2_.§]p§ * _loc14_;
            _loc2_.§;B§.y += _loc2_.§]p§ * _loc15_;
         ...
         if(this.m_limitState1 == b2internal::&!d)
         {
            _loc10_ = _loc2_.§;B§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§;B§.y + _loc2_.m_angularVelocity * _loc5_;
            ...
            this.m_limitImpulse1 = b2Math.§5I§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == b2internal::&!d)
         {
            _loc12_ = _loc3_.§;B§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§;B§.y + _loc3_.m_angularVelocity * _loc8_;
            ...
            this.m_limitImpulse2 = b2Math.§5I§(0,this.m_limitImpulse2 + _loc19_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal::;l;
         var _loc3_:b2Body = b2internal::2z;
         var _loc5_:Number = this.§4S§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.§4S§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.§4S§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.§4S§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         if(this.§1e§ == b2internal::&!d)
         {
            ...
            _loc24_ = b2Math.§5I§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§1!s§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
