package §%f§
{
   public class §2!'§
   {
      ...
      public static function §?!i§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         jsonString = §'K§(luaString,emptyObjectAsArray);
         try
         {
      ...
      public static function §5!&§(param1:String, param2:Boolean = false) : Object
      {
         var returnObject:Object = null;
      ...
      public static function §'K§(param1:String, param2:Boolean = false) : String
      {
         ...
         return §5!o§(param1,param2);
      }
      
      private static function §5!o§(param1:String, param2:Boolean) : String
      {
