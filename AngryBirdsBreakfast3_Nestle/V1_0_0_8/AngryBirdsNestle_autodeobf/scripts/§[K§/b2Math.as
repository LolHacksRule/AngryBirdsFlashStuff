package §[K§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§^!q§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §?!F§(param1:Number) : Boolean
      {
      ...
      public static function §1F§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1.col1.x * param2.x + param1.col2.x * param2.y,param1.col1.y * param2.x + param1.col2.y * param2.y);
      }
      
      public static function §8E§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §2_§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         var _loc3_:Number = param1.x - param2.x;
         var _loc4_:Number = param1.y - param2.y;
      ...
      {
         return b2Mat22.§^!q§(§'C§(param1.col1,param2.col1),§'C§(param1.col2,param2.col2));
      }
      
      public static function §[p§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§^!q§(§1F§(param1,param2.col1),§1F§(param1,param2.col2));
      }
      ...
      {
         return new b2Vec2(§-L§(param1.x),§-L§(param1.y));
      }
      
      public static function §&!A§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§^!q§(§@!@§(param1.col1),§@!@§(param1.col2));
      }
      
      public static function §0"8§(param1:Number, param2:Number) : Number
      {
      ...
      {
         return new b2Vec2(§0"8§(param1.x,param2.x),§0"8§(param1.y,param2.y));
      }
      
      public static function §5I§(param1:Number, param2:Number) : Number
      {
         return param1 > param2 ? Number(param1) : Number(param2);
      }
      ...
      {
         return new b2Vec2(§5I§(param1.x,param2.x),§5I§(param1.y,param2.y));
      }
      
      public static function §1!s§(param1:Number, param2:Number, param3:Number) : Number
      {
         return param1 < param2 ? Number(param2) : (param1 > param3 ? Number(param3) : Number(param1));
      }
      
      public static function §null §(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §#!i§(param2,§@Y§(param1,param3));
      }
      
      public static function §]!W§(param1:Array, param2:Array) : void
      {
         var _loc3_:* = param1[0];
         param1[0] = param2[0];
         param2[0] = _loc3_;
      ...
      public static function §true§(param1:Number, param2:Number) : Number
      {
         var _loc3_:Number = Math.random();
         return Number((param2 - param1) * _loc3_ + param1);
      }
      
      public static function §^b§(param1:uint) : uint
      {
