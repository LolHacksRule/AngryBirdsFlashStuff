package §-![§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private var §7!Y§:Vector.<DisplayObject>;
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§7!Y§ = new Vector.<DisplayObject>(0);
      }
      
      override public function dispose() : void
      {
         var _loc1_:int = this.§7!Y§.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            this.§7!Y§[_loc2_].dispose();
            _loc2_++;
         }
         super.dispose();
      }
      ...
      {
         var _loc2_:int = this.§7!Y§.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            if(param1.z < this.§7!Y§[_loc3_].z)
            {
      ...
      public function addChildAt(param1:DisplayObject, param2:int) : void
      {
         ...
         {
            param1.§!Y§();
            this.§7!Y§.splice(param2,0,param1);
            param1.§'!O§(this);
            return;
         }
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§7!Y§[param1];
            _loc3_.§'!O§(null);
            this.§7!Y§.splice(param1,1);
            if(param2)
            {
               _loc3_.dispose();
            }
      ...
      public function §&J§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      public function getChildByName(param1:String) : DisplayObject
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(this.§7!Y§[_loc3_].name == param1)
            {
               return this.§7!Y§[_loc3_];
            }
            _loc3_++;
         }
         return null;
      ...
      {
         return this.§7!Y§.indexOf(param1);
      }
      ...
      public function §<L§(param1:DisplayObject, param2:DisplayObject) : void
      {
         var _loc3_:int = this.getChildIndex(param1);
      ...
      public function § !m§(param1:int, param2:int) : void
      {
         var _loc3_:DisplayObject = this.getChildAt(param1);
         var _loc4_:DisplayObject = this.getChildAt(param2);
         this.§7!Y§[param1] = _loc4_;
         this.§7!Y§[param2] = _loc3_;
      }
      
      public function §9!b§(param1:Function) : void
      {
         this.§7!Y§ = this.§7!Y§.sort(param1);
      }
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§7!Y§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§7!Y§.length;
         if(_loc3_ == 0)
         {
            §,!^§(param1,§%0§);
            transformCoords(§%0§,0,0,§"V§);
            param2.x = §"V§.x;
            param2.y = §"V§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§7!Y§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§7!Y§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§7!Y§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§7!Y§[_loc6_];
            §,!^§(_loc7_,§%0§);
            transformCoords(§%0§,_loc3_,_loc4_,§"V§);
            if(_loc8_ = _loc7_.hitTest(§"V§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§]q§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§7!Y§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§8!C§();
               param1.§ for§(_loc5_);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§1!!§(this,param1.type,_loc2_);
      ...
      private function §1!!§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§7!Y§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
               this.§1!!§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
