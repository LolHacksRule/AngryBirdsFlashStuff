package §&!;§
{
   ...
   public class Texture
   {
      ...
      public static function §"!&§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §&!;§.Texture
      {
         ...
         _loc10_ = new §3!E§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§+8§.§`8§)
         {
            _loc10_.§+G§(param2);
         }
      ...
      public static function §9!J§(param1:Context3D, param2:ByteArray) : §&!;§.Texture
      {
         if(param1 == null)
         {
            throw new §9"&§();
         ...
         var _loc9_:§3!E§ = new §3!E§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§+8§.§`8§)
         {
            _loc9_.§+G§(param2);
         }
      ...
      public static function §]6§(param1:§&!;§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §&!;§.Texture
      {
         var _loc4_:§&!;§.Texture;
         (_loc4_ = new §<x§(param1,param2)).§^K§ = param3;
         return _loc4_;
      }
      
      public static function §#2§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §&!;§.Texture
      {
      ...
      public function adjustVertexData(param1:§&s§, param2:int, param3:int) : void
      {
         ...
         if(this.§^K§)
         {
            ...
            _loc4_ = this.§^K§.width + this.§^K§.x - this.width;
            _loc5_ = this.§^K§.height + this.§^K§.y - this.height;
            param1.§>y§(param2,-this.§^K§.x,-this.§^K§.y);
            param1.§>y§(param2 + 1,-_loc4_,-this.§^K§.y);
            param1.§>y§(param2 + 2,-this.§^K§.x,-_loc5_);
            param1.§>y§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      
      public function get § B§() : Rectangle
      {
         return !!this.§^K§ ? this.§^K§.clone() : new Rectangle(0,0,this.width,this.height);
      }
