package §[e§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §2!G§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §=!V§:b2Vec2;
      
      b2internal var §5P§:Vector.<b2Vec2>;
      
      b2internal var §!"%§:Vector.<b2Vec2>;
      
      b2internal var §4k§:int;
      ...
      public function b2PolygonShape()
      {
         ...
         §5"6§ = b2internal::+"0;
         this.§=!V§ = new b2Vec2();
         this.§5P§ = new Vector.<b2Vec2>();
         this.§!"%§ = new Vector.<b2Vec2>();
         §-!D§ = b2Settings.b2_polygonRadius;
         this.§=!V§.§3S§();
      }
      
      public static function §2"8§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function §-G§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §3!M§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §%1§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         ...
         (_loc5_ = new b2PolygonShape()).§6!M§(param1,param2,param3,param4);
         return _loc5_;
      }
      ...
      public static function §]!B§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§6f§(new b2Vec2(0,0));
            _loc3_.§6f§(_loc9_);
            _loc3_.§6f§(_loc10_);
            _loc3_.§6w§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §?!3§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§=!V§.SetV(_loc2_.§=!V§);
            this.§4k§ = _loc2_.§4k§;
            this.§^!V§(this.§4k§);
            _loc3_ = 0;
            while(_loc3_ < this.§4k§)
            {
               this.§5P§[_loc3_].SetV(_loc2_.§5P§[_loc3_]);
      ...
      public function §4!N§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function §&§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§4k§)
         {
            this.§5P§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§4k§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§4k§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§,@§(this.§5P§[_loc5_],this.§5P§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§0N§() > Number.MIN_VALUE);
            this.§!"%§[_loc3_].SetV(b2Math.§<"7§(_loc6_,1));
            this.§!"%§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§=!V§ = §]!B§(this.§5P§,this.§4k§);
      }
      ...
      public function §5!@§(param1:Number, param2:Number) : void
      {
         this.§4k§ = 4;
         this.§^!V§(4);
         this.§5P§[0].Set(-param1,-param2);
         this.§5P§[1].Set(param1,-param2);
         this.§5P§[2].Set(param1,param2);
         this.§5P§[3].Set(-param1,param2);
         this.§!"%§[0].Set(0,-1);
         this.§!"%§[1].Set(1,0);
         this.§!"%§[2].Set(0,1);
         this.§!"%§[3].Set(-1,0);
      ...
      public function §6!M§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§4k§ = 4;
         this.§^!V§(4);
         this.§5P§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§4k§)
         {
            this.§5P§[_loc6_] = b2Math.§"+§(_loc5_,this.§5P§[_loc6_]);
            this.§!"%§[_loc6_] = b2Math.§1F§(_loc5_.R,this.§!"%§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §=L§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§4k§ = 2;
         this.§^!V§(2);
         this.§5P§[0].SetV(param1);
         this.§5P§[1].SetV(param2);
         this.§=!V§.x = 0.5 * (param1.x + param2.x);
         this.§=!V§.y = 0.5 * (param1.y + param2.y);
         this.§!"%§[0] = b2Math.§<"7§(b2Math.§,@§(param2,param1),1);
         this.§!"%§[0].Normalize();
         this.§!"%§[1].x = -this.§!"%§[0].x;
         this.§!"%§[1].y = -this.§!"%§[0].y;
      }
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < this.§4k§)
         {
            _loc3_ = this.§5P§[_loc9_];
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§4k§)
         {
            _loc6_ = (_loc9_ = this.§5P§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§use§.x = _loc5_ - b2internal::-!D;
         param1.§use§.y = _loc6_ - b2internal::-!D;
         param1.§6&§.x = _loc7_ + b2internal::-!D;
         param1.§6&§.y = _loc8_ + b2internal::-!D;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§4k§ == 2)
         {
            param1.center.x = 0.5 * (this.§5P§[0].x + this.§5P§[1].x);
            param1.center.y = 0.5 * (this.§5P§[0].y + this.§5P§[1].y);
            param1.§6!_§ = 0;
            param1.I = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§4k§)
         {
            _loc11_ = this.§5P§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§4k§ ? this.§5P§[int(_loc10_ + 1)] : this.§5P§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§8E§(param3.R,param1);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§4k§)
         {
            _loc7_[_loc12_] = b2Math.§["!§(_loc5_,this.§5P§[_loc12_]) - _loc6_;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§4k§;
         var _loc14_:int = (_loc10_ + 1) % this.§4k§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§5P§[_loc9_].x * (1 - _loc15_) + this.§5P§[_loc13_].x * _loc15_,this.§5P§[_loc9_].y * (1 - _loc15_) + this.§5P§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§5P§[_loc10_].x * (1 - _loc16_) + this.§5P§[_loc14_].x * _loc16_,this.§5P§[_loc10_].y * (1 - _loc16_) + this.§5P§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§5P§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§4k§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§5P§[_loc12_];
            }
      ...
      {
         var _loc2_:int = this.§5P§.length;
         while(_loc2_ < param1)
         {
            this.§5P§[_loc2_] = new b2Vec2();
