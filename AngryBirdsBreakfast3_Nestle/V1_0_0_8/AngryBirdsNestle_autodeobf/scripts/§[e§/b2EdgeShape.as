package §[e§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      b2internal var §0!k§:b2EdgeShape;
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§?"§ = this.§&!5§.Normalize();
         this.§3b§.Set(this.§&!5§.y,-this.§&!5§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§3b§.x - this.§&!5§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§3b§.y - this.§&!5§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§3b§.x + this.§&!5§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§3b§.y + this.§&!5§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§3b§;
         this.m_cornerDir2.Set(-this.§3b§.x,-this.§3b§.y);
      }
      ...
      public function §?b§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §&!Q§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
