package §5u§
{
   ...
   public interface §;!o§ extends IEventDispatcher
   {
      ...
      function set §1!D§(param1:Rectangle) : void;
      
      function get §1!D§() : Rectangle;
      ...
      function openPopup(param1:§ z§, param2:Boolean = false) : void;
