package §@h§
{
   public class b2Settings
   {
      ...
      public static const §>"0§:Number = 0.005;
      
      public static const §?1§:Number = 0.007;
      
      public static var b2_linearSlop:Number = §;"%§;
      
      public static const §^q§:Number = b2_linearSlop - §>"0§;
      ...
      public static const §1L§:Number = 0.1;
      
      public static const §'![§:Number = 0.01;
      
      public static const §;!F§:Number = 0.1;
      
      public static var b2_linearSleepTolerance:Number = §1L§;
