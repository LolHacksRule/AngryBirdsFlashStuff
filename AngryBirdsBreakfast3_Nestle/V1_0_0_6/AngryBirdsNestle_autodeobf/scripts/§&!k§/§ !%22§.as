package §&!k§
{
   ...
   public class § !"§
   {
      ...
      private function §+"3§(param1:*) : String
      {
         ...
         if(param1 is Array)
         {
            return this.§%"2§(param1 as Array);
         }
         if(param1 is Object && param1 != null)
         {
            return this.§4!L§(param1);
         }
         return "null";
      }
      ...
      private function §%"2§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§+"3§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §4!L§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§;"&§(v.@name.toString()) + ":" + this.§+"3§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
