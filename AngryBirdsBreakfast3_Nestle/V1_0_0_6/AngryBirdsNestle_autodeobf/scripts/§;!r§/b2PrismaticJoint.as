package §;!r§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§[!9§.x * this.§1o§.x + (this.§ !L§ + this.§[!9§.z) * this.§=!g§.x),param1 * (this.§[!9§.x * this.§1o§.y + (this.§ !L§ + this.§[!9§.z) * this.§=!g§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§[!e§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§[!e§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§[!e§.col2.x = this.§[!e§.col1.y;
         if(_loc16_ + _loc17_ != 0)
         {
            this.§[!e§.col2.y = _loc16_ + _loc17_;
         }
         else
         {
            this.§[!e§.col2.y = 1;
         }
         this.§[!e§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§[!e§.col3.x = this.§[!e§.col1.z;
         this.§[!e§.col3.y = this.§[!e§.col2.z;
         this.§[!e§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§[!C§)
         {
         ...
         if(param1.§-F§)
         {
            ...
            this.§[!9§.y *= param1.§;!y§;
            this.§ !L§ *= param1.§;!y§;
            _loc19_ = this.§[!9§.x * this.§1o§.x + (this.§ !L§ + this.§[!9§.z) * this.§=!g§.x;
            _loc20_ = this.§[!9§.x * this.§1o§.y + (this.§ !L§ + this.§[!9§.z) * this.§=!g§.y;
            _loc21_ = this.§[!9§.x * this.m_s1 + this.§[!9§.y + (this.§ !L§ + this.§[!9§.z) * this.m_a1;
            _loc22_ = this.§[!9§.x * this.m_s2 + this.§[!9§.y + (this.§ !L§ + this.§[!9§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§]n§ && this.§1!E§ != b2internal::;c)
         {
            ...
            _loc15_ = this.§'"1§ * (this.§6r§ - _loc14_);
            _loc16_ = this.§ !L§;
            _loc17_ = param1.§]>§ * this.§4!;§;
            this.§ !L§ = b2Math.§;p§(this.§ !L§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§ !L§ - _loc16_) * this.§=!g§.x;
         ...
         if(this.§[!C§ && this.§1!E§ != b2internal::-!n)
         {
            ...
            _loc19_ = this.§[!9§.Copy();
            _loc20_ = this.§[!e§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§[!9§.§!"§(_loc20_);
            if(this.§1!E§ == b2internal::^1)
            {
               this.§[!9§.z = b2Math.§"!;§(this.§[!9§.z,0);
            }
            else if(this.§1!E§ == b2internal::<!s)
            {
               this.§[!9§.z = b2Math.§4!T§(this.§[!9§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§[!9§.z - _loc19_.z) * this.§[!e§.col3.x;
            _loc22_ = -_loc13_ - (this.§[!9§.z - _loc19_.z) * this.§[!e§.col3.y;
            _loc23_ = this.§[!e§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§[!9§.x = _loc23_.x;
            this.§[!9§.y = _loc23_.y;
            ...
            _loc8_ = _loc20_.x * this.§1o§.x + _loc20_.z * this.§=!g§.x;
            _loc9_ = _loc20_.x * this.§1o§.y + _loc20_.z * this.§=!g§.y;
         ...
         {
            _loc24_ = this.§[!e§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§[!9§.x += _loc24_.x;
            this.§[!9§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§1o§.x;
            _loc9_ = _loc24_.x * this.§1o§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§[!C§)
         {
            ...
            {
               _loc19_ = b2Math.§;p§(_loc35_ - this.§&!G§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§&!G§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§=z§)
            {
               _loc19_ = b2Math.§;p§(_loc35_ - this.§=z§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§=z§;
               _loc18_ = true;
            }
         }
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§3! §;
         ...
         if(_loc18_)
         {
            ...
            this.§[!e§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§[!e§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§[!e§.col2.x = this.§[!e§.col1.y;
            if(_loc14_ + _loc15_ != 0)
            {
               this.§[!e§.col2.y = _loc14_ + _loc15_;
            }
            else
            {
               this.§[!e§.col2.y = 1;
            }
            this.§[!e§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§[!e§.col3.x = this.§[!e§.col1.z;
            this.§[!e§.col3.y = this.§[!e§.col2.z;
            this.§[!e§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§[!e§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::,b;
            ...
            this.§[!e§.col1.Set(_loc36_,_loc37_,0);
            this.§[!e§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§[!e§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§1o§.x + _loc28_.z * this.§=!g§.x;
         var _loc32_:Number = _loc28_.x * this.§1o§.y + _loc28_.z * this.§=!g§.y;
