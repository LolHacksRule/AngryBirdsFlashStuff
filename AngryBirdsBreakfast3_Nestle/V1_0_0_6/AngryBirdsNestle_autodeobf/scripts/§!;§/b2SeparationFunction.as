package §!;§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §"!o§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§0"§ = §?""§;
            _loc7_ = this.§&!&§.§3!s§(param1.indexA[0]);
            _loc10_ = this.§@!N§.§3!s§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§=!g§.x = _loc15_ - _loc13_;
            this.§=!g§.y = _loc16_ - _loc14_;
            this.§=!g§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§0"§ = §-O§;
            _loc8_ = this.§&!&§.§3!s§(param1.indexA[0]);
            _loc9_ = this.§&!&§.§3!s§(param1.indexA[1]);
            _loc10_ = this.§@!N§.§3!s§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§=!g§ = b2Math.§9v§(b2Math.§[I§(_loc9_,_loc8_),1);
            this.§=!g§.Normalize();
            _loc20_ = this.§=!g§;
         ...
         {
            this.§0"§ = §"8§;
            _loc11_ = this.§@!N§.§3!s§(param1.indexB[0]);
            _loc12_ = this.§@!N§.§3!s§(param1.indexB[1]);
            _loc7_ = this.§&!&§.§3!s§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§=!g§ = b2Math.§9v§(b2Math.§[I§(_loc12_,_loc11_),1);
            this.§=!g§.Normalize();
            _loc20_ = this.§=!g§;
         ...
         else
         {
            ...
            _loc11_ = this.§@!N§.§3!s§(param1.indexB[0]);
            _loc12_ = this.§@!N§.§3!s§(param1.indexB[1]);
            _loc23_ = b2Math.§6!D§(param3,_loc7_);
            _loc24_ = b2Math.§+n§(param3.R,b2Math.§[I§(_loc9_,_loc8_));
            _loc25_ = b2Math.§6!D§(param5,_loc10_);
            _loc26_ = b2Math.§+n§(param5.R,b2Math.§[I§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§[I§(_loc26_,_loc24_);
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §?""§:
               _loc3_ = b2Math.§?!@§(param1.R,this.§=!g§);
               _loc4_ = b2Math.§?!@§(param2.R,this.§=!g§.§#"!§());
               _loc5_ = this.§&!&§.§<2§(_loc3_);
               _loc6_ = this.§@!N§.§<2§(_loc4_);
               _loc7_ = b2Math.§6!D§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§6!D§(param2,_loc6_)).x - _loc7_.x) * this.§=!g§.x + (_loc8_.y - _loc7_.y) * this.§=!g§.y);
            case §-O§:
               _loc10_ = b2Math.§+n§(param1.R,this.§=!g§);
               _loc7_ = b2Math.§6!D§(param1,this.m_localPoint);
               _loc4_ = b2Math.§?!@§(param2.R,_loc10_.§#"!§());
               _loc6_ = this.§@!N§.§<2§(_loc4_);
               return Number(((_loc8_ = b2Math.§6!D§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §"8§:
               _loc10_ = b2Math.§+n§(param2.R,this.§=!g§);
               _loc8_ = b2Math.§6!D§(param2,this.m_localPoint);
               _loc3_ = b2Math.§?!@§(param1.R,_loc10_.§#"!§());
               _loc5_ = this.§&!&§.§<2§(_loc3_);
               return Number(((_loc7_ = b2Math.§6!D§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
