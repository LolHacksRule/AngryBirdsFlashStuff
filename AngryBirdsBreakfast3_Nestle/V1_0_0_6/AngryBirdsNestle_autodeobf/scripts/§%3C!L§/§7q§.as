package §<!L§
{
   ...
   public class §7q§
   {
      ...
      public static function §0!3§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §,!D§(_loc2_);
         return §[!z§.§7N§(_loc3_.readInt(),true) + §[!z§.§7N§(_loc3_.readInt(),true) + §[!z§.§7N§(_loc3_.readInt(),true) + §[!z§.§7N§(_loc3_.readInt(),true) + §[!z§.§7N§(_loc3_.readInt(),true);
      }
      
      public static function §8!j§(param1:ByteArray) : String
      {
         var _loc2_:Array = §7q§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §,!D§(_loc2_);
         return §[!z§.§7N§(_loc3_.readInt(),true) + §[!z§.§7N§(_loc3_.readInt(),true) + §[!z§.§7N§(_loc3_.readInt(),true) + §[!z§.§7N§(_loc3_.readInt(),true) + §[!z§.§7N§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc6_:uint = 0;
         var _loc2_:Array = §7q§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §,!D§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §,!D§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
