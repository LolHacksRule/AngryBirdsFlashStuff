package §5t§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §[!M§:b2PositionSolverManifold = new b2PositionSolverManifold();
      ...
      public function §"!o§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            b2Settings.b2Assert(_loc17_.§8!S§ > 0);
            §-L§.§"!o§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §-L§.§<",§.x;
            _loc27_ = §-L§.§<",§.y;
            ...
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§'!p§)
            {
               _loc30_ = _loc17_.§&"#§[_loc29_];
               (_loc31_ = _loc28_.§2!O§[_loc29_]).normalImpulse = _loc30_.§#3§;
               _loc31_.tangentImpulse = _loc30_.§ !v§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§6y§.x = §-L§.§&"#§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§6y§.y = §-L§.§&"#§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§4d§.x = §-L§.§&"#§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§4d§.y = §-L§.§&"#§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               if((_loc38_ = _loc15_.§3!o§ + _loc16_.§3!o§ + _loc15_.§%!^§ * _loc36_ + _loc16_.§%!^§ * _loc37_) > 0)
               {
                  _loc31_.§=!s§ = 1 / _loc38_;
               }
               else
               ...
               _loc39_ = (_loc39_ = _loc15_.§-X§ * _loc15_.§3!o§ + _loc16_.§-X§ * _loc16_.§3!o§) + (_loc15_.§-X§ * _loc15_.§%!^§ * _loc36_ + _loc16_.§-X§ * _loc16_.§%!^§ * _loc37_);
               _loc31_.§=]§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               if((_loc44_ = _loc15_.§3!o§ + _loc16_.§3!o§ + _loc15_.§%!^§ * _loc42_ + _loc16_.§%!^§ * _loc43_) > 0)
               {
                  _loc31_.§ !K§ = 1 / _loc44_;
               }
               else
               ...
               {
                  _loc31_.§6!m§ = -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§'!p§ == 2)
            {
               _loc48_ = _loc28_.§2!O§[0];
               _loc49_ = _loc28_.§2!O§[1];
               _loc50_ = _loc15_.§3!o§;
               _loc51_ = _loc15_.§%!^§;
               _loc52_ = _loc16_.§3!o§;
               _loc53_ = _loc16_.§%!^§;
               _loc54_ = _loc48_.§6y§.x * _loc27_ - _loc48_.§6y§.y * _loc26_;
               _loc55_ = _loc48_.§4d§.x * _loc27_ - _loc48_.§4d§.y * _loc26_;
               _loc56_ = _loc49_.§6y§.x * _loc27_ - _loc49_.§6y§.y * _loc26_;
               _loc57_ = _loc49_.§4d§.x * _loc27_ - _loc49_.§4d§.y * _loc26_;
         ...
         while(_loc5_ < this.§3"5§)
         {
            ...
            if(param1.§-F§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§6y§.x * _loc22_ - _loc20_.§6y§.y * _loc21_);
                  _loc7_.§4!"§.x -= _loc9_ * _loc21_;
                  _loc7_.§4!"§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§4d§.x * _loc22_ - _loc20_.§4d§.y * _loc21_);
                  _loc8_.§4!"§.x += _loc11_ * _loc21_;
                  _loc8_.§4!"§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  (_loc23_ = _loc6_.§2!O§[_loc18_]).normalImpulse = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         while(_loc24_ < this.§3"5§)
         {
            ...
            _loc1_ = 0;
            while(_loc1_ < _loc25_.§'!p§)
            {
               _loc2_ = _loc25_.§2!O§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§4d§.y - _loc30_.x + _loc28_ * _loc2_.§6y§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§4d§.x - _loc30_.y - _loc28_ * _loc2_.§6y§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§ !K§ * -_loc10_;
               _loc12_ = _loc40_ * _loc2_.normalImpulse;
               _loc14_ = (_loc11_ = (_loc13_ = b2Math.§;p§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_)) - _loc2_.tangentImpulse) * _loc38_;
               _loc15_ = _loc11_ * _loc39_;
               _loc30_.x -= _loc32_ * _loc14_;
               _loc30_.y -= _loc32_ * _loc15_;
               _loc28_ -= _loc33_ * (_loc2_.§6y§.x * _loc15_ - _loc2_.§6y§.y * _loc14_);
               _loc31_.x += _loc34_ * _loc14_;
               _loc31_.y += _loc34_ * _loc15_;
               _loc29_ += _loc35_ * (_loc2_.§4d§.x * _loc15_ - _loc2_.§4d§.y * _loc14_);
            ...
            if(_loc25_.§'!p§ == 1)
            {
               _loc2_ = _loc25_.§2!O§[0];
               _loc7_ = _loc31_.x + -_loc29_ * _loc2_.§4d§.y - _loc30_.x - -_loc28_ * _loc2_.§6y§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§4d§.x - _loc30_.y - _loc28_ * _loc2_.§6y§.x;
               _loc9_ = _loc7_ * _loc36_ + _loc8_ * _loc37_;
               _loc11_ = -_loc2_.§=!s§ * (_loc9_ - _loc2_.§6!m§);
            ...
            {
               _loc43_ = _loc25_.§2!O§[0];
               _loc44_ = _loc25_.§2!O§[1];
               _loc45_ = _loc43_.normalImpulse;
               _loc46_ = _loc44_.normalImpulse;
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§4d§.y - _loc30_.x + _loc28_ * _loc43_.§6y§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§4d§.x - _loc30_.y - _loc28_ * _loc43_.§6y§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§4d§.y - _loc30_.x + _loc28_ * _loc44_.§6y§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§4d§.x - _loc30_.y - _loc28_ * _loc44_.§6y§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§6!m§;
               _loc54_ = _loc52_ - _loc44_.§6!m§;
               _loc22_ = _loc25_.K;
               _loc53_ -= _loc22_.col1.x * _loc45_ + _loc22_.col2.x * _loc46_;
               _loc54_ -= _loc22_.col1.y * _loc45_ + _loc22_.col2.y * _loc46_;
               _loc55_ = 0.001;
               _loc56_ = -((_loc22_ = _loc25_.§=!s§).col1.x * _loc53_ + _loc22_.col2.x * _loc54_);
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§6y§.x * _loc19_ - _loc43_.§6y§.y * _loc18_ + _loc44_.§6y§.x * _loc21_ - _loc44_.§6y§.y * _loc20_);
                  _loc31_.x += _loc34_ * (_loc18_ + _loc20_);
                  _loc31_.y += _loc34_ * (_loc19_ + _loc21_);
                  _loc29_ += _loc35_ * (_loc43_.§4d§.x * _loc19_ - _loc43_.§4d§.y * _loc18_ + _loc44_.§4d§.x * _loc21_ - _loc44_.§4d§.y * _loc20_);
                  _loc43_.normalImpulse = _loc56_;
                  _loc44_.normalImpulse = _loc57_;
               }
               else
               {
                  _loc56_ = -_loc43_.§=!s§ * _loc53_;
                  _loc57_ = 0;
                  _loc51_ = 0;
      ...
      public function §!!9§() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.§3"5§)
         {
            _loc2_ = this.§=W§[_loc1_];
            _loc3_ = _loc2_.§,Z§;
            _loc4_ = 0;
            while(_loc4_ < _loc2_.§'!p§)
            {
               _loc5_ = _loc3_.§&"#§[_loc4_];
               _loc6_ = _loc2_.§2!O§[_loc4_];
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:Number = 0;
         var _loc3_:int = 0;
         while(_loc3_ < this.§3"5§)
         {
            _loc5_ = (_loc4_ = this.§=W§[_loc3_]).§@!`§;
            _loc6_ = _loc4_.§@$§;
            _loc7_ = _loc5_.§-X§ * _loc5_.§3!o§;
            _loc8_ = _loc5_.§-X§ * _loc5_.§%!^§;
            _loc9_ = _loc6_.§-X§ * _loc6_.§3!o§;
            _loc10_ = _loc6_.§-X§ * _loc6_.§%!^§;
            §[!M§.§"!o§(_loc4_);
            _loc11_ = §[!M§.§<",§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§'!p§)
            {
               _loc13_ = _loc4_.§2!O§[_loc12_];
               _loc14_ = §[!M§.§&"#§[_loc12_];
               _loc15_ = §[!M§.§3y§[_loc12_];
               ...
               _loc20_ = b2Math.§;p§(param1 * (_loc15_ + b2Settings.b2_linearSlop),-b2Settings.b2_maxLinearCorrection,0);
