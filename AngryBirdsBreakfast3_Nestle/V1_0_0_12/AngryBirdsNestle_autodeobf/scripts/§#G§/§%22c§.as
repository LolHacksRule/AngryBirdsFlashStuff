package §#G§
{
   ...
   public class §"c§
   {
      ...
      {
         super();
         this.jsonString = this.§82§(param1);
      }
      ...
      private function §82§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§8k§(param1 as String);
         }
         if(param1 is Number)
         {
      ...
      private function §8k§(param1:String) : String
      {
      ...
      private function §,4§(param1:Array) : String
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§82§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §3o§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§8k§(v.@name.toString()) + ":" + this.§82§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
