package §7!&§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §2v§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         var _loc4_:Number = NaN;
         var _loc5_:Number = NaN;
      ...
      public function §4"0§(param1:b2DynamicTreeNode) : b2AABB
      {
         return param1.aabb;
      }
      ...
      public function §;!m§(param1:Function, param2:b2AABB) : void
      {
         ...
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§ "0§(param2))
            {
               if(_loc5_.§7!]§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc5_:b2Vec2;
         (_loc5_ = b2Math.§?7§(_loc3_,_loc4_)).Normalize();
         var _loc6_:b2Vec2 = b2Math.§<_§(1,_loc5_);
         ...
         _loc9_.§5!'§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§5!'§.y = Math.max(_loc3_.y,_loc11_);
         ...
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§ "0§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§ !h§();
               _loc16_ = _loc14_.aabb.§1;§();
      ...
      private function §7!o§() : b2DynamicTreeNode
      {
      ...
      private function §7"+§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_.§7!]§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§6!§.x + _loc6_.aabb.§5!'§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§6!§.y + _loc6_.aabb.§5!'§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§6!§.x + _loc7_.aabb.§5!'§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§6!§.y + _loc7_.aabb.§5!'§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         (_loc5_ = this.§7!o§()).parent = _loc4_;
         _loc5_.userData = null;
         _loc5_.aabb.§8C§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            {
               _loc4_.aabb.§8C§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
      ...
      private function §+e§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc5_ = _loc3_.aabb;
               _loc3_.aabb = b2AABB.§8C§(_loc3_.child1.aabb,_loc3_.child2.aabb);
