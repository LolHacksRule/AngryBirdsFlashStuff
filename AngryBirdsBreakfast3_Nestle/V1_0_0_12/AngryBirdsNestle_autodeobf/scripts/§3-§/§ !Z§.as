package §3-§
{
   ...
   public class § !Z§ extends §3!!§
   {
      ...
      public function § !Z§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§9^§(param1,param2);
      }
      
      protected function §9^§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc16_:§'!h§ = null;
         var _loc3_:Dictionary = this.§`!Q§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§8!,§(_loc7_,_loc6_)]) == null)
            {
      ...
      private function §8!,§(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function §`!Q§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§8!,§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §%T§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
