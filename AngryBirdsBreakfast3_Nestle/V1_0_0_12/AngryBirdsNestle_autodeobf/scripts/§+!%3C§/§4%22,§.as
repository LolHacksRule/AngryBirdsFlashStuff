package §+!<§
{
   ...
   public class §4",§
   {
      ...
      {
         (this.§=e§.getItemByName("TextField_NickNameField_Register") as §&0§).§"S§.removeEventListener(TextEvent.TEXT_INPUT,this.§?!i§);
         (this.§=e§.getItemByName("TextField_PasswordField_Register") as §&0§).§"S§.removeEventListener(TextEvent.TEXT_INPUT,this.§3"-§);
         (this.§=e§.getItemByName("TextField_PasswordFieldRepeat_Register") as §&0§).§"S§.removeEventListener(TextEvent.TEXT_INPUT,this.§3"-§);
         ...
         this.§#"7§.stage.removeEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.§>4§);
      }
      
      public function dispose() : void
      {
         this.deActivate();
         this.§#"7§.§'2§.removeEventListener(LoginHandlerEvent.ERROR,this.§+"2§);
         this.§#"7§.§'2§.removeEventListener(LoginHandlerEvent.§["6§,this.§?^§);
      ...
      public function activate() : void
      {
         ...
         _loc2_.§"S§.tabIndex = 2;
         _loc3_.§"S§.tabIndex = 3;
         _loc1_.§"S§.addEventListener(TextEvent.TEXT_INPUT,this.§?!i§);
         _loc2_.§"S§.addEventListener(TextEvent.TEXT_INPUT,this.§3"-§);
         _loc3_.§"S§.addEventListener(TextEvent.TEXT_INPUT,this.§3"-§);
         this.§#"7§.§ N§();
      }
      
      private function §?!i§(param1:TextEvent) : void
      {
         var _loc2_:RegExp = /[A-Za-z0-9]/;
         var _loc3_:String = §2"&§.ONLY_LETTERS_AND_NUMBERS_ALLOWED;
         if(!param1.text.match(_loc2_) && _loc3_)
         {
            (§-!2§.§7O§ as AngryBirdsCustom).§0!l§.openPopup(new §>!F§(_loc3_,§>!F§.§6H§));
         }
      }
      
      private function §3"-§(param1:TextEvent) : void
      {
         var _loc2_:RegExp = /[*]/;
         if(!param1.text.match(_loc2_) && null)
         {
            (§-!2§.§7O§ as AngryBirdsCustom).§0!l§.openPopup(new §>!F§(null,§>!F§.§6H§));
         }
      }
      ...
      public function §#!y§() : void
      {
         ...
         this.§#"7§.§'2§.addEventListener(LoginHandlerEvent.§["6§,this.§?^§);
         this.§#"7§.§'2§.addEventListener(LoginHandlerEvent.ERROR,this.§+"2§);
         this.§#"7§.§'2§.§1a§(_loc10_);
      }
      ...
      private function §+3§(param1:String) : void
      {
         ...
         this.§#"7§.stage.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.§>4§);
      }
      ...
      private function §>4§(param1:FocusEvent) : void
      {
