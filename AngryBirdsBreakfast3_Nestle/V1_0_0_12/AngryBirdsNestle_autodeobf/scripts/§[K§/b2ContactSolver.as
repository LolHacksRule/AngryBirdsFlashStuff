package §[K§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §8!s§:b2WorldManifold = new b2WorldManifold();
      
      private static var §6!H§:b2PositionSolverManifold = new b2PositionSolverManifold();
       
      
      private var §5m§:b2TimeStep;
      ...
      {
         this.§5m§ = new b2TimeStep();
         this.§["2§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §implements§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§0!5§(),_loc10_.§0!5§());
            _loc20_ = _loc15_.§ Y§.x;
            _loc21_ = _loc15_.§ Y§.y;
            _loc22_ = _loc16_.§ Y§.x;
            _loc23_ = _loc16_.§ Y§.y;
            ...
            §8!s§.§implements§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §8!s§.§1!G§.x;
            _loc27_ = §8!s§.§1!G§.y;
            (_loc28_ = this.§["2§[_loc6_]).§'!R§ = _loc15_;
            _loc28_.§@V§ = _loc16_;
            _loc28_.§!"7§ = _loc17_;
            ...
            _loc28_.§2!p§.x = _loc17_.§<!y§.x;
            _loc28_.§2!p§.y = _loc17_.§<!y§.y;
            ...
            while(_loc29_ < _loc28_.§<!h§)
            {
               ...
               (_loc31_ = _loc28_.§^0§[_loc29_]).normalImpulse = _loc30_.§6![§;
               _loc31_.tangentImpulse = _loc30_.§1!l§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§,!<§.x = §8!s§.§#$§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§,!<§.y = §8!s§.§#$§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§ !'§.x = §8!s§.§#$§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§ !'§.y = §8!s§.§#$§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               if((_loc38_ = _loc15_.§;!R§ + _loc16_.§;!R§ + _loc15_.§1!k§ * _loc36_ + _loc16_.§1!k§ * _loc37_) > 0)
               {
                  _loc31_.§`!&§ = 1 / _loc38_;
               }
               else
               ...
               _loc39_ = (_loc39_ = _loc15_.§<Q§ * _loc15_.§;!R§ + _loc16_.§<Q§ * _loc16_.§;!R§) + (_loc15_.§<Q§ * _loc15_.§1!k§ * _loc36_ + _loc16_.§<Q§ * _loc16_.§1!k§ * _loc37_);
               _loc31_.§5!6§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               if((_loc44_ = _loc15_.§;!R§ + _loc16_.§;!R§ + _loc15_.§1!k§ * _loc42_ + _loc16_.§1!k§ * _loc43_) > 0)
               {
                  _loc31_.§;!'§ = 1 / _loc44_;
               }
               else
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.§8J§)
         {
            _loc7_ = (_loc6_ = this.§["2§[_loc5_]).§'!R§;
            _loc8_ = _loc6_.§@V§;
            _loc9_ = _loc7_.§;!R§;
            _loc10_ = _loc7_.§1!k§;
            _loc11_ = _loc8_.§;!R§;
            ...
            if(param1.§#=§)
            {
               ...
               {
                  _loc20_ = _loc6_.§^0§[_loc18_];
                  _loc20_.normalImpulse *= param1.§6!'§;
                  _loc20_.tangentImpulse *= param1.§6!'§;
                  ...
                  _loc7_.§ Y§.x -= _loc9_ * _loc21_;
                  _loc7_.§ Y§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§ !'§.x * _loc22_ - _loc20_.§ !'§.y * _loc21_);
                  _loc8_.§ Y§.x += _loc11_ * _loc21_;
                  _loc8_.§ Y§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  (_loc23_ = _loc6_.§^0§[_loc18_]).normalImpulse = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§8J§)
         {
            _loc26_ = (_loc25_ = this.§["2§[_loc24_]).§'!R§;
            _loc27_ = _loc25_.§@V§;
            ...
            {
               _loc2_ = _loc25_.§^0§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§ !'§.y - _loc30_.x + _loc28_ * _loc2_.§,!<§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§ !'§.x - _loc30_.y - _loc28_ * _loc2_.§,!<§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§;!'§ * -_loc10_;
               _loc12_ = _loc40_ * _loc2_.normalImpulse;
               _loc14_ = (_loc11_ = (_loc13_ = b2Math.§8M§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_)) - _loc2_.tangentImpulse) * _loc38_;
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§ !'§.y - _loc30_.x + _loc28_ * _loc43_.§,!<§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§ !'§.x - _loc30_.y - _loc28_ * _loc43_.§,!<§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§ !'§.y - _loc30_.x + _loc28_ * _loc44_.§,!<§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§ !'§.x - _loc30_.y - _loc28_ * _loc44_.§,!<§.x;
      ...
      public function §1""§() : void
      {
         ...
         while(_loc1_ < this.§8J§)
         {
            ...
            while(_loc4_ < _loc2_.§<!h§)
            {
               ...
               _loc6_ = _loc2_.§^0§[_loc4_];
               _loc5_.§6![§ = _loc6_.normalImpulse;
               _loc5_.§1!l§ = _loc6_.tangentImpulse;
               _loc4_++;
            }
            _loc1_++;
         }
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:Number = 0;
         var _loc3_:int = 0;
         while(_loc3_ < this.§8J§)
         {
            _loc5_ = (_loc4_ = this.§["2§[_loc3_]).§'!R§;
            _loc6_ = _loc4_.§@V§;
            _loc7_ = _loc5_.§<Q§ * _loc5_.§;!R§;
            _loc8_ = _loc5_.§<Q§ * _loc5_.§1!k§;
            _loc9_ = _loc6_.§<Q§ * _loc6_.§;!R§;
            _loc10_ = _loc6_.§<Q§ * _loc6_.§1!k§;
            §6!H§.§implements§(_loc4_);
            _loc11_ = §6!H§.§1!G§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§<!h§)
            {
               _loc13_ = _loc4_.§^0§[_loc12_];
               _loc14_ = §6!H§.§#$§[_loc12_];
               _loc15_ = §6!H§.§1!O§[_loc12_];
               ...
               _loc20_ = b2Math.§8M§(param1 * (_loc15_ + b2Settings.b2_linearSlop),-b2Settings.b2_maxLinearCorrection,0);
               _loc22_ = (_loc21_ = -_loc13_.§5!6§ * _loc20_) * _loc11_.x;
