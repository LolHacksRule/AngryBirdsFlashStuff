package §=!!§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      public function §+!%§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§"![§)
         {
            this.§^v§[_loc6_] = b2Math.§#@§(_loc5_,this.§^v§[_loc6_]);
            this.§6"0§[_loc6_] = b2Math.§-!u§(_loc5_.R,this.§6"0§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         while(_loc17_ < this.§"![§)
         {
            _loc6_ = (_loc9_ = this.§^v§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§6"0§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§&1§.x = _loc5_ - b2internal::>!M;
         param1.§&1§.y = _loc6_ - b2internal::>!M;
         param1.§3!E§.x = _loc7_ + b2internal::>!M;
         param1.§3!E§.y = _loc8_ + b2internal::>!M;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§"![§ == 2)
         {
            param1.center.x = 0.5 * (this.§^v§[0].x + this.§^v§[1].x);
            param1.center.y = 0.5 * (this.§^v§[0].y + this.§^v§[1].y);
            param1.§#!3§ = 0;
            param1.I = 0;
            return;
         }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§,w§(param1,param3.position);
