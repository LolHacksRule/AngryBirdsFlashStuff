         ...
         switch(param1.§5Q§)
         {
            case b2Manifold.§9!+§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§!!f§.x = _loc19_ / _loc26_;
                  this.§!!f§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§!!f§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§!!f§.x;
               _loc23_ = _loc16_ + param3 * this.§!!f§.y;
               _loc24_ = _loc17_ - param5 * this.§!!f§.x;
               _loc25_ = _loc18_ - param5 * this.§!!f§.y;
