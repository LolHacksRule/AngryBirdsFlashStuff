package §,Z§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      b2internal static function §<9§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               _loc25_ = param1.R;
               param1.§`C§.x = _loc7_.x + (_loc25_.col1.x * _loc23_ + _loc25_.col2.x * _loc24_);
               param1.§`C§.y = _loc7_.y + (_loc25_.col1.y * _loc23_ + _loc25_.col2.y * _loc24_);
               param1.§3y§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§3y§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §^Z§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§+!U§)
         {
            this.§8S§[_loc6_] = b2Math.§=&§(_loc5_,this.§8S§[_loc6_]);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         {
            _loc6_ = (_loc9_ = this.§8S§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§<!@§.x = _loc5_ - b2internal::7!m;
         param1.§<!@§.y = _loc6_ - b2internal::7!m;
         param1.§2!1§.x = _loc7_ + b2internal::7!m;
         param1.§2!1§.y = _loc8_ + b2internal::7!m;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§+!U§ == 2)
         {
            param1.§`C§.x = 0.5 * (this.§8S§[0].x + this.§8S§[1].x);
            param1.§`C§.y = 0.5 * (this.§8S§[0].y + this.§8S§[1].y);
            param1.§[]§ = 0;
            param1.I = 0;
            return;
         }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§<"E§(param1,param3.position);
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§8S§[_loc9_].x * (1 - _loc15_) + this.§8S§[_loc13_].x * _loc15_,this.§8S§[_loc9_].y * (1 - _loc15_) + this.§8S§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§8S§[_loc10_].x * (1 - _loc16_) + this.§8S§[_loc14_].x * _loc16_,this.§8S§[_loc10_].y * (1 - _loc16_) + this.§8S§[_loc14_].y * _loc16_);
