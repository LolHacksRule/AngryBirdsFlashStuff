package §!X§
{
   ...
   public class §?p§ extends §^"G§
   {
      ...
      public static const §8h§:String = "transition_lop";
      ...
      protected function §3p§(param1:int) : void
      {
         ...
         if(_loc3_)
         {
            if(_loc4_ = §0";§.loop && !§!7§)
            {
               if(_loc2_.name == "MovieClip_TutorialClip" && §0";§.type == §7C§.§@!=§)
               {
                  _loc5_ = "loop_run";
                  _loc2_.gotoAndStop(_loc5_);
                  dispatchEvent(new Event(§8h§));
               }
               else
               {
                  _loc6_ = §0";§.defaultStartLabel != "" ? §0";§.defaultStartLabel : "";
                  if((_loc7_ = §0";§.startLabel != "" ? §0";§.startLabel : _loc6_) != "")
                  {
