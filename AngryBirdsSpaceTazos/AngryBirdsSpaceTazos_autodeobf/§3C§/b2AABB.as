package §3c§
{
   ...
   public class b2AABB
   {
      ...
      {
         var _loc1_:Number = this.§2!1§.x - this.§<!@§.x;
         var _loc2_:Number = this.§2!1§.y - this.§<!@§.y;
         var _loc3_:Boolean = _loc1_ >= 0 && _loc2_ >= 0;
         return Boolean(_loc3_ && this.§<!@§.§,8§() && this.§2!1§.§,8§());
      }
      
      public function §4!F§() : b2Vec2
      {
         return new b2Vec2((this.§<!@§.x + this.§2!1§.x) / 2,(this.§<!@§.y + this.§2!1§.y) / 2);
      }
      
      public function §!!B§() : b2Vec2
      {
         return new b2Vec2((this.§2!1§.x - this.§<!@§.x) / 2,(this.§2!1§.y - this.§<!@§.y) / 2);
      }
      ...
      public function §""B§(param1:b2AABB) : Boolean
      {
         ...
         _loc2_ = _loc2_ && param1.§2!1§.x <= this.§2!1§.x;
         return Boolean(_loc2_ && param1.§2!1§.y <= this.§2!1§.y);
      }
      ...
      public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput) : Boolean
      {
         ...
         {
            if(_loc5_ < this.§<!@§.x || this.§2!1§.x < _loc5_)
            {
               return false;
            }
         }
         else
         {
            ...
            _loc14_ = (this.§2!1§.x - _loc5_) * _loc12_;
            _loc16_ = -1;
            if(_loc13_ > _loc14_)
            {
               _loc15_ = _loc13_;
         ...
         {
            if(_loc6_ < this.§<!@§.y || this.§2!1§.y < _loc6_)
            {
               return false;
            }
         }
         else
         {
            ...
            _loc14_ = (this.§2!1§.y - _loc6_) * _loc12_;
            _loc16_ = -1;
            if(_loc13_ > _loc14_)
            {
               _loc15_ = _loc13_;
      ...
      {
         var _loc2_:Number = param1.§<!@§.x - this.§2!1§.x;
         var _loc3_:Number = param1.§<!@§.y - this.§2!1§.y;
         var _loc4_:Number = this.§<!@§.x - param1.§2!1§.x;
         var _loc5_:Number = this.§<!@§.y - param1.§2!1§.y;
      ...
      public function §@B§(param1:b2AABB, param2:b2AABB) : void
      {
         ...
         this.§2!1§.x = Math.max(param1.§2!1§.x,param2.§2!1§.x);
         this.§2!1§.y = Math.max(param1.§2!1§.y,param2.§2!1§.y);
      }
   }
}
