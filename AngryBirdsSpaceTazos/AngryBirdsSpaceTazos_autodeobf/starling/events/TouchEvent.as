package starling.events
{
   ...
   public class TouchEvent extends Event
   {
      ...
      {
         super(param1,param5);
         this.§6!n§ = !!param2 ? param2 : new Vector.<§7M§>(0);
         this.§'"+§ = param3;
         this.§<N§ = param4;
         this.§%!I§ = -1;
      ...
      public function §4!V§(param1:DisplayObject, param2:String = null) : Vector.<§7M§>
      {
         ...
         while(_loc5_ < _loc4_)
         {
            _loc7_ = (_loc6_ = this.§6!n§[_loc5_]).target == param1 || param1 is DisplayObjectContainer && (param1 as DisplayObjectContainer).contains(_loc6_.target);
