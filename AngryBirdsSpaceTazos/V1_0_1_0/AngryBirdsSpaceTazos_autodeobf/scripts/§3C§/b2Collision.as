package §3c§
{
   ...
   public class b2Collision
   {
      ...
      private static var §8$§:Vector.<§10§> = §^!u§();
      
      private static var s_clipPoints1:Vector.<§10§> = §^!u§();
      
      private static var s_clipPoints2:Vector.<§10§> = §^!u§();
      
      private static var §2!4§:Vector.<int> = new Vector.<int>(1);
      ...
      private static var static:b2Vec2 = new b2Vec2();
      ...
      public static function §@j§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §9!R§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §9!R§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §9!R§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §9!R§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §^! §(param1:Vector.<§10§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         _loc20_.id.§;!B§.§+"0§ = param4;
         _loc20_.id.§;!B§.§25§ = _loc21_;
         _loc20_.id.§;!B§.§#"!§ = 0;
         _loc20_ = param1[1];
      ...
      public static function §>B§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §2!4§[0] = _loc8_;
         var _loc9_:Number = §@j§(§2!4§,param2,param3,param4,param5);
         _loc8_ = §2!4§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §>!U§[0] = _loc10_;
         var _loc11_:Number = §@j§(§>!U§,param4,param5,param2,param3);
         _loc10_ = §>!U§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §-"1§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = § !s§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         ...
         var _loc37_:Vector.<§10§> = s_clipPoints1;
         var _loc38_:Vector.<§10§> = s_clipPoints2;
      ...
      public static function §1!6§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§0"B§.y = _loc16_ - _loc27_.y;
            param1.§0"B§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§[!J§ = 1;
            param1.§0w§ = b2Manifold.§%p§;
            param1.§0"B§.x = _loc15_ - _loc28_.x;
            param1.§0"B§.y = _loc16_ - _loc28_.y;
            param1.§0"B§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§,!T§[0].m_localPoint.SetV(param4.§1Q§);
            param1.§,!T§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§[!J§ = 1;
            param1.§0w§ = b2Manifold.§%p§;
            param1.§0"B§.x = _loc23_[_loc25_].x;
            param1.§0"B§.y = _loc23_[_loc25_].y;
            param1.§0"B§.Normalize();
