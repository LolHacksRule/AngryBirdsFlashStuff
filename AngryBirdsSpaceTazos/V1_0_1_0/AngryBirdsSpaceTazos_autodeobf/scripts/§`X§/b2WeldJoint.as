package §`X§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc7_ = this.§&!K§.y - _loc4_.m_sweep.localCenter.y;
         _loc3_ = _loc2_.col1.x * _loc6_ + _loc2_.col2.x * _loc7_;
         _loc7_ = _loc2_.col1.y * _loc6_ + _loc2_.col2.y * _loc7_;
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.m_xf.R;
         _loc8_ = this.§%K§.x - _loc5_.m_sweep.localCenter.x;
         _loc9_ = this.§%K§.y - _loc5_.m_sweep.localCenter.y;
         ...
         if(param1.§`m§)
         {
            ...
            this.§0"3§.y *= param1.§-I§;
            this.§0"3§.z *= param1.§-I§;
            _loc4_.§?o§.x -= _loc10_ * this.§0"3§.x;
            _loc4_.§?o§.y -= _loc10_ * this.§0"3§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§0"3§.y - _loc7_ * this.§0"3§.x + this.§0"3§.z);
            _loc5_.§?o§.x += _loc11_ * this.§0"3§.x;
            _loc5_.§?o§.y += _loc11_ * this.§0"3§.y;
            _loc5_.m_angularVelocity += _loc13_ * (_loc8_ * this.§0"3§.y - _loc9_ * this.§0"3§.x + this.§0"3§.z);
         }
         else
         {
            this.§0"3§.§@!d§();
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc5_:b2Body = b2internal::?H;
         _loc2_ = _loc4_.m_xf.R;
         var _loc6_:Number = this.§&!K§.x - _loc4_.m_sweep.localCenter.x;
         var _loc7_:Number = this.§&!K§.y - _loc4_.m_sweep.localCenter.y;
         _loc3_ = _loc2_.col1.x * _loc6_ + _loc2_.col2.x * _loc7_;
         _loc7_ = _loc2_.col1.y * _loc6_ + _loc2_.col2.y * _loc7_;
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.m_xf.R;
         var _loc8_:Number = this.§%K§.x - _loc5_.m_sweep.localCenter.x;
         ...
         var _loc19_:Number = b2Math.§<D§(_loc16_);
         if(_loc18_ > _loc17_)
         {
            _loc12_ *= 1;
            _loc13_ *= 1;
