package §`X§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§0"3§.x * this.§-m§.x + (this.§9H§ + this.§0"3§.y) * this.§4H§.x),param1 * (this.§0"3§.x * this.§-m§.y + (this.§9H§ + this.§0"3§.y) * this.§4H§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§<T§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§<T§.col2.x = this.§<T§.col1.y;
         this.§<T§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§]U§)
         {
         ...
         if(param1.§`m§)
         {
            ...
            this.§0"3§.y *= param1.§-I§;
            this.§9H§ *= param1.§-I§;
            _loc19_ = this.§0"3§.x * this.§-m§.x + (this.§9H§ + this.§0"3§.y) * this.§4H§.x;
            _loc20_ = this.§0"3§.x * this.§-m§.y + (this.§9H§ + this.§0"3§.y) * this.§4H§.y;
            _loc21_ = this.§0"3§.x * this.m_s1 + (this.§9H§ + this.§0"3§.y) * this.m_a1;
            _loc22_ = this.§0"3§.x * this.m_s2 + (this.§9H§ + this.§0"3§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§4H§.x * (_loc6_.x - _loc4_.x) + this.§4H§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§!!#§ * (this.§7B§ - _loc13_);
            _loc15_ = this.§9H§;
            _loc16_ = param1.§2^§ * this.§8!R§;
            this.§9H§ = b2Math.§`J§(this.§9H§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§9H§ - _loc15_) * this.§4H§.x;
            _loc9_ = _loc14_ * this.§4H§.y;
         ...
         {
            _loc17_ = this.§4H§.x * (_loc6_.x - _loc4_.x) + this.§4H§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§0"3§.Copy();
            _loc19_ = this.§<T§.§3!N§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§0"3§.§]!H§(_loc19_);
            if(this.§?§ == b2internal::6!S)
            {
               this.§0"3§.y = b2Math.§'!i§(this.§0"3§.y,0);
            }
            else if(this.§?§ == b2internal::]!=)
            {
               this.§0"3§.y = b2Math.§+!G§(this.§0"3§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§0"3§.y - _loc18_.y) * this.§<T§.col2.x;
            if(this.§<T§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§<T§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§0"3§.x = _loc21_;
            _loc19_.x = this.§0"3§.x - _loc18_.x;
            _loc19_.y = this.§0"3§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§-m§.x + _loc19_.y * this.§4H§.x;
            _loc9_ = _loc19_.x * this.§-m§.y + _loc19_.y * this.§4H§.y;
         ...
         else
         {
            ...
            this.§0"3§.x += _loc22_;
            _loc8_ = _loc22_ * this.§-m§.x;
            _loc9_ = _loc22_ * this.§-m§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§]U§)
         {
            ...
            _loc34_ = this.§4H§.x * _loc26_ + this.§4H§.y * _loc27_;
            if(b2Math.§<D§(this.§3O§ - this.§+!+§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§`J§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§<D§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§+!+§)
            {
               _loc19_ = b2Math.§`J§(_loc34_ - this.§+!+§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§+!+§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§3O§)
            {
               _loc19_ = b2Math.§`J§(_loc34_ - this.§3O§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§3O§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§<T§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§<T§.col2.x = this.§<T§.col1.y;
            this.§<T§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§<T§.§3!N§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::8"2;
         ...
         var _loc30_:Number = _loc28_.x * this.§-m§.x + _loc28_.y * this.§4H§.x;
         var _loc31_:Number = _loc28_.x * this.§-m§.y + _loc28_.y * this.§4H§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::8"2 * _loc30_;
         _loc6_.y -= b2internal::8"2 * _loc31_;
         _loc7_ -= b2internal::-!J * _loc32_;
         _loc8_.x += b2internal::9; * _loc30_;
         _loc8_.y += b2internal::9; * _loc31_;
         _loc9_ += b2internal::6"2 * _loc33_;
