package §3!1§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §7x§:b2WorldManifold = new b2WorldManifold();
      
      private static var §-!n§:b2PositionSolverManifold = new b2PositionSolverManifold();
       
      
      private var §<Y§:b2TimeStep;
      
      private var §9!H§;
      
      b2internal var §8p§:Vector.<b2ContactConstraint>;
      
      private var §5$§:int;
      
      public function b2ContactSolver()
      {
         this.§<Y§ = new b2TimeStep();
         this.§8p§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §5!k§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§9!H§ = param4;
         this.§5$§ = param3;
         while(this.§8p§.length < this.§5$§)
         {
            this.§8p§[this.§8p§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§break§;
            _loc10_ = _loc5_.§`!y§;
            _loc11_ = _loc9_.§else§;
            _loc12_ = _loc10_.§else§;
            _loc13_ = _loc11_.§'"D§;
            _loc14_ = _loc12_.§'"D§;
            _loc15_ = _loc9_.m_body;
            _loc16_ = _loc10_.m_body;
            _loc17_ = _loc5_.§%s§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§93§(),_loc10_.§93§());
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§5!e§(),_loc10_.§5!e§());
            _loc20_ = _loc15_.§>w§.x;
            _loc21_ = _loc15_.§>w§.y;
            _loc22_ = _loc16_.§>w§.x;
            _loc23_ = _loc16_.§>w§.y;
            ...
            b2Settings.b2Assert(_loc17_.§61§ > 0);
            §7x§.§5!k§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §7x§.§`j§.x;
            _loc27_ = §7x§.§`j§.y;
            (_loc28_ = this.§8p§[_loc6_]).§43§ = _loc15_;
            _loc28_.§4!l§ = _loc16_;
            _loc28_.§]",§ = _loc17_;
            _loc28_.normal.x = _loc26_;
            _loc28_.normal.y = _loc27_;
            _loc28_.§?8§ = _loc17_.§61§;
            _loc28_.friction = _loc18_;
            _loc28_.restitution = _loc19_;
            _loc28_.§=A§.x = _loc17_.§["0§.x;
            _loc28_.§=A§.y = _loc17_.§["0§.y;
            _loc28_.localPoint.x = _loc17_.m_localPoint.x;
            _loc28_.localPoint.y = _loc17_.m_localPoint.y;
            _loc28_.radius = _loc13_ + _loc14_;
            _loc28_.type = _loc17_.§5!q§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§?8§)
            {
               _loc30_ = _loc17_.§-P§[_loc29_];
               (_loc31_ = _loc28_.§]'§[_loc29_]).normalImpulse = _loc30_.§ "$§;
               _loc31_.tangentImpulse = _loc30_.§5";§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§-![§.x = §7x§.§-P§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§-![§.y = §7x§.§-P§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§7!Y§.x = §7x§.§-P§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§7!Y§.y = §7x§.§-P§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               if((_loc38_ = _loc15_.§]!T§ + _loc16_.§]!T§ + _loc15_.§@#§ * _loc36_ + _loc16_.§@#§ * _loc37_) > 0)
               {
                  _loc31_.§+"0§ = 1 / _loc38_;
               }
               else
               ...
               _loc41_ *= _loc41_;
               _loc42_ *= _loc42_;
               if((_loc43_ = _loc15_.§]!T§ + _loc16_.§]!T§ + _loc15_.§@#§ * _loc41_ + _loc16_.§@#§ * _loc42_) > 0)
               {
                  _loc31_.§>!s§ = 1 / _loc43_;
               }
               else
               ...
               {
                  _loc31_.§]"E§ = -_loc28_.restitution * _loc46_;
               }
               _loc29_++;
            }
            if(_loc28_.§?8§ == 2)
            {
               ...
               _loc51_ = _loc16_.§]!T§;
               _loc52_ = _loc16_.§@#§;
               _loc53_ = _loc47_.§-![§.x * _loc27_ - _loc47_.§-![§.y * _loc26_;
               _loc54_ = _loc47_.§7!Y§.x * _loc27_ - _loc47_.§7!Y§.y * _loc26_;
               _loc55_ = _loc48_.§-![§.x * _loc27_ - _loc48_.§-![§.y * _loc26_;
               _loc56_ = _loc48_.§7!Y§.x * _loc27_ - _loc48_.§7!Y§.y * _loc26_;
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         while(_loc5_ < this.§5$§)
         {
            _loc7_ = (_loc6_ = this.§8p§[_loc5_]).§43§;
            _loc8_ = _loc6_.§4!l§;
            _loc9_ = _loc7_.§]!T§;
            _loc10_ = _loc7_.§@#§;
            _loc11_ = _loc8_.§]!T§;
            ...
            if(param1.§3!2§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc20_.normalImpulse *= param1.§2!H§;
                  _loc20_.tangentImpulse *= param1.§2!H§;
                  ...
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§7!Y§.x * _loc22_ - _loc20_.§7!Y§.y * _loc21_);
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§5$§)
         {
            _loc26_ = (_loc25_ = this.§8p§[_loc24_]).§43§;
            _loc27_ = _loc25_.§4!l§;
            ...
            while(_loc1_ < _loc25_.§?8§)
            {
               ...
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§7!Y§.y - _loc30_.x + _loc28_ * _loc2_.§-![§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§7!Y§.x - _loc30_.y - _loc28_ * _loc2_.§-![§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§>!s§ * -_loc10_;
               _loc12_ = _loc40_ * _loc2_.normalImpulse;
               _loc14_ = (_loc11_ = (_loc13_ = b2Math.§>G§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_)) - _loc2_.tangentImpulse) * _loc38_;
               ...
               _loc29_ += _loc35_ * (_loc2_.§7!Y§.x * _loc15_ - _loc2_.§7!Y§.y * _loc14_);
            ...
            if(_loc25_.§?8§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§+"0§ * (_loc9_ - _loc2_.§]"E§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§7!Y§.y - _loc30_.x + _loc28_ * _loc43_.§-![§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§7!Y§.x - _loc30_.y - _loc28_ * _loc43_.§-![§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§7!Y§.y - _loc30_.x + _loc28_ * _loc44_.§-![§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§7!Y§.x - _loc30_.y - _loc28_ * _loc44_.§-![§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§]"E§;
               _loc54_ = _loc52_ - _loc44_.§]"E§;
               _loc22_ = _loc25_.K;
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc29_ += _loc35_ * (_loc43_.§7!Y§.x * _loc19_ - _loc43_.§7!Y§.y * _loc18_ + _loc44_.§7!Y§.x * _loc21_ - _loc44_.§7!Y§.y * _loc20_);
      ...
      public function §0"§() : void
      {
         ...
         while(_loc1_ < this.§5$§)
         {
            _loc2_ = this.§8p§[_loc1_];
            _loc3_ = _loc2_.§]",§;
            _loc4_ = 0;
            while(_loc4_ < _loc2_.§?8§)
            {
               _loc5_ = _loc3_.§-P§[_loc4_];
               _loc6_ = _loc2_.§]'§[_loc4_];
               _loc5_.§ "$§ = _loc6_.normalImpulse;
               _loc5_.§5";§ = _loc6_.tangentImpulse;
               _loc4_++;
            }
            _loc1_++;
         }
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§5$§)
         {
            _loc5_ = (_loc4_ = this.§8p§[_loc3_]).§43§;
            _loc6_ = _loc4_.§4!l§;
            _loc7_ = _loc5_.§]!T§;
            _loc8_ = _loc5_.§@#§;
            _loc9_ = _loc6_.§]!T§;
            ...
            while(_loc12_ < _loc4_.§?8§)
            {
               ...
               _loc20_ = b2Math.§>G§(param1 * (_loc15_ + b2Settings.b2_linearSlop),-b2Settings.b2_maxLinearCorrection,0);
