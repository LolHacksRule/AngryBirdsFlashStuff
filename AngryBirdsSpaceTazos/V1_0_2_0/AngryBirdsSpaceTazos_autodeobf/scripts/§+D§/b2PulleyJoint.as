package §+D§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §7X§:Number = 2;
       
      
      private var §1e§:b2Body;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§1e§ = b2internal::]X.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§&"7§.x - this.§1e§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§&"7§.y - this.§1e§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§+!L§.x - this.§1e§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§+!L§.y - this.§1e§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§&9§);
         this.m_localAnchor2.SetV(param1.§^"<§);
         this.§'"?§ = param1.§1""§;
         this.§<!`§ = param1.§>u§ + this.§'"?§ * param1.§^p§;
         this.m_maxLength1 = b2Math.§'a§(param1.§-j§,this.§<!`§ - this.§'"?§ * b2internal::7X);
         this.m_maxLength2 = b2Math.§'a§(param1.§<!5§,(this.§<!`§ - b2internal::7X) / this.§'"?§);
         this.§!=§ = 0;
      ...
      {
         var _loc1_:b2Vec2 = this.§1e§.m_xf.position.Copy();
         _loc1_.§7-§(this.m_groundAnchor1);
         return _loc1_;
      }
      ...
      {
         var _loc1_:b2Vec2 = this.§1e§.m_xf.position.Copy();
         _loc1_.§7-§(this.m_groundAnchor2);
         return _loc1_;
      }
      
      public function GetLength1() : Number
      {
         var _loc1_:b2Vec2 = b2internal::]X.GetWorldPoint(this.m_localAnchor1);
         var _loc2_:Number = this.§1e§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.§1e§.m_xf.position.y + this.m_groundAnchor1.y;
      ...
      {
         var _loc1_:b2Vec2 = b2internal::9!W.GetWorldPoint(this.m_localAnchor2);
         var _loc2_:Number = this.§1e§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.§1e§.m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc14_:Number = this.§1e§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.§1e§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.§1e§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.§1e§.m_xf.position.y + this.m_groundAnchor2.y;
         this.m_u1.Set(_loc10_ - _loc14_,_loc11_ - _loc15_);
         this.m_u2.Set(_loc12_ - _loc16_,_loc13_ - _loc17_);
         var _loc18_:Number = this.m_u1.§"!E§();
         var _loc19_:Number = this.m_u2.§"!E§();
         if(_loc18_ > b2Settings.b2_linearSlop)
         {
            this.m_u1.§4z§(1 / _loc18_);
         }
         else
         {
            this.m_u1.§ "2§();
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§<!`§ - _loc18_ - this.§'"?§ * _loc19_) > 0)
         {
            this.§6J§ = b2internal::%!";
            this.§!=§ = 0;
         }
         ...
         this.m_limitMass1 = _loc2_.§]!T§ + _loc2_.§@#§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§]!T§ + _loc3_.§@#§ * _loc22_ * _loc22_;
         this.§8!z§ = this.m_limitMass1 + this.§'"?§ * this.§'"?§ * this.m_limitMass2;
         ...
         {
            this.§!=§ *= param1.§2!H§;
            this.m_limitImpulse1 *= param1.§2!H§;
            this.m_limitImpulse2 *= param1.§2!H§;
            _loc23_ = (-this.§!=§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§!=§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§'"?§ * this.§!=§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§'"?§ * this.§!=§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§>w§.x += _loc2_.§]!T§ * _loc23_;
            _loc2_.§>w§.y += _loc2_.§]!T§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§@#§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§>w§.x += _loc3_.§]!T§ * _loc25_;
            _loc3_.§>w§.y += _loc3_.§]!T§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§6J§ == b2internal::^!n)
         {
            ...
            _loc19_ = this.§8!z§ * -_loc18_;
            _loc20_ = this.§!=§;
            this.§!=§ = b2Math.§!!e§(0,this.§!=§ + _loc19_);
            ...
            _loc2_.§>w§.x += _loc2_.§]!T§ * _loc14_;
            _loc2_.§>w§.y += _loc2_.§]!T§ * _loc15_;
         ...
         if(this.m_limitState1 == b2internal::^!n)
         {
            _loc10_ = _loc2_.§>w§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§>w§.y + _loc2_.m_angularVelocity * _loc5_;
         ...
         if(this.m_limitState2 == b2internal::^!n)
         {
            _loc12_ = _loc3_.§>w§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§>w§.y + _loc3_.m_angularVelocity * _loc8_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal::]X;
         var _loc3_:b2Body = b2internal::9!W;
         var _loc5_:Number = this.§1e§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.§1e§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.§1e§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.§1e§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         if(this.§6J§ == b2internal::^!n)
         {
            ...
            if(_loc18_ > b2Settings.b2_linearSlop)
            {
               this.m_u2.§4z§(1 / _loc18_);
            }
            else
            {
               this.m_u2.§ "2§();
            }
            _loc19_ = this.§<!`§ - _loc17_ - this.§'"?§ * _loc18_;
            _loc24_ = b2Math.§!!e§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§>G§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§8!z§ * _loc19_) * this.m_u1.x;
         ...
         if(this.m_limitState1 == b2internal::^!n)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§"!E§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::^!n)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§"!E§()) > b2Settings.b2_linearSlop)
            {
