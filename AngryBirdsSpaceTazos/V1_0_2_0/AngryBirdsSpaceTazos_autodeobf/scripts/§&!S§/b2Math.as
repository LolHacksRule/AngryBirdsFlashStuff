package §&!S§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§?X§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §27§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         return param1.x * param2.y - param1.y * param2.x;
      }
      
      public static function §8b§(param1:b2Vec2, param2:Number) : b2Vec2
      {
         return new b2Vec2(param2 * param1.y,-param2 * param1.x);
      }
      
      public static function §9!8§(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §53§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         _loc3_ = §%r§(param1.R,param2);
         _loc3_.x += param1.position.x;
         _loc3_.y += param1.position.y;
         return _loc3_;
      }
      
      public static function §8!5§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         var _loc4_:Number = NaN;
         _loc3_ = §2"=§(param2,param1.position);
      ...
      public static function §2"=§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1.x - param2.x,param1.y - param2.y);
      }
      ...
      public static function §07§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         var _loc3_:Number = param1.x - param2.x;
         var _loc4_:Number = param1.y - param2.y;
      ...
      public static function §5!Z§(param1:Number, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1 * param2.x,param1 * param2.y);
      }
      
      public static function §4k§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§?X§(§>%§(param1.col1,param2.col1),§>%§(param1.col2,param2.col2));
      }
      
      public static function §>!0§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§?X§(§%r§(param1,param2.col1),§%r§(param1,param2.col2));
      }
      ...
      public static function §12§(param1:Number) : Number
      {
         return param1 > 0 ? Number(param1) : Number(-param1);
      }
      
      public static function §=y§(param1:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§12§(param1.x),§12§(param1.y));
      }
      
      public static function §'"E§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§?X§(§=y§(param1.col1),§=y§(param1.col2));
      }
      ...
      public static function §>G§(param1:Number, param2:Number, param3:Number) : Number
      {
      ...
      {
         return §]!-§(param2,§8?§(param1,param3));
      }
      
      public static function §'"1§(param1:Array, param2:Array) : void
      {
         var _loc3_:* = param1[0];
         param1[0] = param2[0];
         param2[0] = _loc3_;
