package §3"$§
{
   ...
   public class Texture
   {
      ...
      public static function §5!%§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §3"$§.Texture
      {
         return §8!<§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §8!<§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §3"$§.Texture
      {
      ...
      public static function §3"1§(param1:Context3D, param2:ByteArray) : §3"$§.Texture
      {
         if(param1 == null)
         {
            throw new § k§();
      ...
      public static function § z§(param1:§3"$§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §3"$§.Texture
      {
         var _loc4_:§3"$§.Texture;
         (_loc4_ = new §5! §(param1,param2)).§0!<§ = param3;
         return _loc4_;
      }
      
      public static function §&"?§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §3"$§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§3"$§.Texture = §8!<§(param1,_loc6_,false,param5);
         if(!§ ![§.§%!<§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§-!F§, param2:int, param3:int) : void
      {
         ...
         if(this.§0!<§)
         {
            ...
            param1.§5C§(param2,-this.§0!<§.x,-this.§0!<§.y);
            param1.§5C§(param2 + 1,-_loc4_,-this.§0!<§.y);
            param1.§5C§(param2 + 2,-this.§0!<§.x,-_loc5_);
            param1.§5C§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      ...
      public function get root() : §3"$§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §3"$§.Texture
      {
         return this;
      }
