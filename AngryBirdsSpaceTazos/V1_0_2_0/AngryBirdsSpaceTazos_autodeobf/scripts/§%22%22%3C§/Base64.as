package §""<§
{
   ...
   public class Base64
   {
      ...
      private static const §[!8§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §[&§(param1:String) : ByteArray
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §[!8§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
