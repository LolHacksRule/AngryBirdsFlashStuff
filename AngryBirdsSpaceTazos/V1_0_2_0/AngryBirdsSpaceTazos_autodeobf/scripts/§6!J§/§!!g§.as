package §6!J§
{
   ...
   public class §!!g§
   {
      ...
      private function §2!?§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§2"0§(param1 as String);
         }
         if(param1 is Number)
         {
         ...
         if(param1 is Array)
         {
            return this.§6R§(param1 as Array);
         }
      ...
      private function §2"0§(param1:String) : String
      {
      ...
      private function §6R§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§2"0§(v.@name.toString()) + ":" + this.§2!?§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
