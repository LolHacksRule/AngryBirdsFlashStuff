package §try§
{
   ...
   public class §,H§
   {
      ...
      public static function §+!N§(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number) : §+!$§
      {
         ...
         while(_loc17_ < 2)
         {
            _loc12_[_loc17_] = §;!+§(_loc8_,_loc9_,_loc14_[_loc17_].x,_loc14_[_loc17_].y);
         ...
         var _loc19_:§+!$§;
         (_loc19_ = new §+!$§()).§6b§ = Math.sqrt(_loc16_);
         _loc19_.§9p§ = _loc18_;
         return _loc19_;
      }
