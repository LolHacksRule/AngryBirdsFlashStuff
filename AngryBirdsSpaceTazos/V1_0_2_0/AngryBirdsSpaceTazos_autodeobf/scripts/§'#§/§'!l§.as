package §'#§
{
   public class §'!l§
   {
      ...
      public static function §&K§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         jsonString = §6%§(luaString,emptyObjectAsArray);
         try
         {
      ...
      public static function §6!T§(param1:String, param2:Boolean = false) : Object
      {
         var returnObject:Object = null;
      ...
      public static function §6%§(param1:String, param2:Boolean = false) : String
      {
         ...
         return §]!r§(param1,param2);
      }
      
      private static function §]!r§(param1:String, param2:Boolean) : String
      {
