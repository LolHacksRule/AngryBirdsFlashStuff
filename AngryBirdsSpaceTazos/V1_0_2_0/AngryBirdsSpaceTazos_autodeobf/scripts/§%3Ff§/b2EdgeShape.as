package §?f§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§]@§ = this.§>"+§.Normalize();
         this.§`j§.Set(this.§>"+§.y,-this.§>"+§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§`j§.x - this.§>"+§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§`j§.y - this.§>"+§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§`j§.x + this.§>"+§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§`j§.y + this.§>"+§.y) + this.m_v2.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§;L§ * _loc12_)
            {
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§53§(param3,this.m_v1);
         var _loc7_:b2Vec2 = b2Math.§53§(param3,this.m_v2);
