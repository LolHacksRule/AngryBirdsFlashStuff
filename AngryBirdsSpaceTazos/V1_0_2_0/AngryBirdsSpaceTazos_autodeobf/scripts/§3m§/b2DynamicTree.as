package §3m§
{
   ...
   public class b2DynamicTree
   {
      ...
      private var §9J§:b2DynamicTreeNode;
      ...
      public function §`!D§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
         ...
         _loc3_.aabb.§2M§.x = param1.§2M§.x + _loc4_;
         _loc3_.aabb.§2M§.y = param1.§2M§.y + _loc5_;
         _loc3_.§]"6§ = param2;
         this.§?0§(_loc3_);
         return _loc3_;
      }
      
      public function §'!d§(param1:b2DynamicTreeNode) : void
      {
         this.§ J§(param1);
         this.§%!D§(param1);
      }
      ...
      public function §`">§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         ...
         param1.aabb.§2M§.x = param2.§2M§.x + _loc4_;
         param1.aabb.§2M§.y = param2.§2M§.y + _loc5_;
         this.§?0§(param1);
         return true;
      }
      ...
      public function § !<§(param1:Function, param2:b2AABB) : void
      {
         ...
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§7"3§(param2))
            {
               if(_loc5_.§"!x§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§9!8§(1,_loc5_);
         var _loc7_:b2Vec2 = b2Math.§=y§(_loc6_);
         var _loc8_:Number = param2.§;L§;
         _loc9_ = new b2AABB();
         ...
         _loc9_.§2M§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§2M§.y = Math.max(_loc3_.y,_loc11_);
         ...
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§7"3§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§9! §();
               _loc16_ = _loc14_.aabb.§4!o§();
      ...
      private function §?0§(param1:b2DynamicTreeNode) : void
      {
         ...
         var _loc2_:b2Vec2 = param1.aabb.§9! §();
         ...
         if(_loc3_.§"!x§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§>9§.x + _loc6_.aabb.§2M§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§>9§.y + _loc6_.aabb.§2M§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§>9§.x + _loc7_.aabb.§2M§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§>9§.y + _loc7_.aabb.§2M§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
