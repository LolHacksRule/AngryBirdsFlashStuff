package §3m§
{
   ...
   public class b2Collision
   {
      ...
      private static var §7E§:Vector.<§2!-§> = §='§();
      ...
      private static var §5!F§:Vector.<int> = new Vector.<int>(1);
      
      private static var § !U§:b2Vec2 = new b2Vec2();
      
      private static var §7!3§:b2Vec2 = new b2Vec2();
      ...
      public static function §#!>§(param1:Vector.<§2!-§>, param2:Vector.<§2!-§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§2!-§ = null;
         var _loc6_:int = 0;
      ...
      public static function §@"2§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§[d§;
         var _loc7_:Vector.<b2Vec2> = param1.§4"+§;
         var _loc8_:Vector.<b2Vec2> = param1.§>t§;
         var _loc9_:int = param4.§[d§;
         var _loc10_:Vector.<b2Vec2> = param4.§4"+§;
         _loc11_ = param2.R;
      ...
      public static function §0z§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§[d§;
         var _loc7_:Vector.<b2Vec2> = param2.§>t§;
         _loc9_ = param5.R;
         _loc8_ = param4.§+!g§;
         ...
         var _loc17_:Number = §@"2§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §@"2§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §@"2§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §@"2§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §%"$§(param1:Vector.<§2!-§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§2!-§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§[d§;
         var _loc8_:Vector.<b2Vec2> = param2.§>t§;
         var _loc9_:int = param5.§[d§;
         var _loc10_:Vector.<b2Vec2> = param5.§4"+§;
         var _loc11_:Vector.<b2Vec2> = param5.§>t§;
         _loc12_ = param3.R;
      ...
      public static function §7!v§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§2!-§ = null;
         ...
         param1.§61§ = 0;
         var _loc7_:Number = param2.§'"D§ + param4.§'"D§;
         var _loc8_:int = 0;
         §3!^§[0] = _loc8_;
         var _loc9_:Number = §0z§(§3!^§,param2,param3,param4,param5);
         _loc8_ = §3!^§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §5!F§[0] = _loc10_;
         var _loc11_:Number = §0z§(§5!F§,param4,param5,param2,param3);
         _loc10_ = §5!F§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§5!q§ = b2Manifold.§="G§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§2!-§> = §7E§;
         §%"$§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§[d§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§4"+§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = § !U§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §7!3§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §'g§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         ...
         var _loc37_:Vector.<§2!-§> = s_clipPoints1;
         var _loc38_:Vector.<§2!-§> = s_clipPoints2;
      ...
      public static function §2"+§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§'"D§ + param4.§'"D§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§5!q§ = b2Manifold.§4r§;
         param1.m_localPoint.SetV(param2.§"!u§);
         param1.§["0§.§ "2§();
         param1.§61§ = 1;
         param1.§-P§[0].m_localPoint.SetV(param4.§"!u§);
         param1.§-P§[0].m_id.key = 0;
      }
      ...
      public static function §!!^§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§'"D§ + param4.§'"D§;
         var _loc21_:int = param2.§[d§;
         var _loc22_:Vector.<b2Vec2> = param2.§4"+§;
         var _loc23_:Vector.<b2Vec2> = param2.§>t§;
         var _loc24_:int = 0;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§61§ = 1;
            param1.§5!q§ = b2Manifold.§="G§;
            param1.§["0§.x = _loc15_ - _loc27_.x;
            param1.§["0§.y = _loc16_ - _loc27_.y;
            param1.§["0§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§61§ = 1;
            param1.§5!q§ = b2Manifold.§="G§;
            param1.§["0§.x = _loc15_ - _loc28_.x;
            param1.§["0§.y = _loc16_ - _loc28_.y;
            param1.§["0§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§-P§[0].m_localPoint.SetV(param4.§"!u§);
            param1.§-P§[0].m_id.key = 0;
      ...
      public static function §7"3§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§>9§;
         var _loc4_:b2Vec2 = param1.§2M§;
