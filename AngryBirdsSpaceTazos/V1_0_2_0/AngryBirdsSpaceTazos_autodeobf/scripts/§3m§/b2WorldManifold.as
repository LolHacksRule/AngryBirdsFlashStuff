package §3m§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §5!k§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§5!q§)
         {
            case b2Manifold.§4r§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§-P§[0].m_localPoint;
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§`j§.x = _loc19_ / _loc26_;
                  this.§`j§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§`j§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§`j§.x;
               _loc23_ = _loc16_ + param3 * this.§`j§.y;
               _loc24_ = _loc17_ - param5 * this.§`j§.x;
               _loc25_ = _loc18_ - param5 * this.§`j§.y;
               this.§-P§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§-P§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§="G§:
               _loc8_ = param2.R;
               _loc7_ = param1.§["0§;
               ...
               this.§`j§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§61§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§-P§[_loc6_].m_localPoint;
                  ...
                  this.§-P§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§-P§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§?r§:
               ...
               while(_loc6_ < param1.§61§)
               {
                  ...
                  this.§-P§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§-P§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
