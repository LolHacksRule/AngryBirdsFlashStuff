package §3m§
{
   ...
   class b2SeparationFunction
   {
      ...
      public var §7C§:b2DistanceProxy;
      
      public var §<!X§:b2DistanceProxy;
      
      public var §5!q§:int;
      
      public var m_localPoint:b2Vec2;
      
      public var §8!_§:b2Vec2;
      ...
      public function §5!k§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§5!q§ = §=!v§;
            _loc7_ = this.§7C§.§5!u§(param1.indexA[0]);
            _loc10_ = this.§<!X§.§5!u§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§8!_§.x = _loc15_ - _loc13_;
            this.§8!_§.y = _loc16_ - _loc14_;
            this.§8!_§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§5!q§ = §="G§;
            _loc8_ = this.§7C§.§5!u§(param1.indexA[0]);
            _loc9_ = this.§7C§.§5!u§(param1.indexA[1]);
            _loc10_ = this.§<!X§.§5!u§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§8!_§ = b2Math.§8b§(b2Math.§2"=§(_loc9_,_loc8_),1);
            this.§8!_§.Normalize();
            _loc20_ = this.§8!_§;
         ...
         {
            this.§5!q§ = §?r§;
            _loc11_ = this.§<!X§.§5!u§(param1.indexB[0]);
            _loc12_ = this.§<!X§.§5!u§(param1.indexB[1]);
            _loc7_ = this.§7C§.§5!u§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§8!_§ = b2Math.§8b§(b2Math.§2"=§(_loc12_,_loc11_),1);
            this.§8!_§.Normalize();
            _loc20_ = this.§8!_§;
         ...
         else
         {
            ...
            _loc11_ = this.§<!X§.§5!u§(param1.indexB[0]);
            _loc12_ = this.§<!X§.§5!u§(param1.indexB[1]);
            _loc23_ = b2Math.§53§(param3,_loc7_);
            _loc24_ = b2Math.§%r§(param3.R,b2Math.§2"=§(_loc9_,_loc8_));
            _loc25_ = b2Math.§53§(param5,_loc10_);
            _loc26_ = b2Math.§%r§(param5.R,b2Math.§2"=§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§2"=§(_loc26_,_loc24_);
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§>G§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§>G§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §=!v§:
               _loc3_ = b2Math.§@^§(param1.R,this.§8!_§);
               _loc4_ = b2Math.§@^§(param2.R,this.§8!_§.§1"§());
               _loc5_ = this.§7C§.§4`§(_loc3_);
               _loc6_ = this.§<!X§.§4`§(_loc4_);
               _loc7_ = b2Math.§53§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§53§(param2,_loc6_)).x - _loc7_.x) * this.§8!_§.x + (_loc8_.y - _loc7_.y) * this.§8!_§.y);
            case §="G§:
               _loc10_ = b2Math.§%r§(param1.R,this.§8!_§);
               _loc7_ = b2Math.§53§(param1,this.m_localPoint);
               _loc4_ = b2Math.§@^§(param2.R,_loc10_.§1"§());
               _loc6_ = this.§<!X§.§4`§(_loc4_);
               return Number(((_loc8_ = b2Math.§53§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §?r§:
               _loc10_ = b2Math.§%r§(param2.R,this.§8!_§);
               _loc8_ = b2Math.§53§(param2,this.m_localPoint);
               _loc3_ = b2Math.§@^§(param1.R,_loc10_.§1"§());
               _loc5_ = this.§7C§.§4`§(_loc3_);
               return Number(((_loc7_ = b2Math.§53§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
