package §'!&§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§=!W§ = new Vector.<DisplayObject>(0);
      }
      
      override public function dispose() : void
      {
         var _loc1_:int = this.§=!W§.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      public function §3!d§(param1:DisplayObject) : void
      {
         var _loc2_:int = this.§=!W§.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            if(param1.z < this.§=!W§[_loc3_].z)
            {
      ...
      public function getChildByName(param1:String) : DisplayObject
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(this.§=!W§[_loc3_].name == param1)
            {
               return this.§=!W§[_loc3_];
            }
            _loc3_++;
         }
         return null;
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§=!W§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§=!W§.length;
         if(_loc3_ == 0)
         {
            §+"F§(param1,§9O§);
            transformCoords(§9O§,0,0,§;!l§);
            param2.x = §;!l§.x;
            param2.y = §;!l§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§=!W§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§=!W§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§=!W§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§=!W§[_loc6_];
            §+"F§(_loc7_,§9O§);
            transformCoords(§9O§,_loc3_,_loc4_,§;!l§);
            if(_loc8_ = _loc7_.hitTest(§;!l§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§3=§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§=!W§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§<!m§();
               param1.§!r§(_loc5_);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§6"-§(this,param1.type,_loc2_);
      ...
      private function §6"-§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§=!W§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
               this.§6"-§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
