package §7r§
{
   ...
   public class §8y§
   {
      ...
      public static function §%!W§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §throw§(_loc2_);
         return §"W§.§8!4§(_loc3_.readInt(),true) + §"W§.§8!4§(_loc3_.readInt(),true) + §"W§.§8!4§(_loc3_.readInt(),true) + §"W§.§8!4§(_loc3_.readInt(),true) + §"W§.§8!4§(_loc3_.readInt(),true);
      }
      
      public static function §=!]§(param1:ByteArray) : String
      {
         var _loc2_:Array = §8y§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §throw§(_loc2_);
         return §"W§.§8!4§(_loc3_.readInt(),true) + §"W§.§8!4§(_loc3_.readInt(),true) + §"W§.§8!4§(_loc3_.readInt(),true) + §"W§.§8!4§(_loc3_.readInt(),true) + §"W§.§8!4§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §8y§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §throw§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §throw§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
