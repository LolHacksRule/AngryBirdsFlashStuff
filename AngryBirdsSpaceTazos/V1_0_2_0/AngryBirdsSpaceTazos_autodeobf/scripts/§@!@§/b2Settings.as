package §@!@§
{
   public class b2Settings
   {
      ...
      public static const §9"$§:int = 65535;
      ...
      public static const §2!L§:Number = 0.007;
      
      public static const b2_linearSlop:Number = §2!L§;
      
      public static const §0§:Number = b2_linearSlop - §^!;§;
