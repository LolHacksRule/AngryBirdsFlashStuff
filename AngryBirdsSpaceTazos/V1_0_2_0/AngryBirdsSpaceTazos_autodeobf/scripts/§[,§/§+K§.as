package §[,§
{
   ...
   public class §+K§ extends §#!v§
   {
      ...
      public function §+K§(param1:Sprite, param2:§]!U§, param3:b2World, param4:§]"<§, param5:Number, param6:Number, param7:Number, param8:Number = 1.0, param9:Boolean = true)
      {
      ...
      override protected function specialPower(param1:§class§, param2:Number = 0, param3:Number = 0) : void
      {
         ...
         var _loc11_:§#!v§;
         (_loc11_ = §#!v§(param1.addObject("BIRD_BLUE",_loc4_ - _loc10_,_loc5_ - _loc9_,0,§]j§.§4"1§,true,false,false,scale))).§]Q§(new b2Vec2(_loc6_ - 7 * _loc10_,_loc7_ - 7 * _loc9_));
         (_loc11_ = §#!v§(param1.addObject("BIRD_BLUE",_loc4_ + _loc10_,_loc5_ + _loc9_,0,§]j§.§4"1§,true,false,false,scale))).§]Q§(new b2Vec2(_loc6_ + 7 * _loc10_,_loc7_ + 7 * _loc9_));
      }
   }
}
