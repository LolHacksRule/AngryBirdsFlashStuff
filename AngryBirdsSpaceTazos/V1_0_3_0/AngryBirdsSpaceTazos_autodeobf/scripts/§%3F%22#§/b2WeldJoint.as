package §?"#§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc7_ = this.§4M§.y - _loc4_.m_sweep.localCenter.y;
         ...
         if(param1.§%Z§)
         {
            ...
            this.§2""§.y *= param1.§0!`§;
            this.§2""§.z *= param1.§0!`§;
            _loc4_.§0!'§.x -= _loc10_ * this.§2""§.x;
            _loc4_.§0!'§.y -= _loc10_ * this.§2""§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§2""§.y - _loc7_ * this.§2""§.x + this.§2""§.z);
            _loc5_.§0!'§.x += _loc11_ * this.§2""§.x;
            _loc5_.§0!'§.y += _loc11_ * this.§2""§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc5_:b2Body = b2internal::8"?;
         _loc2_ = _loc4_.m_xf.R;
         var _loc6_:Number = this.§4M§.x - _loc4_.m_sweep.localCenter.x;
         ...
         var _loc19_:Number = b2Math.§8A§(_loc16_);
         if(_loc18_ > _loc17_)
         {
            _loc12_ *= 1;
            _loc13_ *= 1;
