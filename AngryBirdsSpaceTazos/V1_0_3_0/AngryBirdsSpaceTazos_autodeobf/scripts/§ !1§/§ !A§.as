package § !1§
{
   ...
   public class § !A§
   {
      ...
      public static function §<_§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §;!<§(_loc2_);
         return §[!p§.§6Q§(_loc3_.readInt(),true) + §[!p§.§6Q§(_loc3_.readInt(),true) + §[!p§.§6Q§(_loc3_.readInt(),true) + §[!p§.§6Q§(_loc3_.readInt(),true) + §[!p§.§6Q§(_loc3_.readInt(),true);
      }
      
      public static function §6!2§(param1:ByteArray) : String
      {
         var _loc2_:Array = § !A§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §;!<§(_loc2_);
         return §[!p§.§6Q§(_loc3_.readInt(),true) + §[!p§.§6Q§(_loc3_.readInt(),true) + §[!p§.§6Q§(_loc3_.readInt(),true) + §[!p§.§6Q§(_loc3_.readInt(),true) + §[!p§.§6Q§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc6_:uint = 0;
         var _loc2_:Array = § !A§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §;!<§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
