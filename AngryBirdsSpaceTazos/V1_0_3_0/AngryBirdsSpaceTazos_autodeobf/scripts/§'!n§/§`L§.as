package §'!n§
{
   public class §`L§
   {
      ...
      public static function §3!,§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         jsonString = §>"D§(luaString,emptyObjectAsArray);
         try
         {
      ...
      public static function §>"D§(param1:String, param2:Boolean = false) : String
      {
         ...
         return §5b§(param1,param2);
      }
      
      private static function §5b§(param1:String, param2:Boolean) : String
      {
