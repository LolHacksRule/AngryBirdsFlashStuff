package §>!m§
{
   ...
   class b2Simplex
   {
      ...
      public var §8i§:Vector.<b2SimplexVertex>;
      ...
      function b2Simplex()
      {
         ...
         this.§8i§ = new Vector.<b2SimplexVertex>(3);
         super();
         this.§8i§[0] = this.m_v1;
         this.§8i§[1] = this.m_v2;
         this.§8i§[2] = this.m_v3;
      ...
      public function §>!C§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         this.§<!^§ = param1.count;
         var _loc8_:Vector.<b2SimplexVertex> = this.§8i§;
         var _loc9_:int = 0;
         while(_loc9_ < this.§<!^§)
         {
            ...
            _loc10_.§<v§ = b2Math.§>">§(param3,_loc6_);
            _loc10_.§=!<§ = b2Math.§>">§(param5,_loc7_);
            _loc10_.w = b2Math.§0t§(_loc10_.§=!<§,_loc10_.§<v§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§<!^§ > 1)
         {
            _loc11_ = param1.§^!m§;
            if((_loc12_ = this.§4!l§()) < 0.5 * _loc11_ || 2 * _loc11_ < _loc12_ || _loc12_ < Number.MIN_VALUE)
            {
               this.§<!^§ = 0;
            }
         }
      ...
      public function §,Y§(param1:b2SimplexCache) : void
      {
         ...
         var _loc2_:Vector.<b2SimplexVertex> = this.§8i§;
         var _loc3_:int = 0;
         while(_loc3_ < this.§<!^§)
         {
      ...
      public function §%"$§() : b2Vec2
      {
         ...
         {
            case 1:
               return this.m_v1.w.§,!M§();
            case 2:
               _loc1_ = b2Math.§0t§(this.m_v2.w,this.m_v1.w);
               _loc2_ = b2Math.§3"F§(_loc1_,this.m_v1.w.§,!M§());
               if(_loc2_ > 0)
               {
                  return b2Math.§!k§(1,_loc1_);
               }
      ...
      public function §,[§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§<!^§)
         {
            case 0:
               ...
               break;
            case 1:
               param1.SetV(this.m_v1.§<v§);
               param2.SetV(this.m_v1.§=!<§);
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§<v§.x + this.m_v2.a * this.m_v2.§<v§.x;
               param1.y = this.m_v1.a * this.m_v1.§<v§.y + this.m_v2.a * this.m_v2.§<v§.y;
               param2.x = this.m_v1.a * this.m_v1.§=!<§.x + this.m_v2.a * this.m_v2.§=!<§.x;
               param2.y = this.m_v1.a * this.m_v1.§=!<§.y + this.m_v2.a * this.m_v2.§=!<§.y;
               break;
            case 3:
               param2.x = param1.x = this.m_v1.a * this.m_v1.§<v§.x + this.m_v2.a * this.m_v2.§<v§.x + this.m_v3.a * this.m_v3.§<v§.x;
               param2.y = param1.y = this.m_v1.a * this.m_v1.§<v§.y + this.m_v2.a * this.m_v2.§<v§.y + this.m_v3.a * this.m_v3.§<v§.y;
               break;
            default:
               b2Settings.b2Assert(false);
         }
      ...
      public function §4!l§() : Number
      {
         switch(this.§<!^§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§0t§(this.m_v1.w,this.m_v2.w).§@"9§();
            case 3:
               return b2Math.§3"F§(b2Math.§0t§(this.m_v2.w,this.m_v1.w),b2Math.§0t§(this.m_v3.w,this.m_v1.w));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve2() : void
      {
         ...
         var _loc3_:b2Vec2 = b2Math.§0t§(_loc2_,_loc1_);
         var _loc4_:Number;
      ...
      public function Solve3() : void
      {
         ...
         var _loc4_:b2Vec2 = b2Math.§0t§(_loc2_,_loc1_);
         var _loc5_:Number = b2Math.§0T§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§0T§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§0t§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§0T§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§0T§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§0t§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§0T§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§0T§(_loc3_,_loc14_);
         var _loc18_:Number = -_loc15_;
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§3"F§(_loc4_,_loc9_)) * b2Math.§3"F§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§3"F§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§3"F§(_loc1_,_loc2_);
