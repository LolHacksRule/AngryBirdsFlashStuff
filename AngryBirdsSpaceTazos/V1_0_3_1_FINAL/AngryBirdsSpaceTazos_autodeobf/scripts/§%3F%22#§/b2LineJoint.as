package §?"#§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§2""§.x * this.§-!l§.x + (this.§9p§ + this.§2""§.y) * this.§;!p§.x),param1 * (this.§2""§.x * this.§-!l§.y + (this.§9p§ + this.§2""§.y) * this.§;!p§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§%Z§)
         {
            ...
            this.§2""§.y *= param1.§0!`§;
            this.§9p§ *= param1.§0!`§;
            _loc19_ = this.§2""§.x * this.§-!l§.x + (this.§9p§ + this.§2""§.y) * this.§;!p§.x;
            _loc20_ = this.§2""§.x * this.§-!l§.y + (this.§9p§ + this.§2""§.y) * this.§;!p§.y;
            _loc21_ = this.§2""§.x * this.m_s1 + (this.§9p§ + this.§2""§.y) * this.m_a1;
            _loc22_ = this.§2""§.x * this.m_s2 + (this.§9p§ + this.§2""§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§;!p§.x * (_loc6_.x - _loc4_.x) + this.§;!p§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§>$§ * (this.§?!C§ - _loc13_);
            _loc15_ = this.§9p§;
            _loc16_ = param1.§;!!§ * this.§1#§;
            this.§9p§ = b2Math.§>!]§(this.§9p§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§9p§ - _loc15_) * this.§;!p§.x;
            _loc9_ = _loc14_ * this.§;!p§.y;
         ...
         {
            _loc17_ = this.§;!p§.x * (_loc6_.x - _loc4_.x) + this.§;!p§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§2""§.Copy();
            _loc19_ = this.§<C§.§][§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§2""§.§ ,§(_loc19_);
            if(this.§+!r§ == b2internal::=!C)
            {
               this.§2""§.y = b2Math.§<"4§(this.§2""§.y,0);
            }
            else if(this.§+!r§ == b2internal::2!M)
            {
               this.§2""§.y = b2Math.§@]§(this.§2""§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§2""§.y - _loc18_.y) * this.§<C§.col2.x;
            if(this.§<C§.col1.x != 0)
            {
            ...
            this.§2""§.x = _loc21_;
            _loc19_.x = this.§2""§.x - _loc18_.x;
            _loc19_.y = this.§2""§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§-!l§.x + _loc19_.y * this.§;!p§.x;
            _loc9_ = _loc19_.x * this.§-!l§.y + _loc19_.y * this.§;!p§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§+"5§)
         {
            ...
            _loc34_ = this.§;!p§.x * _loc26_ + this.§;!p§.y * _loc27_;
            if(b2Math.§8A§(this.§-!p§ - this.§-I§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§>!]§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§8A§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§-I§)
            {
               _loc19_ = b2Math.§>!]§(_loc34_ - this.§-I§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§-I§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§-!p§)
            {
               _loc19_ = b2Math.§>!]§(_loc34_ - this.§-!p§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§<C§.§][§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::"u;
         ...
         var _loc30_:Number = _loc28_.x * this.§-!l§.x + _loc28_.y * this.§;!p§.x;
         var _loc31_:Number = _loc28_.x * this.§-!l§.y + _loc28_.y * this.§;!p§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::"u * _loc30_;
         _loc6_.y -= b2internal::"u * _loc31_;
         _loc7_ -= b2internal::7T * _loc32_;
         _loc8_.x += b2internal::4V * _loc30_;
         _loc8_.y += b2internal::4V * _loc31_;
         _loc9_ += b2internal::=3 * _loc33_;
