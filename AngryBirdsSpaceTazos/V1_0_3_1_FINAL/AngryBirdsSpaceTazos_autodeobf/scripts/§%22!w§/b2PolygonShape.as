package §"!w§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      b2internal var §8i§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         §9!w§ = b2internal::7!D;
         this.§`!!§ = new b2Vec2();
         this.§8i§ = new Vector.<b2Vec2>();
         this.§<"C§ = new Vector.<b2Vec2>();
         §^!G§ = b2Settings.b2_polygonRadius;
         this.§`!!§.§]#§();
      }
      ...
      public static function §%e§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §'!t§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§4"7§(param1,param2);
         return _loc3_;
      }
      ...
      public static function §;!c§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc3_.§ ,§(_loc9_);
            _loc3_.§ ,§(_loc10_);
            _loc3_.§7!J§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §!!$§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§-W§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§-W§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            while(_loc3_ < this.§ !!§)
            {
               this.§8i§[_loc3_].SetV(_loc2_.§8i§[_loc3_]);
      ...
      public function §]1§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§ !!§)
         {
            this.§8i§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§ !!§)
         {
            ...
            _loc6_ = b2Math.§0t§(this.§8i§[_loc5_],this.§8i§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§8!B§() > Number.MIN_VALUE);
            this.§<"C§[_loc3_].SetV(b2Math.§#!c§(_loc6_,1));
            this.§<"C§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§`!!§ = §;!c§(this.§8i§,this.§ !!§);
      }
      ...
      public function §'G§(param1:Number, param2:Number) : void
      {
         this.§ !!§ = 4;
         this.§>!2§(4);
         this.§8i§[0].Set(-param1,-param2);
         this.§8i§[1].Set(param1,-param2);
         this.§8i§[2].Set(param1,param2);
         this.§8i§[3].Set(-param1,param2);
         this.§<"C§[0].Set(0,-1);
         this.§<"C§[1].Set(1,0);
         this.§<"C§[2].Set(0,1);
         this.§<"C§[3].Set(-1,0);
      ...
      public function §+!G§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§ !!§)
         {
            this.§8i§[_loc6_] = b2Math.§>">§(_loc5_,this.§8i§[_loc6_]);
            this.§<"C§[_loc6_] = b2Math.§5%§(_loc5_.R,this.§<"C§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §4"7§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§ !!§ = 2;
         this.§>!2§(2);
         this.§8i§[0].SetV(param1);
         this.§8i§[1].SetV(param2);
         this.§`!!§.x = 0.5 * (param1.x + param2.x);
         this.§`!!§.y = 0.5 * (param1.y + param2.y);
         this.§<"C§[0] = b2Math.§#!c§(b2Math.§0t§(param2,param1),1);
         this.§<"C§[0].Normalize();
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         while(_loc17_ < this.§ !!§)
         {
            _loc6_ = (_loc9_ = this.§8i§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§<"C§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§5!v§.x = _loc5_ - b2internal::^!G;
         param1.§5!v§.y = _loc6_ - b2internal::^!G;
         param1.§4r§.x = _loc7_ + b2internal::^!G;
         param1.§4r§.y = _loc8_ + b2internal::^!G;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§ !!§ == 2)
         {
            param1.§`!f§.x = 0.5 * (this.§8i§[0].x + this.§8i§[1].x);
            param1.§`!f§.y = 0.5 * (this.§8i§[0].y + this.§8i§[1].y);
            param1.§4"-§ = 0;
            param1.I = 0;
            return;
         }
         ...
         while(_loc10_ < this.§ !!§)
         {
            _loc11_ = this.§8i§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§ !!§ ? this.§8i§[int(_loc10_ + 1)] : this.§8i§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§4m§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§0T§(param1,param3.position);
         ...
         while(_loc12_ < this.§ !!§)
         {
            _loc7_[_loc12_] = b2Math.§0T§(_loc5_,this.§8i§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§>">§(param3,_loc24_.§`!f§));
                  return _loc24_.§4"-§;
               }
               return 0;
               break;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§8i§[_loc9_].x * (1 - _loc15_) + this.§8i§[_loc13_].x * _loc15_,this.§8i§[_loc9_].y * (1 - _loc15_) + this.§8i§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§8i§[_loc10_].x * (1 - _loc16_) + this.§8i§[_loc14_].x * _loc16_,this.§8i§[_loc10_].y * (1 - _loc16_) + this.§8i§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§8i§[_loc13_];
         _loc12_ = _loc13_;
      ...
      public function §1!r§() : Vector.<b2Vec2>
      {
         return this.§8i§;
      }
      ...
      public function §7!?§(param1:b2Vec2) : int
      {
      ...
      {
         var _loc2_:int = this.§8i§.length;
         while(_loc2_ < param1)
         {
            this.§8i§[_loc2_] = new b2Vec2();
