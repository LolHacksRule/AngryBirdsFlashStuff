package §"!w§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§%%§ = this.§ "A§.Normalize();
         this.§4F§.Set(this.§ "A§.y,-this.§ "A§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§4F§.x - this.§ "A§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§4F§.y - this.§ "A§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§4F§.x + this.§ "A§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§4F§.y + this.§ "A§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§4F§;
         this.m_cornerDir2.Set(-this.§4F§.x,-this.§4F§.y);
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§^!g§ * _loc12_)
            {
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc8_:Number = b2Math.§0T§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§0T§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §-!_§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §?!e§() : b2EdgeShape
      {
         return this.§?!l§;
      }
      
      public function §33§() : b2EdgeShape
      {
         return this.§]j§;
      }
      ...
      b2internal function §7V§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§?!l§ = param1;
