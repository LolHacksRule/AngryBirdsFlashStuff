package §"X§
{
   ...
   public class §<q§
   {
      ...
      public static function §;z§(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number) : §;W§
      {
         ...
         while(_loc17_ < 2)
         {
            _loc12_[_loc17_] = §6k§(_loc8_,_loc9_,_loc14_[_loc17_].x,_loc14_[_loc17_].y);
         ...
         var _loc19_:§;W§;
         (_loc19_ = new §;W§()).§[t§ = Math.sqrt(_loc16_);
         _loc19_.§9!G§ = _loc18_;
         return _loc19_;
      }
      
      public static function §6k§(param1:Number, param2:Number, param3:Number, param4:Number) : Number
      {
