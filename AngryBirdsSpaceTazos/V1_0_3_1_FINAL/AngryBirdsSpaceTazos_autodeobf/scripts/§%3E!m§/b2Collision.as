package §>!m§
{
   ...
   public class b2Collision
   {
      ...
      private static var §6M§:Vector.<§<D§> = §>v§();
      
      private static var s_clipPoints1:Vector.<§<D§> = §>v§();
      
      private static var s_clipPoints2:Vector.<§<D§> = §>v§();
      
      private static var §%!9§:Vector.<int> = new Vector.<int>(1);
      
      private static var §#"4§:Vector.<int> = new Vector.<int>(1);
      
      private static var §7v§:b2Vec2 = new b2Vec2();
      ...
      private static var §0X§:b2Vec2 = new b2Vec2();
      ...
      public static function §4"+§(param1:Vector.<§<D§>, param2:Vector.<§<D§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§<D§ = null;
         var _loc6_:int = 0;
      ...
      public static function §5!#§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param1.§8i§;
         var _loc8_:Vector.<b2Vec2> = param1.§<"C§;
         var _loc9_:int = param4.§ !!§;
         var _loc10_:Vector.<b2Vec2> = param4.§8i§;
         _loc11_ = param2.R;
      ...
      public static function §4!u§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param2.§<"C§;
         _loc9_ = param5.R;
         _loc8_ = param4.§`!!§;
      ...
      public static function §42§(param1:Vector.<§<D§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param2.§<"C§;
         var _loc9_:int = param5.§ !!§;
         var _loc10_:Vector.<b2Vec2> = param5.§8i§;
         var _loc11_:Vector.<b2Vec2> = param5.§<"C§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§5X§.§9!v§ = param4;
         _loc20_.id.§5X§.§@!o§ = _loc21_;
         _loc20_.id.§5X§.§,"9§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§5X§.§9!v§ = param4;
         _loc20_.id.§5X§.§@!o§ = _loc22_;
         _loc20_.id.§5X§.§,"9§ = 1;
      }
      
      private static function §>v§() : Vector.<§<D§>
      {
         var _loc1_:Vector.<§<D§> = new Vector.<§<D§>(2);
         _loc1_[0] = new §<D§();
         _loc1_[1] = new §<D§();
         return _loc1_;
      }
      ...
      public static function §=G§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         param1.§"!g§ = 0;
         var _loc7_:Number = param2.§^!G§ + param4.§^!G§;
         var _loc8_:int = 0;
         §%!9§[0] = _loc8_;
         var _loc9_:Number = §4!u§(§%!9§,param2,param3,param4,param5);
         _loc8_ = §%!9§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §#"4§[0] = _loc10_;
         var _loc11_:Number = §4!u§(§#"4§,param4,param5,param2,param3);
         _loc10_ = §#"4§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§9!w§ = b2Manifold.§]w§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§<D§> = §6M§;
         §42§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§ !!§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§8i§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §7v§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = § !H§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §[!W§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §0X§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§<D§> = s_clipPoints1;
         var _loc38_:Vector.<§<D§> = s_clipPoints2;
      ...
      public static function §1g§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§^!G§ + param4.§^!G§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§9!w§ = b2Manifold.§1!n§;
         param1.m_localPoint.SetV(param2.§2O§);
         param1.§,!J§.§]#§();
         param1.§"!g§ = 1;
         param1.§9x§[0].m_localPoint.SetV(param4.§2O§);
         param1.§9x§[0].m_id.key = 0;
      }
      
      public static function §+"1§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§^!G§ + param4.§^!G§;
         var _loc21_:int = param2.§ !!§;
         var _loc22_:Vector.<b2Vec2> = param2.§8i§;
         var _loc23_:Vector.<b2Vec2> = param2.§<"C§;
         var _loc24_:int = 0;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§"!g§ = 1;
            param1.§9!w§ = b2Manifold.§]w§;
            param1.§,!J§.x = _loc15_ - _loc27_.x;
            param1.§,!J§.y = _loc16_ - _loc27_.y;
            param1.§,!J§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§"!g§ = 1;
            param1.§9!w§ = b2Manifold.§]w§;
            param1.§,!J§.x = _loc15_ - _loc28_.x;
            param1.§,!J§.y = _loc16_ - _loc28_.y;
            param1.§,!J§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§9x§[0].m_localPoint.SetV(param4.§2O§);
            param1.§9x§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§"!g§ = 1;
            param1.§9!w§ = b2Manifold.§]w§;
            param1.§,!J§.x = _loc23_[_loc25_].x;
            param1.§,!J§.y = _loc23_[_loc25_].y;
            param1.§,!J§.Normalize();
      ...
      public static function § "B§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§5!v§;
         var _loc4_:b2Vec2 = param1.§4r§;
