package §<!A§
{
   ...
   public class §="?§
   {
      ...
      public static function §8D§(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number) : §#g§
      {
         ...
         while(_loc17_ < 2)
         {
            _loc12_[_loc17_] = §`!b§(_loc8_,_loc9_,_loc14_[_loc17_].x,_loc14_[_loc17_].y);
         ...
         var _loc19_:§#g§;
         (_loc19_ = new §#g§()).§2v§ = Math.sqrt(_loc16_);
         _loc19_.§ 5§ = _loc18_;
         return _loc19_;
      }
      
      public static function §`!b§(param1:Number, param2:Number, param3:Number, param4:Number) : Number
      {
