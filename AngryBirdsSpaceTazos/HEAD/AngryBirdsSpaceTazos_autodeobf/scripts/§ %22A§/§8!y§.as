package § "A§
{
   ...
   public class §8!y§ extends §=!s§
   {
      ...
      public function §8!y§(param1:Vector.<MovieClip>, param2:Stage, param3:Number = 41.666666666666664)
      {
         super(param1,param2);
         this.§>!8§ = 0;
         this.§'"'§ = param1.length;
      ...
      protected function §7!0§(param1:int) : void
      {
         ...
         if(_loc3_)
         {
            if(_loc4_ = §,!u§.loop && !§#!Y§)
            {
               if(_loc2_.name == "MovieClip_TutorialClip" && §,!u§.type == §6u§.§9!w§)
               {
                  _loc5_ = "loop_run";
               ...
               {
                  _loc6_ = §,!u§.defaultStartLabel != "" ? §,!u§.defaultStartLabel : "";
                  if((_loc7_ = §,!u§.startLabel != "" ? §,!u§.startLabel : _loc6_) != "")
                  {
