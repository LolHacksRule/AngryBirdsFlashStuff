package §4!W§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         return _loc4_ * _loc4_ + _loc5_ * _loc5_ <= b2internal::!!l * b2internal::!!l;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc9_:Number = _loc7_ * _loc7_ + _loc8_ * _loc8_ - b2internal::!!l * b2internal::!!l;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§'!l§.Set(_loc4_ - b2internal::!!l,_loc5_ - b2internal::!!l);
         param1.§?i§.Set(_loc4_ + b2internal::!!l,_loc5_ + b2internal::!!l);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§`"3§ = param2 * b2Settings.b2_pi * b2internal::!!l * b2internal::!!l;
         param1.§>!4§.SetV(this.§#!=§);
         param1.I = param1.§`"3§ * (0.5 * b2internal::!!l * b2internal::!!l + (this.§#!=§.x * this.§#!=§.x + this.§#!=§.y * this.§#!=§.y));
      }
      
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         var _loc9_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§<!-§(param3,this.§#!=§);
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.§>P§(param1,_loc5_) - param2)) < -b2internal::!!l + Number.MIN_VALUE)
         {
            return 0;
         }
         if(_loc6_ > b2internal::!!l)
         {
            param4.SetV(_loc5_);
            return Math.PI * b2internal::!!l * b2internal::!!l;
         }
         var _loc7_:Number = b2internal::!!l * b2internal::!!l;
         var _loc8_:Number = _loc6_ * _loc6_;
         _loc9_ = _loc7_ * (Math.asin(_loc6_ / b2internal::!!l) + Math.PI / 2) + _loc6_ * Math.sqrt(_loc7_ - _loc8_);
      ...
      public function §8i§(param1:b2Vec2) : void
      {
         this.§#!=§.SetV(param1);
      }
