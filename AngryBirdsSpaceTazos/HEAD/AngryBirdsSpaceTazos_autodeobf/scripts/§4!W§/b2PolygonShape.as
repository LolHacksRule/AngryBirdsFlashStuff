package §4!W§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §>!g§:b2Mat22 = new b2Mat22();
      ...
      public static function §6!T§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§3!Z§(param1,param2);
         return _loc3_;
      }
      
      public static function §>g§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
      ...
      b2internal static function §'R§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               _loc25_ = param1.R;
               param1.§>!4§.x = _loc7_.x + (_loc25_.col1.x * _loc23_ + _loc25_.col2.x * _loc24_);
               param1.§>!4§.y = _loc7_.y + (_loc25_.col1.y * _loc23_ + _loc25_.col2.y * _loc24_);
               param1.§ !V§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§ !V§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function § ",§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§-!<§)
         {
            ...
            _loc6_ = b2Math.§%!q§(this.§[!F§[_loc5_],this.§[!F§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§@""§() > Number.MIN_VALUE);
            this.§!s§[_loc3_].SetV(b2Math.get(_loc6_,1));
            this.§!s§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§-!X§ = §#!k§(this.§[!F§,this.§-!<§);
      }
      
      public function §3!Z§(param1:Number, param2:Number) : void
      {
         this.§-!<§ = 4;
         this.§8"A§(4);
      ...
      public function §+!P§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§-!<§)
         {
            this.§[!F§[_loc6_] = b2Math.§<!-§(_loc5_,this.§[!F§[_loc6_]);
            this.§!s§[_loc6_] = b2Math.§;!q§(_loc5_.R,this.§!s§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §9J§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§-!<§ = 2;
         this.§8"A§(2);
         this.§[!F§[0].SetV(param1);
         this.§[!F§[1].SetV(param2);
         this.§-!X§.x = 0.5 * (param1.x + param2.x);
         this.§-!X§.y = 0.5 * (param1.y + param2.y);
         this.§!s§[0] = b2Math.get(b2Math.§%!q§(param2,param1),1);
         this.§!s§[0].Normalize();
         this.§!s§[1].x = -this.§!s§[0].x;
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         while(_loc17_ < this.§-!<§)
         {
            ...
            _loc18_ = (_loc9_ = this.§!s§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§'!l§.x = _loc5_ - b2internal::!!l;
         param1.§'!l§.y = _loc6_ - b2internal::!!l;
         param1.§?i§.x = _loc7_ + b2internal::!!l;
         param1.§?i§.y = _loc8_ + b2internal::!!l;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§-!<§ == 2)
         {
            param1.§>!4§.x = 0.5 * (this.§[!F§[0].x + this.§[!F§[1].x);
            param1.§>!4§.y = 0.5 * (this.§[!F§[0].y + this.§[!F§[1].y);
            param1.§`"3§ = 0;
            param1.I = 0;
            return;
         }
         ...
         while(_loc10_ < this.§-!<§)
         {
            ...
            _loc12_ = _loc10_ + 1 < this.§-!<§ ? this.§[!F§[int(_loc10_ + 1)] : this.§[!F§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§6s§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§>P§(param1,param3.position);
         ...
         while(_loc12_ < this.§-!<§)
         {
            _loc7_[_loc12_] = b2Math.§>P§(_loc5_,this.§[!F§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§<!-§(param3,_loc24_.§>!4§));
                  return _loc24_.§`"3§;
               }
               return 0;
               break;
      ...
      public function §0!j§() : Vector.<b2Vec2>
      {
         return this.§!s§;
      }
      ...
      private function §1H§() : Boolean
      {
         return false;
      }
      
      private function §8"A§(param1:int) : void
      {
