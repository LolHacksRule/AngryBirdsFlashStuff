package §`!w§
{
   ...
   public class Base64
   {
      ...
      private static const §0"D§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §"!§(param1:ByteArray) : String
      {
         ...
         while(param1.bytesAvailable > 0)
         {
            ...
            {
               _loc2_ += §0"D§.charAt(_loc4_[_loc7_]);
               _loc7_++;
            }
         }
         return _loc2_;
      ...
      public static function §^t§(param1:String) : ByteArray
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §0"D§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
