package §6!n§
{
   public class b2Vec2
   {
      ...
      public static function §?"G§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function § !E§(param1:b2Mat22) : void
      {
      ...
      public function §4!C§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§>P§(this,param1.col1);
         this.y = b2Math.§>P§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      {
         return b2Math.§;!P§(this.x) && b2Math.§;!P§(this.y);
      }
   }
}
