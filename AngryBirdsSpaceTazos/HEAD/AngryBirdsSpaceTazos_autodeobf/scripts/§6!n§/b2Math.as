package §6!n§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§9`§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §;!P§(param1:Number) : Boolean
      {
      ...
      public static function get(param1:b2Vec2, param2:Number) : b2Vec2
      {
      ...
      public static function §6s§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§>P§(param2,param1.col1),§>P§(param2,param1.col2));
      }
      ...
      public static function §'!c§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         ...
         _loc3_ = §%!q§(param2,param1.position);
      ...
      public static function §%!q§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1.x - param2.x,param1.y - param2.y);
      }
      
      public static function §4!T§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §1![§(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§9`§(§1"§(param1.col1,param2.col1),§1"§(param1.col2,param2.col2));
      }
      
      public static function §]f§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§9`§(§;!q§(param1,param2.col1),§;!q§(param1,param2.col2));
      }
      
      public static function §=D§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§>P§(param1.col1,param2.col1),§>P§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§>P§(param1.col1,param2.col2),§>P§(param1.col2,param2.col2));
         return b2Mat22.§9`§(_loc3_,_loc4_);
      }
      ...
      {
         return new b2Vec2(§<W§(param1.x),§<W§(param1.y));
      }
      
      public static function §6e§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§9`§(§ #§(param1.col1),§ #§(param1.col2));
      }
      ...
      public static function §0"C§(param1:Number, param2:Number) : Number
      {
         return param1 > param2 ? Number(param1) : Number(param2);
      }
      ...
      public static function §1[§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§0"C§(param1.x,param2.x),§0"C§(param1.y,param2.y));
      }
      ...
      public static function §4<§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §1[§(param2,§#3§(param1,param3));
      }
      ...
      public static function §@_§(param1:Number, param2:Number) : Number
      {
      ...
      public static function §1>§(param1:uint) : Boolean
      {
