package §9"@§
{
   ...
   public class Texture
   {
      ...
      public static function §4w§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §9"@§.Texture
      {
         return §]!Z§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §]!Z§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §9"@§.Texture
      {
         ...
         _loc10_ = new §6""§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§8T§.§^y§)
         {
            _loc10_.§2!N§(param2);
         }
      ...
      public static function §9m§(param1:Context3D, param2:ByteArray) : §9"@§.Texture
      {
         if(param1 == null)
         {
            throw new §!!z§();
         ...
         var _loc9_:§6""§ = new §6""§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§8T§.§^y§)
         {
            _loc9_.§2!N§(param2);
         }
      ...
      public static function §4!V§(param1:§9"@§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §9"@§.Texture
      {
         var _loc4_:§9"@§.Texture;
         (_loc4_ = new §["$§(param1,param2)).§6-§ = param3;
         return _loc4_;
      }
      
      public static function §8!K§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §9"@§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§9"@§.Texture = §]!Z§(param1,_loc6_,false,param5);
         if(!§8T§.§^y§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§>"C§, param2:int, param3:int) : void
      {
         ...
         if(this.§6-§)
         {
            ...
            _loc4_ = this.§6-§.width + this.§6-§.x - this.width;
            _loc5_ = this.§6-§.height + this.§6-§.y - this.height;
            param1.§0"#§(param2,-this.§6-§.x,-this.§6-§.y);
            param1.§0"#§(param2 + 1,-_loc4_,-this.§6-§.y);
            param1.§0"#§(param2 + 2,-this.§6-§.x,-_loc5_);
      ...
      {
         return !!this.§6-§ ? this.§6-§.clone() : new Rectangle(0,0,this.width,this.height);
      }
