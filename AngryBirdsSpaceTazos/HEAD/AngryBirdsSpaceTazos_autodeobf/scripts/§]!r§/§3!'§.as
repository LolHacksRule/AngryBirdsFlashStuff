package §]!r§
{
   ...
   public class §3!'§
   {
      ...
      public static function §3">§(param1:String) : String
      {
         ...
         return §-O§.§?P§(_loc3_.readInt(),true) + §-O§.§?P§(_loc3_.readInt(),true) + §-O§.§?P§(_loc3_.readInt(),true) + §-O§.§?P§(_loc3_.readInt(),true) + §-O§.§?P§(_loc3_.readInt(),true);
      }
      
      public static function §5"0§(param1:ByteArray) : String
      {
         var _loc2_:Array = §3!'§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §>A§(_loc2_);
         return §-O§.§?P§(_loc3_.readInt(),true) + §-O§.§?P§(_loc3_.readInt(),true) + §-O§.§?P§(_loc3_.readInt(),true) + §-O§.§?P§(_loc3_.readInt(),true) + §-O§.§?P§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc6_:uint = 0;
         var _loc2_:Array = §3!'§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §>A§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
