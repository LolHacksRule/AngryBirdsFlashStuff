package §;!Z§
{
   ...
   public class b2Collision
   {
      ...
      private static var §"z§:Vector.<§>";§> = § ![§();
      
      private static var s_clipPoints1:Vector.<§>";§> = § ![§();
      
      private static var s_clipPoints2:Vector.<§>";§> = § ![§();
      
      private static var §9I§:Vector.<int> = new Vector.<int>(1);
      
      private static var §4"5§:Vector.<int> = new Vector.<int>(1);
      
      private static var §9!t§:b2Vec2 = new b2Vec2();
      ...
      public static function §5u§(param1:Vector.<§>";§>, param2:Vector.<§>";§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§>";§ = null;
         var _loc6_:int = 0;
      ...
      public static function §@-§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param1.§!s§;
      ...
      public static function §3!j§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param2.§!s§;
         _loc9_ = param5.R;
         _loc8_ = param4.§-!X§;
      ...
      public static function §+v§(param1:Vector.<§>";§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param2.§!s§;
         var _loc9_:int = param5.§-!<§;
         var _loc10_:Vector.<b2Vec2> = param5.§[!F§;
         var _loc11_:Vector.<b2Vec2> = param5.§!s§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§0!=§.§&"B§ = param4;
         _loc20_.id.§0!=§.§6!Q§ = _loc21_;
         _loc20_.id.§0!=§.§>" § = 0;
         _loc20_ = param1[1];
      ...
      public static function §3"§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         param1.§&!G§ = 0;
         var _loc7_:Number = param2.§!!l§ + param4.§!!l§;
         var _loc8_:int = 0;
         §9I§[0] = _loc8_;
         var _loc9_:Number = §3!j§(§9I§,param2,param3,param4,param5);
         _loc8_ = §9I§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §4"5§[0] = _loc10_;
         var _loc11_:Number = §3!j§(§4"5§,param4,param5,param2,param3);
         _loc10_ = §4"5§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§[!F§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §9!t§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §-&§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         ...
         if((_loc39_ = §5u§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §5u§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§5d§.SetV(_loc27_);
      ...
      public static function §%k§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§!!l§ + param4.§!!l§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§`K§ = b2Manifold.§+!2§;
         param1.m_localPoint.SetV(param2.§#!=§);
         param1.§5d§.§58§();
         param1.§&!G§ = 1;
         param1.§63§[0].m_localPoint.SetV(param4.§#!=§);
         param1.§63§[0].m_id.key = 0;
      }
      ...
      public static function §+"#§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§!!l§ + param4.§!!l§;
         var _loc21_:int = param2.§-!<§;
         var _loc22_:Vector.<b2Vec2> = param2.§[!F§;
         var _loc23_:Vector.<b2Vec2> = param2.§!s§;
         var _loc24_:int = 0;
         ...
         if(_loc19_ < Number.MIN_VALUE)
         {
            param1.§&!G§ = 1;
            param1.§`K§ = b2Manifold.§^!G§;
            param1.§5d§.SetV(_loc23_[_loc18_]);
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§&!G§ = 1;
            param1.§`K§ = b2Manifold.§^!G§;
            param1.§5d§.x = _loc15_ - _loc27_.x;
            param1.§5d§.y = _loc16_ - _loc27_.y;
            param1.§5d§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§&!G§ = 1;
            param1.§`K§ = b2Manifold.§^!G§;
            param1.§5d§.x = _loc15_ - _loc28_.x;
            param1.§5d§.y = _loc16_ - _loc28_.y;
            param1.§5d§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§63§[0].m_localPoint.SetV(param4.§#!=§);
            param1.§63§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§&!G§ = 1;
            param1.§`K§ = b2Manifold.§^!G§;
            param1.§5d§.x = _loc23_[_loc25_].x;
            param1.§5d§.y = _loc23_[_loc25_].y;
            param1.§5d§.Normalize();
