package §;!Z§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §0!E§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
      ...
      public function §>!u§(param1:b2DynamicTreeNode) : void
      {
         this.§#!u§(param1);
         this.§7-§(param1);
      }
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc19_:*;
         _loc12_[_loc19_ = _loc13_++] = this.§@!c§;
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§1'§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§,!V§();
      ...
      private function § case§(param1:b2DynamicTreeNode) : void
      {
         ...
         var _loc2_:b2Vec2 = param1.aabb.§,!V§();
         var _loc3_:b2DynamicTreeNode = this.§@!c§;
         if(_loc3_.§%I§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§'!l§.x + _loc6_.aabb.§?i§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§'!l§.y + _loc6_.aabb.§?i§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§'!l§.x + _loc7_.aabb.§?i§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§'!l§.y + _loc7_.aabb.§?i§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         _loc5_.§??§ = null;
         _loc5_.aabb.§2!w§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            {
               _loc4_.aabb.§2!w§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
      ...
      private function §#!u§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc5_ = _loc3_.aabb;
               _loc3_.aabb = b2AABB.§2!w§(_loc3_.child1.aabb,_loc3_.child2.aabb);
