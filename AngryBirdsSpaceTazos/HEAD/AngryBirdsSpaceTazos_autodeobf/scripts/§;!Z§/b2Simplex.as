package §;!Z§
{
   ...
   class b2Simplex
   {
      ...
      public function §>!q§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         while(_loc9_ < this.§""6§)
         {
            ...
            _loc6_ = param2.§[E§(_loc10_.indexA);
            _loc7_ = param4.§[E§(_loc10_.indexB);
            _loc10_.§[w§ = b2Math.§<!-§(param3,_loc6_);
            _loc10_.§"!e§ = b2Math.§<!-§(param5,_loc7_);
            _loc10_.w = b2Math.§%!q§(_loc10_.§"!e§,_loc10_.§[w§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§""6§ > 1)
      ...
      public function §2!m§() : b2Vec2
      {
         ...
         {
            case 1:
               return this.m_v1.w.§3!F§();
            case 2:
               _loc1_ = b2Math.§%!q§(this.m_v2.w,this.m_v1.w);
               _loc2_ = b2Math.§^!s§(_loc1_,this.m_v1.w.§3!F§());
               if(_loc2_ > 0)
               {
                  return b2Math.§""C§(1,_loc1_);
               }
               return b2Math.get(_loc1_,1);
               break;
            default:
      ...
      public function §[e§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§""6§)
         {
            case 0:
            ...
            case 1:
               ...
               param2.SetV(this.m_v1.§"!e§);
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§[w§.x + this.m_v2.a * this.m_v2.§[w§.x;
               param1.y = this.m_v1.a * this.m_v1.§[w§.y + this.m_v2.a * this.m_v2.§[w§.y;
               param2.x = this.m_v1.a * this.m_v1.§"!e§.x + this.m_v2.a * this.m_v2.§"!e§.x;
               param2.y = this.m_v1.a * this.m_v1.§"!e§.y + this.m_v2.a * this.m_v2.§"!e§.y;
               break;
            case 3:
      ...
      public function §]n§() : Number
      {
         switch(this.§""6§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§%!q§(this.m_v1.w,this.m_v2.w).§4"3§();
            case 3:
               return b2Math.§^!s§(b2Math.§%!q§(this.m_v2.w,this.m_v1.w),b2Math.§%!q§(this.m_v3.w,this.m_v1.w));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve2() : void
      {
         ...
         var _loc3_:b2Vec2 = b2Math.§%!q§(_loc2_,_loc1_);
         var _loc4_:Number;
      ...
      public function Solve3() : void
      {
         ...
         var _loc4_:b2Vec2 = b2Math.§%!q§(_loc2_,_loc1_);
         var _loc5_:Number = b2Math.§>P§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§>P§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§%!q§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§>P§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§>P§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§%!q§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§>P§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§>P§(_loc3_,_loc14_);
