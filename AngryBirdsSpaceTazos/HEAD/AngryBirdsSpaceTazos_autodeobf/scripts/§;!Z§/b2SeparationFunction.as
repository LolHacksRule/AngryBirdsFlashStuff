package §;!Z§
{
   ...
   class b2SeparationFunction
   {
      ...
      public static const §0"5§:int = 4;
       
      
      public var §5_§:b2DistanceProxy;
      ...
      public function §break§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§`K§ = § s§;
            _loc7_ = this.§5_§.§[E§(param1.indexA[0]);
            _loc10_ = this.§5#§.§[E§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§`K§ = §^!G§;
            _loc8_ = this.§5_§.§[E§(param1.indexA[0]);
            _loc9_ = this.§5_§.§[E§(param1.indexA[1]);
            _loc10_ = this.§5#§.§[E§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§"^§ = b2Math.get(b2Math.§%!q§(_loc9_,_loc8_),1);
            this.§"^§.Normalize();
            _loc20_ = this.§"^§;
         ...
         {
            this.§`K§ = §0"5§;
            _loc11_ = this.§5#§.§[E§(param1.indexB[0]);
            _loc12_ = this.§5#§.§[E§(param1.indexB[1]);
            _loc7_ = this.§5_§.§[E§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§"^§ = b2Math.get(b2Math.§%!q§(_loc12_,_loc11_),1);
            this.§"^§.Normalize();
            _loc20_ = this.§"^§;
         ...
         else
         {
            ...
            _loc24_ = b2Math.§;!q§(param3.R,b2Math.§%!q§(_loc9_,_loc8_));
            _loc25_ = b2Math.§<!-§(param5,_loc10_);
            _loc26_ = b2Math.§;!q§(param5.R,b2Math.§%!q§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§%!q§(_loc26_,_loc24_);
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case § s§:
               _loc3_ = b2Math.§6s§(param1.R,this.§"^§);
               _loc4_ = b2Math.§6s§(param2.R,this.§"^§.§3!F§());
               _loc5_ = this.§5_§.§extends§(_loc3_);
               _loc6_ = this.§5#§.§extends§(_loc4_);
            ...
            case §^!G§:
               ...
               _loc4_ = b2Math.§6s§(param2.R,_loc10_.§3!F§());
               _loc6_ = this.§5#§.§extends§(_loc4_);
            ...
            case §0"5§:
               ...
               _loc3_ = b2Math.§6s§(param1.R,_loc10_.§3!F§());
               _loc5_ = this.§5_§.§extends§(_loc3_);
