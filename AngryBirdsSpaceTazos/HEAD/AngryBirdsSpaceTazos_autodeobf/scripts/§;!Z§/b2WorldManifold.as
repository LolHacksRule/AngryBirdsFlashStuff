package §;!Z§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §break§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§`K§)
         {
            case b2Manifold.§+!2§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§63§[0].m_localPoint;
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§while§.x = _loc19_ / _loc26_;
                  this.§while§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§while§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§while§.x;
               _loc23_ = _loc16_ + param3 * this.§while§.y;
               _loc24_ = _loc17_ - param5 * this.§while§.x;
               _loc25_ = _loc18_ - param5 * this.§while§.y;
               this.§63§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§63§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§^!G§:
               _loc8_ = param2.R;
               _loc7_ = param1.§5d§;
               ...
               this.§while§.x = _loc9_;
               this.§while§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§&!G§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§63§[_loc6_].m_localPoint;
                  ...
                  this.§63§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§63§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§0"5§:
               ...
               while(_loc6_ < param1.§&!G§)
               {
                  ...
                  this.§63§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§63§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
