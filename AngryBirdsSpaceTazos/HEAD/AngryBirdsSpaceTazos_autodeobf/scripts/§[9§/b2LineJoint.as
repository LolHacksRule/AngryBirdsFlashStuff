package §[9§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§^i§.x * this.§<!^§.x + (this.§9,§ + this.§^i§.y) * this.§"^§.x),param1 * (this.§^i§.x * this.§<!^§.y + (this.§9,§ + this.§^i§.y) * this.§"^§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§9]§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§9]§.col2.x = this.§9]§.col1.y;
         this.§9]§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§]!D§)
         {
         ...
         if(param1.§'!t§)
         {
            ...
            this.§^i§.y *= param1.§?!$§;
            this.§9,§ *= param1.§?!$§;
            _loc19_ = this.§^i§.x * this.§<!^§.x + (this.§9,§ + this.§^i§.y) * this.§"^§.x;
            _loc20_ = this.§^i§.x * this.§<!^§.y + (this.§9,§ + this.§^i§.y) * this.§"^§.y;
            _loc21_ = this.§^i§.x * this.m_s1 + (this.§9,§ + this.§^i§.y) * this.m_a1;
            _loc22_ = this.§^i§.x * this.m_s2 + (this.§9,§ + this.§^i§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§3"-§ && this.§`R§ != b2internal::^!K)
         {
            ...
            _loc14_ = this.§]c§ * (this.§2!q§ - _loc13_);
            _loc15_ = this.§9,§;
            _loc16_ = param1.§;@§ * this.§[!l§;
            this.§9,§ = b2Math.§5!^§(this.§9,§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§9,§ - _loc15_) * this.§"^§.x;
         ...
         if(this.§]!D§ && this.§`R§ != b2internal::?!k)
         {
            ...
            _loc18_ = this.§^i§.Copy();
            _loc19_ = this.§9]§.§;#§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§^i§.§=4§(_loc19_);
            if(this.§`R§ == b2internal::#!j)
            {
               this.§^i§.y = b2Math.§0"C§(this.§^i§.y,0);
            }
            else if(this.§`R§ == b2internal::2J)
            {
               this.§^i§.y = b2Math.§#!t§(this.§^i§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§^i§.y - _loc18_.y) * this.§9]§.col2.x;
            if(this.§9]§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§9]§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§]!D§)
         {
            ...
            {
               _loc19_ = b2Math.§5!^§(_loc34_ - this.§=!u§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§=!u§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§=q§)
            {
               _loc19_ = b2Math.§5!^§(_loc34_ - this.§=q§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§=q§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§9]§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§9]§.col2.x = this.§9]§.col1.y;
            this.§9]§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§9]§.§;#§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::1^;
         ...
         _loc8_.x += b2internal:: !A * _loc30_;
         _loc8_.y += b2internal:: !A * _loc31_;
         _loc9_ += b2internal::&"7 * _loc33_;
