   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§'!t§)
         {
            ...
            this.§^i§.y *= param1.§?!$§;
            this.§^i§.z *= param1.§?!$§;
            _loc4_.§9e§.x -= _loc10_ * this.§^i§.x;
            _loc4_.§9e§.y -= _loc10_ * this.§^i§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§^i§.y - _loc7_ * this.§^i§.x + this.§^i§.z);
            _loc5_.§9e§.x += _loc11_ * this.§^i§.x;
            _loc5_.§9e§.y += _loc11_ * this.§^i§.y;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§7g§.Solve33(_loc21_,-_loc18_,-_loc19_,-_loc20_);
         this.§^i§.§=4§(_loc21_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc16_:Number = _loc5_.m_sweep.a - _loc4_.m_sweep.a - this.§7!v§;
         ...
         this.§7g§.Solve33(_loc20_,-_loc14_,-_loc15_,-_loc16_);
