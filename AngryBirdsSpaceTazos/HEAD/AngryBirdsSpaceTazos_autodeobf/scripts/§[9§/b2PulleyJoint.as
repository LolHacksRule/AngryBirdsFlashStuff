package §[9§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §5C§:Number = 2;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§`!x§ = b2internal::[F.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§%!4§.x - this.§`!x§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§%!4§.y - this.§`!x§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§3k§.x - this.§`!x§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§3k§.y - this.§`!x§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§8U§);
         this.m_localAnchor2.SetV(param1.§#i§);
         this.§;=§ = param1.§8J§;
         this.§%! § = param1.§^!W§ + this.§;=§ * param1.§3!p§;
         this.m_maxLength1 = b2Math.§#!t§(param1.§6%§,this.§%! § - this.§;=§ * b2internal::5C);
         this.m_maxLength2 = b2Math.§#!t§(param1.§8l§,(this.§%! § - b2internal::5C) / this.§;=§);
         this.§^i§ = 0;
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc18_:Number = this.m_u1.§4"3§();
         var _loc19_:Number = this.m_u2.§4"3§();
         ...
         {
            this.§5!s§ = b2internal::?!k;
            this.§^i§ = 0;
         }
         else
         {
            this.§5!s§ = b2internal::2J;
         }
         ...
         {
            this.m_limitState1 = b2internal::2J;
         }
         ...
         {
            this.m_limitState2 = b2internal::2J;
         }
         var _loc21_:Number = _loc5_ * this.m_u1.y - _loc6_ * this.m_u1.x;
         var _loc22_:Number = _loc8_ * this.m_u2.y - _loc9_ * this.m_u2.x;
         this.m_limitMass1 = _loc2_.§var § + _loc2_.§,"!§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§var § + _loc3_.§,"!§ * _loc22_ * _loc22_;
         this.§!N§ = this.m_limitMass1 + this.§;=§ * this.§;=§ * this.m_limitMass2;
         ...
         if(param1.§'!t§)
         {
            ...
            _loc25_ = (-this.§;=§ * this.§^i§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§;=§ * this.§^i§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§9e§.x += _loc2_.§var § * _loc23_;
            _loc2_.§9e§.y += _loc2_.§var § * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§,"!§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§9e§.x += _loc3_.§var § * _loc25_;
            _loc3_.§9e§.y += _loc3_.§var § * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = _loc4_.col1.y * _loc8_ + _loc4_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         if(this.§5!s§ == b2internal::2J)
         {
            _loc10_ = _loc2_.§9e§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§9e§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§9e§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§9e§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§;=§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§!N§ * -_loc18_;
            _loc20_ = this.§^i§;
            this.§^i§ = b2Math.§0"C§(0,this.§^i§ + _loc19_);
            ...
            _loc2_.§9e§.x += _loc2_.§var § * _loc14_;
            _loc2_.§9e§.y += _loc2_.§var § * _loc15_;
         ...
         if(this.m_limitState1 == b2internal::2J)
         {
            _loc10_ = _loc2_.§9e§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§9e§.y + _loc2_.m_angularVelocity * _loc5_;
            ...
            this.m_limitImpulse1 = b2Math.§0"C§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == b2internal::2J)
         {
            _loc12_ = _loc3_.§9e§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§9e§.y + _loc3_.m_angularVelocity * _loc8_;
            ...
            this.m_limitImpulse2 = b2Math.§0"C§(0,this.m_limitImpulse2 + _loc19_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§5!s§ == b2internal::2J)
         {
            ...
            _loc17_ = this.m_u1.§4"3§();
            _loc18_ = this.m_u2.§4"3§();
         ...
         if(this.m_limitState1 == b2internal::2J)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§4"3§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::2J)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§4"3§()) > b2Settings.b2_linearSlop)
            {
