package §'!a§
{
   public class b2Settings
   {
      ...
      public static const §+5§:int = 65535;
      ...
      public static const §,!9§:Number = 0.007;
      
      public static const b2_linearSlop:Number = §,!9§;
      
      public static const §1">§:Number = b2_linearSlop - §&!J§;
      ...
      public static const §8t§:Number = 0.1;
      
      public static const §'-§:Number = 0.01;
      
      public static const §2!Z§:Number = 0.1;
      
      public static var b2_linearSleepTolerance:Number = §8t§;
