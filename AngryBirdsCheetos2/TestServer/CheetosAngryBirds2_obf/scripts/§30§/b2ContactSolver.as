package §30§
{
   ...
   public class b2ContactSolver
   {
      ...
      public function §#!O§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§45§;
            _loc10_ = _loc5_.§?G§;
            _loc11_ = _loc9_.§^!+§;
            _loc12_ = _loc10_.§^!+§;
            _loc13_ = _loc11_.§#&§;
            ...
            _loc17_ = _loc5_.§3!#§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§<!7§(),_loc10_.§<!7§());
            ...
            b2Settings.b2Assert(_loc17_.§break§ > 0);
            §%z§.§#!O§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §%z§.§?!B§.x;
            _loc27_ = §%z§.§?!B§.y;
            ...
            _loc28_.§&n§ = _loc17_.§break§;
            _loc28_.friction = _loc18_;
            _loc28_.restitution = _loc19_;
            _loc28_.§]9§.x = _loc17_.§7!A§.x;
            _loc28_.§]9§.y = _loc17_.§7!A§.y;
            ...
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§&n§)
            {
               _loc30_ = _loc17_.§@Z§[_loc29_];
               (_loc31_ = _loc28_.§ try§[_loc29_]).normalImpulse = _loc30_.§'!?§;
               _loc31_.tangentImpulse = _loc30_.§,m§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§=!J§.x = §%z§.§@Z§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§=!J§.y = §%z§.§@Z§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§?! §.x = §%z§.§@Z§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§?! §.y = §%z§.§@Z§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§+5§ + _loc16_.§+5§ + _loc15_.§%L§ * _loc36_ + _loc16_.§%L§ * _loc37_;
               _loc31_.§!!G§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§>§ * _loc15_.§+5§ + _loc16_.§>§ * _loc16_.§+5§) + (_loc15_.§>§ * _loc15_.§%L§ * _loc36_ + _loc16_.§>§ * _loc16_.§%L§ * _loc37_);
               _loc31_.§&!N§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§+5§ + _loc16_.§+5§ + _loc15_.§%L§ * _loc42_ + _loc16_.§%L§ * _loc43_;
               _loc31_.§?!2§ = 1 / _loc44_;
               _loc31_.§18§ = 0;
               ...
               {
                  _loc31_.§18§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§&n§ == 2)
            {
               _loc48_ = _loc28_.§ try§[0];
               _loc49_ = _loc28_.§ try§[1];
               _loc50_ = _loc15_.§+5§;
               _loc51_ = _loc15_.§%L§;
               _loc52_ = _loc16_.§+5§;
               _loc53_ = _loc16_.§%L§;
         ...
         while(_loc5_ < this.§-!=§)
         {
            ...
            if(param1.§7!^§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc7_.§2!@§.x -= _loc9_ * _loc21_;
                  _loc7_.§2!@§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§?! §.x * _loc22_ - _loc20_.§?! §.y * _loc21_);
                  _loc8_.§2!@§.x += _loc11_ * _loc21_;
                  _loc8_.§2!@§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  (_loc23_ = _loc6_.§ try§[_loc18_]).normalImpulse = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         while(_loc24_ < this.§-!=§)
         {
            ...
            _loc1_ = 0;
            while(_loc1_ < _loc25_.§&n§)
            {
               _loc2_ = _loc25_.§ try§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§?! §.y - _loc30_.x + _loc28_ * _loc2_.§=!J§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§?! §.x - _loc30_.y - _loc28_ * _loc2_.§=!J§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§?!2§ * -_loc10_;
               _loc12_ = _loc40_ * _loc2_.normalImpulse;
               _loc14_ = (_loc11_ = (_loc13_ = b2Math.§9!%§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_)) - _loc2_.tangentImpulse) * _loc38_;
            ...
            if(_loc25_.§&n§ == 1)
            {
               _loc2_ = _loc25_.§ try§[0];
               _loc7_ = _loc31_.x + -_loc29_ * _loc2_.§?! §.y - _loc30_.x - -_loc28_ * _loc2_.§=!J§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§?! §.x - _loc30_.y - _loc28_ * _loc2_.§=!J§.x;
               _loc9_ = _loc7_ * _loc36_ + _loc8_ * _loc37_;
               _loc11_ = -_loc2_.§!!G§ * (_loc9_ - _loc2_.§18§);
            ...
            {
               _loc43_ = _loc25_.§ try§[0];
               _loc44_ = _loc25_.§ try§[1];
               _loc45_ = _loc43_.normalImpulse;
               _loc46_ = _loc44_.normalImpulse;
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§?! §.y - _loc30_.x + _loc28_ * _loc43_.§=!J§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§?! §.x - _loc30_.y - _loc28_ * _loc43_.§=!J§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§?! §.y - _loc30_.x + _loc28_ * _loc44_.§=!J§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§?! §.x - _loc30_.y - _loc28_ * _loc44_.§=!J§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§18§;
               _loc54_ = _loc52_ - _loc44_.§18§;
               _loc22_ = _loc25_.§-!5§;
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§-!=§)
         {
            ...
            _loc6_ = _loc4_.§<!L§;
            _loc7_ = _loc5_.§>§ * _loc5_.§+5§;
            _loc8_ = _loc5_.§>§ * _loc5_.§%L§;
            _loc9_ = _loc6_.§>§ * _loc6_.§+5§;
            _loc10_ = _loc6_.§>§ * _loc6_.§%L§;
            §+9§.§#!O§(_loc4_);
            _loc11_ = §+9§.§?!B§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§&n§)
            {
               ...
               _loc20_ = b2Math.§9!%§(param1 * (_loc15_ + b2Settings.b2_linearSlop),-b2Settings.b2_maxLinearCorrection,0);
               _loc22_ = (_loc21_ = -_loc13_.§&!N§ * _loc20_) * _loc11_.x;
