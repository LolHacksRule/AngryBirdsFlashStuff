package §,§
{
   ...
   public class §7!N§
   {
                              ...
                              if(_loc7_ || param3)
                              {
                                 if(!_loc6_)
                                 {
                                    ...
                                    if(this.§0!b§.length <= 0)
                                    {
                                       ...
                                       {
                                          §§push(§!6§);
                                          §§push("WARNING: LevelSlingshot(), slingshot does not have any bird information " + this.§7F§);
                                          if(!_loc6_)
                                          {
                                             §§push(§§pop() + " ");
                                             if(!_loc6_)
      ...
      public function §@!K§() : int
      {
         ...
         for each(_loc2_ in this.§0!b§)
         {
            if(_loc6_)
            {
               ...
               if(!(_loc5_ && _loc2_))
               {
                  §§push(int(§§pop() + §3!!§.§^!-§(_loc2_.name).score));
               }
               _loc1_ = §§pop();
            }
         }
      ...
      public function §!!X§() : void
      {
         ...
         while(true)
         {
            §§push(this.§^!I§.objects.§0P§(this.§!=§,this.§]!U§));
            if(_loc3_)
            {
               §§push(int(§§pop()));
            }
                        ...
                        if(!_loc7_)
                        {
                           if(§§pop())
                           {
                              ...
                              if(§§pop())
                              {
                                 ...
                                 {
                                    addr122:
                                    §§push(Number(Math.sqrt((this.§7F§ - this.§0!b§[_loc2_ + 1].x) * (this.§7F§ - this.§0!b§[_loc2_ + 1].x) + (this.§6_§ - this.§0!b§[_loc2_ + 1].y) * (this.§6_§ - this.§0!b§[_loc2_ + 1].y))));
                                    if(!_loc7_)
                                    {
                                       §§push(§§pop());
                                       if(!_loc7_)
                              ...
                              §§push(Number(Math.sqrt((this.§7F§ - this.§0!b§[_loc2_].x) * (this.§7F§ - this.§0!b§[_loc2_].x) + (this.§6_§ - this.§0!b§[_loc2_].y) * (this.§6_§ - this.§0!b§[_loc2_].y))));
                              if(!_loc7_)
                              {
                                 _loc3_ = §§pop();
                                 if(_loc6_)
               ...
               if(!(_loc4_ && param1))
               {
                  ...
                  while(true)
                  {
                     ...
                     while(true)
                     {
                        ...
                        §§push(§§pop() + §§pop());
                        loop14:
                        for(; _loc3_ || _loc3_; while(_loc3_ || param2)
                        {
                           §§push(§§pop() >= §§pop());
                           if(!_loc4_)
                           {
