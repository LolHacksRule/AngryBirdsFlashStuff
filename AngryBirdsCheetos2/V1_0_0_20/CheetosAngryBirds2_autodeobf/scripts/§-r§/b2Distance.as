package §-r§
{
   ...
   public class b2Distance
   {
      ...
      private static var §"!P§:Vector.<int> = new Vector.<int>(3);
      ...
      public static function §4!-§(param1:b2DistanceOutput, param2:b2SimplexCache, param3:b2DistanceInput) : void
      {
         ...
         var _loc15_:Number;
         var _loc14_:b2Vec2;
         var _loc16_:Number = _loc15_ = (_loc14_ = _loc8_.§!e§()).§0]§();
         var _loc19_:int = 0;
         while(_loc19_ < 20)
         {
            _loc13_ = _loc8_.§ ]§;
            ...
            if((_loc16_ = (_loc18_ = _loc8_.§!e§()).§0]§()) > _loc15_)
            {
            }
            _loc15_ = _loc16_;
         ...
         if(param3.§"_§)
         {
            _loc23_ = _loc4_.§#&§;
            _loc24_ = _loc5_.§#&§;
            if(param1.§8!6§ > _loc23_ + _loc24_ && param1.§8!6§ > Number.MIN_VALUE)
            {
               param1.§8!6§ -= _loc23_ + _loc24_;
               (_loc25_ = b2Math.§=_§(param1.§9R§,param1.§]!<§)).Normalize();
               param1.§]!<§.x += _loc23_ * _loc25_.x;
               param1.§]!<§.y += _loc23_ * _loc25_.y;
               param1.§9R§.x -= _loc24_ * _loc25_.x;
               param1.§9R§.y -= _loc24_ * _loc25_.y;
            }
            else
            {
               (_loc18_ = new b2Vec2()).x = 0.5 * (param1.§]!<§.x + param1.§9R§.x);
               _loc18_.y = 0.5 * (param1.§]!<§.y + param1.§9R§.y);
               param1.§]!<§.x = param1.§9R§.x = _loc18_.x;
               param1.§]!<§.y = param1.§9R§.y = _loc18_.y;
               param1.§8!6§ = 0;
            }
         }
      }
