package §;!#§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§==§.x * this.§%!&§.x + (this.§+!$§ + this.§==§.y) * this.§2d§.x),param1 * (this.§==§.x * this.§%!&§.y + (this.§+!$§ + this.§==§.y) * this.§2d§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§5!R§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§5!R§.col2.x = this.§5!R§.col1.y;
         this.§5!R§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§3!e§)
         {
         ...
         if(param1.§7!^§)
         {
            ...
            this.§==§.y *= param1.§,K§;
            this.§+!$§ *= param1.§,K§;
            _loc19_ = this.§==§.x * this.§%!&§.x + (this.§+!$§ + this.§==§.y) * this.§2d§.x;
            _loc20_ = this.§==§.x * this.§%!&§.y + (this.§+!$§ + this.§==§.y) * this.§2d§.y;
            _loc21_ = this.§==§.x * this.m_s1 + (this.§+!$§ + this.§==§.y) * this.m_a1;
            _loc22_ = this.§==§.x * this.m_s2 + (this.§+!$§ + this.§==§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§2!c§ && this.§,=§ != b2internal::0!F)
         {
            ...
            _loc14_ = this.§>!§ * (this.§`W§ - _loc13_);
            _loc15_ = this.§+!$§;
            _loc16_ = param1.§1_§ * this.§99§;
            this.§+!$§ = b2Math.§9!%§(this.§+!$§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§+!$§ - _loc15_) * this.§2d§.x;
         ...
         if(this.§3!e§ && this.§,=§ != b2internal::9!d)
         {
            ...
            _loc18_ = this.§==§.Copy();
            _loc19_ = this.§5!R§.§ §(new b2Vec2(),-_loc12_,-_loc17_);
            this.§==§.§!!,§(_loc19_);
            if(this.§,=§ == b2internal::'M)
            {
            ...
            {
               this.§==§.y = b2Math.§?I§(this.§==§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§==§.y - _loc18_.y) * this.§5!R§.col2.x;
            if(this.§5!R§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§5!R§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            _loc8_ = _loc19_.x * this.§%!&§.x + _loc19_.y * this.§2d§.x;
            _loc9_ = _loc19_.x * this.§%!&§.y + _loc19_.y * this.§2d§.y;
         ...
         else
         {
            if(this.§5!R§.col1.x != 0)
            {
               _loc22_ = -_loc12_ / this.§5!R§.col1.x;
            }
            else
            {
               _loc22_ = 0;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§3!e§)
         {
            ...
            if(b2Math.§1T§(this.§,I§ - this.§1c§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§9!%§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§1T§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§1c§)
            {
               _loc19_ = b2Math.§9!%§(_loc34_ - this.§1c§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§1c§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§,I§)
            {
               _loc19_ = b2Math.§9!%§(_loc34_ - this.§,I§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§5!R§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§5!R§.col2.x = this.§5!R§.col1.y;
            this.§5!R§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§5!R§.§ §(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::"d;
         ...
         var _loc30_:Number = _loc28_.x * this.§%!&§.x + _loc28_.y * this.§2d§.x;
         var _loc31_:Number = _loc28_.x * this.§%!&§.y + _loc28_.y * this.§2d§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::"d * _loc30_;
         _loc6_.y -= b2internal::"d * _loc31_;
         _loc7_ -= b2internal::^l * _loc32_;
         _loc8_.x += b2internal::1! * _loc30_;
         _loc8_.y += b2internal::1! * _loc31_;
         _loc9_ += b2internal::4!3 * _loc33_;
