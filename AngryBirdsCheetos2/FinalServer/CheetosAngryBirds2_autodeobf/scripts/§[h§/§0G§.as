package §[h§
{
   ...
   public class §0G§
   {
      ...
      public static function §?e§() : String
      {
         ...
         var _loc5_:String;
         return (_loc5_ = §5T§(_loc2_ + _loc4_ + _loc3_ + counter++).toUpperCase()).substring(0,8) + _loc5_.substring(8,12) + _loc5_.substring(12,16) + _loc5_.substring(16,20) + _loc5_.substring(20,32);
      }
      ...
      private static function §>!h§(param1:Array, param2:Number) : Array
      {
         ...
         while(_loc9_ < param1.length)
         {
            ...
            while(_loc15_ < 80)
            {
               ...
               _loc16_ = §"k§(§"k§(§3!+§(_loc4_,5),sha1_ft(_loc15_,_loc5_,_loc6_,_loc7_)),§"k§(§"k§(_loc8_,_loc3_[_loc15_]),sha1_kt(_loc15_)));
               _loc8_ = _loc7_;
               _loc7_ = _loc6_;
               _loc6_ = §3!+§(_loc5_,30);
               _loc5_ = _loc4_;
            ...
            _loc4_ = §"k§(_loc4_,_loc10_);
            _loc5_ = §"k§(_loc5_,_loc11_);
            _loc6_ = §"k§(_loc6_,_loc12_);
            _loc7_ = §"k§(_loc7_,_loc13_);
            _loc8_ = §"k§(_loc8_,_loc14_);
            _loc9_ += 16;
         }
