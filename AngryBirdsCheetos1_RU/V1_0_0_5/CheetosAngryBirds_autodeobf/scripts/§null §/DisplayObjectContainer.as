package §null §
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§4!-§ = new Vector.<DisplayObject>(0);
      }
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         if(param1 >= 0 && param1 < this.numChildren)
         {
            ...
            _loc3_.dispatchEvent(new Event(Event.§2j§,true));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§?y§));
            }
            _loc3_.§8K§(null);
      ...
      public function §9l§(param1:DisplayObject, param2:DisplayObject) : void
      {
         var _loc3_:int = this.getChildIndex(param1);
         ...
         this.§8!7§(_loc3_,_loc4_);
      }
      
      public function §8!7§(param1:int, param2:int) : void
      {
         var _loc3_:DisplayObject = this.getChildAt(param1);
         var _loc4_:DisplayObject = this.getChildAt(param2);
         this.§4!-§[param1] = _loc4_;
         this.§4!-§[param2] = _loc3_;
      }
      
      public function §8S§(param1:Function) : void
      {
         this.§4!-§ = this.§4!-§.sort(param1);
      }
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§4!-§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§4!-§.length;
         if(_loc3_ == 0)
         {
            §7!N§(param1,§>p§);
            transformCoords(§>p§,0,0,§;!+§);
            param2.x = §;!+§.x;
            param2.y = §;!+§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§4!-§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§4!-§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§4!-§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§4!-§[_loc6_];
            §7!N§(_loc7_,§>p§);
            transformCoords(§>p§,_loc3_,_loc4_,§;!+§);
      ...
      override public function render(param1:§7o§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§4!-§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§09§();
               param1.§2!;§(_loc5_);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§95§(this,param1.type,_loc2_);
      ...
      private function §95§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§4!-§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
               this.§95§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
