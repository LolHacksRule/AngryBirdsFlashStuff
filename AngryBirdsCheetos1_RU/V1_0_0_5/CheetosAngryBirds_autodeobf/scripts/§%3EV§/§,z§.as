   ...
   public class §,z§ extends §"!L§
   {
      ...
      protected function §;!C§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§4k§(_loc7_,_loc6_)]) == null)
            {
      ...
      private function §4k§(param1:String, param2:String) : String
      {
      ...
      private function §>!9§(param1:Vector.<XML>) : Dictionary
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§4k§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §=e§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
