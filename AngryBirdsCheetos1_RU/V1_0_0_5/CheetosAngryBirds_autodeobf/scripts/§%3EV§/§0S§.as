package §>V§
{
   ...
   public class §0S§ extends §"!L§
   {
       
      
      public function §0S§(param1:Object, param2:BitmapData)
      {
         super(param2);
         this.§;!C§(param1);
      }
         ...
         for(_loc3_ in param1)
         {
            if(_loc3_.indexOf("chars") == 0)
            {
               ...
               for(_loc5_ in _loc4_)
               {
                  ...
                  (_loc7_ = new §6!T§()).mName = String.fromCharCode(_loc6_.code);
                  _loc7_.§=8§ = new Rectangle(_loc6_.x,_loc6_.y,_loc6_.width,_loc6_.height);
                  _loc7_.§?!J§ = _loc6_.width / 2;
