   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§'K§)
         {
            ...
            this.§;!B§.y *= param1.§0O§;
            this.§;!B§.z *= param1.§0O§;
            _loc4_.§%!N§.x -= _loc10_ * this.§;!B§.x;
            _loc4_.§%!N§.y -= _loc10_ * this.§;!B§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§;!B§.y - _loc7_ * this.§;!B§.x + this.§;!B§.z);
            _loc5_.§%!N§.x += _loc11_ * this.§;!B§.x;
            _loc5_.§%!N§.y += _loc11_ * this.§;!B§.y;
            _loc5_.m_angularVelocity += _loc13_ * (_loc8_ * this.§;!B§.y - _loc9_ * this.§;!B§.x + this.§;!B§.z);
         }
         else
         {
            this.§;!B§.§&N§();
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc16_:Number = _loc5_.m_sweep.a - _loc4_.m_sweep.a - this.§^!7§;
