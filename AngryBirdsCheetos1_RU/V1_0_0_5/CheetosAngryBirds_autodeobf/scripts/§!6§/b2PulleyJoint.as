package §!6§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §2B§:Number = 2;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§+!@§ = b2internal::#4.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§7!0§.x - this.§+!@§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§7!0§.y - this.§+!@§.m_xf.position.y;
         ...
         this.§;!M§ = param1.§#!J§;
         this.§`G§ = param1.§,8§ + this.§;!M§ * param1.§9w§;
         this.m_maxLength1 = b2Math.§>! §(param1.§#O§,this.§`G§ - this.§;!M§ * b2internal::2B);
         this.m_maxLength2 = b2Math.§>! §(param1.§;f§,(this.§`G§ - b2internal::2B) / this.§;!M§);
         this.§;!B§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§;!B§ * this.m_u2.x,param1 * this.§;!B§ * this.m_u2.y);
      }
      ...
      {
         var _loc1_:b2Vec2 = this.§+!@§.m_xf.position.Copy();
         _loc1_.§-!L§(this.m_groundAnchor2);
         return _loc1_;
      }
      
      public function GetLength1() : Number
      {
         var _loc1_:b2Vec2 = b2internal::#4.GetWorldPoint(this.m_localAnchor1);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§`G§ - _loc18_ - this.§;!M§ * _loc19_) > 0)
         {
            this.§4W§ = b2internal::@D;
            this.§;!B§ = 0;
         }
         else
         {
            this.§4W§ = b2internal::#2;
         }
         ...
         this.m_limitMass1 = _loc2_.§^!^§ + _loc2_.§^U§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§^!^§ + _loc3_.§^U§ * _loc22_ * _loc22_;
         this.§+V§ = this.m_limitMass1 + this.§;!M§ * this.§;!M§ * this.m_limitMass2;
         ...
         {
            this.§;!B§ *= param1.§0O§;
            this.m_limitImpulse1 *= param1.§0O§;
            this.m_limitImpulse2 *= param1.§0O§;
            _loc23_ = (-this.§;!B§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§;!B§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§;!M§ * this.§;!B§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§;!M§ * this.§;!B§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§%!N§.x += _loc2_.§^!^§ * _loc23_;
            _loc2_.§%!N§.y += _loc2_.§^!^§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§^U§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§%!N§.x += _loc3_.§^!^§ * _loc25_;
            _loc3_.§%!N§.y += _loc3_.§^!^§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§^U§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§;!B§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§4W§ == b2internal::#2)
         {
            ...
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§;!M§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§+V§ * -_loc18_;
            _loc20_ = this.§;!B§;
            this.§;!B§ = b2Math.§]!Z§(0,this.§;!B§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§;!B§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§;!M§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§;!M§ * _loc19_ * this.m_u2.y;
            _loc2_.§%!N§.x += _loc2_.§^!^§ * _loc14_;
            _loc2_.§%!N§.y += _loc2_.§^!^§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§^U§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§%!N§.x += _loc3_.§^!^§ * _loc16_;
            _loc3_.§%!N§.y += _loc3_.§^!^§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§^U§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.m_limitState1 == b2internal::#2)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§!!K§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::#2)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§!!K§()) > b2Settings.b2_linearSlop)
            {
