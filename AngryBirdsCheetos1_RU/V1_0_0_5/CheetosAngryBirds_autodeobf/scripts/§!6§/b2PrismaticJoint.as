package §!6§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§;!B§.x * this.§8!I§.x + (this.§'!S§ + this.§;!B§.z) * this.§%'§.x),param1 * (this.§;!B§.x * this.§8!I§.y + (this.§'!S§ + this.§;!B§.z) * this.§%'§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§4!S§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§4!S§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§4!S§.col2.x = this.§4!S§.col1.y;
         this.§4!S§.col2.y = _loc16_ + _loc17_;
         this.§4!S§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§4!S§.col3.x = this.§4!S§.col1.z;
         this.§4!S§.col3.y = this.§4!S§.col2.z;
         this.§4!S§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§0!&§)
         {
         ...
         if(param1.§'K§)
         {
            ...
            this.§;!B§.y *= param1.§0O§;
            this.§'!S§ *= param1.§0O§;
            _loc19_ = this.§;!B§.x * this.§8!I§.x + (this.§'!S§ + this.§;!B§.z) * this.§%'§.x;
            _loc20_ = this.§;!B§.x * this.§8!I§.y + (this.§'!S§ + this.§;!B§.z) * this.§%'§.y;
            _loc21_ = this.§;!B§.x * this.m_s1 + this.§;!B§.y + (this.§'!S§ + this.§;!B§.z) * this.m_a1;
            _loc22_ = this.§;!B§.x * this.m_s2 + this.§;!B§.y + (this.§'!S§ + this.§;!B§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§%=§ && this.§4!W§ != b2internal::4!O)
         {
            ...
            _loc16_ = this.§'!S§;
            _loc17_ = param1.§=S§ * this.§6!X§;
            this.§'!S§ = b2Math.§ !`§(this.§'!S§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§'!S§ - _loc16_) * this.§%'§.x;
         ...
         if(this.§0!&§ && this.§4!W§ != b2internal::@D)
         {
            ...
            _loc19_ = this.§;!B§.Copy();
            _loc20_ = this.§4!S§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§;!B§.§-!L§(_loc20_);
            if(this.§4!W§ == b2internal::3!L)
            {
               this.§;!B§.z = b2Math.§]!Z§(this.§;!B§.z,0);
            }
            else if(this.§4!W§ == b2internal::#2)
            {
               this.§;!B§.z = b2Math.§>! §(this.§;!B§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§;!B§.z - _loc19_.z) * this.§4!S§.col3.x;
            _loc22_ = -_loc13_ - (this.§;!B§.z - _loc19_.z) * this.§4!S§.col3.y;
            _loc23_ = this.§4!S§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§;!B§.x = _loc23_.x;
            this.§;!B§.y = _loc23_.y;
            _loc20_.x = this.§;!B§.x - _loc19_.x;
            _loc20_.y = this.§;!B§.y - _loc19_.y;
            _loc20_.z = this.§;!B§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§8!I§.x + _loc20_.z * this.§%'§.x;
            _loc9_ = _loc20_.x * this.§8!I§.y + _loc20_.z * this.§%'§.y;
         ...
         {
            _loc24_ = this.§4!S§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§;!B§.x += _loc24_.x;
            this.§;!B§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§8!I§.x;
            _loc9_ = _loc24_.x * this.§8!I§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§0!&§)
         {
            ...
            {
               _loc19_ = b2Math.§ !`§(_loc35_ - this.§@T§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§@T§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§8C§)
            {
               _loc19_ = b2Math.§ !`§(_loc35_ - this.§8C§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§8C§;
               _loc18_ = true;
            }
         }
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§-O§;
         ...
         if(_loc18_)
         {
            ...
            this.§4!S§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§4!S§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§4!S§.col2.x = this.§4!S§.col1.y;
            this.§4!S§.col2.y = _loc14_ + _loc15_;
            this.§4!S§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§4!S§.col3.x = this.§4!S§.col1.z;
            this.§4!S§.col3.y = this.§4!S§.col2.z;
            this.§4!S§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§4!S§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::1!^;
            ...
            this.§4!S§.col1.Set(_loc36_,_loc37_,0);
            this.§4!S§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§4!S§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§8!I§.x + _loc28_.z * this.§%'§.x;
         var _loc32_:Number = _loc28_.x * this.§8!I§.y + _loc28_.z * this.§%'§.y;
         ...
         _loc7_ -= b2internal::2!T * _loc33_;
         _loc8_.x += b2internal::7[ * _loc31_;
         _loc8_.y += b2internal::7[ * _loc32_;
         _loc9_ += b2internal::8!X * _loc34_;
