package §;k§
{
   ...
   public class §[§
   {
      ...
      public static const §!!F§:String = "InitialiseSession";
      
      public static const §<j§:String = "GetActiveLevels";
      
      public static const §@!6§:String = "GetActiveSpotPrize";
      
      public static const §#@§:String = "LevelStart";
      
      public static const §!G§:String = "PurchasePowerUp";
      
      public static const §&h§:String = "UseFreePlay";
      
      public static const §!!$§:String = "UpdateSpotPrizeWin";
      
      public static const §`_§:String = "LevelComplete";
      ...
      private static const §]&§:String = "32cc4dd7e526830db25794f997c305e82ea80dc5";
      
      private static const §4!%§:int = 500;
       
      
      public function §[§(param1:Object, param2:String, param3:§2!L§, param4:String)
      {
         super();
         ...
         switch(param4)
         {
            case §'! §:
               ...
               _loc6_.data = §8!_§.encode(param1);
               break;
            case §;p§:
               _loc6_.data = this.§8!3§(param1);
         }
      ...
      public static function §5e§(param1:Object) : String
      {
         return §92§(param1);
      }
      
      private static function §"!C§(param1:*, param2:int = 0) : void
      {
         var _loc4_:* = null;
         for(_loc4_ in param1)
         {
            §"!C§(param1[_loc4_],param2 + 1);
         }
      }
      
      public static function §92§(param1:Object) : String
      {
      ...
      public static function §class§(param1:String) : String
      {
         return §!!Y§.§ +§([param1,§;!K§.§+!K§.§'!9§,§]&§].join("|"));
      }
      
      public static function §=!§(param1:String, param2:Number, param3:Number) : String
      {
         return §#0§(param1,param2,param3);
      }
      
      public static function §#0§(param1:String, param2:Number, param3:Number) : String
      {
         var _loc4_:Array;
         (_loc4_ = []).push(param2);
         _loc4_.push(param3);
