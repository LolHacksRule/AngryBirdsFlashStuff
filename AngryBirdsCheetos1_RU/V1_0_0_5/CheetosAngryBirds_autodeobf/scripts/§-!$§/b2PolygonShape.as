package §-!$§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §=C§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §=Y§:b2Vec2;
      
      b2internal var §try§:Vector.<b2Vec2>;
      
      b2internal var §?O§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         §&D§ = b2internal::0D;
         this.§=Y§ = new b2Vec2();
         this.§try§ = new Vector.<b2Vec2>();
         this.§?O§ = new Vector.<b2Vec2>();
         each = b2Settings.b2_polygonRadius;
         this.§=Y§.§&N§();
      }
      
      public static function §1b§(param1:Array, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§3R§(param1,param2);
         return _loc3_;
      }
      
      public static function §1%§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§1Y§(param1,param2);
         return _loc3_;
      }
      
      public static function §6!U§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§return§(param1,param2);
         return _loc3_;
      }
      ...
      public static function §4![§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         ...
         (_loc5_ = new b2PolygonShape()).§=!I§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §3F§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§5G§(param1,param2);
         return _loc3_;
      }
      
      public static function §6!#§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
      ...
      b2internal static function §=p§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§'a§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§'a§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            while(_loc3_ < this.§^Z§)
            {
               this.§try§[_loc3_].SetV(_loc2_.§try§[_loc3_]);
               this.§?O§[_loc3_].SetV(_loc2_.§?O§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §3R§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§1Y§(_loc3_,param2);
      }
      
      public function §1Y§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§^Z§)
         {
            this.§try§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§^Z§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§^Z§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§,!!§(this.§try§[_loc5_],this.§try§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§`!C§() > Number.MIN_VALUE);
            this.§?O§[_loc3_].SetV(b2Math.§5q§(_loc6_,1));
            this.§?O§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§=Y§ = §6!#§(this.§try§,this.§^Z§);
      }
      ...
      public function §return§(param1:Number, param2:Number) : void
      {
         this.§^Z§ = 4;
         this.§,g§(4);
         this.§try§[0].Set(-param1,-param2);
         this.§try§[1].Set(param1,-param2);
         this.§try§[2].Set(param1,param2);
         this.§try§[3].Set(-param1,param2);
         this.§?O§[0].Set(0,-1);
         this.§?O§[1].Set(1,0);
         this.§?O§[2].Set(0,1);
         this.§?O§[3].Set(-1,0);
      ...
      public function §=!I§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§^Z§ = 4;
         this.§,g§(4);
         this.§try§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§^Z§)
         {
            this.§try§[_loc6_] = b2Math.§8v§(_loc5_,this.§try§[_loc6_]);
            this.§?O§[_loc6_] = b2Math.§#N§(_loc5_.R,this.§?O§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §5G§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§^Z§ = 2;
         this.§,g§(2);
         this.§try§[0].SetV(param1);
         this.§try§[1].SetV(param2);
         this.§=Y§.x = 0.5 * (param1.x + param2.x);
         this.§=Y§.y = 0.5 * (param1.y + param2.y);
         this.§?O§[0] = b2Math.§5q§(b2Math.§,!!§(param2,param1),1);
         this.§?O§[0].Normalize();
         this.§?O§[1].x = -this.§?O§[0].x;
         this.§?O§[1].y = -this.§?O§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§^Z§)
         {
            _loc6_ = (_loc9_ = this.§try§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§?O§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§]!@§.x = _loc5_ - b2internal::each;
         param1.§]!@§.y = _loc6_ - b2internal::each;
         param1.§=H§.x = _loc7_ + b2internal::each;
         param1.§=H§.y = _loc8_ + b2internal::each;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§^Z§ == 2)
         {
            param1.center.x = 0.5 * (this.§try§[0].x + this.§try§[1].x);
            param1.center.y = 0.5 * (this.§try§[0].y + this.§try§[1].y);
            param1.§0t§ = 0;
            param1.§0!+§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§^Z§)
         {
            _loc11_ = this.§try§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§^Z§ ? this.§try§[int(_loc10_ + 1)] : this.§try§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§0t§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§0!+§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§@G§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§^Z§)
         {
            _loc7_[_loc12_] = b2Math.§@G§(_loc5_,this.§try§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§8v§(param3,_loc24_.center));
                  return _loc24_.§0t§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§^Z§;
         var _loc14_:int = (_loc10_ + 1) % this.§^Z§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§try§[_loc9_].x * (1 - _loc15_) + this.§try§[_loc13_].x * _loc15_,this.§try§[_loc9_].y * (1 - _loc15_) + this.§try§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§try§[_loc10_].x * (1 - _loc16_) + this.§try§[_loc14_].x * _loc16_,this.§try§[_loc10_].y * (1 - _loc16_) + this.§try§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§try§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§^Z§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§try§[_loc12_];
            }
         ...
         _loc20_.§!!T§(1 / _loc19_);
         param4.SetV(b2Math.§8v§(param3,_loc20_));
         return _loc19_;
      }
      ...
      {
         var _loc2_:int = this.§try§.length;
         while(_loc2_ < param1)
         {
            this.§try§[_loc2_] = new b2Vec2();
            this.§?O§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
