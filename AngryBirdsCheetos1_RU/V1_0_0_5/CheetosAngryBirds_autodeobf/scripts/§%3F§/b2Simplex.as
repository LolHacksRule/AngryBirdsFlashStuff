package §?§
{
   ...
   class b2Simplex
   {
      ...
      public var §try§:Vector.<b2SimplexVertex>;
      ...
      function b2Simplex()
      {
         ...
         this.§try§ = new Vector.<b2SimplexVertex>(3);
         super();
         this.§try§[0] = this.m_v1;
         this.§try§[1] = this.m_v2;
         this.§try§[2] = this.m_v3;
      }
      ...
      public function §=!?§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         this.§&w§ = param1.count;
         var _loc8_:Vector.<b2SimplexVertex> = this.§try§;
         var _loc9_:int = 0;
         while(_loc9_ < this.§&w§)
         {
            (_loc10_ = _loc8_[_loc9_]).indexA = param1.indexA[_loc9_];
            _loc10_.indexB = param1.indexB[_loc9_];
            _loc6_ = param2.§4<§(_loc10_.indexA);
            _loc7_ = param4.§4<§(_loc10_.indexB);
            _loc10_.§9! § = b2Math.§8v§(param3,_loc6_);
            _loc10_.§2=§ = b2Math.§8v§(param5,_loc7_);
            _loc10_.§,!<§ = b2Math.§,!!§(_loc10_.§2=§,_loc10_.§9! §);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§&w§ > 1)
         {
            _loc11_ = param1.§@!Y§;
            if((_loc12_ = this.§8!'§()) < 0.5 * _loc11_ || 2 * _loc11_ < _loc12_ || _loc12_ < Number.MIN_VALUE)
            {
               this.§&w§ = 0;
            }
         }
      ...
      public function §4!3§(param1:b2SimplexCache) : void
      {
         param1.§@!Y§ = this.§8!'§();
         param1.count = uint(this.§&w§);
         var _loc2_:Vector.<b2SimplexVertex> = this.§try§;
         var _loc3_:int = 0;
         while(_loc3_ < this.§&w§)
         {
      ...
      public function §4M§() : b2Vec2
      {
         ...
         switch(this.§&w§)
         {
            case 1:
               return this.m_v1.§,!<§.§19§();
            case 2:
               _loc1_ = b2Math.§,!!§(this.m_v2.§,!<§,this.m_v1.§,!<§);
               _loc2_ = b2Math.§<!R§(_loc1_,this.m_v1.§,!<§.§19§());
               if(_loc2_ > 0)
               {
                  return b2Math.§,!P§(1,_loc1_);
               }
               return b2Math.§5q§(_loc1_,1);
               break;
            default:
      ...
      public function §8f§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§&w§)
         {
            case 0:
            ...
            case 1:
               ...
               param2.SetV(this.m_v1.§2=§);
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§9! §.x + this.m_v2.a * this.m_v2.§9! §.x;
               param1.y = this.m_v1.a * this.m_v1.§9! §.y + this.m_v2.a * this.m_v2.§9! §.y;
               param2.x = this.m_v1.a * this.m_v1.§2=§.x + this.m_v2.a * this.m_v2.§2=§.x;
               param2.y = this.m_v1.a * this.m_v1.§2=§.y + this.m_v2.a * this.m_v2.§2=§.y;
               break;
            case 3:
               param2.x = param1.x = this.m_v1.a * this.m_v1.§9! §.x + this.m_v2.a * this.m_v2.§9! §.x + this.m_v3.a * this.m_v3.§9! §.x;
               param2.y = param1.y = this.m_v1.a * this.m_v1.§9! §.y + this.m_v2.a * this.m_v2.§9! §.y + this.m_v3.a * this.m_v3.§9! §.y;
               break;
            default:
               b2Settings.b2Assert(false);
         }
      ...
      public function §8!'§() : Number
      {
         switch(this.§&w§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§,!!§(this.m_v1.§,!<§,this.m_v2.§,!<§).§!!K§();
            case 3:
               return b2Math.§<!R§(b2Math.§,!!§(this.m_v2.§,!<§,this.m_v1.§,!<§),b2Math.§,!!§(this.m_v3.§,!<§,this.m_v1.§,!<§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc5_:Number = b2Math.§@G§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§@G§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§,!!§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§@G§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§@G§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§,!!§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§@G§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§@G§(_loc3_,_loc14_);
