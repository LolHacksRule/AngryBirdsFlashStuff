package §?§
{
   ...
   class b2SeparationFunction
   {
      ...
      public var §2!F§:b2DistanceProxy;
      ...
      public function §+!R§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§&D§ = §3![§;
            _loc7_ = this.§^m§.§4<§(param1.indexA[0]);
            _loc10_ = this.§2!F§.§4<§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§&D§ = §[,§;
            _loc8_ = this.§^m§.§4<§(param1.indexA[0]);
            _loc9_ = this.§^m§.§4<§(param1.indexA[1]);
            _loc10_ = this.§2!F§.§4<§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§%'§ = b2Math.§5q§(b2Math.§,!!§(_loc9_,_loc8_),1);
            this.§%'§.Normalize();
            _loc20_ = this.§%'§;
         ...
         {
            this.§&D§ = §&<§;
            _loc11_ = this.§2!F§.§4<§(param1.indexB[0]);
            _loc12_ = this.§2!F§.§4<§(param1.indexB[1]);
            _loc7_ = this.§^m§.§4<§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§%'§ = b2Math.§5q§(b2Math.§,!!§(_loc12_,_loc11_),1);
            this.§%'§.Normalize();
            _loc20_ = this.§%'§;
         ...
         else
         {
            ...
            _loc11_ = this.§2!F§.§4<§(param1.indexB[0]);
            _loc12_ = this.§2!F§.§4<§(param1.indexB[1]);
            _loc23_ = b2Math.§8v§(param3,_loc7_);
            _loc24_ = b2Math.§#N§(param3.R,b2Math.§,!!§(_loc9_,_loc8_));
            _loc25_ = b2Math.§8v§(param5,_loc10_);
            _loc26_ = b2Math.§#N§(param5.R,b2Math.§,!!§(_loc12_,_loc11_));
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         switch(this.§&D§)
         {
            case §3![§:
               ...
               _loc4_ = b2Math.§[! §(param2.R,this.§%'§.§19§());
               _loc5_ = this.§^m§.§,;§(_loc3_);
               _loc6_ = this.§2!F§.§,;§(_loc4_);
               _loc7_ = b2Math.§8v§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§8v§(param2,_loc6_)).x - _loc7_.x) * this.§%'§.x + (_loc8_.y - _loc7_.y) * this.§%'§.y);
            case §[,§:
               _loc10_ = b2Math.§#N§(param1.R,this.§%'§);
               _loc7_ = b2Math.§8v§(param1,this.m_localPoint);
               _loc4_ = b2Math.§[! §(param2.R,_loc10_.§19§());
               _loc6_ = this.§2!F§.§,;§(_loc4_);
               return Number(((_loc8_ = b2Math.§8v§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §&<§:
               _loc10_ = b2Math.§#N§(param2.R,this.§%'§);
               _loc8_ = b2Math.§8v§(param2,this.m_localPoint);
               _loc3_ = b2Math.§[! §(param1.R,_loc10_.§19§());
               _loc5_ = this.§^m§.§,;§(_loc3_);
               return Number(((_loc7_ = b2Math.§8v§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
