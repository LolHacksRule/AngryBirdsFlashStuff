package §?§
{
   ...
   public class b2TimeOfImpact
   {
      ...
      private static var §0!N§:b2DistanceInput = new b2DistanceInput();
      
      private static var §9!N§:b2Transform = new b2Transform();
      
      private static var §]0§:b2Transform = new b2Transform();
      
      private static var §%!9§:b2SeparationFunction = new b2SeparationFunction();
      
      private static var §21§:b2DistanceOutput = new b2DistanceOutput();
      ...
      public static function §;!#§(param1:b2TOIInput) : Number
      {
         ...
         do
         {
            ...
            §0!N§.§@]§ = §9!N§;
            §0!N§.§ K§ = §]0§;
            b2Distance.§2!M§(§21§,§`+§,§0!N§);
            if(§21§.§"i§ <= 0)
            {
               _loc8_ = 1;
               break;
            }
            §%!9§.§+!R§(§`+§,_loc2_,§9!N§,_loc3_,§]0§);
            if((_loc12_ = §%!9§.Evaluate(§9!N§,§]0§)) <= 0)
            {
               _loc8_ = 1;
               break;
            }
            ...
            _loc4_.§@#§(§9!N§,_loc15_);
            _loc5_.§@#§(§]0§,_loc15_);
            if((_loc17_ = §%!9§.Evaluate(§9!N§,§]0§)) >= _loc11_)
            {
               _loc8_ = 1;
               break;
            }
