package §?§
{
   ...
   public class b2Collision
   {
      ...
      private static var §6!S§:Vector.<§?u§> = §?!Z§();
      
      private static var s_clipPoints1:Vector.<§?u§> = §?!Z§();
      
      private static var s_clipPoints2:Vector.<§?u§> = §?!Z§();
      
      private static var §8!K§:Vector.<int> = new Vector.<int>(1);
      ...
      private static var §6!_§:b2Vec2 = new b2Vec2();
      ...
      public static function §7!3§(param1:Vector.<§?u§>, param2:Vector.<§?u§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§?u§ = null;
         var _loc6_:int = 0;
      ...
      public static function §`w§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§^Z§;
         var _loc7_:Vector.<b2Vec2> = param1.§try§;
         var _loc8_:Vector.<b2Vec2> = param1.§?O§;
         var _loc9_:int = param4.§^Z§;
         var _loc10_:Vector.<b2Vec2> = param4.§try§;
         _loc11_ = param2.R;
      ...
      public static function §-i§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param2.§?O§;
         _loc9_ = param5.R;
         _loc8_ = param4.§=Y§;
         ...
         var _loc17_:Number = §`w§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §`w§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §`w§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §`w§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §+!T§(param1:Vector.<§?u§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param2.§?O§;
         var _loc9_:int = param5.§^Z§;
         var _loc10_:Vector.<b2Vec2> = param5.§try§;
         var _loc11_:Vector.<b2Vec2> = param5.§?O§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§2X§.§2!H§ = param4;
         _loc20_.id.§2X§.§@q§ = _loc21_;
         _loc20_.id.§2X§.§;i§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§2X§.§2!H§ = param4;
         _loc20_.id.§2X§.§@q§ = _loc22_;
         _loc20_.id.§2X§.§;i§ = 1;
      }
      
      private static function §?!Z§() : Vector.<§?u§>
      {
         var _loc1_:Vector.<§?u§> = new Vector.<§?u§>(2);
         _loc1_[0] = new §?u§();
         _loc1_[1] = new §?u§();
         return _loc1_;
      }
      ...
      public static function §'!"§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         param1.§6!G§ = 0;
         var _loc7_:Number = param2.each + param4.each;
         var _loc8_:int = 0;
         §8!K§[0] = _loc8_;
         var _loc9_:Number = §-i§(§8!K§,param2,param3,param4,param5);
         _loc8_ = §8!K§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §;!9§[0] = _loc10_;
         var _loc11_:Number = §-i§(§;!9§,param4,param5,param2,param3);
         _loc10_ = §;!9§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §5!@§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §>5§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §&!D§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §6!_§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§?u§> = s_clipPoints1;
         var _loc38_:Vector.<§?u§> = s_clipPoints2;
         if((_loc39_ = §7!3§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §7!3§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§]o§.SetV(_loc27_);
      ...
      public static function §#e§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.each + param4.each;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§&D§ = b2Manifold.§2A§;
         param1.m_localPoint.SetV(param2.§0k§);
         param1.§]o§.§&N§();
         param1.§6!G§ = 1;
         param1.§,O§[0].m_localPoint.SetV(param4.§0k§);
      ...
      public static function § L§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.each + param4.each;
         var _loc21_:int = param2.§^Z§;
         var _loc22_:Vector.<b2Vec2> = param2.§try§;
         var _loc23_:Vector.<b2Vec2> = param2.§?O§;
         var _loc24_:int = 0;
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§6!G§ = 1;
            param1.§&D§ = b2Manifold.§[,§;
            param1.§]o§.x = _loc15_ - _loc28_.x;
            param1.§]o§.y = _loc16_ - _loc28_.y;
            param1.§]o§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§,O§[0].m_localPoint.SetV(param4.§0k§);
            param1.§,O§[0].m_id.key = 0;
      ...
      public static function §@!Z§(param1:b2AABB, param2:b2AABB) : Boolean
      {
