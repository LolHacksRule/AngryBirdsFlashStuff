package §?§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §6B§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
      ...
      public function §!!0§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         var _loc4_:Number = NaN;
         var _loc5_:Number = NaN;
         b2Settings.b2Assert(param1.§6!&§());
         if(param1.aabb.§8!L§(param2))
         {
            return false;
         }
         this.§[T§(param1);
      ...
      public function §8!]§(param1:Function, param2:b2AABB) : void
      {
         ...
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§@!Z§(param2))
            {
               if(_loc5_.§6!&§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§@!Z§(_loc9_) != false)
            {
      ...
      private function §3!I§() : b2DynamicTreeNode
      {
      ...
      private function §]J§(param1:b2DynamicTreeNode) : void
      {
         ...
         (_loc5_ = this.§3!I§()).parent = _loc4_;
         _loc5_.§=!<§ = null;
         _loc5_.aabb.§7!P§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            while(!_loc4_.aabb.§8!L§(_loc5_.aabb))
            {
               _loc4_.aabb.§7!P§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
      ...
      private function §[T§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc5_ = _loc3_.aabb;
               _loc3_.aabb = b2AABB.§7!P§(_loc3_.child1.aabb,_loc3_.child2.aabb);
               if(_loc5_.§8!L§(_loc3_.aabb))
               {
                  break;
               }
