package §0C§
{
   ...
   public class §>e§
   {
      ...
      public function §7K§(param1:String) : int
      {
      ...
      public function §6!2§(param1:String) : String
      {
         var _loc4_:int = 0;
      ...
      public function set §9!C§(param1:String) : void
      {
         this.§+3§ = param1;
      }
