package §-A§
{
   ...
   public class Texture
   {
      ...
      {
         return §=!S§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §=!S§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §-A§.Texture
      {
      ...
      public static function §0`§(param1:Context3D, param2:ByteArray) : §-A§.Texture
      {
         if(param1 == null)
         {
            throw new §%!1§();
      ...
      public static function §7!E§(param1:§-A§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §-A§.Texture
      {
         var _loc4_:§-A§.Texture;
         (_loc4_ = new §[!F§(param1,param2)).§?!T§ = param3;
         return _loc4_;
      }
      
      public static function §9!8§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §-A§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§-A§.Texture = §=!S§(param1,_loc6_,false,param5);
         if(!§!F§.§^!J§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§20§, param2:int, param3:int) : void
      {
         ...
         if(this.§?!T§)
         {
            ...
            _loc4_ = this.§?!T§.width + this.§?!T§.x - this.width;
            _loc5_ = this.§?!T§.height + this.§?!T§.y - this.height;
            param1.§=$§(param2,-this.§?!T§.x,-this.§?!T§.y);
            param1.§=$§(param2 + 1,-_loc4_,-this.§?!T§.y);
            param1.§=$§(param2 + 2,-this.§?!T§.x,-_loc5_);
      ...
      {
         return !!this.§?!T§ ? this.§?!T§.clone() : new Rectangle(0,0,this.width,this.height);
      }
