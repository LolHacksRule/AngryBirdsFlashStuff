package §?!H§
{
   ...
   public class § c§
   {
         ...
         for each(_loc2_ in param1.Shape)
         {
            if(_loc2_.@shape == "CIRCLE" || _loc2_.@shape == "POLYGON" || _loc2_.@shape == "NONE")
            {
               ...
               if(_loc4_ == "CIRCLE")
               {
                  ...
                  §2y§(_loc3_,_loc4_,_loc7_,_loc5_);
               }
               else
               {
            ...
            else
            {
               ...
               §1!N§(_loc2_.@id,_loc2_.@shape,_loc2_.@width,_loc2_.@height,_loc2_.@flipAngleCorrection);
            }
         }
      }
      
      public static function §1!N§(param1:String, param2:String, param3:Number, param4:Number, param5:Number) : void
      {
      ...
      {
         var _loc5_:§?U§;
         (_loc5_ = new §?U§(param1,param2,-1,-1,param4)).§#!-§(param3);
         _loc5_.§!!9§();
         §@!=§[§@!=§.length] = _loc5_;
      }
      
      public static function §2y§(param1:String, param2:String, param3:Number, param4:Array) : void
      {
         var _loc5_:§?U§;
         (_loc5_ = new §?U§(param1,param2,param3,param3)).§#!-§(param4);
         §@!=§[§@!=§.length] = _loc5_;
      }
      
      public static function §<!7§(param1:String) : §?U§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §@!=§.length)
         {
