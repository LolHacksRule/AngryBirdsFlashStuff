package §^!5§
{
   ...
   public class § set§
   {
      ...
      private function §'f§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§7!I§(param1 as String);
         }
         if(param1 is Number)
         {
      ...
      private function §7!I§(param1:String) : String
      {
      ...
      private function §]b§(param1:Array) : String
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§'f§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §2!0§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§7!I§(v.@name.toString()) + ":" + this.§'f§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
