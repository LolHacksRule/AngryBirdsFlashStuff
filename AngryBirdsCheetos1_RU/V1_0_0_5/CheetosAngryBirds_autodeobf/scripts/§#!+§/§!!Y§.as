package §#!+§
{
   ...
   public class §!!Y§
   {
      ...
      public static function § +§(param1:String) : String
      {
         ...
         return §#!Z§.§<X§(_loc3_.readInt(),true) + §#!Z§.§<X§(_loc3_.readInt(),true) + §#!Z§.§<X§(_loc3_.readInt(),true) + §#!Z§.§<X§(_loc3_.readInt(),true) + §#!Z§.§<X§(_loc3_.readInt(),true);
      }
      ...
      public static function §7!B§(param1:String) : String
      {
         var _loc7_:uint = 0;
