package §+,§
{
   public class b2Vec2
   {
      ...
      public static function §&!4§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §0!_§(param1:b2Vec2) : void
      {
         this.x -= param1.x;
         this.y -= param1.y;
      }
      ...
      public function §9A§(param1:b2Mat22) : void
      {
      ...
      public function §2!P§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§@G§(this,param1.col1);
         this.y = b2Math.§@G§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      {
         return b2Math.§;e§(this.x) && b2Math.§;e§(this.y);
      }
   }
}
