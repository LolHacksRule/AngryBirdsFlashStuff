package §^q§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§4!%§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §4w§(param1:Number) : Boolean
      {
         return isFinite(param1);
      }
      
      public static function §2P§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §1p§(param1:b2Vec2, param2:Number) : b2Vec2
      {
      ...
      {
         return new b2Vec2(§2P§(param2,param1.col1),§2P§(param2,param1.col2));
      }
      
      public static function §1L§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §5!&§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         ...
         _loc3_ = §#!F§(param2,param1.position);
      ...
      public static function §>w§(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§4!%§(§]f§(param1.col1,param2.col1),§]f§(param1.col2,param2.col2));
      }
      
      public static function §^!$§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§4!%§(§!X§(param1,param2.col1),§!X§(param1,param2.col2));
      }
      
      public static function §]§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§2P§(param1.col1,param2.col1),§2P§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§2P§(param1.col1,param2.col2),§2P§(param1.col2,param2.col2));
      ...
      public static function §0!b§(param1:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§"§(param1.x),§"§(param1.y));
      }
      
      public static function §1Z§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§4!%§(§0!b§(param1.col1),§0!b§(param1.col2));
      }
      
      public static function §33§(param1:Number, param2:Number) : Number
      {
         return param1 < param2 ? Number(param1) : Number(param2);
      }
      
      public static function §22§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§33§(param1.x,param2.x),§33§(param1.y,param2.y));
      }
      ...
      public static function §in§(param1:Number, param2:Number, param3:Number) : Number
      {
      ...
      {
         return §,!J§(param2,§22§(param1,param3));
      }
      
      public static function §[j§(param1:Array, param2:Array) : void
      {
         var _loc3_:* = param1[0];
         param1[0] = param2[0];
         param2[0] = _loc3_;
      ...
      public static function §5!9§(param1:Number, param2:Number) : Number
      {
