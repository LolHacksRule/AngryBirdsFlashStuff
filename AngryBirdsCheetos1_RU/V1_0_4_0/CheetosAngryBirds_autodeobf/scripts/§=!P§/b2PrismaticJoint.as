package §=!P§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§8!R§.x * this.§+!&§.x + (this.§6!`§ + this.§8!R§.z) * this.§#§.x),param1 * (this.§8!R§.x * this.§+!&§.y + (this.§6!`§ + this.§8!R§.z) * this.§#§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§3!S§)
         {
            ...
            this.§6!`§ *= param1.§8B§;
            _loc19_ = this.§8!R§.x * this.§+!&§.x + (this.§6!`§ + this.§8!R§.z) * this.§#§.x;
            _loc20_ = this.§8!R§.x * this.§+!&§.y + (this.§6!`§ + this.§8!R§.z) * this.§#§.y;
            _loc21_ = this.§8!R§.x * this.m_s1 + this.§8!R§.y + (this.§6!`§ + this.§8!R§.z) * this.m_a1;
            _loc22_ = this.§8!R§.x * this.m_s2 + this.§8!R§.y + (this.§6!`§ + this.§8!R§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§@g§ && this.§^V§ != b2internal::&9)
         {
            ...
            _loc15_ = this.§;!&§ * (this.§9F§ - _loc14_);
            _loc16_ = this.§6!`§;
            _loc17_ = param1.§7!H§ * this.§8!4§;
            this.§6!`§ = b2Math.§in§(this.§6!`§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§6!`§ - _loc16_) * this.§#§.x;
         ...
         if(this.§ g§ && this.§^V§ != b2internal::@+)
         {
            ...
            _loc19_ = this.§8!R§.Copy();
            _loc20_ = this.§<! §.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§8!R§.§9&§(_loc20_);
            if(this.§^V§ == b2internal:: %)
            {
               this.§8!R§.z = b2Math.§`a§(this.§8!R§.z,0);
            }
            else if(this.§^V§ == b2internal::-I)
            {
               this.§8!R§.z = b2Math.§33§(this.§8!R§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§8!R§.z - _loc19_.z) * this.§<! §.col3.x;
            _loc22_ = -_loc13_ - (this.§8!R§.z - _loc19_.z) * this.§<! §.col3.y;
            _loc23_ = this.§<! §.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§8!R§.x = _loc23_.x;
            this.§8!R§.y = _loc23_.y;
            _loc20_.x = this.§8!R§.x - _loc19_.x;
            _loc20_.y = this.§8!R§.y - _loc19_.y;
            _loc20_.z = this.§8!R§.z - _loc19_.z;
         ...
         else
         {
            ...
            this.§8!R§.x += _loc24_.x;
            this.§8!R§.y += _loc24_.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§ g§)
         {
            ...
            if(b2Math.§"§(this.§'J§ - this.§'%§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§in§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§"§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§'%§)
            {
               _loc19_ = b2Math.§in§(_loc35_ - this.§'%§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§'%§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§'J§)
            {
               _loc19_ = b2Math.§in§(_loc35_ - this.§'J§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§0A§;
