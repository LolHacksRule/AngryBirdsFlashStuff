package §[!E§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if(0 <= _loc15_ && _loc15_ <= param2.§%K§ * _loc13_)
         {
            _loc15_ /= _loc13_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§?J§.Set(_loc4_ - b2internal::9@,_loc5_ - b2internal::9@);
         param1.§@9§.Set(_loc4_ + b2internal::9@,_loc5_ + b2internal::9@);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§-!9§ = param2 * b2Settings.b2_pi * b2internal::9@ * b2internal::9@;
         param1.center.SetV(this.§"! §);
         param1.§#I§ = param1.§-!9§ * (0.5 * b2internal::9@ * b2internal::9@ + (this.§"! §.x * this.§"! §.x + this.§"! §.y * this.§"! §.y));
      }
      
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         var _loc9_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§1L§(param3,this.§"! §);
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.§2P§(param1,_loc5_) - param2)) < -b2internal::9@ + Number.MIN_VALUE)
         {
            return 0;
         }
