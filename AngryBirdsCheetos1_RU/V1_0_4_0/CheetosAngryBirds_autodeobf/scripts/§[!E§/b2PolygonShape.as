package §[!E§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §;Q§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §]C§:b2Vec2;
      
      b2internal var §class§:Vector.<b2Vec2>;
      
      b2internal var §@E§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         §3;§ = b2internal::+4;
         this.§]C§ = new b2Vec2();
         this.§class§ = new Vector.<b2Vec2>();
         this.§@E§ = new Vector.<b2Vec2>();
         §9@§ = b2Settings.b2_polygonRadius;
         this.§]C§.§0q§();
      }
      ...
      public static function §00§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§`!@§(param1,param2);
         return _loc3_;
      ...
      public static function §4!T§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §-!M§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§9&§(new b2Vec2(0,0));
            _loc3_.§9&§(_loc9_);
            _loc3_.§9&§(_loc10_);
            _loc3_.§=v§(_loc16_ * _loc7_);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §&0§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§1!G§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§1!G§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            while(_loc3_ < this.§[8§)
            {
               this.§class§[_loc3_].SetV(_loc2_.§class§[_loc3_]);
               this.§@E§[_loc3_].SetV(_loc2_.§@E§[_loc3_]);
               _loc3_++;
            }
         }
      }
      ...
      public function §!! §(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§5!P§(_loc3_,param2);
      }
      
      public function §5!P§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§[8§)
         {
            this.§class§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§[8§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§[8§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§#!F§(this.§class§[_loc5_],this.§class§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§ X§() > Number.MIN_VALUE);
            this.§@E§[_loc3_].SetV(b2Math.§1p§(_loc6_,1));
            this.§@E§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§]C§ = §-!M§(this.§class§,this.§[8§);
      }
      ...
      public function §`!@§(param1:Number, param2:Number) : void
      {
         this.§[8§ = 4;
         this.§#!?§(4);
         this.§class§[0].Set(-param1,-param2);
         this.§class§[1].Set(param1,-param2);
         this.§class§[2].Set(param1,param2);
         this.§class§[3].Set(-param1,param2);
         this.§@E§[0].Set(0,-1);
         this.§@E§[1].Set(1,0);
         this.§@E§[2].Set(0,1);
         this.§@E§[3].Set(-1,0);
      ...
      public function §2^§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§[8§)
         {
            this.§class§[_loc6_] = b2Math.§1L§(_loc5_,this.§class§[_loc6_]);
            this.§@E§[_loc6_] = b2Math.§!X§(_loc5_.R,this.§@E§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §]!0§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§[8§ = 2;
         this.§#!?§(2);
         this.§class§[0].SetV(param1);
         this.§class§[1].SetV(param2);
         this.§]C§.x = 0.5 * (param1.x + param2.x);
         this.§]C§.y = 0.5 * (param1.y + param2.y);
         this.§@E§[0] = b2Math.§1p§(b2Math.§#!F§(param2,param1),1);
         this.§@E§[0].Normalize();
         this.§@E§[1].x = -this.§@E§[0].x;
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         while(_loc9_ < this.§[8§)
         {
            _loc3_ = this.§class§[_loc9_];
            _loc5_ = _loc7_ - _loc3_.x;
            _loc6_ = _loc8_ - _loc3_.y;
            _loc3_ = this.§@E§[_loc9_];
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§[8§)
         {
            _loc6_ = (_loc9_ = this.§class§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§@E§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         var _loc4_:b2Vec2 = this.§class§[0];
         ...
         param1.§?J§.x = _loc5_ - b2internal::9@;
         param1.§?J§.y = _loc6_ - b2internal::9@;
         param1.§@9§.x = _loc7_ + b2internal::9@;
         param1.§@9§.y = _loc8_ + b2internal::9@;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§[8§ == 2)
         {
            param1.center.x = 0.5 * (this.§class§[0].x + this.§class§[1].x);
            param1.center.y = 0.5 * (this.§class§[0].y + this.§class§[1].y);
            param1.§-!9§ = 0;
            param1.§#I§ = 0;
            return;
         }
         ...
         var _loc6_:Number = 0;
         var _loc10_:int = 0;
         while(_loc10_ < this.§[8§)
         {
            _loc11_ = this.§class§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§[8§ ? this.§class§[int(_loc10_ + 1)] : this.§class§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§2P§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§2P§(_loc5_,this.§class§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§1L§(param3,_loc24_.center));
                  return _loc24_.§-!9§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§[8§;
         var _loc14_:int = (_loc10_ + 1) % this.§[8§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§class§[_loc9_].x * (1 - _loc15_) + this.§class§[_loc13_].x * _loc15_,this.§class§[_loc9_].y * (1 - _loc15_) + this.§class§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§class§[_loc10_].x * (1 - _loc16_) + this.§class§[_loc14_].x * _loc16_,this.§class§[_loc10_].y * (1 - _loc16_) + this.§class§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§class§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§[8§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§class§[_loc12_];
            }
         ...
         _loc20_.§=v§(1 / _loc19_);
         param4.SetV(b2Math.§1L§(param3,_loc20_));
         return _loc19_;
      }
      ...
      {
         var _loc2_:int = this.§class§.length;
         while(_loc2_ < param1)
         {
            this.§class§[_loc2_] = new b2Vec2();
            this.§@E§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
