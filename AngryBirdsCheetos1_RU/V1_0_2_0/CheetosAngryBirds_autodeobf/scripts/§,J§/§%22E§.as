package §,J§
{
   ...
   public class §"E§
   {
      ...
      private function §"@§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§&!N§(param1 as String);
         }
         if(param1 is Number)
         {
         ...
         if(param1 is Array)
         {
            return this.§3!Y§(param1 as Array);
         }
      ...
      private function §&!N§(param1:String) : String
      {
      ...
      private function §3!Y§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§&!N§(v.@name.toString()) + ":" + this.§"@§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
