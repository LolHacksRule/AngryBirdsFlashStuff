package §!!7§
{
   ...
   public class §@A§
   {
      ...
      public static function §@!2§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §!v§(_loc2_);
         return §0!C§.§3Q§(_loc3_.readInt(),true) + §0!C§.§3Q§(_loc3_.readInt(),true) + §0!C§.§3Q§(_loc3_.readInt(),true) + §0!C§.§3Q§(_loc3_.readInt(),true) + §0!C§.§3Q§(_loc3_.readInt(),true);
      }
      
      public static function §15§(param1:ByteArray) : String
      {
      ...
      private static function §!v§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
