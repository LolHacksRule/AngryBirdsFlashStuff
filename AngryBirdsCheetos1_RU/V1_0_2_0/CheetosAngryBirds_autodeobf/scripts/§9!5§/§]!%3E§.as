package §9!5§
{
   ...
   public class §]!>§
   {
      ...
      public static const §2T§:String = "easeInOutElastic";
      
      public static const §+!?§:String = "easeOutInElastic";
      
      public static const §>a§:String = "easeInBounce";
      
      public static const §8f§:String = "easeOutBounce";
      
      public static const §7!L§:String = "easeInOutBounce";
      ...
      private static function §]T§() : void
      {
         ...
         §=M§(§=Y§,easeInElastic);
         §=M§(§=;§,easeOutElastic);
         §=M§(§2T§,easeInOutElastic);
         §=M§(§+!?§,easeOutInElastic);
         §=M§(§>a§,easeInBounce);
         §=M§(§8f§,easeOutBounce);
         §=M§(§7!L§,easeInOutBounce);
         §=M§(§'!<§,easeOutInBounce);
      }
