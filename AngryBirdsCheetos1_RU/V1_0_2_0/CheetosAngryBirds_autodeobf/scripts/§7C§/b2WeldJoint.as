package §7C§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc7_ = this.§'!D§.y - _loc4_.m_sweep.localCenter.y;
         ...
         if(param1.§3j§)
         {
            ...
            this.§[!8§.y *= param1.§'7§;
            this.§[!8§.z *= param1.§'7§;
            _loc4_.§5+§.x -= _loc10_ * this.§[!8§.x;
            _loc4_.§5+§.y -= _loc10_ * this.§[!8§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§[!8§.y - _loc7_ * this.§[!8§.x + this.§[!8§.z);
            _loc5_.§5+§.x += _loc11_ * this.§[!8§.x;
            _loc5_.§5+§.y += _loc11_ * this.§[!8§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc5_:b2Body = b2internal::[L;
         _loc2_ = _loc4_.m_xf.R;
         var _loc6_:Number = this.§'!D§.x - _loc4_.m_sweep.localCenter.x;
         ...
         var _loc19_:Number = b2Math.§+Q§(_loc16_);
         if(_loc18_ > _loc17_)
         {
            _loc12_ *= 1;
            _loc13_ *= 1;
