package §7C§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§'"§ = b2internal::@6.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§7!S§.x - this.§'"§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§7!S§.y - this.§'"§.m_xf.position.y;
         ...
         this.m_maxLength1 = b2Math.§6!9§(param1.§%u§,this.§-!@§ - this.§-!!§ * b2internal::-!7);
         this.m_maxLength2 = b2Math.§6!9§(param1.§8J§,(this.§-!@§ - b2internal::-!7) / this.§-!!§);
         this.§[!8§ = 0;
      ...
      {
         var _loc1_:b2Vec2 = b2internal::@6.GetWorldPoint(this.m_localAnchor1);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.m_limitMass1 = _loc2_.§=!P§ + _loc2_.§`!6§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§=!P§ + _loc3_.§`!6§ * _loc22_ * _loc22_;
         ...
         if(param1.§3j§)
         {
            ...
            _loc2_.§5+§.x += _loc2_.§=!P§ * _loc23_;
            _loc2_.§5+§.y += _loc2_.§=!P§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§`!6§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§5+§.x += _loc3_.§=!P§ * _loc25_;
            _loc3_.§5+§.y += _loc3_.§=!P§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§#!+§ == b2internal::;!-)
         {
            _loc10_ = _loc2_.§5+§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§5+§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§5+§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§5+§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§-!!§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§ B§ * -_loc18_;
            _loc20_ = this.§[!8§;
            this.§[!8§ = b2Math.§+!]§(0,this.§[!8§ + _loc19_);
            ...
            _loc2_.§5+§.x += _loc2_.§=!P§ * _loc14_;
            _loc2_.§5+§.y += _loc2_.§=!P§ * _loc15_;
