package §7C§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§[!8§.x * this.§[T§.x + (this.§7!>§ + this.§[!8§.y) * this.§@^§.x),param1 * (this.§[!8§.x * this.§[T§.y + (this.§7!>§ + this.§[!8§.y) * this.§@^§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§9W§ = this.§9W§ > Number.MIN_VALUE ? Number(1 / this.§9W§) : Number(0);
         ...
         if(param1.§3j§)
         {
            ...
            this.§[!8§.y *= param1.§'7§;
            this.§7!>§ *= param1.§'7§;
            _loc19_ = this.§[!8§.x * this.§[T§.x + (this.§7!>§ + this.§[!8§.y) * this.§@^§.x;
            _loc20_ = this.§[!8§.x * this.§[T§.y + (this.§7!>§ + this.§[!8§.y) * this.§@^§.y;
            _loc21_ = this.§[!8§.x * this.m_s1 + (this.§7!>§ + this.§[!8§.y) * this.m_a1;
            _loc22_ = this.§[!8§.x * this.m_s2 + (this.§7!>§ + this.§[!8§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§!!;§ && this.§@w§ != b2internal::5a)
         {
            ...
            _loc14_ = this.§9W§ * (this.§;H§ - _loc13_);
            _loc15_ = this.§7!>§;
            _loc16_ = param1.§2!2§ * this.§7;§;
            this.§7!>§ = b2Math.§5!%§(this.§7!>§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§7!>§ - _loc15_) * this.§@^§.x;
         ...
         if(this.§"M§ && this.§@w§ != b2internal::+!2)
         {
            ...
            _loc18_ = this.§[!8§.Copy();
            _loc19_ = this.§^!!§.§#!E§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§[!8§.§#H§(_loc19_);
            if(this.§@w§ == b2internal::=D)
            {
            ...
            {
               this.§[!8§.y = b2Math.§6!9§(this.§[!8§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§[!8§.y - _loc18_.y) * this.§^!!§.col2.x;
            if(this.§^!!§.col1.x != 0)
            {
            ...
            _loc8_ = _loc19_.x * this.§[T§.x + _loc19_.y * this.§@^§.x;
            _loc9_ = _loc19_.x * this.§[T§.y + _loc19_.y * this.§@^§.y;
         ...
         else
         {
            ...
            this.§[!8§.x += _loc22_;
            _loc8_ = _loc22_ * this.§[T§.x;
            _loc9_ = _loc22_ * this.§[T§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§"M§)
         {
            ...
            if(b2Math.§+Q§(this.§6W§ - this.§97§) < 2 * b2Settings.b2_linearSlop)
            {
               ...
               _loc16_ = b2Math.§+Q§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§97§)
            {
               _loc19_ = b2Math.§5!%§(_loc34_ - this.§97§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§97§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§6W§)
            {
               _loc19_ = b2Math.§5!%§(_loc34_ - this.§6W§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§6W§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§^!!§.§#!E§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::>Y;
         ...
         var _loc30_:Number = _loc28_.x * this.§[T§.x + _loc28_.y * this.§@^§.x;
         var _loc31_:Number = _loc28_.x * this.§[T§.y + _loc28_.y * this.§@^§.y;
         ...
         _loc7_ -= b2internal::>Q * _loc32_;
         _loc8_.x += b2internal::7Y * _loc30_;
         _loc8_.y += b2internal::7Y * _loc31_;
