package §&!+§
{
   public class b2Math
   {
      ...
      public static function §0!B§(param1:Number) : Boolean
      {
      ...
      public static function §?I§(param1:b2Vec2, param2:Number) : b2Vec2
      {
      ...
      public static function §4k§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §3!K§(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§`!A§(§#'§(param1.col1,param2.col1),§#'§(param1.col2,param2.col2));
      }
      
      public static function §-q§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§`!A§(§4k§(param1,param2.col1),§4k§(param1,param2.col2));
      }
      ...
      {
         return new b2Vec2(§+Q§(param1.x),§+Q§(param1.y));
      }
      
      public static function §`4§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§`!A§(§%!%§(param1.col1),§%!%§(param1.col2));
      }
      
      public static function §6!9§(param1:Number, param2:Number) : Number
      {
      ...
      {
         return new b2Vec2(§6!9§(param1.x,param2.x),§6!9§(param1.y,param2.y));
      }
      ...
      {
         return §@!A§(param2,§ !Y§(param1,param3));
      }
      ...
      public static function §0Y§() : Number
      {
      ...
      public static function §=2§(param1:uint) : uint
      {
      ...
      public static function §,z§(param1:uint) : Boolean
      {
