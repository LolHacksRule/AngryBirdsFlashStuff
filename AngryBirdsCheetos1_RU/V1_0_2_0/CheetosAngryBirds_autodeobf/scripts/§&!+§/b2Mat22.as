package §&!+§
{
   public class b2Mat22
   {
      ...
      public static function §9u§(param1:Number) : b2Mat22
      {
      ...
      public function §2!7§(param1:b2Mat22) : void
      {
         this.col1.SetV(param1.col1);
         this.col2.SetV(param1.col2);
      }
      
      public function §1!^§(param1:b2Mat22) : void
      {
      ...
      public function §<t§(param1:b2Mat22) : b2Mat22
      {
      ...
      public function §#!E§(param1:b2Vec2, param2:Number, param3:Number) : b2Vec2
      {
