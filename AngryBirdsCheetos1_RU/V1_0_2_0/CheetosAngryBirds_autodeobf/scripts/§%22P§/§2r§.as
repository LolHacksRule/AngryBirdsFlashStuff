package §"P§
{
   ...
   public class §2r§
   {
      ...
      {
         §2<§[§2<§.length] = new §%w§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13);
      }
      
      public static function §0w§(param1:String) : §%w§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §2<§.length)
         {
            if(§%w§(§2<§[_loc2_]).mName.toLowerCase() == param1.toLowerCase())
            {
               return §%w§(§2<§[_loc2_]);
            }
            _loc2_++;
