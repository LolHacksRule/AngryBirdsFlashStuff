package §"P§
{
   ...
   public class §8m§
   {
      ...
      public static function §@X§(param1:XMLList, param2:XMLList, param3:XMLList) : void
      {
         var _loc4_:XML = null;
         §1z§ = new Array();
      ...
      {
         §1z§[§1z§.length] = new §,!I§(param1,param2,param3,param4,param5,param6,param7,param8);
      }
      
      public static function §6!Y§(param1:String) : §,!I§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §1z§.length)
         {
            if((§1z§[_loc2_] as §,!I§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §,!I§(§1z§[_loc2_]);
            }
            _loc2_++;
