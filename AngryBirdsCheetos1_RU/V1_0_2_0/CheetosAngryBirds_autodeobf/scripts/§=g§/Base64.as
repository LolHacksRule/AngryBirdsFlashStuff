package §=g§
{
   ...
   public class Base64
   {
      ...
      private static const §2,§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §9g§(param1:ByteArray) : String
      {
      ...
      public static function § !G§(param1:String) : ByteArray
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §2,§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
