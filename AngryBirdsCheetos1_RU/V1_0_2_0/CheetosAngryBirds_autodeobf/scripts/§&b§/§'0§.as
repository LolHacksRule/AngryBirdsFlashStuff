package §&b§
{
   ...
   public class §'0§
   {
      ...
      public static const § !O§:uint = 16711680;
      ...
      public static const §8!6§:uint = 32896;
      ...
      public static const §2!B§:uint = 8388736;
      ...
      public static function §3!V§(param1:uint) : int
      {
      ...
      public static function §&!J§(param1:int, param2:int, param3:int) : uint
      {
         return param1 << 16 | param2 << 8 | param3;
      }
      
      public static function §0!a§(param1:int, param2:int, param3:int, param4:int) : uint
      {
