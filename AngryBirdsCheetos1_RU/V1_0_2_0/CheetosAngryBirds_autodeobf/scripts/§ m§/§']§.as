package § m§
{
   ...
   public class §']§ extends §#!>§
   {
      ...
      public static function §0!&§(param1:§#!>§) : §']§
      {
         var _loc2_:§']§ = new §']§(param1.type,param1.index1,param1.index2,param1.point1,param1.point2,param1.§"u§,param1.§%T§,param1.lowerLimit,param1.upperLimit,param1.§<!?§,param1.motorSpeed,param1.§]p§,param1.maxTorque);
         _loc2_.§&e§ = param1.§&e§;
