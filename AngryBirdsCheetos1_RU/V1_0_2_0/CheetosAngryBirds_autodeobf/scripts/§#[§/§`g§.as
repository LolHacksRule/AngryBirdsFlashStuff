package §#[§
{
   public class §`g§
   {
      ...
      public static function §#!6§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
      ...
      private static function §19§(param1:String, param2:Boolean) : String
      {
