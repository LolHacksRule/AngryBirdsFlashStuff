package §<!^§
{
   ...
   public class b2Collision
   {
      ...
      private static var §=!a§:Vector.<§<S§> = §9!G§();
      
      private static var s_clipPoints1:Vector.<§<S§> = §9!G§();
      
      private static var s_clipPoints2:Vector.<§<S§> = §9!G§();
      
      private static var §6S§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §1!R§(param1:Vector.<§<S§>, param2:Vector.<§<S§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§<S§ = null;
         var _loc6_:int = 0;
      ...
      public static function §;X§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param1.§while§;
         var _loc8_:Vector.<b2Vec2> = param1.§?!9§;
         var _loc9_:int = param4.§<§;
         var _loc10_:Vector.<b2Vec2> = param4.§while§;
         _loc11_ = param2.R;
      ...
      public static function §#f§(param1:Vector.<§<S§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc10_:Vector.<b2Vec2> = param5.§while§;
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§]?§.§=H§ = param4;
         _loc20_.id.§]?§.§8!H§ = _loc22_;
         _loc20_.id.§]?§.§<!Y§ = 1;
      }
      
      private static function §9!G§() : Vector.<§<S§>
      {
      ...
      public static function §]§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §6S§[0] = _loc8_;
         var _loc9_:Number = §8!5§(§6S§,param2,param3,param4,param5);
         _loc8_ = §6S§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §+5§[0] = _loc10_;
         var _loc11_:Number = §8!5§(§+5§,param4,param5,param2,param3);
         _loc10_ = §+5§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §&V§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         ...
         if((_loc39_ = §1!R§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §1!R§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§=-§.SetV(_loc27_);
      ...
      public static function §]S§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc22_:Vector.<b2Vec2> = param2.§while§;
      ...
      public static function §]g§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§5I§;
         var _loc4_:b2Vec2 = param1.§9m§;
