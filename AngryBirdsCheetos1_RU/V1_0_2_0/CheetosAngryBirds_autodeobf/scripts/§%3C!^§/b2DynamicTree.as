package §<!^§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §-!>§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
         ...
         _loc3_.aabb.§5I§.x = param1.§5I§.x - _loc4_;
         _loc3_.aabb.§5I§.y = param1.§5I§.y - _loc5_;
         _loc3_.aabb.§9m§.x = param1.§9m§.x + _loc4_;
         _loc3_.aabb.§9m§.y = param1.§9m§.y + _loc5_;
         _loc3_.§3_§ = param2;
         this.§]!!§(_loc3_);
         return _loc3_;
      }
      
      public function §2x§(param1:b2DynamicTreeNode) : void
      {
         this.§!! §(param1);
         this.§<!"§(param1);
      }
      ...
      public function §4[§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         ...
         param1.aabb.§5I§.x = param2.§5I§.x - _loc4_;
         param1.aabb.§5I§.y = param2.§5I§.y - _loc5_;
         param1.aabb.§9m§.x = param2.§9m§.x + _loc4_;
         param1.aabb.§9m§.y = param2.§9m§.y + _loc5_;
         this.§]!!§(param1);
         return true;
      }
      ...
      public function §9!F§(param1:b2DynamicTreeNode) : b2AABB
      {
         return param1.aabb;
      }
      ...
      public function §=G§(param1:Function, param2:b2AABB) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc7_:*;
         _loc3_[_loc7_ = _loc4_++] = this.§!!M§;
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§]g§(param2))
            {
               if(_loc5_.§'Q§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc5_:b2Vec2;
         (_loc5_ = b2Math.§+w§(_loc3_,_loc4_)).Normalize();
         var _loc6_:b2Vec2 = b2Math.§@!7§(1,_loc5_);
         var _loc7_:b2Vec2 = b2Math.§%!%§(_loc6_);
         var _loc8_:Number = param2.§<!H§;
         _loc9_ = new b2AABB();
         _loc10_ = _loc3_.x + _loc8_ * (_loc4_.x - _loc3_.x);
         _loc11_ = _loc3_.y + _loc8_ * (_loc4_.y - _loc3_.y);
         _loc9_.§5I§.x = Math.min(_loc3_.x,_loc10_);
         _loc9_.§5I§.y = Math.min(_loc3_.y,_loc11_);
         _loc9_.§9m§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§9m§.y = Math.max(_loc3_.y,_loc11_);
         ...
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§]g§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§8_§();
               _loc16_ = _loc14_.aabb.§4U§();
      ...
      private function §2+§() : b2DynamicTreeNode
      {
      ...
      private function §]!!§(param1:b2DynamicTreeNode) : void
      {
         ...
         var _loc2_:b2Vec2 = param1.aabb.§8_§();
         ...
         if(_loc3_.§'Q§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§5I§.x + _loc6_.aabb.§9m§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§5I§.y + _loc6_.aabb.§9m§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§5I§.x + _loc7_.aabb.§9m§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§5I§.y + _loc7_.aabb.§9m§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         if(_loc4_)
         {
            ...
            while(!_loc4_.aabb.§3!Z§(_loc5_.aabb))
            {
