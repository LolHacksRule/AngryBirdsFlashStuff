package §<!^§
{
   ...
   public class b2TimeOfImpact
   {
      ...
      private static var § R§:b2SimplexCache = new b2SimplexCache();
      
      private static var §1!K§:b2DistanceInput = new b2DistanceInput();
      ...
      public static function §0!O§(param1:b2TOIInput) : Number
      {
         ...
         b2Settings.b2Assert(_loc4_.§6L§ == _loc5_.§6L§);
         b2Settings.b2Assert(1 - _loc4_.§6L§ > Number.MIN_VALUE);
         var _loc6_:Number = _loc2_.§!!&§ + _loc3_.§!!&§;
         var _loc7_:Number = param1.§4A§;
         var _loc8_:Number = 0;
         var _loc10_:int = 0;
         ...
         do
         {
            ...
            §!i§.§1U§(§ R§,_loc2_,§-@§,_loc3_,§]K§);
            if((_loc12_ = §!i§.Evaluate(§-@§,§]K§)) <= 0)
            {
               _loc8_ = 1;
               break;
            }
            ...
            _loc16_ = _loc12_;
            _loc4_.§3!H§(§-@§,_loc15_);
            _loc5_.§3!H§(§]K§,_loc15_);
            if((_loc17_ = §!i§.Evaluate(§-@§,§]K§)) >= _loc11_)
            {
               _loc8_ = 1;
               break;
            }
            ...
            do
            {
               ...
               _loc4_.§3!H§(§-@§,_loc19_);
               _loc5_.§3!H§(§]K§,_loc19_);
               _loc20_ = §!i§.Evaluate(§-@§,§]K§);
               if(b2Math.§+Q§(_loc20_ - _loc11_) < 0.025 * _loc7_)
               {
                  _loc13_ = _loc19_;
                  break;
               }
