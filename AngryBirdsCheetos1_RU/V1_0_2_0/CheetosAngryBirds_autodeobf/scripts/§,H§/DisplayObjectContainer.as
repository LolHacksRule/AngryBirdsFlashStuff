package §,H§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private var §4!D§:Vector.<DisplayObject>;
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§4!D§ = new Vector.<DisplayObject>(0);
      }
      
      override public function dispose() : void
      {
         var _loc1_:int = this.§4!D§.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            this.§4!D§[_loc2_].dispose();
            _loc2_++;
         }
         super.dispose();
      }
      ...
      public function addChildAt(param1:DisplayObject, param2:int) : void
      {
         ...
         {
            param1.§@J§();
            this.§4!D§.splice(param2,0,param1);
            param1.§#u§(this);
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§4!D§[param1];
            _loc3_.dispatchEvent(new Event(Event.§'j§,true));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§6!R§));
            }
            _loc3_.§#u§(null);
            this.§4!D§.splice(param1,1);
            if(param2)
            {
               _loc3_.dispose();
            }
      ...
      public function §>1§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      {
         var _loc2_:int = this.§4!D§.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            if(this.§4!D§[_loc3_].name == param1)
            {
               return this.§4!D§[_loc3_];
            }
            _loc3_++;
         }
         return null;
      ...
      {
         return this.§4!D§.indexOf(param1);
      }
      ...
      public function §=!&§(param1:int, param2:int) : void
      {
         ...
         this.§4!D§[param1] = _loc4_;
         this.§4!D§[param2] = _loc3_;
      }
      
      public function §2n§(param1:Function) : void
      {
         this.§4!D§ = this.§4!D§.sort(param1);
      }
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§4!D§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§4!D§.length;
         if(_loc3_ == 0)
         {
            §implements§(param1,§ g§);
            transformCoords(§ g§,0,0,§81§);
            param2.x = §81§.x;
            param2.y = §81§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§4!D§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§4!D§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§4!D§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§4!D§[_loc6_];
            §implements§(_loc7_,§ g§);
            transformCoords(§ g§,_loc3_,_loc4_,§81§);
            if(_loc8_ = _loc7_.hitTest(§81§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§@9§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§4!D§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§"B§();
               param1.§[!"§(_loc5_);
      ...
      public function §80§(param1:Event) : void
      {
         if(param1.bubbles)
         {
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§[H§(this,param1.type,_loc2_);
      ...
      private function §[H§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§4!D§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
               this.§[H§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
