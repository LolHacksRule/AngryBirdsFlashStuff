package § y§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      b2internal var §while§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         §"!V§ = b2internal::7F;
         this.§'2§ = new b2Vec2();
         this.§while§ = new Vector.<b2Vec2>();
         this.§?!9§ = new Vector.<b2Vec2>();
         §!!&§ = b2Settings.b2_polygonRadius;
         this.§'2§.§8Q§();
      }
      
      public static function §>c§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function §+q§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §2t§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      b2internal static function §7!§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§9L§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§9L§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            while(_loc3_ < this.§<§)
            {
               this.§while§[_loc3_].SetV(_loc2_.§while§[_loc3_]);
      ...
      public function §#K§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§<§)
         {
            this.§while§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§<§)
         {
            ...
            _loc6_ = b2Math.§+w§(this.§while§[_loc5_],this.§while§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§,=§() > Number.MIN_VALUE);
            this.§?!9§[_loc3_].SetV(b2Math.§?I§(_loc6_,1));
            this.§?!9§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§'2§ = §`!#§(this.§while§,this.§<§);
      }
      ...
      public function §]H§(param1:Number, param2:Number) : void
      {
         this.§<§ = 4;
         this.§3!I§(4);
         this.§while§[0].Set(-param1,-param2);
         this.§while§[1].Set(param1,-param2);
         this.§while§[2].Set(param1,param2);
         this.§while§[3].Set(-param1,param2);
         this.§?!9§[0].Set(0,-1);
         this.§?!9§[1].Set(1,0);
         this.§?!9§[2].Set(0,1);
         this.§?!9§[3].Set(-1,0);
      ...
      public function §'E§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§<§)
         {
            this.§while§[_loc6_] = b2Math.§,d§(_loc5_,this.§while§[_loc6_]);
            this.§?!9§[_loc6_] = b2Math.§4k§(_loc5_.R,this.§?!9§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §'R§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§<§ = 2;
         this.§3!I§(2);
         this.§while§[0].SetV(param1);
         this.§while§[1].SetV(param2);
         this.§'2§.x = 0.5 * (param1.x + param2.x);
         this.§'2§.y = 0.5 * (param1.y + param2.y);
         this.§?!9§[0] = b2Math.§?I§(b2Math.§+w§(param2,param1),1);
         this.§?!9§[0].Normalize();
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         while(_loc17_ < this.§<§)
         {
            _loc6_ = (_loc9_ = this.§while§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         var _loc4_:b2Vec2 = this.§while§[0];
         ...
         param1.§5I§.x = _loc5_ - b2internal::!!&;
         param1.§5I§.y = _loc6_ - b2internal::!!&;
         param1.§9m§.x = _loc7_ + b2internal::!!&;
         param1.§9m§.y = _loc8_ + b2internal::!!&;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§<§ == 2)
         {
            param1.center.x = 0.5 * (this.§while§[0].x + this.§while§[1].x);
            param1.center.y = 0.5 * (this.§while§[0].y + this.§while§[1].y);
            param1.§>i§ = 0;
            param1.§0K§ = 0;
            return;
         }
         ...
         while(_loc10_ < this.§<§)
         {
            _loc11_ = this.§while§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§<§ ? this.§while§[int(_loc10_ + 1)] : this.§while§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§>i§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§0K§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         while(_loc12_ < this.§<§)
         {
            _loc7_[_loc12_] = b2Math.§9`§(_loc5_,this.§while§[_loc12_]) - _loc6_;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§while§[_loc9_].x * (1 - _loc15_) + this.§while§[_loc13_].x * _loc15_,this.§while§[_loc9_].y * (1 - _loc15_) + this.§while§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§while§[_loc10_].x * (1 - _loc16_) + this.§while§[_loc14_].x * _loc16_,this.§while§[_loc10_].y * (1 - _loc16_) + this.§while§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§while§[_loc13_];
         _loc12_ = _loc13_;
      ...
      public function §#E§() : Vector.<b2Vec2>
      {
         return this.§?!9§;
      }
      
      public function §12§(param1:b2Vec2) : int
      {
      ...
      private function §3!I§(param1:int) : void
      {
         var _loc2_:int = this.§while§.length;
         while(_loc2_ < param1)
         {
            this.§while§[_loc2_] = new b2Vec2();
