package §#J§
{
   ...
   public class §#5§
   {
      ...
      public static function §#c§() : String
      {
         ...
         var _loc5_:String;
         return (_loc5_ = §42§(_loc2_ + _loc4_ + _loc3_ + counter++).toUpperCase()).substring(0,8) + _loc5_.substring(8,12) + _loc5_.substring(12,16) + _loc5_.substring(16,20) + _loc5_.substring(20,32);
      }
      
      private static function §42§(param1:String) : String
      {
         return §0!I§(param1);
      }
      
      private static function §0!I§(param1:String) : String
      {
         return §]!<§(§8-§(§,u§(param1),param1.length * 8));
      }
      ...
      private static function §8-§(param1:Array, param2:Number) : Array
      {
         ...
         while(_loc9_ < param1.length)
         {
            ...
            while(_loc15_ < 80)
            {
               ...
               {
                  _loc3_[_loc15_] = §@!<§(_loc3_[_loc15_ - 3] ^ _loc3_[_loc15_ - 8] ^ _loc3_[_loc15_ - 14] ^ _loc3_[_loc15_ - 16],1);
               }
               _loc16_ = §7!E§(§7!E§(§@!<§(_loc4_,5),sha1_ft(_loc15_,_loc5_,_loc6_,_loc7_)),§7!E§(§7!E§(_loc8_,_loc3_[_loc15_]),sha1_kt(_loc15_)));
               _loc8_ = _loc7_;
               _loc7_ = _loc6_;
               _loc6_ = §@!<§(_loc5_,30);
               _loc5_ = _loc4_;
      ...
      private static function §@!<§(param1:Number, param2:Number) : Number
      {
