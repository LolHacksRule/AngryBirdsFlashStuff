package §3!,§
{
   ...
   public class §41§ extends § e§
   {
       
      
      public function §41§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
      ...
      protected function §5Q§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         var _loc16_:§8!3§ = null;
         var _loc3_:Dictionary = this.§^D§(param2);
      ...
      private function §^D§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            for each(_loc6_ in _loc5_)
            {
               ...
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §4y§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
