package §'!#§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §1h§:b2PositionSolverManifold = new b2PositionSolverManifold();
       
      
      private var §-t§:b2TimeStep;
      
      private var §-!`§;
      
      b2internal var §=!N§:Vector.<b2ContactConstraint>;
      
      private var §]!#§:int;
      
      public function b2ContactSolver()
      {
         this.§-t§ = new b2TimeStep();
         this.§=!N§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §;!W§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§-!`§ = param4;
         this.§]!#§ = param3;
         while(this.§=!N§.length < this.§]!#§)
         {
            this.§=!N§[this.§=!N§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§8!7§;
            _loc10_ = _loc5_.§86§;
            _loc11_ = _loc9_.§1!O§;
            _loc12_ = _loc10_.§1!O§;
            _loc13_ = _loc11_.§!R§;
            ...
            _loc20_ = _loc15_.§2!G§.x;
            _loc21_ = _loc15_.§2!G§.y;
            _loc22_ = _loc16_.§2!G§.x;
            _loc23_ = _loc16_.§2!G§.y;
            _loc24_ = _loc15_.m_angularVelocity;
            _loc25_ = _loc16_.m_angularVelocity;
            b2Settings.b2Assert(_loc17_.§+!K§ > 0);
            §#!0§.§;!W§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §#!0§.§`!!§.x;
            _loc27_ = §#!0§.§`!!§.y;
            (_loc28_ = this.§=!N§[_loc6_]).§#1§ = _loc15_;
            _loc28_.§"!<§ = _loc16_;
            _loc28_.§?Q§ = _loc17_;
            ...
            _loc28_.§,3§.x = _loc17_.§[R§.x;
            _loc28_.§,3§.y = _loc17_.§[R§.y;
            ...
            {
               _loc30_ = _loc17_.§^G§[_loc29_];
               (_loc31_ = _loc28_.§7T§[_loc29_]).normalImpulse = _loc30_.§;L§;
               _loc31_.tangentImpulse = _loc30_.§2f§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§9!@§.x = §#!0§.§^G§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§9!@§.y = §#!0§.§^G§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§4+§.x = §#!0§.§^G§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§4+§.y = §#!0§.§^G§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§-q§ + _loc16_.§-q§ + _loc15_.§'a§ * _loc36_ + _loc16_.§'a§ * _loc37_;
               _loc31_.§;g§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§"n§ * _loc15_.§-q§ + _loc16_.§"n§ * _loc16_.§-q§) + (_loc15_.§"n§ * _loc15_.§'a§ * _loc36_ + _loc16_.§"n§ * _loc16_.§'a§ * _loc37_);
               _loc31_.§3s§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§-q§ + _loc16_.§-q§ + _loc15_.§'a§ * _loc42_ + _loc16_.§'a§ * _loc43_;
               _loc31_.§=1§ = 1 / _loc44_;
               _loc31_.§#!@§ = 0;
            ...
            if(_loc28_.§!§ == 2)
            {
               _loc48_ = _loc28_.§7T§[0];
               _loc49_ = _loc28_.§7T§[1];
               _loc50_ = _loc15_.§-q§;
               _loc51_ = _loc15_.§'a§;
               _loc52_ = _loc16_.§-q§;
               _loc53_ = _loc16_.§'a§;
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         while(_loc5_ < this.§]!#§)
         {
            ...
            if(param1.§4!D§)
            {
               ...
               {
                  _loc20_ = _loc6_.§7T§[_loc18_];
                  _loc20_.normalImpulse *= param1.§1a§;
                  _loc20_.tangentImpulse *= param1.§1a§;
                  ...
                  _loc7_.§2!G§.x -= _loc9_ * _loc21_;
                  _loc7_.§2!G§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§4+§.x * _loc22_ - _loc20_.§4+§.y * _loc21_);
                  _loc8_.§2!G§.x += _loc11_ * _loc21_;
                  _loc8_.§2!G§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  (_loc23_ = _loc6_.§7T§[_loc18_]).normalImpulse = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         while(_loc24_ < this.§]!#§)
         {
            _loc26_ = (_loc25_ = this.§=!N§[_loc24_]).§#1§;
            _loc27_ = _loc25_.§"!<§;
            ...
            {
               _loc2_ = _loc25_.§7T§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§4+§.y - _loc30_.x + _loc28_ * _loc2_.§9!@§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§4+§.x - _loc30_.y - _loc28_ * _loc2_.§9!@§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§=1§ * -_loc10_;
            ...
            if(_loc25_.§!§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§;g§ * (_loc9_ - _loc2_.§#!@§);
            ...
            {
               _loc43_ = _loc25_.§7T§[0];
               _loc44_ = _loc25_.§7T§[1];
               _loc45_ = _loc43_.normalImpulse;
               _loc46_ = _loc44_.normalImpulse;
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§4+§.y - _loc30_.x + _loc28_ * _loc43_.§9!@§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§4+§.x - _loc30_.y - _loc28_ * _loc43_.§9!@§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§4+§.y - _loc30_.x + _loc28_ * _loc44_.§9!@§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§4+§.x - _loc30_.y - _loc28_ * _loc44_.§9!@§.x;
      ...
      public function §]![§() : void
      {
         ...
         while(_loc1_ < this.§]!#§)
         {
            ...
            while(_loc4_ < _loc2_.§!§)
            {
               _loc5_ = _loc3_.§^G§[_loc4_];
               _loc6_ = _loc2_.§7T§[_loc4_];
               _loc5_.§;L§ = _loc6_.normalImpulse;
               _loc5_.§2f§ = _loc6_.tangentImpulse;
               _loc4_++;
            }
            _loc1_++;
         }
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§]!#§)
         {
            _loc5_ = (_loc4_ = this.§=!N§[_loc3_]).§#1§;
            _loc6_ = _loc4_.§"!<§;
            _loc7_ = _loc5_.§"n§ * _loc5_.§-q§;
            _loc8_ = _loc5_.§"n§ * _loc5_.§'a§;
            _loc9_ = _loc6_.§"n§ * _loc6_.§-q§;
            _loc10_ = _loc6_.§"n§ * _loc6_.§'a§;
            §1h§.§;!W§(_loc4_);
            _loc11_ = §1h§.§`!!§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§!§)
            {
               _loc13_ = _loc4_.§7T§[_loc12_];
               _loc14_ = §1h§.§^G§[_loc12_];
               _loc15_ = §1h§.§9!Q§[_loc12_];
               ...
               _loc22_ = (_loc21_ = -_loc13_.§3s§ * _loc20_) * _loc11_.x;
