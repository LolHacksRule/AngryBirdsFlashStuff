package §'!#§
{
   ...
   class b2PositionSolverManifold
   {
      ...
      private static var §implements§:b2Vec2 = new b2Vec2();
      ...
      public var §9!Q§:Vector.<Number>;
      
      function b2PositionSolverManifold()
      {
         super();
         this.§`!!§ = new b2Vec2();
         this.§9!Q§ = new Vector.<Number>(b2Settings.b2_maxManifoldPoints);
      ...
      public function §;!W§(param1:b2ContactConstraint) : void
      {
         ...
         switch(param1.type)
         {
            case b2Manifold.§throw§:
               ...
               _loc9_ = param1.§#1§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc10_ = param1.§#1§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               _loc5_ = param1.§"!<§.m_xf.R;
               _loc6_ = param1.§7T§[0].localPoint;
               ...
               this.§9!Q§[0] = _loc13_ * this.§`!!§.x + _loc14_ * this.§`!!§.y - param1.radius;
               break;
            case b2Manifold.§[!$§:
               _loc5_ = param1.§#1§.m_xf.R;
               _loc6_ = param1.§,3§;
               ...
               while(_loc2_ < param1.§!§)
               {
                  _loc6_ = param1.§7T§[_loc2_].localPoint;
                  ...
                  this.§9!Q§[_loc2_] = (_loc3_ - _loc7_) * this.§`!!§.x + (_loc4_ - _loc8_) * this.§`!!§.y - param1.radius;
