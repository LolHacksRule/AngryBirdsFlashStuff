package §9A§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§?!$§ = b2internal::try.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§2!E§.x - this.§?!$§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§2!E§.y - this.§?!$§.m_xf.position.y;
         ...
         this.§-!5§ = param1.§',§;
         this.§%U§ = param1.§97§ + this.§-!5§ * param1.§=4§;
         this.m_maxLength1 = b2Math.§]!A§(param1.§8!J§,this.§%U§ - this.§-!5§ * b2internal::;Y);
         this.m_maxLength2 = b2Math.§]!A§(param1.§ W§,(this.§%U§ - b2internal::;Y) / this.§-!5§);
         this.§&S§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§&S§ * this.m_u2.x,param1 * this.§&S§ * this.m_u2.y);
      }
      ...
      {
         var _loc1_:b2Vec2 = this.§?!$§.m_xf.position.Copy();
         _loc1_.§=O§(this.m_groundAnchor2);
         return _loc1_;
      }
      
      public function GetLength1() : Number
      {
         var _loc1_:b2Vec2 = b2internal::try.GetWorldPoint(this.m_localAnchor1);
      ...
      {
         var _loc1_:b2Vec2 = b2internal::-f.GetWorldPoint(this.m_localAnchor2);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc18_:Number = this.m_u1.§=!J§();
         var _loc19_:Number = this.m_u2.§=!J§();
         if(_loc18_ > b2Settings.b2_linearSlop)
         {
            this.m_u1.§^B§(1 / _loc18_);
         }
         else
         {
            this.m_u1.§<!5§();
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§%U§ - _loc18_ - this.§-!5§ * _loc19_) > 0)
         {
            this.§3U§ = b2internal::26;
            this.§&S§ = 0;
         }
         else
         {
            this.§3U§ = b2internal::<j;
         }
         if(_loc18_ < this.m_maxLength1)
         {
            this.m_limitState1 = b2internal::26;
            this.m_limitImpulse1 = 0;
         }
         else
         {
            this.m_limitState1 = b2internal::<j;
         }
         if(_loc19_ < this.m_maxLength2)
         {
            this.m_limitState2 = b2internal::26;
            this.m_limitImpulse2 = 0;
         }
         else
         {
            this.m_limitState2 = b2internal::<j;
         }
         var _loc21_:Number = _loc5_ * this.m_u1.y - _loc6_ * this.m_u1.x;
         var _loc22_:Number = _loc8_ * this.m_u2.y - _loc9_ * this.m_u2.x;
         this.m_limitMass1 = _loc2_.§-q§ + _loc2_.§'a§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§-q§ + _loc3_.§'a§ * _loc22_ * _loc22_;
         this.§%"§ = this.m_limitMass1 + this.§-!5§ * this.§-!5§ * this.m_limitMass2;
         ...
         {
            this.§&S§ *= param1.§1a§;
            this.m_limitImpulse1 *= param1.§1a§;
            this.m_limitImpulse2 *= param1.§1a§;
            _loc23_ = (-this.§&S§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§&S§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§-!5§ * this.§&S§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§-!5§ * this.§&S§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§2!G§.x += _loc2_.§-q§ * _loc23_;
            _loc2_.§2!G§.y += _loc2_.§-q§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§'a§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§2!G§.x += _loc3_.§-q§ * _loc25_;
            _loc3_.§2!G§.y += _loc3_.§-q§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = _loc4_.col1.y * _loc8_ + _loc4_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         if(this.§3U§ == b2internal::<j)
         {
            _loc10_ = _loc2_.§2!G§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§2!G§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§2!G§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§2!G§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§-!5§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§%"§ * -_loc18_;
            _loc20_ = this.§&S§;
            this.§&S§ = b2Math.§[!6§(0,this.§&S§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§&S§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§-!5§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§-!5§ * _loc19_ * this.m_u2.y;
            _loc2_.§2!G§.x += _loc2_.§-q§ * _loc14_;
            _loc2_.§2!G§.y += _loc2_.§-q§ * _loc15_;
         ...
         if(this.m_limitState1 == b2internal::<j)
         {
            _loc10_ = _loc2_.§2!G§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§2!G§.y + _loc2_.m_angularVelocity * _loc5_;
         ...
         if(this.m_limitState2 == b2internal::<j)
         {
            _loc12_ = _loc3_.§2!G§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§2!G§.y + _loc3_.m_angularVelocity * _loc8_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§3U§ == b2internal::<j)
         {
            ...
            if(_loc18_ > b2Settings.b2_linearSlop)
            {
               this.m_u2.§^B§(1 / _loc18_);
            }
            else
            {
               this.m_u2.§<!5§();
            }
            _loc19_ = this.§%U§ - _loc17_ - this.§-!5§ * _loc18_;
            ...
            _loc15_ = -this.§-!5§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§-!5§ * _loc20_ * this.m_u2.y;
         ...
         if(this.m_limitState1 == b2internal::<j)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§=!J§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::<j)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§=!J§()) > b2Settings.b2_linearSlop)
            {
