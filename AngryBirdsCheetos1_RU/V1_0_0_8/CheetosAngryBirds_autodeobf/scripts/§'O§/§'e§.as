package §'O§
{
   public class §'e§
   {
      ...
      public static function §7Z§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
      ...
      private static function §9!T§(param1:String, param2:Boolean) : String
      {
