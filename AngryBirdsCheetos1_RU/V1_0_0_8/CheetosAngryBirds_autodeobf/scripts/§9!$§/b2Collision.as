package §9!$§
{
   ...
   public class b2Collision
   {
      ...
      private static var §;W§:Vector.<§6R§> = §#!>§();
      
      private static var s_clipPoints1:Vector.<§6R§> = §#!>§();
      
      private static var s_clipPoints2:Vector.<§6R§> = §#!>§();
      ...
      private static var §1t§:b2Vec2 = new b2Vec2();
      ...
      public static function §1w§(param1:Vector.<§6R§>, param2:Vector.<§6R§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§6R§ = null;
         var _loc6_:int = 0;
      ...
      public static function §1!6§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§'W§;
      ...
      public static function §"!G§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §1!6§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §1!6§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §1!6§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §1!6§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §#!V§(param1:Vector.<§6R§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§6R§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§'W§;
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§ ^§.§9!-§ = param4;
         _loc20_.id.§ ^§.§%!R§ = _loc22_;
         _loc20_.id.§ ^§.§3Z§ = 1;
      }
      
      private static function §#!>§() : Vector.<§6R§>
      {
         var _loc1_:Vector.<§6R§> = new Vector.<§6R§>(2);
         _loc1_[0] = new §6R§();
         _loc1_[1] = new §6R§();
         return _loc1_;
      }
      ...
      public static function § O§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         param1.§+!K§ = 0;
         var _loc7_:Number = param2.§!R§ + param4.§!R§;
         var _loc8_:int = 0;
         §#,§[0] = _loc8_;
         var _loc9_:Number = §"!G§(§#,§,param2,param3,param4,param5);
         _loc8_ = §#,§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §!!E§[0] = _loc10_;
         var _loc11_:Number = §"!G§(§!!E§,param4,param5,param2,param3);
         _loc10_ = §!!E§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§6R§> = §;W§;
         §#!V§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         ...
         var _loc37_:Vector.<§6R§> = s_clipPoints1;
         var _loc38_:Vector.<§6R§> = s_clipPoints2;
         if((_loc39_ = §1w§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §1w§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
      ...
      public static function §[t§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§!R§ + param4.§!R§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§5! § = b2Manifold.§throw§;
         param1.m_localPoint.SetV(param2.§>!E§);
         param1.§[R§.§<!5§();
         param1.§+!K§ = 1;
         param1.§^G§[0].m_localPoint.SetV(param4.§>!E§);
      ...
      public static function §@!$§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§!R§ + param4.§!R§;
