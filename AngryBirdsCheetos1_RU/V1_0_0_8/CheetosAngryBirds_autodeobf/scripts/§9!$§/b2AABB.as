package §9!$§
{
   ...
   public class b2AABB
   {
      ...
      {
         var _loc1_:Number = this.§![§.x - this.§,c§.x;
         var _loc2_:Number = this.§![§.y - this.§,c§.y;
         var _loc3_:Boolean = _loc1_ >= 0 && _loc2_ >= 0;
         return Boolean(_loc3_ && this.§,c§.§`!1§() && this.§![§.§`!1§());
      }
      
      public function §-&§() : b2Vec2
      {
         return new b2Vec2((this.§,c§.x + this.§![§.x) / 2,(this.§,c§.y + this.§![§.y) / 2);
      }
      
      public function §=b§() : b2Vec2
      {
         return new b2Vec2((this.§![§.x - this.§,c§.x) / 2,(this.§![§.y - this.§,c§.y) / 2);
      }
      ...
      public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput) : Boolean
      {
         ...
         {
            if(_loc5_ < this.§,c§.x || this.§![§.x < _loc5_)
            {
               return false;
            }
         }
         ...
         {
            if(_loc6_ < this.§,c§.y || this.§![§.y < _loc6_)
            {
               return false;
            }
         }
      ...
      {
         var _loc2_:Number = param1.§,c§.x - this.§![§.x;
         var _loc3_:Number = param1.§,c§.y - this.§![§.y;
         var _loc4_:Number = this.§,c§.x - param1.§![§.x;
         var _loc5_:Number = this.§,c§.y - param1.§![§.y;
