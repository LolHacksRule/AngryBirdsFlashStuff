package §9!$§
{
   ...
   public class b2DynamicTree
   {
      ...
      private var §41§:b2DynamicTreeNode;
      ...
      public function §>v§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            _loc3_ = this.§!3§;
            _loc4_ = 0;
            while(_loc3_.§5Z§() == false)
            {
               _loc3_ = !!(this.§!T§ >> _loc4_ & 1) ? _loc3_.child2 : _loc3_.child1;
               _loc4_ = _loc4_ + 1 & 31;
            }
            ++this.§!T§;
            this.§1!>§(_loc3_);
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§6!D§(1,_loc5_);
         ...
         var _loc13_:int = 0;
         var _loc19_:*;
         _loc12_[_loc19_ = _loc13_++] = this.§!3§;
         while(_loc13_ > 0)
         {
      ...
      private function §,![§(param1:b2DynamicTreeNode) : void
      {
         ...
         var _loc3_:b2DynamicTreeNode = this.§!3§;
         if(_loc3_.§5Z§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§,c§.x + _loc6_.aabb.§![§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§,c§.y + _loc6_.aabb.§![§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§,c§.x + _loc7_.aabb.§![§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§,c§.y + _loc7_.aabb.§![§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
