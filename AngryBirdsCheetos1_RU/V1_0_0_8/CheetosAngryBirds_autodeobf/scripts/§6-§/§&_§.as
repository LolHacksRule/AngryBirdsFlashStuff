package §6-§
{
   ...
   public class §&_§ extends §;J§
   {
      ...
      public static var §7!O§:Boolean = false;
       
      
      public function §&_§(param1:Object, param2:BitmapData)
      {
         super(param2);
         this.§6A§(param1);
      }
      
      private static function § D§(param1:§,2§, param2:int, param3:int) : void
      {
         if(param1.§^!3§.top < 0)
         {
            param1.§^!3§.top = 0;
      ...
      protected function §6A§(param1:Object) : void
      {
         var _loc4_:* = null;
         ...
         for(_loc4_ in param1)
         {
            if(_loc4_.indexOf("sprite_") != -1)
            {
               ...
               § D§(_loc6_,§9!+§.width,§9!+§.height);
               if(_loc2_)
               {
                  _loc6_.§1!H§ = _loc5_.pivotx / _loc3_;
                  _loc6_.§+!`§ = _loc5_.pivoty / _loc3_;
               }
               else
               {
                  _loc6_.§1!H§ = _loc5_.width / 2;
