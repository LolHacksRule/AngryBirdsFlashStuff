package §6-§
{
   ...
   public class §5!U§ extends §;J§
   {
       
      
      public function §5!U§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§6A§(param1,param2);
      }
      
      protected function §6A§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc16_:§,2§ = null;
         var _loc3_:Dictionary = this.§^!S§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§&U§(_loc7_,_loc6_)]) == null)
            {
            ...
            if(_loc10_)
            {
               ...
               (_loc16_ = new §,2§()).mName = _loc6_;
               _loc16_.§^!3§ = _loc15_;
               _loc16_.§1!H§ = _loc10_.pivotX;
      ...
      private function §&U§(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function §^!S§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§&U§(_loc4_,_loc6_.@name);
