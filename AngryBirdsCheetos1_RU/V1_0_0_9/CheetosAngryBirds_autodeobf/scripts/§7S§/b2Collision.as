package §7S§
{
   ...
   public class b2Collision
   {
      ...
      private static var §>0§:Vector.<§=W§> = §=w§();
      
      private static var s_clipPoints1:Vector.<§=W§> = §=w§();
      
      private static var s_clipPoints2:Vector.<§=W§> = §=w§();
      ...
      private static var §1!E§:b2Vec2 = new b2Vec2();
      
      private static var §^!8§:b2Vec2 = new b2Vec2();
      
      private static var §<!,§:b2Vec2 = new b2Vec2();
      
      private static var §8!5§:b2Vec2 = new b2Vec2();
      ...
      public static function §3!X§(param1:Vector.<§=W§>, param2:Vector.<§=W§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§=W§ = null;
         var _loc6_:int = 0;
      ...
      public static function §5t§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§6!S§;
         var _loc7_:Vector.<b2Vec2> = param1.§6!@§;
         var _loc8_:Vector.<b2Vec2> = param1.§4!?§;
         var _loc9_:int = param4.§6!S§;
         var _loc10_:Vector.<b2Vec2> = param4.§6!@§;
         _loc11_ = param2.R;
      ...
      public static function §6k§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §5t§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §5t§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §5t§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §5t§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §1!U§(param1:Vector.<§=W§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§=W§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§6!S§;
         var _loc8_:Vector.<b2Vec2> = param2.§4!?§;
         var _loc9_:int = param5.§6!S§;
         var _loc10_:Vector.<b2Vec2> = param5.§6!@§;
         ...
         _loc20_.id.§&V§.§^E§ = param4;
         _loc20_.id.§&V§.§^!K§ = _loc21_;
         _loc20_.id.§&V§.§7!<§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§&V§.§^E§ = param4;
         _loc20_.id.§&V§.§^!K§ = _loc22_;
         _loc20_.id.§&V§.§7!<§ = 1;
      }
      
      private static function §=w§() : Vector.<§=W§>
      {
      ...
      public static function §>! §(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §>!-§[0] = _loc8_;
         var _loc9_:Number = §6k§(§>!-§,param2,param3,param4,param5);
         _loc8_ = §>!-§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §=>§[0] = _loc10_;
         var _loc11_:Number = §6k§(§=>§,param4,param5,param2,param3);
         _loc10_ = §=>§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§@!_§ = b2Manifold.§5!E§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§=W§> = §>0§;
         §1!U§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§6!S§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§6!@§)[_loc16_];
         ...
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §1!E§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §^!8§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §8!5§;
         _loc20_ = _loc14_.R;
         ...
         if((_loc39_ = §3!X§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §3!X§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
      ...
      public static function §;Q§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§@!_§ = b2Manifold.§'!Q§;
         param1.m_localPoint.SetV(param2.§%!G§);
         param1.§]V§.§4S§();
         param1.§5f§ = 1;
         param1.§6!_§[0].m_localPoint.SetV(param4.§%!G§);
         param1.§6!_§[0].m_id.key = 0;
      }
      
      public static function §]_§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§6!S§;
         var _loc22_:Vector.<b2Vec2> = param2.§6!@§;
      ...
      public static function §=o§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§%!6§;
         var _loc4_:b2Vec2 = param1.§4!=§;
