package §7S§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §`!0§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§@!_§ = §7y§;
            _loc7_ = this.§2a§.§8g§(param1.indexA[0]);
            _loc10_ = this.§#<§.§8g§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§8!W§.x = _loc15_ - _loc13_;
            this.§8!W§.y = _loc16_ - _loc14_;
            this.§8!W§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§@!_§ = §5!E§;
            _loc8_ = this.§2a§.§8g§(param1.indexA[0]);
            _loc9_ = this.§2a§.§8g§(param1.indexA[1]);
            _loc10_ = this.§#<§.§8g§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§8!W§ = b2Math.§#K§(b2Math.§4!'§(_loc9_,_loc8_),1);
            this.§8!W§.Normalize();
            _loc20_ = this.§8!W§;
         ...
         {
            this.§@!_§ = §0H§;
            _loc11_ = this.§#<§.§8g§(param1.indexB[0]);
            _loc12_ = this.§#<§.§8g§(param1.indexB[1]);
            _loc7_ = this.§2a§.§8g§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§8!W§ = b2Math.§#K§(b2Math.§4!'§(_loc12_,_loc11_),1);
            this.§8!W§.Normalize();
            _loc20_ = this.§8!W§;
         ...
         else
         {
            ...
            _loc24_ = b2Math.§5!§(param3.R,b2Math.§4!'§(_loc9_,_loc8_));
            _loc25_ = b2Math.§'?§(param5,_loc10_);
            _loc26_ = b2Math.§5!§(param5.R,b2Math.§4!'§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§4!'§(_loc26_,_loc24_);
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§1!<§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§1!<§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §7y§:
               _loc3_ = b2Math.§9O§(param1.R,this.§8!W§);
               _loc4_ = b2Math.§9O§(param2.R,this.§8!W§.§2!+§());
               _loc5_ = this.§2a§.§]T§(_loc3_);
               _loc6_ = this.§#<§.§]T§(_loc4_);
               _loc7_ = b2Math.§'?§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§'?§(param2,_loc6_)).x - _loc7_.x) * this.§8!W§.x + (_loc8_.y - _loc7_.y) * this.§8!W§.y);
            case §5!E§:
               _loc10_ = b2Math.§5!§(param1.R,this.§8!W§);
               _loc7_ = b2Math.§'?§(param1,this.m_localPoint);
               _loc4_ = b2Math.§9O§(param2.R,_loc10_.§2!+§());
               _loc6_ = this.§#<§.§]T§(_loc4_);
               return Number(((_loc8_ = b2Math.§'?§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §0H§:
               _loc10_ = b2Math.§5!§(param2.R,this.§8!W§);
               _loc8_ = b2Math.§'?§(param2,this.m_localPoint);
               _loc3_ = b2Math.§9O§(param1.R,_loc10_.§2!+§());
               _loc5_ = this.§2a§.§]T§(_loc3_);
