package §7S§
{
   ...
   public class b2DynamicTree
   {
      ...
      private var §3G§:b2DynamicTreeNode;
      ...
      public function §0!3§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
      ...
      public function §3N§(param1:b2DynamicTreeNode) : void
      {
         this.§^!H§(param1);
         this.§+<§(param1);
      }
      ...
      public function §=x§(param1:Function, param2:b2AABB) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc7_:*;
         _loc3_[_loc7_ = _loc4_++] = this.§%D§;
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§=o§(param2))
            {
               if(_loc5_.§#!S§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc5_:b2Vec2;
         (_loc5_ = b2Math.§4!'§(_loc3_,_loc4_)).Normalize();
         var _loc6_:b2Vec2 = b2Math.§+u§(1,_loc5_);
         var _loc7_:b2Vec2 = b2Math.§8K§(_loc6_);
         var _loc8_:Number = param2.§5v§;
         _loc9_ = new b2AABB();
         ...
         _loc9_.§4!=§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§4!=§.y = Math.max(_loc3_.y,_loc11_);
         var _loc12_:Vector.<b2DynamicTreeNode> = new Vector.<b2DynamicTreeNode>();
         var _loc13_:int = 0;
         var _loc19_:*;
         _loc12_[_loc19_ = _loc13_++] = this.§%D§;
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§=o§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§"!3§();
      ...
      private function §;!^§(param1:b2DynamicTreeNode) : void
      {
         ...
         var _loc2_:b2Vec2 = param1.aabb.§"!3§();
         ...
         if(_loc3_.§#!S§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§%!6§.x + _loc6_.aabb.§4!=§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§%!6§.y + _loc6_.aabb.§4!=§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§%!6§.x + _loc7_.aabb.§4!=§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§%!6§.y + _loc7_.aabb.§4!=§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         _loc5_.§0?§ = null;
         _loc5_.aabb.§1g§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            while(!_loc4_.aabb.§@!P§(_loc5_.aabb))
            {
               _loc4_.aabb.§1g§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
      ...
      private function §^!H§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc5_ = _loc3_.aabb;
               _loc3_.aabb = b2AABB.§1g§(_loc3_.child1.aabb,_loc3_.child2.aabb);
               if(_loc5_.§@!P§(_loc3_.aabb))
               {
                  break;
               }
