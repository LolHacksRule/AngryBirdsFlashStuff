package §7S§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §`!0§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§@!_§)
         {
            case b2Manifold.§'!Q§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§6!_§[0].m_localPoint;
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§[!4§.x = _loc19_ / _loc26_;
                  this.§[!4§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§[!4§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§[!4§.x;
               _loc23_ = _loc16_ + param3 * this.§[!4§.y;
               _loc24_ = _loc17_ - param5 * this.§[!4§.x;
               _loc25_ = _loc18_ - param5 * this.§[!4§.y;
               this.§6!_§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§6!_§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§5!E§:
               _loc8_ = param2.R;
               _loc7_ = param1.§]V§;
               ...
               this.§[!4§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§5f§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§6!_§[_loc6_].m_localPoint;
                  ...
                  this.§6!_§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§6!_§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§0H§:
               ...
               while(_loc6_ < param1.§5f§)
               {
                  ...
                  this.§6!_§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§6!_§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
