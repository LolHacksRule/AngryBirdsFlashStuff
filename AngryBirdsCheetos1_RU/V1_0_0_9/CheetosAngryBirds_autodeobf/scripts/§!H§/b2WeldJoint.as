package §!H§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc7_ = this.§0!_§.y - _loc4_.m_sweep.localCenter.y;
         _loc3_ = _loc2_.col1.x * _loc6_ + _loc2_.col2.x * _loc7_;
         _loc7_ = _loc2_.col1.y * _loc6_ + _loc2_.col2.y * _loc7_;
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.m_xf.R;
         _loc8_ = this.§#F§.x - _loc5_.m_sweep.localCenter.x;
         _loc9_ = this.§#F§.y - _loc5_.m_sweep.localCenter.y;
         ...
         if(param1.§7!Z§)
         {
            ...
            this.§9$§.y *= param1.§+k§;
            this.§9$§.z *= param1.§+k§;
            _loc4_.§7W§.x -= _loc10_ * this.§9$§.x;
            _loc4_.§7W§.y -= _loc10_ * this.§9$§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§9$§.y - _loc7_ * this.§9$§.x + this.§9$§.z);
            _loc5_.§7W§.x += _loc11_ * this.§9$§.x;
            _loc5_.§7W§.y += _loc11_ * this.§9$§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc5_:b2Body = b2internal::%!;
         _loc2_ = _loc4_.m_xf.R;
         var _loc6_:Number = this.§0!_§.x - _loc4_.m_sweep.localCenter.x;
         var _loc7_:Number = this.§0!_§.y - _loc4_.m_sweep.localCenter.y;
         _loc3_ = _loc2_.col1.x * _loc6_ + _loc2_.col2.x * _loc7_;
         _loc7_ = _loc2_.col1.y * _loc6_ + _loc2_.col2.y * _loc7_;
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.m_xf.R;
         var _loc8_:Number = this.§#F§.x - _loc5_.m_sweep.localCenter.x;
