package §!H§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§9$§.x * this.§'H§.x + (this.§3!N§ + this.§9$§.y) * this.§8!W§.x),param1 * (this.§9$§.x * this.§'H§.y + (this.§3!N§ + this.§9$§.y) * this.§8!W§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§7!Z§)
         {
            ...
            this.§9$§.y *= param1.§+k§;
            this.§3!N§ *= param1.§+k§;
            _loc19_ = this.§9$§.x * this.§'H§.x + (this.§3!N§ + this.§9$§.y) * this.§8!W§.x;
            _loc20_ = this.§9$§.x * this.§'H§.y + (this.§3!N§ + this.§9$§.y) * this.§8!W§.y;
            _loc21_ = this.§9$§.x * this.m_s1 + (this.§3!N§ + this.§9$§.y) * this.m_a1;
            _loc22_ = this.§9$§.x * this.m_s2 + (this.§3!N§ + this.§9$§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§8!W§.x * (_loc6_.x - _loc4_.x) + this.§8!W§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§&!J§ * (this.§!!_§ - _loc13_);
            _loc15_ = this.§3!N§;
            _loc16_ = param1.§1-§ * this.§+l§;
            this.§3!N§ = b2Math.§1!<§(this.§3!N§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§3!N§ - _loc15_) * this.§8!W§.x;
            _loc9_ = _loc14_ * this.§8!W§.y;
         ...
         {
            _loc17_ = this.§8!W§.x * (_loc6_.x - _loc4_.x) + this.§8!W§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§9$§.Copy();
            _loc19_ = this.§&§.§??§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§9$§.§<!A§(_loc19_);
            if(this.§7!8§ == b2internal::@")
            {
               this.§9$§.y = b2Math.§set §(this.§9$§.y,0);
            }
            else if(this.§7!8§ == b2internal::5!P)
            {
               this.§9$§.y = b2Math.§,B§(this.§9$§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§9$§.y - _loc18_.y) * this.§&§.col2.x;
            if(this.§&§.col1.x != 0)
            {
            ...
            _loc8_ = _loc19_.x * this.§'H§.x + _loc19_.y * this.§8!W§.x;
            _loc9_ = _loc19_.x * this.§'H§.y + _loc19_.y * this.§8!W§.y;
         ...
         else
         {
            ...
            this.§9$§.x += _loc22_;
            _loc8_ = _loc22_ * this.§'H§.x;
            _loc9_ = _loc22_ * this.§'H§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§0b§)
         {
            ...
            _loc34_ = this.§8!W§.x * _loc26_ + this.§8!W§.y * _loc27_;
            if(b2Math.§[!I§(this.§`!V§ - this.§5r§) < 2 * b2Settings.b2_linearSlop)
            {
            ...
            else if(_loc34_ <= this.§5r§)
            {
               _loc19_ = b2Math.§1!<§(_loc34_ - this.§5r§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§5r§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§`!V§)
            {
               _loc19_ = b2Math.§1!<§(_loc34_ - this.§`!V§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§`!V§;
               _loc18_ = true;
            }
         }
         ...
         var _loc30_:Number = _loc28_.x * this.§'H§.x + _loc28_.y * this.§8!W§.x;
         var _loc31_:Number = _loc28_.x * this.§'H§.y + _loc28_.y * this.§8!W§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::'t * _loc30_;
         _loc6_.y -= b2internal::'t * _loc31_;
         _loc7_ -= b2internal::2!3 * _loc32_;
         _loc8_.x += b2internal::%!R * _loc30_;
         _loc8_.y += b2internal::%!R * _loc31_;
