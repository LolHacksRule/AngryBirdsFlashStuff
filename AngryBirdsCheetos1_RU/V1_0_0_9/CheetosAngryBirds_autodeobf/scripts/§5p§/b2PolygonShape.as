package §5p§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      public static function §+!J§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§0!E§(param1,param2);
         return _loc3_;
      }
      
      public static function §3y§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public function §#6§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§0!E§(_loc3_,param2);
      }
      
      public function §0!E§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§6!S§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§4!'§(this.§6!@§[_loc5_],this.§6!@§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§0!]§() > Number.MIN_VALUE);
            this.§4!?§[_loc3_].SetV(b2Math.§#K§(_loc6_,1));
            this.§4!?§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§&6§ = §]b§(this.§6!@§,this.§6!S§);
      }
      ...
      public function §]e§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§6!S§)
         {
            this.§6!@§[_loc6_] = b2Math.§'?§(_loc5_,this.§6!@§[_loc6_]);
            this.§4!?§[_loc6_] = b2Math.§5!§(_loc5_.R,this.§4!?§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §-C§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§&6§.x = 0.5 * (param1.x + param2.x);
         this.§&6§.y = 0.5 * (param1.y + param2.y);
         this.§4!?§[0] = b2Math.§#K§(b2Math.§4!'§(param2,param1),1);
         this.§4!?§[0].Normalize();
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§%!6§.x = _loc5_ - b2internal::8!!;
         param1.§%!6§.y = _loc6_ - b2internal::8!!;
         param1.§4!=§.x = _loc7_ + b2internal::8!!;
         param1.§4!=§.y = _loc8_ + b2internal::8!!;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§6!S§)
         {
            _loc11_ = this.§6!@§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§6!S§ ? this.§6!@§[int(_loc10_ + 1)] : this.§6!@§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§=D§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§]!3§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§9O§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§9h§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§6!S§)
         {
            _loc7_[_loc12_] = b2Math.§9h§(_loc5_,this.§6!@§[_loc12_]) - _loc6_;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§6!S§;
         var _loc14_:int = (_loc10_ + 1) % this.§6!S§;
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§6!S§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
