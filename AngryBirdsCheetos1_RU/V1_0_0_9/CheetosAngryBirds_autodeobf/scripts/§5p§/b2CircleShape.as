package §5p§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if(0 <= _loc15_ && _loc15_ <= param2.§5v§ * _loc13_)
         {
            _loc15_ /= _loc13_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§%!6§.Set(_loc4_ - b2internal::8!!,_loc5_ - b2internal::8!!);
         param1.§4!=§.Set(_loc4_ + b2internal::8!!,_loc5_ + b2internal::8!!);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§=D§ = param2 * b2Settings.b2_pi * b2internal::8!! * b2internal::8!!;
         param1.center.SetV(this.§%!G§);
         param1.§]!3§ = param1.§=D§ * (0.5 * b2internal::8!! * b2internal::8!! + (this.§%!G§.x * this.§%!G§.x + this.§%!G§.y * this.§%!G§.y));
      }
      
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         var _loc9_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§'?§(param3,this.§%!G§);
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.§9h§(param1,_loc5_) - param2)) < -b2internal::8!! + Number.MIN_VALUE)
         {
            return 0;
         }
