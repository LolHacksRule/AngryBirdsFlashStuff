package §0!F§
{
   public class §7A§
   {
      ...
      public static function §7!1§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
      ...
      private static function §;v§(param1:String, param2:Boolean) : String
      {
