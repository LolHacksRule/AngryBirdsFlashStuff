package §4!1§
{
   ...
   public class §'z§
   {
      ...
      public static var §69§:ByteArray;
      ...
      public static function §1!Z§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §3h§(_loc2_);
         return §2Z§.§8C§(_loc3_.readInt(),true) + §2Z§.§8C§(_loc3_.readInt(),true) + §2Z§.§8C§(_loc3_.readInt(),true) + §2Z§.§8C§(_loc3_.readInt(),true) + §2Z§.§8C§(_loc3_.readInt(),true);
      }
      
      public static function § !Y§(param1:ByteArray) : String
      {
         var _loc2_:Array = §'z§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §3h§(_loc2_);
         return §2Z§.§8C§(_loc3_.readInt(),true) + §2Z§.§8C§(_loc3_.readInt(),true) + §2Z§.§8C§(_loc3_.readInt(),true) + §2Z§.§8C§(_loc3_.readInt(),true) + §2Z§.§8C§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §'z§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §3h§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §3h§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
