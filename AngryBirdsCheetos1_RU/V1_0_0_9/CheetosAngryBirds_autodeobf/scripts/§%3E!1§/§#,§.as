package §>!1§
{
   ...
   public class §#,§
   {
      ...
      public static function §2h§() : String
      {
         ...
         var _loc5_:String;
         return (_loc5_ = §'!C§(_loc2_ + _loc4_ + _loc3_ + counter++).toUpperCase()).substring(0,8) + _loc5_.substring(8,12) + _loc5_.substring(12,16) + _loc5_.substring(16,20) + _loc5_.substring(20,32);
      }
      
      private static function §'!C§(param1:String) : String
      {
         return §22§(param1);
      }
      
      private static function §22§(param1:String) : String
      {
         return §2!O§(§?4§(§0d§(param1),param1.length * 8));
      }
      
      private static function §?4§(param1:Array, param2:Number) : Array
      {
         ...
         while(_loc9_ < param1.length)
         {
            ...
            while(_loc15_ < 80)
            {
               ...
               {
                  _loc3_[_loc15_] = §>!E§(_loc3_[_loc15_ - 3] ^ _loc3_[_loc15_ - 8] ^ _loc3_[_loc15_ - 14] ^ _loc3_[_loc15_ - 16],1);
               }
               _loc16_ = §^!S§(§^!S§(§>!E§(_loc4_,5),sha1_ft(_loc15_,_loc5_,_loc6_,_loc7_)),§^!S§(§^!S§(_loc8_,_loc3_[_loc15_]),sha1_kt(_loc15_)));
               _loc8_ = _loc7_;
               _loc7_ = _loc6_;
               _loc6_ = §>!E§(_loc5_,30);
               _loc5_ = _loc4_;
            ...
            _loc4_ = §^!S§(_loc4_,_loc10_);
            _loc5_ = §^!S§(_loc5_,_loc11_);
            _loc6_ = §^!S§(_loc6_,_loc12_);
            _loc7_ = §^!S§(_loc7_,_loc13_);
            _loc8_ = §^!S§(_loc8_,_loc14_);
            _loc9_ += 16;
         }
      ...
      private static function §^!S§(param1:Number, param2:Number) : Number
      {
      ...
      private static function §>!E§(param1:Number, param2:Number) : Number
      {
         return param1 << param2 | param1 >>> 32 - param2;
      }
      
      private static function §0d§(param1:String) : Array
      {
      ...
      private static function §2!O§(param1:Array) : String
      {
