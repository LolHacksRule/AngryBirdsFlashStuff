package §3!&§
{
   ...
   public class b2EdgeAndCircleContact extends b2Contact
   {
      ...
      override b2internal function Evaluate() : void
      {
         ...
         this.§8!J§(b2internal::+P,b2internal::=N.GetShape() as b2EdgeShape,_loc1_.m_xf,b2internal::?P.GetShape() as b2CircleShape,_loc2_.m_xf);
      }
      
      private function §8!J§(param1:b2Manifold, param2:b2EdgeShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
      }
   }
}
