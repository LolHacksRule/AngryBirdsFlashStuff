package §3!&§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §8§:b2WorldManifold = new b2WorldManifold();
      
      private static var §^!W§:b2PositionSolverManifold = new b2PositionSolverManifold();
       
      
      private var §4o§:b2TimeStep;
      
      private var §;!Q§;
      
      b2internal var §7T§:Vector.<b2ContactConstraint>;
      
      private var §7!$§:int;
      
      public function b2ContactSolver()
      {
         this.§4o§ = new b2TimeStep();
         this.§7T§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §`!0§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§;!Q§ = param4;
         this.§7!$§ = param3;
         while(this.§7T§.length < this.§7!$§)
         {
            this.§7T§[this.§7T§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§=N§;
            _loc10_ = _loc5_.§?P§;
            _loc11_ = _loc9_.§,!@§;
            _loc12_ = _loc10_.§,!@§;
            _loc13_ = _loc11_.§8!!§;
            ...
            _loc17_ = _loc5_.§3a§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§32§(),_loc10_.§32§());
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§7!&§(),_loc10_.§7!&§());
            _loc20_ = _loc15_.§7W§.x;
            _loc21_ = _loc15_.§7W§.y;
            _loc22_ = _loc16_.§7W§.x;
            _loc23_ = _loc16_.§7W§.y;
            _loc24_ = _loc15_.m_angularVelocity;
            _loc25_ = _loc16_.m_angularVelocity;
            b2Settings.b2Assert(_loc17_.§5f§ > 0);
            §8§.§`!0§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §8§.§[!4§.x;
            _loc27_ = §8§.§[!4§.y;
            (_loc28_ = this.§7T§[_loc6_]).§1U§ = _loc15_;
            _loc28_.§"=§ = _loc16_;
            _loc28_.§ !9§ = _loc17_;
            ...
            _loc28_.§]`§.x = _loc17_.§]V§.x;
            _loc28_.§]`§.y = _loc17_.§]V§.y;
            _loc28_.localPoint.x = _loc17_.m_localPoint.x;
            _loc28_.localPoint.y = _loc17_.m_localPoint.y;
            _loc28_.radius = _loc13_ + _loc14_;
            _loc28_.type = _loc17_.§@!_§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§]!@§)
            {
               _loc30_ = _loc17_.§6!_§[_loc29_];
               (_loc31_ = _loc28_.§"Q§[_loc29_]).normalImpulse = _loc30_.§">§;
               _loc31_.tangentImpulse = _loc30_.§@!8§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§<$§.x = §8§.§6!_§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§<$§.y = §8§.§6!_§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§?!U§.x = §8§.§6!_§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§?!U§.y = §8§.§6!_§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§?t§ + _loc16_.§?t§ + _loc15_.§<!V§ * _loc36_ + _loc16_.§<!V§ * _loc37_;
               _loc31_.§&!2§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§^"§ * _loc15_.§?t§ + _loc16_.§^"§ * _loc16_.§?t§) + (_loc15_.§^"§ * _loc15_.§<!V§ * _loc36_ + _loc16_.§^"§ * _loc16_.§<!V§ * _loc37_);
               _loc31_.§-!1§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§?t§ + _loc16_.§?t§ + _loc15_.§<!V§ * _loc42_ + _loc16_.§<!V§ * _loc43_;
               _loc31_.§4§ = 1 / _loc44_;
               _loc31_.§6!W§ = 0;
               ...
               {
                  _loc31_.§6!W§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§]!@§ == 2)
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         while(_loc5_ < this.§7!$§)
         {
            _loc7_ = (_loc6_ = this.§7T§[_loc5_]).§1U§;
            _loc8_ = _loc6_.§"=§;
            _loc9_ = _loc7_.§?t§;
            _loc10_ = _loc7_.§<!V§;
            _loc11_ = _loc8_.§?t§;
            ...
            if(param1.§7!Z§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc7_.§7W§.x -= _loc9_ * _loc21_;
                  _loc7_.§7W§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§?!U§.x * _loc22_ - _loc20_.§?!U§.y * _loc21_);
                  _loc8_.§7W§.x += _loc11_ * _loc21_;
                  _loc8_.§7W§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         {
            _loc26_ = (_loc25_ = this.§7T§[_loc24_]).§1U§;
            _loc27_ = _loc25_.§"=§;
            ...
            while(_loc1_ < _loc25_.§]!@§)
            {
               ...
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§?!U§.y - _loc30_.x + _loc28_ * _loc2_.§<$§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§?!U§.x - _loc30_.y - _loc28_ * _loc2_.§<$§.x;
            ...
            if(_loc25_.§]!@§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§&!2§ * (_loc9_ - _loc2_.§6!W§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§?!U§.y - _loc30_.x + _loc28_ * _loc43_.§<$§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§?!U§.x - _loc30_.y - _loc28_ * _loc43_.§<$§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§?!U§.y - _loc30_.x + _loc28_ * _loc44_.§<$§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§?!U§.x - _loc30_.y - _loc28_ * _loc44_.§<$§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§6!W§;
               _loc54_ = _loc52_ - _loc44_.§6!W§;
               _loc22_ = _loc25_.§+"§;
      ...
      public function §,T§() : void
      {
         ...
         while(_loc1_ < this.§7!$§)
         {
            _loc2_ = this.§7T§[_loc1_];
            _loc3_ = _loc2_.§ !9§;
            _loc4_ = 0;
            while(_loc4_ < _loc2_.§]!@§)
            {
               _loc5_ = _loc3_.§6!_§[_loc4_];
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§7!$§)
         {
            _loc5_ = (_loc4_ = this.§7T§[_loc3_]).§1U§;
            _loc6_ = _loc4_.§"=§;
            _loc7_ = _loc5_.§^"§ * _loc5_.§?t§;
            _loc8_ = _loc5_.§^"§ * _loc5_.§<!V§;
            _loc9_ = _loc6_.§^"§ * _loc6_.§?t§;
            _loc10_ = _loc6_.§^"§ * _loc6_.§<!V§;
            §^!W§.§`!0§(_loc4_);
            _loc11_ = §^!W§.§[!4§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§]!@§)
            {
               ...
               _loc22_ = (_loc21_ = -_loc13_.§-!1§ * _loc20_) * _loc11_.x;
