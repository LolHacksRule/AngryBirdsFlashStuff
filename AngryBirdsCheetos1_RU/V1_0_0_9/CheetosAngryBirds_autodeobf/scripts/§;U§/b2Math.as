package §;U§
{
   public class b2Math
   {
      ...
      public static function §#K§(param1:b2Vec2, param2:Number) : b2Vec2
      {
         return new b2Vec2(param2 * param1.y,-param2 * param1.x);
      }
      
      public static function §+u§(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §9O§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§9h§(param2,param1.col1),§9h§(param2,param1.col2));
      }
      ...
      public static function §#!E§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         ...
         _loc3_ = §4!'§(param2,param1.position);
      ...
      public static function §6X§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         var _loc3_:Number = param1.x - param2.x;
         var _loc4_:Number = param1.y - param2.y;
      ...
      public static function §2q§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§?!?§(§ i§(param1.col1,param2.col1),§ i§(param1.col2,param2.col2));
      }
      ...
      public static function §0e§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§9h§(param1.col1,param2.col1),§9h§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§9h§(param1.col1,param2.col2),§9h§(param1.col2,param2.col2));
      ...
      public static function §8K§(param1:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§[!I§(param1.x),§[!I§(param1.y));
      }
      
      public static function §5y§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§?!?§(§8K§(param1.col1),§8K§(param1.col2));
      }
      ...
      public static function §set §(param1:Number, param2:Number) : Number
      {
         return param1 > param2 ? Number(param1) : Number(param2);
      }
      ...
      {
         return new b2Vec2(§set §(param1.x,param2.x),§set §(param1.y,param2.y));
      }
      ...
      public static function §0a§() : Number
      {
      ...
      public static function §%t§(param1:uint) : uint
      {
      ...
      public static function §%6§(param1:uint) : Boolean
      {
