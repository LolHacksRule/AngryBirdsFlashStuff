package §;U§
{
   public class b2Sweep
   {
      ...
      public function §4>§(param1:b2Transform, param2:Number) : void
      {
      ...
      public function §#!<§(param1:Number) : void
      {
         ...
         if(this.§7!G§ < param1 && 1 - this.§7!G§ > Number.MIN_VALUE)
         {
            _loc2_ = (param1 - this.§7!G§) / (1 - this.§7!G§);
