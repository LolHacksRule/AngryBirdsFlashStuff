package §;U§
{
   public class b2Vec2
   {
      ...
      public static function §6d§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §6p§(param1:b2Mat22) : void
      {
      ...
      {
         var _loc2_:Number = b2Math.§9h§(this,param1.col1);
         this.y = b2Math.§9h§(this,param1.col2);
         this.x = _loc2_;
      }
