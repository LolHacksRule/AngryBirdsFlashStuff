package §7u§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§&!7§ = new Vector.<DisplayObject>(0);
      }
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         if(param1 >= 0 && param1 < this.numChildren)
         {
            ...
            _loc3_.dispatchEvent(new Event(Event.§43§,true));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§;!5§));
            }
            _loc3_.§4!<§(null);
      ...
      public function §,!A§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§&!7§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§&!7§.length;
         if(_loc3_ == 0)
         {
            §9P§(param1,§[C§);
            transformCoords(§[C§,0,0,§20§);
            param2.x = §20§.x;
            param2.y = §20§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§&!7§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§&!7§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§&!7§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§&!7§[_loc6_];
            §9P§(_loc7_,§[C§);
            transformCoords(§[C§,_loc3_,_loc4_,§20§);
            if(_loc8_ = _loc7_.hitTest(§20§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§5[§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§&!7§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§]F§();
               param1.§0!"§(_loc5_);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§0V§(this,param1.type,_loc2_);
      ...
      private function §0V§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§&!7§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
               this.§0V§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
