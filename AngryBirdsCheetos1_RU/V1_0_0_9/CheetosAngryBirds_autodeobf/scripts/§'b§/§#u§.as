package §'b§
{
   ...
   public class §#u§ extends §]!L§
   {
      ...
      public function §#u§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§=!_§(param1,param2);
      }
      
      protected function §=!_§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc16_:§"2§ = null;
         var _loc3_:Dictionary = this.§0!R§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if(_loc10_)
            {
               ...
               _loc16_.§4Y§ = _loc15_;
               _loc16_.§`!G§ = _loc10_.pivotX;
               _loc16_.§2F§ = _loc10_.pivotY;
               _loc16_.§%"§ = §`!"§;
               §?$§(_loc16_);
            }
         }
      ...
      private function §0!R§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
