package §1!A§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§<!&§[param1];
            _loc3_.dispatchEvent(new Event(Event.§`!O§,true));
            if(stage)
            {
      ...
      public function §&x§(param1:int, param2:int) : void
      {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§<!&§[_loc6_];
            §0!V§(_loc7_,§!k§);
            transformCoords(§!k§,_loc3_,_loc4_,§">§);
      ...
      public function §3E§(param1:Event) : void
      {
         if(param1.bubbles)
         {
