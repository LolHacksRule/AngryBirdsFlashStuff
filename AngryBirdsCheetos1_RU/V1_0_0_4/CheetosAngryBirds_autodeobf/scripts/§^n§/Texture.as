package §^n§
{
   ...
   public class Texture
   {
      ...
      public static function §5!]§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §^n§.Texture
      {
         return §-B§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §-B§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §^n§.Texture
      {
         ...
         _loc10_ = new §6p§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§'C§.§1!;§)
         {
            _loc10_.§1!&§(param2);
         }
      ...
      public static function §6!5§(param1:Context3D, param2:ByteArray) : §^n§.Texture
      {
         if(param1 == null)
         {
            throw new §>!C§();
         ...
         var _loc9_:§6p§ = new §6p§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§'C§.§1!;§)
         {
            _loc9_.§1!&§(param2);
         }
      ...
      public static function §&k§(param1:§^n§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §^n§.Texture
      {
         var _loc4_:§^n§.Texture;
         (_loc4_ = new §;!_§(param1,param2)).§2!D§ = param3;
         return _loc4_;
      }
      
      public static function §%!8§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §^n§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§^n§.Texture = §-B§(param1,_loc6_,false,param5);
         if(!§'C§.§1!;§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§^!C§, param2:int, param3:int) : void
      {
         ...
         if(this.§2!D§)
         {
            ...
            _loc4_ = this.§2!D§.width + this.§2!D§.x - this.width;
            _loc5_ = this.§2!D§.height + this.§2!D§.y - this.height;
            param1.§!L§(param2,-this.§2!D§.x,-this.§2!D§.y);
            param1.§!L§(param2 + 1,-_loc4_,-this.§2!D§.y);
            param1.§!L§(param2 + 2,-this.§2!D§.x,-_loc5_);
            param1.§!L§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      
      public function get §`§() : Rectangle
      {
         return !!this.§2!D§ ? this.§2!D§.clone() : new Rectangle(0,0,this.width,this.height);
      }
      ...
      public function get root() : §^n§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §^n§.Texture
      {
         return this;
      }
