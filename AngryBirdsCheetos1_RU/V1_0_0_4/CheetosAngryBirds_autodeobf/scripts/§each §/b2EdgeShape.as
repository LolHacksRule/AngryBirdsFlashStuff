package §each §
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§ '§ = this.§]`§.Normalize();
         this.§8n§.Set(this.§]`§.y,-this.§]`§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§8n§.x - this.§]`§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§8n§.y - this.§]`§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§8n§.x + this.§]`§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§8n§.y + this.§]`§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§8n§;
         this.m_cornerDir2.Set(-this.§8n§.x,-this.§8n§.y);
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc8_:Number = b2Math.§0U§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§0U§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function § try§() : b2EdgeShape
      {
         return this.§[!%§;
      }
      ...
      public function §<k§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
      ...
      b2internal function §6n§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§[!%§ = param1;
