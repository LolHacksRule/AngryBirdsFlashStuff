package §each §
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      b2internal var §9N§:Vector.<b2Vec2>;
      ...
      public static function §&!2§(param1:Array, param2:Number) : b2PolygonShape
      {
         ...
         _loc3_.§7!1§(param1,param2);
         return _loc3_;
      }
      
      public static function §`h§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §;#§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         ...
         (_loc5_ = new b2PolygonShape()).§]l§(param1,param2,param3,param4);
         return _loc5_;
      }
      ...
      b2internal static function §>`§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§@!Z§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§@!Z§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            while(_loc3_ < this.§-e§)
            {
               ...
               this.§9N§[_loc3_].SetV(_loc2_.§9N§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §7!1§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function § !7§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§-e§)
         {
            ...
            _loc6_ = b2Math.§@!^§(this.§[!G§[_loc5_],this.§[!G§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§1c§() > Number.MIN_VALUE);
            this.§9N§[_loc3_].SetV(b2Math.§+]§(_loc6_,1));
            this.§9N§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§'j§ = §,!$§(this.§[!G§,this.§-e§);
      }
      
      public function §58§(param1:Number, param2:Number) : void
      {
         this.§-e§ = 4;
         this.§@e§(4);
      ...
      public function §]l§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§-e§ = 4;
         this.§@e§(4);
         this.§[!G§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§-e§)
         {
            this.§[!G§[_loc6_] = b2Math.§=$§(_loc5_,this.§[!G§[_loc6_]);
            this.§9N§[_loc6_] = b2Math.§8%§(_loc5_.R,this.§9N§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §1u§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§-e§ = 2;
         this.§@e§(2);
         this.§[!G§[0].SetV(param1);
         this.§[!G§[1].SetV(param2);
         this.§'j§.x = 0.5 * (param1.x + param2.x);
         this.§'j§.y = 0.5 * (param1.y + param2.y);
         this.§9N§[0] = b2Math.§+]§(b2Math.§@!^§(param2,param1),1);
         this.§9N§[0].Normalize();
         this.§9N§[1].x = -this.§9N§[0].x;
         this.§9N§[1].y = -this.§9N§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         while(_loc17_ < this.§-e§)
         {
            ...
            _loc18_ = (_loc9_ = this.§9N§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§0!<§.x = _loc5_ - b2internal::>!;;
         param1.§0!<§.y = _loc6_ - b2internal::>!;;
         param1.§+;§.x = _loc7_ + b2internal::>!;;
         param1.§+;§.y = _loc8_ + b2internal::>!;;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         while(_loc10_ < this.§-e§)
         {
            ...
            _loc12_ = _loc10_ + 1 < this.§-e§ ? this.§[!G§[int(_loc10_ + 1)] : this.§[!G§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§0U§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§0U§(_loc5_,this.§[!G§[_loc12_]) - _loc6_;
      ...
      public function §2C§() : Vector.<b2Vec2>
      {
         return this.§[!G§;
      }
      
      public function §95§() : Vector.<b2Vec2>
      {
         return this.§9N§;
      }
