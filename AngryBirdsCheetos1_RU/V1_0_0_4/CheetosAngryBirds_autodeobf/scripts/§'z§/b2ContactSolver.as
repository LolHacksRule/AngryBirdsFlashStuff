package §'z§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §;2§:b2WorldManifold = new b2WorldManifold();
      
      private static var §]!L§:b2PositionSolverManifold = new b2PositionSolverManifold();
      ...
      b2internal var §40§:Vector.<b2ContactConstraint>;
      ...
      public function b2ContactSolver()
      {
         ...
         this.§40§ = new Vector.<b2ContactConstraint>();
         super();
      }
      ...
      public function §2![§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§"m§ = param4;
         this.§02§ = param3;
         while(this.§40§.length < this.§02§)
         {
            this.§40§[this.§40§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§&L§;
            _loc10_ = _loc5_.§8! §;
            _loc11_ = _loc9_.§[q§;
            _loc12_ = _loc10_.§[q§;
            _loc13_ = _loc11_.§>!;§;
            ...
            b2Settings.b2Assert(_loc17_.§<n§ > 0);
            §;2§.§2![§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §;2§.§8n§.x;
            _loc27_ = §;2§.§8n§.y;
            (_loc28_ = this.§40§[_loc6_]).§1I§ = _loc15_;
            _loc28_.§!T§ = _loc16_;
            _loc28_.§<!<§ = _loc17_;
            ...
            _loc28_.§'w§.x = _loc17_.§4S§.x;
            _loc28_.§'w§.y = _loc17_.§4S§.y;
            ...
            while(_loc29_ < _loc28_.§@!K§)
            {
               ...
               (_loc31_ = _loc28_.§?v§[_loc29_]).normalImpulse = _loc30_.§#!9§;
               _loc31_.tangentImpulse = _loc30_.§1d§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§=b§.x = §;2§.§!!=§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§=b§.y = §;2§.§!!=§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§<!F§.x = §;2§.§!!=§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§<!F§.y = §;2§.§!!=§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§"!§ + _loc16_.§"!§ + _loc15_.§9y§ * _loc36_ + _loc16_.§9y§ * _loc37_;
               _loc31_.§6!A§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§9!=§ * _loc15_.§"!§ + _loc16_.§9!=§ * _loc16_.§"!§) + (_loc15_.§9!=§ * _loc15_.§9y§ * _loc36_ + _loc16_.§9!=§ * _loc16_.§9y§ * _loc37_);
               _loc31_.§+!X§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§"!§ + _loc16_.§"!§ + _loc15_.§9y§ * _loc42_ + _loc16_.§9y§ * _loc43_;
               _loc31_.§]!T§ = 1 / _loc44_;
               _loc31_.§'=§ = 0;
            ...
            if(_loc28_.§@!K§ == 2)
            {
               ...
               _loc57_ = _loc49_.§<!F§.x * _loc27_ - _loc49_.§<!F§.y * _loc26_;
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.§02§)
         {
            _loc7_ = (_loc6_ = this.§40§[_loc5_]).§1I§;
            _loc8_ = _loc6_.§!T§;
            _loc9_ = _loc7_.§"!§;
            _loc10_ = _loc7_.§9y§;
            _loc11_ = _loc8_.§"!§;
            ...
            if(param1.§[1§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc20_.normalImpulse *= param1.§8!J§;
                  _loc20_.tangentImpulse *= param1.§8!J§;
                  ...
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§<!F§.x * _loc22_ - _loc20_.§<!F§.y * _loc21_);
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§02§)
         {
            _loc26_ = (_loc25_ = this.§40§[_loc24_]).§1I§;
            _loc27_ = _loc25_.§!T§;
            ...
            while(_loc1_ < _loc25_.§@!K§)
            {
               ...
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§<!F§.y - _loc30_.x + _loc28_ * _loc2_.§=b§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§<!F§.x - _loc30_.y - _loc28_ * _loc2_.§=b§.x;
               ...
               _loc29_ += _loc35_ * (_loc2_.§<!F§.x * _loc15_ - _loc2_.§<!F§.y * _loc14_);
            ...
            if(_loc25_.§@!K§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§6!A§ * (_loc9_ - _loc2_.§'=§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§<!F§.y - _loc30_.x + _loc28_ * _loc43_.§=b§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§<!F§.x - _loc30_.y - _loc28_ * _loc43_.§=b§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§<!F§.y - _loc30_.x + _loc28_ * _loc44_.§=b§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§<!F§.x - _loc30_.y - _loc28_ * _loc44_.§=b§.x;
               ...
               _loc55_ = 0.001;
               _loc56_ = -((_loc22_ = _loc25_.§6!A§).col1.x * _loc53_ + _loc22_.col2.x * _loc54_);
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc29_ += _loc35_ * (_loc43_.§<!F§.x * _loc19_ - _loc43_.§<!F§.y * _loc18_ + _loc44_.§<!F§.x * _loc21_ - _loc44_.§<!F§.y * _loc20_);
                  _loc43_.normalImpulse = _loc56_;
                  _loc44_.normalImpulse = _loc57_;
               }
               else
               {
                  _loc56_ = -_loc43_.§6!A§ * _loc53_;
                  _loc57_ = 0;
                  _loc51_ = 0;
      ...
      public function §6!M§() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.§02§)
         {
            _loc2_ = this.§40§[_loc1_];
            _loc3_ = _loc2_.§<!<§;
            _loc4_ = 0;
            while(_loc4_ < _loc2_.§@!K§)
            {
               ...
               _loc5_.§1d§ = _loc6_.tangentImpulse;
               _loc4_++;
            }
            _loc1_++;
         }
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:Number = 0;
         var _loc3_:int = 0;
         while(_loc3_ < this.§02§)
         {
            _loc5_ = (_loc4_ = this.§40§[_loc3_]).§1I§;
            _loc6_ = _loc4_.§!T§;
            _loc7_ = _loc5_.§9!=§ * _loc5_.§"!§;
            _loc8_ = _loc5_.§9!=§ * _loc5_.§9y§;
            _loc9_ = _loc6_.§9!=§ * _loc6_.§"!§;
            _loc10_ = _loc6_.§9!=§ * _loc6_.§9y§;
            §]!L§.§2![§(_loc4_);
            _loc11_ = §]!L§.§8n§;
            _loc12_ = 0;
