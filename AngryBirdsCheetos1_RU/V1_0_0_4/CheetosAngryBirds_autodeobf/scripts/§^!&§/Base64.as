package §^!&§
{
   ...
   public class Base64
   {
      ...
      private static const §"!P§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §0A§(param1:ByteArray) : String
      {
      ...
      public static function §'!J§(param1:String) : ByteArray
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §"!P§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
