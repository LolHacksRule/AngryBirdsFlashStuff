package §5n§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§8!2§.x * this.§>N§.x + (this.§ u§ + this.§8!2§.y) * this.§-g§.x),param1 * (this.§8!2§.x * this.§>N§.y + (this.§ u§ + this.§8!2§.y) * this.§-g§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§9!8§ = this.§9!8§ > Number.MIN_VALUE ? Number(1 / this.§9!8§) : Number(0);
         ...
         this.§!8§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§!8§.col2.x = this.§!8§.col1.y;
         this.§!8§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§>5§)
         {
         ...
         if(param1.§[1§)
         {
            ...
            this.§ u§ *= param1.§8!J§;
            _loc19_ = this.§8!2§.x * this.§>N§.x + (this.§ u§ + this.§8!2§.y) * this.§-g§.x;
            _loc20_ = this.§8!2§.x * this.§>N§.y + (this.§ u§ + this.§8!2§.y) * this.§-g§.y;
            _loc21_ = this.§8!2§.x * this.m_s1 + (this.§ u§ + this.§8!2§.y) * this.m_a1;
            _loc22_ = this.§8!2§.x * this.m_s2 + (this.§ u§ + this.§8!2§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§3-§ && this.§<m§ != b2internal::9P)
         {
            ...
            _loc14_ = this.§9!8§ * (this.§3!"§ - _loc13_);
            _loc15_ = this.§ u§;
            _loc16_ = param1.§0O§ * this.§5!U§;
            this.§ u§ = b2Math.§=!,§(this.§ u§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§ u§ - _loc15_) * this.§-g§.x;
         ...
         if(this.§>5§ && this.§<m§ != b2internal::`4)
         {
            ...
            _loc18_ = this.§8!2§.Copy();
            _loc19_ = this.§!8§.§;!N§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§8!2§.§0![§(_loc19_);
            if(this.§<m§ == b2internal::@E)
            {
               this.§8!2§.y = b2Math.§`!L§(this.§8!2§.y,0);
            }
            else if(this.§<m§ == b2internal::3G)
            {
               this.§8!2§.y = b2Math.§;!5§(this.§8!2§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§8!2§.y - _loc18_.y) * this.§!8§.col2.x;
            if(this.§!8§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§!8§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§8!2§.x = _loc21_;
            _loc19_.x = this.§8!2§.x - _loc18_.x;
            _loc19_.y = this.§8!2§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§>N§.x + _loc19_.y * this.§-g§.x;
            _loc9_ = _loc19_.x * this.§>N§.y + _loc19_.y * this.§-g§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§>5§)
         {
            ...
            {
               _loc19_ = b2Math.§=!,§(_loc34_ - this.§ !L§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§ !L§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§0R§)
            {
               _loc19_ = b2Math.§=!,§(_loc34_ - this.§0R§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§0R§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§!8§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§!8§.col2.x = this.§!8§.col1.y;
            this.§!8§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§!8§.§;!N§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::3!5;
         ...
         var _loc30_:Number = _loc28_.x * this.§>N§.x + _loc28_.y * this.§-g§.x;
         var _loc31_:Number = _loc28_.x * this.§>N§.y + _loc28_.y * this.§-g§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::3!5 * _loc30_;
         _loc6_.y -= b2internal::3!5 * _loc31_;
         _loc7_ -= b2internal::6! * _loc32_;
         _loc8_.x += b2internal::"M * _loc30_;
         _loc8_.y += b2internal::"M * _loc31_;
