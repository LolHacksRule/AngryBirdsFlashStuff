package §5n§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§4%§ = b2internal::"8.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§,!?§.x - this.§4%§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§,!?§.y - this.§4%§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§^f§.x - this.§4%§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§^f§.y - this.§4%§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§!!B§);
         this.m_localAnchor2.SetV(param1.§<!_§);
         this.§?_§ = param1.§@d§;
         this.§-&§ = param1.§6k§ + this.§?_§ * param1.§"!`§;
         this.m_maxLength1 = b2Math.§;!5§(param1.§5!>§,this.§-&§ - this.§?_§ * b2internal::,");
         this.m_maxLength2 = b2Math.§;!5§(param1.§,$§,(this.§-&§ - b2internal::,") / this.§?_§);
         this.§8!2§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§8!2§ * this.m_u2.x,param1 * this.§8!2§ * this.m_u2.y);
      }
      ...
      {
         var _loc1_:b2Vec2 = b2internal::"8.GetWorldPoint(this.m_localAnchor1);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            this.m_limitState1 = b2internal::3G;
         }
         ...
         {
            this.m_limitState2 = b2internal::3G;
         }
         var _loc21_:Number = _loc5_ * this.m_u1.y - _loc6_ * this.m_u1.x;
         var _loc22_:Number = _loc8_ * this.m_u2.y - _loc9_ * this.m_u2.x;
         this.m_limitMass1 = _loc2_.§"!§ + _loc2_.§9y§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§"!§ + _loc3_.§9y§ * _loc22_ * _loc22_;
         this.§%!X§ = this.m_limitMass1 + this.§?_§ * this.§?_§ * this.m_limitMass2;
         ...
         {
            this.§8!2§ *= param1.§8!J§;
            this.m_limitImpulse1 *= param1.§8!J§;
            this.m_limitImpulse2 *= param1.§8!J§;
            _loc23_ = (-this.§8!2§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§8!2§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§?_§ * this.§8!2§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§?_§ * this.§8!2§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§;!#§.x += _loc2_.§"!§ * _loc23_;
            _loc2_.§;!#§.y += _loc2_.§"!§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§9y§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§;!#§.x += _loc3_.§"!§ * _loc25_;
            _loc3_.§;!#§.y += _loc3_.§"!§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§9y§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§8!2§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§<1§ == b2internal::3G)
         {
            ...
            _loc19_ = this.§%!X§ * -_loc18_;
            _loc20_ = this.§8!2§;
            this.§8!2§ = b2Math.§`!L§(0,this.§8!2§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§8!2§ - _loc20_) * this.m_u1.x;
            ...
            _loc2_.m_angularVelocity += _loc2_.§9y§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§;!#§.x += _loc3_.§"!§ * _loc16_;
            _loc3_.§;!#§.y += _loc3_.§"!§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§9y§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
         if(this.m_limitState1 == b2internal::3G)
         {
            _loc10_ = _loc2_.§;!#§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§;!#§.y + _loc2_.m_angularVelocity * _loc5_;
         ...
         if(this.m_limitState2 == b2internal::3G)
         {
            _loc12_ = _loc3_.§;!#§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§;!#§.y + _loc3_.m_angularVelocity * _loc8_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§<1§ == b2internal::3G)
         {
            ...
            _loc13_ = -(_loc20_ = -this.§%!X§ * _loc19_) * this.m_u1.x;
            ...
            _loc2_.m_sweep.a += _loc2_.§9y§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§"!§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§"!§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§9y§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§8]§();
            _loc3_.§8]§();
         }
         if(this.m_limitState1 == b2internal::3G)
