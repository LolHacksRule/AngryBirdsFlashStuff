package §[I§
{
   ...
   public class §&^§
   {
      ...
      public static function §2,§() : String
      {
         ...
         var _loc5_:String;
         return (_loc5_ = §=L§(_loc2_ + _loc4_ + _loc3_ + counter++).toUpperCase()).substring(0,8) + _loc5_.substring(8,12) + _loc5_.substring(12,16) + _loc5_.substring(16,20) + _loc5_.substring(20,32);
      }
      
      private static function §=L§(param1:String) : String
      {
         return §&!P§(param1);
      }
      ...
      {
         return §;!0§(§[5§(§;F§(param1),param1.length * 8));
      }
      
      private static function §[5§(param1:Array, param2:Number) : Array
      {
         ...
         while(_loc9_ < param1.length)
         {
            ...
            while(_loc15_ < 80)
            {
               ...
               {
                  _loc3_[_loc15_] = §2!=§(_loc3_[_loc15_ - 3] ^ _loc3_[_loc15_ - 8] ^ _loc3_[_loc15_ - 14] ^ _loc3_[_loc15_ - 16],1);
               }
               _loc16_ = §6!E§(§6!E§(§2!=§(_loc4_,5),sha1_ft(_loc15_,_loc5_,_loc6_,_loc7_)),§6!E§(§6!E§(_loc8_,_loc3_[_loc15_]),sha1_kt(_loc15_)));
               _loc8_ = _loc7_;
               _loc7_ = _loc6_;
               _loc6_ = §2!=§(_loc5_,30);
               _loc5_ = _loc4_;
            ...
            _loc4_ = §6!E§(_loc4_,_loc10_);
            _loc5_ = §6!E§(_loc5_,_loc11_);
            _loc6_ = §6!E§(_loc6_,_loc12_);
            _loc7_ = §6!E§(_loc7_,_loc13_);
            _loc8_ = §6!E§(_loc8_,_loc14_);
            _loc9_ += 16;
         }
      ...
      private static function §6!E§(param1:Number, param2:Number) : Number
      {
      ...
      private static function §2!=§(param1:Number, param2:Number) : Number
      {
         return param1 << param2 | param1 >>> 32 - param2;
      }
      
      private static function §;F§(param1:String) : Array
      {
