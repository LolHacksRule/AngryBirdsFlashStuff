package § e§
{
   ...
   public class § !§
   {
      ...
      public static var §4E§:ByteArray;
      ...
      public static function §5,§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §&C§(_loc2_);
         return §2Z§.§!M§(_loc3_.readInt(),true) + §2Z§.§!M§(_loc3_.readInt(),true) + §2Z§.§!M§(_loc3_.readInt(),true) + §2Z§.§!M§(_loc3_.readInt(),true) + §2Z§.§!M§(_loc3_.readInt(),true);
      }
      
      public static function §4J§(param1:ByteArray) : String
      {
      ...
      private static function §&C§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
