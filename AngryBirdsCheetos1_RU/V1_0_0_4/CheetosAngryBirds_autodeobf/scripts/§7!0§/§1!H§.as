package §7!0§
{
   ...
   public class §1!H§ extends §<!9§
   {
       
      
      public function §1!H§(param1:Object, param2:BitmapData)
      {
         super(param2);
         this.§+5§(param1);
      }
         ...
         for(_loc3_ in param1)
         {
            if(_loc3_.indexOf("chars") == 0)
            {
               ...
               for(_loc5_ in _loc4_)
               {
                  ...
                  (_loc7_ = new §`C§()).mName = String.fromCharCode(_loc6_.code);
                  _loc7_.§<j§ = new Rectangle(_loc6_.x,_loc6_.y,_loc6_.width,_loc6_.height);
                  _loc7_.§ z§ = _loc6_.width / 2;
                  _loc7_.§]E§ = _loc6_.baseline;
                  _loc7_.§7E§ = §`5§;
                  §=#§(_loc7_);
               }
            }
