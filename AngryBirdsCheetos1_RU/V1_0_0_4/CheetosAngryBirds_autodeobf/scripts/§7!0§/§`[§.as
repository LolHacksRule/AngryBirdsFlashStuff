package §7!0§
{
   ...
   public class §`[§ extends §<!9§
   {
      ...
      protected function §+5§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         var _loc16_:§`C§ = null;
         var _loc3_:Dictionary = this.§^!T§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§-!H§(_loc7_,_loc6_)]) == null)
            {
               ...
               {
                  _loc10_ = new §8!+§(0,0,_loc11_,_loc12_,_loc13_,_loc14_);
               }
            }
            if(_loc10_)
            {
               _loc15_ = new Rectangle(_loc8_ + _loc10_.x,_loc9_ + _loc10_.y,_loc10_.width,_loc10_.height);
               (_loc16_ = new §`C§()).mName = _loc6_;
               _loc16_.§<j§ = _loc15_;
               _loc16_.§ z§ = _loc10_.pivotX;
               _loc16_.§]E§ = _loc10_.pivotY;
               _loc16_.§7E§ = §`5§;
               §=#§(_loc16_);
            }
         }
      ...
      private function §^!T§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§-!H§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §8!+§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
