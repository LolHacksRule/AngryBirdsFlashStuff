         ...
         switch(param1.§&>§)
         {
            case b2Manifold.§9_§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§8n§.x = _loc19_ / _loc26_;
                  this.§8n§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§8n§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§8n§.x;
               _loc23_ = _loc16_ + param3 * this.§8n§.y;
               _loc24_ = _loc17_ - param5 * this.§8n§.x;
               _loc25_ = _loc18_ - param5 * this.§8n§.y;
