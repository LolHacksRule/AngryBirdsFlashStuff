package §]M§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §2![§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§&>§ = §"!E§;
            _loc7_ = this.§<! §.§8x§(param1.indexA[0]);
            _loc10_ = this.§;_§.§8x§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§&>§ = § V§;
            _loc8_ = this.§<! §.§8x§(param1.indexA[0]);
            _loc9_ = this.§<! §.§8x§(param1.indexA[1]);
            _loc10_ = this.§;_§.§8x§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§-g§ = b2Math.§+]§(b2Math.§@!^§(_loc9_,_loc8_),1);
            this.§-g§.Normalize();
            _loc20_ = this.§-g§;
         ...
         {
            this.§&>§ = §5!V§;
            _loc11_ = this.§;_§.§8x§(param1.indexB[0]);
            _loc12_ = this.§;_§.§8x§(param1.indexB[1]);
            _loc7_ = this.§<! §.§8x§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§-g§ = b2Math.§+]§(b2Math.§@!^§(_loc12_,_loc11_),1);
            this.§-g§.Normalize();
            _loc20_ = this.§-g§;
         ...
         else
         {
            ...
            _loc24_ = b2Math.§8%§(param3.R,b2Math.§@!^§(_loc9_,_loc8_));
            _loc25_ = b2Math.§=$§(param5,_loc10_);
            _loc26_ = b2Math.§8%§(param5.R,b2Math.§@!^§(_loc12_,_loc11_));
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         switch(this.§&>§)
         {
            case §"!E§:
               ...
               _loc4_ = b2Math.§+!"§(param2.R,this.§-g§.§3C§());
               _loc5_ = this.§<! §.§1!V§(_loc3_);
               _loc6_ = this.§;_§.§1!V§(_loc4_);
               _loc7_ = b2Math.§=$§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§=$§(param2,_loc6_)).x - _loc7_.x) * this.§-g§.x + (_loc8_.y - _loc7_.y) * this.§-g§.y);
            case § V§:
               _loc10_ = b2Math.§8%§(param1.R,this.§-g§);
               _loc7_ = b2Math.§=$§(param1,this.m_localPoint);
               _loc4_ = b2Math.§+!"§(param2.R,_loc10_.§3C§());
               _loc6_ = this.§;_§.§1!V§(_loc4_);
               return Number(((_loc8_ = b2Math.§=$§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §5!V§:
               _loc10_ = b2Math.§8%§(param2.R,this.§-g§);
               _loc8_ = b2Math.§=$§(param2,this.m_localPoint);
               _loc3_ = b2Math.§+!"§(param1.R,_loc10_.§3C§());
               _loc5_ = this.§<! §.§1!V§(_loc3_);
