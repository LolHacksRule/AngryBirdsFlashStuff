package §]M§
{
   ...
   public class b2Collision
   {
      ...
      private static var §#6§:Vector.<§17§> = §>!I§();
      
      private static var s_clipPoints1:Vector.<§17§> = §>!I§();
      
      private static var s_clipPoints2:Vector.<§17§> = §>!I§();
      ...
      private static var §6!K§:b2Vec2 = new b2Vec2();
      
      private static var §2k§:b2Vec2 = new b2Vec2();
      ...
      public static function §+!4§(param1:Vector.<§17§>, param2:Vector.<§17§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§17§ = null;
         var _loc6_:int = 0;
      ...
      public static function §3!>§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param1.§9N§;
      ...
      public static function §!! §(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param2.§9N§;
         _loc9_ = param5.R;
         _loc8_ = param4.§'j§;
      ...
      public static function §[T§(param1:Vector.<§17§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param2.§9N§;
         var _loc9_:int = param5.§-e§;
         var _loc10_:Vector.<b2Vec2> = param5.§[!G§;
         var _loc11_:Vector.<b2Vec2> = param5.§9N§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§<!E§.§-z§ = param4;
         _loc20_.id.§<!E§.§-a§ = _loc21_;
         _loc20_.id.§<!E§.§]!>§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§<!E§.§-z§ = param4;
         _loc20_.id.§<!E§.§-a§ = _loc22_;
         _loc20_.id.§<!E§.§]!>§ = 1;
      }
      
      private static function §>!I§() : Vector.<§17§>
      {
         var _loc1_:Vector.<§17§> = new Vector.<§17§>(2);
         _loc1_[0] = new §17§();
         _loc1_[1] = new §17§();
         return _loc1_;
      }
      ...
      public static function §]!]§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §!m§[0] = _loc8_;
         var _loc9_:Number = §!! §(§!m§,param2,param3,param4,param5);
         _loc8_ = §!m§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §"!M§[0] = _loc10_;
         var _loc11_:Number = §!! §(§"!M§,param4,param5,param2,param3);
         _loc10_ = §"!M§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §>k§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §6!K§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §2k§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §]e§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§17§> = s_clipPoints1;
         var _loc38_:Vector.<§17§> = s_clipPoints2;
         if((_loc39_ = §+!4§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §+!4§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§4S§.SetV(_loc27_);
      ...
      public static function §%t§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§&>§ = b2Manifold.§9_§;
         param1.m_localPoint.SetV(param2.§@K§);
         param1.§4S§.§6d§();
         param1.§<n§ = 1;
         param1.§!!=§[0].m_localPoint.SetV(param4.§@K§);
         param1.§!!=§[0].m_id.key = 0;
      }
      ...
      public static function §+!B§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc23_:Vector.<b2Vec2> = param2.§9N§;
         var _loc24_:int = 0;
         ...
         if(_loc19_ < Number.MIN_VALUE)
         {
            param1.§<n§ = 1;
            param1.§&>§ = b2Manifold.§ V§;
            param1.§4S§.SetV(_loc23_[_loc18_]);
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§<n§ = 1;
            param1.§&>§ = b2Manifold.§ V§;
            param1.§4S§.x = _loc15_ - _loc27_.x;
            param1.§4S§.y = _loc16_ - _loc27_.y;
            param1.§4S§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§<n§ = 1;
            param1.§&>§ = b2Manifold.§ V§;
            param1.§4S§.x = _loc15_ - _loc28_.x;
            param1.§4S§.y = _loc16_ - _loc28_.y;
            param1.§4S§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§!!=§[0].m_localPoint.SetV(param4.§@K§);
            param1.§!!=§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§<n§ = 1;
            param1.§&>§ = b2Manifold.§ V§;
            param1.§4S§.x = _loc23_[_loc25_].x;
            param1.§4S§.y = _loc23_[_loc25_].y;
            param1.§4S§.Normalize();
