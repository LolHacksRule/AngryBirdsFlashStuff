   ...
   class b2Simplex
   {
      ...
      public function §+k§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         while(_loc9_ < this.§>!D§)
         {
            ...
            _loc6_ = param2.§8x§(_loc10_.indexA);
            _loc7_ = param4.§8x§(_loc10_.indexB);
            _loc10_.§3!]§ = b2Math.§=$§(param3,_loc6_);
            _loc10_.§9!$§ = b2Math.§=$§(param5,_loc7_);
            _loc10_.§3T§ = b2Math.§@!^§(_loc10_.§9!$§,_loc10_.§3!]§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§>!D§ > 1)
      ...
      public function §5M§(param1:b2SimplexCache) : void
      {
         param1.§=!$§ = this.§#y§();
         param1.count = uint(this.§>!D§);
      ...
      public function §`r§() : b2Vec2
      {
         ...
         {
            case 1:
               return this.m_v1.§3T§.§3C§();
            case 2:
               _loc1_ = b2Math.§@!^§(this.m_v2.§3T§,this.m_v1.§3T§);
               _loc2_ = b2Math.§^,§(_loc1_,this.m_v1.§3T§.§3C§());
               if(_loc2_ > 0)
               {
      ...
      public function §48§() : b2Vec2
      {
         switch(this.§>!D§)
         {
            ...
            case 1:
               return this.m_v1.§3T§;
            case 2:
               return new b2Vec2(this.m_v1.a * this.m_v1.§3T§.x + this.m_v2.a * this.m_v2.§3T§.x,this.m_v1.a * this.m_v1.§3T§.y + this.m_v2.a * this.m_v2.§3T§.y);
            default:
               b2Settings.b2Assert(false);
               return new b2Vec2();
         }
      ...
      public function §#y§() : Number
      {
         switch(this.§>!D§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§@!^§(this.m_v1.§3T§,this.m_v2.§3T§).§%C§();
            case 3:
               return b2Math.§^,§(b2Math.§@!^§(this.m_v2.§3T§,this.m_v1.§3T§),b2Math.§@!^§(this.m_v3.§3T§,this.m_v1.§3T§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      {
         var _loc1_:b2Vec2 = this.m_v1.§3T§;
         var _loc2_:b2Vec2 = this.m_v2.§3T§;
      ...
      public function Solve3() : void
      {
         ...
         var _loc1_:b2Vec2 = this.m_v1.§3T§;
         var _loc2_:b2Vec2 = this.m_v2.§3T§;
         var _loc3_:b2Vec2 = this.m_v3.§3T§;
         var _loc4_:b2Vec2 = b2Math.§@!^§(_loc2_,_loc1_);
         var _loc5_:Number = b2Math.§0U§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§0U§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§@!^§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§0U§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§0U§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§@!^§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§0U§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§0U§(_loc3_,_loc14_);
