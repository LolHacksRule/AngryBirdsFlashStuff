package §5!K§
{
   public class b2Vec2
   {
      ...
      public static function §%!9§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §3!A§(param1:b2Mat22) : void
      {
      ...
      {
         var _loc2_:Number = b2Math.§0U§(this,param1.col1);
         this.y = b2Math.§0U§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      {
         return b2Math.§0!Q§(this.x) && b2Math.§0!Q§(this.y);
      }
   }
}
