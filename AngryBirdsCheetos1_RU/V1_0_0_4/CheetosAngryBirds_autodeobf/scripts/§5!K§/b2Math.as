package §5!K§
{
   public class b2Math
   {
      ...
      public static function §0!Q§(param1:Number) : Boolean
      {
      ...
      {
         return new b2Vec2(§0U§(param2,param1.col1),§0U§(param2,param1.col2));
      }
      ...
      public static function §6h§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§`H§(§8!§(param1.col1,param2.col1),§8!§(param1.col2,param2.col2));
      }
      
      public static function §[!N§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§`H§(§8%§(param1,param2.col1),§8%§(param1,param2.col2));
      }
      
      public static function §4!D§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§0U§(param1.col1,param2.col1),§0U§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§0U§(param1.col1,param2.col2),§0U§(param1.col2,param2.col2));
      ...
      public static function §4!S§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§`H§(§=!8§(param1.col1),§=!8§(param1.col2));
      }
      ...
      public static function §5A§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function include(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §5A§(param2,§4!]§(param1,param3));
      }
