package §8!P§
{
   ...
   public class §try § extends §60§
   {
      ...
      public function §try §(param1:Number, param2:Number, param3:String, param4:Number, param5:Number)
      {
         super(param1,param2);
         this.§8!G§ = param3;
         this.§"?§ = param4;
      ...
      override public function update(param1:Number, param2:Sprite, param3:§>g§) : Boolean
      {
         ...
         if(param1 > this.time)
         {
            ...
            {
               _loc4_.scaleX = this.§"?§ + (this.§'G§ - this.§"?§) * this.§9!M§(param1);
               _loc4_.scaleY = this.§"?§ + (this.§'G§ - this.§"?§) * this.§9!M§(param1);
            }
         }
         if(param1 >= this.time + duration)
         {
      ...
      {
         return new §try §(time,duration,this.§8!G§,this.§"?§,this.§'G§);
      }
   }
}
