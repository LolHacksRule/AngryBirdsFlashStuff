package § else§
{
   ...
   public class §6!7§
   {
      ...
      public function §6!7§(param1:*)
      {
         super();
         this.§`d§ = this.§`!S§(param1);
      }
      ...
      private function §`!S§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§2E§(param1 as String);
         }
         if(param1 is Number)
         {
      ...
      private function §2E§(param1:String) : String
      {
      ...
      private function §!u§(param1:Array) : String
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§`!S§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §"!Z§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§2E§(v.@name.toString()) + ":" + this.§`!S§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
