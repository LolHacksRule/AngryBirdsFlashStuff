package §9A§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§&S§.x * this.§#!W§.x + (this.§"^§ + this.§&S§.y) * this.§1G§.x),param1 * (this.§&S§.x * this.§#!W§.y + (this.§"^§ + this.§&S§.y) * this.§1G§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§4!&§ = this.§4!&§ > Number.MIN_VALUE ? Number(1 / this.§4!&§) : Number(0);
         ...
         this.§0!2§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§0!2§.col2.x = this.§0!2§.col1.y;
         this.§0!2§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§`z§)
         {
         ...
         if(param1.§4!D§)
         {
            ...
            this.§&S§.y *= param1.§1a§;
            this.§"^§ *= param1.§1a§;
            _loc19_ = this.§&S§.x * this.§#!W§.x + (this.§"^§ + this.§&S§.y) * this.§1G§.x;
            _loc20_ = this.§&S§.x * this.§#!W§.y + (this.§"^§ + this.§&S§.y) * this.§1G§.y;
            _loc21_ = this.§&S§.x * this.m_s1 + (this.§"^§ + this.§&S§.y) * this.m_a1;
            _loc22_ = this.§&S§.x * this.m_s2 + (this.§"^§ + this.§&S§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§1G§.x * (_loc6_.x - _loc4_.x) + this.§1G§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§4!&§ * (this.§4!A§ - _loc13_);
            _loc15_ = this.§"^§;
            _loc16_ = param1.§+!I§ * this.§;!7§;
            this.§"^§ = b2Math.§;f§(this.§"^§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§"^§ - _loc15_) * this.§1G§.x;
            _loc9_ = _loc14_ * this.§1G§.y;
         ...
         {
            _loc17_ = this.§1G§.x * (_loc6_.x - _loc4_.x) + this.§1G§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§&S§.Copy();
            _loc19_ = this.§0!2§.§-!X§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§&S§.§=O§(_loc19_);
            if(this.§%&§ == b2internal::1-)
            {
               this.§&S§.y = b2Math.§[!6§(this.§&S§.y,0);
            }
            else if(this.§%&§ == b2internal::<j)
            {
               this.§&S§.y = b2Math.§]!A§(this.§&S§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§&S§.y - _loc18_.y) * this.§0!2§.col2.x;
            if(this.§0!2§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§0!2§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§&S§.x = _loc21_;
            _loc19_.x = this.§&S§.x - _loc18_.x;
            _loc19_.y = this.§&S§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§#!W§.x + _loc19_.y * this.§1G§.x;
            _loc9_ = _loc19_.x * this.§#!W§.y + _loc19_.y * this.§1G§.y;
         ...
         else
         {
            if(this.§0!2§.col1.x != 0)
            {
               _loc22_ = -_loc12_ / this.§0!2§.col1.x;
            }
            else
            {
               _loc22_ = 0;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§`z§)
         {
            ...
            _loc34_ = this.§1G§.x * _loc26_ + this.§1G§.y * _loc27_;
            if(b2Math.§@6§(this.§+a§ - this.§7!Y§) < 2 * b2Settings.b2_linearSlop)
            {
            ...
            else if(_loc34_ <= this.§7!Y§)
            {
               _loc19_ = b2Math.§;f§(_loc34_ - this.§7!Y§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§7!Y§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§+a§)
            {
               _loc19_ = b2Math.§;f§(_loc34_ - this.§+a§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§+a§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§0!2§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§0!2§.col2.x = this.§0!2§.col1.y;
            this.§0!2§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§0!2§.§-!X§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::>!3;
         ...
         var _loc30_:Number = _loc28_.x * this.§#!W§.x + _loc28_.y * this.§1G§.x;
         var _loc31_:Number = _loc28_.x * this.§#!W§.y + _loc28_.y * this.§1G§.y;
         ...
         _loc7_ -= b2internal::1@ * _loc32_;
         _loc8_.x += b2internal::5_ * _loc30_;
         _loc8_.y += b2internal::5_ * _loc31_;
         _loc9_ += b2internal::0x * _loc33_;
