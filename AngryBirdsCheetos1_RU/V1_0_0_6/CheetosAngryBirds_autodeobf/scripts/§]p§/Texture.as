package §]p§
{
   ...
   public class Texture
   {
      ...
      public static function §+P§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §]p§.Texture
      {
      ...
      public static function §+!U§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §]p§.Texture
      {
         ...
         return new §7!C§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §2$§(param1:Context3D, param2:ByteArray) : §]p§.Texture
      {
         if(param1 == null)
         {
            throw new §[!%§();
      ...
      public static function §-!7§(param1:§]p§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §]p§.Texture
      {
         var _loc4_:§]p§.Texture;
         (_loc4_ = new §7!C§(param1,param2)).§9!=§ = param3;
         return _loc4_;
      }
      
      public static function §use§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §]p§.Texture
      {
      ...
      public function adjustVertexData(param1:§3!B§, param2:int, param3:int) : void
      {
         ...
         if(this.§9!=§)
         {
            ...
            param1.§^p§(param2,-this.§9!=§.x,-this.§9!=§.y);
            param1.§^p§(param2 + 1,-_loc4_,-this.§9!=§.y);
            param1.§^p§(param2 + 2,-this.§9!=§.x,-_loc5_);
            param1.§^p§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
