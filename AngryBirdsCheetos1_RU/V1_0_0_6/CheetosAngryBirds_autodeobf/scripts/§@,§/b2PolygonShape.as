package §@,§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §7O§:b2Mat22 = new b2Mat22();
      ...
      public function b2PolygonShape()
      {
         ...
         this.§=!$§ = new Vector.<b2Vec2>();
         §!R§ = b2Settings.b2_polygonRadius;
         this.§;w§.§<!5§();
      }
      
      public static function §>i§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function §6!0§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §'U§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§=O§(new b2Vec2(0,0));
            _loc3_.§=O§(_loc9_);
            _loc3_.§=O§(_loc10_);
            _loc3_.§^B§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      public function § L§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§'W§)
         {
            ...
            b2Settings.b2Assert(_loc6_.§@!F§() > Number.MIN_VALUE);
            this.§=!$§[_loc3_].SetV(b2Math.§+! §(_loc6_,1));
            this.§=!$§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§;w§ = §'U§(this.§<!;§,this.§'W§);
      }
      ...
      public function §<!]§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§'W§)
         {
            this.§<!;§[_loc6_] = b2Math.§!r§(_loc5_,this.§<!;§[_loc6_]);
      ...
      public function §@y§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§<!;§[0].SetV(param1);
         this.§<!;§[1].SetV(param2);
         this.§;w§.x = 0.5 * (param1.x + param2.x);
         this.§;w§.y = 0.5 * (param1.y + param2.y);
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§,c§.x = _loc5_ - b2internal::!R;
         param1.§,c§.y = _loc6_ - b2internal::!R;
         param1.§![§.x = _loc7_ + b2internal::!R;
         param1.§![§.y = _loc8_ + b2internal::!R;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         while(_loc10_ < this.§'W§)
         {
            ...
            _loc12_ = _loc10_ + 1 < this.§'W§ ? this.§<!;§[int(_loc10_ + 1)] : this.§<!;§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§7n§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§7n§(_loc5_,this.§<!;§[_loc12_]) - _loc6_;
      ...
      public function § if§() : Vector.<b2Vec2>
      {
         return this.§<!;§;
      }
      
      public function §7b§() : Vector.<b2Vec2>
      {
         return this.§=!$§;
      }
      
      public function §!c§(param1:b2Vec2) : int
      {
