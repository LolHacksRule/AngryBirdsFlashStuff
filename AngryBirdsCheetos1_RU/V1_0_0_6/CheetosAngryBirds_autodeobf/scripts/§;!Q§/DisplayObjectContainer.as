package §;!Q§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§?^§[param1];
            _loc3_.dispatchEvent(new Event(Event.§6Y§,true));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§+9§));
            }
            _loc3_.§#&§(null);
      ...
      public function §9a§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
