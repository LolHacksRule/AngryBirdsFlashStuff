      ...
      public function §;!W§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         ...
         switch(param1.§5! §)
         {
            case b2Manifold.§throw§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§^G§[0].m_localPoint;
               ...
               this.§^G§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§^G§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§[!$§:
               _loc8_ = param2.R;
               _loc7_ = param1.§[R§;
               ...
               this.§`!!§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§+!K§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§^G§[_loc6_].m_localPoint;
                  ...
                  this.§^G§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§^G§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§3!+§:
               ...
               while(_loc6_ < param1.§+!K§)
               {
                  ...
                  this.§^G§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§^G§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
