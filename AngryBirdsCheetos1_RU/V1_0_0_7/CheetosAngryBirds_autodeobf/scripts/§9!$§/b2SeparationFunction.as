package §9!$§
{
   ...
   class b2SeparationFunction
   {
      ...
      public var §6N§:b2DistanceProxy;
      
      public var §5! §:int;
      
      public var m_localPoint:b2Vec2;
      
      public var §1G§:b2Vec2;
      ...
      public function §;!W§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§5! § = §`!?§;
            _loc7_ = this.§#!A§.§7!5§(param1.indexA[0]);
            _loc10_ = this.§6N§.§7!5§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§1G§.x = _loc15_ - _loc13_;
            this.§1G§.y = _loc16_ - _loc14_;
            this.§1G§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§5! § = §[!$§;
            _loc8_ = this.§#!A§.§7!5§(param1.indexA[0]);
            _loc9_ = this.§#!A§.§7!5§(param1.indexA[1]);
            _loc10_ = this.§6N§.§7!5§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§1G§ = b2Math.§+! §(b2Math.§;!-§(_loc9_,_loc8_),1);
            this.§1G§.Normalize();
            _loc20_ = this.§1G§;
         ...
         {
            this.§5! § = §3!+§;
            _loc11_ = this.§6N§.§7!5§(param1.indexB[0]);
            _loc12_ = this.§6N§.§7!5§(param1.indexB[1]);
            _loc7_ = this.§#!A§.§7!5§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§1G§ = b2Math.§+! §(b2Math.§;!-§(_loc12_,_loc11_),1);
            this.§1G§.Normalize();
            _loc20_ = this.§1G§;
         ...
         else
         {
            ...
            _loc24_ = b2Math.§@!H§(param3.R,b2Math.§;!-§(_loc9_,_loc8_));
            _loc25_ = b2Math.§!r§(param5,_loc10_);
            _loc26_ = b2Math.§@!H§(param5.R,b2Math.§;!-§(_loc12_,_loc11_));
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §`!?§:
               _loc3_ = b2Math.§=!B§(param1.R,this.§1G§);
               _loc4_ = b2Math.§=!B§(param2.R,this.§1G§.§=S§());
               _loc5_ = this.§#!A§.§3D§(_loc3_);
               _loc6_ = this.§6N§.§3D§(_loc4_);
               _loc7_ = b2Math.§!r§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§!r§(param2,_loc6_)).x - _loc7_.x) * this.§1G§.x + (_loc8_.y - _loc7_.y) * this.§1G§.y);
            case §[!$§:
               _loc10_ = b2Math.§@!H§(param1.R,this.§1G§);
               _loc7_ = b2Math.§!r§(param1,this.m_localPoint);
               _loc4_ = b2Math.§=!B§(param2.R,_loc10_.§=S§());
               _loc6_ = this.§6N§.§3D§(_loc4_);
               return Number(((_loc8_ = b2Math.§!r§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §3!+§:
               _loc10_ = b2Math.§@!H§(param2.R,this.§1G§);
               _loc8_ = b2Math.§!r§(param2,this.m_localPoint);
               _loc3_ = b2Math.§=!B§(param1.R,_loc10_.§=S§());
               _loc5_ = this.§#!A§.§3D§(_loc3_);
               return Number(((_loc7_ = b2Math.§!r§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
