package §@,§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§2!S§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§4s§ = this.§2!S§.Normalize();
         this.§`!!§.Set(this.§2!S§.y,-this.§2!S§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§`!!§.x - this.§2!S§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§`!!§.y - this.§2!S§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§`!!§.x + this.§2!S§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§`!!§.y + this.§2!S§.y) + this.m_v2.y);
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc8_:Number = b2Math.§7n§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§7n§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §<!A§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §7S§() : b2EdgeShape
      {
         return this.§!x§;
      }
      ...
      b2internal function §3V§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§"E§ = param1;
      ...
      b2internal function §do §(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§!x§ = param1;
