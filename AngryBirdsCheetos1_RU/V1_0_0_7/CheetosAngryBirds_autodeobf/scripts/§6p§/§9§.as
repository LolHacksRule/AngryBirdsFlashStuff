package §6p§
{
   ...
   public class §9§
   {
      ...
      public static function §=+§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §59§(_loc2_);
         return §3!2§.§#!;§(_loc3_.readInt(),true) + §3!2§.§#!;§(_loc3_.readInt(),true) + §3!2§.§#!;§(_loc3_.readInt(),true) + §3!2§.§#!;§(_loc3_.readInt(),true) + §3!2§.§#!;§(_loc3_.readInt(),true);
      }
      
      public static function §[!A§(param1:ByteArray) : String
      {
         var _loc2_:Array = §9§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §59§(_loc2_);
         return §3!2§.§#!;§(_loc3_.readInt(),true) + §3!2§.§#!;§(_loc3_.readInt(),true) + §3!2§.§#!;§(_loc3_.readInt(),true) + §3!2§.§#!;§(_loc3_.readInt(),true) + §3!2§.§#!;§(_loc3_.readInt(),true);
      }
      
      public static function §6!Q§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §9§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §59§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §59§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
