package § !b§
{
   ...
   public class § &§ extends §4e§
   {
      ...
      protected function §[!R§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§1o§(_loc7_,_loc6_)]) == null)
            {
      ...
      private function §1o§(param1:String, param2:String) : String
      {
      ...
      private function §&!C§(param1:Vector.<XML>) : Dictionary
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§1o§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §7A§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
