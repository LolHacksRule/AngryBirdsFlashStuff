package §!!#§
{
   ...
   public class b2DynamicTree
   {
      ...
      private var §5u§:b2DynamicTreeNode;
      ...
      public function §52§(param1:b2DynamicTreeNode) : void
      {
         this.§#!K§(param1);
         this.§13§(param1);
      }
      ...
      public function §<!+§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         var _loc4_:Number = NaN;
         var _loc5_:Number = NaN;
         b2Settings.b2Assert(param1.§0!E§());
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc5_:b2Vec2;
         (_loc5_ = b2Math.§#!F§(_loc3_,_loc4_)).Normalize();
         var _loc6_:b2Vec2 = b2Math.§&![§(1,_loc5_);
         var _loc7_:b2Vec2 = b2Math.§0!b§(_loc6_);
         var _loc8_:Number = param2.§%K§;
         _loc9_ = new b2AABB();
         ...
         _loc9_.§@9§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§@9§.y = Math.max(_loc3_.y,_loc11_);
         ...
         while(_loc13_ > 0)
         {
            ...
            {
               _loc15_ = _loc14_.aabb.final();
               _loc16_ = _loc14_.aabb.§5G§();
      ...
      private function §1!<§() : b2DynamicTreeNode
      {
         var _loc1_:b2DynamicTreeNode = null;
         if(this.§5u§)
         {
            _loc1_ = this.§5u§;
            this.§5u§ = _loc1_.parent;
            _loc1_.parent = null;
            _loc1_.child1 = null;
            _loc1_.child2 = null;
            return _loc1_;
      ...
      private function §13§(param1:b2DynamicTreeNode) : void
      {
         param1.parent = this.§5u§;
         this.§5u§ = param1;
      }
      ...
      private function §=l§(param1:b2DynamicTreeNode) : void
      {
         ...
         var _loc2_:b2Vec2 = param1.aabb.final();
         ...
         if(_loc3_.§0!E§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§?J§.x + _loc6_.aabb.§@9§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§?J§.y + _loc6_.aabb.§@9§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§?J§.x + _loc7_.aabb.§@9§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§?J§.y + _loc7_.aabb.§@9§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
