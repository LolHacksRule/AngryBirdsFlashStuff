package §!!#§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §in §(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§3;§ = §"W§;
            _loc7_ = this.§8!E§.§+1§(param1.indexA[0]);
            _loc10_ = this.§^r§.§+1§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§3;§ = §,k§;
            _loc8_ = this.§8!E§.§+1§(param1.indexA[0]);
            _loc9_ = this.§8!E§.§+1§(param1.indexA[1]);
            _loc10_ = this.§^r§.§+1§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§#§ = b2Math.§1p§(b2Math.§#!F§(_loc9_,_loc8_),1);
            this.§#§.Normalize();
            _loc20_ = this.§#§;
         ...
         {
            this.§3;§ = §?e§;
            _loc11_ = this.§^r§.§+1§(param1.indexB[0]);
            _loc12_ = this.§^r§.§+1§(param1.indexB[1]);
            _loc7_ = this.§8!E§.§+1§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§#§ = b2Math.§1p§(b2Math.§#!F§(_loc12_,_loc11_),1);
            this.§#§.Normalize();
            _loc20_ = this.§#§;
         ...
         else
         {
            ...
            _loc11_ = this.§^r§.§+1§(param1.indexB[0]);
            _loc12_ = this.§^r§.§+1§(param1.indexB[1]);
            _loc23_ = b2Math.§1L§(param3,_loc7_);
            _loc24_ = b2Math.§!X§(param3.R,b2Math.§#!F§(_loc9_,_loc8_));
            _loc25_ = b2Math.§1L§(param5,_loc10_);
            _loc26_ = b2Math.§!X§(param5.R,b2Math.§#!F§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§#!F§(_loc26_,_loc24_);
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§in§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§in§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §"W§:
               _loc3_ = b2Math.§%!7§(param1.R,this.§#§);
               _loc4_ = b2Math.§%!7§(param2.R,this.§#§.§<!Q§());
               _loc5_ = this.§8!E§.§#&§(_loc3_);
               _loc6_ = this.§^r§.§#&§(_loc4_);
               _loc7_ = b2Math.§1L§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§1L§(param2,_loc6_)).x - _loc7_.x) * this.§#§.x + (_loc8_.y - _loc7_.y) * this.§#§.y);
            case §,k§:
               _loc10_ = b2Math.§!X§(param1.R,this.§#§);
               _loc7_ = b2Math.§1L§(param1,this.m_localPoint);
               _loc4_ = b2Math.§%!7§(param2.R,_loc10_.§<!Q§());
               _loc6_ = this.§^r§.§#&§(_loc4_);
               return Number(((_loc8_ = b2Math.§1L§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §?e§:
               _loc10_ = b2Math.§!X§(param2.R,this.§#§);
               _loc8_ = b2Math.§1L§(param2,this.m_localPoint);
               _loc3_ = b2Math.§%!7§(param1.R,_loc10_.§<!Q§());
               _loc5_ = this.§8!E§.§#&§(_loc3_);
               return Number(((_loc7_ = b2Math.§1L§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
