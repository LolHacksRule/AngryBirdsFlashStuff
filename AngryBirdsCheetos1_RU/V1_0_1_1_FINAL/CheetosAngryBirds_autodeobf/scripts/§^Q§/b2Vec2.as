package §^q§
{
   public class b2Vec2
   {
      ...
      public static function §9!O§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §1!T§(param1:b2Vec2) : void
      {
         this.x -= param1.x;
         this.y -= param1.y;
      }
      ...
      public function §5!0§(param1:b2Mat22) : void
      {
      ...
      public function §2O§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§2P§(this,param1.col1);
         this.y = b2Math.§2P§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      {
         return b2Math.§4w§(this.x) && b2Math.§4w§(this.y);
      }
   }
}
