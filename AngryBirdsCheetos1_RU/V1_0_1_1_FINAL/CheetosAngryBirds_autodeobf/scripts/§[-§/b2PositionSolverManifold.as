package §[-§
{
   ...
   class b2PositionSolverManifold
   {
      ...
      public function §in §(param1:b2ContactConstraint) : void
      {
         var _loc2_:int = 0;
         ...
         b2Settings.b2Assert(param1.§0f§ > 0);
         switch(param1.type)
         {
            case b2Manifold.§4!&§:
            ...
            case b2Manifold.§,k§:
               ...
               _loc5_ = param1.§]z§.m_xf.R;
               _loc2_ = 0;
               while(_loc2_ < param1.§0f§)
               {
                  _loc6_ = param1.§!!C§[_loc2_].localPoint;
