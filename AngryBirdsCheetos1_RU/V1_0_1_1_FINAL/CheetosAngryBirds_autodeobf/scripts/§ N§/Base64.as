package § N§
{
   ...
   public class Base64
   {
      ...
      private static const §"!3§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §2Q§(param1:String) : String
      {
      ...
      public static function §+§(param1:String) : ByteArray
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §"!3§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
