package §2K§
{
   ...
   public class §,!@§ extends §7!!§
   {
      ...
      public function §,!@§(param1:XML, param2:§,!@§, param3:§;,§, param4:MovieClip = null)
      {
         ...
         {
            this.§<G§.push(new §,!@§(_loc5_,this,null));
         }
         for each(_loc6_ in param1.Repeater)
         {
            this.§<G§.push(new §7&§(_loc6_,this,null));
         }
         for each(_loc7_ in param1.Button)
         {
            this.§<G§.push(new § 3§(_loc7_,this));
         }
         for each(_loc8_ in param1.TextField)
         {
            this.§<G§.push(new §catch§(_loc8_,this));
         }
         for each(_loc9_ in param1.MovieClip)
         {
            this.§<G§.push(new §,d§(_loc9_,this));
         }
         for each(_loc10_ in param1.Popup)
         {
            this.§<G§.push(new §3!5§(_loc10_,this));
         }
         for each(_loc11_ in param1.Slider)
         {
            this.§<G§.push(new §%p§(_loc11_,this));
         }
      ...
      public function addComponent(param1:§7!!§) : void
      {
         if(this.§<G§.indexOf(param1) < 0)
         {
            ...
            param1.setVisibility(this.§7R§ && param1.§7R§);
            param1.viewWidth = viewWidth;
            param1.viewHeight = viewHeight;
         }
      }
      
      public function removeComponent(param1:§7!!§) : void
      {
      ...
      public function §#!Z§(param1:String, param2:Boolean) : void
      {
