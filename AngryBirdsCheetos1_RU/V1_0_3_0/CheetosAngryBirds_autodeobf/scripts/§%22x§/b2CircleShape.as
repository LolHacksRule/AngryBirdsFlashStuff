package §"x§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc4_:Number = param1.position.x + (_loc3_.col1.x * this.§`!H§.x + _loc3_.col2.x * this.§`!H§.y);
         var _loc5_:Number = param1.position.y + (_loc3_.col1.y * this.§`!H§.x + _loc3_.col2.y * this.§`!H§.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc5_:Number = param3.position.x + (_loc4_.col1.x * this.§`!H§.x + _loc4_.col2.x * this.§`!H§.y);
         var _loc6_:Number = param3.position.y + (_loc4_.col1.y * this.§`!H§.x + _loc4_.col2.y * this.§`!H§.y);
         ...
         if(0 <= _loc15_ && _loc15_ <= param2.§8!N§ * _loc13_)
         {
            _loc15_ /= _loc13_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         var _loc4_:Number = param2.position.x + (_loc3_.col1.x * this.§`!H§.x + _loc3_.col2.x * this.§`!H§.y);
         var _loc5_:Number = param2.position.y + (_loc3_.col1.y * this.§`!H§.x + _loc3_.col2.y * this.§`!H§.y);
         param1.§ !B§.Set(_loc4_ - b2internal::?',_loc5_ - b2internal::?');
         param1.§>w§.Set(_loc4_ + b2internal::?',_loc5_ + b2internal::?');
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§ !E§ = param2 * b2Settings.b2_pi * b2internal::?' * b2internal::?';
         param1.center.SetV(this.§`!H§);
         param1.§^!Q§ = param1.§ !E§ * (0.5 * b2internal::?' * b2internal::?' + (this.§`!H§.x * this.§`!H§.x + this.§`!H§.y * this.§`!H§.y));
      }
      
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         var _loc9_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§#t§(param3,this.§`!H§);
         var _loc6_:Number;
