package §"x§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §,o§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §7e§:b2Vec2;
      
      b2internal var §5!1§:Vector.<b2Vec2>;
      
      b2internal var §;I§:Vector.<b2Vec2>;
      
      b2internal var §2I§:int;
      ...
      public function b2PolygonShape()
      {
         ...
         this.§;I§ = new Vector.<b2Vec2>();
         §?'§ = b2Settings.b2_polygonRadius;
         this.§7e§.§0&§();
      }
      
      public static function §4L§(param1:Array, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§2O§(param1,param2);
         return _loc3_;
      }
      ...
      public static function §1!A§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §-!`§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         ...
         (_loc5_ = new b2PolygonShape()).§<3§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §&Q§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§8U§(param1,param2);
         return _loc3_;
      }
      ...
      public static function §#^§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc3_.§<!`§(_loc9_);
            _loc3_.§<!`§(_loc10_);
            _loc3_.§=!3§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §2!L§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§6!?§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§6!?§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§7e§.SetV(_loc2_.§7e§);
            this.§2I§ = _loc2_.§2I§;
            this.§[e§(this.§2I§);
            _loc3_ = 0;
            while(_loc3_ < this.§2I§)
            {
               this.§5!1§[_loc3_].SetV(_loc2_.§5!1§[_loc3_]);
               this.§;I§[_loc3_].SetV(_loc2_.§;I§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §2O§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function §<!]§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§2I§)
         {
            this.§5!1§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§2I§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§2I§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§9!A§(this.§5!1§[_loc5_],this.§5!1§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§2!<§() > Number.MIN_VALUE);
            this.§;I§[_loc3_].SetV(b2Math.§4"§(_loc6_,1));
            this.§;I§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§7e§ = §#^§(this.§5!1§,this.§2I§);
      }
      ...
      public function §&_§(param1:Number, param2:Number) : void
      {
         this.§2I§ = 4;
         this.§[e§(4);
         this.§5!1§[0].Set(-param1,-param2);
         this.§5!1§[1].Set(param1,-param2);
         this.§5!1§[2].Set(param1,param2);
         this.§5!1§[3].Set(-param1,param2);
         this.§;I§[0].Set(0,-1);
         this.§;I§[1].Set(1,0);
         this.§;I§[2].Set(0,1);
         this.§;I§[3].Set(-1,0);
      ...
      public function §<3§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§2I§ = 4;
         this.§[e§(4);
         this.§5!1§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§2I§)
         {
            this.§5!1§[_loc6_] = b2Math.§#t§(_loc5_,this.§5!1§[_loc6_]);
            this.§;I§[_loc6_] = b2Math.§<§(_loc5_.R,this.§;I§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §8U§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§2I§ = 2;
         this.§[e§(2);
         this.§5!1§[0].SetV(param1);
         this.§5!1§[1].SetV(param2);
         this.§7e§.x = 0.5 * (param1.x + param2.x);
         this.§7e§.y = 0.5 * (param1.y + param2.y);
         this.§;I§[0] = b2Math.§4"§(b2Math.§9!A§(param2,param1),1);
         this.§;I§[0].Normalize();
         this.§;I§[1].x = -this.§;I§[0].x;
         this.§;I§[1].y = -this.§;I§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§2I§)
         {
            _loc6_ = (_loc9_ = this.§5!1§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§;I§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§ !B§.x = _loc5_ - b2internal::?';
         param1.§ !B§.y = _loc6_ - b2internal::?';
         param1.§>w§.x = _loc7_ + b2internal::?';
         param1.§>w§.y = _loc8_ + b2internal::?';
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§2I§ == 2)
         {
            param1.center.x = 0.5 * (this.§5!1§[0].x + this.§5!1§[1].x);
            param1.center.y = 0.5 * (this.§5!1§[0].y + this.§5!1§[1].y);
            param1.§ !E§ = 0;
            param1.§^!Q§ = 0;
            return;
         }
         ...
         var _loc6_:Number = 0;
         var _loc10_:int = 0;
         while(_loc10_ < this.§2I§)
         {
            _loc11_ = this.§5!1§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§2I§ ? this.§5!1§[int(_loc10_ + 1)] : this.§5!1§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§6h§(param3.R,param1);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§2I§)
         {
            _loc7_[_loc12_] = b2Math.§@!#§(_loc5_,this.§5!1§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§#t§(param3,_loc24_.center));
                  return _loc24_.§ !E§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§2I§;
         var _loc14_:int = (_loc10_ + 1) % this.§2I§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§5!1§[_loc9_].x * (1 - _loc15_) + this.§5!1§[_loc13_].x * _loc15_,this.§5!1§[_loc9_].y * (1 - _loc15_) + this.§5!1§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§5!1§[_loc10_].x * (1 - _loc16_) + this.§5!1§[_loc14_].x * _loc16_,this.§5!1§[_loc10_].y * (1 - _loc16_) + this.§5!1§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§5!1§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§2I§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§5!1§[_loc12_];
            }
         ...
         _loc20_.§=!3§(1 / _loc19_);
         param4.SetV(b2Math.§#t§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §9#§() : Vector.<b2Vec2>
      {
         return this.§;I§;
      }
      
      public function §-!G§(param1:b2Vec2) : int
      {
         var _loc5_:Number = NaN;
         var _loc2_:int = 0;
         var _loc3_:Number = this.§5!1§[0].x * param1.x + this.§5!1§[0].y * param1.y;
         var _loc4_:int = 1;
         while(_loc4_ < this.§2I§)
         {
      ...
      {
         var _loc2_:int = this.§5!1§.length;
         while(_loc2_ < param1)
         {
            this.§5!1§[_loc2_] = new b2Vec2();
            this.§;I§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
