package §9!a§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private var §8!D§:Vector.<DisplayObject>;
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§8!D§ = new Vector.<DisplayObject>(0);
      }
      
      override public function dispose() : void
      {
         var _loc1_:int = this.§8!D§.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            this.§8!D§[_loc2_].dispose();
            _loc2_++;
         }
         super.dispose();
      }
      ...
      public function addChildAt(param1:DisplayObject, param2:int) : void
      {
         ...
         {
            param1.§'+§();
            this.§8!D§.splice(param2,0,param1);
            param1.§1P§(this);
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§8!D§[param1];
            _loc3_.dispatchEvent(new Event(Event.§`6§,true));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§#!1§));
            }
            _loc3_.§1P§(null);
            this.§8!D§.splice(param1,1);
            if(param2)
            {
               _loc3_.dispose();
            }
      ...
      {
         var _loc2_:int = this.§8!D§.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            if(this.§8!D§[_loc3_].name == param1)
            {
               return this.§8!D§[_loc3_];
            }
            _loc3_++;
         }
         return null;
      ...
      {
         return this.§8!D§.indexOf(param1);
      }
      ...
      public function §=R§(param1:int, param2:int) : void
      {
         ...
         this.§8!D§[param1] = _loc4_;
         this.§8!D§[param2] = _loc3_;
      }
      
      public function § O§(param1:Function) : void
      {
         this.§8!D§ = this.§8!D§.sort(param1);
      }
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§8!D§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§8!D§.length;
         if(_loc3_ == 0)
         {
            §!!2§(param1,§&h§);
            transformCoords(§&h§,0,0,§-!N§);
            param2.x = §-!N§.x;
            param2.y = §-!N§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§8!D§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§8!D§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§8!D§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§8!D§[_loc6_];
            §!!2§(_loc7_,§&h§);
            transformCoords(§&h§,_loc3_,_loc4_,§-!N§);
            if(_loc8_ = _loc7_.hitTest(§-!N§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§>q§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§8!D§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§0!]§();
               param1.§7S§(_loc5_);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§3P§(this,param1.type,_loc2_);
      ...
      private function §3P§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§8!D§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
               this.§3P§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
