package §&U§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §+!M§:b2WorldManifold = new b2WorldManifold();
      ...
      b2internal var §!d§:Vector.<b2ContactConstraint>;
      ...
      {
         this.§=!]§ = new b2TimeStep();
         this.§!d§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §9!K§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§``§ = param4;
         this.§9!=§ = param3;
         while(this.§!d§.length < this.§9!=§)
         {
            this.§!d§[this.§!d§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§`3§;
            _loc10_ = _loc5_.§+!D§;
            _loc11_ = _loc9_.§%9§;
            _loc12_ = _loc10_.§%9§;
            _loc13_ = _loc11_.§?'§;
            ...
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§,H§(),_loc10_.§,H§());
            _loc20_ = _loc15_.§;!8§.x;
            _loc21_ = _loc15_.§;!8§.y;
            _loc22_ = _loc16_.§;!8§.x;
            _loc23_ = _loc16_.§;!8§.y;
            ...
            §+!M§.§9!K§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §+!M§.§>!7§.x;
            _loc27_ = §+!M§.§>!7§.y;
            (_loc28_ = this.§!d§[_loc6_]).§,w§ = _loc15_;
            _loc28_.§2h§ = _loc16_;
            _loc28_.§,+§ = _loc17_;
            ...
            _loc28_.§@!K§.x = _loc17_.§ R§.x;
            _loc28_.§@!K§.y = _loc17_.§ R§.y;
            ...
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§ j§)
            {
               _loc30_ = _loc17_.§6!"§[_loc29_];
               (_loc31_ = _loc28_.§?"§[_loc29_]).normalImpulse = _loc30_.§"!3§;
               _loc31_.tangentImpulse = _loc30_.§^#§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§'2§.x = §+!M§.§6!"§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§'2§.y = §+!M§.§6!"§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§&!_§.x = §+!M§.§6!"§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§&!_§.y = §+!M§.§6!"§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§1c§ + _loc16_.§1c§ + _loc15_.§1!`§ * _loc36_ + _loc16_.§1!`§ * _loc37_;
               _loc31_.§>!N§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§7![§ * _loc15_.§1c§ + _loc16_.§7![§ * _loc16_.§1c§) + (_loc15_.§7![§ * _loc15_.§1!`§ * _loc36_ + _loc16_.§7![§ * _loc16_.§1!`§ * _loc37_);
               _loc31_.§2=§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§1c§ + _loc16_.§1c§ + _loc15_.§1!`§ * _loc42_ + _loc16_.§1!`§ * _loc43_;
               _loc31_.§,!4§ = 1 / _loc44_;
               _loc31_.§^o§ = 0;
               ...
               {
                  _loc31_.§^o§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§ j§ == 2)
            {
               ...
               _loc55_ = _loc48_.§&!_§.x * _loc27_ - _loc48_.§&!_§.y * _loc26_;
               _loc56_ = _loc49_.§'2§.x * _loc27_ - _loc49_.§'2§.y * _loc26_;
               _loc57_ = _loc49_.§&!_§.x * _loc27_ - _loc49_.§&!_§.y * _loc26_;
         ...
         while(_loc5_ < this.§9!=§)
         {
            ...
            if(param1.§!4§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc7_.§;!8§.x -= _loc9_ * _loc21_;
                  _loc7_.§;!8§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§&!_§.x * _loc22_ - _loc20_.§&!_§.y * _loc21_);
                  _loc8_.§;!8§.x += _loc11_ * _loc21_;
                  _loc8_.§;!8§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§9!=§)
         {
            _loc26_ = (_loc25_ = this.§!d§[_loc24_]).§,w§;
            _loc27_ = _loc25_.§2h§;
            ...
            _loc1_ = 0;
            while(_loc1_ < _loc25_.§ j§)
            {
               _loc2_ = _loc25_.§?"§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§&!_§.y - _loc30_.x + _loc28_ * _loc2_.§'2§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§&!_§.x - _loc30_.y - _loc28_ * _loc2_.§'2§.x;
               ...
               _loc29_ += _loc35_ * (_loc2_.§&!_§.x * _loc15_ - _loc2_.§&!_§.y * _loc14_);
            ...
            if(_loc25_.§ j§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§>!N§ * (_loc9_ - _loc2_.§^o§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§&!_§.y - _loc30_.x + _loc28_ * _loc43_.§'2§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§&!_§.x - _loc30_.y - _loc28_ * _loc43_.§'2§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§&!_§.y - _loc30_.x + _loc28_ * _loc44_.§'2§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§&!_§.x - _loc30_.y - _loc28_ * _loc44_.§'2§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§^o§;
               _loc54_ = _loc52_ - _loc44_.§^o§;
               _loc22_ = _loc25_.§]0§;
               _loc53_ -= _loc22_.col1.x * _loc45_ + _loc22_.col2.x * _loc46_;
               _loc54_ -= _loc22_.col1.y * _loc45_ + _loc22_.col2.y * _loc46_;
               _loc55_ = 0.001;
               _loc56_ = -((_loc22_ = _loc25_.§>!N§).col1.x * _loc53_ + _loc22_.col2.x * _loc54_);
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc29_ += _loc35_ * (_loc43_.§&!_§.x * _loc19_ - _loc43_.§&!_§.y * _loc18_ + _loc44_.§&!_§.x * _loc21_ - _loc44_.§&!_§.y * _loc20_);
                  _loc43_.normalImpulse = _loc56_;
                  _loc44_.normalImpulse = _loc57_;
               }
               else
               {
                  _loc56_ = -_loc43_.§>!N§ * _loc53_;
                  _loc57_ = 0;
                  _loc51_ = 0;
      ...
      public function §`&§() : void
      {
         ...
         while(_loc1_ < this.§9!=§)
         {
            ...
            _loc3_ = _loc2_.§,+§;
            _loc4_ = 0;
            while(_loc4_ < _loc2_.§ j§)
            {
               _loc5_ = _loc3_.§6!"§[_loc4_];
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§9!=§)
         {
            _loc5_ = (_loc4_ = this.§!d§[_loc3_]).§,w§;
            _loc6_ = _loc4_.§2h§;
            _loc7_ = _loc5_.§7![§ * _loc5_.§1c§;
            _loc8_ = _loc5_.§7![§ * _loc5_.§1!`§;
            _loc9_ = _loc6_.§7![§ * _loc6_.§1c§;
            _loc10_ = _loc6_.§7![§ * _loc6_.§1!`§;
            §`!2§.§9!K§(_loc4_);
            _loc11_ = §`!2§.§>!7§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§ j§)
            {
               _loc13_ = _loc4_.§?"§[_loc12_];
               _loc14_ = §`!2§.§6!"§[_loc12_];
               _loc15_ = §`!2§.§1o§[_loc12_];
