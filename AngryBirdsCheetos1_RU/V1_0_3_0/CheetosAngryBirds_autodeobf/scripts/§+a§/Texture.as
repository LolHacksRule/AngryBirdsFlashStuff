package §+a§
{
   ...
   public class Texture
   {
      ...
      public static function §,N§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §+a§.Texture
      {
         return §`k§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §`k§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §+a§.Texture
      {
         ...
         _loc10_ = new §4K§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§"u§.§3"§)
         {
            _loc10_.§;t§(param2);
         }
         ...
         return new §9e§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §3!]§(param1:Context3D, param2:ByteArray) : §+a§.Texture
      {
         if(param1 == null)
         {
            throw new §'!?§();
         ...
         var _loc9_:§4K§ = new §4K§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§"u§.§3"§)
         {
            _loc9_.§;t§(param2);
         }
      ...
      public static function §use§(param1:§+a§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §+a§.Texture
      {
         var _loc4_:§+a§.Texture;
         (_loc4_ = new §9e§(param1,param2)).§?Q§ = param3;
         return _loc4_;
      }
      
      public static function §?r§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §+a§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§+a§.Texture = §`k§(param1,_loc6_,false,param5);
         if(!§"u§.§3"§)
         {
            _loc6_.dispose();
         }
