package §7$§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §9!K§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§%V§ = § I§;
            _loc7_ = this.§]!H§.§'V§(param1.indexA[0]);
            _loc10_ = this.§>`§.§'V§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§%V§ = §5!]§;
            _loc8_ = this.§]!H§.§'V§(param1.indexA[0]);
            _loc9_ = this.§]!H§.§'V§(param1.indexA[1]);
            _loc10_ = this.§>`§.§'V§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§<,§ = b2Math.§4"§(b2Math.§9!A§(_loc9_,_loc8_),1);
            this.§<,§.Normalize();
            _loc20_ = this.§<,§;
         ...
         {
            this.§%V§ = §5!H§;
            _loc11_ = this.§>`§.§'V§(param1.indexB[0]);
            _loc12_ = this.§>`§.§'V§(param1.indexB[1]);
            _loc7_ = this.§]!H§.§'V§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§<,§ = b2Math.§4"§(b2Math.§9!A§(_loc12_,_loc11_),1);
            this.§<,§.Normalize();
            _loc20_ = this.§<,§;
         ...
         else
         {
            ...
            _loc11_ = this.§>`§.§'V§(param1.indexB[0]);
            _loc12_ = this.§>`§.§'V§(param1.indexB[1]);
            _loc23_ = b2Math.§#t§(param3,_loc7_);
            _loc24_ = b2Math.§<§(param3.R,b2Math.§9!A§(_loc9_,_loc8_));
            _loc25_ = b2Math.§#t§(param5,_loc10_);
            _loc26_ = b2Math.§<§(param5.R,b2Math.§9!A§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§9!A§(_loc26_,_loc24_);
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case § I§:
               _loc3_ = b2Math.§6h§(param1.R,this.§<,§);
               _loc4_ = b2Math.§6h§(param2.R,this.§<,§.§8!!§());
               _loc5_ = this.§]!H§.§?!7§(_loc3_);
               _loc6_ = this.§>`§.§?!7§(_loc4_);
               _loc7_ = b2Math.§#t§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§#t§(param2,_loc6_)).x - _loc7_.x) * this.§<,§.x + (_loc8_.y - _loc7_.y) * this.§<,§.y);
            case §5!]§:
               _loc10_ = b2Math.§<§(param1.R,this.§<,§);
               _loc7_ = b2Math.§#t§(param1,this.m_localPoint);
               _loc4_ = b2Math.§6h§(param2.R,_loc10_.§8!!§());
               _loc6_ = this.§>`§.§?!7§(_loc4_);
            ...
            case §5!H§:
               ...
               _loc3_ = b2Math.§6h§(param1.R,_loc10_.§8!!§());
               _loc5_ = this.§]!H§.§?!7§(_loc3_);
