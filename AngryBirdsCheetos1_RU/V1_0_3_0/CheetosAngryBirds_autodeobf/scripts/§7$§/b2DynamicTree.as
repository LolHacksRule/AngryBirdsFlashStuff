package §7$§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §%!E§(param1:b2DynamicTreeNode) : b2AABB
      {
         return param1.aabb;
      }
      ...
      public function §8!$§(param1:Function, param2:b2AABB) : void
      {
         ...
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§?U§(param2))
            {
               if(_loc5_.§ !9§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc5_:b2Vec2;
         (_loc5_ = b2Math.§9!A§(_loc3_,_loc4_)).Normalize();
         var _loc6_:b2Vec2 = b2Math.§0+§(1,_loc5_);
         var _loc7_:b2Vec2 = b2Math.§3l§(_loc6_);
         var _loc8_:Number = param2.§8!N§;
         _loc9_ = new b2AABB();
         ...
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§?U§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§`!R§();
               _loc16_ = _loc14_.aabb.§4!a§();
      ...
      private function §5+§() : b2DynamicTreeNode
      {
         var _loc1_:b2DynamicTreeNode = null;
         if(this.§^!0§)
         {
            _loc1_ = this.§^!0§;
            this.§^!0§ = _loc1_.parent;
            _loc1_.parent = null;
            _loc1_.child1 = null;
            _loc1_.child2 = null;
            return _loc1_;
      ...
      private function §3g§(param1:b2DynamicTreeNode) : void
      {
         ...
         var _loc2_:b2Vec2 = param1.aabb.§`!R§();
         ...
         if(_loc3_.§ !9§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§ !B§.x + _loc6_.aabb.§>w§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§ !B§.y + _loc6_.aabb.§>w§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§ !B§.x + _loc7_.aabb.§>w§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§ !B§.y + _loc7_.aabb.§>w§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         (_loc5_ = this.§5+§()).parent = _loc4_;
         _loc5_.§5!_§ = null;
         _loc5_.aabb.§^!H§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            {
               _loc4_.aabb.§^!H§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
      ...
      private function §[Q§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc5_ = _loc3_.aabb;
               _loc3_.aabb = b2AABB.§^!H§(_loc3_.child1.aabb,_loc3_.child2.aabb);
