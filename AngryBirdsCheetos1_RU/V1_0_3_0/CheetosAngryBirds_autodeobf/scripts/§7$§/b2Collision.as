package §7$§
{
   ...
   public class b2Collision
   {
      ...
      private static var §3d§:Vector.<§!b§> = §@!6§();
      
      private static var s_clipPoints1:Vector.<§!b§> = §@!6§();
      
      private static var s_clipPoints2:Vector.<§!b§> = §@!6§();
      
      private static var §,A§:Vector.<int> = new Vector.<int>(1);
      
      private static var §8A§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §7r§(param1:Vector.<§!b§>, param2:Vector.<§!b§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§!b§ = null;
         var _loc6_:int = 0;
      ...
      public static function §[!&§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc6_:int = param1.§2I§;
         var _loc7_:Vector.<b2Vec2> = param1.§5!1§;
         var _loc8_:Vector.<b2Vec2> = param1.§;I§;
         var _loc9_:int = param4.§2I§;
         var _loc10_:Vector.<b2Vec2> = param4.§5!1§;
         _loc11_ = param2.R;
      ...
      public static function §4!'§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§2I§;
         var _loc7_:Vector.<b2Vec2> = param2.§;I§;
         _loc9_ = param5.R;
         _loc8_ = param4.§7e§;
      ...
      public static function §!!A§(param1:Vector.<§!b§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§!b§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§2I§;
         var _loc8_:Vector.<b2Vec2> = param2.§;I§;
         var _loc9_:int = param5.§2I§;
         var _loc10_:Vector.<b2Vec2> = param5.§5!1§;
         var _loc11_:Vector.<b2Vec2> = param5.§;I§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§=!A§.§-!E§ = param4;
         _loc20_.id.§=!A§.§]'§ = _loc21_;
         _loc20_.id.§=!A§.§1b§ = 0;
         _loc20_ = param1[1];
      ...
      public static function §%r§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§!b§ = null;
         ...
         var _loc8_:int = 0;
         §,A§[0] = _loc8_;
         var _loc9_:Number = §4!'§(§,A§,param2,param3,param4,param5);
         _loc8_ = §,A§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §8A§[0] = _loc10_;
         var _loc11_:Number = §4!'§(§8A§,param4,param5,param2,param3);
         _loc10_ = §8A§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§%V§ = b2Manifold.§5!]§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§!b§> = §3d§;
         §!!A§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§2I§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§5!1§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §1![§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         ...
         if((_loc39_ = §7r§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §7r§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§ R§.SetV(_loc27_);
      ...
      public static function §5Q§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§%V§ = b2Manifold.§7,§;
         param1.m_localPoint.SetV(param2.§`!H§);
         param1.§ R§.§0&§();
         param1.§<!Y§ = 1;
         param1.§6!"§[0].m_localPoint.SetV(param4.§`!H§);
         param1.§6!"§[0].m_id.key = 0;
      }
      ...
      public static function §&!+§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§2I§;
         var _loc22_:Vector.<b2Vec2> = param2.§5!1§;
         var _loc23_:Vector.<b2Vec2> = param2.§;I§;
         var _loc24_:int = 0;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§<!Y§ = 1;
            param1.§%V§ = b2Manifold.§5!]§;
            param1.§ R§.x = _loc15_ - _loc27_.x;
            param1.§ R§.y = _loc16_ - _loc27_.y;
            param1.§ R§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§<!Y§ = 1;
            param1.§%V§ = b2Manifold.§5!]§;
            param1.§ R§.x = _loc15_ - _loc28_.x;
            param1.§ R§.y = _loc16_ - _loc28_.y;
            param1.§ R§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§6!"§[0].m_localPoint.SetV(param4.§`!H§);
            param1.§6!"§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§<!Y§ = 1;
            param1.§%V§ = b2Manifold.§5!]§;
            param1.§ R§.x = _loc23_[_loc25_].x;
            param1.§ R§.y = _loc23_[_loc25_].y;
            param1.§ R§.Normalize();
      ...
      public static function §?U§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§ !B§;
