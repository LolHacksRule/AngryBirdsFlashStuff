package
{
   ...
   public class §;!W§
   {
      ...
      private function §?h§(param1:*) : String
      {
      ...
      private function §&l§(param1:Array) : String
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§?h§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §0![§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§&!G§(v.@name.toString()) + ":" + this.§?h§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
