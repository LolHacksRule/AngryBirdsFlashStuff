package §50§
{
   ...
   public class §=!J§
   {
      ...
      public static function §%D§(param1:String) : String
      {
         ...
         return §=!6§.§"<§(_loc3_.readInt(),true) + §=!6§.§"<§(_loc3_.readInt(),true) + §=!6§.§"<§(_loc3_.readInt(),true) + §=!6§.§"<§(_loc3_.readInt(),true) + §=!6§.§"<§(_loc3_.readInt(),true);
      }
      
      public static function §51§(param1:ByteArray) : String
      {
         var _loc2_:Array = §=!J§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §2§(_loc2_);
         return §=!6§.§"<§(_loc3_.readInt(),true) + §=!6§.§"<§(_loc3_.readInt(),true) + §=!6§.§"<§(_loc3_.readInt(),true) + §=!6§.§"<§(_loc3_.readInt(),true) + §=!6§.§"<§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §=!J§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §2§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
