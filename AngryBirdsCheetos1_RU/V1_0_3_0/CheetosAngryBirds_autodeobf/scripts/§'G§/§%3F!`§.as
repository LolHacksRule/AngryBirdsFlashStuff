package §'G§
{
   ...
   public class §?!`§
   {
      ...
      {
         §!!3§[§!!3§.length] = new §2!]§(param1,param2,param3,param4,param5);
      }
      
      public static function §;+§(param1:String, param2:String, param3:Array, param4:Number) : void
      {
         var _loc5_:§2!]§;
         (_loc5_ = new §2!]§(param1,param2,-1,-1,param4)).§%%§(param3);
         _loc5_.§5T§();
         §!!3§[§!!3§.length] = _loc5_;
      }
      ...
      {
         var _loc5_:§2!]§;
         (_loc5_ = new §2!]§(param1,param2,param3,param3)).§%%§(param4);
         §!!3§[§!!3§.length] = _loc5_;
      }
      
      public static function §8+§(param1:String) : §2!]§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §!!3§.length)
         {
            if((§!!3§[_loc2_] as §2!]§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §2!]§(§!!3§[_loc2_]);
            }
            _loc2_++;
