package §#h§
{
   ...
   public class §;!@§
   {
      ...
      public static function §5!;§() : String
      {
         ...
         var _loc5_:String;
         return (_loc5_ = §3Y§(_loc2_ + _loc4_ + _loc3_ + counter++).toUpperCase()).substring(0,8) + _loc5_.substring(8,12) + _loc5_.substring(12,16) + _loc5_.substring(16,20) + _loc5_.substring(20,32);
      }
      
      private static function §3Y§(param1:String) : String
      {
         return §^!B§(param1);
      }
      
      private static function §^!B§(param1:String) : String
      {
         return §9!1§(§-y§(§&#§(param1),param1.length * 8));
      }
      
      private static function §-y§(param1:Array, param2:Number) : Array
      {
         ...
         while(_loc9_ < param1.length)
         {
            ...
            while(_loc15_ < 80)
            {
               ...
               _loc16_ = §"!V§(§"!V§(§%Q§(_loc4_,5),sha1_ft(_loc15_,_loc5_,_loc6_,_loc7_)),§"!V§(§"!V§(_loc8_,_loc3_[_loc15_]),sha1_kt(_loc15_)));
               _loc8_ = _loc7_;
               _loc7_ = _loc6_;
               _loc6_ = §%Q§(_loc5_,30);
               _loc5_ = _loc4_;
            ...
            _loc4_ = §"!V§(_loc4_,_loc10_);
            _loc5_ = §"!V§(_loc5_,_loc11_);
            _loc6_ = §"!V§(_loc6_,_loc12_);
            _loc7_ = §"!V§(_loc7_,_loc13_);
            _loc8_ = §"!V§(_loc8_,_loc14_);
            _loc9_ += 16;
         }
      ...
      private static function §"!V§(param1:Number, param2:Number) : Number
      {
      ...
      private static function §&#§(param1:String) : Array
      {
      ...
      private static function §9!1§(param1:Array) : String
      {
