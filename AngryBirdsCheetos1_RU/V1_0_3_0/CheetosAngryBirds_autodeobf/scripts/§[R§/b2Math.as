package §[R§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§3!G§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §3U§(param1:Number) : Boolean
      {
      ...
      public static function §4"§(param1:b2Vec2, param2:Number) : b2Vec2
      {
      ...
      public static function §6h§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §&!C§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         ...
         _loc3_ = §9!A§(param2,param1.position);
      ...
      public static function §9!A§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1.x - param2.x,param1.y - param2.y);
      }
      
      public static function §5!X§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §2X§(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§3!G§(§"Q§(param1.col1,param2.col1),§"Q§(param1.col2,param2.col2));
      }
      
      public static function §get §(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§3!G§(§<§(param1,param2.col1),§<§(param1,param2.col2));
      }
      ...
      public static function §,m§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         ...
         return b2Mat22.§3!G§(_loc3_,_loc4_);
      }
      ...
      public static function §3l§(param1:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§,!!§(param1.x),§,!!§(param1.y));
      }
      
      public static function §'f§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§3!G§(§3l§(param1.col1),§3l§(param1.col2));
      }
      ...
      public static function §7!L§(param1:Number, param2:Number) : Number
      {
         return param1 > param2 ? Number(param1) : Number(param2);
      }
      ...
      {
         return new b2Vec2(§7!L§(param1.x,param2.x),§7!L§(param1.y,param2.y));
      }
      
      public static function §'U§(param1:Number, param2:Number, param3:Number) : Number
      {
      ...
      {
         return §"9§(param2,§>X§(param1,param3));
      }
      
      public static function §8w§(param1:Array, param2:Array) : void
      {
         var _loc3_:* = param1[0];
         param1[0] = param2[0];
         param2[0] = _loc3_;
      ...
      public static function §4P§(param1:uint) : Boolean
      {
