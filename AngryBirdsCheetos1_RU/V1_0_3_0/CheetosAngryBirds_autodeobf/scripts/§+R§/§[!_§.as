package §+R§
{
   ...
   public class §[!_§ extends §#!O§
   {
      ...
      private static function §-!A§(param1:§[`§, param2:int, param3:int) : void
      {
         if(param1.§1@§.top < 0)
         {
            param1.§1@§.top = 0;
         ...
         if(param1.§1@§.bottom > param3)
         {
            param1.§1@§.bottom = param3;
         }
         if(param1.§1@§.right > param2)
         {
      ...
      protected function §4$§(param1:Object) : void
      {
         ...
         for(_loc4_ in param1)
         {
            if(_loc4_.indexOf("sprite_") != -1)
            {
               ...
               §-!A§(_loc6_,§6$§.width,§6$§.height);
               if(_loc2_)
               {
                  _loc6_.§=3§ = _loc5_.pivotx / _loc3_;
                  _loc6_.§`!G§ = _loc5_.pivoty / _loc3_;
               }
               else
               {
                  _loc6_.§=3§ = _loc5_.width / 2;
                  _loc6_.§`!G§ = _loc5_.height / 2;
               }
               _loc6_.§=!R§ = §6$§;
               §1F§(_loc6_);
            }
