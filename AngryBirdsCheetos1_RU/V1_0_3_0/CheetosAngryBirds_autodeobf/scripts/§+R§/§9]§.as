package §+R§
{
   ...
   public class §9]§ extends §#!O§
   {
      ...
      public function §9]§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
      ...
      protected function §4$§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         var _loc16_:§[`§ = null;
         var _loc3_:Dictionary = this.§>!V§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§6i§(_loc7_,_loc6_)]) == null)
            {
               ...
               {
                  _loc10_ = new §7!9§(0,0,_loc11_,_loc12_,_loc13_,_loc14_);
               }
            }
            if(_loc10_)
            {
      ...
      private function §6i§(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function §>!V§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§6i§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §7!9§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
