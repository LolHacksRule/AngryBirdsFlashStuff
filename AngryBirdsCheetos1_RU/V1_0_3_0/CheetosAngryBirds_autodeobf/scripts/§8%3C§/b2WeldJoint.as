package §8<§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc7_ = this.§+!W§.y - _loc4_.m_sweep.localCenter.y;
         ...
         if(param1.§!4§)
         {
            ...
            this.§8q§.y *= param1.§5!-§;
            this.§8q§.z *= param1.§5!-§;
            _loc4_.§;!8§.x -= _loc10_ * this.§8q§.x;
            _loc4_.§;!8§.y -= _loc10_ * this.§8q§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§8q§.y - _loc7_ * this.§8q§.x + this.§8q§.z);
            _loc5_.§;!8§.x += _loc11_ * this.§8q§.x;
            _loc5_.§;!8§.y += _loc11_ * this.§8q§.y;
            _loc5_.m_angularVelocity += _loc13_ * (_loc8_ * this.§8q§.y - _loc9_ * this.§8q§.x + this.§8q§.z);
         }
         else
         {
            this.§8q§.§0&§();
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc5_:b2Body = b2internal::;<;
         _loc2_ = _loc4_.m_xf.R;
         var _loc6_:Number = this.§+!W§.x - _loc4_.m_sweep.localCenter.x;
         ...
         var _loc16_:Number = _loc5_.m_sweep.a - _loc4_.m_sweep.a - this.native;
