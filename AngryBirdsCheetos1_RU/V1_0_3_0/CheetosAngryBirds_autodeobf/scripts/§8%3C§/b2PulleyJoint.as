package §8<§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§#$§ = b2internal::!!_.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§[!3§.x - this.§#$§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§[!3§.y - this.§#$§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§,!I§.x - this.§#$§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§,!I§.y - this.§#$§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§;!,§);
         this.m_localAnchor2.SetV(param1.§const§);
         this.§,T§ = param1.§`Q§;
         this.§5$§ = param1.§%1§ + this.§,T§ * param1.§#!]§;
         this.m_maxLength1 = b2Math.§;z§(param1.§@s§,this.§5$§ - this.§,T§ * b2internal::"!$);
         this.m_maxLength2 = b2Math.§;z§(param1.§2w§,(this.§5$§ - b2internal::"!$) / this.§,T§);
         this.§8q§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§8q§ * this.m_u2.x,param1 * this.§8q§ * this.m_u2.y);
      }
      ...
      {
         var _loc1_:b2Vec2 = b2internal::!!_.GetWorldPoint(this.m_localAnchor1);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc18_:Number = this.m_u1.§;!N§();
         var _loc19_:Number = this.m_u2.§;!N§();
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§5$§ - _loc18_ - this.§,T§ * _loc19_) > 0)
         {
            this.§9!!§ = b2internal::,!5;
            this.§8q§ = 0;
         }
         ...
         this.m_limitMass1 = _loc2_.§1c§ + _loc2_.§1!`§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§1c§ + _loc3_.§1!`§ * _loc22_ * _loc22_;
         this.§4j§ = this.m_limitMass1 + this.§,T§ * this.§,T§ * this.m_limitMass2;
         ...
         if(param1.§!4§)
         {
            ...
            _loc23_ = (-this.§8q§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§8q§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§,T§ * this.§8q§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§,T§ * this.§8q§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§;!8§.x += _loc2_.§1c§ * _loc23_;
            _loc2_.§;!8§.y += _loc2_.§1c§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§1!`§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§;!8§.x += _loc3_.§1c§ * _loc25_;
            _loc3_.§;!8§.y += _loc3_.§1c§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§9!!§ == b2internal::+[)
         {
            ...
            _loc19_ = this.§4j§ * -_loc18_;
            _loc20_ = this.§8q§;
            this.§8q§ = b2Math.§7!L§(0,this.§8q§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§8q§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§,T§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§,T§ * _loc19_ * this.m_u2.y;
            _loc2_.§;!8§.x += _loc2_.§1c§ * _loc14_;
            _loc2_.§;!8§.y += _loc2_.§1c§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§1!`§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§;!8§.x += _loc3_.§1c§ * _loc16_;
            _loc3_.§;!8§.y += _loc3_.§1c§ * _loc17_;
         ...
         if(this.m_limitState1 == b2internal::+[)
         {
            ...
            this.m_limitImpulse1 = b2Math.§7!L§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == b2internal::+[)
         {
            ...
            this.m_limitImpulse2 = b2Math.§7!L§(0,this.m_limitImpulse2 + _loc19_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§9!!§ == b2internal::+[)
         {
            ...
            _loc19_ = this.§5$§ - _loc17_ - this.§,T§ * _loc18_;
            _loc24_ = b2Math.§7!L§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§'U§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§4j§ * _loc19_) * this.m_u1.x;
            _loc14_ = -_loc20_ * this.m_u1.y;
            _loc15_ = -this.§,T§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§,T§ * _loc20_ * this.m_u2.y;
            _loc2_.m_sweep.c.x += _loc2_.§1c§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§1c§ * _loc14_;
            _loc2_.m_sweep.a += _loc2_.§1!`§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§1c§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§1c§ * _loc16_;
         ...
         if(this.m_limitState1 == b2internal::+[)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§;!N§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::+[)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§;!N§()) > b2Settings.b2_linearSlop)
            {
