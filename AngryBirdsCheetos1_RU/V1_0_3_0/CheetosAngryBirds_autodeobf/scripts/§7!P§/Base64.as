package §7!P§
{
   ...
   public class Base64
   {
      ...
      private static const § o§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §6!Y§(param1:ByteArray) : String
      {
      ...
      public static function §`!!§(param1:String) : ByteArray
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = § o§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
