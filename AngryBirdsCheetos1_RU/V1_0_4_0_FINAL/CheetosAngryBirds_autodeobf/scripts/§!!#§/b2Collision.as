package §!!#§
{
   ...
   public class b2Collision
   {
      ...
      private static var §#4§:Vector.<§4c§> = §+!8§();
      
      private static var s_clipPoints1:Vector.<§4c§> = §+!8§();
      
      private static var s_clipPoints2:Vector.<§4c§> = §+!8§();
      
      private static var §6U§:Vector.<int> = new Vector.<int>(1);
      
      private static var §<9§:Vector.<int> = new Vector.<int>(1);
      
      private static var §4+§:b2Vec2 = new b2Vec2();
      
      private static var §5!C§:b2Vec2 = new b2Vec2();
      
      private static var § !`§:b2Vec2 = new b2Vec2();
      
      private static var §3!Y§:b2Vec2 = new b2Vec2();
      ...
      public static function §+i§(param1:Vector.<§4c§>, param2:Vector.<§4c§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§4c§ = null;
         var _loc6_:int = 0;
      ...
      public static function §!!?§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param1.§class§;
         var _loc8_:Vector.<b2Vec2> = param1.§@E§;
         var _loc9_:int = param4.§[8§;
         var _loc10_:Vector.<b2Vec2> = param4.§class§;
         _loc11_ = param2.R;
      ...
      public static function §'u§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§[8§;
         var _loc7_:Vector.<b2Vec2> = param2.§@E§;
         _loc9_ = param5.R;
         _loc8_ = param4.§]C§;
      ...
      public static function §,w§(param1:Vector.<§4c§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param2.§@E§;
         var _loc9_:int = param5.§[8§;
         var _loc10_:Vector.<b2Vec2> = param5.§class§;
         var _loc11_:Vector.<b2Vec2> = param5.§@E§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§&i§.§"m§ = param4;
         _loc20_.id.§&i§.§5!R§ = _loc21_;
         _loc20_.id.§&i§.§+!M§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§&i§.§"m§ = param4;
         _loc20_.id.§&i§.§5!R§ = _loc22_;
         _loc20_.id.§&i§.§+!M§ = 1;
      }
      
      private static function §+!8§() : Vector.<§4c§>
      {
         var _loc1_:Vector.<§4c§> = new Vector.<§4c§>(2);
         _loc1_[0] = new §4c§();
         _loc1_[1] = new §4c§();
         return _loc1_;
      }
      
      public static function §2n§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§4c§ = null;
         ...
         var _loc8_:int = 0;
         §6U§[0] = _loc8_;
         var _loc9_:Number = §'u§(§6U§,param2,param3,param4,param5);
         _loc8_ = §6U§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §<9§[0] = _loc10_;
         var _loc11_:Number = §'u§(§<9§,param4,param5,param2,param3);
         _loc10_ = §<9§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§3;§ = b2Manifold.§,k§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§4c§> = §#4§;
         §,w§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§[8§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§class§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §4+§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §5!C§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         ...
         var _loc37_:Vector.<§4c§> = s_clipPoints1;
         var _loc38_:Vector.<§4c§> = s_clipPoints2;
      ...
      public static function §2!^§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§3;§ = b2Manifold.§4!&§;
         param1.m_localPoint.SetV(param2.§"! §);
         param1.§ I§.§0q§();
         param1.§^d§ = 1;
         param1.§"!_§[0].m_localPoint.SetV(param4.§"! §);
         param1.§"!_§[0].m_id.key = 0;
      }
      ...
      public static function §!L§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§[8§;
         var _loc22_:Vector.<b2Vec2> = param2.§class§;
         var _loc23_:Vector.<b2Vec2> = param2.§@E§;
         var _loc24_:int = 0;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§^d§ = 1;
            param1.§3;§ = b2Manifold.§,k§;
            param1.§ I§.x = _loc15_ - _loc27_.x;
            param1.§ I§.y = _loc16_ - _loc27_.y;
            param1.§ I§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§^d§ = 1;
            param1.§3;§ = b2Manifold.§,k§;
            param1.§ I§.x = _loc15_ - _loc28_.x;
            param1.§ I§.y = _loc16_ - _loc28_.y;
            param1.§ I§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§"!_§[0].m_localPoint.SetV(param4.§"! §);
            param1.§"!_§[0].m_id.key = 0;
