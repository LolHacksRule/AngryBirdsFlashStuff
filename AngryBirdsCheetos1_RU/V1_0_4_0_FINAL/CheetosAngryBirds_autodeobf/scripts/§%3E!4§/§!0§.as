package §>!4§
{
   ...
   public class §!0§
   {
      ...
      public static function §8!`§(param1:String) : String
      {
         ...
         return §>!#§.§^1§(_loc3_.readInt(),true) + §>!#§.§^1§(_loc3_.readInt(),true) + §>!#§.§^1§(_loc3_.readInt(),true) + §>!#§.§^1§(_loc3_.readInt(),true) + §>!#§.§^1§(_loc3_.readInt(),true);
      }
      
      public static function §9!W§(param1:ByteArray) : String
      {
