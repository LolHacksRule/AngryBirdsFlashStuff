package §43§
{
   ...
   public class b2ContactSolver
   {
      ...
      public function §8#§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§1!I§;
            _loc10_ = _loc5_.§1i§;
            _loc11_ = _loc9_.§[T§;
            _loc12_ = _loc10_.§[T§;
            _loc13_ = _loc11_.§!!`§;
            ...
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§]!8§(),_loc10_.§]!8§());
            _loc20_ = _loc15_.§%q§.x;
            _loc21_ = _loc15_.§%q§.y;
            _loc22_ = _loc16_.§%q§.x;
            _loc23_ = _loc16_.§%q§.y;
            ...
            § ;§.§8#§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = § ;§.§?=§.x;
            _loc27_ = § ;§.§?=§.y;
            (_loc28_ = this.§6O§[_loc6_]).§^!<§ = _loc15_;
            _loc28_.§!E§ = _loc16_;
            _loc28_.§6!+§ = _loc17_;
            ...
            _loc28_.§ 4§.x = _loc17_.§,?§.x;
            _loc28_.§ 4§.y = _loc17_.§,?§.y;
            ...
            {
               _loc30_ = _loc17_.§%!C§[_loc29_];
               (_loc31_ = _loc28_.§^!4§[_loc29_]).normalImpulse = _loc30_.§"I§;
               _loc31_.tangentImpulse = _loc30_.§4!&§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§0!M§.x = § ;§.§%!C§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§0!M§.y = § ;§.§%!C§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§!6§.x = § ;§.§%!C§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§!6§.y = § ;§.§%!C§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§6I§ + _loc16_.§6I§ + _loc15_.§2!L§ * _loc36_ + _loc16_.§2!L§ * _loc37_;
               _loc31_.§'!?§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§;^§ * _loc15_.§6I§ + _loc16_.§;^§ * _loc16_.§6I§) + (_loc15_.§;^§ * _loc15_.§2!L§ * _loc36_ + _loc16_.§;^§ * _loc16_.§2!L§ * _loc37_);
               _loc31_.§8!?§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§6I§ + _loc16_.§6I§ + _loc15_.§2!L§ * _loc42_ + _loc16_.§2!L§ * _loc43_;
               _loc31_.§1q§ = 1 / _loc44_;
               _loc31_.§&!F§ = 0;
               ...
               {
                  _loc31_.§&!F§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§8!"§ == 2)
            {
               ...
               _loc52_ = _loc16_.§6I§;
               _loc53_ = _loc16_.§2!L§;
               _loc54_ = _loc48_.§0!M§.x * _loc27_ - _loc48_.§0!M§.y * _loc26_;
               _loc55_ = _loc48_.§!6§.x * _loc27_ - _loc48_.§!6§.y * _loc26_;
               _loc56_ = _loc49_.§0!M§.x * _loc27_ - _loc49_.§0!M§.y * _loc26_;
               ...
               {
                  _loc28_.§5!`§.col1.Set(_loc58_,_loc60_);
                  _loc28_.§5!`§.col2.Set(_loc60_,_loc59_);
                  _loc28_.§5!`§.§<5§(_loc28_.§'!?§);
               }
               else
               {
         ...
         while(_loc5_ < this.§&`§)
         {
            ...
            if(param1.§3!-§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc20_.normalImpulse *= param1.§4!G§;
                  _loc20_.tangentImpulse *= param1.§4!G§;
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§0!M§.x * _loc22_ - _loc20_.§0!M§.y * _loc21_);
                  _loc7_.§%q§.x -= _loc9_ * _loc21_;
                  _loc7_.§%q§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§!6§.x * _loc22_ - _loc20_.§!6§.y * _loc21_);
                  _loc8_.§%q§.x += _loc11_ * _loc21_;
                  _loc8_.§%q§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         while(_loc24_ < this.§&`§)
         {
            _loc26_ = (_loc25_ = this.§6O§[_loc24_]).§^!<§;
            _loc27_ = _loc25_.§!E§;
            ...
            while(_loc1_ < _loc25_.§8!"§)
            {
               ...
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§!6§.y - _loc30_.x + _loc28_ * _loc2_.§0!M§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§!6§.x - _loc30_.y - _loc28_ * _loc2_.§0!M§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§1q§ * -_loc10_;
               _loc12_ = _loc40_ * _loc2_.normalImpulse;
               _loc14_ = (_loc11_ = (_loc13_ = b2Math.§,W§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_)) - _loc2_.tangentImpulse) * _loc38_;
               _loc15_ = _loc11_ * _loc39_;
               _loc30_.x -= _loc32_ * _loc14_;
               _loc30_.y -= _loc32_ * _loc15_;
               _loc28_ -= _loc33_ * (_loc2_.§0!M§.x * _loc15_ - _loc2_.§0!M§.y * _loc14_);
            ...
            if(_loc25_.§8!"§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§'!?§ * (_loc9_ - _loc2_.§&!F§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§!6§.y - _loc30_.x + _loc28_ * _loc43_.§0!M§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§!6§.x - _loc30_.y - _loc28_ * _loc43_.§0!M§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§!6§.y - _loc30_.x + _loc28_ * _loc44_.§0!M§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§!6§.x - _loc30_.y - _loc28_ * _loc44_.§0!M§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§&!F§;
               _loc54_ = _loc52_ - _loc44_.§&!F§;
               _loc22_ = _loc25_.§5!`§;
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§0!M§.x * _loc19_ - _loc43_.§0!M§.y * _loc18_ + _loc44_.§0!M§.x * _loc21_ - _loc44_.§0!M§.y * _loc20_);
               ...
               else
               {
                  ...
                  _loc57_ = 0;
                  _loc51_ = 0;
                  _loc52_ = _loc25_.§5!`§.col1.y * _loc56_ + _loc54_;
                  ...
                  else
                  {
                     ...
                     _loc51_ = _loc25_.§5!`§.col2.x * _loc57_ + _loc53_;
                     _loc52_ = 0;
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§&`§)
         {
            _loc5_ = (_loc4_ = this.§6O§[_loc3_]).§^!<§;
            _loc6_ = _loc4_.§!E§;
            _loc7_ = _loc5_.§;^§ * _loc5_.§6I§;
            _loc8_ = _loc5_.§;^§ * _loc5_.§2!L§;
            _loc9_ = _loc6_.§;^§ * _loc6_.§6I§;
            _loc10_ = _loc6_.§;^§ * _loc6_.§2!L§;
            §!!#§.§8#§(_loc4_);
            _loc11_ = §!!#§.§?=§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§8!"§)
            {
               ...
               _loc20_ = b2Math.§,W§(param1 * (_loc15_ + b2Settings.b2_linearSlop),-b2Settings.b2_maxLinearCorrection,0);
