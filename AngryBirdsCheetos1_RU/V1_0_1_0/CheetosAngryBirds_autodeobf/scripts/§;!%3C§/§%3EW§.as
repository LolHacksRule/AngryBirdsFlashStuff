package §;!<§
{
   ...
   public class §>W§
   {
      ...
      private static function §9!I§(param1:String) : String
      {
         return §+!W§(§4_§(§&9§(param1),param1.length * 8));
      }
      
      private static function §4_§(param1:Array, param2:Number) : Array
      {
         ...
         while(_loc9_ < param1.length)
         {
            ...
            while(_loc15_ < 80)
            {
               ...
               {
                  _loc3_[_loc15_] = §'!O§(_loc3_[_loc15_ - 3] ^ _loc3_[_loc15_ - 8] ^ _loc3_[_loc15_ - 14] ^ _loc3_[_loc15_ - 16],1);
               }
               _loc16_ = §];§(§];§(§'!O§(_loc4_,5),sha1_ft(_loc15_,_loc5_,_loc6_,_loc7_)),§];§(§];§(_loc8_,_loc3_[_loc15_]),sha1_kt(_loc15_)));
               _loc8_ = _loc7_;
               _loc7_ = _loc6_;
               _loc6_ = §'!O§(_loc5_,30);
               _loc5_ = _loc4_;
      ...
      private static function §'!O§(param1:Number, param2:Number) : Number
      {
         return param1 << param2 | param1 >>> 32 - param2;
      }
      
      private static function §&9§(param1:String) : Array
      {
      ...
      private static function §+!W§(param1:Array) : String
      {
