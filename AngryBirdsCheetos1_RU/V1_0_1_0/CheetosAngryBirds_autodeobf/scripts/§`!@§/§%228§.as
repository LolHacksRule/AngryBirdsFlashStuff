package §`!@§
{
   public class §"8§
   {
      ...
      public static function §^!L§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
      ...
      private static function §7H§(param1:String, param2:Boolean) : String
      {
