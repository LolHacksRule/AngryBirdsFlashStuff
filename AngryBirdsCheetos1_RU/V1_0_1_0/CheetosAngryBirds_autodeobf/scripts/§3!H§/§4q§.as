package §3!H§
{
   ...
   public class §4q§
   {
      ...
      public static function §`,§(param1:String) : String
      {
         ...
         return §#x§.§=q§(_loc3_.readInt(),true) + §#x§.§=q§(_loc3_.readInt(),true) + §#x§.§=q§(_loc3_.readInt(),true) + §#x§.§=q§(_loc3_.readInt(),true) + §#x§.§=q§(_loc3_.readInt(),true);
      }
      
      public static function §&L§(param1:ByteArray) : String
      {
         var _loc2_:Array = §4q§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §[!"§(_loc2_);
         return §#x§.§=q§(_loc3_.readInt(),true) + §#x§.§=q§(_loc3_.readInt(),true) + §#x§.§=q§(_loc3_.readInt(),true) + §#x§.§=q§(_loc3_.readInt(),true) + §#x§.§=q§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §4q§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §[!"§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
