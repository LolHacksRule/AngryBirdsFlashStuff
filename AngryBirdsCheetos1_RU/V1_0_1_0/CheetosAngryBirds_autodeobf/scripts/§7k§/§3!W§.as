package §7k§
{
   ...
   public class §3!W§ extends § M§
   {
       
      
      public function §3!W§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§,M§(param1,param2);
      }
      
      protected function §,M§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if(_loc10_)
            {
               ...
               (_loc16_ = new §5O§()).mName = _loc6_;
               _loc16_.§0!`§ = _loc15_;
               _loc16_.§4!M§ = _loc10_.pivotX;
               _loc16_.§;H§ = _loc10_.pivotY;
               _loc16_.§3]§ = §!![§;
               §@!_§(_loc16_);
            }
         }
      ...
      private function §=!H§(param1:Vector.<XML>) : Dictionary
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§,!$§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §?4§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
