package §7k§
{
   ...
   public class §4!L§ extends § M§
   {
       
      
      public function §4!L§(param1:Object, param2:BitmapData)
      {
         super(param2);
         this.§,M§(param1);
      }
         ...
         for(_loc3_ in param1)
         {
            if(_loc3_.indexOf("chars") == 0)
            {
               ...
               for(_loc5_ in _loc4_)
               {
                  ...
                  (_loc7_ = new §5O§()).mName = String.fromCharCode(_loc6_.code);
                  _loc7_.§0!`§ = new Rectangle(_loc6_.x,_loc6_.y,_loc6_.width,_loc6_.height);
                  _loc7_.§4!M§ = _loc6_.width / 2;
