package §,!8§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§]4§.x * this.§,![§.x + (this.§]I§ + this.§]4§.y) * this.§6!5§.x),param1 * (this.§]4§.x * this.§,![§.y + (this.§]I§ + this.§]4§.y) * this.§6!5§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§3!-§)
         {
            ...
            this.§]4§.y *= param1.§4!G§;
            this.§]I§ *= param1.§4!G§;
            _loc19_ = this.§]4§.x * this.§,![§.x + (this.§]I§ + this.§]4§.y) * this.§6!5§.x;
            _loc20_ = this.§]4§.x * this.§,![§.y + (this.§]I§ + this.§]4§.y) * this.§6!5§.y;
            _loc21_ = this.§]4§.x * this.m_s1 + (this.§]I§ + this.§]4§.y) * this.m_a1;
            _loc22_ = this.§]4§.x * this.m_s2 + (this.§]I§ + this.§]4§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§6!5§.x * (_loc6_.x - _loc4_.x) + this.§6!5§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§9!+§ * (this.§16§ - _loc13_);
            _loc15_ = this.§]I§;
            _loc16_ = param1.§>!!§ * this.§-%§;
            this.§]I§ = b2Math.§,W§(this.§]I§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§]I§ - _loc15_) * this.§6!5§.x;
            _loc9_ = _loc14_ * this.§6!5§.y;
         ...
         {
            _loc17_ = this.§6!5§.x * (_loc6_.x - _loc4_.x) + this.§6!5§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§]4§.Copy();
            _loc19_ = this.§`!V§.§>M§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§]4§.§!!X§(_loc19_);
            if(this.§%?§ == b2internal::1,)
            {
               this.§]4§.y = b2Math.§,L§(this.§]4§.y,0);
            }
            else if(this.§%?§ == b2internal::"&)
            {
               this.§]4§.y = b2Math.§=#§(this.§]4§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§]4§.y - _loc18_.y) * this.§`!V§.col2.x;
            if(this.§`!V§.col1.x != 0)
            {
            ...
            _loc8_ = _loc19_.x * this.§,![§.x + _loc19_.y * this.§6!5§.x;
            _loc9_ = _loc19_.x * this.§,![§.y + _loc19_.y * this.§6!5§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§`9§)
         {
            ...
            _loc34_ = this.§6!5§.x * _loc26_ + this.§6!5§.y * _loc27_;
            if(b2Math.§<!,§(this.§,b§ - this.§%l§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§,W§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§<!,§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§%l§)
            {
               _loc19_ = b2Math.§,W§(_loc34_ - this.§%l§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§%l§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§,b§)
            {
               _loc19_ = b2Math.§,W§(_loc34_ - this.§,b§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§`!V§.§>M§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::9";
         ...
         var _loc30_:Number = _loc28_.x * this.§,![§.x + _loc28_.y * this.§6!5§.x;
         var _loc31_:Number = _loc28_.x * this.§,![§.y + _loc28_.y * this.§6!5§.y;
