package §,!8§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §-G§:Number = 2;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§^j§ = b2internal::%!F.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§>k§.x - this.§^j§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§>k§.y - this.§^j§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§1!J§.x - this.§^j§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§1!J§.y - this.§^j§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§'s§);
         this.m_localAnchor2.SetV(param1.§5%§);
         this.§'L§ = param1.§?3§;
         this.§ !7§ = param1.§ -§ + this.§'L§ * param1.§+@§;
         this.m_maxLength1 = b2Math.§=#§(param1.§<V§,this.§ !7§ - this.§'L§ * b2internal::-G);
         this.m_maxLength2 = b2Math.§=#§(param1.§>!F§,(this.§ !7§ - b2internal::-G) / this.§'L§);
         this.§]4§ = 0;
      ...
      {
         var _loc1_:b2Vec2 = this.§^j§.m_xf.position.Copy();
         _loc1_.§!!X§(this.m_groundAnchor2);
         return _loc1_;
      }
      
      public function GetLength1() : Number
      {
         var _loc1_:b2Vec2 = b2internal::%!F.GetWorldPoint(this.m_localAnchor1);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc18_:Number = this.m_u1.§-V§();
         var _loc19_:Number = this.m_u2.§-V§();
         if(_loc18_ > b2Settings.b2_linearSlop)
         {
            this.m_u1.§7!G§(1 / _loc18_);
         }
         else
         {
            this.m_u1.§,!3§();
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§ !7§ - _loc18_ - this.§'L§ * _loc19_) > 0)
         {
            this.§%Q§ = b2internal::@d;
            this.§]4§ = 0;
         }
         ...
         this.m_limitMass1 = _loc2_.§6I§ + _loc2_.§2!L§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§6I§ + _loc3_.§2!L§ * _loc22_ * _loc22_;
         this.§[!<§ = this.m_limitMass1 + this.§'L§ * this.§'L§ * this.m_limitMass2;
         ...
         {
            this.§]4§ *= param1.§4!G§;
            this.m_limitImpulse1 *= param1.§4!G§;
            this.m_limitImpulse2 *= param1.§4!G§;
            _loc23_ = (-this.§]4§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§]4§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§'L§ * this.§]4§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§'L§ * this.§]4§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§%q§.x += _loc2_.§6I§ * _loc23_;
            _loc2_.§%q§.y += _loc2_.§6I§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§2!L§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§%q§.x += _loc3_.§6I§ * _loc25_;
            _loc3_.§%q§.y += _loc3_.§6I§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§2!L§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§]4§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc10_ = _loc2_.§%q§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§%q§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§%q§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§%q§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§'L§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§[!<§ * -_loc18_;
            _loc20_ = this.§]4§;
            this.§]4§ = b2Math.§,L§(0,this.§]4§ + _loc19_);
            ...
            _loc2_.§%q§.x += _loc2_.§6I§ * _loc14_;
            _loc2_.§%q§.y += _loc2_.§6I§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§2!L§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§%q§.x += _loc3_.§6I§ * _loc16_;
            _loc3_.§%q§.y += _loc3_.§6I§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§2!L§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§%Q§ == b2internal::"&)
         {
            ...
            if(_loc18_ > b2Settings.b2_linearSlop)
            {
               this.m_u2.§7!G§(1 / _loc18_);
            }
            else
            {
               this.m_u2.§,!3§();
            }
            _loc19_ = this.§ !7§ - _loc17_ - this.§'L§ * _loc18_;
            _loc24_ = b2Math.§,L§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§,W§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            ...
            _loc2_.m_sweep.c.x += _loc2_.§6I§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§6I§ * _loc14_;
            _loc2_.m_sweep.a += _loc2_.§2!L§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§6I§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§6I§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§2!L§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§[B§();
            _loc3_.§[B§();
         }
         if(this.m_limitState1 == b2internal::"&)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§-V§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::"&)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§-V§()) > b2Settings.b2_linearSlop)
            {
