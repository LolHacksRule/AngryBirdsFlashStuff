   ...
   public class §^o§
   {
      ...
      public static function § P§(param1:XMLList, param2:XMLList, param3:XMLList) : void
      {
         ...
         for each(_loc4_ in param1.Material)
         {
            ...
            §+J§(_loc4_.@id,_loc4_.@bodyType,_loc4_.@density,_loc4_.@friction,_loc4_.@restitution,_loc4_.@strength,_loc4_.@defence,_loc4_.@colors);
         }
         §-!$§(param2,param3);
      }
      ...
      public static function §+J§(param1:String, param2:String, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : void
      {
