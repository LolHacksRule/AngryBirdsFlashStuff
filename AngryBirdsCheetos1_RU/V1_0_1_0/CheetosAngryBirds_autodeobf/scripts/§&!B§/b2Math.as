package §&!B§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§>m§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function § !0§(param1:Number) : Boolean
      {
      ...
      public static function §7i§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         return param1.x * param2.y - param1.y * param2.x;
      }
      
      public static function §>!Y§(param1:b2Vec2, param2:Number) : b2Vec2
      {
      ...
      public static function §7U§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return new b2Vec2(§-m§(param2,param1.col1),§-m§(param2,param1.col2));
      }
      
      public static function §+Z§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         _loc3_ = §7U§(param1.R,param2);
      ...
      public static function §[l§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         ...
         _loc3_ = §12§(param2,param1.position);
      ...
      public static function §12§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1.x - param2.x,param1.y - param2.y);
      }
      ...
      {
         return b2Mat22.§>m§(§<9§(param1.col1,param2.col1),§<9§(param1.col2,param2.col2));
      }
      
      public static function §!2§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§>m§(§7U§(param1,param2.col1),§7U§(param1,param2.col2));
      }
      
      public static function §[!D§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§-m§(param1.col1,param2.col1),§-m§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§-m§(param1.col1,param2.col2),§-m§(param1.col2,param2.col2));
         return b2Mat22.§>m§(_loc3_,_loc4_);
      }
      ...
      {
         return b2Mat22.§>m§(§>§(param1.col1),§>§(param1.col2));
      }
      ...
      public static function §6z§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§=#§(param1.x,param2.x),§=#§(param1.y,param2.y));
      }
      ...
      public static function §,W§(param1:Number, param2:Number, param3:Number) : Number
      {
      ...
      {
         return §=Z§(param2,§6z§(param1,param3));
      }
      
      public static function §;d§(param1:Array, param2:Array) : void
      {
         var _loc3_:* = param1[0];
         param1[0] = param2[0];
         param2[0] = _loc3_;
      ...
      public static function §3!K§(param1:uint) : Boolean
      {
