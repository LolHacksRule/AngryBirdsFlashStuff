package §#b§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc4_:Number = param1.position.x + (_loc3_.col1.x * this.§!!Q§.x + _loc3_.col2.x * this.§!!Q§.y);
         var _loc5_:Number = param1.position.y + (_loc3_.col1.y * this.§!!Q§.x + _loc3_.col2.y * this.§!!Q§.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc5_:Number = param3.position.x + (_loc4_.col1.x * this.§!!Q§.x + _loc4_.col2.x * this.§!!Q§.y);
         var _loc6_:Number = param3.position.y + (_loc4_.col1.y * this.§!!Q§.x + _loc4_.col2.y * this.§!!Q§.y);
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         var _loc4_:Number = param2.position.x + (_loc3_.col1.x * this.§!!Q§.x + _loc3_.col2.x * this.§!!Q§.y);
         var _loc5_:Number = param2.position.y + (_loc3_.col1.y * this.§!!Q§.x + _loc3_.col2.y * this.§!!Q§.y);
         param1.§1n§.Set(_loc4_ - b2internal::!!`,_loc5_ - b2internal::!!`);
         param1.§>L§.Set(_loc4_ + b2internal::!!`,_loc5_ + b2internal::!!`);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§3O§ = param2 * b2Settings.b2_pi * b2internal::!!` * b2internal::!!`;
         param1.center.SetV(this.§!!Q§);
         param1.§-!`§ = param1.§3O§ * (0.5 * b2internal::!!` * b2internal::!!` + (this.§!!Q§.x * this.§!!Q§.x + this.§!!Q§.y * this.§!!Q§.y));
      }
      
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         var _loc9_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§+Z§(param3,this.§!!Q§);
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.§-m§(param1,_loc5_) - param2)) < -b2internal::!!` + Number.MIN_VALUE)
         {
            return 0;
         }
      ...
      public function §1!F§(param1:b2Vec2) : void
      {
         this.§!!Q§.SetV(param1);
      }
