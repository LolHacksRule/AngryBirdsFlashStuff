package §#b§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §67§:b2Mat22 = new b2Mat22();
      ...
      public static function §#!S§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function §>!B§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §0!1§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§8c§(param1,param2);
         return _loc3_;
      }
      ...
      public static function §>[§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         ...
         (_loc5_ = new b2PolygonShape()).§[V§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §5<§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§+]§(param1,param2);
         return _loc3_;
      ...
      public static function §3v§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc3_.§!!X§(_loc9_);
            _loc3_.§!!X§(_loc10_);
            _loc3_.§7!G§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §2P§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§9f§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§9f§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §&!9§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§"t§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§12§(this.§%%§[_loc5_],this.§%%§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§0!K§() > Number.MIN_VALUE);
            this.§[D§[_loc3_].SetV(b2Math.§>!Y§(_loc6_,1));
            this.§[D§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§,!M§ = §3v§(this.§%%§,this.§"t§);
      }
      
      public function §8c§(param1:Number, param2:Number) : void
      {
         this.§"t§ = 4;
         this.§[4§(4);
      ...
      public function §[V§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§"t§ = 4;
         this.§[4§(4);
         this.§%%§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§"t§)
         {
            this.§%%§[_loc6_] = b2Math.§+Z§(_loc5_,this.§%%§[_loc6_]);
            this.§[D§[_loc6_] = b2Math.§7U§(_loc5_.R,this.§[D§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §+]§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§[D§[0] = b2Math.§>!Y§(b2Math.§12§(param2,param1),1);
         this.§[D§[0].Normalize();
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§"t§)
         {
            _loc6_ = (_loc9_ = this.§%%§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§1n§.x = _loc5_ - b2internal::!!`;
         param1.§1n§.y = _loc6_ - b2internal::!!`;
         param1.§>L§.x = _loc7_ + b2internal::!!`;
         param1.§>L§.y = _loc8_ + b2internal::!!`;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§"t§ == 2)
         {
            param1.center.x = 0.5 * (this.§%%§[0].x + this.§%%§[1].x);
            param1.center.y = 0.5 * (this.§%%§[0].y + this.§%%§[1].y);
            param1.§3O§ = 0;
            param1.§-!`§ = 0;
            return;
         }
         ...
         var _loc6_:Number = 0;
         var _loc10_:int = 0;
         while(_loc10_ < this.§"t§)
         {
            _loc11_ = this.§%%§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§"t§ ? this.§%%§[int(_loc10_ + 1)] : this.§%%§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         {
            _loc7_[_loc12_] = b2Math.§-m§(_loc5_,this.§%%§[_loc12_]) - _loc6_;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§"t§;
         var _loc14_:int = (_loc10_ + 1) % this.§"t§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§%%§[_loc9_].x * (1 - _loc15_) + this.§%%§[_loc13_].x * _loc15_,this.§%%§[_loc9_].y * (1 - _loc15_) + this.§%%§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§%%§[_loc10_].x * (1 - _loc16_) + this.§%%§[_loc14_].x * _loc16_,this.§%%§[_loc10_].y * (1 - _loc16_) + this.§%%§[_loc14_].y * _loc16_);
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§"t§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
      ...
      public function §6V§(param1:b2Vec2) : int
      {
