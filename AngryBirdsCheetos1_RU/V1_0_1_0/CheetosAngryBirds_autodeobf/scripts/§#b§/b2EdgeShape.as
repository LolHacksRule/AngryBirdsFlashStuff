package §#b§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§6!a§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§"h§ = this.§6!a§.Normalize();
         this.§?=§.Set(this.§6!a§.y,-this.§6!a§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§?=§.x - this.§6!a§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§?=§.y - this.§6!a§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§?=§.x + this.§6!a§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§?=§.y + this.§6!a§.y) + this.m_v2.y);
      ...
      public function §"p§() : b2EdgeShape
      {
         return this.§`!M§;
      }
      
      public function §0w§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
