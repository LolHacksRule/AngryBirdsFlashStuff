package §%!B§
{
   ...
   public class b2Collision
   {
      ...
      private static var §3e§:Vector.<§9!#§> = §;f§();
      
      private static var s_clipPoints1:Vector.<§9!#§> = §;f§();
      
      private static var s_clipPoints2:Vector.<§9!#§> = §;f§();
      
      private static var §10§:Vector.<int> = new Vector.<int>(1);
      
      private static var §`e§:Vector.<int> = new Vector.<int>(1);
      
      private static var §7m§:b2Vec2 = new b2Vec2();
      
      private static var §]!!§:b2Vec2 = new b2Vec2();
      
      private static var §+!K§:b2Vec2 = new b2Vec2();
      
      private static var §5X§:b2Vec2 = new b2Vec2();
      ...
      public static function §%A§(param1:Vector.<§9!#§>, param2:Vector.<§9!#§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§9!#§ = null;
         var _loc6_:int = 0;
      ...
      public static function §9!a§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§"t§;
         var _loc7_:Vector.<b2Vec2> = param1.§%%§;
         var _loc8_:Vector.<b2Vec2> = param1.§[D§;
         var _loc9_:int = param4.§"t§;
      ...
      public static function §>N§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §9!a§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §9!a§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §9!a§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §9!a§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §3f§(param1:Vector.<§9!#§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§9!#§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§"t§;
         var _loc8_:Vector.<b2Vec2> = param2.§[D§;
         var _loc9_:int = param5.§"t§;
      ...
      private static function §;f§() : Vector.<§9!#§>
      {
         var _loc1_:Vector.<§9!#§> = new Vector.<§9!#§>(2);
         _loc1_[0] = new §9!#§();
         _loc1_[1] = new §9!#§();
         return _loc1_;
      }
      
      public static function §8!8§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§9!#§ = null;
         ...
         var _loc8_:int = 0;
         §10§[0] = _loc8_;
         var _loc9_:Number = §>N§(§10§,param2,param3,param4,param5);
         _loc8_ = §10§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §`e§[0] = _loc10_;
         var _loc11_:Number = §>N§(§`e§,param4,param5,param2,param3);
         _loc10_ = §`e§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§9!#§> = §3e§;
         §3f§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§"t§;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §7m§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §]!!§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §+!K§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §<X§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§9!#§> = s_clipPoints1;
         var _loc38_:Vector.<§9!#§> = s_clipPoints2;
      ...
      public static function §#2§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§@9§ = b2Manifold.§>a§;
         param1.m_localPoint.SetV(param2.§!!Q§);
         param1.§,?§.§,!3§();
         param1.§>#§ = 1;
         param1.§%!C§[0].m_localPoint.SetV(param4.§!!Q§);
         param1.§%!C§[0].m_id.key = 0;
      }
      
      public static function §5K§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
      ...
      public static function §8!X§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§1n§;
