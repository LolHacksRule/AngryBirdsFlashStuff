   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         if(param1 >= 0 && param1 < this.numChildren)
         {
            ...
            _loc3_.dispatchEvent(new Event(Event.§<7§,true));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§;c§));
            }
            _loc3_.§7b§(null);
      ...
      public function final(param1:DisplayObject, param2:DisplayObject) : void
      {
         var _loc3_:int = this.getChildIndex(param1);
         ...
         this.§2!X§(_loc3_,_loc4_);
      }
      
      public function §2!X§(param1:int, param2:int) : void
      {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            ...
            §@!X§(_loc7_,§?!9§);
            transformCoords(§?!9§,_loc3_,_loc4_,§[!=§);
      ...
      public function §2!F§(param1:Event) : void
      {
         if(param1.bubbles)
         {
