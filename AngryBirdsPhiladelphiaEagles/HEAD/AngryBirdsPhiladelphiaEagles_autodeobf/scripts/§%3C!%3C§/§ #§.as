package §<!<§
{
   ...
   public class § #§ extends Popup
   {
      ...
      public function § #§(param1:XML, param2:§<!K§, param3:Sprite, param4:String)
      {
         super(param1,param2);
         this.§"!P§ = param4;
      ...
      override public function open(param1:Boolean = true) : void
      {
         ...
         {
            if((AngryBirdsFP11.§^O§ as Object).isEggUnlocked("1000-5"))
            {
            ...
            else
            {
               ...
               mClip.ButtonEasterEgg5.addEventListener(MouseEvent.CLICK,this.§@n§);
            }
         }
      ...
      {
         (AngryBirdsFP11.§^O§ as Object).setEggUnlocked("1000-5");
         mClip.ButtonEasterEgg5.visible = false;
      }
