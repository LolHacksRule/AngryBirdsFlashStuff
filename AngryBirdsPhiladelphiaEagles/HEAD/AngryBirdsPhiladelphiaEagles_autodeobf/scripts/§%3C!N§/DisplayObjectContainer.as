   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         if(param1 >= 0 && param1 < this.numChildren)
         {
            ...
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§8K§));
            }
            _loc3_.§7B§(null);
      ...
      public function §0l§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            ...
            §1!H§(_loc7_,§8!J§);
            transformCoords(§8!J§,_loc3_,_loc4_,§<!&§);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§4!C§(this,param1.type,_loc2_);
      ...
      private function §4!C§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               this.§4!C§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
