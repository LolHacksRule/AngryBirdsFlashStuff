package §3!O§
{
   ...
   public class Base64
   {
      ...
      private static const §`4§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function encode(param1:String) : String
      {
         ...
         return §continue§(_loc2_);
      }
      
      public static function §continue§(param1:ByteArray) : String
      {
      ...
      {
         var _loc2_:ByteArray = §41§(param1);
         return _loc2_.readUTFBytes(_loc2_.length);
      }
      
      public static function §41§(param1:String) : ByteArray
      {
         var _loc6_:uint = 0;
         var _loc7_:uint = 0;
         var _loc2_:ByteArray = new ByteArray();
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §`4§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
