         ...
         for(_loc3_ in param1)
         {
            if(_loc3_.indexOf("chars") == 0)
            {
               ...
               for(_loc5_ in _loc4_)
               {
                  ...
                  (_loc7_ = new §false§()).mName = String.fromCharCode(_loc6_.code);
                  _loc7_.§]t§ = new Rectangle(_loc6_.x,_loc6_.y,_loc6_.width,_loc6_.height);
                  _loc7_.§4G§ = _loc6_.width / 2;
                  _loc7_.§8K§ = _loc6_.baseline;
                  _loc7_.§?!G§ = §@`§;
                  §&w§(_loc7_);
               }
            }
