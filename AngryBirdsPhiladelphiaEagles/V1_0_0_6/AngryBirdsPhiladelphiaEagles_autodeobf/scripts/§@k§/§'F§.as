package §@k§
{
   ...
   public class §'F§ extends §-[§
   {
      ...
      protected function §8$§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc16_:§false§ = null;
         var _loc3_:Dictionary = this.§var §(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§+j§(_loc7_,_loc6_)]) == null)
            {
               ...
               {
                  _loc10_ = new §8B§(0,0,_loc11_,_loc12_,_loc13_,_loc14_);
               }
            }
            if(_loc10_)
            {
               _loc15_ = new Rectangle(_loc8_ + _loc10_.x,_loc9_ + _loc10_.y,_loc10_.width,_loc10_.height);
               (_loc16_ = new §false§()).mName = _loc6_;
               _loc16_.§]t§ = _loc15_;
               _loc16_.§4G§ = _loc10_.pivotX;
               _loc16_.§8K§ = _loc10_.pivotY;
               _loc16_.§?!G§ = §@`§;
               §&w§(_loc16_);
            }
         }
      ...
      private function §+j§(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function §var §(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§+j§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §8B§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
