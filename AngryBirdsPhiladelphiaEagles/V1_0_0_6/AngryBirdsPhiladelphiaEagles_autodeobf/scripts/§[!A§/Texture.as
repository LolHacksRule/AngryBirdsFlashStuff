package §[!A§
{
   ...
   public class Texture
   {
      ...
      public static function §#K§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §[!A§.Texture
      {
      ...
      public static function §+!5§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §[!A§.Texture
      {
         ...
         return new §2!&§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §2!4§(param1:Context3D, param2:ByteArray) : §[!A§.Texture
      {
         if(param1 == null)
         {
            throw new §[!C§();
      ...
      public static function §'!+§(param1:§[!A§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §[!A§.Texture
      {
         ...
         (_loc4_ = new §2!&§(param1,param2)).§0z§ = param3;
         return _loc4_;
      }
      
      public static function §'!!§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §[!A§.Texture
      {
      ...
      public function adjustVertexData(param1:§2r§, param2:int, param3:int) : void
      {
         ...
         if(this.§0z§)
         {
            ...
            _loc4_ = this.§0z§.width + this.§0z§.x - this.width;
            _loc5_ = this.§0z§.height + this.§0z§.y - this.height;
            param1.§-#§(param2,-this.§0z§.x,-this.§0z§.y);
            param1.§-#§(param2 + 1,-_loc4_,-this.§0z§.y);
            param1.§-#§(param2 + 2,-this.§0z§.x,-_loc5_);
      ...
      {
         return !!this.§0z§ ? this.§0z§.clone() : new Rectangle(0,0,this.width,this.height);
      }
