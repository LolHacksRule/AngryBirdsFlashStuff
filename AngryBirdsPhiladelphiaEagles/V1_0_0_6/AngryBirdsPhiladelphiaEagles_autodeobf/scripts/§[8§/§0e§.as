package §[8§
{
   ...
   public class §0e§
   {
      ...
      public static function § G§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §4!J§(_loc2_);
         return §!!8§.§9x§(_loc3_.readInt(),true) + §!!8§.§9x§(_loc3_.readInt(),true) + §!!8§.§9x§(_loc3_.readInt(),true) + §!!8§.§9x§(_loc3_.readInt(),true) + §!!8§.§9x§(_loc3_.readInt(),true);
      }
      
      public static function §^<§(param1:ByteArray) : String
      {
         var _loc2_:Array = §0e§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §4!J§(_loc2_);
         return §!!8§.§9x§(_loc3_.readInt(),true) + §!!8§.§9x§(_loc3_.readInt(),true) + §!!8§.§9x§(_loc3_.readInt(),true) + §!!8§.§9x§(_loc3_.readInt(),true) + §!!8§.§9x§(_loc3_.readInt(),true);
      }
      
      public static function §import§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §0e§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §4!J§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §4!J§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
