   ...
   public class §%!,§
   {
      ...
      private function §<7§(param1:int) : void
      {
         ...
         while(_loc7_ < 8)
         {
            ...
            while(_loc8_ < 8)
            {
               this.§7s§[_loc2_] = 1 / (this.§7!-§[this.§8c§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               this.§^V§[_loc2_] = 1 / (this.§ 0§[this.§8c§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               _loc2_++;
               _loc8_++;
            }
            _loc7_++;
      ...
      private function §,h§(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         ...
         while(_loc8_ < 64)
         {
            this.§3!8§[this.§8c§[_loc8_]] = _loc9_[_loc8_];
            _loc8_++;
         }
         var _loc10_:int = this.§3!8§[0] - param3;
         param3 = this.§3!8§[0];
         if(_loc10_ == 0)
         {
            this.§6$§(param4[0]);
         ...
         var _loc11_:int = 63;
         while(_loc11_ > 0 && this.§3!8§[_loc11_] == 0)
         {
            _loc11_--;
         }
         if(_loc11_ == 0)
         ...
         {
            _loc12_ = _loc8_;
            while(this.§3!8§[_loc8_] == 0 && _loc8_ <= _loc11_)
            {
               _loc8_++;
            }
      ...
      public function encode(param1:BitmapData) : ByteArray
      {
         ...
         while(_loc5_ < param1.height)
         {
            ...
            while(_loc6_ < param1.width)
            {
               ...
               _loc2_ = this.§,h§(this.§<!-§,this.§7s§,_loc2_,this.§-!=§,this.§3l§);
               _loc3_ = this.§,h§(this.§#!+§,this.§^V§,_loc3_,this.§%1§,this.§[G§);
               _loc4_ = this.§,h§(this.§?!9§,this.§^V§,_loc4_,this.§%1§,this.§[G§);
               _loc6_ += 8;
            }
            _loc5_ += 8;
         }
