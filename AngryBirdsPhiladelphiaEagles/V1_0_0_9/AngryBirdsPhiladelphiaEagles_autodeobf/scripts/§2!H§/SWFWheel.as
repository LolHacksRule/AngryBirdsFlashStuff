package §2!H§
{
   ...
   public class SWFWheel
   {
      ...
      public static const §8T§:String = "SWFWheel.join";
      
      public static const §,!#§:String = "SWFWheel.getState";
      
      private static var §[H§:Stage;
      ...
      public static function initialize(param1:Stage) : void
      {
         ...
         §[H§ = param1;
         ExternalInterface.call(§8T§,ExternalInterface.objectID);
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §[H§.getObjectsUnderPoint(new Point(§[H§.mouseX,§[H§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
