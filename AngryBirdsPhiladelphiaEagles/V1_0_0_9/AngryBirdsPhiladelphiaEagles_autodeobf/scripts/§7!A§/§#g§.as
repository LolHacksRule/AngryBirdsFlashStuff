package §7!A§
{
   ...
   public class §#g§ extends §9!H§
   {
      ...
      public function §#g§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
      ...
      protected function §&s§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§0!J§(_loc7_,_loc6_)]) == null)
            {
               ...
               {
                  _loc10_ = new §30§(0,0,_loc11_,_loc12_,_loc13_,_loc14_);
               }
            }
            if(_loc10_)
            {
               _loc15_ = new Rectangle(_loc8_ + _loc10_.x,_loc9_ + _loc10_.y,_loc10_.width,_loc10_.height);
               (_loc16_ = new §%b§()).mName = _loc6_;
               _loc16_.§&V§ = _loc15_;
               _loc16_.§25§ = _loc10_.pivotX;
      ...
      private function §0!J§(param1:String, param2:String) : String
      {
      ...
      private function §!c§(param1:Vector.<XML>) : Dictionary
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§0!J§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §30§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
