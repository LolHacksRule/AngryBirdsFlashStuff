package §,]§
{
   ...
   public class Texture
   {
      ...
      public static function §]!B§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §,]§.Texture
      {
         return §2x§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §2x§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §,]§.Texture
      {
         ...
         _loc10_ = new §%!5§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§&!H§.§9!@§)
         {
            _loc10_.§!y§(param2);
         }
      ...
      public static function §"!>§(param1:Context3D, param2:ByteArray) : §,]§.Texture
      {
         ...
         var _loc9_:§%!5§ = new §%!5§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§&!H§.§9!@§)
         {
            _loc9_.§!y§(param2);
         }
      ...
      public static function §7z§(param1:§,]§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §,]§.Texture
      {
         var _loc4_:§,]§.Texture;
      ...
      public static function §"_§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §,]§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§,]§.Texture = §2x§(param1,_loc6_,false,param5);
         if(!§&!H§.§9!@§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§3L§, param2:int, param3:int) : void
      {
         ...
         if(this.§ C§)
         {
            ...
            param1.§0!N§(param2,-this.§ C§.x,-this.§ C§.y);
            param1.§0!N§(param2 + 1,-_loc4_,-this.§ C§.y);
            param1.§0!N§(param2 + 2,-this.§ C§.x,-_loc5_);
            param1.§0!N§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
