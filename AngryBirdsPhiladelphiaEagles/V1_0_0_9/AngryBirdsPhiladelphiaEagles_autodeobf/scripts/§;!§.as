package
{
   ...
   public class §;!§
   {
      ...
      private function §"!I§(param1:*) : String
      {
      ...
      private function §;!7§(param1:Array) : String
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§"!I§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §8S§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§<!H§(v.@name.toString()) + ":" + this.§"!I§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
