package §-!'§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§>t§ = new Vector.<DisplayObject>(0);
      }
      
      override public function dispose() : void
      {
         var _loc1_:int = this.§>t§.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         if(param1 >= 0 && param1 < this.numChildren)
         {
            ...
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§[K§));
            }
            _loc3_.§?b§(null);
      ...
      public function getChildByName(param1:String) : DisplayObject
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(this.§>t§[_loc3_].name == param1)
            {
               return this.§>t§[_loc3_];
            }
            _loc3_++;
         }
         return null;
      ...
      public function §"S§(param1:int, param2:int) : void
      {
         ...
         this.§>t§[param2] = _loc3_;
      }
      
      public function §2U§(param1:Function) : void
      {
         this.§>t§ = this.§>t§.sort(param1);
      }
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§>t§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§>t§.length;
         if(_loc3_ == 0)
         {
            §0N§(param1,§0y§);
            transformCoords(§0y§,0,0,§6!G§);
            param2.x = §6!G§.x;
            param2.y = §6!G§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§>t§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§>t§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§>t§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§>t§[_loc6_];
            §0N§(_loc7_,§0y§);
            transformCoords(§0y§,_loc3_,_loc4_,§6!G§);
            if(_loc8_ = _loc7_.hitTest(§6!G§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§@`§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§>t§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§`"§();
               param1.§^H§(_loc5_);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§7W§(this,param1.type,_loc2_);
      ...
      private function §7W§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§>t§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
               this.§7W§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
