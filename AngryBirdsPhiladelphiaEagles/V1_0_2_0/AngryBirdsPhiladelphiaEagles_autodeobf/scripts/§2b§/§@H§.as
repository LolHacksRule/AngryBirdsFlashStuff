package §2b§
{
   ...
   public class §@H§
   {
      ...
      public static function §2_§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §6z§(_loc2_);
         return §3!E§.§ -§(_loc3_.readInt(),true) + §3!E§.§ -§(_loc3_.readInt(),true) + §3!E§.§ -§(_loc3_.readInt(),true) + §3!E§.§ -§(_loc3_.readInt(),true) + §3!E§.§ -§(_loc3_.readInt(),true);
      }
      
      public static function §;2§(param1:ByteArray) : String
      {
         var _loc2_:Array = §@H§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §6z§(_loc2_);
         return §3!E§.§ -§(_loc3_.readInt(),true) + §3!E§.§ -§(_loc3_.readInt(),true) + §3!E§.§ -§(_loc3_.readInt(),true) + §3!E§.§ -§(_loc3_.readInt(),true) + §3!E§.§ -§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §@H§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §6z§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §6z§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
