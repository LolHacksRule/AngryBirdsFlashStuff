package §9!A§
{
   ...
   public class §`!7§
   {
      ...
      public function §`!7§(param1:Number = 50)
      {
         this.§8l§ = [0,1,5,6,14,15,27,28,2,4,7,13,16,26,29,42,3,8,12,17,25,30,41,43,9,11,18,24,31,40,44,53,10,19,23,32,39,45,52,54,20,22,33,38,46,51,55,60,21,34,37,47,50,56,59,61,35,36,48,49,57,58,62,63];
         this.§8b§ = new Array(64);
         this.§+!4§ = new Array(64);
         this.§9!M§ = new Array(64);
         this.§4u§ = new Array(64);
         ...
         this.§?w§ = new Array(65535);
         this.category = new Array(65535);
         this.§@3§ = new Array(64);
         this.§6F§ = new Array(64);
         this.§+g§ = new Array(64);
         this.§>!H§ = new Array(64);
         super();
         if(param1 <= 0)
      ...
      private function §&t§(param1:int) : void
      {
         ...
         while(_loc7_ < 8)
         {
            ...
            while(_loc8_ < 8)
            {
               this.§9!M§[_loc2_] = 1 / (this.§8b§[this.§8l§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               this.§4u§[_loc2_] = 1 / (this.§+!4§[this.§8l§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               _loc2_++;
               _loc8_++;
            }
            _loc7_++;
      ...
      {
         this.§^1§ = this.§,!A§(this.§>!"§,this.§=t§);
         this.§1Z§ = this.§,!A§(this.§0"§,this.§@[§);
         this.§!T§ = this.§,!A§(this.§+j§,this.§[]§);
         this.§4g§ = this.§,!A§(this.§`!H§,this.§-=§);
      }
      ...
      private function §-?§() : void
      {
         ...
         while(_loc4_ <= 15)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               ...
               this.§?w§[32767 + _loc3_] = new §6!D§();
               this.§?w§[32767 + _loc3_].len = _loc4_;
               this.§?w§[32767 + _loc3_].val = _loc3_;
               _loc3_++;
            }
            _loc3_ = -(_loc2_ - 1);
            while(_loc3_ <= -_loc1_)
            {
               ...
               this.§?w§[32767 + _loc3_] = new §6!D§();
               this.§?w§[32767 + _loc3_].len = _loc4_;
               this.§?w§[32767 + _loc3_].val = _loc2_ - 1 + _loc3_;
               _loc3_++;
            }
            _loc1_ <<= 1;
            _loc2_ <<= 1;
      ...
      private function §0_§(param1:§6!D§) : void
      {
      ...
      private function §,@§(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         var _loc6_:§6!D§ = param5[0];
         var _loc7_:§6!D§ = param5[240];
         var _loc9_:Array = this.§!!$§(param1,param2);
         _loc8_ = 0;
         while(_loc8_ < 64)
         {
            this.§@3§[this.§8l§[_loc8_]] = _loc9_[_loc8_];
            _loc8_++;
         }
         var _loc10_:int = this.§@3§[0] - param3;
         param3 = this.§@3§[0];
         if(_loc10_ == 0)
         {
            this.§0_§(param4[0]);
         ...
         {
            this.§0_§(param4[this.category[32767 + _loc10_]]);
            this.§0_§(this.§?w§[32767 + _loc10_]);
         }
         var _loc11_:int = 63;
         while(_loc11_ > 0 && this.§@3§[_loc11_] == 0)
         {
            _loc11_--;
         }
         if(_loc11_ == 0)
         ...
         {
            _loc12_ = _loc8_;
            while(this.§@3§[_loc8_] == 0 && _loc8_ <= _loc11_)
            {
               _loc8_++;
            }
            ...
            this.§0_§(param5[_loc13_ * 16 + this.category[32767 + this.§@3§[_loc8_]]]);
            this.§0_§(this.§?w§[32767 + this.§@3§[_loc8_]]);
            _loc8_++;
         }
         if(_loc11_ != 63)
         {
      ...
      private function §[,§(param1:BitmapData, param2:int, param3:int) : void
      {
         ...
         while(_loc5_ < 8)
         {
            ...
            while(_loc6_ < 8)
            {
               ...
               this.§6F§[_loc4_] = 0.299 * _loc8_ + 0.587 * _loc9_ + 0.114 * _loc10_ - 128;
      ...
      public function encode(param1:BitmapData) : ByteArray
      {
         ...
         while(_loc5_ < param1.height)
         {
            ...
            while(_loc6_ < param1.width)
            {
               ...
               _loc2_ = this.§,@§(this.§6F§,this.§9!M§,_loc2_,this.§^1§,this.§!T§);
               _loc3_ = this.§,@§(this.§+g§,this.§4u§,_loc3_,this.§1Z§,this.§4g§);
               _loc4_ = this.§,@§(this.§>!H§,this.§4u§,_loc4_,this.§1Z§,this.§4g§);
               _loc6_ += 8;
            }
            _loc5_ += 8;
         }
         if(this.§3!M§ >= 0)
         {
            (_loc7_ = new §6!D§()).len = this.§3!M§ + 1;
            _loc7_.val = (1 << this.§3!M§ + 1) - 1;
            this.§0_§(_loc7_);
         }
         this.§[!<§(65497);
         return this.§7!>§;
