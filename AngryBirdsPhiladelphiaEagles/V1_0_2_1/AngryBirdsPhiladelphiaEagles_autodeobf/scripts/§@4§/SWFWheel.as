package §@4§
{
   ...
   public class SWFWheel
   {
      ...
      public static function initialize(param1:Stage) : void
      {
         ...
         §0[§ = ExternalInterface.call(§'! §,ExternalInterface.objectID);
         if(§0[§ == §1k§)
         {
            return;
         }
      ...
      public static function get §08§() : int
      {
         return §0[§;
      }
      
      public static function get §2w§() : Boolean
      {
         return §?5§;
      }
      
      public static function set §2w§(param1:Boolean) : void
      {
         §?5§ = param1;
      }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §4!§.getObjectsUnderPoint(new Point(§4!§.mouseX,§4!§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
