package §@M§
{
   ...
   public class Texture
   {
      ...
      public static function §6N§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §@M§.Texture
      {
         return §6@§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §6@§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §@M§.Texture
      {
      ...
      public static function §',§(param1:Context3D, param2:ByteArray) : §@M§.Texture
      {
         if(param1 == null)
         {
            throw new §>Z§();
      ...
      public static function §"j§(param1:§@M§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §@M§.Texture
      {
         var _loc4_:§@M§.Texture;
         (_loc4_ = new §@w§(param1,param2)).§0r§ = param3;
         return _loc4_;
      }
      
      public static function §8g§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §@M§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§@M§.Texture = §6@§(param1,_loc6_,false,param5);
         if(!§2l§.§[l§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§1!K§, param2:int, param3:int) : void
      {
         ...
         if(this.§0r§)
         {
            ...
            _loc4_ = this.§0r§.width + this.§0r§.x - this.width;
            _loc5_ = this.§0r§.height + this.§0r§.y - this.height;
            param1.§!#§(param2,-this.§0r§.x,-this.§0r§.y);
            param1.§!#§(param2 + 1,-_loc4_,-this.§0r§.y);
            param1.§!#§(param2 + 2,-this.§0r§.x,-_loc5_);
      ...
      {
         return !!this.§0r§ ? this.§0r§.clone() : new Rectangle(0,0,this.width,this.height);
      }
      ...
      public function get root() : §@M§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §@M§.Texture
      {
         return this;
      }
