package §+s§
{
   ...
   public class §;t§
   {
      ...
      public static function §[!0§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §7!2§(_loc2_);
         return §>j§.§ 5§(_loc3_.readInt(),true) + §>j§.§ 5§(_loc3_.readInt(),true) + §>j§.§ 5§(_loc3_.readInt(),true) + §>j§.§ 5§(_loc3_.readInt(),true) + §>j§.§ 5§(_loc3_.readInt(),true);
      }
      
      public static function §!!9§(param1:ByteArray) : String
      {
         var _loc2_:Array = §;t§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §7!2§(_loc2_);
         return §>j§.§ 5§(_loc3_.readInt(),true) + §>j§.§ 5§(_loc3_.readInt(),true) + §>j§.§ 5§(_loc3_.readInt(),true) + §>j§.§ 5§(_loc3_.readInt(),true) + §>j§.§ 5§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §;t§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §7!2§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §7!2§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
