package §!6§
{
   ...
   public class Base64
   {
      ...
      private static const §#r§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §4!3§(param1:ByteArray) : String
      {
      ...
      public static function §6§(param1:String) : ByteArray
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §#r§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
