package §?!G§
{
   ...
   public class §4&§
   {
      ...
      private static var §4m§:Boolean = false;
      ...
      public static function encode(param1:BitmapData) : ByteArray
      {
         ...
         _loc4_.compress();
         § try§(_loc2_,1229209940,_loc4_);
         § try§(_loc2_,1229278788,null);
         return _loc2_;
      }
      
      private static function § try§(param1:ByteArray, param2:uint, param3:ByteArray) : void
      {
         var _loc8_:uint = 0;
         var _loc9_:uint = 0;
         var _loc10_:uint = 0;
