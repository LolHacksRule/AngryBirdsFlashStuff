package §4q§
{
   ...
   public class §5s§ extends Popup
   {
      ...
      public function §5s§(param1:XML, param2:§@]§, param3:Sprite, param4:String)
      {
         super(param1,param2);
         this.§'y§ = param4;
      ...
      override public function open(param1:Boolean = true) : void
      {
         ...
         if(this.§'y§ == "POWERUP_TUTORIAL_SLINGSCOPE")
         {
            if((AngryBirdsFP11.§3!?§ as Object).isEggUnlocked("1000-5"))
            {
            ...
            else
            {
               ...
               mClip.ButtonEasterEgg5.addEventListener(MouseEvent.CLICK,this.§@!G§);
            }
         }
      ...
      {
         (AngryBirdsFP11.§3!?§ as Object).setEggUnlocked("1000-5");
         mClip.ButtonEasterEgg5.visible = false;
      }
