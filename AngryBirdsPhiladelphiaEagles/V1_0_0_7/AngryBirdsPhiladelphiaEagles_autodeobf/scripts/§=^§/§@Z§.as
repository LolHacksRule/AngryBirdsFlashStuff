package §=^§
{
   ...
   public class §@Z§
   {
      ...
      private function § '§(param1:*) : String
      {
         ...
         if(param1 is Array)
         {
            return this.§1Q§(param1 as Array);
         }
         if(param1 is Object && param1 != null)
         {
            return this.§3u§(param1);
         }
         return "null";
      }
      ...
      private function §1Q§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
      ...
      private function §3u§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§3&§(v.@name.toString()) + ":" + this.§ '§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
