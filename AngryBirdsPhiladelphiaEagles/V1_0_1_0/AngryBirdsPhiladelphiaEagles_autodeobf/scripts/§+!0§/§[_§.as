package §+!0§
{
   ...
   public class §[_§ extends §=j§
   {
      ...
      protected function §>M§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         var _loc16_:§#N§ = null;
         var _loc3_:Dictionary = this.§1X§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§[$§(_loc7_,_loc6_)]) == null)
            {
               ...
               {
                  _loc10_ = new §4!2§(0,0,_loc11_,_loc12_,_loc13_,_loc14_);
               }
            }
            if(_loc10_)
            {
               _loc15_ = new Rectangle(_loc8_ + _loc10_.x,_loc9_ + _loc10_.y,_loc10_.width,_loc10_.height);
               (_loc16_ = new §#N§()).mName = _loc6_;
               _loc16_.§'!3§ = _loc15_;
               _loc16_.§!p§ = _loc10_.pivotX;
      ...
      private function §1X§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            for each(_loc6_ in _loc5_)
            {
               ...
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §4!2§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
