package §?@§
{
   ...
   public class §5a§
   {
      ...
      public static function §?F§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §?!5§(_loc2_);
         return §3_§.§0P§(_loc3_.readInt(),true) + §3_§.§0P§(_loc3_.readInt(),true) + §3_§.§0P§(_loc3_.readInt(),true) + §3_§.§0P§(_loc3_.readInt(),true) + §3_§.§0P§(_loc3_.readInt(),true);
      }
      
      public static function § try§(param1:ByteArray) : String
      {
         var _loc2_:Array = §5a§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §?!5§(_loc2_);
         return §3_§.§0P§(_loc3_.readInt(),true) + §3_§.§0P§(_loc3_.readInt(),true) + §3_§.§0P§(_loc3_.readInt(),true) + §3_§.§0P§(_loc3_.readInt(),true) + §3_§.§0P§(_loc3_.readInt(),true);
      }
      
      public static function §6j§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §5a§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §?!5§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §?!5§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
