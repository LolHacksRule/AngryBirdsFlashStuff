package §3H§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private var §&_§:Vector.<DisplayObject>;
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§&_§ = new Vector.<DisplayObject>(0);
      }
      
      override public function dispose() : void
      {
         var _loc1_:int = this.§&_§.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         if(param1 >= 0 && param1 < this.numChildren)
         {
            ...
            _loc3_.dispatchEvent(new Event(Event.§"9§,true));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§[h§));
            }
            _loc3_.§'!'§(null);
      ...
      public function §+K§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      public function §3z§(param1:Function) : void
      {
         this.§&_§ = this.§&_§.sort(param1);
      }
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§&_§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§&_§.length;
         if(_loc3_ == 0)
         {
            §5F§(param1,§[1§);
            transformCoords(§[1§,0,0,§&!-§);
            param2.x = §&!-§.x;
            param2.y = §&!-§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§&_§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§&_§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§&_§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§&_§[_loc6_];
            §5F§(_loc7_,§[1§);
            transformCoords(§[1§,_loc3_,_loc4_,§&!-§);
      ...
      override public function render(param1:§4!3§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§&_§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§#!#§();
               param1.§'!6§(_loc5_);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§09§(this,param1.type,_loc2_);
      ...
      private function §09§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§&_§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
               this.§09§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
