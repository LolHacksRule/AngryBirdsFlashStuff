package § !N§
{
   ...
   public class §^!>§
   {
      ...
      private static const get:String = "compositeSprite";
      ...
      {
         var _loc3_:XML = null;
         var _loc2_:XMLList = param1.child(get);
      ...
      public static function §+C§(param1:String, param2:§`v§, param3:Boolean = true) : §3H§.Sprite
      {
         var _loc7_:XML = null;
         var _loc8_:§6!§ = null;
         var _loc9_:§`!@§ = null;
         ...
         var _loc5_:§3H§.Sprite = new §3H§.Sprite();
      ...
      public static function §;q§(param1:String, param2:§`v§) : flash.display.Sprite
      {
         var _loc6_:XML = null;
         var _loc7_:§6!§ = null;
