package §0l§
{
   ...
   public class Texture
   {
      ...
      public static function §8Q§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §0l§.Texture
      {
         return §&5§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §&5§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §0l§.Texture
      {
         ...
         return new §`j§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §-[§(param1:Context3D, param2:ByteArray) : §0l§.Texture
      {
         if(param1 == null)
         {
            throw new § L§();
      ...
      public static function §#w§(param1:§0l§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §0l§.Texture
      {
         var _loc4_:§0l§.Texture;
         (_loc4_ = new §`j§(param1,param2)).§%i§ = param3;
         return _loc4_;
      }
      
      public static function § !$§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §0l§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§0l§.Texture = §&5§(param1,_loc6_,false,param5);
         if(!§>$§.§9!B§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§+L§, param2:int, param3:int) : void
      {
         ...
         if(this.§%i§)
         {
            ...
            _loc4_ = this.§%i§.width + this.§%i§.x - this.width;
            _loc5_ = this.§%i§.height + this.§%i§.y - this.height;
            param1.§>!B§(param2,-this.§%i§.x,-this.§%i§.y);
            param1.§>!B§(param2 + 1,-_loc4_,-this.§%i§.y);
            param1.§>!B§(param2 + 2,-this.§%i§.x,-_loc5_);
            param1.§>!B§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      ...
      public function get root() : §0l§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §0l§.Texture
      {
         return this;
      }
