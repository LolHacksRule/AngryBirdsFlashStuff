package §2!'§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§&""§.x * this.§;!]§.x + (this.§^!f§ + this.§&""§.z) * this.§try§.x),param1 * (this.§&""§.x * this.§;!]§.y + (this.§^!f§ + this.§&""§.z) * this.§try§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§?!S§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§?!S§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§?!S§.col2.x = this.§?!S§.col1.y;
         this.§?!S§.col2.y = _loc16_ + _loc17_;
         this.§?!S§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§?!S§.col3.x = this.§?!S§.col1.z;
         this.§?!S§.col3.y = this.§?!S§.col2.z;
         this.§?!S§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§>7§)
         {
         ...
         if(param1.§9!w§)
         {
            ...
            this.§&""§.y *= param1.§[!4§;
            this.§^!f§ *= param1.§[!4§;
            _loc19_ = this.§&""§.x * this.§;!]§.x + (this.§^!f§ + this.§&""§.z) * this.§try§.x;
            _loc20_ = this.§&""§.x * this.§;!]§.y + (this.§^!f§ + this.§&""§.z) * this.§try§.y;
            _loc21_ = this.§&""§.x * this.m_s1 + this.§&""§.y + (this.§^!f§ + this.§&""§.z) * this.m_a1;
            _loc22_ = this.§&""§.x * this.m_s2 + this.§&""§.y + (this.§^!f§ + this.§&""§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§try§.x * (_loc6_.x - _loc4_.x) + this.§try§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§1!F§ * (this.§!z§ - _loc14_);
            _loc16_ = this.§^!f§;
            _loc17_ = param1.§?!C§ * this.§!!V§;
            this.§^!f§ = b2Math.§?!?§(this.§^!f§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§^!f§ - _loc16_) * this.§try§.x;
            _loc9_ = _loc15_ * this.§try§.y;
         ...
         {
            _loc18_ = this.§try§.x * (_loc6_.x - _loc4_.x) + this.§try§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§&""§.Copy();
            _loc20_ = this.§?!S§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§&""§.§2!3§(_loc20_);
            if(this.§=H§ == b2internal::1l)
            {
               this.§&""§.z = b2Math.§&h§(this.§&""§.z,0);
            }
            else if(this.§=H§ == b2internal::4!S)
            {
               this.§&""§.z = b2Math.§;!t§(this.§&""§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§&""§.z - _loc19_.z) * this.§?!S§.col3.x;
            _loc22_ = -_loc13_ - (this.§&""§.z - _loc19_.z) * this.§?!S§.col3.y;
            ...
            _loc8_ = _loc20_.x * this.§;!]§.x + _loc20_.z * this.§try§.x;
            _loc9_ = _loc20_.x * this.§;!]§.y + _loc20_.z * this.§try§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§>7§)
         {
            ...
            _loc35_ = this.§try§.x * _loc26_ + this.§try§.y * _loc27_;
            if(b2Math.§0@§(this.§9M§ - this.§#g§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§?!?§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§0@§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§#g§)
            {
               _loc19_ = b2Math.§?!?§(_loc35_ - this.§#g§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§#g§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§9M§)
            {
               _loc19_ = b2Math.§?!?§(_loc35_ - this.§9M§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§9M§;
               _loc18_ = true;
            }
         }
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§5,§;
         _loc16_ = b2Math.§&h§(_loc16_,b2Math.§0@§(_loc29_));
         _loc17_ = b2Math.§0@§(_loc30_);
         if(_loc18_)
         {
            ...
            this.§?!S§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§?!S§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§?!S§.col2.x = this.§?!S§.col1.y;
            this.§?!S§.col2.y = _loc14_ + _loc15_;
            this.§?!S§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§?!S§.col3.x = this.§?!S§.col1.z;
            this.§?!S§.col3.y = this.§?!S§.col2.z;
            this.§?!S§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§?!S§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::`!Q;
            ...
            this.§?!S§.col1.Set(_loc36_,_loc37_,0);
            this.§?!S§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§?!S§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§;!]§.x + _loc28_.z * this.§try§.x;
         var _loc32_:Number = _loc28_.x * this.§;!]§.y + _loc28_.z * this.§try§.y;
