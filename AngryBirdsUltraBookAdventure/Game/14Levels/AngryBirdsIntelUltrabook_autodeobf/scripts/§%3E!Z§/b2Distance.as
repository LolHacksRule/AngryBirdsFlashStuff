      ...
      public static function §65§(param1:b2DistanceOutput, param2:b2SimplexCache, param3:b2DistanceInput) : void
      {
         ...
         if(param3.§#!+§)
         {
            ...
            if(param1.§>!_§ > _loc23_ + _loc24_ && param1.§>!_§ > Number.MIN_VALUE)
            {
               ...
               param1.§3!O§.y += _loc23_ * _loc25_.y;
               param1.§"!"§.x -= _loc24_ * _loc25_.x;
               param1.§"!"§.y -= _loc24_ * _loc25_.y;
            }
            else
            {
               (_loc18_ = new b2Vec2()).x = 0.5 * (param1.§3!O§.x + param1.§"!"§.x);
               _loc18_.y = 0.5 * (param1.§3!O§.y + param1.§"!"§.y);
               param1.§3!O§.x = param1.§"!"§.x = _loc18_.x;
               param1.§3!O§.y = param1.§"!"§.y = _loc18_.y;
               param1.§>!_§ = 0;
            }
         }
      }
