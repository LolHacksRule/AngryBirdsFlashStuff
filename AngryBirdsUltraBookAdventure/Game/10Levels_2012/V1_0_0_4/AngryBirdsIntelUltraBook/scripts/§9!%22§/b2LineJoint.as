package §9!"§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§,!2§.x * this.§^^§.x + (this.§8t§ + this.§,!2§.y) * this.§]]§.x),param1 * (this.§,!2§.x * this.§^^§.y + (this.§8t§ + this.§,!2§.y) * this.§]]§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§<M§ = this.§<M§ > Number.MIN_VALUE ? Number(1 / this.§<M§) : Number(0);
         ...
         if(param1.§[8§)
         {
            ...
            this.§,!2§.y *= param1.§87§;
            this.§8t§ *= param1.§87§;
            _loc19_ = this.§,!2§.x * this.§^^§.x + (this.§8t§ + this.§,!2§.y) * this.§]]§.x;
            _loc20_ = this.§,!2§.x * this.§^^§.y + (this.§8t§ + this.§,!2§.y) * this.§]]§.y;
            _loc21_ = this.§,!2§.x * this.m_s1 + (this.§8t§ + this.§,!2§.y) * this.m_a1;
            _loc22_ = this.§,!2§.x * this.m_s2 + (this.§8t§ + this.§,!2§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§-!>§ && this.§>!X§ != b2internal::'!E)
         {
            ...
            _loc14_ = this.§<M§ * (this.§&?§ - _loc13_);
            _loc15_ = this.§8t§;
            _loc16_ = param1.§^Z§ * this.§&e§;
            this.§8t§ = b2Math.§]#§(this.§8t§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§8t§ - _loc15_) * this.§]]§.x;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§5,§)
         {
            ...
            if(b2Math.§-n§(this.§9D§ - this.§,8§) < 2 * b2Settings.b2_linearSlop)
            {
               ...
               _loc16_ = b2Math.§-n§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§,8§)
            {
               _loc19_ = b2Math.§]#§(_loc34_ - this.§,8§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§,8§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§9D§)
            {
               _loc19_ = b2Math.§]#§(_loc34_ - this.§9D§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§9D§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§^!u§.§3!=§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::9k;
         ...
         _loc6_.x -= b2internal::9k * _loc30_;
         _loc6_.y -= b2internal::9k * _loc31_;
         _loc7_ -= b2internal::8- * _loc32_;
         _loc8_.x += b2internal::,!J * _loc30_;
         _loc8_.y += b2internal::,!J * _loc31_;
