               ...
               if(_loc8_ || param1)
               {
                  ...
                  if(!_loc9_)
                  {
                     ...
                     if(_loc8_ || param1)
                     {
                        ...
                        addr91:
                        var _loc5_:* = §§pop();
                        §§push(§3§.§0!T§(param2) * _loc4_);
                        if(!(_loc9_ && param2))
                        {
                           §§push(Number(§§pop()));
                        }
                        var _loc6_:* = §§pop();
                        §§push(§3§.§2&§(param2) * _loc4_);
                        if(_loc8_ || param2)
                        {
                           §§push(Number(§§pop()));
                        }
      ...
      public function §>e§(param1:uint, param2:Number = 1.0) : void
      {
         ...
         if(_loc7_)
         {
            ...
            if(_loc7_)
            {
               ...
               var _loc4_:* = §§pop();
               §§push(§3§.§0!T§(param1) * _loc3_);
               if(_loc7_ || param1)
               {
                  §§push(Number(§§pop()));
               }
               var _loc5_:* = §§pop();
               §§push(§3§.§2&§(param1) * _loc3_);
               if(_loc7_ || this)
               {
                  §§push(Number(§§pop()));
               }
