package §3Y§
{
   ...
   public class LevelObjectMovieClipHelper
   {
                  ...
                  if(!_loc6_)
                  {
                     ...
                     if(param2)
                     {
                        if(_loc7_ || param2)
                        {
                              ...
                              while(true)
                              {
                                 ...
                                 while(true)
                                 {
                                    ...
                                    while(true)
                                    {
                                       ...
                                       while(true)
                                       {
                                          _loc4_[0] = new b2Vec2(_loc3_.x * LevelMain.§!5§,_loc3_.y * LevelMain.§!5§);
                                          addr231:
                                          while(true)
                                          {
                                             _loc4_[1] = new b2Vec2(_loc3_.x * LevelMain.§!5§,(_loc3_.y + _loc3_.height) * LevelMain.§!5§);
                                             continue loop2;
                                          }
                                       }
                                    }
                           ...
                           while(true)
                           {
                              _loc4_[2] = new b2Vec2((_loc3_.x + _loc3_.width) * LevelMain.§!5§,(_loc3_.y + _loc3_.height) * LevelMain.§!5§);
                              loop4:
                              ...
                              },continue loop3)
                              {
                                 while(true)
                                 {
                                    _loc4_[3] = new b2Vec2((_loc3_.x + _loc3_.width) * LevelMain.§!5§,_loc3_.y * LevelMain.§!5§);
                                    continue loop4;
                                 }
                              }
                              §§goto(addr231);
                                 ...
                                 while(true)
                                 {
                                    if(_loc4_.width != _loc4_.height)
                                    {
                                       while(!_loc6_)
                                       {
                                          ...
                                          if(_loc7_ || param1)
                                          {
                                             _loc3_[2] = (_loc4_.y + _loc4_.height / 2) * LevelMain.§!5§;
                                             addr143:
                                             if(_loc6_ && param2)
                                             {
                                                while(!_loc6_)
                                                ...
                                                while(_loc7_)
                                                {
                                                   while(true)
                                                   {
                                                      _loc3_[1] = (_loc4_.x + _loc4_.width / 2) * LevelMain.§!5§;
                                                      §§goto(addr134);
                                                   }
                                                }
                                                addr134:
                                    ...
                                    while(true)
                                    {
                                       _loc3_[0] = _loc4_.width * LevelMain.§!5§ / 2;
                                       §§goto(addr163);
                                    }
                                 }
                              }
      ...
      public static function §^!Q§(param1:MovieClip) : Array
      {
         var _loc6_:Boolean = false;
         var _loc7_:Boolean = true;
         var _loc4_:* = 0;
         ...
         if(!_loc6_)
         {
            ...
            while(true)
            {
               ...
               if(!_loc6_)
               {
                  _loc2_[_loc4_].Set((_loc5_.getRect(param1).x + _loc5_.getRect(param1).width / 2) * LevelMain.§!5§,(_loc5_.getRect(param1).y + _loc5_.getRect(param1).height / 2) * LevelMain.§!5§);
                  if(!_loc7_)
                  {
                     continue;
                  }
