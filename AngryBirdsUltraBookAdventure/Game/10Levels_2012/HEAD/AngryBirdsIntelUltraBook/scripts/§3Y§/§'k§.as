                                                                                 ...
                                                                                 if(_loc11_)
                                                                                 {
                                                                                    ...
                                                                                    while(true)
                                                                                    {
                                                                                       if(_loc11_)
                                                                                       {
                                                                                          ...
                                                                                          addr154:
                                                                                          addr100:
                                                                                          param1.§%!!§(§8!;§.§`Q§,LevelParticleManager.§1!'§,§8!;§.§;Z§,§8!N§().GetPosition().x + _loc7_,§8!N§().GetPosition().y + _loc8_,1750 + Math.random() * 500,"",§"K§(§4!W§),_loc2_ * Math.cos(_loc6_),-_loc2_ * Math.sin(_loc6_),10,_loc2_ * 50);
                                                                                          while(true)
                                                                                          {
                                                                                             if(!(_loc10_ && param1))
                                                                                             {
