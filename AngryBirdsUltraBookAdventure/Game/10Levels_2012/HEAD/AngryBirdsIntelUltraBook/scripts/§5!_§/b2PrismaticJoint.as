package §5!_§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§>!C§.x * this.§1+§.x + (this.§<D§ + this.§>!C§.z) * this.§"x§.x),param1 * (this.§>!C§.x * this.§1+§.y + (this.§<D§ + this.§>!C§.z) * this.§"x§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§'!g§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§'!g§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§'!g§.col2.x = this.§'!g§.col1.y;
         this.§'!g§.col2.y = _loc16_ + _loc17_;
         this.§'!g§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§'!g§.col3.x = this.§'!g§.col1.z;
         this.§'!g§.col3.y = this.§'!g§.col2.z;
         this.§'!g§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§+`§)
         {
         ...
         if(param1.§3!=§)
         {
            ...
            this.§>!C§.y *= param1.§&l§;
            this.§<D§ *= param1.§&l§;
            _loc19_ = this.§>!C§.x * this.§1+§.x + (this.§<D§ + this.§>!C§.z) * this.§"x§.x;
            _loc20_ = this.§>!C§.x * this.§1+§.y + (this.§<D§ + this.§>!C§.z) * this.§"x§.y;
            _loc21_ = this.§>!C§.x * this.m_s1 + this.§>!C§.y + (this.§<D§ + this.§>!C§.z) * this.m_a1;
            _loc22_ = this.§>!C§.x * this.m_s2 + this.§>!C§.y + (this.§<D§ + this.§>!C§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§4z§ && this.§;,§ != §>!2§)
         {
            _loc14_ = this.§"x§.x * (_loc6_.x - _loc4_.x) + this.§"x§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§8!B§ * (this.§+V§ - _loc14_);
            _loc16_ = this.§<D§;
            _loc17_ = param1.§?!>§ * this.§^W§;
            this.§<D§ = b2Math.§"J§(this.§<D§ + _loc15_,-_loc17_,_loc17_);
            _loc15_ = this.§<D§ - _loc16_;
            _loc8_ = _loc15_ * this.§"x§.x;
            _loc9_ = _loc15_ * this.§"x§.y;
         ...
         if(this.§+`§ && this.§;,§ != §1P§)
         {
            _loc18_ = this.§"x§.x * (_loc6_.x - _loc4_.x) + this.§"x§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§>!C§.Copy();
            _loc20_ = this.§'!g§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§>!C§.§1"§(_loc20_);
            if(this.§;,§ == §1!>§)
            {
               this.§>!C§.z = b2Math.§,C§(this.§>!C§.z,0);
            }
            else if(this.§;,§ == §5'§)
            {
               this.§>!C§.z = b2Math.§3G§(this.§>!C§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§>!C§.z - _loc19_.z) * this.§'!g§.col3.x;
            _loc22_ = -_loc13_ - (this.§>!C§.z - _loc19_.z) * this.§'!g§.col3.y;
            _loc23_ = this.§'!g§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§>!C§.x = _loc23_.x;
            this.§>!C§.y = _loc23_.y;
            _loc20_.x = this.§>!C§.x - _loc19_.x;
            _loc20_.y = this.§>!C§.y - _loc19_.y;
            _loc20_.z = this.§>!C§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§1+§.x + _loc20_.z * this.§"x§.x;
            _loc9_ = _loc20_.x * this.§1+§.y + _loc20_.z * this.§"x§.y;
         ...
         {
            _loc24_ = this.§'!g§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§>!C§.x += _loc24_.x;
            this.§>!C§.y += _loc24_.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§+`§)
         {
            ...
            _loc35_ = this.§"x§.x * _loc26_ + this.§"x§.y * _loc27_;
            if(b2Math.§'!8§(this.§3!b§ - this.§ !S§) < 2 * b2Settings.b2_linearSlop)
            {
            ...
            {
               _loc19_ = b2Math.§"J§(_loc35_ - this.§ !S§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§ !S§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§3!b§)
            {
               _loc19_ = b2Math.§"J§(_loc35_ - this.§3!b§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§3!b§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§'!g§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§'!g§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§'!g§.col2.x = this.§'!g§.col1.y;
            this.§'!g§.col2.y = _loc14_ + _loc15_;
            this.§'!g§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§'!g§.col3.x = this.§'!g§.col1.z;
            this.§'!g§.col3.y = this.§'!g§.col2.z;
            this.§'!g§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§'!g§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = §+!b§;
            ...
            this.§'!g§.col1.Set(_loc36_,_loc37_,0);
            this.§'!g§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§'!g§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§1+§.x + _loc28_.z * this.§"x§.x;
         var _loc32_:Number = _loc28_.x * this.§1+§.y + _loc28_.z * this.§"x§.y;
