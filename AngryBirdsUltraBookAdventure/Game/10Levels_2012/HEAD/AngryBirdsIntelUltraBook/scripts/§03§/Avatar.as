package §03§
{
   ...
   public class Avatar extends Sprite
   {
               ...
               while(_loc6_)
               {
                  ...
                  while(true)
                  {
                     while(_loc6_)
                     {
                        ...
                        {
                           §§goto(addr54);
                        },var bgCls:Class = AssetCache.§,!k§("BackgroundContainer"),if(_loc6_ || this)
                        {
                        },this.§?0§ = new bgCls(),this.§?0§.stop(),addr185:,addr193:,if(_loc6_)
                        {
                           addr167:
                           if(!(_loc5_ && bgCls))
                           {
               ...
               do
               {
                  ...
                  while(true)
                  {
                     if(§§pop() != §§pop())
                     {
                        if(!_loc6_)
                        {
                           §§push(this.§>I§.framesLoaded - foundInFrame);
                           if(_loc6_)
                           {
                              break;
                           }
      ...
      public function §[7§() : Array
      {
         ...
         loop3:
         for(var _loc3_:int = 0,var _loc4_:* = this.§3j§; §§hasnext(_loc4_,_loc3_); if(true)
         {
            continue;
         },§§goto(addr98))
         {
            item = §§nextvalue(_loc3_,_loc4_);
            if(!_loc6_)
            {
            }
            loop4:
