   ...
   public class StateCutScene extends StateBase
   {
      ...
      private function §,!V§(e:Event) : void
      {
         ...
         while(true)
         {
            ...
            {
               loop2:
               for(§§push(this.§;!,§); §§pop(); if(_loc3_ && this)
               {
                  continue;
      ...
      protected function §6+§() : String
      {
         ...
         §§push(LevelManager.§7+§().§#L§(levelId + "-OUTRO"));
         if(!(_loc4_ && _loc3_))
         {
            §§push(§§pop());
         }
                           ...
                           while(true)
                           {
                              ...
                              while(true)
                              {
                                 ...
                                 while(_loc3_)
                                 {
                                    ...
                                    if(!(_loc4_ && cutScene))
                                    {
                                       §§push(LevelManager.§7+§().§#L§(levelId + "-INTRO"));
                                       continue loop8;
                                    }
                                    addr183:
                                    while(true)
                                                ...
                                                if(!_loc1_)
                                                {
                                                   ...
                                                   while(_loc2_)
                                                   {
                                                      while(true)
                                                      {
                                                         ...
                                                         while(true)
                                                         {
                                                            §§pop().§7B§.removeChild(this.§+!e§.sprite);
                                                            break loop12;
                                                            §§goto(addr104);
                                                         }
                                                      }
                           ...
                           while(true)
                           {
                              ...
                              while(true)
                              {
                                 if(!§§pop())
                                 {
                                    §§push(this.§+!e§);
                                    loop7:
                                    for(; !_loc2_; §§push(this.§+!e§),if(!_loc3_)
                                    {
                                       continue;
