package §`!H§
{
   ...
   public class b2Collision
   {
      ...
      private static var §,c§:Vector.<§>!b§> = §-6§();
      
      private static var s_clipPoints1:Vector.<§>!b§> = §-6§();
      
      private static var s_clipPoints2:Vector.<§>!b§> = §-6§();
      
      private static var §&!U§:Vector.<int> = new Vector.<int>(1);
      
      private static var §-<§:Vector.<int> = new Vector.<int>(1);
      
      private static var §50§:b2Vec2 = new b2Vec2();
      ...
      public static function §^8§(param1:Vector.<§>!b§>, param2:Vector.<§>!b§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§>!b§ = null;
         var _loc6_:int = 0;
      ...
      public static function §^I§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc6_:int = param1.§<!H§;
         var _loc7_:Vector.<b2Vec2> = param1.§!!I§;
         var _loc8_:Vector.<b2Vec2> = param1.§9!3§;
         var _loc9_:int = param4.§<!H§;
         var _loc10_:Vector.<b2Vec2> = param4.§!!I§;
         _loc11_ = param2.R;
      ...
      public static function §[!6§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§<!H§;
         var _loc7_:Vector.<b2Vec2> = param2.§9!3§;
         _loc9_ = param5.R;
         _loc8_ = param4.§1! §;
         ...
         var _loc17_:Number = §^I§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §^I§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : int(0);
         var _loc21_:Number = §^I§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            {
               _loc14_ = _loc22_ + 1 < _loc6_ ? int(_loc22_ + 1) : int(0);
            }
            _loc17_ = §^I§(param2,param3,_loc14_,param4,param5);
            if(_loc17_ <= _loc23_)
            {
               break;
            }
      ...
      public static function §!e§(param1:Vector.<§>!b§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§>!b§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§<!H§;
         var _loc8_:Vector.<b2Vec2> = param2.§9!3§;
         var _loc9_:int = param5.§<!H§;
         var _loc10_:Vector.<b2Vec2> = param5.§!!I§;
         var _loc11_:Vector.<b2Vec2> = param5.§9!3§;
         _loc12_ = param3.R;
         ...
         var _loc22_:int = _loc21_ + 1 < _loc9_ ? int(_loc21_ + 1) : int(0);
         _loc20_ = param1[0];
         ...
         _loc20_.id.features.§+c§ = param4;
         _loc20_.id.features.§8!O§ = _loc21_;
         _loc20_.id.features.§,Z§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.features.§+c§ = param4;
         _loc20_.id.features.§8!O§ = _loc22_;
         _loc20_.id.features.§,Z§ = 1;
      }
      
      private static function §-6§() : Vector.<§>!b§>
      {
         var _loc1_:Vector.<§>!b§> = new Vector.<§>!b§>(2);
         _loc1_[0] = new §>!b§();
         _loc1_[1] = new §>!b§();
         return _loc1_;
      }
      ...
      public static function §<!&§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         param1.§7I§ = 0;
         var _loc7_:Number = param2.§&!N§ + param4.§&!N§;
         var _loc8_:int = 0;
         §&!U§[0] = _loc8_;
         var _loc9_:Number = §[!6§(§&!U§,param2,param3,param4,param5);
         _loc8_ = §&!U§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §-<§[0] = _loc10_;
         var _loc11_:Number = §[!6§(§-<§,param4,param5,param2,param3);
         _loc10_ = §-<§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§@!D§ = b2Manifold.§0^§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§>!b§> = §,c§;
         §!e§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§<!H§;
         var _loc23_:Vector.<b2Vec2> = _loc12_.§!!I§;
         ...
         var _loc37_:Vector.<§>!b§> = s_clipPoints1;
         var _loc38_:Vector.<§>!b§> = s_clipPoints2;
         _loc39_ = §^8§(_loc37_,_loc21_,_loc30_,_loc35_);
         if(_loc39_ < 2)
         {
            return;
         }
         _loc39_ = §^8§(_loc38_,_loc37_,_loc29_,_loc36_);
         if(_loc39_ < 2)
         {
            return;
         }
         param1.§4!f§.SetV(_loc27_);
         ...
         while(_loc41_ < b2Settings.b2_maxManifoldPoints)
         {
            ...
            if(_loc42_ <= _loc7_)
            {
               ...
               _loc43_.m_id.features.§ !h§ = _loc17_;
               _loc40_++;
            }
            _loc41_++;
         }
      ...
      public static function §3B§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§&!N§ + param4.§&!N§;
         ...
         param1.§4!f§.§@l§();
         param1.§7I§ = 1;
         param1.§ 2§[0].m_localPoint.SetV(param4.§8!@§);
         param1.§ 2§[0].m_id.key = 0;
      }
      
      public static function §;!L§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§&!N§ + param4.§&!N§;
         var _loc21_:int = param2.§<!H§;
         var _loc22_:Vector.<b2Vec2> = param2.§!!I§;
         var _loc23_:Vector.<b2Vec2> = param2.§9!3§;
         var _loc24_:int = 0;
         ...
         var _loc26_:int = _loc25_ + 1 < _loc21_ ? int(_loc25_ + 1) : int(0);
         ...
         if(_loc19_ < Number.MIN_VALUE)
         {
            param1.§7I§ = 1;
            param1.§@!D§ = b2Manifold.§0^§;
            param1.§4!f§.SetV(_loc23_[_loc18_]);
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§7I§ = 1;
            param1.§@!D§ = b2Manifold.§0^§;
            param1.§4!f§.x = _loc15_ - _loc27_.x;
            param1.§4!f§.y = _loc16_ - _loc27_.y;
            param1.§4!f§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§7I§ = 1;
            param1.§@!D§ = b2Manifold.§0^§;
            param1.§4!f§.x = _loc15_ - _loc28_.x;
            param1.§4!f§.y = _loc16_ - _loc28_.y;
            param1.§4!f§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§ 2§[0].m_localPoint.SetV(param4.§8!@§);
            param1.§ 2§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§7I§ = 1;
            param1.§@!D§ = b2Manifold.§0^§;
            param1.§4!f§.x = _loc23_[_loc25_].x;
            param1.§4!f§.y = _loc23_[_loc25_].y;
            param1.§4!f§.Normalize();
      ...
      public static function §>!N§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§]G§;
         var _loc4_:b2Vec2 = param1.§[h§;
