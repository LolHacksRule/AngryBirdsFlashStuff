package §`!H§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §3!a§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§@!D§ = §;!c§;
            _loc7_ = this.§&!C§.§2!6§(param1.indexA[0]);
            _loc10_ = this.§ !i§.§2!6§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§"x§.x = _loc15_ - _loc13_;
            this.§"x§.y = _loc16_ - _loc14_;
            this.§"x§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§@!D§ = §0^§;
            _loc8_ = this.§&!C§.§2!6§(param1.indexA[0]);
            _loc9_ = this.§&!C§.§2!6§(param1.indexA[1]);
            _loc10_ = this.§ !i§.§2!6§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§"x§ = b2Math.§7!&§(b2Math.§0l§(_loc9_,_loc8_),1);
            this.§"x§.Normalize();
            _loc20_ = this.§"x§;
            _loc19_ = param3.R;
         ...
         {
            this.§@!D§ = §'!h§;
            _loc11_ = this.§ !i§.§2!6§(param1.indexB[0]);
            _loc12_ = this.§ !i§.§2!6§(param1.indexB[1]);
            _loc7_ = this.§&!C§.§2!6§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§"x§ = b2Math.§7!&§(b2Math.§0l§(_loc12_,_loc11_),1);
            this.§"x§.Normalize();
            _loc20_ = this.§"x§;
            _loc19_ = param5.R;
            _loc17_ = _loc19_.col1.x * _loc20_.x + _loc19_.col2.x * _loc20_.y;
         ...
         else
         {
            ...
            _loc11_ = this.§ !i§.§2!6§(param1.indexB[0]);
            _loc12_ = this.§ !i§.§2!6§(param1.indexB[1]);
            _loc23_ = b2Math.§5F§(param3,_loc7_);
            _loc24_ = b2Math.§>8§(param3.R,b2Math.§0l§(_loc9_,_loc8_));
            _loc25_ = b2Math.§5F§(param5,_loc10_);
            _loc26_ = b2Math.§>8§(param5.R,b2Math.§0l§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§0l§(_loc26_,_loc24_);
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §;!c§:
               _loc3_ = b2Math.§`!e§(param1.R,this.§"x§);
               _loc4_ = b2Math.§`!e§(param2.R,this.§"x§.§7!F§());
               _loc5_ = this.§&!C§.§1<§(_loc3_);
               _loc6_ = this.§ !i§.§1<§(_loc4_);
               _loc7_ = b2Math.§5F§(param1,_loc5_);
               _loc8_ = b2Math.§5F§(param2,_loc6_);
               return Number((_loc8_.x - _loc7_.x) * this.§"x§.x + (_loc8_.y - _loc7_.y) * this.§"x§.y);
            case §0^§:
               _loc10_ = b2Math.§>8§(param1.R,this.§"x§);
               _loc7_ = b2Math.§5F§(param1,this.m_localPoint);
               _loc4_ = b2Math.§`!e§(param2.R,_loc10_.§7!F§());
               _loc6_ = this.§ !i§.§1<§(_loc4_);
               _loc8_ = b2Math.§5F§(param2,_loc6_);
               return Number((_loc8_.x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §'!h§:
               _loc10_ = b2Math.§>8§(param2.R,this.§"x§);
               _loc8_ = b2Math.§5F§(param2,this.m_localPoint);
               _loc3_ = b2Math.§`!e§(param1.R,_loc10_.§7!F§());
               _loc5_ = this.§&!C§.§1<§(_loc3_);
               _loc7_ = b2Math.§5F§(param1,_loc5_);
