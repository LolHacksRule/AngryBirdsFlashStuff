package com.angrybirds.friendsbar
{
   ...
   public class FriendsBar extends Sprite
   {
                                             ...
                                             if(!(_loc3_ && this))
                                             {
                                                ...
                                                while(!_loc3_)
                                                {
                                                      ...
                                                      if(!_loc3_)
                                                      {
                                                         ...
                                                         while(true)
                                                         {
                                                            ...
                                                            if(_loc2_)
                                                            {
                                                               ...
                                                               while(true)
                                                               {
                                                                  §§pop().§[!;§.btnInvite.addEventListener(MouseEvent.CLICK,this.§4!L§);
                                                                  addr649:
                                                                  loop21:
                                                                  while(true)
                                                                  {
                                                                     ...
                                                                     while(true)
                                                                     {
                                                                        ...
                                                                        while(_loc2_)
                                                                        {
                                                                           §§pop().§[!;§.btnFullscreen.addEventListener(MouseEvent.CLICK,this.§-`§);
                                                                           while(true)
                                                                           {
                                                                              while(_loc2_ || _loc2_)
                                                                              {
                                                                                 if(_loc2_)
                                                                                 {
                                                                                    ...
                                                                                    while(true)
                                                                                    {
                                                                                       §§pop().§[!;§.btnSound.addEventListener(MouseEvent.CLICK,this.§[t§);
                                                                                       addr594:
                                                                                       while(true)
                                                                                       {
                                                                                          if(_loc2_)
                                                                                       ...
                                                                                       loop30:
                                                                                       for(; !(_loc3_ && _loc3_); §§push(this.§#Z§),if(_loc3_ && _loc3_)
                                                                                       {
                                                                                          continue;
                                                                                       },if(_loc2_)
                                                                                       {
                                                                                          addr520:
                                                                                          §§pop().§`!G§.addEventListener(MouseEvent.CLICK,this.§54§);
                                                                                          break loop6;
                                                                                       },§§goto(addr567))
                                                                                       {
                                                                                          §§pop().§[!;§.btnTutorial.addEventListener(MouseEvent.CLICK,this.§<!P§);
                                                                                          while(true)
                                                                                          {
                                                                                             if(!_loc3_)
                                                                                             {
                                                                                             ...
                                                                                             else
                                                                                             {
                                                                                                ...
                                                                                                while(true)
                                                                                                {
                                                                                                   ...
                                                                                                   while(_loc2_)
                                                                                                   {
                                                                                                      §§pop().§[!;§.btnInfo.addEventListener(MouseEvent.CLICK,this.§0!G§);
                                                                                                      while(true)
                                                                                                      {
                                                                                                      }
                                                                                                   }
                                                   ...
                                                   while(true)
                                                   {
                                                      ...
                                                      while(true)
                                                      {
                                                         §§pop().addEventListener(CachedDataEvent.DATA_LOADED,this.§=!>§);
                                                         addr473:
                                                         while(true)
                                                         {
                                                            addr452:
                                       ...
                                       if(!_loc3_)
                                       {
                                          if(false)
                                          {
                                             while(true)
                                             {
                                                ...
                                                if(_loc2_ || _loc2_)
                                                {
                                                   §§pop().§3v§.addEventListener(MouseEvent.CLICK,this.§&N§);
                                                   if(!(_loc3_ && this))
                                                   {
                                                      addr59:
                                                      if(_loc2_ || _loc2_)
                                          ...
                                          if(!_loc3_)
                                          {
                                             §§pop().§,<§.visible = this.§#Z§.§3v§.visible = false;
                                             if(_loc2_)
                                             {
                                                break;
                                             }
                  ...
                  if(_loc5_)
                  {
                     ...
                     if(§§pop())
                     {
                        ...
                        while(true)
                        {
                           ...
                           while(true)
                           {
                              §§pop().§9f§.height = targetStageHeight - this.§#Z§.§<!4§.height - this.§#Z§.§9!T§.height + 5;
                              while(true)
                              {
                                 loop7:
                                 while(true)
                                 {
                                    ...
                                    while(_loc5_)
                                    {
                                       §§pop().§9!T§.y = this.§#Z§.§9f§.y + this.§#Z§.§9f§.height;
                                       while(!_loc4_)
                                       {
            ...
            while(true)
            {
               ...
               while(true)
               {
                  if(!this.§4,§)
                  {
                     ...
                     {
                        loop3:
                        for(§§push(this.§1W§); §§pop().data == this.§ !;§.§1!_§().data; )
                        {
                           §§push(this.§1W§);
                           if(!_loc3_)
                           {
            ...
            while(true)
            {
               ...
               while(true)
               {
                  while(true)
                  {
                     ...
                     §§push(int(Math.floor(this.§1W§.§&4§ / 2)));
                     loop14:
      ...
      private function §;&§() : void
      {
         ...
         §§push(this.§1W§.offset == this.§1W§.data.length - this.§1W§.§&4§);
         if(!_loc3_)
         {
            §§push(!§§pop());
            if(_loc4_)
                              ...
                              while(true)
                              {
                                 ...
                                 if(_loc14_ || score)
                                 {
                                    ...
                                    while(true)
                                    {
                                       ...
                                       §§push(this.§4,§.§6,§(score,stars,eagle,out_usersBeaten));
                                       if(_loc14_ || score)
                                       {
                                          §§push(int(§§pop()));
                                       }
         ...
         if(_loc6_ || count)
         {
            while(true)
            {
               ...
               },§§goto(addr176))
               {
                  ...
                  {
                     addr225:
                     counterBackground = §§pop().§[!;§.mcItemCountBg;
                     if(_loc6_ || text)
                     {
                        while(true)
                        {
                                    ...
                                    if(_loc6_ || count)
                                    {
                                       ...
                                       while(true)
                                       {
                                          ...
                                          while(true)
                                          {
                                             ...
                                             if(_loc6_)
                                             {
                                                §§pop().§[!;§.txtInboxItemCount.text.text = text;
                                                continue loop16;
                                             }
                                             §§goto(addr225);
                                          }
