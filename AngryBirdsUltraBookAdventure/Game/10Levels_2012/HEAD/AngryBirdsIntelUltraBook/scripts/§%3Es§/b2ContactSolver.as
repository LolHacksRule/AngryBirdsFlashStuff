   ...
   public class b2ContactSolver
   {
      ...
      public function §3!a§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            _loc17_ = _loc5_.§%8§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§]!G§(),_loc10_.§]!G§());
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§#!N§(),_loc10_.§#!N§());
            _loc20_ = _loc15_.§69§.x;
            _loc21_ = _loc15_.§69§.y;
            _loc22_ = _loc16_.§69§.x;
            _loc23_ = _loc16_.§69§.y;
            _loc24_ = _loc15_.m_angularVelocity;
            _loc25_ = _loc16_.m_angularVelocity;
            b2Settings.b2Assert(_loc17_.§7I§ > 0);
            §=>§.§3!a§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §=>§.§@^§.x;
            _loc27_ = §=>§.§@^§.y;
            _loc28_ = this.§^!Y§[_loc6_];
            _loc28_.§7!K§ = _loc15_;
            _loc28_.§'P§ = _loc16_;
            _loc28_.§-%§ = _loc17_;
            ...
            _loc28_.§!!3§.x = _loc17_.§4!f§.x;
            _loc28_.§!!3§.y = _loc17_.§4!f§.y;
            ...
            while(_loc29_ < _loc28_.§[![§)
            {
               ...
               _loc31_ = _loc28_.§&!3§[_loc29_];
               _loc31_.normalImpulse = _loc30_.§8!L§;
               _loc31_.tangentImpulse = _loc30_.§-!V§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§[#§.x = §=>§.§ 2§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§[#§.y = §=>§.§ 2§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§18§.x = §=>§.§ 2§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§18§.y = §=>§.§ 2§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§4s§ + _loc16_.§4s§ + _loc15_.§[!F§ * _loc36_ + _loc16_.§[!F§ * _loc37_;
               _loc31_.§,!§ = 1 / _loc38_;
               _loc39_ = _loc15_.§;!3§ * _loc15_.§4s§ + _loc16_.§;!3§ * _loc16_.§4s§;
               _loc39_ += _loc15_.§;!3§ * _loc15_.§[!F§ * _loc36_ + _loc16_.§;!3§ * _loc16_.§[!F§ * _loc37_;
               _loc31_.§&"§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§4s§ + _loc16_.§4s§ + _loc15_.§[!F§ * _loc42_ + _loc16_.§[!F§ * _loc43_;
               _loc31_.§1`§ = 1 / _loc44_;
               _loc31_.§<F§ = 0;
            ...
            if(_loc28_.§[![§ == 2)
            {
               ...
               _loc55_ = _loc48_.§18§.x * _loc27_ - _loc48_.§18§.y * _loc26_;
               _loc56_ = _loc49_.§[#§.x * _loc27_ - _loc49_.§[#§.y * _loc26_;
               _loc57_ = _loc49_.§18§.x * _loc27_ - _loc49_.§18§.y * _loc26_;
               ...
               {
                  _loc28_.§^7§.col1.Set(_loc58_,_loc60_);
                  _loc28_.§^7§.col2.Set(_loc60_,_loc59_);
                  _loc28_.§^7§.§6!<§(_loc28_.§,!§);
               }
               else
               {
         ...
         while(_loc5_ < this.§ !C§)
         {
            ...
            if(param1.§3!=§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc20_.normalImpulse *= param1.§&l§;
                  _loc20_.tangentImpulse *= param1.§&l§;
                  ...
                  _loc7_.§69§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§18§.x * _loc22_ - _loc20_.§18§.y * _loc21_);
                  _loc8_.§69§.x += _loc11_ * _loc21_;
                  _loc8_.§69§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§ !C§)
         {
            _loc25_ = this.§^!Y§[_loc24_];
            _loc26_ = _loc25_.§7!K§;
            _loc27_ = _loc25_.§'P§;
            ...
            while(_loc1_ < _loc25_.§[![§)
            {
               ...
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§18§.y - _loc30_.x + _loc28_ * _loc2_.§[#§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§18§.x - _loc30_.y - _loc28_ * _loc2_.§[#§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§1`§ * -_loc10_;
               _loc12_ = _loc40_ * _loc2_.normalImpulse;
               _loc13_ = b2Math.§"J§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_);
               ...
               _loc29_ += _loc35_ * (_loc2_.§18§.x * _loc15_ - _loc2_.§18§.y * _loc14_);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§18§.y - _loc30_.x + _loc28_ * _loc43_.§[#§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§18§.x - _loc30_.y - _loc28_ * _loc43_.§[#§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§18§.y - _loc30_.x + _loc28_ * _loc44_.§[#§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§18§.x - _loc30_.y - _loc28_ * _loc44_.§[#§.x;
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc29_ += _loc35_ * (_loc43_.§18§.x * _loc19_ - _loc43_.§18§.y * _loc18_ + _loc44_.§18§.x * _loc21_ - _loc44_.§18§.y * _loc20_);
               ...
               else
               {
                  ...
                  _loc57_ = 0;
                  _loc51_ = 0;
                  _loc52_ = _loc25_.§^7§.col1.y * _loc56_ + _loc54_;
                  ...
                  else
                  {
                     ...
                     _loc51_ = _loc25_.§^7§.col2.x * _loc57_ + _loc53_;
                     _loc52_ = 0;
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§ !C§)
         {
            ...
            _loc5_ = _loc4_.§7!K§;
            _loc6_ = _loc4_.§'P§;
            _loc7_ = _loc5_.§;!3§ * _loc5_.§4s§;
            _loc8_ = _loc5_.§;!3§ * _loc5_.§[!F§;
            _loc9_ = _loc6_.§;!3§ * _loc6_.§4s§;
            _loc10_ = _loc6_.§;!3§ * _loc6_.§[!F§;
            §?W§.§3!a§(_loc4_);
            _loc11_ = §?W§.§@^§;
            _loc12_ = 0;
