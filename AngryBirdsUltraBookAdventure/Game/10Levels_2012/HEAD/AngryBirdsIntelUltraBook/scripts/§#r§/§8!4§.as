                                                ...
                                                while(true)
                                                {
                                                   if(_loc2_)
                                                   {
                                                      ...
                                                      while(true)
                                                      {
                                                                                                      ...
                                                                                                      while(true)
                                                                                                      {
                                                                                                         ...
                                                                                                         while(_loc2_ || this)
                                                                                                         {
                                                                                                            ...
                                                                                                            while(true)
                                                                                                            {
                                                                                                               ...
                                                                                                               while(true)
                                                                                                               {
                                                                                                                  §§pop().§>!,§.text = §@E§(this.§2>§.levelScore) || "0";
                                                                                                                  loop35:
                                                                                                                  while(_loc2_ || this)
                                                                                                                  {
                                                                                                                     if(!_loc1_)
                                                                                                                        ...
                                                                                                                        if(!_loc1_)
                                                                                                                        {
                                                                                                                           if(!_loc1_)
                                                                                                                           {
                                                                                                                              if(!_loc1_)
                                                                                                                              {
                                                                                                                                 if(!_loc1_)
                                                                                                                                 {
                                                                                                                                    §§pop().mcStar3.visible = this.§2>§.stars >= 3;
                                                                                                                                    while(!(_loc1_ && this))
                                                                                                                                    {
                                                                                                                                       if(!(_loc2_ || _loc1_))
                                                                                                                                       {
                                                                                                                                                ...
                                                                                                                                                if(!(_loc1_ && _loc1_))
                                                                                                                                                {
                                                                                                                                                   ...
                                                                                                                                                   while(true)
                                                                                                                                                   {
                                                                                                                                                      if(_loc2_)
                                                                                                                                                      {
                                                                                                                                                         ...
                                                                                                                                                         §§pop().mcStar2.visible = this.§2>§.stars >= 2;
                                                                                                                                                         loop41:
                                                                                                                                                         while(_loc2_ || _loc1_)
                                                                                                                                                         {
                                                                                                                                                            if(_loc2_)
                                                                                                                                                      ...
                                                                                                                                                      else
                                                                                                                                                      {
                                                                                                                                                         while(!(_loc1_ && _loc1_))
                                                                                                                                                         {
                                                                                                                                                            §§pop().mcStar1.visible = this.§2>§.stars >= 1;
                                                                                                                                                            §§goto(addr171);
                                                                                                                                                         }
                                                                                                                                                         §§goto(addr272);
                                                                                                                                                         addr157:
                                                         ...
                                                         §§pop().§;!J§.text = this.§2>§.rank.toString() || "";
                                                         §§goto(addr246);
                                                      }
                                                   }
                                                   else
