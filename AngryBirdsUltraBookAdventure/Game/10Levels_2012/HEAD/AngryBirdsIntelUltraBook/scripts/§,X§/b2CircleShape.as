package §,X§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         return _loc4_ * _loc4_ + _loc5_ * _loc5_ <= §&!N§ * §&!N§;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc9_:Number = _loc7_ * _loc7_ + _loc8_ * _loc8_ - §&!N§ * §&!N§;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§]G§.Set(_loc4_ - §&!N§,_loc5_ - §&!N§);
         param1.§[h§.Set(_loc4_ + §&!N§,_loc5_ + §&!N§);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§2!3§ = param2 * b2Settings.b2_pi * §&!N§ * §&!N§;
         param1.§+!a§.SetV(this.§8!@§);
         param1.§'!i§ = param1.§2!3§ * (0.5 * §&!N§ * §&!N§ + (this.§8!@§.x * this.§8!@§.x + this.§8!@§.y * this.§8!@§.y));
      }
      
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         var _loc9_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§5F§(param3,this.§8!@§);
         var _loc6_:Number = -(b2Math.§6!F§(param1,_loc5_) - param2);
         if(_loc6_ < -§&!N§ + Number.MIN_VALUE)
         {
            return 0;
         }
         if(_loc6_ > §&!N§)
         ...
         var _loc7_:Number = §&!N§ * §&!N§;
         var _loc8_:Number = _loc6_ * _loc6_;
         _loc9_ = _loc7_ * (Math.asin(_loc6_ / §&!N§) + Math.PI / 2) + _loc6_ * Math.sqrt(_loc7_ - _loc8_);
