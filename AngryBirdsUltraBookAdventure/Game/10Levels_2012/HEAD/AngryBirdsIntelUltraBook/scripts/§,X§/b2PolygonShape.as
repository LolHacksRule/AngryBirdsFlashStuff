package §,X§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      b2internal var §9!3§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         this.§9!3§ = new Vector.<b2Vec2>();
         §&!N§ = b2Settings.b2_polygonRadius;
         this.§1! §.§@l§();
      }
      
      public static function §09§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function §=l§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§3!4§(param1,param2);
         return _loc3_;
      }
      
      public static function §8!M§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape = new b2PolygonShape();
         _loc5_.§0!A§(param1,param2,param3,param4);
         return _loc5_;
      }
      ...
      public static function §=Z§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§1"§(new b2Vec2(0,0));
            _loc3_.§1"§(_loc9_);
            _loc3_.§1"§(_loc10_);
            _loc3_.§49§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §<!+§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if(_loc18_ < 0.95 * _loc6_)
            {
               ...
               _loc25_ = param1.R;
               param1.§+!a§.x = _loc7_.x + (_loc25_.col1.x * _loc23_ + _loc25_.col2.x * _loc24_);
               param1.§+!a§.y = _loc7_.y + (_loc25_.col1.y * _loc23_ + _loc25_.col2.y * _loc24_);
               param1.§ !P§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§ !P§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            while(_loc3_ < this.§<!H§)
            {
               ...
               this.§9!3§[_loc3_].SetV(_loc2_.§9!3§[_loc3_]);
               _loc3_++;
            }
         }
      }
      ...
      public function §=!?§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§<!H§)
         {
            this.§!!I§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§<!H§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§<!H§ ? int(_loc3_ + 1) : int(0);
            _loc6_ = b2Math.§0l§(this.§!!I§[_loc5_],this.§!!I§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§ 8§() > Number.MIN_VALUE);
            this.§9!3§[_loc3_].SetV(b2Math.§7!&§(_loc6_,1));
            this.§9!3§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§1! § = §=Z§(this.§!!I§,this.§<!H§);
      }
      
      public function §3!4§(param1:Number, param2:Number) : void
      {
         this.§<!H§ = 4;
         this.§,5§(4);
         this.§!!I§[0].Set(-param1,-param2);
         this.§!!I§[1].Set(param1,-param2);
         this.§!!I§[2].Set(param1,param2);
         this.§!!I§[3].Set(-param1,param2);
         this.§9!3§[0].Set(0,-1);
         this.§9!3§[1].Set(1,0);
         this.§9!3§[2].Set(0,1);
         this.§9!3§[3].Set(-1,0);
      ...
      public function §0!A§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§<!H§ = 4;
         this.§,5§(4);
         this.§!!I§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§<!H§)
         {
            this.§!!I§[_loc6_] = b2Math.§5F§(_loc5_,this.§!!I§[_loc6_]);
            this.§9!3§[_loc6_] = b2Math.§>8§(_loc5_.R,this.§9!3§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §>!D§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§<!H§ = 2;
         this.§,5§(2);
         this.§!!I§[0].SetV(param1);
         this.§!!I§[1].SetV(param2);
         this.§1! §.x = 0.5 * (param1.x + param2.x);
         this.§1! §.y = 0.5 * (param1.y + param2.y);
         this.§9!3§[0] = b2Math.§7!&§(b2Math.§0l§(param2,param1),1);
         this.§9!3§[0].Normalize();
         this.§9!3§[1].x = -this.§9!3§[0].x;
         this.§9!3§[1].y = -this.§9!3§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§<!H§)
         {
            _loc9_ = this.§!!I§[_loc17_];
            _loc6_ = _loc9_.x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc9_ = this.§9!3§[_loc17_];
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§<!H§ == 2)
         {
            param1.§+!a§.x = 0.5 * (this.§!!I§[0].x + this.§!!I§[1].x);
            param1.§+!a§.y = 0.5 * (this.§!!I§[0].y + this.§!!I§[1].y);
            param1.§2!3§ = 0;
            param1.§'!i§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§<!H§)
         {
            _loc11_ = this.§!!I§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§<!H§ ? this.§!!I§[int(_loc10_ + 1)] : this.§!!I§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§2!3§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.§+!a§.Set(_loc3_,_loc4_);
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§`!e§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§6!F§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§6!F§(_loc5_,this.§!!I§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§5F§(param3,_loc24_.§+!a§));
                  return _loc24_.§2!3§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§<!H§;
         var _loc14_:int = (_loc10_ + 1) % this.§<!H§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§!!I§[_loc9_].x * (1 - _loc15_) + this.§!!I§[_loc13_].x * _loc15_,this.§!!I§[_loc9_].y * (1 - _loc15_) + this.§!!I§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§!!I§[_loc10_].x * (1 - _loc16_) + this.§!!I§[_loc14_].x * _loc16_,this.§!!I§[_loc10_].y * (1 - _loc16_) + this.§!!I§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§!!I§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            _loc12_ = (_loc12_ + 1) % this.§<!H§;
            if(_loc12_ == _loc14_)
            {
               _loc22_ = _loc18_;
            }
         ...
         _loc20_.§49§(1 / _loc19_);
         param4.SetV(b2Math.§5F§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §6!_§() : Vector.<b2Vec2>
      {
         return this.§!!I§;
      }
      
      public function §"!_§() : Vector.<b2Vec2>
      {
         return this.§9!3§;
      }
      
      public function §+H§(param1:b2Vec2) : int
      {
