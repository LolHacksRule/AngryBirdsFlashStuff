package §,X§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               while(true)
               {
                  §§push(§§pop() * (this.§!!I§[0].x + this.§!!I§[1].x));
                  loop142:
                  while(true)
                  {
                     §§pop().x = §§pop();
                     while(true)
                     {
                        ...
                        if(!(_loc28_ && param1))
                        {
                           ...
                           §§push(§§pop() * (this.§!!I§[0].y + this.§!!I§[1].y));
                        }
                        §§pop().y = §§pop();
                        while(_loc27_ || this)
                        {
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         if(_loc27_)
         {
            §§push(§§pop() - b2Math.§6!F§(param1,param3.position));
            if(_loc27_)
            {
               addr48:
               §§push(Number(§§pop()));
                                                                  ...
                                                                  if(_loc11_)
                                                                  {
                                                                     ...
                                                                     if(!_loc28_)
                                                                     {
                                                                        ...
                                                                        if(!(_loc28_ && this))
                                                                        {
                                                                           ...
                                                                           §§push(this.§!!I§[_loc9_].x * (1 - _loc15_));
                                                                           if(_loc27_ || param3)
                                                                           {
                                                                              §§push(this.§!!I§[_loc13_].x * _loc15_);
                                                                              if(!(_loc28_ && param2))
                                                                              {
                                                                                 addr721:
                                                                                 §§push(§§pop() + §§pop());
                                                                                 §§push(this.§!!I§[_loc9_].y * (1 - _loc15_));
                                                                                 if(_loc27_ || param2)
                                                                                 {
                                                                                    §§push(§§pop() + this.§!!I§[_loc13_].y * _loc15_);
                                                                                 }
                                                                              }
                                                                              var _loc17_:b2Vec2 = new §§pop().b2Vec2(§§pop(),§§pop());
                                                                              §§push(§§findproperty(b2Vec2));
                                                                              §§push(this.§!!I§[_loc10_].x * (1 - _loc16_));
                                                                              if(!(_loc28_ && this))
                                                                              {
                                                                                 §§push(this.§!!I§[_loc14_].x * _loc16_);
                                                                                 if(_loc27_ || param2)
                                                                                 {
                                                                                    addr780:
                                                                                    §§push(§§pop() + §§pop());
                                                                                    §§push(this.§!!I§[_loc10_].y * (1 - _loc16_));
                                                                                    if(_loc27_)
                                                                                    {
                                                                                       §§push(§§pop() + this.§!!I§[_loc14_].y * _loc16_);
                                                                                    }
                                                                                 }
