package §0!=§
{
   ...
   public class SHA1
   {
      ...
      public static function §-!<§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §7l§(_loc2_);
         return §3T§.§>&§(_loc3_.readInt(),true) + §3T§.§>&§(_loc3_.readInt(),true) + §3T§.§>&§(_loc3_.readInt(),true) + §3T§.§>&§(_loc3_.readInt(),true) + §3T§.§>&§(_loc3_.readInt(),true);
      }
      
      public static function §<!N§(param1:ByteArray) : String
      {
         var _loc2_:Array = SHA1.§1U§(param1);
         var _loc3_:ByteArray = §7l§(_loc2_);
         return §3T§.§>&§(_loc3_.readInt(),true) + §3T§.§>&§(_loc3_.readInt(),true) + §3T§.§>&§(_loc3_.readInt(),true) + §3T§.§>&§(_loc3_.readInt(),true) + §3T§.§>&§(_loc3_.readInt(),true);
      }
      ...
      private static function §7l§(param1:Array) : ByteArray
      {
         var _loc9_:int = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         ...
         _loc11_.position = 0;
         §[b§ = new ByteArray();
         §[b§.writeBytes(_loc11_);
         §[b§.position = 0;
         return _loc11_;
      }
      
      private static function §1U§(param1:ByteArray) : Array
      {
