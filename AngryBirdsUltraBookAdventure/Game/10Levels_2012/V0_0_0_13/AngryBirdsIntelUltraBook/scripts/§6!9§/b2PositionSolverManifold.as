package §6!9§
{
   ...
   class b2PositionSolverManifold
   {
      ...
      private static var §7!f§:b2Vec2 = new b2Vec2();
      ...
      public function §;o§(param1:b2ContactConstraint) : void
      {
         ...
         switch(param1.type)
         {
            case b2Manifold.§8!G§:
               ...
               _loc9_ = param1.§^!G§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc10_ = param1.§^!G§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               _loc5_ = param1.§-z§.m_xf.R;
               _loc6_ = param1.§5o§[0].localPoint;
               _loc11_ = param1.§-z§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc12_ = param1.§-z§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               ...
               if(_loc15_ > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§9O§.x = _loc13_ / _loc16_;
                  this.§9O§.y = _loc14_ / _loc16_;
               }
               else
               {
                  this.§9O§.x = 1;
            ...
            case b2Manifold.§,!0§:
               _loc5_ = param1.§^!G§.m_xf.R;
               _loc6_ = param1.§>v§;
               this.§9O§.x = _loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y;
               this.§9O§.y = _loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y;
               _loc5_ = param1.§^!G§.m_xf.R;
               _loc6_ = param1.localPoint;
               _loc7_ = param1.§^!G§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc8_ = param1.§^!G§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               _loc5_ = param1.§-z§.m_xf.R;
               _loc2_ = 0;
            ...
            case b2Manifold.§#,§:
               ...
               {
                  _loc6_ = param1.§5o§[_loc2_].localPoint;
                  _loc3_ = param1.§^!G§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
                  _loc4_ = param1.§^!G§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
                  this.§?!4§[_loc2_] = (_loc3_ - _loc7_) * this.§9O§.x + (_loc4_ - _loc8_) * this.§9O§.y - param1.radius;
