package §'s§
{
   ...
   class b2Simplex
   {
                              ...
                              if(_loc4_)
                              {
                                 ...
                                 switch(§§pop())
                                 {
                                    ...
                                    case 1:
                                       ...
                                       if(!(_loc5_ && _loc1_))
                                       {
                                          §§push(b2Math.§!!I§(_loc1_,this.m_v1.§`c§.§[3§()));
                                          break;
                                       }
                                       continue;
                                 }
                                             ...
                                             default:
                                                while(true)
                                                {
                                                   ...
                                                   else
                                                   {
                                                      ...
                                                      {
                                                         addr97:
                                                         §§push(b2Math.§;v§(this.m_v1.§`c§,this.m_v2.§`c§).§ >§());
                                                         break loop1;
                                                      }
                                                      if(!(_loc2_ && _loc1_))
                                                      {
      ...
      public function Solve3() : void
      {
         ...
         §§push(b2Math.§2&§(_loc1_,_loc4_));
         if(!_loc27_)
         {
            §§push(Number(§§pop()));
         }
         var _loc5_:* = §§pop();
         §§push(b2Math.§2&§(_loc2_,_loc4_));
         if(_loc28_ || this)
         {
            §§push(Number(§§pop()));
         }
         ...
         if(_loc28_)
         {
            ...
            §§push(b2Math.§2&§(_loc1_,_loc9_));
            if(!(_loc27_ && _loc3_))
            {
               §§push(Number(§§pop()));
            }
            var _loc10_:* = §§pop();
            §§push(b2Math.§2&§(_loc3_,_loc9_));
            if(!_loc27_)
            {
               §§push(Number(§§pop()));
            }
            ...
            if(!_loc27_)
            {
               ...
               §§push(b2Math.§2&§(_loc2_,_loc14_));
               if(_loc28_)
               {
                  §§push(Number(§§pop()));
               }
               var _loc15_:* = §§pop();
               §§push(b2Math.§2&§(_loc3_,_loc14_));
               if(!(_loc27_ && _loc3_))
               {
                  §§push(Number(§§pop()));
               }
