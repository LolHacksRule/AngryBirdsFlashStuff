package §4H§
{
   ...
   public class StateManager
   {
         ...
         while(true)
         {
            ...
            if(_loc4_)
            {
               if(!(_loc3_ && _loc2_))
               {
                  ...
                  else if((this.§`!h§[_loc2_] as StateBase).mName == param1)
                  {
                     if(_loc4_ || param1)
                     {
                        break;
      ...
      public function get §0-§() : Boolean
      {
         var _loc1_:Boolean = true;
         var _loc2_:Boolean = false;
         §§push(this.mNextState == StateBase.§&r§);
         if(!_loc2_)
         {
            return !§§pop();
         }
                                                   ...
                                                   if(_loc7_)
                                                   {
                                                      if(_loc7_)
                                                      {
                                                         while(true)
                                                         {
                                                            §§push(this.§-v§);
                                                            loop17:
                                                            for(; _loc7_; §§push(this.§-v§),if(_loc6_ && _loc3_)
                                                            {
                                                               continue;
                                                            },§§goto(addr79))
                                                            {
