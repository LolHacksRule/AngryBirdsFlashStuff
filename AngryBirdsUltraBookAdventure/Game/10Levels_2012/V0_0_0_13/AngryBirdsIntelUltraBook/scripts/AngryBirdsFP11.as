   ...
   public class AngryBirdsFP11 extends BasicGame
   {
      ...
      public static function playThemeMusic() : void
      {
         ...
         if(_loc2_)
         {
            ...
            while(true)
            {
               §§push(SoundEngine.§!_§("Channel_Theme"));
               addr139:
               loop1:
               while(true)
               {
         ...
         if(!_loc2_)
         {
            ...
            while(true)
            {
               ...
               while(true)
               {
                  ...
                  §§pop().init(Server.§&7§(),stage.loaderInfo.parameters.assetsUrl || "",stage.loaderInfo.parameters.buildNumber || "",this.§8!V§,this.§@h§);
                  loop2:
                  while(true)
                  {
                     while(true)
               ...
               while(true)
               {
                  while(true)
                  {
                     ...
                     while(true)
                     {
                        ...
                        {
                           loop5:
                           for(§§push(this.§>O§); !§§pop(); if(!(_loc7_ || e))
                           {
                              continue;
                                    ...
                                    while(true)
                                    {
                                       ...
                                       if(!(_loc6_ && this))
                                       {
                                          ...
                                          if(widthScale < heightScale)
                                          {
                                             ...
                                             addr452:
                                             addr458:
                                             §§push(Number(stage.stageWidth * (§1[§ / §8!6§)));
                                             if(!(_loc6_ && this))
                                             {
                                                height = §§pop();
                                                addr435:
                     ...
                     })
                     {
                        ...
                        while(!_loc2_)
                        {
                           ...
                           while(true)
                           {
                              ...
                              §§pop().§2!@§(JSON.parse(this.§8!V§.getFileAsString("Chapters.json")));
                              continue loop5;
                              §§goto(addr50);
                           }
                        }
