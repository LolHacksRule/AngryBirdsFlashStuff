   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§5h§)
         {
            ...
            this.§;!?§.y *= param1.§<!1§;
            this.§;!?§.z *= param1.§<!1§;
            _loc4_.§45§.x -= _loc10_ * this.§;!?§.x;
            _loc4_.§45§.y -= _loc10_ * this.§;!?§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§;!?§.y - _loc7_ * this.§;!?§.x + this.§;!?§.z);
            _loc5_.§45§.x += _loc11_ * this.§;!?§.x;
            _loc5_.§45§.y += _loc11_ * this.§;!?§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc16_:Number = _loc5_.m_sweep.a - _loc4_.m_sweep.a - this.§#G§;
