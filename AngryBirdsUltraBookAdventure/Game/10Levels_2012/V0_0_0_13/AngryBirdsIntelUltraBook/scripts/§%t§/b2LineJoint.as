package §%t§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§;!?§.x * this.§3t§.x + (this.§&4§ + this.§;!?§.y) * this.§[N§.x),param1 * (this.§;!?§.x * this.§3t§.y + (this.§&4§ + this.§;!?§.y) * this.§[N§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§5Y§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§5Y§.col2.x = this.§5Y§.col1.y;
         this.§5Y§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§]p§)
         {
         ...
         if(param1.§5h§)
         {
            ...
            this.§;!?§.y *= param1.§<!1§;
            this.§&4§ *= param1.§<!1§;
            _loc19_ = this.§;!?§.x * this.§3t§.x + (this.§&4§ + this.§;!?§.y) * this.§[N§.x;
            _loc20_ = this.§;!?§.x * this.§3t§.y + (this.§&4§ + this.§;!?§.y) * this.§[N§.y;
            _loc21_ = this.§;!?§.x * this.m_s1 + (this.§&4§ + this.§;!?§.y) * this.m_a1;
            _loc22_ = this.§;!?§.x * this.m_s2 + (this.§&4§ + this.§;!?§.y) * this.m_a2;
            _loc2_.§45§.x -= §%]§ * _loc19_;
            _loc2_.§45§.y -= §%]§ * _loc20_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§&!b§ && this.§@!O§ != §!!4§)
         {
            ...
            _loc14_ = this.§!!^§ * (this.§;G§ - _loc13_);
            _loc15_ = this.§&4§;
            _loc16_ = param1.§`"§ * this.§@0§;
            this.§&4§ = b2Math.§[$§(this.§&4§ + _loc14_,-_loc16_,_loc16_);
            _loc14_ = this.§&4§ - _loc15_;
            _loc8_ = _loc14_ * this.§[N§.x;
         ...
         if(this.§]p§ && this.§@!O§ != §15§)
         {
            ...
            if(this.§@!O§ == §6!!§)
            {
               this.§;!?§.y = b2Math.§<p§(this.§;!?§.y,0);
            }
            else if(this.§@!O§ == §0!&§)
            {
               this.§;!?§.y = b2Math.§ if§(this.§;!?§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§;!?§.y - _loc18_.y) * this.§5Y§.col2.x;
            if(this.§5Y§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§5Y§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            _loc8_ = _loc19_.x * this.§3t§.x + _loc19_.y * this.§[N§.x;
            _loc9_ = _loc19_.x * this.§3t§.y + _loc19_.y * this.§[N§.y;
         ...
         else
         {
            if(this.§5Y§.col1.x != 0)
            {
               _loc22_ = -_loc12_ / this.§5Y§.col1.x;
            }
            else
            {
               _loc22_ = 0;
            ...
            this.§;!?§.x += _loc22_;
            _loc8_ = _loc22_ * this.§3t§.x;
            _loc9_ = _loc22_ * this.§3t§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§]p§)
         {
            ...
            {
               _loc19_ = b2Math.§[$§(_loc34_ - this.§'!X§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§'!X§ - _loc34_;
               _loc18_ = true;
            }
         ...
         if(_loc18_)
         {
            ...
            this.§5Y§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§5Y§.col2.x = this.§5Y§.col1.y;
            this.§5Y§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§5Y§.§<!6§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = §%]§;
         ...
         var _loc30_:Number = _loc28_.x * this.§3t§.x + _loc28_.y * this.§[N§.x;
         var _loc31_:Number = _loc28_.x * this.§3t§.y + _loc28_.y * this.§[N§.y;
