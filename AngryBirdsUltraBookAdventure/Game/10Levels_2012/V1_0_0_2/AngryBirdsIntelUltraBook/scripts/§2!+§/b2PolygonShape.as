package §2!+§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §+n§:b2Mat22 = new b2Mat22();
      ...
      b2internal static function §@!S§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§?U§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§?U§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §&!c§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§,L§)
         {
            this.§#!w§[_loc6_] = b2Math.§'!6§(_loc5_,this.§#!w§[_loc6_]);
            this.§2!-§[_loc6_] = b2Math.§'q§(_loc5_.R,this.§2!-§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§>!6§.x = _loc5_ - b2internal::9!A;
         param1.§>!6§.y = _loc6_ - b2internal::9!A;
         param1.§8!X§.x = _loc7_ + b2internal::9!A;
         param1.§8!X§.y = _loc8_ + b2internal::9!A;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§'l§(param1,param3.position);
