package §'s§
{
   ...
   public class b2Collision
   {
      ...
      private static var §;!R§:Vector.<§'!P§> = §3O§();
      
      private static var s_clipPoints1:Vector.<§'!P§> = §3O§();
      
      private static var s_clipPoints2:Vector.<§'!P§> = §3O§();
      
      private static var §-!0§:Vector.<int> = new Vector.<int>(1);
      
      private static var §=S§:Vector.<int> = new Vector.<int>(1);
      
      private static var §3!O§:b2Vec2 = new b2Vec2();
      ...
      public static function §@U§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §1J§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §1J§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : int(0);
         var _loc21_:Number = §1J§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            _loc17_ = §1J§(param2,param3,_loc14_,param4,param5);
            if(_loc17_ <= _loc23_)
            {
               break;
            }
      ...
      public static function §!X§(param1:Vector.<§'!P§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         _loc20_.id.features.§[J§ = _loc21_;
         _loc20_.id.features.§[O§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.features.§^!F§ = param4;
         _loc20_.id.features.§[J§ = _loc22_;
         _loc20_.id.features.§[O§ = 1;
      }
      ...
      public static function §]Y§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §-!0§[0] = _loc8_;
         var _loc9_:Number = §@U§(§-!0§,param2,param3,param4,param5);
         _loc8_ = §-!0§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §=S§[0] = _loc10_;
         var _loc11_:Number = §@U§(§=S§,param4,param5,param2,param3);
         _loc10_ = §=S§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc26_:b2Vec2 = §3!O§;
         _loc26_.Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2 = §]g§;
         _loc27_.x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2 = §9-§;
         ...
         _loc39_ = §0!N§(_loc37_,_loc21_,_loc30_,_loc35_);
         if(_loc39_ < 2)
         {
            return;
         }
         _loc39_ = §0!N§(_loc38_,_loc37_,_loc29_,_loc36_);
         if(_loc39_ < 2)
         {
            return;
         }
         ...
         while(_loc41_ < b2Settings.b2_maxManifoldPoints)
         {
            ...
            if(_loc42_ <= _loc7_)
            {
               ...
               _loc43_.m_id.features.§8_§ = _loc17_;
               _loc40_++;
            }
            _loc41_++;
         }
