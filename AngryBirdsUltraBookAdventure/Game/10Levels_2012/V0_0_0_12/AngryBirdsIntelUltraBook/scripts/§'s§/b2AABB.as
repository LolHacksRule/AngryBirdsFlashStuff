package §'s§
{
   ...
   public class b2AABB
   {
      ...
      public static function §1b§(param1:b2AABB, param2:b2AABB) : b2AABB
      {
         var _loc3_:b2AABB = new b2AABB();
         _loc3_.§1b§(param1,param2);
         return _loc3_;
      }
      ...
      public function §9M§() : Boolean
      {
         ...
         return Boolean(_loc3_ && this.§^"§.§9M§() && this.§=!O§.§9M§());
      }
      ...
      public function §1b§(param1:b2AABB, param2:b2AABB) : void
      {
