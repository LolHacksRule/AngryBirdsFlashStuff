         ...
         switch(param1.§32§)
         {
            case b2Manifold.§8!G§:
               ...
               if(_loc21_ > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§9O§.x = _loc19_ / _loc26_;
                  this.§9O§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§9O§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§9O§.x;
               _loc23_ = _loc16_ + param3 * this.§9O§.y;
               _loc24_ = _loc17_ - param5 * this.§9O§.x;
               _loc25_ = _loc18_ - param5 * this.§9O§.y;
