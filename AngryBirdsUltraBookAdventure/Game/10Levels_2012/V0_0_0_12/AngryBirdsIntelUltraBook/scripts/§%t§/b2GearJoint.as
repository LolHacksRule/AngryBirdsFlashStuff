package §%t§
{
   ...
   public class b2GearJoint extends b2Joint
   {
                  ...
                  if(_loc7_ || _loc2_)
                  {
                     if(_loc7_)
                     {
                        while(true)
                        {
                           ...
                           §§push(param1.joint1.§32§);
                           if(!_loc6_)
                           {
                              §§push(int(§§pop()));
                           }
                           var _loc2_:* = §§pop();
                           §§push(param1.joint2.§32§);
                           if(!_loc6_)
                           {
                              §§push(int(§§pop()));
                           }
      ...
      override public function GetReactionTorque(param1:Number) : Number
      {
         ...
         if(!(_loc9_ && _loc3_))
         {
            §§push(§§pop() - §&!F§.m_sweep.localCenter.x);
            if(_loc8_)
            {
               addr40:
               §§push(Number(§§pop()));
            ...
            if(!(_loc9_ && this))
            {
               §§push(§§pop() - §&!F§.m_sweep.localCenter.y);
               if(!_loc9_)
               {
                  §§push(Number(§§pop()));
               }
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc3_:b2Body = §&!F§;
         §§push(this.§"C§.§3!$§(_loc2_.§45§,_loc2_.m_angularVelocity,_loc3_.§45§,_loc3_.m_angularVelocity));
         if(_loc7_)
         {
            §§push(Number(§§pop()));
         }
