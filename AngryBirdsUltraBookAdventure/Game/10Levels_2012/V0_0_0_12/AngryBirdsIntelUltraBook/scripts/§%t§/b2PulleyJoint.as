package §%t§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         this.m_groundAnchor1.x = param1.§+f§.x - this.§]R§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§+f§.y - this.§]R§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§6!P§.x - this.§]R§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§6!P§.y - this.§]R§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§`!V§);
         this.m_localAnchor2.SetV(param1.§6$§);
         this.§?"§ = param1.§2![§;
         this.§,!Z§ = param1.§,"§ + this.§?"§ * param1.§[!$§;
         this.m_maxLength1 = b2Math.§ if§(param1.§!! §,this.§,!Z§ - this.§?"§ * §3!;§);
         this.m_maxLength2 = b2Math.§ if§(param1.§;u§,(this.§,!Z§ - §3!;§) / this.§?"§);
         this.§;!?§ = 0;
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            this.m_u2.§%!U§(1 / _loc19_);
         }
         else
         {
            this.m_u2.§5b§();
         }
         var _loc20_:Number = this.§,!Z§ - _loc18_ - this.§?"§ * _loc19_;
         if(_loc20_ > 0)
         {
            this.§'Z§ = §15§;
            this.§;!?§ = 0;
         ...
         this.m_limitMass1 = _loc2_.§8[§ + _loc2_.§&f§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§8[§ + _loc3_.§&f§ * _loc22_ * _loc22_;
         this.§7U§ = this.m_limitMass1 + this.§?"§ * this.§?"§ * this.m_limitMass2;
         ...
         if(param1.§5h§)
         {
            ...
            _loc2_.§45§.x += _loc2_.§8[§ * _loc23_;
            _loc2_.§45§.y += _loc2_.§8[§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§&f§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§45§.x += _loc3_.§8[§ * _loc25_;
            _loc3_.§45§.y += _loc3_.§8[§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§'Z§ == §0!&§)
         {
            _loc10_ = _loc2_.§45§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§45§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§45§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§45§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§?"§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§7U§ * -_loc18_;
            _loc20_ = this.§;!?§;
            this.§;!?§ = b2Math.§<p§(0,this.§;!?§ + _loc19_);
            _loc19_ = this.§;!?§ - _loc20_;
            _loc14_ = -_loc19_ * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§?"§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§?"§ * _loc19_ * this.m_u2.y;
            _loc2_.§45§.x += _loc2_.§8[§ * _loc14_;
            _loc2_.§45§.y += _loc2_.§8[§ * _loc15_;
         ...
         if(this.m_limitState1 == §0!&§)
         {
            ...
            this.m_limitImpulse1 = b2Math.§<p§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == §0!&§)
         {
            ...
            this.m_limitImpulse2 = b2Math.§<p§(0,this.m_limitImpulse2 + _loc19_);
