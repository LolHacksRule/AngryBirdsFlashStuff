package §3p§
{
   ...
   public class §]x§ extends §"!§
   {
      ...
      override protected function isMoving() : Boolean
      {
         ...
         if(_loc3_)
         {
            §§push(Math.abs(§9f§().GetLinearVelocity().x) < b2Settings.b2_linearSleepTolerance * _loc1_);
            if(_loc3_ || _loc2_)
            {
               §§push(Boolean(§§pop()));
               loop0:
                  ...
                  while(true)
                  {
                     if(§§pop())
                     {
                        ...
                        while(true)
                        {
                           ...
                           while(true)
                           {
                              §§push(Math.abs(§9f§().GetLinearVelocity().y) < b2Settings.b2_linearSleepTolerance * _loc1_);
                              addr126:
                              while(true)
                              {
                                 §§push(Boolean(§§pop()));
                                    ...
                                    if(!(_loc2_ && _loc1_))
                                    {
                                       ...
                                       else
                                       {
                                          while(true)
                                          {
                                             if(_loc3_)
                                             {
                                                §§push(Math.abs(§9f§().GetAngularVelocity()) < b2Settings.b2_angularSleepTolerance * _loc1_);
                                                if(!(_loc2_ && _loc3_))
                                                {
                                                   if(!_loc2_)
                                                   {
