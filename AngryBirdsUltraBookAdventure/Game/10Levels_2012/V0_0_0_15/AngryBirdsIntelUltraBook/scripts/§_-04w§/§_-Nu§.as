package §_-04w§
{
   ...
   public class §_-Nu§
   {
      ...
      public static function encode(param1:BitmapData) : ByteArray
      {
         ...
         _loc3_.writeByte(0);
         §_-0Cz§(_loc2_,1229472850,_loc3_);
         ...
         _loc4_.compress();
         §_-0Cz§(_loc2_,1229209940,_loc4_);
         §_-0Cz§(_loc2_,1229278788,null);
         return _loc2_;
      }
      ...
      private static function §_-0Cz§(param1:ByteArray, param2:uint, param3:ByteArray) : void
      {
         ...
         {
            _loc8_ = uint(§_-D8§[(_loc8_ ^ param1.readUnsignedByte()) & uint(255)] ^ uint(_loc8_ >>> 8));
            _loc7_++;
         }
