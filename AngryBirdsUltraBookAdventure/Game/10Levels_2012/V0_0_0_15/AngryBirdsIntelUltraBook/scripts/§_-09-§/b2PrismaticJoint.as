package §_-09-§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§_-MK§.x * this.§_-0t§.x + (this.§_-j§ + this.§_-MK§.z) * this.§_-DN§.x),param1 * (this.§_-MK§.x * this.§_-0t§.y + (this.§_-j§ + this.§_-MK§.z) * this.§_-DN§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§_-04m§ > Number.MIN_VALUE)
         {
            this.§_-04m§ = 1 / this.§_-04m§;
         }
         ...
         this.§_-0Ax§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§_-0Ax§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§_-0Ax§.col2.x = this.§_-0Ax§.col1.y;
         this.§_-0Ax§.col2.y = _loc16_ + _loc17_;
         this.§_-0Ax§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§_-0Ax§.col3.x = this.§_-0Ax§.col1.z;
         this.§_-0Ax§.col3.y = this.§_-0Ax§.col2.z;
         this.§_-0Ax§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§_-E5§)
         {
         ...
         if(param1.§_-0F7§)
         {
            ...
            _loc19_ = this.§_-MK§.x * this.§_-0t§.x + (this.§_-j§ + this.§_-MK§.z) * this.§_-DN§.x;
            _loc20_ = this.§_-MK§.x * this.§_-0t§.y + (this.§_-j§ + this.§_-MK§.z) * this.§_-DN§.y;
            _loc21_ = this.§_-MK§.x * this.m_s1 + this.§_-MK§.y + (this.§_-j§ + this.§_-MK§.z) * this.m_a1;
            _loc22_ = this.§_-MK§.x * this.m_s2 + this.§_-MK§.y + (this.§_-j§ + this.§_-MK§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§_-DN§.x * (_loc6_.x - _loc4_.x) + this.§_-DN§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§_-04m§ * (this.§_-09I§ - _loc14_);
            _loc16_ = this.§_-j§;
            _loc17_ = param1.§_-pn§ * this.§_-V§;
            this.§_-j§ = b2Math.§_-ZK§(this.§_-j§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§_-j§ - _loc16_) * this.§_-DN§.x;
            _loc9_ = _loc15_ * this.§_-DN§.y;
         ...
         {
            _loc18_ = this.§_-DN§.x * (_loc6_.x - _loc4_.x) + this.§_-DN§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§_-MK§.Copy();
            _loc20_ = this.§_-0Ax§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§_-MK§.§_-M6§(_loc20_);
            if(this.§_-Vb§ == b2internal::_-D3)
            {
               this.§_-MK§.z = b2Math.§_-yL§(this.§_-MK§.z,0);
            }
            else if(this.§_-Vb§ == b2internal::_-Z5)
            {
               this.§_-MK§.z = b2Math.§_-fa§(this.§_-MK§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§_-MK§.z - _loc19_.z) * this.§_-0Ax§.col3.x;
            _loc22_ = -_loc13_ - (this.§_-MK§.z - _loc19_.z) * this.§_-0Ax§.col3.y;
            _loc23_ = this.§_-0Ax§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§_-MK§.x = _loc23_.x;
            this.§_-MK§.y = _loc23_.y;
            _loc20_.x = this.§_-MK§.x - _loc19_.x;
            _loc20_.y = this.§_-MK§.y - _loc19_.y;
            _loc20_.z = this.§_-MK§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§_-0t§.x + _loc20_.z * this.§_-DN§.x;
            _loc9_ = _loc20_.x * this.§_-0t§.y + _loc20_.z * this.§_-DN§.y;
         ...
         else
         {
            ...
            this.§_-MK§.x += _loc24_.x;
            this.§_-MK§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§_-0t§.x;
            _loc9_ = _loc24_.x * this.§_-0t§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§_-E5§)
         {
            ...
            _loc35_ = this.§_-DN§.x * _loc26_ + this.§_-DN§.y * _loc27_;
            if(b2Math.§_-010§(this.§_-KV§ - this.§_-Fr§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§_-ZK§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§_-010§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§_-Fr§)
            {
               _loc19_ = b2Math.§_-ZK§(_loc35_ - this.§_-Fr§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§_-Fr§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§_-KV§)
            {
               _loc19_ = b2Math.§_-ZK§(_loc35_ - this.§_-KV§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§_-KV§;
               _loc18_ = true;
            }
         }
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§_-o1§;
         _loc16_ = b2Math.§_-yL§(_loc16_,b2Math.§_-010§(_loc29_));
         _loc17_ = b2Math.§_-010§(_loc30_);
         if(_loc18_)
         {
            ...
            this.§_-0Ax§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§_-0Ax§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§_-0Ax§.col2.x = this.§_-0Ax§.col1.y;
            this.§_-0Ax§.col2.y = _loc14_ + _loc15_;
            this.§_-0Ax§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§_-0Ax§.col3.x = this.§_-0Ax§.col1.z;
            this.§_-0Ax§.col3.y = this.§_-0Ax§.col2.z;
            this.§_-0Ax§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§_-0Ax§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::_-04l;
            ...
            this.§_-0Ax§.col1.Set(_loc36_,_loc37_,0);
            this.§_-0Ax§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§_-0Ax§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§_-0t§.x + _loc28_.z * this.§_-DN§.x;
         var _loc32_:Number = _loc28_.x * this.§_-0t§.y + _loc28_.z * this.§_-DN§.y;
         ...
         _loc6_.x -= b2internal::_-04l * _loc31_;
         _loc6_.y -= b2internal::_-04l * _loc32_;
         _loc7_ -= b2internal::_-gk * _loc33_;
         _loc8_.x += b2internal::_-cW * _loc31_;
         _loc8_.y += b2internal::_-cW * _loc32_;
         _loc9_ += b2internal::_-at * _loc34_;
