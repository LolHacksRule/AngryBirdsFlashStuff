package §_-03n§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §_-FP§:b2Mat22 = new b2Mat22();
      ...
      public static function §_-WO§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§_-M6§(new b2Vec2(0,0));
            _loc3_.§_-M6§(_loc9_);
            _loc3_.§_-M6§(_loc10_);
            _loc3_.§_-mx§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §_-08P§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§_-0FC§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§_-0FC§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §_-zb§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§_-OS§ ? int(_loc3_ + 1) : 0;
      ...
      public function §_-tU§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§_-OS§)
         {
            this.§_-09U§[_loc6_] = b2Math.§_-yP§(_loc5_,this.§_-09U§[_loc6_]);
            this.§_-EH§[_loc6_] = b2Math.§_-S4§(_loc5_.R,this.§_-EH§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §_-QF§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§_-LW§.x = 0.5 * (param1.x + param2.x);
         this.§_-LW§.y = 0.5 * (param1.y + param2.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§_-OS§)
         {
            _loc6_ = (_loc9_ = this.§_-09U§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§_-EH§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§_-Bv§.x = _loc5_ - b2internal::_-0CZ;
         param1.§_-Bv§.y = _loc6_ - b2internal::_-0CZ;
         param1.§_-MB§.x = _loc7_ + b2internal::_-0CZ;
         param1.§_-MB§.y = _loc8_ + b2internal::_-0CZ;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§_-OS§ == 2)
         {
            param1.center.x = 0.5 * (this.§_-09U§[0].x + this.§_-09U§[1].x);
            param1.center.y = 0.5 * (this.§_-09U§[0].y + this.§_-09U§[1].y);
            param1.§_-ze§ = 0;
            param1.§_-CG§ = 0;
            return;
         }
         ...
         param1.§_-ze§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§_-CG§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§_-r8§(param1,param3.position);
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§_-OS§;
         var _loc14_:int = (_loc10_ + 1) % this.§_-OS§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§_-09U§[_loc9_].x * (1 - _loc15_) + this.§_-09U§[_loc13_].x * _loc15_,this.§_-09U§[_loc9_].y * (1 - _loc15_) + this.§_-09U§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§_-09U§[_loc10_].x * (1 - _loc16_) + this.§_-09U§[_loc14_].x * _loc16_,this.§_-09U§[_loc10_].y * (1 - _loc16_) + this.§_-09U§[_loc14_].y * _loc16_);
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§_-OS§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
