   ...
   public class Texture
   {
      ...
      public function adjustVertexData(param1:§_-9f§, param2:int, param3:int) : void
      {
         ...
         if(this.§_-Q0§)
         {
            ...
            _loc4_ = this.§_-Q0§.width + this.§_-Q0§.x - this.width;
            _loc5_ = this.§_-Q0§.height + this.§_-Q0§.y - this.height;
            param1.§_-ZN§(param2,-this.§_-Q0§.x,-this.§_-Q0§.y);
            param1.§_-ZN§(param2 + 1,-_loc4_,-this.§_-Q0§.y);
            param1.§_-ZN§(param2 + 2,-this.§_-Q0§.x,-_loc5_);
            param1.§_-ZN§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
