package §_-8d§
{
   public class §_-rz§ extends §_-Ew§
   {
      ...
      override public function initializeAnimations(param1:Array) : void
      {
         ...
         §_-06j§("INTEL_SLINGSHOT",["INTEL_SLING_SHOT_01_BACK","INTEL_SLING_SHOT_01_FRONT"]);
