package §_-gE§
{
   ...
   class b2Simplex
   {
      ...
      public function §_-4m§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            _loc11_ = param1.§_-VL§;
            if((_loc12_ = this.§_-01b§()) < 0.5 * _loc11_ || 2 * _loc11_ < _loc12_ || _loc12_ < Number.MIN_VALUE)
            {
               this.§_-ru§ = 0;
            }
         }
      ...
      public function §_-Au§() : b2Vec2
      {
         ...
         switch(this.§_-ru§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§_-rd§(_loc1_,this.m_v1.§_-04b§.§_-5M§());
               if(_loc2_ > 0)
               {
      ...
      public function §_-oo§() : b2Vec2
      {
         switch(this.§_-ru§)
         {
            ...
            case 2:
               return new b2Vec2(this.m_v1.a * this.m_v1.§_-04b§.x + this.m_v2.a * this.m_v2.§_-04b§.x,this.m_v1.a * this.m_v1.§_-04b§.y + this.m_v2.a * this.m_v2.§_-04b§.y);
            default:
               b2Settings.b2Assert(false);
               return new b2Vec2();
         }
      ...
      public function §use§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§_-ru§)
         {
            ...
            case 1:
               ...
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§_-9x§.x + this.m_v2.a * this.m_v2.§_-9x§.x;
               param1.y = this.m_v1.a * this.m_v1.§_-9x§.y + this.m_v2.a * this.m_v2.§_-9x§.y;
               param2.x = this.m_v1.a * this.m_v1.§_-8S§.x + this.m_v2.a * this.m_v2.§_-8S§.x;
               param2.y = this.m_v1.a * this.m_v1.§_-8S§.y + this.m_v2.a * this.m_v2.§_-8S§.y;
               break;
            case 3:
               param2.x = param1.x = this.m_v1.a * this.m_v1.§_-9x§.x + this.m_v2.a * this.m_v2.§_-9x§.x + this.m_v3.a * this.m_v3.§_-9x§.x;
               param2.y = param1.y = this.m_v1.a * this.m_v1.§_-9x§.y + this.m_v2.a * this.m_v2.§_-9x§.y + this.m_v3.a * this.m_v3.§_-9x§.y;
               break;
            default:
               b2Settings.b2Assert(false);
         }
      ...
      public function §_-01b§() : Number
      {
         switch(this.§_-ru§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§_-DO§(this.m_v1.§_-04b§,this.m_v2.§_-04b§).§_-YT§();
            case 3:
               return b2Math.§_-rd§(b2Math.§_-DO§(this.m_v2.§_-04b§,this.m_v1.§_-04b§),b2Math.§_-DO§(this.m_v3.§_-04b§,this.m_v1.§_-04b§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc5_:Number = b2Math.§_-r8§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§_-r8§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§_-DO§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§_-r8§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§_-r8§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§_-DO§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§_-r8§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§_-r8§(_loc3_,_loc14_);
         var _loc18_:Number = -_loc15_;
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§_-rd§(_loc4_,_loc9_)) * b2Math.§_-rd§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§_-rd§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§_-rd§(_loc1_,_loc2_);
