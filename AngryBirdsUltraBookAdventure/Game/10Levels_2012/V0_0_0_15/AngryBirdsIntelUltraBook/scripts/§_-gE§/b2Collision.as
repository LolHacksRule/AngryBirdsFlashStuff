package §_-gE§
{
   ...
   public class b2Collision
   {
      ...
      private static var §_-uE§:Vector.<§_-ix§> = §_-um§();
      
      private static var s_clipPoints1:Vector.<§_-ix§> = §_-um§();
      
      private static var s_clipPoints2:Vector.<§_-ix§> = §_-um§();
      
      private static var §_-0EE§:Vector.<int> = new Vector.<int>(1);
      
      private static var §_-gq§:Vector.<int> = new Vector.<int>(1);
      
      private static var §_-I2§:b2Vec2 = new b2Vec2();
      
      private static var §_-Aj§:b2Vec2 = new b2Vec2();
      
      private static var §_-kn§:b2Vec2 = new b2Vec2();
      
      private static var §_-KT§:b2Vec2 = new b2Vec2();
      
      private static var §_-4F§:b2Vec2 = new b2Vec2();
      ...
      public static function §_-F3§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §_-02D§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §_-02D§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §_-02D§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §_-02D§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §_-F2§(param1:Vector.<§_-ix§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§_-OS§;
         var _loc8_:Vector.<b2Vec2> = param2.§_-EH§;
         var _loc9_:int = param5.§_-OS§;
         ...
         _loc20_.id.§_-9h§.§_-uj§ = param4;
         _loc20_.id.§_-9h§.§_-09v§ = _loc21_;
         _loc20_.id.§_-9h§.§_-Cq§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§_-9h§.§_-uj§ = param4;
         _loc20_.id.§_-9h§.§_-09v§ = _loc22_;
         _loc20_.id.§_-9h§.§_-Cq§ = 1;
      }
      ...
      public static function §_-r1§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §_-0EE§[0] = _loc8_;
         var _loc9_:Number = §_-F3§(§_-0EE§,param2,param3,param4,param5);
         _loc8_ = §_-0EE§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §_-gq§[0] = _loc10_;
         var _loc11_:Number = §_-F3§(§_-gq§,param4,param5,param2,param3);
         _loc10_ = §_-gq§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §_-I2§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §_-Aj§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §_-kn§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         ...
         if((_loc39_ = §_-Z4§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §_-Z4§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
      ...
      public static function §_-Wb§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§catch§.y = _loc16_ - _loc27_.y;
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§_-XO§ = 1;
            param1.§_-1c§ = b2Manifold.§_-f8§;
            param1.§catch§.x = _loc15_ - _loc28_.x;
            param1.§catch§.y = _loc16_ - _loc28_.y;
            param1.§catch§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§_-Eg§[0].m_localPoint.SetV(param4.§_-bq§);
            param1.§_-Eg§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§catch§.y = _loc23_[_loc25_].y;
            param1.§catch§.Normalize();
