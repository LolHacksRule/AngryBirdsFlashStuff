         ...
         switch(param1.§_-1c§)
         {
            case b2Manifold.§_-fd§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§_-mm§.x = _loc19_ / _loc26_;
                  this.§_-mm§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§_-mm§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§_-mm§.x;
               _loc23_ = _loc16_ + param3 * this.§_-mm§.y;
               _loc24_ = _loc17_ - param5 * this.§_-mm§.x;
               _loc25_ = _loc18_ - param5 * this.§_-mm§.y;
               this.§_-Eg§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§_-Eg§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
