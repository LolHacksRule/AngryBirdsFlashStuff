package §-w§
{
   ...
   public class §^!&§
   {
      ...
      public function initializeAnimations(param1:Array) : void
      {
         ...
         this.§1V§("BACKGROUND_12_MOON_2",["BACKGROUND_12_MOON_2"]);
      ...
      {
         if(!this.§1V§(param1,[param1 + "_1",param1 + "_2",param1 + "_3",param1 + "_4"]))
         {
            if(!this.§1V§(param1,[param1 + "_1",param1 + "_2",param1 + "_3"]))
            {
               if(!this.§1V§(param1,[param1 + "_1"]))
               {
                  if(this.§1V§(param1,[param1]))
                  {
                  }
               }
            }
