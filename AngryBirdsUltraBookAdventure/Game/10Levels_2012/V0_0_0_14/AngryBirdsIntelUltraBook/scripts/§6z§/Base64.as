package §6z§
{
   ...
   public class Base64
   {
      ...
      private static const §7!Y§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      
      {
         ...
         if(!(_loc1_ && _loc2_))
         {
            §7!Y§ = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
            do
            {
               version = "1.1.0";
            }
      ...
      public static function §>!8§(param1:ByteArray) : String
      {
                                                                                    ...
                                                                                    while(_loc9_)
                                                                                    {
                                                                                       ...
                                                                                       while(true)
                                                                                       {
                                                                                          ...
                                                                                          while(true)
                                                                                          {
                                                                                             ...
                                                                                             if(_loc9_ || _loc2_)
                                                                                             {
                                                                                                §§push(§§pop() + §7!Y§.charAt(_loc4_[_loc7_]));
                                                                                             }
                                                                                             _loc2_ = §§pop();
                                                                                             while(true)
                                                                                             {
      ...
      {
         var _loc2_:ByteArray = §"E§(param1);
         return _loc2_.readUTFBytes(_loc2_.length);
      }
      
      public static function §"E§(param1:String) : ByteArray
      {
