package §6z§
{
   ...
   public class §7>§
   {
      ...
      public function §7>§(param1:ByteArray, param2:String, param3:String, param4:String, param5:Function, param6:Function)
      {
         ...
         var _loc7_:String = (_loc7_ = §'q§ + §"!d§ + "?access_token=" + param3).replace("[USER_ID]",param4);
         §[g§.log("Uploading image; URL:" + _loc7_);
         param1 = this.§9O§(param1,param2);
      ...
      {
         §[g§.log("Error!! " + param1.toString());
         §[g§.log("Data?" + param1.target.data.toString());
         if(this.§"w§ != null)
         {
            this.§"w§();
         }
