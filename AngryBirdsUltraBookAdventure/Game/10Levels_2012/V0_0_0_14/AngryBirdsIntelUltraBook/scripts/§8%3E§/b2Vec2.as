package §8>§
{
   public class b2Vec2
   {
      ...
      public static function §8!f§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      {
         var _loc2_:Number = b2Math.§1!P§(this,param1.col1);
         this.y = b2Math.§1!P§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      {
         return b2Math.§]d§(this.x) && b2Math.§]d§(this.y);
      }
   }
}
