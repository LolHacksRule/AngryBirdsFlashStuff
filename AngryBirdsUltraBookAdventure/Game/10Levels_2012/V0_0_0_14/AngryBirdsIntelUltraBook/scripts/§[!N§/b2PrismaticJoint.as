package §[!N§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§+!P§.x * this.§;!]§.x + (this.§#!s§ + this.§+!P§.z) * this.§9u§.x),param1 * (this.§+!P§.x * this.§;!]§.y + (this.§#!s§ + this.§+!P§.z) * this.§9u§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§9!G§)
         {
            ...
            this.§+!P§.y *= param1.§&t§;
            this.§#!s§ *= param1.§&t§;
            _loc19_ = this.§+!P§.x * this.§;!]§.x + (this.§#!s§ + this.§+!P§.z) * this.§9u§.x;
            _loc20_ = this.§+!P§.x * this.§;!]§.y + (this.§#!s§ + this.§+!P§.z) * this.§9u§.y;
            _loc21_ = this.§+!P§.x * this.m_s1 + this.§+!P§.y + (this.§#!s§ + this.§+!P§.z) * this.m_a1;
            _loc22_ = this.§+!P§.x * this.m_s2 + this.§+!P§.y + (this.§#!s§ + this.§+!P§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§9u§.x * (_loc6_.x - _loc4_.x) + this.§9u§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§>y§ * (this.§@!]§ - _loc14_);
            _loc16_ = this.§#!s§;
            _loc17_ = param1.§6c§ * this.§]!P§;
            this.§#!s§ = b2Math.§5L§(this.§#!s§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§#!s§ - _loc16_) * this.§9u§.x;
            _loc9_ = _loc15_ * this.§9u§.y;
         ...
         {
            _loc18_ = this.§9u§.x * (_loc6_.x - _loc4_.x) + this.§9u§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§+!P§.Copy();
            ...
            {
               this.§+!P§.z = b2Math.§^!n§(this.§+!P§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§+!P§.z - _loc19_.z) * this.§`!F§.col3.x;
            _loc22_ = -_loc13_ - (this.§+!P§.z - _loc19_.z) * this.§`!F§.col3.y;
            _loc23_ = this.§`!F§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§+!P§.x = _loc23_.x;
            this.§+!P§.y = _loc23_.y;
            _loc20_.x = this.§+!P§.x - _loc19_.x;
            _loc20_.y = this.§+!P§.y - _loc19_.y;
            _loc20_.z = this.§+!P§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§;!]§.x + _loc20_.z * this.§9u§.x;
            _loc9_ = _loc20_.x * this.§;!]§.y + _loc20_.z * this.§9u§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§]!x§)
         {
            ...
            _loc35_ = this.§9u§.x * _loc26_ + this.§9u§.y * _loc27_;
            if(b2Math.§>!Y§(this.§`1§ - this.§@@§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§5L§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§>!Y§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§@@§)
            {
               _loc19_ = b2Math.§5L§(_loc35_ - this.§@@§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§@@§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§`1§)
            {
               _loc19_ = b2Math.§5L§(_loc35_ - this.§`1§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§`1§;
               _loc18_ = true;
            }
         }
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§8;§;
         ...
         var _loc31_:Number = _loc28_.x * this.§;!]§.x + _loc28_.z * this.§9u§.x;
         var _loc32_:Number = _loc28_.x * this.§;!]§.y + _loc28_.z * this.§9u§.y;
         ...
         _loc6_.x -= b2internal::8!K * _loc31_;
         _loc6_.y -= b2internal::8!K * _loc32_;
         _loc7_ -= b2internal::[!= * _loc33_;
         _loc8_.x += b2internal::!!8 * _loc31_;
         _loc8_.y += b2internal::!!8 * _loc32_;
         _loc9_ += b2internal::1& * _loc34_;
