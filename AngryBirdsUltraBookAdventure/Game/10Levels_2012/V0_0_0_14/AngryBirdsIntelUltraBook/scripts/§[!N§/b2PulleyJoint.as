package §[!N§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §1!"§:Number = 2;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         this.m_groundAnchor1.x = param1.§&!>§.x - this.§>,§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§&!>§.y - this.§>,§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§7!+§.x - this.§>,§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§7!+§.y - this.§>,§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§9!9§);
         this.m_localAnchor2.SetV(param1.§^G§);
         this.§do§ = param1.§32§;
         this.§"!i§ = param1.§5%§ + this.§do§ * param1.§3!r§;
         this.m_maxLength1 = b2Math.§^!n§(param1.§;J§,this.§"!i§ - this.§do§ * b2internal::1!");
         this.m_maxLength2 = b2Math.§^!n§(param1.§ M§,(this.§"!i§ - b2internal::1!") / this.§do§);
         this.§+!P§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§+!P§ * this.m_u2.x,param1 * this.§+!P§ * this.m_u2.y);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc18_:Number = this.m_u1.§-l§();
         var _loc19_:Number = this.m_u2.§-l§();
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§"!i§ - _loc18_ - this.§do§ * _loc19_) > 0)
         {
         ...
         this.m_limitMass1 = _loc2_.§1!X§ + _loc2_.§^!B§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§1!X§ + _loc3_.§^!B§ * _loc22_ * _loc22_;
         this.§76§ = this.m_limitMass1 + this.§do§ * this.§do§ * this.m_limitMass2;
         ...
         {
            this.§+!P§ *= param1.§&t§;
            this.m_limitImpulse1 *= param1.§&t§;
            this.m_limitImpulse2 *= param1.§&t§;
            _loc23_ = (-this.§+!P§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§+!P§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§do§ * this.§+!P§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§do§ * this.§+!P§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§9!§.x += _loc2_.§1!X§ * _loc23_;
            _loc2_.§9!§.y += _loc2_.§1!X§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§^!B§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§9!§.x += _loc3_.§1!X§ * _loc25_;
            _loc3_.§9!§.y += _loc3_.§1!X§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§^!B§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§+!P§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = _loc4_.col1.y * _loc8_ + _loc4_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         if(this.§46§ == b2internal:: B)
         {
            _loc10_ = _loc2_.§9!§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§9!§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§9!§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§9!§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§do§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§76§ * -_loc18_;
            _loc20_ = this.§+!P§;
            this.§+!P§ = b2Math.§ 9§(0,this.§+!P§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§+!P§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§do§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§do§ * _loc19_ * this.m_u2.y;
            _loc2_.§9!§.x += _loc2_.§1!X§ * _loc14_;
            _loc2_.§9!§.y += _loc2_.§1!X§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§^!B§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§9!§.x += _loc3_.§1!X§ * _loc16_;
            _loc3_.§9!§.y += _loc3_.§1!X§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§^!B§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§46§ == b2internal:: B)
         {
            ...
            if(_loc18_ > b2Settings.b2_linearSlop)
            {
               this.m_u2.§;a§(1 / _loc18_);
            }
            else
            {
               this.m_u2.§%&§();
            }
            _loc19_ = this.§"!i§ - _loc17_ - this.§do§ * _loc18_;
            _loc24_ = b2Math.§ 9§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§5L§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§76§ * _loc19_) * this.m_u1.x;
            _loc14_ = -_loc20_ * this.m_u1.y;
            _loc15_ = -this.§do§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§do§ * _loc20_ * this.m_u2.y;
            _loc2_.m_sweep.c.x += _loc2_.§1!X§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§1!X§ * _loc14_;
            _loc2_.m_sweep.a += _loc2_.§^!B§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§1!X§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§1!X§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§^!B§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§ n§();
            _loc3_.§ n§();
         }
         if(this.m_limitState1 == b2internal:: B)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§-l§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal:: B)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§-l§()) > b2Settings.b2_linearSlop)
            {
