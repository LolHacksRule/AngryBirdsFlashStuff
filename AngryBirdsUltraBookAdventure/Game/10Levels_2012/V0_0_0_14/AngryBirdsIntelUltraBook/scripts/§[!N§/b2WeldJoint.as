package §[!N§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc7_ = this.§^!i§.y - _loc4_.m_sweep.localCenter.y;
         _loc3_ = _loc2_.col1.x * _loc6_ + _loc2_.col2.x * _loc7_;
         _loc7_ = _loc2_.col1.y * _loc6_ + _loc2_.col2.y * _loc7_;
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.m_xf.R;
         _loc8_ = this.§?!5§.x - _loc5_.m_sweep.localCenter.x;
         _loc9_ = this.§?!5§.y - _loc5_.m_sweep.localCenter.y;
         ...
         if(param1.§9!G§)
         {
            ...
            this.§+!P§.y *= param1.§&t§;
            this.§+!P§.z *= param1.§&t§;
            _loc4_.§9!§.x -= _loc10_ * this.§+!P§.x;
            _loc4_.§9!§.y -= _loc10_ * this.§+!P§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§+!P§.y - _loc7_ * this.§+!P§.x + this.§+!P§.z);
            _loc5_.§9!§.x += _loc11_ * this.§+!P§.x;
            _loc5_.§9!§.y += _loc11_ * this.§+!P§.y;
            _loc5_.m_angularVelocity += _loc13_ * (_loc8_ * this.§+!P§.y - _loc9_ * this.§+!P§.x + this.§+!P§.z);
         }
         else
         {
            this.§+!P§.§%&§();
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§#K§.Solve33(_loc21_,-_loc18_,-_loc19_,-_loc20_);
         this.§+!P§.§[!C§(_loc21_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc5_:b2Body = b2internal::7!<;
         _loc2_ = _loc4_.m_xf.R;
         var _loc6_:Number = this.§^!i§.x - _loc4_.m_sweep.localCenter.x;
         var _loc7_:Number = this.§^!i§.y - _loc4_.m_sweep.localCenter.y;
         _loc3_ = _loc2_.col1.x * _loc6_ + _loc2_.col2.x * _loc7_;
         _loc7_ = _loc2_.col1.y * _loc6_ + _loc2_.col2.y * _loc7_;
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.m_xf.R;
         var _loc8_:Number = this.§?!5§.x - _loc5_.m_sweep.localCenter.x;
         ...
         this.§#K§.Solve33(_loc20_,-_loc14_,-_loc15_,-_loc16_);
