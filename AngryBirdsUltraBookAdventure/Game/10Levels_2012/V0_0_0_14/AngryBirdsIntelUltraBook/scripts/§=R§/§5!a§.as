package §=R§
{
   ...
   public class §5!a§ extends §&W§
   {
      ...
      {
         if(this.§35§ == §5!a§.COMPONENT_STATE_ACTIVE_DEFAULT)
         {
            this.setComponentState(§5!a§.§4]§);
         }
         else if(this.§35§ == §5!a§.§4]§)
         {
            this.setComponentState(§5!a§.COMPONENT_STATE_ACTIVE_DEFAULT);
         }
      }
