package §0!'§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      public function b2PolygonShape()
      {
         ...
         §6q§ = b2Settings.b2_polygonRadius;
         this.§[E§.§%&§();
      }
      ...
      b2internal static function §=!b§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§,!d§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§,!d§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§]S§.x = _loc5_ - b2internal::6q;
         param1.§]S§.y = _loc6_ - b2internal::6q;
         param1.§-!o§.x = _loc7_ + b2internal::6q;
         param1.§-!o§.y = _loc8_ + b2internal::6q;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§1!P§(param1,param3.position);
