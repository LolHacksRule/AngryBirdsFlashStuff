package §`M§
{
   ...
   public class §9!#§ extends §&W§
   {
      ...
      override public function clear() : void
      {
         ...
         if(this.§3z§)
         {
            this.§3z§.movieClip.removeChild(mClip);
         }
         super.clear();
      }
      ...
      public function §;!=§(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            {
               §[g§.log("WARNING: UIContainer(" + mName + ") setItemVisibility can not be done because item " + param1 + " does not exist");
            }
         }
      }
