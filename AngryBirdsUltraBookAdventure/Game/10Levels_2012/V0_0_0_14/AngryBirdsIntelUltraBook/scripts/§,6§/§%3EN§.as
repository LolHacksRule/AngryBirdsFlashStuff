package §,6§
{
   ...
   public class §>N§
   {
      ...
      private function §6X§(param1:Array) : void
      {
         var _loc2_:Array = null;
         var _loc3_:String = null;
         if(param1 != null)
         {
            _loc2_ = this.§5A§(param1);
      ...
      private function §5A§(param1:Array) : Array
      {
         var _loc3_:String = null;
         var _loc2_:Array = [];
      ...
      protected function §?!%§(param1:String, param2:Array) : void
      {
         ...
         var _loc3_:§1V§ = new §1V§();
         for each(_loc4_ in param2)
         {
            _loc5_ = _loc4_[0];
            _loc6_ = _loc4_[1];
            _loc3_.§,!x§(_loc5_,this.§;r§(_loc6_));
         }
         this.§`!'§[param1] = _loc3_;
      }
