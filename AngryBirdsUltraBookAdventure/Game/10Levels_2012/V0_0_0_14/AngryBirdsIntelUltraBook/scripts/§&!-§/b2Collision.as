package §&!-§
{
   ...
   public class b2Collision
   {
      ...
      private static var §[!8§:Vector.<§2!P§> = §@i§();
      
      private static var s_clipPoints1:Vector.<§2!P§> = §@i§();
      
      private static var s_clipPoints2:Vector.<§2!P§> = §@i§();
      
      private static var §=y§:Vector.<int> = new Vector.<int>(1);
      
      private static var §'G§:Vector.<int> = new Vector.<int>(1);
      
      private static var §'!;§:b2Vec2 = new b2Vec2();
      
      private static var §'8§:b2Vec2 = new b2Vec2();
      
      private static var §5!m§:b2Vec2 = new b2Vec2();
      ...
      public static function §4!0§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §=y§[0] = _loc8_;
         var _loc9_:Number = §^!a§(§=y§,param2,param3,param4,param5);
         _loc8_ = §=y§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §'G§[0] = _loc10_;
         var _loc11_:Number = §^!a§(§'G§,param4,param5,param2,param3);
         _loc10_ = §'G§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§2!P§> = §[!8§;
         §[!U§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         ...
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §5!m§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         ...
         var _loc37_:Vector.<§2!P§> = s_clipPoints1;
         var _loc38_:Vector.<§2!P§> = s_clipPoints2;
         if((_loc39_ = §[!M§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §[!M§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
