package §&!-§
{
   ...
   public class b2Distance
   {
      ...
      private static var §=!x§:b2Simplex = new b2Simplex();
      
      private static var §8!c§:Vector.<int> = new Vector.<int>(3);
      ...
      public static function §7U§(param1:b2DistanceOutput, param2:b2SimplexCache, param3:b2DistanceInput) : void
      {
         ...
         var _loc15_:Number;
         var _loc14_:b2Vec2;
         var _loc16_:Number = _loc15_ = (_loc14_ = _loc8_.§^!P§()).§!!v§();
         var _loc19_:int = 0;
         while(_loc19_ < 20)
         {
            _loc13_ = _loc8_.§8Q§;
            ...
            if((_loc16_ = (_loc18_ = _loc8_.§^!P§()).§!!v§()) > _loc15_)
            {
            }
            _loc15_ = _loc16_;
         ...
         if(param3.§2!j§)
         {
            _loc23_ = _loc4_.§6q§;
            _loc24_ = _loc5_.§6q§;
            if(param1.§!!q§ > _loc23_ + _loc24_ && param1.§!!q§ > Number.MIN_VALUE)
            {
               param1.§!!q§ -= _loc23_ + _loc24_;
            ...
            {
               (_loc18_ = new b2Vec2()).x = 0.5 * (param1.§<!0§.x + param1.§]!I§.x);
               _loc18_.y = 0.5 * (param1.§<!0§.y + param1.§]!I§.y);
               param1.§<!0§.x = param1.§]!I§.x = _loc18_.x;
               param1.§<!0§.y = param1.§]!I§.y = _loc18_.y;
               param1.§!!q§ = 0;
            }
         }
      }
