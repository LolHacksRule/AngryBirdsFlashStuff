package §&!-§
{
   ...
   class b2Simplex
   {
      ...
      public function §?H§() : b2Vec2
      {
         ...
         switch(this.§8Q§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§#!9§(_loc1_,this.m_v1.§"S§.§2!'§());
               if(_loc2_ > 0)
               {
      ...
      public function §^!P§() : b2Vec2
      {
         switch(this.§8Q§)
         {
            ...
            case 1:
               return this.m_v1.§"S§;
            case 2:
               return new b2Vec2(this.m_v1.a * this.m_v1.§"S§.x + this.m_v2.a * this.m_v2.§"S§.x,this.m_v1.a * this.m_v1.§"S§.y + this.m_v2.a * this.m_v2.§"S§.y);
            default:
               b2Settings.b2Assert(false);
               return new b2Vec2();
         }
      ...
      public function §]!5§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§8Q§)
         {
            ...
            case 1:
               ...
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§7!C§.x + this.m_v2.a * this.m_v2.§7!C§.x;
               param1.y = this.m_v1.a * this.m_v1.§7!C§.y + this.m_v2.a * this.m_v2.§7!C§.y;
               param2.x = this.m_v1.a * this.m_v1.§>!c§.x + this.m_v2.a * this.m_v2.§>!c§.x;
               param2.y = this.m_v1.a * this.m_v1.§>!c§.y + this.m_v2.a * this.m_v2.§>!c§.y;
               break;
            case 3:
               param2.x = param1.x = this.m_v1.a * this.m_v1.§7!C§.x + this.m_v2.a * this.m_v2.§7!C§.x + this.m_v3.a * this.m_v3.§7!C§.x;
               param2.y = param1.y = this.m_v1.a * this.m_v1.§7!C§.y + this.m_v2.a * this.m_v2.§7!C§.y + this.m_v3.a * this.m_v3.§7!C§.y;
               break;
            default:
               b2Settings.b2Assert(false);
         }
      ...
      public function §2!`§() : Number
      {
         switch(this.§8Q§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§>G§(this.m_v1.§"S§,this.m_v2.§"S§).§-l§();
            case 3:
               return b2Math.§#!9§(b2Math.§>G§(this.m_v2.§"S§,this.m_v1.§"S§),b2Math.§>G§(this.m_v3.§"S§,this.m_v1.§"S§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc5_:Number = b2Math.§1!P§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§1!P§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§>G§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§1!P§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§1!P§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§>G§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§1!P§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§1!P§(_loc3_,_loc14_);
