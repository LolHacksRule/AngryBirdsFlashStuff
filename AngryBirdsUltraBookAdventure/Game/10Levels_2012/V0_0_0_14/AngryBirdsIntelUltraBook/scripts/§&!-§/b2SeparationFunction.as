   ...
   class b2SeparationFunction
   {
      ...
      public function §7R§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         if(_loc6_ == 1)
         {
            ...
            this.§9u§.x = _loc15_ - _loc13_;
            this.§9u§.y = _loc16_ - _loc14_;
            this.§9u§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§"!1§ = §@!`§;
            _loc8_ = this.§<n§.§#I§(param1.indexA[0]);
         ...
         else
         {
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§5L§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§5L§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         switch(this.§"!1§)
         {
            case §,!9§:
               ...
               return Number(((_loc8_ = b2Math.§,^§(param2,_loc6_)).x - _loc7_.x) * this.§9u§.x + (_loc8_.y - _loc7_.y) * this.§9u§.y);
            case §@!`§:
