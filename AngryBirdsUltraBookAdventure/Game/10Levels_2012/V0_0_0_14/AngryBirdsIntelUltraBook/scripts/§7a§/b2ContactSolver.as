package §7a§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §[Y§:b2WorldManifold = new b2WorldManifold();
      
      private static var §#§:b2PositionSolverManifold = new b2PositionSolverManifold();
       
      
      private var §@!A§:b2TimeStep;
      ...
      {
         this.§@!A§ = new b2TimeStep();
         this.§!F§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §7R§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§48§;
            _loc10_ = _loc5_.§[=§;
            _loc11_ = _loc9_.§>!C§;
            _loc12_ = _loc10_.§>!C§;
            _loc13_ = _loc11_.§6q§;
            ...
            _loc17_ = _loc5_.§[2§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§&w§(),_loc10_.§&w§());
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§,O§(),_loc10_.§,O§());
            _loc20_ = _loc15_.§9!§.x;
            _loc21_ = _loc15_.§9!§.y;
            _loc22_ = _loc16_.§9!§.x;
            _loc23_ = _loc16_.§9!§.y;
            ...
            b2Settings.b2Assert(_loc17_.§]B§ > 0);
            §[Y§.§7R§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §[Y§.§=![§.x;
            _loc27_ = §[Y§.§=![§.y;
            (_loc28_ = this.§!F§[_loc6_]).§-!O§ = _loc15_;
            _loc28_.§3!u§ = _loc16_;
            _loc28_.§<I§ = _loc17_;
            _loc28_.normal.x = _loc26_;
            _loc28_.normal.y = _loc27_;
            _loc28_.§6Y§ = _loc17_.§]B§;
            _loc28_.friction = _loc18_;
            _loc28_.restitution = _loc19_;
            _loc28_.§^@§.x = _loc17_.§0!?§.x;
            _loc28_.§^@§.y = _loc17_.§0!?§.y;
            _loc28_.localPoint.x = _loc17_.m_localPoint.x;
            _loc28_.localPoint.y = _loc17_.m_localPoint.y;
            _loc28_.radius = _loc13_ + _loc14_;
            _loc28_.type = _loc17_.§"!1§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§6Y§)
            {
               _loc30_ = _loc17_.§<8§[_loc29_];
               (_loc31_ = _loc28_.§@a§[_loc29_]).normalImpulse = _loc30_.§9!s§;
               _loc31_.tangentImpulse = _loc30_.§[&§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§7!D§.x = §[Y§.§<8§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§7!D§.y = §[Y§.§<8§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§`A§.x = §[Y§.§<8§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§`A§.y = §[Y§.§<8§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§1!X§ + _loc16_.§1!X§ + _loc15_.§^!B§ * _loc36_ + _loc16_.§^!B§ * _loc37_;
               _loc31_.§>!H§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§#K§ * _loc15_.§1!X§ + _loc16_.§#K§ * _loc16_.§1!X§) + (_loc15_.§#K§ * _loc15_.§^!B§ * _loc36_ + _loc16_.§#K§ * _loc16_.§^!B§ * _loc37_);
               _loc31_.§4!2§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§1!X§ + _loc16_.§1!X§ + _loc15_.§^!B§ * _loc42_ + _loc16_.§^!B§ * _loc43_;
               _loc31_.§^&§ = 1 / _loc44_;
               _loc31_.§ !R§ = 0;
            ...
            if(_loc28_.§6Y§ == 2)
            {
               ...
               _loc52_ = _loc16_.§1!X§;
               _loc53_ = _loc16_.§^!B§;
               _loc54_ = _loc48_.§7!D§.x * _loc27_ - _loc48_.§7!D§.y * _loc26_;
               _loc55_ = _loc48_.§`A§.x * _loc27_ - _loc48_.§`A§.y * _loc26_;
               _loc56_ = _loc49_.§7!D§.x * _loc27_ - _loc49_.§7!D§.y * _loc26_;
               _loc57_ = _loc49_.§`A§.x * _loc27_ - _loc49_.§`A§.y * _loc26_;
         ...
         while(_loc5_ < this.§?!v§)
         {
            ...
            if(param1.§9!G§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§7!D§.x * _loc22_ - _loc20_.§7!D§.y * _loc21_);
                  _loc7_.§9!§.x -= _loc9_ * _loc21_;
                  _loc7_.§9!§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§`A§.x * _loc22_ - _loc20_.§`A§.y * _loc21_);
                  _loc8_.§9!§.x += _loc11_ * _loc21_;
                  _loc8_.§9!§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§?!v§)
         {
            _loc26_ = (_loc25_ = this.§!F§[_loc24_]).§-!O§;
            _loc27_ = _loc25_.§3!u§;
            ...
            _loc1_ = 0;
            while(_loc1_ < _loc25_.§6Y§)
            {
               _loc2_ = _loc25_.§@a§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§`A§.y - _loc30_.x + _loc28_ * _loc2_.§7!D§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§`A§.x - _loc30_.y - _loc28_ * _loc2_.§7!D§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§^&§ * -_loc10_;
               _loc12_ = _loc40_ * _loc2_.normalImpulse;
               _loc14_ = (_loc11_ = (_loc13_ = b2Math.§5L§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_)) - _loc2_.tangentImpulse) * _loc38_;
               _loc15_ = _loc11_ * _loc39_;
               _loc30_.x -= _loc32_ * _loc14_;
               _loc30_.y -= _loc32_ * _loc15_;
               _loc28_ -= _loc33_ * (_loc2_.§7!D§.x * _loc15_ - _loc2_.§7!D§.y * _loc14_);
               _loc31_.x += _loc34_ * _loc14_;
               _loc31_.y += _loc34_ * _loc15_;
               _loc29_ += _loc35_ * (_loc2_.§`A§.x * _loc15_ - _loc2_.§`A§.y * _loc14_);
            ...
            if(_loc25_.§6Y§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§>!H§ * (_loc9_ - _loc2_.§ !R§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§`A§.y - _loc30_.x + _loc28_ * _loc43_.§7!D§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§`A§.x - _loc30_.y - _loc28_ * _loc43_.§7!D§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§`A§.y - _loc30_.x + _loc28_ * _loc44_.§7!D§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§`A§.x - _loc30_.y - _loc28_ * _loc44_.§7!D§.x;
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§7!D§.x * _loc19_ - _loc43_.§7!D§.y * _loc18_ + _loc44_.§7!D§.x * _loc21_ - _loc44_.§7!D§.y * _loc20_);
                  _loc31_.x += _loc34_ * (_loc18_ + _loc20_);
                  _loc31_.y += _loc34_ * (_loc19_ + _loc21_);
                  _loc29_ += _loc35_ * (_loc43_.§`A§.x * _loc19_ - _loc43_.§`A§.y * _loc18_ + _loc44_.§`A§.x * _loc21_ - _loc44_.§`A§.y * _loc20_);
      ...
      public function §;d§() : void
      {
         ...
         while(_loc1_ < this.§?!v§)
         {
            ...
            _loc3_ = _loc2_.§<I§;
            _loc4_ = 0;
            while(_loc4_ < _loc2_.§6Y§)
            {
               _loc5_ = _loc3_.§<8§[_loc4_];
               _loc6_ = _loc2_.§@a§[_loc4_];
               _loc5_.§9!s§ = _loc6_.normalImpulse;
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§?!v§)
         {
            _loc5_ = (_loc4_ = this.§!F§[_loc3_]).§-!O§;
            _loc6_ = _loc4_.§3!u§;
            _loc7_ = _loc5_.§#K§ * _loc5_.§1!X§;
            _loc8_ = _loc5_.§#K§ * _loc5_.§^!B§;
            _loc9_ = _loc6_.§#K§ * _loc6_.§1!X§;
            _loc10_ = _loc6_.§#K§ * _loc6_.§^!B§;
            §#§.§7R§(_loc4_);
            _loc11_ = §#§.§=![§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§6Y§)
            {
               ...
               _loc20_ = b2Math.§5L§(param1 * (_loc15_ + b2Settings.b2_linearSlop),-b2Settings.b2_maxLinearCorrection,0);
