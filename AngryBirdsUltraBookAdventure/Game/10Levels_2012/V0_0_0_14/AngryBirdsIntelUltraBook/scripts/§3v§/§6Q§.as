                              ...
                              while(true)
                              {
                                 ...
                                 while(true)
                                 {
                                    ...
                                    while(true)
                                    {
                                       ...
                                       addr181:
                                       loop29:
                                       for(; !(_loc1_ && §6Q§); if(!(_loc2_ || _loc1_))
                                       {
                                          continue;
                                       },§§goto(addr91))
                                       {
                                                               ...
                                                               while(_loc2_)
                                                               {
                                                                  ...
                                                                  while(true)
                                                                  {
                                                                     ...
                                                                     while(true)
                                                                     {
                                                                        ...
                                                                        while(true)
                                                                        {
                                                                           §6F§ = "Effect_Pig_Destruction_Headshot";
                                                                           loop14:
                                                                           while(true)
                                                                           {
                                       ...
                                       while(!(_loc7_ && param1))
                                       {
                                          if(§§pop() == §§pop())
                                          {
                                             if(!_loc7_)
                                             {
                                                ...
                                                while(true)
                                                {
                                                   §§pop().alpha = Math.max(0,Math.min(1,2 * §4!u§.§4!W§((this.§87§ - this.§1!<§) / this.§87§,false)));
                                                   loop6:
                                                   while(!_loc7_)
                                                   {
                                                      if(_loc8_)
                                                      {
                                                         §§push(Math.atan2(-this.§;E§,this.§^y§) * (180 / Math.PI));
                                                         if(_loc8_)
                                                         {
                                                            if(_loc8_)
                                                            {
                                                                                 ...
                                                                                 if(!(_loc7_ && param1))
                                                                                 {
                                                                                    if(_loc8_ || _loc2_)
                                                                                    {
                                                                                       ...
                                                                                       })
                                                                                       {
                                                                                          ...
                                                                                          while(!_loc7_)
                                                                                          {
                                                                                             §§pop().scaleX = Math.max(0.2,this.§0!<§.alpha);
                                                                                             if(!_loc7_)
                                                                                             {
                                                                                                §§push(this.§0!<§);
                                                                                                loop9:
                                                                                                while(true)
                                                                                                {
                                                                                                   if(_loc8_)
                                                                                                   {
                                                                                                      §§pop().scaleY = Math.max(0.2,this.§0!<§.alpha);
                                                                                                      if(_loc7_ && _loc3_)
                                                                                                      {
                                                                                                         break;
                                                                                                      }
