package §4!S§
{
   ...
   public class §=P§
   {
      ...
      private static var § U§:Array = §4!p§();
      ...
      private static function §4!p§() : Array
      {
         var _loc2_:uint = 0;
         var _loc3_:uint = 0;
         var _loc4_:uint = 0;
      ...
      public static function §>K§(param1:ByteArray, param2:uint = 0, param3:uint = 0) : uint
      {
         ...
         while(_loc4_ < param3)
         {
            _loc5_ = uint(§ U§[(_loc5_ ^ param1[_loc4_]) & 255]) ^ _loc5_ >>> 8;
            _loc4_++;
         }
         return _loc5_ ^ 4294967295;
      }
      
      public static function §]!a§(param1:ByteArray, param2:uint = 0, param3:uint = 0) : uint
      {
         if(param2 >= param1.length)
         {
            param2 = param1.length;
