package com.angrybirds.friendsbar
{
   ...
   public class §&E§ extends Sprite
   {
      ...
      
      {
         ...
         if(_loc2_ || §&E§)
         {
            §'g§ = "SidebarButtonStateInfo";
            while(true)
            {
               §4!3§ = "SidebarButtonStatePlay";
               while(!_loc1_)
               {
                  §"!0§ = "SidebarButtonStateNone";
                  if(_loc2_)
                  {
                     return;
                     addr45:
                                                ...
                                                if(_loc2_ || _loc1_)
                                                {
                                                   ...
                                                   if(!(_loc3_ && _loc3_))
                                                   {
                                                      ...
                                                      if(_loc2_ || _loc2_)
                                                      {
                                                         ...
                                                         §§pop().§!!g§.btnFullscreen.addEventListener(MouseEvent.CLICK,this.§0R§);
                                                         break loop20;
                                                         addr240:
                                                         addr420:
                                                      }
                                                   ...
                                                   addr290:
                                                   §§pop().scrollerSprite.addEventListener(§[0§.§3n§,this.§>!T§);
                                                   loop2:
                                                   while(!(_loc3_ && _loc2_))
                                                   {
                                                      §§push(this.§%k§);
                                                      ...
                                                      while(true)
                                                      {
                                                         ...
                                                         while(true)
                                                         {
                                                            §§pop().addEventListener(§7!]§.§?X§,this.§,!8§);
                                                            addr284:
                                                            addr241:
                                                            while(true)
                                                            {
                                                                  ...
                                                                  while(true)
                                                                  {
                                                                     ...
                                                                     if(!(_loc3_ && _loc3_))
                                                                     {
                                                                        ...
                                                                        if(!(_loc3_ && _loc2_))
                                                                        {
                                                                           ...
                                                                           {
                                                                              addr323:
                                                                              §§pop().§]!t§.addEventListener(MouseEvent.CLICK,this.§1s§);
                                                                              break loop2;
                                                                           }
                                                                           §§goto(addr401);
                                                                        }
                                                                        while(true)
                                                                        {
                                                                           §§pop().§!!g§.btnSound.addEventListener(MouseEvent.CLICK,this.§ !h§);
                                                                           break loop11;
                                                                        }
                                                                        addr380:
                                                                     }
                                                                     ...
                                                                     while(_loc2_)
                                                                     {
                                                                        §§pop().§!!g§.btnTutorial.addEventListener(MouseEvent.CLICK,this.§]!l§);
                                                                        continue loop11;
                                                                     }
                                                                     while(true)
                                                                     {
                                                                        §§pop().§!!g§.btnInfo.addEventListener(MouseEvent.CLICK,this.§^!w§);
                                                                        addr362:
                                                                        while(!(_loc3_ && this))
                                                                        {
                                                                           if(!(_loc3_ && _loc3_))
                           ...
                           while(true)
                           {
                              ...
                              while(true)
                              {
                                 ...
                                 while(true)
                                 {
                                    ...
                                    loop13:
                                    for(; !_loc2_; SimpleButton(this.§60§.§!!g§.btnTutorial).mouseEnabled = param1 == §"!0§ ? false : true,if(!_loc3_)
                                    {
                                       continue;
                                    },if(!_loc2_)
                                    {
                     ...
                     if(§§pop().data.indexOf(_loc2_) != -1)
                     {
                        while(true)
                        {
                           ...
                           while(true)
                           {
                              ...
                              while(true)
                              {
                                 §§pop().data.splice(this.§%k§.§^"§().data.indexOf(_loc2_),1);
                                 addr203:
                                 while(true)
                                 {
                                 }
                                                         ...
                                                         if(!(_loc3_ && this))
                                                         {
                                                            ...
                                                            while(true)
                                                            {
                                                               if(_loc4_)
                                                               {
                                                                  ...
                                                                  while(true)
                                                                  {
                                                                     §§pop().data.splice(this.§,!u§.data.indexOf(_loc2_),1);
                                                                     §§goto(addr130);
                                                                  }
                                                                  addr132:
                                                               }
      ...
      private function resize(param1:Number) : void
      {
         ...
         if(!_loc4_)
         {
            ...
            while(true)
            {
               §§pop().§3!H§.height = _loc2_ - this.§60§.§'!>§.height - this.§60§.§-T§.height + 5;
               addr130:
               while(true)
               {
                  §§push(this.§60§);
                  ...
                  while(true)
                  {
                     §§pop().§-T§.y = this.§60§.§3!H§.y + this.§60§.§3!H§.height;
                     addr112:
                     while(true)
                     {
                        addr55:
               ...
               §§pop().§!!g§.y = this.§60§.§-T§.y + 55;
               loop6:
               for(; !(_loc4_ && _loc3_); §§pop().§'>§.y = this.§60§.§-T§.y + 45,if(!(_loc5_ || param1))
               {
                  continue;
               },if(!_loc4_)
               {
               ...
               },§§goto(addr101))
               {
                  ...
                  if(!_loc4_)
                  {
                     §§push(this.§60§.§-T§.height - 30);
                     if(!_loc4_)
                     {
                        §§push(§§pop() + this.§60§.§'!>§.height - 30);
                     }
                     §§push(§§pop() - §§pop());
                     if(!(_loc4_ && param1))
                     {
                  ...
                  while(true)
                  {
                     ...
                     while(true)
                     {
                        ...
                        while(true)
                        {
                           ...
                           while(true)
                           {
                              §§push(int(Math.floor(this.§,!U§.§'!V§ / 2)));
                              loop6:
                              while(true)
                              {
                                 if(_loc7_)
      ...
      private function §&!d§() : void
      {
         ...
         var _loc1_:* = §§pop();
         §§push(this.§,!U§.offset == this.§,!U§.data.length - this.§,!U§.§'!V§);
         if(!(_loc3_ && _loc1_))
         {
            §§push(!§§pop());
         }
      ...
      public function §3!U§(param1:String, param2:int, param3:int, param4:int, param5:Array, param6:Boolean = false) : int
      {
         ...
         if(_loc13_ || param3)
         {
            ...
            §§push(this.§,!u§.§3!U§(param2,param3,param4,_loc7_));
            if(_loc13_)
            {
               §§push(int(§§pop()));
            }
      ...
      public function §'!O§(param1:int) : void
      {
         ...
         if(_loc6_ || _loc2_)
         {
            if(param1 != 0)
            {
               ...
               while(true)
               {
                  §§pop().§!!g§.txtInboxItemCount.visible = true;
                  loop1:
                  while(true)
                  {
                     if(_loc6_)
                     {
                        ...
                        if(_loc6_ || this)
                        {
                           §§pop().§!!g§.mcItemCountBg.visible = true;
                           loop2:
                           while(true)
                           {
                              if(!_loc6_)
                           ...
                           §§pop().§!!g§.mcItemCountBg.visible = false;
                           §§goto(addr137);
                        }
                     }
                     else
                     {
                        ...
                        if(!(_loc5_ && this))
                        {
                           §§pop().§!!g§.txtInboxItemCount.visible = false;
                           §§goto(addr154);
                        }
                        else
                        {
                           addr157:
                           _loc3_ = §§pop().§!!g§.mcItemCountBg;
                           if(!(_loc5_ && this))
                           {
                              _loc4_ = _loc3_.width;
                              loop5:
