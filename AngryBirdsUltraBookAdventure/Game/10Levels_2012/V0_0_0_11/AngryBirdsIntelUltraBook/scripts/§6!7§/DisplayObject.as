package §6!7§
{
   ...
   public class DisplayObject extends EventDispatcher
   {
      ...
      public function DisplayObject()
      {
         ...
         this.§`!%§ = this.§else§ = this.§0!>§ = this.§+<§ = this.§1!8§ = 0;
         this.§?@§ = this.§-Z§ = this.§7!T§ = 1;
      ...
      public function §[!4§(param1:DisplayObject, param2:Matrix = null) : Matrix
      {
         ...
         if(param1 == this.§+w§ || param1 == null && this.§+w§ == null)
         {
            ...
            {
               param2.translate(this.§`!%§,this.§else§);
            }
            return param2;
         }
         if(param1 == null)
      ...
      {
         if(this.§1!8§ == 0 && this.§?@§ == 1 && this.§-Z§ == 1)
         {
            if(this.§`!%§ + this.§0!>§ != 0 || this.§else§ + this.§+<§ != 0)
            {
      ...
      {
         this.§7!T§ = param1 < 0 ? Number(0) : (param1 > 1 ? Number(1) : Number(param1));
      }
