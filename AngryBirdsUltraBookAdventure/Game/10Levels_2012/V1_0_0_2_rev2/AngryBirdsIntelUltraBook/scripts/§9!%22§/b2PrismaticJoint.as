package §9!"§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§,!2§.x * this.§^^§.x + (this.§8t§ + this.§,!2§.z) * this.§]]§.x),param1 * (this.§,!2§.x * this.§^^§.y + (this.§8t§ + this.§,!2§.z) * this.§]]§.y));
      }
      ...
      public function §<!0§() : Number
      {
         ...
         var _loc8_:b2Vec2;
         return Number((_loc8_ = _loc1_.§!!U§(this.§;!3§)).x * _loc6_ + _loc8_.y * _loc7_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§5,§)
         {
            ...
            if(b2Math.§-n§(this.§9D§ - this.§,8§) < 2 * b2Settings.b2_linearSlop)
            {
               this.§>!X§ = b2internal::'!E;
            }
         ...
         if(param1.§[8§)
         {
            ...
            this.§,!2§.y *= param1.§87§;
            this.§8t§ *= param1.§87§;
            _loc19_ = this.§,!2§.x * this.§^^§.x + (this.§8t§ + this.§,!2§.z) * this.§]]§.x;
            _loc20_ = this.§,!2§.x * this.§^^§.y + (this.§8t§ + this.§,!2§.z) * this.§]]§.y;
            _loc21_ = this.§,!2§.x * this.m_s1 + this.§,!2§.y + (this.§8t§ + this.§,!2§.z) * this.m_a1;
            _loc22_ = this.§,!2§.x * this.m_s2 + this.§,!2§.y + (this.§8t§ + this.§,!2§.z) * this.m_a2;
            _loc2_.§^O§.x -= b2internal::9k * _loc19_;
            _loc2_.§^O§.y -= b2internal::9k * _loc20_;
            _loc2_.m_angularVelocity -= b2internal::8- * _loc21_;
            _loc3_.§^O§.x += b2internal::,!J * _loc19_;
            _loc3_.§^O§.y += b2internal::,!J * _loc20_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§-!>§ && this.§>!X§ != b2internal::'!E)
         {
            ...
            _loc15_ = this.§<M§ * (this.§&?§ - _loc14_);
            _loc16_ = this.§8t§;
            _loc17_ = param1.§^Z§ * this.§&e§;
            this.§8t§ = b2Math.§]#§(this.§8t§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§8t§ - _loc16_) * this.§]]§.x;
            _loc9_ = _loc15_ * this.§]]§.y;
            _loc10_ = _loc15_ * this.m_a1;
            _loc11_ = _loc15_ * this.m_a2;
            _loc4_.x -= b2internal::9k * _loc8_;
            _loc4_.y -= b2internal::9k * _loc9_;
            _loc5_ -= b2internal::8- * _loc10_;
            _loc6_.x += b2internal::,!J * _loc8_;
            _loc6_.y += b2internal::,!J * _loc9_;
         ...
         if(this.§5,§ && this.§>!X§ != b2internal::+!t)
         {
            ...
            if(this.§>!X§ == b2internal::1!i)
            {
               this.§,!2§.z = b2Math.§0!_§(this.§,!2§.z,0);
            }
            else if(this.§>!X§ == b2internal::#!F)
            {
               this.§,!2§.z = b2Math.§>M§(this.§,!2§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§,!2§.z - _loc19_.z) * this.§^!u§.col3.x;
            _loc22_ = -_loc13_ - (this.§,!2§.z - _loc19_.z) * this.§^!u§.col3.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§5,§)
         {
            ...
            if(b2Math.§-n§(this.§9D§ - this.§,8§) < 2 * b2Settings.b2_linearSlop)
            {
               ...
               _loc16_ = b2Math.§-n§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§,8§)
            {
               _loc19_ = b2Math.§]#§(_loc35_ - this.§,8§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§,8§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§9D§)
            {
               _loc19_ = b2Math.§]#§(_loc35_ - this.§9D§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§9D§;
               _loc18_ = true;
            }
         }
         this.§^^§ = b2Math.§'q§(_loc20_,this.§"A§);
         ...
         _loc16_ = b2Math.§0!_§(_loc16_,b2Math.§-n§(_loc29_));
         _loc17_ = b2Math.§-n§(_loc30_);
         if(_loc18_)
         {
            _loc12_ = b2internal::9k;
            _loc13_ = b2internal::,!J;
         ...
         _loc6_.x -= b2internal::9k * _loc31_;
         _loc6_.y -= b2internal::9k * _loc32_;
         _loc7_ -= b2internal::8- * _loc33_;
         _loc8_.x += b2internal::,!J * _loc31_;
         _loc8_.y += b2internal::,!J * _loc32_;
