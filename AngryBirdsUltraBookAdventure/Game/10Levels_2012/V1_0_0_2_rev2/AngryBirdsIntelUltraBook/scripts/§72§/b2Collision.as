package §72§
{
   ...
   public class b2Collision
   {
      ...
      private static var §0!p§:Vector.<§=8§> = §!!8§();
      
      private static var s_clipPoints1:Vector.<§=8§> = §!!8§();
      
      private static var s_clipPoints2:Vector.<§=8§> = §!!8§();
      
      private static var §<!P§:Vector.<int> = new Vector.<int>(1);
      
      private static var §?!N§:Vector.<int> = new Vector.<int>(1);
      
      private static var §3!0§:b2Vec2 = new b2Vec2();
      ...
      public static function §%!8§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §<!P§[0] = _loc8_;
         var _loc9_:Number = § !g§(§<!P§,param2,param3,param4,param5);
         _loc8_ = §<!P§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §?!N§[0] = _loc10_;
         var _loc11_:Number = § !g§(§?!N§,param4,param5,param2,param3);
         _loc10_ = §?!N§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §3!0§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §@!w§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §5%§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
