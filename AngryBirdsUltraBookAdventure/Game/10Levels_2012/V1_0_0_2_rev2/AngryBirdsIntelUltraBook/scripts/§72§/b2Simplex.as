package §72§
{
   ...
   class b2Simplex
   {
      ...
      public function §`!o§() : b2Vec2
      {
         ...
         switch(this.§9s§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§0M§(_loc1_,this.m_v1.§^N§.§@H§());
               if(_loc2_ > 0)
               {
      ...
      public function §"!C§() : b2Vec2
      {
         switch(this.§9s§)
         {
            ...
            case 1:
               return this.m_v1.§^N§;
            case 2:
               return new b2Vec2(this.m_v1.a * this.m_v1.§^N§.x + this.m_v2.a * this.m_v2.§^N§.x,this.m_v1.a * this.m_v1.§^N§.y + this.m_v2.a * this.m_v2.§^N§.y);
            default:
               b2Settings.b2Assert(false);
               return new b2Vec2();
         }
      ...
      public function §-K§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§9s§)
         {
            ...
            case 1:
               ...
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§[!r§.x + this.m_v2.a * this.m_v2.§[!r§.x;
               param1.y = this.m_v1.a * this.m_v1.§[!r§.y + this.m_v2.a * this.m_v2.§[!r§.y;
               param2.x = this.m_v1.a * this.m_v1.§3!$§.x + this.m_v2.a * this.m_v2.§3!$§.x;
               param2.y = this.m_v1.a * this.m_v1.§3!$§.y + this.m_v2.a * this.m_v2.§3!$§.y;
               break;
            case 3:
               param2.x = param1.x = this.m_v1.a * this.m_v1.§[!r§.x + this.m_v2.a * this.m_v2.§[!r§.x + this.m_v3.a * this.m_v3.§[!r§.x;
               param2.y = param1.y = this.m_v1.a * this.m_v1.§[!r§.y + this.m_v2.a * this.m_v2.§[!r§.y + this.m_v3.a * this.m_v3.§[!r§.y;
               break;
            default:
               b2Settings.b2Assert(false);
         }
      ...
      public function §`!7§() : Number
      {
         switch(this.§9s§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§54§(this.m_v1.§^N§,this.m_v2.§^N§).§>!7§();
            case 3:
               return b2Math.§0M§(b2Math.§54§(this.m_v2.§^N§,this.m_v1.§^N§),b2Math.§54§(this.m_v3.§^N§,this.m_v1.§^N§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc5_:Number = b2Math.§'l§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§'l§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§54§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§'l§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§'l§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§54§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§'l§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§'l§(_loc3_,_loc14_);
         var _loc18_:Number = -_loc15_;
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§0M§(_loc4_,_loc9_)) * b2Math.§0M§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§0M§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§0M§(_loc1_,_loc2_);
