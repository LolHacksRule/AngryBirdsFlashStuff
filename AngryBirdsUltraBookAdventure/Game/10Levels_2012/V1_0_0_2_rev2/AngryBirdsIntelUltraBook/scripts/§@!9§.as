package
{
   ...
   public class §@!9§ extends AngryBirdsFP11
   {
      ...
      public static const §<!a§:String = "1.0.0.2 r97344)";
      ...
      public function §@!9§(param1:§,6§)
      {
         ...
         §8!`§ = param1.stage.loaderInfo.parameters.serverRoot || (!!§[!d§ ? "http://head-dot-ab-in-adventure.appspot.com" : "http://head-dot-ab-in-adventure.appspot.com");
         super(param1);
         §6!f§ = this;
         §'N§.§var §(§'W§.§[!#§);
