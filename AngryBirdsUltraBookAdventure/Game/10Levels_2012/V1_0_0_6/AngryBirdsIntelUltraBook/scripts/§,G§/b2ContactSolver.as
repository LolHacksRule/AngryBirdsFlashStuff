package §,G§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §@x§:b2PositionSolverManifold = new b2PositionSolverManifold();
      ...
      public function §'K§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§7!a§ = param4;
         this.§=z§ = param3;
         while(this.§#!8§.length < this.§=z§)
         {
            this.§#!8§[this.§#!8§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§3t§;
            _loc10_ = _loc5_.§[i§;
            _loc11_ = _loc9_.§"!w§;
            _loc12_ = _loc10_.§"!w§;
            _loc13_ = _loc11_.§?!X§;
            ...
            b2Settings.b2Assert(_loc17_.§2V§ > 0);
            §!6§.§'K§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §!6§.§-n§.x;
            _loc27_ = §!6§.§-n§.y;
            (_loc28_ = this.§#!8§[_loc6_]).§0w§ = _loc15_;
            _loc28_.§^2§ = _loc16_;
            _loc28_.§0q§ = _loc17_;
            ...
            _loc28_.§[!<§.x = _loc17_.§6O§.x;
            _loc28_.§[!<§.y = _loc17_.§6O§.y;
            ...
            {
               _loc30_ = _loc17_.§4!a§[_loc29_];
               (_loc31_ = _loc28_.§7!4§[_loc29_]).normalImpulse = _loc30_.§-!s§;
               _loc31_.tangentImpulse = _loc30_.§%%§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§2o§.x = §!6§.§4!a§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§2o§.y = §!6§.§4!a§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§ ;§.x = §!6§.§4!a§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§ ;§.y = §!6§.§4!a§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§-7§ + _loc16_.§-7§ + _loc15_.§,!o§ * _loc36_ + _loc16_.§,!o§ * _loc37_;
               _loc31_.§`!C§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§ ,§ * _loc15_.§-7§ + _loc16_.§ ,§ * _loc16_.§-7§) + (_loc15_.§ ,§ * _loc15_.§,!o§ * _loc36_ + _loc16_.§ ,§ * _loc16_.§,!o§ * _loc37_);
               _loc31_.§;§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§-7§ + _loc16_.§-7§ + _loc15_.§,!o§ * _loc42_ + _loc16_.§,!o§ * _loc43_;
               _loc31_.§;h§ = 1 / _loc44_;
               _loc31_.§73§ = 0;
               ...
               {
                  _loc31_.§73§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§@!#§ == 2)
            {
               _loc48_ = _loc28_.§7!4§[0];
               _loc49_ = _loc28_.§7!4§[1];
               _loc50_ = _loc15_.§-7§;
               _loc51_ = _loc15_.§,!o§;
               _loc52_ = _loc16_.§-7§;
               _loc53_ = _loc16_.§,!o§;
               _loc54_ = _loc48_.§2o§.x * _loc27_ - _loc48_.§2o§.y * _loc26_;
               _loc55_ = _loc48_.§ ;§.x * _loc27_ - _loc48_.§ ;§.y * _loc26_;
               _loc56_ = _loc49_.§2o§.x * _loc27_ - _loc49_.§2o§.y * _loc26_;
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         while(_loc5_ < this.§=z§)
         {
            ...
            if(param1.§#!P§)
            {
               ...
               {
                  _loc20_ = _loc6_.§7!4§[_loc18_];
                  _loc20_.normalImpulse *= param1.§ !o§;
                  _loc20_.tangentImpulse *= param1.§ !o§;
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§2o§.x * _loc22_ - _loc20_.§2o§.y * _loc21_);
                  _loc7_.§%!V§.x -= _loc9_ * _loc21_;
                  _loc7_.§%!V§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§ ;§.x * _loc22_ - _loc20_.§ ;§.y * _loc21_);
                  _loc8_.§%!V§.x += _loc11_ * _loc21_;
                  _loc8_.§%!V§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  (_loc23_ = _loc6_.§7!4§[_loc18_]).normalImpulse = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§=z§)
         {
            _loc26_ = (_loc25_ = this.§#!8§[_loc24_]).§0w§;
            _loc27_ = _loc25_.§^2§;
            ...
            {
               _loc2_ = _loc25_.§7!4§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§ ;§.y - _loc30_.x + _loc28_ * _loc2_.§2o§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§ ;§.x - _loc30_.y - _loc28_ * _loc2_.§2o§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§;h§ * -_loc10_;
               ...
               _loc28_ -= _loc33_ * (_loc2_.§2o§.x * _loc15_ - _loc2_.§2o§.y * _loc14_);
            ...
            if(_loc25_.§@!#§ == 1)
            {
               _loc2_ = _loc25_.§7!4§[0];
               _loc7_ = _loc31_.x + -_loc29_ * _loc2_.§ ;§.y - _loc30_.x - -_loc28_ * _loc2_.§2o§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§ ;§.x - _loc30_.y - _loc28_ * _loc2_.§2o§.x;
               _loc9_ = _loc7_ * _loc36_ + _loc8_ * _loc37_;
               _loc11_ = -_loc2_.§`!C§ * (_loc9_ - _loc2_.§73§);
            ...
            {
               _loc43_ = _loc25_.§7!4§[0];
               _loc44_ = _loc25_.§7!4§[1];
               _loc45_ = _loc43_.normalImpulse;
               _loc46_ = _loc44_.normalImpulse;
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§ ;§.y - _loc30_.x + _loc28_ * _loc43_.§2o§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§ ;§.x - _loc30_.y - _loc28_ * _loc43_.§2o§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§ ;§.y - _loc30_.x + _loc28_ * _loc44_.§2o§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§ ;§.x - _loc30_.y - _loc28_ * _loc44_.§2o§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§73§;
               _loc54_ = _loc52_ - _loc44_.§73§;
               _loc22_ = _loc25_.§&+§;
               _loc53_ -= _loc22_.col1.x * _loc45_ + _loc22_.col2.x * _loc46_;
               _loc54_ -= _loc22_.col1.y * _loc45_ + _loc22_.col2.y * _loc46_;
               _loc55_ = 0.001;
               _loc56_ = -((_loc22_ = _loc25_.§`!C§).col1.x * _loc53_ + _loc22_.col2.x * _loc54_);
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§2o§.x * _loc19_ - _loc43_.§2o§.y * _loc18_ + _loc44_.§2o§.x * _loc21_ - _loc44_.§2o§.y * _loc20_);
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§=z§)
         {
            ...
            _loc6_ = _loc4_.§^2§;
            _loc7_ = _loc5_.§ ,§ * _loc5_.§-7§;
            _loc8_ = _loc5_.§ ,§ * _loc5_.§,!o§;
            _loc9_ = _loc6_.§ ,§ * _loc6_.§-7§;
            _loc10_ = _loc6_.§ ,§ * _loc6_.§,!o§;
            §@x§.§'K§(_loc4_);
            _loc11_ = §@x§.§-n§;
            _loc12_ = 0;
