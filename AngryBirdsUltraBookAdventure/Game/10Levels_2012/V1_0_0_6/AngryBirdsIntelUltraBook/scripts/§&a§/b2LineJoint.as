package §&a§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§<<§.x * this.§9?§.x + (this.§1!'§ + this.§<<§.y) * this.§<!^§.x),param1 * (this.§<<§.x * this.§9?§.y + (this.§1!'§ + this.§<<§.y) * this.§<!^§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§#!P§)
         {
            ...
            this.§<<§.y *= param1.§ !o§;
            this.§1!'§ *= param1.§ !o§;
            _loc19_ = this.§<<§.x * this.§9?§.x + (this.§1!'§ + this.§<<§.y) * this.§<!^§.x;
            _loc20_ = this.§<<§.x * this.§9?§.y + (this.§1!'§ + this.§<<§.y) * this.§<!^§.y;
            _loc21_ = this.§<<§.x * this.m_s1 + (this.§1!'§ + this.§<<§.y) * this.m_a1;
            _loc22_ = this.§<<§.x * this.m_s2 + (this.§1!'§ + this.§<<§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§2'§ && this.§"!"§ != b2internal::`C)
         {
            ...
            _loc14_ = this.§&!w§ * (this.§0i§ - _loc13_);
            _loc15_ = this.§1!'§;
            _loc16_ = param1.§&!'§ * this.§1!W§;
            this.§1!'§ = b2Math.§]!M§(this.§1!'§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§1!'§ - _loc15_) * this.§<!^§.x;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§;!m§)
         {
            ...
            if(b2Math.§`c§(this.§>![§ - this.§;!a§) < 2 * b2Settings.b2_linearSlop)
            {
               ...
               _loc16_ = b2Math.§`c§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§;!a§)
            {
               _loc19_ = b2Math.§]!M§(_loc34_ - this.§;!a§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§;!a§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§>![§)
            {
               _loc19_ = b2Math.§]!M§(_loc34_ - this.§>![§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§%!m§.§-,§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::,';
