package §&a§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = this.§6d§.y - _loc5_.m_sweep.localCenter.y;
         ...
         if(param1.§#!P§)
         {
            ...
            this.§<<§.y *= param1.§ !o§;
            this.§<<§.z *= param1.§ !o§;
            _loc4_.§%!V§.x -= _loc10_ * this.§<<§.x;
            _loc4_.§%!V§.y -= _loc10_ * this.§<<§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§<<§.y - _loc7_ * this.§<<§.x + this.§<<§.z);
            _loc5_.§%!V§.x += _loc11_ * this.§<<§.x;
            _loc5_.§%!V§.y += _loc11_ * this.§<<§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.m_xf.R;
         var _loc8_:Number = this.§6d§.x - _loc5_.m_sweep.localCenter.x;
