package §&a§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§0K§ = b2internal::>0.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§>y§.x - this.§0K§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§>y§.y - this.§0K§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§]k§.x - this.§0K§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§]k§.y - this.§0K§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§4!%§);
         this.m_localAnchor2.SetV(param1.§=!I§);
         this.§=G§ = param1.§ N§;
         this.§?A§ = param1.§`P§ + this.§=G§ * param1.§'=§;
         this.m_maxLength1 = b2Math.§=!@§(param1.§0#§,this.§?A§ - this.§=G§ * b2internal::@!A);
         this.m_maxLength2 = b2Math.§=!@§(param1.§"!<§,(this.§?A§ - b2internal::@!A) / this.§=G§);
         this.§<<§ = 0;
      ...
      public function GetLength1() : Number
      {
         ...
         var _loc2_:Number = this.§0K§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.§0K§.m_xf.position.y + this.m_groundAnchor1.y;
      ...
      public function GetLength2() : Number
      {
         ...
         var _loc2_:Number = this.§0K§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.§0K§.m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc14_:Number = this.§0K§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.§0K§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.§0K§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.§0K§.m_xf.position.y + this.m_groundAnchor2.y;
         this.m_u1.Set(_loc10_ - _loc14_,_loc11_ - _loc15_);
         this.m_u2.Set(_loc12_ - _loc16_,_loc13_ - _loc17_);
         var _loc18_:Number = this.m_u1.§-D§();
         var _loc19_:Number = this.m_u2.§-D§();
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§?A§ - _loc18_ - this.§=G§ * _loc19_) > 0)
         {
            this.§1!f§ = b2internal::#!?;
            this.§<<§ = 0;
         }
         ...
         this.m_limitMass1 = _loc2_.§-7§ + _loc2_.§,!o§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§-7§ + _loc3_.§,!o§ * _loc22_ * _loc22_;
         this.§?!A§ = this.m_limitMass1 + this.§=G§ * this.§=G§ * this.m_limitMass2;
         ...
         {
            this.§<<§ *= param1.§ !o§;
            this.m_limitImpulse1 *= param1.§ !o§;
            this.m_limitImpulse2 *= param1.§ !o§;
            _loc23_ = (-this.§<<§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§<<§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§=G§ * this.§<<§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§=G§ * this.§<<§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§%!V§.x += _loc2_.§-7§ * _loc23_;
            _loc2_.§%!V§.y += _loc2_.§-7§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§,!o§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§%!V§.x += _loc3_.§-7§ * _loc25_;
            _loc3_.§%!V§.y += _loc3_.§-7§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = _loc4_.col1.y * _loc8_ + _loc4_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         if(this.§1!f§ == b2internal::>6)
         {
            _loc10_ = _loc2_.§%!V§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§%!V§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§%!V§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§%!V§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§=G§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§?!A§ * -_loc18_;
            _loc20_ = this.§<<§;
            this.§<<§ = b2Math.§!!X§(0,this.§<<§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§<<§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§=G§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§=G§ * _loc19_ * this.m_u2.y;
            _loc2_.§%!V§.x += _loc2_.§-7§ * _loc14_;
            _loc2_.§%!V§.y += _loc2_.§-7§ * _loc15_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal::>0;
         var _loc3_:b2Body = b2internal::[=;
         var _loc5_:Number = this.§0K§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.§0K§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.§0K§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.§0K§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         if(this.§1!f§ == b2internal::>6)
         {
            ...
            _loc19_ = this.§?A§ - _loc17_ - this.§=G§ * _loc18_;
            ...
            _loc15_ = -this.§=G§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§=G§ * _loc20_ * this.m_u2.y;
            _loc2_.m_sweep.c.x += _loc2_.§-7§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§-7§ * _loc14_;
         ...
         if(this.m_limitState1 == b2internal::>6)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§-D§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::>6)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§-D§()) > b2Settings.b2_linearSlop)
            {
