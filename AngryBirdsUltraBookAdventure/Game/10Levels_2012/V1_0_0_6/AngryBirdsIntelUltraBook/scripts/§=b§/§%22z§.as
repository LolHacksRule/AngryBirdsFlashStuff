package §=b§
{
   ...
   public class §"z§
   {
      ...
      public static function §6!,§(param1:MovieClip, param2:Boolean) : Array
      {
         ...
         _loc4_[1] = new b2Vec2(_loc3_.x * §'u§.§18§,(_loc3_.y + _loc3_.height) * §'u§.§18§);
         _loc4_[2] = new b2Vec2((_loc3_.x + _loc3_.width) * §'u§.§18§,(_loc3_.y + _loc3_.height) * §'u§.§18§);
      ...
      public static function §"!6§(param1:MovieClip, param2:Boolean) : Array
      {
         ...
         _loc3_[1] = (_loc4_.x + _loc4_.width / 2) * §'u§.§18§;
