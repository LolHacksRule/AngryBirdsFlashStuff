package §,C§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§1e§ = this.§]x§.Normalize();
         this.§-n§.Set(this.§]x§.y,-this.§]x§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§-n§.x - this.§]x§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§-n§.y - this.§]x§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§-n§.x + this.§]x§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§-n§.y + this.§]x§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§-n§;
         this.m_cornerDir2.Set(-this.§-n§.x,-this.§-n§.y);
      }
