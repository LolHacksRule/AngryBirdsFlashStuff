   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      b2internal static function §?s§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§9a§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§9a§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §<^§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§!!=§)
         {
            ...
            _loc6_ = b2Math.§9!<§(this.§%!]§[_loc5_],this.§%!]§[_loc4_]);
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§+!`§.x = _loc5_ - b2internal::?!X;
         param1.§+!`§.y = _loc6_ - b2internal::?!X;
         param1.§"W§.x = _loc7_ + b2internal::?!X;
         param1.§"W§.y = _loc8_ + b2internal::?!X;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         param1.§]J§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§93§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         while(_loc12_ < this.§!!=§)
         {
            _loc7_[_loc12_] = b2Math.§+!1§(_loc5_,this.§%!]§[_loc12_]) - _loc6_;
