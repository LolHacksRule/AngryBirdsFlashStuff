   ...
   public class §`L§
   {
      ...
      private static function §-+§() : void
      {
         ...
         for each(_loc6_ in [true,false])
         {
            ...
            _loc1_.§=!!§(§7!p§(_loc6_),_loc2_.§`!L§,_loc3_.§`!L§);
               ...
               for each(_loc9_ in [true,false])
               {
                  for each(_loc10_ in [true,false])
                  {
                     for each(_loc11_ in _loc8_)
                     {
                        ...
                        _loc1_.§=!!§(§;<§(_loc6_,_loc10_,_loc9_,_loc11_,_loc7_),_loc2_.§`!L§,_loc3_.§`!L§);
                     }
                  }
               }
            }
      ...
      public function render(param1:Context3D, param2:Matrix3D, param3:Number = 1.0) : void
      {
         ...
         var _loc5_:* = param3 != 1;
         var _loc6_:String = !!this.§+x§ ? §;<§(_loc5_,this.§+x§.mipMapping,this.§+x§.repeat,this.§4!z§,this.§#!%§) : §7!p§(_loc5_);
         §?%§.§4!s§(param1,_loc4_);
         this.§@j§(param1);
      ...
      public function §;!Z§(param1:§;R§, param2:Texture, param3:String) : Boolean
      {
         ...
         {
            return this.§+x§.root != param2.root || this.§+x§.repeat != param2.repeat || this.§4!z§ != param3 || this.§#!%§ != param1.useColor || this.§4!6§ == 8192;
         }
         if(this.§+x§ == null && param2 == null)
         {
            return false;
         }
         return this.§4!6§ != 0 || this.§#!%§ != param1.useColor;
      }
   }
}
