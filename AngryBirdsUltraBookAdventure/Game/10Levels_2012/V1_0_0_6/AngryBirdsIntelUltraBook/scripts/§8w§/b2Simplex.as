   ...
   class b2Simplex
   {
      ...
      public function §=!#§() : b2Vec2
      {
         ...
         switch(this.§1!Y§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§#R§(_loc1_,this.m_v1.§&U§.§&!+§());
               if(_loc2_ > 0)
               {
      ...
      public function §?!e§() : b2Vec2
      {
         switch(this.§1!Y§)
         {
            ...
            case 1:
               return this.m_v1.§&U§;
            case 2:
               return new b2Vec2(this.m_v1.a * this.m_v1.§&U§.x + this.m_v2.a * this.m_v2.§&U§.x,this.m_v1.a * this.m_v1.§&U§.y + this.m_v2.a * this.m_v2.§&U§.y);
            default:
               b2Settings.b2Assert(false);
               return new b2Vec2();
         }
      ...
      public function §3!l§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§1!Y§)
         {
            ...
            case 2:
               ...
               param2.x = this.m_v1.a * this.m_v1.§8!d§.x + this.m_v2.a * this.m_v2.§8!d§.x;
               param2.y = this.m_v1.a * this.m_v1.§8!d§.y + this.m_v2.a * this.m_v2.§8!d§.y;
               break;
            case 3:
      ...
      public function §&O§() : Number
      {
         switch(this.§1!Y§)
         {
            ...
            case 3:
               return b2Math.§#R§(b2Math.§9!<§(this.m_v2.§&U§,this.m_v1.§&U§),b2Math.§9!<§(this.m_v3.§&U§,this.m_v1.§&U§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
