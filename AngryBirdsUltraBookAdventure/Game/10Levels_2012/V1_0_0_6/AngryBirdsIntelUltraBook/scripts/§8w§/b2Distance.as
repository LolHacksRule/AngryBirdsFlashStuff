package §8w§
{
   ...
   public class b2Distance
   {
      ...
      public static function §3H§(param1:b2DistanceOutput, param2:b2SimplexCache, param3:b2DistanceInput) : void
      {
         ...
         var _loc15_:Number;
         var _loc14_:b2Vec2;
         var _loc16_:Number = _loc15_ = (_loc14_ = _loc8_.§?!e§()).§#-§();
         var _loc19_:int = 0;
         while(_loc19_ < 20)
         {
            _loc13_ = _loc8_.§1!Y§;
         ...
         if(param3.§5!=§)
         {
            _loc23_ = _loc4_.§?!X§;
            _loc24_ = _loc5_.§?!X§;
            if(param1.§6=§ > _loc23_ + _loc24_ && param1.§6=§ > Number.MIN_VALUE)
            {
               param1.§6=§ -= _loc23_ + _loc24_;
            ...
            {
               (_loc18_ = new b2Vec2()).x = 0.5 * (param1.§4!+§.x + param1.§!!!§.x);
               _loc18_.y = 0.5 * (param1.§4!+§.y + param1.§!!!§.y);
               param1.§4!+§.x = param1.§!!!§.x = _loc18_.x;
               param1.§4!+§.y = param1.§!!!§.y = _loc18_.y;
               param1.§6=§ = 0;
            }
         }
      }
