package §"x§
{
   ...
   public class §>!s§
   {
      ...
      public function §>!s§(param1:ByteArray, param2:String, param3:String, param4:String, param5:Function, param6:Function)
      {
         ...
         var _loc7_:String = (_loc7_ = §+!r§ + §0>§ + "?access_token=" + param3).replace("[USER_ID]",param4);
         §-8§.log("Uploading image; URL:" + _loc7_);
      ...
      {
         §-8§.log("Error!! " + param1.toString());
         §-8§.log("Data?" + param1.target.data.toString());
         if(this.§"!p§ != null)
         {
            this.§"!p§();
         }
