                                                                                          ...
                                                                                          if(§§pop().search(/^sprite_sheets\/(.*)\.json$/i) != -1)
                                                                                          {
                                                                                             if(_loc7_)
                                                                                             {
                                                                                                try
                                                                                                {
                                                                                                   ...
                                                                                                   {
                                                                                                      addr197:
                                                                                                      §§pop().§§slot[8] = JSON.parse((packageFiles[fileName] as §?K§).§'M§(false));
                                                                                                      if(!_loc6_)
                                                                                                      {
                                                                                                         this.§@!j§(jsonObject);
                                                                                                         if(_loc7_ || _loc3_)
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               if(!_loc4_)
               {
                  ...
                  while(§§pop().§`_§(§§pop(),§§pop().§§slot[2]), !(_loc3_ || param1));
            ...
            if(_loc5_)
            {
               ...
               while(true)
               {
                  ...
                  if(!_loc6_)
                  {
                     ...
                     {
                        §§pop().§§slot[3] = §>!^§;
                        for(; !(_loc6_ && this); §§pop().§`_§(§§pop(),§§pop().§§slot[2]),if(!(_loc5_ || _loc3_))
                        {
                           continue;
                        },§§goto(addr137))
                        {
