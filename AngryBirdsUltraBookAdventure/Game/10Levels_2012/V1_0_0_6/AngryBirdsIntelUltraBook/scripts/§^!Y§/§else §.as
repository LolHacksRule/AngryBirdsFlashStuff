package §^!Y§
{
   ...
   public class §else §
   {
      ...
      public function initializeAnimations(param1:Array) : void
      {
         ...
         this.§,!m§("BACKGROUND_12_LAYER_3",["BACKGROUND_12_LAYER_3"]);
         ...
         this.§,!m§("SCORE_BIRD_BLACK",["SCORE_BIRD_BLACK"]);
         this.§,!m§("SCORE_BIRD_WHITE",["SCORE_BIRD_WHITE"]);
         this.§,!m§("SCORE_BIRD_YELLOW",["SCORE_BIRD_YELLOW"]);
         this.§,!m§("SCORE_PIG",["SCORE_PIG"]);
         for each(_loc2_ in [{
            "name":"TRAIL_",
            "count":3
         },{
      ...
      {
         if(!this.§,!m§(param1,[param1 + "_1",param1 + "_2",param1 + "_3",param1 + "_4"]))
         {
            if(!this.§,!m§(param1,[param1 + "_1",param1 + "_2",param1 + "_3"]))
            {
               if(!this.§,!m§(param1,[param1 + "_1"]))
               {
                  if(this.§,!m§(param1,[param1]))
                  {
                  }
               }
            }
