package §!m§
{
   ...
   public class b2TimeOfImpact
   {
      ...
      private static var §46§:b2DistanceInput = new b2DistanceInput();
      
      private static var §,J§:b2Transform = new b2Transform();
      
      private static var §8l§:b2Transform = new b2Transform();
      ...
      public static function §@! §(param1:b2TOIInput) : Number
      {
         ...
         do
         {
            ...
            §2!$§.§2@§(§2;§,_loc2_,§,J§,_loc3_,§8l§);
            _loc12_ = §2!$§.Evaluate(§,J§,§8l§);
            if(_loc12_ <= 0)
            {
               _loc8_ = 1;
               break;
