package §!m§
{
   ...
   public class b2Collision
   {
      ...
      private static var §"!H§:Vector.<§&!W§> = §#!d§();
      
      private static var s_clipPoints1:Vector.<§&!W§> = §#!d§();
      
      private static var s_clipPoints2:Vector.<§&!W§> = §#!d§();
      
      private static var §]!f§:Vector.<int> = new Vector.<int>(1);
      
      private static var §#![§:Vector.<int> = new Vector.<int>(1);
      
      private static var §9!I§:b2Vec2 = new b2Vec2();
      ...
      public static function §8!c§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         while(true)
         {
            ...
            _loc17_ = §'!L§(param2,param3,_loc14_,param4,param5);
            if(_loc17_ <= _loc23_)
            {
               break;
            }
      ...
      public static function §^!O§(param1:Vector.<§&!W§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         _loc20_.id.features.§set § = param4;
         _loc20_.id.features.§-!A§ = _loc21_;
         _loc20_.id.features.§=!<§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.features.§set § = param4;
         _loc20_.id.features.§-!A§ = _loc22_;
         _loc20_.id.features.§=!<§ = 1;
      }
      ...
      public static function §&?§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §]!f§[0] = _loc8_;
         var _loc9_:Number = §8!c§(§]!f§,param2,param3,param4,param5);
         _loc8_ = §]!f§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §#![§[0] = _loc10_;
         var _loc11_:Number = §8!c§(§#![§,param4,param5,param2,param3);
         _loc10_ = §#![§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         _loc39_ = §'!B§(_loc37_,_loc21_,_loc30_,_loc35_);
         if(_loc39_ < 2)
         {
            return;
         }
         _loc39_ = §'!B§(_loc38_,_loc37_,_loc29_,_loc36_);
         if(_loc39_ < 2)
         {
            return;
         }
         ...
         while(_loc41_ < b2Settings.b2_maxManifoldPoints)
         {
            ...
            if(_loc42_ <= _loc7_)
            {
               ...
               _loc43_.m_id.features.§[f§ = _loc17_;
               _loc40_++;
            }
            _loc41_++;
         }
