package §#!0§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §?V§:b2WorldManifold = new b2WorldManifold();
      
      private static var §@!A§:b2PositionSolverManifold = new b2PositionSolverManifold();
       
      
      private var §1L§:b2TimeStep;
      ...
      {
         this.§1L§ = new b2TimeStep();
         this.§%!,§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §2@§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            _loc17_ = _loc5_.§1!4§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§[!N§(),_loc10_.§[!N§());
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§0w§(),_loc10_.§0w§());
            _loc20_ = _loc15_.§4!h§.x;
            _loc21_ = _loc15_.§4!h§.y;
            _loc22_ = _loc16_.§4!h§.x;
            _loc23_ = _loc16_.§4!h§.y;
            _loc24_ = _loc15_.m_angularVelocity;
            _loc25_ = _loc16_.m_angularVelocity;
            b2Settings.b2Assert(_loc17_.§5<§ > 0);
            §?V§.§2@§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §?V§.§+i§.x;
            _loc27_ = §?V§.§+i§.y;
            _loc28_ = this.§%!,§[_loc6_];
            _loc28_.§7l§ = _loc15_;
            ...
            _loc28_.type = _loc17_.§2!5§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§39§)
            {
               _loc30_ = _loc17_.§&!2§[_loc29_];
               _loc31_ = _loc28_.§]!8§[_loc29_];
               _loc31_.normalImpulse = _loc30_.§#!Y§;
               _loc31_.tangentImpulse = _loc30_.§!B§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§#p§.x = §?V§.§&!2§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§#p§.y = §?V§.§&!2§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§;u§.x = §?V§.§&!2§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§;u§.y = §?V§.§&!2§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§=n§ + _loc16_.§=n§ + _loc15_.§1&§ * _loc36_ + _loc16_.§1&§ * _loc37_;
               _loc31_.§#!=§ = 1 / _loc38_;
               _loc39_ = _loc15_.§@U§ * _loc15_.§=n§ + _loc16_.§@U§ * _loc16_.§=n§;
               _loc39_ += _loc15_.§@U§ * _loc15_.§1&§ * _loc36_ + _loc16_.§@U§ * _loc16_.§1&§ * _loc37_;
               _loc31_.§]I§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§=n§ + _loc16_.§=n§ + _loc15_.§1&§ * _loc42_ + _loc16_.§1&§ * _loc43_;
               _loc31_.§;5§ = 1 / _loc44_;
               _loc31_.§!6§ = 0;
               ...
               {
                  _loc31_.§!6§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§39§ == 2)
            {
               ...
               _loc52_ = _loc16_.§=n§;
               _loc53_ = _loc16_.§1&§;
               _loc54_ = _loc48_.§#p§.x * _loc27_ - _loc48_.§#p§.y * _loc26_;
               _loc55_ = _loc48_.§;u§.x * _loc27_ - _loc48_.§;u§.y * _loc26_;
               _loc56_ = _loc49_.§#p§.x * _loc27_ - _loc49_.§#p§.y * _loc26_;
               _loc57_ = _loc49_.§;u§.x * _loc27_ - _loc49_.§;u§.y * _loc26_;
         ...
         while(_loc5_ < this.§'N§)
         {
            ...
            if(param1.§-K§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§#p§.x * _loc22_ - _loc20_.§#p§.y * _loc21_);
                  _loc7_.§4!h§.x -= _loc9_ * _loc21_;
                  _loc7_.§4!h§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§;u§.x * _loc22_ - _loc20_.§;u§.y * _loc21_);
                  _loc8_.§4!h§.x += _loc11_ * _loc21_;
                  _loc8_.§4!h§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         while(_loc24_ < this.§'N§)
         {
            ...
            _loc1_ = 0;
            while(_loc1_ < _loc25_.§39§)
            {
               _loc2_ = _loc25_.§]!8§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§;u§.y - _loc30_.x + _loc28_ * _loc2_.§#p§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§;u§.x - _loc30_.y - _loc28_ * _loc2_.§#p§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§;5§ * -_loc10_;
               _loc12_ = _loc40_ * _loc2_.normalImpulse;
               _loc13_ = b2Math.§3X§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_);
               ...
               _loc28_ -= _loc33_ * (_loc2_.§#p§.x * _loc15_ - _loc2_.§#p§.y * _loc14_);
               _loc31_.x += _loc34_ * _loc14_;
               _loc31_.y += _loc34_ * _loc15_;
               _loc29_ += _loc35_ * (_loc2_.§;u§.x * _loc15_ - _loc2_.§;u§.y * _loc14_);
            ...
            if(_loc25_.§39§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§#!=§ * (_loc9_ - _loc2_.§!6§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§;u§.y - _loc30_.x + _loc28_ * _loc43_.§#p§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§;u§.x - _loc30_.y - _loc28_ * _loc43_.§#p§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§;u§.y - _loc30_.x + _loc28_ * _loc44_.§#p§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§;u§.x - _loc30_.y - _loc28_ * _loc44_.§#p§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§!6§;
               _loc54_ = _loc52_ - _loc44_.§!6§;
               _loc22_ = _loc25_.§'!§;
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§#p§.x * _loc19_ - _loc43_.§#p§.y * _loc18_ + _loc44_.§#p§.x * _loc21_ - _loc44_.§#p§.y * _loc20_);
                  _loc31_.x += _loc34_ * (_loc18_ + _loc20_);
                  _loc31_.y += _loc34_ * (_loc19_ + _loc21_);
                  _loc29_ += _loc35_ * (_loc43_.§;u§.x * _loc19_ - _loc43_.§;u§.y * _loc18_ + _loc44_.§;u§.x * _loc21_ - _loc44_.§;u§.y * _loc20_);
      ...
      public function §9r§() : void
      {
         ...
         while(_loc1_ < this.§'N§)
         {
            ...
            _loc3_ = _loc2_.§8S§;
            _loc4_ = 0;
            while(_loc4_ < _loc2_.§39§)
            {
               _loc5_ = _loc3_.§&!2§[_loc4_];
               _loc6_ = _loc2_.§]!8§[_loc4_];
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§'N§)
         {
            ...
            _loc5_ = _loc4_.§7l§;
            _loc6_ = _loc4_.§<H§;
            _loc7_ = _loc5_.§@U§ * _loc5_.§=n§;
            _loc8_ = _loc5_.§@U§ * _loc5_.§1&§;
            _loc9_ = _loc6_.§@U§ * _loc6_.§=n§;
            _loc10_ = _loc6_.§@U§ * _loc6_.§1&§;
            §@!A§.§2@§(_loc4_);
            _loc11_ = §@!A§.§+i§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§39§)
            {
               _loc13_ = _loc4_.§]!8§[_loc12_];
               _loc14_ = §@!A§.§&!2§[_loc12_];
               _loc15_ = §@!A§.§+!a§[_loc12_];
               ...
               _loc20_ = b2Math.§3X§(param1 * (_loc15_ + b2Settings.b2_linearSlop),-b2Settings.b2_maxLinearCorrection,0);
               _loc21_ = -_loc13_.§]I§ * _loc20_;
