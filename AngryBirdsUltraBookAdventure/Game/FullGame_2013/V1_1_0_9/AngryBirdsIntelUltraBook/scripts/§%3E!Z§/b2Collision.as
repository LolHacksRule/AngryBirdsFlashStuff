package §>!Z§
{
   ...
   public class b2Collision
   {
      ...
      private static var §?!d§:Vector.<§"h§> = §^3§();
      
      private static var s_clipPoints1:Vector.<§"h§> = §^3§();
      
      private static var s_clipPoints2:Vector.<§"h§> = §^3§();
      
      private static var §[!w§:Vector.<int> = new Vector.<int>(1);
      ...
      private static var §7!G§:b2Vec2 = new b2Vec2();
      ...
      public static function §var§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §=R§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §=R§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §=R§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §=R§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §%!t§(param1:Vector.<§"h§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         _loc20_.id.§?!O§.§<!y§ = param4;
         _loc20_.id.§?!O§.§?! § = _loc21_;
         _loc20_.id.§?!O§.§'!c§ = 0;
         _loc20_ = param1[1];
      ...
      public static function §8!R§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §[!w§[0] = _loc8_;
         var _loc9_:Number = §var§(§[!w§,param2,param3,param4,param5);
         _loc8_ = §[!w§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §!!T§[0] = _loc10_;
         var _loc11_:Number = §var§(§!!T§,param4,param5,param2,param3);
         _loc10_ = §!!T§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc37_:Vector.<§"h§> = s_clipPoints1;
         var _loc38_:Vector.<§"h§> = s_clipPoints2;
         if((_loc39_ = §1!f§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §1!f§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§1!§.SetV(_loc27_);
      ...
      public static function §;R§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§&!h§ = 1;
            param1.§3r§ = b2Manifold.§-!-§;
            param1.§1!§.x = _loc15_ - _loc28_.x;
            param1.§1!§.y = _loc16_ - _loc28_.y;
            param1.§1!§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§ !C§[0].m_localPoint.SetV(param4.§`3§);
            param1.§ !C§[0].m_id.key = 0;
