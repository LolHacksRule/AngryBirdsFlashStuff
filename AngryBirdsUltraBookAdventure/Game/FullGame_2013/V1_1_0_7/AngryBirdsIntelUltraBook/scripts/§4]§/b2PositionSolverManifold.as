package §4]§
{
   ...
   class b2PositionSolverManifold
   {
      ...
      private static var §4!2§:b2Vec2 = new b2Vec2();
      ...
      public function §`!D§(param1:b2ContactConstraint) : void
      {
         ...
         switch(param1.type)
         {
            case b2Manifold.§+!,§:
               ...
               _loc9_ = param1.§19§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc10_ = param1.§19§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               ...
               if((_loc15_ = _loc13_ * _loc13_ + _loc14_ * _loc14_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§6!P§.x = _loc13_ / _loc16_;
                  this.§6!P§.y = _loc14_ / _loc16_;
               }
               else
               {
                  this.§6!P§.x = 1;
               ...
               this.§`=§[0] = _loc13_ * this.§6!P§.x + _loc14_ * this.§6!P§.y - param1.radius;
               break;
            case b2Manifold.§-!-§:
               _loc5_ = param1.§19§.m_xf.R;
               _loc6_ = param1.§8!9§;
               this.§6!P§.x = _loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y;
               this.§6!P§.y = _loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y;
               _loc5_ = param1.§19§.m_xf.R;
               _loc6_ = param1.localPoint;
               _loc7_ = param1.§19§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc8_ = param1.§19§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               _loc5_ = param1.§"@§.m_xf.R;
               _loc2_ = 0;
            ...
            case b2Manifold.§3!J§:
               ...
               {
                  _loc6_ = param1.§+"§[_loc2_].localPoint;
                  _loc3_ = param1.§19§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
                  _loc4_ = param1.§19§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
                  this.§`=§[_loc2_] = (_loc3_ - _loc7_) * this.§6!P§.x + (_loc4_ - _loc8_) * this.§6!P§.y - param1.radius;
