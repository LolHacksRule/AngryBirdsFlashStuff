   ...
   public class b2ContactSolver
   {
      ...
      public function §`!D§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            § !4§.§`!D§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = § !4§.§6!P§.x;
            _loc27_ = § !4§.§6!P§.y;
            (_loc28_ = this.§;!d§[_loc6_]).§19§ = _loc15_;
            _loc28_.§"@§ = _loc16_;
            _loc28_.§^#§ = _loc17_;
            ...
            _loc28_.§8!9§.x = _loc17_.§1!§.x;
            _loc28_.§8!9§.y = _loc17_.§1!§.y;
            _loc28_.localPoint.x = _loc17_.m_localPoint.x;
            _loc28_.localPoint.y = _loc17_.m_localPoint.y;
            _loc28_.radius = _loc13_ + _loc14_;
            _loc28_.type = _loc17_.§3r§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§%!3§)
            {
               _loc30_ = _loc17_.§ !C§[_loc29_];
               (_loc31_ = _loc28_.§+"§[_loc29_]).normalImpulse = _loc30_.§-J§;
               _loc31_.tangentImpulse = _loc30_.§]+§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§&!c§.x = § !4§.§ !C§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§&!c§.y = § !4§.§ !C§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§]!0§.x = § !4§.§ !C§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§]!0§.y = § !4§.§ !C§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§3!q§ + _loc16_.§3!q§ + _loc15_.§2!1§ * _loc36_ + _loc16_.§2!1§ * _loc37_;
               _loc31_.§>!o§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§"X§ * _loc15_.§3!q§ + _loc16_.§"X§ * _loc16_.§3!q§) + (_loc15_.§"X§ * _loc15_.§2!1§ * _loc36_ + _loc16_.§"X§ * _loc16_.§2!1§ * _loc37_);
               _loc31_.§>V§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§3!q§ + _loc16_.§3!q§ + _loc15_.§2!1§ * _loc42_ + _loc16_.§2!1§ * _loc43_;
               _loc31_.§2`§ = 1 / _loc44_;
               _loc31_.§@!C§ = 0;
               ...
               {
                  _loc31_.§@!C§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§%!3§ == 2)
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         while(_loc5_ < this.§;1§)
         {
            _loc7_ = (_loc6_ = this.§;!d§[_loc5_]).§19§;
            _loc8_ = _loc6_.§"@§;
            _loc9_ = _loc7_.§3!q§;
            _loc10_ = _loc7_.§2!1§;
            _loc11_ = _loc8_.§3!q§;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         {
            _loc26_ = (_loc25_ = this.§;!d§[_loc24_]).§19§;
            _loc27_ = _loc25_.§"@§;
            ...
            while(_loc1_ < _loc25_.§%!3§)
            {
               ...
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§]!0§.y - _loc30_.x + _loc28_ * _loc2_.§&!c§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§]!0§.x - _loc30_.y - _loc28_ * _loc2_.§&!c§.x;
            ...
            if(_loc25_.§%!3§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§>!o§ * (_loc9_ - _loc2_.§@!C§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§]!0§.y - _loc30_.x + _loc28_ * _loc43_.§&!c§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§]!0§.x - _loc30_.y - _loc28_ * _loc43_.§&!c§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§]!0§.y - _loc30_.x + _loc28_ * _loc44_.§&!c§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§]!0§.x - _loc30_.y - _loc28_ * _loc44_.§&!c§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§@!C§;
               _loc54_ = _loc52_ - _loc44_.§@!C§;
               _loc22_ = _loc25_.§+!K§;
               _loc53_ -= _loc22_.col1.x * _loc45_ + _loc22_.col2.x * _loc46_;
               _loc54_ -= _loc22_.col1.y * _loc45_ + _loc22_.col2.y * _loc46_;
               _loc55_ = 0.001;
               _loc56_ = -((_loc22_ = _loc25_.§>!o§).col1.x * _loc53_ + _loc22_.col2.x * _loc54_);
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§;1§)
         {
            _loc5_ = (_loc4_ = this.§;!d§[_loc3_]).§19§;
            _loc6_ = _loc4_.§"@§;
            _loc7_ = _loc5_.§"X§ * _loc5_.§3!q§;
            _loc8_ = _loc5_.§"X§ * _loc5_.§2!1§;
            _loc9_ = _loc6_.§"X§ * _loc6_.§3!q§;
            _loc10_ = _loc6_.§"X§ * _loc6_.§2!1§;
            §7!R§.§`!D§(_loc4_);
            _loc11_ = §7!R§.§6!P§;
            _loc12_ = 0;
