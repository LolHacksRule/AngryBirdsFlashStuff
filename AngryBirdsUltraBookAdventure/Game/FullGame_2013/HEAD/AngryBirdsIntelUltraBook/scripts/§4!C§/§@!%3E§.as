package §4!C§
{
   ...
   public class §@!>§ extends §7W§
   {
       
      
      private var §3q§:b2Joint;
      ...
      public static function §9!F§(param1:§7W§) : §@!>§
      {
         var _loc3_:Boolean = true;
         var _loc4_:Boolean = false;
         var _loc2_:§@!>§ = new §@!>§(param1.type,param1.index1,param1.index2,param1.point1,param1.point2,param1.§"x§,param1.§#§,param1.lowerLimit,param1.upperLimit,param1.§>'§,param1.motorSpeed,param1.§-!D§,param1.maxTorque);
         if(!_loc4_)
         {
            _loc2_.§6G§ = param1.§6G§;
            while(true)
