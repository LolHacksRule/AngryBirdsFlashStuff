            ...
            while(true)
            {
               ...
               while(true)
               {
                  ...
                  while(true)
                  {
                     ...
                     {
                        loop4:
                        while(§`=§.getItemByName("Button_MightyEagle"))
                        {
                           if(_loc1_ || _loc2_)
                           {
                              if(!(_loc2_ && _loc1_))
                     ...
                     while(true)
                     {
                        ...
                        while(true)
                        {
                           ...
                           while(true)
                           {
                              ...
                              {
                                 loop7:
                                 for(§§push(this.§!!T§); §§pop() != null; §§push(this.§!!T§),if(_loc1_ || this)
                                 {
                                    §§pop().stop();
                                    continue loop5;
                                 })
      ...
      protected function useMightyEagle() : void
      {
         ...
         while(true)
         {
            ...
            while(_loc3_ || meScore)
            {
               ...
               §§push(AngryBirdsFP11.sUserProgress.getEagleScoreForLevel(LevelManager.§1m§));
               if(_loc3_ || _loc2_)
               {
                  §§push(int(§§pop()));
               }
