package §[!$§
{
   ...
   public class StateFacebookLevelEnd extends StateLevelEndRio
   {
      ...
      override protected function onBadgeLanded() : void
      {
         ...
         §§push((AngryBirdsFP11.sUserProgress as FacebookUserProgress).§"8§(LevelManager.§1m§));
         if(_loc6_)
         {
            §§push(int(§§pop()));
         }
                  ...
                  while(true)
                  {
                     ...
                     if(!(_loc10_ && this))
                     {
                        ...
                        while(true)
                        {
                           ...
                           while(true)
                           {
                              §§push((§§pop() as FacebookUserProgress).§1U§);
                              loop7:
                              while(true)
                              {
                                 §§push(Boolean(§§pop()));
                                                                     ...
                                                                     if(!(_loc10_ && this))
                                                                     {
                                                                        ...
                                                                        switch(§§pop())
                                                                        {
                                                                           ...
                                                                           case 1:
                                                                              ...
                                                                              §§pop().§`F§(§§pop(),§§pop(),§§pop(),§§pop(),§`S§.controller.getScore());
                                                                              if(!(_loc10_ && this))
                                                                              {
                                                                                 break;
                                                                                 addr589:
                                                                                 ...
                                                                                 if(_loc9_)
                                                                                 {
                                                                                    if(!_loc10_)
                                                                                    {
                                                                                       ...
                                                                                       if(!(_loc10_ && component))
                                                                                       {
                                                                                          ...
                                                                                          §§pop().§`F§(§§pop(),§§pop(),§§pop(),§`S§.controller.getScore());
                                                                                          addr553:
                                                                                          if(_loc9_ || eventIndex)
                                                                                          {
                                                                                             addr491:
                                                                              ...
                                                                              if(!_loc10_)
                                                                              {
                                                                                 if(_loc9_)
                                                                                 {
                                                                                    if(_loc9_ || eventIndex)
                                                                                    {
                                                                                       ...
                                                                                       §§pop().§'!e§(§§pop(),§§pop(),§`S§.controller.getScore(),this.§ !<§);
                                                                                       if(!(_loc10_ && component))
                                                                                       {
                                                                                          if(_loc9_)
                                                                                          {
      ...
      override protected function setScoreData() : void
      {
         ...
         §§push(AngryBirdsFP11.sUserProgress.getScoreForLevel(LevelManager.§1m§));
         if(!_loc6_)
         {
            §§push(int(§§pop()));
         }
            ...
            while(true)
            {
               ...
               if(!(_loc6_ && highScore))
               {
                  ...
                  if(!(_loc6_ && this))
                  {
                     ...
                     §§push(AngryBirdsFP11.sUserProgress.getStarsForLevel(LevelManager.§1m§,newScore));
                     if(!_loc6_)
                     {
                        §§push(int(§§pop()));
                     }
