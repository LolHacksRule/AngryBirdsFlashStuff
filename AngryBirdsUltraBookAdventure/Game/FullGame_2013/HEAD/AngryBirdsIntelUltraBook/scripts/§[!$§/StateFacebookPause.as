                                       ...
                                       while(true)
                                       {
                                          ...
                                          while(!_loc3_)
                                          {
                                             ...
                                             while(true)
                                             {
                                                ...
                                                {
                                                   §§push(§§findproperty(§ j§));
                                                   §§push(TweenManager.§7!E§);
                                                   if(_loc2_)
                                                   {
                                                   }
                                                   §§push(TweenManager.§7!E§.§5§(§`=§.getItemByName("Container_PauseMenu") as UIContainerRovio,{"x":0},null,0.25));
                                                   if(!_loc3_)
                                                   {
                                                   }
                                                   §§pop().§ j§ = §§pop().§7f§(§§pop(),TweenManager.§7!E§.§5§((§`=§.getItemByName("MovieClip_DarkBG") as §=D§).mClip,{"alpha":1},{"alpha":0},0.25));
                                                   continue loop19;
                                                }
                                             }
                                             continue loop19;
                        ...
                        while(true)
                        {
                           while(!(_loc2_ && this))
                           {
                              ...
                              while(true)
                              {
                                 ...
                                 §§push(TweenManager.§7!E§.§5§(§`=§.getItemByName("Container_PauseMenu") as UIContainerRovio,{"x":OFFSCREEN_X},null,0.25));
                                 if(_loc1_ || _loc1_)
                                 {
                                 }
                                 §§pop().§ j§ = §§pop().§7f§(§§pop(),TweenManager.§7!E§.§5§((§`=§.getItemByName("MovieClip_DarkBG") as §=D§).mClip,{"alpha":0},{"alpha":1},0.25));
                                 continue loop0;
                              }
                              if(!(_loc2_ && _loc1_))
                              {
