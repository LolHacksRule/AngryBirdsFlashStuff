         ...
         switch(param1.§2!5§)
         {
            case b2Manifold.§@!"§:
               ...
               if(_loc21_ > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§+i§.x = _loc19_ / _loc26_;
                  this.§+i§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§+i§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§+i§.x;
               _loc23_ = _loc16_ + param3 * this.§+i§.y;
               _loc24_ = _loc17_ - param5 * this.§+i§.x;
               _loc25_ = _loc18_ - param5 * this.§+i§.y;
            ...
            case b2Manifold.§<!!§:
               ...
               this.§+i§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§5<§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§&!2§[_loc6_].m_localPoint;
                  ...
                  this.§&!2§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§&!2§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§&!>§:
               ...
               while(_loc6_ < param1.§5<§)
               {
                  ...
                  this.§&!2§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§&!2§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
