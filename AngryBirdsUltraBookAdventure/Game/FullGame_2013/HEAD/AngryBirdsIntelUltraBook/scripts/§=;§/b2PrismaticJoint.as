package §=;§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§;D§.x * this.§8!"§.x + (this.§4k§ + this.§;D§.z) * this.§@_§.x),param1 * (this.§;D§.x * this.§8!"§.y + (this.§4k§ + this.§;D§.z) * this.§@_§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§^!3§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§^!3§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§^!3§.col2.x = this.§^!3§.col1.y;
         this.§^!3§.col2.y = _loc16_ + _loc17_;
         this.§^!3§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§^!3§.col3.x = this.§^!3§.col1.z;
         this.§^!3§.col3.y = this.§^!3§.col2.z;
         this.§^!3§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§3!§)
         {
         ...
         if(param1.§-K§)
         {
            ...
            this.§;D§.y *= param1.§&s§;
            this.§4k§ *= param1.§&s§;
            _loc19_ = this.§;D§.x * this.§8!"§.x + (this.§4k§ + this.§;D§.z) * this.§@_§.x;
            _loc20_ = this.§;D§.x * this.§8!"§.y + (this.§4k§ + this.§;D§.z) * this.§@_§.y;
            _loc21_ = this.§;D§.x * this.m_s1 + this.§;D§.y + (this.§4k§ + this.§;D§.z) * this.m_a1;
            _loc22_ = this.§;D§.x * this.m_s2 + this.§;D§.y + (this.§4k§ + this.§;D§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§@_§.x * (_loc6_.x - _loc4_.x) + this.§@_§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§ !J§ * (this.§2"§ - _loc14_);
            _loc16_ = this.§4k§;
            _loc17_ = param1.§`M§ * this.§&U§;
            this.§4k§ = b2Math.§3X§(this.§4k§ + _loc15_,-_loc17_,_loc17_);
            _loc15_ = this.§4k§ - _loc16_;
            _loc8_ = _loc15_ * this.§@_§.x;
            _loc9_ = _loc15_ * this.§@_§.y;
         ...
         if(this.§3!§ && this.§!!I§ != §5!§)
         {
            _loc18_ = this.§@_§.x * (_loc6_.x - _loc4_.x) + this.§@_§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§;D§.Copy();
            _loc20_ = this.§^!3§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§;D§.§!V§(_loc20_);
            if(this.§!!I§ == §1p§)
            {
               this.§;D§.z = b2Math.§-!V§(this.§;D§.z,0);
            }
            else if(this.§!!I§ == §`7§)
            {
               this.§;D§.z = b2Math.§]!#§(this.§;D§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§;D§.z - _loc19_.z) * this.§^!3§.col3.x;
            _loc22_ = -_loc13_ - (this.§;D§.z - _loc19_.z) * this.§^!3§.col3.y;
            _loc23_ = this.§^!3§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§;D§.x = _loc23_.x;
            this.§;D§.y = _loc23_.y;
            _loc20_.x = this.§;D§.x - _loc19_.x;
            _loc20_.y = this.§;D§.y - _loc19_.y;
            _loc20_.z = this.§;D§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§8!"§.x + _loc20_.z * this.§@_§.x;
            _loc9_ = _loc20_.x * this.§8!"§.y + _loc20_.z * this.§@_§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§3!§)
         {
            ...
            _loc35_ = this.§@_§.x * _loc26_ + this.§@_§.y * _loc27_;
            if(b2Math.§&!]§(this.§^!b§ - this.§%!I§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§3X§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§&!]§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§%!I§)
            {
               _loc19_ = b2Math.§3X§(_loc35_ - this.§%!I§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§%!I§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§^!b§)
            {
               _loc19_ = b2Math.§3X§(_loc35_ - this.§^!b§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§^!3§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§^!3§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§^!3§.col2.x = this.§^!3§.col1.y;
            this.§^!3§.col2.y = _loc14_ + _loc15_;
            this.§^!3§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§^!3§.col3.x = this.§^!3§.col1.z;
            this.§^!3§.col3.y = this.§^!3§.col2.z;
            this.§^!3§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§^!3§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = §1!h§;
            ...
            this.§^!3§.col1.Set(_loc36_,_loc37_,0);
            this.§^!3§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§^!3§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§8!"§.x + _loc28_.z * this.§@_§.x;
         var _loc32_:Number = _loc28_.x * this.§8!"§.y + _loc28_.z * this.§@_§.y;
         ...
         _loc6_.x -= §1!h§ * _loc31_;
         _loc6_.y -= §1!h§ * _loc32_;
         _loc7_ -= §%k§ * _loc33_;
         _loc8_.x += §9!6§ * _loc31_;
         _loc8_.y += §9!6§ * _loc32_;
         _loc9_ += §9!7§ * _loc34_;
