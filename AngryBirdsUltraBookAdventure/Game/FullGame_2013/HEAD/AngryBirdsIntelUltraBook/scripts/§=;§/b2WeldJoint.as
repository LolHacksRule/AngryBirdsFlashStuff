package §=;§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = this.§ G§.y - _loc5_.m_sweep.localCenter.y;
         ...
         if(param1.§-K§)
         {
            ...
            this.§;D§.y *= param1.§&s§;
            this.§;D§.z *= param1.§&s§;
            _loc4_.§4!h§.x -= _loc10_ * this.§;D§.x;
            _loc4_.§4!h§.y -= _loc10_ * this.§;D§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§;D§.y - _loc7_ * this.§;D§.x + this.§;D§.z);
            _loc5_.§4!h§.x += _loc11_ * this.§;D§.x;
            _loc5_.§4!h§.y += _loc11_ * this.§;D§.y;
            _loc5_.m_angularVelocity += _loc13_ * (_loc8_ * this.§;D§.y - _loc9_ * this.§;D§.x + this.§;D§.z);
         }
         else
         {
            this.§;D§.§@!;§();
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.m_xf.R;
         var _loc8_:Number = this.§ G§.x - _loc5_.m_sweep.localCenter.x;
