package §0!3§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      b2internal static function §"e§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if(_loc18_ < 0.95 * _loc6_)
            {
               ...
               param1.§8!P§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§8!P§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §-B§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§"#§ ? int(_loc3_ + 1) : int(0);
      ...
      public function §!!O§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§"#§)
         {
            this.§`!a§[_loc6_] = b2Math.§&!M§(_loc5_,this.§`!a§[_loc6_]);
            this.§6>§[_loc6_] = b2Math.§]!§(_loc5_.R,this.§6>§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §'k§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§7_§.x = 0.5 * (param1.x + param2.x);
         this.§7_§.y = 0.5 * (param1.y + param2.y);
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§"#§ == 2)
         {
            param1.§4=§.x = 0.5 * (this.§`!a§[0].x + this.§`!a§[1].x);
            param1.§4=§.y = 0.5 * (this.§`!a§[0].y + this.§`!a§[1].y);
            param1.§=`§ = 0;
            param1.§#P§ = 0;
            return;
         }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§extends§(param1,param3.position);
