package §0!3§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§=d§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§6M§ = this.§=d§.Normalize();
         this.§+i§.Set(this.§=d§.y,-this.§=d§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§+i§.x - this.§=d§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§+i§.y - this.§=d§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§+i§.x + this.§=d§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§+i§.y + this.§=d§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§+i§;
         this.m_cornerDir2.Set(-this.§+i§.x,-this.§+i§.y);
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if(_loc12_ > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§-Q§ * _loc12_)
            {
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc8_:Number = b2Math.§extends§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§extends§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
