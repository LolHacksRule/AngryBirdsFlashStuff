package §5=§
{
   ...
   public class §9F§ extends GoogleAnalyticsTracker
   {
                           ...
                           while(true)
                           {
                              while(true)
                              {
                                 ...
                                 while(true)
                                 {
                                    while(true)
                                    {
                                       CATEGORY_LEVEL_POWERUP_COMPLETED = § !I§ + "-powerup";
                                       while(true)
                                       {
                                          while(true)
                                          {
      ...
      public static function §&k§(action:String, label:String = null, value:int = 0) : void
      {
         ...
         {
            loop1:
            for(; !(_loc5_ && action); if(_loc5_ && §9F§)
            {
               continue;
            },if(false)
            {
               §§goto(addr54);
            },§§push(§ !G§(action,SAMPLE_100_PERCENT_FLASH_ACTIONS,SAMPLE_1_PERCENT_FLASH_ACTIONS)),if(_loc6_)
            {
               §§push(§§pop());
      ...
      public static function §-y§(powerupsUsed:Array, level:String, score:int) : void
      {
         ...
         if(_loc5_)
         {
            ...
            {
               loop1:
               for(; !(_loc6_ && §9F§); while(!(_loc6_ && score))
               {
                  §§push(§%e§(powerupsUsed));
                  if(_loc5_ || §9F§)
                  {
                                                      ...
                                                      while(!(_loc7_ && §9F§))
                                                      {
                                                         ...
                                                         while(true)
                                                         {
                                                            if(_loc8_)
                                                            {
                                                               ...
                                                               §§push(§ !G§(category,SAMPLE_100_PERCENT_CATEGORIES,SAMPLE_1_PERCENT_CATEGORIES));
                                                               if(_loc8_ || §9F§)
                                                               {
                                                                  if(_loc7_)
                                                                  {
