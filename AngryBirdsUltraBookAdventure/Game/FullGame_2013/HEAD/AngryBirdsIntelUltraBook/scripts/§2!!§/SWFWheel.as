package §2!!§
{
   ...
   public class SWFWheel
   {
      ...
      public static function initialize(param1:Stage) : void
      {
         ...
         §"!D§ = param1;
         ExternalInterface.call(§2E§);
         ExternalInterface.call(§;!@§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §97§ = ExternalInterface.call(§#Q§,ExternalInterface.objectID);
         if(§97§ == §=4§)
         {
            return;
         }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array = §"!D§.getObjectsUnderPoint(new Point(§"!D§.mouseX,§"!D§.mouseY));
