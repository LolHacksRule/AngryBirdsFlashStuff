                                                ...
                                                if(§§pop().search(/^sprite_sheets\/(.*)\.json$/i) != -1)
                                                {
                                                   if(_loc6_)
                                                   {
                                                      try
                                                      {
                                                         ...
                                                         if(!_loc7_)
                                                         {
                                                            §§pop().§§slot[8] = JSON.parse((packageFiles[fileName] as FZipFile).§^!-§(false));
                                                            if(!_loc7_)
                                                            {
                                                               this.§7-§(jsonObject);
                                                               if(_loc6_ || this)
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               if(!_loc3_)
               {
                  ...
                  while(§§pop().§=Y§(§§pop(),§§pop().§§slot[2]), _loc3_ && this);
