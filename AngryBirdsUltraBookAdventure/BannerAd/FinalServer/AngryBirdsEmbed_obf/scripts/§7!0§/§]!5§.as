         ...
         for each(_loc2_ in param1.Shape)
         {
            if(_loc2_.@shape == "CIRCLE" || _loc2_.@shape == "POLYGON" || _loc2_.@shape == "NONE")
            {
               ...
               if(_loc4_ == "CIRCLE")
               {
                  ...
                  §1!0§(_loc3_,_loc4_,_loc7_,_loc5_);
               }
               else
               {
                  §+q§(_loc3_,_loc4_,_loc5_,_loc2_.@flipAngleCorrection);
               }
            }
            else
            {
               ...
               §4g§(_loc2_.@id,_loc2_.@shape,_loc2_.@width,_loc2_.@height,_loc2_.@flipAngleCorrection);
            }
         }
      }
      
      public static function §4g§(param1:String, param2:String, param3:Number, param4:Number, param5:Number) : void
      {
         §<[§[§<[§.length] = new §<$§(param1,param2,param3,param4,param5);
      }
      
      public static function §+q§(param1:String, param2:String, param3:Array, param4:Number) : void
      {
         var _loc5_:§<$§;
         (_loc5_ = new §<$§(param1,param2,-1,-1,param4)).§<+§(param3);
         _loc5_.§"g§();
         §<[§[§<[§.length] = _loc5_;
      }
      
      public static function §1!0§(param1:String, param2:String, param3:Number, param4:Array) : void
      {
         var _loc5_:§<$§;
         (_loc5_ = new §<$§(param1,param2,param3,param3)).§<+§(param4);
         §<[§[§<[§.length] = _loc5_;
      }
