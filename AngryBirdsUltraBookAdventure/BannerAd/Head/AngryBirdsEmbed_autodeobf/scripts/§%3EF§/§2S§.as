package §>F§
{
   ...
   public class §2S§
   {
      ...
      public function §2S§(param1:§%]§, param2:§;@§, param3:String, param4:int, param5:int, param6:Number, param7:Number, param8:Number, param9:String, param10:int, param11:Number = 0, param12:Number = 0, param13:Number = 0, param14:Number = 0, param15:Number = 1, param16:int = -1, param17:Boolean = false)
      {
         this.§>Q§ = new Sprite();
         super();
         this.§ 3§ = param1;
      ...
      protected function §6K§(param1:Texture) : §%!,§
      {
      ...
      public function §19§(param1:§'§) : void
      {
         this.§'9§ = param1;
      }
      ...
      public function update(param1:Number) : Boolean
      {
         ...
         if(this.§'9§)
         {
            if(this.§'9§.sprite == null || this.§'9§.§<?§ == null)
            {
               return false;
            }
            this.§5!>§ = this.§'9§.§9! §().GetPosition().x;
            this.§#!$§ = this.§'9§.§9! §().GetPosition().y;
         }
         if(this.§0l§ > 0 && this.§=!'§)
         {
            _loc3_ = 15;
      ...
      public function §7X§(param1:Number) : Boolean
      {
         ...
         if(this.§,!8§ == §9!>§)
         {
            if(this.§@=§ == §!!?§)
            {
               this.§>Q§.alpha = Math.max(0,Math.min(1,2 * §!F§.§>!!§((this.§<R§ - this.§,L§) / this.§<R§,false)));
