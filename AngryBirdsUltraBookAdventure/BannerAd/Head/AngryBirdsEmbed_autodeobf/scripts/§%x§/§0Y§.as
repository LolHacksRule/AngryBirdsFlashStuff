package §%x§
{
   ...
   public class §0Y§
   {
      ...
      public function §'U§(param1:Number) : void
      {
         ...
         if(!this.§4Q§ && this.§7h§ >= 0)
         {
            ...
            if(this.§7h§ <= 0)
            {
               ...
               if(!isNaN(this.§!!5§))
               {
                  _loc2_ = this.§@3§.§7C§.objects.§8k§(this.§5!>§,this.§!!5§);
               }
               if(_loc2_ < 0)
               {
               ...
               else if(!this.§@3§.§7C§.objects.§%t§(_loc2_).§0§)
               {
                  this.§'A§ = false;
                  this.§7h§ = -1;
               }
               else if(this.§@3§.§7C§.objects.§%t§(_loc2_).§`E§())
               {
                  this.§'A§ = false;
                  this.§7h§ = 2000;
               }
      ...
      {
         var _loc1_:§<q§ = §`K§.§!P§(this.mName).shape;
         if(_loc1_.§@!H§() == §<q§.§8!3§)
         {
            this.§94§ = _loc1_.§6! §()[0];
            this.§,N§ = _loc1_.§9Q§;
         }
         else if(_loc1_.§@!H§() == §<q§.§,j§)
         {
            this.§94§ = new b2Vec2(0,0);
            this.§,N§ = 1.5;
         }
         this.§=!'§ = this.§@3§.§7C§.§+!!§.§3H§(this.mName);
         if(!this.§=!'§)
         {
            this.§&<§(null);
         }
         ...
         if(this.§&%§ > 0)
         {
            ...
            else
            {
               ...
               else
               {
                  ...
                  _loc3_ = §!F§.§>!!§(_loc3_,false);
                  this.§!!B§ = this.§0S§ + _loc3_ * -this.§0S§;
               }
               this.§+H§ = 360 * §!F§.§>!!§((this.§%l§ - this.§&%§) / this.§%l§) * this.§#%§;
            }
            this.§6i§();
         }
