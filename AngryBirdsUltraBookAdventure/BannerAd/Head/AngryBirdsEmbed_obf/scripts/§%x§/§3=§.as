package §%x§
{
   ...
   public class §3=§
   {
      ...
      public function §3=§(param1:§#;§, param2:§<-§, param3:Sprite)
      {
         var _loc4_:int = 0;
         var _loc5_:§?!3§ = null;
         ...
         if(param2)
         {
            this.setPosition(param2.§9R§,param2.§2^§);
            this.§0L§();
            _loc4_ = 0;
            while(_loc4_ < param2.§"9§)
            {
               _loc5_ = param2.§8P§(_loc4_);
            ...
            if(this.§"_§.length <= 0)
            {
               §0!<§.log("WARNING: LevelSlingshot(), slingshot does not have any bird information " + this.§5!>§ + " " + this.§#!$§);
               this.§'o§(§ in§);
            }
            else
            {
      ...
      protected function §,H§() : void
      {
         ...
         if(!§-o§)
         {
            ...
            §-o§ = this.§7C§.textureManager.§4K§(_loc2_);
         }
         this.§&H§ = new Sprite();
         var _loc1_:§%!,§ = new §%!,§(§-o§);
      ...
      public function §'U§(param1:Number) : void
      {
         ...
         if(this.§7h§ >= 0)
         {
            ...
            if(this.§7h§ <= 0)
            {
               _loc2_ = this.§7C§.objects.§8k§(this.§]!7§,this.§!!5§);
               if(_loc2_ < 0)
               {
                  this.§8%§(0.1);
                  this.§7h§ = 0;
               }
               else if(!this.§7C§.objects.§%t§(_loc2_).§0§)
               {
                  this.§7h§ = -1;
               }
               else if(this.§7C§.objects.§%t§(_loc2_).§`E§())
               {
                  this.§7h§ = 2000;
               }
               else
