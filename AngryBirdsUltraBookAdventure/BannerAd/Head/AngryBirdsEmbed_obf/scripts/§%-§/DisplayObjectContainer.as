package §%-§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private static var §7!3§:Point = new Point();
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         if(param1 >= 0 && param1 < this.numChildren)
         {
            ...
            _loc3_.dispatchEvent(new Event(Event.§]g§,true));
            if(stage)
            {
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§]j§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§]j§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§]j§[_loc6_];
            §#!1§(_loc7_,§+!>§);
            transformCoords(§+!>§,_loc3_,_loc4_,§7!3§);
            if(_loc8_ = _loc7_.hitTest(§7!3§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§`G§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§]j§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§<<§();
               param1.§5!F§(_loc5_);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§]d§(this,param1.type,_loc2_);
      ...
      private function §]d§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§]j§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
               this.§]d§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
