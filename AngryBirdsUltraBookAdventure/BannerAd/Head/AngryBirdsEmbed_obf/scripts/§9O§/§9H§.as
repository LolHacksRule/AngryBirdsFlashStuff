package §9O§
{
   ...
   public class §9H§
   {
      ...
      public static function encode(param1:BitmapData) : ByteArray
      {
         ...
         _loc4_.compress();
         §9c§(_loc2_,1229209940,_loc4_);
         §9c§(_loc2_,1229278788,null);
         return _loc2_;
      }
      
      private static function §9c§(param1:ByteArray, param2:uint, param3:ByteArray) : void
      {
         var _loc8_:uint = 0;
         var _loc9_:uint = 0;
         var _loc10_:uint = 0;
