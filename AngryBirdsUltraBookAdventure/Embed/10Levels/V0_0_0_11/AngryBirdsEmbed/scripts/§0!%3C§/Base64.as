package §0!<§
{
   ...
   public class Base64
   {
      ...
      private static const §<W§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
                                                ...
                                                while(true)
                                                {
                                                   ...
                                                   while(true)
                                                   {
                                                      if(§§pop() < _loc4_.length)
                                                      {
                                                         ...
                                                         if(!(_loc8_ && Base64))
                                                         {
                                                            §§push(§§pop() + §<W§.charAt(_loc4_[_loc7_]));
                                                         }
                                                         _loc2_ = §§pop();
                                                         §§push(_loc7_);
                                                      }
                                 ...
                                 if(!(_loc9_ && _loc2_))
                                 {
                                    ...
                                    if(!(_loc9_ && _loc3_))
                                    {
                                       ...
                                       if(!_loc9_)
                                       {
                                          ...
                                          {
                                             _loc3_[_loc6_] = §<W§.indexOf(param1.charAt(_loc5_ + _loc6_));
                                             if(_loc8_ || _loc3_)
                                             {
                                                §§push(_loc6_ + 1);
                                                if(!(_loc9_ && param1))
