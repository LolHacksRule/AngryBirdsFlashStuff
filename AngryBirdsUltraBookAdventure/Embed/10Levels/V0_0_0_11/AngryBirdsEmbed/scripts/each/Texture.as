package each
{
   ...
   public class Texture
   {
      ...
      public static function § !3§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : each.Texture
      {
         return §7w§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §7w§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : each.Texture
      {
                              ...
                              if(!(_loc12_ && param3))
                              {
                                 if(!§§pop())
                                 {
                                    if(!(_loc12_ && param1))
                                    {
                                       ...
                                       _loc10_ = new §,!4§(_loc11_,_loc7_,_loc8_,param3,true,param4);
                                       §§push(§'_§.§3R§);
                                       if(!_loc12_)
                                       {
                                          if(§§pop())
      ...
      public static function §-!+§(param1:Context3D, param2:ByteArray) : each.Texture
      {
         ...
         if(!_loc11_)
         {
            ...
            if(!_loc11_)
            {
               ...
               var _loc9_:§,!4§ = new §,!4§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
               if(_loc10_)
               {
                  if(§'_§.§3R§)
                  {
      ...
      public static function §]=§(param1:each.Texture, param2:Rectangle = null, param3:Rectangle = null) : each.Texture
      {
         var _loc4_:each.Texture;
         (_loc4_ = new §-0§(param1,param2)).§2!=§ = param3;
         return _loc4_;
      }
      
      public static function §6Q§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : each.Texture
      {
         var _loc8_:Boolean = true;
         var _loc9_:Boolean = false;
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:each.Texture = §7w§(param1,_loc6_,false,param5);
         if(_loc8_ || param3)
         {
            if(!§'_§.§3R§)
            {
         ...
         if(!(_loc7_ && this))
         {
            if(this.§2!=§)
            {
               if(_loc6_ || param1)
               {
                  ...
                  {
                     §§push(this.§2!=§.width + this.§2!=§.x - this.width);
                     if(!_loc7_)
                     {
                        §§push(Number(§§pop()));
                        if(!_loc7_)
                     ...
                     if(_loc6_ || this)
                     {
                        §§push(this.§2!=§.height + this.§2!=§.y - this.height);
                        if(_loc6_)
                        {
                           addr96:
                           §§push(Number(§§pop()));
                     ...
                     addr98:
                     param1.§=!G§(param2,-this.§2!=§.x,-this.§2!=§.y);
                     if(_loc6_)
                     {
                        §§push(param1);
                        §§push(param2 + 1);
      ...
      public function get §,!3§() : Rectangle
      {
         ...
         if(!_loc1_)
         {
            return !!this.§2!=§ ? this.§2!=§.clone() : new Rectangle(0,0,this.width,this.height);
         }
         §§goto(addr32);
      }
      ...
      public function get root() : each.Texture
      {
         return null;
      }
      ...
      public function get parent() : each.Texture
      {
         return this;
      }
