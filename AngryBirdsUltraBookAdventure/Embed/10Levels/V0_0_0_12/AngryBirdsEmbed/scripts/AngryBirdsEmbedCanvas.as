package
{
   ...
   public class AngryBirdsEmbedCanvas extends §2+§
   {
      
      public static const §#d§:String = "0.0.0.1 (r97123) beta";
      ...
      private function §&!§() : void
      {
         ...
         if(_loc2_ || this)
         {
            ...
            if(_loc2_ || this)
            {
               ...
               if(_loc2_ || this)
               {
                  §§pop().§+!E§ = §§pop() || "http://head.angrybirds-ultrabook.appspot.com/";
                  if(_loc2_)
                  {
      ...
      private function onStageResize(param1:Event) : void
      {
            ...
            if(_loc3_ || _loc2_)
            {
               if(§§pop())
               {
                  if(_loc3_)
                  {
                     ...
                     {
                        addr45:
                        §§push(stage.stageWidth - this.§29§.width);
                        if(!(_loc2_ && _loc3_))
                        {
                           §§push(1);
                           if(!(_loc2_ && this))
         ...
         if(!_loc2_)
         {
            addr91:
            §§push(this.§29§);
            §§push(stage.stageHeight - this.§29§.height >> 1);
         }
      }
