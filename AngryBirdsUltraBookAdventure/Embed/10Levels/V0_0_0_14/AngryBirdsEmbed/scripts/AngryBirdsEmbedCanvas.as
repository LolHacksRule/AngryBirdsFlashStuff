package
{
   ...
   public class AngryBirdsEmbedCanvas extends §'Q§
   {
      ...
      public static const §#0§:String = "0.0.0.1 (r97248) beta";
      ...
      private function §3v§() : void
      {
         ...
         if(_loc2_ || this)
         {
            ...
            if(_loc2_ || this)
            {
               ...
               if(_loc2_ || this)
               {
                  §§pop().§+u§ = §§pop() || "http://head.angrybirds-ultrabook.appspot.com/";
                  if(_loc2_)
                  {
      ...
      private function onStageResize(param1:Event) : void
      {
            ...
            if(_loc3_ || _loc2_)
            {
               if(§§pop())
               {
                  if(_loc3_)
                  {
                     ...
                     {
                        addr45:
                        §§push(stage.stageWidth - this.§#!1§.width);
                        if(!(_loc2_ && _loc3_))
                        {
                           §§push(1);
                           if(!(_loc2_ && this))
         ...
         if(!_loc2_)
         {
            addr91:
            §§push(this.§#!1§);
            §§push(stage.stageHeight - this.§#!1§.height >> 1);
         }
      }
