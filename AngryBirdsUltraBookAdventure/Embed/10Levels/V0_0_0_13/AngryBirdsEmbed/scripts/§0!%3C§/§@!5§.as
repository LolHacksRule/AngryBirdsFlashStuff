   ...
   public class §@!5§ extends Sprite
   {
                                                               ...
                                                               if(!_loc6_)
                                                               {
                                                                  ...
                                                                  if(!(_loc6_ && _loc2_))
                                                                  {
                                                                     ...
                                                                     if(_loc5_ || this)
                                                                     {
                                                                        ...
                                                                        {
                                                                           addr191:
                                                                           §§push(§§pop() + Math.round(this.§2B§[_loc4_][2] / this.§2B§[_loc4_][1]));
                                                                        }
                                                                        _loc3_ = §§pop() + §§pop();
                                                                        §§push(this.§2B§);
                                                                        if(!_loc6_)
      ...
      public function §@a§(param1:String, param2:Number) : void
      {
                              ...
                              if(_loc5_)
                              {
                                 ...
                                 if(!(_loc6_ && param2))
                                 {
                                    ...
                                    if(!_loc6_)
                                    {
                                       ...
                                       addr186:
                                       §§pop()[§§pop()][2] = this.§2B§[_loc3_][2] + param2;
                                       §§goto(addr197);
                                    }
                                    addr185:
                                    §§push(this.§2B§);
         ...
         if(§§pop() == -1)
         {
            ...
            if(_loc5_)
            {
               §§pop()[this.§2B§.length] = new Array();
               §§goto(addr101);
               §§push(int(this.§2B§.length - 1));
            }
            §§goto(addr114);
         }
         §§goto(addr150);
