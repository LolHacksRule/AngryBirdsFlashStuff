package §'!E§
{
   ...
   public class §2@§ extends §9!§
   {
      ...
      public static function §'M§(param1:§9!§) : §2@§
      {
         var _loc2_:§2@§ = new §2@§(param1.type,param1.index1,param1.index2,param1.point1,param1.point2,param1.§5!?§,param1.§true§,param1.lowerLimit,param1.upperLimit,param1.§<d§,param1.motorSpeed,param1.§0Z§,param1.maxTorque);
         _loc2_.§=w§ = param1.§=w§;
      ...
      public function get §8!6§() : b2Joint
      {
         return this.§,! §;
      }
      
      public function set §8!6§(param1:b2Joint) : void
      {
         this.§,! § = param1;
      }
