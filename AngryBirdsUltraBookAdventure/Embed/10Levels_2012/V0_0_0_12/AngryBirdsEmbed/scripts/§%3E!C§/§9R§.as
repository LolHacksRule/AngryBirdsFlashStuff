package §>!C§
{
   ...
   public class §9R§
   {
      ...
      {
         if(param1.§'F§ == §+i§.§try§ || param1.§'F§ == §+i§.§]D§ || param1.§'F§ == §+i§.§+^§)
         {
            return true;
         }
         return false;
      ...
      public function §,!%§() : int
      {
         ...
         {
            _loc3_ = _loc2_.id;
            if((_loc4_ = §3n§.§]B§(_loc3_)) == null && _loc3_.indexOf("MISC_") == 0)
            {
      ...
      public function §%t§() : XML
      {
         ...
         {
            _loc1_ += " <Camera id=\"" + _loc2_.id + "\" leftBorder=\"" + _loc2_.left + "\" rightBorder=\"" + _loc2_.right + "\" topBorder=\"" + _loc2_.top + "\" bottomBorder=\"" + (_loc2_.top + §`m§.§]@§) + "\"></Camera>";
         }
         _loc1_ += "</Cameras>";
         ...
         {
            _loc1_ += "<Item id=\"" + this.§2x§[_loc3_].id + "\" x=\"" + this.§2x§[_loc3_].x + "\" y=\"" + this.§2x§[_loc3_].y + "\" rotation=\"" + this.§2x§[_loc3_].angle + "\" ></Item>";
            _loc3_++;
         }
         _loc1_ += "</Level>";
