package §`!%§
{
   ...
   public class § z§ extends §6E§
   {
      ...
      override public function activate() : void
      {
         ...
         if(this.§<!?§ > 0)
         {
            §#!4§.setText(this.§<!?§.toString(),"TextField_ScoreToBeat");
         }
         else
         {
            §#!4§.getItemByName("MovieClip_ScoreToBeatTitle").setVisibility(false);
            §#!4§.getItemByName("TextField_ScoreToBeat").setVisibility(false);
         }
      }
