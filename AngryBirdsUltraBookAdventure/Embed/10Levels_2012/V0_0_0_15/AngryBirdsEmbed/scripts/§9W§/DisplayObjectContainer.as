package §9W§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function §9_§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
                        ...
                        if(_loc10_)
                        {
                           ...
                           while(_loc6_ >= 0)
                           {
                              ...
                              if(!(_loc9_ && _loc3_))
                              {
                                 ...
                                 if(!_loc9_)
                                 {
                                    transformCoords(§[9§,_loc3_,_loc4_,§2Y§);
                                 }
                              }
                              if(_loc8_ = _loc7_.hitTest(§2Y§,param2))
                              {
                                 if(_loc10_ || this)
                                 {
                                    return _loc8_;
