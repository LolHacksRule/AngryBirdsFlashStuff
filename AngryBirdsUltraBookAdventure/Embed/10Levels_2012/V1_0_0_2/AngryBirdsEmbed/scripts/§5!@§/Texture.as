package §5!@§
{
   ...
   public class Texture
   {
      ...
      public static function §?g§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §5!@§.Texture
      {
         return §3+§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §3+§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §5!@§.Texture
      {
      ...
      public static function §@!F§(param1:§5!@§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §5!@§.Texture
      {
         var _loc4_:§5!@§.Texture;
         (_loc4_ = new §4`§(param1,param2)).§+8§ = param3;
         return _loc4_;
      }
      
      public static function §2b§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §5!@§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§5!@§.Texture = §3+§(param1,_loc6_,false,param5);
         if(!§;T§.§&H§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§;2§, param2:int, param3:int) : void
      {
         ...
         if(this.§+8§)
         {
            ...
            param1.§&!>§(param2,-this.§+8§.x,-this.§+8§.y);
            param1.§&!>§(param2 + 1,-_loc4_,-this.§+8§.y);
            param1.§&!>§(param2 + 2,-this.§+8§.x,-_loc5_);
