package §'k§
{
   public class §2!3§ extends §#k§
   {
       
      
      public function §2!3§(param1:§ >§)
      {
      ...
      override public function initializeAnimations(param1:Array) : void
      {
         ...
         §<y§("INTEL_SMOKE_CLOUD",["INTEL_SMOKE_CLOUD_1","INTEL_SMOKE_CLOUD_2","INTEL_SMOKE_CLOUD_3","INTEL_SMOKE_CLOUD_4","INTEL_SMOKE_CLOUD_5","INTEL_SMOKE_CLOUD_6"]);
      }
