package §&p§
{
   ...
   public class §%?§
   {
      ...
      private static var § set§:Vector.<Number>;
                                                                                                      ...
                                                                                                      if(_loc24_)
                                                                                                      {
                                                                                                         ...
                                                                                                         while(true)
                                                                                                         {
                                                                                                            ...
                                                                                                            if(_loc24_ || _loc2_)
                                                                                                            {
                                                                                                               if(_loc9_)
                                                                                                               {
                                                                                                                  _loc12_ = ["repeat",!(_loc23_ && §%?§) ? §§pop() : §§pop()];
                                                                                                                  addr409:
                                                                                                                  if(_loc24_)
                                                                                                                  {
                                                                                                                     §§push(_loc11_);
      ...
      public function render(param1:Context3D, param2:Matrix3D, param3:Number = 1.0) : void
      {
         ...
         §§push(this.§5!@§.premultipliedAlpha);
         if(_loc8_ || param2)
         {
            §§push(Boolean(§§pop()));
         }
         ...
         if(_loc8_ || param2)
         {
            ...
            {
               addr54:
               §§push(§5W§(_loc5_,this.§=E§.mipMapping,this.§=E§.repeat,this.§+!,§,this.§4W§));
               if(_loc8_)
               {
                  §§push(§§pop());
                  if(!_loc9_)
