package
{
   ...
   public class §@!?§ extends AngryBirdsFP11
   {
      ...
      public static const §#d§:String = "0.0.0.1 (r97069) beta";
      ...
      override protected function initStateLoad() : §8s§
      {
         ...
         return new §?3§(true,§8s§.§0!7§,this.getMinLoadingScreenTime(),stage.loaderInfo.parameters.assetsUrl || "",stage.loaderInfo.parameters.buildNumber || "");
      }
      ...
      private function §!!#§() : void
      {
         ...
         if(this.§4!?§)
         {
            this.§4!?§.x = this.§2!B§ - this.§4!?§.width / this.§4!?§.scaleX >> 1;
            this.§4!?§.y = this.§2!0§ - this.§4!?§.height / this.§4!?§.scaleY >> 1;
