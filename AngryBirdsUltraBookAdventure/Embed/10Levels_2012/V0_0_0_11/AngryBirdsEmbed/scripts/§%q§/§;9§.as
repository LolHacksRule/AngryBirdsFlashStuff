package §%q§
{
   ...
   public class §;9§ extends DisplayObject implements §!o§
   {
      ...
      public function §;9§(param1:Texture, param2:Number, param3:int = 128, param4:String = null, param5:String = null)
      {
         ...
         this.§2p§ = param4 || (!!this.§2"§ ? Context3DBlendFactor.ONE : Context3DBlendFactor.SOURCE_ALPHA);
         if(param3 > 0)
         {
            this.§?_§(param3);
         }
      ...
      {
         param1.y += param2 * 250;
         param1.alpha = 1 - param1.currentTime / param1.§2r§;
      ...
      private function §?_§(param1:int) : void
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = this.§3g§;
         var _loc3_:int = this.§3g§ + param1;
         var _loc4_:§+!A§;
      ...
      private function §,[§(param1:Matrix3D) : void
      {
         ...
         if(this.§^x§ > 0)
         {
            ...
            while(this.§#f§ > 0)
            {
               ...
               if(!isNaN(this.§4`§))
               {
                  _loc13_ = _loc12_ * (1 - this.§4`§ + Math.random() * this.§4`§ * 2) + this.§#D§;
               }
               this.§#D§ += _loc12_ - _loc13_;
               this.§#f§ -= _loc13_;
            }
      ...
      override public function render(param1:§`G§, param2:Number) : void
      {
         ...
         param2 *= this.alpha;
         var _loc3_:String = §%?§.§5W§(param2 != 1,this.§]s§.mipMapping,false,this.§;! §,true);
