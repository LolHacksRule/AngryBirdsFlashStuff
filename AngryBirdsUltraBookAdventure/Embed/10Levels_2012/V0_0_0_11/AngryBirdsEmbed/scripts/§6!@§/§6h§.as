package §6!@§
{
   ...
   public class §6h§
   {
      ...
      public function §6h§(param1:§"r§, param2:Sprite, param3:§'!3§, param4:Number)
      {
         ...
         {
            _loc7_ = (_loc13_ = param3.§4K§(param1.mName)).pivotY;
            if(!this.§7#§)
            {
         ...
         else
         {
            ...
            _loc7_ = _loc10_.§4!5§.bottom;
            _loc8_ = (_loc10_.§4!5§.left + _loc10_.§4!5§.right) / 2;
         }
         if(this.§3^§ <= 0)
         {
      ...
      private function §use §(param1:§"r§, param2:Number) : void
      {
         ...
         {
            if((_loc4_ = ParticleManager.§2]§(_loc3_.id,this.§ 7§)) && _loc4_.§,!0§ > 0)
            {
      ...
      private function §4!"§() : void
      {
         ...
         while(§`m§.§0!6§ + (this.§0W§.x - this.§3^§) * §`m§.§;`§ > 0)
         {
            this.§0W§.x -= this.§3^§;
         }
         this.§#U§();
