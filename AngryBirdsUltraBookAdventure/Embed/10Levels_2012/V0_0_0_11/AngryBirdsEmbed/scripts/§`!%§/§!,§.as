   ...
   public class §!,§ extends §9[§
   {
      ...
      protected function §]L§() : void
      {
         ...
         while(_loc1_ < this.§ U§.length)
         {
            ...
            {
               (this.§ U§[_loc1_] as §3!?§).setEnabled(false);
            }
            else
            {
               (this.§ U§[_loc1_] as §3!?§).setEnabled(true);
            }
            _loc1_++;
         }
      }
      ...
      {
         if(param2.length > 0 && param3 is §?o§)
         {
            if((param3 as §?o§).mParentContainer.mParentContainer.mName == "Repeater_LevelSelection" || (param3 as §?o§).mParentContainer.mParentContainer.mName == "Repeater_LevelSelection15")
            {
               if(!this.§-g§)
               {
