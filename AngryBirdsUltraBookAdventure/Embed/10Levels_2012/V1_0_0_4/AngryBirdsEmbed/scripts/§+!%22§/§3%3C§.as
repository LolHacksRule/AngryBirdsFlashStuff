   ...
   public class §3<§ extends Sprite
   {
                                                               ...
                                                               if(!_loc6_)
                                                               {
                                                                  ...
                                                                  if(!(_loc6_ && _loc2_))
                                                                  {
                                                                     ...
                                                                     if(_loc5_ || this)
                                                                     {
                                                                        ...
                                                                        {
                                                                           addr191:
                                                                           §§push(§§pop() + Math.round(this.§"m§[_loc4_][2] / this.§"m§[_loc4_][1]));
                                                                        }
                                                                        _loc3_ = §§pop() + §§pop();
                                                                        §§push(this.§"m§);
                                                                        if(!_loc6_)
      ...
      public function §8!+§(param1:String, param2:Number) : void
      {
                              ...
                              if(_loc5_)
                              {
                                 ...
                                 if(!(_loc6_ && param2))
                                 {
                                    ...
                                    if(!_loc6_)
                                    {
                                       ...
                                       addr186:
                                       §§pop()[§§pop()][2] = this.§"m§[_loc3_][2] + param2;
                                       §§goto(addr197);
                                    }
                                    addr185:
                                    §§push(this.§"m§);
         ...
         if(§§pop() == -1)
         {
            ...
            if(_loc5_)
            {
               §§pop()[this.§"m§.length] = new Array();
               §§goto(addr101);
               §§push(int(this.§"m§.length - 1));
            }
            §§goto(addr114);
         }
         §§goto(addr150);
