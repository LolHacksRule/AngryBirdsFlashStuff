package
{
   ...
   public class §#W§ extends AngryBirdsFP11
   {
      ...
      public static const §#0§:String = "1.0.0.4 (r97370) beta";
      
      private static const §>5§:String = "AngryBirdsEmbedIntelSettings";
      ...
      public function §=K§(param1:String) : void
      {
         ...
         if(_loc3_)
         {
            ...
            if(_loc3_ || this)
            {
               navigateToURL(new URLRequest("https://apps.facebook.com/ab_in_adventure/?ref=wallPlay" + param1 + "&levelId=" + §5j§.§%V§),"_blank");
               if(_loc3_)
               {
                  addr54:
                  this.§0!"§();
