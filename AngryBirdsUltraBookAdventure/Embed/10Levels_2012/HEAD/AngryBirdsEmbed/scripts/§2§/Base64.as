package §2§
{
   ...
   public class Base64
   {
      ...
      private static const §%F§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §?+§(param1:String) : ByteArray
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §%F§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
