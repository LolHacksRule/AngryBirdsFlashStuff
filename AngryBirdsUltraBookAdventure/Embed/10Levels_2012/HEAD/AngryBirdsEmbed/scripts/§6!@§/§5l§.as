package §6!@§
{
   ...
   public class §5l§
   {
      ...
      public function §5l§(param1:String, param2:Number, param3:§;@§, param4:Number)
      {
      ...
      protected function §!!4§(param1:uint) : §^K§
      {
         return new §^K§(4096,4096,param1);
      }
      ...
      {
         if(§?!?§.§5!%§("CHANNEL_AMBIENT") == null || !§?!?§.§5!%§("CHANNEL_AMBIENT").§!q§())
         {
            §?!?§.§#'§(this.§>1§.§%b§,"CHANNEL_AMBIENT",999);
         }
      }
      ...
      public function §^-§(param1:Number, param2:Number) : void
      {
         ...
         if(this.§'e§ != null)
         {
            this.§'e§.scaleX = this.§'e§.scaleY = 1 / §[F§.§+K§;
            this.§'e§.x = -§[F§.§=z§ * (1 / §[F§.§+K§);
