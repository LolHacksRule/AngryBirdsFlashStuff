package §!c§
{
   ...
   public class §'4§
   {
      ...
      public static function §?u§(param1:XMLList) : void
      {
         var _loc2_:XML = null;
         §-!1§ = new Array();
      ...
      {
         §-!1§[§-!1§.length] = new §8M§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13);
      }
      
      public static function §%C§(param1:String) : §8M§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §-!1§.length)
         {
            if(§8M§(§-!1§[_loc2_]).mName.toLowerCase() == param1.toLowerCase())
            {
               return §8M§(§-!1§[_loc2_]);
            }
            _loc2_++;
