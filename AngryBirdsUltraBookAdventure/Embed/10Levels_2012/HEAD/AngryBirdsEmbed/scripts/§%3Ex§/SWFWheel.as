package §>x§
{
   ...
   public class SWFWheel
   {
      ...
      public static function initialize(param1:Stage) : void
      {
         ...
         _stage = param1;
         ExternalInterface.call(§,!D§);
         ExternalInterface.call(§85§,ExternalInterface.objectID);
         ExternalInterface.addCallback("checkBrowserScroll",checkBrowserScroll);
         §8m§ = ExternalInterface.call(§,5§,ExternalInterface.objectID);
         if(§8m§ == §-i§)
         {
            return;
         }
      ...
      public static function get §7y§() : int
      {
         return §8m§;
      }
