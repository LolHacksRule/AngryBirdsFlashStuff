package §<h§
{
   public class §,V§ extends §%]§
   {
      ...
      override public function initializeAnimations(param1:Array) : void
      {
         ...
         §;!D§("POWERUP_BOMB",["POWERUP_DROP_01"]);
         §;!D§("POWERUP_BOMB_PARACHUTE",["POWERUP_DROP_02"]);
         §;!D§("SUPER_SLINGSHOT",["SLING_SHOT_02_BACK","SLING_SHOT_02_FRONT"]);
         §;!D§("LASER_DOT",["LASER_DOT"]);
         §;!D§("INTEL_SMOKE_CLOUD",["INTEL_SMOKE_CLOUD_1","INTEL_SMOKE_CLOUD_2","INTEL_SMOKE_CLOUD_3","INTEL_SMOKE_CLOUD_4","INTEL_SMOKE_CLOUD_5","INTEL_SMOKE_CLOUD_6"]);
      }
