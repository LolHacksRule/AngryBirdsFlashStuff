package §=!0§
{
   ...
   public class §>4§
   {
               ...
               for each(_loc9_ in [true,false])
               {
                  for each(_loc10_ in [true,false])
                  {
                     for each(_loc11_ in _loc8_)
                     {
                        ...
                        if(_loc11_ == § case§.NONE)
                        {
                           _loc12_.push("nearest",!!_loc10_ ? "mipnearest" : "mipnone");
                        }
                        else if(_loc11_ == § case§.§@§)
                        {
      ...
      public function render(param1:Context3D, param2:Matrix3D, param3:Number = 1.0) : void
      {
         ...
         var _loc5_:* = param3 != 1;
         var _loc6_:String = !!this.§9!A§ ? §4!+§(_loc5_,this.§9!A§.mipMapping,this.§9!A§.repeat,this.§6!I§,this.§4!B§) : §1z§(_loc5_);
         §2N§.§5!,§(param1,_loc4_);
         this.§1K§(param1);
         param1.setProgram(§>I§.§`S§.§&!L§(_loc6_));
         param1.setVertexBufferAt(0,this.§#f§,§3!!§.§"K§,Context3DVertexBufferFormat.FLOAT_3);
         if(this.§9!A§ == null || this.§4!B§)
         {
      ...
      public function §'o§(param1:§<3§, param2:Number, param3:Texture, param4:String, param5:Matrix3D) : void
      {
         ...
         if(this.§@!;§ == 0)
         {
            this.§9!A§ = param3;
            this.§6!I§ = param4;
            this.§,Y§.§5!3§(!!param3 ? Boolean(param3.premultipliedAlpha) : true,false);
      ...
      {
         if(this.§9!A§ != null && param2 != null)
         {
            return this.§9!A§.root != param2.root || this.§9!A§.repeat != param2.repeat || this.§6!I§ != param3 || this.§4!B§ != param1.useColor || this.§@!;§ == 8192;
         }
         if(this.§9!A§ == null && param2 == null)
         {
            return false;
         }
         return this.§@!;§ != 0 || this.§4!B§ != (param1.useColor || param4 != 1);
      }
   }
}
