package §!m§
{
   ...
   public class b2AABB
   {
      ...
      {
         var _loc1_:Number = this.§=!`§.x - this.§4m§.x;
         var _loc2_:Number = this.§=!`§.y - this.§4m§.y;
         var _loc3_:Boolean = _loc1_ >= 0 && _loc2_ >= 0;
         return Boolean(_loc3_ && this.§4m§.§<`§() && this.§=!`§.§<`§());
      }
      
      public function §0!8§() : b2Vec2
      {
         return new b2Vec2((this.§4m§.x + this.§=!`§.x) / 2,(this.§4m§.y + this.§=!`§.y) / 2);
      }
      
      public function §&o§() : b2Vec2
      {
         return new b2Vec2((this.§=!`§.x - this.§4m§.x) / 2,(this.§=!`§.y - this.§4m§.y) / 2);
      }
      
      public function §!!4§(param1:b2AABB) : Boolean
      {
         var _loc2_:Boolean = true;
         _loc2_ = _loc2_ && this.§4m§.x <= param1.§4m§.x;
         _loc2_ = _loc2_ && this.§4m§.y <= param1.§4m§.y;
      ...
      public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput) : Boolean
      {
         ...
         {
            if(_loc5_ < this.§4m§.x || this.§=!`§.x < _loc5_)
            {
               return false;
            }
         }
         ...
         {
            _loc12_ = 1 / _loc7_;
            _loc13_ = (this.§4m§.x - _loc5_) * _loc12_;
         ...
         {
            if(_loc6_ < this.§4m§.y || this.§=!`§.y < _loc6_)
            {
               return false;
            }
         }
         ...
         {
            _loc12_ = 1 / _loc8_;
            _loc13_ = (this.§4m§.y - _loc6_) * _loc12_;
      ...
      {
         var _loc2_:Number = param1.§4m§.x - this.§=!`§.x;
         var _loc3_:Number = param1.§4m§.y - this.§=!`§.y;
         var _loc4_:Number = this.§4m§.x - param1.§=!`§.x;
         var _loc5_:Number = this.§4m§.y - param1.§=!`§.y;
      ...
      {
         this.§4m§.x = Math.min(param1.§4m§.x,param2.§4m§.x);
         this.§4m§.y = Math.min(param1.§4m§.y,param2.§4m§.y);
