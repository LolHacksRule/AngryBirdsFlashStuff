package §3b§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      b2internal static function §&]§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§4!;§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         {
            _loc6_ = (_loc9_ = this.§0!k§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§>h§.x = _loc5_ - b2internal:: !c;
         param1.§>h§.y = _loc6_ - b2internal:: !c;
         param1.§^!z§.x = _loc7_ + b2internal:: !c;
         param1.§^!z§.y = _loc8_ + b2internal:: !c;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§]D§ == 2)
         {
            param1.center.x = 0.5 * (this.§0!k§[0].x + this.§0!k§[1].x);
            param1.center.y = 0.5 * (this.§0!k§[0].y + this.§0!k§[1].y);
            param1.§&q§ = 0;
            param1.§6_§ = 0;
            return;
         }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§#D§(param1,param3.position);
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§0!k§[_loc9_].x * (1 - _loc15_) + this.§0!k§[_loc13_].x * _loc15_,this.§0!k§[_loc9_].y * (1 - _loc15_) + this.§0!k§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§0!k§[_loc10_].x * (1 - _loc16_) + this.§0!k§[_loc14_].x * _loc16_,this.§0!k§[_loc10_].y * (1 - _loc16_) + this.§0!k§[_loc14_].y * _loc16_);
