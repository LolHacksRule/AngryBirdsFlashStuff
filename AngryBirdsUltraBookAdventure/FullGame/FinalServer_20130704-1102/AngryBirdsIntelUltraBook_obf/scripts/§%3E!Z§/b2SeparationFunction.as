   ...
   class b2SeparationFunction
   {
      ...
      public function §`!D§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         if(_loc6_ == 1)
         {
            ...
            this.§try§.x = _loc15_ - _loc13_;
            this.§try§.y = _loc16_ - _loc14_;
            this.§try§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§3r§ = §-!-§;
            _loc8_ = this.§&!_§.§2l§(param1.indexA[0]);
         ...
         else if(param1.indexA[0] == param1.indexA[0])
         {
            ...
            this.§try§ = b2Math.§66§(b2Math.§%M§(_loc12_,_loc11_),1);
            this.§try§.Normalize();
            _loc20_ = this.§try§;
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         switch(this.§3r§)
         {
            case §^x§:
               ...
               return Number(((_loc8_ = b2Math.§%!r§(param2,_loc6_)).x - _loc7_.x) * this.§try§.x + (_loc8_.y - _loc7_.y) * this.§try§.y);
            case §-!-§:
