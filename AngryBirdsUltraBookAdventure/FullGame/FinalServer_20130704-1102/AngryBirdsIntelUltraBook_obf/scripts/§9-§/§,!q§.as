package §9-§
{
   ...
   public class §,!q§
   {
      ...
      public function §,!q§(param1:Number = 50)
      {
         ...
         this.§<!L§ = [1,2,3,0,4,17,5,18,33,49,65,6,19,81,97,7,34,113,20,50,129,145,161,8,35,66,177,193,21,82,209,240,36,51,98,114,130,9,10,22,23,24,25,26,37,38,39,40,41,42,52,53,54,55,56,57,58,67,68,69,70,71,72,73,74,83,84,85,86,87,88,89,90,99,100,101,102,103,104,105,106,115,116,117,118,119,120,121,122,131,132,133,134,135,136,137,138,146,147,148,149,150,151,152,153,154,162,163,164,165,166,167,168,169,170,178,179,180,181,182,183,184,185,186,194,195,196,197,198,199,200,201,202,210,211,212,213,214,215,216,217,218,225,226,227,228,229,230,231,232,233,234,241,242,243,244,245,246,247,248,249,250];
      ...
      private function §&!,§(param1:int) : void
      {
         ...
         while(_loc7_ < 8)
         {
            ...
            while(_loc8_ < 8)
            {
               this.§#!_§[_loc2_] = 1 / (this.§`!3§[this.§+@§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               this.§#]§[_loc2_] = 1 / (this.§6!8§[this.§+@§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               _loc2_++;
               _loc8_++;
            }
            _loc7_++;
      ...
      {
         this.§4d§ = this.§@!%§(this.§7^§,this.§%!w§);
         this.§7!M§ = this.§@!%§(this.§ ![§,this.§+!>§);
         this.§!b§ = this.§@!%§(this.§"!`§,this.§<!L§);
         this.§<Z§ = this.§@!%§(this.§'"!§,this.§3!%§);
      }
      ...
      private function §6!9§(param1:§^!`§) : void
      {
      ...
      private function § for§(param1:int) : void
      {
      ...
      private function §,!U§() : void
      {
         ...
         while(_loc1_ < 64)
         {
            this.writeByte(this.§6!8§[_loc1_]);
            _loc1_++;
         }
      }
      ...
      private function §8![§(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         ...
         while(_loc8_ < 64)
         {
            this.§8V§[this.§+@§[_loc8_]] = _loc9_[_loc8_];
            _loc8_++;
         }
         var _loc10_:int = this.§8V§[0] - param3;
         param3 = this.§8V§[0];
         if(_loc10_ == 0)
         {
            this.§6!9§(param4[0]);
         ...
         {
            this.§6!9§(param4[this.category[32767 + _loc10_]]);
            this.§6!9§(this.§4'§[32767 + _loc10_]);
         }
         var _loc11_:int = 63;
         while(_loc11_ > 0 && this.§8V§[_loc11_] == 0)
         {
            _loc11_--;
         }
         if(_loc11_ == 0)
         ...
         {
            _loc12_ = _loc8_;
            while(this.§8V§[_loc8_] == 0 && _loc8_ <= _loc11_)
            {
               _loc8_++;
            }
            ...
            this.§6!9§(param5[_loc13_ * 16 + this.category[32767 + this.§8V§[_loc8_]]]);
            this.§6!9§(this.§4'§[32767 + this.§8V§[_loc8_]]);
            _loc8_++;
         }
         if(_loc11_ != 63)
         {
      ...
      public function encode(param1:BitmapData) : ByteArray
      {
         ...
         while(_loc5_ < param1.height)
         {
            ...
            while(_loc6_ < param1.width)
            {
               ...
               _loc2_ = this.§8![§(this.§,!'§,this.§#!_§,_loc2_,this.§4d§,this.§!b§);
               _loc3_ = this.§8![§(this.§]!S§,this.§#]§,_loc3_,this.§7!M§,this.§<Z§);
               _loc4_ = this.§8![§(this.§@N§,this.§#]§,_loc4_,this.§7!M§,this.§<Z§);
               _loc6_ += 8;
            }
            _loc5_ += 8;
         }
