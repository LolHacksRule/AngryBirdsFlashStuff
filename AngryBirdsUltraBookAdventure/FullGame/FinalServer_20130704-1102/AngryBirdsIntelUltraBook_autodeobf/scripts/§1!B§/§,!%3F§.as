package §1!B§
{
   ...
   public class §,!?§
   {
      ...
      public function §,!?§(param1:ByteArray, param2:String, param3:String, param4:String, param5:Function, param6:Function)
      {
         ...
         var _loc7_:String = (_loc7_ = §0!Y§ + §26§ + "?access_token=" + param3).replace("[USER_ID]",param4);
         §<m§.log("Uploading image; URL:" + _loc7_);
      ...
      {
         §<m§.log("Error!! " + param1.toString());
         §<m§.log("Data?" + param1.target.data.toString());
         if(this.§7!0§ != null)
         {
            this.§7!0§();
         }
