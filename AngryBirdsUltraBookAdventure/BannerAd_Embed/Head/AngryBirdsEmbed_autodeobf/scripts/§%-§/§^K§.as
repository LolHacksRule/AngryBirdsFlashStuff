package §%-§
{
   ...
   public class §^K§ extends DisplayObject
   {
      ...
      public function §^K§(param1:Number, param2:Number, param3:uint = 16777215, param4:Boolean = true)
      {
         super();
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         else
         {
            ...
            {
               this.§5!@§.§"[§(_loc7_,§ w§);
               transformCoords(§+!>§,§ w§.x,§ w§.y,§7!3§);
               _loc3_ = _loc3_ < §7!3§.x ? Number(_loc3_) : Number(§7!3§.x);
               _loc4_ = _loc4_ > §7!3§.x ? Number(_loc4_) : Number(§7!3§.x);
               _loc5_ = _loc5_ < §7!3§.y ? Number(_loc5_) : Number(§7!3§.y);
               _loc6_ = _loc6_ > §7!3§.y ? Number(_loc6_) : Number(§7!3§.y);
               _loc7_++;
            }
         }
         param2.x = _loc3_;
