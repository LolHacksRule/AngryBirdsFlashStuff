package §!c§
{
   ...
   public class §<L§
   {
      ...
      {
         §?x§[§?x§.length] = new §4F§(param1,param2,param3,param4,param5,param6,param7,param8);
      }
      
      public static function §;a§(param1:String) : §4F§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §?x§.length)
         {
            if((§?x§[_loc2_] as §4F§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §4F§(§?x§[_loc2_]);
            }
            _loc2_++;
