package §<h§
{
   ...
   public class §%]§
   {
      ...
      private function §8a§(param1:Array) : void
      {
      ...
      private function §1p§(param1:String) : void
      {
      ...
      protected function §<`§(param1:String, param2:Array) : void
      {
         ...
         var _loc3_:§7p§ = new §7p§();
         for each(_loc4_ in param2)
         {
            _loc5_ = _loc4_[0];
            _loc6_ = _loc4_[1];
            _loc3_.§;!D§(_loc5_,this.§'$§(_loc6_));
         }
         this.§`Q§[param1] = _loc3_;
      }
      
      public function §3H§(param1:String) : §<@§
      {
