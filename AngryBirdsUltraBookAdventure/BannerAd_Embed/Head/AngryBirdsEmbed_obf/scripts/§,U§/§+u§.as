package §,U§
{
   ...
   public class §+u§ extends EventDispatcher implements §&?§
   {
      ...
      {
         return (this.§1!H§[param1] as §"!0§).§0I§(false);
      }
      
      public function §7"§(param1:String) : ByteArray
      {
         return (this.§1!H§[param1] as §"!0§).content;
      }
      ...
      public function §?s§(param1:ByteArray, param2:Boolean = true) : void
      {
         ...
         while(_loc5_ >= 0)
         {
            if((_loc6_ = _loc3_.§+$§(_loc5_)).§4T§.substr(-1) != "/")
            {
               if(!this.§1!H§[_loc6_.§4T§])
               {
               }
               this.§1!H§[_loc6_.§4T§] = _loc4_[_loc6_.§4T§] = _loc6_;
            }
            _loc5_--;
         }
         this.§@u§(_loc4_);
      ...
      protected function §@u§(param1:Object) : void
      {
         ...
         for(fileName in packageFiles)
         {
            if(fileName.search(/^sprite_sheets\/(.*)\.json$/i) != -1)
            {
               try
               {
                  jsonObject = JSON.parse((packageFiles[fileName] as §"!0§).§0I§(false));
               }
               catch(e:Error)
               {
            ...
            if(levelNameResults)
            {
               §6M§.§ r§(levelNameResults[1].toLowerCase(),§<-§.§<!0§(this.getFileAsString(fileName)));
            }
