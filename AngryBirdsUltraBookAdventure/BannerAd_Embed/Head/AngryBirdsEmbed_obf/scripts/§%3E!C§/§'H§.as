package §>!C§
{
   public class §'H§
   {
      ...
      public function set §8i§(param1:String) : void
      {
         this.§!A§ = param1;
      }
      
      public function get §3P§() : String
      {
         return this.§;!C§;
      }
      
      public function set §3P§(param1:String) : void
      {
         this.§;!C§ = param1;
      }
      ...
      public function set §3w§(param1:String) : void
      {
         this.§<I§ = param1;
      }
      ...
      public function set §5I§(param1:String) : void
      {
         this.§3t§ = param1;
      }
