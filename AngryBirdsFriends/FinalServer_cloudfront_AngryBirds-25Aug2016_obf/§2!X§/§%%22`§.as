package §2!X§
{
   ...
   public class §%"`§
   {
      ...
      public function §8!6§() : void
      {
         ...
         {
            this.§]Y§.removeChild(this.§+##§[_loc1_]);
            _loc1_++;
         }
      ...
      public function §6"Z§(param1:int) : Boolean
      {
         if(this.§&"_§ - param1 > 0 || this.§&"_§ - param1 - this.§9!D§ < -this.§+!&§.length)
         {
            return true;
         }
         return false;
      ...
      public function updatePositions() : void
      {
         ...
         while(_loc1_ < this.§+!&§.length)
         {
            ...
            if(_loc3_ > -this.§1#G§ && _loc3_ < this.§3#l§ - this.§1#G§ && !this.§27§(_loc1_))
            {
               _loc4_ = this.§5=§();
