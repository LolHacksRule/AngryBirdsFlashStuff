package §6"r§
{
   ...
   public class §#s§ extends §=O§
   {
      ...
      public function §#s§(param1:XML, param2:§0"<§, param3:MovieClip = null)
      {
         this.§%#<§ = new Rectangle();
      ...
      {
         this.listenerUIEventOccured(§]#c§,§&"2§[§]#c§]);
      }
      ...
      private function stopDrag(param1:Event = null) : void
      {
         ...
         if(this.§8#Y§)
         {
            this.setComponentVisualState(this.§8#Y§);
            this.§8#Y§ = null;
         }
      }
      ...
      public function §0k§(param1:Rectangle) : void
      {
         this.§%#<§ = param1;
      }
