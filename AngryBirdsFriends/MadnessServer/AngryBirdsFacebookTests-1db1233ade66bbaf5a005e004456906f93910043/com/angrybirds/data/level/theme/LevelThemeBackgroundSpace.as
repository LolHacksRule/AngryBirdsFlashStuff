package com.angrybirds.data.level.theme
{
   public class LevelThemeBackgroundSpace extends LevelThemeBackground
   {
      ...
      private function initializeLayer(layerData:Object, foreground:Boolean = false) : void
      {
         ...
         var frameTime:Number = !!layerData.frameTime ? Number(layerData.frameTime * 1000) : Number(0);
         ...
         var visible:Boolean = layerData.visible !== undefined ? Boolean(layerData.visible) : true;
         var layer:LevelThemeBackgroundLayerSpace = null;
         layer = new LevelThemeBackgroundLayerSpace(spriteName,spriteNames,frameTime,color,scale,zDistance,offsetX,offsetY,xMult,yMult,angleMult,scaleSpeed,velocityX,velocityY,foreground,tileable,false,moveStartOffsetX,moveEndOffsetX,false,visible);
