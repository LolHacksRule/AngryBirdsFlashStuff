package com.angrybirds.engine.objects
{
   ...
   public class LevelObjectBirdOrange extends LevelObjectBird
   {
      ...
      override public function applyDamage(damage:Number, updateManager:ILevelObjectUpdateManager, damagingObject:LevelObject, addScore:Boolean = true, ignoreDefence:Boolean = false) : Number
      {
         ...
         if(!specialPowerUsed && this.mInflateTimer == this.NILL_TIME && (damagingObject && !damagingObject.levelItem.specialtyAvailableAfterCollision))
         {
         ...
         {
            returnValue = super.applyDamage(damage,updateManager,damagingObject,addScore,ignoreDefence);
         }
         if(damagingObject && !damagingObject.levelItem.specialtyAvailableAfterCollision)
         {
