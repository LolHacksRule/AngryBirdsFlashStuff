package com.angrybirds.engine.background
{
   ...
   public class AnimationFactory
   {
      ...
      private static const ANIMATION_TYPE_SET_VISIBLE:String = "setVisible";
      ...
      public static function createAnimation(sprite:Sprite, levelBackgroundLayer:LevelBackgroundLayer, data:AnimationData) : AbsLayerAnimation
      {
         ...
         switch(data.type)
         {
            ...
            case ANIMATION_TYPE_SCALE:
               ...
               break;
            case ANIMATION_TYPE_SET_VISIBLE:
               animation = new SetVisibleAnimation(sprite,levelBackgroundLayer,data);
         }
         return animation;
      }
   }
