package §<"F§
{
   ...
   public class §0"W§ extends Popup
   {
      ...
      public function §0"W§(param1:§`_§, param2:StatePopupManager)
      {
         ...
         this.§2"&§ = mClip.TermsAndConditions_Text.y + this.§1"Y§ - mClip.TermsAndConditions_Text.height + this.§'!F§;
      ...
      private function §=!%§(param1:Event) : void
      {
         ...
         var _loc2_:Number = mClip.TermsAndConditions_Text.y - (this.§=4§ + this.§'"E§);
