      ...
      override protected function onUIInteraction(eventIndex:int, eventName:String, component:UIEventListenerRovio) : void
      {
         ...
         switch(eventName)
         {
            ...
            case "TERMS_AND_PRIVACY":
               ...
               navigateToURL(new URLRequest(AngryBirdsFacebook.PRIVACY_WEB_URL + "?locale=" + InitDataLoader.userLocaleShort + "&token=" + AngryBirdsFacebook(AngryBirdsFacebook.sSingleton).dataModelFriends.rovioAccessToken.accessToken + "&appId=" + AngryBirdsFacebook.beaconAppId),"_blank");
               break;
            case "EASTER_EGG_3":
               mUIView.getItemByName("ButtonEasterEgg3").setVisibility(false);
