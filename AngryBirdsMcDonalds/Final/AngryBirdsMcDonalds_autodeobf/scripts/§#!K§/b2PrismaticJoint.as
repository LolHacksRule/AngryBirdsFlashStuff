package §#!K§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§+!=§.x * this.§8!1§.x + (this.§7!d§ + this.§+!=§.z) * this.§>E§.x),param1 * (this.§+!=§.x * this.§8!1§.y + (this.§7!d§ + this.§+!=§.z) * this.§>E§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§'!#§)
         {
            ...
            this.§+!=§.y *= param1.§,!e§;
            this.§7!d§ *= param1.§,!e§;
            _loc19_ = this.§+!=§.x * this.§8!1§.x + (this.§7!d§ + this.§+!=§.z) * this.§>E§.x;
            _loc20_ = this.§+!=§.x * this.§8!1§.y + (this.§7!d§ + this.§+!=§.z) * this.§>E§.y;
            _loc21_ = this.§+!=§.x * this.m_s1 + this.§+!=§.y + (this.§7!d§ + this.§+!=§.z) * this.m_a1;
            _loc22_ = this.§+!=§.x * this.m_s2 + this.§+!=§.y + (this.§7!d§ + this.§+!=§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§^!>§ && this.§<!Q§ != b2internal::"R)
         {
            ...
            _loc15_ = this.§2,§ * (this.§@!Q§ - _loc14_);
            _loc16_ = this.§7!d§;
            _loc17_ = param1.§+u§ * this.§0<§;
            this.§7!d§ = b2Math.§]$§(this.§7!d§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§7!d§ - _loc16_) * this.§>E§.x;
         ...
         if(this.§]!C§ && this.§<!Q§ != b2internal::8b)
         {
            ...
            if(this.§<!Q§ == b2internal::`!2)
            {
               this.§+!=§.z = b2Math.§6!C§(this.§+!=§.z,0);
            }
            else if(this.§<!Q§ == b2internal::?!&)
            {
               this.§+!=§.z = b2Math.§[N§(this.§+!=§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§+!=§.z - _loc19_.z) * this.§1!%§.col3.x;
            _loc22_ = -_loc13_ - (this.§+!=§.z - _loc19_.z) * this.§1!%§.col3.y;
            ...
            _loc8_ = _loc20_.x * this.§8!1§.x + _loc20_.z * this.§>E§.x;
            _loc9_ = _loc20_.x * this.§8!1§.y + _loc20_.z * this.§>E§.y;
         ...
         else
         {
            ...
            this.§+!=§.x += _loc24_.x;
            this.§+!=§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§8!1§.x;
            _loc9_ = _loc24_.x * this.§8!1§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§]!C§)
         {
            ...
            else if(_loc35_ <= this.§ h§)
            {
               _loc19_ = b2Math.§]$§(_loc35_ - this.§ h§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§ h§ - _loc35_;
               _loc18_ = true;
            }
         ...
         var _loc31_:Number = _loc28_.x * this.§8!1§.x + _loc28_.z * this.§>E§.x;
         var _loc32_:Number = _loc28_.x * this.§8!1§.y + _loc28_.z * this.§>E§.y;
         ...
         _loc7_ -= b2internal::4!Y * _loc33_;
         _loc8_.x += b2internal::>V * _loc31_;
         _loc8_.y += b2internal::>V * _loc32_;
