package §7! §
{
   ...
   public class §3!<§
   {
      ...
      public static function §;!O§(param1:XML) : void
      {
         ...
         {
            §<_§[String(_loc3_.@name)] = _loc3_;
         }
      }
      
      public static function §8E§(param1:String, param2:§4n§, param3:Boolean = true) : §0@§.Sprite
      {
         var _loc7_:XML = null;
         var _loc8_:§%!h§ = null;
         var _loc9_:§1]§ = null;
         ...
         var _loc5_:§0@§.Sprite = new §0@§.Sprite();
      ...
      public static function §'!p§(param1:String, param2:§4n§) : flash.display.Sprite
      {
         var _loc6_:XML = null;
         var _loc7_:§%!h§ = null;
         ...
         var _loc4_:XML;
         var _loc5_:XMLList = (_loc4_ = §<_§[param1]).child(§@-§);
