package §4!4§
{
   ...
   class b2PositionSolverManifold
   {
      ...
      function b2PositionSolverManifold()
      {
         ...
         this.§"!h§ = new Vector.<b2Vec2>(b2Settings.b2_maxManifoldPoints);
         var _loc1_:int = 0;
         while(_loc1_ < b2Settings.b2_maxManifoldPoints)
         {
            this.§"!h§[_loc1_] = new b2Vec2();
            _loc1_++;
         }
      }
      
      public function §08§(param1:b2ContactConstraint) : void
      {
         var _loc2_:int = 0;
         ...
         switch(param1.type)
         {
            case b2Manifold.§`!f§:
               ...
               _loc5_ = param1.§<u§.m_xf.R;
               _loc6_ = param1.§=!G§[0].localPoint;
               _loc11_ = param1.§<u§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc12_ = param1.§<u§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               ...
               this.§"!h§[0].x = 0.5 * (_loc9_ + _loc11_);
               this.§"!h§[0].y = 0.5 * (_loc10_ + _loc12_);
               this.§#!'§[0] = _loc13_ * this.§6!"§.x + _loc14_ * this.§6!"§.y - param1.radius;
               break;
            case b2Manifold.§8Z§:
               _loc5_ = param1.§>!k§.m_xf.R;
               _loc6_ = param1.§#"§;
               ...
               while(_loc2_ < param1.§',§)
               {
                  _loc6_ = param1.§=!G§[_loc2_].localPoint;
                  _loc3_ = param1.§<u§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
                  _loc4_ = param1.§<u§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
                  this.§#!'§[_loc2_] = (_loc3_ - _loc7_) * this.§6!"§.x + (_loc4_ - _loc8_) * this.§6!"§.y - param1.radius;
                  this.§"!h§[_loc2_].x = _loc3_;
                  this.§"!h§[_loc2_].y = _loc4_;
                  _loc2_++;
               }
               break;
            case b2Manifold.§[n§:
               ...
               _loc5_ = param1.§<u§.m_xf.R;
               _loc6_ = param1.localPoint;
               _loc7_ = param1.§<u§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc8_ = param1.§<u§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               _loc5_ = param1.§>!k§.m_xf.R;
               _loc2_ = 0;
               while(_loc2_ < param1.§',§)
               {
                  ...
                  this.§#!'§[_loc2_] = (_loc3_ - _loc7_) * this.§6!"§.x + (_loc4_ - _loc8_) * this.§6!"§.y - param1.radius;
                  this.§"!h§[_loc2_].Set(_loc3_,_loc4_);
                  _loc2_++;
               }
               this.§6!"§.x *= -1;
               this.§6!"§.y *= -1;
