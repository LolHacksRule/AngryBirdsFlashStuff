package §+!o§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      b2internal var §0S§:Vector.<b2Vec2>;
      
      b2internal var §&!,§:Vector.<b2Vec2>;
      
      b2internal var §1y§:int;
      ...
      public function b2PolygonShape()
      {
         ...
         §,!f§ = b2internal::@P;
         this.§7!=§ = new b2Vec2();
         this.§0S§ = new Vector.<b2Vec2>();
         this.§&!,§ = new Vector.<b2Vec2>();
         §0!B§ = b2Settings.b2_polygonRadius;
         this.§7!=§.§4[§();
      }
      ...
      public static function §?u§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§7b§(param1,param2);
         return _loc3_;
      }
      ...
      public static function § !M§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
      ...
      public static function §0B§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §5!6§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
      ...
      b2internal static function §!A§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§[R§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§[R§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§6!^§(this.§1y§);
            _loc3_ = 0;
            while(_loc3_ < this.§1y§)
            {
               this.§0S§[_loc3_].SetV(_loc2_.§0S§[_loc3_]);
      ...
      public function §"!2§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§7b§(_loc3_,param2);
      }
      
      public function §7b§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§1y§)
         {
            this.§0S§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§1y§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§1y§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§6!a§(this.§0S§[_loc5_],this.§0S§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§'P§() > Number.MIN_VALUE);
            this.§&!,§[_loc3_].SetV(b2Math.§-!f§(_loc6_,1));
            this.§&!,§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§7!=§ = §5!6§(this.§0S§,this.§1y§);
      }
      ...
      public function §>!-§(param1:Number, param2:Number) : void
      {
         this.§1y§ = 4;
         this.§6!^§(4);
         this.§0S§[0].Set(-param1,-param2);
         this.§0S§[1].Set(param1,-param2);
         this.§0S§[2].Set(param1,param2);
         this.§0S§[3].Set(-param1,param2);
         this.§&!,§[0].Set(0,-1);
         this.§&!,§[1].Set(1,0);
         this.§&!,§[2].Set(0,1);
         this.§&!,§[3].Set(-1,0);
      ...
      public function §?Z§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§1y§)
         {
            this.§0S§[_loc6_] = b2Math.§=o§(_loc5_,this.§0S§[_loc6_]);
            this.§&!,§[_loc6_] = b2Math.§#!j§(_loc5_.R,this.§&!,§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §,m§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§1y§ = 2;
         this.§6!^§(2);
         this.§0S§[0].SetV(param1);
         this.§0S§[1].SetV(param2);
         this.§7!=§.x = 0.5 * (param1.x + param2.x);
         this.§7!=§.y = 0.5 * (param1.y + param2.y);
         this.§&!,§[0] = b2Math.§-!f§(b2Math.§6!a§(param2,param1),1);
         this.§&!,§[0].Normalize();
         this.§&!,§[1].x = -this.§&!,§[0].x;
         this.§&!,§[1].y = -this.§&!,§[0].y;
      }
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < this.§1y§)
         {
            _loc3_ = this.§0S§[_loc9_];
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§1y§)
         {
            _loc6_ = (_loc9_ = this.§0S§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§4%§.x = _loc5_ - b2internal::0!B;
         param1.§4%§.y = _loc6_ - b2internal::0!B;
         param1.§!#§.x = _loc7_ + b2internal::0!B;
         param1.§!#§.y = _loc8_ + b2internal::0!B;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§1y§ == 2)
         {
            param1.center.x = 0.5 * (this.§0S§[0].x + this.§0S§[1].x);
            param1.center.y = 0.5 * (this.§0S§[0].y + this.§0S§[1].y);
            param1.§14§ = 0;
            param1.§2+§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§1y§)
         {
            _loc11_ = this.§0S§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§1y§ ? this.§0S§[int(_loc10_ + 1)] : this.§0S§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§14§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§2+§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§83§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§1y§)
         {
            _loc7_[_loc12_] = b2Math.§83§(_loc5_,this.§0S§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§=o§(param3,_loc24_.center));
                  return _loc24_.§14§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§1y§;
         var _loc14_:int = (_loc10_ + 1) % this.§1y§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§0S§[_loc9_].x * (1 - _loc15_) + this.§0S§[_loc13_].x * _loc15_,this.§0S§[_loc9_].y * (1 - _loc15_) + this.§0S§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§0S§[_loc10_].x * (1 - _loc16_) + this.§0S§[_loc14_].x * _loc16_,this.§0S§[_loc10_].y * (1 - _loc16_) + this.§0S§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§0S§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§1y§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§0S§[_loc12_];
            }
         ...
         _loc20_.§`!-§(1 / _loc19_);
         param4.SetV(b2Math.§=o§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §1!3§() : Vector.<b2Vec2>
      {
         return this.§0S§;
      }
      ...
      {
         var _loc2_:int = this.§0S§.length;
         while(_loc2_ < param1)
         {
            this.§0S§[_loc2_] = new b2Vec2();
