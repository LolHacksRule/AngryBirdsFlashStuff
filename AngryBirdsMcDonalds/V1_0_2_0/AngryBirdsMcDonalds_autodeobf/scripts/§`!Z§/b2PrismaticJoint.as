package §`!Z§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§;!V§.x * this.§ in§.x + (this.§=E§ + this.§;!V§.z) * this.§"!R§.x),param1 * (this.§;!V§.x * this.§ in§.y + (this.§=E§ + this.§;!V§.z) * this.§"!R§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§7?§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§7?§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§7?§.col2.x = this.§7?§.col1.y;
         this.§7?§.col2.y = _loc16_ + _loc17_;
         this.§7?§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§7?§.col3.x = this.§7?§.col1.z;
         this.§7?§.col3.y = this.§7?§.col2.z;
         this.§7?§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§2!T§)
         {
         ...
         if(param1.§%!C§)
         {
            ...
            this.§;!V§.y *= param1.§2!=§;
            this.§=E§ *= param1.§2!=§;
            _loc19_ = this.§;!V§.x * this.§ in§.x + (this.§=E§ + this.§;!V§.z) * this.§"!R§.x;
            _loc20_ = this.§;!V§.x * this.§ in§.y + (this.§=E§ + this.§;!V§.z) * this.§"!R§.y;
            _loc21_ = this.§;!V§.x * this.m_s1 + this.§;!V§.y + (this.§=E§ + this.§;!V§.z) * this.m_a1;
            _loc22_ = this.§;!V§.x * this.m_s2 + this.§;!V§.y + (this.§=E§ + this.§;!V§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§68§ && this.§``§ != b2internal::3!T)
         {
            ...
            _loc15_ = this.§0T§ * (this.§-!N§ - _loc14_);
            _loc16_ = this.§=E§;
            _loc17_ = param1.§+n§ * this.§'F§;
            this.§=E§ = b2Math.§=!5§(this.§=E§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§=E§ - _loc16_) * this.§"!R§.x;
         ...
         if(this.§2!T§ && this.§``§ != b2internal::@x)
         {
            ...
            _loc19_ = this.§;!V§.Copy();
            _loc20_ = this.§7?§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§;!V§.§`s§(_loc20_);
            if(this.§``§ == b2internal::'_)
            {
               this.§;!V§.z = b2Math.§`l§(this.§;!V§.z,0);
            }
            else if(this.§``§ == b2internal::]!6)
            {
               this.§;!V§.z = b2Math.§+!b§(this.§;!V§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§;!V§.z - _loc19_.z) * this.§7?§.col3.x;
            _loc22_ = -_loc13_ - (this.§;!V§.z - _loc19_.z) * this.§7?§.col3.y;
            _loc23_ = this.§7?§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§;!V§.x = _loc23_.x;
            this.§;!V§.y = _loc23_.y;
            _loc20_.x = this.§;!V§.x - _loc19_.x;
            _loc20_.y = this.§;!V§.y - _loc19_.y;
            _loc20_.z = this.§;!V§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§ in§.x + _loc20_.z * this.§"!R§.x;
            _loc9_ = _loc20_.x * this.§ in§.y + _loc20_.z * this.§"!R§.y;
         ...
         {
            _loc24_ = this.§7?§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§;!V§.x += _loc24_.x;
            this.§;!V§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§ in§.x;
            _loc9_ = _loc24_.x * this.§ in§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§2!T§)
         {
            ...
            else if(_loc35_ <= this.§'T§)
            {
               _loc19_ = b2Math.§=!5§(_loc35_ - this.§'T§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§'T§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.native)
            {
               _loc19_ = b2Math.§=!5§(_loc35_ - this.native + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.native;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§7?§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§7?§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§7?§.col2.x = this.§7?§.col1.y;
            this.§7?§.col2.y = _loc14_ + _loc15_;
            this.§7?§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§7?§.col3.x = this.§7?§.col1.z;
            this.§7?§.col3.y = this.§7?§.col2.z;
            this.§7?§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§7?§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::]!_;
            ...
            this.§7?§.col1.Set(_loc36_,_loc37_,0);
            this.§7?§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§7?§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§ in§.x + _loc28_.z * this.§"!R§.x;
         var _loc32_:Number = _loc28_.x * this.§ in§.y + _loc28_.z * this.§"!R§.y;
         ...
         _loc6_.x -= b2internal::]!_ * _loc31_;
         _loc6_.y -= b2internal::]!_ * _loc32_;
         _loc7_ -= b2internal::;i * _loc33_;
         _loc8_.x += b2internal::;L * _loc31_;
         _loc8_.y += b2internal::;L * _loc32_;
