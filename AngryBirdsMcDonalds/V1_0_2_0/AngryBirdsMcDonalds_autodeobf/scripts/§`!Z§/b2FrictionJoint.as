package §`!Z§
{
   ...
   public class b2FrictionJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * this.§7s§.x,param1 * this.§7s§.y);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§%!C§)
         {
            ...
            this.§&!"§ *= param1.§2!=§;
            _loc15_ = this.§7s§;
            _loc4_.§'R§.x -= _loc10_ * _loc15_.x;
            _loc4_.§'R§.y -= _loc10_ * _loc15_.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * _loc15_.y - _loc7_ * _loc15_.x + this.§&!"§);
            _loc5_.§'R§.x += _loc11_ * _loc15_.x;
            _loc5_.§'R§.y += _loc11_ * _loc15_.y;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc18_ = param1.§+n§ * this.§0!Q§;
         this.§&!"§ = b2Math.§=!5§(this.§&!"§ + _loc20_,-_loc18_,_loc18_);
         ...
         var _loc25_:b2Vec2 = this.§7s§.Copy();
         this.§7s§.§`s§(_loc24_);
         _loc18_ = param1.§+n§ * this.§,!J§;
         if(this.§7s§.§6!5§() > _loc18_ * _loc18_)
         {
            this.§7s§.Normalize();
            this.§7s§.§7!E§(_loc18_);
         }
         _loc24_ = b2Math.§^!Y§(this.§7s§,_loc25_);
