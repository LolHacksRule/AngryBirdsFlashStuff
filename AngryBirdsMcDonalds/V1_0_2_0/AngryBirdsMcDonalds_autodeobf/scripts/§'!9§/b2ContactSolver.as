package §'!9§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §[!H§:b2WorldManifold = new b2WorldManifold();
      
      private static var §-!§:b2PositionSolverManifold = new b2PositionSolverManifold();
       
      
      private var §1q§:b2TimeStep;
      ...
      {
         this.§1q§ = new b2TimeStep();
         this.§+!E§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §6!_§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§2!G§;
            _loc10_ = _loc5_.§#!S§;
            _loc11_ = _loc9_.§+!Z§;
            _loc12_ = _loc10_.§+!Z§;
            _loc13_ = _loc11_.§^!c§;
            ...
            §[!H§.§6!_§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §[!H§.§1m§.x;
            _loc27_ = §[!H§.§1m§.y;
            (_loc28_ = this.§+!E§[_loc6_]).§+!#§ = _loc15_;
            _loc28_.§1!K§ = _loc16_;
            _loc28_.§>B§ = _loc17_;
            ...
            _loc28_.§"!k§.x = _loc17_.§#S§.x;
            _loc28_.§"!k§.y = _loc17_.§#S§.y;
            ...
            while(_loc29_ < _loc28_.§[3§)
            {
               ...
               (_loc31_ = _loc28_.§"!T§[_loc29_]).normalImpulse = _loc30_.§79§;
               _loc31_.tangentImpulse = _loc30_.§++§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§,n§.x = §[!H§.§;N§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§,n§.y = §[!H§.§;N§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§>!O§.x = §[!H§.§;N§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§>!O§.y = §[!H§.§;N§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§>w§ + _loc16_.§>w§ + _loc15_.§#R§ * _loc36_ + _loc16_.§#R§ * _loc37_;
               _loc31_.§0!;§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§9!M§ * _loc15_.§>w§ + _loc16_.§9!M§ * _loc16_.§>w§) + (_loc15_.§9!M§ * _loc15_.§#R§ * _loc36_ + _loc16_.§9!M§ * _loc16_.§#R§ * _loc37_);
               _loc31_.§,!e§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§>w§ + _loc16_.§>w§ + _loc15_.§#R§ * _loc42_ + _loc16_.§#R§ * _loc43_;
               _loc31_.§5d§ = 1 / _loc44_;
               _loc31_.§&3§ = 0;
               ...
               {
                  _loc31_.§&3§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§[3§ == 2)
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         while(_loc5_ < this.§0!!§)
         {
            ...
            if(param1.§%!C§)
            {
               ...
               {
                  _loc20_ = _loc6_.§"!T§[_loc18_];
                  _loc20_.normalImpulse *= param1.§2!=§;
                  _loc20_.tangentImpulse *= param1.§2!=§;
                  ...
                  _loc7_.§'R§.x -= _loc9_ * _loc21_;
                  _loc7_.§'R§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§>!O§.x * _loc22_ - _loc20_.§>!O§.y * _loc21_);
                  _loc8_.§'R§.x += _loc11_ * _loc21_;
                  _loc8_.§'R§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  (_loc23_ = _loc6_.§"!T§[_loc18_]).normalImpulse = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         {
            _loc26_ = (_loc25_ = this.§+!E§[_loc24_]).§+!#§;
            _loc27_ = _loc25_.§1!K§;
            ...
            {
               _loc2_ = _loc25_.§"!T§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§>!O§.y - _loc30_.x + _loc28_ * _loc2_.§,n§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§>!O§.x - _loc30_.y - _loc28_ * _loc2_.§,n§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§5d§ * -_loc10_;
            ...
            if(_loc25_.§[3§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§0!;§ * (_loc9_ - _loc2_.§&3§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§>!O§.y - _loc30_.x + _loc28_ * _loc43_.§,n§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§>!O§.x - _loc30_.y - _loc28_ * _loc43_.§,n§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§>!O§.y - _loc30_.x + _loc28_ * _loc44_.§,n§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§>!O§.x - _loc30_.y - _loc28_ * _loc44_.§,n§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§&3§;
               _loc54_ = _loc52_ - _loc44_.§&3§;
               _loc22_ = _loc25_.§%! §;
      ...
      public function §8`§() : void
      {
         ...
         while(_loc1_ < this.§0!!§)
         {
            ...
            while(_loc4_ < _loc2_.§[3§)
            {
               ...
               _loc6_ = _loc2_.§"!T§[_loc4_];
               _loc5_.§79§ = _loc6_.normalImpulse;
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§0!!§)
         {
            _loc5_ = (_loc4_ = this.§+!E§[_loc3_]).§+!#§;
            _loc6_ = _loc4_.§1!K§;
            _loc7_ = _loc5_.§9!M§ * _loc5_.§>w§;
            _loc8_ = _loc5_.§9!M§ * _loc5_.§#R§;
            _loc9_ = _loc6_.§9!M§ * _loc6_.§>w§;
            _loc10_ = _loc6_.§9!M§ * _loc6_.§#R§;
            §-!§.§6!_§(_loc4_);
            _loc11_ = §-!§.§1m§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§[3§)
            {
               _loc13_ = _loc4_.§"!T§[_loc12_];
               _loc14_ = §-!§.§;N§[_loc12_];
               _loc15_ = §-!§.§63§[_loc12_];
               ...
               _loc22_ = (_loc21_ = -_loc13_.§,!e§ * _loc20_) * _loc11_.x;
