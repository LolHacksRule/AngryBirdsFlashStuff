package §",§
{
   ...
   public class Texture
   {
      ...
      {
         return §7N§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §7N§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §",§.Texture
      {
         ...
         _loc10_ = new §>!9§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§<!2§.§+X§)
         {
            _loc10_.§8Z§(param2);
         }
      ...
      public static function §[!-§(param1:Context3D, param2:ByteArray) : §",§.Texture
      {
         ...
         var _loc9_:§>!9§ = new §>!9§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§<!2§.§+X§)
         {
            _loc9_.§8Z§(param2);
         }
      ...
      public static function §,!p§(param1:§",§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §",§.Texture
      {
         var _loc4_:§",§.Texture;
         (_loc4_ = new §<!4§(param1,param2)).§]!$§ = param3;
         return _loc4_;
      }
      ...
      public static function §&!=§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §",§.Texture
      {
         ...
         var _loc7_:§",§.Texture = §7N§(param1,_loc6_,false,param5);
         if(!§<!2§.§+X§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§!i§, param2:int, param3:int) : void
      {
         ...
         if(this.§]!$§)
         {
            ...
            param1.§[<§(param2 + 1,-_loc4_,-this.§]!$§.y);
            param1.§[<§(param2 + 2,-this.§]!$§.x,-_loc5_);
            param1.§[<§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      
      public function get §+!Q§() : Rectangle
      {
