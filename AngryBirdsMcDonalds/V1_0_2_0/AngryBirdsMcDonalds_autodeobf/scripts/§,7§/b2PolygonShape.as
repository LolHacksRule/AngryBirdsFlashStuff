package §,7§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §9!!§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §2!3§:b2Vec2;
      ...
      public static function §-i§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §1!j§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §>J§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§`s§(new b2Vec2(0,0));
            _loc3_.§`s§(_loc9_);
            _loc3_.§`s§(_loc10_);
            _loc3_.§7!E§(_loc16_ * _loc7_);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §^G§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§6!R§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§6!R§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §0'§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§[S§)
         {
            this.§<!T§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§[S§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§[S§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§^!Y§(this.§<!T§[_loc5_],this.§<!T§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§6!5§() > Number.MIN_VALUE);
            this.§>M§[_loc3_].SetV(b2Math.§?j§(_loc6_,1));
            this.§>M§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§2!3§ = §>J§(this.§<!T§,this.§[S§);
      }
      ...
      public function §]!h§(param1:Number, param2:Number) : void
      {
         this.§[S§ = 4;
         this.§&9§(4);
         this.§<!T§[0].Set(-param1,-param2);
         this.§<!T§[1].Set(param1,-param2);
         this.§<!T§[2].Set(param1,param2);
         this.§<!T§[3].Set(-param1,param2);
         this.§>M§[0].Set(0,-1);
         this.§>M§[1].Set(1,0);
         this.§>M§[2].Set(0,1);
         this.§>M§[3].Set(-1,0);
      ...
      public function §]k§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§[S§)
         {
            this.§<!T§[_loc6_] = b2Math.§<!E§(_loc5_,this.§<!T§[_loc6_]);
            this.§>M§[_loc6_] = b2Math.§+!T§(_loc5_.R,this.§>M§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §!!j§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§[S§ = 2;
         this.§&9§(2);
         this.§<!T§[0].SetV(param1);
         this.§<!T§[1].SetV(param2);
         this.§2!3§.x = 0.5 * (param1.x + param2.x);
         this.§2!3§.y = 0.5 * (param1.y + param2.y);
         this.§>M§[0] = b2Math.§?j§(b2Math.§^!Y§(param2,param1),1);
         this.§>M§[0].Normalize();
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§[S§)
         {
            _loc6_ = (_loc9_ = this.§<!T§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§>M§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§"!^§.x = _loc5_ - b2internal::^!c;
         param1.§"!^§.y = _loc6_ - b2internal::^!c;
         param1.§6L§.x = _loc7_ + b2internal::^!c;
         param1.§6L§.y = _loc8_ + b2internal::^!c;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§[S§ == 2)
         {
            param1.center.x = 0.5 * (this.§<!T§[0].x + this.§<!T§[1].x);
            param1.center.y = 0.5 * (this.§<!T§[0].y + this.§<!T§[1].y);
            param1.§,q§ = 0;
            param1.§#!M§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§[S§)
         {
            _loc11_ = this.§<!T§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§[S§ ? this.§<!T§[int(_loc10_ + 1)] : this.§<!T§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§#!G§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§`z§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§[S§)
         {
            _loc7_[_loc12_] = b2Math.§`z§(_loc5_,this.§<!T§[_loc12_]) - _loc6_;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§[S§;
         var _loc14_:int = (_loc10_ + 1) % this.§[S§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§<!T§[_loc9_].x * (1 - _loc15_) + this.§<!T§[_loc13_].x * _loc15_,this.§<!T§[_loc9_].y * (1 - _loc15_) + this.§<!T§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§<!T§[_loc10_].x * (1 - _loc16_) + this.§<!T§[_loc14_].x * _loc16_,this.§<!T§[_loc10_].y * (1 - _loc16_) + this.§<!T§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§<!T§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§[S§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§<!T§[_loc12_];
            }
      ...
      public function §;Z§(param1:b2Vec2) : int
      {
