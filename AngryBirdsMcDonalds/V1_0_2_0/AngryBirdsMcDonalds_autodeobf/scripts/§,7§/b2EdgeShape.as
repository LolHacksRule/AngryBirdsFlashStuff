package §,7§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§1m§.Set(this.§`A§.y,-this.§`A§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§1m§.x - this.§`A§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§1m§.y - this.§`A§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§1m§.x + this.§`A§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§1m§.y + this.§`A§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§1m§;
         this.m_cornerDir2.Set(-this.§1m§.x,-this.§1m§.y);
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc8_:Number = b2Math.§`z§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§`z§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §]!0§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §9!L§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
