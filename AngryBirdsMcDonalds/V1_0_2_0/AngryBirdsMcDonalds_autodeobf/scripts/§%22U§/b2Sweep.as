package §"U§
{
   public class b2Sweep
   {
      ...
      public function Copy() : b2Sweep
      {
         ...
         _loc1_.a0 = this.a0;
         _loc1_.a = this.a;
         _loc1_.§throw§ = this.§throw§;
         return _loc1_;
      }
      
      public function §=q§(param1:b2Transform, param2:Number) : void
      {
      ...
      public function §6>§(param1:Number) : void
      {
         ...
         if(this.§throw§ < param1 && 1 - this.§throw§ > Number.MIN_VALUE)
         {
            _loc2_ = (param1 - this.§throw§) / (1 - this.§throw§);
