package §"U§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§1V§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §5a§(param1:Number) : Boolean
      {
      ...
      {
         return new b2Vec2(§`z§(param2,param1.col1),§`z§(param2,param1.col2));
      }
      ...
      public static function §,!Z§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
      ...
      public static function §6!k§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §1!n§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         var _loc3_:Number = param1.x - param2.x;
         var _loc4_:Number = param1.y - param2.y;
      ...
      public static function §var§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§1V§(§[!L§(param1.col1,param2.col1),§[!L§(param1.col2,param2.col2));
      }
      
      public static function §'S§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§1V§(§+!T§(param1,param2.col1),§+!T§(param1,param2.col2));
      }
      
      public static function §?! §(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§`z§(param1.col1,param2.col1),§`z§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§`z§(param1.col1,param2.col2),§`z§(param1.col2,param2.col2));
         return b2Mat22.§1V§(_loc3_,_loc4_);
      }
      ...
      public static function §1=§(param1:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§1V§(§1=§(param1.col1),§1=§(param1.col2));
      }
      ...
      public static function §#y§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§`l§(param1.x,param2.x),§`l§(param1.y,param2.y));
      }
      ...
      public static function §5v§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §#y§(param2,§?!b§(param1,param3));
      }
      
      public static function §9=§(param1:Array, param2:Array) : void
      {
         var _loc3_:* = param1[0];
         param1[0] = param2[0];
         param2[0] = _loc3_;
      ...
      public static function §2!d§(param1:uint) : uint
      {
