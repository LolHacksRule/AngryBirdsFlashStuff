package §"U§
{
   public class b2Vec2
   {
      ...
      public static function §>!B§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §7!E§(param1:Number) : void
      {
         this.x *= param1;
         this.y *= param1;
      }
      ...
      public function §0!H§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§`z§(this,param1.col1);
         this.y = b2Math.§`z§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      {
         return b2Math.§5a§(this.x) && b2Math.§5a§(this.y);
      }
   }
}
