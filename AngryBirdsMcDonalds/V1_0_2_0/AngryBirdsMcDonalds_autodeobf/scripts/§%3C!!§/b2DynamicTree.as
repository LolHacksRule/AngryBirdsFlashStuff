package §<!!§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §4f§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
         ...
         _loc3_.aabb.§6L§.x = param1.§6L§.x + _loc4_;
         _loc3_.aabb.§6L§.y = param1.§6L§.y + _loc5_;
         _loc3_.§,3§ = param2;
         this.§][§(_loc3_);
         return _loc3_;
      }
      ...
      public function §72§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         var _loc4_:Number = NaN;
         var _loc5_:Number = NaN;
         b2Settings.b2Assert(param1.§+!"§());
         if(param1.aabb.§8x§(param2))
         {
            return false;
         }
         this.§#!T§(param1);
         ...
         param1.aabb.§6L§.x = param2.§6L§.x + _loc4_;
         param1.aabb.§6L§.y = param2.§6L§.y + _loc5_;
         this.§][§(param1);
         return true;
      }
      ...
      public function §-!K§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            ...
            while(_loc3_.§+!"§() == false)
            {
               _loc3_ = !!(this.§?F§ >> _loc4_ & 1) ? _loc3_.child2 : _loc3_.child1;
               _loc4_ = _loc4_ + 1 & 31;
            }
            ++this.§?F§;
            this.§#!T§(_loc3_);
      ...
      public function §6!^§(param1:b2DynamicTreeNode) : b2AABB
      {
         return param1.aabb;
      }
      ...
      public function §0x§(param1:Function, param2:b2AABB) : void
      {
         ...
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§;l§(param2))
            {
               if(_loc5_.§+!"§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§%!p§(1,_loc5_);
         var _loc7_:b2Vec2 = b2Math.§1=§(_loc6_);
         ...
         _loc9_.§6L§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§6L§.y = Math.max(_loc3_.y,_loc11_);
         ...
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§;l§(_loc9_) != false)
            {
      ...
      private function §3!J§() : b2DynamicTreeNode
      {
         var _loc1_:b2DynamicTreeNode = null;
         if(this.§&Z§)
         {
            _loc1_ = this.§&Z§;
            this.§&Z§ = _loc1_.parent;
            _loc1_.parent = null;
            _loc1_.child1 = null;
            _loc1_.child2 = null;
            return _loc1_;
      ...
      private function §for §(param1:b2DynamicTreeNode) : void
      {
         param1.parent = this.§&Z§;
         this.§&Z§ = param1;
      }
      ...
      private function §][§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_.§+!"§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§"!^§.x + _loc6_.aabb.§6L§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§"!^§.y + _loc6_.aabb.§6L§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§"!^§.x + _loc7_.aabb.§6L§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§"!^§.y + _loc7_.aabb.§6L§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         (_loc5_ = this.§3!J§()).parent = _loc4_;
         _loc5_.§,3§ = null;
         _loc5_.aabb.§4!l§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            while(!_loc4_.aabb.§8x§(_loc5_.aabb))
            {
               _loc4_.aabb.§4!l§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
      ...
      private function §#!T§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc5_ = _loc3_.aabb;
               _loc3_.aabb = b2AABB.§4!l§(_loc3_.child1.aabb,_loc3_.child2.aabb);
               if(_loc5_.§8x§(_loc3_.aabb))
               {
                  break;
               }
