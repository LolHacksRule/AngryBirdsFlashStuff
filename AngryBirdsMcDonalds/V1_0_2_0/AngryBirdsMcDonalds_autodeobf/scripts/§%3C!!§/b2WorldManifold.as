package §<!!§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §6!_§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§+k§)
         {
            case b2Manifold.§3b§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§1m§.x = _loc19_ / _loc26_;
                  this.§1m§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§1m§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§1m§.x;
               _loc23_ = _loc16_ + param3 * this.§1m§.y;
               _loc24_ = _loc17_ - param5 * this.§1m§.x;
               _loc25_ = _loc18_ - param5 * this.§1m§.y;
