package §<!!§
{
   ...
   public class b2Collision
   {
      ...
      private static var §^!F§:Vector.<§^!M§> = §1N§();
      
      private static var s_clipPoints1:Vector.<§^!M§> = §1N§();
      
      private static var s_clipPoints2:Vector.<§^!M§> = §1N§();
      
      private static var §+!<§:Vector.<int> = new Vector.<int>(1);
      
      private static var §1R§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §?!e§(param1:Vector.<§^!M§>, param2:Vector.<§^!M§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§^!M§ = null;
         var _loc6_:int = 0;
      ...
      public static function §3^§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param1.§<!T§;
         var _loc8_:Vector.<b2Vec2> = param1.§>M§;
         var _loc9_:int = param4.§[S§;
         var _loc10_:Vector.<b2Vec2> = param4.§<!T§;
         _loc11_ = param2.R;
      ...
      public static function §9z§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
      ...
      public static function §"!L§(param1:Vector.<§^!M§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§^!M§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§[S§;
         var _loc8_:Vector.<b2Vec2> = param2.§>M§;
         var _loc9_:int = param5.§[S§;
         var _loc10_:Vector.<b2Vec2> = param5.§<!T§;
         ...
         _loc20_.id.§^!C§.§2!,§ = param4;
         _loc20_.id.§^!C§.§=!9§ = _loc21_;
         _loc20_.id.§^!C§.§<!G§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§^!C§.§2!,§ = param4;
         _loc20_.id.§^!C§.§=!9§ = _loc22_;
         _loc20_.id.§^!C§.§<!G§ = 1;
      }
      
      private static function §1N§() : Vector.<§^!M§>
      {
         var _loc1_:Vector.<§^!M§> = new Vector.<§^!M§>(2);
         _loc1_[0] = new §^!M§();
         _loc1_[1] = new §^!M§();
         return _loc1_;
      }
      
      public static function §%7§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§^!M§ = null;
         ...
         var _loc8_:int = 0;
         §+!<§[0] = _loc8_;
         var _loc9_:Number = §9z§(§+!<§,param2,param3,param4,param5);
         _loc8_ = §+!<§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §1R§[0] = _loc10_;
         var _loc11_:Number = §9z§(§1R§,param4,param5,param2,param3);
         _loc10_ = §1R§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§+k§ = b2Manifold.§-!b§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§^!M§> = §^!F§;
         §"!L§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§[S§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§<!T§)[_loc16_];
         ...
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §?!f§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §-!O§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§^!M§> = s_clipPoints1;
         var _loc38_:Vector.<§^!M§> = s_clipPoints2;
         if((_loc39_ = §?!e§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §?!e§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§#S§.SetV(_loc27_);
      ...
      public static function §3!Z§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§+k§ = b2Manifold.§3b§;
         param1.m_localPoint.SetV(param2.§--§);
         param1.§#S§.§1!=§();
         param1.§&!-§ = 1;
         param1.§;N§[0].m_localPoint.SetV(param4.§--§);
      ...
      public static function §[e§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§[S§;
         var _loc22_:Vector.<b2Vec2> = param2.§<!T§;
         var _loc23_:Vector.<b2Vec2> = param2.§>M§;
         var _loc24_:int = 0;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§&!-§ = 1;
            param1.§+k§ = b2Manifold.§-!b§;
            param1.§#S§.x = _loc15_ - _loc27_.x;
            param1.§#S§.y = _loc16_ - _loc27_.y;
            param1.§#S§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§&!-§ = 1;
            param1.§+k§ = b2Manifold.§-!b§;
            param1.§#S§.x = _loc15_ - _loc28_.x;
            param1.§#S§.y = _loc16_ - _loc28_.y;
            param1.§#S§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§;N§[0].m_localPoint.SetV(param4.§--§);
            param1.§;N§[0].m_id.key = 0;
      ...
      public static function §;l§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§"!^§;
         var _loc4_:b2Vec2 = param1.§6L§;
