package §<!!§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §6!_§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         if(_loc6_ == 1)
         {
            ...
            _loc10_ = this.§9b§.§#!&§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§+k§ = §+!h§;
            _loc11_ = this.§9b§.§#!&§(param1.indexB[0]);
            _loc12_ = this.§9b§.§#!&§(param1.indexB[1]);
            _loc7_ = this.§4!;§.§#!&§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§"!R§ = b2Math.§?j§(b2Math.§^!Y§(_loc12_,_loc11_),1);
            this.§"!R§.Normalize();
            _loc20_ = this.§"!R§;
         ...
         else
         {
            ...
            _loc11_ = this.§9b§.§#!&§(param1.indexB[0]);
            _loc12_ = this.§9b§.§#!&§(param1.indexB[1]);
            _loc23_ = b2Math.§<!E§(param3,_loc7_);
            _loc24_ = b2Math.§+!T§(param3.R,b2Math.§^!Y§(_loc9_,_loc8_));
            _loc25_ = b2Math.§<!E§(param5,_loc10_);
            _loc26_ = b2Math.§+!T§(param5.R,b2Math.§^!Y§(_loc12_,_loc11_));
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §#!3§:
               _loc3_ = b2Math.§#!G§(param1.R,this.§"!R§);
               _loc4_ = b2Math.§#!G§(param2.R,this.§"!R§.§#6§());
               _loc5_ = this.§4!;§.§<!>§(_loc3_);
               _loc6_ = this.§9b§.§<!>§(_loc4_);
               _loc7_ = b2Math.§<!E§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§<!E§(param2,_loc6_)).x - _loc7_.x) * this.§"!R§.x + (_loc8_.y - _loc7_.y) * this.§"!R§.y);
            case §-!b§:
               _loc10_ = b2Math.§+!T§(param1.R,this.§"!R§);
               _loc7_ = b2Math.§<!E§(param1,this.m_localPoint);
               _loc4_ = b2Math.§#!G§(param2.R,_loc10_.§#6§());
               _loc6_ = this.§9b§.§<!>§(_loc4_);
               return Number(((_loc8_ = b2Math.§<!E§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §+!h§:
               _loc10_ = b2Math.§+!T§(param2.R,this.§"!R§);
               _loc8_ = b2Math.§<!E§(param2,this.m_localPoint);
               _loc3_ = b2Math.§#!G§(param1.R,_loc10_.§#6§());
               _loc5_ = this.§4!;§.§<!>§(_loc3_);
               return Number(((_loc7_ = b2Math.§<!E§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
