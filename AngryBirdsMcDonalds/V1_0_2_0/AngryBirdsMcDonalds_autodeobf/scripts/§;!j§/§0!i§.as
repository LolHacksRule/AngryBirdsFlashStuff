package §;!j§
{
   public class §0!i§
   {
      ...
      public static function §`!O§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
      ...
      private static function §-!Y§(param1:String, param2:Boolean) : String
      {
