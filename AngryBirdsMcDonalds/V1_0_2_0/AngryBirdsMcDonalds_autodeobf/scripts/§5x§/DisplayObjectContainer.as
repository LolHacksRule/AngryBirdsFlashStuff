package §5x§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§#!#§[param1];
            _loc3_.dispatchEvent(new Event(Event.§8L§,true));
            if(stage)
            {
      ...
      public function §-!I§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      public function §98§(param1:Function) : void
      {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§#!#§[_loc6_];
            §,!S§(_loc7_,§4U§);
            transformCoords(§4U§,_loc3_,_loc4_,§+N§);
