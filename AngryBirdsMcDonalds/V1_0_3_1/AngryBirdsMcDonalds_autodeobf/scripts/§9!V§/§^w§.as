package §9!V§
{
   ...
   public class §^w§
   {
      ...
      public static function §class§(param1:String) : String
      {
         ...
         return §?+§.§8S§(_loc3_.readInt(),true) + §?+§.§8S§(_loc3_.readInt(),true) + §?+§.§8S§(_loc3_.readInt(),true) + §?+§.§8S§(_loc3_.readInt(),true) + §?+§.§8S§(_loc3_.readInt(),true);
      }
      
      public static function §=$§(param1:ByteArray) : String
      {
         var _loc2_:Array = §^w§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §?6§(_loc2_);
         return §?+§.§8S§(_loc3_.readInt(),true) + §?+§.§8S§(_loc3_.readInt(),true) + §?+§.§8S§(_loc3_.readInt(),true) + §?+§.§8S§(_loc3_.readInt(),true) + §?+§.§8S§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §^w§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §?6§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
