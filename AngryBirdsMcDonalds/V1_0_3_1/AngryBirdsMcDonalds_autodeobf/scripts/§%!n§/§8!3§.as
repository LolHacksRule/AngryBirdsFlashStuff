package §%!n§
{
   ...
   public class §8!3§
   {
      ...
      public static function §,5§(param1:XMLList, param2:XMLList, param3:XMLList) : void
      {
         var _loc4_:XML = null;
         §?!9§ = new Array();
      ...
      public static function §^L§(param1:XMLList, param2:XMLList) : void
      {
         var _loc3_:XML = null;
         var _loc4_:§;%§ = null;
      ...
      {
         §?!9§[§?!9§.length] = new §;%§(param1,param2,param3,param4,param5,param6,param7,param8);
      }
      ...
      public static function §`[§(param1:String) : §;%§
      {
         ...
         {
            if((§?!9§[_loc2_] as §;%§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §;%§(§?!9§[_loc2_]);
            }
            _loc2_++;
