         ...
         for(_loc3_ in param1)
         {
            if(_loc3_.indexOf("chars") == 0)
            {
               ...
               for(_loc5_ in _loc4_)
               {
                  ...
                  (_loc7_ = new § else§()).mName = String.fromCharCode(_loc6_.code);
                  _loc7_.§5!4§ = new Rectangle(_loc6_.x,_loc6_.y,_loc6_.width,_loc6_.height);
                  _loc7_.§[3§ = _loc6_.width / 2;
                  _loc7_.§75§ = _loc6_.baseline;
                  _loc7_.§"!k§ = §`#§;
                  §9!^§(_loc7_);
               }
            }
