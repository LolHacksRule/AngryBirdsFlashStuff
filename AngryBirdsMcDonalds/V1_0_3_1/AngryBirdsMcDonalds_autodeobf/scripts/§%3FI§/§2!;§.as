package §?I§
{
   ...
   public class §2!;§
   {
      ...
      {
         var _loc2_:BitmapData = §=P§(param1);
         return §4,§.encode(_loc2_);
      }
      
      public static function §7!A§(param1:DisplayObject, param2:Number) : ByteArray
      {
         var _loc3_:BitmapData = §=P§(param1);
         var _loc4_:§,!S§;
         return (_loc4_ = new §,!S§(param2)).encode(_loc3_);
      }
      
      public static function §=P§(param1:DisplayObject) : BitmapData
      {
