package §&c§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private var §1!K§:Vector.<DisplayObject>;
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§1!K§ = new Vector.<DisplayObject>(0);
      }
      
      override public function dispose() : void
      {
         var _loc1_:int = this.§1!K§.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            this.§1!K§[_loc2_].dispose();
            _loc2_++;
         }
         super.dispose();
      }
      ...
      public function addChildAt(param1:DisplayObject, param2:int) : void
      {
         ...
         {
            param1.§`!D§();
            this.§1!K§.splice(param2,0,param1);
            param1.§1<§(this);
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§1!K§[param1];
            _loc3_.dispatchEvent(new Event(Event.§4M§,true));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§ $§));
            }
            _loc3_.§1<§(null);
            this.§1!K§.splice(param1,1);
            if(param2)
            {
               _loc3_.dispose();
            }
      ...
      public function §>S§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      {
         var _loc2_:int = this.§1!K§.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            if(this.§1!K§[_loc3_].name == param1)
            {
               return this.§1!K§[_loc3_];
            }
            _loc3_++;
         }
         return null;
      ...
      {
         return this.§1!K§.indexOf(param1);
      }
      ...
      public function swapChildren(param1:DisplayObject, param2:DisplayObject) : void
      {
         ...
         this.§0J§(_loc3_,_loc4_);
      }
      
      public function §0J§(param1:int, param2:int) : void
      {
         var _loc3_:DisplayObject = this.getChildAt(param1);
         var _loc4_:DisplayObject = this.getChildAt(param2);
         this.§1!K§[param1] = _loc4_;
         this.§1!K§[param2] = _loc3_;
      }
      
      public function §;;§(param1:Function) : void
      {
         this.§1!K§ = this.§1!K§.sort(param1);
      }
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§1!K§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§1!K§.length;
         if(_loc3_ == 0)
         {
            §1d§(param1,§"!3§);
            transformCoords(§"!3§,0,0,§2E§);
            param2.x = §2E§.x;
            param2.y = §2E§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§1!K§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§1!K§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§1!K§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§1!K§[_loc6_];
            §1d§(_loc7_,§"!3§);
            transformCoords(§"!3§,_loc3_,_loc4_,§2E§);
            if(_loc8_ = _loc7_.hitTest(§2E§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§3!e§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§1!K§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§#i§();
               param1.§=L§(_loc5_);
      ...
      private function §#!]§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§1!K§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
