package §8!b§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §!m§:b2Mat22 = new b2Mat22();
      ...
      public static function §6L§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
      ...
      public static function §-C§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§3!V§(param1,param2);
         return _loc3_;
      }
      ...
      b2internal static function §>!T§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
      ...
      public function §6j§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function §,!"§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§0`§)
         {
            ...
            _loc6_ = b2Math.§+z§(this.§&!B§[_loc5_],this.§&!B§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§2!j§() > Number.MIN_VALUE);
            this.§^!-§[_loc3_].SetV(b2Math.§=!8§(_loc6_,1));
            this.§^!-§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§`l§ = §,!?§(this.§&!B§,this.§0`§);
      }
      ...
      public function § Z§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§0`§)
         {
            this.§&!B§[_loc6_] = b2Math.§,z§(_loc5_,this.§&!B§[_loc6_]);
            this.§^!-§[_loc6_] = b2Math.§#F§(_loc5_.R,this.§^!-§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §3!V§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§0`§ = 2;
         this.§3w§(2);
         this.§&!B§[0].SetV(param1);
         this.§&!B§[1].SetV(param2);
         this.§`l§.x = 0.5 * (param1.x + param2.x);
         this.§`l§.y = 0.5 * (param1.y + param2.y);
         this.§^!-§[0] = b2Math.§=!8§(b2Math.§+z§(param2,param1),1);
         this.§^!-§[0].Normalize();
         this.§^!-§[1].x = -this.§^!-§[0].x;
         this.§^!-§[1].y = -this.§^!-§[0].y;
      }
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§3=§.x = _loc5_ - b2internal::=V;
         param1.§3=§.y = _loc6_ - b2internal::=V;
         param1.§5V§.x = _loc7_ + b2internal::=V;
         param1.§5V§.y = _loc8_ + b2internal::=V;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         while(_loc10_ < this.§0`§)
         {
            ...
            _loc12_ = _loc10_ + 1 < this.§0`§ ? this.§&!B§[int(_loc10_ + 1)] : this.§&!B§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§0!f§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§7e§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§#!1§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§6!Z§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§6!Z§(_loc5_,this.§&!B§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§,z§(param3,_loc24_.center));
                  return _loc24_.§0!f§;
               }
               return 0;
               break;
         ...
         _loc20_.§5D§(1 / _loc19_);
         param4.SetV(b2Math.§,z§(param3,_loc20_));
         return _loc19_;
      }
      ...
      private function §3w§(param1:int) : void
      {
