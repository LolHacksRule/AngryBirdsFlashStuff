package §0,§
{
   public class b2Math
   {
      ...
      public static function §6!Z§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      {
         return new b2Vec2(§6!Z§(param2,param1.col1),§6!Z§(param2,param1.col2));
      }
      ...
      public static function §1Z§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         var _loc4_:Number = NaN;
         _loc3_ = §+z§(param2,param1.position);
      ...
      public static function §8d§(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§-!2§(§[!2§(param1.col1,param2.col1),§[!2§(param1.col2,param2.col2));
      }
      
      public static function §`q§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§-!2§(§#F§(param1,param2.col1),§#F§(param1,param2.col2));
      }
      
      public static function §;!7§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§6!Z§(param1.col1,param2.col1),§6!Z§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§6!Z§(param1.col1,param2.col2),§6!Z§(param1.col2,param2.col2));
      ...
      public static function §[E§(param1:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§`!9§(param1.x),§`!9§(param1.y));
      }
      
      public static function §#&§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§-!2§(§[E§(param1.col1),§[E§(param1.col2));
      }
      ...
      public static function §4E§(param1:uint) : uint
      {
      ...
      public static function §2n§(param1:uint) : Boolean
      {
