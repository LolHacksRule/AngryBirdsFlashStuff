package §!4§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§-V§ = b2internal::=s.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§7!=§.x - this.§-V§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§7!=§.y - this.§-V§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§!!Q§.x - this.§-V§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§!!Q§.y - this.§-V§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§3_§);
         this.m_localAnchor2.SetV(param1.§-<§);
         this.§ a§ = param1.§^C§;
         this.§'!G§ = param1.§!X§ + this.§ a§ * param1.§2!'§;
         this.m_maxLength1 = b2Math.§;!F§(param1.§+0§,this.§'!G§ - this.§ a§ * b2internal::"F);
         this.m_maxLength2 = b2Math.§;!F§(param1.§,!I§,(this.§'!G§ - b2internal::"F) / this.§ a§);
         this.§8!§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§8!§ * this.m_u2.x,param1 * this.§8!§ * this.m_u2.y);
      }
      ...
      {
         var _loc1_:b2Vec2 = this.§-V§.m_xf.position.Copy();
      ...
      {
         var _loc1_:b2Vec2 = b2internal::=s.GetWorldPoint(this.m_localAnchor1);
         var _loc2_:Number = this.§-V§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.§-V§.m_xf.position.y + this.m_groundAnchor1.y;
      ...
      public function GetLength2() : Number
      {
         ...
         var _loc2_:Number = this.§-V§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.§-V§.m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc14_:Number = this.§-V§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.§-V§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.§-V§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.§-V§.m_xf.position.y + this.m_groundAnchor2.y;
         this.m_u1.Set(_loc10_ - _loc14_,_loc11_ - _loc15_);
         this.m_u2.Set(_loc12_ - _loc16_,_loc13_ - _loc17_);
         var _loc18_:Number = this.m_u1.§?!5§();
         var _loc19_:Number = this.m_u2.§?!5§();
         if(_loc18_ > b2Settings.b2_linearSlop)
         {
            this.m_u1.§5D§(1 / _loc18_);
         }
         else
         {
            this.m_u1.§ !b§();
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§'!G§ - _loc18_ - this.§ a§ * _loc19_) > 0)
         {
            this.§`I§ = b2internal::1!`;
            this.§8!§ = 0;
         }
         ...
         {
            this.§`I§ = b2internal::6!B;
         }
         if(_loc18_ < this.m_maxLength1)
         {
            this.m_limitState1 = b2internal::1!`;
            this.m_limitImpulse1 = 0;
         }
         else
         {
            this.m_limitState1 = b2internal::6!B;
         }
         if(_loc19_ < this.m_maxLength2)
         {
            this.m_limitState2 = b2internal::1!`;
            this.m_limitImpulse2 = 0;
         }
         else
         {
            this.m_limitState2 = b2internal::6!B;
         }
         var _loc21_:Number = _loc5_ * this.m_u1.y - _loc6_ * this.m_u1.x;
         var _loc22_:Number = _loc8_ * this.m_u2.y - _loc9_ * this.m_u2.x;
         this.m_limitMass1 = _loc2_.§&l§ + _loc2_.§]!Q§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§&l§ + _loc3_.§]!Q§ * _loc22_ * _loc22_;
         this.§#!G§ = this.m_limitMass1 + this.§ a§ * this.§ a§ * this.m_limitMass2;
         ...
         {
            this.§8!§ *= param1.§,!m§;
            this.m_limitImpulse1 *= param1.§,!m§;
            this.m_limitImpulse2 *= param1.§,!m§;
            _loc23_ = (-this.§8!§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§8!§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§ a§ * this.§8!§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§ a§ * this.§8!§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§"M§.x += _loc2_.§&l§ * _loc23_;
            _loc2_.§"M§.y += _loc2_.§&l§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§]!Q§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§"M§.x += _loc3_.§&l§ * _loc25_;
            _loc3_.§"M§.y += _loc3_.§&l§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§`I§ == b2internal::6!B)
         {
            ...
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§ a§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§#!G§ * -_loc18_;
            _loc20_ = this.§8!§;
            this.§8!§ = b2Math.§[!l§(0,this.§8!§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§8!§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§ a§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§ a§ * _loc19_ * this.m_u2.y;
            _loc2_.§"M§.x += _loc2_.§&l§ * _loc14_;
            _loc2_.§"M§.y += _loc2_.§&l§ * _loc15_;
         ...
         if(this.m_limitState1 == b2internal::6!B)
         {
            _loc10_ = _loc2_.§"M§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§"M§.y + _loc2_.m_angularVelocity * _loc5_;
         ...
         if(this.m_limitState2 == b2internal::6!B)
         {
            _loc12_ = _loc3_.§"M§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§"M§.y + _loc3_.m_angularVelocity * _loc8_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal::=s;
         var _loc3_:b2Body = b2internal::"!;
         var _loc5_:Number = this.§-V§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.§-V§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.§-V§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.§-V§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         if(this.§`I§ == b2internal::6!B)
         {
            ...
            if(_loc18_ > b2Settings.b2_linearSlop)
            {
               this.m_u2.§5D§(1 / _loc18_);
            }
            else
            {
               this.m_u2.§ !b§();
            }
            _loc19_ = this.§'!G§ - _loc17_ - this.§ a§ * _loc18_;
            _loc24_ = b2Math.§[!l§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§@!-§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§#!G§ * _loc19_) * this.m_u1.x;
            _loc14_ = -_loc20_ * this.m_u1.y;
            _loc15_ = -this.§ a§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§ a§ * _loc20_ * this.m_u2.y;
            _loc2_.m_sweep.c.x += _loc2_.§&l§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§&l§ * _loc14_;
         ...
         if(this.m_limitState1 == b2internal::6!B)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§?!5§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::6!B)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§?!5§()) > b2Settings.b2_linearSlop)
            {
