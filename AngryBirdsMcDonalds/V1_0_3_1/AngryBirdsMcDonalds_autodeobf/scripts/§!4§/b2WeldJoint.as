package §!4§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = this.§&!i§.y - _loc5_.m_sweep.localCenter.y;
         ...
         if(param1.§8!&§)
         {
            ...
            this.§8!§.y *= param1.§,!m§;
            this.§8!§.z *= param1.§,!m§;
            _loc4_.§"M§.x -= _loc10_ * this.§8!§.x;
            _loc4_.§"M§.y -= _loc10_ * this.§8!§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§8!§.y - _loc7_ * this.§8!§.x + this.§8!§.z);
            _loc5_.§"M§.x += _loc11_ * this.§8!§.x;
            _loc5_.§"M§.y += _loc11_ * this.§8!§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.m_xf.R;
         var _loc8_:Number = this.§&!i§.x - _loc5_.m_sweep.localCenter.x;
         ...
         var _loc19_:Number = b2Math.§`!9§(_loc16_);
         if(_loc18_ > _loc17_)
         {
            _loc12_ *= 1;
            _loc13_ *= 1;
