package §!4§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§8!§.x * this.§1!9§.x + (this.§?L§ + this.§8!§.y) * this.§+!l§.x),param1 * (this.§8!§.x * this.§1!9§.y + (this.§?L§ + this.§8!§.y) * this.§+!l§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§5M§ = this.§5M§ > Number.MIN_VALUE ? Number(1 / this.§5M§) : Number(0);
         ...
         if(param1.§8!&§)
         {
            ...
            this.§8!§.y *= param1.§,!m§;
            this.§?L§ *= param1.§,!m§;
            _loc19_ = this.§8!§.x * this.§1!9§.x + (this.§?L§ + this.§8!§.y) * this.§+!l§.x;
            _loc20_ = this.§8!§.x * this.§1!9§.y + (this.§?L§ + this.§8!§.y) * this.§+!l§.y;
            _loc21_ = this.§8!§.x * this.m_s1 + (this.§?L§ + this.§8!§.y) * this.m_a1;
            _loc22_ = this.§8!§.x * this.m_s2 + (this.§?L§ + this.§8!§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§+!l§.x * (_loc6_.x - _loc4_.x) + this.§+!l§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§5M§ * (this.§4!W§ - _loc13_);
            _loc15_ = this.§?L§;
            _loc16_ = param1.§"!?§ * this.§3<§;
            this.§?L§ = b2Math.§@!-§(this.§?L§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§?L§ - _loc15_) * this.§+!l§.x;
            _loc9_ = _loc14_ * this.§+!l§.y;
         ...
         {
            _loc17_ = this.§+!l§.x * (_loc6_.x - _loc4_.x) + this.§+!l§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§8!§.Copy();
            _loc19_ = this.§-U§.§'s§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§8!§.§;3§(_loc19_);
            if(this.§%g§ == b2internal::[!<)
            {
               this.§8!§.y = b2Math.§[!l§(this.§8!§.y,0);
            }
            else if(this.§%g§ == b2internal::6!B)
            {
               this.§8!§.y = b2Math.§;!F§(this.§8!§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§8!§.y - _loc18_.y) * this.§-U§.col2.x;
            if(this.§-U§.col1.x != 0)
            {
            ...
            _loc8_ = _loc19_.x * this.§1!9§.x + _loc19_.y * this.§+!l§.x;
            _loc9_ = _loc19_.x * this.§1!9§.y + _loc19_.y * this.§+!l§.y;
         ...
         else
         {
            ...
            this.§8!§.x += _loc22_;
            _loc8_ = _loc22_ * this.§1!9§.x;
            _loc9_ = _loc22_ * this.§1!9§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§9#§)
         {
            ...
            else if(_loc34_ >= this.§5c§)
            {
               _loc19_ = b2Math.§@!-§(_loc34_ - this.§5c§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§5c§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§-U§.§'s§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::4T;
         ...
         var _loc30_:Number = _loc28_.x * this.§1!9§.x + _loc28_.y * this.§+!l§.x;
         var _loc31_:Number = _loc28_.x * this.§1!9§.y + _loc28_.y * this.§+!l§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::4T * _loc30_;
         _loc6_.y -= b2internal::4T * _loc31_;
         _loc7_ -= b2internal::^S * _loc32_;
         _loc8_.x += b2internal::#!9 * _loc30_;
         _loc8_.y += b2internal::#!9 * _loc31_;
         _loc9_ += b2internal::0K * _loc33_;
