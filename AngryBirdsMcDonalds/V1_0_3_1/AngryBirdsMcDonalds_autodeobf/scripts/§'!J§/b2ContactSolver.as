package §'!J§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §32§:b2WorldManifold = new b2WorldManifold();
      
      private static var §8x§:b2PositionSolverManifold = new b2PositionSolverManifold();
       
      
      private var §2!<§:b2TimeStep;
      ...
      {
         this.§2!<§ = new b2TimeStep();
         this.§?&§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §,!p§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            _loc17_ = _loc5_.§ I§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§5v§(),_loc10_.§5v§());
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§"3§(),_loc10_.§"3§());
            _loc20_ = _loc15_.§"M§.x;
            _loc21_ = _loc15_.§"M§.y;
            _loc22_ = _loc16_.§"M§.x;
            _loc23_ = _loc16_.§"M§.y;
            ...
            b2Settings.b2Assert(_loc17_.§'q§ > 0);
            §32§.§,!p§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §32§.§#+§.x;
            _loc27_ = §32§.§#+§.y;
            (_loc28_ = this.§?&§[_loc6_]).§@!F§ = _loc15_;
            _loc28_.§9!T§ = _loc16_;
            _loc28_.§7S§ = _loc17_;
            ...
            _loc28_.§@!k§.x = _loc17_.§^!Q§.x;
            _loc28_.§@!k§.y = _loc17_.§^!Q§.y;
            _loc28_.localPoint.x = _loc17_.m_localPoint.x;
            _loc28_.localPoint.y = _loc17_.m_localPoint.y;
            _loc28_.radius = _loc13_ + _loc14_;
            _loc28_.type = _loc17_.§5!a§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§"4§)
            {
               _loc30_ = _loc17_.§0!4§[_loc29_];
               (_loc31_ = _loc28_.§7!Q§[_loc29_]).normalImpulse = _loc30_.§&V§;
               _loc31_.tangentImpulse = _loc30_.§,!B§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§6!7§.x = §32§.§0!4§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§6!7§.y = §32§.§0!4§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§%S§.x = §32§.§0!4§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§%S§.y = §32§.§0!4§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§&l§ + _loc16_.§&l§ + _loc15_.§]!Q§ * _loc36_ + _loc16_.§]!Q§ * _loc37_;
               _loc31_.§>_§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§+C§ * _loc15_.§&l§ + _loc16_.§+C§ * _loc16_.§&l§) + (_loc15_.§+C§ * _loc15_.§]!Q§ * _loc36_ + _loc16_.§+C§ * _loc16_.§]!Q§ * _loc37_);
               _loc31_.§8!<§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§&l§ + _loc16_.§&l§ + _loc15_.§]!Q§ * _loc42_ + _loc16_.§]!Q§ * _loc43_;
               _loc31_.§%!E§ = 1 / _loc44_;
               _loc31_.§=!R§ = 0;
            ...
            if(_loc28_.§"4§ == 2)
            {
               _loc48_ = _loc28_.§7!Q§[0];
               _loc49_ = _loc28_.§7!Q§[1];
               _loc50_ = _loc15_.§&l§;
               _loc51_ = _loc15_.§]!Q§;
               _loc52_ = _loc16_.§&l§;
               _loc53_ = _loc16_.§]!Q§;
               _loc54_ = _loc48_.§6!7§.x * _loc27_ - _loc48_.§6!7§.y * _loc26_;
               _loc55_ = _loc48_.§%S§.x * _loc27_ - _loc48_.§%S§.y * _loc26_;
               _loc56_ = _loc49_.§6!7§.x * _loc27_ - _loc49_.§6!7§.y * _loc26_;
               _loc57_ = _loc49_.§%S§.x * _loc27_ - _loc49_.§%S§.y * _loc26_;
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.§6!e§)
         {
            _loc7_ = (_loc6_ = this.§?&§[_loc5_]).§@!F§;
            _loc8_ = _loc6_.§9!T§;
            _loc9_ = _loc7_.§&l§;
            _loc10_ = _loc7_.§]!Q§;
            _loc11_ = _loc8_.§&l§;
            ...
            if(param1.§8!&§)
            {
               ...
               {
                  _loc20_ = _loc6_.§7!Q§[_loc18_];
                  _loc20_.normalImpulse *= param1.§,!m§;
                  _loc20_.tangentImpulse *= param1.§,!m§;
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§6!7§.x * _loc22_ - _loc20_.§6!7§.y * _loc21_);
                  _loc7_.§"M§.x -= _loc9_ * _loc21_;
                  _loc7_.§"M§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§%S§.x * _loc22_ - _loc20_.§%S§.y * _loc21_);
            ...
            else
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  (_loc23_ = _loc6_.§7!Q§[_loc18_]).normalImpulse = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§6!e§)
         {
            _loc26_ = (_loc25_ = this.§?&§[_loc24_]).§@!F§;
            _loc27_ = _loc25_.§9!T§;
            ...
            {
               _loc2_ = _loc25_.§7!Q§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§%S§.y - _loc30_.x + _loc28_ * _loc2_.§6!7§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§%S§.x - _loc30_.y - _loc28_ * _loc2_.§6!7§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§%!E§ * -_loc10_;
               ...
               _loc28_ -= _loc33_ * (_loc2_.§6!7§.x * _loc15_ - _loc2_.§6!7§.y * _loc14_);
               _loc31_.x += _loc34_ * _loc14_;
               _loc31_.y += _loc34_ * _loc15_;
               _loc29_ += _loc35_ * (_loc2_.§%S§.x * _loc15_ - _loc2_.§%S§.y * _loc14_);
            ...
            if(_loc25_.§"4§ == 1)
            {
               _loc2_ = _loc25_.§7!Q§[0];
               _loc7_ = _loc31_.x + -_loc29_ * _loc2_.§%S§.y - _loc30_.x - -_loc28_ * _loc2_.§6!7§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§%S§.x - _loc30_.y - _loc28_ * _loc2_.§6!7§.x;
               _loc9_ = _loc7_ * _loc36_ + _loc8_ * _loc37_;
               _loc11_ = -_loc2_.§>_§ * (_loc9_ - _loc2_.§=!R§);
            ...
            {
               _loc43_ = _loc25_.§7!Q§[0];
               _loc44_ = _loc25_.§7!Q§[1];
               _loc45_ = _loc43_.normalImpulse;
               _loc46_ = _loc44_.normalImpulse;
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§%S§.y - _loc30_.x + _loc28_ * _loc43_.§6!7§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§%S§.x - _loc30_.y - _loc28_ * _loc43_.§6!7§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§%S§.y - _loc30_.x + _loc28_ * _loc44_.§6!7§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§%S§.x - _loc30_.y - _loc28_ * _loc44_.§6!7§.x;
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§6!7§.x * _loc19_ - _loc43_.§6!7§.y * _loc18_ + _loc44_.§6!7§.x * _loc21_ - _loc44_.§6!7§.y * _loc20_);
                  _loc31_.x += _loc34_ * (_loc18_ + _loc20_);
                  _loc31_.y += _loc34_ * (_loc19_ + _loc21_);
                  _loc29_ += _loc35_ * (_loc43_.§%S§.x * _loc19_ - _loc43_.§%S§.y * _loc18_ + _loc44_.§%S§.x * _loc21_ - _loc44_.§%S§.y * _loc20_);
      ...
      public function §%!<§() : void
      {
         ...
         while(_loc1_ < this.§6!e§)
         {
            ...
            {
               _loc5_ = _loc3_.§0!4§[_loc4_];
               _loc6_ = _loc2_.§7!Q§[_loc4_];
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:Number = 0;
         var _loc3_:int = 0;
         while(_loc3_ < this.§6!e§)
         {
            _loc5_ = (_loc4_ = this.§?&§[_loc3_]).§@!F§;
            _loc6_ = _loc4_.§9!T§;
            _loc7_ = _loc5_.§+C§ * _loc5_.§&l§;
            _loc8_ = _loc5_.§+C§ * _loc5_.§]!Q§;
            _loc9_ = _loc6_.§+C§ * _loc6_.§&l§;
            _loc10_ = _loc6_.§+C§ * _loc6_.§]!Q§;
            §8x§.§,!p§(_loc4_);
            _loc11_ = §8x§.§#+§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§"4§)
            {
               _loc13_ = _loc4_.§7!Q§[_loc12_];
               _loc14_ = §8x§.§0!4§[_loc12_];
               _loc15_ = §8x§.§%!l§[_loc12_];
