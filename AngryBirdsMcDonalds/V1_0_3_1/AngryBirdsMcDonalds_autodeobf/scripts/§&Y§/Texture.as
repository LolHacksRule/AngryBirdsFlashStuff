package §&Y§
{
   ...
   public class Texture
   {
      ...
      public static function §'!l§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §&Y§.Texture
      {
         return §&o§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §&o§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §&Y§.Texture
      {
         ...
         _loc10_ = new §0j§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§`M§.§]!b§)
         {
            _loc10_.§7!1§(param2);
         }
      ...
      public static function §"!'§(param1:Context3D, param2:ByteArray) : §&Y§.Texture
      {
         if(param1 == null)
         {
            throw new §5!%§();
         ...
         var _loc9_:§0j§ = new §0j§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§`M§.§]!b§)
         {
            _loc9_.§7!1§(param2);
         }
      ...
      public static function §#0§(param1:§&Y§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §&Y§.Texture
      {
         var _loc4_:§&Y§.Texture;
         (_loc4_ = new §>e§(param1,param2)).§`!H§ = param3;
         return _loc4_;
      }
      
      public static function §6R§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §&Y§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§&Y§.Texture = §&o§(param1,_loc6_,false,param5);
         if(!§`M§.§]!b§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§#!N§, param2:int, param3:int) : void
      {
         ...
         if(this.§`!H§)
         {
            ...
            _loc4_ = this.§`!H§.width + this.§`!H§.x - this.width;
            _loc5_ = this.§`!H§.height + this.§`!H§.y - this.height;
            param1.§8i§(param2,-this.§`!H§.x,-this.§`!H§.y);
            param1.§8i§(param2 + 1,-_loc4_,-this.§`!H§.y);
            param1.§8i§(param2 + 2,-this.§`!H§.x,-_loc5_);
            param1.§8i§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      
      public function get §`!l§() : Rectangle
      {
         return !!this.§`!H§ ? this.§`!H§.clone() : new Rectangle(0,0,this.width,this.height);
      }
