package §-!T§
{
   ...
   public class b2Collision
   {
      ...
      private static var §7!V§:Vector.<§;!W§> = §3![§();
      
      private static var s_clipPoints1:Vector.<§;!W§> = §3![§();
      
      private static var s_clipPoints2:Vector.<§;!W§> = §3![§();
      
      private static var §#!§:Vector.<int> = new Vector.<int>(1);
      
      private static var §[!d§:Vector.<int> = new Vector.<int>(1);
      
      private static var §4!n§:b2Vec2 = new b2Vec2();
      ...
      public static function §2!D§(param1:Vector.<§;!W§>, param2:Vector.<§;!W§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§;!W§ = null;
         var _loc6_:int = 0;
      ...
      public static function § S§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §@!C§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §@!C§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §@!C§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §@!C§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §^p§(param1:Vector.<§;!W§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§=!+§.§-!W§ = param4;
         _loc20_.id.§=!+§.§return§ = _loc22_;
         _loc20_.id.§=!+§.§9!Q§ = 1;
      }
      
      private static function §3![§() : Vector.<§;!W§>
      {
      ...
      public static function §6!I§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§;!W§ = null;
         ...
         param1.§'q§ = 0;
         var _loc7_:Number = param2.§=V§ + param4.§=V§;
         var _loc8_:int = 0;
         §#!§[0] = _loc8_;
         var _loc9_:Number = § S§(§#!§,param2,param3,param4,param5);
         _loc8_ = §#!§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §[!d§[0] = _loc10_;
         var _loc11_:Number = § S§(§[!d§,param4,param5,param2,param3);
         _loc10_ = §[!d§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§5!a§ = b2Manifold.§>!<§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§;!W§> = §7!V§;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §4!n§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §]!'§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         ...
         if((_loc39_ = §2!D§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §2!D§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§^!Q§.SetV(_loc27_);
      ...
      public static function §-P§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§=V§ + param4.§=V§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§5!a§ = b2Manifold.§3!?§;
         param1.m_localPoint.SetV(param2.§?!d§);
         param1.§^!Q§.§ !b§();
         param1.§'q§ = 1;
         param1.§0!4§[0].m_localPoint.SetV(param4.§?!d§);
         param1.§0!4§[0].m_id.key = 0;
      }
      ...
      public static function §@!O§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§=V§ + param4.§=V§;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§'q§ = 1;
            param1.§5!a§ = b2Manifold.§>!<§;
            param1.§^!Q§.x = _loc15_ - _loc27_.x;
            param1.§^!Q§.y = _loc16_ - _loc27_.y;
            param1.§^!Q§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§'q§ = 1;
            param1.§5!a§ = b2Manifold.§>!<§;
            param1.§^!Q§.x = _loc15_ - _loc28_.x;
            param1.§^!Q§.y = _loc16_ - _loc28_.y;
            param1.§^!Q§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§0!4§[0].m_localPoint.SetV(param4.§?!d§);
            param1.§0!4§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§'q§ = 1;
            param1.§5!a§ = b2Manifold.§>!<§;
            param1.§^!Q§.x = _loc23_[_loc25_].x;
            param1.§^!Q§.y = _loc23_[_loc25_].y;
            param1.§^!Q§.Normalize();
      ...
      public static function §7q§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§3=§;
         var _loc4_:b2Vec2 = param1.§5V§;
