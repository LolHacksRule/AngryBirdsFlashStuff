package §-!T§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §,!p§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§5!a§)
         {
            case b2Manifold.§3!?§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§0!4§[0].m_localPoint;
               ...
               this.§0!4§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§0!4§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§>!<§:
               _loc8_ = param2.R;
               _loc7_ = param1.§^!Q§;
               ...
               this.§#+§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§'q§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§0!4§[_loc6_].m_localPoint;
                  ...
                  this.§0!4§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§0!4§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§6!@§:
               ...
               while(_loc6_ < param1.§'q§)
               {
                  ...
                  this.§0!4§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§0!4§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
