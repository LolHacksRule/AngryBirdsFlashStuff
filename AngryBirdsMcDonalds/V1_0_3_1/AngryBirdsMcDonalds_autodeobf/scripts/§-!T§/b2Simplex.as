   ...
   class b2Simplex
   {
      ...
      public function §=B§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         while(_loc9_ < this.§,!&§)
         {
            ...
            _loc10_.§5[§ = b2Math.§,z§(param3,_loc6_);
            _loc10_.§%!"§ = b2Math.§,z§(param5,_loc7_);
            _loc10_.§;![§ = b2Math.§+z§(_loc10_.§%!"§,_loc10_.§5[§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§,!&§ > 1)
         {
            _loc11_ = param1.§5t§;
            if((_loc12_ = this.§>!3§()) < 0.5 * _loc11_ || 2 * _loc11_ < _loc12_ || _loc12_ < Number.MIN_VALUE)
            {
               this.§,!&§ = 0;
            }
         }
      ...
      public function §;S§(param1:b2SimplexCache) : void
      {
         param1.§5t§ = this.§>!3§();
      ...
      public function §,l§() : b2Vec2
      {
         ...
         switch(this.§,!&§)
         {
            case 1:
               return this.m_v1.§;![§.§=!e§();
            case 2:
               _loc1_ = b2Math.§+z§(this.m_v2.§;![§,this.m_v1.§;![§);
               _loc2_ = b2Math.§-i§(_loc1_,this.m_v1.§;![§.§=!e§());
               if(_loc2_ > 0)
               {
      ...
      public function §>!3§() : Number
      {
         switch(this.§,!&§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§+z§(this.m_v1.§;![§,this.m_v2.§;![§).§?!5§();
            case 3:
               return b2Math.§-i§(b2Math.§+z§(this.m_v2.§;![§,this.m_v1.§;![§),b2Math.§+z§(this.m_v3.§;![§,this.m_v1.§;![§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve2() : void
      {
         ...
         var _loc3_:b2Vec2 = b2Math.§+z§(_loc2_,_loc1_);
         var _loc4_:Number;
      ...
      public function Solve3() : void
      {
         ...
         var _loc4_:b2Vec2 = b2Math.§+z§(_loc2_,_loc1_);
         var _loc5_:Number = b2Math.§6!Z§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§6!Z§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§+z§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§6!Z§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§6!Z§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§+z§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§6!Z§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§6!Z§(_loc3_,_loc14_);
