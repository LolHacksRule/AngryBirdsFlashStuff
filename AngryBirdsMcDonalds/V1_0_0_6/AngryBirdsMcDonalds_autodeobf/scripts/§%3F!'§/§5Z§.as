package §?!'§
{
   ...
   public class §5Z§
   {
      ...
      {
         §2!@§[§2!@§.length] = new §-M§(param1,param2,param3,param4,param5);
      }
      
      public static function §^!b§(param1:String, param2:String, param3:Array, param4:Number) : void
      {
         var _loc5_:§-M§;
         (_loc5_ = new §-M§(param1,param2,-1,-1,param4)).§=?§(param3);
         _loc5_.§%O§();
         §2!@§[§2!@§.length] = _loc5_;
      }
      ...
      {
         var _loc5_:§-M§;
         (_loc5_ = new §-M§(param1,param2,param3,param3)).§=?§(param4);
         §2!@§[§2!@§.length] = _loc5_;
      }
      
      public static function §,_§(param1:String) : §-M§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §2!@§.length)
         {
            if((§2!@§[_loc2_] as §-M§).mName.toLowerCase() == param1.toLowerCase())
            {
               return §-M§(§2!@§[_loc2_]);
            }
            _loc2_++;
