   ...
   public class §!!N§
   {
      ...
      public static function §[=§(param1:XMLList, param2:XMLList, param3:XMLList) : void
      {
         ...
         for each(_loc4_ in param1.Material)
         {
            ...
            §?!I§(_loc4_.@id,_loc4_.@bodyType,_loc4_.@density,_loc4_.@friction,_loc4_.@restitution,_loc4_.@strength,_loc4_.@defence,_loc4_.@colors);
         }
         §3D§(param2,param3);
      }
      
      public static function §3D§(param1:XMLList, param2:XMLList) : void
      {
         var _loc3_:XML = null;
         var _loc4_:§ 8§ = null;
         for each(_loc3_ in param1.Material)
         {
            if(_loc4_ = § !i§(_loc3_.@id))
            {
               _loc4_.§&i§(_loc3_);
            }
            else
      ...
      public static function §?!I§(param1:String, param2:String, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : void
      {
         §2!m§[§2!m§.length] = new § 8§(param1,param2,param3,param4,param5,param6,param7,param8);
      }
      
      public static function § !i§(param1:String) : § 8§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §2!m§.length)
         {
            if((§2!m§[_loc2_] as § 8§).mName.toLowerCase() == param1.toLowerCase())
            {
               return § 8§(§2!m§[_loc2_]);
            }
            _loc2_++;
