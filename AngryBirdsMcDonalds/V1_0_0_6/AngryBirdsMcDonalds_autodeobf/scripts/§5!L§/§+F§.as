package §5!L§
{
   ...
   public class §+F§
   {
      ...
      public static function §;!l§(param1:MovieClip, param2:Boolean) : Array
      {
         ...
         _loc4_[0] = new b2Vec2(_loc3_.x * §!!G§.§ !E§,_loc3_.y * §!!G§.§ !E§);
         _loc4_[1] = new b2Vec2(_loc3_.x * §!!G§.§ !E§,(_loc3_.y + _loc3_.height) * §!!G§.§ !E§);
         _loc4_[2] = new b2Vec2((_loc3_.x + _loc3_.width) * §!!G§.§ !E§,(_loc3_.y + _loc3_.height) * §!!G§.§ !E§);
         _loc4_[3] = new b2Vec2((_loc3_.x + _loc3_.width) * §!!G§.§ !E§,_loc3_.y * §!!G§.§ !E§);
         _loc4_.reverse();
         return _loc4_;
      }
      ...
      public static function §,!f§(param1:MovieClip, param2:Boolean) : Array
      {
         ...
         _loc3_[0] = _loc4_.width * §!!G§.§ !E§ / 2;
         _loc3_[1] = (_loc4_.x + _loc4_.width / 2) * §!!G§.§ !E§;
         _loc3_[2] = (_loc4_.y + _loc4_.height / 2) * §!!G§.§ !E§;
         return _loc3_;
      }
      
      public static function §]!_§(param1:MovieClip) : Array
      {
         var _loc4_:int = 0;
         var _loc5_:DisplayObject = null;
         ...
         while(_loc4_ < _loc3_.numChildren)
         {
            ...
            _loc2_[_loc4_].Set((_loc5_.getRect(param1).x + _loc5_.getRect(param1).width / 2) * §!!G§.§ !E§,(_loc5_.getRect(param1).y + _loc5_.getRect(param1).height / 2) * §!!G§.§ !E§);
            _loc4_++;
         }
         _loc2_.reverse();
         if(_loc2_.length < 3)
