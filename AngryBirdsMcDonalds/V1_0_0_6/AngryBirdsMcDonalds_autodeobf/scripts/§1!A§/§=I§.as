package §1!A§
{
   ...
   public class §=I§
   {
      ...
      public static function §!3§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §6!T§(_loc2_);
         return §9!=§.§import§(_loc3_.readInt(),true) + §9!=§.§import§(_loc3_.readInt(),true) + §9!=§.§import§(_loc3_.readInt(),true) + §9!=§.§import§(_loc3_.readInt(),true) + §9!=§.§import§(_loc3_.readInt(),true);
      }
      
      public static function §6Z§(param1:ByteArray) : String
      {
         var _loc2_:Array = §=I§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §6!T§(_loc2_);
         return §9!=§.§import§(_loc3_.readInt(),true) + §9!=§.§import§(_loc3_.readInt(),true) + §9!=§.§import§(_loc3_.readInt(),true) + §9!=§.§import§(_loc3_.readInt(),true) + §9!=§.§import§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §=I§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §6!T§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §6!T§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
