package §8!n§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §1!O§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§3l§)
         {
            case b2Manifold.§-!Y§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§%Q§[0].m_localPoint;
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§%!T§.x = _loc19_ / _loc26_;
                  this.§%!T§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§%!T§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§%!T§.x;
               _loc23_ = _loc16_ + param3 * this.§%!T§.y;
               _loc24_ = _loc17_ - param5 * this.§%!T§.x;
               _loc25_ = _loc18_ - param5 * this.§%!T§.y;
               this.§%Q§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§%Q§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§?!Z§:
               _loc8_ = param2.R;
               _loc7_ = param1.§!!#§;
               ...
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§%Q§[_loc6_].m_localPoint;
                  ...
                  this.§%Q§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§%Q§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§][§:
               ...
               while(_loc6_ < param1.§"e§)
               {
                  ...
                  this.§%Q§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§%Q§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
