package §8!n§
{
   ...
   public class b2AABB
   {
      ...
      public function §6I§() : Boolean
      {
         var _loc1_:Number = this.§,8§.x - this.§;w§.x;
         var _loc2_:Number = this.§,8§.y - this.§;w§.y;
         var _loc3_:Boolean = _loc1_ >= 0 && _loc2_ >= 0;
         return Boolean(_loc3_ && this.§;w§.§6I§() && this.§,8§.§6I§());
      }
      
      public function §=!C§() : b2Vec2
      {
         return new b2Vec2((this.§;w§.x + this.§,8§.x) / 2,(this.§;w§.y + this.§,8§.y) / 2);
      }
      
      public function §#8§() : b2Vec2
      {
         return new b2Vec2((this.§,8§.x - this.§;w§.x) / 2,(this.§,8§.y - this.§;w§.y) / 2);
      }
      ...
      public function §-Z§(param1:b2AABB) : Boolean
      {
         ...
         _loc2_ = _loc2_ && param1.§,8§.x <= this.§,8§.x;
         return Boolean(_loc2_ && param1.§,8§.y <= this.§,8§.y);
      }
      ...
      public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput) : Boolean
      {
         ...
         {
            if(_loc5_ < this.§;w§.x || this.§,8§.x < _loc5_)
            {
               return false;
            }
         }
         else
         {
            ...
            _loc14_ = (this.§,8§.x - _loc5_) * _loc12_;
            _loc16_ = -1;
            if(_loc13_ > _loc14_)
            {
               _loc15_ = _loc13_;
         ...
         {
            if(_loc6_ < this.§;w§.y || this.§,8§.y < _loc6_)
            {
               return false;
            }
         }
         else
         {
            ...
            _loc14_ = (this.§,8§.y - _loc6_) * _loc12_;
            _loc16_ = -1;
            if(_loc13_ > _loc14_)
            {
               _loc15_ = _loc13_;
      ...
      {
         var _loc2_:Number = param1.§;w§.x - this.§,8§.x;
         var _loc3_:Number = param1.§;w§.y - this.§,8§.y;
         var _loc4_:Number = this.§;w§.x - param1.§,8§.x;
         var _loc5_:Number = this.§;w§.y - param1.§,8§.y;
      ...
      public function §#g§(param1:b2AABB, param2:b2AABB) : void
      {
         ...
         this.§,8§.x = Math.max(param1.§,8§.x,param2.§,8§.x);
         this.§,8§.y = Math.max(param1.§,8§.y,param2.§,8§.y);
      }
   }
}
