package §8!n§
{
   ...
   public class b2Collision
   {
      ...
      private static var §9!4§:Vector.<§+m§> = §>!-§();
      
      private static var s_clipPoints1:Vector.<§+m§> = §>!-§();
      
      private static var s_clipPoints2:Vector.<§+m§> = §>!-§();
      
      private static var §4!E§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §^!6§(param1:Vector.<§+m§>, param2:Vector.<§+m§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§+m§ = null;
         var _loc6_:int = 0;
      ...
      public static function §%!"§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param1.§'9§;
         var _loc8_:Vector.<b2Vec2> = param1.§[%§;
         var _loc9_:int = param4.§9>§;
         var _loc10_:Vector.<b2Vec2> = param4.§'9§;
         _loc11_ = param2.R;
      ...
      public static function §1F§(param1:Vector.<§+m§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc9_:int = param5.§9>§;
         var _loc10_:Vector.<b2Vec2> = param5.§'9§;
         ...
         _loc20_.id.§0!e§.§'!A§ = param4;
         _loc20_.id.§0!e§.§ try§ = _loc21_;
         _loc20_.id.§0!e§.§,!N§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§0!e§.§'!A§ = param4;
         _loc20_.id.§0!e§.§ try§ = _loc22_;
         _loc20_.id.§0!e§.§,!N§ = 1;
      }
      
      private static function §>!-§() : Vector.<§+m§>
      {
      ...
      public static function §#O§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §4!E§[0] = _loc8_;
         var _loc9_:Number = §=!e§(§4!E§,param2,param3,param4,param5);
         _loc8_ = §4!E§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §[!8§[0] = _loc10_;
         var _loc11_:Number = §=!e§(§[!8§,param4,param5,param2,param3);
         _loc10_ = §[!8§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§3l§ = b2Manifold.§?!Z§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§+m§> = §9!4§;
         §1F§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§9>§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§'9§)[_loc16_];
         ...
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §<Q§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §?$§;
         _loc20_ = _loc14_.R;
      ...
      public static function §'o§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§3l§ = b2Manifold.§-!Y§;
         param1.m_localPoint.SetV(param2.§>l§);
         param1.§!!#§.§%!&§();
         param1.§"e§ = 1;
         param1.§%Q§[0].m_localPoint.SetV(param4.§>l§);
         param1.§%Q§[0].m_id.key = 0;
      }
      
      public static function §?s§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§9>§;
         var _loc22_:Vector.<b2Vec2> = param2.§'9§;
      ...
      {
         var _loc3_:b2Vec2 = param2.§;w§;
         var _loc4_:b2Vec2 = param1.§,8§;
