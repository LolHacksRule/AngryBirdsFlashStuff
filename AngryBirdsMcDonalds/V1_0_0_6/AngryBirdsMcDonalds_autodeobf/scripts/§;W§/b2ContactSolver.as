package §;W§
{
   ...
   public class b2ContactSolver
   {
      ...
      public function §1!O§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            _loc17_ = _loc5_.§@n§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§;!f§(),_loc10_.§;!f§());
            ...
            §#`§.§1!O§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §#`§.§%!T§.x;
            _loc27_ = §#`§.§%!T§.y;
            (_loc28_ = this.§?p§[_loc6_]).§1v§ = _loc15_;
            _loc28_.§<W§ = _loc16_;
            _loc28_.§9%§ = _loc17_;
            ...
            _loc28_.type = _loc17_.§3l§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§'c§)
            {
               _loc30_ = _loc17_.§%Q§[_loc29_];
               (_loc31_ = _loc28_.§#!j§[_loc29_]).normalImpulse = _loc30_.§ !T§;
               _loc31_.tangentImpulse = _loc30_.§[!+§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§@!,§.x = §#`§.§%Q§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§@!,§.y = §#`§.§%Q§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§"!l§.x = §#`§.§%Q§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§"!l§.y = §#`§.§%Q§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§0T§ + _loc16_.§0T§ + _loc15_.§#d§ * _loc36_ + _loc16_.§#d§ * _loc37_;
               _loc31_.§2R§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§0!+§ * _loc15_.§0T§ + _loc16_.§0!+§ * _loc16_.§0T§) + (_loc15_.§0!+§ * _loc15_.§#d§ * _loc36_ + _loc16_.§0!+§ * _loc16_.§#d§ * _loc37_);
               _loc31_.§+!&§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§0T§ + _loc16_.§0T§ + _loc15_.§#d§ * _loc42_ + _loc16_.§#d§ * _loc43_;
               _loc31_.§],§ = 1 / _loc44_;
               _loc31_.§9v§ = 0;
               ...
               {
                  _loc31_.§9v§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§'c§ == 2)
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         while(_loc5_ < this.§&!C§)
         {
            _loc7_ = (_loc6_ = this.§?p§[_loc5_]).§1v§;
            _loc8_ = _loc6_.§<W§;
            _loc9_ = _loc7_.§0T§;
            _loc10_ = _loc7_.§#d§;
            _loc11_ = _loc8_.§0T§;
            ...
            if(param1.§0!J§)
            {
               ...
               {
                  _loc20_ = _loc6_.§#!j§[_loc18_];
                  _loc20_.normalImpulse *= param1.§'!P§;
                  _loc20_.tangentImpulse *= param1.§'!P§;
            ...
            else
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  (_loc23_ = _loc6_.§#!j§[_loc18_]).normalImpulse = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         {
            _loc26_ = (_loc25_ = this.§?p§[_loc24_]).§1v§;
            _loc27_ = _loc25_.§<W§;
            ...
            _loc1_ = 0;
            while(_loc1_ < _loc25_.§'c§)
            {
               _loc2_ = _loc25_.§#!j§[_loc1_];
               ...
               _loc14_ = (_loc11_ = (_loc13_ = b2Math.§1!P§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_)) - _loc2_.tangentImpulse) * _loc38_;
            ...
            if(_loc25_.§'c§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§2R§ * (_loc9_ - _loc2_.§9v§);
            ...
            else
            {
               ...
               _loc53_ = _loc51_ - _loc43_.§9v§;
               _loc54_ = _loc52_ - _loc44_.§9v§;
               _loc22_ = _loc25_.§0!<§;
               _loc53_ -= _loc22_.col1.x * _loc45_ + _loc22_.col2.x * _loc46_;
               _loc54_ -= _loc22_.col1.y * _loc45_ + _loc22_.col2.y * _loc46_;
               _loc55_ = 0.001;
               _loc56_ = -((_loc22_ = _loc25_.§2R§).col1.x * _loc53_ + _loc22_.col2.x * _loc54_);
      ...
      public function §[!`§() : void
      {
         ...
         while(_loc1_ < this.§&!C§)
         {
            ...
            _loc3_ = _loc2_.§9%§;
            _loc4_ = 0;
            while(_loc4_ < _loc2_.§'c§)
            {
               _loc5_ = _loc3_.§%Q§[_loc4_];
               _loc6_ = _loc2_.§#!j§[_loc4_];
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§&!C§)
         {
            _loc5_ = (_loc4_ = this.§?p§[_loc3_]).§1v§;
            _loc6_ = _loc4_.§<W§;
            _loc7_ = _loc5_.§0!+§ * _loc5_.§0T§;
            _loc8_ = _loc5_.§0!+§ * _loc5_.§#d§;
            _loc9_ = _loc6_.§0!+§ * _loc6_.§0T§;
            _loc10_ = _loc6_.§0!+§ * _loc6_.§#d§;
            §!%§.§1!O§(_loc4_);
            _loc11_ = §!%§.§%!T§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§'c§)
            {
               _loc13_ = _loc4_.§#!j§[_loc12_];
               _loc14_ = §!%§.§%Q§[_loc12_];
               _loc15_ = §!%§.§3!M§[_loc12_];
               ...
               _loc20_ = b2Math.§1!P§(param1 * (_loc15_ + b2Settings.b2_linearSlop),-b2Settings.b2_maxLinearCorrection,0);
