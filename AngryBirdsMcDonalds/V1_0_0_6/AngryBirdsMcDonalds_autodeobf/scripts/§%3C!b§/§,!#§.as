package §<!b§
{
   ...
   public class §,!#§
   {
      ...
      private function §'!;§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§8h§(param1 as String);
         }
         if(param1 is Number)
         {
         ...
         if(param1 is Array)
         {
            return this.§7!J§(param1 as Array);
         }
      ...
      private function §8h§(param1:String) : String
      {
      ...
      private function §7!J§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
      ...
      private function §=!f§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§8h§(v.@name.toString()) + ":" + this.§'!;§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
