package §?6§
{
   ...
   public class §,!B§ extends §2!e§
   {
      ...
      private static function §`Q§(param1:§!K§, param2:int, param3:int) : void
      {
         if(param1.§&@§.top < 0)
         {
            param1.§&@§.top = 0;
      ...
      protected function §<=§(param1:Object) : void
      {
         ...
         for(_loc4_ in param1)
         {
            if(_loc4_.indexOf("sprite_") != -1)
            {
               ...
               §`Q§(_loc6_,§@!?§.width,§@!?§.height);
               if(_loc2_)
               {
                  _loc6_.§7f§ = _loc5_.pivotx / _loc3_;
                  _loc6_.§,!l§ = _loc5_.pivoty / _loc3_;
               }
               else
               {
                  _loc6_.§7f§ = _loc5_.width / 2;
                  _loc6_.§,!l§ = _loc5_.height / 2;
               }
               _loc6_.§ case§ = §@!?§;
               §'!4§(_loc6_);
            }
