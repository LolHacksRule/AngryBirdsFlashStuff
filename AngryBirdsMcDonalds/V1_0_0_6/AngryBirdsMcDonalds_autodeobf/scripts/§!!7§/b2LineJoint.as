package §!!7§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§^!7§.x * this.§84§.x + (this.§3!a§ + this.§^!7§.y) * this.§+!R§.x),param1 * (this.§^!7§.x * this.§84§.y + (this.§3!a§ + this.§^!7§.y) * this.§+!R§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§9H§ = this.§9H§ > Number.MIN_VALUE ? Number(1 / this.§9H§) : Number(0);
         ...
         if(param1.§0!J§)
         {
            ...
            this.§^!7§.y *= param1.§'!P§;
            this.§3!a§ *= param1.§'!P§;
            _loc19_ = this.§^!7§.x * this.§84§.x + (this.§3!a§ + this.§^!7§.y) * this.§+!R§.x;
            _loc20_ = this.§^!7§.x * this.§84§.y + (this.§3!a§ + this.§^!7§.y) * this.§+!R§.y;
            _loc21_ = this.§^!7§.x * this.m_s1 + (this.§3!a§ + this.§^!7§.y) * this.m_a1;
            _loc22_ = this.§^!7§.x * this.m_s2 + (this.§3!a§ + this.§^!7§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§`!-§ && this.§for § != b2internal::4!b)
         {
            ...
            _loc14_ = this.§9H§ * (this.§@!H§ - _loc13_);
            _loc15_ = this.§3!a§;
            _loc16_ = param1.§4l§ * this.§-!S§;
            this.§3!a§ = b2Math.§1!P§(this.§3!a§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§3!a§ - _loc15_) * this.§+!R§.x;
         ...
         if(this.§&N§ && this.§for § != b2internal::&-)
         {
            ...
            _loc18_ = this.§^!7§.Copy();
            _loc19_ = this.§&f§.§-8§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§^!7§.§,g§(_loc19_);
            if(this.§for § == b2internal::-A)
            {
               this.§^!7§.y = b2Math.§<!!§(this.§^!7§.y,0);
            }
            else if(this.§for § == b2internal::@w)
            {
               this.§^!7§.y = b2Math.§4!T§(this.§^!7§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§^!7§.y - _loc18_.y) * this.§&f§.col2.x;
            if(this.§&f§.col1.x != 0)
            {
            ...
            this.§^!7§.x = _loc21_;
            _loc19_.x = this.§^!7§.x - _loc18_.x;
            _loc19_.y = this.§^!7§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§84§.x + _loc19_.y * this.§+!R§.x;
            _loc9_ = _loc19_.x * this.§84§.y + _loc19_.y * this.§+!R§.y;
         ...
         else
         {
            ...
            this.§^!7§.x += _loc22_;
            _loc8_ = _loc22_ * this.§84§.x;
            _loc9_ = _loc22_ * this.§84§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§&N§)
         {
            ...
            if(b2Math.§]!b§(this.§?%§ - this.§"s§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§1!P§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§]!b§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§"s§)
            {
               _loc19_ = b2Math.§1!P§(_loc34_ - this.§"s§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§"s§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§?%§)
            {
               _loc19_ = b2Math.§1!P§(_loc34_ - this.§?%§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§&f§.§-8§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::?B;
         ...
         var _loc30_:Number = _loc28_.x * this.§84§.x + _loc28_.y * this.§+!R§.x;
         var _loc31_:Number = _loc28_.x * this.§84§.y + _loc28_.y * this.§+!R§.y;
