package §!!7§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §+!6§:Number = 2;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§0!'§ = b2internal::-!j.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§+!2§.x - this.§0!'§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§+!2§.y - this.§0!'§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§25§.x - this.§0!'§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§25§.y - this.§0!'§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§'8§);
         this.m_localAnchor2.SetV(param1.§>!_§);
         this.§'l§ = param1.§1<§;
         this.§!Z§ = param1.§`'§ + this.§'l§ * param1.§&u§;
         this.m_maxLength1 = b2Math.§4!T§(param1.§8-§,this.§!Z§ - this.§'l§ * b2internal::+!6);
         this.m_maxLength2 = b2Math.§4!T§(param1.§8`§,(this.§!Z§ - b2internal::+!6) / this.§'l§);
         this.§^!7§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§^!7§ * this.m_u2.x,param1 * this.§^!7§ * this.m_u2.y);
      }
      ...
      {
         var _loc1_:b2Vec2 = this.§0!'§.m_xf.position.Copy();
         _loc1_.§,g§(this.m_groundAnchor2);
         return _loc1_;
      }
      
      public function GetLength1() : Number
      {
         var _loc1_:b2Vec2 = b2internal::-!j.GetWorldPoint(this.m_localAnchor1);
      ...
      {
         var _loc1_:b2Vec2 = b2internal::30.GetWorldPoint(this.m_localAnchor2);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§!Z§ - _loc18_ - this.§'l§ * _loc19_) > 0)
         {
            this.§=Z§ = b2internal::&-;
            this.§^!7§ = 0;
         }
         ...
         this.m_limitMass1 = _loc2_.§0T§ + _loc2_.§#d§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§0T§ + _loc3_.§#d§ * _loc22_ * _loc22_;
         this.§"!j§ = this.m_limitMass1 + this.§'l§ * this.§'l§ * this.m_limitMass2;
         ...
         {
            this.§^!7§ *= param1.§'!P§;
            this.m_limitImpulse1 *= param1.§'!P§;
            this.m_limitImpulse2 *= param1.§'!P§;
            _loc23_ = (-this.§^!7§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§^!7§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§'l§ * this.§^!7§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§'l§ * this.§^!7§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§?!%§.x += _loc2_.§0T§ * _loc23_;
            _loc2_.§?!%§.y += _loc2_.§0T§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§#d§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§?!%§.x += _loc3_.§0T§ * _loc25_;
            _loc3_.§?!%§.y += _loc3_.§0T§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§#d§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§^!7§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§=Z§ == b2internal::@w)
         {
            ...
            _loc19_ = this.§"!j§ * -_loc18_;
            _loc20_ = this.§^!7§;
            this.§^!7§ = b2Math.§<!!§(0,this.§^!7§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§^!7§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§'l§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§'l§ * _loc19_ * this.m_u2.y;
            _loc2_.§?!%§.x += _loc2_.§0T§ * _loc14_;
            _loc2_.§?!%§.y += _loc2_.§0T§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§#d§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§?!%§.x += _loc3_.§0T§ * _loc16_;
            _loc3_.§?!%§.y += _loc3_.§0T§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§#d§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
         if(this.m_limitState1 == b2internal::@w)
         {
            _loc10_ = _loc2_.§?!%§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§?!%§.y + _loc2_.m_angularVelocity * _loc5_;
         ...
         if(this.m_limitState2 == b2internal::@w)
         {
            _loc12_ = _loc3_.§?!%§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§?!%§.y + _loc3_.m_angularVelocity * _loc8_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§=Z§ == b2internal::@w)
         {
            ...
            _loc19_ = this.§!Z§ - _loc17_ - this.§'l§ * _loc18_;
            _loc24_ = b2Math.§<!!§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§1!P§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§"!j§ * _loc19_) * this.m_u1.x;
            _loc14_ = -_loc20_ * this.m_u1.y;
            _loc15_ = -this.§'l§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§'l§ * _loc20_ * this.m_u2.y;
            _loc2_.m_sweep.c.x += _loc2_.§0T§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§0T§ * _loc14_;
            _loc2_.m_sweep.a += _loc2_.§#d§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§0T§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§0T§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§#d§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§5!%§();
            _loc3_.§5!%§();
         }
         if(this.m_limitState1 == b2internal::@w)
