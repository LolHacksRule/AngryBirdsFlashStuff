package § e§
{
   public class §8n§
   {
      ...
      public static function §0!k§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
      ...
      private static function §+!5§(param1:String, param2:Boolean) : String
      {
