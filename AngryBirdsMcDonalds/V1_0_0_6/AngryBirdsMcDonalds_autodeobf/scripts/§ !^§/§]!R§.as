package § !^§
{
   ...
   public class §]!R§ extends § !^§.Texture
   {
      ...
      private function §1z§(param1:Context3D) : void
      {
         ...
         if(_loc2_)
         {
            _loc4_ = param1.createTexture(this.§3y§,this.§ 5§,Context3DTextureFormat.BGRA,this.§>!$§);
            § !^§.Texture.uploadBitmapData(_loc4_,_loc2_,this.§']§);
         }
         else if(_loc3_)
         {
            _loc5_ = _loc3_[6] == 2 ? Context3DTextureFormat.COMPRESSED : Context3DTextureFormat.BGRA;
            _loc4_ = param1.createTexture(this.§3y§,this.§ 5§,_loc5_,this.§>!$§);
