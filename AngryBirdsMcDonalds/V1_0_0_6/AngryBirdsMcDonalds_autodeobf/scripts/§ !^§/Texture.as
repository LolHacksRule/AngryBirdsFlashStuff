package § !^§
{
   ...
   public class Texture
   {
      ...
      {
         return §8!b§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §8!b§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : § !^§.Texture
      {
         ...
         return new §<t§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §4!O§(param1:Context3D, param2:ByteArray) : § !^§.Texture
      {
         if(param1 == null)
         {
            throw new §'!]§();
      ...
      {
         var _loc4_:§ !^§.Texture;
         (_loc4_ = new §<t§(param1,param2)).§ w§ = param3;
         return _loc4_;
      }
      
      public static function §7!`§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : § !^§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§ !^§.Texture = §8!b§(param1,_loc6_,false,param5);
         if(!§do§.§[J§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§%!k§, param2:int, param3:int) : void
      {
         ...
         if(this.§ w§)
         {
            ...
            param1.§;9§(param2,-this.§ w§.x,-this.§ w§.y);
            param1.§;9§(param2 + 1,-_loc4_,-this.§ w§.y);
            param1.§;9§(param2 + 2,-this.§ w§.x,-_loc5_);
            param1.§;9§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
