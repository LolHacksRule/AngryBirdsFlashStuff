package §%!h§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §`6§:b2Mat22 = new b2Mat22();
      ...
      public static function §@!8§(param1:Array, param2:Number) : b2PolygonShape
      {
         ...
         _loc3_.§5!d§(param1,param2);
         return _loc3_;
      }
      
      public static function §2!j§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §-!-§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         ...
         (_loc5_ = new b2PolygonShape()).§3!Z§(param1,param2,param3,param4);
         return _loc5_;
      }
      ...
      b2internal static function §4!1§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§2"§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§2"§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §5!d§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function §&4§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§9>§)
         {
            this.§'9§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§9>§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§9>§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§'u§(this.§'9§[_loc5_],this.§'9§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§[n§() > Number.MIN_VALUE);
            this.§[%§[_loc3_].SetV(b2Math.§>!J§(_loc6_,1));
            this.§[%§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§ !n§ = §-!3§(this.§'9§,this.§9>§);
      }
      
      public function §8!V§(param1:Number, param2:Number) : void
      {
         this.§9>§ = 4;
         this.§<?§(4);
         this.§'9§[0].Set(-param1,-param2);
         this.§'9§[1].Set(param1,-param2);
         this.§'9§[2].Set(param1,param2);
         this.§'9§[3].Set(-param1,param2);
         this.§[%§[0].Set(0,-1);
         this.§[%§[1].Set(1,0);
         this.§[%§[2].Set(0,1);
         this.§[%§[3].Set(-1,0);
      ...
      public function §3!Z§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§9>§ = 4;
         this.§<?§(4);
         this.§'9§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§9>§)
         {
            this.§'9§[_loc6_] = b2Math.§+!W§(_loc5_,this.§'9§[_loc6_]);
            this.§[%§[_loc6_] = b2Math.§&U§(_loc5_.R,this.§[%§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §4!D§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§9>§ = 2;
         this.§<?§(2);
         this.§'9§[0].SetV(param1);
         this.§'9§[1].SetV(param2);
         this.§ !n§.x = 0.5 * (param1.x + param2.x);
         this.§ !n§.y = 0.5 * (param1.y + param2.y);
         this.§[%§[0] = b2Math.§>!J§(b2Math.§'u§(param2,param1),1);
         this.§[%§[0].Normalize();
         this.§[%§[1].x = -this.§[%§[0].x;
         this.§[%§[1].y = -this.§[%§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§9>§)
         {
            _loc6_ = (_loc9_ = this.§'9§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§;w§.x = _loc5_ - b2internal::?!U;
         param1.§;w§.y = _loc6_ - b2internal::?!U;
         param1.§,8§.x = _loc7_ + b2internal::?!U;
         param1.§,8§.y = _loc8_ + b2internal::?!U;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§9>§ == 2)
         {
            param1.center.x = 0.5 * (this.§'9§[0].x + this.§'9§[1].x);
            param1.center.y = 0.5 * (this.§'9§[0].y + this.§'9§[1].y);
            param1.§%!#§ = 0;
            param1.§%l§ = 0;
            return;
         }
         ...
         {
            _loc11_ = this.§'9§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§9>§ ? this.§'9§[int(_loc10_ + 1)] : this.§'9§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§5!_§(param3.R,param1);
         ...
         {
            _loc7_[_loc12_] = b2Math.§#!?§(_loc5_,this.§'9§[_loc12_]) - _loc6_;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§9>§;
         var _loc14_:int = (_loc10_ + 1) % this.§9>§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§'9§[_loc9_].x * (1 - _loc15_) + this.§'9§[_loc13_].x * _loc15_,this.§'9§[_loc9_].y * (1 - _loc15_) + this.§'9§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§'9§[_loc10_].x * (1 - _loc16_) + this.§'9§[_loc14_].x * _loc16_,this.§'9§[_loc10_].y * (1 - _loc16_) + this.§'9§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§'9§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§9>§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§'9§[_loc12_];
            }
      ...
      public function §5Q§() : Vector.<b2Vec2>
      {
         return this.§'9§;
      }
      ...
      public function §[j§(param1:b2Vec2) : int
      {
