   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         if(param1 >= 0 && param1 < this.numChildren)
         {
            ...
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§7!X§));
            }
            _loc3_.§5X§(null);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            ...
            §+o§(_loc7_,§[N§);
            transformCoords(§[N§,_loc3_,_loc4_,§-!e§);
            if(_loc8_ = _loc7_.hitTest(§-!e§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      public function §0B§(param1:Event) : void
      {
         if(param1.bubbles)
         {
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§<!T§(this,param1.type,_loc2_);
      ...
      private function §<!T§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               this.§<!T§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
