package §8<§
{
   ...
   public class Base64
   {
      ...
      private static const §2!G§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §^L§(param1:ByteArray) : String
      {
         ...
         while(param1.bytesAvailable > 0)
         {
            ...
            {
               _loc2_ += §2!G§.charAt(_loc4_[_loc7_]);
               _loc7_++;
            }
         }
         return _loc2_;
      ...
      {
         var _loc2_:ByteArray = §+C§(param1);
         return _loc2_.readUTFBytes(_loc2_.length);
      }
      
      public static function §+C§(param1:String) : ByteArray
      {
         var _loc6_:uint = 0;
         var _loc7_:uint = 0;
         var _loc2_:ByteArray = new ByteArray();
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §2!G§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
