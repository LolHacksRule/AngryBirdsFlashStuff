package §0i§
{
   ...
   public class Base64
   {
      ...
      private static const §[!S§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §2!S§(param1:ByteArray) : String
      {
      ...
      public static function §3!c§(param1:String) : String
      {
         var _loc2_:ByteArray = §+h§(param1);
         return _loc2_.readUTFBytes(_loc2_.length);
      }
      
      public static function §+h§(param1:String) : ByteArray
      {
         var _loc6_:uint = 0;
         var _loc7_:uint = 0;
         var _loc2_:ByteArray = new ByteArray();
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §[!S§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
