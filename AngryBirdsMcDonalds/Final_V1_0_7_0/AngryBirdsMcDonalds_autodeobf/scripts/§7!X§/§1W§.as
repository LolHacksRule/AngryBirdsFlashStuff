package §7!X§
{
   ...
   public class §1W§
   {
      ...
      public static var §3!U§:ByteArray;
      ...
      public static function §<%§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §6!9§(_loc2_);
         return §=g§.§4t§(_loc3_.readInt(),true) + §=g§.§4t§(_loc3_.readInt(),true) + §=g§.§4t§(_loc3_.readInt(),true) + §=g§.§4t§(_loc3_.readInt(),true) + §=g§.§4t§(_loc3_.readInt(),true);
      }
      
      public static function §38§(param1:ByteArray) : String
      {
         var _loc2_:Array = §1W§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §6!9§(_loc2_);
         return §=g§.§4t§(_loc3_.readInt(),true) + §=g§.§4t§(_loc3_.readInt(),true) + §=g§.§4t§(_loc3_.readInt(),true) + §=g§.§4t§(_loc3_.readInt(),true) + §=g§.§4t§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §1W§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §6!9§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §6!9§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
