package §&!P§
{
   ...
   public class b2Collision
   {
      ...
      private static var §?Y§:Vector.<§9T§> = §8!%§();
      
      private static var s_clipPoints1:Vector.<§9T§> = §8!%§();
      
      private static var s_clipPoints2:Vector.<§9T§> = §8!%§();
      
      private static var §?! §:Vector.<int> = new Vector.<int>(1);
      
      private static var §6e§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §2!>§(param1:Vector.<§9T§>, param2:Vector.<§9T§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§9T§ = null;
         var _loc6_:int = 0;
      ...
      public static function §!;§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc6_:int = param1.§1y§;
         var _loc7_:Vector.<b2Vec2> = param1.§0S§;
         var _loc8_:Vector.<b2Vec2> = param1.§&!,§;
         var _loc9_:int = param4.§1y§;
         var _loc10_:Vector.<b2Vec2> = param4.§0S§;
         _loc11_ = param2.R;
      ...
      public static function §var §(param1:Vector.<§9T§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§9T§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§1y§;
         var _loc8_:Vector.<b2Vec2> = param2.§&!,§;
         var _loc9_:int = param5.§1y§;
         var _loc10_:Vector.<b2Vec2> = param5.§0S§;
         ...
         _loc20_.id.§5!J§.§^S§ = param4;
         _loc20_.id.§5!J§.§-Y§ = _loc21_;
         _loc20_.id.§5!J§.§%%§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§5!J§.§^S§ = param4;
         _loc20_.id.§5!J§.§-Y§ = _loc22_;
         _loc20_.id.§5!J§.§%%§ = 1;
      }
      
      private static function §8!%§() : Vector.<§9T§>
      {
         var _loc1_:Vector.<§9T§> = new Vector.<§9T§>(2);
         _loc1_[0] = new §9T§();
         _loc1_[1] = new §9T§();
         return _loc1_;
      }
      ...
      public static function §4![§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         param1.§>r§ = 0;
         var _loc7_:Number = param2.§0!B§ + param4.§0!B§;
         var _loc8_:int = 0;
         §?! §[0] = _loc8_;
         var _loc9_:Number = §'!Z§(§?! §,param2,param3,param4,param5);
         _loc8_ = §?! §[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §6e§[0] = _loc10_;
         var _loc11_:Number = §'!Z§(§6e§,param4,param5,param2,param3);
         _loc10_ = §6e§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§,!f§ = b2Manifold.§8Z§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§9T§> = §?Y§;
         §var §(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§1y§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§0S§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §2!`§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §5!d§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §+!N§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §!!6§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§9T§> = s_clipPoints1;
         var _loc38_:Vector.<§9T§> = s_clipPoints2;
      ...
      public static function §<![§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§0!B§ + param4.§0!B§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§,!f§ = b2Manifold.§`!f§;
         param1.m_localPoint.SetV(param2.§`%§);
         param1.§4!0§.§4[§();
         param1.§>r§ = 1;
         param1.§"!h§[0].m_localPoint.SetV(param4.§`%§);
         param1.§"!h§[0].m_id.key = 0;
      }
      ...
      public static function §@!>§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§0!B§ + param4.§0!B§;
         var _loc21_:int = param2.§1y§;
         var _loc22_:Vector.<b2Vec2> = param2.§0S§;
         ...
         if(_loc19_ < Number.MIN_VALUE)
         {
            param1.§>r§ = 1;
            param1.§,!f§ = b2Manifold.§8Z§;
            param1.§4!0§.SetV(_loc23_[_loc18_]);
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§>r§ = 1;
            param1.§,!f§ = b2Manifold.§8Z§;
            param1.§4!0§.x = _loc15_ - _loc27_.x;
            param1.§4!0§.y = _loc16_ - _loc27_.y;
            param1.§4!0§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§>r§ = 1;
            param1.§,!f§ = b2Manifold.§8Z§;
            param1.§4!0§.x = _loc15_ - _loc28_.x;
            param1.§4!0§.y = _loc16_ - _loc28_.y;
            param1.§4!0§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§"!h§[0].m_localPoint.SetV(param4.§`%§);
            param1.§"!h§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§>r§ = 1;
            param1.§,!f§ = b2Manifold.§8Z§;
            param1.§4!0§.x = _loc23_[_loc25_].x;
            param1.§4!0§.y = _loc23_[_loc25_].y;
            param1.§4!0§.Normalize();
