package §#!K§
{
   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc7_ = this.§5!h§.y - _loc4_.m_sweep.localCenter.y;
         ...
         if(param1.§'!#§)
         {
            ...
            this.§+!=§.y *= param1.§,!e§;
            this.§+!=§.z *= param1.§,!e§;
            _loc4_.§'!f§.x -= _loc10_ * this.§+!=§.x;
            _loc4_.§'!f§.y -= _loc10_ * this.§+!=§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§+!=§.y - _loc7_ * this.§+!=§.x + this.§+!=§.z);
            _loc5_.§'!f§.x += _loc11_ * this.§+!=§.x;
            _loc5_.§'!f§.y += _loc11_ * this.§+!=§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc5_:b2Body = b2internal::,!7;
         _loc2_ = _loc4_.m_xf.R;
         var _loc6_:Number = this.§5!h§.x - _loc4_.m_sweep.localCenter.x;
         ...
         var _loc16_:Number = _loc5_.m_sweep.a - _loc4_.m_sweep.a - this.§8B§;
