package §+!o§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§"!E§ = this.§7!'§.Normalize();
         this.§6!"§.Set(this.§7!'§.y,-this.§7!'§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§6!"§.x - this.§7!'§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§6!"§.y - this.§7!'§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§6!"§.x + this.§7!'§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§6!"§.y + this.§7!'§.y) + this.m_v2.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§92§ * _loc12_)
            {
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc8_:Number = b2Math.§83§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§83§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §9t§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §0v§() : b2EdgeShape
      {
         return this.§<!0§;
      }
