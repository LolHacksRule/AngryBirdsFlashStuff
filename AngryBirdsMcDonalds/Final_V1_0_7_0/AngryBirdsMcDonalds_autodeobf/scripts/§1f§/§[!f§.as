package §1f§
{
   ...
   public class §[!f§ extends § !%§
   {
      ...
      public static var §5!N§:Boolean = false;
      ...
      private static function §8x§(param1:§#7§, param2:int, param3:int) : void
      {
         if(param1.§+a§.top < 0)
         {
            param1.§+a§.top = 0;
      ...
      protected function §0e§(param1:Object) : void
      {
         ...
         for(_loc4_ in param1)
         {
            if(_loc4_.indexOf("sprite_") != -1)
            {
               ...
               §8x§(_loc6_,§4b§.width,§4b§.height);
               if(_loc2_)
               {
                  _loc6_.§@;§ = _loc5_.pivotx / _loc3_;
                  _loc6_.§2u§ = _loc5_.pivoty / _loc3_;
               }
               else
               {
                  _loc6_.§@;§ = _loc5_.width / 2;
                  _loc6_.§2u§ = _loc5_.height / 2;
               }
               _loc6_.§6b§ = §4b§;
               §"8§(_loc6_);
            }
