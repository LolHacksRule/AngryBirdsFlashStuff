package §1f§
{
   ...
   public class §7!a§ extends § !%§
   {
       
      
      public function §7!a§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§0e§(param1,param2);
      }
      
      protected function §0e§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc16_:§#7§ = null;
         var _loc3_:Dictionary = this.§7z§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if(_loc10_)
            {
               ...
               (_loc16_ = new §#7§()).mName = _loc6_;
               _loc16_.§+a§ = _loc15_;
               _loc16_.§@;§ = _loc10_.pivotX;
               _loc16_.§2u§ = _loc10_.pivotY;
               _loc16_.§6b§ = §4b§;
               §"8§(_loc16_);
            }
         }
      ...
      private function §7z§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
