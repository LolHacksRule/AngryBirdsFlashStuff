package §&!9§
{
   ...
   public class Texture
   {
      ...
      public static function §5^§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §&!9§.Texture
      {
         return §0!i§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §0!i§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §&!9§.Texture
      {
         ...
         return new §6q§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §%!]§(param1:Context3D, param2:ByteArray) : §&!9§.Texture
      {
         if(param1 == null)
         {
            throw new §'b§();
      ...
      public static function §%!_§(param1:§&!9§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §&!9§.Texture
      {
         var _loc4_:§&!9§.Texture;
         (_loc4_ = new §6q§(param1,param2)).§!§ = param3;
         return _loc4_;
      }
      
      public static function §-!d§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §&!9§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§&!9§.Texture = §0!i§(param1,_loc6_,false,param5);
         if(!§'!3§.§'!I§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§3K§, param2:int, param3:int) : void
      {
         ...
         if(this.§!§)
         {
            ...
            param1.§0!!§(param2,-this.§!§.x,-this.§!§.y);
            param1.§0!!§(param2 + 1,-_loc4_,-this.§!§.y);
            param1.§0!!§(param2 + 2,-this.§!§.x,-_loc5_);
