package §0@§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      private var §0E§:Vector.<DisplayObject>;
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§0E§ = new Vector.<DisplayObject>(0);
      }
      
      override public function dispose() : void
      {
         var _loc1_:int = this.§0E§.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            this.§0E§[_loc2_].dispose();
            _loc2_++;
         }
         super.dispose();
      }
      ...
      public function addChildAt(param1:DisplayObject, param2:int) : void
      {
         ...
         {
            param1.§;!>§();
            this.§0E§.splice(param2,0,param1);
            param1.§;,§(this);
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§0E§[param1];
            _loc3_.dispatchEvent(new Event(Event.§#A§,true));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§@!-§));
            }
            _loc3_.§;,§(null);
            this.§0E§.splice(param1,1);
            if(param2)
            {
               _loc3_.dispose();
            }
      ...
      {
         var _loc2_:int = this.§0E§.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            if(this.§0E§[_loc3_].name == param1)
            {
               return this.§0E§[_loc3_];
            }
            _loc3_++;
         }
         return null;
      ...
      public function §%c§(param1:int, param2:int) : void
      {
         ...
         this.§0E§[param1] = _loc4_;
         this.§0E§[param2] = _loc3_;
      }
      
      public function §'!,§(param1:Function) : void
      {
         this.§0E§ = this.§0E§.sort(param1);
      }
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§0E§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§0E§.length;
         if(_loc3_ == 0)
         {
            §3!6§(param1,§8!f§);
            transformCoords(§8!f§,0,0,§3M§);
            param2.x = §3M§.x;
            param2.y = §3M§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§0E§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§0E§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§0E§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§0E§[_loc6_];
            §3!6§(_loc7_,§8!f§);
            transformCoords(§8!f§,_loc3_,_loc4_,§3M§);
            if(_loc8_ = _loc7_.hitTest(§3M§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§ if§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§0E§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§%J§();
               param1.§?!"§(_loc5_);
      ...
      private function §?1§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§0E§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
