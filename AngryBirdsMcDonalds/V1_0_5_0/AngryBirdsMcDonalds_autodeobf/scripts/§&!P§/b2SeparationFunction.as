package §&!P§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §08§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§,!f§ = §5!o§;
            _loc7_ = this.§ !U§.§!!A§(param1.indexA[0]);
            _loc10_ = this.§5!,§.§!!A§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§>E§.x = _loc15_ - _loc13_;
            this.§>E§.y = _loc16_ - _loc14_;
            this.§>E§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§,!f§ = §8Z§;
            _loc8_ = this.§ !U§.§!!A§(param1.indexA[0]);
            _loc9_ = this.§ !U§.§!!A§(param1.indexA[1]);
            _loc10_ = this.§5!,§.§!!A§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§>E§ = b2Math.§-!f§(b2Math.§6!a§(_loc9_,_loc8_),1);
            this.§>E§.Normalize();
            _loc20_ = this.§>E§;
         ...
         {
            this.§,!f§ = §[n§;
            _loc11_ = this.§5!,§.§!!A§(param1.indexB[0]);
            _loc12_ = this.§5!,§.§!!A§(param1.indexB[1]);
            _loc7_ = this.§ !U§.§!!A§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§>E§ = b2Math.§-!f§(b2Math.§6!a§(_loc12_,_loc11_),1);
            this.§>E§.Normalize();
            _loc20_ = this.§>E§;
         ...
         else
         {
            ...
            _loc24_ = b2Math.§#!j§(param3.R,b2Math.§6!a§(_loc9_,_loc8_));
            _loc25_ = b2Math.§=o§(param5,_loc10_);
            _loc26_ = b2Math.§#!j§(param5.R,b2Math.§6!a§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§6!a§(_loc26_,_loc24_);
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §5!o§:
               _loc3_ = b2Math.§>!<§(param1.R,this.§>E§);
               _loc4_ = b2Math.§>!<§(param2.R,this.§>E§.§`!]§());
               _loc5_ = this.§ !U§.§[U§(_loc3_);
               _loc6_ = this.§5!,§.§[U§(_loc4_);
               _loc7_ = b2Math.§=o§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§=o§(param2,_loc6_)).x - _loc7_.x) * this.§>E§.x + (_loc8_.y - _loc7_.y) * this.§>E§.y);
            case §8Z§:
               _loc10_ = b2Math.§#!j§(param1.R,this.§>E§);
               _loc7_ = b2Math.§=o§(param1,this.m_localPoint);
               _loc4_ = b2Math.§>!<§(param2.R,_loc10_.§`!]§());
               _loc6_ = this.§5!,§.§[U§(_loc4_);
               return Number(((_loc8_ = b2Math.§=o§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §[n§:
               _loc10_ = b2Math.§#!j§(param2.R,this.§>E§);
               _loc8_ = b2Math.§=o§(param2,this.m_localPoint);
               _loc3_ = b2Math.§>!<§(param1.R,_loc10_.§`!]§());
               _loc5_ = this.§ !U§.§[U§(_loc3_);
