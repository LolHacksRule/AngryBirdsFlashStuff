package §]q§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §'W§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §%e§:b2Vec2;
      
      b2internal var §5l§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         §+C§ = b2internal::1!N;
         this.§%e§ = new b2Vec2();
         this.§5l§ = new Vector.<b2Vec2>();
         this.§@!'§ = new Vector.<b2Vec2>();
         §!C§ = b2Settings.b2_polygonRadius;
         this.§%e§.§"9§();
      }
      
      public static function §+m§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function §6Y§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §59§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§#!g§(param1,param2,param3,param4);
         return _loc5_;
      }
      ...
      public static function §[7§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc3_.§"W§(_loc9_);
            _loc3_.§"W§(_loc10_);
            _loc3_.§!!L§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            while(_loc3_ < this.§<R§)
            {
               this.§5l§[_loc3_].SetV(_loc2_.§5l§[_loc3_]);
      ...
      public function §#!i§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function §&!D§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§<R§)
         {
            this.§5l§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§<R§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§<R§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§>+§(this.§5l§[_loc5_],this.§5l§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§+!!§() > Number.MIN_VALUE);
            this.§@!'§[_loc3_].SetV(b2Math.§7!E§(_loc6_,1));
            this.§@!'§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§%e§ = §[7§(this.§5l§,this.§<R§);
      }
      ...
      public function § !H§(param1:Number, param2:Number) : void
      {
         this.§<R§ = 4;
         this.§>!E§(4);
         this.§5l§[0].Set(-param1,-param2);
         this.§5l§[1].Set(param1,-param2);
         this.§5l§[2].Set(param1,param2);
         this.§5l§[3].Set(-param1,param2);
         this.§@!'§[0].Set(0,-1);
         this.§@!'§[1].Set(1,0);
         this.§@!'§[2].Set(0,1);
         this.§@!'§[3].Set(-1,0);
      ...
      public function §#!g§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§<R§ = 4;
         this.§>!E§(4);
         this.§5l§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§<R§)
         {
            this.§5l§[_loc6_] = b2Math.§ case§(_loc5_,this.§5l§[_loc6_]);
      ...
      public function §;C§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§<R§ = 2;
         this.§>!E§(2);
         this.§5l§[0].SetV(param1);
         this.§5l§[1].SetV(param2);
         this.§%e§.x = 0.5 * (param1.x + param2.x);
         this.§%e§.y = 0.5 * (param1.y + param2.y);
         this.§@!'§[0] = b2Math.§7!E§(b2Math.§>+§(param2,param1),1);
         this.§@!'§[0].Normalize();
         this.§@!'§[1].x = -this.§@!'§[0].x;
         this.§@!'§[1].y = -this.§@!'§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§<R§)
         {
            _loc6_ = (_loc9_ = this.§5l§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§>!W§.x = _loc5_ - b2internal::!C;
         param1.§>!W§.y = _loc6_ - b2internal::!C;
         param1.§]!F§.x = _loc7_ + b2internal::!C;
         param1.§]!F§.y = _loc8_ + b2internal::!C;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§<R§ == 2)
         {
            param1.center.x = 0.5 * (this.§5l§[0].x + this.§5l§[1].x);
            param1.center.y = 0.5 * (this.§5l§[0].y + this.§5l§[1].y);
            param1.§0,§ = 0;
            param1.§4!8§ = 0;
            return;
         }
         ...
         var _loc6_:Number = 0;
         var _loc10_:int = 0;
         while(_loc10_ < this.§<R§)
         {
            _loc11_ = this.§5l§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§<R§ ? this.§5l§[int(_loc10_ + 1)] : this.§5l§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§[U§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§[U§(_loc5_,this.§5l§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§ case§(param3,_loc24_.center));
                  return _loc24_.§0,§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§<R§;
         var _loc14_:int = (_loc10_ + 1) % this.§<R§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§5l§[_loc9_].x * (1 - _loc15_) + this.§5l§[_loc13_].x * _loc15_,this.§5l§[_loc9_].y * (1 - _loc15_) + this.§5l§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§5l§[_loc10_].x * (1 - _loc16_) + this.§5l§[_loc14_].x * _loc16_,this.§5l§[_loc10_].y * (1 - _loc16_) + this.§5l§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§5l§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§<R§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§5l§[_loc12_];
            }
         ...
         _loc20_.§!!L§(1 / _loc19_);
         param4.SetV(b2Math.§ case§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §-o§() : Vector.<b2Vec2>
      {
         return this.§@!'§;
      }
      
      public function §8!6§(param1:b2Vec2) : int
      {
      ...
      {
         var _loc2_:int = this.§5l§.length;
         while(_loc2_ < param1)
         {
            this.§5l§[_loc2_] = new b2Vec2();
