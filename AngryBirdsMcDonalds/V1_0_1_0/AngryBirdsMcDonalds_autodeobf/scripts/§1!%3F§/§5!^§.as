package §1!?§
{
   ...
   public class §5!^§
   {
      ...
      {
         this.§3!S§ = [0,1,5,6,14,15,27,28,2,4,7,13,16,26,29,42,3,8,12,17,25,30,41,43,9,11,18,24,31,40,44,53,10,19,23,32,39,45,52,54,20,22,33,38,46,51,55,60,21,34,37,47,50,56,59,61,35,36,48,49,57,58,62,63];
         this.§,Y§ = new Array(64);
         this.§&J§ = new Array(64);
         this.§]!O§ = new Array(64);
         this.§`!"§ = new Array(64);
         ...
         this.§6!a§ = [0,0,2,1,3,3,2,4,3,5,5,4,4,0,0,1,125];
      ...
      private function § !U§(param1:int) : void
      {
         ...
         while(_loc7_ < 8)
         {
            ...
            while(_loc8_ < 8)
            {
               this.§]!O§[_loc2_] = 1 / (this.§,Y§[this.§3!S§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               this.§`!"§[_loc2_] = 1 / (this.§&J§[this.§3!S§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               _loc2_++;
               _loc8_++;
            }
            _loc7_++;
      ...
      {
         this.§3!M§ = this.§?!=§(this.§7!&§,this.§@!1§);
         this.§0!o§ = this.§?!=§(this.§?!&§,this.§@[§);
         this.§2!;§ = this.§?!=§(this.§6!a§,this.§&!C§);
         this.§-!k§ = this.§?!=§(this.§?!;§,this.§,!C§);
      }
      ...
      private function §?!f§(param1:§4d§) : void
      {
      ...
      private function §7!I§(param1:int, param2:int) : void
      {
         this.§%!W§(65472);
         this.§%!W§(17);
         this.writeByte(8);
      ...
      private function §8f§() : void
      {
         ...
         while(_loc1_ < 16)
         {
            this.writeByte(this.§6!a§[_loc1_ + 1]);
            _loc1_++;
         }
         _loc1_ = 0;
         while(_loc1_ <= 161)
      ...
      private function §3!K§(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         var _loc8_:int = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         var _loc6_:§4d§ = param5[0];
         var _loc7_:§4d§ = param5[240];
         var _loc9_:Array = this.§%!A§(param1,param2);
         _loc8_ = 0;
         while(_loc8_ < 64)
         {
            this.§%6§[this.§3!S§[_loc8_]] = _loc9_[_loc8_];
            _loc8_++;
         }
         ...
         while(_loc8_ <= _loc11_)
         {
            ...
            this.§?!f§(param5[_loc13_ * 16 + this.category[32767 + this.§%6§[_loc8_]]]);
            this.§?!f§(this.§]@§[32767 + this.§%6§[_loc8_]]);
            _loc8_++;
         }
         if(_loc11_ != 63)
         {
      ...
      public function encode(param1:BitmapData) : ByteArray
      {
         ...
         this.§=!#§();
         this.§3u§();
         this.§7!I§(param1.width,param1.height);
         this.§8f§();
         this.§6!U§();
         var _loc2_:Number = 0;
         var _loc3_:Number = 0;
         ...
         while(_loc5_ < param1.height)
         {
            ...
            while(_loc6_ < param1.width)
            {
               ...
               _loc2_ = this.§3!K§(this.§#!&§,this.§]!O§,_loc2_,this.§3!M§,this.§2!;§);
               _loc3_ = this.§3!K§(this.§`!c§,this.§`!"§,_loc3_,this.§0!o§,this.§-!k§);
               _loc4_ = this.§3!K§(this.§[`§,this.§`!"§,_loc4_,this.§0!o§,this.§-!k§);
               _loc6_ += 8;
            }
            _loc5_ += 8;
         }
         if(this.§3!Y§ >= 0)
         {
            (_loc7_ = new §4d§()).len = this.§3!Y§ + 1;
            _loc7_.val = (1 << this.§3!Y§ + 1) - 1;
            this.§?!f§(_loc7_);
         }
         this.§%!W§(65497);
         return this.§<o§;
