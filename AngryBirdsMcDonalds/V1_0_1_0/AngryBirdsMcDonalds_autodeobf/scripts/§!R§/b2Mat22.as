package §!R§
{
   public class b2Mat22
   {
      ...
      public static function §<!b§(param1:b2Vec2, param2:b2Vec2) : b2Mat22
      {
      ...
      public function §[!n§(param1:b2Mat22) : void
      {
      ...
      public function §6T§(param1:b2Mat22) : b2Mat22
      {
      ...
      public function §5d§(param1:b2Vec2, param2:Number, param3:Number) : b2Vec2
      {
