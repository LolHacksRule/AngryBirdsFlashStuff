package §]7§
{
   ...
   public class b2Collision
   {
      ...
      private static var §?!2§:Vector.<§3!`§> = §88§();
      
      private static var s_clipPoints1:Vector.<§3!`§> = §88§();
      
      private static var s_clipPoints2:Vector.<§3!`§> = §88§();
      
      private static var §-V§:Vector.<int> = new Vector.<int>(1);
      
      private static var §#x§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §+&§(param1:Vector.<§3!`§>, param2:Vector.<§3!`§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§3!`§ = null;
         var _loc6_:int = 0;
      ...
      public static function §?!$§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc6_:int = param1.§<R§;
         var _loc7_:Vector.<b2Vec2> = param1.§5l§;
         var _loc8_:Vector.<b2Vec2> = param1.§@!'§;
         var _loc9_:int = param4.§<R§;
         var _loc10_:Vector.<b2Vec2> = param4.§5l§;
         _loc11_ = param2.R;
      ...
      public static function §=!9§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
      ...
      public static function §6!A§(param1:Vector.<§3!`§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§3!`§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§<R§;
         var _loc8_:Vector.<b2Vec2> = param2.§@!'§;
         var _loc9_:int = param5.§<R§;
         var _loc10_:Vector.<b2Vec2> = param5.§5l§;
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§,!W§.§?<§ = param4;
         _loc20_.id.§,!W§.§-[§ = _loc22_;
         _loc20_.id.§,!W§.§1!O§ = 1;
      }
      
      private static function §88§() : Vector.<§3!`§>
      {
         var _loc1_:Vector.<§3!`§> = new Vector.<§3!`§>(2);
         _loc1_[0] = new §3!`§();
         _loc1_[1] = new §3!`§();
         return _loc1_;
      }
      ...
      public static function §@!!§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §-V§[0] = _loc8_;
         var _loc9_:Number = §=!9§(§-V§,param2,param3,param4,param5);
         _loc8_ = §-V§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §#x§[0] = _loc10_;
         var _loc11_:Number = §=!9§(§#x§,param4,param5,param2,param3);
         _loc10_ = §#x§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§+C§ = b2Manifold.§6U§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§3!`§> = §?!2§;
         §6!A§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§<R§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§5l§)[_loc16_];
         ...
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §?X§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         ...
         var _loc37_:Vector.<§3!`§> = s_clipPoints1;
         var _loc38_:Vector.<§3!`§> = s_clipPoints2;
      ...
      public static function §`a§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§+C§ = b2Manifold.§1!g§;
         param1.m_localPoint.SetV(param2.§+k§);
         param1.§>!Q§.§"9§();
         param1.§,!!§ = 1;
         param1.§55§[0].m_localPoint.SetV(param4.§+k§);
         param1.§55§[0].m_id.key = 0;
      }
      
      public static function §6!Q§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§<R§;
         var _loc22_:Vector.<b2Vec2> = param2.§5l§;
      ...
      public static function §6!_§(param1:b2AABB, param2:b2AABB) : Boolean
      {
