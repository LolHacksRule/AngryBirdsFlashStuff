package §]7§
{
   ...
   public class b2TimeOfImpact
   {
      ...
      private static var §"!1§:b2SeparationFunction = new b2SeparationFunction();
      ...
      public static function §+#§(param1:b2TOIInput) : Number
      {
         ...
         ++b2_toiCalls;
         var _loc2_:b2DistanceProxy = param1.§9s§;
         var _loc3_:b2DistanceProxy = param1.§4!S§;
         var _loc4_:b2Sweep = param1.§0!K§;
         var _loc5_:b2Sweep = param1.§<i§;
         b2Settings.b2Assert(_loc4_.§3!2§ == _loc5_.§3!2§);
         b2Settings.b2Assert(1 - _loc4_.§3!2§ > Number.MIN_VALUE);
         ...
         do
         {
            ...
            §"!1§.§4G§(§<!X§,_loc2_,§,!D§,_loc3_,§5!>§);
            if((_loc12_ = §"!1§.Evaluate(§,!D§,§5!>§)) <= 0)
            {
               _loc8_ = 1;
               break;
            }
            ...
            _loc4_.§&0§(§,!D§,_loc15_);
            _loc5_.§&0§(§5!>§,_loc15_);
            if((_loc17_ = §"!1§.Evaluate(§,!D§,§5!>§)) >= _loc11_)
            {
               _loc8_ = 1;
               break;
            }
            ...
            do
            {
               ...
               _loc4_.§&0§(§,!D§,_loc19_);
               _loc5_.§&0§(§5!>§,_loc19_);
               _loc20_ = §"!1§.Evaluate(§,!D§,§5!>§);
               if(b2Math.§'s§(_loc20_ - _loc11_) < 0.025 * _loc7_)
               {
                  _loc13_ = _loc19_;
                  break;
               }
