package §]7§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §4G§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§+C§)
         {
            case b2Manifold.§1!g§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§55§[0].m_localPoint;
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§%r§.x = _loc19_ / _loc26_;
                  this.§%r§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§%r§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§%r§.x;
               _loc23_ = _loc16_ + param3 * this.§%r§.y;
               _loc24_ = _loc17_ - param5 * this.§%r§.x;
               _loc25_ = _loc18_ - param5 * this.§%r§.y;
               this.§55§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§55§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§6U§:
               _loc8_ = param2.R;
               _loc7_ = param1.§>!Q§;
               ...
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§55§[_loc6_].m_localPoint;
                  ...
                  this.§55§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§55§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§,!b§:
               ...
               while(_loc6_ < param1.§,!!§)
               {
                  ...
                  this.§55§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§55§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
