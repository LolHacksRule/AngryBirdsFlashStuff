package §]7§
{
   ...
   class b2Simplex
   {
      ...
      public var §5l§:Vector.<b2SimplexVertex>;
      ...
      function b2Simplex()
      {
         ...
         this.§5l§ = new Vector.<b2SimplexVertex>(3);
         super();
         this.§5l§[0] = this.m_v1;
         this.§5l§[1] = this.m_v2;
         this.§5l§[2] = this.m_v3;
      ...
      public function §4!&§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         this.§5Q§ = param1.count;
         var _loc8_:Vector.<b2SimplexVertex> = this.§5l§;
         var _loc9_:int = 0;
         while(_loc9_ < this.§5Q§)
         {
            (_loc10_ = _loc8_[_loc9_]).indexA = param1.indexA[_loc9_];
            _loc10_.indexB = param1.indexB[_loc9_];
            _loc6_ = param2.§5!P§(_loc10_.indexA);
            _loc7_ = param4.§5!P§(_loc10_.indexB);
            _loc10_.§"^§ = b2Math.§ case§(param3,_loc6_);
            _loc10_.§-D§ = b2Math.§ case§(param5,_loc7_);
            _loc10_.§'!@§ = b2Math.§>+§(_loc10_.§-D§,_loc10_.§"^§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§5Q§ > 1)
      ...
      public function §0`§(param1:b2SimplexCache) : void
      {
         param1.§`i§ = this.§`Z§();
         param1.count = uint(this.§5Q§);
         var _loc2_:Vector.<b2SimplexVertex> = this.§5l§;
         var _loc3_:int = 0;
         while(_loc3_ < this.§5Q§)
         {
      ...
      public function §7"§() : b2Vec2
      {
         ...
         switch(this.§5Q§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§1n§(_loc1_,this.m_v1.§'!@§.§`!a§());
               if(_loc2_ > 0)
               {
                  return b2Math.§&!-§(1,_loc1_);
               }
               return b2Math.§7!E§(_loc1_,1);
               break;
            default:
      ...
      public function §'R§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§5Q§)
         {
            ...
            case 1:
               ...
               param2.SetV(this.m_v1.§-D§);
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§"^§.x + this.m_v2.a * this.m_v2.§"^§.x;
               param1.y = this.m_v1.a * this.m_v1.§"^§.y + this.m_v2.a * this.m_v2.§"^§.y;
               param2.x = this.m_v1.a * this.m_v1.§-D§.x + this.m_v2.a * this.m_v2.§-D§.x;
               param2.y = this.m_v1.a * this.m_v1.§-D§.y + this.m_v2.a * this.m_v2.§-D§.y;
               break;
            case 3:
      ...
      public function §`Z§() : Number
      {
         switch(this.§5Q§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§>+§(this.m_v1.§'!@§,this.m_v2.§'!@§).§!I§();
            case 3:
               return b2Math.§1n§(b2Math.§>+§(this.m_v2.§'!@§,this.m_v1.§'!@§),b2Math.§>+§(this.m_v3.§'!@§,this.m_v1.§'!@§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc5_:Number = b2Math.§[U§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§[U§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§>+§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§[U§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§[U§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§>+§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§[U§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§[U§(_loc3_,_loc14_);
         var _loc18_:Number = -_loc15_;
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§1n§(_loc4_,_loc9_)) * b2Math.§1n§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§1n§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§1n§(_loc1_,_loc2_);
