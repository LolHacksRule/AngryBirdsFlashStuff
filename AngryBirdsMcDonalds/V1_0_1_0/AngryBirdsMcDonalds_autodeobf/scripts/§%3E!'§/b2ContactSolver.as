package §>!'§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §&6§:b2WorldManifold = new b2WorldManifold();
      
      private static var §6]§:b2PositionSolverManifold = new b2PositionSolverManifold();
       
      
      private var §!!V§:b2TimeStep;
      
      private var §7g§;
      
      b2internal var §4!3§:Vector.<b2ContactConstraint>;
      
      private var §6!o§:int;
      
      public function b2ContactSolver()
      {
         this.§!!V§ = new b2TimeStep();
         this.§4!3§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §4G§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§7g§ = param4;
         this.§6!o§ = param3;
         while(this.§4!3§.length < this.§6!o§)
         {
            this.§4!3§[this.§4!3§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§7c§;
            _loc10_ = _loc5_.§!!@§;
            _loc11_ = _loc9_.§'i§;
            _loc12_ = _loc10_.§'i§;
            _loc13_ = _loc11_.§!C§;
            ...
            _loc17_ = _loc5_.§&m§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§'!I§(),_loc10_.§'!I§());
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§?J§(),_loc10_.§?J§());
            _loc20_ = _loc15_.§5!m§.x;
            _loc21_ = _loc15_.§5!m§.y;
            _loc22_ = _loc16_.§5!m§.x;
            _loc23_ = _loc16_.§5!m§.y;
            _loc24_ = _loc15_.m_angularVelocity;
            _loc25_ = _loc16_.m_angularVelocity;
            b2Settings.b2Assert(_loc17_.§,!!§ > 0);
            §&6§.§4G§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §&6§.§%r§.x;
            _loc27_ = §&6§.§%r§.y;
            (_loc28_ = this.§4!3§[_loc6_]).§-6§ = _loc15_;
            _loc28_.§?w§ = _loc16_;
            _loc28_.§'l§ = _loc17_;
            ...
            _loc28_.§5!;§.x = _loc17_.§>!Q§.x;
            _loc28_.§5!;§.y = _loc17_.§>!Q§.y;
            ...
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§50§)
            {
               _loc30_ = _loc17_.§55§[_loc29_];
               (_loc31_ = _loc28_.§,f§[_loc29_]).normalImpulse = _loc30_.§^!a§;
               _loc31_.tangentImpulse = _loc30_.§?!b§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§&!R§.x = §&6§.§55§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§&!R§.y = §&6§.§55§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§>0§.x = §&6§.§55§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§>0§.y = §&6§.§55§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§#@§ + _loc16_.§#@§ + _loc15_.§<3§ * _loc36_ + _loc16_.§<3§ * _loc37_;
               _loc31_.§^! § = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§+!C§ * _loc15_.§#@§ + _loc16_.§+!C§ * _loc16_.§#@§) + (_loc15_.§+!C§ * _loc15_.§<3§ * _loc36_ + _loc16_.§+!C§ * _loc16_.§<3§ * _loc37_);
               _loc31_.§"! § = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§#@§ + _loc16_.§#@§ + _loc15_.§<3§ * _loc42_ + _loc16_.§<3§ * _loc43_;
               _loc31_.§-R§ = 1 / _loc44_;
               _loc31_.§!A§ = 0;
               ...
               {
                  _loc31_.§!A§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§50§ == 2)
            {
               ...
               _loc52_ = _loc16_.§#@§;
               _loc53_ = _loc16_.§<3§;
               _loc54_ = _loc48_.§&!R§.x * _loc27_ - _loc48_.§&!R§.y * _loc26_;
               _loc55_ = _loc48_.§>0§.x * _loc27_ - _loc48_.§>0§.y * _loc26_;
               _loc56_ = _loc49_.§&!R§.x * _loc27_ - _loc49_.§&!R§.y * _loc26_;
               ...
               {
                  _loc28_.§7s§.col1.Set(_loc58_,_loc60_);
                  _loc28_.§7s§.col2.Set(_loc60_,_loc59_);
                  _loc28_.§7s§.§6T§(_loc28_.§^! §);
               }
               else
               {
                  _loc28_.§50§ = 1;
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.§6!o§)
         {
            _loc7_ = (_loc6_ = this.§4!3§[_loc5_]).§-6§;
            _loc8_ = _loc6_.§?w§;
            _loc9_ = _loc7_.§#@§;
            _loc10_ = _loc7_.§<3§;
            _loc11_ = _loc8_.§#@§;
            ...
            if(param1.§=s§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§&!R§.x * _loc22_ - _loc20_.§&!R§.y * _loc21_);
                  _loc7_.§5!m§.x -= _loc9_ * _loc21_;
                  _loc7_.§5!m§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§>0§.x * _loc22_ - _loc20_.§>0§.y * _loc21_);
                  _loc8_.§5!m§.x += _loc11_ * _loc21_;
                  _loc8_.§5!m§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  (_loc23_ = _loc6_.§,f§[_loc18_]).normalImpulse = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§6!o§)
         {
            _loc26_ = (_loc25_ = this.§4!3§[_loc24_]).§-6§;
            _loc27_ = _loc25_.§?w§;
            ...
            _loc1_ = 0;
            while(_loc1_ < _loc25_.§50§)
            {
               _loc2_ = _loc25_.§,f§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§>0§.y - _loc30_.x + _loc28_ * _loc2_.§&!R§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§>0§.x - _loc30_.y - _loc28_ * _loc2_.§&!R§.x;
               ...
               _loc28_ -= _loc33_ * (_loc2_.§&!R§.x * _loc15_ - _loc2_.§&!R§.y * _loc14_);
            ...
            if(_loc25_.§50§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§^! § * (_loc9_ - _loc2_.§!A§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§>0§.y - _loc30_.x + _loc28_ * _loc43_.§&!R§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§>0§.x - _loc30_.y - _loc28_ * _loc43_.§&!R§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§>0§.y - _loc30_.x + _loc28_ * _loc44_.§&!R§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§>0§.x - _loc30_.y - _loc28_ * _loc44_.§&!R§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§!A§;
               _loc54_ = _loc52_ - _loc44_.§!A§;
               _loc22_ = _loc25_.§7s§;
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§&!R§.x * _loc19_ - _loc43_.§&!R§.y * _loc18_ + _loc44_.§&!R§.x * _loc21_ - _loc44_.§&!R§.y * _loc20_);
               ...
               else
               {
                  ...
                  _loc57_ = 0;
                  _loc51_ = 0;
                  _loc52_ = _loc25_.§7s§.col1.y * _loc56_ + _loc54_;
                  ...
                  else
                  {
                     ...
                     _loc51_ = _loc25_.§7s§.col2.x * _loc57_ + _loc53_;
                     _loc52_ = 0;
      ...
      public function §,S§() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.§6!o§)
         {
            _loc2_ = this.§4!3§[_loc1_];
            _loc3_ = _loc2_.§'l§;
            _loc4_ = 0;
            while(_loc4_ < _loc2_.§50§)
            {
               _loc5_ = _loc3_.§55§[_loc4_];
               _loc6_ = _loc2_.§,f§[_loc4_];
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:Number = 0;
         var _loc3_:int = 0;
         while(_loc3_ < this.§6!o§)
         {
            _loc5_ = (_loc4_ = this.§4!3§[_loc3_]).§-6§;
            _loc6_ = _loc4_.§?w§;
            _loc7_ = _loc5_.§+!C§ * _loc5_.§#@§;
            _loc8_ = _loc5_.§+!C§ * _loc5_.§<3§;
            _loc9_ = _loc6_.§+!C§ * _loc6_.§#@§;
            _loc10_ = _loc6_.§+!C§ * _loc6_.§<3§;
            §6]§.§4G§(_loc4_);
            _loc11_ = §6]§.§%r§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§50§)
            {
               _loc13_ = _loc4_.§,f§[_loc12_];
               _loc14_ = §6]§.§55§[_loc12_];
               _loc15_ = §6]§.§+!f§[_loc12_];
