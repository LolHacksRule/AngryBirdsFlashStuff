package §,![§
{
   ...
   public class §#j§ extends §2!"§
   {
      ...
      public function §#j§(param1:XML, param2:§[!S§, param3:MovieClip = null)
      {
      ...
      {
         this.listenerEventOccured(§%!6§,§5y§[§%!6§]);
      }
      ...
      private function stopDrag(param1:Event = null) : void
      {
         ...
         if(mClip.stage)
         {
            ...
            this.setComponentVisualState(§>!6§.COMPONENT_STATE_ACTIVE_DEFAULT);
         }
         if(this.§?`§)
         {
      ...
      public function §8y§(param1:Rectangle) : void
      {
         this.§0t§ = param1;
      }
