package §4!=§
{
   ...
   public class §>H§
   {
      ...
      public static var §0W§:ByteArray;
      ...
      public static function §,!=§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §7!'§(_loc2_);
         return §4X§.§=!%§(_loc3_.readInt(),true) + §4X§.§=!%§(_loc3_.readInt(),true) + §4X§.§=!%§(_loc3_.readInt(),true) + §4X§.§=!%§(_loc3_.readInt(),true) + §4X§.§=!%§(_loc3_.readInt(),true);
      }
      ...
      private static function §7!'§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
