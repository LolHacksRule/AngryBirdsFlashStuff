package §#N§
{
   public class §-!J§
   {
      ...
      {
         § <§[§ <§.length] = new §3!,§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10);
      }
      
      public static function §case §(param1:String) : §3!,§
      {
         var _loc2_:int = 0;
         while(_loc2_ < § <§.length)
         {
            if((§ <§[_loc2_] as §3!,§).mName.toLowerCase() == param1.toLowerCase())
            {
               return § <§[_loc2_] as §3!,§;
            }
            _loc2_++;
