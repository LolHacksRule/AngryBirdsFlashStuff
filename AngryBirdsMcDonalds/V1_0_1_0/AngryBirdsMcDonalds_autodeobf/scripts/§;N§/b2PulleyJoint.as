package §;N§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §7!m§:Number = 2;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§=!Y§ = b2internal:: each.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§#!f§.x - this.§=!Y§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§#!f§.y - this.§=!Y§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§&4§.x - this.§=!Y§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§&4§.y - this.§=!Y§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§4D§);
         this.m_localAnchor2.SetV(param1.§@@§);
         this.§&!S§ = param1.§8!I§;
         this.§[!L§ = param1.§4W§ + this.§&!S§ * param1.§?!m§;
         this.m_maxLength1 = b2Math.§]!W§(param1.§^^§,this.§[!L§ - this.§&!S§ * b2internal::7!m);
         this.m_maxLength2 = b2Math.§]!W§(param1.§+!-§,(this.§[!L§ - b2internal::7!m) / this.§&!S§);
         this.§%z§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§%z§ * this.m_u2.x,param1 * this.§%z§ * this.m_u2.y);
      }
      ...
      public function §6G§() : b2Vec2
      {
         var _loc1_:b2Vec2 = this.§=!Y§.m_xf.position.Copy();
      ...
      {
         var _loc1_:b2Vec2 = b2internal:: each.GetWorldPoint(this.m_localAnchor1);
         var _loc2_:Number = this.§=!Y§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.§=!Y§.m_xf.position.y + this.m_groundAnchor1.y;
      ...
      public function GetLength2() : Number
      {
         ...
         var _loc2_:Number = this.§=!Y§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.§=!Y§.m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc14_:Number = this.§=!Y§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.§=!Y§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.§=!Y§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.§=!Y§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§[!L§ - _loc18_ - this.§&!S§ * _loc19_) > 0)
         {
            this.§;J§ = b2internal::>4;
            this.§%z§ = 0;
         }
         ...
         {
            this.m_limitState1 = b2internal::>4;
            this.m_limitImpulse1 = 0;
         }
         else
         {
         ...
         {
            this.m_limitState2 = b2internal::>4;
            this.m_limitImpulse2 = 0;
         }
         else
         {
         ...
         this.m_limitMass1 = _loc2_.§#@§ + _loc2_.§<3§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§#@§ + _loc3_.§<3§ * _loc22_ * _loc22_;
         this.§]!9§ = this.m_limitMass1 + this.§&!S§ * this.§&!S§ * this.m_limitMass2;
         ...
         if(param1.§=s§)
         {
            ...
            _loc23_ = (-this.§%z§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§%z§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§&!S§ * this.§%z§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§&!S§ * this.§%z§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§5!m§.x += _loc2_.§#@§ * _loc23_;
            _loc2_.§5!m§.y += _loc2_.§#@§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§<3§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§5!m§.x += _loc3_.§#@§ * _loc25_;
            _loc3_.§5!m§.y += _loc3_.§#@§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§<3§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§%z§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc10_ = _loc2_.§5!m§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§5!m§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§5!m§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§5!m§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§&!S§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§]!9§ * -_loc18_;
            _loc20_ = this.§%z§;
            this.§%z§ = b2Math.§@!Q§(0,this.§%z§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§%z§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§&!S§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§&!S§ * _loc19_ * this.m_u2.y;
            _loc2_.§5!m§.x += _loc2_.§#@§ * _loc14_;
            _loc2_.§5!m§.y += _loc2_.§#@§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§<3§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§5!m§.x += _loc3_.§#@§ * _loc16_;
            _loc3_.§5!m§.y += _loc3_.§#@§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§<3§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal:: each;
         var _loc3_:b2Body = b2internal::8[;
         var _loc5_:Number = this.§=!Y§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.§=!Y§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.§=!Y§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.§=!Y§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         if(this.§;J§ == b2internal:: !,)
         {
            ...
            _loc19_ = this.§[!L§ - _loc17_ - this.§&!S§ * _loc18_;
            ...
            _loc2_.m_sweep.a += _loc2_.§<3§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§#@§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§#@§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§<3§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§"d§();
            _loc3_.§"d§();
         }
         if(this.m_limitState1 == b2internal:: !,)
