package §;N§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§%z§.x * this.§#K§.x + (this.§^!k§ + this.§%z§.z) * this.§?!6§.x),param1 * (this.§%z§.x * this.§#K§.y + (this.§^!k§ + this.§%z§.z) * this.§?!6§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§6!S§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§6!S§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§6!S§.col2.x = this.§6!S§.col1.y;
         this.§6!S§.col2.y = _loc16_ + _loc17_;
         this.§6!S§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§6!S§.col3.x = this.§6!S§.col1.z;
         this.§6!S§.col3.y = this.§6!S§.col2.z;
         this.§6!S§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§!!&§)
         {
         ...
         if(param1.§=s§)
         {
            ...
            this.§%z§.y *= param1.§;%§;
            this.§^!k§ *= param1.§;%§;
            _loc19_ = this.§%z§.x * this.§#K§.x + (this.§^!k§ + this.§%z§.z) * this.§?!6§.x;
            _loc20_ = this.§%z§.x * this.§#K§.y + (this.§^!k§ + this.§%z§.z) * this.§?!6§.y;
            _loc21_ = this.§%z§.x * this.m_s1 + this.§%z§.y + (this.§^!k§ + this.§%z§.z) * this.m_a1;
            _loc22_ = this.§%z§.x * this.m_s2 + this.§%z§.y + (this.§^!k§ + this.§%z§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§?!6§.x * (_loc6_.x - _loc4_.x) + this.§?!6§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.final * (this.§0!g§ - _loc14_);
            _loc16_ = this.§^!k§;
            _loc17_ = param1.§#"§ * this.§]!j§;
            this.§^!k§ = b2Math.§%!i§(this.§^!k§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§^!k§ - _loc16_) * this.§?!6§.x;
            _loc9_ = _loc15_ * this.§?!6§.y;
         ...
         {
            _loc18_ = this.§?!6§.x * (_loc6_.x - _loc4_.x) + this.§?!6§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§%z§.Copy();
            _loc20_ = this.§6!S§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§%z§.§"W§(_loc20_);
            if(this.§?9§ == b2internal::9!M)
            {
               this.§%z§.z = b2Math.§@!Q§(this.§%z§.z,0);
            }
            else if(this.§?9§ == b2internal:: !,)
            {
               this.§%z§.z = b2Math.§]!W§(this.§%z§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§%z§.z - _loc19_.z) * this.§6!S§.col3.x;
            _loc22_ = -_loc13_ - (this.§%z§.z - _loc19_.z) * this.§6!S§.col3.y;
            _loc23_ = this.§6!S§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§%z§.x = _loc23_.x;
            this.§%z§.y = _loc23_.y;
            _loc20_.x = this.§%z§.x - _loc19_.x;
            _loc20_.y = this.§%z§.y - _loc19_.y;
            _loc20_.z = this.§%z§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§#K§.x + _loc20_.z * this.§?!6§.x;
            _loc9_ = _loc20_.x * this.§#K§.y + _loc20_.z * this.§?!6§.y;
         ...
         {
            _loc24_ = this.§6!S§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§%z§.x += _loc24_.x;
            this.§%z§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§#K§.x;
            _loc9_ = _loc24_.x * this.§#K§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§!!&§)
         {
            ...
            _loc35_ = this.§?!6§.x * _loc26_ + this.§?!6§.y * _loc27_;
            if(b2Math.§'s§(this.§2-§ - this.§8X§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§%!i§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§'s§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§8X§)
            {
               _loc19_ = b2Math.§%!i§(_loc35_ - this.§8X§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§8X§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§2-§)
            {
               _loc19_ = b2Math.§%!i§(_loc35_ - this.§2-§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§2-§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§6!S§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§6!S§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§6!S§.col2.x = this.§6!S§.col1.y;
            this.§6!S§.col2.y = _loc14_ + _loc15_;
            this.§6!S§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§6!S§.col3.x = this.§6!S§.col1.z;
            this.§6!S§.col3.y = this.§6!S§.col2.z;
            this.§6!S§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§6!S§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::9l;
            ...
            this.§6!S§.col1.Set(_loc36_,_loc37_,0);
            this.§6!S§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§6!S§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§#K§.x + _loc28_.z * this.§?!6§.x;
         var _loc32_:Number = _loc28_.x * this.§#K§.y + _loc28_.z * this.§?!6§.y;
         ...
         _loc6_.x -= b2internal::9l * _loc31_;
         _loc6_.y -= b2internal::9l * _loc32_;
         _loc7_ -= b2internal::?l * _loc33_;
         _loc8_.x += b2internal::0A * _loc31_;
         _loc8_.y += b2internal::0A * _loc32_;
