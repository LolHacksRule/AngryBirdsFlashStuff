package §'x§
{
   ...
   public class §=!4§
   {
      ...
      public static function §#K§(param1:String) : String
      {
         ...
         var _loc3_:ByteArray = §8B§(_loc2_);
         return §0t§.§%!9§(_loc3_.readInt(),true) + §0t§.§%!9§(_loc3_.readInt(),true) + §0t§.§%!9§(_loc3_.readInt(),true) + §0t§.§%!9§(_loc3_.readInt(),true) + §0t§.§%!9§(_loc3_.readInt(),true);
      }
      
      public static function §3!q§(param1:ByteArray) : String
      {
      ...
      private static function §8B§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
