package §8]§
{
   ...
   public class §1w§ extends §@L§
   {
       
      
      public function §1w§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§!!;§(param1,param2);
      }
      ...
      protected function §!!;§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§!n§(_loc7_,_loc6_)]) == null)
            {
               ...
               {
                  _loc10_ = new §1k§(0,0,_loc11_,_loc12_,_loc13_,_loc14_);
               }
            }
            if(_loc10_)
            {
      ...
      private function §0[§(param1:Vector.<XML>) : Dictionary
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§!n§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §1k§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
