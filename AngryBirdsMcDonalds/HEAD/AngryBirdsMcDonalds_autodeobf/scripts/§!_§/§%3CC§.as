package §!_§
{
   public class §<C§
   {
      ...
      {
         this.mLayers[this.mLayers.length] = new §;U§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13,param14,param15,param16,param17);
      }
      
      public function §0!S§() : Number
      {
         return this.§8[§;
      }
   }
