package §+S§
{
   public class b2Mat22
   {
      ...
      public static function §4!G§(param1:Number) : b2Mat22
      {
      ...
      public static function §2!$§(param1:b2Vec2, param2:b2Vec2) : b2Mat22
      {
      ...
      public function §3!k§(param1:b2Mat22) : void
      {
      ...
      public function §`H§(param1:b2Vec2, param2:Number, param3:Number) : b2Vec2
      {
