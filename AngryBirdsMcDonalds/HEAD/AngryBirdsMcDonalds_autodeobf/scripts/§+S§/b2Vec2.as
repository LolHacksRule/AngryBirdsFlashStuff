package §+S§
{
   public class b2Vec2
   {
      ...
      public static function §-!P§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §0o§(param1:b2Vec2) : void
      {
         this.x += param1.x;
         this.y += param1.y;
      }
      ...
      {
         var _loc2_:Number = b2Math.§7!7§(this,param1.col1);
         this.y = b2Math.§7!7§(this,param1.col2);
         this.x = _loc2_;
      }
