package §`!n§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function §`!A§(param1:int, param2:int) : void
      {
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§&!C§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§&!C§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§&!C§[_loc6_];
            §'!C§(_loc7_,§9X§);
            transformCoords(§9X§,_loc3_,_loc4_,§2!F§);
            if(_loc8_ = _loc7_.hitTest(§2!F§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§,!<§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§&!C§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§9!i§();
               param1.§&3§(_loc5_);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§+!q§(this,param1.type,_loc2_);
      ...
      private function §+!q§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = (_loc5_ = _loc4_.§&!C§).length;
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
               this.§+!q§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
