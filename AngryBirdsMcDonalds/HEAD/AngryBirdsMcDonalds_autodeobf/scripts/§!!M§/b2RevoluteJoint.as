package §!!M§
{
   ...
   public class b2RevoluteJoint extends b2Joint
   {
      ...
      {
         return b2internal::^!l.m_sweep.a - b2internal::0!?.m_sweep.a - this.§+_§;
      }
      
      public function §@;§() : Number
      {
         return b2internal::^!l.m_angularVelocity - b2internal::0!?.m_angularVelocity;
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§&1§)
         {
            _loc14_ = _loc3_.m_sweep.a - _loc2_.m_sweep.a - this.§+_§;
            if(b2Math.§3!0§(this.§6<§ - this.§"! §) < 2 * b2Settings.b2_angularSlop)
            {
               this.§]U§ = b2internal::`!?;
            }
         ...
         if(param1.§7z§)
         {
            ...
            _loc15_ = this.§@!<§.x;
            _loc16_ = this.§@!<§.y;
            _loc2_.§switch§.x -= _loc10_ * _loc15_;
            _loc2_.§switch§.y -= _loc10_ * _loc16_;
            _loc2_.m_angularVelocity -= _loc12_ * (_loc6_ * _loc16_ - _loc7_ * _loc15_ + this.§,!L§ + this.§@!<§.z);
            _loc3_.§switch§.x += _loc11_ * _loc15_;
            _loc3_.§switch§.y += _loc11_ * _loc16_;
            _loc3_.m_angularVelocity += _loc13_ * (_loc8_ * _loc16_ - _loc9_ * _loc15_ + this.§,!L§ + this.§@!<§.z);
         }
         else
         {
            this.§@!<§.§%^§();
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc11_:b2Vec2 = _loc2_.§switch§;
         var _loc12_:Number = _loc2_.m_angularVelocity;
         var _loc13_:b2Vec2 = _loc3_.§switch§;
         ...
         {
            _loc19_ = _loc14_ - _loc12_ - this.§%k§;
            _loc20_ = this.§6"§ * -_loc19_;
            _loc21_ = this.§,!L§;
            _loc22_ = param1.§9[§ * this.§=O§;
         ...
         if(this.§&1§ && this.§]U§ != b2internal::5! )
         {
            ...
            this.§2D§.Solve33(this.impulse3,-_loc23_,-_loc24_,-_loc25_);
            if(this.§]U§ == b2internal::`!?)
            {
               this.§@!<§.§0o§(this.impulse3);
            }
            else if(this.§]U§ == b2internal::7')
            {
               if((_loc6_ = this.§@!<§.z + this.impulse3.z) < 0)
               {
                  this.§2D§.Solve22(this.§>!$§,-_loc23_,-_loc24_);
         ...
         else
         {
            ...
            this.§2D§.Solve22(this.impulse2,-_loc26_,-_loc27_);
         ...
         _loc2_.§switch§.SetV(_loc11_);
         _loc2_.m_angularVelocity = _loc12_;
         _loc3_.§switch§.SetV(_loc13_);
