package §!!M§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§@!<§.x * this.§&E§.x + (this.§,!L§ + this.§@!<§.z) * this.§-O§.x),param1 * (this.§@!<§.x * this.§&E§.y + (this.§,!L§ + this.§@!<§.z) * this.§-O§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§4O§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§4O§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§4O§.col2.x = this.§4O§.col1.y;
         this.§4O§.col2.y = _loc16_ + _loc17_;
         this.§4O§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§4O§.col3.x = this.§4O§.col1.z;
         this.§4O§.col3.y = this.§4O§.col2.z;
         this.§4O§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§&1§)
         {
         ...
         if(param1.§7z§)
         {
            ...
            this.§@!<§.y *= param1.§4!a§;
            this.§,!L§ *= param1.§4!a§;
            _loc19_ = this.§@!<§.x * this.§&E§.x + (this.§,!L§ + this.§@!<§.z) * this.§-O§.x;
            _loc20_ = this.§@!<§.x * this.§&E§.y + (this.§,!L§ + this.§@!<§.z) * this.§-O§.y;
            _loc21_ = this.§@!<§.x * this.m_s1 + this.§@!<§.y + (this.§,!L§ + this.§@!<§.z) * this.m_a1;
            _loc22_ = this.§@!<§.x * this.m_s2 + this.§@!<§.y + (this.§,!L§ + this.§@!<§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§-O§.x * (_loc6_.x - _loc4_.x) + this.§-O§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§6"§ * (this.§%k§ - _loc14_);
            _loc16_ = this.§,!L§;
            _loc17_ = param1.§9[§ * this.§[t§;
            this.§,!L§ = b2Math.§&!<§(this.§,!L§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§,!L§ - _loc16_) * this.§-O§.x;
            _loc9_ = _loc15_ * this.§-O§.y;
         ...
         {
            _loc18_ = this.§-O§.x * (_loc6_.x - _loc4_.x) + this.§-O§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§@!<§.Copy();
            _loc20_ = this.§4O§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§@!<§.§0o§(_loc20_);
            if(this.§]U§ == b2internal::7')
            {
               this.§@!<§.z = b2Math.§!U§(this.§@!<§.z,0);
            }
            else if(this.§]U§ == b2internal::%+)
            {
               this.§@!<§.z = b2Math.§4!+§(this.§@!<§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§@!<§.z - _loc19_.z) * this.§4O§.col3.x;
            _loc22_ = -_loc13_ - (this.§@!<§.z - _loc19_.z) * this.§4O§.col3.y;
            _loc23_ = this.§4O§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§@!<§.x = _loc23_.x;
            this.§@!<§.y = _loc23_.y;
            ...
            _loc8_ = _loc20_.x * this.§&E§.x + _loc20_.z * this.§-O§.x;
            _loc9_ = _loc20_.x * this.§&E§.y + _loc20_.z * this.§-O§.y;
         ...
         {
            _loc24_ = this.§4O§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§@!<§.x += _loc24_.x;
            this.§@!<§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§&E§.x;
            _loc9_ = _loc24_.x * this.§&E§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§&1§)
         {
            ...
            _loc35_ = this.§-O§.x * _loc26_ + this.§-O§.y * _loc27_;
            if(b2Math.§3!0§(this.§=I§ - this.§<!M§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§&!<§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§3!0§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§<!M§)
            {
               _loc19_ = b2Math.§&!<§(_loc35_ - this.§<!M§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§<!M§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§=I§)
            {
               _loc19_ = b2Math.§&!<§(_loc35_ - this.§=I§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§5!O§;
         _loc16_ = b2Math.§!U§(_loc16_,b2Math.§3!0§(_loc29_));
         _loc17_ = b2Math.§3!0§(_loc30_);
         if(_loc18_)
         {
            ...
            this.§4O§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§4O§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§4O§.col2.x = this.§4O§.col1.y;
            this.§4O§.col2.y = _loc14_ + _loc15_;
            this.§4O§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§4O§.col3.x = this.§4O§.col1.z;
            this.§4O§.col3.y = this.§4O§.col2.z;
            this.§4O§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§4O§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::;!p;
            ...
            this.§4O§.col1.Set(_loc36_,_loc37_,0);
            this.§4O§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§4O§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§&E§.x + _loc28_.z * this.§-O§.x;
         var _loc32_:Number = _loc28_.x * this.§&E§.y + _loc28_.z * this.§-O§.y;
         ...
         _loc6_.x -= b2internal::;!p * _loc31_;
         _loc6_.y -= b2internal::;!p * _loc32_;
         _loc7_ -= b2internal::8; * _loc33_;
         _loc8_.x += b2internal::>G * _loc31_;
         _loc8_.y += b2internal::>G * _loc32_;
         _loc9_ += b2internal::3o * _loc34_;
