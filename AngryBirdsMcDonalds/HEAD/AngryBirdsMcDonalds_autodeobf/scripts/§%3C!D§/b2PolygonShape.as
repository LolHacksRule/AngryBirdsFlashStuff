package §<!D§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §8'§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §3L§:b2Vec2;
      
      b2internal var §-x§:Vector.<b2Vec2>;
      
      b2internal var §>!@§:Vector.<b2Vec2>;
      
      b2internal var §9Z§:int;
      ...
      public function b2PolygonShape()
      {
         ...
         §0!7§ = b2Settings.b2_polygonRadius;
         this.§3L§.§%^§();
      }
      
      public static function §7!4§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function § !Q§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §1!U§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§do §(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §[!9§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§5!L§(param1,param2);
         return _loc3_;
      }
      ...
      public static function §]!6§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§0o§(new b2Vec2(0,0));
            _loc3_.§0o§(_loc9_);
            _loc3_.§0o§(_loc10_);
            _loc3_.§71§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §<B§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§%!0§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§%!0§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§3L§.SetV(_loc2_.§3L§);
            this.§9Z§ = _loc2_.§9Z§;
            this.§!$§(this.§9Z§);
            _loc3_ = 0;
            while(_loc3_ < this.§9Z§)
            {
      ...
      public function § @§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§9Z§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§1!,§(this.§-x§[_loc5_],this.§-x§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§4!>§() > Number.MIN_VALUE);
            this.§>!@§[_loc3_].SetV(b2Math.§;"§(_loc6_,1));
            this.§>!@§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§3L§ = §]!6§(this.§-x§,this.§9Z§);
      }
      
      public function §8U§(param1:Number, param2:Number) : void
      {
         this.§9Z§ = 4;
         this.§!$§(4);
      ...
      public function §do §(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§9Z§ = 4;
         this.§!$§(4);
         this.§-x§[0].Set(-param1,-param2);
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§9Z§)
         {
            this.§-x§[_loc6_] = b2Math.§<j§(_loc5_,this.§-x§[_loc6_]);
            this.§>!@§[_loc6_] = b2Math.§>H§(_loc5_.R,this.§>!@§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §5!L§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§9Z§ = 2;
         this.§!$§(2);
         this.§-x§[0].SetV(param1);
         this.§-x§[1].SetV(param2);
         this.§3L§.x = 0.5 * (param1.x + param2.x);
         this.§3L§.y = 0.5 * (param1.y + param2.y);
         this.§>!@§[0] = b2Math.§;"§(b2Math.§1!,§(param2,param1),1);
         this.§>!@§[0].Normalize();
         this.§>!@§[1].x = -this.§>!@§[0].x;
         this.§>!@§[1].y = -this.§>!@§[0].y;
      }
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§-!j§.x = _loc5_ - b2internal::0!7;
         param1.§-!j§.y = _loc6_ - b2internal::0!7;
         param1.§5!M§.x = _loc7_ + b2internal::0!7;
         param1.§5!M§.y = _loc8_ + b2internal::0!7;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§9Z§)
         {
            _loc11_ = this.§-x§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§9Z§ ? this.§-x§[int(_loc10_ + 1)] : this.§-x§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§?r§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§7!7§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§9Z§)
         {
            _loc7_[_loc12_] = b2Math.§7!7§(_loc5_,this.§-x§[_loc12_]) - _loc6_;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§9Z§;
         var _loc14_:int = (_loc10_ + 1) % this.§9Z§;
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§9Z§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
      ...
      public function §4m§() : Vector.<b2Vec2>
      {
         return this.§-x§;
      }
