package §,!V§
{
   ...
   public class b2Collision
   {
      ...
      private static var § e§:Vector.<§5=§> = §"n§();
      
      private static var s_clipPoints1:Vector.<§5=§> = §"n§();
      
      private static var s_clipPoints2:Vector.<§5=§> = §"n§();
      ...
      public static function §]L§(param1:Vector.<§5=§>, param2:Vector.<§5=§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§5=§ = null;
         var _loc6_:int = 0;
      ...
      public static function §0![§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §[z§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §[z§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §[z§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §[z§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §9!Y§(param1:Vector.<§5=§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§5=§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§9Z§;
         var _loc8_:Vector.<b2Vec2> = param2.§>!@§;
         var _loc9_:int = param5.§9Z§;
         ...
         _loc20_.id.§9H§.§ G§ = param4;
         _loc20_.id.§9H§.§&;§ = _loc21_;
         _loc20_.id.§9H§.§;>§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§9H§.§ G§ = param4;
         _loc20_.id.§9H§.§&;§ = _loc22_;
         _loc20_.id.§9H§.§;>§ = 1;
      }
      
      private static function §"n§() : Vector.<§5=§>
      {
         var _loc1_:Vector.<§5=§> = new Vector.<§5=§>(2);
         _loc1_[0] = new §5=§();
         _loc1_[1] = new §5=§();
         return _loc1_;
      }
      ...
      public static function §?y§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         param1.§;!e§ = 0;
         var _loc7_:Number = param2.§0!7§ + param4.§0!7§;
         var _loc8_:int = 0;
         §@D§[0] = _loc8_;
         var _loc9_:Number = §0![§(§@D§,param2,param3,param4,param5);
         _loc8_ = §@D§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §%D§[0] = _loc10_;
         var _loc11_:Number = §0![§(§%D§,param4,param5,param2,param3);
         _loc10_ = §%D§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§5=§> = § e§;
         §9!Y§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§9Z§;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §,D§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §,X§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §7s§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §'9§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§5=§> = s_clipPoints1;
         var _loc38_:Vector.<§5=§> = s_clipPoints2;
         if((_loc39_ = §]L§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §]L§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
      ...
      public static function §&!k§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§0!7§ + param4.§0!7§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§@k§ = b2Manifold.§0l§;
         param1.m_localPoint.SetV(param2.§ A§);
         param1.§>l§.§%^§();
         param1.§;!e§ = 1;
         param1.§[9§[0].m_localPoint.SetV(param4.§ A§);
         param1.§[9§[0].m_id.key = 0;
      }
      
      public static function §const§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§0!7§ + param4.§0!7§;
         var _loc21_:int = param2.§9Z§;
