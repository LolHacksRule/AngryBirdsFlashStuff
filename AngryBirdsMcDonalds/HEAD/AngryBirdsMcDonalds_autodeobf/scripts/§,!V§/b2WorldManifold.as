package §,!V§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §`!9§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§@k§)
         {
            case b2Manifold.§0l§:
               ...
               this.§[9§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§[9§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§]]§:
               _loc8_ = param2.R;
               _loc7_ = param1.§>l§;
            ...
            case b2Manifold.§9!?§:
               ...
               while(_loc6_ < param1.§;!e§)
               {
                  ...
                  this.§[9§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§[9§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
