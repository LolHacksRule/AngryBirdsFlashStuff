package §,!V§
{
   ...
   public class b2DynamicTree
   {
      ...
      private var §17§:b2DynamicTreeNode;
      ...
      public function §,!F§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
         ...
         _loc3_.aabb.§5!M§.x = param1.§5!M§.x + _loc4_;
         _loc3_.aabb.§5!M§.y = param1.§5!M§.y + _loc5_;
         _loc3_.§-&§ = param2;
         this.§+A§(_loc3_);
         return _loc3_;
      }
      
      public function §9!8§(param1:b2DynamicTreeNode) : void
      {
         this.§]C§(param1);
         this.§>!K§(param1);
      }
      
      public function §^!3§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         var _loc4_:Number = NaN;
         var _loc5_:Number = NaN;
         ...
         param1.aabb.§5!M§.x = param2.§5!M§.x + _loc4_;
         param1.aabb.§5!M§.y = param2.§5!M§.y + _loc5_;
         this.§+A§(param1);
         return true;
      }
      ...
      public function §9;§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            _loc3_ = this.§8!-§;
            _loc4_ = 0;
            while(_loc3_.§,0§() == false)
            {
               _loc3_ = !!(this.§0!2§ >> _loc4_ & 1) ? _loc3_.child2 : _loc3_.child1;
               _loc4_ = _loc4_ + 1 & 31;
            }
            ++this.§0!2§;
            this.§]C§(_loc3_);
      ...
      public function §,;§(param1:Function, param2:b2AABB) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc7_:*;
         _loc3_[_loc7_ = _loc4_++] = this.§8!-§;
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§?3§(param2))
            {
               if(_loc5_.§,0§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc5_:b2Vec2;
         (_loc5_ = b2Math.§1!,§(_loc3_,_loc4_)).Normalize();
         var _loc6_:b2Vec2 = b2Math.§,!7§(1,_loc5_);
         var _loc7_:b2Vec2 = b2Math.§&!]§(_loc6_);
         var _loc8_:Number = param2.§"C§;
         _loc9_ = new b2AABB();
         ...
         _loc9_.§5!M§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§5!M§.y = Math.max(_loc3_.y,_loc11_);
         var _loc12_:Vector.<b2DynamicTreeNode> = new Vector.<b2DynamicTreeNode>();
         var _loc13_:int = 0;
         var _loc19_:*;
         _loc12_[_loc19_ = _loc13_++] = this.§8!-§;
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§?3§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§-!f§();
      ...
      private function §>V§() : b2DynamicTreeNode
      {
         var _loc1_:b2DynamicTreeNode = null;
         if(this.§17§)
         {
            _loc1_ = this.§17§;
            this.§17§ = _loc1_.parent;
            _loc1_.parent = null;
            _loc1_.child1 = null;
            _loc1_.child2 = null;
            return _loc1_;
      ...
      private function §+A§(param1:b2DynamicTreeNode) : void
      {
         ...
         var _loc2_:b2Vec2 = param1.aabb.§-!f§();
         var _loc3_:b2DynamicTreeNode = this.§8!-§;
         if(_loc3_.§,0§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§-!j§.x + _loc6_.aabb.§5!M§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§-!j§.y + _loc6_.aabb.§5!M§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§-!j§.x + _loc7_.aabb.§5!M§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§-!j§.y + _loc7_.aabb.§5!M§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         (_loc5_ = this.§>V§()).parent = _loc4_;
         _loc5_.§-&§ = null;
         _loc5_.aabb.§>o§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            {
               _loc4_.aabb.§>o§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
      ...
      private function §]C§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc5_ = _loc3_.aabb;
               _loc3_.aabb = b2AABB.§>o§(_loc3_.child1.aabb,_loc3_.child2.aabb);
