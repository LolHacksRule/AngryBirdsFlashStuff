package §%!H§
{
   ...
   public class §--§
   {
      ...
      private function §+!<§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§`!C§(param1 as String);
         }
         if(param1 is Number)
         {
      ...
      private function §>!j§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
      ...
      private function §>!R§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§`!C§(v.@name.toString()) + ":" + this.§+!<§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
