package §#!&§
{
   ...
   public class §#V§ extends §#O§
   {
      ...
      public function §#V§(param1:XML, param2:§59§, param3:MovieClip = null)
      {
         this.§`#§ = new Rectangle();
      ...
      private function startDrag(param1:Event = null) : void
      {
         if(mClip.stage)
         {
            ...
            this.mDragging = true;
            mClip.stage.addEventListener(MouseEvent.MOUSE_MOVE,this.§2k§);
            mClip.stage.addEventListener(MouseEvent.ROLL_OUT,this.stopDrag);
            mClip.stage.addEventListener(MouseEvent.MOUSE_UP,this.stopDrag);
         }
      }
      
      private function §2k§(param1:MouseEvent) : void
      {
         this.listenerEventOccured(§8+§,§1&§[§8+§]);
      }
      ...
      private function stopDrag(param1:Event = null) : void
      {
         ...
         if(mClip.stage)
         {
            mClip.stage.removeEventListener(MouseEvent.MOUSE_MOVE,this.§2k§);
            mClip.stage.removeEventListener(MouseEvent.ROLL_OUT,this.stopDrag);
            mClip.stage.removeEventListener(MouseEvent.MOUSE_UP,this.stopDrag);
            this.setComponentVisualState(§8!_§.COMPONENT_STATE_ACTIVE_DEFAULT);
         }
         if(this.§[!Y§)
         {
            this.setComponentVisualState(this.§[!Y§);
            this.§[!Y§ = null;
         }
      }
