package §5H§
{
   ...
   public class §5<§ extends §0!R§
   {
      ...
      {
         super(param3);
         this.§9Z§(param1,param2);
      }
      
      protected function §9Z§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc16_:§<T§ = null;
         var _loc3_:Dictionary = this.§#!6§(param2);
      ...
      private function §#!6§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§5"§(_loc4_,_loc6_.@name);
