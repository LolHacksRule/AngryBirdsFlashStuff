package §^!7§
{
   ...
   public final class §+B§
   {
      ...
      public static const MIGHTY_EAGLE_Y_CHANGE:Number = Math.sin(§5&§.§4!0§(MIGHTY_EAGLE_FLYING_ANGLE));
      
      public static const MIGHTY_EAGLE_X_DIRECTION:Number = 1;
      
      public static const §9!5§:Number = 1500;
      
      public static const §;!P§:Number = 0.7;
      
      public static const §2y§:Number = 0.2;
      ...
      public static const §+!P§:Number = 4;
      
      public static const §`k§:Number = 60;
      
      public static const §-q§:Number = 16;
      
      public static const §`5§:Number = 6 * §-q§;
      ...
      public static const §<b§:Number = 600;
      
      public static const §6g§:Number = 1.3;
      ...
      public static const §3L§:Number = 1.3;
      
      public static const §;!Y§:Number = 1.3;
      
      public static const §8!=§:Number = 1.5;
      
      public static const §2<§:int = 60;
      
      public static const §0f§:Number = 9;
      
      public static const §"!,§:Number = 5;
      
      public static const §&!X§:Number = 3000;
      
      public static const §%!C§:Number = 60;
      
      public static const §8!<§:Number = 6;
      
      public static const §&0§:Number = 3;
      
      public static const §0!S§:Number = 1 / 30;
      
      public static const § case§:int = 100;
      ...
      public static const §1#§:Number = 7.5;
      
      public static const §-!8§:Number = 300;
      
      public static const §]!O§:Number = 0.5;
      
      public static const §`V§:Number = 6;
      
      public static const §8@§:Number = 9;
      
      public static const get:Number = 0.15;
