package §<"§
{
   ...
   class b2Simplex
   {
      ...
      public var §`!M§:Vector.<b2SimplexVertex>;
      ...
      function b2Simplex()
      {
         ...
         this.§`!M§ = new Vector.<b2SimplexVertex>(3);
         super();
         this.§`!M§[0] = this.m_v1;
         this.§`!M§[1] = this.m_v2;
         this.§`!M§[2] = this.m_v3;
      ...
      public function §+i§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         this.§#E§ = param1.count;
         var _loc8_:Vector.<b2SimplexVertex> = this.§`!M§;
         var _loc9_:int = 0;
         while(_loc9_ < this.§#E§)
         {
            (_loc10_ = _loc8_[_loc9_]).indexA = param1.indexA[_loc9_];
            _loc10_.indexB = param1.indexB[_loc9_];
            _loc6_ = param2.§]!Z§(_loc10_.indexA);
            _loc7_ = param4.§]!Z§(_loc10_.indexB);
            _loc10_.§,!?§ = b2Math.§]x§(param3,_loc6_);
            _loc10_.§>!%§ = b2Math.§]x§(param5,_loc7_);
            _loc10_.§]!#§ = b2Math.§]G§(_loc10_.§>!%§,_loc10_.§,!?§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§#E§ > 1)
      ...
      public function §'!7§(param1:b2SimplexCache) : void
      {
         ...
         var _loc2_:Vector.<b2SimplexVertex> = this.§`!M§;
         var _loc3_:int = 0;
         while(_loc3_ < this.§#E§)
         {
      ...
      public function §[!N§() : b2Vec2
      {
         ...
         {
            case 1:
               return this.m_v1.§]!#§.§6!A§();
            case 2:
               _loc1_ = b2Math.§]G§(this.m_v2.§]!#§,this.m_v1.§]!#§);
               _loc2_ = b2Math.§9H§(_loc1_,this.m_v1.§]!#§.§6!A§());
               if(_loc2_ > 0)
               {
                  return b2Math.§case §(1,_loc1_);
               }
      ...
      public function §,%§() : Number
      {
         switch(this.§#E§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§]G§(this.m_v1.§]!#§,this.m_v2.§]!#§).§4§();
            case 3:
               return b2Math.§9H§(b2Math.§]G§(this.m_v2.§]!#§,this.m_v1.§]!#§),b2Math.§]G§(this.m_v3.§]!#§,this.m_v1.§]!#§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§9H§(_loc4_,_loc9_)) * b2Math.§9H§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§9H§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§9H§(_loc1_,_loc2_);
