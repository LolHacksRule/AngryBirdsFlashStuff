package §<"§
{
   ...
   public class b2Collision
   {
      ...
      private static var §`Q§:Vector.<§%q§> = §+x§();
      
      private static var s_clipPoints1:Vector.<§%q§> = §+x§();
      
      private static var s_clipPoints2:Vector.<§%q§> = §+x§();
      
      private static var §"U§:Vector.<int> = new Vector.<int>(1);
      
      private static var §5p§:Vector.<int> = new Vector.<int>(1);
      
      private static var §2!F§:b2Vec2 = new b2Vec2();
      ...
      public static function §`!O§(param1:Vector.<§%q§>, param2:Vector.<§%q§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§%q§ = null;
         var _loc6_:int = 0;
      ...
      public static function §34§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§-A§;
         var _loc7_:Vector.<b2Vec2> = param1.§`!M§;
         var _loc8_:Vector.<b2Vec2> = param1.§%!b§;
         var _loc9_:int = param4.§-A§;
         var _loc10_:Vector.<b2Vec2> = param4.§`!M§;
         _loc11_ = param2.R;
      ...
      public static function §!!+§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §34§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §34§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §34§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §34§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §<p§(param1:Vector.<§%q§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§%q§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§-A§;
         var _loc8_:Vector.<b2Vec2> = param2.§%!b§;
         var _loc9_:int = param5.§-A§;
         var _loc10_:Vector.<b2Vec2> = param5.§`!M§;
         ...
         _loc20_.id.§8U§.§>E§ = param4;
         _loc20_.id.§8U§.§9E§ = _loc21_;
         _loc20_.id.§8U§.§]u§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§8U§.§>E§ = param4;
         _loc20_.id.§8U§.§9E§ = _loc22_;
         _loc20_.id.§8U§.§]u§ = 1;
      }
      
      private static function §+x§() : Vector.<§%q§>
      {
         var _loc1_:Vector.<§%q§> = new Vector.<§%q§>(2);
         _loc1_[0] = new §%q§();
         _loc1_[1] = new §%q§();
         return _loc1_;
      }
      
      public static function §5!b§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§%q§ = null;
         ...
         param1.§>!=§ = 0;
         var _loc7_:Number = param2.§6x§ + param4.§6x§;
         var _loc8_:int = 0;
         §"U§[0] = _loc8_;
         var _loc9_:Number = §!!+§(§"U§,param2,param3,param4,param5);
         _loc8_ = §"U§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §5p§[0] = _loc10_;
         var _loc11_:Number = §!!+§(§5p§,param4,param5,param2,param3);
         _loc10_ = §5p§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§%q§> = §`Q§;
         §<p§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§-A§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§`!M§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §2!F§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §&!^§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §?!Z§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         ...
         var _loc37_:Vector.<§%q§> = s_clipPoints1;
         var _loc38_:Vector.<§%q§> = s_clipPoints2;
         if((_loc39_ = §`!O§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §`!O§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§=!W§.SetV(_loc27_);
      ...
      public static function §=v§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§6x§ + param4.§6x§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§'A§ = b2Manifold.§4!Q§;
         param1.m_localPoint.SetV(param2.§7V§);
         param1.§=!W§.§0!=§();
         param1.§>!=§ = 1;
         param1.§&!4§[0].m_localPoint.SetV(param4.§7V§);
         param1.§&!4§[0].m_id.key = 0;
      }
      
      public static function § else§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§6x§ + param4.§6x§;
         var _loc21_:int = param2.§-A§;
         var _loc22_:Vector.<b2Vec2> = param2.§`!M§;
         var _loc23_:Vector.<b2Vec2> = param2.§%!b§;
         var _loc24_:int = 0;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§>!=§ = 1;
            param1.§'A§ = b2Manifold.§8?§;
            param1.§=!W§.x = _loc15_ - _loc27_.x;
            param1.§=!W§.y = _loc16_ - _loc27_.y;
            param1.§=!W§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§>!=§ = 1;
            param1.§'A§ = b2Manifold.§8?§;
            param1.§=!W§.x = _loc15_ - _loc28_.x;
            param1.§=!W§.y = _loc16_ - _loc28_.y;
            param1.§=!W§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§&!4§[0].m_localPoint.SetV(param4.§7V§);
            param1.§&!4§[0].m_id.key = 0;
      ...
      public static function §!!D§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§3-§;
         var _loc4_:b2Vec2 = param1.§]s§;
