package §<"§
{
   ...
   public class b2DynamicTree
   {
      ...
      private var §]!F§:b2DynamicTreeNode;
      ...
      public function §-0§(param1:b2DynamicTreeNode) : void
      {
         this.§>q§(param1);
         this.§#N§(param1);
      }
      
      public function § f§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         var _loc4_:Number = NaN;
         var _loc5_:Number = NaN;
         b2Settings.b2Assert(param1.§-!K§());
      ...
      public function §6z§(param1:b2DynamicTreeNode) : b2AABB
      {
         return param1.aabb;
      }
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§case §(1,_loc5_);
         var _loc7_:b2Vec2 = b2Math.§<2§(_loc6_);
         ...
         _loc9_.§]s§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§]s§.y = Math.max(_loc3_.y,_loc11_);
      ...
      private function §class§() : b2DynamicTreeNode
      {
         var _loc1_:b2DynamicTreeNode = null;
         if(this.§]!F§)
         {
            _loc1_ = this.§]!F§;
            this.§]!F§ = _loc1_.parent;
            _loc1_.parent = null;
            _loc1_.child1 = null;
            _loc1_.child2 = null;
            return _loc1_;
      ...
      private function §3#§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_.§-!K§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§3-§.x + _loc6_.aabb.§]s§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§3-§.y + _loc6_.aabb.§]s§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§3-§.x + _loc7_.aabb.§]s§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§3-§.y + _loc7_.aabb.§]s§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         (_loc5_ = this.§class§()).parent = _loc4_;
         _loc5_.§3q§ = null;
         _loc5_.aabb.§ true§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            {
               _loc4_.aabb.§ true§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
      ...
      private function §>q§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc5_ = _loc3_.aabb;
               _loc3_.aabb = b2AABB.§ true§(_loc3_.child1.aabb,_loc3_.child2.aabb);
