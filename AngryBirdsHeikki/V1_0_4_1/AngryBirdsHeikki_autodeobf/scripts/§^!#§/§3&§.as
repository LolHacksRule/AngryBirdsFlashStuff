package §^!#§
{
   ...
   public class §3&§
   {
      ...
      private static function §4!K§(param1:*) : *
      {
         var _loc2_:* = null;
      ...
      private static function §catch§(param1:String) : Boolean
      {
      ...
      public static function §1!%§(param1:Object) : Object
      {
