package §=i§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§]h§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §7l§(param1:Number) : Boolean
      {
      ...
      public static function §9H§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §case §(param1:Number, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return new b2Vec2(§=8§(param2,param1.col1),§=8§(param2,param1.col2));
      }
      ...
      public static function §in§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
      ...
      public static function §=q§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §4d§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         var _loc3_:Number = param1.x - param2.x;
         var _loc4_:Number = param1.y - param2.y;
      ...
      public static function §6T§(param1:Number, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1 * param2.x,param1 * param2.y);
      }
      
      public static function §+!F§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§]h§(§+!7§(param1.col1,param2.col1),§+!7§(param1.col2,param2.col2));
      }
      
      public static function §8^§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§]h§(§^!<§(param1,param2.col1),§^!<§(param1,param2.col2));
      }
      
      public static function §1!#§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§=8§(param1.col1,param2.col1),§=8§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§=8§(param1.col1,param2.col2),§=8§(param1.col2,param2.col2));
         return b2Mat22.§]h§(_loc3_,_loc4_);
      }
      ...
      public static function §<2§(param1:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§]3§(param1.x),§]3§(param1.y));
      }
      
      public static function §`!T§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§]h§(§<2§(param1.col1),§<2§(param1.col2));
      }
      ...
      public static function §3y§(param1:Number, param2:Number) : Number
      {
         return param1 > param2 ? Number(param1) : Number(param2);
      }
      ...
      {
         return new b2Vec2(§3y§(param1.x,param2.x),§3y§(param1.y,param2.y));
      }
      ...
      public static function §7T§() : Number
      {
         return Math.random() * 2 - 1;
      }
      
      public static function §9h§(param1:Number, param2:Number) : Number
      {
         var _loc3_:Number = Math.random();
         return Number((param2 - param1) * _loc3_ + param1);
      }
      
      public static function §2Y§(param1:uint) : uint
      {
      ...
      public static function §5!3§(param1:uint) : Boolean
      {
