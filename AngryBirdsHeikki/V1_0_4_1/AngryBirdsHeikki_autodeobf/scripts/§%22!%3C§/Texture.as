package §"!<§
{
   ...
   public class Texture
   {
      ...
      public static function §93§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §"!<§.Texture
      {
      ...
      public static function §=!@§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §"!<§.Texture
      {
         ...
         return new §<!G§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      ...
      public static function §#u§(param1:§"!<§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §"!<§.Texture
      {
         var _loc4_:§"!<§.Texture;
      ...
      public static function §1G§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §"!<§.Texture
      {
      ...
      public function adjustVertexData(param1:§1!2§, param2:int, param3:int) : void
      {
         ...
         if(this.§];§)
         {
            ...
            param1.§ m§(param2,-this.§];§.x,-this.§];§.y);
            param1.§ m§(param2 + 1,-_loc4_,-this.§];§.y);
            param1.§ m§(param2 + 2,-this.§];§.x,-_loc5_);
