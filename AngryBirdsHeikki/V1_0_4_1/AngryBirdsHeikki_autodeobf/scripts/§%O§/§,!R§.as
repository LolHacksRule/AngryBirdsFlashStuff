package §%O§
{
   ...
   public class §,!R§
   {
      ...
      private static const §9q§:String = "sprite";
      ...
      public static function §!"§(param1:String, param2:§ !§, param3:Boolean = true) : §<!-§.Sprite
      {
         ...
         var _loc6_:XMLList = _loc4_.child(§9q§);
         for each(_loc7_ in _loc6_)
         {
            if(_loc8_ = param2.§^!3§(_loc7_.@name))
            {
               _loc9_ = new §^B§(_loc8_.texture,false,param3);
      ...
      public static function §9!1§(param1:String, param2:§ !§) : flash.display.Sprite
      {
         var _loc6_:XML = null;
         var _loc7_:§=I§ = null;
         ...
         var _loc4_:XML;
         var _loc5_:XMLList = (_loc4_ = §9!>§[param1]).child(§9q§);
