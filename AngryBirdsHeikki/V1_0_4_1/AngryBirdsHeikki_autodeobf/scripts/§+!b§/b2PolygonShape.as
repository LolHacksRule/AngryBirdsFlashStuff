package §+!b§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      public function b2PolygonShape()
      {
         ...
         §6x§ = b2Settings.b2_polygonRadius;
         this.§0'§.§0!=§();
      }
      
      public static function §4O§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function §9g§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §@d§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§2!L§(param1,param2,param3,param4);
         return _loc5_;
      }
      ...
      public static function §#e§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
      ...
      b2internal static function §?!X§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§[!X§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§[!X§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §"a§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§-A§)
         {
            this.§`!M§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§-A§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§-A§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§]G§(this.§`!M§[_loc5_],this.§`!M§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§5!P§() > Number.MIN_VALUE);
            this.§%!b§[_loc3_].SetV(b2Math.§3>§(_loc6_,1));
            this.§%!b§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§0'§ = §#e§(this.§`!M§,this.§-A§);
      }
      ...
      public function §+c§(param1:Number, param2:Number) : void
      {
         this.§-A§ = 4;
         this.§5X§(4);
         this.§`!M§[0].Set(-param1,-param2);
         this.§`!M§[1].Set(param1,-param2);
         this.§`!M§[2].Set(param1,param2);
         this.§`!M§[3].Set(-param1,param2);
         this.§%!b§[0].Set(0,-1);
         this.§%!b§[1].Set(1,0);
         this.§%!b§[2].Set(0,1);
         this.§%!b§[3].Set(-1,0);
      ...
      public function §2!L§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§-A§ = 4;
         this.§5X§(4);
         this.§`!M§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§-A§)
         {
            this.§`!M§[_loc6_] = b2Math.§]x§(_loc5_,this.§`!M§[_loc6_]);
            this.§%!b§[_loc6_] = b2Math.§^!<§(_loc5_.R,this.§%!b§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §;4§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§-A§ = 2;
         this.§5X§(2);
         this.§`!M§[0].SetV(param1);
         this.§`!M§[1].SetV(param2);
         this.§0'§.x = 0.5 * (param1.x + param2.x);
         this.§0'§.y = 0.5 * (param1.y + param2.y);
         this.§%!b§[0] = b2Math.§3>§(b2Math.§]G§(param2,param1),1);
         this.§%!b§[0].Normalize();
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§-A§)
         {
            _loc6_ = (_loc9_ = this.§`!M§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§3-§.x = _loc5_ - b2internal::6x;
         param1.§3-§.y = _loc6_ - b2internal::6x;
         param1.§]s§.x = _loc7_ + b2internal::6x;
         param1.§]s§.y = _loc8_ + b2internal::6x;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§-A§ == 2)
         {
            param1.center.x = 0.5 * (this.§`!M§[0].x + this.§`!M§[1].x);
            param1.center.y = 0.5 * (this.§`!M§[0].y + this.§`!M§[1].y);
            param1.§@!_§ = 0;
            param1.§`§ = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§-A§)
         {
            _loc11_ = this.§`!M§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§-A§ ? this.§`!M§[int(_loc10_ + 1)] : this.§`!M§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         {
            _loc7_[_loc12_] = b2Math.§=8§(_loc5_,this.§`!M§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§]x§(param3,_loc24_.center));
                  return _loc24_.§@!_§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§-A§;
         var _loc14_:int = (_loc10_ + 1) % this.§-A§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§`!M§[_loc9_].x * (1 - _loc15_) + this.§`!M§[_loc13_].x * _loc15_,this.§`!M§[_loc9_].y * (1 - _loc15_) + this.§`!M§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§`!M§[_loc10_].x * (1 - _loc16_) + this.§`!M§[_loc14_].x * _loc16_,this.§`!M§[_loc10_].y * (1 - _loc16_) + this.§`!M§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§`!M§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§-A§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§`!M§[_loc12_];
            }
         ...
         _loc20_.§[![§(1 / _loc19_);
         param4.SetV(b2Math.§]x§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §&!R§(param1:b2Vec2) : int
      {
