package §+!b§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§;1§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§9M§ = this.§;1§.Normalize();
         this.§?L§.Set(this.§;1§.y,-this.§;1§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§?L§.x - this.§;1§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§?L§.y - this.§;1§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§?L§.x + this.§;1§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§?L§.y + this.§;1§.y) + this.m_v2.y);
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§]x§(param3,this.m_v1);
         var _loc7_:b2Vec2 = b2Math.§]x§(param3,this.m_v2);
         var _loc8_:Number = b2Math.§=8§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§=8§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §5f§() : b2Vec2
      {
         return this.§?L§;
      }
      
      public function §8W§() : b2Vec2
      {
         return this.§;1§;
      }
      ...
      public function §[h§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §1!Z§() : b2EdgeShape
      {
         return this.§9D§;
      }
      ...
      b2internal function §;!O§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§9D§ = param1;
      ...
      b2internal function §4I§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§`g§ = param1;
