package §;!F§
{
   ...
   public class §1!2§
   {
      ...
      public function §1!2§(param1:int, param2:Boolean = false)
      {
         this.§^!^§ = new Vector.<Number>(12,true);
         super();
         this.§#!J§ = new ByteArray();
         this.§#!J§.endian = Endian.LITTLE_ENDIAN;
         this.§#!J§.length = param1 * §8!6§ * § !G§;
         var _loc3_:int = 0;
         while(_loc3_ < param1 * §8!6§)
         {
            this.§#!J§.writeFloat(0);
            _loc3_++;
         }
         this.§?!^§ = new Vector.<Number>(param1 * §65§,true);
         this.§`,§ = new Vector.<Number>(param1 * §'^§,true);
         this.§-!'§ = param2;
         this.§7!P§ = param1;
      }
      
      public function clone() : §1!2§
      {
         var _loc1_:§1!2§ = new §1!2§(0,this.§-!'§);
         _loc1_.§#!J§.length = this.§#!J§.length;
         _loc1_.§#!J§.writeBytes(this.§#!J§);
         _loc1_.§?!^§ = this.§?!^§.concat();
         _loc1_.§?!^§.fixed = true;
         _loc1_.§`,§ = this.§`,§.concat();
         _loc1_.§`,§.fixed = true;
      ...
      public function copyTo(param1:§1!2§, param2:int, param3:Number, param4:Boolean, param5:Matrix3D) : void
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         ...
         var _loc10_:ByteArray = param1.§#!J§;
         _loc6_ = this.§7!P§ * §8!6§ * § !G§;
         _loc7_ = param2 * §8!6§ * § !G§;
      ...
      public function append(param1:§1!2§) : void
      {
         var _loc2_:int = this.§#!J§.length;
         this.§#!J§.length += param1.§#!J§.length;
         this.§#!J§.position = _loc2_;
         this.§#!J§.writeBytes(param1.§#!J§);
         this.§?!^§.fixed = false;
      ...
      public function §+!D§(param1:int, param2:Vector3D) : void
      {
      ...
      public function §+`§(param1:int, param2:uint, param3:Number = 1.0) : void
      {
         ...
         var _loc5_:Number = §?`§.§2&§(param2) * _loc4_;
      ...
      private function §<Z§(param1:int, param2:Number) : void
      {
         var _loc3_:int = param1 * §65§;
         var _loc4_:*;
      ...
      public function §'!4§(param1:int, param2:Number) : void
      {
         ...
         if(this.§-!'§)
         {
            this.§+`§(param1,this.§#!Q§(param1),param2);
         }
         else
         {
            _loc3_ = param1 * §65§ + 3;
      ...
      public function §2?§(param1:int) : Number
      {
         var _loc2_:int = param1 * §65§ + 3;
         return this.§?!^§[_loc2_];
      }
      ...
      public function setTexCoords(param1:int, param2:Number, param3:Number) : void
      {
         ...
         this.§#!J§.position = _loc4_ * § !G§;
         this.§#!J§.writeFloat(param2);
         this.§#!J§.writeFloat(param3);
      }
      
      public function getTexCoords(param1:int, param2:Point) : void
      {
         var _loc3_:int = param1 * §8!6§;
         this.§#!J§.position = _loc3_ * § !G§;
         param2.x = this.§#!J§.readFloat();
         param2.y = this.§#!J§.readFloat();
      }
      ...
      public function §!!M§(param1:uint, param2:Number = 1.0) : void
      {
         ...
         _loc3_ /= 255;
         var _loc4_:Number = §?`§.§2&§(param1) * _loc3_;
         var _loc5_:Number = §?`§.§^f§(param1) * _loc3_;
         var _loc6_:Number = §?`§.§=!§(param1) * _loc3_;
         this.§[?§(0,this.§7!P§,_loc4_,_loc5_,_loc6_,param2);
      }
      
      public function §09§(param1:int, param2:int, param3:Number, param4:Number, param5:Number, param6:Number = 1.0) : void
      {
         if(param6 < 0.001)
         {
            param6 = 0.001;
      ...
      public function set §=C§(param1:int) : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         _loc2_ = param1 * §8!6§ * § !G§ - this.§#!J§.length;
         _loc4_ = this.§#!J§.length;
         this.§#!J§.length += _loc2_;
         if(_loc2_ > 0)
         {
            this.§#!J§.position = _loc4_;
            _loc3_ = 0;
      ...
      public function get §0!K§() : Vector.<Number>
      {
         return this.§?!^§;
      }
      
      public function get §#A§() : Vector.<Number>
      {
         return this.§`,§;
      }
   }
