package §4!9§
{
   ...
   public class §3B§
   {
      ...
      public static function §2!O§(param1:DisplayObject) : ByteArray
      {
      ...
      public static function §#U§(param1:DisplayObject, param2:Number) : ByteArray
      {
         ...
         var _loc4_:§"!V§;
         return (_loc4_ = new §"!V§(param2)).encode(_loc3_);
      }
      ...
      public static function §+-§(param1:String, param2:Function) : void
      {
         ...
         var _loc4_:ByteArray = Base64.§7!1§(param1);
         §3W§(_loc4_,param2);
      }
      
      public static function §3W§(param1:ByteArray, param2:Function) : void
      {
