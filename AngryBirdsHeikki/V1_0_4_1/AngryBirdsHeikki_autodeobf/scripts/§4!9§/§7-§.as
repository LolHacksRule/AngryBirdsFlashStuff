package §4!9§
{
   public class §7-§
   {
      ...
      public static function § z§(param1:String, param2:Boolean = false) : Object
      {
         ...
         param1 = §6!b§(param1,param2);
         return JSON.parse(param1);
      }
      
      private static function §6!b§(param1:String, param2:Boolean) : String
      {
