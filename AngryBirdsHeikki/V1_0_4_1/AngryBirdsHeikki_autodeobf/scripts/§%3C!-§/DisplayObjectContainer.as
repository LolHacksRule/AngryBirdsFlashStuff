package §<!-§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function DisplayObjectContainer()
      {
         ...
         this.§>!U§ = new Vector.<DisplayObject>(0);
      }
      
      override public function dispose() : void
      {
         var _loc1_:int = this.§>!U§.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      public function §9s§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      public function §;!K§(param1:int, param2:int) : void
      {
         var _loc3_:DisplayObject = this.getChildAt(param1);
         var _loc4_:DisplayObject = this.getChildAt(param2);
         this.§>!U§[param1] = _loc4_;
         this.§>!U§[param2] = _loc3_;
      }
      
      public function §1m§(param1:Function) : void
      {
         this.§>!U§ = this.§>!U§.sort(param1);
      }
      ...
      public function contains(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.§>!U§[_loc3_]) as DisplayObjectContainer) && _loc5_.contains(param1))
            {
               return true;
            }
            if(_loc4_ == param1)
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc3_:int = this.§>!U§.length;
         if(_loc3_ == 0)
         {
            §^!V§(param1,§ c§);
            transformCoords(§ c§,0,0,§8Q§);
            param2.x = §8Q§.x;
            param2.y = §8Q§.y;
            param2.height = 0;
            param2.width = 0;
         ...
         if(_loc3_ == 1)
         {
            return this.§>!U§[0].getBounds(param1,param2);
         }
         ...
         while(_loc8_ < _loc3_)
         {
            this.§>!U§[_loc8_].getBounds(param1,param2);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = this.§>!U§.length) - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§>!U§[_loc6_];
            §^!V§(_loc7_,§ c§);
            transformCoords(§ c§,_loc3_,_loc4_,§8Q§);
            if(_loc8_ = _loc7_.hitTest(§8Q§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override public function render(param1:§;P§, param2:Number) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = this.§>!U§[_loc4_]).alpha != 0 && _loc5_.visible && _loc5_.scaleX != 0 && _loc5_.scaleY != 0)
            {
               param1.§ !U§();
               param1.§=J§(_loc5_);
