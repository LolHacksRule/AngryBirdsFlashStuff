package §+$§
{
   ...
   public class §>!W§
   {
      ...
      public static const §3!8§:String = "SWFWheel.getState";
      ...
      public static function initialize(param1:Stage) : void
      {
         ...
         §";§ = ExternalInterface.call(§3!8§,ExternalInterface.objectID);
         if(§";§ == §,j§)
         {
            return;
         }
      ...
      private static function triggerMouseEvent(param1:Number, param2:Boolean, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc5_:Array;
         var _loc6_:DisplayObject = (_loc5_ = §81§.getObjectsUnderPoint(new Point(§81§.mouseX,§81§.mouseY))).pop() as DisplayObject;
         while(_loc6_ != null)
         {
