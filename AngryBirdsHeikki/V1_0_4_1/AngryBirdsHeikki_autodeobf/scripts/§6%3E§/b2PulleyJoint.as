package §6>§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§-!^§ = b2internal::+!N.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§9!^§.x - this.§-!^§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§9!^§.y - this.§-!^§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§6c§.x - this.§-!^§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§6c§.y - this.§-!^§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§ i§);
         this.m_localAnchor2.SetV(param1.§<=§);
         this.§>d§ = param1.§+!_§;
         this.§5n§ = param1.§@i§ + this.§>d§ * param1.§6F§;
         this.m_maxLength1 = b2Math.§,S§(param1.§;!L§,this.§5n§ - this.§>d§ * b2internal::@$);
         this.m_maxLength2 = b2Math.§,S§(param1.§"!G§,(this.§5n§ - b2internal::@$) / this.§>d§);
         this.§=!3§ = 0;
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc18_:Number = this.m_u1.§4§();
         var _loc19_:Number = this.m_u2.§4§();
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§5n§ - _loc18_ - this.§>d§ * _loc19_) > 0)
         {
            this.§`!"§ = b2internal::;W;
            this.§=!3§ = 0;
         }
         ...
         this.m_limitMass1 = _loc2_.§=!C§ + _loc2_.§!!§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§=!C§ + _loc3_.§!!§ * _loc22_ * _loc22_;
         this.§,!M§ = this.m_limitMass1 + this.§>d§ * this.§>d§ * this.m_limitMass2;
         ...
         if(param1.§%r§)
         {
            ...
            _loc25_ = (-this.§>d§ * this.§=!3§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§>d§ * this.§=!3§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§]J§.x += _loc2_.§=!C§ * _loc23_;
            _loc2_.§]J§.y += _loc2_.§=!C§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§!!§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§]J§.x += _loc3_.§=!C§ * _loc25_;
            _loc3_.§]J§.y += _loc3_.§=!C§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§`!"§ == b2internal::&![)
         {
            _loc10_ = _loc2_.§]J§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§]J§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§]J§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§]J§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§>d§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§,!M§ * -_loc18_;
            _loc20_ = this.§=!3§;
            this.§=!3§ = b2Math.§3y§(0,this.§=!3§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§=!3§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§>d§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§>d§ * _loc19_ * this.m_u2.y;
            _loc2_.§]J§.x += _loc2_.§=!C§ * _loc14_;
            _loc2_.§]J§.y += _loc2_.§=!C§ * _loc15_;
         ...
         if(this.m_limitState1 == b2internal::&![)
         {
            ...
            this.m_limitImpulse1 = b2Math.§3y§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == b2internal::&![)
         {
            ...
            this.m_limitImpulse2 = b2Math.§3y§(0,this.m_limitImpulse2 + _loc19_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§`!"§ == b2internal::&![)
         {
            ...
            _loc19_ = this.§5n§ - _loc17_ - this.§>d§ * _loc18_;
            _loc24_ = b2Math.§3y§(_loc24_,-_loc19_);
            ...
            _loc15_ = -this.§>d§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§>d§ * _loc20_ * this.m_u2.y;
         ...
         if(this.m_limitState1 == b2internal::&![)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§4§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::&![)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§4§()) > b2Settings.b2_linearSlop)
            {
