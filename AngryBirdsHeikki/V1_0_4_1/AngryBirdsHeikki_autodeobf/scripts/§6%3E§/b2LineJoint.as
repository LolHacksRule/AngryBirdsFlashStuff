package §6>§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§=!3§.x * this.§,!+§.x + (this.§[K§ + this.§=!3§.y) * this.§]§.x),param1 * (this.§=!3§.x * this.§,!+§.y + (this.§[K§ + this.§=!3§.y) * this.§]§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§06§ = this.§06§ > Number.MIN_VALUE ? Number(1 / this.§06§) : Number(0);
         ...
         this.§+Z§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§+Z§.col2.x = this.§+Z§.col1.y;
         this.§+Z§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§,?§)
         {
         ...
         if(param1.§%r§)
         {
            ...
            this.§=!3§.y *= param1.§^!Y§;
            this.§[K§ *= param1.§^!Y§;
            _loc19_ = this.§=!3§.x * this.§,!+§.x + (this.§[K§ + this.§=!3§.y) * this.§]§.x;
            _loc20_ = this.§=!3§.x * this.§,!+§.y + (this.§[K§ + this.§=!3§.y) * this.§]§.y;
            _loc21_ = this.§=!3§.x * this.m_s1 + (this.§[K§ + this.§=!3§.y) * this.m_a1;
            _loc22_ = this.§=!3§.x * this.m_s2 + (this.§[K§ + this.§=!3§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§6!U§ && this.§6'§ != b2internal::`!1)
         {
            ...
            _loc14_ = this.§06§ * (this.§'!&§ - _loc13_);
            _loc15_ = this.§[K§;
            _loc16_ = param1.§5!8§ * this.§-p§;
            this.§[K§ = b2Math.§%!c§(this.§[K§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§[K§ - _loc15_) * this.§]§.x;
         ...
         if(this.§,?§ && this.§6'§ != b2internal::;W)
         {
            ...
            _loc18_ = this.§=!3§.Copy();
            _loc19_ = this.§+Z§.§6!W§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§=!3§.§%<§(_loc19_);
            if(this.§6'§ == b2internal::8!O)
            {
               this.§=!3§.y = b2Math.§3y§(this.§=!3§.y,0);
            }
            else if(this.§6'§ == b2internal::&![)
            {
               this.§=!3§.y = b2Math.§,S§(this.§=!3§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§=!3§.y - _loc18_.y) * this.§+Z§.col2.x;
            if(this.§+Z§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§+Z§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§,?§)
         {
            ...
            {
               _loc19_ = b2Math.§%!c§(_loc34_ - this.§5!,§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§+Z§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§+Z§.col2.x = this.§+Z§.col1.y;
            this.§+Z§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§+Z§.§6!W§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::@W;
         ...
         _loc6_.x -= b2internal::@W * _loc30_;
         _loc6_.y -= b2internal::@W * _loc31_;
         _loc7_ -= b2internal::"!D * _loc32_;
         _loc8_.x += b2internal::01 * _loc30_;
         _loc8_.y += b2internal::01 * _loc31_;
         _loc9_ += b2internal::`!J * _loc33_;
