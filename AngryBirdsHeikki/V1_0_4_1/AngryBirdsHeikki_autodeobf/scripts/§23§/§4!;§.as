package §23§
{
   ...
   public class §4!;§
   {
      ...
      public static function §@!8§(param1:String) : String
      {
         ...
         return §9J§.§"§(_loc3_.readInt(),true) + §9J§.§"§(_loc3_.readInt(),true) + §9J§.§"§(_loc3_.readInt(),true) + §9J§.§"§(_loc3_.readInt(),true) + §9J§.§"§(_loc3_.readInt(),true);
      }
      
      public static function §3r§(param1:ByteArray) : String
      {
