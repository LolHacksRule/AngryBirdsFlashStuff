package §=_§
{
   ...
   public class b2PolyAndCircleContact extends b2Contact
   {
      ...
      public function §=s§(param1:b2Fixture, param2:b2Fixture) : void
      {
         ...
         b2Settings.b2Assert(param2.§6+§() == b2Shape.§2T§);
      }
      ...
      override b2internal function Evaluate() : void
      {
         ...
         b2Collision.§%!A§(b2internal::%`,b2internal::"!V.GetShape() as b2PolygonShape,_loc1_.m_xf,b2internal::[!.GetShape() as b2CircleShape,_loc2_.m_xf);
      }
   }
}
