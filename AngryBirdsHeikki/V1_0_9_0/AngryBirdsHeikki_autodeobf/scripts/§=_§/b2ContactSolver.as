package §=_§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §26§:b2WorldManifold = new b2WorldManifold();
      
      private static var §]!6§:b2PositionSolverManifold = new b2PositionSolverManifold();
       
      
      private var §3u§:b2TimeStep;
      ...
      {
         this.§3u§ = new b2TimeStep();
         this.§=4§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §8_§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            _loc17_ = _loc5_.§2!I§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§`!B§(),_loc10_.§`!B§());
            ...
            b2Settings.b2Assert(_loc17_.§ use§ > 0);
            §26§.§8_§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §26§.§"'§.x;
            _loc27_ = §26§.§"'§.y;
            (_loc28_ = this.§=4§[_loc6_]).§[!N§ = _loc15_;
            _loc28_.§0!'§ = _loc16_;
            _loc28_.§@5§ = _loc17_;
            _loc28_.normal.x = _loc26_;
            _loc28_.normal.y = _loc27_;
            _loc28_.§use§ = _loc17_.§ use§;
            ...
            _loc28_.type = _loc17_.§3!a§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§use§)
            {
               _loc30_ = _loc17_.§]!G§[_loc29_];
               (_loc31_ = _loc28_.§]i§[_loc29_]).normalImpulse = _loc30_.§,!F§;
               _loc31_.tangentImpulse = _loc30_.§>!4§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§6X§.x = §26§.§]!G§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§6X§.y = §26§.§]!G§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§7!%§.x = §26§.§]!G§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§7!%§.y = §26§.§]!G§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§1!+§ + _loc16_.§1!+§ + _loc15_.§-!f§ * _loc36_ + _loc16_.§-!f§ * _loc37_;
               _loc31_.§]! § = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§6H§ * _loc15_.§1!+§ + _loc16_.§6H§ * _loc16_.§1!+§) + (_loc15_.§6H§ * _loc15_.§-!f§ * _loc36_ + _loc16_.§6H§ * _loc16_.§-!f§ * _loc37_);
               _loc31_.§#!d§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§1!+§ + _loc16_.§1!+§ + _loc15_.§-!f§ * _loc42_ + _loc16_.§-!f§ * _loc43_;
               _loc31_.§]![§ = 1 / _loc44_;
               _loc31_.§ !"§ = 0;
            ...
            if(_loc28_.§use§ == 2)
            {
               ...
               _loc52_ = _loc16_.§1!+§;
               _loc53_ = _loc16_.§-!f§;
               _loc54_ = _loc48_.§6X§.x * _loc27_ - _loc48_.§6X§.y * _loc26_;
               _loc55_ = _loc48_.§7!%§.x * _loc27_ - _loc48_.§7!%§.y * _loc26_;
               _loc56_ = _loc49_.§6X§.x * _loc27_ - _loc49_.§6X§.y * _loc26_;
               _loc57_ = _loc49_.§7!%§.x * _loc27_ - _loc49_.§7!%§.y * _loc26_;
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.§8I§)
         {
            _loc7_ = (_loc6_ = this.§=4§[_loc5_]).§[!N§;
            _loc8_ = _loc6_.§0!'§;
            _loc9_ = _loc7_.§1!+§;
            _loc10_ = _loc7_.§-!f§;
            _loc11_ = _loc8_.§1!+§;
            ...
            if(param1.§9!N§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc20_.normalImpulse *= param1.§>x§;
                  _loc20_.tangentImpulse *= param1.§>x§;
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§6X§.x * _loc22_ - _loc20_.§6X§.y * _loc21_);
                  _loc7_.§@!1§.x -= _loc9_ * _loc21_;
                  _loc7_.§@!1§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§7!%§.x * _loc22_ - _loc20_.§7!%§.y * _loc21_);
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§8I§)
         {
            _loc26_ = (_loc25_ = this.§=4§[_loc24_]).§[!N§;
            _loc27_ = _loc25_.§0!'§;
            ...
            _loc1_ = 0;
            while(_loc1_ < _loc25_.§use§)
            {
               _loc2_ = _loc25_.§]i§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§7!%§.y - _loc30_.x + _loc28_ * _loc2_.§6X§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§7!%§.x - _loc30_.y - _loc28_ * _loc2_.§6X§.x;
               ...
               _loc28_ -= _loc33_ * (_loc2_.§6X§.x * _loc15_ - _loc2_.§6X§.y * _loc14_);
               _loc31_.x += _loc34_ * _loc14_;
               _loc31_.y += _loc34_ * _loc15_;
               _loc29_ += _loc35_ * (_loc2_.§7!%§.x * _loc15_ - _loc2_.§7!%§.y * _loc14_);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§7!%§.y - _loc30_.x + _loc28_ * _loc43_.§6X§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§7!%§.x - _loc30_.y - _loc28_ * _loc43_.§6X§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§7!%§.y - _loc30_.x + _loc28_ * _loc44_.§6X§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§7!%§.x - _loc30_.y - _loc28_ * _loc44_.§6X§.x;
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§6X§.x * _loc19_ - _loc43_.§6X§.y * _loc18_ + _loc44_.§6X§.x * _loc21_ - _loc44_.§6X§.y * _loc20_);
                  _loc31_.x += _loc34_ * (_loc18_ + _loc20_);
                  _loc31_.y += _loc34_ * (_loc19_ + _loc21_);
                  _loc29_ += _loc35_ * (_loc43_.§7!%§.x * _loc19_ - _loc43_.§7!%§.y * _loc18_ + _loc44_.§7!%§.x * _loc21_ - _loc44_.§7!%§.y * _loc20_);
      ...
      public function §[!L§() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.§8I§)
         {
            _loc2_ = this.§=4§[_loc1_];
            _loc3_ = _loc2_.§@5§;
            _loc4_ = 0;
            while(_loc4_ < _loc2_.§use§)
            {
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:Number = 0;
         var _loc3_:int = 0;
         while(_loc3_ < this.§8I§)
         {
            _loc5_ = (_loc4_ = this.§=4§[_loc3_]).§[!N§;
            _loc6_ = _loc4_.§0!'§;
            _loc7_ = _loc5_.§6H§ * _loc5_.§1!+§;
            _loc8_ = _loc5_.§6H§ * _loc5_.§-!f§;
            _loc9_ = _loc6_.§6H§ * _loc6_.§1!+§;
            _loc10_ = _loc6_.§6H§ * _loc6_.§-!f§;
            §]!6§.§8_§(_loc4_);
            _loc11_ = §]!6§.§"'§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§use§)
            {
               ...
               _loc22_ = (_loc21_ = -_loc13_.§#!d§ * _loc20_) * _loc11_.x;
