package § 0§
{
   ...
   public class Texture
   {
      ...
      public static function §&!W§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : § 0§.Texture
      {
         return §2!K§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §2!K§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : § 0§.Texture
      {
         ...
         _loc10_ = new §^!A§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§&!B§.§1!>§)
         {
            _loc10_.§!%§(param2);
         }
      ...
      public static function §'A§(param1:Context3D, param2:ByteArray) : § 0§.Texture
      {
         if(param1 == null)
         {
            throw new §#!J§();
         ...
         var _loc9_:§^!A§ = new §^!A§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§&!B§.§1!>§)
         {
            _loc9_.§!%§(param2);
         }
      ...
      public static function §+!K§(param1:§ 0§.Texture, param2:Rectangle = null, param3:Rectangle = null) : § 0§.Texture
      {
      ...
      public static function §,[§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : § 0§.Texture
      {
         ...
         var _loc7_:§ 0§.Texture = §2!K§(param1,_loc6_,false,param5);
         if(!§&!B§.§1!>§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§7!F§, param2:int, param3:int) : void
      {
         ...
         if(this.§<[§)
         {
            ...
            param1.§5!J§(param2,-this.§<[§.x,-this.§<[§.y);
            param1.§5!J§(param2 + 1,-_loc4_,-this.§<[§.y);
            param1.§5!J§(param2 + 2,-this.§<[§.x,-_loc5_);
            param1.§5!J§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      
      public function get §12§() : Rectangle
      {
