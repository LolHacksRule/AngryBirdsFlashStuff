package §#!f§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc3_ = this.§->§[param1];
            _loc3_.dispatchEvent(new Event(Event.§8H§,true));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§7!B§));
            }
            _loc3_.§3L§(null);
      ...
      public function §2V§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      public function §'§(param1:DisplayObject, param2:DisplayObject) : void
      {
         ...
         this.§0!9§(_loc3_,_loc4_);
      }
      
      public function §0!9§(param1:int, param2:int) : void
      {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§->§[_loc6_];
            §!c§(_loc7_,§8!;§);
            transformCoords(§8!;§,_loc3_,_loc4_,§#b§);
            if(_loc8_ = _loc7_.hitTest(§#b§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
