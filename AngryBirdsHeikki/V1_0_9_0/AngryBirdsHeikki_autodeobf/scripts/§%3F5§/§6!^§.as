package §?5§
{
   ...
   public class §6!^§
   {
      ...
      public static function §8o§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §>!Z§(_loc2_);
         return §8z§.§8!2§(_loc3_.readInt(),true) + §8z§.§8!2§(_loc3_.readInt(),true) + §8z§.§8!2§(_loc3_.readInt(),true) + §8z§.§8!2§(_loc3_.readInt(),true) + §8z§.§8!2§(_loc3_.readInt(),true);
      }
      
      public static function §[!F§(param1:ByteArray) : String
      {
         var _loc2_:Array = §6!^§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §>!Z§(_loc2_);
         return §8z§.§8!2§(_loc3_.readInt(),true) + §8z§.§8!2§(_loc3_.readInt(),true) + §8z§.§8!2§(_loc3_.readInt(),true) + §8z§.§8!2§(_loc3_.readInt(),true) + §8z§.§8!2§(_loc3_.readInt(),true);
      }
      
      public static function §3P§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §6!^§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §>!Z§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §>!Z§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
