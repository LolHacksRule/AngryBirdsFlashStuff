package § !_§
{
   public class b2Math
   {
      ...
      public static function §^!9§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§ h§(param2,param1.col1),§ h§(param2,param1.col2));
      }
      
      public static function §8!&§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         _loc3_ = §"!a§(param1.R,param2);
         _loc3_.x += param1.position.x;
         _loc3_.y += param1.position.y;
         return _loc3_;
      }
      
      public static function §<7§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
      ...
      public static function §9t§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      {
         return b2Mat22.§;!?§(§`t§(param1.col1,param2.col1),§`t§(param1.col2,param2.col2));
      }
      
      public static function §^!-§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§;!?§(§"!a§(param1,param2.col1),§"!a§(param1,param2.col2));
      }
      
      public static function §3!@§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§ h§(param1.col1,param2.col1),§ h§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§ h§(param1.col1,param2.col2),§ h§(param1.col2,param2.col2));
      ...
      public static function §!O§(param1:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§;!?§(§!O§(param1.col1),§!O§(param1.col2));
      }
      ...
      public static function §1!!§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §%%§(param2,§#d§(param1,param3));
      }
      ...
      public static function §29§(param1:uint) : Boolean
      {
