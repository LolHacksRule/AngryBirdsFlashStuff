package § !_§
{
   public class b2Vec2
   {
      ...
      public static function §0!&§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §6!C§(param1:b2Mat22) : void
      {
      ...
      public function §5F§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§ h§(this,param1.col1);
         this.y = b2Math.§ h§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      {
         return b2Math.§<!X§(this.x) && b2Math.§<!X§(this.y);
      }
   }
}
