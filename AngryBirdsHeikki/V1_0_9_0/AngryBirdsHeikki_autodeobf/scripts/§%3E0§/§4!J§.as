package §>0§
{
   ...
   public class §4!J§ extends §[!W§
   {
       
      
      public function §4!J§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§2D§(param1,param2);
      }
      
      protected function §2D§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
