package §>0§
{
   ...
   public class §0o§ extends §[!W§
   {
      ...
      public function §0o§(param1:Object, param2:BitmapData)
      {
         super(param2);
         this.§2D§(param1);
      }
         ...
         for(_loc3_ in param1)
         {
            if(_loc3_.indexOf("chars") == 0)
            {
               ...
               for(_loc5_ in _loc4_)
               {
                  ...
                  (_loc7_ = new §7"§()).mName = String.fromCharCode(_loc6_.code);
                  _loc7_.§#!_§ = new Rectangle(_loc6_.x,_loc6_.y,_loc6_.width,_loc6_.height);
