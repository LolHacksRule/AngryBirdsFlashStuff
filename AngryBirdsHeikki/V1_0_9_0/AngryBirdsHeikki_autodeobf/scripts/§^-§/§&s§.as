package §^-§
{
   ...
   public class §&s§
   {
      ...
      {
         §7!"§[§7!"§.length] = new §'!!§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13);
      }
      
      public static function §5d§(param1:String) : §'!!§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §7!"§.length)
         {
            if(§'!!§(§7!"§[_loc2_]).mName.toLowerCase() == param1.toLowerCase())
            {
               return §'!!§(§7!"§[_loc2_]);
            }
            _loc2_++;
         }
         §]_§.log("WARNING: LevelItemResourcePaths -> getResourcePathSound request has no return value, this path does not exist: " + param1);
         return null;
      }
   }
}
