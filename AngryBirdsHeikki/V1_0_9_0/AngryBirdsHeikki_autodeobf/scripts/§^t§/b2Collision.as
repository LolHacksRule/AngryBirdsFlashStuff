package §^t§
{
   ...
   public class b2Collision
   {
      ...
      private static var §]q§:Vector.<§^M§> = §48§();
      
      private static var s_clipPoints1:Vector.<§^M§> = §48§();
      
      private static var s_clipPoints2:Vector.<§^M§> = §48§();
      
      private static var §,!I§:Vector.<int> = new Vector.<int>(1);
      
      private static var §=V§:Vector.<int> = new Vector.<int>(1);
      
      private static var §9!=§:b2Vec2 = new b2Vec2();
      
      private static var §8!C§:b2Vec2 = new b2Vec2();
      
      private static var §1X§:b2Vec2 = new b2Vec2();
      ...
      public static function §-!%§(param1:Vector.<§^M§>, param2:Vector.<§^M§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§^M§ = null;
         var _loc6_:int = 0;
      ...
      public static function §7j§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §<!9§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §<!9§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §<!9§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §<!9§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function § o§(param1:Vector.<§^M§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         _loc20_.id.§;F§.§#B§ = param4;
         _loc20_.id.§;F§.§ 4§ = _loc21_;
         _loc20_.id.§;F§.§6!f§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§;F§.§#B§ = param4;
         _loc20_.id.§;F§.§ 4§ = _loc22_;
         _loc20_.id.§;F§.§6!f§ = 1;
      }
      
      private static function §48§() : Vector.<§^M§>
      {
      ...
      public static function §9!e§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§^M§ = null;
         ...
         param1.§ use§ = 0;
         var _loc7_:Number = param2.§?T§ + param4.§?T§;
         var _loc8_:int = 0;
         §,!I§[0] = _loc8_;
         var _loc9_:Number = §7j§(§,!I§,param2,param3,param4,param5);
         _loc8_ = §,!I§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §=V§[0] = _loc10_;
         var _loc11_:Number = §7j§(§=V§,param4,param5,param2,param3);
         _loc10_ = §=V§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§^M§> = §]q§;
         § o§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§!x§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§!!a§)[_loc16_];
         ...
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §8!C§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §1X§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §9!a§;
         _loc20_ = _loc14_.R;
      ...
      public static function §%V§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§?T§ + param4.§?T§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§3!a§ = b2Manifold.§ !A§;
         param1.m_localPoint.SetV(param2.§3!=§);
         param1.§@;§.§>!T§();
         param1.§ use§ = 1;
         param1.§]!G§[0].m_localPoint.SetV(param4.§3!=§);
         param1.§]!G§[0].m_id.key = 0;
      }
      
      public static function §%!A§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§?T§ + param4.§?T§;
         var _loc21_:int = param2.§!x§;
