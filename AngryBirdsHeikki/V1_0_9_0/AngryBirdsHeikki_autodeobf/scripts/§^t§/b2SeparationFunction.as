package §^t§
{
   ...
   class b2SeparationFunction
   {
      ...
      public var §9!K§:b2DistanceProxy;
      ...
      public function §8_§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§3!a§ = §8!T§;
            _loc7_ = this.§9!K§.§&^§(param1.indexA[0]);
            _loc10_ = this.§>Y§.§&^§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§8u§.x = _loc15_ - _loc13_;
            this.§8u§.y = _loc16_ - _loc14_;
            this.§8u§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§3!a§ = §&![§;
            _loc8_ = this.§9!K§.§&^§(param1.indexA[0]);
            _loc9_ = this.§9!K§.§&^§(param1.indexA[1]);
            _loc10_ = this.§>Y§.§&^§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§8u§ = b2Math.§@-§(b2Math.§=`§(_loc9_,_loc8_),1);
            this.§8u§.Normalize();
            _loc20_ = this.§8u§;
         ...
         {
            this.§3!a§ = §+!=§;
            _loc11_ = this.§>Y§.§&^§(param1.indexB[0]);
            _loc12_ = this.§>Y§.§&^§(param1.indexB[1]);
            _loc7_ = this.§9!K§.§&^§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§8u§ = b2Math.§@-§(b2Math.§=`§(_loc12_,_loc11_),1);
            this.§8u§.Normalize();
            _loc20_ = this.§8u§;
         ...
         else
         {
            ...
            _loc11_ = this.§>Y§.§&^§(param1.indexB[0]);
            _loc12_ = this.§>Y§.§&^§(param1.indexB[1]);
            _loc23_ = b2Math.§8!&§(param3,_loc7_);
            _loc24_ = b2Math.§"!a§(param3.R,b2Math.§=`§(_loc9_,_loc8_));
            _loc25_ = b2Math.§8!&§(param5,_loc10_);
            _loc26_ = b2Math.§"!a§(param5.R,b2Math.§=`§(_loc12_,_loc11_));
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §8!T§:
               _loc3_ = b2Math.§^!9§(param1.R,this.§8u§);
               _loc4_ = b2Math.§^!9§(param2.R,this.§8u§.§!K§());
               _loc5_ = this.§9!K§.§=O§(_loc3_);
               _loc6_ = this.§>Y§.§=O§(_loc4_);
               _loc7_ = b2Math.§8!&§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§8!&§(param2,_loc6_)).x - _loc7_.x) * this.§8u§.x + (_loc8_.y - _loc7_.y) * this.§8u§.y);
            case §&![§:
               _loc10_ = b2Math.§"!a§(param1.R,this.§8u§);
               _loc7_ = b2Math.§8!&§(param1,this.m_localPoint);
               _loc4_ = b2Math.§^!9§(param2.R,_loc10_.§!K§());
               _loc6_ = this.§>Y§.§=O§(_loc4_);
               return Number(((_loc8_ = b2Math.§8!&§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §+!=§:
               _loc10_ = b2Math.§"!a§(param2.R,this.§8u§);
               _loc8_ = b2Math.§8!&§(param2,this.m_localPoint);
               _loc3_ = b2Math.§^!9§(param1.R,_loc10_.§!K§());
               _loc5_ = this.§9!K§.§=O§(_loc3_);
               return Number(((_loc7_ = b2Math.§8!&§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
