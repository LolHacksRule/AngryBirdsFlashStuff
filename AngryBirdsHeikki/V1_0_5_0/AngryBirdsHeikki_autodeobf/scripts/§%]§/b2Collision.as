package §%]§
{
   ...
   public class b2Collision
   {
      ...
      private static var §@!3§:Vector.<§@!T§> = § U§();
      
      private static var s_clipPoints1:Vector.<§@!T§> = § U§();
      
      private static var s_clipPoints2:Vector.<§@!T§> = § U§();
      
      private static var §?!J§:Vector.<int> = new Vector.<int>(1);
      
      private static var §4I§:Vector.<int> = new Vector.<int>(1);
      ...
      private static var §5!K§:b2Vec2 = new b2Vec2();
      ...
      public static function §4q§(param1:Vector.<§@!T§>, param2:Vector.<§@!T§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§@!T§ = null;
         var _loc6_:int = 0;
      ...
      public static function §;s§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§1!T§;
         var _loc7_:Vector.<b2Vec2> = param1.§&1§;
         var _loc8_:Vector.<b2Vec2> = param1.§package§;
         var _loc9_:int = param4.§1!T§;
      ...
      public static function §'$§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§1!T§;
         var _loc7_:Vector.<b2Vec2> = param2.§package§;
         _loc9_ = param5.R;
         _loc8_ = param4.§^§;
         ...
         var _loc17_:Number = §;s§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §;s§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §;s§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §;s§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §5!Y§(param1:Vector.<§@!T§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§@!T§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§1!T§;
         var _loc8_:Vector.<b2Vec2> = param2.§package§;
         var _loc9_:int = param5.§1!T§;
         var _loc10_:Vector.<b2Vec2> = param5.§&1§;
         var _loc11_:Vector.<b2Vec2> = param5.§package§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§^3§.§0D§ = param4;
         _loc20_.id.§^3§.§ !b§ = _loc21_;
         _loc20_.id.§^3§.§]0§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§^3§.§0D§ = param4;
         _loc20_.id.§^3§.§ !b§ = _loc22_;
         _loc20_.id.§^3§.§]0§ = 1;
      }
      
      private static function § U§() : Vector.<§@!T§>
      {
      ...
      public static function §3!b§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§@!T§ = null;
         ...
         var _loc8_:int = 0;
         §?!J§[0] = _loc8_;
         var _loc9_:Number = §'$§(§?!J§,param2,param3,param4,param5);
         _loc8_ = §?!J§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §4I§[0] = _loc10_;
         var _loc11_:Number = §'$§(§4I§,param4,param5,param2,param3);
         _loc10_ = §4I§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§?S§ = b2Manifold.§&W§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§@!T§> = §@!3§;
         §5!Y§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§1!T§;
         ...
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §?a§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §?!V§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         ...
         if((_loc39_ = §4q§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §4q§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
      ...
      public static function §[M§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§4!?§.§#!d§();
         param1.§in § = 1;
         param1.§1N§[0].m_localPoint.SetV(param4.§]!I§);
         param1.§1N§[0].m_id.key = 0;
      }
      
      public static function each(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§1!T§;
         var _loc22_:Vector.<b2Vec2> = param2.§&1§;
         var _loc23_:Vector.<b2Vec2> = param2.§package§;
         var _loc24_:int = 0;
      ...
      public static function §#8§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§'H§;
         var _loc4_:b2Vec2 = param1.§@!X§;
