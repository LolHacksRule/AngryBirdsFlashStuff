package §%]§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §^!R§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§?S§ = §",§;
            _loc7_ = this.§18§.§8!K§(param1.indexA[0]);
            _loc10_ = this.§?!C§.§8!K§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§?S§ = §&W§;
            _loc8_ = this.§18§.§8!K§(param1.indexA[0]);
            _loc9_ = this.§18§.§8!K§(param1.indexA[1]);
            _loc10_ = this.§?!C§.§8!K§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§+!%§ = b2Math.§>@§(b2Math.§#!G§(_loc9_,_loc8_),1);
            this.§+!%§.Normalize();
            _loc20_ = this.§+!%§;
         ...
         {
            this.§?S§ = §&m§;
            _loc11_ = this.§?!C§.§8!K§(param1.indexB[0]);
            _loc12_ = this.§?!C§.§8!K§(param1.indexB[1]);
            _loc7_ = this.§18§.§8!K§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§+!%§ = b2Math.§>@§(b2Math.§#!G§(_loc12_,_loc11_),1);
            this.§+!%§.Normalize();
            _loc20_ = this.§+!%§;
         ...
         else
         {
            ...
            _loc11_ = this.§?!C§.§8!K§(param1.indexB[0]);
            _loc12_ = this.§?!C§.§8!K§(param1.indexB[1]);
            _loc23_ = b2Math.§8j§(param3,_loc7_);
            _loc24_ = b2Math.§8]§(param3.R,b2Math.§#!G§(_loc9_,_loc8_));
            _loc25_ = b2Math.§8j§(param5,_loc10_);
            _loc26_ = b2Math.§8]§(param5.R,b2Math.§#!G§(_loc12_,_loc11_));
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§8![§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§8![§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         switch(this.§?S§)
         {
            case §",§:
               ...
               _loc4_ = b2Math.§"![§(param2.R,this.§+!%§.§6! §());
               _loc5_ = this.§18§.§%d§(_loc3_);
               _loc6_ = this.§?!C§.§%d§(_loc4_);
               _loc7_ = b2Math.§8j§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§8j§(param2,_loc6_)).x - _loc7_.x) * this.§+!%§.x + (_loc8_.y - _loc7_.y) * this.§+!%§.y);
            case §&W§:
               _loc10_ = b2Math.§8]§(param1.R,this.§+!%§);
               _loc7_ = b2Math.§8j§(param1,this.m_localPoint);
               _loc4_ = b2Math.§"![§(param2.R,_loc10_.§6! §());
               _loc6_ = this.§?!C§.§%d§(_loc4_);
               return Number(((_loc8_ = b2Math.§8j§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §&m§:
               _loc10_ = b2Math.§8]§(param2.R,this.§+!%§);
               _loc8_ = b2Math.§8j§(param2,this.m_localPoint);
               _loc3_ = b2Math.§"![§(param1.R,_loc10_.§6! §());
               _loc5_ = this.§18§.§%d§(_loc3_);
               return Number(((_loc7_ = b2Math.§8j§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
