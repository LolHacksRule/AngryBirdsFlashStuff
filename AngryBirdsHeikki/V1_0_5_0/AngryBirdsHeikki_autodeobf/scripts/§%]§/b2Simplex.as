package §%]§
{
   ...
   class b2Simplex
   {
      ...
      public function § !_§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         while(_loc9_ < this.§`#§)
         {
            ...
            _loc6_ = param2.§8!K§(_loc10_.indexA);
            _loc7_ = param4.§8!K§(_loc10_.indexB);
            _loc10_.§+!E§ = b2Math.§8j§(param3,_loc6_);
            _loc10_.§"!0§ = b2Math.§8j§(param5,_loc7_);
            _loc10_.§9=§ = b2Math.§#!G§(_loc10_.§"!0§,_loc10_.§+!E§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§`#§ > 1)
      ...
      public function §]9§() : b2Vec2
      {
         ...
         {
            case 1:
               return this.m_v1.§9=§.§6! §();
            case 2:
               _loc1_ = b2Math.§#!G§(this.m_v2.§9=§,this.m_v1.§9=§);
               _loc2_ = b2Math.§=!C§(_loc1_,this.m_v1.§9=§.§6! §());
               if(_loc2_ > 0)
               {
                  return b2Math.§!!E§(1,_loc1_);
               }
      ...
      public function §>H§() : b2Vec2
      {
         switch(this.§`#§)
         {
            ...
            case 1:
               return this.m_v1.§9=§;
            case 2:
               return new b2Vec2(this.m_v1.a * this.m_v1.§9=§.x + this.m_v2.a * this.m_v2.§9=§.x,this.m_v1.a * this.m_v1.§9=§.y + this.m_v2.a * this.m_v2.§9=§.y);
            default:
               b2Settings.b2Assert(false);
               return new b2Vec2();
         }
      ...
      public function §^!P§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§`#§)
         {
            ...
            case 1:
               ...
               param2.SetV(this.m_v1.§"!0§);
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§+!E§.x + this.m_v2.a * this.m_v2.§+!E§.x;
               param1.y = this.m_v1.a * this.m_v1.§+!E§.y + this.m_v2.a * this.m_v2.§+!E§.y;
               param2.x = this.m_v1.a * this.m_v1.§"!0§.x + this.m_v2.a * this.m_v2.§"!0§.x;
               param2.y = this.m_v1.a * this.m_v1.§"!0§.y + this.m_v2.a * this.m_v2.§"!0§.y;
               break;
            case 3:
      ...
      public function §]8§() : Number
      {
         switch(this.§`#§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§#!G§(this.m_v1.§9=§,this.m_v2.§9=§).§;@§();
            case 3:
               return b2Math.§=!C§(b2Math.§#!G§(this.m_v2.§9=§,this.m_v1.§9=§),b2Math.§#!G§(this.m_v3.§9=§,this.m_v1.§9=§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      {
         var _loc1_:b2Vec2 = this.m_v1.§9=§;
         var _loc2_:b2Vec2 = this.m_v2.§9=§;
      ...
      public function Solve3() : void
      {
         ...
         var _loc1_:b2Vec2 = this.m_v1.§9=§;
         var _loc2_:b2Vec2 = this.m_v2.§9=§;
         var _loc3_:b2Vec2 = this.m_v3.§9=§;
         var _loc4_:b2Vec2 = b2Math.§#!G§(_loc2_,_loc1_);
         var _loc5_:Number = b2Math.§8b§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§8b§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§#!G§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§8b§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§8b§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§#!G§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§8b§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§8b§(_loc3_,_loc14_);
         var _loc18_:Number = -_loc15_;
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§=!C§(_loc4_,_loc9_)) * b2Math.§=!C§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§=!C§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§=!C§(_loc1_,_loc2_);
