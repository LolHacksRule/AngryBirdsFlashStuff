package § !9§
{
   ...
   public class Texture
   {
      ...
      public static function §22§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : § !9§.Texture
      {
         return §-_§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §-_§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : § !9§.Texture
      {
         ...
         return new §5O§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §"!J§(param1:Context3D, param2:ByteArray) : § !9§.Texture
      {
         if(param1 == null)
         {
            throw new §9!O§();
      ...
      public static function §^![§(param1:§ !9§.Texture, param2:Rectangle = null, param3:Rectangle = null) : § !9§.Texture
      {
         var _loc4_:§ !9§.Texture;
         (_loc4_ = new §5O§(param1,param2)).§<g§ = param3;
         return _loc4_;
      }
      
      public static function §8!H§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : § !9§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§ !9§.Texture = §-_§(param1,_loc6_,false,param5);
         if(!§5!5§.§#b§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§>'§, param2:int, param3:int) : void
      {
         ...
         if(this.§<g§)
         {
            ...
            _loc4_ = this.§<g§.width + this.§<g§.x - this.width;
            _loc5_ = this.§<g§.height + this.§<g§.y - this.height;
            param1.§`<§(param2,-this.§<g§.x,-this.§<g§.y);
            param1.§`<§(param2 + 1,-_loc4_,-this.§<g§.y);
            param1.§`<§(param2 + 2,-this.§<g§.x,-_loc5_);
