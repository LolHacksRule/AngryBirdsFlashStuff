package §=u§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §5Y§:b2Mat22 = new b2Mat22();
      ...
      b2internal var §package§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         this.§package§ = new Vector.<b2Vec2>();
      ...
      public static function §+_§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
      ...
      public static function §#w§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§03§(new b2Vec2(0,0));
            _loc3_.§03§(_loc9_);
            _loc3_.§03§(_loc10_);
            _loc3_.§6!%§(_loc16_ * _loc7_);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §'!&§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§3!4§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§3!4§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§%#§(this.§1!T§);
            _loc3_ = 0;
            while(_loc3_ < this.§1!T§)
            {
               this.§&1§[_loc3_].SetV(_loc2_.§&1§[_loc3_]);
               this.§package§[_loc3_].SetV(_loc2_.§package§[_loc3_]);
               _loc3_++;
            }
         }
      }
      ...
      public function §>!+§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§1!T§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§#!G§(this.§&1§[_loc5_],this.§&1§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§5§() > Number.MIN_VALUE);
            this.§package§[_loc3_].SetV(b2Math.§>@§(_loc6_,1));
            this.§package§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§^§ = §#w§(this.§&1§,this.§1!T§);
      }
      ...
      public function §0;§(param1:Number, param2:Number) : void
      {
         ...
         this.§package§[0].Set(0,-1);
         this.§package§[1].Set(1,0);
         this.§package§[2].Set(0,1);
         this.§package§[3].Set(-1,0);
         this.§^§.§#!d§();
      }
      ...
      public function §'+§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§1!T§)
         {
            this.§&1§[_loc6_] = b2Math.§8j§(_loc5_,this.§&1§[_loc6_]);
            this.§package§[_loc6_] = b2Math.§8]§(_loc5_.R,this.§package§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §`c§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§package§[0] = b2Math.§>@§(b2Math.§#!G§(param2,param1),1);
         this.§package§[0].Normalize();
         this.§package§[1].x = -this.§package§[0].x;
         this.§package§[1].y = -this.§package§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§1!T§)
         {
            _loc6_ = (_loc9_ = this.§&1§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§package§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§'H§.x = _loc5_ - b2internal:: !W;
         param1.§'H§.y = _loc6_ - b2internal:: !W;
         param1.§@!X§.x = _loc7_ + b2internal:: !W;
         param1.§@!X§.y = _loc8_ + b2internal:: !W;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§1!T§)
         {
            _loc11_ = this.§&1§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§1!T§ ? this.§&1§[int(_loc10_ + 1)] : this.§&1§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§8b§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§1!T§)
         {
            _loc7_[_loc12_] = b2Math.§8b§(_loc5_,this.§&1§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§8j§(param3,_loc24_.center));
                  return _loc24_.§1!8§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§1!T§;
         var _loc14_:int = (_loc10_ + 1) % this.§1!T§;
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§1!T§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
         ...
         _loc20_.§6!%§(1 / _loc19_);
         param4.SetV(b2Math.§8j§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §#!H§() : Vector.<b2Vec2>
      {
         return this.§package§;
      }
      
      public function §6!?§(param1:b2Vec2) : int
      {
         var _loc5_:Number = NaN;
         var _loc2_:int = 0;
         var _loc3_:Number = this.§&1§[0].x * param1.x + this.§&1§[0].y * param1.y;
         var _loc4_:int = 1;
         while(_loc4_ < this.§1!T§)
         {
      ...
      private function §%#§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            ...
            this.§package§[_loc2_] = new b2Vec2();
            _loc2_++;
         }
      }
   }
