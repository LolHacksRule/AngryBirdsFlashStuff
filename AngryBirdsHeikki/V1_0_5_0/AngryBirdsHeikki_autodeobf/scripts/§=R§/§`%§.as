package §=R§
{
   ...
   public class §`%§
   {
      ...
      public static const §import§:String = "linear";
      
      public static const §,j§:String = "easeIn";
      ...
      public static const §0!C§:String = "easeInOutBack";
      
      public static const §>!Q§:String = "easeOutInBack";
      ...
      public static const §?4§:String = "easeOutInElastic";
      ...
      public static const §`p§:String = "easeOutInBounce";
      ...
      private static function §,W§() : void
      {
         ...
         § !2§(§?L§,easeInElastic);
         § !2§(§`G§,easeOutElastic);
         § !2§(§[!5§,easeInOutElastic);
         § !2§(§?4§,easeOutInElastic);
         § !2§(§`&§,easeInBounce);
         § !2§(§]!T§,easeOutBounce);
         § !2§(§4'§,easeInOutBounce);
         § !2§(§`p§,easeOutInBounce);
