package §@!]§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§9y§.x * this.§9!?§.x + (this.§3?§ + this.§9y§.z) * this.§+!%§.x),param1 * (this.§9y§.x * this.§9!?§.y + (this.§3?§ + this.§9y§.z) * this.§+!%§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§4Y§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§4Y§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§4Y§.col2.x = this.§4Y§.col1.y;
         this.§4Y§.col2.y = _loc16_ + _loc17_;
         this.§4Y§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§4Y§.col3.x = this.§4Y§.col1.z;
         this.§4Y§.col3.y = this.§4Y§.col2.z;
         this.§4Y§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§29§)
         {
         ...
         if(param1.§3+§)
         {
            ...
            this.§9y§.y *= param1.§%"§;
            this.§3?§ *= param1.§%"§;
            _loc19_ = this.§9y§.x * this.§9!?§.x + (this.§3?§ + this.§9y§.z) * this.§+!%§.x;
            _loc20_ = this.§9y§.x * this.§9!?§.y + (this.§3?§ + this.§9y§.z) * this.§+!%§.y;
            _loc21_ = this.§9y§.x * this.m_s1 + this.§9y§.y + (this.§3?§ + this.§9y§.z) * this.m_a1;
            _loc22_ = this.§9y§.x * this.m_s2 + this.§9y§.y + (this.§3?§ + this.§9y§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§<Y§ && this.§[-§ != b2internal::?&)
         {
            ...
            _loc15_ = this.§"7§ * (this.§2%§ - _loc14_);
            _loc16_ = this.§3?§;
            _loc17_ = param1.§3v§ * this.§+!S§;
            this.§3?§ = b2Math.§8![§(this.§3?§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§3?§ - _loc16_) * this.§+!%§.x;
         ...
         if(this.§29§ && this.§[-§ != b2internal::]W)
         {
            ...
            _loc19_ = this.§9y§.Copy();
            _loc20_ = this.§4Y§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§9y§.§03§(_loc20_);
            if(this.§[-§ == b2internal::;!=)
            {
               this.§9y§.z = b2Math.§#!0§(this.§9y§.z,0);
            }
            else if(this.§[-§ == b2internal::[z)
            {
               this.§9y§.z = b2Math.§3d§(this.§9y§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§9y§.z - _loc19_.z) * this.§4Y§.col3.x;
            _loc22_ = -_loc13_ - (this.§9y§.z - _loc19_.z) * this.§4Y§.col3.y;
            _loc23_ = this.§4Y§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§9y§.x = _loc23_.x;
            this.§9y§.y = _loc23_.y;
            _loc20_.x = this.§9y§.x - _loc19_.x;
            _loc20_.y = this.§9y§.y - _loc19_.y;
            _loc20_.z = this.§9y§.z - _loc19_.z;
         ...
         {
            _loc24_ = this.§4Y§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§9y§.x += _loc24_.x;
            this.§9y§.y += _loc24_.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§29§)
         {
            ...
            if(b2Math.§?A§(this.§>t§ - this.§6d§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§8![§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§?A§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§6d§)
            {
               _loc19_ = b2Math.§8![§(_loc35_ - this.§6d§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§6d§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§>t§)
            {
               _loc19_ = b2Math.§8![§(_loc35_ - this.§>t§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§>t§;
               _loc18_ = true;
            }
         }
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§7!0§;
         ...
         if(_loc18_)
         {
            ...
            this.§4Y§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§4Y§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§4Y§.col2.x = this.§4Y§.col1.y;
            this.§4Y§.col2.y = _loc14_ + _loc15_;
            this.§4Y§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§4Y§.col3.x = this.§4Y§.col1.z;
            this.§4Y§.col3.y = this.§4Y§.col2.z;
            this.§4Y§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§4Y§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::,o;
            ...
            this.§4Y§.col1.Set(_loc36_,_loc37_,0);
            this.§4Y§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§4Y§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         ...
         _loc6_.x -= b2internal::,o * _loc31_;
         _loc6_.y -= b2internal::,o * _loc32_;
         _loc7_ -= b2internal::#e * _loc33_;
         _loc8_.x += b2internal::4!I * _loc31_;
         _loc8_.y += b2internal::4!I * _loc32_;
