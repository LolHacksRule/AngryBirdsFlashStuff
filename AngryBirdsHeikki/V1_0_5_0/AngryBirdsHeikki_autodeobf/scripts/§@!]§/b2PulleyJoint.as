package §@!]§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§+!K§ = b2internal::]!O.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§+t§.x - this.§+!K§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§+t§.y - this.§+!K§.m_xf.position.y;
         ...
         this.§@,§ = param1.§>!;§;
         this.§;!§ = param1.§30§ + this.§@,§ * param1.§!§;
         this.m_maxLength1 = b2Math.§3d§(param1.§[!=§,this.§;!§ - this.§@,§ * b2internal::?V);
         this.m_maxLength2 = b2Math.§3d§(param1.§?Z§,(this.§;!§ - b2internal::?V) / this.§@,§);
         this.§9y§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§9y§ * this.m_u2.x,param1 * this.§9y§ * this.m_u2.y);
      }
      ...
      public function §^!T§() : b2Vec2
      {
         ...
         _loc1_.§03§(this.m_groundAnchor1);
         return _loc1_;
      }
      ...
      {
         var _loc1_:b2Vec2 = this.§+!K§.m_xf.position.Copy();
         _loc1_.§03§(this.m_groundAnchor2);
         return _loc1_;
      }
      
      public function GetLength1() : Number
      {
         var _loc1_:b2Vec2 = b2internal::]!O.GetWorldPoint(this.m_localAnchor1);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.m_limitMass1 = _loc2_.§;!E§ + _loc2_.§8z§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§;!E§ + _loc3_.§8z§ * _loc22_ * _loc22_;
         this.§ B§ = this.m_limitMass1 + this.§@,§ * this.§@,§ * this.m_limitMass2;
         ...
         if(param1.§3+§)
         {
            ...
            _loc23_ = (-this.§9y§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§9y§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§@,§ * this.§9y§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§@,§ * this.§9y§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§#A§.x += _loc2_.§;!E§ * _loc23_;
            _loc2_.§#A§.y += _loc2_.§;!E§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§8z§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§#A§.x += _loc3_.§;!E§ * _loc25_;
            _loc3_.§#A§.y += _loc3_.§;!E§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§8z§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§9y§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = _loc4_.col1.y * _loc8_ + _loc4_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         if(this.§+!_§ == b2internal::[z)
         {
            _loc10_ = _loc2_.§#A§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§#A§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§#A§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§#A§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§@,§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§ B§ * -_loc18_;
            _loc20_ = this.§9y§;
            this.§9y§ = b2Math.§#!0§(0,this.§9y§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§9y§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§@,§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§@,§ * _loc19_ * this.m_u2.y;
            _loc2_.§#A§.x += _loc2_.§;!E§ * _loc14_;
            _loc2_.§#A§.y += _loc2_.§;!E§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§8z§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§#A§.x += _loc3_.§;!E§ * _loc16_;
            _loc3_.§#A§.y += _loc3_.§;!E§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§8z§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
         if(this.m_limitState1 == b2internal::[z)
         {
            _loc10_ = _loc2_.§#A§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§#A§.y + _loc2_.m_angularVelocity * _loc5_;
         ...
         if(this.m_limitState2 == b2internal::[z)
         {
            _loc12_ = _loc3_.§#A§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§#A§.y + _loc3_.m_angularVelocity * _loc8_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§+!_§ == b2internal::[z)
         {
            ...
            _loc19_ = b2Math.§8![§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            ...
            _loc2_.m_sweep.c.x += _loc2_.§;!E§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§;!E§ * _loc14_;
            _loc2_.m_sweep.a += _loc2_.§8z§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§;!E§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§;!E§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§8z§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§+?§();
            _loc3_.§+?§();
         }
         if(this.m_limitState1 == b2internal::[z)
