package §6Q§
{
   ...
   public class §>!#§
   {
      ...
      private function §9!3§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§2!O§(param1 as String);
         }
         if(param1 is Number)
         {
      ...
      private function §2!O§(param1:String) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§2!O§(v.@name.toString()) + ":" + this.§9!3§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
