package §=!c§
{
   ...
   public class §=>§ extends §"6§
   {
      ...
      public function §=>§(param1:XML, param2:§=>§, param3:§if§, param4:MovieClip = null)
      {
         var _loc5_:XML = null;
         var _loc6_:XML = null;
         var _loc7_:XML = null;
         ...
         {
            this.§-!`§.push(new §>d§(_loc6_,this,null));
         }
      ...
      public function §+7§(param1:§"6§) : void
      {
      ...
      public function addComponent(param1:§"6§) : void
      {
         if(this.§-!`§.indexOf(param1) < 0)
         {
            ...
            param1.setActiveStatus(this.§6T§);
            param1.setVisibility(this.§7F§ && param1.§7F§);
      ...
      public function §7Z§(param1:String, param2:Boolean) : void
      {
      ...
      override public function getParentView() : §if§
      {
         if(this.§=?§)
         {
            return this.§=?§;
