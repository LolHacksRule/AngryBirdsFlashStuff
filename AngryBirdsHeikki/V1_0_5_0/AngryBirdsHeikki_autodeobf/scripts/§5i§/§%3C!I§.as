package §5i§
{
   ...
   public class §<!I§
   {
      ...
      public static var §3!O§:ByteArray;
      ...
      public static function §+!T§(param1:String) : String
      {
         ...
         return §9!R§.§8n§(_loc3_.readInt(),true) + §9!R§.§8n§(_loc3_.readInt(),true) + §9!R§.§8n§(_loc3_.readInt(),true) + §9!R§.§8n§(_loc3_.readInt(),true) + §9!R§.§8n§(_loc3_.readInt(),true);
      }
