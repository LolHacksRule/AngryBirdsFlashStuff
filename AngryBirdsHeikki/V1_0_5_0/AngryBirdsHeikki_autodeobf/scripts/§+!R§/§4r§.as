package §+!R§
{
   ...
   public class §4r§ extends §`!C§
   {
       
      
      public function §4r§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§2!+§(param1,param2);
      }
      
      protected function §2!+§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc16_:§"O§ = null;
         var _loc3_:Dictionary = this.§"h§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§2<§(_loc7_,_loc6_)]) == null)
            {
      ...
      private function §2<§(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function §"h§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§2<§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §5G§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
