   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         if(param1 >= 0 && param1 < this.numChildren)
         {
            ...
            _loc3_.dispatchEvent(new Event(Event.§^Z§,true));
            if(stage)
            {
               _loc3_.dispatchEventOnChildren(new Event(Event.§4!@§));
            }
            _loc3_.§`o§(null);
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            ...
            §5y§(_loc7_,§]!D§);
            transformCoords(§]!D§,_loc3_,_loc4_,§=x§);
            if(_loc8_ = _loc7_.hitTest(§=x§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.final(this,param1.type,_loc2_);
      ...
      private function final(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               this.final(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
