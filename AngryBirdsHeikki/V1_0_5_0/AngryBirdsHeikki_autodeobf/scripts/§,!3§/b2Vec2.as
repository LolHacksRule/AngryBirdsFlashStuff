package §,!3§
{
   public class b2Vec2
   {
      ...
      public static function §,V§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      {
         var _loc2_:Number = b2Math.§8b§(this,param1.col1);
         this.y = b2Math.§8b§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      public function §7l§(param1:b2Vec2) : void
      {
      ...
      {
         return b2Math.§3!0§(this.x) && b2Math.§3!0§(this.y);
      }
   }
}
