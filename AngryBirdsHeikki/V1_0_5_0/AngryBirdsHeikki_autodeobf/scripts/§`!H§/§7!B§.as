package §`!H§
{
   ...
   public class §7!B§
   {
      ...
      public static function §0L§(param1:String, param2:§@!E§, param3:Boolean = true) : §[=§.Sprite
      {
         var _loc7_:XML = null;
         var _loc8_:§5f§ = null;
         var _loc9_:§@!#§ = null;
         ...
         {
            if(_loc8_ = param2.§;X§(_loc7_.@name))
            {
      ...
      public static function §81§(param1:String, param2:§@!E§) : flash.display.Sprite
      {
         var _loc6_:XML = null;
         var _loc7_:§5f§ = null;
         ...
         var _loc4_:XML;
         var _loc5_:XMLList = (_loc4_ = §#![§[param1]).child(§=!6§);
         for each(_loc6_ in _loc5_)
         {
            if(_loc7_ = param2.§;X§(_loc6_.@name))
            {
