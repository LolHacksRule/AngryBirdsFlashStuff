package §!4§
{
   ...
   public class b2Collision
   {
      ...
      private static var §3o§:Vector.<int> = new Vector.<int>(1);
      
      private static var §5e§:b2Vec2 = new b2Vec2();
      
      private static var §['§:b2Vec2 = new b2Vec2();
      
      private static var §3W§:b2Vec2 = new b2Vec2();
      ...
      public static function §9'§(param1:Vector.<§+!>§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc20_:§+!>§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§6!U§;
         var _loc8_:Vector.<b2Vec2> = param2.§%!L§;
         var _loc9_:int = param5.§6!U§;
         ...
         _loc20_.id.§`!8§.§6x§ = param4;
         _loc20_.id.§`!8§.§;!'§ = _loc21_;
         _loc20_.id.§`!8§.§ 2§ = 0;
         _loc20_ = param1[1];
      ...
      public static function §!!U§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §7!@§[0] = _loc8_;
         var _loc9_:Number = §,5§(§7!@§,param2,param3,param4,param5);
         _loc8_ = §7!@§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §3o§[0] = _loc10_;
         var _loc11_:Number = §,5§(§3o§,param4,param5,param2,param3);
         _loc10_ = §3o§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§+!>§> = §`!I§;
         §9'§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§6!U§;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §5e§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §['§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §3W§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §'§;
         _loc20_ = _loc14_.R;
         ...
         if((_loc39_ = §;y§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §;y§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
      ...
      public static function §null§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§'m§ + param4.§'m§;
         var _loc21_:int = param2.§6!U§;
