package §-!5§
{
   ...
   public class §1!_§
   {
      ...
      public static function §,!G§(param1:String) : String
      {
         ...
         return §<j§.§65§(_loc3_.readInt(),true) + §<j§.§65§(_loc3_.readInt(),true) + §<j§.§65§(_loc3_.readInt(),true) + §<j§.§65§(_loc3_.readInt(),true) + §<j§.§65§(_loc3_.readInt(),true);
      }
      
      public static function §4!9§(param1:ByteArray) : String
      {
         var _loc2_:Array = §1!_§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §5!?§(_loc2_);
         return §<j§.§65§(_loc3_.readInt(),true) + §<j§.§65§(_loc3_.readInt(),true) + §<j§.§65§(_loc3_.readInt(),true) + §<j§.§65§(_loc3_.readInt(),true) + §<j§.§65§(_loc3_.readInt(),true);
      }
      
      public static function §8x§(param1:String) : String
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §1!_§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §5!?§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
