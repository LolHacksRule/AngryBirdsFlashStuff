package §7q§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§,9§ = this.§'!H§.Normalize();
         this.§4e§.Set(this.§'!H§.y,-this.§'!H§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§4e§.x - this.§'!H§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§4e§.y - this.§'!H§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§4e§.x + this.§'!H§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§4e§.y + this.§'!H§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§4e§;
         this.m_cornerDir2.Set(-this.§4e§.x,-this.§4e§.y);
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc8_:Number = b2Math.§[!N§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§[!N§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
