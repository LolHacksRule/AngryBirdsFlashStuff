package §"d§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         this.m_groundAnchor1.x = param1.§%R§.x - this.§4F§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§%R§.y - this.§4F§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§>!M§.x - this.§4F§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§>!M§.y - this.§4F§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§@b§);
         this.m_localAnchor2.SetV(param1.§=i§);
         this.§?!e§ = param1.§9K§;
         this.§3!;§ = param1.§`1§ + this.§?!e§ * param1.§,D§;
         this.m_maxLength1 = b2Math.§ d§(param1.§7!B§,this.§3!;§ - this.§?!e§ * b2internal::%a);
         this.m_maxLength2 = b2Math.§ d§(param1.§-!]§,(this.§3!;§ - b2internal::%a) / this.§?!e§);
         this.§12§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§12§ * this.m_u2.x,param1 * this.§12§ * this.m_u2.y);
      }
      ...
      public function GetLength1() : Number
      {
         ...
         var _loc2_:Number = this.§4F§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.§4F§.m_xf.position.y + this.m_groundAnchor1.y;
      ...
      public function GetLength2() : Number
      {
         ...
         var _loc2_:Number = this.§4F§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.§4F§.m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc14_:Number = this.§4F§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.§4F§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.§4F§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.§4F§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§3!;§ - _loc18_ - this.§?!e§ * _loc19_) > 0)
         {
            this.§"2§ = b2internal::7t;
            this.§12§ = 0;
         }
         else
         {
         ...
         {
            this.m_limitState1 = b2internal::7t;
            this.m_limitImpulse1 = 0;
         }
         else
         {
            this.m_limitState1 = b2internal::&!U;
         }
         if(_loc19_ < this.m_maxLength2)
         {
            this.m_limitState2 = b2internal::7t;
            this.m_limitImpulse2 = 0;
         }
         else
         {
            this.m_limitState2 = b2internal::&!U;
         }
         var _loc21_:Number = _loc5_ * this.m_u1.y - _loc6_ * this.m_u1.x;
         var _loc22_:Number = _loc8_ * this.m_u2.y - _loc9_ * this.m_u2.x;
         this.m_limitMass1 = _loc2_.§",§ + _loc2_.§-2§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§",§ + _loc3_.§-2§ * _loc22_ * _loc22_;
         this.§%!@§ = this.m_limitMass1 + this.§?!e§ * this.§?!e§ * this.m_limitMass2;
         ...
         if(param1.§?S§)
         {
            ...
            this.m_limitImpulse1 *= param1.§const§;
            this.m_limitImpulse2 *= param1.§const§;
            _loc23_ = (-this.§12§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§12§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§?!e§ * this.§12§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§?!e§ * this.§12§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§@S§.x += _loc2_.§",§ * _loc23_;
            _loc2_.§@S§.y += _loc2_.§",§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§-2§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§@S§.x += _loc3_.§",§ * _loc25_;
            _loc3_.§@S§.y += _loc3_.§",§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§"2§ == b2internal::&!U)
         {
            ...
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§?!e§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§%!@§ * -_loc18_;
            _loc20_ = this.§12§;
            this.§12§ = b2Math.§9![§(0,this.§12§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§12§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§?!e§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§?!e§ * _loc19_ * this.m_u2.y;
            _loc2_.§@S§.x += _loc2_.§",§ * _loc14_;
            _loc2_.§@S§.y += _loc2_.§",§ * _loc15_;
         ...
         if(this.m_limitState1 == b2internal::&!U)
         {
            _loc10_ = _loc2_.§@S§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§@S§.y + _loc2_.m_angularVelocity * _loc5_;
            ...
            this.m_limitImpulse1 = b2Math.§9![§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == b2internal::&!U)
         {
            _loc12_ = _loc3_.§@S§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§@S§.y + _loc3_.m_angularVelocity * _loc8_;
            ...
            this.m_limitImpulse2 = b2Math.§9![§(0,this.m_limitImpulse2 + _loc19_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal::#A;
         var _loc3_:b2Body = b2internal::2!`;
         var _loc5_:Number = this.§4F§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.§4F§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.§4F§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.§4F§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         if(this.§"2§ == b2internal::&!U)
         {
            ...
            if(_loc18_ > b2Settings.b2_linearSlop)
            {
               this.m_u2.§0O§(1 / _loc18_);
            }
            else
            {
               this.m_u2.§^!,§();
            }
            _loc19_ = this.§3!;§ - _loc17_ - this.§?!e§ * _loc18_;
            _loc24_ = b2Math.§9![§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§>I§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§%!@§ * _loc19_) * this.m_u1.x;
            _loc14_ = -_loc20_ * this.m_u1.y;
            _loc15_ = -this.§?!e§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§?!e§ * _loc20_ * this.m_u2.y;
