package §!4§
{
   ...
   class b2Simplex
   {
      ...
      public function §1t§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            _loc11_ = param1.§4M§;
            if((_loc12_ = this.§4A§()) < 0.5 * _loc11_ || 2 * _loc11_ < _loc12_ || _loc12_ < Number.MIN_VALUE)
            {
               this.§33§ = 0;
            }
         }
      ...
      public function §^?§() : b2Vec2
      {
         ...
         switch(this.§33§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§8!f§(_loc1_,this.m_v1.§79§.§^!b§());
               if(_loc2_ > 0)
               {
      ...
      public function § !M§() : b2Vec2
      {
         switch(this.§33§)
         {
            ...
            case 1:
               return this.m_v1.§79§;
            case 2:
               return new b2Vec2(this.m_v1.a * this.m_v1.§79§.x + this.m_v2.a * this.m_v2.§79§.x,this.m_v1.a * this.m_v1.§79§.y + this.m_v2.a * this.m_v2.§79§.y);
            default:
               b2Settings.b2Assert(false);
               return new b2Vec2();
         }
      ...
      public function §>U§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§33§)
         {
            ...
            case 1:
               ...
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§2!=§.x + this.m_v2.a * this.m_v2.§2!=§.x;
               param1.y = this.m_v1.a * this.m_v1.§2!=§.y + this.m_v2.a * this.m_v2.§2!=§.y;
               param2.x = this.m_v1.a * this.m_v1.§8!Z§.x + this.m_v2.a * this.m_v2.§8!Z§.x;
               param2.y = this.m_v1.a * this.m_v1.§8!Z§.y + this.m_v2.a * this.m_v2.§8!Z§.y;
               break;
            case 3:
               param2.x = param1.x = this.m_v1.a * this.m_v1.§2!=§.x + this.m_v2.a * this.m_v2.§2!=§.x + this.m_v3.a * this.m_v3.§2!=§.x;
               param2.y = param1.y = this.m_v1.a * this.m_v1.§2!=§.y + this.m_v2.a * this.m_v2.§2!=§.y + this.m_v3.a * this.m_v3.§2!=§.y;
               break;
            default:
               b2Settings.b2Assert(false);
         }
      ...
      public function §4A§() : Number
      {
         switch(this.§33§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§8!Y§(this.m_v1.§79§,this.m_v2.§79§).§--§();
            case 3:
      ...
      public function Solve3() : void
      {
         ...
         var _loc5_:Number = b2Math.§[!N§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§[!N§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§8!Y§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§[!N§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§[!N§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§8!Y§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§[!N§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§[!N§(_loc3_,_loc14_);
         var _loc18_:Number = -_loc15_;
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§8!f§(_loc4_,_loc9_)) * b2Math.§8!f§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§8!f§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§8!f§(_loc1_,_loc2_);
