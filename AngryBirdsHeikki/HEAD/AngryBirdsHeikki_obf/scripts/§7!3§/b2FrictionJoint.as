package §7!3§
{
   ...
   public class b2FrictionJoint extends b2Joint
   {
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc20_:Number = -this.§4y§ * _loc19_;
         var _loc21_:Number = this.§!!^§;
         _loc18_ = param1.§,>§ * this.§!!6§;
         this.§!!^§ = b2Math.§6m§(this.§!!^§ + _loc20_,-_loc18_,_loc18_);
         _loc20_ = this.§!!^§ - _loc21_;
         _loc7_ -= _loc12_ * _loc20_;
         _loc9_ += _loc13_ * _loc20_;
         var _loc22_:Number = _loc8_.x - _loc9_ * _loc17_ - _loc6_.x + _loc7_ * _loc15_;
         var _loc23_:Number = _loc8_.y + _loc9_ * _loc16_ - _loc6_.y - _loc7_ * _loc14_;
         var _loc24_:b2Vec2 = b2Math.§]!I§(this.§1!7§,new b2Vec2(-_loc22_,-_loc23_));
         var _loc25_:b2Vec2 = this.§'A§.Copy();
         this.§'A§.§5>§(_loc24_);
         _loc18_ = param1.§,>§ * this.§!%§;
         if(this.§'A§.§ P§() > _loc18_ * _loc18_)
         {
            this.§'A§.Normalize();
            this.§'A§.§6Q§(_loc18_);
         }
         _loc24_ = b2Math.§!M§(this.§'A§,_loc25_);
