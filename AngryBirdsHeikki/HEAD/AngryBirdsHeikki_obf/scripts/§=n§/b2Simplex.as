package §=n§
{
   ...
   class b2Simplex
   {
      ...
      public var §[_§:Vector.<b2SimplexVertex>;
      ...
      function b2Simplex()
      {
         ...
         this.§[_§ = new Vector.<b2SimplexVertex>(3);
         super();
         this.§[_§[0] = this.m_v1;
         this.§[_§[1] = this.m_v2;
         this.§[_§[2] = this.m_v3;
      ...
      public function §+N§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         this.§&!Y§ = param1.count;
         var _loc8_:Vector.<b2SimplexVertex> = this.§[_§;
         var _loc9_:int = 0;
         while(_loc9_ < this.§&!Y§)
         {
            ...
            _loc10_.§5A§ = b2Math.§'Y§(param3,_loc6_);
            _loc10_.§^T§ = b2Math.§'Y§(param5,_loc7_);
            _loc10_.§@!T§ = b2Math.§!M§(_loc10_.§^T§,_loc10_.§5A§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§&!Y§ > 1)
         {
            _loc11_ = param1.§2C§;
            if((_loc12_ = this.§"_§()) < 0.5 * _loc11_ || 2 * _loc11_ < _loc12_ || _loc12_ < Number.MIN_VALUE)
            {
               this.§&!Y§ = 0;
            }
         }
      ...
      {
         param1.§2C§ = this.§"_§();
         param1.count = uint(this.§&!Y§);
         var _loc2_:Vector.<b2SimplexVertex> = this.§[_§;
         var _loc3_:int = 0;
         while(_loc3_ < this.§&!Y§)
         {
      ...
      public function §0e§() : b2Vec2
      {
         ...
         {
            case 1:
               return this.m_v1.§@!T§.§^!K§();
            case 2:
               _loc1_ = b2Math.§!M§(this.m_v2.§@!T§,this.m_v1.§@!T§);
               _loc2_ = b2Math.§5![§(_loc1_,this.m_v1.§@!T§.§^!K§());
               if(_loc2_ > 0)
               {
                  return b2Math.§%n§(1,_loc1_);
               }
               return b2Math.§10§(_loc1_,1);
               break;
            default:
      ...
      public function §=!8§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§&!Y§)
         {
            case 0:
               ...
               break;
            case 1:
               param1.SetV(this.m_v1.§5A§);
               param2.SetV(this.m_v1.§^T§);
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§5A§.x + this.m_v2.a * this.m_v2.§5A§.x;
               param1.y = this.m_v1.a * this.m_v1.§5A§.y + this.m_v2.a * this.m_v2.§5A§.y;
               param2.x = this.m_v1.a * this.m_v1.§^T§.x + this.m_v2.a * this.m_v2.§^T§.x;
               param2.y = this.m_v1.a * this.m_v1.§^T§.y + this.m_v2.a * this.m_v2.§^T§.y;
               break;
            case 3:
               param2.x = param1.x = this.m_v1.a * this.m_v1.§5A§.x + this.m_v2.a * this.m_v2.§5A§.x + this.m_v3.a * this.m_v3.§5A§.x;
               param2.y = param1.y = this.m_v1.a * this.m_v1.§5A§.y + this.m_v2.a * this.m_v2.§5A§.y + this.m_v3.a * this.m_v3.§5A§.y;
               break;
            default:
               b2Settings.b2Assert(false);
         }
      ...
      public function §"_§() : Number
      {
         switch(this.§&!Y§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§!M§(this.m_v1.§@!T§,this.m_v2.§@!T§).§=!G§();
            case 3:
               return b2Math.§5![§(b2Math.§!M§(this.m_v2.§@!T§,this.m_v1.§@!T§),b2Math.§!M§(this.m_v3.§@!T§,this.m_v1.§@!T§));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc5_:Number = b2Math.§8!&§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§8!&§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§!M§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§8!&§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§8!&§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§!M§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§8!&§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§8!&§(_loc3_,_loc14_);
