package §=n§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §9!M§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§5!'§ = §#!K§;
            _loc7_ = this.§+>§.§@!-§(param1.indexA[0]);
            _loc10_ = this.§@!B§.§@!-§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§<Z§.x = _loc15_ - _loc13_;
            this.§<Z§.y = _loc16_ - _loc14_;
            this.§<Z§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§5!'§ = §@!A§;
            _loc8_ = this.§+>§.§@!-§(param1.indexA[0]);
            _loc9_ = this.§+>§.§@!-§(param1.indexA[1]);
            _loc10_ = this.§@!B§.§@!-§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§<Z§ = b2Math.§10§(b2Math.§!M§(_loc9_,_loc8_),1);
            this.§<Z§.Normalize();
            _loc20_ = this.§<Z§;
         ...
         {
            this.§5!'§ = § e§;
            _loc11_ = this.§@!B§.§@!-§(param1.indexB[0]);
            _loc12_ = this.§@!B§.§@!-§(param1.indexB[1]);
            _loc7_ = this.§+>§.§@!-§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§<Z§ = b2Math.§10§(b2Math.§!M§(_loc12_,_loc11_),1);
            this.§<Z§.Normalize();
            _loc20_ = this.§<Z§;
         ...
         else
         {
            ...
            _loc11_ = this.§@!B§.§@!-§(param1.indexB[0]);
            _loc12_ = this.§@!B§.§@!-§(param1.indexB[1]);
            _loc23_ = b2Math.§'Y§(param3,_loc7_);
            _loc24_ = b2Math.§]!I§(param3.R,b2Math.§!M§(_loc9_,_loc8_));
            _loc25_ = b2Math.§'Y§(param5,_loc10_);
            _loc26_ = b2Math.§]!I§(param5.R,b2Math.§!M§(_loc12_,_loc11_));
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§6m§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§6m§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §#!K§:
               _loc3_ = b2Math.§]v§(param1.R,this.§<Z§);
               _loc4_ = b2Math.§]v§(param2.R,this.§<Z§.§^!K§());
               _loc5_ = this.§+>§.§0,§(_loc3_);
               _loc6_ = this.§@!B§.§0,§(_loc4_);
               _loc7_ = b2Math.§'Y§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§'Y§(param2,_loc6_)).x - _loc7_.x) * this.§<Z§.x + (_loc8_.y - _loc7_.y) * this.§<Z§.y);
            case §@!A§:
               _loc10_ = b2Math.§]!I§(param1.R,this.§<Z§);
               _loc7_ = b2Math.§'Y§(param1,this.m_localPoint);
               _loc4_ = b2Math.§]v§(param2.R,_loc10_.§^!K§());
               _loc6_ = this.§@!B§.§0,§(_loc4_);
               return Number(((_loc8_ = b2Math.§'Y§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case § e§:
               _loc10_ = b2Math.§]!I§(param2.R,this.§<Z§);
               _loc8_ = b2Math.§'Y§(param2,this.m_localPoint);
               _loc3_ = b2Math.§]v§(param1.R,_loc10_.§^!K§());
               _loc5_ = this.§+>§.§0,§(_loc3_);
               return Number(((_loc7_ = b2Math.§'Y§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
