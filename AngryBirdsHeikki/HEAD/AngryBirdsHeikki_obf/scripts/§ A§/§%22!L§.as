   ...
   public class §"!L§
   {
      ...
      public static function §<4§(param1:XMLList, param2:XMLList, param3:XMLList) : void
      {
         ...
         for each(_loc4_ in param1.Material)
         {
            ...
            §4p§(_loc4_.@id,_loc4_.@bodyType,_loc4_.@density,_loc4_.@friction,_loc4_.@restitution,_loc4_.@strength,_loc4_.@defence,_loc4_.@colors);
         }
         §6-§(param2,param3);
      }
      
      public static function §6-§(param1:XMLList, param2:XMLList) : void
      {
         var _loc3_:XML = null;
         var _loc4_:§&!#§ = null;
         for each(_loc3_ in param1.Material)
         {
            if(_loc4_ = §5!E§(_loc3_.@id))
            {
               _loc4_.§,`§(_loc3_);
            }
            else
      ...
      public static function §4p§(param1:String, param2:String, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : void
      {
         §=P§[§=P§.length] = new §&!#§(param1,param2,param3,param4,param5,param6,param7,param8);
      }
      
      public static function §5!E§(param1:String) : §&!#§
      {
         var _loc2_:int = 0;
