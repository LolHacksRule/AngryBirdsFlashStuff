package §6!;§
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function §,N§(param1:int = 0, param2:int = -1, param3:Boolean = false) : void
      {
         if(param2 < 0 || param2 >= this.numChildren)
         {
      ...
      public function §1K§(param1:Event) : void
      {
         if(param1.bubbles)
         {
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§6!D§(this,param1.type,_loc2_);
      ...
      private function §6!D§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               this.§6!D§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
