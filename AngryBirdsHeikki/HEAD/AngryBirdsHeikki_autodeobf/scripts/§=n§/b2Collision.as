package §=n§
{
   ...
   public class b2Collision
   {
      ...
      private static var §8C§:Vector.<§0!G§> = §23§();
      
      private static var s_clipPoints1:Vector.<§0!G§> = §23§();
      
      private static var s_clipPoints2:Vector.<§0!G§> = §23§();
      
      private static var §^J§:Vector.<int> = new Vector.<int>(1);
      
      private static var §;k§:Vector.<int> = new Vector.<int>(1);
      ...
      private static var §true §:b2Vec2 = new b2Vec2();
      ...
      public static function §<!6§(param1:Vector.<§0!G§>, param2:Vector.<§0!G§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§0!G§ = null;
         var _loc6_:int = 0;
      ...
      public static function §=X§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§=z§;
         var _loc7_:Vector.<b2Vec2> = param1.§[_§;
         var _loc8_:Vector.<b2Vec2> = param1.§'F§;
         var _loc9_:int = param4.§=z§;
         var _loc10_:Vector.<b2Vec2> = param4.§[_§;
         _loc11_ = param2.R;
      ...
      public static function §^S§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§=z§;
         var _loc7_:Vector.<b2Vec2> = param2.§'F§;
         _loc9_ = param5.R;
         _loc8_ = param4.§;F§;
         ...
         var _loc17_:Number = §=X§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §=X§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §=X§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §=X§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §2!5§(param1:Vector.<§0!G§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§0!G§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§=z§;
         var _loc8_:Vector.<b2Vec2> = param2.§'F§;
         var _loc9_:int = param5.§=z§;
         var _loc10_:Vector.<b2Vec2> = param5.§[_§;
         var _loc11_:Vector.<b2Vec2> = param5.§'F§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§4!P§.§22§ = param4;
         _loc20_.id.§4!P§.§,!;§ = _loc21_;
         _loc20_.id.§4!P§.§@!b§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§4!P§.§22§ = param4;
         _loc20_.id.§4!P§.§,!;§ = _loc22_;
         _loc20_.id.§4!P§.§@!b§ = 1;
      }
      
      private static function §23§() : Vector.<§0!G§>
      {
         var _loc1_:Vector.<§0!G§> = new Vector.<§0!G§>(2);
         _loc1_[0] = new §0!G§();
         _loc1_[1] = new §0!G§();
         return _loc1_;
      }
      ...
      public static function §+!B§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         param1.§;!e§ = 0;
         var _loc7_:Number = param2.§]U§ + param4.§]U§;
         var _loc8_:int = 0;
         §^J§[0] = _loc8_;
         var _loc9_:Number = §^S§(§^J§,param2,param3,param4,param5);
         _loc8_ = §^J§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §;k§[0] = _loc10_;
         var _loc11_:Number = §^S§(§;k§,param4,param5,param2,param3);
         _loc10_ = §;k§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§5!'§ = b2Manifold.§@!A§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§0!G§> = §8C§;
         §2!5§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§=z§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§[_§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §,!S§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §`9§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         ...
         var _loc37_:Vector.<§0!G§> = s_clipPoints1;
         var _loc38_:Vector.<§0!G§> = s_clipPoints2;
         if((_loc39_ = §<!6§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §<!6§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§#e§.SetV(_loc27_);
      ...
      public static function §#u§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§]U§ + param4.§]U§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§5!'§ = b2Manifold.§=;§;
         param1.m_localPoint.SetV(param2.§8I§);
         param1.§#e§.§8c§();
         param1.§;!e§ = 1;
         param1.§0F§[0].m_localPoint.SetV(param4.§8I§);
         param1.§0F§[0].m_id.key = 0;
      }
      
      public static function §[z§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§]U§ + param4.§]U§;
         var _loc21_:int = param2.§=z§;
         var _loc22_:Vector.<b2Vec2> = param2.§[_§;
         var _loc23_:Vector.<b2Vec2> = param2.§'F§;
         var _loc24_:int = 0;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§;!e§ = 1;
            param1.§5!'§ = b2Manifold.§@!A§;
            param1.§#e§.x = _loc15_ - _loc27_.x;
            param1.§#e§.y = _loc16_ - _loc27_.y;
            param1.§#e§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§;!e§ = 1;
            param1.§5!'§ = b2Manifold.§@!A§;
            param1.§#e§.x = _loc15_ - _loc28_.x;
            param1.§#e§.y = _loc16_ - _loc28_.y;
            param1.§#e§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§0F§[0].m_localPoint.SetV(param4.§8I§);
            param1.§0F§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§;!e§ = 1;
            param1.§5!'§ = b2Manifold.§@!A§;
            param1.§#e§.x = _loc23_[_loc25_].x;
            param1.§#e§.y = _loc23_[_loc25_].y;
            param1.§#e§.Normalize();
