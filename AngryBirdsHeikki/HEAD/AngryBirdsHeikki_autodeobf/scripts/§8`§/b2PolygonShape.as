package §8`§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §0O§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §;F§:b2Vec2;
      
      b2internal var §[_§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         §5!'§ = b2internal::0B;
         this.§;F§ = new b2Vec2();
         this.§[_§ = new Vector.<b2Vec2>();
         this.§'F§ = new Vector.<b2Vec2>();
         §]U§ = b2Settings.b2_polygonRadius;
         this.§;F§.§8c§();
      }
      ...
      public static function §"P§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§^U§(param1,param2,param3,param4);
         return _loc5_;
      }
      ...
      public static function §7y§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
      ...
      b2internal static function §>I§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§1!T§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§1!T§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§;F§.SetV(_loc2_.§;F§);
            this.§=z§ = _loc2_.§=z§;
            this.§4_§(this.§=z§);
            _loc3_ = 0;
            while(_loc3_ < this.§=z§)
            {
               this.§[_§[_loc3_].SetV(_loc2_.§[_§[_loc3_]);
      ...
      public function §8!=§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function §[!4§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§=z§)
         {
            this.§[_§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§=z§)
         {
            ...
            _loc6_ = b2Math.§!M§(this.§[_§[_loc5_],this.§[_§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§ P§() > Number.MIN_VALUE);
            this.§'F§[_loc3_].SetV(b2Math.§10§(_loc6_,1));
            this.§'F§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§;F§ = §7y§(this.§[_§,this.§=z§);
      }
      ...
      public function §&§(param1:Number, param2:Number) : void
      {
         this.§=z§ = 4;
         this.§4_§(4);
         this.§[_§[0].Set(-param1,-param2);
         this.§[_§[1].Set(param1,-param2);
         this.§[_§[2].Set(param1,param2);
         this.§[_§[3].Set(-param1,param2);
         this.§'F§[0].Set(0,-1);
         this.§'F§[1].Set(1,0);
         this.§'F§[2].Set(0,1);
         this.§'F§[3].Set(-1,0);
      ...
      public function §^U§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§=z§ = 4;
         this.§4_§(4);
         this.§[_§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§=z§)
         {
            this.§[_§[_loc6_] = b2Math.§'Y§(_loc5_,this.§[_§[_loc6_]);
            this.§'F§[_loc6_] = b2Math.§]!I§(_loc5_.R,this.§'F§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §;!R§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§=z§ = 2;
         this.§4_§(2);
         this.§[_§[0].SetV(param1);
         this.§[_§[1].SetV(param2);
         this.§;F§.x = 0.5 * (param1.x + param2.x);
         this.§;F§.y = 0.5 * (param1.y + param2.y);
         this.§'F§[0] = b2Math.§10§(b2Math.§!M§(param2,param1),1);
         this.§'F§[0].Normalize();
         this.§'F§[1].x = -this.§'F§[0].x;
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         {
            _loc6_ = (_loc9_ = this.§[_§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§'F§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§+?§.x = _loc5_ - b2internal::]U;
         param1.§+?§.y = _loc6_ - b2internal::]U;
         param1.§`-§.x = _loc7_ + b2internal::]U;
         param1.§`-§.y = _loc8_ + b2internal::]U;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§=z§ == 2)
         {
            param1.center.x = 0.5 * (this.§[_§[0].x + this.§[_§[1].x);
            param1.center.y = 0.5 * (this.§[_§[0].y + this.§[_§[1].y);
            param1.§%G§ = 0;
            param1.§#!U§ = 0;
            return;
         }
         ...
         {
            _loc11_ = this.§[_§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§=z§ ? this.§[_§[int(_loc10_ + 1)] : this.§[_§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§%G§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§#!U§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§]v§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§8!&§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§8!&§(_loc5_,this.§[_§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§'Y§(param3,_loc24_.center));
                  return _loc24_.§%G§;
               }
               return 0;
               break;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§[_§[_loc9_].x * (1 - _loc15_) + this.§[_§[_loc13_].x * _loc15_,this.§[_§[_loc9_].y * (1 - _loc15_) + this.§[_§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§[_§[_loc10_].x * (1 - _loc16_) + this.§[_§[_loc14_].x * _loc16_,this.§[_§[_loc10_].y * (1 - _loc16_) + this.§[_§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§[_§[_loc13_];
         _loc12_ = _loc13_;
         ...
         _loc20_.§6Q§(1 / _loc19_);
         param4.SetV(b2Math.§'Y§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §"p§(param1:b2Vec2) : int
      {
      ...
      private function §4_§(param1:int) : void
      {
         var _loc2_:int = this.§[_§.length;
         while(_loc2_ < param1)
         {
            this.§[_§[_loc2_] = new b2Vec2();
