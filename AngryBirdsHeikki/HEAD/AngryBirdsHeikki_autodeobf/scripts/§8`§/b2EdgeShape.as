package §8`§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      b2internal var §1u§:b2EdgeShape;
      
      b2internal var §8_§:b2EdgeShape;
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§&!A§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§set § = this.§&!A§.Normalize();
         this.§-0§.Set(this.§&!A§.y,-this.§&!A§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§-0§.x - this.§&!A§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§-0§.y - this.§&!A§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§-0§.x + this.§&!A§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§-0§.y + this.§&!A§.y) + this.m_v2.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§3!%§ * _loc12_)
            {
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§'Y§(param3,this.m_v1);
         var _loc7_:b2Vec2 = b2Math.§'Y§(param3,this.m_v2);
      ...
      public function §<g§() : b2EdgeShape
      {
         return this.§1u§;
      }
      
      public function §&!8§() : b2EdgeShape
      {
         return this.§8_§;
      }
      
      public function §8K§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
      ...
      b2internal function §?j§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§1u§ = param1;
