package §7!3§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§[H§.x * this.§^!&§.x + (this.§@"§ + this.§[H§.z) * this.§<Z§.x),param1 * (this.§[H§.x * this.§^!&§.y + (this.§@"§ + this.§[H§.z) * this.§<Z§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§`!;§)
         {
            ...
            this.§[H§.y *= param1.§"§;
            this.§@"§ *= param1.§"§;
            _loc19_ = this.§[H§.x * this.§^!&§.x + (this.§@"§ + this.§[H§.z) * this.§<Z§.x;
            _loc20_ = this.§[H§.x * this.§^!&§.y + (this.§@"§ + this.§[H§.z) * this.§<Z§.y;
            _loc21_ = this.§[H§.x * this.m_s1 + this.§[H§.y + (this.§@"§ + this.§[H§.z) * this.m_a1;
            _loc22_ = this.§[H§.x * this.m_s2 + this.§[H§.y + (this.§@"§ + this.§[H§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§ !K§ && this.§2!a§ != b2internal::55)
         {
            ...
            _loc15_ = this.§0`§ * (this.§#d§ - _loc14_);
            _loc16_ = this.§@"§;
            _loc17_ = param1.§,>§ * this.§ var§;
            this.§@"§ = b2Math.§6m§(this.§@"§ + _loc15_,-_loc17_,_loc17_);
         ...
         if(this.§]<§ && this.§2!a§ != b2internal::2!h)
         {
            ...
            if(this.§2!a§ == b2internal::4;)
            {
               this.§[H§.z = b2Math.§"F§(this.§[H§.z,0);
            }
            else if(this.§2!a§ == b2internal::^!_)
            {
               this.§[H§.z = b2Math.§[!0§(this.§[H§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§[H§.z - _loc19_.z) * this.§'Q§.col3.x;
            _loc22_ = -_loc13_ - (this.§[H§.z - _loc19_.z) * this.§'Q§.col3.y;
            _loc23_ = this.§'Q§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§[H§.x = _loc23_.x;
            this.§[H§.y = _loc23_.y;
            _loc20_.x = this.§[H§.x - _loc19_.x;
            _loc20_.y = this.§[H§.y - _loc19_.y;
            _loc20_.z = this.§[H§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§^!&§.x + _loc20_.z * this.§<Z§.x;
            _loc9_ = _loc20_.x * this.§^!&§.y + _loc20_.z * this.§<Z§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§]<§)
         {
            ...
            if(b2Math.§6!L§(this.§["§ - this.§4u§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§6m§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§6!L§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§4u§)
            {
               _loc19_ = b2Math.§6m§(_loc35_ - this.§4u§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§4u§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§["§)
            {
               _loc19_ = b2Math.§6m§(_loc35_ - this.§["§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         var _loc31_:Number = _loc28_.x * this.§^!&§.x + _loc28_.z * this.§<Z§.x;
         var _loc32_:Number = _loc28_.x * this.§^!&§.y + _loc28_.z * this.§<Z§.y;
         ...
         _loc6_.x -= b2internal::9g * _loc31_;
         _loc6_.y -= b2internal::9g * _loc32_;
         _loc7_ -= b2internal::%!S * _loc33_;
         _loc8_.x += b2internal::#t * _loc31_;
         _loc8_.y += b2internal::#t * _loc32_;
         _loc9_ += b2internal::2e * _loc34_;
