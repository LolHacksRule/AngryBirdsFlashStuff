package §`!^§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§ !e§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §6!B§(param1:Number) : Boolean
      {
      ...
      public static function §10§(param1:b2Vec2, param2:Number) : b2Vec2
      {
      ...
      public static function §'Y§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         ...
         _loc3_ = §]!I§(param1.R,param2);
         _loc3_.x += param1.position.x;
         _loc3_.y += param1.position.y;
         return _loc3_;
      }
      
      public static function §9!c§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
      ...
      public static function §7!9§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §=V§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§ !e§(§>o§(param1.col1,param2.col1),§>o§(param1.col2,param2.col2));
      }
      
      public static function §%e§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§ !e§(§]!I§(param1,param2.col1),§]!I§(param1,param2.col2));
      }
      ...
      public static function §%m§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         ...
         return b2Mat22.§ !e§(_loc3_,_loc4_);
      }
      ...
      {
         return new b2Vec2(§6!L§(param1.x),§6!L§(param1.y));
      }
      
      public static function §=-§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§ !e§(§-%§(param1.col1),§-%§(param1.col2));
      }
      ...
      public static function §6m§(param1:Number, param2:Number, param3:Number) : Number
      {
         return param1 < param2 ? Number(param2) : (param1 > param3 ? Number(param3) : Number(param1));
      }
      
      public static function §=i§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §&1§(param2,§9,§(param1,param3));
      }
      ...
      public static function §!V§(param1:uint) : uint
      {
