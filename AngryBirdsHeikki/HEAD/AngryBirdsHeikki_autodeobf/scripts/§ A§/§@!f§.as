package § A§
{
   ...
   public class §@!f§
   {
      ...
      {
         §=!-§[§=!-§.length] = new §68§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13);
      }
      
      public static function §6r§(param1:String) : §68§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §=!-§.length)
         {
            if(§68§(§=!-§[_loc2_]).mName.toLowerCase() == param1.toLowerCase())
            {
               return §68§(§=!-§[_loc2_]);
            }
            _loc2_++;
