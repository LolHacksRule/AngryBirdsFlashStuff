package §%E§
{
   ...
   class b2PositionSolverManifold
   {
      ...
      public function §9!M§(param1:b2ContactConstraint) : void
      {
         var _loc2_:int = 0;
         ...
         {
            case b2Manifold.§=;§:
               _loc5_ = param1.§1!V§.m_xf.R;
               _loc6_ = param1.localPoint;
               _loc9_ = param1.§1!V§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc10_ = param1.§1!V§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               _loc5_ = param1.§;!?§.m_xf.R;
               _loc6_ = param1.§-Z§[0].localPoint;
               ...
               this.§0F§[0].x = 0.5 * (_loc9_ + _loc11_);
               this.§0F§[0].y = 0.5 * (_loc10_ + _loc12_);
            ...
            case b2Manifold.§@!A§:
               ...
               _loc5_ = param1.§1!V§.m_xf.R;
               _loc6_ = param1.localPoint;
               _loc7_ = param1.§1!V§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc8_ = param1.§1!V§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               _loc5_ = param1.§;!?§.m_xf.R;
               _loc2_ = 0;
               while(_loc2_ < param1.§++§)
               {
                  _loc6_ = param1.§-Z§[_loc2_].localPoint;
                  ...
                  this.§0F§[_loc2_].x = _loc3_;
                  this.§0F§[_loc2_].y = _loc4_;
                  _loc2_++;
               }
               break;
            case b2Manifold.§ e§:
               ...
               {
                  _loc6_ = param1.§-Z§[_loc2_].localPoint;
                  _loc3_ = param1.§1!V§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
                  _loc4_ = param1.§1!V§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
                  this.§&!%§[_loc2_] = (_loc3_ - _loc7_) * this.§-0§.x + (_loc4_ - _loc8_) * this.§-0§.y - param1.radius;
                  this.§0F§[_loc2_].Set(_loc3_,_loc4_);
                  _loc2_++;
               }
               this.§-0§.x *= -1;
               this.§-0§.y *= -1;
