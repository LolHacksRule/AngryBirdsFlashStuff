package §#r§
{
   ...
   public class §'!0§
   {
      ...
      public static function §14§(param1:String) : String
      {
         var _loc2_:Array = createBlocksFromString(param1);
         var _loc3_:ByteArray = §58§(_loc2_);
         return §7o§.§=!U§(_loc3_.readInt(),true) + §7o§.§=!U§(_loc3_.readInt(),true) + §7o§.§=!U§(_loc3_.readInt(),true) + §7o§.§=!U§(_loc3_.readInt(),true) + §7o§.§=!U§(_loc3_.readInt(),true);
      }
      
      public static function §%![§(param1:ByteArray) : String
      {
         var _loc2_:Array = §'!0§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §58§(_loc2_);
         return §7o§.§=!U§(_loc3_.readInt(),true) + §7o§.§=!U§(_loc3_.readInt(),true) + §7o§.§=!U§(_loc3_.readInt(),true) + §7o§.§=!U§(_loc3_.readInt(),true) + §7o§.§=!U§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §'!0§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §58§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
      ...
      private static function §58§(param1:Array) : ByteArray
      {
         var _loc9_:* = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
