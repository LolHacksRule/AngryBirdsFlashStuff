package §`!Q§
{
   ...
   public class §&;§
   {
      ...
      private static var §6k§:Array = §6Z§();
      ...
      private static function §6Z§() : Array
      {
         var _loc2_:uint = 0;
         var _loc3_:uint = 0;
         var _loc4_:uint = 0;
      ...
      public static function §0z§(param1:ByteArray, param2:uint = 0, param3:uint = 0) : uint
      {
         var _loc4_:uint = 0;
         ...
         while(_loc4_ < param3)
         {
            _loc5_ = uint(§6k§[(_loc5_ ^ param1[_loc4_]) & 255]) ^ _loc5_ >>> 8;
            _loc4_++;
         }
