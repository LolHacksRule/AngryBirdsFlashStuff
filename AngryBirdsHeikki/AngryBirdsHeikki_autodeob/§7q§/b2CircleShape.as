package §7q§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if(0 <= _loc15_ && _loc15_ <= param2.§!!O§ * _loc13_)
         {
            _loc15_ /= _loc13_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§?`§.Set(_loc4_ - b2internal::'m,_loc5_ - b2internal::'m);
         param1.§[O§.Set(_loc4_ + b2internal::'m,_loc5_ + b2internal::'m);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§9h§ = param2 * b2Settings.b2_pi * b2internal::'m * b2internal::'m;
         param1.center.SetV(this.§7]§);
         param1.§5!W§ = param1.§9h§ * (0.5 * b2internal::'m * b2internal::'m + (this.§7]§.x * this.§7]§.x + this.§7]§.y * this.§7]§.y));
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.§[!N§(param1,_loc5_) - param2)) < -b2internal::'m + Number.MIN_VALUE)
         {
            return 0;
         }
