         ...
         switch(param1.§2!]§)
         {
            case b2Manifold.§;N§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§4e§.x = _loc19_ / _loc26_;
                  this.§4e§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§4e§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§4e§.x;
               _loc23_ = _loc16_ + param3 * this.§4e§.y;
               _loc24_ = _loc17_ - param5 * this.§4e§.x;
               _loc25_ = _loc18_ - param5 * this.§4e§.y;
