package §`!E§
{
   ...
   public class b2Collision
   {
      ...
      private static var §>P§:Vector.<int> = new Vector.<int>(1);
      
      private static var §#b§:b2Vec2 = new b2Vec2();
      
      private static var §<!^§:b2Vec2 = new b2Vec2();
      
      private static var §5!Z§:b2Vec2 = new b2Vec2();
      
      private static var §0E§:b2Vec2 = new b2Vec2();
      ...
      public static function §5!J§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
      ...
      public static function §;W§(param1:Vector.<§ !,§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
      ...
      private static function §'?§() : Vector.<§ !,§>
      {
      ...
      public static function §1!Q§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§ !,§ = null;
         ...
         var _loc8_:int = 0;
         §,e§[0] = _loc8_;
         var _loc9_:Number = §5!J§(§,e§,param2,param3,param4,param5);
         _loc8_ = §,e§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §>P§[0] = _loc10_;
         var _loc11_:Number = §5!J§(§>P§,param4,param5,param2,param3);
         _loc10_ = §>P§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§%P§ = b2Manifold.§ b§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§ !,§> = §]!T§;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §#b§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §<!^§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §5!Z§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
      ...
      public static function §9!7§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§%P§ = b2Manifold.§`F§;
         param1.m_localPoint.SetV(param2.§>!D§);
         param1.§'O§.§0'§();
         param1.§+#§ = 1;
         param1.§!&§[0].m_localPoint.SetV(param4.§>!D§);
         param1.§!&§[0].m_id.key = 0;
      }
