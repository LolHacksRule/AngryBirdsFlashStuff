package §`!E§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §8!6§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§%P§)
         {
            case b2Manifold.§`F§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§,!P§.x = _loc19_ / _loc26_;
                  this.§,!P§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§,!P§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§,!P§.x;
               _loc23_ = _loc16_ + param3 * this.§,!P§.y;
               _loc24_ = _loc17_ - param5 * this.§,!P§.x;
               _loc25_ = _loc18_ - param5 * this.§,!P§.y;
