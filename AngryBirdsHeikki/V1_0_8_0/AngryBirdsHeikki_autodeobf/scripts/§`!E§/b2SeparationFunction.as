package §`!E§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §8!6§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§%P§ = §<H§;
            _loc7_ = this.§-!a§.§+N§(param1.indexA[0]);
            _loc10_ = this.§,k§.§+N§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§]F§.x = _loc15_ - _loc13_;
            this.§]F§.y = _loc16_ - _loc14_;
            this.§]F§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§%P§ = § b§;
            _loc8_ = this.§-!a§.§+N§(param1.indexA[0]);
            _loc9_ = this.§-!a§.§+N§(param1.indexA[1]);
            _loc10_ = this.§,k§.§+N§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§]F§ = b2Math.§9;§(b2Math.§2V§(_loc9_,_loc8_),1);
            this.§]F§.Normalize();
            _loc20_ = this.§]F§;
         ...
         {
            this.§%P§ = §6a§;
            _loc11_ = this.§,k§.§+N§(param1.indexB[0]);
            _loc12_ = this.§,k§.§+N§(param1.indexB[1]);
            _loc7_ = this.§-!a§.§+N§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§]F§ = b2Math.§9;§(b2Math.§2V§(_loc12_,_loc11_),1);
            this.§]F§.Normalize();
            _loc20_ = this.§]F§;
         ...
         else
         {
            ...
            _loc11_ = this.§,k§.§+N§(param1.indexB[0]);
            _loc12_ = this.§,k§.§+N§(param1.indexB[1]);
            _loc23_ = b2Math.§]!O§(param3,_loc7_);
            _loc24_ = b2Math.§3D§(param3.R,b2Math.§2V§(_loc9_,_loc8_));
            _loc25_ = b2Math.§]!O§(param5,_loc10_);
            _loc26_ = b2Math.§3D§(param5.R,b2Math.§2V§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§2V§(_loc26_,_loc24_);
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §<H§:
               _loc3_ = b2Math.§"!O§(param1.R,this.§]F§);
               _loc4_ = b2Math.§"!O§(param2.R,this.§]F§.§,!e§());
               _loc5_ = this.§-!a§.§%K§(_loc3_);
               _loc6_ = this.§,k§.§%K§(_loc4_);
               _loc7_ = b2Math.§]!O§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§]!O§(param2,_loc6_)).x - _loc7_.x) * this.§]F§.x + (_loc8_.y - _loc7_.y) * this.§]F§.y);
            case § b§:
               _loc10_ = b2Math.§3D§(param1.R,this.§]F§);
               _loc7_ = b2Math.§]!O§(param1,this.m_localPoint);
               _loc4_ = b2Math.§"!O§(param2.R,_loc10_.§,!e§());
               _loc6_ = this.§,k§.§%K§(_loc4_);
               return Number(((_loc8_ = b2Math.§]!O§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §6a§:
               _loc10_ = b2Math.§3D§(param2.R,this.§]F§);
               _loc8_ = b2Math.§]!O§(param2,this.m_localPoint);
               _loc3_ = b2Math.§"!O§(param1.R,_loc10_.§,!e§());
               _loc5_ = this.§-!a§.§%K§(_loc3_);
               return Number(((_loc7_ = b2Math.§]!O§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
