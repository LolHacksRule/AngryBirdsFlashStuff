package §;!U§
{
   ...
   class b2PositionSolverManifold
   {
      ...
      public var §;K§:Vector.<Number>;
      
      function b2PositionSolverManifold()
      {
         super();
         this.§,!P§ = new b2Vec2();
         this.§;K§ = new Vector.<Number>(b2Settings.b2_maxManifoldPoints);
      ...
      public function §8!6§(param1:b2ContactConstraint) : void
      {
         var _loc2_:int = 0;
         ...
         switch(param1.type)
         {
            case b2Manifold.§`F§:
               ...
               if((_loc15_ = _loc13_ * _loc13_ + _loc14_ * _loc14_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§,!P§.x = _loc13_ / _loc16_;
                  this.§,!P§.y = _loc14_ / _loc16_;
               }
               else
               {
                  this.§,!P§.x = 1;
               ...
               this.§;K§[0] = _loc13_ * this.§,!P§.x + _loc14_ * this.§,!P§.y - param1.radius;
               break;
            case b2Manifold.§ b§:
               _loc5_ = param1.§?$§.m_xf.R;
               _loc6_ = param1.§"!L§;
               this.§,!P§.x = _loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y;
               this.§,!P§.y = _loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y;
               _loc5_ = param1.§?$§.m_xf.R;
               _loc6_ = param1.localPoint;
               ...
               while(_loc2_ < param1.§[=§)
               {
                  ...
                  this.§;K§[_loc2_] = (_loc3_ - _loc7_) * this.§,!P§.x + (_loc4_ - _loc8_) * this.§,!P§.y - param1.radius;
