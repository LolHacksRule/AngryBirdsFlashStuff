package §;!U§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §'!J§:b2WorldManifold = new b2WorldManifold();
      ...
      b2internal var §'!T§:Vector.<b2ContactConstraint>;
      ...
      {
         this.§<<§ = new b2TimeStep();
         this.§'!T§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §8!6§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§;B§ = param4;
         this.§&u§ = param3;
         while(this.§'!T§.length < this.§&u§)
         {
            this.§'!T§[this.§'!T§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            ...
            §'!J§.§8!6§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §'!J§.§,!P§.x;
            _loc27_ = §'!J§.§,!P§.y;
            (_loc28_ = this.§'!T§[_loc6_]).§?$§ = _loc15_;
            _loc28_.§%!§ = _loc16_;
            _loc28_.§8@§ = _loc17_;
            ...
            _loc28_.§"!L§.x = _loc17_.§'O§.x;
            _loc28_.§"!L§.y = _loc17_.§'O§.y;
            _loc28_.localPoint.x = _loc17_.m_localPoint.x;
            _loc28_.localPoint.y = _loc17_.m_localPoint.y;
            _loc28_.radius = _loc13_ + _loc14_;
            _loc28_.type = _loc17_.§%P§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§[=§)
            {
               _loc30_ = _loc17_.§!&§[_loc29_];
               (_loc31_ = _loc28_.§#!8§[_loc29_]).normalImpulse = _loc30_.§;!=§;
               _loc31_.tangentImpulse = _loc30_.§@!7§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§#! §.x = §'!J§.§!&§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§#! §.y = §'!J§.§!&§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§4M§.x = §'!J§.§!&§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§4M§.y = §'!J§.§!&§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§!q§ + _loc16_.§!q§ + _loc15_.§&!Y§ * _loc36_ + _loc16_.§&!Y§ * _loc37_;
               _loc31_.§?0§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§[J§ * _loc15_.§!q§ + _loc16_.§[J§ * _loc16_.§!q§) + (_loc15_.§[J§ * _loc15_.§&!Y§ * _loc36_ + _loc16_.§[J§ * _loc16_.§&!Y§ * _loc37_);
               _loc31_.§ !7§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§!q§ + _loc16_.§!q§ + _loc15_.§&!Y§ * _loc42_ + _loc16_.§&!Y§ * _loc43_;
               _loc31_.§8!1§ = 1 / _loc44_;
               _loc31_.§10§ = 0;
               ...
               {
                  _loc31_.§10§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§[=§ == 2)
            {
               ...
               _loc55_ = _loc48_.§4M§.x * _loc27_ - _loc48_.§4M§.y * _loc26_;
               _loc56_ = _loc49_.§#! §.x * _loc27_ - _loc49_.§#! §.y * _loc26_;
               _loc57_ = _loc49_.§4M§.x * _loc27_ - _loc49_.§4M§.y * _loc26_;
               ...
               {
                  _loc28_.§6_§.col1.Set(_loc58_,_loc60_);
                  _loc28_.§6_§.col2.Set(_loc60_,_loc59_);
                  _loc28_.§6_§.§;+§(_loc28_.§?0§);
               }
               else
               {
                  _loc28_.§[=§ = 1;
         ...
         while(_loc5_ < this.§&u§)
         {
            ...
            if(param1.§7U§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc20_.normalImpulse *= param1.§1J§;
                  _loc20_.tangentImpulse *= param1.§1J§;
                  ...
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§4M§.x * _loc22_ - _loc20_.§4M§.y * _loc21_);
            ...
            else
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  (_loc23_ = _loc6_.§#!8§[_loc18_]).normalImpulse = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         {
            _loc26_ = (_loc25_ = this.§'!T§[_loc24_]).§?$§;
            _loc27_ = _loc25_.§%!§;
            ...
            while(_loc1_ < _loc25_.§[=§)
            {
               ...
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§4M§.y - _loc30_.x + _loc28_ * _loc2_.§#! §.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§4M§.x - _loc30_.y - _loc28_ * _loc2_.§#! §.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§8!1§ * -_loc10_;
               ...
               _loc29_ += _loc35_ * (_loc2_.§4M§.x * _loc15_ - _loc2_.§4M§.y * _loc14_);
            ...
            if(_loc25_.§[=§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§?0§ * (_loc9_ - _loc2_.§10§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§4M§.y - _loc30_.x + _loc28_ * _loc43_.§#! §.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§4M§.x - _loc30_.y - _loc28_ * _loc43_.§#! §.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§4M§.y - _loc30_.x + _loc28_ * _loc44_.§#! §.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§4M§.x - _loc30_.y - _loc28_ * _loc44_.§#! §.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§10§;
               _loc54_ = _loc52_ - _loc44_.§10§;
               _loc22_ = _loc25_.§6_§;
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc29_ += _loc35_ * (_loc43_.§4M§.x * _loc19_ - _loc43_.§4M§.y * _loc18_ + _loc44_.§4M§.x * _loc21_ - _loc44_.§4M§.y * _loc20_);
               ...
               else
               {
                  ...
                  _loc57_ = 0;
                  _loc51_ = 0;
                  _loc52_ = _loc25_.§6_§.col1.y * _loc56_ + _loc54_;
                  ...
                  else
                  {
                     ...
                     _loc51_ = _loc25_.§6_§.col2.x * _loc57_ + _loc53_;
                     _loc52_ = 0;
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§&u§)
         {
            _loc5_ = (_loc4_ = this.§'!T§[_loc3_]).§?$§;
            _loc6_ = _loc4_.§%!§;
            _loc7_ = _loc5_.§[J§ * _loc5_.§!q§;
            _loc8_ = _loc5_.§[J§ * _loc5_.§&!Y§;
            _loc9_ = _loc6_.§[J§ * _loc6_.§!q§;
            _loc10_ = _loc6_.§[J§ * _loc6_.§&!Y§;
            §`e§.§8!6§(_loc4_);
            _loc11_ = §`e§.§,!P§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§[=§)
            {
               ...
               _loc22_ = (_loc21_ = -_loc13_.§ !7§ * _loc20_) * _loc11_.x;
