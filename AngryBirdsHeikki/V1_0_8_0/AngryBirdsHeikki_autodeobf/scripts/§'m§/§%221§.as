package §'m§
{
   ...
   public class §"1§
   {
      ...
      public static function §%O§(param1:String) : String
      {
         ...
         return §1!§.§?!d§(_loc3_.readInt(),true) + §1!§.§?!d§(_loc3_.readInt(),true) + §1!§.§?!d§(_loc3_.readInt(),true) + §1!§.§?!d§(_loc3_.readInt(),true) + §1!§.§?!d§(_loc3_.readInt(),true);
      }
      
      public static function §]!4§(param1:ByteArray) : String
      {
         var _loc2_:Array = §"1§.createBlocksFromByteArray(param1);
         var _loc3_:ByteArray = §8!§(_loc2_);
         return §1!§.§?!d§(_loc3_.readInt(),true) + §1!§.§?!d§(_loc3_.readInt(),true) + §1!§.§?!d§(_loc3_.readInt(),true) + §1!§.§?!d§(_loc3_.readInt(),true) + §1!§.§?!d§(_loc3_.readInt(),true);
      }
      ...
      {
         var _loc7_:uint = 0;
         var _loc2_:Array = §"1§.createBlocksFromString(param1);
         var _loc3_:ByteArray = §8!§(_loc2_);
         var _loc4_:String = "";
         _loc3_.position = 0;
         var _loc5_:int = 0;
