package § !3§
{
   ...
   public class Base64
   {
      ...
      private static const §@6§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §1!$§(param1:String) : ByteArray
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §@6§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
