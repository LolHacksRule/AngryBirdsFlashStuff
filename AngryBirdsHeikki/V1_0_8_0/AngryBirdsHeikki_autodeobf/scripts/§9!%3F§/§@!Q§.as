package §9!?§
{
   public class §@!Q§
   {
      ...
      public static function §8L§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
      ...
      private static function §6§(param1:String, param2:Boolean) : String
      {
