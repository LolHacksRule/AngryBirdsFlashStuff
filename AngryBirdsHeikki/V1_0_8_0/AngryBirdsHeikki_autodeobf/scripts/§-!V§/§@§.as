package §-!V§
{
   ...
   public class §@§ extends §-!'§
   {
      ...
      public function §@§(param1:XML, param2:§@§, param3:§"$§, param4:MovieClip = null)
      {
         ...
         {
            this.§@!^§.push(new §'J§(_loc7_,this));
         }
         for each(_loc8_ in param1.TextField)
         {
            this.§@!^§.push(new §+V§(_loc8_,this));
         }
         for each(_loc9_ in param1.MovieClip)
         {
            this.§@!^§.push(new §+!T§(_loc9_,this));
         }
      ...
      public function containerEventOccured(param1:int, param2:String, param3:§4!I§) : void
      {
         if(mParentContainer)
         {
      ...
      public function §5!C§(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            {
               §!X§.log("WARNING: UIContainer(" + mName + ") setItemVisibility can not be done because item " + param1 + " does not exist");
            }
         }
      }
