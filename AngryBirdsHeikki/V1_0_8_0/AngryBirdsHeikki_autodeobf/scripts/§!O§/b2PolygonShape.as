package §!O§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §,4§:b2Mat22 = new b2Mat22();
      ...
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§4E§(param1,param2);
         return _loc3_;
      }
      
      public static function §5m§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §8w§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
      ...
      public static function §'k§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc3_.§>!+§(_loc9_);
            _loc3_.§>!+§(_loc10_);
            _loc3_.§>!W§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §[!O§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§7X§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§7X§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §%8§(param1:Array, param2:Number = 0) : void
      {
         ...
         this.§4E§(_loc3_,param2);
      }
      
      public function §4E§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§'b§)
         {
            ...
            _loc6_ = b2Math.§2V§(this.§1'§[_loc5_],this.§1'§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§&!T§() > Number.MIN_VALUE);
            this.§4;§[_loc3_].SetV(b2Math.§9;§(_loc6_,1));
            this.§4;§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§ U§ = §'k§(this.§1'§,this.§'b§);
      }
      ...
      public function §+&§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§'b§)
         {
            this.§1'§[_loc6_] = b2Math.§]!O§(_loc5_,this.§1'§[_loc6_]);
            this.§4;§[_loc6_] = b2Math.§3D§(_loc5_.R,this.§4;§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §7!a§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§'b§ = 2;
         this.§'!]§(2);
         ...
         this.§4;§[0] = b2Math.§9;§(b2Math.§2V§(param2,param1),1);
         this.§4;§[0].Normalize();
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§9!^§.x = _loc5_ - b2internal::]!5;
         param1.§9!^§.y = _loc6_ - b2internal::]!5;
         param1.§ I§.x = _loc7_ + b2internal::]!5;
         param1.§ I§.y = _loc8_ + b2internal::]!5;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         while(_loc10_ < this.§'b§)
         {
            ...
            _loc12_ = _loc10_ + 1 < this.§'b§ ? this.§1'§[int(_loc10_ + 1)] : this.§1'§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
         ...
         param1.§6!O§ = param2 * _loc5_;
         _loc3_ *= 1 / _loc5_;
         _loc4_ *= 1 / _loc5_;
         param1.center.Set(_loc3_,_loc4_);
         param1.§9A§ = param2 * _loc6_;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§"!O§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§3!2§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§3!2§(_loc5_,this.§1'§[_loc12_]) - _loc6_;
