package §0!=§
{
   public class b2Mat22
   {
      ...
      public static function §@y§(param1:Number) : b2Mat22
      {
      ...
      public static function §8$§(param1:b2Vec2, param2:b2Vec2) : b2Mat22
      {
      ...
      public function §8G§(param1:b2Mat22) : void
      {
         this.col1.SetV(param1.col1);
         this.col2.SetV(param1.col2);
      }
      
      public function §03§(param1:b2Mat22) : void
      {
      ...
      public function §@L§(param1:b2Vec2, param2:Number, param3:Number) : b2Vec2
      {
