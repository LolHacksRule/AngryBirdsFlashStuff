package §0!=§
{
   public class b2Vec2
   {
      ...
      public function §7!B§(param1:b2Vec2) : void
      {
         this.x -= param1.x;
         this.y -= param1.y;
      }
      ...
      public function §1p§(param1:b2Mat22) : void
      {
         var _loc2_:Number = b2Math.§3!2§(this,param1.col1);
         this.y = b2Math.§3!2§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      {
         return b2Math.§+k§(this.x) && b2Math.§+k§(this.y);
      }
   }
}
