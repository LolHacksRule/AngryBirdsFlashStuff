package §0!=§
{
   public class b2Math
   {
      ...
      public static function §+k§(param1:Number) : Boolean
      {
         return isFinite(param1);
      }
      
      public static function §3!2§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §9;§(param1:b2Vec2, param2:Number) : b2Vec2
      {
         return new b2Vec2(param2 * param1.y,-param2 * param1.x);
      }
      
      public static function §39§(param1:Number, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(-param1 * param2.y,param1 * param2.x);
      }
      
      public static function §3D§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return new b2Vec2(§3!2§(param2,param1.col1),§3!2§(param2,param1.col2));
      }
      
      public static function §]!O§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         _loc3_ = §3D§(param1.R,param2);
      ...
      public static function §=!"§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         ...
         _loc3_ = §2V§(param2,param1.position);
      ...
      public static function §2V§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(param1.x - param2.x,param1.y - param2.y);
      }
      ...
      public static function §9P§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         var _loc3_:Number = param1.x - param2.x;
         var _loc4_:Number = param1.y - param2.y;
      ...
      {
         return b2Mat22.§8$§(§8!+§(param1.col1,param2.col1),§8!+§(param1.col2,param2.col2));
      }
      
      public static function §>6§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§8$§(§3D§(param1,param2.col1),§3D§(param1,param2.col2));
      }
      
      public static function §-W§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§3!2§(param1.col1,param2.col1),§3!2§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§3!2§(param1.col1,param2.col2),§3!2§(param1.col2,param2.col2));
         return b2Mat22.§8$§(_loc3_,_loc4_);
      }
      
      public static function §4B§(param1:Number) : Number
      {
         return param1 > 0 ? Number(param1) : Number(-param1);
      }
      
      public static function §5q§(param1:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§4B§(param1.x),§4B§(param1.y));
      }
      
      public static function §6!>§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§8$§(§5q§(param1.col1),§5q§(param1.col2));
      }
      ...
      {
         return §=J§(param2,§@b§(param1,param3));
      }
      
      public static function §4!U§(param1:Array, param2:Array) : void
      {
         var _loc3_:* = param1[0];
         param1[0] = param2[0];
         param2[0] = _loc3_;
      ...
      public static function §78§(param1:uint) : uint
      {
