package §#!6§
{
   ...
   public class Texture
   {
      ...
      public static function §1;§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §#!6§.Texture
      {
         return §5!7§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §5!7§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §#!6§.Texture
      {
         ...
         _loc10_ = new §1i§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§7[§.§4!R§)
         {
            _loc10_.§19§(param2);
         }
         ...
         return new §3R§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §%!8§(param1:Context3D, param2:ByteArray) : §#!6§.Texture
      {
         if(param1 == null)
         {
            throw new §7!N§();
         ...
         var _loc9_:§1i§ = new §1i§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§7[§.§4!R§)
         {
            _loc9_.§19§(param2);
         }
      ...
      public static function §5@§(param1:§#!6§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §#!6§.Texture
      {
         var _loc4_:§#!6§.Texture;
         (_loc4_ = new §3R§(param1,param2)).§'y§ = param3;
         return _loc4_;
      }
      
      public static function §"o§(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §#!6§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§#!6§.Texture = §5!7§(param1,_loc6_,false,param5);
         if(!§7[§.§4!R§)
         {
            _loc6_.dispose();
         }
      ...
      public function get root() : §#!6§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §#!6§.Texture
      {
         return this;
      }
