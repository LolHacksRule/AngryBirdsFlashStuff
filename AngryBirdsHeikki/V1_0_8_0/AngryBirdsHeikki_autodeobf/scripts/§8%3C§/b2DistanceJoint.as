package §8<§
{
   ...
   public class b2DistanceJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * this.§0$§ * this.§=#§.x,param1 * this.§0$§ * this.§=#§.y);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc13_:Number = _loc4_.§!q§ + _loc4_.§&!Y§ * _loc11_ * _loc11_ + _loc5_.§!q§ + _loc5_.§&!Y§ * _loc12_ * _loc12_;
         this.§[J§ = _loc13_ != 0 ? Number(1 / _loc13_) : Number(0);
         if(this.§>!0§ > 0)
         {
            _loc14_ = _loc10_ - this.§9s§;
            _loc15_ = 2 * Math.PI * this.§>!0§;
            _loc16_ = 2 * this.§[J§ * this.§"!M§ * _loc15_;
            _loc17_ = this.§[J§ * _loc15_ * _loc15_;
            this.§>! § = param1.§<G§ * (_loc16_ + param1.§<G§ * _loc17_);
            this.§>! § = this.§>! § != 0 ? Number(1 / this.§>! §) : Number(0);
            this.§``§ = _loc14_ * param1.§<G§ * _loc17_ * this.§>! §;
            this.§[J§ = _loc13_ + this.§>! §;
         ...
         {
            this.§0$§ *= param1.§1J§;
            _loc18_ = this.§0$§ * this.§=#§.x;
            _loc19_ = this.§0$§ * this.§=#§.y;
            _loc4_.§#P§.x -= _loc4_.§!q§ * _loc18_;
            _loc4_.§#P§.y -= _loc4_.§!q§ * _loc19_;
            _loc4_.m_angularVelocity -= _loc4_.§&!Y§ * (_loc6_ * _loc19_ - _loc7_ * _loc18_);
            _loc5_.§#P§.x += _loc5_.§!q§ * _loc18_;
            _loc5_.§#P§.y += _loc5_.§!q§ * _loc19_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc15_:Number = -this.§[J§ * (_loc14_ + this.§``§ + this.§>! § * this.§0$§);
         this.§0$§ += _loc15_;
         ...
         _loc4_.§#P§.x += _loc4_.§!q§ * _loc16_;
         _loc4_.§#P§.y += _loc4_.§!q§ * _loc17_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         _loc10_ /= _loc12_;
         _loc11_ /= _loc12_;
         var _loc13_:Number = _loc12_ - this.§9s§;
         ...
         _loc3_.§ L§();
         _loc4_.§ L§();
         return b2Math.§4B§(_loc13_) < b2Settings.b2_linearSlop;
      }
   }
}
