package §8<§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §1G§:Number = 2;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§'3§ = b2internal::?2.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§?!§.x - this.§'3§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§?!§.y - this.§'3§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§&-§.x - this.§'3§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§&-§.y - this.§'3§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§@!T§);
         this.m_localAnchor2.SetV(param1.§,!;§);
         this.§`4§ = param1.§9!Y§;
         this.§,S§ = param1.§,8§ + this.§`4§ * param1.§6!H§;
         this.m_maxLength1 = b2Math.§]!F§(param1.§#&§,this.§,S§ - this.§`4§ * b2internal::1G);
         this.m_maxLength2 = b2Math.§]!F§(param1.§"Z§,(this.§,S§ - b2internal::1G) / this.§`4§);
         this.§0$§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§0$§ * this.m_u2.x,param1 * this.§0$§ * this.m_u2.y);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc18_:Number = this.m_u1.§6<§();
         var _loc19_:Number = this.m_u2.§6<§();
         if(_loc18_ > b2Settings.b2_linearSlop)
         {
            this.m_u1.§>!W§(1 / _loc18_);
         }
         else
         {
            this.m_u1.§0'§();
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§,S§ - _loc18_ - this.§`4§ * _loc19_) > 0)
         {
            this.§6%§ = b2internal::5s;
            this.§0$§ = 0;
         }
         else
         {
         ...
         {
            this.m_limitState1 = b2internal::5s;
            this.m_limitImpulse1 = 0;
         }
         else
         {
         ...
         {
            this.m_limitState2 = b2internal::5s;
            this.m_limitImpulse2 = 0;
         }
         else
         {
         ...
         this.m_limitMass1 = _loc2_.§!q§ + _loc2_.§&!Y§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§!q§ + _loc3_.§&!Y§ * _loc22_ * _loc22_;
         this.§6d§ = this.m_limitMass1 + this.§`4§ * this.§`4§ * this.m_limitMass2;
         ...
         {
            this.§0$§ *= param1.§1J§;
            this.m_limitImpulse1 *= param1.§1J§;
            this.m_limitImpulse2 *= param1.§1J§;
            _loc23_ = (-this.§0$§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§0$§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§`4§ * this.§0$§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§`4§ * this.§0$§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§#P§.x += _loc2_.§!q§ * _loc23_;
            _loc2_.§#P§.y += _loc2_.§!q§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§&!Y§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§#P§.x += _loc3_.§!q§ * _loc25_;
            _loc3_.§#P§.y += _loc3_.§!q§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§6%§ == b2internal::^!T)
         {
            ...
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§`4§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§6d§ * -_loc18_;
            _loc20_ = this.§0$§;
            this.§0$§ = b2Math.§`!d§(0,this.§0$§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§0$§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§`4§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§`4§ * _loc19_ * this.m_u2.y;
            _loc2_.§#P§.x += _loc2_.§!q§ * _loc14_;
            _loc2_.§#P§.y += _loc2_.§!q§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§&!Y§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§#P§.x += _loc3_.§!q§ * _loc16_;
            _loc3_.§#P§.y += _loc3_.§!q§ * _loc17_;
         ...
         if(this.m_limitState1 == b2internal::^!T)
         {
            ...
            this.m_limitImpulse1 = b2Math.§`!d§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == b2internal::^!T)
         {
            ...
            this.m_limitImpulse2 = b2Math.§`!d§(0,this.m_limitImpulse2 + _loc19_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§6%§ == b2internal::^!T)
         {
            ...
            if(_loc18_ > b2Settings.b2_linearSlop)
            {
               this.m_u2.§>!W§(1 / _loc18_);
            }
            else
            {
               this.m_u2.§0'§();
            }
            _loc19_ = this.§,S§ - _loc17_ - this.§`4§ * _loc18_;
            _loc24_ = b2Math.§`!d§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§%%§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§6d§ * _loc19_) * this.m_u1.x;
            _loc14_ = -_loc20_ * this.m_u1.y;
            _loc15_ = -this.§`4§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§`4§ * _loc20_ * this.m_u2.y;
            _loc2_.m_sweep.c.x += _loc2_.§!q§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§!q§ * _loc14_;
         ...
         if(this.m_limitState1 == b2internal::^!T)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§6<§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::^!T)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§6<§()) > b2Settings.b2_linearSlop)
            {
