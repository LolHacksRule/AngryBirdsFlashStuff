   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§7U§)
         {
            ...
            this.§0$§.y *= param1.§1J§;
            this.§0$§.z *= param1.§1J§;
            _loc4_.§#P§.x -= _loc10_ * this.§0$§.x;
            _loc4_.§#P§.y -= _loc10_ * this.§0$§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§0$§.y - _loc7_ * this.§0$§.x + this.§0$§.z);
            _loc5_.§#P§.x += _loc11_ * this.§0$§.x;
            _loc5_.§#P§.y += _loc11_ * this.§0$§.y;
            _loc5_.m_angularVelocity += _loc13_ * (_loc8_ * this.§0$§.y - _loc9_ * this.§0$§.x + this.§0$§.z);
         }
         else
         {
            this.§0$§.§0'§();
