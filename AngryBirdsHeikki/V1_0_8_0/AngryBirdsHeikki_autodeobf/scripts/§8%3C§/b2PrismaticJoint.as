package §8<§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§0$§.x * this.§'7§.x + (this.§case § + this.§0$§.z) * this.§]F§.x),param1 * (this.§0$§.x * this.§'7§.y + (this.§case § + this.§0$§.z) * this.§]F§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§7U§)
         {
            ...
            this.§0$§.y *= param1.§1J§;
            this.§case § *= param1.§1J§;
            _loc19_ = this.§0$§.x * this.§'7§.x + (this.§case § + this.§0$§.z) * this.§]F§.x;
            _loc20_ = this.§0$§.x * this.§'7§.y + (this.§case § + this.§0$§.z) * this.§]F§.y;
            _loc21_ = this.§0$§.x * this.m_s1 + this.§0$§.y + (this.§case § + this.§0$§.z) * this.m_a1;
            _loc22_ = this.§0$§.x * this.m_s2 + this.§0$§.y + (this.§case § + this.§0$§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§]F§.x * (_loc6_.x - _loc4_.x) + this.§]F§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§%U§ * (this.§5A§ - _loc14_);
            _loc16_ = this.§case §;
            _loc17_ = param1.§<G§ * this.§+K§;
            this.§case § = b2Math.§%%§(this.§case § + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§case § - _loc16_) * this.§]F§.x;
            _loc9_ = _loc15_ * this.§]F§.y;
         ...
         {
            _loc18_ = this.§]F§.x * (_loc6_.x - _loc4_.x) + this.§]F§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§0$§.Copy();
            _loc20_ = this.§-U§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§0$§.§>!+§(_loc20_);
            if(this.§!!7§ == b2internal::[<)
            {
               this.§0$§.z = b2Math.§`!d§(this.§0$§.z,0);
            }
            else if(this.§!!7§ == b2internal::^!T)
            {
               this.§0$§.z = b2Math.§]!F§(this.§0$§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§0$§.z - _loc19_.z) * this.§-U§.col3.x;
            _loc22_ = -_loc13_ - (this.§0$§.z - _loc19_.z) * this.§-U§.col3.y;
            _loc23_ = this.§-U§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§0$§.x = _loc23_.x;
            this.§0$§.y = _loc23_.y;
            _loc20_.x = this.§0$§.x - _loc19_.x;
            _loc20_.y = this.§0$§.y - _loc19_.y;
            _loc20_.z = this.§0$§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§'7§.x + _loc20_.z * this.§]F§.x;
            _loc9_ = _loc20_.x * this.§'7§.y + _loc20_.z * this.§]F§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§=!C§)
         {
            ...
            _loc35_ = this.§]F§.x * _loc26_ + this.§]F§.y * _loc27_;
            if(b2Math.§4B§(this.§5k§ - this.§3g§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§%%§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§4B§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§3g§)
            {
               _loc19_ = b2Math.§%%§(_loc35_ - this.§3g§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§3g§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§5k§)
            {
               _loc19_ = b2Math.§%%§(_loc35_ - this.§5k§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§5k§;
               _loc18_ = true;
            }
         }
         ...
         var _loc31_:Number = _loc28_.x * this.§'7§.x + _loc28_.z * this.§]F§.x;
         var _loc32_:Number = _loc28_.x * this.§'7§.y + _loc28_.z * this.§]F§.y;
         ...
         _loc7_ -= b2internal::?!c * _loc33_;
         _loc8_.x += b2internal:: f * _loc31_;
         _loc8_.y += b2internal:: f * _loc32_;
