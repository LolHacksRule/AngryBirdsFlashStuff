package §?!R§
{
   ...
   public class §,9§ extends §2!L§
   {
      ...
      public static function §;s§(param1:§2!L§) : §,9§
      {
         var _loc2_:§,9§ = new §,9§(param1.type,param1.index1,param1.index2,param1.point1,param1.point2,param1.§]!!§,param1.§&!V§,param1.lowerLimit,param1.upperLimit,param1.§"J§,param1.motorSpeed,param1.§<!>§,param1.maxTorque);
         _loc2_.§1!S§ = param1.§1!S§;
