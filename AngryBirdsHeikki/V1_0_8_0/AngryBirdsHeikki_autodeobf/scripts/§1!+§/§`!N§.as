package §1!+§
{
   public class §`!N§
   {
      ...
      public function §`!N§(param1:String, param2:XMLList, param3:Number, param4:Number, param5:String, param6:String, param7:Number, param8:String, param9:Number, param10:String)
      {
      ...
      {
         this.§3!L§[this.§3!L§.length] = new §-'§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13,param14,param15,param16,param17);
      }
      
      public function §5I§() : Number
      {
         return this.§4!8§;
      }
   }
