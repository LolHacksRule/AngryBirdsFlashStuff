package §2!"§
{
   ...
   public class §"b§
   {
      ...
      {
         §`!@§[§`!@§.length] = new §8y§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13);
      }
      
      public static function §2p§(param1:String) : §8y§
      {
         var _loc2_:int = 0;
         while(_loc2_ < §`!@§.length)
         {
            if(§8y§(§`!@§[_loc2_]).mName.toLowerCase() == param1.toLowerCase())
            {
               return §8y§(§`!@§[_loc2_]);
            }
            _loc2_++;
         }
         §^S§.log("WARNING: LevelItemResourcePaths -> getResourcePathSound request has no return value, this path does not exist: " + param1);
         return null;
      }
   }
}
