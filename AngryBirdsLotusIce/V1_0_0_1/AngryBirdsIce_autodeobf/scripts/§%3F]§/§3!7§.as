package §?]§
{
   ...
   public class §3!7§
   {
      ...
      private static var §for§:Array = §6!8§();
      ...
      private static function §6!8§() : Array
      {
         var _loc2_:uint = 0;
         var _loc3_:uint = 0;
         var _loc4_:uint = 0;
      ...
      public static function §"B§(param1:ByteArray, param2:uint = 0, param3:uint = 0) : uint
      {
         var _loc4_:uint = 0;
         ...
         while(_loc4_ < param3)
         {
            _loc5_ = uint(§for§[(_loc5_ ^ param1[_loc4_]) & 255]) ^ _loc5_ >>> 8;
            _loc4_++;
         }
         return _loc5_ ^ 4294967295;
      }
      
      public static function §[G§(param1:ByteArray, param2:uint = 0, param3:uint = 0) : uint
      {
         if(param2 >= param1.length)
         {
            param2 = param1.length;
