package §'m§
{
   ...
   public class Base64
   {
      ...
      private static const §9P§:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
      ...
      public static function §[_§(param1:ByteArray) : String
      {
         ...
         while(param1.bytesAvailable > 0)
         {
            ...
            {
               _loc2_ += §9P§.charAt(_loc4_[_loc7_]);
               _loc7_++;
            }
         }
         return _loc2_;
      ...
      public static function §;y§(param1:String) : ByteArray
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_] = §9P§.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
