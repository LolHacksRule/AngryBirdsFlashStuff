package §in§
{
   ...
   public class §]R§ extends §%K§
   {
      ...
      public function §]R§(param1:XML, param2:§,1§, param3:MovieClip = null)
      {
         var cls:Class = null;
      ...
      private function §'z§() : void
      {
         if(!this.§[g§)
         {
            this.§[g§ = new § !;§(this.x,this.y,this.mClip.scaleX,this.mClip.scaleY,this.§]]§,this.§,`§,this.§6>§,this.§",§,this.§13§,this.§2!'§,this.§`!&§,this.§>!%§);
         }
         this.§[g§.§5w§(this.§!!1§,this.§5#§);
      ...
      private function §break§(param1:XML) : void
      {
         ...
         else
         {
            ...
            if(_loc3_ == 0)
            {
               this.§5#§ = this.mParentContainer.viewHeight;
            }
            else
            {
               this.§5#§ = _loc3_;
      ...
      {
         this.§9I§ = param1;
         this.mClip.visible = this.§9I§ && this.§57§;
         if(this.visible)
         {
            addEventListeners();
         }
