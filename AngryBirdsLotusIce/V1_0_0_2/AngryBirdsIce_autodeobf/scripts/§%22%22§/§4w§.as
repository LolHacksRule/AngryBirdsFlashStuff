package §""§
{
   ...
   public class §4w§
   {
      ...
      public static const §6A§:String = "linear";
      ...
      public static const §2!1§:String = "easeInBack";
      
      public static const §9o§:String = "easeOutBack";
      
      public static const §0i§:String = "easeInOutBack";
      
      public static const §;e§:String = "easeOutInBack";
      
      public static const §0!-§:String = "easeInElastic";
      
      public static const §`h§:String = "easeOutElastic";
      
      public static const §1!?§:String = "easeInOutElastic";
      
      public static const §'P§:String = "easeOutInElastic";
      
      public static const §[9§:String = "easeInBounce";
      
      public static const §-z§:String = "easeOutBounce";
      
      public static const §<V§:String = "easeInOutBounce";
      
      public static const §1!9§:String = "easeOutInBounce";
      ...
      public static function §9i§(param1:String, param2:Function) : void
      {
         if(§+X§ == null)
         {
            §<!4§();
      ...
      private static function §<!4§() : void
      {
         ...
         §9i§(§0!-§,easeInElastic);
         §9i§(§`h§,easeOutElastic);
         §9i§(§1!?§,easeInOutElastic);
         §9i§(§'P§,easeOutInElastic);
         §9i§(§[9§,easeInBounce);
         §9i§(§-z§,easeOutBounce);
         §9i§(§<V§,easeInOutBounce);
         §9i§(§1!9§,easeOutInBounce);
      }
