package §`6§
{
   ...
   public class § try§ extends §'o§
   {
      ...
      public function § try§(param1:Object, param2:BitmapData)
      {
         super(param2);
         this.§1'§(param1);
      }
      
      private static function §`!F§(param1:§-6§, param2:int, param3:int) : void
      {
         if(param1.§-!E§.top < 0)
         {
            param1.§-!E§.top = 0;
      ...
      protected function §1'§(param1:Object) : void
      {
         ...
         for(_loc4_ in param1)
         {
            if(_loc4_.indexOf("sprite_") != -1)
            {
               ...
               §`!F§(_loc6_,§^6§.width,§^6§.height);
               if(_loc2_)
               {
                  _loc6_.§#0§ = _loc5_.pivotx / _loc3_;
                  _loc6_.§7I§ = _loc5_.pivoty / _loc3_;
               }
               else
               {
                  _loc6_.§#0§ = _loc5_.width / 2;
                  _loc6_.§7I§ = _loc5_.height / 2;
               }
               _loc6_.§4"§ = §^6§;
               §?R§(_loc6_);
            }
