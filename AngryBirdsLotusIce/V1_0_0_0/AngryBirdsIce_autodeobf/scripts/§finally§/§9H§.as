package §finally§
{
   ...
   public class §9H§ extends §5!$§
   {
      
      public static const §9>§:String = "MISC_FOOD_EGG";
       
      
      public function §9H§(param1:§3X§, param2:Sprite, param3:b2World, param4:§ M§, param5:int, param6:String, param7:Number, param8:Number, param9:Number, param10:Boolean = true, param11:Number = 1.0)
      {
      ...
      override public function activateSpecialPower(param1:§3X§) : Boolean
      {
         ...
         var _loc4_:§%!7§;
         (_loc4_ = param1.addObject(§9>§,_loc2_,_loc3_ + 0.01,0,false,true,true,scale)).§^7§ = true;
