   ...
   public class Texture
   {
      ...
      public function adjustVertexData(param1:§+^§, param2:int, param3:int) : void
      {
         ...
         if(this.§?!E§)
         {
            ...
            _loc4_ = this.§?!E§.width + this.§?!E§.x - this.width;
            _loc5_ = this.§?!E§.height + this.§?!E§.y - this.height;
            param1.§7!?§(param2,-this.§?!E§.x,-this.§?!E§.y);
            param1.§7!?§(param2 + 1,-_loc4_,-this.§?!E§.y);
            param1.§7!?§(param2 + 2,-this.§?!E§.x,-_loc5_);
            param1.§7!?§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
