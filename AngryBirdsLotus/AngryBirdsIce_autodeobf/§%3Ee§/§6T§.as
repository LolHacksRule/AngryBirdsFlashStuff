package §>e§
{
   ...
   public class §6T§
   {
      ...
      private var §1!1§:Array;
      
      private var §>y§:Array;
      
      private var §6^§:Array;
      
      public function §6T§(param1:Number = 50)
      {
         ...
         this.§#!=§ = new Array(64);
         this.§var§ = new Array(64);
         this.§6!E§ = new Array(64);
         this.§>g§ = new Array(64);
         ...
         this.§9j§ = [0,0,2,1,2,4,4,3,4,7,5,4,4,0,1,2,119];
         ...
         this.§8z§ = new Array(65535);
         this.category = new Array(65535);
         this.§+=§ = new Array(64);
         this.§1!1§ = new Array(64);
         this.§>y§ = new Array(64);
         this.§6^§ = new Array(64);
         super();
         if(param1 <= 0)
      ...
      private function §+!&§(param1:int) : void
      {
         ...
         while(_loc7_ < 8)
         {
            ...
            while(_loc8_ < 8)
            {
               this.§6!E§[_loc2_] = 1 / (this.§#!=§[this.§+s§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               this.§>g§[_loc2_] = 1 / (this.§var§[this.§+s§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               _loc2_++;
               _loc8_++;
            }
            _loc7_++;
      ...
      private function §9&§() : void
      {
         ...
         this.§-G§ = this.§-#§(this.§<y§,this.§@r§);
         this.§40§ = this.§-#§(this.§"k§,this.§'@§);
         this.§7>§ = this.§-#§(this.§9j§,this.§^f§);
      }
      ...
      private function §6!§() : void
      {
         ...
         while(_loc4_ <= 15)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               ...
               this.§8z§[32767 + _loc3_] = new §2>§();
               this.§8z§[32767 + _loc3_].len = _loc4_;
               this.§8z§[32767 + _loc3_].val = _loc3_;
               _loc3_++;
            }
            _loc3_ = -(_loc2_ - 1);
            while(_loc3_ <= -_loc1_)
            {
               ...
               this.§8z§[32767 + _loc3_] = new §2>§();
               this.§8z§[32767 + _loc3_].len = _loc4_;
               this.§8z§[32767 + _loc3_].val = _loc2_ - 1 + _loc3_;
               _loc3_++;
            }
            _loc1_ <<= 1;
            _loc2_ <<= 1;
      ...
      private function §[R§(param1:§2>§) : void
      {
      ...
      private function §3s§(param1:Array, param2:Array) : Array
      {
         var _loc3_:Number = NaN;
      ...
      private function §7v§(param1:int, param2:int) : void
      {
         this.§ 9§(65472);
         this.§ 9§(17);
         this.writeByte(8);
      ...
      private function §;@§() : void
      {
         ...
         while(_loc1_ < 64)
         {
            this.writeByte(this.§var§[_loc1_]);
            _loc1_++;
         }
      }
      ...
      private function §^!4§() : void
      {
         ...
         while(_loc1_ < 16)
         {
            this.writeByte(this.§9j§[_loc1_ + 1]);
            _loc1_++;
         }
         _loc1_ = 0;
         while(_loc1_ <= 161)
      ...
      private function §#n§(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         var _loc8_:int = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         ...
         var _loc9_:Array = this.§3s§(param1,param2);
         _loc8_ = 0;
         while(_loc8_ < 64)
         {
         ...
         {
            this.§[R§(param4[this.category[32767 + _loc10_]]);
            this.§[R§(this.§8z§[32767 + _loc10_]);
         }
         var _loc11_:int = 63;
         ...
         while(_loc8_ <= _loc11_)
         {
            ...
            this.§[R§(param5[_loc13_ * 16 + this.category[32767 + this.§+=§[_loc8_]]]);
            this.§[R§(this.§8z§[32767 + this.§+=§[_loc8_]]);
            _loc8_++;
         }
         if(_loc11_ != 63)
         {
      ...
      private function §>K§(param1:BitmapData, param2:int, param3:int) : void
      {
         ...
         while(_loc5_ < 8)
         {
            ...
            while(_loc6_ < 8)
            {
               ...
               this.§1!1§[_loc4_] = 0.299 * _loc8_ + 0.587 * _loc9_ + 0.114 * _loc10_ - 128;
               this.§>y§[_loc4_] = -0.16874 * _loc8_ + -0.33126 * _loc9_ + 0.5 * _loc10_;
               this.§6^§[_loc4_] = 0.5 * _loc8_ + -0.41869 * _loc9_ + -0.08131 * _loc10_;
               _loc4_++;
               _loc6_++;
            }
            _loc5_++;
      ...
      public function encode(param1:BitmapData) : ByteArray
      {
         ...
         this.§"!;§();
         this.§;@§();
         this.§7v§(param1.width,param1.height);
         this.§^!4§();
         this.§-R§();
         var _loc2_:Number = 0;
         var _loc3_:Number = 0;
         ...
         while(_loc5_ < param1.height)
         {
            ...
            while(_loc6_ < param1.width)
            {
               ...
               _loc2_ = this.§#n§(this.§1!1§,this.§6!E§,_loc2_,this.§!!3§,this.§40§);
               _loc3_ = this.§#n§(this.§>y§,this.§>g§,_loc3_,this.§-G§,this.§7>§);
               _loc4_ = this.§#n§(this.§6^§,this.§>g§,_loc4_,this.§-G§,this.§7>§);
               _loc6_ += 8;
            }
            _loc5_ += 8;
         }
         if(this.§,g§ >= 0)
         {
            (_loc7_ = new §2>§()).len = this.§,g§ + 1;
            _loc7_.val = (1 << this.§,g§ + 1) - 1;
            this.§[R§(_loc7_);
         }
         this.§ 9§(65497);
         return this.§%Y§;
