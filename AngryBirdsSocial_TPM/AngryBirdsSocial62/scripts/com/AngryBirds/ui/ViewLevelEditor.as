package com.AngryBirds.ui
{
   ...
   public class ViewLevelEditor extends UIView
   {
      ...
      override public function activateView() : void
      {
         ...
         this.mShowDeleteAndRotateTools = false;
      ...
      {
         if((getItemByName("Button_ToolRotate") as UIButtonRovio).mVisibility != (param1 && this.mShowDeleteAndRotateTools))
         {
            setItemVisibility("Button_ToolRotate",param1 && this.mShowDeleteAndRotateTools);
            setItemVisibility("Button_ToolDelete",param1 && this.mShowDeleteAndRotateTools);
         }
