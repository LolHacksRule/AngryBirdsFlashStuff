package com.AngryBirds.AvatarCreator.states
{
   ...
   public class StateAvatarCreator extends StateBase
   {
      ...
      override public function uiInteractionHandler(param1:int, param2:String, param3:UIEventListenerRovio) : void
      {
         ...
         switch(param2)
         {
            ...
            case "SAVE_AVATAR":
               if(AvatarCreator.smAvatar.isMoving() == false)
               {
                  _loc5_ = AvatarCreator.smAvatar.getItemCost();
                  trace("Avatar will cost " + _loc5_);
                  if(_loc5_ == 0)
                  {
                  ...
                  {
                     AvatarCreator.setDebugText("Avatar cost " + _loc5_ + ".");
                  }
               }
               break;
            case "NEXT_CHARACTER":
            ...
            case "TAKE_SNAPSHOT":
               if(AvatarCreator.smAvatar.isMoving() == false)
               {
                  (_loc6_ = this.mUIView.getItemByName("Popup_CharacterEditor_ProfilePicture") as UIPopUpRovio).open();
                  (_loc6_.getItemByName("Button_Save") as UIButtonRovio).setEnabled(true);
            ...
            case "PUBLISH_TO_TWITTER_PROFILE":
               _loc4_ = this.createImage(50,50,true);
               AngryBirdsServer.sendSnapshot("",_loc4_);
         }
      }
      ...
      public function createImage(param1:Number, param2:Number, param3:Boolean = true) : BitmapData
      {
         ...
         var _loc6_:Number = -(_loc5_ = (_loc4_ = this.mUIView.getItemByName("Popup_CharacterEditor_ProfilePicture") as UIPopUpRovio).getItemByName("ProfilePicture_Guide") as UIContainerRovio).mMovieClip.x + _loc5_.width / 2;
         var _loc7_:Number = -_loc5_.mMovieClip.y + _loc5_.height / 2;
      ...
      public function toggleInactiveAvatarVisibility(param1:Boolean) : *
      {
         var _loc3_:Avatar = null;
         var _loc2_:Number = 0;
