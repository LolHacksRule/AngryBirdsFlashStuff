package §-u§
{
   ...
   public class DisplayObjectUpdater extends §8Y§
   {
      ...
      public static const §03§:Array = ["x","y","z","scaleX","scaleY","scaleZ","rotation","rotationX","rotationY","rotationZ","alpha","width","height","_bevelFilter","_blurFilter","_colorMatrixFilter","_convolutionFilter","_displacementMapFilter","_dropShadowFilter","_glowFilter","_gradientBevelFilter","_gradientGlowFilter","_shaderFilter"];
      ...
      override public function setObject(param1:String, param2:Object) : void
      {
         ...
         {
            this.§+!0§(param2 as BitmapFilter,DisplacementMapFilter);
            return;
         }
      ...
      override public function setDestinationValue(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         {
            this._flags |= 2;
            this.§;u§.relativeFlags |= !!param3 ? 2 : 0;
            this.§;u§.y = param2;
         }
         else if(param1 == "z")
         {
            this._flags |= 4;
            this.§;u§.relativeFlags |= !!param3 ? 4 : 0;
            this.§;u§.z = param2;
         }
         else if(param1 == "scaleX")
         {
            this._flags |= 8;
            this.§;u§.relativeFlags |= !!param3 ? 8 : 0;
            this.§;u§.scaleX = param2;
         }
         else if(param1 == "scaleY")
         {
            this._flags |= 16;
            this.§;u§.relativeFlags |= !!param3 ? 16 : 0;
            this.§;u§.scaleY = param2;
         }
         else if(param1 == "scaleZ")
         {
            this._flags |= 32;
            this.§;u§.relativeFlags |= !!param3 ? 32 : 0;
            this.§;u§.scaleZ = param2;
         }
         else if(param1 == "rotation")
         {
            this._flags |= 64;
            this.§;u§.relativeFlags |= !!param3 ? 64 : 0;
            this.§;u§.rotation = param2;
         }
         else if(param1 == "rotationX")
         {
            this._flags |= 128;
            this.§;u§.relativeFlags |= !!param3 ? 128 : 0;
            this.§;u§.rotationX = param2;
         }
         else if(param1 == "rotationY")
         {
            this._flags |= 256;
            this.§;u§.relativeFlags |= !!param3 ? 256 : 0;
            this.§;u§.rotationY = param2;
         }
         else if(param1 == "rotationZ")
         {
            this._flags |= 512;
            this.§;u§.relativeFlags |= !!param3 ? 512 : 0;
            this.§;u§.rotationZ = param2;
         }
         else if(param1 == "alpha")
         {
            this._flags |= 1024;
            this.§;u§.relativeFlags |= !!param3 ? 1024 : 0;
            this.§;u§.alpha = param2;
         }
         else if(param1 == "width")
         {
            this._flags |= 2048;
            this.§;u§.relativeFlags |= !!param3 ? 2048 : 0;
            this.§;u§.width = param2;
         }
         else if(param1 == "height")
         {
            this._flags |= 4096;
            this.§;u§.relativeFlags |= !!param3 ? 4096 : 0;
            this.§;u§.height = param2;
         }
      }
