package §%4§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §&!§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§0!,§ = §5"9§;
            _loc7_ = this.§0y§.§"]§(param1.indexA[0]);
            ...
            this.§+u§.x = _loc15_ - _loc13_;
            this.§+u§.y = _loc16_ - _loc14_;
            this.§+u§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§0!,§ = §`!5§;
            _loc8_ = this.§0y§.§"]§(param1.indexA[0]);
            _loc9_ = this.§0y§.§"]§(param1.indexA[1]);
            _loc10_ = this.§[$§.§"]§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§+u§ = b2Math.§>O§(b2Math.§ !r§(_loc9_,_loc8_),1);
            this.§+u§.Normalize();
            _loc20_ = this.§+u§;
         ...
         else if(param1.indexA[0] == param1.indexA[0])
         {
            ...
            this.§+u§ = b2Math.§>O§(b2Math.§ !r§(_loc12_,_loc11_),1);
            this.§+u§.Normalize();
            _loc20_ = this.§+u§;
         ...
         else
         {
            ...
            _loc11_ = this.§[$§.§"]§(param1.indexB[0]);
            _loc12_ = this.§[$§.§"]§(param1.indexB[1]);
            _loc23_ = b2Math.§#!K§(param3,_loc7_);
            _loc24_ = b2Math.§<!G§(param3.R,b2Math.§ !r§(_loc9_,_loc8_));
            _loc25_ = b2Math.§#!K§(param5,_loc10_);
            _loc26_ = b2Math.§<!G§(param5.R,b2Math.§ !r§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§ !r§(_loc26_,_loc24_);
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         switch(this.§0!,§)
         {
            case §5"9§:
               ...
               return Number(((_loc8_ = b2Math.§#!K§(param2,_loc6_)).x - _loc7_.x) * this.§+u§.x + (_loc8_.y - _loc7_.y) * this.§+u§.y);
            case §`!5§:
               _loc10_ = b2Math.§<!G§(param1.R,this.§+u§);
               _loc7_ = b2Math.§#!K§(param1,this.m_localPoint);
               _loc4_ = b2Math.§#"-§(param2.R,_loc10_.§5E§());
               _loc6_ = this.§[$§.§!F§(_loc4_);
               return Number(((_loc8_ = b2Math.§#!K§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §&O§:
               _loc10_ = b2Math.§<!G§(param2.R,this.§+u§);
               _loc8_ = b2Math.§#!K§(param2,this.m_localPoint);
               _loc3_ = b2Math.§#"-§(param1.R,_loc10_.§5E§());
               _loc5_ = this.§0y§.§!F§(_loc3_);
               return Number(((_loc7_ = b2Math.§#!K§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
