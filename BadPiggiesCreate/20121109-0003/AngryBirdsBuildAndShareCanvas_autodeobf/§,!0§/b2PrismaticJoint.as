package §,!0§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§5!i§.x * this.§4!-§.x + (this.§`t§ + this.§5!i§.z) * this.§+u§.x),param1 * (this.§5!i§.x * this.§4!-§.y + (this.§`t§ + this.§5!i§.z) * this.§+u§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§<"6§.col1.y = _loc16_ * this.m_s1 + _loc17_ * this.m_s2;
         this.§<"6§.col1.z = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§<"6§.col2.x = this.§<"6§.col1.y;
         this.§<"6§.col2.y = _loc16_ + _loc17_;
         this.§<"6§.col2.z = _loc16_ * this.m_a1 + _loc17_ * this.m_a2;
         this.§<"6§.col3.x = this.§<"6§.col1.z;
         this.§<"6§.col3.y = this.§<"6§.col2.z;
         this.§<"6§.col3.z = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§!!$§)
         {
         ...
         if(param1.§@!D§)
         {
            ...
            this.§`t§ *= param1.§class§;
            _loc19_ = this.§5!i§.x * this.§4!-§.x + (this.§`t§ + this.§5!i§.z) * this.§+u§.x;
            _loc20_ = this.§5!i§.x * this.§4!-§.y + (this.§`t§ + this.§5!i§.z) * this.§+u§.y;
            _loc21_ = this.§5!i§.x * this.m_s1 + this.§5!i§.y + (this.§`t§ + this.§5!i§.z) * this.m_a1;
            _loc22_ = this.§5!i§.x * this.m_s2 + this.§5!i§.y + (this.§`t§ + this.§5!i§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc14_ = this.§+u§.x * (_loc6_.x - _loc4_.x) + this.§+u§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc15_ = this.§>E§ * (this.§?!,§ - _loc14_);
            _loc16_ = this.§`t§;
            _loc17_ = param1.§@[§ * this.§<6§;
            this.§`t§ = b2Math.§5" §(this.§`t§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§`t§ - _loc16_) * this.§+u§.x;
            _loc9_ = _loc15_ * this.§+u§.y;
         ...
         {
            _loc18_ = this.§+u§.x * (_loc6_.x - _loc4_.x) + this.§+u§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc19_ = this.§5!i§.Copy();
            _loc20_ = this.§<"6§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§5!i§.§<!n§(_loc20_);
            if(this.§<!3§ == b2internal::@)
            {
               this.§5!i§.z = b2Math.§8!c§(this.§5!i§.z,0);
            }
            else if(this.§<!3§ == b2internal::!"7)
            {
               this.§5!i§.z = b2Math.§+"1§(this.§5!i§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§5!i§.z - _loc19_.z) * this.§<"6§.col3.x;
            _loc22_ = -_loc13_ - (this.§5!i§.z - _loc19_.z) * this.§<"6§.col3.y;
            _loc23_ = this.§<"6§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§5!i§.x = _loc23_.x;
            this.§5!i§.y = _loc23_.y;
            _loc20_.x = this.§5!i§.x - _loc19_.x;
            _loc20_.y = this.§5!i§.y - _loc19_.y;
            _loc20_.z = this.§5!i§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§4!-§.x + _loc20_.z * this.§+u§.x;
            _loc9_ = _loc20_.x * this.§4!-§.y + _loc20_.z * this.§+u§.y;
         ...
         {
            _loc24_ = this.§<"6§.Solve22(new b2Vec2(),-_loc12_,-_loc13_);
            this.§5!i§.x += _loc24_.x;
            this.§5!i§.y += _loc24_.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§!!$§)
         {
            ...
            _loc35_ = this.§+u§.x * _loc26_ + this.§+u§.y * _loc27_;
            if(b2Math.§1!`§(this.§=" § - this.§""@§) < 2 * b2Settings.b2_linearSlop)
            {
            ...
            {
               _loc19_ = b2Math.§5" §(_loc35_ - this.§""@§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§""@§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§=" §)
            {
               _loc19_ = b2Math.§5" §(_loc35_ - this.§=" § + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§<"6§.col1.y = _loc14_ * this.m_s1 + _loc15_ * this.m_s2;
            this.§<"6§.col1.z = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§<"6§.col2.x = this.§<"6§.col1.y;
            this.§<"6§.col2.y = _loc14_ + _loc15_;
            this.§<"6§.col2.z = _loc14_ * this.m_a1 + _loc15_ * this.m_a2;
            this.§<"6§.col3.x = this.§<"6§.col1.z;
            this.§<"6§.col3.y = this.§<"6§.col2.z;
            this.§<"6§.col3.z = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§<"6§.Solve33(_loc28_,-_loc29_,-_loc30_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::+!7;
            ...
            this.§<"6§.col1.Set(_loc36_,_loc37_,0);
            this.§<"6§.col2.Set(_loc37_,_loc38_,0);
            _loc39_ = this.§<"6§.Solve22(new b2Vec2(),-_loc29_,-_loc30_);
            _loc28_.x = _loc39_.x;
            _loc28_.y = _loc39_.y;
            _loc28_.z = 0;
         }
         var _loc31_:Number = _loc28_.x * this.§4!-§.x + _loc28_.z * this.§+u§.x;
         var _loc32_:Number = _loc28_.x * this.§4!-§.y + _loc28_.z * this.§+u§.y;
         ...
         _loc6_.x -= b2internal::+!7 * _loc31_;
         _loc6_.y -= b2internal::+!7 * _loc32_;
         _loc7_ -= b2internal::8"# * _loc33_;
         _loc8_.x += b2internal:: !b * _loc31_;
         _loc8_.y += b2internal:: !b * _loc32_;
         _loc9_ += b2internal:: true * _loc34_;
