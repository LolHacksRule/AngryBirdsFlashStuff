package §[h§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §#t§:Number = 2;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         this.m_groundAnchor1.x = param1.§5!W§.x - this.§"<§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§5!W§.y - this.§"<§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§3=§.x - this.§"<§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§3=§.y - this.§"<§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§;!1§);
         this.m_localAnchor2.SetV(param1.§%?§);
         this.§>!P§ = param1.§6?§;
         this.§8U§ = param1.§%;§ + this.§>!P§ * param1.§9!J§;
         this.m_maxLength1 = b2Math.§5!>§(param1.§#!B§,this.§8U§ - this.§>!P§ * b2internal::#t);
         this.m_maxLength2 = b2Math.§5!>§(param1.§-e§,(this.§8U§ - b2internal::#t) / this.§>!P§);
         this.§7!a§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§7!a§ * this.m_u2.x,param1 * this.§7!a§ * this.m_u2.y);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§8U§ - _loc18_ - this.§>!P§ * _loc19_) > 0)
         {
         ...
         {
            this.§<!O§ = b2internal::86;
         }
         if(_loc18_ < this.m_maxLength1)
         {
            this.m_limitState1 = b2internal::2!v;
            this.m_limitImpulse1 = 0;
         }
         else
         {
            this.m_limitState1 = b2internal::86;
         }
         if(_loc19_ < this.m_maxLength2)
         {
            this.m_limitState2 = b2internal::2!v;
            this.m_limitImpulse2 = 0;
         }
         else
         {
            this.m_limitState2 = b2internal::86;
         }
         var _loc21_:Number = _loc5_ * this.m_u1.y - _loc6_ * this.m_u1.x;
         var _loc22_:Number = _loc8_ * this.m_u2.y - _loc9_ * this.m_u2.x;
         this.m_limitMass1 = _loc2_.§7!?§ + _loc2_.§`d§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§7!?§ + _loc3_.§`d§ * _loc22_ * _loc22_;
         this.§4!I§ = this.m_limitMass1 + this.§>!P§ * this.§>!P§ * this.m_limitMass2;
         ...
         if(param1.§ !K§)
         {
            ...
            _loc23_ = (-this.§7!a§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§7!a§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§>!P§ * this.§7!a§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§>!P§ * this.§7!a§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§<&§.x += _loc2_.§7!?§ * _loc23_;
            _loc2_.§<&§.y += _loc2_.§7!?§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§`d§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§<&§.x += _loc3_.§7!?§ * _loc25_;
            _loc3_.§<&§.y += _loc3_.§7!?§ * _loc26_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§<!O§ == b2internal::86)
         {
            ...
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§>!P§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§4!I§ * -_loc18_;
            _loc20_ = this.§7!a§;
            this.§7!a§ = b2Math.§,!a§(0,this.§7!a§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§7!a§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§>!P§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§>!P§ * _loc19_ * this.m_u2.y;
            _loc2_.§<&§.x += _loc2_.§7!?§ * _loc14_;
            _loc2_.§<&§.y += _loc2_.§7!?§ * _loc15_;
         ...
         if(this.m_limitState1 == b2internal::86)
         {
            _loc10_ = _loc2_.§<&§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§<&§.y + _loc2_.m_angularVelocity * _loc5_;
         ...
         if(this.m_limitState2 == b2internal::86)
         {
            _loc12_ = _loc3_.§<&§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§<&§.y + _loc3_.m_angularVelocity * _loc8_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§<!O§ == b2internal::86)
         {
            ...
            _loc19_ = this.§8U§ - _loc17_ - this.§>!P§ * _loc18_;
            _loc24_ = b2Math.§,!a§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§%!j§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§4!I§ * _loc19_) * this.m_u1.x;
            _loc14_ = -_loc20_ * this.m_u1.y;
            _loc15_ = -this.§>!P§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§>!P§ * _loc20_ * this.m_u2.y;
