package §!"§
{
   ...
   public class §9o§
   {
      ...
      private var §3q§:int = 7;
      
      private var §&!N§:Array;
      
      private var §3e§:Array;
      
      private var §7A§:Array;
      
      private var §[z§:Array;
      
      public function §9o§(param1:Number = 50)
      {
      ...
      private function §&H§(param1:int) : void
      {
         ...
         while(_loc7_ < 8)
         {
            ...
            while(_loc8_ < 8)
            {
               this.§2!-§[_loc2_] = 1 / (this.§#'§[this.§3!§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               this.§6%§[_loc2_] = 1 / (this.§';§[this.§3!§[_loc2_]] * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               _loc2_++;
               _loc8_++;
            }
            _loc7_++;
      ...
      {
         this.§6f§ = this.§ K§(this.§>!N§,this.§5'§);
         this.§'7§ = this.§ K§(this.§,$§,this.§!§);
         this.§-!i§ = this.§ K§(this.§?u§,this.§>!K§);
         this.§7>§ = this.§ K§(this.§'!4§,this.§2j§);
      }
      ...
      private function §6Z§(param1:Array, param2:Array) : Array
      {
         var _loc3_:Number = NaN;
      ...
      private function §#!9§(param1:int, param2:int) : void
      {
         this.§ !J§(65472);
         this.§ !J§(17);
         this.writeByte(8);
      ...
      private function §;>§(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         ...
         var _loc9_:Array = this.§6Z§(param1,param2);
         _loc8_ = 0;
         while(_loc8_ < 64)
         {
            this.§&!N§[this.§3!§[_loc8_]] = _loc9_[_loc8_];
            _loc8_++;
         }
         ...
         while(_loc8_ <= _loc11_)
         {
            ...
            this.§?!Q§(param5[_loc13_ * 16 + this.category[32767 + this.§&!N§[_loc8_]]]);
            this.§?!Q§(this.§%!,§[32767 + this.§&!N§[_loc8_]]);
            _loc8_++;
         }
         if(_loc11_ != 63)
         {
      ...
      private function §'!2§(param1:BitmapData, param2:int, param3:int) : void
      {
         ...
         while(_loc5_ < 8)
         {
            ...
            while(_loc6_ < 8)
            {
               ...
               this.§3e§[_loc4_] = 0.299 * _loc8_ + 0.587 * _loc9_ + 0.114 * _loc10_ - 128;
               this.§7A§[_loc4_] = -0.16874 * _loc8_ + -0.33126 * _loc9_ + 0.5 * _loc10_;
      ...
      public function encode(param1:BitmapData) : ByteArray
      {
         ...
         this.§-!N§();
         this.§0!W§();
         this.§#!9§(param1.width,param1.height);
         this.§7!+§();
         this.§`U§();
         var _loc2_:Number = 0;
         var _loc3_:Number = 0;
         ...
         while(_loc5_ < param1.height)
         {
            ...
            while(_loc6_ < param1.width)
            {
               ...
               _loc2_ = this.§;>§(this.§3e§,this.§2!-§,_loc2_,this.§6f§,this.§-!i§);
               _loc3_ = this.§;>§(this.§7A§,this.§6%§,_loc3_,this.§'7§,this.§7>§);
               _loc4_ = this.§;>§(this.§[z§,this.§6%§,_loc4_,this.§'7§,this.§7>§);
               _loc6_ += 8;
            }
            _loc5_ += 8;
         }
         if(this.§3q§ >= 0)
         {
            (_loc7_ = new §^^§()).len = this.§3q§ + 1;
            _loc7_.val = (1 << this.§3q§ + 1) - 1;
            this.§?!Q§(_loc7_);
         }
         this.§ !J§(65497);
         return this.§=!8§;
