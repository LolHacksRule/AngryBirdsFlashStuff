   ...
   public class Texture
   {
      ...
      public function adjustVertexData(param1:§9!§, param2:int, param3:int) : void
      {
         ...
         if(this.§5!9§)
         {
            ...
            _loc4_ = this.§5!9§.width + this.§5!9§.x - this.width;
            _loc5_ = this.§5!9§.height + this.§5!9§.y - this.height;
            param1.§^!<§(param2,-this.§5!9§.x,-this.§5!9§.y);
            param1.§^!<§(param2 + 1,-_loc4_,-this.§5!9§.y);
            param1.§^!<§(param2 + 2,-this.§5!9§.x,-_loc5_);
