package §[h§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§7!a§.x * this.§&!a§.x + (this.§0,§ + this.§7!a§.z) * this.§;9§.x),param1 * (this.§7!a§.x * this.§&!a§.y + (this.§0,§ + this.§7!a§.z) * this.§;9§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§ !K§)
         {
            ...
            this.§7!a§.y *= param1.§5!;§;
            this.§0,§ *= param1.§5!;§;
            _loc19_ = this.§7!a§.x * this.§&!a§.x + (this.§0,§ + this.§7!a§.z) * this.§;9§.x;
            _loc20_ = this.§7!a§.x * this.§&!a§.y + (this.§0,§ + this.§7!a§.z) * this.§;9§.y;
            _loc21_ = this.§7!a§.x * this.m_s1 + this.§7!a§.y + (this.§0,§ + this.§7!a§.z) * this.m_a1;
            _loc22_ = this.§7!a§.x * this.m_s2 + this.§7!a§.y + (this.§0,§ + this.§7!a§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§7#§ && this.§]!C§ != b2internal::+!5)
         {
            ...
            _loc15_ = this.§-!!§ * (this.§4%§ - _loc14_);
            _loc16_ = this.§0,§;
            _loc17_ = param1.§>N§ * this.§6@§;
            this.§0,§ = b2Math.§%!j§(this.§0,§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§0,§ - _loc16_) * this.§;9§.x;
         ...
         if(this.§&-§ && this.§]!C§ != b2internal::2!v)
         {
            ...
            _loc19_ = this.§7!a§.Copy();
            _loc20_ = this.§ !`§.Solve33(new b2Vec3(),-_loc12_,-_loc13_,-_loc18_);
            this.§7!a§.§!a§(_loc20_);
            if(this.§]!C§ == b2internal::,!')
            {
               this.§7!a§.z = b2Math.§,!a§(this.§7!a§.z,0);
            }
            else if(this.§]!C§ == b2internal::86)
            {
               this.§7!a§.z = b2Math.§5!>§(this.§7!a§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§7!a§.z - _loc19_.z) * this.§ !`§.col3.x;
            _loc22_ = -_loc13_ - (this.§7!a§.z - _loc19_.z) * this.§ !`§.col3.y;
            _loc23_ = this.§ !`§.Solve22(new b2Vec2(),_loc21_,_loc22_);
            _loc23_.x += _loc19_.x;
            _loc23_.y += _loc19_.y;
            this.§7!a§.x = _loc23_.x;
            this.§7!a§.y = _loc23_.y;
            _loc20_.x = this.§7!a§.x - _loc19_.x;
            _loc20_.y = this.§7!a§.y - _loc19_.y;
            _loc20_.z = this.§7!a§.z - _loc19_.z;
            _loc8_ = _loc20_.x * this.§&!a§.x + _loc20_.z * this.§;9§.x;
            _loc9_ = _loc20_.x * this.§&!a§.y + _loc20_.z * this.§;9§.y;
         ...
         else
         {
            ...
            this.§7!a§.x += _loc24_.x;
            this.§7!a§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§&!a§.x;
            _loc9_ = _loc24_.x * this.§&!a§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§&-§)
         {
            ...
            else if(_loc35_ <= this.§0C§)
            {
               _loc19_ = b2Math.§%!j§(_loc35_ - this.§0C§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§0C§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§%X§)
            {
               _loc19_ = b2Math.§%!j§(_loc35_ - this.§%X§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§%X§;
               _loc18_ = true;
            }
         }
         ...
         var _loc31_:Number = _loc28_.x * this.§&!a§.x + _loc28_.z * this.§;9§.x;
         var _loc32_:Number = _loc28_.x * this.§&!a§.y + _loc28_.z * this.§;9§.y;
         ...
         _loc6_.x -= b2internal::3T * _loc31_;
         _loc6_.y -= b2internal::3T * _loc32_;
         _loc7_ -= b2internal::@!= * _loc33_;
         _loc8_.x += b2internal::`y * _loc31_;
         _loc8_.y += b2internal::`y * _loc32_;
         _loc9_ += b2internal::'o * _loc34_;
