package §6" §
{
   ...
   public class §&l§
   {
      ...
      public static function § "!§(param1:b2Shape, param2:b2Transform, param3:b2Shape, param4:b2Transform) : §@" §
      {
         ...
         {
            _loc5_ = §0s§(param1 as b2PolygonShape,param2,param3 as b2CircleShape,param4);
         }
      ...
      public static function §2t§(param1:b2PolygonShape, param2:b2Transform, param3:b2PolygonShape, param4:b2Transform) : §@" §
      {
         ...
         {
            _loc33_ = _loc14_.§ !$§;
            _loc34_ = §2">§(_loc8_,_loc14_.§@!7§,_loc14_.rotation / 180 * Math.PI);
            _loc35_ = §2">§(_loc9_,_loc14_.§@!7§,_loc14_.rotation / 180 * Math.PI);
            _loc34_.§1v§(_loc33_);
            _loc35_.§1v§(_loc33_);
            _loc36_ = b2Math.§]H§(_loc34_,_loc11_);
            _loc37_ = b2Math.§]H§(_loc34_,_loc12_);
            _loc38_ = b2Math.§]H§(_loc35_,_loc11_);
            _loc39_ = b2Math.§]H§(_loc35_,_loc12_);
            ...
            if(_loc40_ < _loc41_)
            {
               if(_loc36_ < § !0§)
               {
                  (_loc43_ = _loc11_.Copy()).§5!]§(_loc34_);
               }
               if(_loc39_ < § !0§ && _loc39_ < _loc36_)
               {
                  (_loc43_ = _loc12_.Copy()).§5!]§(_loc35_);
               }
            }
            else
            {
               if(_loc37_ < § !0§)
               {
                  (_loc43_ = _loc12_.Copy()).§5!]§(_loc34_);
               }
               if(_loc38_ < § !0§ && _loc38_ < _loc37_)
               {
                  (_loc43_ = _loc11_.Copy()).§5!]§(_loc35_);
               }
            }
            _loc14_.§2!k§ = _loc43_ != null;
            if(_loc43_ != null)
            {
               _loc33_.§1v§(_loc43_);
            }
            (_loc44_ = _loc13_.Copy()).Normalize();
            _loc44_.§>!t§(b2Settings.b2_linearSlop * 2);
            _loc33_.§1v§(_loc44_);
            _loc14_.§6!,§ = _loc33_;
            return _loc14_;
         }
      ...
      public static function §0s§(param1:b2PolygonShape, param2:b2Transform, param3:b2CircleShape, param4:b2Transform) : §@" §
      {
         ...
         while(_loc9_ < _loc7_.length)
         {
            ...
            _loc13_ = ((_loc12_ = §'!S§(_loc10_,_loc11_,_loc5_).§ !$§).§`g§() - _loc6_) / _loc12_.§`g§();
            _loc12_.x *= _loc13_;
            _loc12_.y *= _loc13_;
      ...
      public static function §4!<§(param1:b2CircleShape, param2:b2Transform, param3:b2CircleShape, param4:b2Transform) : §@" §
      {
         ...
         var _loc8_:Number = (_loc7_.§`g§() - param1.§4!P§() - param3.§4!P§()) / _loc7_.§`g§();
         _loc7_.x *= _loc8_;
         _loc7_.y *= _loc8_;
         var _loc9_:§@" §;
         (_loc9_ = new §@" §()).§ !$§ = _loc7_;
      ...
      public static function §`l§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2, param4:b2Vec2) : §@" §
      {
         ...
         _loc11_ = _loc7_;
         if(_loc8_.§ !$§.§`g§() < _loc11_.§ !$§.§`g§())
         {
            _loc11_ = _loc8_;
         }
         if(_loc9_.§ !$§.§`g§() < _loc11_.§ !$§.§`g§())
         {
            _loc11_ = _loc9_;
         }
      ...
      public static function §'!S§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2, param4:Boolean = false) : §@" §
      {
         ...
         var _loc8_:§@" §;
         (_loc8_ = new §@" §()).§ !$§ = new b2Vec2(param3.x - _loc7_.x,param3.y - _loc7_.y);
         if(param4)
         {
            _loc8_.§ !$§.§!!]§();
         }
         _loc8_.§@!7§ = !!param4 ? param3 : _loc7_;
         return _loc8_;
      }
      
      public static function §&&§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2, param4:b2Vec2, param5:Boolean = true) : Number
      {
         return §,3§(new b2Vec2(param2.x - param1.x,param2.y - param1.y),new b2Vec2(param4.x - param3.x,param4.y - param3.y),param5);
      }
      ...
      public static function §5!4§(param1:b2Shape, param2:b2Transform, param3:Number = 0) : Rectangle
      {
         ...
         {
            _loc8_ = (param1 as b2CircleShape).§4!P§();
