   ...
   public class b2WeldJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§1!w§)
         {
            ...
            this.§?;§.y *= param1.§<3§;
            this.§?;§.z *= param1.§<3§;
            _loc4_.§,b§.x -= _loc10_ * this.§?;§.x;
            _loc4_.§,b§.y -= _loc10_ * this.§?;§.y;
            _loc4_.m_angularVelocity -= _loc12_ * (_loc6_ * this.§?;§.y - _loc7_ * this.§?;§.x + this.§?;§.z);
            _loc5_.§,b§.x += _loc11_ * this.§?;§.x;
            _loc5_.§,b§.y += _loc11_ * this.§?;§.y;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§@e§.Solve33(_loc21_,-_loc18_,-_loc19_,-_loc20_);
         this.§?;§.§1v§(_loc21_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         this.§@e§.Solve33(_loc20_,-_loc14_,-_loc15_,-_loc16_);
