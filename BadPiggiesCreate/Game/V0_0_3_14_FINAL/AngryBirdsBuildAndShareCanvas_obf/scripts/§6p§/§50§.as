package §6p§
{
   ...
   public class §50§
   {
      ...
      private static function §6t§(param1:DisplayObject, param2:Vector.<§50§>, param3:int, param4:Matrix3D, param5:Number = 1.0) : int
      {
         ...
         if(param1 is DisplayObjectContainer)
         {
            ...
            while(_loc6_ < _loc9_)
            {
               ...
               _loc11_.§+U§(_loc10_);
               param3 = §6t§(_loc11_,param2,param3,_loc10_,param5);
               _loc6_++;
            }
         }
         else
               ...
               for each(_loc9_ in [true,false])
               {
                  for each(_loc10_ in [true,false])
                  {
                     for each(_loc11_ in _loc8_)
                     {
                        ...
                        _loc1_.§3A§(§["3§(_loc6_,_loc10_,_loc9_,_loc11_,_loc7_),_loc2_.§6"%§,_loc3_.§6"%§);
                     }
                  }
               }
            }
      ...
      public function render(param1:Context3D, param2:Matrix3D, param3:Number = 1.0) : void
      {
         ...
         var _loc4_:Boolean = this.§8!m§.premultipliedAlpha;
         var _loc5_:* = param3 != 1;
         var _loc6_:String = !!this.§2!X§ ? §["3§(_loc5_,this.§2!X§.mipMapping,this.§2!X§.repeat,this.§>!V§,this.§@!E§) : §;Q§(_loc5_);
         §5!W§.§3"?§(param1,_loc4_);
         this.§;"6§(param1);
         param1.setProgram(§?%§.§%b§.§!!t§(_loc6_));
         param1.setVertexBufferAt(0,this.§^">§,§>!-§.§[+§,Context3DVertexBufferFormat.FLOAT_3);
         if(this.§2!X§ == null || this.§@!E§)
         {
      ...
      public function §!"0§(param1:§^$§, param2:Number, param3:Texture, param4:String, param5:Matrix3D) : void
      {
         ...
         if(this.§'h§ == 0)
         {
            this.§2!X§ = param3;
            this.§>!V§ = param4;
            this.§8!m§.§&B§(!!param3 ? Boolean(param3.premultipliedAlpha) : true,false);
         }
      ...
      {
         if(this.§2!X§ != null && param2 != null)
         {
            return this.§2!X§.root != param2.root || this.§2!X§.repeat != param2.repeat || this.§>!V§ != param3 || this.§@!E§ != param1.useColor || this.§'h§ == 8192;
         }
         if(this.§2!X§ == null && param2 == null)
         {
            return false;
         }
         return this.§'h§ != 0 || this.§@!E§ != param1.useColor;
      }
   }
}
