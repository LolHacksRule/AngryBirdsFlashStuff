package §"K§
{
   ...
   public class §@Y§ extends §4"+§
   {
      ...
      public static const §0!V§:Array = ["x","y","z","scaleX","scaleY","scaleZ","rotation","rotationX","rotationY","rotationZ","alpha","width","height","_bevelFilter","_blurFilter","_colorMatrixFilter","_convolutionFilter","_displacementMapFilter","_dropShadowFilter","_glowFilter","_gradientBevelFilter","_gradientGlowFilter","_shaderFilter"];
      ...
      override public function setDestinationValue(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         {
            this._flags |= 2;
            this.§,_§.relativeFlags |= !!param3 ? 2 : 0;
            this.§,_§.y = param2;
         }
         else if(param1 == "z")
         {
            this._flags |= 4;
            this.§,_§.relativeFlags |= !!param3 ? 4 : 0;
            this.§,_§.z = param2;
         }
         else if(param1 == "scaleX")
         {
            this._flags |= 8;
            this.§,_§.relativeFlags |= !!param3 ? 8 : 0;
            this.§,_§.scaleX = param2;
         }
         else if(param1 == "scaleY")
         {
            this._flags |= 16;
            this.§,_§.relativeFlags |= !!param3 ? 16 : 0;
            this.§,_§.scaleY = param2;
         }
         else if(param1 == "scaleZ")
         {
            this._flags |= 32;
            this.§,_§.relativeFlags |= !!param3 ? 32 : 0;
            this.§,_§.scaleZ = param2;
         }
         else if(param1 == "rotation")
         {
            this._flags |= 64;
            this.§,_§.relativeFlags |= !!param3 ? 64 : 0;
            this.§,_§.rotation = param2;
         }
         else if(param1 == "rotationX")
         {
            this._flags |= 128;
            this.§,_§.relativeFlags |= !!param3 ? 128 : 0;
            this.§,_§.rotationX = param2;
         }
         else if(param1 == "rotationY")
         {
            this._flags |= 256;
            this.§,_§.relativeFlags |= !!param3 ? 256 : 0;
            this.§,_§.rotationY = param2;
         }
         else if(param1 == "rotationZ")
         {
            this._flags |= 512;
            this.§,_§.relativeFlags |= !!param3 ? 512 : 0;
            this.§,_§.rotationZ = param2;
         }
         else if(param1 == "alpha")
         {
            this._flags |= 1024;
            this.§,_§.relativeFlags |= !!param3 ? 1024 : 0;
            this.§,_§.alpha = param2;
         }
         else if(param1 == "width")
         {
            this._flags |= 2048;
            this.§,_§.relativeFlags |= !!param3 ? 2048 : 0;
            this.§,_§.width = param2;
         }
         else if(param1 == "height")
         {
            this._flags |= 4096;
            this.§,_§.relativeFlags |= !!param3 ? 4096 : 0;
      ...
      override public function setSourceValue(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         {
            this._flags |= 2;
            this.§-!m§.relativeFlags |= !!param3 ? 2 : 0;
            this.§-!m§.y = param2;
         }
         else if(param1 == "z")
         {
            this._flags |= 4;
            this.§-!m§.relativeFlags |= !!param3 ? 4 : 0;
            this.§-!m§.z = param2;
         }
         else if(param1 == "scaleX")
         {
            this._flags |= 8;
            this.§-!m§.relativeFlags |= !!param3 ? 8 : 0;
            this.§-!m§.scaleX = param2;
         }
         else if(param1 == "scaleY")
         {
            this._flags |= 16;
            this.§-!m§.relativeFlags |= !!param3 ? 16 : 0;
            this.§-!m§.scaleY = param2;
         }
         else if(param1 == "scaleZ")
         {
            this._flags |= 32;
            this.§-!m§.relativeFlags |= !!param3 ? 32 : 0;
            this.§-!m§.scaleZ = param2;
         }
         else if(param1 == "rotation")
         {
            this._flags |= 64;
            this.§-!m§.relativeFlags |= !!param3 ? 64 : 0;
            this.§-!m§.rotation = param2;
         }
         else if(param1 == "rotationX")
         {
            this._flags |= 128;
            this.§-!m§.relativeFlags |= !!param3 ? 128 : 0;
            this.§-!m§.rotationX = param2;
         }
         else if(param1 == "rotationY")
         {
            this._flags |= 256;
            this.§-!m§.relativeFlags |= !!param3 ? 256 : 0;
            this.§-!m§.rotationY = param2;
         }
         else if(param1 == "rotationZ")
         {
            this._flags |= 512;
            this.§-!m§.relativeFlags |= !!param3 ? 512 : 0;
            this.§-!m§.rotationZ = param2;
         }
         else if(param1 == "alpha")
         {
            this._flags |= 1024;
            this.§-!m§.relativeFlags |= !!param3 ? 1024 : 0;
            this.§-!m§.alpha = param2;
         }
         else if(param1 == "width")
         {
            this._flags |= 2048;
            this.§-!m§.relativeFlags |= !!param3 ? 2048 : 0;
            this.§-!m§.width = param2;
         }
         else if(param1 == "height")
         {
            this._flags |= 4096;
            this.§-!m§.relativeFlags |= !!param3 ? 4096 : 0;
            this.§-!m§.height = param2;
         }
      }
      ...
      override protected function resolveValues() : void
      {
         ...
         var _loc2_:DisplayObjectParameter = this.§,_§;
         var _loc3_:DisplayObjectParameter = this.§-!m§;
         var _loc4_:uint;
