      ...
      private function §4"#§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_.§5"6§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§8! §.x + _loc6_.aabb.§;R§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§8! §.y + _loc6_.aabb.§;R§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§8! §.x + _loc7_.aabb.§;R§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§8! §.y + _loc7_.aabb.§;R§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         if(_loc4_)
         {
            ...
            while(!_loc4_.aabb.§6",§(_loc5_.aabb))
            {
