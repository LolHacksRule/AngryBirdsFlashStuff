      ...
      public static function §]H§(param1:b2DistanceOutput, param2:b2SimplexCache, param3:b2DistanceInput) : void
      {
         ...
         if(param3.§2h§)
         {
            ...
            if(param1.§`!8§ > _loc23_ + _loc24_ && param1.§`!8§ > Number.MIN_VALUE)
            {
               ...
               param1.§8!3§.y += _loc23_ * _loc25_.y;
               param1.§""7§.x -= _loc24_ * _loc25_.x;
               param1.§""7§.y -= _loc24_ * _loc25_.y;
            }
            else
            {
               (_loc18_ = new b2Vec2()).x = 0.5 * (param1.§8!3§.x + param1.§""7§.x);
               _loc18_.y = 0.5 * (param1.§8!3§.y + param1.§""7§.y);
               param1.§8!3§.x = param1.§""7§.x = _loc18_.x;
               param1.§8!3§.y = param1.§""7§.y = _loc18_.y;
               param1.§`!8§ = 0;
            }
         }
      }
