package §5!o§
{
   ...
   public class b2Collision
   {
      ...
      public static function §42§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §9!Y§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §9!Y§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §9!Y§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §9!Y§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §4"1§(param1:Vector.<§<!2§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc20_:§<!2§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§2!7§;
         var _loc8_:Vector.<b2Vec2> = param2.§8!o§;
         var _loc9_:int = param5.§2!7§;
         ...
         _loc20_.id.§+!x§.§5"'§ = param4;
         _loc20_.id.§+!x§.§#"3§ = _loc21_;
         _loc20_.id.§+!x§.§1!i§ = 0;
         _loc20_ = param1[1];
      ...
      public static function §>"8§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §-s§[0] = _loc8_;
         var _loc9_:Number = §42§(§-s§,param2,param3,param4,param5);
         _loc8_ = §-s§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §;![§[0] = _loc10_;
         var _loc11_:Number = §42§(§;![§,param4,param5,param2,param3);
         _loc10_ = §;![§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§="1§ = b2Manifold.§1!0§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§<!2§> = §<!§;
         §4"1§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§2!7§;
      ...
      public static function §5!%§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§2!7§;
         var _loc22_:Vector.<b2Vec2> = param2.§"!@§;
         var _loc23_:Vector.<b2Vec2> = param2.§8!o§;
         var _loc24_:int = 0;
