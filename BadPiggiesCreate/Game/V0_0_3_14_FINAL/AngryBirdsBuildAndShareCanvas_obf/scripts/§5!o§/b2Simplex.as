package §5!o§
{
   ...
   class b2Simplex
   {
      ...
      public function §<;§() : b2Vec2
      {
         ...
         switch(this.§<v§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§`!@§(_loc1_,this.m_v1.w.§1"$§());
               if(_loc2_ > 0)
               {
                  return b2Math.§4n§(1,_loc1_);
               }
      ...
      public function Solve3() : void
      {
         ...
         var _loc5_:Number = b2Math.§@!y§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§@!y§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§'!%§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§@!y§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§@!y§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§'!%§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§@!y§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§@!y§(_loc3_,_loc14_);
