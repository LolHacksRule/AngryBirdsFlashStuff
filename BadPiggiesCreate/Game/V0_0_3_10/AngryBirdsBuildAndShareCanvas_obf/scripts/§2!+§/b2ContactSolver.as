package §2!+§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §4N§:b2PositionSolverManifold = new b2PositionSolverManifold();
      ...
      public function §6"8§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§8u§(),_loc10_.§8u§());
            _loc20_ = _loc15_.§#!S§.x;
            _loc21_ = _loc15_.§#!S§.y;
            _loc22_ = _loc16_.§#!S§.x;
            _loc23_ = _loc16_.§#!S§.y;
            ...
            b2Settings.b2Assert(_loc17_.§]7§ > 0);
            §"!;§.§6"8§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §"!;§.§'"!§.x;
            _loc27_ = §"!;§.§'"!§.y;
            (_loc28_ = this.§^!`§[_loc6_]).§`!z§ = _loc15_;
            _loc28_.§#!3§ = _loc16_;
            _loc28_.§2"2§ = _loc17_;
            _loc28_.normal.x = _loc26_;
            _loc28_.normal.y = _loc27_;
            _loc28_.§3!y§ = _loc17_.§]7§;
            _loc28_.friction = _loc18_;
            _loc28_.restitution = _loc19_;
            _loc28_.§9"2§.x = _loc17_.§`4§.x;
            _loc28_.§9"2§.y = _loc17_.§`4§.y;
            ...
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§3!y§)
            {
               _loc30_ = _loc17_.§!!6§[_loc29_];
               (_loc31_ = _loc28_.§2`§[_loc29_]).normalImpulse = _loc30_.§=!F§;
               _loc31_.tangentImpulse = _loc30_.§@v§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§-C§.x = §"!;§.§!!6§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§-C§.y = §"!;§.§!!6§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§-!B§.x = §"!;§.§!!6§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§-!B§.y = §"!;§.§!!6§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§+w§ + _loc16_.§+w§ + _loc15_.§-A§ * _loc36_ + _loc16_.§-A§ * _loc37_;
               _loc31_.§0C§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§<!7§ * _loc15_.§+w§ + _loc16_.§<!7§ * _loc16_.§+w§) + (_loc15_.§<!7§ * _loc15_.§-A§ * _loc36_ + _loc16_.§<!7§ * _loc16_.§-A§ * _loc37_);
               _loc31_.§8!-§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§+w§ + _loc16_.§+w§ + _loc15_.§-A§ * _loc42_ + _loc16_.§-A§ * _loc43_;
               _loc31_.§6!`§ = 1 / _loc44_;
               _loc31_.§9[§ = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         while(_loc24_ < this.§""-§)
         {
            _loc26_ = (_loc25_ = this.§^!`§[_loc24_]).§`!z§;
            _loc27_ = _loc25_.§#!3§;
            ...
            _loc1_ = 0;
            while(_loc1_ < _loc25_.§3!y§)
            {
               _loc2_ = _loc25_.§2`§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§-!B§.y - _loc30_.x + _loc28_ * _loc2_.§-C§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§-!B§.x - _loc30_.y - _loc28_ * _loc2_.§-C§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§6!`§ * -_loc10_;
               _loc12_ = _loc40_ * _loc2_.normalImpulse;
               _loc14_ = (_loc11_ = (_loc13_ = b2Math.§9!n§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_)) - _loc2_.tangentImpulse) * _loc38_;
            ...
            if(_loc25_.§3!y§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§0C§ * (_loc9_ - _loc2_.§9[§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§-!B§.y - _loc30_.x + _loc28_ * _loc43_.§-C§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§-!B§.x - _loc30_.y - _loc28_ * _loc43_.§-C§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§-!B§.y - _loc30_.x + _loc28_ * _loc44_.§-C§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§-!B§.x - _loc30_.y - _loc28_ * _loc44_.§-C§.x;
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§""-§)
         {
            _loc5_ = (_loc4_ = this.§^!`§[_loc3_]).§`!z§;
            _loc6_ = _loc4_.§#!3§;
            _loc7_ = _loc5_.§<!7§ * _loc5_.§+w§;
            _loc8_ = _loc5_.§<!7§ * _loc5_.§-A§;
            _loc9_ = _loc6_.§<!7§ * _loc6_.§+w§;
            _loc10_ = _loc6_.§<!7§ * _loc6_.§-A§;
            §4N§.§6"8§(_loc4_);
            _loc11_ = §4N§.§'"!§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§3!y§)
            {
               _loc13_ = _loc4_.§2`§[_loc12_];
               _loc14_ = §4N§.§!!6§[_loc12_];
               _loc15_ = §4N§.§@2§[_loc12_];
               ...
               _loc20_ = b2Math.§9!n§(param1 * (_loc15_ + b2Settings.b2_linearSlop),-b2Settings.b2_maxLinearCorrection,0);
