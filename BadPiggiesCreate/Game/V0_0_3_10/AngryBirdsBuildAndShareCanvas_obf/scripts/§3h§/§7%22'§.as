package §3h§
{
   public class §7"'§
   {
      ...
      private function §#"$§() : §'T§
      {
         ...
         var _loc2_:§'T§ = new §'T§();
         _loc2_.type = §@$§.§%e§;
         _loc2_.value = this.§="0§(this.§&Z§.substr(this.§-!9§,_loc1_ - this.§-!9§));
         this.§-!9§ = _loc1_ + 1;
         this.§4"%§();
         return _loc2_;
      }
      ...
      public function §="0§(param1:String) : String
      {
         ...
         if(this.§&!1§ && this.§5!f§.test(param1))
         {
      ...
      {
         return this.§#U§ = this.§&Z§.charAt(this.§-!9§++);
      }
      
      private function §8"9§() : void
      {
         var _loc1_:int = 0;
         do
         {
      ...
      {
         return this.§]!D§(param1) || param1 >= "A" && param1 <= "F" || param1 >= "a" && param1 <= "f";
      }
      
      public function parseError(param1:String) : void
      {
         throw new JSONParseError(param1,this.§-!9§,this.§&Z§);
      }
   }
}
