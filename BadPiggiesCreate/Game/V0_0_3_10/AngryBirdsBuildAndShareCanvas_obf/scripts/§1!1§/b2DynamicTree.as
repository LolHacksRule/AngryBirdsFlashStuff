package §1!1§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §6!2§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
         ...
         _loc3_.aabb.§28§.x = param1.§28§.x + _loc4_;
         _loc3_.aabb.§28§.y = param1.§28§.y + _loc5_;
         _loc3_.§;O§ = param2;
         this.§4F§(_loc3_);
         return _loc3_;
      }
      
      public function §"!T§(param1:b2DynamicTreeNode) : void
      {
         this.§=s§(param1);
         this.§2n§(param1);
      }
      ...
      public function §!1§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         var _loc4_:Number = NaN;
         var _loc5_:Number = NaN;
         b2Settings.b2Assert(param1.§3"9§());
         if(param1.aabb.§2p§(param2))
         {
            return false;
         }
         this.§=s§(param1);
         ...
         param1.aabb.§28§.x = param2.§28§.x + _loc4_;
         param1.aabb.§28§.y = param2.§28§.y + _loc5_;
         this.§4F§(param1);
         return true;
      }
      ...
      public function §0!c§(param1:Function, param2:b2AABB) : void
      {
         ...
         while(_loc4_ > 0)
         {
            if((_loc5_ = _loc3_[--_loc4_]).aabb.§;!p§(param2))
            {
               if(_loc5_.§3"9§())
               {
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc5_:b2Vec2;
         (_loc5_ = b2Math.§<l§(_loc3_,_loc4_)).Normalize();
         ...
         _loc9_.§=!8§.x = Math.min(_loc3_.x,_loc10_);
         _loc9_.§=!8§.y = Math.min(_loc3_.y,_loc11_);
         _loc9_.§28§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§28§.y = Math.max(_loc3_.y,_loc11_);
         ...
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§;!p§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§7X§();
      ...
      private function §2n§(param1:b2DynamicTreeNode) : void
      {
         param1.parent = this.§5+§;
         this.§5+§ = param1;
      }
      
      private function §4F§(param1:b2DynamicTreeNode) : void
      {
         ...
         var _loc2_:b2Vec2 = param1.aabb.§7X§();
         ...
         if(_loc3_.§3"9§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§=!8§.x + _loc6_.aabb.§28§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§=!8§.y + _loc6_.aabb.§28§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§=!8§.x + _loc7_.aabb.§28§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§=!8§.y + _loc7_.aabb.§28§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         _loc5_.§;O§ = null;
         _loc5_.aabb.§9!y§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            while(!_loc4_.aabb.§2p§(_loc5_.aabb))
            {
               _loc4_.aabb.§9!y§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
      ...
      private function §=s§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc5_ = _loc3_.aabb;
               _loc3_.aabb = b2AABB.§9!y§(_loc3_.child1.aabb,_loc3_.child2.aabb);
               if(_loc5_.§2p§(_loc3_.aabb))
               {
                  break;
               }
