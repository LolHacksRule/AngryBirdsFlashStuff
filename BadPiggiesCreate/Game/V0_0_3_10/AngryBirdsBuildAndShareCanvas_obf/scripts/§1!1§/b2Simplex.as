package §1!1§
{
   ...
   class b2Simplex
   {
      ...
      public function §6!u§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         while(_loc9_ < this.§;z§)
         {
            ...
            _loc6_ = param2.§9S§(_loc10_.indexA);
            _loc7_ = param4.§9S§(_loc10_.indexB);
            _loc10_.§^q§ = b2Math.§>w§(param3,_loc6_);
            _loc10_.§4"6§ = b2Math.§>w§(param5,_loc7_);
            _loc10_.w = b2Math.§<l§(_loc10_.§4"6§,_loc10_.§^q§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§;z§ > 1)
      ...
      public function §[!G§() : b2Vec2
      {
         ...
         {
            case 1:
               return this.m_v1.w.§'!z§();
            case 2:
               _loc1_ = b2Math.§<l§(this.m_v2.w,this.m_v1.w);
               _loc2_ = b2Math.§@V§(_loc1_,this.m_v1.w.§'!z§());
               if(_loc2_ > 0)
               {
      ...
      public function §=v§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§;z§)
         {
            ...
            case 1:
               ...
               param2.SetV(this.m_v1.§4"6§);
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§^q§.x + this.m_v2.a * this.m_v2.§^q§.x;
               param1.y = this.m_v1.a * this.m_v1.§^q§.y + this.m_v2.a * this.m_v2.§^q§.y;
               param2.x = this.m_v1.a * this.m_v1.§4"6§.x + this.m_v2.a * this.m_v2.§4"6§.x;
               param2.y = this.m_v1.a * this.m_v1.§4"6§.y + this.m_v2.a * this.m_v2.§4"6§.y;
               break;
            case 3:
      ...
      public function §#!E§() : Number
      {
         switch(this.§;z§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§<l§(this.m_v1.w,this.m_v2.w).§7!6§();
            case 3:
               return b2Math.§@V§(b2Math.§<l§(this.m_v2.w,this.m_v1.w),b2Math.§<l§(this.m_v3.w,this.m_v1.w));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve2() : void
      {
         ...
         var _loc3_:b2Vec2 = b2Math.§<l§(_loc2_,_loc1_);
         var _loc4_:Number;
