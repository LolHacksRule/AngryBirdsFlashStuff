package §+!d§
{
   ...
   public class §-%§ extends §]!c§
   {
      ...
      protected function § true§(param1:XML, param2:Vector.<XML>) : void
      {
         var _loc5_:XML = null;
         ...
         var _loc16_:§&"1§ = null;
         var _loc3_:Dictionary = this.§53§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§,"3§(_loc7_,_loc6_)]) == null)
            {
      ...
      private function §,"3§(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function §53§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§,"3§(_loc4_,_loc6_.@name);
