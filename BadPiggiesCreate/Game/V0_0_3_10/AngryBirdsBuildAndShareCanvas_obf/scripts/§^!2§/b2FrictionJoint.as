package §^!2§
{
   ...
   public class b2FrictionJoint extends b2Joint
   {
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc20_:Number = -this.§[Q§ * _loc19_;
         var _loc21_:Number = this.§3!"§;
         _loc18_ = param1.§7"2§ * this.§6N§;
         this.§3!"§ = b2Math.§9!n§(this.§3!"§ + _loc20_,-_loc18_,_loc18_);
         _loc20_ = this.§3!"§ - _loc21_;
         _loc7_ -= _loc12_ * _loc20_;
         _loc9_ += _loc13_ * _loc20_;
         var _loc22_:Number = _loc8_.x - _loc9_ * _loc17_ - _loc6_.x + _loc7_ * _loc15_;
         var _loc23_:Number = _loc8_.y + _loc9_ * _loc16_ - _loc6_.y - _loc7_ * _loc14_;
         var _loc24_:b2Vec2 = b2Math.§"p§(this.§5!t§,new b2Vec2(-_loc22_,-_loc23_));
         var _loc25_:b2Vec2 = this.§+!6§.Copy();
         this.§+!6§.§'!K§(_loc24_);
         _loc18_ = param1.§7"2§ * this.§6q§;
         if(this.§+!6§.§2I§() > _loc18_ * _loc18_)
         {
            this.§+!6§.Normalize();
            this.§+!6§.§<!4§(_loc18_);
         }
         _loc24_ = b2Math.§<l§(this.§+!6§,_loc25_);
