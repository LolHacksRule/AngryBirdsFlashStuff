package §^!2§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§3!%§.x * this.§,6§.x + (this.§3§ + this.§3!%§.z) * this.§%9§.x),param1 * (this.§3!%§.x * this.§,6§.y + (this.§3§ + this.§3!%§.z) * this.§%9§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§@!-§)
         {
            ...
            this.§3!%§.y *= param1.§]"5§;
            this.§3§ *= param1.§]"5§;
            _loc19_ = this.§3!%§.x * this.§,6§.x + (this.§3§ + this.§3!%§.z) * this.§%9§.x;
            _loc20_ = this.§3!%§.x * this.§,6§.y + (this.§3§ + this.§3!%§.z) * this.§%9§.y;
            _loc21_ = this.§3!%§.x * this.m_s1 + this.§3!%§.y + (this.§3§ + this.§3!%§.z) * this.m_a1;
            _loc22_ = this.§3!%§.x * this.m_s2 + this.§3!%§.y + (this.§3§ + this.§3!%§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§+'§ && this.§77§ != b2internal::"!9)
         {
            ...
            _loc15_ = this.§0,§ * (this.§-r§ - _loc14_);
            _loc16_ = this.§3§;
            _loc17_ = param1.§7"2§ * this.§0W§;
            this.§3§ = b2Math.§9!n§(this.§3§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§3§ - _loc16_) * this.§%9§.x;
         ...
         if(this.§9Z§ && this.§77§ != b2internal::"S)
         {
            ...
            if(this.§77§ == b2internal::4d)
            {
               this.§3!%§.z = b2Math.§!&§(this.§3!%§.z,0);
            }
            else if(this.§77§ == b2internal::>!^)
            {
               this.§3!%§.z = b2Math.§]§(this.§3!%§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§3!%§.z - _loc19_.z) * this.§"c§.col3.x;
            _loc22_ = -_loc13_ - (this.§3!%§.z - _loc19_.z) * this.§"c§.col3.y;
            ...
            _loc8_ = _loc20_.x * this.§,6§.x + _loc20_.z * this.§%9§.x;
            _loc9_ = _loc20_.x * this.§,6§.y + _loc20_.z * this.§%9§.y;
         ...
         else
         {
            ...
            this.§3!%§.x += _loc24_.x;
            this.§3!%§.y += _loc24_.y;
            _loc8_ = _loc24_.x * this.§,6§.x;
            _loc9_ = _loc24_.x * this.§,6§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§9Z§)
         {
            ...
            if(b2Math.§get §(this.§1b§ - this.§"!L§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§9!n§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§get §(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§"!L§)
            {
               _loc19_ = b2Math.§9!n§(_loc35_ - this.§"!L§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§"!L§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§1b§)
            {
               _loc19_ = b2Math.§9!n§(_loc35_ - this.§1b§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc35_ - this.§1b§;
               _loc18_ = true;
            }
         }
         ...
         var _loc31_:Number = _loc28_.x * this.§,6§.x + _loc28_.z * this.§%9§.x;
         var _loc32_:Number = _loc28_.x * this.§,6§.y + _loc28_.z * this.§%9§.y;
         ...
         _loc6_.x -= b2internal::1!7 * _loc31_;
         _loc6_.y -= b2internal::1!7 * _loc32_;
