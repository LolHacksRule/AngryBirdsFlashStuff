package §%t§
{
   ...
   public class §^!x§
   {
      ...
      private function §6!K§(param1:String) : void
      {
      ...
      private function §%!V§(param1:Array) : Array
      {
         var _loc3_:String = null;
         var _loc2_:Array = [];
      ...
      private function § !H§(param1:Array) : §2!D§
      {
         var _loc3_:String = null;
         var _loc4_:§#B§ = null;
         var _loc2_:§2!D§ = new §2!D§();
         for each(_loc3_ in param1)
         {
            _loc4_ = this.§^o§.§ !Z§(_loc3_);
      ...
      protected function §^"$§(param1:String, param2:Array) : void
      {
         ...
         for each(_loc4_ in param2)
         {
            _loc5_ = _loc4_[0];
            _loc6_ = _loc4_[1];
            _loc3_.§,#§(_loc5_,this.§ !H§(_loc6_));
         }
         this.§@!^§[param1] = _loc3_;
      }
      
      public function §5!7§(param1:String) : §2!D§
      {
         return this.§@!^§[param1];
      }
   }
