package §="$§
{
   ...
   public class §%§
   {
      ...
      private static var §+!b§:Number = 10;
      ...
      public static function doJsCall(param1:String, ... rest) : void
      {
         ...
         var timer:Timer = new Timer(§+!b§,1);
         switch(param0)
         {
            case "startQuest":
               timer.addEventListener(TimerEvent.TIMER_COMPLETE,function():void
               {
                  §!!h§["onQuestStarted"](§3!2§(),§6!7§());
               });
               break;
            case "fetchQuests":
               timer.addEventListener(TimerEvent.TIMER_COMPLETE,function():void
            ...
            case "completeQuest":
               timer.addEventListener(TimerEvent.TIMER_COMPLETE,function():void
               {
                  §!!h§["onQuestCompleted"](§+P§(),§2!n§());
               });
         }
         timer.start();
      }
      
      private static function §3!2§() : String
      {
      ...
      private static function §6!7§() : String
      {
         return "";
      }
      ...
      private static function §2!n§() : String
      {
