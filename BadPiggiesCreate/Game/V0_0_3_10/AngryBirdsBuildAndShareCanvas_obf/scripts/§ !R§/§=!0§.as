package § !R§
{
   ...
   public class §=!0§ extends EventDispatcher
   {
      ...
      public function §=!0§(param1:IEventDispatcher = null)
      {
      ...
      override public function addEventListener(param1:String, param2:Function, param3:Boolean = false, param4:int = 0, param5:Boolean = false) : void
      {
         ...
         ((this.§!O§[param1] || (this.§!O§[param1] = new Vector.<ListenerData>())) as Vector.<ListenerData>).push(_loc6_);
      }
      ...
      override public function removeEventListener(param1:String, param2:Function, param3:Boolean = false) : void
      {
         ...
         if((_loc4_ = this.§!O§[param1] as Vector.<ListenerData>) != null)
         {
      ...
      public function copyFrom(param1:§=!0§) : void
      {
         var _loc3_:* = null;
         ...
         var _loc6_:uint = 0;
         var _loc7_:ListenerData = null;
         var _loc2_:Dictionary = param1.§!O§;
