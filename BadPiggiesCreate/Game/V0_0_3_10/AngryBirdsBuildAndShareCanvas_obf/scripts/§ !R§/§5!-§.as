package § !R§
{
   ...
   public class §5!-§
   {
      ...
      private function §3B§(param1:Class) : Vector.<Class>
      {
      ...
      public function §&!Z§(param1:Class, param2:Class, param3:Array) : void
      {
         var _loc4_:uint = param3.length;
         var _loc5_:uint = 0;
         while(_loc5_ < _loc4_)
         {
            this.§&!C§(param1,param2,param3[_loc5_]);
            _loc5_++;
         }
      }
      ...
      public function §&!C§(param1:Class, param2:Class, param3:String) : void
      {
         var _loc7_:uint = 0;
         var _loc8_:uint = 0;
         ...
         if((_loc6_ = this.§^!R§[param2] as Vector.<Class>) != null)
         {
      ...
      private function §&!w§(param1:Class) : void
      {
         ...
         var _loc3_:Dictionary = this.§^!R§;
         var _loc4_:Dictionary = new Dictionary();
         var _loc6_:uint;
         var _loc5_:Vector.<Class>;
         var _loc7_:int = _loc6_ = (_loc5_ = this.§3B§(param1)).length;
         while(--_loc7_ >= 0)
         {
