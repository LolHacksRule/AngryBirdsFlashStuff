package §4!s§
{
   ...
   public class §7!$§
   {
      ...
      public static const §,M§:Number = 8.8;
      ...
      public static const §4!=§:Number = 4;
      
      public static const §',§:Number = 60;
      
      public static const §=u§:Number = 16;
      
      public static const §!"'§:Number = 6 * §=u§;
      ...
      public static const §5W§:Number = 5;
      
      public static var §3!P§:int = 2;
      ...
      public static const §0S§:Number = 1.5;
      
      public static var §!k§:int = 60;
      
      public static const §'""§:Number = 9;
      
      public static const §3L§:Number = 5;
      ...
      public static const §9!b§:Number = 300;
      
      public static const §-!f§:Number = 0.5;
      
      public static const §,+§:Number = 6;
      
      public static const §`!Y§:Number = 9;
      
      public static const §-!A§:Number = 0.15;
      
      public static const §9"7§:Number = 10;
