package §6U§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      b2internal var §6!z§:b2EdgeShape;
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§0M§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§^'§ = this.§0M§.Normalize();
         this.§'"!§.Set(this.§0M§.y,-this.§0M§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§'"!§.x - this.§0M§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§'"!§.y - this.§0M§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§'"!§.x + this.§0M§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§'"!§.y + this.§0M§.y) + this.m_v2.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§1>§ * _loc12_)
            {
      ...
      public function §5`§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §93§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
      ...
      b2internal function §>!u§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§;!k§ = param1;
      ...
      b2internal function §?!m§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§6!z§ = param1;
