package §4!S§
{
   ...
   public class Texture
   {
      ...
      public static function §%!J§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §4!S§.Texture
      {
         return §7'§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §7'§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §4!S§.Texture
      {
         ...
         return new §4!5§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §'[§(param1:Context3D, param2:ByteArray) : §4!S§.Texture
      {
         if(param1 == null)
         {
            throw new §%!d§();
      ...
      public static function §-!Y§(param1:§4!S§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §4!S§.Texture
      {
         var _loc4_:§4!S§.Texture;
         (_loc4_ = new §4!5§(param1,param2)).§60§ = param3;
         return _loc4_;
      }
      
      public static function empty(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §4!S§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§4!S§.Texture = §7'§(param1,_loc6_,false,param5);
         if(!§^e§.§%d§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§&-§, param2:int, param3:int) : void
      {
         ...
         if(this.§60§)
         {
            ...
            _loc4_ = this.§60§.width + this.§60§.x - this.width;
            _loc5_ = this.§60§.height + this.§60§.y - this.height;
            param1.§'!o§(param2,-this.§60§.x,-this.§60§.y);
            param1.§'!o§(param2 + 1,-_loc4_,-this.§60§.y);
            param1.§'!o§(param2 + 2,-this.§60§.x,-_loc5_);
      ...
      {
         return !!this.§60§ ? this.§60§.clone() : new Rectangle(0,0,this.width,this.height);
      }
      ...
      public function get root() : §4!S§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §4!S§.Texture
      {
         return this;
      }
