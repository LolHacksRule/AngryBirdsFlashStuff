package §6U§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      b2internal var §-u§:Vector.<b2Vec2>;
      
      b2internal var §,!i§:Vector.<b2Vec2>;
      
      b2internal var §8x§:int;
      ...
      public function b2PolygonShape()
      {
         ...
         §""#§ = b2internal::`"6;
         this.§>!a§ = new b2Vec2();
         this.§-u§ = new Vector.<b2Vec2>();
         this.§,!i§ = new Vector.<b2Vec2>();
         §'O§ = b2Settings.b2_polygonRadius;
         this.§>!a§.§+Z§();
      }
      
      public static function §;!h§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function §'C§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §6"!§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§2!p§(param1,param2);
         return _loc3_;
      }
      
      public static function §<n§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
      ...
      public static function §16§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§5"8§(param1,param2);
         return _loc3_;
      }
      ...
      public static function §%`§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§'!K§(new b2Vec2(0,0));
            _loc3_.§'!K§(_loc9_);
            _loc3_.§'!K§(_loc10_);
            _loc3_.§<!4§(_loc16_ * _loc7_);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §^6§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§4!h§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§4!h§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            this.§6M§(this.§8x§);
            _loc3_ = 0;
            while(_loc3_ < this.§8x§)
            {
               this.§-u§[_loc3_].SetV(_loc2_.§-u§[_loc3_]);
      ...
      public function §%K§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         while(_loc3_ < this.§8x§)
         {
            this.§-u§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§8x§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§8x§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§<l§(this.§-u§[_loc5_],this.§-u§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§2I§() > Number.MIN_VALUE);
            this.§,!i§[_loc3_].SetV(b2Math.§-8§(_loc6_,1));
            this.§,!i§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§>!a§ = §%`§(this.§-u§,this.§8x§);
      }
      
      public function §2!p§(param1:Number, param2:Number) : void
      {
         this.§8x§ = 4;
         this.§6M§(4);
         this.§-u§[0].Set(-param1,-param2);
         this.§-u§[1].Set(param1,-param2);
         this.§-u§[2].Set(param1,param2);
         this.§-u§[3].Set(-param1,param2);
         this.§,!i§[0].Set(0,-1);
         this.§,!i§[1].Set(1,0);
         this.§,!i§[2].Set(0,1);
         this.§,!i§[3].Set(-1,0);
      ...
      public function §0@§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§8x§)
         {
            this.§-u§[_loc6_] = b2Math.§>w§(_loc5_,this.§-u§[_loc6_]);
            this.§,!i§[_loc6_] = b2Math.§"p§(_loc5_.R,this.§,!i§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §5"8§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§8x§ = 2;
         this.§6M§(2);
         this.§-u§[0].SetV(param1);
         this.§-u§[1].SetV(param2);
         this.§>!a§.x = 0.5 * (param1.x + param2.x);
         this.§>!a§.y = 0.5 * (param1.y + param2.y);
         this.§,!i§[0] = b2Math.§-8§(b2Math.§<l§(param2,param1),1);
         this.§,!i§[0].Normalize();
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < this.§8x§)
         {
            _loc3_ = this.§-u§[_loc9_];
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§8x§)
         {
            _loc6_ = (_loc9_ = this.§-u§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§=!8§.x = _loc5_ - b2internal::'O;
         param1.§=!8§.y = _loc6_ - b2internal::'O;
         param1.§28§.x = _loc7_ + b2internal::'O;
         param1.§28§.y = _loc8_ + b2internal::'O;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§8x§ == 2)
         {
            param1.center.x = 0.5 * (this.§-u§[0].x + this.§-u§[1].x);
            param1.center.y = 0.5 * (this.§-u§[0].y + this.§-u§[1].y);
            param1.§8L§ = 0;
            param1.I = 0;
            return;
         }
         ...
         var _loc6_:Number = 0;
         var _loc10_:int = 0;
         while(_loc10_ < this.§8x§)
         {
            _loc11_ = this.§-u§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§8x§ ? this.§-u§[int(_loc10_ + 1)] : this.§-u§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§ null§(param3.R,param1);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§8x§)
         {
            _loc7_[_loc12_] = b2Math.§`",§(_loc5_,this.§-u§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§>w§(param3,_loc24_.center));
                  return _loc24_.§8L§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§8x§;
         var _loc14_:int = (_loc10_ + 1) % this.§8x§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§-u§[_loc9_].x * (1 - _loc15_) + this.§-u§[_loc13_].x * _loc15_,this.§-u§[_loc9_].y * (1 - _loc15_) + this.§-u§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§-u§[_loc10_].x * (1 - _loc16_) + this.§-u§[_loc14_].x * _loc16_,this.§-u§[_loc10_].y * (1 - _loc16_) + this.§-u§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§-u§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§8x§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§-u§[_loc12_];
            }
         ...
         _loc20_.§<!4§(1 / _loc19_);
         param4.SetV(b2Math.§>w§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §>4§() : Vector.<b2Vec2>
      {
         return this.§-u§;
      }
      ...
      private function §6M§(param1:int) : void
      {
         var _loc2_:int = this.§-u§.length;
         while(_loc2_ < param1)
         {
            this.§-u§[_loc2_] = new b2Vec2();
