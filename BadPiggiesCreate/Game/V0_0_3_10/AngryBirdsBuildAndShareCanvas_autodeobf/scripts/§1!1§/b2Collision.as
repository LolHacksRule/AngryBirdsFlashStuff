package §1!1§
{
   ...
   public class b2Collision
   {
      ...
      private static var §6!;§:Vector.<§"^§> = §3![§();
      
      private static var s_clipPoints1:Vector.<§"^§> = §3![§();
      
      private static var s_clipPoints2:Vector.<§"^§> = §3![§();
      
      private static var § M§:Vector.<int> = new Vector.<int>(1);
      
      private static var §6!9§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §>!T§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§8x§;
         var _loc7_:Vector.<b2Vec2> = param1.§-u§;
         var _loc8_:Vector.<b2Vec2> = param1.§,!i§;
         var _loc9_:int = param4.§8x§;
         var _loc10_:Vector.<b2Vec2> = param4.§-u§;
         _loc11_ = param2.R;
      ...
      public static function §3H§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §>!T§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §>!T§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §>!T§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §>!T§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §"!G§(param1:Vector.<§"^§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§"^§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§8x§;
         var _loc8_:Vector.<b2Vec2> = param2.§,!i§;
         var _loc9_:int = param5.§8x§;
         var _loc10_:Vector.<b2Vec2> = param5.§-u§;
         ...
         _loc20_.id.§5!;§.§0y§ = param4;
         _loc20_.id.§5!;§.§;!"§ = _loc21_;
         _loc20_.id.§5!;§.§default§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§5!;§.§0y§ = param4;
         _loc20_.id.§5!;§.§;!"§ = _loc22_;
         _loc20_.id.§5!;§.§default§ = 1;
      }
      
      private static function §3![§() : Vector.<§"^§>
      {
      ...
      public static function §+"§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         § M§[0] = _loc8_;
         var _loc9_:Number = §3H§(§ M§,param2,param3,param4,param5);
         _loc8_ = § M§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §6!9§[0] = _loc10_;
         var _loc11_:Number = §3H§(§6!9§,param4,param5,param2,param3);
         _loc10_ = §6!9§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§"^§> = §6!;§;
         §"!G§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§8x§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§-u§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §&P§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
      ...
      public static function §!!;§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§""#§ = b2Manifold.§0"8§;
         param1.m_localPoint.SetV(param2.§]z§);
         param1.§`4§.§+Z§();
         param1.§]7§ = 1;
         param1.§!!6§[0].m_localPoint.SetV(param4.§]z§);
         param1.§!!6§[0].m_id.key = 0;
      }
      
      public static function §>!f§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§8x§;
         var _loc22_:Vector.<b2Vec2> = param2.§-u§;
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§]7§ = 1;
            param1.§""#§ = b2Manifold.§""'§;
            param1.§`4§.x = _loc15_ - _loc27_.x;
            param1.§`4§.y = _loc16_ - _loc27_.y;
            param1.§`4§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§]7§ = 1;
            param1.§""#§ = b2Manifold.§""'§;
            param1.§`4§.x = _loc15_ - _loc28_.x;
            param1.§`4§.y = _loc16_ - _loc28_.y;
            param1.§`4§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§!!6§[0].m_localPoint.SetV(param4.§]z§);
            param1.§!!6§[0].m_id.key = 0;
