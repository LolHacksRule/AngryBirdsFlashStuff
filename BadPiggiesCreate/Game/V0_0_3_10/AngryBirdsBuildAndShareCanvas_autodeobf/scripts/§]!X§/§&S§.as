package §]!X§
{
   ...
   public class §&S§ extends Sprite
   {
      ...
      public function §&S§(param1:int, param2:int, param3:Number, param4:Number, param5:int, param6:int = 40)
      {
         var _loc9_:§0X§ = null;
         ...
         this.§[!w§ = param1;
         this.§6o§ = param2;
         var _loc7_:Number = Math.min(§"!V§.§8!e§,§"!V§.§4-§);
         var _loc8_:Number = Math.max(§"!V§.§8!e§,§"!V§.§4-§);
         param3 /= §"!V§.§4-§;
         param4 /= §"!V§.§8!e§;
         this.§`Y§ = param5;
         ...
         {
            (_loc9_ = new §0X§(Math.random() * 40 + 10)).x = -2000;
            _loc9_.y = -2000;
