   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            _loc7_ = this.§?""§[_loc6_];
            §,,§(_loc7_,§-!z§);
            transformCoords(§-!z§,_loc3_,_loc4_,§<!m§);
            if(_loc8_ = _loc7_.hitTest(§<!m§,param2))
            {
               return _loc8_;
            }
            _loc6_--;
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§5"5§(this,param1.type,_loc2_);
      ...
      private function §5"5§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               this.§5"5§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
