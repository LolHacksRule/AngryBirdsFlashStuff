         ...
         switch(param1.§0!,§)
         {
            case b2Manifold.§%"#§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§&!5§.x = _loc19_ / _loc26_;
                  this.§&!5§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§&!5§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§&!5§.x;
               _loc23_ = _loc16_ + param3 * this.§&!5§.y;
               _loc24_ = _loc17_ - param5 * this.§&!5§.x;
               _loc25_ = _loc18_ - param5 * this.§&!5§.y;
               this.§5S§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§5S§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§`!5§:
               _loc8_ = param2.R;
               _loc7_ = param1.§5!=§;
            ...
            case b2Manifold.§&O§:
               ...
               while(_loc6_ < param1.§`!>§)
               {
                  ...
                  this.§5S§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§5S§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
