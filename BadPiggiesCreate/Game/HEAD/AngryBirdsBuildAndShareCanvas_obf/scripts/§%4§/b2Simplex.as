   ...
   class b2Simplex
   {
      ...
      public function §3W§() : b2Vec2
      {
         ...
         switch(this.§`"2§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§9!r§(_loc1_,this.m_v1.w.§5E§());
               if(_loc2_ > 0)
               {
      ...
      public function §6r§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§`"2§)
         {
            ...
            case 2:
               ...
               param2.x = this.m_v1.a * this.m_v1.§+m§.x + this.m_v2.a * this.m_v2.§+m§.x;
               param2.y = this.m_v1.a * this.m_v1.§+m§.y + this.m_v2.a * this.m_v2.§+m§.y;
               break;
            case 3:
      ...
      public function §+"7§() : Number
      {
         switch(this.§`"2§)
         {
            ...
            case 3:
               return b2Math.§9!r§(b2Math.§ !r§(this.m_v2.w,this.m_v1.w),b2Math.§ !r§(this.m_v3.w,this.m_v1.w));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc5_:Number = b2Math.§8n§(_loc1_,_loc4_);
         var _loc6_:Number;
         var _loc7_:Number = _loc6_ = b2Math.§8n§(_loc2_,_loc4_);
         var _loc8_:Number = -_loc5_;
         var _loc9_:b2Vec2 = b2Math.§ !r§(_loc3_,_loc1_);
         var _loc10_:Number = b2Math.§8n§(_loc1_,_loc9_);
         var _loc11_:Number;
         var _loc12_:Number = _loc11_ = b2Math.§8n§(_loc3_,_loc9_);
         var _loc13_:Number = -_loc10_;
         var _loc14_:b2Vec2 = b2Math.§ !r§(_loc3_,_loc2_);
         var _loc15_:Number = b2Math.§8n§(_loc2_,_loc14_);
         var _loc16_:Number;
         var _loc17_:Number = _loc16_ = b2Math.§8n§(_loc3_,_loc14_);
         var _loc18_:Number = -_loc15_;
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§9!r§(_loc4_,_loc9_)) * b2Math.§9!r§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§9!r§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§9!r§(_loc1_,_loc2_);
