package §%4§
{
   ...
   public class b2Collision
   {
      ...
      private static var §!8§:Vector.<§1!-§> = §'!L§();
      
      private static var s_clipPoints1:Vector.<§1!-§> = §'!L§();
      
      private static var s_clipPoints2:Vector.<§1!-§> = §'!L§();
      
      private static var § !-§:Vector.<int> = new Vector.<int>(1);
      
      private static var §8!H§:Vector.<int> = new Vector.<int>(1);
      ...
      private static var §2!R§:b2Vec2 = new b2Vec2();
      ...
      public static function §8!d§(param1:Vector.<§1!-§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc20_:§1!-§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§6!-§;
         var _loc8_:Vector.<b2Vec2> = param2.§#`§;
         var _loc9_:int = param5.§6!-§;
      ...
      public static function §`!e§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         § !-§[0] = _loc8_;
         var _loc9_:Number = §0"2§(§ !-§,param2,param3,param4,param5);
         _loc8_ = § !-§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §8!H§[0] = _loc10_;
         var _loc11_:Number = §0"2§(§8!H§,param4,param5,param2,param3);
         _loc10_ = §8!H§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         var _loc21_:Vector.<§1!-§> = §!8§;
         §8!d§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§6!-§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§^c§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §"!G§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = § !w§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §[!u§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §2!R§;
         _loc20_ = _loc14_.R;
         ...
         if((_loc39_ = §,Z§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §,Z§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
      ...
      public static function §%d§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§6!-§;
         var _loc22_:Vector.<b2Vec2> = param2.§^c§;
