   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      public static function §[!4§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§<!n§(new b2Vec2(0,0));
            _loc3_.§<!n§(_loc9_);
            _loc3_.§<!n§(_loc10_);
            _loc3_.§7H§(_loc16_ * _loc7_);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      public function §8B§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§6!-§ ? int(_loc3_ + 1) : 0;
      ...
      public function §^!q§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§6!-§)
         {
            this.§^c§[_loc6_] = b2Math.§#!K§(_loc5_,this.§^c§[_loc6_]);
            this.§#`§[_loc6_] = b2Math.§<!G§(_loc5_.R,this.§#`§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §3!7§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§#`§[0] = b2Math.§>O§(b2Math.§ !r§(param2,param1),1);
         this.§#`§[0].Normalize();
         this.§#`§[1].x = -this.§#`§[0].x;
         this.§#`§[1].y = -this.§#`§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§6!-§)
         {
            _loc6_ = (_loc9_ = this.§^c§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§=!H§.x = _loc5_ - b2internal::&!$;
         param1.§=!H§.y = _loc6_ - b2internal::&!$;
         param1.§6P§.x = _loc7_ + b2internal::&!$;
         param1.§6P§.y = _loc8_ + b2internal::&!$;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§6!-§ == 2)
         {
            param1.center.x = 0.5 * (this.§^c§[0].x + this.§^c§[1].x);
            param1.center.y = 0.5 * (this.§^c§[0].y + this.§^c§[1].y);
            param1.§3,§ = 0;
            param1.I = 0;
            return;
         }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§8n§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§8n§(_loc5_,this.§^c§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§#!K§(param3,_loc24_.center));
                  return _loc24_.§3,§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§6!-§;
         var _loc14_:int = (_loc10_ + 1) % this.§6!-§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§^c§[_loc9_].x * (1 - _loc15_) + this.§^c§[_loc13_].x * _loc15_,this.§^c§[_loc9_].y * (1 - _loc15_) + this.§^c§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§^c§[_loc10_].x * (1 - _loc16_) + this.§^c§[_loc14_].x * _loc16_,this.§^c§[_loc10_].y * (1 - _loc16_) + this.§^c§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§^c§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§6!-§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§^c§[_loc12_];
            }
         ...
         _loc20_.§7H§(1 / _loc19_);
         param4.SetV(b2Math.§#!K§(param3,_loc20_));
         return _loc19_;
      }
