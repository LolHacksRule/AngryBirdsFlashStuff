   ...
   public class §="<§ extends EventDispatcher
   {
      ...
      private function §4!a§(param1:Array, param2:BitmapData) : Array
      {
         ...
         while(param1.length > 0)
         {
            ...
            if(_loc3_ + _loc9_.width + §<k§ > param2.width)
            {
               _loc3_ = 0;
               _loc4_ += _loc5_;
               _loc5_ = 0;
            }
            if(_loc4_ + _loc9_.height + §<k§ > param2.height)
            {
               break;
            }
            ...
            _loc3_ += _loc9_.width + §<k§;
            if(_loc9_.height + §<k§ > _loc5_)
            {
               _loc5_ = _loc9_.height + §<k§;
            }
            param1.splice(0,1);
         }
         return _loc6_;
