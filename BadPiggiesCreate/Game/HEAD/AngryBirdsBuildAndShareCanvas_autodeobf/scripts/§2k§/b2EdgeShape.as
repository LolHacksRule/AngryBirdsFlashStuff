package §2k§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§[!G§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§,!P§ = this.§[!G§.Normalize();
         this.§&!5§.Set(this.§[!G§.y,-this.§[!G§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§&!5§.x - this.§[!G§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§&!5§.y - this.§[!G§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§&!5§.x + this.§[!G§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§&!5§.y + this.§[!G§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§&!5§;
         this.m_cornerDir2.Set(-this.§&!5§.x,-this.§&!5§.y);
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc8_:Number = b2Math.§8n§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§8n§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
