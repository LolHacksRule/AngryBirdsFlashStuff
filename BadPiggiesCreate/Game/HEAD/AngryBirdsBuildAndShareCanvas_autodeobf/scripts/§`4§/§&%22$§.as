package §`4§
{
   ...
   public class §&"$§ extends §#![§
   {
      ...
      public static const §66§:Array = ["x","y","z","scaleX","scaleY","scaleZ","rotation","rotationX","rotationY","rotationZ","alpha","width","height","_bevelFilter","_blurFilter","_colorMatrixFilter","_convolutionFilter","_displacementMapFilter","_dropShadowFilter","_glowFilter","_gradientBevelFilter","_gradientGlowFilter","_shaderFilter"];
      ...
      override public function setDestinationValue(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         {
            this._flags |= 4;
            this.§8A§.relativeFlags |= !!param3 ? 4 : 0;
            this.§8A§.z = param2;
         }
         else if(param1 == "scaleX")
         {
            this._flags |= 8;
            this.§8A§.relativeFlags |= !!param3 ? 8 : 0;
            this.§8A§.scaleX = param2;
         }
         else if(param1 == "scaleY")
         {
            this._flags |= 16;
            this.§8A§.relativeFlags |= !!param3 ? 16 : 0;
            this.§8A§.scaleY = param2;
         }
         else if(param1 == "scaleZ")
         {
            this._flags |= 32;
            this.§8A§.relativeFlags |= !!param3 ? 32 : 0;
            this.§8A§.scaleZ = param2;
         }
         else if(param1 == "rotation")
         {
            this._flags |= 64;
            this.§8A§.relativeFlags |= !!param3 ? 64 : 0;
            this.§8A§.rotation = param2;
         }
         else if(param1 == "rotationX")
         {
            this._flags |= 128;
            this.§8A§.relativeFlags |= !!param3 ? 128 : 0;
            this.§8A§.rotationX = param2;
         }
         else if(param1 == "rotationY")
         {
            this._flags |= 256;
            this.§8A§.relativeFlags |= !!param3 ? 256 : 0;
            this.§8A§.rotationY = param2;
         }
         else if(param1 == "rotationZ")
         {
            this._flags |= 512;
            this.§8A§.relativeFlags |= !!param3 ? 512 : 0;
            this.§8A§.rotationZ = param2;
         }
         else if(param1 == "alpha")
         {
            this._flags |= 1024;
            this.§8A§.relativeFlags |= !!param3 ? 1024 : 0;
            this.§8A§.alpha = param2;
         }
         else if(param1 == "width")
         {
            this._flags |= 2048;
            this.§8A§.relativeFlags |= !!param3 ? 2048 : 0;
            this.§8A§.width = param2;
         }
         else if(param1 == "height")
         {
            this._flags |= 4096;
            this.§8A§.relativeFlags |= !!param3 ? 4096 : 0;
            this.§8A§.height = param2;
         }
      }
      ...
      override public function setSourceValue(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         {
            this._flags |= 2;
            this.§`v§.relativeFlags |= !!param3 ? 2 : 0;
            this.§`v§.y = param2;
         }
         else if(param1 == "z")
         {
            this._flags |= 4;
            this.§`v§.relativeFlags |= !!param3 ? 4 : 0;
            this.§`v§.z = param2;
         }
         else if(param1 == "scaleX")
         {
            this._flags |= 8;
            this.§`v§.relativeFlags |= !!param3 ? 8 : 0;
            this.§`v§.scaleX = param2;
         }
         else if(param1 == "scaleY")
         {
            this._flags |= 16;
            this.§`v§.relativeFlags |= !!param3 ? 16 : 0;
            this.§`v§.scaleY = param2;
         }
         else if(param1 == "scaleZ")
         {
            this._flags |= 32;
            this.§`v§.relativeFlags |= !!param3 ? 32 : 0;
            this.§`v§.scaleZ = param2;
         }
         else if(param1 == "rotation")
         {
            this._flags |= 64;
            this.§`v§.relativeFlags |= !!param3 ? 64 : 0;
            this.§`v§.rotation = param2;
         }
         else if(param1 == "rotationX")
         {
            this._flags |= 128;
            this.§`v§.relativeFlags |= !!param3 ? 128 : 0;
            this.§`v§.rotationX = param2;
         }
         else if(param1 == "rotationY")
         {
            this._flags |= 256;
            this.§`v§.relativeFlags |= !!param3 ? 256 : 0;
            this.§`v§.rotationY = param2;
         }
         else if(param1 == "rotationZ")
         {
            this._flags |= 512;
            this.§`v§.relativeFlags |= !!param3 ? 512 : 0;
            this.§`v§.rotationZ = param2;
         }
         else if(param1 == "alpha")
         {
            this._flags |= 1024;
            this.§`v§.relativeFlags |= !!param3 ? 1024 : 0;
            this.§`v§.alpha = param2;
         }
         else if(param1 == "width")
         {
            this._flags |= 2048;
            this.§`v§.relativeFlags |= !!param3 ? 2048 : 0;
            this.§`v§.width = param2;
         }
         else if(param1 == "height")
         {
            this._flags |= 4096;
            this.§`v§.relativeFlags |= !!param3 ? 4096 : 0;
            this.§`v§.height = param2;
         }
      }
      ...
      {
         var _loc1_:DisplayObject = this.§[l§;
         var _loc2_:DisplayObjectParameter = this.§8A§;
         var _loc3_:DisplayObjectParameter = this.§`v§;
         var _loc4_:uint;
