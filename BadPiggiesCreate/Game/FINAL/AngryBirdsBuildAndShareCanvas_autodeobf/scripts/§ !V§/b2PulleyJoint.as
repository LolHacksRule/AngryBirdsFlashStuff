package § !V§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§%2§ = b2internal::0"7.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§-+§.x - this.§%2§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§-+§.y - this.§%2§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§'8§.x - this.§%2§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§'8§.y - this.§%2§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§!2§);
         this.m_localAnchor2.SetV(param1.§ !c§);
         this.§?!L§ = param1.§`x§;
         this.§6s§ = param1.§,q§ + this.§?!L§ * param1.§-!k§;
         this.m_maxLength1 = b2Math.§8L§(param1.§;[§,this.§6s§ - this.§?!L§ * b2internal::5!,);
         this.m_maxLength2 = b2Math.§8L§(param1.§1!2§,(this.§6s§ - b2internal::5!,) / this.§?!L§);
         this.§?;§ = 0;
      ...
      public function GetLength1() : Number
      {
         ...
         var _loc2_:Number = this.§%2§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.§%2§.m_xf.position.y + this.m_groundAnchor1.y;
      ...
      public function GetLength2() : Number
      {
         ...
         var _loc2_:Number = this.§%2§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.§%2§.m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc14_:Number = this.§%2§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.§%2§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.§%2§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.§%2§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§6s§ - _loc18_ - this.§?!L§ * _loc19_) > 0)
         {
            this.§7"%§ = b2internal::@g;
            this.§?;§ = 0;
         }
         ...
         this.m_limitMass1 = _loc2_.§;k§ + _loc2_.§6x§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§;k§ + _loc3_.§6x§ * _loc22_ * _loc22_;
         this.§]0§ = this.m_limitMass1 + this.§?!L§ * this.§?!L§ * this.m_limitMass2;
         ...
         {
            this.§?;§ *= param1.§<3§;
            this.m_limitImpulse1 *= param1.§<3§;
            this.m_limitImpulse2 *= param1.§<3§;
            _loc23_ = (-this.§?;§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§?;§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§?!L§ * this.§?;§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§?!L§ * this.§?;§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§,b§.x += _loc2_.§;k§ * _loc23_;
            _loc2_.§,b§.y += _loc2_.§;k§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§6x§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§,b§.x += _loc3_.§;k§ * _loc25_;
            _loc3_.§,b§.y += _loc3_.§;k§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§6x§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§?;§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§7"%§ == b2internal::^"<)
         {
            ...
            _loc19_ = this.§]0§ * -_loc18_;
            _loc20_ = this.§?;§;
            this.§?;§ = b2Math.§6§(0,this.§?;§ + _loc19_);
            ...
            _loc2_.§,b§.x += _loc2_.§;k§ * _loc14_;
            _loc2_.§,b§.y += _loc2_.§;k§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§6x§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§,b§.x += _loc3_.§;k§ * _loc16_;
            _loc3_.§,b§.y += _loc3_.§;k§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§6x§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
         if(this.m_limitState1 == b2internal::^"<)
         {
            ...
            this.m_limitImpulse1 = b2Math.§6§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == b2internal::^"<)
         {
            ...
            this.m_limitImpulse2 = b2Math.§6§(0,this.m_limitImpulse2 + _loc19_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal::0"7;
         var _loc3_:b2Body = b2internal:: `;
         var _loc5_:Number = this.§%2§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.§%2§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.§%2§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.§%2§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         if(this.§7"%§ == b2internal::^"<)
         {
            ...
            _loc19_ = this.§6s§ - _loc17_ - this.§?!L§ * _loc18_;
            _loc24_ = b2Math.§6§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§&>§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            _loc13_ = -(_loc20_ = -this.§]0§ * _loc19_) * this.m_u1.x;
            _loc14_ = -_loc20_ * this.m_u1.y;
            _loc15_ = -this.§?!L§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§?!L§ * _loc20_ * this.m_u2.y;
            _loc2_.m_sweep.c.x += _loc2_.§;k§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§;k§ * _loc14_;
            _loc2_.m_sweep.a += _loc2_.§6x§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§;k§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§;k§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§6x§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§#!k§();
            _loc3_.§#!k§();
         }
         if(this.m_limitState1 == b2internal::^"<)
