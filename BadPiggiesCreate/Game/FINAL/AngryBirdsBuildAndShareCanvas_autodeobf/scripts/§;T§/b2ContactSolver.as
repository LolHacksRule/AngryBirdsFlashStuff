package §;T§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §5O§:b2WorldManifold = new b2WorldManifold();
      ...
      public function §1o§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§5"$§;
            _loc10_ = _loc5_.dynamic;
            _loc11_ = _loc9_.§#j§;
            _loc12_ = _loc10_.§#j§;
            _loc13_ = _loc11_.§;$§;
            _loc14_ = _loc12_.§;$§;
            ...
            _loc17_ = _loc5_.§%!X§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§2!U§(),_loc10_.§2!U§());
            ...
            b2Settings.b2Assert(_loc17_.§<!c§ > 0);
            §5O§.§1o§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §5O§.§]!?§.x;
            _loc27_ = §5O§.§]!?§.y;
            (_loc28_ = this.§#I§[_loc6_]).§@!<§ = _loc15_;
            _loc28_.§3j§ = _loc16_;
            _loc28_.§implements§ = _loc17_;
            _loc28_.normal.x = _loc26_;
            _loc28_.normal.y = _loc27_;
            _loc28_.§<"5§ = _loc17_.§<!c§;
            _loc28_.friction = _loc18_;
            _loc28_.restitution = _loc19_;
            _loc28_.§ !Y§.x = _loc17_.§,"'§.x;
            _loc28_.§ !Y§.y = _loc17_.§,"'§.y;
            ...
            while(_loc29_ < _loc28_.§<"5§)
            {
               ...
               (_loc31_ = _loc28_.§>"%§[_loc29_]).normalImpulse = _loc30_.§=!y§;
               _loc31_.tangentImpulse = _loc30_.§%!B§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§+,§.x = §5O§.§5!'§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§+,§.y = §5O§.§5!'§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§6u§.x = §5O§.§5!'§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§6u§.y = §5O§.§5!'§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§;k§ + _loc16_.§;k§ + _loc15_.§6x§ * _loc36_ + _loc16_.§6x§ * _loc37_;
               _loc31_.§#9§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§@e§ * _loc15_.§;k§ + _loc16_.§@e§ * _loc16_.§;k§) + (_loc15_.§@e§ * _loc15_.§6x§ * _loc36_ + _loc16_.§@e§ * _loc16_.§6x§ * _loc37_);
               _loc31_.§#! § = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§;k§ + _loc16_.§;k§ + _loc15_.§6x§ * _loc42_ + _loc16_.§6x§ * _loc43_;
               _loc31_.§]s§ = 1 / _loc44_;
               _loc31_.§!! § = 0;
            ...
            if(_loc28_.§<"5§ == 2)
            {
               ...
               _loc55_ = _loc48_.§6u§.x * _loc27_ - _loc48_.§6u§.y * _loc26_;
               _loc56_ = _loc49_.§+,§.x * _loc27_ - _loc49_.§+,§.y * _loc26_;
               _loc57_ = _loc49_.§6u§.x * _loc27_ - _loc49_.§6u§.y * _loc26_;
               ...
               {
                  _loc28_.§@V§.col1.Set(_loc58_,_loc60_);
                  _loc28_.§@V§.col2.Set(_loc60_,_loc59_);
                  _loc28_.§@V§.§7!Z§(_loc28_.§#9§);
               }
               else
               {
                  _loc28_.§<"5§ = 1;
         ...
         while(_loc5_ < this.§[!N§)
         {
            ...
            if(param1.§1!w§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc20_.normalImpulse *= param1.§<3§;
                  _loc20_.tangentImpulse *= param1.§<3§;
                  ...
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§6u§.x * _loc22_ - _loc20_.§6u§.y * _loc21_);
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         while(_loc24_ < this.§[!N§)
         {
            ...
            while(_loc1_ < _loc25_.§<"5§)
            {
               ...
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§6u§.y - _loc30_.x + _loc28_ * _loc2_.§+,§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§6u§.x - _loc30_.y - _loc28_ * _loc2_.§+,§.x;
               ...
               _loc29_ += _loc35_ * (_loc2_.§6u§.x * _loc15_ - _loc2_.§6u§.y * _loc14_);
            ...
            if(_loc25_.§<"5§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§#9§ * (_loc9_ - _loc2_.§!! §);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§6u§.y - _loc30_.x + _loc28_ * _loc43_.§+,§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§6u§.x - _loc30_.y - _loc28_ * _loc43_.§+,§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§6u§.y - _loc30_.x + _loc28_ * _loc44_.§+,§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§6u§.x - _loc30_.y - _loc28_ * _loc44_.§+,§.x;
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc29_ += _loc35_ * (_loc43_.§6u§.x * _loc19_ - _loc43_.§6u§.y * _loc18_ + _loc44_.§6u§.x * _loc21_ - _loc44_.§6u§.y * _loc20_);
               ...
               else
               {
                  ...
                  _loc57_ = 0;
                  _loc51_ = 0;
                  _loc52_ = _loc25_.§@V§.col1.y * _loc56_ + _loc54_;
                  ...
                  else
                  {
                     ...
                     _loc51_ = _loc25_.§@V§.col2.x * _loc57_ + _loc53_;
                     _loc52_ = 0;
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§[!N§)
         {
            ...
            _loc6_ = _loc4_.§3j§;
            _loc7_ = _loc5_.§@e§ * _loc5_.§;k§;
            _loc8_ = _loc5_.§@e§ * _loc5_.§6x§;
            _loc9_ = _loc6_.§@e§ * _loc6_.§;k§;
            _loc10_ = _loc6_.§@e§ * _loc6_.§6x§;
            §[![§.§1o§(_loc4_);
            _loc11_ = §[![§.§]!?§;
            _loc12_ = 0;
