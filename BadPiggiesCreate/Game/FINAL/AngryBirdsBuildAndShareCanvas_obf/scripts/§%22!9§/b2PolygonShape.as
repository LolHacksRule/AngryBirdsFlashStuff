package §"!9§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      public function §,"2§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§2!7§ ? int(_loc3_ + 1) : 0;
      ...
      public function §&w§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§8!o§[0] = b2Math.§+Z§(b2Math.§'!%§(param2,param1),1);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§2!7§)
         {
            _loc6_ = (_loc9_ = this.§"!@§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§8!o§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§8! §.x = _loc5_ - b2internal::;$;
         param1.§8! §.y = _loc6_ - b2internal::;$;
         param1.§;R§.x = _loc7_ + b2internal::;$;
         param1.§;R§.y = _loc8_ + b2internal::;$;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§@!y§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§2!7§)
         {
            _loc7_[_loc12_] = b2Math.§@!y§(_loc5_,this.§"!@§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§>!C§(param3,_loc24_.center));
                  return _loc24_.§5d§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§2!7§;
         var _loc14_:int = (_loc10_ + 1) % this.§2!7§;
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§2!7§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
         ...
         _loc20_.§>!t§(1 / _loc19_);
         param4.SetV(b2Math.§>!C§(param3,_loc20_));
         return _loc19_;
      }
