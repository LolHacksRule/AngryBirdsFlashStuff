package §^%§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§&w§ = b2internal::9!B.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§62§.x - this.§&w§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§62§.y - this.§&w§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§`"6§.x - this.§&w§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§`"6§.y - this.§&w§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§98§);
         this.m_localAnchor2.SetV(param1.§?m§);
         this.§9!e§ = param1.§9!1§;
         this.§ "!§ = param1.§2"-§ + this.§9!e§ * param1.§%""§;
         this.m_maxLength1 = b2Math.§7!-§(param1.§8!+§,this.§ "!§ - this.§9!e§ * b2internal::,"3);
         this.m_maxLength2 = b2Math.§7!-§(param1.§"!3§,(this.§ "!§ - b2internal::,"3) / this.§9!e§);
         this.§^!@§ = 0;
      ...
      {
         var _loc1_:b2Vec2 = b2internal::9!B.GetWorldPoint(this.m_localAnchor1);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc18_:Number = this.m_u1.§<_§();
         var _loc19_:Number = this.m_u2.§<_§();
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§ "!§ - _loc18_ - this.§9!e§ * _loc19_) > 0)
         {
            this.§1l§ = b2internal::;k;
            this.§^!@§ = 0;
         }
         else
         {
            this.§1l§ = b2internal::<!3;
         }
         if(_loc18_ < this.m_maxLength1)
         {
            this.m_limitState1 = b2internal::;k;
            this.m_limitImpulse1 = 0;
         }
         else
         {
            this.m_limitState1 = b2internal::<!3;
         }
         if(_loc19_ < this.m_maxLength2)
         {
            this.m_limitState2 = b2internal::;k;
            this.m_limitImpulse2 = 0;
         }
         else
         {
            this.m_limitState2 = b2internal::<!3;
         }
         var _loc21_:Number = _loc5_ * this.m_u1.y - _loc6_ * this.m_u1.x;
         var _loc22_:Number = _loc8_ * this.m_u2.y - _loc9_ * this.m_u2.x;
         this.m_limitMass1 = _loc2_.§"!O§ + _loc2_.§6""§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§"!O§ + _loc3_.§6""§ * _loc22_ * _loc22_;
         this.§`!u§ = this.m_limitMass1 + this.§9!e§ * this.§9!e§ * this.m_limitMass2;
         ...
         if(param1.§1!$§)
         {
            ...
            _loc25_ = (-this.§9!e§ * this.§^!@§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§9!e§ * this.§^!@§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§4X§.x += _loc2_.§"!O§ * _loc23_;
            _loc2_.§4X§.y += _loc2_.§"!O§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§6""§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§4X§.x += _loc3_.§"!O§ * _loc25_;
            _loc3_.§4X§.y += _loc3_.§"!O§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§6""§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§^!@§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc9_ = _loc4_.col1.y * _loc8_ + _loc4_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         if(this.§1l§ == b2internal::<!3)
         {
            _loc10_ = _loc2_.§4X§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§4X§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§4X§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§4X§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§9!e§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§`!u§ * -_loc18_;
            _loc20_ = this.§^!@§;
            this.§^!@§ = b2Math.§9!o§(0,this.§^!@§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§^!@§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§9!e§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§9!e§ * _loc19_ * this.m_u2.y;
            _loc2_.§4X§.x += _loc2_.§"!O§ * _loc14_;
            _loc2_.§4X§.y += _loc2_.§"!O§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§6""§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§4X§.x += _loc3_.§"!O§ * _loc16_;
            _loc3_.§4X§.y += _loc3_.§"!O§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§6""§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
         if(this.m_limitState1 == b2internal::<!3)
         {
            _loc10_ = _loc2_.§4X§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§4X§.y + _loc2_.m_angularVelocity * _loc5_;
            ...
            this.m_limitImpulse1 = b2Math.§9!o§(0,this.m_limitImpulse1 + _loc19_);
         ...
         if(this.m_limitState2 == b2internal::<!3)
         {
            _loc12_ = _loc3_.§4X§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§4X§.y + _loc3_.m_angularVelocity * _loc8_;
            ...
            this.m_limitImpulse2 = b2Math.§9!o§(0,this.m_limitImpulse2 + _loc19_);
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§1l§ == b2internal::<!3)
         {
            ...
            _loc19_ = this.§ "!§ - _loc17_ - this.§9!e§ * _loc18_;
            _loc24_ = b2Math.§9!o§(_loc24_,-_loc19_);
            ...
            _loc15_ = -this.§9!e§ * _loc20_ * this.m_u2.x;
            _loc16_ = -this.§9!e§ * _loc20_ * this.m_u2.y;
            _loc2_.m_sweep.c.x += _loc2_.§"!O§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§"!O§ * _loc14_;
            _loc2_.m_sweep.a += _loc2_.§6""§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§"!O§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§"!O§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§6""§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§<!S§();
            _loc3_.§<!S§();
         }
         if(this.m_limitState1 == b2internal::<!3)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§<_§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::<!3)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§<_§()) > b2Settings.b2_linearSlop)
            {
