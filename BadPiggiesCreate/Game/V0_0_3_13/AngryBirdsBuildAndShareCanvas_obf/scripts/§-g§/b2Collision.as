package §-g§
{
   ...
   public class b2Collision
   {
      ...
      private static var §7!f§:Vector.<§8s§> = §34§();
      
      private static var s_clipPoints1:Vector.<§8s§> = §34§();
      
      private static var s_clipPoints2:Vector.<§8s§> = §34§();
      
      private static var §6J§:Vector.<int> = new Vector.<int>(1);
      ...
      private static var §5V§:b2Vec2 = new b2Vec2();
      ...
      public static function §4!O§(param1:Vector.<§8s§>, param2:Vector.<§8s§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§8s§ = null;
         var _loc6_:int = 0;
      ...
      public static function §]!-§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc6_:int = param1.§`e§;
         var _loc7_:Vector.<b2Vec2> = param1.§6!+§;
         var _loc8_:Vector.<b2Vec2> = param1.§8b§;
         var _loc9_:int = param4.§`e§;
      ...
      public static function §"!5§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§`e§;
         var _loc7_:Vector.<b2Vec2> = param2.§8b§;
         _loc9_ = param5.R;
         _loc8_ = param4.§+Z§;
      ...
      public static function §`x§(param1:Vector.<§8s§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§8s§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§`e§;
         var _loc8_:Vector.<b2Vec2> = param2.§8b§;
         var _loc9_:int = param5.§`e§;
         var _loc10_:Vector.<b2Vec2> = param5.§6!+§;
         var _loc11_:Vector.<b2Vec2> = param5.§8b§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§6n§.§#!w§ = param4;
         _loc20_.id.§6n§.§0!0§ = _loc21_;
         _loc20_.id.§6n§.§`!E§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§6n§.§#!w§ = param4;
         _loc20_.id.§6n§.§0!0§ = _loc22_;
         _loc20_.id.§6n§.§`!E§ = 1;
      }
      
      private static function §34§() : Vector.<§8s§>
      {
         var _loc1_:Vector.<§8s§> = new Vector.<§8s§>(2);
         _loc1_[0] = new §8s§();
         _loc1_[1] = new §8s§();
         return _loc1_;
      }
      ...
      public static function §#!k§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         param1.§]Y§ = 0;
         var _loc7_:Number = param2.§9"=§ + param4.§9"=§;
         var _loc8_:int = 0;
         §6J§[0] = _loc8_;
         var _loc9_:Number = §"!5§(§6J§,param2,param3,param4,param5);
         _loc8_ = §6J§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§&"9§ = b2Manifold.§@!b§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§8s§> = §7!f§;
         §`x§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§`e§;
         ...
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §^!e§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §5V§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§8s§> = s_clipPoints1;
         var _loc38_:Vector.<§8s§> = s_clipPoints2;
         if((_loc39_ = §4!O§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §4!O§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§'!+§.SetV(_loc27_);
      ...
      public static function §7w§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§9"=§ + param4.§9"=§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§&"9§ = b2Manifold.§6A§;
         param1.m_localPoint.SetV(param2.§<l§);
         param1.§'!+§.§4e§();
         param1.§]Y§ = 1;
         param1.§]!k§[0].m_localPoint.SetV(param4.§<l§);
         param1.§]!k§[0].m_id.key = 0;
      }
      
      public static function § !P§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§9"=§ + param4.§9"=§;
         var _loc21_:int = param2.§`e§;
         var _loc22_:Vector.<b2Vec2> = param2.§6!+§;
         var _loc23_:Vector.<b2Vec2> = param2.§8b§;
         var _loc24_:int = 0;
