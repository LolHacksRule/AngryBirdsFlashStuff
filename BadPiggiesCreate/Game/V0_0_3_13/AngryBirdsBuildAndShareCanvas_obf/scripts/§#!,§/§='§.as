package §#!,§
{
   ...
   public class §='§
   {
      ...
      public function §^",§(param1:Class, param2:Class, param3:Array) : void
      {
         var _loc4_:uint = param3.length;
         var _loc5_:uint = 0;
         while(_loc5_ < _loc4_)
         {
            this.§2!,§(param1,param2,param3[_loc5_]);
            _loc5_++;
         }
      }
      ...
      public function §2!,§(param1:Class, param2:Class, param3:String) : void
      {
         var _loc7_:uint = 0;
         var _loc8_:uint = 0;
      ...
      private function §@"7§(param1:Class) : void
      {
