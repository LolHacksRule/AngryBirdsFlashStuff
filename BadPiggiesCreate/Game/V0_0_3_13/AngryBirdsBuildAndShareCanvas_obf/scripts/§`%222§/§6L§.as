package §`"2§
{
   ...
   public class §6L§
   {
      ...
      public static function §&I§(param1:String, param2:§6!,§, param3:Boolean = true) : §`L§.Sprite
      {
         var _loc7_:XML = null;
         var _loc8_:§%3§ = null;
         var _loc9_:§-;§ = null;
         ...
         var _loc5_:§`L§.Sprite = new §`L§.Sprite();
      ...
      public static function §+! §(param1:String, param2:§6!,§) : flash.display.Sprite
      {
         var _loc6_:XML = null;
         var _loc7_:§%3§ = null;
