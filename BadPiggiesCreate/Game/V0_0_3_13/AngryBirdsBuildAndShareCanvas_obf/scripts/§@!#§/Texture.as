package §@!#§
{
   ...
   public class Texture
   {
      ...
      public static function §&_§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §@!#§.Texture
      {
      ...
      public static function §7!k§(param1:§@!#§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §@!#§.Texture
      {
         var _loc4_:§@!#§.Texture;
         (_loc4_ = new §`"<§(param1,param2)).§4S§ = param3;
         return _loc4_;
      }
      
      public static function empty(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §@!#§.Texture
      {
      ...
      public function adjustVertexData(param1:§^"9§, param2:int, param3:int) : void
      {
         ...
         if(this.§4S§)
         {
            ...
            _loc4_ = this.§4S§.width + this.§4S§.x - this.width;
            _loc5_ = this.§4S§.height + this.§4S§.y - this.height;
            param1.§ !L§(param2,-this.§4S§.x,-this.§4S§.y);
            param1.§ !L§(param2 + 1,-_loc4_,-this.§4S§.y);
            param1.§ !L§(param2 + 2,-this.§4S§.x,-_loc5_);
      ...
      {
         return !!this.§4S§ ? this.§4S§.clone() : new Rectangle(0,0,this.width,this.height);
      }
