package §5!]§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §7!H§:b2Mat22 = new b2Mat22();
      ...
      b2internal var §8b§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         this.§8b§ = new Vector.<b2Vec2>();
         §9"=§ = b2Settings.b2_polygonRadius;
         this.§+Z§.§4e§();
      }
      
      public static function §use §(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function §+D§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §8Y§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§2Y§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §>!h§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §,"=§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§4![§(new b2Vec2(0,0));
            _loc3_.§4![§(_loc9_);
            _loc3_.§4![§(_loc10_);
            _loc3_.§'q§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §[!i§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§5!0§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§5!0§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            while(_loc3_ < this.§`e§)
            {
               ...
               this.§8b§[_loc3_].SetV(_loc2_.§8b§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §!!Q§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function §?!%§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§`e§)
         {
            this.§6!+§[_loc3_].SetV(param1[_loc3_]);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < this.§`e§)
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§`e§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§8"<§(this.§6!+§[_loc5_],this.§6!+§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§@!1§() > Number.MIN_VALUE);
            this.§8b§[_loc3_].SetV(b2Math.§=§(_loc6_,1));
            this.§8b§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§+Z§ = §,"=§(this.§6!+§,this.§`e§);
      }
      ...
      public function §-!y§(param1:Number, param2:Number) : void
      {
         this.§`e§ = 4;
         this.§@^§(4);
         this.§6!+§[0].Set(-param1,-param2);
         this.§6!+§[1].Set(param1,-param2);
         this.§6!+§[2].Set(param1,param2);
         this.§6!+§[3].Set(-param1,param2);
         this.§8b§[0].Set(0,-1);
         this.§8b§[1].Set(1,0);
         this.§8b§[2].Set(0,1);
         this.§8b§[3].Set(-1,0);
      ...
      public function §2Y§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§`e§ = 4;
         this.§@^§(4);
         this.§6!+§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§`e§)
         {
            this.§6!+§[_loc6_] = b2Math.§5!V§(_loc5_,this.§6!+§[_loc6_]);
            this.§8b§[_loc6_] = b2Math.§%!T§(_loc5_.R,this.§8b§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §9`§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§`e§ = 2;
         this.§@^§(2);
         this.§6!+§[0].SetV(param1);
         this.§6!+§[1].SetV(param2);
         this.§+Z§.x = 0.5 * (param1.x + param2.x);
         this.§+Z§.y = 0.5 * (param1.y + param2.y);
         this.§8b§[0] = b2Math.§=§(b2Math.§8"<§(param2,param1),1);
         this.§8b§[0].Normalize();
         this.§8b§[1].x = -this.§8b§[0].x;
         this.§8b§[1].y = -this.§8b§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§`e§)
         {
            _loc6_ = (_loc9_ = this.§6!+§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§8b§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§%!?§.x = _loc5_ - b2internal::9"=;
         param1.§%!?§.y = _loc6_ - b2internal::9"=;
         param1.§<h§.x = _loc7_ + b2internal::9"=;
         param1.§<h§.y = _loc8_ + b2internal::9"=;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§`e§ == 2)
         {
            param1.center.x = 0.5 * (this.§6!+§[0].x + this.§6!+§[1].x);
            param1.center.y = 0.5 * (this.§6!+§[0].y + this.§6!+§[1].y);
            param1.§&!q§ = 0;
            param1.I = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§`e§)
         {
            _loc11_ = this.§6!+§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§`e§ ? this.§6!+§[int(_loc10_ + 1)] : this.§6!+§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§1j§(param3.R,param1);
         ...
         {
            _loc7_[_loc12_] = b2Math.§9!%§(_loc5_,this.§6!+§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§5!V§(param3,_loc24_.center));
                  return _loc24_.§&!q§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§`e§;
         var _loc14_:int = (_loc10_ + 1) % this.§`e§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§6!+§[_loc9_].x * (1 - _loc15_) + this.§6!+§[_loc13_].x * _loc15_,this.§6!+§[_loc9_].y * (1 - _loc15_) + this.§6!+§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§6!+§[_loc10_].x * (1 - _loc16_) + this.§6!+§[_loc14_].x * _loc16_,this.§6!+§[_loc10_].y * (1 - _loc16_) + this.§6!+§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§6!+§[_loc13_];
         _loc12_ = _loc13_;
         while(_loc12_ != _loc14_)
         {
            if((_loc12_ = (_loc12_ + 1) % this.§`e§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
            {
               _loc22_ = this.§6!+§[_loc12_];
            }
         ...
         _loc20_.§'q§(1 / _loc19_);
         param4.SetV(b2Math.§5!V§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §9"2§() : Vector.<b2Vec2>
      {
         return this.§6!+§;
      }
