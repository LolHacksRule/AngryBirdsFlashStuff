package §@R§
{
   ...
   public class §1!A§ extends §8y§
   {
      
      public static var §6!z§:Boolean = false;
       
      
      public function §1!A§(param1:Object, param2:BitmapData)
      {
         super(param2);
         this.§<<§(param1);
      }
      
      private static function §5x§(param1:§]1§, param2:int, param3:int) : void
      {
         if(param1.§`!#§.top < 0)
         {
            param1.§`!#§.top = 0;
      ...
      protected function §<<§(param1:Object) : void
      {
         ...
         for(_loc4_ in param1)
         {
            if(_loc4_.indexOf("sprite_") != -1)
            {
               ...
               §5x§(_loc6_,§4!b§.width,§4!b§.height);
               if(_loc2_)
               {
                  _loc6_.§%n§ = _loc5_.pivotx / _loc3_;
                  _loc6_.§#Y§ = _loc5_.pivoty / _loc3_;
               }
               else
               {
                  _loc6_.§%n§ = _loc5_.width / 2;
