package §4!S§
{
   ...
   public class §+!6§
   {
      ...
      private static var §3!u§:Dictionary = new Dictionary();
      
      private static var §5d§:Number = 10;
      ...
      public static function doJsCall(param1:String, ... rest) : void
      {
         ...
         var timer:Timer = new Timer(§5d§,1);
         switch(param0)
         {
            case "startQuest":
               timer.addEventListener(TimerEvent.TIMER_COMPLETE,function():void
               {
                  §3!u§["onQuestStarted"](§ "5§(),§@4§());
               });
               break;
            case "fetchQuests":
               timer.addEventListener(TimerEvent.TIMER_COMPLETE,function():void
               {
                  §3!u§["onQuestsFetched"](§`3§());
               });
               break;
            case "completeQuest":
               timer.addEventListener(TimerEvent.TIMER_COMPLETE,function():void
               {
                  §3!u§["onQuestCompleted"](§`3§(),§8!F§(),§`l§(),§"'§());
               });
               break;
            case "bolts":
               timer.addEventListener(TimerEvent.TIMER_COMPLETE,function():void
      ...
      private static function §@4§() : String
      {
         return "";
      }
      
      private static function §`3§() : String
      {
         var _loc1_:* = "{";
         var _loc2_:int = 0;
         while(_loc2_ < 20)
      ...
      private static function §8!F§() : String
      {
      ...
      private static function §6W§() : String
      {
      ...
      private static function §7!3§() : Object
      {
