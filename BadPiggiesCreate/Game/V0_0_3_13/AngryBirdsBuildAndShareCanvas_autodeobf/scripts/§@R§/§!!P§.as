package §@R§
{
   ...
   public class §!!P§ extends §8y§
   {
       
      
      public function §!!P§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§<<§(param1,param2);
      }
      ...
      protected function §<<§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         var _loc16_:§]1§ = null;
         var _loc3_:Dictionary = this.§4r§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if(_loc10_)
            {
               ...
               (_loc16_ = new §]1§()).mName = _loc6_;
               _loc16_.§`!#§ = _loc15_;
               _loc16_.§%n§ = _loc10_.pivotX;
               _loc16_.§#Y§ = _loc10_.pivotY;
               _loc16_.§#"=§ = §4!b§;
               §%9§(_loc16_);
            }
         }
      ...
      private function §4r§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
