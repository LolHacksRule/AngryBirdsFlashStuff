package §1"?§
{
   ...
   public class §?"1§
   {
      ...
      private function §9!Q§(param1:Vector.<GhostObject>) : void
      {
         ...
         for each(_loc3_ in param1)
         {
            (_loc15_ = new Bitmap(§5!U§.§,!E§.§4F§.§!!k§(_loc3_.name),"auto",true)).filters = [new GlowFilter(_loc3_.borderColor,1,10,10,10)];
         ...
         §0!+§.§'G§(_loc13_.bitmapData,§0!+§.§`!Z§.bitmapData);
         _loc6_.bitmapData.draw(_loc13_);
         _loc14_ = §5!U§.§,!E§.§4F§.§`!+§(_loc6_.bitmapData);
         this.§-M§ = new §-;§(_loc14_);
         this.§-M§.x = _loc2_.x;
         this.§-M§.y = _loc2_.y;
         this.§-M§.scaleX = _loc7_;
         this.§-M§.scaleY = _loc7_;
         this.§%!z§ = new Point(_loc2_.x,_loc2_.y);
      }
      
      private function §^!w§(param1:Vector.<GhostObject>) : void
      {
         ...
         {
            if(this.§!!g§[_loc2_] == undefined)
            {
               _loc3_ = §5!U§.§,!E§.§4F§.§!!k§(_loc2_.name);
               _loc4_ = §5!U§.§,!E§.§4F§.§`!+§(_loc3_);
               ...
               this.§!!g§[_loc2_] = _loc5_;
            }
            _loc2_.addEventListener(§?!i§.CHANGE,this.§!!D§);
         }
      }
      
      private function §!!D§(param1:§?!i§) : void
      {
         var _loc2_:GhostObject = param1.target as GhostObject;
         if(_loc2_.§="0§)
         {
            §5!U§.§,!E§.objects.§ ! §.addChildAt(this.§!!g§[_loc2_],1);
      ...
      public function §="$§() : void
      {
         if(this.§-M§)
         {
            §5!U§.§,!E§.objects.§ ! §.addChildAt(this.§-M§,0);
            this.§-M§.x = this.§%!z§.x;
            this.§-M§.y = this.§%!z§.y;
         }
      }
      ...
      public function §`!w§() : void
      {
         if(this.§-M§ && this.§-M§.parent)
         {
            if(!this.§<!w§)
            {
               this.§<!w§ = §"L§.§7!?§.§4!P§(this.§-M§,{"y":this.§-M§.height},{"y":this.§-M§.y},0.8,§"L§.§ "9§);
               this.§<!w§.onComplete = this.§5!u§;
               this.§<!w§.play();
            }
            else
            {
      ...
      {
         §5!U§.§,!E§.objects.§ ! §.removeChild(this.§-M§);
      }
   }
}
