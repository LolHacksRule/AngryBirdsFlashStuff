package §&!n§
{
   ...
   public class b2DynamicTree
   {
      ...
      private var §7i§:b2DynamicTreeNode;
      ...
      public function §[2§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
         ...
         _loc3_.aabb.§0!l§.x = param1.§0!l§.x - _loc4_;
         _loc3_.aabb.§0!l§.y = param1.§0!l§.y - _loc5_;
         _loc3_.aabb.§6E§.x = param1.§6E§.x + _loc4_;
         _loc3_.aabb.§6E§.y = param1.§6E§.y + _loc5_;
         _loc3_.§-!j§ = param2;
         this.§+D§(_loc3_);
         return _loc3_;
      }
      ...
      public function §8;§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         ...
         param1.aabb.§0!l§.x = param2.§0!l§.x - _loc4_;
         param1.aabb.§0!l§.y = param2.§0!l§.y - _loc5_;
         param1.aabb.§6E§.x = param2.§6E§.x + _loc4_;
         param1.aabb.§6E§.y = param2.§6E§.y + _loc5_;
         this.§+D§(param1);
         return true;
      }
      ...
      public function § try§(param1:b2DynamicTreeNode) : b2AABB
      {
         return param1.aabb;
      }
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§3!X§(1,_loc5_);
         var _loc7_:b2Vec2 = b2Math.§[!W§(_loc6_);
         var _loc8_:Number = param2.§'U§;
         _loc9_ = new b2AABB();
         _loc10_ = _loc3_.x + _loc8_ * (_loc4_.x - _loc3_.x);
         _loc11_ = _loc3_.y + _loc8_ * (_loc4_.y - _loc3_.y);
         _loc9_.§0!l§.x = Math.min(_loc3_.x,_loc10_);
         _loc9_.§0!l§.y = Math.min(_loc3_.y,_loc11_);
         _loc9_.§6E§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§6E§.y = Math.max(_loc3_.y,_loc11_);
         var _loc12_:Vector.<b2DynamicTreeNode> = new Vector.<b2DynamicTreeNode>();
         var _loc13_:int = 0;
         var _loc19_:*;
         _loc12_[_loc19_ = _loc13_++] = this.§'!x§;
         while(_loc13_ > 0)
         {
            if((_loc14_ = _loc12_[--_loc13_]).aabb.§=!1§(_loc9_) != false)
            {
               _loc15_ = _loc14_.aabb.§ ,§();
               _loc16_ = _loc14_.aabb.§ !z§();
      ...
      private function §]!9§() : b2DynamicTreeNode
      {
         var _loc1_:b2DynamicTreeNode = null;
         if(this.§7i§)
         {
            _loc1_ = this.§7i§;
            this.§7i§ = _loc1_.parent;
            _loc1_.parent = null;
            _loc1_.child1 = null;
            _loc1_.child2 = null;
            return _loc1_;
      ...
      private function §+D§(param1:b2DynamicTreeNode) : void
      {
         ...
         var _loc3_:b2DynamicTreeNode = this.§'!x§;
         if(_loc3_.§<!u§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§0!l§.x + _loc6_.aabb.§6E§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§0!l§.y + _loc6_.aabb.§6E§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§0!l§.x + _loc7_.aabb.§6E§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§0!l§.y + _loc7_.aabb.§6E§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
         ...
         (_loc5_ = this.§]!9§()).parent = _loc4_;
         _loc5_.§-!j§ = null;
         _loc5_.aabb.§ !1§(param1.aabb,_loc3_.aabb);
         if(_loc4_)
         {
            ...
            {
               _loc4_.aabb.§ !1§(_loc4_.child1.aabb,_loc4_.child2.aabb);
               _loc5_ = _loc4_;
      ...
      private function §;"-§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc5_ = _loc3_.aabb;
               _loc3_.aabb = b2AABB.§ !1§(_loc3_.child1.aabb,_loc3_.child2.aabb);
