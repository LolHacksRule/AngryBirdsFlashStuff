package §&!n§
{
   ...
   public class b2Collision
   {
      ...
      private static var §,!#§:Vector.<§ Z§> = §&a§();
      
      private static var s_clipPoints1:Vector.<§ Z§> = §&a§();
      
      private static var s_clipPoints2:Vector.<§ Z§> = §&a§();
      
      private static var §9!_§:Vector.<int> = new Vector.<int>(1);
      
      private static var §]"+§:Vector.<int> = new Vector.<int>(1);
      
      private static var §do §:b2Vec2 = new b2Vec2();
      ...
      public static function §[i§(param1:Vector.<§ Z§>, param2:Vector.<§ Z§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§ Z§ = null;
         var _loc6_:int = 0;
      ...
      public static function §-!Q§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§0!$§;
         var _loc7_:Vector.<b2Vec2> = param1.§"x§;
         var _loc8_:Vector.<b2Vec2> = param1.§+!X§;
         var _loc9_:int = param4.§0!$§;
         var _loc10_:Vector.<b2Vec2> = param4.§"x§;
         _loc11_ = param2.R;
      ...
      public static function §]e§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§0!$§;
         var _loc7_:Vector.<b2Vec2> = param2.§+!X§;
         _loc9_ = param5.R;
         _loc8_ = param4.§&U§;
         ...
         var _loc17_:Number = §-!Q§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §-!Q§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §-!Q§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §-!Q§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §"!3§(param1:Vector.<§ Z§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param2.§+!X§;
         var _loc9_:int = param5.§0!$§;
         var _loc10_:Vector.<b2Vec2> = param5.§"x§;
         var _loc11_:Vector.<b2Vec2> = param5.§+!X§;
         _loc12_ = param3.R;
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§]l§.§]!"§ = param4;
         _loc20_.id.§]l§.§<!'§ = _loc22_;
         _loc20_.id.§]l§.§"y§ = 1;
      }
      
      private static function §&a§() : Vector.<§ Z§>
      {
         var _loc1_:Vector.<§ Z§> = new Vector.<§ Z§>(2);
         _loc1_[0] = new § Z§();
         _loc1_[1] = new § Z§();
         return _loc1_;
      }
      
      public static function §2j§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§ Z§ = null;
         ...
         param1.§@!p§ = 0;
         var _loc7_:Number = param2.§&!o§ + param4.§&!o§;
         var _loc8_:int = 0;
         §9!_§[0] = _loc8_;
         var _loc9_:Number = §]e§(§9!_§,param2,param3,param4,param5);
         _loc8_ = §9!_§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §]"+§[0] = _loc10_;
         var _loc11_:Number = §]e§(§]"+§,param4,param5,param2,param3);
         _loc10_ = §]"+§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§;M§ = b2Manifold.§ !b§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§ Z§> = §,!#§;
         §"!3§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§0!$§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§"x§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §do §).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §?!r§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §]!t§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §2"&§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§ Z§> = s_clipPoints1;
         var _loc38_:Vector.<§ Z§> = s_clipPoints2;
         if((_loc39_ = §[i§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §[i§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§'""§.SetV(_loc27_);
      ...
      public static function §9>§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§&!o§ + param4.§&!o§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§;M§ = b2Manifold.§5![§;
         param1.m_localPoint.SetV(param2.§-!C§);
         param1.§'""§.§6V§();
         param1.§@!p§ = 1;
         param1.§'!N§[0].m_localPoint.SetV(param4.§-!C§);
         param1.§'!N§[0].m_id.key = 0;
      }
      
      public static function §[!X§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§&!o§ + param4.§&!o§;
         var _loc21_:int = param2.§0!$§;
         var _loc22_:Vector.<b2Vec2> = param2.§"x§;
         var _loc23_:Vector.<b2Vec2> = param2.§+!X§;
         var _loc24_:int = 0;
      ...
      public static function §=!1§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§0!l§;
         var _loc4_:b2Vec2 = param1.§6E§;
