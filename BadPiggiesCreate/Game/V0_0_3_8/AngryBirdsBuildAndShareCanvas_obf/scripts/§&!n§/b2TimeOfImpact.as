package §&!n§
{
   ...
   public class b2TimeOfImpact
   {
      ...
      private static var §#!H§:b2SimplexCache = new b2SimplexCache();
      
      private static var §1"5§:b2DistanceInput = new b2DistanceInput();
      ...
      public static function §2!0§(param1:b2TOIInput) : Number
      {
         ...
         ++b2_toiCalls;
         var _loc2_:b2DistanceProxy = param1.§+!k§;
         var _loc3_:b2DistanceProxy = param1.§"!^§;
         var _loc4_:b2Sweep = param1.§'!f§;
         var _loc5_:b2Sweep = param1.§`!m§;
         b2Settings.b2Assert(_loc4_.§#b§ == _loc5_.§#b§);
         b2Settings.b2Assert(1 - _loc4_.§#b§ > Number.MIN_VALUE);
         var _loc6_:Number = _loc2_.§&!o§ + _loc3_.§&!o§;
         var _loc7_:Number = param1.§0!z§;
         var _loc8_:Number = 0;
         var _loc10_:int = 0;
         ...
         do
         {
            ...
            §1"5§.§^$§ = §=O§;
            §1"5§.§>"!§ = §&x§;
            b2Distance.§^"1§(§!!k§,§#!H§,§1"5§);
            if(§!!k§.§%"$§ <= 0)
            {
               _loc8_ = 1;
               break;
            }
            §&3§.§`!&§(§#!H§,_loc2_,§=O§,_loc3_,§&x§);
            if((_loc12_ = §&3§.Evaluate(§=O§,§&x§)) <= 0)
            {
               _loc8_ = 1;
               break;
            }
            ...
            _loc4_.§@w§(§=O§,_loc15_);
            _loc5_.§@w§(§&x§,_loc15_);
            if((_loc17_ = §&3§.Evaluate(§=O§,§&x§)) >= _loc11_)
            {
               _loc8_ = 1;
               break;
            }
