   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function removeChildAt(param1:int, param2:Boolean = false) : void
      {
         ...
         if(param1 >= 0 && param1 < this.numChildren)
         {
            ...
            _loc3_.dispatchEvent(new Event(Event.§<e§,true));
            if(stage)
            {
      ...
      public function §4!J§(param1:Function) : void
      {
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         while(_loc6_ >= 0)
         {
            ...
            §'!b§(_loc7_,§"j§);
            transformCoords(§"j§,_loc3_,_loc4_,§<!!§);
      ...
      override function dispatchEventOnChildren(param1:Event) : void
      {
         ...
         this.§6!l§(this,param1.type,_loc2_);
      ...
      private function §6!l§(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               this.§6!l§(_loc5_[_loc7_],param2,param3);
               _loc7_++;
            }
         }
      }
