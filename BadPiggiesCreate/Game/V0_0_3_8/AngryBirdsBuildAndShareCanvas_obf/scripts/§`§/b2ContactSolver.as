package §`§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §2!z§:b2WorldManifold = new b2WorldManifold();
      
      private static var §9!l§:b2PositionSolverManifold = new b2PositionSolverManifold();
      ...
      b2internal var §-!3§:Vector.<b2ContactConstraint>;
      ...
      {
         this.§,§ = new b2TimeStep();
         this.§-!3§ = new Vector.<b2ContactConstraint>();
         super();
      }
      ...
      public function §`!&§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§[=§ = param4;
         this.§^U§ = param3;
         while(this.§-!3§.length < this.§^U§)
         {
            this.§-!3§[this.§-!3§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            ...
            _loc19_ = b2Settings.b2MixRestitution(_loc9_.§<K§(),_loc10_.§<K§());
            _loc20_ = _loc15_.§?!%§.x;
            _loc21_ = _loc15_.§?!%§.y;
            _loc22_ = _loc16_.§?!%§.x;
            _loc23_ = _loc16_.§?!%§.y;
            ...
            §2!z§.§`!&§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §2!z§.§5N§.x;
            _loc27_ = §2!z§.§5N§.y;
            (_loc28_ = this.§-!3§[_loc6_]).§["%§ = _loc15_;
            _loc28_.§`!<§ = _loc16_;
            _loc28_.§?a§ = _loc17_;
            ...
            _loc28_.type = _loc17_.§;M§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§5+§)
            {
               _loc30_ = _loc17_.§'!N§[_loc29_];
               (_loc31_ = _loc28_.§,_§[_loc29_]).normalImpulse = _loc30_.§1M§;
               _loc31_.tangentImpulse = _loc30_.§4!M§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§ j§.x = §2!z§.§'!N§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§ j§.y = §2!z§.§'!N§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§%!B§.x = §2!z§.§'!N§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§%!B§.y = §2!z§.§'!N§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§-!P§ + _loc16_.§-!P§ + _loc15_.§;c§ * _loc36_ + _loc16_.§;c§ * _loc37_;
               _loc31_.§9!p§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§>?§ * _loc15_.§-!P§ + _loc16_.§>?§ * _loc16_.§-!P§) + (_loc15_.§>?§ * _loc15_.§;c§ * _loc36_ + _loc16_.§>?§ * _loc16_.§;c§ * _loc37_);
               _loc31_.§3!F§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§-!P§ + _loc16_.§-!P§ + _loc15_.§;c§ * _loc42_ + _loc16_.§;c§ * _loc43_;
               _loc31_.§=`§ = 1 / _loc44_;
               _loc31_.§'d§ = 0;
            ...
            if(_loc28_.§5+§ == 2)
            {
               ...
               _loc52_ = _loc16_.§-!P§;
               _loc53_ = _loc16_.§;c§;
               _loc54_ = _loc48_.§ j§.x * _loc27_ - _loc48_.§ j§.y * _loc26_;
               _loc55_ = _loc48_.§%!B§.x * _loc27_ - _loc48_.§%!B§.y * _loc26_;
               _loc56_ = _loc49_.§ j§.x * _loc27_ - _loc49_.§ j§.y * _loc26_;
               _loc57_ = _loc49_.§%!B§.x * _loc27_ - _loc49_.§%!B§.y * _loc26_;
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         while(_loc5_ < this.§^U§)
         {
            ...
            if(param1.§&9§)
            {
               ...
               {
                  _loc20_ = _loc6_.§,_§[_loc18_];
                  _loc20_.normalImpulse *= param1.§4!1§;
                  _loc20_.tangentImpulse *= param1.§4!1§;
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§ j§.x * _loc22_ - _loc20_.§ j§.y * _loc21_);
                  _loc7_.§?!%§.x -= _loc9_ * _loc21_;
                  _loc7_.§?!%§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§%!B§.x * _loc22_ - _loc20_.§%!B§.y * _loc21_);
            ...
            else
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  (_loc23_ = _loc6_.§,_§[_loc18_]).normalImpulse = 0;
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§^U§)
         {
            _loc26_ = (_loc25_ = this.§-!3§[_loc24_]).§["%§;
            _loc27_ = _loc25_.§`!<§;
            ...
            {
               _loc2_ = _loc25_.§,_§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§%!B§.y - _loc30_.x + _loc28_ * _loc2_.§ j§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§%!B§.x - _loc30_.y - _loc28_ * _loc2_.§ j§.x;
               ...
               _loc28_ -= _loc33_ * (_loc2_.§ j§.x * _loc15_ - _loc2_.§ j§.y * _loc14_);
               _loc31_.x += _loc34_ * _loc14_;
               _loc31_.y += _loc34_ * _loc15_;
               _loc29_ += _loc35_ * (_loc2_.§%!B§.x * _loc15_ - _loc2_.§%!B§.y * _loc14_);
            ...
            if(_loc25_.§5+§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§9!p§ * (_loc9_ - _loc2_.§'d§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§%!B§.y - _loc30_.x + _loc28_ * _loc43_.§ j§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§%!B§.x - _loc30_.y - _loc28_ * _loc43_.§ j§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§%!B§.y - _loc30_.x + _loc28_ * _loc44_.§ j§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§%!B§.x - _loc30_.y - _loc28_ * _loc44_.§ j§.x;
               ...
               _loc55_ = 0.001;
               _loc56_ = -((_loc22_ = _loc25_.§9!p§).col1.x * _loc53_ + _loc22_.col2.x * _loc54_);
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§ j§.x * _loc19_ - _loc43_.§ j§.y * _loc18_ + _loc44_.§ j§.x * _loc21_ - _loc44_.§ j§.y * _loc20_);
                  _loc31_.x += _loc34_ * (_loc18_ + _loc20_);
                  _loc31_.y += _loc34_ * (_loc19_ + _loc21_);
                  _loc29_ += _loc35_ * (_loc43_.§%!B§.x * _loc19_ - _loc43_.§%!B§.y * _loc18_ + _loc44_.§%!B§.x * _loc21_ - _loc44_.§%!B§.y * _loc20_);
                  _loc43_.normalImpulse = _loc56_;
                  _loc44_.normalImpulse = _loc57_;
               }
               else
               {
                  _loc56_ = -_loc43_.§9!p§ * _loc53_;
                  _loc57_ = 0;
                  _loc51_ = 0;
      ...
      public function §6D§() : void
      {
         ...
         while(_loc1_ < this.§^U§)
         {
            ...
            {
               _loc5_ = _loc3_.§'!N§[_loc4_];
               _loc6_ = _loc2_.§,_§[_loc4_];
               _loc5_.§1M§ = _loc6_.normalImpulse;
               _loc5_.§4!M§ = _loc6_.tangentImpulse;
               _loc4_++;
            }
            _loc1_++;
         }
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc3_ < this.§^U§)
         {
            _loc5_ = (_loc4_ = this.§-!3§[_loc3_]).§["%§;
            _loc6_ = _loc4_.§`!<§;
            _loc7_ = _loc5_.§>?§ * _loc5_.§-!P§;
            _loc8_ = _loc5_.§>?§ * _loc5_.§;c§;
            _loc9_ = _loc6_.§>?§ * _loc6_.§-!P§;
            _loc10_ = _loc6_.§>?§ * _loc6_.§;c§;
            §9!l§.§`!&§(_loc4_);
            _loc11_ = §9!l§.§5N§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§5+§)
            {
               _loc13_ = _loc4_.§,_§[_loc12_];
               _loc14_ = §9!l§.§'!N§[_loc12_];
               _loc15_ = §9!l§.§2m§[_loc12_];
               ...
               _loc22_ = (_loc21_ = -_loc13_.§3!F§ * _loc20_) * _loc11_.x;
