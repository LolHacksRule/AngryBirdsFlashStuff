package §&"+§
{
   ...
   public class §<!1§ extends §7D§
   {
       
      
      private var §4!d§:b2Joint;
      ...
      public static function §==§(param1:§7D§) : §<!1§
      {
         var _loc2_:§<!1§ = new §<!1§(param1.type,param1.index1,param1.index2,param1.point1,param1.point2,param1.§&m§,param1.§+!Q§,param1.lowerLimit,param1.upperLimit,param1.§""§,param1.motorSpeed,param1.§1!N§,param1.maxTorque);
         _loc2_.§-l§ = param1.§-l§;
