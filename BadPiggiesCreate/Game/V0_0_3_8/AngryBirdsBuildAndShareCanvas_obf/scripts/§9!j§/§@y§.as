package §9!j§
{
   ...
   public class §@y§ extends EventDispatcher
   {
      ...
      public function §@y§(param1:IEventDispatcher = null)
      {
      ...
      override public function addEventListener(param1:String, param2:Function, param3:Boolean = false, param4:int = 0, param5:Boolean = false) : void
      {
         ...
         ((this.§@!9§[param1] || (this.§@!9§[param1] = new Vector.<ListenerData>())) as Vector.<ListenerData>).push(_loc6_);
      }
      ...
      override public function removeEventListener(param1:String, param2:Function, param3:Boolean = false) : void
      {
         ...
         if((_loc4_ = this.§@!9§[param1] as Vector.<ListenerData>) != null)
         {
      ...
      public function copyFrom(param1:§@y§) : void
      {
         var _loc3_:* = null;
         ...
         var _loc6_:uint = 0;
         var _loc7_:ListenerData = null;
         var _loc2_:Dictionary = param1.§@!9§;
