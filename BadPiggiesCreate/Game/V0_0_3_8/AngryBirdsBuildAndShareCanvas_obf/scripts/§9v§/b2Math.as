package §9v§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§9m§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §@b§(param1:b2Vec2, param2:Number) : b2Vec2
      {
         return new b2Vec2(param2 * param1.y,-param2 * param1.x);
      }
      
      public static function §3!X§(param1:Number, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(-param1 * param2.y,param1 * param2.x);
      }
      
      public static function §2!U§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §3C§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §4b§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§9m§(§3C§(param1.col1,param2.col1),§3C§(param1.col2,param2.col2));
      }
      
      public static function §#!9§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§9m§(§2!U§(param1,param2.col1),§2!U§(param1,param2.col2));
      }
      ...
      public static function §;k§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         ...
         return b2Mat22.§9m§(_loc3_,_loc4_);
      }
      ...
      public static function §[!W§(param1:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§?!Y§(param1.x),§?!Y§(param1.y));
      }
      
      public static function §7!B§(param1:b2Mat22) : b2Mat22
      {
         return b2Mat22.§9m§(§[!W§(param1.col1),§[!W§(param1.col2));
      }
      ...
      public static function §79§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§%!N§(param1.x,param2.x),§%!N§(param1.y,param2.y));
      }
      ...
      public static function §!j§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §79§(param2,§7§(param1,param3));
      }
      
      public static function §8!H§(param1:Array, param2:Array) : void
      {
         var _loc3_:* = param1[0];
         param1[0] = param2[0];
         param2[0] = _loc3_;
      ...
      public static function §3!r§(param1:uint) : Boolean
      {
