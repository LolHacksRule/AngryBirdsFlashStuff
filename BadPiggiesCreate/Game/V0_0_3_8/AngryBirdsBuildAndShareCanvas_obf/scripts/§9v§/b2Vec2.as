package §9v§
{
   public class b2Vec2
   {
      ...
      public static function §6q§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function native(param1:b2Vec2) : void
      {
         this.x += param1.x;
         this.y += param1.y;
      }
      
      public function §7E§(param1:b2Vec2) : void
      {
         this.x -= param1.x;
         this.y -= param1.y;
      }
      ...
      {
         var _loc2_:Number = b2Math.§%m§(this,param1.col1);
         this.y = b2Math.§%m§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      public function §3!X§(param1:Number) : void
      {
         var _loc2_:Number = this.x;
         this.x = -param1 * this.y;
         this.y = param1 * _loc2_;
      ...
      public function §79§(param1:b2Vec2) : void
      {
         this.x = this.x > param1.x ? Number(this.x) : Number(param1.x);
         this.y = this.y > param1.y ? Number(this.y) : Number(param1.y);
      }
