package §>O§
{
   ...
   public class §]!q§ extends §4!!§
   {
      ...
      override protected function updateObject(param1:Number) : void
      {
         ...
         var _loc7_:Dictionary = this.§=F§;
         for(_loc14_ in _loc4_)
         {
            _loc6_ = _loc5_[_loc14_];
            if(param1 != 1 && (_loc8_ = this.§=F§[_loc14_] as Vector.<Number>) != null)
            {
      ...
      public function §@"$§(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         if((_loc4_ = this.§=F§[param1] as Vector.<Number>) == null)
         {
            this.§=F§[param1] = _loc4_ = new Vector.<Number>();
         }
         _loc4_.push(param2);
         this.§&N§["cp." + param1 + "." + _loc4_.length] = param3;
      }
