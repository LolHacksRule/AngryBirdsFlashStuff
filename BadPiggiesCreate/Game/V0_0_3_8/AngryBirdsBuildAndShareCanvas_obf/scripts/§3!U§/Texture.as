package §3!U§
{
   ...
   public class Texture
   {
      ...
      public static function §+g§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §3!U§.Texture
      {
         return §`4§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §`4§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §3!U§.Texture
      {
      ...
      public static function §]!v§(param1:Context3D, param2:ByteArray) : §3!U§.Texture
      {
         if(param1 == null)
         {
            throw new §&!2§();
      ...
      public static function § !"§(param1:§3!U§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §3!U§.Texture
      {
         var _loc4_:§3!U§.Texture;
         (_loc4_ = new §<!&§(param1,param2)).§9!"§ = param3;
         return _loc4_;
      }
      
      public static function empty(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §3!U§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§3!U§.Texture = §`4§(param1,_loc6_,false,param5);
         if(!§^d§.§=",§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§!$§, param2:int, param3:int) : void
      {
         ...
         if(this.§9!"§)
         {
            ...
            param1.§!u§(param2,-this.§9!"§.x,-this.§9!"§.y);
            param1.§!u§(param2 + 1,-_loc4_,-this.§9!"§.y);
            param1.§!u§(param2 + 2,-this.§9!"§.x,-_loc5_);
      ...
      public function get root() : §3!U§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §3!U§.Texture
      {
         return this;
      }
