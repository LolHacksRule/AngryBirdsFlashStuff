package § 6§
{
   ...
   public class §5`§ extends §4!!§
   {
      ...
      protected var §]q§:DisplayObjectParameter;
      ...
      public function §5`§()
      {
         ...
         this.§]q§ = new DisplayObjectParameter();
         super();
      }
      
      public static function §"!%§(param1:§'"#§) : void
      {
         param1.§0;§(§5`§,DisplayObject,§&!@§);
      }
      ...
      override public function setDestinationValue(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         {
            this._flags |= 2;
            this.§]q§.relativeFlags |= !!param3 ? 2 : 0;
            this.§]q§.y = param2;
         }
         else if(param1 == "z")
         {
            this._flags |= 4;
            this.§]q§.relativeFlags |= !!param3 ? 4 : 0;
            this.§]q§.z = param2;
         }
         else if(param1 == "scaleX")
         {
            this._flags |= 8;
            this.§]q§.relativeFlags |= !!param3 ? 8 : 0;
            this.§]q§.scaleX = param2;
         }
         else if(param1 == "scaleY")
         {
            this._flags |= 16;
            this.§]q§.relativeFlags |= !!param3 ? 16 : 0;
            this.§]q§.scaleY = param2;
         }
         else if(param1 == "scaleZ")
         {
            this._flags |= 32;
            this.§]q§.relativeFlags |= !!param3 ? 32 : 0;
            this.§]q§.scaleZ = param2;
         }
         else if(param1 == "rotation")
         {
            this._flags |= 64;
            this.§]q§.relativeFlags |= !!param3 ? 64 : 0;
            this.§]q§.rotation = param2;
         }
         else if(param1 == "rotationX")
         {
            this._flags |= 128;
            this.§]q§.relativeFlags |= !!param3 ? 128 : 0;
            this.§]q§.rotationX = param2;
         }
         else if(param1 == "rotationY")
         {
            this._flags |= 256;
            this.§]q§.relativeFlags |= !!param3 ? 256 : 0;
            this.§]q§.rotationY = param2;
         }
         else if(param1 == "rotationZ")
         {
            this._flags |= 512;
            this.§]q§.relativeFlags |= !!param3 ? 512 : 0;
            this.§]q§.rotationZ = param2;
         }
         else if(param1 == "alpha")
         {
            this._flags |= 1024;
            this.§]q§.relativeFlags |= !!param3 ? 1024 : 0;
            this.§]q§.alpha = param2;
         }
         else if(param1 == "width")
         {
            this._flags |= 2048;
            this.§]q§.relativeFlags |= !!param3 ? 2048 : 0;
            this.§]q§.width = param2;
         }
         else if(param1 == "height")
         {
            this._flags |= 4096;
            this.§]q§.relativeFlags |= !!param3 ? 4096 : 0;
            this.§]q§.height = param2;
         }
      }
      ...
      protected function §'!E§(param1:Class) : BitmapFilter
      {
      ...
      override protected function updateObject(param1:Number) : void
      {
         ...
         var _loc3_:DisplayObjectParameter = this.§]q§;
         var _loc4_:DisplayObjectParameter = this.§ [§;
      ...
      override protected function resolveValues() : void
      {
         ...
         var _loc2_:DisplayObjectParameter = this.§]q§;
      ...
      override public function getObject(param1:String) : Object
      {
         if(param1 == "_blurFilter")
         {
            return this.§'!E§(BlurFilter);
         }
         if(param1 == "_glowFilter")
         {
            return this.§'!E§(GlowFilter);
         }
         if(param1 == "_dropShadowFilter")
         {
            return this.§'!E§(DropShadowFilter);
         }
         if(param1 == "_colorMatrixFilter")
         {
            return this.§'!E§(ColorMatrixFilter);
         }
         if(param1 == "_bevelFilter")
         {
            return this.§'!E§(BevelFilter);
         }
         if(param1 == "_gradientGlowFilter")
         {
            return this.§'!E§(GradientGlowFilter);
         }
         if(param1 == "_gradientBevelFilter")
         {
            return this.§'!E§(GradientBevelFilter);
         }
         if(param1 == "_convolutionFilter")
         {
            return this.§'!E§(ConvolutionFilter);
         }
         if(param1 == "_displacementMapFilter")
         {
            return this.§'!E§(DisplacementMapFilter);
         }
         if(param1 == "_shaderFilter")
         {
            return this.§'!E§(ShaderFilter);
         }
         return null;
      }
