package §2!Q§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §=u§:b2Mat22 = new b2Mat22();
      ...
      public static function §%y§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §for §(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§1!c§(param1,param2);
         return _loc3_;
      }
      
      public static function §3B§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.native(new b2Vec2(0,0));
            _loc3_.native(_loc9_);
            _loc3_.native(_loc10_);
            _loc3_.§3!J§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §[!G§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§'!h§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§'!h§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §>!R§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§0!$§)
         {
            ...
            _loc6_ = b2Math.§-=§(this.§"x§[_loc5_],this.§"x§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§5U§() > Number.MIN_VALUE);
            this.§+!X§[_loc3_].SetV(b2Math.§@b§(_loc6_,1));
            this.§+!X§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§&U§ = §3B§(this.§"x§,this.§0!$§);
      }
      ...
      public function §&!0§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§0!$§)
         {
            this.§"x§[_loc6_] = b2Math.§;!N§(_loc5_,this.§"x§[_loc6_]);
            this.§+!X§[_loc6_] = b2Math.§2!U§(_loc5_.R,this.§+!X§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §1!c§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§0!$§ = 2;
         this.§%!0§(2);
         this.§"x§[0].SetV(param1);
         this.§"x§[1].SetV(param2);
         this.§&U§.x = 0.5 * (param1.x + param2.x);
         this.§&U§.y = 0.5 * (param1.y + param2.y);
         this.§+!X§[0] = b2Math.§@b§(b2Math.§-=§(param2,param1),1);
         this.§+!X§[0].Normalize();
         this.§+!X§[1].x = -this.§+!X§[0].x;
         this.§+!X§[1].y = -this.§+!X§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         while(_loc17_ < this.§0!$§)
         {
            ...
            _loc18_ = (_loc9_ = this.§+!X§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§0!l§.x = _loc5_ - b2internal::&!o;
         param1.§0!l§.y = _loc6_ - b2internal::&!o;
         param1.§6E§.x = _loc7_ + b2internal::&!o;
         param1.§6E§.y = _loc8_ + b2internal::&!o;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         while(_loc10_ < this.§0!$§)
         {
            ...
            _loc12_ = _loc10_ + 1 < this.§0!$§ ? this.§"x§[int(_loc10_ + 1)] : this.§"x§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      public function §@"0§() : Vector.<b2Vec2>
      {
         return this.§+!X§;
      }
