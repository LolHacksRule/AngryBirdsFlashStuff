package §2!Q§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      b2internal var §5N§:b2Vec2;
      
      b2internal var §43§:b2Vec2;
      ...
      b2internal var §9!N§:b2EdgeShape;
      
      b2internal var §try§:b2EdgeShape;
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§43§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§^-§ = this.§43§.Normalize();
         this.§5N§.Set(this.§43§.y,-this.§43§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§5N§.x - this.§43§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§5N§.y - this.§43§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§5N§.x + this.§43§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§5N§.y + this.§43§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§5N§;
         this.m_cornerDir2.Set(-this.§5N§.x,-this.§5N§.y);
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc8_:Number = b2Math.§%m§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§%m§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §;g§(param1:b2Transform) : b2Vec2
      {
      ...
      public function §4"%§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
