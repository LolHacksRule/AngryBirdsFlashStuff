package §&!n§
{
   ...
   class b2Simplex
   {
      ...
      public function §=?§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         this.§6!v§ = param1.count;
         var _loc8_:Vector.<b2SimplexVertex> = this.§"x§;
         var _loc9_:int = 0;
         while(_loc9_ < this.§6!v§)
         {
            ...
            _loc10_.§3!d§ = b2Math.§;!N§(param3,_loc6_);
            _loc10_.§`!Z§ = b2Math.§;!N§(param5,_loc7_);
            _loc10_.w = b2Math.§-=§(_loc10_.§`!Z§,_loc10_.§3!d§);
            _loc10_.a = 0;
            _loc9_++;
         }
         if(this.§6!v§ > 1)
      ...
      public function § each§(param1:b2SimplexCache) : void
      {
         param1.§<!v§ = this.§'!Y§();
         param1.count = uint(this.§6!v§);
         var _loc2_:Vector.<b2SimplexVertex> = this.§"x§;
         var _loc3_:int = 0;
         while(_loc3_ < this.§6!v§)
         {
      ...
      public function §'!B§() : b2Vec2
      {
         ...
         {
            case 1:
               return this.m_v1.w.§=!P§();
            case 2:
               _loc1_ = b2Math.§-=§(this.m_v2.w,this.m_v1.w);
               _loc2_ = b2Math.§[k§(_loc1_,this.m_v1.w.§=!P§());
               if(_loc2_ > 0)
               {
                  return b2Math.§3!X§(1,_loc1_);
               }
               return b2Math.§@b§(_loc1_,1);
               break;
            default:
      ...
      public function §#!h§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§6!v§)
         {
            case 0:
               ...
               break;
            case 1:
               param1.SetV(this.m_v1.§3!d§);
               param2.SetV(this.m_v1.§`!Z§);
               break;
            case 2:
               param1.x = this.m_v1.a * this.m_v1.§3!d§.x + this.m_v2.a * this.m_v2.§3!d§.x;
               param1.y = this.m_v1.a * this.m_v1.§3!d§.y + this.m_v2.a * this.m_v2.§3!d§.y;
               param2.x = this.m_v1.a * this.m_v1.§`!Z§.x + this.m_v2.a * this.m_v2.§`!Z§.x;
               param2.y = this.m_v1.a * this.m_v1.§`!Z§.y + this.m_v2.a * this.m_v2.§`!Z§.y;
               break;
            case 3:
               param2.x = param1.x = this.m_v1.a * this.m_v1.§3!d§.x + this.m_v2.a * this.m_v2.§3!d§.x + this.m_v3.a * this.m_v3.§3!d§.x;
               param2.y = param1.y = this.m_v1.a * this.m_v1.§3!d§.y + this.m_v2.a * this.m_v2.§3!d§.y + this.m_v3.a * this.m_v3.§3!d§.y;
               break;
            default:
               b2Settings.b2Assert(false);
         }
      ...
      public function §'!Y§() : Number
      {
         switch(this.§6!v§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§-=§(this.m_v1.w,this.m_v2.w).§8!p§();
            case 3:
               return b2Math.§[k§(b2Math.§-=§(this.m_v2.w,this.m_v1.w),b2Math.§-=§(this.m_v3.w,this.m_v1.w));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
      ...
      public function Solve3() : void
      {
         ...
         var _loc19_:Number;
         var _loc20_:Number = (_loc19_ = b2Math.§[k§(_loc4_,_loc9_)) * b2Math.§[k§(_loc2_,_loc3_);
         var _loc21_:Number = _loc19_ * b2Math.§[k§(_loc3_,_loc1_);
         var _loc22_:Number = _loc19_ * b2Math.§[k§(_loc1_,_loc2_);
