package §&!n§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §`!&§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§;M§ = §!T§;
            _loc7_ = this.§0M§.§@"'§(param1.indexA[0]);
            ...
            this.§-N§.x = _loc15_ - _loc13_;
            this.§-N§.y = _loc16_ - _loc14_;
            this.§-N§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§;M§ = § !b§;
            _loc8_ = this.§0M§.§@"'§(param1.indexA[0]);
            _loc9_ = this.§0M§.§@"'§(param1.indexA[1]);
            _loc10_ = this.§#[§.§@"'§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§-N§ = b2Math.§@b§(b2Math.§-=§(_loc9_,_loc8_),1);
            this.§-N§.Normalize();
            _loc20_ = this.§-N§;
         ...
         else if(param1.indexA[0] == param1.indexA[0])
         {
            ...
            this.§-N§ = b2Math.§@b§(b2Math.§-=§(_loc12_,_loc11_),1);
            this.§-N§.Normalize();
            _loc20_ = this.§-N§;
         ...
         else
         {
            ...
            _loc11_ = this.§#[§.§@"'§(param1.indexB[0]);
            _loc12_ = this.§#[§.§@"'§(param1.indexB[1]);
            _loc23_ = b2Math.§;!N§(param3,_loc7_);
            _loc24_ = b2Math.§2!U§(param3.R,b2Math.§-=§(_loc9_,_loc8_));
            _loc25_ = b2Math.§;!N§(param5,_loc10_);
            _loc26_ = b2Math.§2!U§(param5.R,b2Math.§-=§(_loc12_,_loc11_));
            ...
            if(_loc33_ != 0)
            {
               _loc21_ = b2Math.§"A§((_loc32_ * _loc31_ - _loc30_ * _loc28_) / _loc33_,0,1);
            }
            if((_loc34_ = (_loc32_ * _loc21_ + _loc31_) / _loc28_) < 0)
            {
               _loc34_ = 0;
               _loc21_ = b2Math.§"A§((_loc32_ - _loc30_) / _loc27_,0,1);
            }
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §!T§:
               _loc3_ = b2Math.§^P§(param1.R,this.§-N§);
               _loc4_ = b2Math.§^P§(param2.R,this.§-N§.§=!P§());
               _loc5_ = this.§0M§.§?w§(_loc3_);
               _loc6_ = this.§#[§.§?w§(_loc4_);
               _loc7_ = b2Math.§;!N§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§;!N§(param2,_loc6_)).x - _loc7_.x) * this.§-N§.x + (_loc8_.y - _loc7_.y) * this.§-N§.y);
            case § !b§:
               _loc10_ = b2Math.§2!U§(param1.R,this.§-N§);
               _loc7_ = b2Math.§;!N§(param1,this.m_localPoint);
               _loc4_ = b2Math.§^P§(param2.R,_loc10_.§=!P§());
               _loc6_ = this.§#[§.§?w§(_loc4_);
               return Number(((_loc8_ = b2Math.§;!N§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §;!4§:
               _loc10_ = b2Math.§2!U§(param2.R,this.§-N§);
               _loc8_ = b2Math.§;!N§(param2,this.m_localPoint);
               _loc3_ = b2Math.§^P§(param1.R,_loc10_.§=!P§());
               _loc5_ = this.§0M§.§?w§(_loc3_);
               return Number(((_loc7_ = b2Math.§;!N§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
