package §9!j§
{
   ...
   public class §'"#§
   {
      ...
      public function §0;§(param1:Class, param2:Class, param3:Array) : void
      {
         var _loc4_:uint = param3.length;
         var _loc5_:uint = 0;
         while(_loc5_ < _loc4_)
         {
            this.§=!A§(param1,param2,param3[_loc5_]);
            _loc5_++;
         }
      }
      
      public function §?!C§(param1:Class, param2:String) : Class
      {
         var _loc4_:* = undefined;
         var _loc3_:* = this.§7!-§[param1];
         if(_loc3_ != null)
         {
      ...
      public function §=!A§(param1:Class, param2:Class, param3:String) : void
      {
         var _loc7_:uint = 0;
         var _loc8_:uint = 0;
         var _loc9_:Class = null;
         if(this.§7!-§[param2] == undefined)
         {
            this.§%e§(param2);
         }
         var _loc4_:Dictionary;
         var _loc5_:Class = (_loc4_ = this.§7!-§)[param2][param3] as Class;
         _loc4_[param2][param3] = param1;
         var _loc6_:Vector.<Class>;
         if((_loc6_ = this.§6"§[param2] as Vector.<Class>) != null)
         {
      ...
      private function §%e§(param1:Class) : void
      {
         ...
         var _loc2_:Dictionary = this.§7!-§;
         var _loc3_:Dictionary = this.§6"§;
