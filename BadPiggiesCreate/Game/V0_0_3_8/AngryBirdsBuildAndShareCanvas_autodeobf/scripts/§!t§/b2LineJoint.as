package §!t§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§8j§.x * this.§>!L§.x + (this.§<!l§ + this.§8j§.y) * this.§-N§.x),param1 * (this.§8j§.x * this.§>!L§.y + (this.§<!l§ + this.§8j§.y) * this.§-N§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§&9§)
         {
            ...
            this.§<!l§ *= param1.§4!1§;
            _loc19_ = this.§8j§.x * this.§>!L§.x + (this.§<!l§ + this.§8j§.y) * this.§-N§.x;
            _loc20_ = this.§8j§.x * this.§>!L§.y + (this.§<!l§ + this.§8j§.y) * this.§-N§.y;
            _loc21_ = this.§8j§.x * this.m_s1 + (this.§<!l§ + this.§8j§.y) * this.m_a1;
            _loc22_ = this.§8j§.x * this.m_s2 + (this.§<!l§ + this.§8j§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§-N§.x * (_loc6_.x - _loc4_.x) + this.§-N§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§'!§ * (this.§<"1§ - _loc13_);
            _loc15_ = this.§<!l§;
            _loc16_ = param1.§,!i§ * this.§'y§;
            this.§<!l§ = b2Math.§"A§(this.§<!l§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§<!l§ - _loc15_) * this.§-N§.x;
            _loc9_ = _loc14_ * this.§-N§.y;
         ...
         {
            _loc17_ = this.§-N§.x * (_loc6_.x - _loc4_.x) + this.§-N§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§8j§.Copy();
            _loc19_ = this.§`1§.§=!3§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§8j§.native(_loc19_);
            if(this.§3K§ == b2internal::&"3)
            {
               this.§8j§.y = b2Math.§%!N§(this.§8j§.y,0);
            }
            else if(this.§3K§ == b2internal::]!c)
            {
               this.§8j§.y = b2Math.§,n§(this.§8j§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§8j§.y - _loc18_.y) * this.§`1§.col2.x;
            if(this.§`1§.col1.x != 0)
            {
            ...
            this.§8j§.x = _loc21_;
            _loc19_.x = this.§8j§.x - _loc18_.x;
            _loc19_.y = this.§8j§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§>!L§.x + _loc19_.y * this.§-N§.x;
            _loc9_ = _loc19_.x * this.§>!L§.y + _loc19_.y * this.§-N§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§9!C§)
         {
            ...
            _loc34_ = this.§-N§.x * _loc26_ + this.§-N§.y * _loc27_;
            if(b2Math.§?!Y§(this.§^]§ - this.§?J§) < 2 * b2Settings.b2_linearSlop)
            {
            ...
            {
               _loc19_ = b2Math.§"A§(_loc34_ - this.§?J§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§?J§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§^]§)
            {
               _loc19_ = b2Math.§"A§(_loc34_ - this.§^]§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§`1§.§=!3§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::9"+;
         ...
         var _loc30_:Number = _loc28_.x * this.§>!L§.x + _loc28_.y * this.§-N§.x;
         var _loc31_:Number = _loc28_.x * this.§>!L§.y + _loc28_.y * this.§-N§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::9"+ * _loc30_;
         _loc6_.y -= b2internal::9"+ * _loc31_;
         _loc7_ -= b2internal::6!N * _loc32_;
         _loc8_.x += b2internal::`!I * _loc30_;
         _loc8_.y += b2internal::`!I * _loc31_;
         _loc9_ += b2internal::3t * _loc33_;
