package §0!!§
{
   ...
   public class §2z§ extends Sprite
   {
      ...
      public function §2z§(param1:int, param2:int, param3:Number, param4:Number, param5:int, param6:int = 40)
      {
         var _loc9_:§^h§ = null;
         ...
         this.§]!m§ = param1;
         this.§3!9§ = param2;
         var _loc7_:Number = Math.min(§8!0§.§6S§,§8!0§.§&!_§);
         var _loc8_:Number = Math.max(§8!0§.§6S§,§8!0§.§&!_§);
         param3 /= §8!0§.§&!_§;
         param4 /= §8!0§.§6S§;
         this.§`z§ = param5;
         ...
         {
            (_loc9_ = new §^h§(Math.random() * 40 + 10)).x = -2000;
            _loc9_.y = -2000;
            this.addChild(_loc9_);
            this.§7"1§[_loc12_] = _loc9_;
            _loc12_++;
         }
         this.scaleX = _loc8_;
         this.scaleY = _loc8_;
