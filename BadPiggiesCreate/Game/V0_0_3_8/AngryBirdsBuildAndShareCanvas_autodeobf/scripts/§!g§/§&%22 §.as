package §!g§
{
   public class §&" §
   {
      ...
      public var §7!F§:String;
      
      public var §0c§:String;
      ...
      {
         this.§<!@§[this.§<!@§.length] = new §`j§(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13,param14,param15,param16,param17);
      }
