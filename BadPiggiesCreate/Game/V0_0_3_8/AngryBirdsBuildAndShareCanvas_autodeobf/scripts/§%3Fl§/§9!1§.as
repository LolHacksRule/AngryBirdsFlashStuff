package §?l§
{
   ...
   public class §9!1§ extends §;6§
   {
       
      
      public function §9!1§(param1:XML, param2:Vector.<XML>, param3:BitmapData)
      {
         super(param3);
         this.§+"!§(param1,param2);
      }
      ...
      protected function §+"!§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         var _loc16_:§5a§ = null;
         var _loc3_:Dictionary = this.§;!O§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§8!N§(_loc7_,_loc6_)]) == null)
            {
               ...
               {
                  _loc10_ = new §!!x§(0,0,_loc11_,_loc12_,_loc13_,_loc14_);
               }
            }
            if(_loc10_)
            {
               _loc15_ = new Rectangle(_loc8_ + _loc10_.x,_loc9_ + _loc10_.y,_loc10_.width,_loc10_.height);
               (_loc16_ = new §5a§()).mName = _loc6_;
               _loc16_.§0!T§ = _loc15_;
               _loc16_.§5!2§ = _loc10_.pivotX;
               _loc16_.§`P§ = _loc10_.pivotY;
               _loc16_.§32§ = §'b§;
               §3-§(_loc16_);
            }
         }
      ...
      private function §8!N§(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function §;!O§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§8!N§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §!!x§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
