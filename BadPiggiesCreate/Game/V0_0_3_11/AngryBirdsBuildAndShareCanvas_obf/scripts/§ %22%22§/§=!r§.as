package § ""§
{
   ...
   public class §=!r§ extends §0"2§
   {
       
      
      public function §=!r§(param1:§6!u§, param2:Sprite, param3:b2World, param4:§@%§, param5:int, param6:String, param7:Number, param8:Number, param9:Number, param10:Boolean = true, param11:Number = 1.0)
      {
