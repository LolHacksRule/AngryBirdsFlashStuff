package §<!k§
{
   ...
   public class §0"7§ extends Sprite
   {
      ...
      public function §0"7§(param1:int, param2:int, param3:Number, param4:Number, param5:int, param6:int = 40)
      {
         var _loc9_:§ F§ = null;
         ...
         this.§>!`§ = param1;
         this.§ !U§ = param2;
         var _loc7_:Number = Math.min(§?z§.§%!K§,§?z§.§'!<§);
         var _loc8_:Number = Math.max(§?z§.§%!K§,§?z§.§'!<§);
         param3 /= §?z§.§'!<§;
         param4 /= §?z§.§%!K§;
         this.§29§ = param5;
         ...
         {
            (_loc9_ = new § F§(Math.random() * 40 + 10)).x = -2000;
            _loc9_.y = -2000;
