package §1!3§
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§2g§.Set(_loc4_ - b2internal::5^,_loc5_ - b2internal::5^);
         param1.§3!P§.Set(_loc4_ + b2internal::5^,_loc5_ + b2internal::5^);
      }
      
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         param1.§82§ = param2 * b2Settings.b2_pi * b2internal::5^ * b2internal::5^;
         param1.center.SetV(this.§;!+§);
         param1.I = param1.§82§ * (0.5 * b2internal::5^ * b2internal::5^ + (this.§;!+§.x * this.§;!+§.x + this.§;!+§.y * this.§;!+§.y));
      }
      
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         var _loc9_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§3!o§(param3,this.§;!+§);
         var _loc6_:Number;
         if((_loc6_ = -(b2Math.§&"4§(param1,_loc5_) - param2)) < -b2internal::5^ + Number.MIN_VALUE)
         {
            return 0;
         }
      ...
      public function §3!j§(param1:b2Vec2) : void
      {
         this.§;!+§.SetV(param1);
      }
