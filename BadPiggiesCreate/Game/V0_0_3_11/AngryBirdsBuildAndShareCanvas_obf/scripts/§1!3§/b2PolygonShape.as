package §1!3§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §;y§:b2Mat22 = new b2Mat22();
      ...
      b2internal var §5!_§:Vector.<b2Vec2>;
      ...
      public function b2PolygonShape()
      {
         ...
         this.§5!_§ = new Vector.<b2Vec2>();
         §5^§ = b2Settings.b2_polygonRadius;
         this.§%9§.§>!!§();
      }
      
      public static function §1k§(param1:Array, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§5!a§(param1,param2);
         return _loc3_;
      }
      
      public static function §2"%§(param1:Vector.<b2Vec2>, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §8!g§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §=y§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
         _loc3_.§8D§(param1,param2);
         return _loc3_;
      }
      ...
      public static function §7!^§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc3_.§`"!§(_loc9_);
            _loc3_.§`"!§(_loc10_);
            _loc3_.§9"!§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      b2internal static function §,_§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§3!i§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§3!i§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      override public function Set(param1:b2Shape) : void
      {
         ...
         if(param1 is b2PolygonShape)
         {
            ...
            while(_loc3_ < this.§]n§)
            {
               ...
               this.§5!_§[_loc3_].SetV(_loc2_.§5!_§[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      public function §5!a§(param1:Array, param2:Number = 0) : void
      {
      ...
      public function §%7§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§]n§)
         {
            ...
            _loc6_ = b2Math.§8"!§(this.§[Q§[_loc5_],this.§[Q§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§7F§() > Number.MIN_VALUE);
            this.§5!_§[_loc3_].SetV(b2Math.§ n§(_loc6_,1));
            this.§5!_§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§%9§ = §7!^§(this.§[Q§,this.§]n§);
      }
      ...
      public function § "$§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         while(_loc6_ < this.§]n§)
         {
            this.§[Q§[_loc6_] = b2Math.§3!o§(_loc5_,this.§[Q§[_loc6_]);
            this.§5!_§[_loc6_] = b2Math.§9p§(_loc5_.R,this.§5!_§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §8D§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§]n§ = 2;
         this.§+!>§(2);
         this.§[Q§[0].SetV(param1);
         this.§[Q§[1].SetV(param2);
         this.§%9§.x = 0.5 * (param1.x + param2.x);
         this.§%9§.y = 0.5 * (param1.y + param2.y);
         this.§5!_§[0] = b2Math.§ n§(b2Math.§8"!§(param2,param1),1);
         this.§5!_§[0].Normalize();
         this.§5!_§[1].x = -this.§5!_§[0].x;
         this.§5!_§[1].y = -this.§5!_§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         while(_loc17_ < this.§]n§)
         {
            ...
            _loc18_ = (_loc9_ = this.§5!_§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§2g§.x = _loc5_ - b2internal::5^;
         param1.§2g§.y = _loc6_ - b2internal::5^;
         param1.§3!P§.x = _loc7_ + b2internal::5^;
         param1.§3!P§.y = _loc8_ + b2internal::5^;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         while(_loc10_ < this.§]n§)
         {
            ...
            _loc12_ = _loc10_ + 1 < this.§]n§ ? this.§[Q§[int(_loc10_ + 1)] : this.§[Q§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         {
            _loc7_[_loc12_] = b2Math.§&"4§(_loc5_,this.§[Q§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§3!o§(param3,_loc24_.center));
                  return _loc24_.§82§;
               }
               return 0;
               break;
         ...
         _loc20_.§9"!§(1 / _loc19_);
         param4.SetV(b2Math.§3!o§(param3,_loc20_));
         return _loc19_;
      }
      ...
      public function §9!D§() : Vector.<b2Vec2>
      {
         return this.§[Q§;
      }
