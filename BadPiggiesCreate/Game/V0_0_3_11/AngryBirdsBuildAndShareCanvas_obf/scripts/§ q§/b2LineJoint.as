package § q§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§#"4§.x * this.§#!9§.x + (this.§^!?§ + this.§#"4§.y) * this.§3"$§.x),param1 * (this.§#"4§.x * this.§#!9§.y + (this.§^!?§ + this.§#"4§.y) * this.§3"$§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§7d§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§7d§.col2.x = this.§7d§.col1.y;
         this.§7d§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§;![§)
         {
         ...
         if(param1.§ !<§)
         {
            ...
            this.§#"4§.y *= param1.§7"'§;
            this.§^!?§ *= param1.§7"'§;
            _loc19_ = this.§#"4§.x * this.§#!9§.x + (this.§^!?§ + this.§#"4§.y) * this.§3"$§.x;
            _loc20_ = this.§#"4§.x * this.§#!9§.y + (this.§^!?§ + this.§#"4§.y) * this.§3"$§.y;
            _loc21_ = this.§#"4§.x * this.m_s1 + (this.§^!?§ + this.§#"4§.y) * this.m_a1;
            _loc22_ = this.§#"4§.x * this.m_s2 + (this.§^!?§ + this.§#"4§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§3"$§.x * (_loc6_.x - _loc4_.x) + this.§3"$§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§,T§ * (this.§?c§ - _loc13_);
            _loc15_ = this.§^!?§;
            _loc16_ = param1.§'!R§ * this.§#!0§;
            this.§^!?§ = b2Math.§`V§(this.§^!?§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§^!?§ - _loc15_) * this.§3"$§.x;
            _loc9_ = _loc14_ * this.§3"$§.y;
         ...
         {
            _loc17_ = this.§3"$§.x * (_loc6_.x - _loc4_.x) + this.§3"$§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§#"4§.Copy();
            _loc19_ = this.§7d§.§]z§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§#"4§.§`"!§(_loc19_);
            if(this.§7"%§ == b2internal::'^)
            {
               this.§#"4§.y = b2Math.§+&§(this.§#"4§.y,0);
            }
            else if(this.§7"%§ == b2internal::0!%)
            {
               this.§#"4§.y = b2Math.§]0§(this.§#"4§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§#"4§.y - _loc18_.y) * this.§7d§.col2.x;
            if(this.§7d§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§7d§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§#"4§.x = _loc21_;
            _loc19_.x = this.§#"4§.x - _loc18_.x;
            _loc19_.y = this.§#"4§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§#!9§.x + _loc19_.y * this.§3"$§.x;
            _loc9_ = _loc19_.x * this.§#!9§.y + _loc19_.y * this.§3"$§.y;
         ...
         else
         {
            if(this.§7d§.col1.x != 0)
            {
               _loc22_ = -_loc12_ / this.§7d§.col1.x;
            }
            else
            {
               _loc22_ = 0;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§;![§)
         {
            ...
            _loc34_ = this.§3"$§.x * _loc26_ + this.§3"$§.y * _loc27_;
            if(b2Math.§;W§(this.§ f§ - this.§?i§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§`V§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§;W§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§?i§)
            {
               _loc19_ = b2Math.§`V§(_loc34_ - this.§?i§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§?i§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§ f§)
            {
               _loc19_ = b2Math.§`V§(_loc34_ - this.§ f§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
               _loc16_ = _loc34_ - this.§ f§;
               _loc18_ = true;
            }
         }
         ...
         if(_loc18_)
         {
            ...
            this.§7d§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§7d§.col2.x = this.§7d§.col1.y;
            this.§7d§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§7d§.§]z§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::9!J;
         ...
         var _loc30_:Number = _loc28_.x * this.§#!9§.x + _loc28_.y * this.§3"$§.x;
         var _loc31_:Number = _loc28_.x * this.§#!9§.y + _loc28_.y * this.§3"$§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::9!J * _loc30_;
         _loc6_.y -= b2internal::9!J * _loc31_;
         _loc7_ -= b2internal::;!v * _loc32_;
         _loc8_.x += b2internal::?!^ * _loc30_;
         _loc8_.y += b2internal::?!^ * _loc31_;
         _loc9_ += b2internal::0h * _loc33_;
