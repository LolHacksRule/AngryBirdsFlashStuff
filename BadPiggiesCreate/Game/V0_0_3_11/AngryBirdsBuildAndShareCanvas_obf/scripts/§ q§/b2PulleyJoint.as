package § q§
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      b2internal static const §&C§:Number = 2;
       
      
      private var §5!Q§:b2Body;
      ...
      public function b2PulleyJoint(param1:b2PulleyJointDef)
      {
         ...
         super(param1);
         this.§5!Q§ = b2internal:: [.m_world.m_groundBody;
         this.m_groundAnchor1.x = param1.§;Y§.x - this.§5!Q§.m_xf.position.x;
         this.m_groundAnchor1.y = param1.§;Y§.y - this.§5!Q§.m_xf.position.y;
         this.m_groundAnchor2.x = param1.§'!y§.x - this.§5!Q§.m_xf.position.x;
         this.m_groundAnchor2.y = param1.§'!y§.y - this.§5!Q§.m_xf.position.y;
         this.m_localAnchor1.SetV(param1.§[!L§);
         this.m_localAnchor2.SetV(param1.§8!^§);
         this.§'!§ = param1.§84§;
         this.§2"!§ = param1.§@!+§ + this.§'!§ * param1.§""%§;
         this.m_maxLength1 = b2Math.§]0§(param1.§2!X§,this.§2"!§ - this.§'!§ * b2internal::&C);
         this.m_maxLength2 = b2Math.§]0§(param1.§^!v§,(this.§2"!§ - b2internal::&C) / this.§'!§);
         this.§#"4§ = 0;
      ...
      {
         return new b2Vec2(param1 * this.§#"4§ * this.m_u2.x,param1 * this.§#"4§ * this.m_u2.y);
      }
      ...
      {
         var _loc1_:b2Vec2 = this.§5!Q§.m_xf.position.Copy();
         _loc1_.§`"!§(this.m_groundAnchor1);
         return _loc1_;
      }
      
      public function §0!a§() : b2Vec2
      {
         var _loc1_:b2Vec2 = this.§5!Q§.m_xf.position.Copy();
      ...
      public function GetLength1() : Number
      {
         ...
         var _loc2_:Number = this.§5!Q§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.§5!Q§.m_xf.position.y + this.m_groundAnchor1.y;
      ...
      public function GetLength2() : Number
      {
         ...
         var _loc2_:Number = this.§5!Q§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.§5!Q§.m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc14_:Number = this.§5!Q§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.§5!Q§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.§5!Q§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.§5!Q§.m_xf.position.y + this.m_groundAnchor2.y;
         this.m_u1.Set(_loc10_ - _loc14_,_loc11_ - _loc15_);
         this.m_u2.Set(_loc12_ - _loc16_,_loc13_ - _loc17_);
         var _loc18_:Number = this.m_u1.§9!5§();
         var _loc19_:Number = this.m_u2.§9!5§();
         ...
         var _loc20_:Number;
         if((_loc20_ = this.§2"!§ - _loc18_ - this.§'!§ * _loc19_) > 0)
         {
            this.§]!O§ = b2internal::7w;
            this.§#"4§ = 0;
         }
         else
         {
         ...
         {
            this.m_limitState1 = b2internal::7w;
            this.m_limitImpulse1 = 0;
         }
         else
         {
            this.m_limitState1 = b2internal::0!%;
         }
         if(_loc19_ < this.m_maxLength2)
         {
            this.m_limitState2 = b2internal::7w;
            this.m_limitImpulse2 = 0;
         }
         else
         {
            this.m_limitState2 = b2internal::0!%;
         }
         var _loc21_:Number = _loc5_ * this.m_u1.y - _loc6_ * this.m_u1.x;
         var _loc22_:Number = _loc8_ * this.m_u2.y - _loc9_ * this.m_u2.x;
         this.m_limitMass1 = _loc2_.§4`§ + _loc2_.§^J§ * _loc21_ * _loc21_;
         this.m_limitMass2 = _loc3_.§4`§ + _loc3_.§^J§ * _loc22_ * _loc22_;
         this.§2!"§ = this.m_limitMass1 + this.§'!§ * this.§'!§ * this.m_limitMass2;
         ...
         if(param1.§ !<§)
         {
            ...
            _loc23_ = (-this.§#"4§ - this.m_limitImpulse1) * this.m_u1.x;
            _loc24_ = (-this.§#"4§ - this.m_limitImpulse1) * this.m_u1.y;
            _loc25_ = (-this.§'!§ * this.§#"4§ - this.m_limitImpulse2) * this.m_u2.x;
            _loc26_ = (-this.§'!§ * this.§#"4§ - this.m_limitImpulse2) * this.m_u2.y;
            _loc2_.§#"3§.x += _loc2_.§4`§ * _loc23_;
            _loc2_.§#"3§.y += _loc2_.§4`§ * _loc24_;
            _loc2_.m_angularVelocity += _loc2_.§^J§ * (_loc5_ * _loc24_ - _loc6_ * _loc23_);
            _loc3_.§#"3§.x += _loc3_.§4`§ * _loc25_;
            _loc3_.§#"3§.y += _loc3_.§4`§ * _loc26_;
            _loc3_.m_angularVelocity += _loc3_.§^J§ * (_loc8_ * _loc26_ - _loc9_ * _loc25_);
         }
         else
         {
            this.§#"4§ = 0;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc10_ = _loc2_.§#"3§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§#"3§.y + _loc2_.m_angularVelocity * _loc5_;
            _loc12_ = _loc3_.§#"3§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§#"3§.y + _loc3_.m_angularVelocity * _loc8_;
            _loc18_ = -(this.m_u1.x * _loc10_ + this.m_u1.y * _loc11_) - this.§'!§ * (this.m_u2.x * _loc12_ + this.m_u2.y * _loc13_);
            _loc19_ = this.§2!"§ * -_loc18_;
            _loc20_ = this.§#"4§;
            this.§#"4§ = b2Math.§+&§(0,this.§#"4§ + _loc19_);
            _loc14_ = -(_loc19_ = this.§#"4§ - _loc20_) * this.m_u1.x;
            _loc15_ = -_loc19_ * this.m_u1.y;
            _loc16_ = -this.§'!§ * _loc19_ * this.m_u2.x;
            _loc17_ = -this.§'!§ * _loc19_ * this.m_u2.y;
            _loc2_.§#"3§.x += _loc2_.§4`§ * _loc14_;
            _loc2_.§#"3§.y += _loc2_.§4`§ * _loc15_;
            _loc2_.m_angularVelocity += _loc2_.§^J§ * (_loc5_ * _loc15_ - _loc6_ * _loc14_);
            _loc3_.§#"3§.x += _loc3_.§4`§ * _loc16_;
            _loc3_.§#"3§.y += _loc3_.§4`§ * _loc17_;
            _loc3_.m_angularVelocity += _loc3_.§^J§ * (_loc8_ * _loc17_ - _loc9_ * _loc16_);
         }
         if(this.m_limitState1 == b2internal::0!%)
         {
            _loc10_ = _loc2_.§#"3§.x + -_loc2_.m_angularVelocity * _loc6_;
            _loc11_ = _loc2_.§#"3§.y + _loc2_.m_angularVelocity * _loc5_;
         ...
         if(this.m_limitState2 == b2internal::0!%)
         {
            _loc12_ = _loc3_.§#"3§.x + -_loc3_.m_angularVelocity * _loc9_;
            _loc13_ = _loc3_.§#"3§.y + _loc3_.m_angularVelocity * _loc8_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal:: [;
         var _loc3_:b2Body = b2internal::-?;
         var _loc5_:Number = this.§5!Q§.m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.§5!Q§.m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.§5!Q§.m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.§5!Q§.m_xf.position.y + this.m_groundAnchor2.y;
         ...
         if(this.§]!O§ == b2internal::0!%)
         {
            ...
            _loc17_ = this.m_u1.§9!5§();
            _loc18_ = this.m_u2.§9!5§();
            ...
            _loc19_ = this.§2"!§ - _loc17_ - this.§'!§ * _loc18_;
            _loc24_ = b2Math.§+&§(_loc24_,-_loc19_);
            _loc19_ = b2Math.§`V§(_loc19_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
            ...
            _loc2_.m_sweep.c.x += _loc2_.§4`§ * _loc13_;
            _loc2_.m_sweep.c.y += _loc2_.§4`§ * _loc14_;
            _loc2_.m_sweep.a += _loc2_.§^J§ * (_loc9_ * _loc14_ - _loc10_ * _loc13_);
            _loc3_.m_sweep.c.x += _loc3_.§4`§ * _loc15_;
            _loc3_.m_sweep.c.y += _loc3_.§4`§ * _loc16_;
            _loc3_.m_sweep.a += _loc3_.§^J§ * (_loc11_ * _loc16_ - _loc12_ * _loc15_);
            _loc2_.§-y§();
            _loc3_.§-y§();
         }
         if(this.m_limitState1 == b2internal::0!%)
         {
            ...
            _loc14_ = _loc2_.m_sweep.c.y + _loc10_;
            this.m_u1.Set(_loc13_ - _loc5_,_loc14_ - _loc6_);
            if((_loc17_ = this.m_u1.§9!5§()) > b2Settings.b2_linearSlop)
            {
         ...
         if(this.m_limitState2 == b2internal::0!%)
         {
            ...
            _loc16_ = _loc3_.m_sweep.c.y + _loc12_;
            this.m_u2.Set(_loc15_ - _loc7_,_loc16_ - _loc8_);
            if((_loc18_ = this.m_u2.§9!5§()) > b2Settings.b2_linearSlop)
            {
