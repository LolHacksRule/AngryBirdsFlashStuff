package §;!A§
{
   ...
   public class §;!u§ extends §8!=§
   {
       
      
      public var §%"+§:§`5§;
      
      public var §`6§:Vector.<§8!=§>;
      
      public var §7!k§:Boolean = false;
      
      public function §;!u§(param1:XML, param2:§;!u§, param3:§`5§, param4:MovieClip = null)
      {
         var _loc5_:XML = null;
         var _loc6_:XML = null;
         var _loc7_:XML = null;
         ...
         {
            this.§`6§.push(new §;!u§(_loc5_,this,null));
         }
         for each(_loc6_ in param1.Repeater)
         {
            this.§`6§.push(new §'!K§(_loc6_,this,null));
         }
         for each(_loc7_ in param1.Button)
         {
            this.§`6§.push(new §2v§(_loc7_,this));
         }
         for each(_loc8_ in param1.TextField)
         {
            this.§`6§.push(new § !F§(_loc8_,this));
         }
         for each(_loc9_ in param1.MovieClip)
         {
            this.§`6§.push(new §%!`§(_loc9_,this));
         }
         for each(_loc10_ in param1.Popup)
         {
            this.§`6§.push(new §#!w§(_loc10_,this));
         }
         for each(_loc11_ in param1.Slider)
         {
            this.§`6§.push(new §+Y§(_loc11_,this));
         }
      ...
      public function §85§(param1:§8!=§) : void
      {
      ...
      public function §&!W§(param1:§8!=§) : void
      {
         if(this.§`6§.indexOf(param1) < 0)
         {
            ...
            param1.setActiveStatus(this.override);
      ...
      public function removeComponent(param1:§8!=§) : void
      {
      ...
      public function §&!7§(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            {
               § do§.log("WARNING: UIContainer(" + mName + ") setItemVisibility can not be done because item " + param1 + " does not exist");
            }
         }
      }
      ...
      public function getItemByName(param1:String) : §8!=§
      {
         ...
         for each(_loc2_ in this.§`6§)
         {
            ...
            if(_loc2_ is §;!u§)
            {
               _loc3_ = (_loc2_ as §;!u§).getItemByName(param1);
               if(_loc3_ != null)
               {
                  return _loc3_;
               }
