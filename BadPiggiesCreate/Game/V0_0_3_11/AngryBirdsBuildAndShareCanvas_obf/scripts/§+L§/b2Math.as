package §+L§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§2!W§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §=!q§(param1:Number) : Boolean
      {
      ...
      public static function §7!y§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         return param1.x * param2.y - param1.y * param2.x;
      }
      
      public static function § n§(param1:b2Vec2, param2:Number) : b2Vec2
      {
         return new b2Vec2(param2 * param1.y,-param2 * param1.x);
      }
      
      public static function §-8§(param1:Number, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(-param1 * param2.y,param1 * param2.x);
      }
      
      public static function §9p§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return new b2Vec2(§&"4§(param2,param1.col1),§&"4§(param2,param1.col2));
      }
      
      public static function §3!o§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         _loc3_ = §9p§(param1.R,param2);
         _loc3_.x += param1.position.x;
         _loc3_.y += param1.position.y;
         return _loc3_;
      }
      
      public static function §8<§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
      ...
      {
         return b2Mat22.§2!W§(§ !g§(param1.col1,param2.col1),§ !g§(param1.col2,param2.col2));
      }
      
      public static function §6"9§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§2!W§(§9p§(param1,param2.col1),§9p§(param1,param2.col2));
      }
      
      public static function §>!7§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§&"4§(param1.col1,param2.col1),§&"4§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§&"4§(param1.col1,param2.col2),§&"4§(param1.col2,param2.col2));
         return b2Mat22.§2!W§(_loc3_,_loc4_);
      }
      ...
      {
         return b2Mat22.§2!W§(§?!x§(param1.col1),§?!x§(param1.col2));
      }
      ...
      public static function §8"7§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
      ...
      public static function §`V§(param1:Number, param2:Number, param3:Number) : Number
      {
         return param1 < param2 ? Number(param2) : (param1 > param3 ? Number(param3) : Number(param1));
      }
      
      public static function §'!Q§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2) : b2Vec2
      {
         return §&"7§(param2,§8"7§(param1,param3));
      }
      
      public static function §5!Z§(param1:Array, param2:Array) : void
      {
         var _loc3_:* = param1[0];
         param1[0] = param2[0];
         param2[0] = _loc3_;
      ...
      public static function §3"6§() : Number
      {
