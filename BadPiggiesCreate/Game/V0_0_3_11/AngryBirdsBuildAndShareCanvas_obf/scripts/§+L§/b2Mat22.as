package §+L§
{
   public class b2Mat22
   {
      ...
      public static function §2!W§(param1:b2Vec2, param2:b2Vec2) : b2Mat22
      {
         var _loc3_:b2Mat22 = new b2Mat22();
         _loc3_.§0!m§(param1,param2);
         return _loc3_;
      }
      ...
      public function §0!m§(param1:b2Vec2, param2:b2Vec2) : void
      {
      ...
      public function §]z§(param1:b2Vec2, param2:Number, param3:Number) : b2Vec2
      {
