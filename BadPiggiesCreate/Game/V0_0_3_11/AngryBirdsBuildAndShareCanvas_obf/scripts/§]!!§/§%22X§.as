package §]!!§
{
   ...
   public class §"X§ extends §^s§
   {
      ...
      public static function §`!^§(param1:§^s§) : §"X§
      {
         var _loc2_:§"X§ = new §"X§(param1.type,param1.index1,param1.index2,param1.point1,param1.point2,param1.§'J§,param1.§6!3§,param1.lowerLimit,param1.upperLimit,param1.§6!c§,param1.motorSpeed,param1.§#!W§,param1.maxTorque);
         _loc2_.§8!R§ = param1.§8!R§;
