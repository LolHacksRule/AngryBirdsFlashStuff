package §9![§
{
   ...
   public class b2ContactSolver
   {
      ...
      private static var §4!e§:b2WorldManifold = new b2WorldManifold();
      
      private static var §"8§:b2PositionSolverManifold = new b2PositionSolverManifold();
       
      
      private var §^!s§:b2TimeStep;
      
      private var §0!5§;
      
      b2internal var §super§:Vector.<b2ContactConstraint>;
      
      private var §9F§:int;
      
      public function b2ContactSolver()
      {
         this.§^!s§ = new b2TimeStep();
         this.§super§ = new Vector.<b2ContactConstraint>();
         super();
      }
      
      public function §5$§(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         this.§0!5§ = param4;
         this.§9F§ = param3;
         while(this.§super§.length < this.§9F§)
         {
            this.§super§[this.§super§.length] = new b2ContactConstraint();
         }
         _loc6_ = 0;
         while(_loc6_ < param3)
         {
            _loc9_ = (_loc5_ = param2[_loc6_]).§2G§;
            _loc10_ = _loc5_.§]![§;
            _loc11_ = _loc9_.§3!H§;
            _loc12_ = _loc10_.§3!H§;
            _loc13_ = _loc11_.§5^§;
            ...
            _loc17_ = _loc5_.§3J§();
            _loc18_ = b2Settings.b2MixFriction(_loc9_.§1!4§(),_loc10_.§1!4§());
            ...
            b2Settings.b2Assert(_loc17_.§7i§ > 0);
            §4!e§.§5$§(_loc17_,_loc15_.m_xf,_loc13_,_loc16_.m_xf,_loc14_);
            _loc26_ = §4!e§.§2R§.x;
            _loc27_ = §4!e§.§2R§.y;
            (_loc28_ = this.§super§[_loc6_]).§@]§ = _loc15_;
            _loc28_.§3@§ = _loc16_;
            _loc28_.§^@§ = _loc17_;
            _loc28_.normal.x = _loc26_;
            _loc28_.normal.y = _loc27_;
            _loc28_.§-o§ = _loc17_.§7i§;
            _loc28_.friction = _loc18_;
            _loc28_.restitution = _loc19_;
            _loc28_.§]",§.x = _loc17_.§2F§.x;
            _loc28_.§]",§.y = _loc17_.§2F§.y;
            _loc28_.localPoint.x = _loc17_.m_localPoint.x;
            _loc28_.localPoint.y = _loc17_.m_localPoint.y;
            _loc28_.radius = _loc13_ + _loc14_;
            _loc28_.type = _loc17_.§7!S§;
            _loc29_ = 0;
            while(_loc29_ < _loc28_.§-o§)
            {
               _loc30_ = _loc17_.§;r§[_loc29_];
               (_loc31_ = _loc28_.§#!V§[_loc29_]).normalImpulse = _loc30_.§=W§;
               _loc31_.tangentImpulse = _loc30_.§?!@§;
               _loc31_.localPoint.SetV(_loc30_.m_localPoint);
               _loc32_ = _loc31_.§5[§.x = §4!e§.§;r§[_loc29_].x - _loc15_.m_sweep.c.x;
               _loc33_ = _loc31_.§5[§.y = §4!e§.§;r§[_loc29_].y - _loc15_.m_sweep.c.y;
               _loc34_ = _loc31_.§60§.x = §4!e§.§;r§[_loc29_].x - _loc16_.m_sweep.c.x;
               _loc35_ = _loc31_.§60§.y = §4!e§.§;r§[_loc29_].y - _loc16_.m_sweep.c.y;
               _loc36_ = _loc32_ * _loc27_ - _loc33_ * _loc26_;
               _loc37_ = _loc34_ * _loc27_ - _loc35_ * _loc26_;
               _loc36_ *= _loc36_;
               _loc37_ *= _loc37_;
               _loc38_ = _loc15_.§4`§ + _loc16_.§4`§ + _loc15_.§^J§ * _loc36_ + _loc16_.§^J§ * _loc37_;
               _loc31_.§]!$§ = 1 / _loc38_;
               _loc39_ = (_loc39_ = _loc15_.§<"8§ * _loc15_.§4`§ + _loc16_.§<"8§ * _loc16_.§4`§) + (_loc15_.§<"8§ * _loc15_.§^J§ * _loc36_ + _loc16_.§<"8§ * _loc16_.§^J§ * _loc37_);
               _loc31_.§,!"§ = 1 / _loc39_;
               _loc40_ = _loc27_;
               _loc41_ = -_loc26_;
               ...
               _loc42_ *= _loc42_;
               _loc43_ *= _loc43_;
               _loc44_ = _loc15_.§4`§ + _loc16_.§4`§ + _loc15_.§^J§ * _loc42_ + _loc16_.§^J§ * _loc43_;
               _loc31_.§^,§ = 1 / _loc44_;
               _loc31_.§-_§ = 0;
               ...
               {
                  _loc31_.§-_§ += -_loc28_.restitution * _loc47_;
               }
               _loc29_++;
            }
            if(_loc28_.§-o§ == 2)
            {
               ...
               _loc52_ = _loc16_.§4`§;
               _loc53_ = _loc16_.§^J§;
               _loc54_ = _loc48_.§5[§.x * _loc27_ - _loc48_.§5[§.y * _loc26_;
               _loc55_ = _loc48_.§60§.x * _loc27_ - _loc48_.§60§.y * _loc26_;
               _loc56_ = _loc49_.§5[§.x * _loc27_ - _loc49_.§5[§.y * _loc26_;
               _loc57_ = _loc49_.§60§.x * _loc27_ - _loc49_.§60§.y * _loc26_;
               ...
               {
                  _loc28_.§8B§.col1.Set(_loc58_,_loc60_);
                  _loc28_.§8B§.col2.Set(_loc60_,_loc59_);
                  _loc28_.§8B§.§,!;§(_loc28_.§]!$§);
               }
               else
               {
      ...
      public function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc7_ = (_loc6_ = this.§super§[_loc5_]).§@]§;
            _loc8_ = _loc6_.§3@§;
            _loc9_ = _loc7_.§4`§;
            _loc10_ = _loc7_.§^J§;
            _loc11_ = _loc8_.§4`§;
            ...
            if(param1.§ !<§)
            {
               ...
               while(_loc18_ < _loc19_)
               {
                  ...
                  _loc7_.m_angularVelocity -= _loc10_ * (_loc20_.§5[§.x * _loc22_ - _loc20_.§5[§.y * _loc21_);
                  _loc7_.§#"3§.x -= _loc9_ * _loc21_;
                  _loc7_.§#"3§.y -= _loc9_ * _loc22_;
                  _loc8_.m_angularVelocity += _loc12_ * (_loc20_.§60§.x * _loc22_ - _loc20_.§60§.y * _loc21_);
                  _loc8_.§#"3§.x += _loc11_ * _loc21_;
                  _loc8_.§#"3§.y += _loc11_ * _loc22_;
                  _loc18_++;
               }
            }
            else
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         var _loc57_:Number = NaN;
         var _loc24_:int = 0;
         while(_loc24_ < this.§9F§)
         {
            _loc26_ = (_loc25_ = this.§super§[_loc24_]).§@]§;
            _loc27_ = _loc25_.§3@§;
            ...
            _loc1_ = 0;
            while(_loc1_ < _loc25_.§-o§)
            {
               _loc2_ = _loc25_.§#!V§[_loc1_];
               _loc7_ = _loc31_.x - _loc29_ * _loc2_.§60§.y - _loc30_.x + _loc28_ * _loc2_.§5[§.y;
               _loc8_ = _loc31_.y + _loc29_ * _loc2_.§60§.x - _loc30_.y - _loc28_ * _loc2_.§5[§.x;
               _loc10_ = _loc7_ * _loc38_ + _loc8_ * _loc39_;
               _loc11_ = _loc2_.§^,§ * -_loc10_;
               _loc12_ = _loc40_ * _loc2_.normalImpulse;
               _loc14_ = (_loc11_ = (_loc13_ = b2Math.§`V§(_loc2_.tangentImpulse + _loc11_,-_loc12_,_loc12_)) - _loc2_.tangentImpulse) * _loc38_;
               _loc15_ = _loc11_ * _loc39_;
               _loc30_.x -= _loc32_ * _loc14_;
               _loc30_.y -= _loc32_ * _loc15_;
               _loc28_ -= _loc33_ * (_loc2_.§5[§.x * _loc15_ - _loc2_.§5[§.y * _loc14_);
               _loc31_.x += _loc34_ * _loc14_;
               _loc31_.y += _loc34_ * _loc15_;
               _loc29_ += _loc35_ * (_loc2_.§60§.x * _loc15_ - _loc2_.§60§.y * _loc14_);
            ...
            if(_loc25_.§-o§ == 1)
            {
               ...
               _loc11_ = -_loc2_.§]!$§ * (_loc9_ - _loc2_.§-_§);
            ...
            else
            {
               ...
               _loc47_ = _loc31_.x - _loc29_ * _loc43_.§60§.y - _loc30_.x + _loc28_ * _loc43_.§5[§.y;
               _loc48_ = _loc31_.y + _loc29_ * _loc43_.§60§.x - _loc30_.y - _loc28_ * _loc43_.§5[§.x;
               _loc49_ = _loc31_.x - _loc29_ * _loc44_.§60§.y - _loc30_.x + _loc28_ * _loc44_.§5[§.y;
               _loc50_ = _loc31_.y + _loc29_ * _loc44_.§60§.x - _loc30_.y - _loc28_ * _loc44_.§5[§.x;
               _loc51_ = _loc47_ * _loc36_ + _loc48_ * _loc37_;
               _loc52_ = _loc49_ * _loc36_ + _loc50_ * _loc37_;
               _loc53_ = _loc51_ - _loc43_.§-_§;
               _loc54_ = _loc52_ - _loc44_.§-_§;
               _loc22_ = _loc25_.§8B§;
               ...
               if(_loc56_ >= 0 && _loc57_ >= 0)
               {
                  ...
                  _loc28_ -= _loc33_ * (_loc43_.§5[§.x * _loc19_ - _loc43_.§5[§.y * _loc18_ + _loc44_.§5[§.x * _loc21_ - _loc44_.§5[§.y * _loc20_);
                  _loc31_.x += _loc34_ * (_loc18_ + _loc20_);
                  _loc31_.y += _loc34_ * (_loc19_ + _loc21_);
                  _loc29_ += _loc35_ * (_loc43_.§60§.x * _loc19_ - _loc43_.§60§.y * _loc18_ + _loc44_.§60§.x * _loc21_ - _loc44_.§60§.y * _loc20_);
               ...
               else
               {
                  ...
                  _loc57_ = 0;
                  _loc51_ = 0;
                  _loc52_ = _loc25_.§8B§.col1.y * _loc56_ + _loc54_;
                  ...
                  else
                  {
                     ...
                     _loc51_ = _loc25_.§8B§.col2.x * _loc57_ + _loc53_;
                     _loc52_ = 0;
      ...
      public function §"p§() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.§9F§)
         {
            _loc2_ = this.§super§[_loc1_];
            _loc3_ = _loc2_.§^@§;
            _loc4_ = 0;
            while(_loc4_ < _loc2_.§-o§)
            {
               _loc5_ = _loc3_.§;r§[_loc4_];
               _loc6_ = _loc2_.§#!V§[_loc4_];
               _loc5_.§=W§ = _loc6_.normalImpulse;
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         {
            _loc5_ = (_loc4_ = this.§super§[_loc3_]).§@]§;
            _loc6_ = _loc4_.§3@§;
            _loc7_ = _loc5_.§<"8§ * _loc5_.§4`§;
            _loc8_ = _loc5_.§<"8§ * _loc5_.§^J§;
            _loc9_ = _loc6_.§<"8§ * _loc6_.§4`§;
            _loc10_ = _loc6_.§<"8§ * _loc6_.§^J§;
            §"8§.§5$§(_loc4_);
            _loc11_ = §"8§.§2R§;
            _loc12_ = 0;
            while(_loc12_ < _loc4_.§-o§)
            {
               ...
               _loc20_ = b2Math.§`V§(param1 * (_loc15_ + b2Settings.b2_linearSlop),-b2Settings.b2_maxLinearCorrection,0);
