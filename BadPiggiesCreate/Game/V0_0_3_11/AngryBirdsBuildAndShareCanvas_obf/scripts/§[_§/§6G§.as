package §[_§
{
   ...
   public class §6G§
   {
      ...
      private function §6c§(param1:Array) : void
      {
      ...
      protected function §]N§(param1:String, param2:Array) : Boolean
      {
         ...
         try
         {
            this.§0D§[name] = this.§[A§(frameNames);
         }
         catch(e:Error)
         {
            result = false;
      ...
      private function §[A§(param1:Array) : §+!P§
      {
         var _loc3_:String = null;
         var _loc4_:§'!N§ = null;
         var _loc2_:§+!P§ = new §+!P§();
      ...
      protected function §^`§(param1:String, param2:Array) : void
      {
         ...
         var _loc3_:§6!M§ = new §6!M§();
         for each(_loc4_ in param2)
         {
            _loc5_ = _loc4_[0];
            _loc6_ = _loc4_[1];
            _loc3_.§]N§(_loc5_,this.§[A§(_loc6_));
         }
         this.§0D§[param1] = _loc3_;
      }
      
      public function §5m§(param1:String) : §+!P§
      {
