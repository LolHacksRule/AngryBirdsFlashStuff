package §]d§
{
   ...
   public class §1O§
   {
      ...
      public function §1O§(param1:*)
      {
         super();
         this.§9"9§ = this.§'P§(param1);
      }
      ...
      private function §'P§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§8!0§(param1 as String);
         }
         if(param1 is Number)
         {
         ...
         if(param1 is Array)
         {
            return this.§3!S§(param1 as Array);
         }
      ...
      private function §8!0§(param1:String) : String
      {
      ...
      private function §3!S§(param1:Array) : String
      {
         var _loc2_:* = "";
         var _loc3_:int = 0;
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§'P§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §1"4§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§8!0§(v.@name.toString()) + ":" + this.§'P§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
