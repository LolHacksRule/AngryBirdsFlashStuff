package §0",§
{
   ...
   public class §2w§ extends Sprite
   {
      ...
      public function §2w§(param1:§,"5§, param2:§,"5§)
      {
         super();
         this.§2!b§ = param1;
         this.§?!L§ = param2;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         var _loc2_:Point = this.§2!b§.position;
         var _loc3_:Point = this.§?!L§.position;
         ...
         _loc6_.normalize(§+@§ * 2);
         var _loc8_:Point;
         (_loc8_ = _loc3_.subtract(_loc2_.add(_loc6_))).normalize(§@!Q§);
         var _loc9_:Point = _loc3_.subtract(_loc8_);
         (_loc6_ = new Point(-_loc8_.y,_loc8_.x)).normalize(§@!Q§ / 2);
