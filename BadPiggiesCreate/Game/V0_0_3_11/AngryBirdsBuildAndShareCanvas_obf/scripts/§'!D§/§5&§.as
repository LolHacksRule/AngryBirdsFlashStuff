package §'!D§
{
   ...
   public class §5&§ extends §?!i§ implements §[!2§
   {
      ...
      public function §5&§(param1:Array, param2:§7'§, param3:Number)
      {
         var _loc4_:uint = 0;
         var _loc5_:uint = 0;
         var _loc6_:§!!W§ = null;
         ...
         if(_loc4_ > 0)
         {
            ...
            if(_loc4_ > 1)
            {
               ...
               §['§ = this.§9!U§.duration > §['§ ? Number(this.§9!U§.duration) : Number(§['§);
               if(_loc4_ > 2)
               {
                  ...
                  if(_loc4_ > 3)
                  {
                     ...
                     §['§ = this.§4!s§.duration > §['§ ? Number(this.§4!s§.duration) : Number(§['§);
                     if(_loc4_ > 4)
                     {
