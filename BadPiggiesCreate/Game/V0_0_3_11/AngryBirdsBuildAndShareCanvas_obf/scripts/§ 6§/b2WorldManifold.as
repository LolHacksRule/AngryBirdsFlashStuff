package § 6§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §5$§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§7!S§)
         {
            case b2Manifold.§9T§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§2R§.x = _loc19_ / _loc26_;
                  this.§2R§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§2R§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§2R§.x;
               _loc23_ = _loc16_ + param3 * this.§2R§.y;
               _loc24_ = _loc17_ - param5 * this.§2R§.x;
               _loc25_ = _loc18_ - param5 * this.§2R§.y;
