package § 6§
{
   ...
   public class b2Collision
   {
      ...
      private static var §`!O§:Vector.<§5!V§> = §9!W§();
      
      private static var s_clipPoints1:Vector.<§5!V§> = §9!W§();
      
      private static var s_clipPoints2:Vector.<§5!V§> = §9!W§();
      
      private static var §9""§:Vector.<int> = new Vector.<int>(1);
      
      private static var §2!Z§:Vector.<int> = new Vector.<int>(1);
      
      private static var §13§:b2Vec2 = new b2Vec2();
      
      private static var §1!p§:b2Vec2 = new b2Vec2();
      
      private static var §>!&§:b2Vec2 = new b2Vec2();
      
      private static var §use §:b2Vec2 = new b2Vec2();
      
      private static var §4v§:b2Vec2 = new b2Vec2();
      ...
      public static function §2;§(param1:Vector.<§5!V§>, param2:Vector.<§5!V§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§5!V§ = null;
         var _loc6_:int = 0;
      ...
      public static function §3!L§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         var _loc11_:b2Mat22 = null;
         var _loc12_:b2Vec2 = null;
         var _loc25_:Number = NaN;
         var _loc6_:int = param1.§]n§;
         var _loc7_:Vector.<b2Vec2> = param1.§[Q§;
         var _loc8_:Vector.<b2Vec2> = param1.§5!_§;
         var _loc9_:int = param4.§]n§;
         var _loc10_:Vector.<b2Vec2> = param4.§[Q§;
         _loc11_ = param2.R;
      ...
      public static function §"Q§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.§]n§;
         var _loc7_:Vector.<b2Vec2> = param2.§5!_§;
         _loc9_ = param5.R;
         _loc8_ = param4.§%9§;
         ...
         var _loc17_:Number = §3!L§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §3!L§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §3!L§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §3!L§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §<"$§(param1:Vector.<§5!V§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§5!V§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§]n§;
         var _loc8_:Vector.<b2Vec2> = param2.§5!_§;
         var _loc9_:int = param5.§]n§;
         var _loc10_:Vector.<b2Vec2> = param5.§[Q§;
         var _loc11_:Vector.<b2Vec2> = param5.§5!_§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§-"7§.§+!a§ = param4;
         _loc20_.id.§-"7§.§'!i§ = _loc21_;
         _loc20_.id.§-"7§.§4&§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§-"7§.§+!a§ = param4;
         _loc20_.id.§-"7§.§'!i§ = _loc22_;
         _loc20_.id.§-"7§.§4&§ = 1;
      }
      
      private static function §9!W§() : Vector.<§5!V§>
      {
         var _loc1_:Vector.<§5!V§> = new Vector.<§5!V§>(2);
         _loc1_[0] = new §5!V§();
         _loc1_[1] = new §5!V§();
         return _loc1_;
      }
      
      public static function §'!5§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         var _loc6_:§5!V§ = null;
         ...
         var _loc8_:int = 0;
         §9""§[0] = _loc8_;
         var _loc9_:Number = §"Q§(§9""§,param2,param3,param4,param5);
         _loc8_ = §9""§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §2!Z§[0] = _loc10_;
         var _loc11_:Number = §"Q§(§2!Z§,param4,param5,param2,param3);
         _loc10_ = §2!Z§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§7!S§ = b2Manifold.§%q§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§5!V§> = §`!O§;
         §<"$§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§]n§;
         var _loc23_:Vector.<b2Vec2>;
         var _loc24_:b2Vec2 = (_loc23_ = _loc12_.§[Q§)[_loc16_];
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §13§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §1!p§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §>!&§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §4v§;
         _loc20_ = _loc14_.R;
         ...
         var _loc37_:Vector.<§5!V§> = s_clipPoints1;
         var _loc38_:Vector.<§5!V§> = s_clipPoints2;
         if((_loc39_ = §2;§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §2;§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§2F§.SetV(_loc27_);
      ...
      public static function §0!+§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§7!S§ = b2Manifold.§9T§;
         param1.m_localPoint.SetV(param2.§;!+§);
         param1.§2F§.§>!!§();
         param1.§7i§ = 1;
         param1.§;r§[0].m_localPoint.SetV(param4.§;!+§);
         param1.§;r§[0].m_id.key = 0;
      }
      ...
      public static function §5"$§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc21_:int = param2.§]n§;
         var _loc22_:Vector.<b2Vec2> = param2.§[Q§;
         var _loc23_:Vector.<b2Vec2> = param2.§5!_§;
         var _loc24_:int = 0;
         ...
         if(_loc19_ < Number.MIN_VALUE)
         {
            param1.§7i§ = 1;
            param1.§7!S§ = b2Manifold.§%q§;
            param1.§2F§.SetV(_loc23_[_loc18_]);
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§7i§ = 1;
            param1.§7!S§ = b2Manifold.§%q§;
            param1.§2F§.x = _loc15_ - _loc27_.x;
            param1.§2F§.y = _loc16_ - _loc27_.y;
            param1.§2F§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§7i§ = 1;
            param1.§7!S§ = b2Manifold.§%q§;
            param1.§2F§.x = _loc15_ - _loc28_.x;
            param1.§2F§.y = _loc16_ - _loc28_.y;
            param1.§2F§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§;r§[0].m_localPoint.SetV(param4.§;!+§);
            param1.§;r§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§7i§ = 1;
            param1.§7!S§ = b2Manifold.§%q§;
            param1.§2F§.x = _loc23_[_loc25_].x;
            param1.§2F§.y = _loc23_[_loc25_].y;
            param1.§2F§.Normalize();
      ...
      public static function §&!P§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§2g§;
         var _loc4_:b2Vec2 = param1.§3!P§;
