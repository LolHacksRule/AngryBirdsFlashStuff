package § 6§
{
   ...
   public class b2DynamicTree
   {
      ...
      private var §,J§:b2DynamicTreeNode;
      ...
      public function §8!9§(param1:b2AABB, param2:*) : b2DynamicTreeNode
      {
         ...
         _loc3_.aabb.§2g§.x = param1.§2g§.x - _loc4_;
         _loc3_.aabb.§2g§.y = param1.§2g§.y - _loc5_;
         _loc3_.aabb.§3!P§.x = param1.§3!P§.x + _loc4_;
         _loc3_.aabb.§3!P§.y = param1.§3!P§.y + _loc5_;
         _loc3_.§'!3§ = param2;
         this.§ !]§(_loc3_);
         return _loc3_;
      }
      ...
      public function §%"7§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         ...
         param1.aabb.§2g§.x = param2.§2g§.x - _loc4_;
         param1.aabb.§2g§.y = param2.§2g§.y - _loc5_;
         param1.aabb.§3!P§.x = param2.§3!P§.x + _loc4_;
         param1.aabb.§3!P§.y = param2.§3!P§.y + _loc5_;
         this.§ !]§(param1);
         return true;
      }
      ...
      public function §>!Q§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            ...
            {
               _loc3_ = !!(this.§8e§ >> _loc4_ & 1) ? _loc3_.child2 : _loc3_.child1;
               _loc4_ = _loc4_ + 1 & 31;
            }
            ++this.§8e§;
            this.§+! §(_loc3_);
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         _loc9_.§2g§.x = Math.min(_loc3_.x,_loc10_);
         _loc9_.§2g§.y = Math.min(_loc3_.y,_loc11_);
         _loc9_.§3!P§.x = Math.max(_loc3_.x,_loc10_);
         _loc9_.§3!P§.y = Math.max(_loc3_.y,_loc11_);
         var _loc12_:Vector.<b2DynamicTreeNode> = new Vector.<b2DynamicTreeNode>();
         var _loc13_:int = 0;
         var _loc19_:*;
         _loc12_[_loc19_ = _loc13_++] = this.§>b§;
         while(_loc13_ > 0)
         {
      ...
      private function §8J§() : b2DynamicTreeNode
      {
         var _loc1_:b2DynamicTreeNode = null;
         if(this.§,J§)
         {
            _loc1_ = this.§,J§;
            this.§,J§ = _loc1_.parent;
            _loc1_.parent = null;
            _loc1_.child1 = null;
            _loc1_.child2 = null;
            return _loc1_;
      ...
      private function § !]§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_.§@A§() == false)
         {
            do
            {
               ...
               _loc8_ = Math.abs((_loc6_.aabb.§2g§.x + _loc6_.aabb.§3!P§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§2g§.y + _loc6_.aabb.§3!P§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§2g§.x + _loc7_.aabb.§3!P§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§2g§.y + _loc7_.aabb.§3!P§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
