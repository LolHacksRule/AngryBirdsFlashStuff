package §9H§
{
   ...
   public class § y§ extends §%!O§
   {
      ...
      public static const §4!n§:Array = ["x","y","z","scaleX","scaleY","scaleZ","rotation","rotationX","rotationY","rotationZ","alpha","width","height","_bevelFilter","_blurFilter","_colorMatrixFilter","_convolutionFilter","_displacementMapFilter","_dropShadowFilter","_glowFilter","_gradientBevelFilter","_gradientGlowFilter","_shaderFilter"];
      ...
      protected var §&J§:DisplayObject = null;
      
      protected var §,H§:DisplayObjectParameter;
      
      public function § y§()
      {
         this.§,H§ = new DisplayObjectParameter();
      ...
      override public function setObject(param1:String, param2:Object) : void
      {
         ...
         {
            this.§8!k§(param2 as BitmapFilter,BlurFilter);
            return;
         }
         if(param1 == "_glowFilter")
         {
            this.§8!k§(param2 as BitmapFilter,GlowFilter);
            return;
         }
         if(param1 == "_dropShadowFilter")
         {
            this.§8!k§(param2 as BitmapFilter,DropShadowFilter);
            return;
         }
         if(param1 == "_colorMatrixFilter")
         {
            this.§8!k§(param2 as BitmapFilter,ColorMatrixFilter);
            return;
         }
         if(param1 == "_bevelFilter")
         {
            this.§8!k§(param2 as BitmapFilter,BevelFilter);
            return;
         }
         if(param1 == "_gradientGlowFilter")
         {
            this.§8!k§(param2 as BitmapFilter,GradientGlowFilter);
            return;
         }
         if(param1 == "_gradientBevelFilter")
         {
            this.§8!k§(param2 as BitmapFilter,GradientBevelFilter);
            return;
         }
         if(param1 == "_convolutionFilter")
         {
            this.§8!k§(param2 as BitmapFilter,ConvolutionFilter);
            return;
         }
         if(param1 == "_displacementMapFilter")
         {
            this.§8!k§(param2 as BitmapFilter,DisplacementMapFilter);
            return;
         }
         if(param1 == "_shaderFilter")
         {
            this.§8!k§(param2 as BitmapFilter,ShaderFilter);
            return;
         }
      }
      ...
      protected function §8!k§(param1:BitmapFilter, param2:Class) : void
      {
         var _loc3_:Array = this.§&J§.filters;
      ...
      override public function setSourceValue(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         {
            this._flags |= 2;
            this.§,H§.relativeFlags |= !!param3 ? 2 : 0;
            this.§,H§.y = param2;
         }
         else if(param1 == "z")
         {
            this._flags |= 4;
            this.§,H§.relativeFlags |= !!param3 ? 4 : 0;
            this.§,H§.z = param2;
         }
         else if(param1 == "scaleX")
         {
            this._flags |= 8;
            this.§,H§.relativeFlags |= !!param3 ? 8 : 0;
            this.§,H§.scaleX = param2;
         }
         else if(param1 == "scaleY")
         {
            this._flags |= 16;
            this.§,H§.relativeFlags |= !!param3 ? 16 : 0;
            this.§,H§.scaleY = param2;
         }
         else if(param1 == "scaleZ")
         {
            this._flags |= 32;
            this.§,H§.relativeFlags |= !!param3 ? 32 : 0;
            this.§,H§.scaleZ = param2;
         }
         else if(param1 == "rotation")
         {
            this._flags |= 64;
            this.§,H§.relativeFlags |= !!param3 ? 64 : 0;
            this.§,H§.rotation = param2;
         }
         else if(param1 == "rotationX")
         {
            this._flags |= 128;
            this.§,H§.relativeFlags |= !!param3 ? 128 : 0;
            this.§,H§.rotationX = param2;
         }
         else if(param1 == "rotationY")
         {
            this._flags |= 256;
            this.§,H§.relativeFlags |= !!param3 ? 256 : 0;
            this.§,H§.rotationY = param2;
         }
         else if(param1 == "rotationZ")
         {
            this._flags |= 512;
            this.§,H§.relativeFlags |= !!param3 ? 512 : 0;
            this.§,H§.rotationZ = param2;
         }
         else if(param1 == "alpha")
         {
            this._flags |= 1024;
            this.§,H§.relativeFlags |= !!param3 ? 1024 : 0;
            this.§,H§.alpha = param2;
         }
         else if(param1 == "width")
         {
            this._flags |= 2048;
            this.§,H§.relativeFlags |= !!param3 ? 2048 : 0;
            this.§,H§.width = param2;
         }
         else if(param1 == "height")
         {
            this._flags |= 4096;
            this.§,H§.relativeFlags |= !!param3 ? 4096 : 0;
            this.§,H§.height = param2;
         }
      }
      ...
      override protected function updateObject(param1:Number) : void
      {
         ...
         var _loc4_:DisplayObjectParameter = this.§,H§;
      ...
      {
         this.§&J§ = param1 as DisplayObject;
      }
      
      override protected function resolveValues() : void
      {
         var _loc1_:DisplayObject = this.§&J§;
         var _loc2_:DisplayObjectParameter = this.§`"%§;
         var _loc3_:DisplayObjectParameter = this.§,H§;
         var _loc4_:uint;
