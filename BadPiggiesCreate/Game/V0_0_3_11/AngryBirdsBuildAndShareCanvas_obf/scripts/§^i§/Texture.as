package §^i§
{
   ...
   public class Texture
   {
      ...
      public static function §9!m§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §^i§.Texture
      {
         return §0"-§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §0"-§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §^i§.Texture
      {
         ...
         _loc10_ = new §?3§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§!!l§.§2!-§)
         {
            _loc10_.§%§(param2);
         }
         ...
         return new §@d§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §"C§(param1:Context3D, param2:ByteArray) : §^i§.Texture
      {
         if(param1 == null)
         {
            throw new §3_§();
         ...
         var _loc9_:§?3§ = new §?3§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§!!l§.§2!-§)
         {
            _loc9_.§%§(param2);
         }
      ...
      public static function §?"7§(param1:§^i§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §^i§.Texture
      {
         var _loc4_:§^i§.Texture;
         (_loc4_ = new §@d§(param1,param2)).§[!m§ = param3;
         return _loc4_;
      }
      
      public static function empty(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §^i§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§^i§.Texture = §0"-§(param1,_loc6_,false,param5);
         if(!§!!l§.§2!-§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§+r§, param2:int, param3:int) : void
      {
         ...
         if(this.§[!m§)
         {
            ...
            param1.§]^§(param2,-this.§[!m§.x,-this.§[!m§.y);
            param1.§]^§(param2 + 1,-_loc4_,-this.§[!m§.y);
            param1.§]^§(param2 + 2,-this.§[!m§.x,-_loc5_);
      ...
      public function get root() : §^i§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §^i§.Texture
      {
         return this;
      }
