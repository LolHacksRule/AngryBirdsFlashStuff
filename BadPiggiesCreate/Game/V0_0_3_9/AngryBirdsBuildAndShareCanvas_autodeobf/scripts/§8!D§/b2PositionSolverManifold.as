package §8!D§
{
   ...
   class b2PositionSolverManifold
   {
      ...
      function b2PositionSolverManifold()
      {
         ...
         this.§3J§ = new Vector.<b2Vec2>(b2Settings.b2_maxManifoldPoints);
         var _loc1_:int = 0;
         while(_loc1_ < b2Settings.b2_maxManifoldPoints)
         {
            this.§3J§[_loc1_] = new b2Vec2();
            _loc1_++;
         }
      }
      ...
      public function §+"'§(param1:b2ContactConstraint) : void
      {
         ...
         {
            case b2Manifold.§@B§:
               _loc5_ = param1.§<!S§.m_xf.R;
               _loc6_ = param1.localPoint;
               _loc9_ = param1.§<!S§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc10_ = param1.§<!S§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               ...
               this.§3J§[0].x = 0.5 * (_loc9_ + _loc11_);
               this.§3J§[0].y = 0.5 * (_loc10_ + _loc12_);
               this.§6-§[0] = _loc13_ * this.§<!"§.x + _loc14_ * this.§<!"§.y - param1.radius;
               break;
            case b2Manifold.§8!#§:
               _loc5_ = param1.§<!S§.m_xf.R;
               _loc6_ = param1.§#6§;
               ...
               _loc5_ = param1.§<!S§.m_xf.R;
               _loc6_ = param1.localPoint;
               _loc7_ = param1.§<!S§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
               _loc8_ = param1.§<!S§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
               _loc5_ = param1.§=Y§.m_xf.R;
               _loc2_ = 0;
               while(_loc2_ < param1.§0"%§)
               {
                  ...
                  this.§6-§[_loc2_] = (_loc3_ - _loc7_) * this.§<!"§.x + (_loc4_ - _loc8_) * this.§<!"§.y - param1.radius;
                  this.§3J§[_loc2_].x = _loc3_;
                  this.§3J§[_loc2_].y = _loc4_;
                  _loc2_++;
               }
               break;
            case b2Manifold.§6^§:
               ...
               {
                  _loc6_ = param1.§^!o§[_loc2_].localPoint;
                  _loc3_ = param1.§<!S§.m_xf.position.x + (_loc5_.col1.x * _loc6_.x + _loc5_.col2.x * _loc6_.y);
                  _loc4_ = param1.§<!S§.m_xf.position.y + (_loc5_.col1.y * _loc6_.x + _loc5_.col2.y * _loc6_.y);
                  this.§6-§[_loc2_] = (_loc3_ - _loc7_) * this.§<!"§.x + (_loc4_ - _loc8_) * this.§<!"§.y - param1.radius;
                  this.§3J§[_loc2_].Set(_loc3_,_loc4_);
                  _loc2_++;
               }
               this.§<!"§.x *= -1;
               this.§<!"§.y *= -1;
