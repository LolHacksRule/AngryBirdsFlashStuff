package §]!]§
{
   ...
   public class §9J§ extends Sprite
   {
      
      private static const §%8§:int = 20;
      
      private static const §3!m§:int = 20;
      ...
      public function §9J§(param1:§<!z§, param2:§<!z§)
      {
         super();
         this.§3P§ = param1;
         this.§2!E§ = param2;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         var _loc2_:Point = this.§3P§.position;
         var _loc3_:Point = this.§2!E§.position;
         ...
         _loc6_.normalize(§;!^§ * 2);
         var _loc8_:Point;
         (_loc8_ = _loc3_.subtract(_loc2_.add(_loc6_))).normalize(§3!m§);
         var _loc9_:Point = _loc3_.subtract(_loc8_);
         (_loc6_ = new Point(-_loc8_.y,_loc8_.x)).normalize(§3!m§ / 2);
         ...
         §3!T§.§&v§(_loc11_,§3!T§.§2K§.bitmapData);
