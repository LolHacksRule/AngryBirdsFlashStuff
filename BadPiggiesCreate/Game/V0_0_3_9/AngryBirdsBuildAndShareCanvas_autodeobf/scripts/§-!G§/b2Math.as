package §-!G§
{
   public class b2Math
   {
      ...
      public static const b2Mat22_identity:b2Mat22 = b2Mat22.§4c§(new b2Vec2(1,0),new b2Vec2(0,1));
      ...
      public static function §3!Q§(param1:Number) : Boolean
      {
         return isFinite(param1);
      }
      
      public static function §3M§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §22§(param1:b2Vec2, param2:Number) : b2Vec2
      {
         return new b2Vec2(param2 * param1.y,-param2 * param1.x);
      }
      
      public static function §9!B§(param1:Number, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(-param1 * param2.y,param1 * param2.x);
      }
      
      public static function §6B§(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
      ...
      {
         return new b2Vec2(§3M§(param2,param1.col1),§3M§(param2,param1.col2));
      }
      
      public static function §'H§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
         _loc3_ = §6B§(param1.R,param2);
         _loc3_.x += param1.position.x;
         _loc3_.y += param1.position.y;
         return _loc3_;
      }
      
      public static function §0!=§(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = null;
      ...
      public static function §8!V§(param1:b2Vec2, param2:b2Vec2) : Number
      {
         var _loc3_:Number = param1.x - param2.x;
         var _loc4_:Number = param1.y - param2.y;
      ...
      public static function §>r§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§4c§(§=!S§(param1.col1,param2.col1),§=!S§(param1.col2,param2.col2));
      }
      
      public static function §7!C§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         return b2Mat22.§4c§(§6B§(param1,param2.col1),§6B§(param1,param2.col2));
      }
      
      public static function §%!S§(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Vec2 = new b2Vec2(§3M§(param1.col1,param2.col1),§3M§(param1.col2,param2.col1));
         var _loc4_:b2Vec2 = new b2Vec2(§3M§(param1.col1,param2.col2),§3M§(param1.col2,param2.col2));
         return b2Mat22.§4c§(_loc3_,_loc4_);
      }
      ...
      public static function §9a§(param1:b2Vec2) : b2Vec2
      {
      ...
      {
         return b2Mat22.§4c§(§9a§(param1.col1),§9a§(param1.col2));
      }
      ...
      public static function §2!a§(param1:b2Vec2, param2:b2Vec2) : b2Vec2
      {
         return new b2Vec2(§;]§(param1.x,param2.x),§;]§(param1.y,param2.y));
      }
      
      public static function §<C§(param1:Number, param2:Number, param3:Number) : Number
      {
      ...
      {
         return §2!a§(param2,§<m§(param1,param3));
      }
      ...
      public static function §3!z§(param1:Number, param2:Number) : Number
      {
         var _loc3_:Number = Math.random();
         return Number((param2 - param1) * _loc3_ + param1);
      }
      
      public static function §62§(param1:uint) : uint
      {
      ...
      public static function §2!b§(param1:uint) : Boolean
      {
