      ...
      protected function §!C§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§=-§(_loc7_,_loc6_)]) == null)
            {
               ...
               {
                  _loc10_ = new §3!§(0,0,_loc11_,_loc12_,_loc13_,_loc14_);
               }
            }
            if(_loc10_)
            {
               ...
               _loc16_.§8!G§ = _loc15_;
               _loc16_.§6o§ = _loc10_.pivotX;
               _loc16_.§["2§ = _loc10_.pivotY;
               _loc16_.§,!d§ = §[!`§;
               §>""§(_loc16_);
            }
         }
         ...
         for each(_loc3_ in param1)
         {
            ...
            for each(_loc6_ in _loc5_)
            {
               ...
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §3!§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
