package §0Q§
{
   ...
   public class §6w§ extends Sprite
   {
      ...
      public function §6w§(param1:int, param2:int, param3:Number, param4:Number, param5:int, param6:int = 40)
      {
         var _loc9_:§,<§ = null;
         ...
         this.§3W§ = param1;
         this.§&! § = param2;
         var _loc7_:Number = Math.min(§%s§.§-=§,§%s§.§,!=§);
         var _loc8_:Number = Math.max(§%s§.§-=§,§%s§.§,!=§);
         param3 /= §%s§.§,!=§;
         param4 /= §%s§.§-=§;
         this.§?R§ = param5;
