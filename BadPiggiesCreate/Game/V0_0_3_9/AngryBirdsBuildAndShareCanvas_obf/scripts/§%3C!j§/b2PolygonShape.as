package §<!j§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      public function b2PolygonShape()
      {
         ...
         §7!1§ = b2Settings.b2_polygonRadius;
         this.§["-§.§7!@§();
      }
      ...
      public static function §]5§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
      ...
      public static function §^"+§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc16_ = 0.5 * _loc15_;
            _loc4_ += _loc16_;
            _loc3_.§,!m§(new b2Vec2(0,0));
            _loc3_.§,!m§(_loc9_);
            _loc3_.§,!m§(_loc10_);
            _loc3_.§'!V§(_loc16_ * 0.3333333333333333);
            _loc8_++;
         }
         _loc3_.x *= 1 / _loc4_;
         _loc3_.y *= 1 / _loc4_;
      ...
      public function §>!x§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§7K§ ? int(_loc3_ + 1) : 0;
            _loc6_ = b2Math.§?[§(this.§;W§[_loc5_],this.§;W§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§7" §() > Number.MIN_VALUE);
            this.§;T§[_loc3_].SetV(b2Math.§22§(_loc6_,1));
      ...
      public function §;!i§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         ...
         _loc5_.R.Set(param4);
         var _loc6_:int = 0;
         while(_loc6_ < this.§7K§)
         {
            this.§;W§[_loc6_] = b2Math.§'H§(_loc5_,this.§;W§[_loc6_]);
            this.§;T§[_loc6_] = b2Math.§6B§(_loc5_.R,this.§;T§[_loc6_]);
            _loc6_++;
         }
      }
      
      public function §46§(param1:b2Vec2, param2:b2Vec2) : void
      {
         this.§7K§ = 2;
         this.§[I§(2);
         ...
         this.§;T§[0] = b2Math.§22§(b2Math.§?[§(param2,param1),1);
         this.§;T§[0].Normalize();
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc16_:int = -1;
         var _loc17_:int = 0;
         while(_loc17_ < this.§7K§)
         {
            _loc6_ = (_loc9_ = this.§;W§[_loc17_]).x - _loc10_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§+!&§.x = _loc5_ - b2internal::7!1;
         param1.§+!&§.y = _loc6_ - b2internal::7!1;
         param1.§;l§.x = _loc7_ + b2internal::7!1;
         param1.§;l§.y = _loc8_ + b2internal::7!1;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§7K§ == 2)
         {
            param1.center.x = 0.5 * (this.§;W§[0].x + this.§;W§[1].x);
            param1.center.y = 0.5 * (this.§;W§[0].y + this.§;W§[1].y);
            param1.§6%§ = 0;
            param1.I = 0;
            return;
         }
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.§7K§)
         {
            _loc11_ = this.§;W§[_loc10_];
            _loc12_ = _loc10_ + 1 < this.§7K§ ? this.§;W§[int(_loc10_ + 1)] : this.§;W§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:Number = param2 - b2Math.§3M§(param1,param3.position);
         ...
         _loc12_ = 0;
         while(_loc12_ < this.§7K§)
         {
            _loc7_[_loc12_] = b2Math.§3M§(_loc5_,this.§;W§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§'H§(param3,_loc24_.center));
                  return _loc24_.§6%§;
               }
               return 0;
               break;
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§7K§;
         var _loc14_:int = (_loc10_ + 1) % this.§7K§;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§;W§[_loc9_].x * (1 - _loc15_) + this.§;W§[_loc13_].x * _loc15_,this.§;W§[_loc9_].y * (1 - _loc15_) + this.§;W§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§;W§[_loc10_].x * (1 - _loc16_) + this.§;W§[_loc14_].x * _loc16_,this.§;W§[_loc10_].y * (1 - _loc16_) + this.§;W§[_loc14_].y * _loc16_);
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§7K§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
         ...
         _loc20_.§'!V§(1 / _loc19_);
         param4.SetV(b2Math.§'H§(param3,_loc20_));
         return _loc19_;
      }
