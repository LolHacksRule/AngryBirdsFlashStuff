package §<!j§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§-X§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§!!r§ = this.§-X§.Normalize();
         this.§<!"§.Set(this.§-X§.y,-this.§-X§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§<!"§.x - this.§-X§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§<!"§.y - this.§-X§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§<!"§.x + this.§-X§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§<!"§.y + this.§-X§.y) + this.m_v2.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         if((_loc12_ = -(_loc5_ * _loc9_ + _loc6_ * _loc10_)) > _loc11_)
         {
            ...
            if(0 <= _loc15_ && _loc15_ <= param2.§6!O§ * _loc12_)
            {
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§'H§(param3,this.m_v1);
         var _loc7_:b2Vec2 = b2Math.§'H§(param3,this.m_v2);
         var _loc8_:Number = b2Math.§3M§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§3M§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      b2internal function §9D§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§+"0§ = param1;
      ...
      b2internal function §4!i§(param1:b2EdgeShape, param2:b2Vec2, param3:b2Vec2, param4:Boolean) : void
      {
         this.§3!<§ = param1;
