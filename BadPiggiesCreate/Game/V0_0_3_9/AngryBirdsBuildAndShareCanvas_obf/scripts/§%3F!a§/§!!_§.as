package §?!a§
{
   ...
   public class §!!_§
   {
      ...
      public function §!!_§(param1:*)
      {
         super();
         this.§3"%§ = this.§+!m§(param1);
      }
      ...
      private function §+!m§(param1:*) : String
      {
         ...
         if(param1 is String)
         {
            return this.§>!p§(param1 as String);
         }
         if(param1 is Number)
         {
         ...
         if(param1 is Array)
         {
            return this.§9`§(param1 as Array);
         }
         if(param1 is Object && param1 != null)
         {
            return this.§6!b§(param1);
         }
         return "null";
      }
      
      private function §>!p§(param1:String) : String
      {
      ...
      private function §9`§(param1:Array) : String
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            _loc2_ += this.§+!m§(param1[_loc3_]);
            _loc3_++;
         }
         return "[" + _loc2_ + "]";
      }
      
      private function §6!b§(param1:Object) : String
      {
         ...
         else
         {
            for each(v in classInfo..§*§.(name() == "variable" || name() == "accessor" && attribute("access").charAt(0) == "r"))
            {
               if(!(v.metadata && v.metadata.(@name == "Transient").length() > 0))
               {
                  ...
                  s += this.§>!p§(v.@name.toString()) + ":" + this.§+!m§(o[v.@name]);
               }
            }
         }
         return "{" + s + "}";
