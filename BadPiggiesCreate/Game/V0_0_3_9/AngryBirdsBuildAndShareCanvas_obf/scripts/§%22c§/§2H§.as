package §"c§
{
   ...
   public class §2H§ extends §?t§ implements §5",§
   {
      ...
      public function §2H§(param1:Array, param2:§ E§, param3:Number)
      {
         var _loc4_:uint = 0;
         var _loc5_:uint = 0;
         var _loc6_:§,!B§ = null;
         ...
         if(_loc4_ > 0)
         {
            ...
            §4!1§ = this.§5z§.duration > §4!1§ ? Number(this.§5z§.duration) : Number(§4!1§);
            if(_loc4_ > 1)
            {
               this.§3t§ = param1[1] as §,!B§;
               §4!1§ = this.§3t§.duration > §4!1§ ? Number(this.§3t§.duration) : Number(§4!1§);
               if(_loc4_ > 2)
               {
                  this.§^",§ = param1[2] as §,!B§;
                  §4!1§ = this.§^",§.duration > §4!1§ ? Number(this.§^",§.duration) : Number(§4!1§);
                  if(_loc4_ > 3)
                  {
                     this.§?b§ = param1[3] as §,!B§;
                     §4!1§ = this.§?b§.duration > §4!1§ ? Number(this.§?b§.duration) : Number(§4!1§);
                     if(_loc4_ > 4)
                     {
                        ...
                        while(_loc5_ < _loc4_)
                        {
                           ...
                           §4!1§ = _loc6_.duration > §4!1§ ? Number(_loc6_.duration) : Number(§4!1§);
                           _loc5_++;
                        }
                     }
                  }
