package §8!k§
{
   ...
   public class b2LineJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§8!u§.x * this.§9j§.x + (this.§1!O§ + this.§8!u§.y) * this.§?"5§.x),param1 * (this.§8!u§.x * this.§9j§.y + (this.§1!O§ + this.§8!u§.y) * this.§?"5§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         this.§ t§ = this.§ t§ > Number.MIN_VALUE ? Number(1 / this.§ t§) : Number(0);
         ...
         this.§4!#§.col1.y = _loc16_ * this.m_s1 * this.m_a1 + _loc17_ * this.m_s2 * this.m_a2;
         this.§4!#§.col2.x = this.§4!#§.col1.y;
         this.§4!#§.col2.y = _loc14_ + _loc15_ + _loc16_ * this.m_a1 * this.m_a1 + _loc17_ * this.m_a2 * this.m_a2;
         if(this.§&p§)
         {
         ...
         if(param1.§2!z§)
         {
            ...
            this.§8!u§.y *= param1.§>!i§;
            this.§1!O§ *= param1.§>!i§;
            _loc19_ = this.§8!u§.x * this.§9j§.x + (this.§1!O§ + this.§8!u§.y) * this.§?"5§.x;
            _loc20_ = this.§8!u§.x * this.§9j§.y + (this.§1!O§ + this.§8!u§.y) * this.§?"5§.y;
            _loc21_ = this.§8!u§.x * this.m_s1 + (this.§1!O§ + this.§8!u§.y) * this.m_a1;
            _loc22_ = this.§8!u§.x * this.m_s2 + (this.§1!O§ + this.§8!u§.y) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         {
            _loc13_ = this.§?"5§.x * (_loc6_.x - _loc4_.x) + this.§?"5§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc14_ = this.§ t§ * (this.§[$§ - _loc13_);
            _loc15_ = this.§1!O§;
            _loc16_ = param1.§@w§ * this.§=!q§;
            this.§1!O§ = b2Math.§<C§(this.§1!O§ + _loc14_,-_loc16_,_loc16_);
            _loc8_ = (_loc14_ = this.§1!O§ - _loc15_) * this.§?"5§.x;
            _loc9_ = _loc14_ * this.§?"5§.y;
         ...
         {
            _loc17_ = this.§?"5§.x * (_loc6_.x - _loc4_.x) + this.§?"5§.y * (_loc6_.y - _loc4_.y) + this.m_a2 * _loc7_ - this.m_a1 * _loc5_;
            _loc18_ = this.§8!u§.Copy();
            _loc19_ = this.§4!#§.§`"7§(new b2Vec2(),-_loc12_,-_loc17_);
            this.§8!u§.§,!m§(_loc19_);
            if(this.§"!7§ == b2internal::-!B)
            {
               this.§8!u§.y = b2Math.§;]§(this.§8!u§.y,0);
            }
            else if(this.§"!7§ == b2internal::<2)
            {
               this.§8!u§.y = b2Math.§!"9§(this.§8!u§.y,0);
            }
            _loc20_ = -_loc12_ - (this.§8!u§.y - _loc18_.y) * this.§4!#§.col2.x;
            if(this.§4!#§.col1.x != 0)
            {
               _loc21_ = _loc20_ / this.§4!#§.col1.x + _loc18_.x;
            }
            else
            {
               _loc21_ = _loc18_.x;
            ...
            this.§8!u§.x = _loc21_;
            _loc19_.x = this.§8!u§.x - _loc18_.x;
            _loc19_.y = this.§8!u§.y - _loc18_.y;
            _loc8_ = _loc19_.x * this.§9j§.x + _loc19_.y * this.§?"5§.x;
            _loc9_ = _loc19_.x * this.§9j§.y + _loc19_.y * this.§?"5§.y;
         ...
         else
         {
            ...
            this.§8!u§.x += _loc22_;
            _loc8_ = _loc22_ * this.§9j§.x;
            _loc9_ = _loc22_ * this.§9j§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§&p§)
         {
            ...
            _loc34_ = this.§?"5§.x * _loc26_ + this.§?"5§.y * _loc27_;
            if(b2Math.§`8§(this.§,"§ - this.§;!=§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§<C§(_loc34_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§`8§(_loc34_);
               _loc18_ = true;
            }
            else if(_loc34_ <= this.§;!=§)
            {
               _loc19_ = b2Math.§<C§(_loc34_ - this.§;!=§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§;!=§ - _loc34_;
               _loc18_ = true;
            }
            else if(_loc34_ >= this.§,"§)
            {
               _loc19_ = b2Math.§<C§(_loc34_ - this.§,"§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         if(_loc18_)
         {
            ...
            this.§4!#§.col1.y = _loc14_ * this.m_s1 * this.m_a1 + _loc15_ * this.m_s2 * this.m_a2;
            this.§4!#§.col2.x = this.§4!#§.col1.y;
            this.§4!#§.col2.y = _loc12_ + _loc13_ + _loc14_ * this.m_a1 * this.m_a1 + _loc15_ * this.m_a2 * this.m_a2;
            this.§4!#§.§`"7§(_loc28_,-_loc29_,-_loc19_);
         }
         else
         {
            _loc12_ = b2internal::4!l;
         ...
         var _loc30_:Number = _loc28_.x * this.§9j§.x + _loc28_.y * this.§?"5§.x;
         var _loc31_:Number = _loc28_.x * this.§9j§.y + _loc28_.y * this.§?"5§.y;
         var _loc32_:Number = _loc28_.x * this.m_s1 + _loc28_.y * this.m_a1;
         var _loc33_:Number = _loc28_.x * this.m_s2 + _loc28_.y * this.m_a2;
         _loc6_.x -= b2internal::4!l * _loc30_;
         _loc6_.y -= b2internal::4!l * _loc31_;
         _loc7_ -= b2internal::=+ * _loc32_;
         _loc8_.x += b2internal::7!k * _loc30_;
         _loc8_.y += b2internal::7!k * _loc31_;
         _loc9_ += b2internal::;!N * _loc33_;
