package §8!k§
{
   ...
   public class b2DistanceJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * this.§8!u§ * this.§8!@§.x,param1 * this.§8!u§ * this.§8!@§.y);
      }
      ...
      public function §1r§(param1:Number) : void
      {
         this.§!!r§ = param1;
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc13_:Number = _loc4_.§@"!§ + _loc4_.§!!o§ * _loc11_ * _loc11_ + _loc5_.§@"!§ + _loc5_.§!!o§ * _loc12_ * _loc12_;
         this.§9!>§ = _loc13_ != 0 ? Number(1 / _loc13_) : Number(0);
         if(this.§<!G§ > 0)
         {
            _loc14_ = _loc10_ - this.§!!r§;
            _loc15_ = 2 * Math.PI * this.§<!G§;
            _loc16_ = 2 * this.§9!>§ * this.§,!-§ * _loc15_;
            _loc17_ = this.§9!>§ * _loc15_ * _loc15_;
            this.§8h§ = param1.§@w§ * (_loc16_ + param1.§@w§ * _loc17_);
            this.§8h§ = this.§8h§ != 0 ? Number(1 / this.§8h§) : Number(0);
            this.§[w§ = _loc14_ * param1.§@w§ * _loc17_ * this.§8h§;
            this.§9!>§ = _loc13_ + this.§8h§;
            this.§9!>§ = this.§9!>§ != 0 ? Number(1 / this.§9!>§) : Number(0);
         }
         if(param1.§2!z§)
         {
            this.§8!u§ *= param1.§>!i§;
            _loc18_ = this.§8!u§ * this.§8!@§.x;
            _loc19_ = this.§8!u§ * this.§8!@§.y;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc15_:Number = -this.§9!>§ * (_loc14_ + this.§[w§ + this.§8h§ * this.§8!u§);
         this.§8!u§ += _loc15_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         _loc10_ /= _loc12_;
         _loc11_ /= _loc12_;
         var _loc13_:Number = _loc12_ - this.§!!r§;
