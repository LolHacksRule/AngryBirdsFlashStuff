package §8Y§
{
   ...
   public class Texture
   {
      ...
      public static function §0"+§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §8Y§.Texture
      {
         return §7"$§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §7"$§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §8Y§.Texture
      {
         ...
         return new §?!N§(_loc10_,new Rectangle(0,0,_loc5_,_loc6_),true);
      }
      
      public static function §+!g§(param1:Context3D, param2:ByteArray) : §8Y§.Texture
      {
         if(param1 == null)
         {
            throw new §@!m§();
      ...
      public static function §,]§(param1:§8Y§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §8Y§.Texture
      {
         var _loc4_:§8Y§.Texture;
         (_loc4_ = new §?!N§(param1,param2)).§ !^§ = param3;
         return _loc4_;
      }
      
      public static function empty(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §8Y§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§8Y§.Texture = §7"$§(param1,_loc6_,false,param5);
         if(!§=!]§.§=t§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§7!M§, param2:int, param3:int) : void
      {
         ...
         if(this.§ !^§)
         {
            ...
            param1.§0!T§(param2,-this.§ !^§.x,-this.§ !^§.y);
            param1.§0!T§(param2 + 1,-_loc4_,-this.§ !^§.y);
            param1.§0!T§(param2 + 2,-this.§ !^§.x,-_loc5_);
            param1.§0!T§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
      ...
      public function get root() : §8Y§.Texture
      {
         return null;
      }
      ...
      public function get parent() : §8Y§.Texture
      {
         return this;
      }
