package §-!G§
{
   public class b2Vec2
   {
      ...
      {
         var _loc2_:Number = b2Math.§3M§(this,param1.col1);
         this.y = b2Math.§3M§(this,param1.col2);
         this.x = _loc2_;
      }
      
      public function §22§(param1:Number) : void
      {
         var _loc2_:Number = this.x;
      ...
      public function §2!a§(param1:b2Vec2) : void
      {
         this.x = this.x > param1.x ? Number(this.x) : Number(param1.x);
         this.y = this.y > param1.y ? Number(this.y) : Number(param1.y);
      }
      ...
      {
         return b2Math.§3!Q§(this.x) && b2Math.§3!Q§(this.y);
      }
   }
}
