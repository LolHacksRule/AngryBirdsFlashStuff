package §-!G§
{
   public class b2Mat22
   {
      ...
      public static function §<!a§(param1:Number) : b2Mat22
      {
      ...
      public static function §4c§(param1:b2Vec2, param2:b2Vec2) : b2Mat22
      {
      ...
      public function §5=§(param1:b2Mat22) : void
      {
         this.col1.SetV(param1.col1);
         this.col2.SetV(param1.col2);
      }
      
      public function §6!0§(param1:b2Mat22) : void
      {
      ...
      public function §<!4§(param1:b2Mat22) : b2Mat22
      {
      ...
      public function §`"7§(param1:b2Vec2, param2:Number, param3:Number) : b2Vec2
      {
