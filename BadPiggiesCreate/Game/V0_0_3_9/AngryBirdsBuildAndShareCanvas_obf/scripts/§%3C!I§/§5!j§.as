package §<!I§
{
   ...
   public class §5!j§ extends §="5§
   {
      
      public static const §1!V§:int = 4;
      ...
      public function §5!j§(param1:XML, param2:§>"-§, param3:MovieClip = null)
      {
         this.§&`§ = new Rectangle();
      ...
      private function startDrag(param1:Event = null) : void
      {
         if(mClip.stage)
         {
            ...
            this.mDragging = true;
            mClip.stage.addEventListener(MouseEvent.MOUSE_MOVE,this.§5!3§);
            mClip.stage.addEventListener(MouseEvent.ROLL_OUT,this.stopDrag);
            mClip.stage.addEventListener(MouseEvent.MOUSE_UP,this.stopDrag);
         }
      }
      
      private function §5!3§(param1:MouseEvent) : void
      {
         this.listenerEventOccured(§1!V§,§1!]§[§1!V§]);
      }
      ...
      private function stopDrag(param1:Event = null) : void
      {
         ...
         if(mClip.stage)
         {
            mClip.stage.removeEventListener(MouseEvent.MOUSE_MOVE,this.§5!3§);
