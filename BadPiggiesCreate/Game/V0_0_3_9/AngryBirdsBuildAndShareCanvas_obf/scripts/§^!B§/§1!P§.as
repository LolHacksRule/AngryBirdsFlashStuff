package §^!B§
{
   ...
   public class §1!P§
   {
      ...
      private var §3f§:Dictionary;
      
      public function §1!P§()
      {
         this.§3f§ = new Dictionary();
      ...
      public function §]!Y§(param1:Class, param2:Class, param3:Array) : void
      {
         var _loc4_:uint = param3.length;
         var _loc5_:uint = 0;
         while(_loc5_ < _loc4_)
         {
            this.§^!z§(param1,param2,param3[_loc5_]);
            _loc5_++;
         }
      }
      
      public function §1"%§(param1:Class, param2:String) : Class
      {
         var _loc4_:* = undefined;
         var _loc3_:* = this.§3f§[param1];
         if(_loc3_ != null)
         {
      ...
      public function §^!z§(param1:Class, param2:Class, param3:String) : void
      {
         var _loc7_:uint = 0;
         var _loc8_:uint = 0;
         var _loc9_:Class = null;
         if(this.§3f§[param2] == undefined)
         {
            this.§"!D§(param2);
         }
         var _loc4_:Dictionary;
         var _loc5_:Class = (_loc4_ = this.§3f§)[param2][param3] as Class;
         _loc4_[param2][param3] = param1;
         var _loc6_:Vector.<Class>;
         if((_loc6_ = this.§[G§[param2] as Vector.<Class>) != null)
         {
      ...
      private function §"!D§(param1:Class) : void
      {
