package §!!A§
{
   public class §&!-§
   {
      ...
      public static function §7N§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
      ...
      private static function §5!z§(param1:String, param2:Boolean) : String
      {
