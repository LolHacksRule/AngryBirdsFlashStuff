package §[!Z§
{
   ...
   public class b2Collision
   {
      ...
      private static var §52§:Vector.<§"f§> = §"![§();
      
      private static var s_clipPoints1:Vector.<§"f§> = §"![§();
      
      private static var s_clipPoints2:Vector.<§"f§> = §"![§();
      
      private static var §!D§:Vector.<int> = new Vector.<int>(1);
      
      private static var §1!1§:Vector.<int> = new Vector.<int>(1);
      ...
      private static var §;!_§:b2Vec2 = new b2Vec2();
      ...
      public static function § !R§(param1:Vector.<§"f§>, param2:Vector.<§"f§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§"f§ = null;
         var _loc6_:int = 0;
      ...
      public static function §6`§(param1:Vector.<§"f§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         var _loc12_:b2Mat22 = null;
         var _loc13_:b2Vec2 = null;
         var _loc20_:§"f§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§7K§;
         var _loc8_:Vector.<b2Vec2> = param2.§;T§;
         var _loc9_:int = param5.§7K§;
         ...
         _loc20_.id.§6y§.§<!6§ = param4;
         _loc20_.id.§6y§.§&""§ = _loc21_;
         _loc20_.id.§6y§.§&!G§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§6y§.§<!6§ = param4;
         _loc20_.id.§6y§.§&""§ = _loc22_;
         _loc20_.id.§6y§.§&!G§ = 1;
      }
      
      private static function §"![§() : Vector.<§"f§>
      {
      ...
      public static function §>!G§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         param1.§[!3§ = 0;
         var _loc7_:Number = param2.§7!1§ + param4.§7!1§;
         var _loc8_:int = 0;
         §!D§[0] = _loc8_;
         var _loc9_:Number = §;!a§(§!D§,param2,param3,param4,param5);
         _loc8_ = §!D§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §1!1§[0] = _loc10_;
         var _loc11_:Number = §;!a§(§1!1§,param4,param5,param2,param3);
         _loc10_ = §1!1§[0];
         if(_loc11_ > _loc7_)
         {
            return;
         ...
         else
         {
            ...
            _loc15_ = param5;
            _loc16_ = _loc8_;
            param1.§!!y§ = b2Manifold.§8!#§;
            _loc17_ = 0;
         }
         var _loc21_:Vector.<§"f§> = §52§;
         §6`§(_loc21_,_loc12_,_loc14_,_loc16_,_loc13_,_loc15_);
         var _loc22_:int = _loc12_.§7K§;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §?Q§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         ...
         if((_loc39_ = § !R§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = § !R§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
         param1.§86§.SetV(_loc27_);
      ...
      public static function §]!K§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.§7!1§ + param4.§7!1§;
         if(_loc14_ > _loc15_ * _loc15_)
         {
            return;
         }
         param1.§!!y§ = b2Manifold.§@B§;
         param1.m_localPoint.SetV(param2.§3"8§);
         param1.§86§.§7!@§();
         param1.§[!3§ = 1;
         param1.§3J§[0].m_localPoint.SetV(param4.§3"8§);
         param1.§3J§[0].m_id.key = 0;
      }
      
      public static function §49§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.§7!1§ + param4.§7!1§;
         var _loc21_:int = param2.§7K§;
         ...
         if(_loc19_ < Number.MIN_VALUE)
         {
            param1.§[!3§ = 1;
            param1.§!!y§ = b2Manifold.§8!#§;
            param1.§86§.SetV(_loc23_[_loc18_]);
         ...
         if(_loc29_ <= 0)
         {
            ...
            param1.§[!3§ = 1;
            param1.§!!y§ = b2Manifold.§8!#§;
            param1.§86§.x = _loc15_ - _loc27_.x;
            param1.§86§.y = _loc16_ - _loc27_.y;
            param1.§86§.Normalize();
         ...
         else if(_loc30_ <= 0)
         {
            ...
            param1.§[!3§ = 1;
            param1.§!!y§ = b2Manifold.§8!#§;
            param1.§86§.x = _loc15_ - _loc28_.x;
            param1.§86§.y = _loc16_ - _loc28_.y;
            param1.§86§.Normalize();
            param1.m_localPoint.SetV(_loc28_);
            param1.§3J§[0].m_localPoint.SetV(param4.§3"8§);
            param1.§3J§[0].m_id.key = 0;
         ...
         else
         {
            ...
            param1.§[!3§ = 1;
            param1.§!!y§ = b2Manifold.§8!#§;
            param1.§86§.x = _loc23_[_loc25_].x;
            param1.§86§.y = _loc23_[_loc25_].y;
            param1.§86§.Normalize();
