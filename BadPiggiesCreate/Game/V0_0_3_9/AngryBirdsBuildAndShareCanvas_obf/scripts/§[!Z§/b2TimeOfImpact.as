package §[!Z§
{
   ...
   public class b2TimeOfImpact
   {
      ...
      private static var §,!0§:b2SimplexCache = new b2SimplexCache();
      
      private static var §for §:b2DistanceInput = new b2DistanceInput();
      ...
      private static var §2!M§:b2DistanceOutput = new b2DistanceOutput();
      ...
      public static function §>`§(param1:b2TOIInput) : Number
      {
         ...
         do
         {
            ...
            _loc4_.§5G§(§!q§,_loc15_);
            _loc5_.§5G§(§0!>§,_loc15_);
            if((_loc17_ = §>"#§.Evaluate(§!q§,§0!>§)) >= _loc11_)
            {
               _loc8_ = 1;
               break;
            }
