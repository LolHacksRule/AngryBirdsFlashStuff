package §[!Z§
{
   ...
   public class b2DynamicTree
   {
      ...
      public function §7y§(param1:b2DynamicTreeNode) : void
      {
         this.§-p§(param1);
         this.§5,§(param1);
      }
      ...
      public function §;!e§(param1:b2DynamicTreeNode, param2:b2AABB, param3:b2Vec2) : Boolean
      {
         var _loc4_:Number = NaN;
         var _loc5_:Number = NaN;
         b2Settings.b2Assert(param1.§ else§());
      ...
      public function §6"'§(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            _loc3_ = this.§[]§;
            _loc4_ = 0;
            while(_loc3_.§ else§() == false)
            {
               _loc3_ = !!(this.§9!h§ >> _loc4_ & 1) ? _loc3_.child2 : _loc3_.child1;
               _loc4_ = _loc4_ + 1 & 31;
            }
            ++this.§9!h§;
            this.§-p§(_loc3_);
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§9!B§(1,_loc5_);
         var _loc7_:b2Vec2 = b2Math.§9a§(_loc6_);
         var _loc8_:Number = param2.§6!O§;
         _loc9_ = new b2AABB();
      ...
      private function §0",§(param1:b2DynamicTreeNode) : void
      {
         ...
         if(_loc3_.§ else§() == false)
         {
            do
            {
               _loc6_ = _loc3_.child1;
               _loc7_ = _loc3_.child2;
               _loc8_ = Math.abs((_loc6_.aabb.§+!&§.x + _loc6_.aabb.§;l§.x) / 2 - _loc2_.x) + Math.abs((_loc6_.aabb.§+!&§.y + _loc6_.aabb.§;l§.y) / 2 - _loc2_.y);
               _loc9_ = Math.abs((_loc7_.aabb.§+!&§.x + _loc7_.aabb.§;l§.x) / 2 - _loc2_.x) + Math.abs((_loc7_.aabb.§+!&§.y + _loc7_.aabb.§;l§.y) / 2 - _loc2_.y);
               if(_loc8_ < _loc9_)
               {
                  _loc3_ = _loc6_;
               }
