package §[!Z§
{
   ...
   class b2SeparationFunction
   {
      ...
      public var §9!I§:b2DistanceProxy;
      ...
      public function §+"'§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§!!y§ = §1F§;
            _loc7_ = this.§;A§.§[!6§(param1.indexA[0]);
            _loc10_ = this.§9!I§.§[!6§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
            ...
            this.§?"5§.x = _loc15_ - _loc13_;
            this.§?"5§.y = _loc16_ - _loc14_;
            this.§?"5§.Normalize();
         }
         else if(param1.indexB[0] == param1.indexB[1])
         {
            this.§!!y§ = §8!#§;
            _loc8_ = this.§;A§.§[!6§(param1.indexA[0]);
            _loc9_ = this.§;A§.§[!6§(param1.indexA[1]);
            _loc10_ = this.§9!I§.§[!6§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§?"5§ = b2Math.§22§(b2Math.§?[§(_loc9_,_loc8_),1);
            this.§?"5§.Normalize();
            _loc20_ = this.§?"5§;
         ...
         {
            this.§!!y§ = §6^§;
            _loc11_ = this.§9!I§.§[!6§(param1.indexB[0]);
            _loc12_ = this.§9!I§.§[!6§(param1.indexB[1]);
            _loc7_ = this.§;A§.§[!6§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§?"5§ = b2Math.§22§(b2Math.§?[§(_loc12_,_loc11_),1);
            this.§?"5§.Normalize();
            _loc20_ = this.§?"5§;
         ...
         else
         {
            ...
            _loc11_ = this.§9!I§.§[!6§(param1.indexB[0]);
            _loc12_ = this.§9!I§.§[!6§(param1.indexB[1]);
            _loc23_ = b2Math.§'H§(param3,_loc7_);
            _loc24_ = b2Math.§6B§(param3.R,b2Math.§?[§(_loc9_,_loc8_));
            _loc25_ = b2Math.§'H§(param5,_loc10_);
            _loc26_ = b2Math.§6B§(param5.R,b2Math.§?[§(_loc12_,_loc11_));
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         {
            case §1F§:
               _loc3_ = b2Math.§&x§(param1.R,this.§?"5§);
               _loc4_ = b2Math.§&x§(param2.R,this.§?"5§.§,n§());
               _loc5_ = this.§;A§.§9!E§(_loc3_);
               _loc6_ = this.§9!I§.§9!E§(_loc4_);
               _loc7_ = b2Math.§'H§(param1,_loc5_);
               return Number(((_loc8_ = b2Math.§'H§(param2,_loc6_)).x - _loc7_.x) * this.§?"5§.x + (_loc8_.y - _loc7_.y) * this.§?"5§.y);
            case §8!#§:
               _loc10_ = b2Math.§6B§(param1.R,this.§?"5§);
               _loc7_ = b2Math.§'H§(param1,this.m_localPoint);
               _loc4_ = b2Math.§&x§(param2.R,_loc10_.§,n§());
               _loc6_ = this.§9!I§.§9!E§(_loc4_);
               return Number(((_loc8_ = b2Math.§'H§(param2,_loc6_)).x - _loc7_.x) * _loc10_.x + (_loc8_.y - _loc7_.y) * _loc10_.y);
            case §6^§:
               _loc10_ = b2Math.§6B§(param2.R,this.§?"5§);
               _loc8_ = b2Math.§'H§(param2,this.m_localPoint);
               _loc3_ = b2Math.§&x§(param1.R,_loc10_.§,n§());
               _loc5_ = this.§;A§.§9!E§(_loc3_);
               return Number(((_loc7_ = b2Math.§'H§(param1,_loc5_)).x - _loc8_.x) * _loc10_.x + (_loc7_.y - _loc8_.y) * _loc10_.y);
            default:
