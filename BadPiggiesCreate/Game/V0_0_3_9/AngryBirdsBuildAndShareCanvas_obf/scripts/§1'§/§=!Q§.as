package §1'§
{
   ...
   public class §=!Q§ extends §`!J§
   {
      ...
      public static function §,!H§(param1:§`!J§) : §=!Q§
      {
         var _loc2_:§=!Q§ = new §=!Q§(param1.type,param1.index1,param1.index2,param1.point1,param1.point2,param1.§`!@§,param1.§-u§,param1.lowerLimit,param1.upperLimit,param1.§"T§,param1.motorSpeed,param1.§!"4§,param1.maxTorque);
         _loc2_.§9"%§ = param1.§9"%§;
