package §3!t§
{
   public class b2Vec2
   {
      ...
      public static function §83§(param1:Number, param2:Number) : b2Vec2
      {
      ...
      public function §9!6§(param1:b2Vec2) : void
      {
         this.x += param1.x;
         this.y += param1.y;
      }
      ...
      public function §0"3§(param1:b2Mat22) : void
      {
      ...
      {
         var _loc2_:Number = b2Math.§"!o§(this,param1.col1);
         this.y = b2Math.§"!o§(this,param1.col2);
         this.x = _loc2_;
      }
      ...
      {
         return b2Math.§'O§(this.x) && b2Math.§'O§(this.y);
      }
   }
}
