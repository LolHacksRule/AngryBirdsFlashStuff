package §-!^§
{
   public class §'u§
   {
      ...
      public static function §#Q§(param1:String, param2:Boolean = false, param3:Boolean = false) : Object
      {
      ...
      private static function § !C§(param1:String, param2:Boolean) : String
      {
