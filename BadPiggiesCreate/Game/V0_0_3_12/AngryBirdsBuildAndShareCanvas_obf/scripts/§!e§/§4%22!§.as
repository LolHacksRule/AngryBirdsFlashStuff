package §!e§
{
   ...
   public class §4"!§ extends §5f§ implements §#!e§
   {
      ...
      public function §4"!§(param1:Array, param2:§8"7§, param3:Number)
      {
         var _loc4_:uint = 0;
         var _loc5_:uint = 0;
         var _loc6_:§3j§ = null;
      ...
      override protected function internalUpdate(param1:Number) : void
      {
         ...
         if(param1 - _loc4_ >= 0)
         {
            if(this.§[X§ != null)
            {
               if(_loc4_ <= (_loc2_ = _loc2_ + this.§[X§.duration) && _loc3_ <= param1)
               {
                  this.§[X§.update(param1 - _loc3_);
               }
               _loc3_ = _loc2_;
               if(this.§19§ != null)
               {
                  if(_loc4_ <= (_loc2_ = _loc2_ + this.§19§.duration) && _loc3_ <= param1)
                  {
                     this.§19§.update(param1 - _loc3_);
                  }
                  _loc3_ = _loc2_;
                  if(this.§[!@§ != null)
                  {
                     ...
                     if(this.§]!F§ != null)
                     {
                        if(_loc4_ <= (_loc2_ = _loc2_ + this.§]!F§.duration) && _loc3_ <= param1)
                        {
                           this.§]!F§.update(param1 - _loc3_);
                        }
                        _loc3_ = _loc2_;
                        if(this.§4!L§ != null)
                        {
                           _loc5_ = this.§4!L§.length;
                           _loc6_ = 0;
                           while(_loc6_ < _loc5_)
                           {
                              _loc7_ = this.§4!L§[_loc6_];
