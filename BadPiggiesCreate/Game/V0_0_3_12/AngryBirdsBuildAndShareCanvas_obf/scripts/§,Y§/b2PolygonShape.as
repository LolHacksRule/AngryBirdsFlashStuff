package §,Y§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §7!U§:b2Mat22 = new b2Mat22();
       
      
      b2internal var §0!G§:b2Vec2;
      ...
      public static function §1"9§(param1:Array, param2:Number) : b2PolygonShape
      {
      ...
      public static function §;!I§(param1:Number, param2:Number) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §8!&§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : b2PolygonShape
      {
         var _loc5_:b2PolygonShape;
         (_loc5_ = new b2PolygonShape()).§7U§(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public static function §8W§(param1:b2Vec2, param2:b2Vec2) : b2PolygonShape
      {
         var _loc3_:b2PolygonShape = new b2PolygonShape();
      ...
      public static function §9!J§(param1:Vector.<b2Vec2>, param2:uint) : b2Vec2
      {
      ...
      b2internal static function §5V§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§9g§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§9g§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §&,§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         while(_loc3_ < this.§?!8§)
         {
            ...
            _loc6_ = b2Math.§'T§(this.§2!!§[_loc5_],this.§2!!§[_loc4_]);
            b2Settings.b2Assert(_loc6_.§["6§() > Number.MIN_VALUE);
            this.§5!-§[_loc3_].SetV(b2Math.§2S§(_loc6_,1));
            this.§5!-§[_loc3_].Normalize();
            _loc3_++;
         }
         this.§0!G§ = §9!J§(this.§2!!§,this.§?!8§);
      }
      ...
      public function §7U§(param1:Number, param2:Number, param3:b2Vec2 = null, param4:Number = 0.0) : void
      {
         this.§?!8§ = 4;
         this.§^!'§(4);
         this.§2!!§[0].Set(-param1,-param2);
         ...
         while(_loc6_ < this.§?!8§)
         {
            this.§2!!§[_loc6_] = b2Math.§9!q§(_loc5_,this.§2!!§[_loc6_]);
            this.§5!-§[_loc6_] = b2Math.§!!7§(_loc5_.R,this.§5!-§[_loc6_]);
            _loc6_++;
         }
      }
      ...
      public function §+!3§(param1:b2Vec2, param2:b2Vec2) : void
      {
         ...
         this.§0!G§.x = 0.5 * (param1.x + param2.x);
         this.§0!G§.y = 0.5 * (param1.y + param2.y);
         this.§5!-§[0] = b2Math.§2S§(b2Math.§'T§(param2,param1),1);
         this.§5!-§[0].Normalize();
         this.§5!-§[1].x = -this.§5!-§[0].x;
         this.§5!-§[1].y = -this.§5!-§[0].y;
      }
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         {
            _loc6_ = (_loc9_ = this.§2!!§[_loc17_]).x - _loc10_;
            _loc7_ = _loc9_.y - _loc11_;
            _loc18_ = (_loc9_ = this.§5!-§[_loc17_]).x * _loc6_ + _loc9_.y * _loc7_;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§6R§.x = _loc5_ - b2internal::[!?;
         param1.§6R§.y = _loc6_ - b2internal::[!?;
         param1.include.x = _loc7_ + b2internal::[!?;
         param1.include.y = _loc8_ + b2internal::[!?;
      }
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         if(this.§?!8§ == 2)
         {
            param1.center.x = 0.5 * (this.§2!!§[0].x + this.§2!!§[1].x);
            param1.center.y = 0.5 * (this.§2!!§[0].y + this.§2!!§[1].y);
            param1.§&!H§ = 0;
            param1.I = 0;
            return;
         }
         ...
         while(_loc10_ < this.§?!8§)
         {
            ...
            _loc12_ = _loc10_ + 1 < this.§?!8§ ? this.§2!!§[int(_loc10_ + 1)] : this.§2!!§[0];
            _loc13_ = _loc11_.x - 0;
            _loc14_ = _loc11_.y - 0;
            _loc15_ = _loc12_.x - 0;
            _loc16_ = _loc12_.y - 0;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc25_:Number = NaN;
         var _loc5_:b2Vec2 = b2Math.§'S§(param3.R,param1);
         var _loc6_:Number = param2 - b2Math.§"!o§(param1,param3.position);
         ...
         {
            _loc7_[_loc12_] = b2Math.§"!o§(_loc5_,this.§2!!§[_loc12_]) - _loc6_;
         ...
         switch(_loc8_)
         {
            case 0:
               if(_loc11_)
               {
                  ...
                  param4.SetV(b2Math.§9!q§(param3,_loc24_.center));
                  return _loc24_.§&!H§;
               }
               return 0;
               break;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.§2!!§[_loc9_].x * (1 - _loc15_) + this.§2!!§[_loc13_].x * _loc15_,this.§2!!§[_loc9_].y * (1 - _loc15_) + this.§2!!§[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.§2!!§[_loc10_].x * (1 - _loc16_) + this.§2!!§[_loc14_].x * _loc16_,this.§2!!§[_loc10_].y * (1 - _loc16_) + this.§2!!§[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.§2!!§[_loc13_];
         _loc12_ = _loc13_;
         ...
         _loc20_.§%!?§(1 / _loc19_);
         param4.SetV(b2Math.§9!q§(param3,_loc20_));
         return _loc19_;
      }
