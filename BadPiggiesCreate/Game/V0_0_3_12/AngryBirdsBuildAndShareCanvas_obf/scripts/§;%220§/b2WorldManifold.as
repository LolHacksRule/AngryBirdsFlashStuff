package §;"0§
{
   ...
   public class b2WorldManifold
   {
      ...
      public function §[z§(param1:b2Manifold, param2:b2Transform, param3:Number, param4:b2Transform, param5:Number) : void
      {
         var _loc6_:int = 0;
         ...
         switch(param1.§+V§)
         {
            case b2Manifold.§2"2§:
               ...
               _loc8_ = param4.R;
               _loc7_ = param1.§ !J§[0].m_localPoint;
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§'3§.x = _loc19_ / _loc26_;
                  this.§'3§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§'3§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§'3§.x;
               _loc23_ = _loc16_ + param3 * this.§'3§.y;
               _loc24_ = _loc17_ - param5 * this.§'3§.x;
               _loc25_ = _loc18_ - param5 * this.§'3§.y;
               this.§ !J§[0].x = 0.5 * (_loc22_ + _loc24_);
               this.§ !J§[0].y = 0.5 * (_loc23_ + _loc25_);
               break;
            case b2Manifold.§?B§:
               _loc8_ = param2.R;
               _loc7_ = param1.§^S§;
               ...
               this.§'3§.y = _loc10_;
               _loc6_ = 0;
               while(_loc6_ < param1.§3!G§)
               {
                  _loc8_ = param4.R;
                  _loc7_ = param1.§ !J§[_loc6_].m_localPoint;
                  ...
                  this.§ !J§[_loc6_].x = _loc13_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc9_;
                  this.§ !J§[_loc6_].y = _loc14_ + 0.5 * (param3 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param5) * _loc10_;
                  _loc6_++;
               }
               break;
            case b2Manifold.§`9§:
               ...
               while(_loc6_ < param1.§3!G§)
               {
                  ...
                  this.§ !J§[_loc6_].x = _loc13_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc9_;
                  this.§ !J§[_loc6_].y = _loc14_ + 0.5 * (param5 - (_loc13_ - _loc11_) * _loc9_ - (_loc14_ - _loc12_) * _loc10_ - param3) * _loc10_;
                  _loc6_++;
               }
         }
      }
