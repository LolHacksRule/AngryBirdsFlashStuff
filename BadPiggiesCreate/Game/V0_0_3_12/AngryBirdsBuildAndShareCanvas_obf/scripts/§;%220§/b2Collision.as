package §;"0§
{
   ...
   public class b2Collision
   {
      ...
      private static var §9!I§:Vector.<§-!1§> = § !m§();
      
      private static var s_clipPoints1:Vector.<§-!1§> = § !m§();
      
      private static var s_clipPoints2:Vector.<§-!1§> = § !m§();
      
      private static var §87§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §29§(param1:Vector.<§-!1§>, param2:Vector.<§-!1§>, param3:b2Vec2, param4:Number) : int
      {
         var _loc5_:§-!1§ = null;
         var _loc6_:int = 0;
      ...
      public static function §0!@§(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param1.§5!-§;
      ...
      public static function § ""§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc7_:Vector.<b2Vec2> = param2.§5!-§;
         _loc9_ = param5.R;
         _loc8_ = param4.§0!G§;
      ...
      public static function §+!6§(param1:Vector.<§-!1§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc8_:Vector.<b2Vec2> = param2.§5!-§;
         var _loc9_:int = param5.§?!8§;
         var _loc10_:Vector.<b2Vec2> = param5.§2!!§;
         var _loc11_:Vector.<b2Vec2> = param5.§5!-§;
         _loc12_ = param3.R;
         ...
         _loc20_.id.§<!b§.§4"§ = param4;
         _loc20_.id.§<!b§.§9!X§ = _loc21_;
         _loc20_.id.§<!b§.§`!v§ = 0;
         _loc20_ = param1[1];
         ...
         _loc20_.v.y = param6.position.y + (_loc12_.col1.y * _loc13_.x + _loc12_.col2.y * _loc13_.y);
         _loc20_.id.§<!b§.§4"§ = param4;
         _loc20_.id.§<!b§.§9!X§ = _loc22_;
         _loc20_.id.§<!b§.§`!v§ = 1;
      }
      
      private static function § !m§() : Vector.<§-!1§>
      {
      ...
      public static function § <§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §87§[0] = _loc8_;
         var _loc9_:Number = § ""§(§87§,param2,param3,param4,param5);
         _loc8_ = §87§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc26_:b2Vec2;
         (_loc26_ = §@!F§).Set(_loc25_.x - _loc24_.x,_loc25_.y - _loc24_.y);
         _loc26_.Normalize();
         var _loc27_:b2Vec2;
         (_loc27_ = §%U§).x = _loc26_.y;
         _loc27_.y = -_loc26_.x;
         var _loc28_:b2Vec2;
         (_loc28_ = §]!Y§).Set(0.5 * (_loc24_.x + _loc25_.x),0.5 * (_loc24_.y + _loc25_.y));
         var _loc29_:b2Vec2 = §3!m§;
         _loc20_ = _loc14_.R;
         ...
         if((_loc39_ = §29§(_loc37_,_loc21_,_loc30_,_loc35_)) < 2)
         {
            return;
         }
         if((_loc39_ = §29§(_loc38_,_loc37_,_loc29_,_loc36_)) < 2)
         {
            return;
         }
      ...
      public static function §>"+§(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         param1.§+V§ = b2Manifold.§2"2§;
         param1.m_localPoint.SetV(param2.§continue§);
         param1.§^S§.§ 4§();
         param1.§3!G§ = 1;
         param1.§ !J§[0].m_localPoint.SetV(param4.§continue§);
         param1.§ !J§[0].m_id.key = 0;
      }
      ...
      public static function §[P§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc23_:Vector.<b2Vec2> = param2.§5!-§;
         var _loc24_:int = 0;
      ...
      public static function §3!z§(param1:b2AABB, param2:b2AABB) : Boolean
      {
         var _loc3_:b2Vec2 = param2.§6R§;
         var _loc4_:b2Vec2 = param1.include;
         var _loc5_:Number = _loc3_.x - _loc4_.x;
         var _loc6_:Number = _loc3_.y - _loc4_.y;
         _loc3_ = param1.§6R§;
         _loc4_ = param2.include;
