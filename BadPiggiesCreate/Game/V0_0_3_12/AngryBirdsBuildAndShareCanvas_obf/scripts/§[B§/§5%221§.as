package §[B§
{
   ...
   public class §5"1§
   {
      ...
      public static const MIGHTY_EAGLE_Y_CHANGE:Number = Math.sin(§60§.§`!r§(MIGHTY_EAGLE_FLYING_ANGLE));
      
      public static const MIGHTY_EAGLE_X_DIRECTION:Number = 1;
      
      public static const §-<§:Number = 1500;
      
      public static const §7v§:Number = 0.7;
      
      public static const §>!f§:Number = 0.2;
      
      public static const §!!f§:Number = 8.8;
      
      public static const §+J§:Number = 2400;
      ...
      public static const §"!-§:Number = 6 * §"f§;
      ...
      public static const §7!a§:Number = 7.5;
      
      public static const §^"&§:Number = 300;
      
      public static const § do§:Number = 0.5;
