package §4"$§
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      {
         return new b2Vec2(param1 * (this.§>&§.x * this.§@!w§.x + (this.§@!S§ + this.§>&§.z) * this.§+6§.x),param1 * (this.§>&§.x * this.§@!w§.y + (this.§@!S§ + this.§>&§.z) * this.§+6§.y));
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(param1.§50§)
         {
            ...
            this.§>&§.y *= param1.§<!4§;
            this.§@!S§ *= param1.§<!4§;
            _loc19_ = this.§>&§.x * this.§@!w§.x + (this.§@!S§ + this.§>&§.z) * this.§+6§.x;
            _loc20_ = this.§>&§.x * this.§@!w§.y + (this.§@!S§ + this.§>&§.z) * this.§+6§.y;
            _loc21_ = this.§>&§.x * this.m_s1 + this.§>&§.y + (this.§@!S§ + this.§>&§.z) * this.m_a1;
            _loc22_ = this.§>&§.x * this.m_s2 + this.§>&§.y + (this.§@!S§ + this.§>&§.z) * this.m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.§#!l§ && this.§-J§ != b2internal::"h)
         {
            ...
            _loc15_ = this.§@"-§ * (this.§#x§ - _loc14_);
            _loc16_ = this.§@!S§;
            _loc17_ = param1.§!"7§ * this.§>!y§;
            this.§@!S§ = b2Math.§4"?§(this.§@!S§ + _loc15_,-_loc17_,_loc17_);
            _loc8_ = (_loc15_ = this.§@!S§ - _loc16_) * this.§+6§.x;
         ...
         if(this.§ =§ && this.§-J§ != b2internal::21)
         {
            ...
            if(this.§-J§ == b2internal::<i)
            {
               this.§>&§.z = b2Math.§9b§(this.§>&§.z,0);
            }
            else if(this.§-J§ == b2internal::2!s)
            {
               this.§>&§.z = b2Math.§#!>§(this.§>&§.z,0);
            }
            _loc21_ = -_loc12_ - (this.§>&§.z - _loc19_.z) * this.§3!<§.col3.x;
            _loc22_ = -_loc13_ - (this.§>&§.z - _loc19_.z) * this.§3!<§.col3.y;
            ...
            _loc8_ = _loc20_.x * this.§@!w§.x + _loc20_.z * this.§+6§.x;
            _loc9_ = _loc20_.x * this.§@!w§.y + _loc20_.z * this.§+6§.y;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         if(this.§ =§)
         {
            ...
            if(b2Math.§3!n§(this.§^!=§ - this.§[!1§) < 2 * b2Settings.b2_linearSlop)
            {
               _loc19_ = b2Math.§4"?§(_loc35_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);
               _loc16_ = b2Math.§3!n§(_loc35_);
               _loc18_ = true;
            }
            else if(_loc35_ <= this.§[!1§)
            {
               _loc19_ = b2Math.§4"?§(_loc35_ - this.§[!1§ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);
               _loc16_ = this.§[!1§ - _loc35_;
               _loc18_ = true;
            }
            else if(_loc35_ >= this.§^!=§)
            {
               _loc19_ = b2Math.§4"?§(_loc35_ - this.§^!=§ + b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);
         ...
         var _loc30_:Number = _loc9_ - _loc7_ - this.§>!e§;
         _loc16_ = b2Math.§9b§(_loc16_,b2Math.§3!n§(_loc29_));
         _loc17_ = b2Math.§3!n§(_loc30_);
         if(_loc18_)
         {
         ...
         var _loc31_:Number = _loc28_.x * this.§@!w§.x + _loc28_.z * this.§+6§.x;
         var _loc32_:Number = _loc28_.x * this.§@!w§.y + _loc28_.z * this.§+6§.y;
         ...
         _loc7_ -= b2internal::;a * _loc33_;
         _loc8_.x += b2internal::6! * _loc31_;
         _loc8_.y += b2internal::6! * _loc32_;
         _loc9_ += b2internal::3B * _loc34_;
