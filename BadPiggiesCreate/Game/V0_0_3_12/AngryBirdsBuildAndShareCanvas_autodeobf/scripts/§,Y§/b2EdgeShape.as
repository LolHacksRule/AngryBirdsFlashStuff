package §,Y§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      b2internal var §5!5§:b2EdgeShape;
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.m_v1 = param1;
         this.m_v2 = param2;
         this.§&!8§.Set(this.m_v2.x - this.m_v1.x,this.m_v2.y - this.m_v1.y);
         this.§&3§ = this.§&!8§.Normalize();
         this.§'3§.Set(this.§&!8§.y,-this.§&!8§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§'3§.x - this.§&!8§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§'3§.y - this.§&!8§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§'3§.x + this.§&!8§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§'3§.y + this.§&!8§.y) + this.m_v2.y);
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         {
            param1.§6R§.x = _loc4_;
            param1.include.x = _loc6_;
         }
         else
         {
            param1.§6R§.x = _loc6_;
            param1.include.x = _loc4_;
         }
         if(_loc5_ < _loc7_)
         {
            param1.§6R§.y = _loc5_;
            param1.include.y = _loc7_;
         }
         else
         {
            param1.§6R§.y = _loc7_;
            param1.include.y = _loc5_;
         }
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.§9!q§(param3,this.m_v1);
         var _loc7_:b2Vec2 = b2Math.§9!q§(param3,this.m_v2);
         var _loc8_:Number = b2Math.§"!o§(param1,_loc6_) - param2;
         var _loc9_:Number = b2Math.§"!o§(param1,_loc7_) - param2;
         if(_loc8_ > 0)
         {
            if(_loc9_ > 0)
            {
      ...
      public function §throw§(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
