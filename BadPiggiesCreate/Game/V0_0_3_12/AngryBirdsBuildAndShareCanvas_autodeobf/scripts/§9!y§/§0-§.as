package §9!y§
{
   ...
   public class §0-§ extends Sprite
   {
      ...
      public function §0-§(param1:int, param2:int, param3:Number, param4:Number, param5:int, param6:int = 40, param7:Number = 0, param8:String = "ParticleStar")
      {
         var _loc9_:§+'§ = null;
         super();
         this.§9p§ = param1 * §%W§.§@!N§;
         this.§75§ = param2 * §%W§.§`N§;
         this.scrollRect = new Rectangle(0,0,this.§9p§,this.§75§);
         this.§ !b§ = param5;
