package §^Q§
{
   ...
   public class Texture
   {
      ...
      public static function §;!`§(param1:Context3D, param2:Bitmap, param3:Boolean = true, param4:Boolean = false) : §^Q§.Texture
      {
         return §%<§(param1,param2.bitmapData,param3,param4);
      }
      
      public static function §%<§(param1:Context3D, param2:BitmapData, param3:Boolean = true, param4:Boolean = false) : §^Q§.Texture
      {
         ...
         _loc10_ = new §7G§(_loc11_,_loc7_,_loc8_,param3,true,param4);
         if(§0"<§.§5C§)
         {
            _loc10_.§8P§(param2);
         }
      ...
      public static function §"!?§(param1:Context3D, param2:ByteArray) : §^Q§.Texture
      {
         if(param1 == null)
         {
            throw new §<!r§();
         ...
         var _loc9_:§7G§ = new §7G§(_loc8_,_loc5_,_loc6_,_loc7_ > 1,false);
         if(§0"<§.§5C§)
         {
            _loc9_.§8P§(param2);
         }
      ...
      public static function §5&§(param1:§^Q§.Texture, param2:Rectangle = null, param3:Rectangle = null) : §^Q§.Texture
      {
         var _loc4_:§^Q§.Texture;
         (_loc4_ = new § 5§(param1,param2)).§@!0§ = param3;
         return _loc4_;
      }
      
      public static function empty(param1:Context3D, param2:int = 64, param3:int = 64, param4:uint = 4.294967295E9, param5:Boolean = false) : §^Q§.Texture
      {
         var _loc6_:BitmapData = new BitmapData(param2,param3,true,param4);
         var _loc7_:§^Q§.Texture = §%<§(param1,_loc6_,false,param5);
         if(!§0"<§.§5C§)
         {
            _loc6_.dispose();
         }
      ...
      public function adjustVertexData(param1:§'%§, param2:int, param3:int) : void
      {
         ...
         if(this.§@!0§)
         {
            ...
            param1.§4Z§(param2,-this.§@!0§.x,-this.§@!0§.y);
            param1.§4Z§(param2 + 1,-_loc4_,-this.§@!0§.y);
            param1.§4Z§(param2 + 2,-this.§@!0§.x,-_loc5_);
            param1.§4Z§(param2 + 3,-_loc4_,-_loc5_);
         }
      }
