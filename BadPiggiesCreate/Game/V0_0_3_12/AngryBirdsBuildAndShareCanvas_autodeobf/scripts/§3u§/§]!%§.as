package §3u§
{
   ...
   public class §]!%§ extends §!!O§
   {
      ...
      protected function §2!%§(param1:XML, param2:Vector.<XML>) : void
      {
         ...
         var _loc16_:§^!k§ = null;
         var _loc3_:Dictionary = this.§9"%§(param2);
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if((_loc10_ = _loc3_[this.§[!X§(_loc7_,_loc6_)]) == null)
            {
               ...
               {
                  _loc10_ = new §3A§(0,0,_loc11_,_loc12_,_loc13_,_loc14_);
               }
            }
            if(_loc10_)
            {
      ...
      private function §[!X§(param1:String, param2:String) : String
      {
         return param1 + "#" + param2;
      }
      
      private function §9"%§(param1:Vector.<XML>) : Dictionary
      {
         var _loc3_:XML = null;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc7_ = this.§[!X§(_loc4_,_loc6_.@name);
               if(_loc2_[_loc7_] == null)
               {
                  ...
                  _loc2_[_loc7_] = new §3A§(_loc12_,_loc13_,_loc8_,_loc9_,_loc10_,_loc11_);
               }
            }
         }
         return _loc2_;
