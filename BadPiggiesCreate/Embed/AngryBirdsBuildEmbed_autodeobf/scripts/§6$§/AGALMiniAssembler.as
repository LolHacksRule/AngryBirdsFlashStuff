         ...
         while(_loc9_ < _loc10_ && this.§8'§ == "")
         {
            ...
            else
            {
               ...
               if(_loc16_.flags & §#!;§)
               {
                  ...
                  if(_loc7_ > §-J§)
                  {
                     this.§8'§ = "error: nesting to deep, maximum allowed is " + §-J§ + ".";
                     break;
                  }
               }
               ...
               if(_loc8_ > §>&§)
               {
                  this.§8'§ = "error: too many opcodes. maximum is " + §>&§ + ".";
                  break;
               }
               ...
               while(_loc21_ < _loc20_)
               {
                  ...
                  else if(_loc31_)
                  {
                     ...
                     while(_loc37_ < _loc43_)
                     {
                        ...
                        if((_loc45_ = §0!c§[_loc14_[_loc37_]]) == null)
                        {
