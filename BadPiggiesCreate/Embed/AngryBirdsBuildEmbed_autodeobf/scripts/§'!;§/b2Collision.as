package §'!;§
{
   ...
   public class b2Collision
   {
      ...
      private static var §`c§:Vector.<int> = new Vector.<int>(1);
      ...
      public static function §,n§(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc17_:Number = §'h§(param2,param3,_loc14_,param4,param5);
         var _loc18_:int = _loc14_ - 1 >= 0 ? int(_loc14_ - 1) : int(_loc6_ - 1);
         var _loc19_:Number = §'h§(param2,param3,_loc18_,param4,param5);
         var _loc20_:int = _loc14_ + 1 < _loc6_ ? int(_loc14_ + 1) : 0;
         var _loc21_:Number = §'h§(param2,param3,_loc20_,param4,param5);
         ...
         while(true)
         {
            ...
            if((_loc17_ = §'h§(param2,param3,_loc14_,param4,param5)) <= _loc23_)
            {
               break;
            }
            _loc22_ = _loc14_;
      ...
      public static function §<!d§(param1:Vector.<§^A§>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc20_:§^A§ = null;
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.§8k§;
         var _loc8_:Vector.<b2Vec2> = param2.§+!]§;
         var _loc9_:int = param5.§8k§;
         ...
         _loc20_.id.§8!Y§.§5!3§ = param4;
         _loc20_.id.§8!Y§.§`J§ = _loc21_;
         _loc20_.id.§8!Y§.§'!P§ = 0;
         _loc20_ = param1[1];
      ...
      public static function §4@§(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc8_:int = 0;
         §`c§[0] = _loc8_;
         var _loc9_:Number = §,n§(§`c§,param2,param3,param4,param5);
         _loc8_ = §`c§[0];
         if(_loc9_ > _loc7_)
         {
            return;
         ...
         var _loc10_:int = 0;
         §=8§[0] = _loc10_;
         var _loc11_:Number = §,n§(§=8§,param4,param5,param2,param3);
         _loc10_ = §=8§[0];
         if(_loc11_ > _loc7_)
         {
            return;
