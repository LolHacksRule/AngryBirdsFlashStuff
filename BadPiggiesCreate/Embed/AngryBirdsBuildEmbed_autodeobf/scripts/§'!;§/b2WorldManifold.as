         ...
         switch(param1.§5!Z§)
         {
            case b2Manifold.§;!P§:
               ...
               if((_loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_) > Number.MIN_VALUE * Number.MIN_VALUE)
               {
                  ...
                  this.§<!S§.x = _loc19_ / _loc26_;
                  this.§<!S§.y = _loc20_ / _loc26_;
               }
               else
               {
                  this.§<!S§.x = 1;
               ...
               _loc22_ = _loc15_ + param3 * this.§<!S§.x;
               _loc23_ = _loc16_ + param3 * this.§<!S§.y;
               _loc24_ = _loc17_ - param5 * this.§<!S§.x;
               _loc25_ = _loc18_ - param5 * this.§<!S§.y;
