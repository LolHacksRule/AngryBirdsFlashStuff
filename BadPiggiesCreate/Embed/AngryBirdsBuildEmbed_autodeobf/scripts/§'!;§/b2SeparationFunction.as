package §'!;§
{
   ...
   class b2SeparationFunction
   {
      ...
      public function §6!V§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            this.§5!Z§ = §]![§;
            _loc7_ = this.§`!g§.§2!E§(param1.indexA[0]);
            _loc10_ = this.§ !4§.§2!E§(param1.indexB[0]);
            _loc20_ = _loc7_;
            _loc19_ = param3.R;
         ...
         {
            this.§5!Z§ = § !N§;
            _loc8_ = this.§`!g§.§2!E§(param1.indexA[0]);
            _loc9_ = this.§`!g§.§2!E§(param1.indexA[1]);
            _loc10_ = this.§ !4§.§2!E§(param1.indexB[0]);
            this.m_localPoint.x = 0.5 * (_loc8_.x + _loc9_.x);
            this.m_localPoint.y = 0.5 * (_loc8_.y + _loc9_.y);
            this.§;9§ = b2Math.§!!r§(b2Math.§<b§(_loc9_,_loc8_),1);
            this.§;9§.Normalize();
            _loc20_ = this.§;9§;
         ...
         {
            this.§5!Z§ = §%!5§;
            _loc11_ = this.§ !4§.§2!E§(param1.indexB[0]);
            _loc12_ = this.§ !4§.§2!E§(param1.indexB[1]);
            _loc7_ = this.§`!g§.§2!E§(param1.indexA[0]);
            this.m_localPoint.x = 0.5 * (_loc11_.x + _loc12_.x);
            this.m_localPoint.y = 0.5 * (_loc11_.y + _loc12_.y);
            this.§;9§ = b2Math.§!!r§(b2Math.§<b§(_loc12_,_loc11_),1);
            this.§;9§.Normalize();
            _loc20_ = this.§;9§;
         ...
         else
         {
            ...
            _loc24_ = b2Math.§`!"§(param3.R,b2Math.§<b§(_loc9_,_loc8_));
            _loc25_ = b2Math.§#!N§(param5,_loc10_);
            _loc26_ = b2Math.§`!"§(param5.R,b2Math.§<b§(_loc12_,_loc11_));
            _loc27_ = _loc24_.x * _loc24_.x + _loc24_.y * _loc24_.y;
            _loc28_ = _loc26_.x * _loc26_.x + _loc26_.y * _loc26_.y;
            _loc29_ = b2Math.§<b§(_loc26_,_loc24_);
      ...
      public function Evaluate(param1:b2Transform, param2:b2Transform) : Number
      {
         ...
         switch(this.§5!Z§)
         {
            case §]![§:
               ...
               return Number(((_loc8_ = b2Math.§#!N§(param2,_loc6_)).x - _loc7_.x) * this.§;9§.x + (_loc8_.y - _loc7_.y) * this.§;9§.y);
            case § !N§:
