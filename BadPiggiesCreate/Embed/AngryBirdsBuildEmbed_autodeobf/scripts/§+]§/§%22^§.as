package §+]§
{
   ...
   public class §"^§
   {
      ...
      public static function § each§(param1:b2Shape, param2:b2Transform, param3:b2Shape, param4:b2Transform) : § set§
      {
         ...
         {
            _loc5_ = §4n§(param1 as b2PolygonShape,param2,param3 as b2CircleShape,param4);
         }
         else if(param1 is b2CircleShape && param3 is b2PolygonShape)
         {
            (_loc5_ = §4n§(param3 as b2PolygonShape,param4,param1 as b2CircleShape,param2)).§^Y§.§-![§();
         }
      ...
      public static function §8]§(param1:b2PolygonShape, param2:b2Transform, param3:b2PolygonShape, param4:b2Transform) : § set§
      {
         ...
         while(_loc15_ < _loc6_.length)
         {
            ...
            while(_loc21_ < _loc7_.length)
            {
               ...
               _loc30_ = false;
               if(§]1§(_loc16_,_loc19_,_loc22_,_loc23_) || §]1§(_loc17_,_loc20_,_loc22_,_loc23_) || §]1§(_loc22_,_loc25_,_loc16_,_loc17_) || §]1§(_loc23_,_loc26_,_loc16_,_loc17_))
               {
                  _loc30_ = true;
               }
               if(_loc30_)
         ...
         {
            _loc33_ = _loc14_.§4!<§;
            _loc34_ = §6w§(_loc8_,_loc14_.§'E§,_loc14_.rotation / 180 * Math.PI);
            _loc35_ = §6w§(_loc9_,_loc14_.§'E§,_loc14_.rotation / 180 * Math.PI);
            _loc34_.§!a§(_loc33_);
            _loc35_.§!a§(_loc33_);
            _loc36_ = b2Math.§@9§(_loc34_,_loc11_);
            _loc37_ = b2Math.§@9§(_loc34_,_loc12_);
            _loc38_ = b2Math.§@9§(_loc35_,_loc11_);
            ...
            if(_loc40_ < _loc41_)
            {
               if(_loc36_ < §4x§)
               {
                  (_loc43_ = _loc11_.Copy()).§&!v§(_loc34_);
               }
               if(_loc39_ < §4x§ && _loc39_ < _loc36_)
               {
                  (_loc43_ = _loc12_.Copy()).§&!v§(_loc35_);
               }
            }
            else
            {
               if(_loc37_ < §4x§)
               {
                  (_loc43_ = _loc12_.Copy()).§&!v§(_loc34_);
               }
               if(_loc38_ < §4x§ && _loc38_ < _loc37_)
               {
                  (_loc43_ = _loc11_.Copy()).§&!v§(_loc35_);
               }
            }
            _loc14_.§0J§ = _loc43_ != null;
            if(_loc43_ != null)
            {
               _loc33_.§!a§(_loc43_);
            }
            (_loc44_ = _loc13_.Copy()).Normalize();
            _loc44_.§=!K§(b2Settings.b2_linearSlop * 2);
            _loc33_.§!a§(_loc44_);
            _loc14_.§^Y§ = _loc33_;
            return _loc14_;
         }
      ...
      public static function §4n§(param1:b2PolygonShape, param2:b2Transform, param3:b2CircleShape, param4:b2Transform) : § set§
      {
         ...
         while(_loc9_ < _loc7_.length)
         {
            ...
            _loc13_ = ((_loc12_ = §4!J§(_loc10_,_loc11_,_loc5_).§4!<§).§#!^§() - _loc6_) / _loc12_.§#!^§();
            _loc12_.x *= _loc13_;
            _loc12_.y *= _loc13_;
      ...
      public static function §+>§(param1:b2CircleShape, param2:b2Transform, param3:b2CircleShape, param4:b2Transform) : § set§
      {
         ...
         var _loc8_:Number = (_loc7_.§#!^§() - param1.§?'§() - param3.§?'§()) / _loc7_.§#!^§();
         _loc7_.x *= _loc8_;
         _loc7_.y *= _loc8_;
         var _loc9_:§ set§;
      ...
      public static function §66§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2, param4:b2Vec2) : § set§
      {
         ...
         _loc11_ = _loc7_;
         if(_loc8_.§4!<§.§#!^§() < _loc11_.§4!<§.§#!^§())
         {
            _loc11_ = _loc8_;
         }
         if(_loc9_.§4!<§.§#!^§() < _loc11_.§4!<§.§#!^§())
         {
            _loc11_ = _loc9_;
         }
         if(_loc10_.§4!<§.§#!^§() < _loc11_.§4!<§.§#!^§())
         {
            _loc11_ = _loc10_;
         }
         return _loc11_;
      ...
      public static function §4!J§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2, param4:Boolean = false) : § set§
      {
         ...
         var _loc8_:§ set§;
         (_loc8_ = new § set§()).§4!<§ = new b2Vec2(param3.x - _loc7_.x,param3.y - _loc7_.y);
         if(param4)
         {
            _loc8_.§4!<§.§-![§();
         }
         _loc8_.§'E§ = !!param4 ? param3 : _loc7_;
         return _loc8_;
      }
      
      public static function §">§(param1:b2Vec2, param2:b2Vec2, param3:b2Vec2, param4:b2Vec2, param5:Boolean = true) : Number
      {
         return §?b§(new b2Vec2(param2.x - param1.x,param2.y - param1.y),new b2Vec2(param4.x - param3.x,param4.y - param3.y),param5);
      }
