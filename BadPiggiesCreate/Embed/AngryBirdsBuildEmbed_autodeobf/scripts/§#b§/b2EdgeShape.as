package §#b§
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      public function b2EdgeShape(param1:b2Vec2, param2:b2Vec2)
      {
         ...
         this.§<!S§.Set(this.§@O§.y,-this.§@O§.x);
         this.m_coreV1.Set(-b2Settings.b2_toiSlop * (this.§<!S§.x - this.§@O§.x) + this.m_v1.x,-b2Settings.b2_toiSlop * (this.§<!S§.y - this.§@O§.y) + this.m_v1.y);
         this.m_coreV2.Set(-b2Settings.b2_toiSlop * (this.§<!S§.x + this.§@O§.x) + this.m_v2.x,-b2Settings.b2_toiSlop * (this.§<!S§.y + this.§@O§.y) + this.m_v2.y);
         this.m_cornerDir1 = this.§<!S§;
         this.m_cornerDir2.Set(-this.§<!S§.x,-this.§<!S§.y);
      }
