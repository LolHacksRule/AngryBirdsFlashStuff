package §#b§
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      private static var §1!n§:b2Mat22 = new b2Mat22();
      ...
      b2internal static function §7!4§(param1:b2OBB, param2:Vector.<b2Vec2>, param3:int) : void
      {
         ...
         while(_loc4_ <= param3)
         {
            ...
            if((_loc18_ = (_loc15_ - _loc13_) * (_loc16_ - _loc14_)) < 0.95 * _loc6_)
            {
               ...
               param1.§4k§.x = 0.5 * (_loc15_ - _loc13_);
               param1.§4k§.y = 0.5 * (_loc16_ - _loc14_);
            }
            _loc4_++;
         }
      }
      ...
      public function §[!c§(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc3_ + 1 < this.§8k§ ? int(_loc3_ + 1) : 0;
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.§ !d§.x = _loc5_ - b2internal::%+;
         param1.§ !d§.y = _loc6_ - b2internal::%+;
         param1.§=!j§.x = _loc7_ + b2internal::%+;
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc13_:int = (_loc9_ + 1) % this.§8k§;
         var _loc14_:int = (_loc10_ + 1) % this.§8k§;
         ...
         {
            if((_loc12_ = (_loc12_ + 1) % this.§8k§) == _loc14_)
            {
               _loc22_ = _loc18_;
            }
            else
