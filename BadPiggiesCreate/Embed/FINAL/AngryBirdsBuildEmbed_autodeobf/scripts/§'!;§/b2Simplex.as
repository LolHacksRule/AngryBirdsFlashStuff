package §'!;§
{
   ...
   class b2Simplex
   {
      ...
      public function §^!J§(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         {
            _loc11_ = param1.§^!8§;
            if((_loc12_ = this.§3!K§()) < 0.5 * _loc11_ || 2 * _loc11_ < _loc12_ || _loc12_ < Number.MIN_VALUE)
            {
               this.§'!,§ = 0;
            }
         }
      ...
      public function §3o§() : b2Vec2
      {
         ...
         switch(this.§'!,§)
         {
            ...
            case 2:
               ...
               _loc2_ = b2Math.§?§(_loc1_,this.m_v1.§6! §.§[1§());
               if(_loc2_ > 0)
               {
      ...
      public function § !F§(param1:b2Vec2, param2:b2Vec2) : void
      {
         switch(this.§'!,§)
         {
            ...
            case 2:
               ...
               param2.x = this.m_v1.a * this.m_v1.§0!j§.x + this.m_v2.a * this.m_v2.§0!j§.x;
               param2.y = this.m_v1.a * this.m_v1.§0!j§.y + this.m_v2.a * this.m_v2.§0!j§.y;
               break;
            case 3:
      ...
      public function §3!K§() : Number
      {
         switch(this.§'!,§)
         {
            ...
            case 1:
               return 0;
            case 2:
               return b2Math.§<b§(this.m_v1.§6! §,this.m_v2.§6! §).§#!^§();
            case 3:
               return b2Math.§?§(b2Math.§<b§(this.m_v2.§6! §,this.m_v1.§6! §),b2Math.§<b§(this.m_v3.§6! §,this.m_v1.§6! §));
            default:
               b2Settings.b2Assert(false);
               return 0;
         }
